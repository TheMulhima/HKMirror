...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnEnable", true), OnEnable);

}
}
internal static event Delegates.OnEnable_BeforeArgs _beforeOnEnable;
internal static event Delegates.OnEnable_AfterArgs _afterOnEnable;
private static void OnEnable(Action<InControl.InControlManager> orig, InControl.InControlManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnDisable", true), OnDisable);

}
}
internal static event Delegates.OnDisable_BeforeArgs _beforeOnDisable;
internal static event Delegates.OnDisable_AfterArgs _afterOnDisable;
private static void OnDisable(Action<InControl.InControlManager> orig, InControl.InControlManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "Update", true), Update);

}
}
internal static event Delegates.Update_BeforeArgs _beforeUpdate;
internal static event Delegates.Update_AfterArgs _afterUpdate;
private static void Update(Action<InControl.InControlManager> orig, InControl.InControlManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "FixedUpdate", true), FixedUpdate);
...
private static void FixedUpdate(Action<InControl.InControlManager> orig, InControl.InControlManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationFocus", true), OnApplicationFocus);
...
private static void OnApplicationFocus(Action<InControl.InControlManager,  bool> orig, InControl.InControlManager self,  bool focusState)
{
...
{
foreach (Delegates.OnApplicationFocus_BeforeArgs toInvoke in _beforeOnApplicationFocus.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnApplicationFocus_AfterArgs toInvoke in _afterOnApplicationFocus.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationPause", true), OnApplicationPause);
...
private static void OnApplicationPause(Action<InControl.InControlManager,  bool> orig, InControl.InControlManager self,  bool pauseState)
{
...
{
foreach (Delegates.OnApplicationPause_BeforeArgs toInvoke in _beforeOnApplicationPause.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnApplicationPause_AfterArgs toInvoke in _afterOnApplicationPause.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationQuit", true), OnApplicationQuit);
...
private static void OnApplicationQuit(Action<InControl.InControlManager> orig, InControl.InControlManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnSceneWasLoaded", true), OnSceneWasLoaded);
...
private static void OnSceneWasLoaded(Action<InControl.InControlManager,  UnityEngine.SceneManagement.Scene,  UnityEngine.SceneManagement.LoadSceneMode> orig, InControl.InControlManager self,  UnityEngine.SceneManagement.Scene scene,  UnityEngine.SceneManagement.LoadSceneMode loadSceneMode)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "LogMessage", false), LogMessage);
...
private static void LogMessage(Action< InControl.LogMessage> orig,  InControl.LogMessage logMessage)
{
...
{
public InControl.InControlManager self;
}
public delegate void OnEnable_BeforeArgs(Params_OnEnable args);
public delegate void OnEnable_AfterArgs(Params_OnEnable args);
public delegate void OnEnable_WithArgs (Action<InControl.InControlManager> orig, InControl.InControlManager self);
...
public delegate void OnDisable_WithArgs (Action<InControl.InControlManager> orig, InControl.InControlManager self);
...
public delegate void Update_WithArgs (Action<InControl.InControlManager> orig, InControl.InControlManager self);
...
public delegate void FixedUpdate_WithArgs (Action<InControl.InControlManager> orig, InControl.InControlManager self);
...
public delegate void OnApplicationFocus_WithArgs (Action<InControl.InControlManager,  bool> orig, InControl.InControlManager self,  bool focusState);
...
public delegate void OnApplicationPause_WithArgs (Action<InControl.InControlManager,  bool> orig, InControl.InControlManager self,  bool pauseState);
...
public delegate void OnApplicationQuit_WithArgs (Action<InControl.InControlManager> orig, InControl.InControlManager self);
...
public delegate void OnSceneWasLoaded_WithArgs (Action<InControl.InControlManager,  UnityEngine.SceneManagement.Scene,  UnityEngine.SceneManagement.LoadSceneMode> orig, InControl.InControlManager self,  UnityEngine.SceneManagement.Scene scene,  UnityEngine.SceneManagement.LoadSceneMode loadSceneMode);
public sealed class Params_LogMessage
{
public InControl.LogMessage logMessage;
}
...
public delegate void LogMessage_WithArgs (Action< InControl.LogMessage> orig,  InControl.LogMessage logMessage);
}
...
{
add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnEnable", true), value);
remove => HookEndpointManager.Remove<Delegates.OnEnable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnEnable", true), value);
}
public static event Delegates.OnDisable_WithArgs OnDisable
{
add => HookEndpointManager.Add<Delegates.OnDisable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnDisable", true), value);
remove => HookEndpointManager.Remove<Delegates.OnDisable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnDisable", true), value);
}
public static event Delegates.Update_WithArgs Update
{
add => HookEndpointManager.Add<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "Update", true), value);
remove => HookEndpointManager.Remove<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "Update", true), value);
}
public static event Delegates.FixedUpdate_WithArgs FixedUpdate
{
add => HookEndpointManager.Add<Delegates.FixedUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "FixedUpdate", true), value);
remove => HookEndpointManager.Remove<Delegates.FixedUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "FixedUpdate", true), value);
}
public static event Delegates.OnApplicationFocus_WithArgs OnApplicationFocus
{
add => HookEndpointManager.Add<Delegates.OnApplicationFocus_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationFocus", true), value);
remove => HookEndpointManager.Remove<Delegates.OnApplicationFocus_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationFocus", true), value);
}
public static event Delegates.OnApplicationPause_WithArgs OnApplicationPause
{
add => HookEndpointManager.Add<Delegates.OnApplicationPause_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationPause", true), value);
remove => HookEndpointManager.Remove<Delegates.OnApplicationPause_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationPause", true), value);
}
public static event Delegates.OnApplicationQuit_WithArgs OnApplicationQuit
{
add => HookEndpointManager.Add<Delegates.OnApplicationQuit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationQuit", true), value);
remove => HookEndpointManager.Remove<Delegates.OnApplicationQuit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationQuit", true), value);
}
public static event Delegates.OnSceneWasLoaded_WithArgs OnSceneWasLoaded
{
add => HookEndpointManager.Add<Delegates.OnSceneWasLoaded_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnSceneWasLoaded", true), value);
remove => HookEndpointManager.Remove<Delegates.OnSceneWasLoaded_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnSceneWasLoaded", true), value);
}
public static event Delegates.LogMessage_WithArgs LogMessage
{
add => HookEndpointManager.Add<Delegates.LogMessage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "LogMessage", false), value);
remove => HookEndpointManager.Remove<Delegates.LogMessage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "LogMessage", false), value);
}
}
