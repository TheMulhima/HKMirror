...
public static class OnInControlManager
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnEnable()
        {
            if (!HookedList.Contains("OnEnable"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnEnable", true),
                    OnEnable);
            }
        }
        ...
        internal static void HookOnDisable()
        {
            if (!HookedList.Contains("OnDisable"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnDisable", true),
                    OnDisable);
            }
        }
        ...
        internal static void HookFixedUpdate()
        {
            if (!HookedList.Contains("FixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "FixedUpdate", true),
                    FixedUpdate);
            }
        }
        ...
        internal static void HookOnApplicationFocus()
        {
            if (!HookedList.Contains("OnApplicationFocus"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationFocus", true),
                    OnApplicationFocus);
            }
        }
        ...
        private static void OnApplicationFocus(Action<InControl.InControlManager, bool> orig,
            InControl.InControlManager self, bool focusState)
        {
        ...
        internal static void HookOnApplicationPause()
        {
            if (!HookedList.Contains("OnApplicationPause"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationPause", true),
                    OnApplicationPause);
            }
        }
        ...
        private static void OnApplicationPause(Action<InControl.InControlManager, bool> orig,
            InControl.InControlManager self, bool pauseState)
        {
        ...
        internal static void HookOnApplicationQuit()
        {
            if (!HookedList.Contains("OnApplicationQuit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationQuit", true),
                    OnApplicationQuit);
            }
        }
        ...
        internal static void HookOnSceneWasLoaded()
        {
            if (!HookedList.Contains("OnSceneWasLoaded"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnSceneWasLoaded", true),
                    OnSceneWasLoaded);
            }
        }
        ...
        private static void OnSceneWasLoaded(
            Action<InControl.InControlManager, UnityEngine.SceneManagement.Scene,
                UnityEngine.SceneManagement.LoadSceneMode> orig, InControl.InControlManager self,
            UnityEngine.SceneManagement.Scene scene, UnityEngine.SceneManagement.LoadSceneMode loadSceneMode)
        {
        ...
        internal static void HookLogMessage()
        {
            if (!HookedList.Contains("LogMessage"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "LogMessage", false),
                    LogMessage);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnable_WithArgs(Action<InControl.InControlManager> orig,
            InControl.InControlManager self);
        ...
        public delegate void OnDisable_WithArgs(Action<InControl.InControlManager> orig,
            InControl.InControlManager self);
        ...
        public delegate void FixedUpdate_WithArgs(Action<InControl.InControlManager> orig,
            InControl.InControlManager self);
        ...
        public delegate void OnApplicationFocus_WithArgs(Action<InControl.InControlManager, bool> orig,
            InControl.InControlManager self, bool focusState);
        ...
        public delegate void OnApplicationPause_WithArgs(Action<InControl.InControlManager, bool> orig,
            InControl.InControlManager self, bool pauseState);
        ...
        public delegate void OnApplicationQuit_WithArgs(Action<InControl.InControlManager> orig,
            InControl.InControlManager self);
        ...
        public delegate void OnSceneWasLoaded_WithArgs(
            Action<InControl.InControlManager, UnityEngine.SceneManagement.Scene,
                UnityEngine.SceneManagement.LoadSceneMode> orig, InControl.InControlManager self,
            UnityEngine.SceneManagement.Scene scene, UnityEngine.SceneManagement.LoadSceneMode loadSceneMode);
    ...
    public static class WithOrig
    {
        public static event Delegates.OnEnable_WithArgs OnEnable
        {
            add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnEnable", true), value);
        ...
        public static event Delegates.OnDisable_WithArgs OnDisable
        {
            add => HookEndpointManager.Add<Delegates.OnDisable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnDisable", true), value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "Update", true), value);
        ...
        public static event Delegates.FixedUpdate_WithArgs FixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.FixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "FixedUpdate", true), value);
        ...
        public static event Delegates.OnApplicationFocus_WithArgs OnApplicationFocus
        {
            add => HookEndpointManager.Add<Delegates.OnApplicationFocus_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationFocus", true), value);
        ...
        public static event Delegates.OnApplicationPause_WithArgs OnApplicationPause
        {
            add => HookEndpointManager.Add<Delegates.OnApplicationPause_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationPause", true), value);
        ...
        public static event Delegates.OnApplicationQuit_WithArgs OnApplicationQuit
        {
            add => HookEndpointManager.Add<Delegates.OnApplicationQuit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnApplicationQuit", true), value);
        ...
        public static event Delegates.OnSceneWasLoaded_WithArgs OnSceneWasLoaded
        {
            add => HookEndpointManager.Add<Delegates.OnSceneWasLoaded_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "OnSceneWasLoaded", true), value);
        ...
        public static event Delegates.LogMessage_WithArgs LogMessage
        {
            add => HookEndpointManager.Add<Delegates.LogMessage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InControlManager), "LogMessage", false), value);
