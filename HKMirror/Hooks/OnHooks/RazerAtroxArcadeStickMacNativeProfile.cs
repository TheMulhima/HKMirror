...
public static class OnRazerAtroxArcadeStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RazerAtroxArcadeStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RazerAtroxArcadeStickMacNativeProfile> orig,
            RazerAtroxArcadeStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerAtroxArcadeStickMacNativeProfile> orig,
            RazerAtroxArcadeStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public RazerAtroxArcadeStickMacNativeProfile self;
        }
    }
