...
public static class OnXboxOneUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneUnityProfile> orig, XboxOneUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneUnityProfile> orig, XboxOneUnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(XboxOneUnityProfile), "Define"), value);
