...
/// <summary>
/// Contains different types of On Hooks for XboxOneUnityProfile class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnXboxOneUnityProfile
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XboxOneUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.XboxOneUnityProfile> orig, InControl.UnityDeviceProfiles.XboxOneUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.XboxOneUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.XboxOneUnityProfile> orig, InControl.UnityDeviceProfiles.XboxOneUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XboxOneUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XboxOneUnityProfile), "Define", true), value);
}
}
