...
public static class OnEightBitdoNES30ProMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoNES30ProMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoNES30ProMacUnityProfile> orig,
            EightBitdoNES30ProMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoNES30ProMacUnityProfile> orig,
            EightBitdoNES30ProMacUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoNES30ProMacUnityProfile self;
        }
    }
