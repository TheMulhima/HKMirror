...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoNES30ProMacUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.EightBitdoNES30ProMacUnityProfile> orig, InControl.UnityDeviceProfiles.EightBitdoNES30ProMacUnityProfile self)
{
...
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.EightBitdoNES30ProMacUnityProfile> orig, InControl.UnityDeviceProfiles.EightBitdoNES30ProMacUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoNES30ProMacUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoNES30ProMacUnityProfile), "Define", true), value);
}
}
