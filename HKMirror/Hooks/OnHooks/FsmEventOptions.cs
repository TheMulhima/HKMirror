...
public static class OnFsmEventOptions
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FsmEventOptions), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<FsmEventOptions> orig, FsmEventOptions self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FsmEventOptions), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<FsmEventOptions> orig, FsmEventOptions self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnUpdate_WithArgs(Action<FsmEventOptions> orig, FsmEventOptions self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<FsmEventOptions> orig, FsmEventOptions self);

        public sealed class Params_Reset
        {
            public FsmEventOptions self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FsmEventOptions), "Reset"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FsmEventOptions), "OnUpdate"), value);
