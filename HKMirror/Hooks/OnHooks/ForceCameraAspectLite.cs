...
public static class OnForceCameraAspectLite
{
    internal static class HookHandler
    {
        ...
        private static void AutoScaleViewport(On.ForceCameraAspectLite.orig_AutoScaleViewport orig,
            ForceCameraAspectLite self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterAutoScaleViewport != null) _afterAutoScaleViewport.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void AutoScaleViewport_NormalArgs(Params_AutoScaleViewport args);
