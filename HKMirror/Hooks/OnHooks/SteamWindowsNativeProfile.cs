...
public static class OnSteamWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SteamWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<SteamWindowsNativeProfile> orig, SteamWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SteamWindowsNativeProfile> orig, SteamWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public SteamWindowsNativeProfile self;
        }
    }
