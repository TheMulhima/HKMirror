...
private static void OnAnimatorIK(On.PlayMakerAnimatorIKProxy.orig_OnAnimatorIK orig,PlayMakerAnimatorIKProxy self,  int layerIndex)
{
...
public delegate void OnAnimatorIK_WithArgs (Action<PlayMakerAnimatorIKProxy,  int> orig, PlayMakerAnimatorIKProxy self,  int layerIndex);
}
