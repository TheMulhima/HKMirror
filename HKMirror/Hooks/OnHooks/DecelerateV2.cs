...
public static class OnDecelerateV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<DecelerateV2> orig, DecelerateV2 self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<DecelerateV2> orig, DecelerateV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<DecelerateV2> orig, DecelerateV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<DecelerateV2> orig, DecelerateV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<DecelerateV2> orig, DecelerateV2 self)
        {
        ...
        internal static void HookDecelerateSelf()
        {
            if (!HookedList.Contains("DecelerateSelf"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "DecelerateSelf"), DecelerateSelf);
            }
        }
        ...
        private static void DecelerateSelf(Action<DecelerateV2> orig, DecelerateV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<DecelerateV2> orig, DecelerateV2 self);
        ...
        public delegate void DecelerateSelf_WithArgs(Action<DecelerateV2> orig, DecelerateV2 self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<DecelerateV2> orig, DecelerateV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<DecelerateV2> orig, DecelerateV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<DecelerateV2> orig, DecelerateV2 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<DecelerateV2> orig, DecelerateV2 self);

        public sealed class Params_Reset
        {
            public DecelerateV2 self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "Awake"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DecelerateSelf_WithArgs DecelerateSelf
        {
            add => HookEndpointManager.Add<Delegates.DecelerateSelf_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DecelerateV2), "DecelerateSelf"), value);
