...
public static class OnAtPlayControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AtPlayControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AtPlayControllerMacNativeProfile> orig, AtPlayControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AtPlayControllerMacNativeProfile> orig,
            AtPlayControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public AtPlayControllerMacNativeProfile self;
        }
    }
