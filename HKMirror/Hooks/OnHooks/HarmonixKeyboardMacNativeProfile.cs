...
public static class OnHarmonixKeyboardMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HarmonixKeyboardMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HarmonixKeyboardMacNativeProfile> orig, HarmonixKeyboardMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HarmonixKeyboardMacNativeProfile> orig,
            HarmonixKeyboardMacNativeProfile self);

        public sealed class Params_Define
        {
            public HarmonixKeyboardMacNativeProfile self;
        }
    }
