...
private static System.Collections.IEnumerator Turn(On.Climber.orig_Turn orig,Climber self,  bool turnClockwise,  bool tweenPos)
{
...
private static UnityEngine.RaycastHit2D FireRayLocal(On.Climber.orig_FireRayLocal orig,Climber self,  UnityEngine.Vector2 direction,  float length)
{
...
public delegate System.Collections.IEnumerator Walk_WithArgs (Func<Climber, System.Collections.IEnumerator> orig, Climber self);
...
public delegate System.Collections.IEnumerator Turn_WithArgs (Func<Climber,  bool,  bool, System.Collections.IEnumerator> orig, Climber self,  bool turnClockwise,  bool tweenPos);
...
public delegate System.Collections.IEnumerator DoStun_AfterArgs(Params_DoStun args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DoStun_WithArgs (Func<Climber, System.Collections.IEnumerator> orig, Climber self);
...
public delegate UnityEngine.RaycastHit2D FireRayLocal_AfterArgs(Params_FireRayLocal args, UnityEngine.RaycastHit2D ret);
public delegate UnityEngine.RaycastHit2D FireRayLocal_WithArgs (Func<Climber,  UnityEngine.Vector2,  float, UnityEngine.RaycastHit2D> orig, Climber self,  UnityEngine.Vector2 direction,  float length);
