...
public static class Ontk2dCamera
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_CameraSettings()
        {
            if (!HookedList.Contains("get_CameraSettings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCamera), "get_CameraSettings"),
                    get_CameraSettings);
            }
        }
        ...
        internal static void Hookget_InheritConfig()
        {
            if (!HookedList.Contains("get_InheritConfig"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCamera), "get_InheritConfig"),
                    get_InheritConfig);
            }
        }
        ...
        internal static void Hookset_InheritConfig()
        {
            if (!HookedList.Contains("set_InheritConfig"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCamera), "set_InheritConfig"),
                    set_InheritConfig);
            }
        }
        ...
        internal static void Hookget_ScreenExtents()
        {
            if (!HookedList.Contains("get_ScreenExtents"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCamera), "get_ScreenExtents"),
                    get_ScreenExtents);
            }
        }
        ...
        private static Rect get_NativeScreenExtents(Func<tk2dCamera, Rect> orig,
            tk2dCamera self)
        {
        ...
        private static Vector2 get_TargetResolution(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self)
        {
        ...
        private static Vector2 get_NativeResolution(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self)
        {
        ...
        internal static void Hookget_ScreenOffset()
        {
            if (!HookedList.Contains("get_ScreenOffset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCamera), "get_ScreenOffset"),
                    get_ScreenOffset);
            }
        }
        ...
        private static Vector2 get_ScreenResolution(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self)
        {
        ...
        private static Vector2 get_ScaledResolution(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self)
        {
        ...
        internal static void Hookget_ScreenCamera()
        {
            if (!HookedList.Contains("get_ScreenCamera"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCamera), "get_ScreenCamera"),
                    get_ScreenCamera);
            }
        }
        ...
        internal static void Hookget_SettingsRoot()
        {
            if (!HookedList.Contains("get_SettingsRoot"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCamera), "get_SettingsRoot"),
                    get_SettingsRoot);
            }
        }
        ...
        private static Matrix4x4 OrthoOffCenter(On.tk2dCamera.orig_OrthoOffCenter orig, tk2dCamera self,
            Vector2 scale, float left, float right, float bottom, float top, float near, float far)
        {
        ...
        private static Vector2 GetScaleForOverride(On.tk2dCamera.orig_GetScaleForOverride orig,
        ...
        private static Vector2 GetOffsetForOverride(On.tk2dCamera.orig_GetOffsetForOverride orig,
        ...
        private static Matrix4x4 GetProjectionMatrixForOverride(
            ...
            out Rect screenExtents, out Rect unscaledScreenExtents)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate Vector2 get_NativeResolution_AfterArgs(Params_get_NativeResolution args,
            Vector2 ret);

        public delegate void get_NativeResolution_BeforeArgs(Params_get_NativeResolution args);

        public delegate Vector2 get_NativeResolution_WithArgs(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self);

        public delegate Rect get_NativeScreenExtents_AfterArgs(Params_get_NativeScreenExtents args,
            Rect ret);

        public delegate void get_NativeScreenExtents_BeforeArgs(Params_get_NativeScreenExtents args);

        public delegate Rect get_NativeScreenExtents_WithArgs(Func<tk2dCamera, Rect> orig,
            tk2dCamera self);

        public delegate Vector2 get_resolution_AfterArgs(Params_get_resolution args,
            Vector2 ret);

        public delegate void get_resolution_BeforeArgs(Params_get_resolution args);

        public delegate Vector2 get_resolution_WithArgs(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self);

        public delegate Vector2 get_ScaledResolution_AfterArgs(Params_get_ScaledResolution args,
            Vector2 ret);

        public delegate void get_ScaledResolution_BeforeArgs(Params_get_ScaledResolution args);

        public delegate Vector2 get_ScaledResolution_WithArgs(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self);

        public delegate Camera get_ScreenCamera_AfterArgs(Params_get_ScreenCamera args,
            Camera ret);

        public delegate void get_ScreenCamera_BeforeArgs(Params_get_ScreenCamera args);

        public delegate Camera get_ScreenCamera_WithArgs(Func<tk2dCamera, Camera> orig,
            tk2dCamera self);

        public delegate Rect get_ScreenExtents_AfterArgs(Params_get_ScreenExtents args,
            Rect ret);

        public delegate void get_ScreenExtents_BeforeArgs(Params_get_ScreenExtents args);

        public delegate Rect get_ScreenExtents_WithArgs(Func<tk2dCamera, Rect> orig,
            tk2dCamera self);

        public delegate Vector2 get_ScreenOffset_AfterArgs(Params_get_ScreenOffset args,
            Vector2 ret);

        public delegate void get_ScreenOffset_BeforeArgs(Params_get_ScreenOffset args);

        public delegate Vector2 get_ScreenOffset_WithArgs(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self);

        public delegate Vector2 get_ScreenResolution_AfterArgs(Params_get_ScreenResolution args,
            Vector2 ret);

        public delegate void get_ScreenResolution_BeforeArgs(Params_get_ScreenResolution args);

        public delegate Vector2 get_ScreenResolution_WithArgs(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self);
        ...
        public delegate Vector2 get_TargetResolution_AfterArgs(Params_get_TargetResolution args,
            Vector2 ret);

        public delegate void get_TargetResolution_BeforeArgs(Params_get_TargetResolution args);

        public delegate Vector2 get_TargetResolution_WithArgs(Func<tk2dCamera, Vector2> orig,
            tk2dCamera self);

        public delegate Camera get_UnityCamera_AfterArgs(Params_get_UnityCamera args,
            Camera ret);

        public delegate void get_UnityCamera_BeforeArgs(Params_get_UnityCamera args);

        public delegate Camera get_UnityCamera_WithArgs(Func<tk2dCamera, Camera> orig,
            tk2dCamera self);
        ...
        public delegate Vector2 GetOffsetForOverride_AfterArgs(Params_GetOffsetForOverride args,
            Vector2 ret);

        public delegate void GetOffsetForOverride_BeforeArgs(Params_GetOffsetForOverride args);

        public delegate Vector2 GetOffsetForOverride_WithArgs(
            Func<tk2dCamera, tk2dCamera, tk2dCameraResolutionOverride, Vector2, float, float,
                Vector2> orig, tk2dCamera self, tk2dCamera settings,
            tk2dCameraResolutionOverride currentOverride, Vector2 scale, float width, float height);

        public delegate Matrix4x4 GetProjectionMatrixForOverride_AfterArgs(
            Params_GetProjectionMatrixForOverride args, Matrix4x4 ret);

        public delegate void GetProjectionMatrixForOverride_BeforeArgs(Params_GetProjectionMatrixForOverride args);

        public delegate Matrix4x4 GetProjectionMatrixForOverride_WithArgs(
            Func<tk2dCamera, tk2dCamera, tk2dCameraResolutionOverride, float, float, bool, Rect,
                Rect, Matrix4x4> orig, tk2dCamera self, tk2dCamera settings,
            tk2dCameraResolutionOverride currentOverride, float pixelWidth, float pixelHeight, bool halfTexelOffset,
            out Rect screenExtents, out Rect unscaledScreenExtents);

        public delegate Vector2 GetScaleForOverride_AfterArgs(Params_GetScaleForOverride args,
            Vector2 ret);

        public delegate void GetScaleForOverride_BeforeArgs(Params_GetScaleForOverride args);

        public delegate Vector2 GetScaleForOverride_WithArgs(
            Func<tk2dCamera, tk2dCamera, tk2dCameraResolutionOverride, float, float, Vector2> orig,
            tk2dCamera self, tk2dCamera settings, tk2dCameraResolutionOverride currentOverride, float width,
            float height);

        public delegate Vector2 GetScreenPixelDimensions_AfterArgs(Params_GetScreenPixelDimensions args,
            Vector2 ret);

        public delegate void GetScreenPixelDimensions_BeforeArgs(Params_GetScreenPixelDimensions args);

        public delegate Vector2 GetScreenPixelDimensions_WithArgs(
            Func<tk2dCamera, tk2dCamera, Vector2> orig, tk2dCamera self, tk2dCamera settings);
        ...
        public delegate Matrix4x4 OrthoOffCenter_AfterArgs(Params_OrthoOffCenter args,
            Matrix4x4 ret);

        public delegate void OrthoOffCenter_BeforeArgs(Params_OrthoOffCenter args);

        public delegate Matrix4x4 OrthoOffCenter_WithArgs(
            Func<tk2dCamera, Vector2, float, float, float, float, float, float, Matrix4x4> orig,
            tk2dCamera self, Vector2 scale, float left, float right, float bottom, float top, float near,
            float far);
