...
public static class OnFindGameObject
{
    internal static class HookHandler
    {
        ...
        private static void Find(Action<FindGameObject> orig, FindGameObject self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterFind != null) _afterFind.Invoke(@params);
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Find_NormalArgs(Params_Find args);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.Find_NormalArgs Find
        {
            add => HookEndpointManager.Add<Delegates.Find_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FindGameObject), "Find"), value);
            remove => HookEndpointManager.Remove<Delegates.Find_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FindGameObject), "Find"), value);
        }
