...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckBossSceneUnlocked), "get_IsTrue", true), get_IsTrue);
...
public delegate void Reset_WithArgs (Action<GGCheckBossSceneUnlocked> orig, GGCheckBossSceneUnlocked self);
...
public delegate bool get_IsTrue_WithArgs (Func<GGCheckBossSceneUnlocked, bool> orig, GGCheckBossSceneUnlocked self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBossSceneUnlocked), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBossSceneUnlocked), "get_IsTrue", true), value);
}
}
