...
public static class OnGGCheckBossSceneUnlocked
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_IsTrue()
        {
            if (!HookedList.Contains("get_IsTrue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckBossSceneUnlocked), "get_IsTrue", true),
                    get_IsTrue);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_IsTrue_WithArgs(Func<GGCheckBossSceneUnlocked, bool> orig,
            GGCheckBossSceneUnlocked self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.get_IsTrue_WithArgs get_IsTrue
        {
            add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GGCheckBossSceneUnlocked), "get_IsTrue", true), value);
