...
private static System.Collections.IEnumerator Fade_Color_float_float(On.ColorFader.orig_Fade_Color_float_float orig,ColorFader self,  UnityEngine.Color to,  float time,  float delay)
{
...
{
foreach (Delegates.Fade_Color_float_float_BeforeArgs toInvoke in _beforeFade_Color_float_float.GetInvocationList())
{
try
{
...
public delegate System.Collections.IEnumerator Fade_Color_float_float_AfterArgs(Params_Fade_Color_float_float args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Fade_Color_float_float_WithArgs (Func<ColorFader,  UnityEngine.Color,  float,  float, System.Collections.IEnumerator> orig, ColorFader self,  UnityEngine.Color to,  float time,  float delay);
}
