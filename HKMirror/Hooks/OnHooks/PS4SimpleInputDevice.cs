...
public static class OnPS4SimpleInputDevice
{
    internal static class HookHandler
    {
        ...
        internal static void HookUpdate()
        {
            if (!HookedList.Contains("Update"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "Update", true),
                    Update);
            }
        }
        ...
        private static void Update(Action<InControl.PS4SimpleInputDevice, ulong, float> orig,
            InControl.PS4SimpleInputDevice self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookGetNativeVibrationValue()
        {
            if (!HookedList.Contains("GetNativeVibrationValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "GetNativeVibrationValue",
                        false), GetNativeVibrationValue);
            }
        }
        ...
        private static int GetNativeVibrationValue(Func<float, int> orig, float strength)
        {
            ...
            {
                foreach (Delegates.GetNativeVibrationValue_BeforeArgs toInvoke in _beforeGetNativeVibrationValue
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetNativeVibrationValue_AfterArgs toInvoke in _afterGetNativeVibrationValue
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_IsConnected()
        {
            if (!HookedList.Contains("get_IsConnected"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "get_IsConnected", true),
                    get_IsConnected);
            }
        }
        ...
        private static bool get_IsConnected(Func<InControl.PS4SimpleInputDevice, bool> orig,
            InControl.PS4SimpleInputDevice self)
        {
        ...
        internal static void HookGetVibrationMixer()
        {
            if (!HookedList.Contains("GetVibrationMixer"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "GetVibrationMixer", true),
                    GetVibrationMixer);
            }
        }
        ...
        private static VibrationMixer GetVibrationMixer(Func<InControl.PS4SimpleInputDevice, VibrationMixer> orig,
            InControl.PS4SimpleInputDevice self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Update_WithArgs(Action<InControl.PS4SimpleInputDevice, ulong, float> orig,
            InControl.PS4SimpleInputDevice self, ulong updateTick, float deltaTime);
        ...
        public delegate bool get_IsConnected_WithArgs(Func<InControl.PS4SimpleInputDevice, bool> orig,
            InControl.PS4SimpleInputDevice self);
        ...
        public delegate VibrationMixer GetVibrationMixer_WithArgs(
            Func<InControl.PS4SimpleInputDevice, VibrationMixer> orig, InControl.PS4SimpleInputDevice self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "Update", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetNativeVibrationValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "GetNativeVibrationValue",
                    false), value);
            remove => HookEndpointManager.Remove<Delegates.GetNativeVibrationValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "GetNativeVibrationValue",
                    false), value);
        }
        ...
        public static event Delegates.get_IsConnected_WithArgs get_IsConnected
        {
            add => HookEndpointManager.Add<Delegates.get_IsConnected_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice), "get_IsConnected", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetVibrationMixer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice),
                    "VibrationManager.IVibrationMixerProvider.GetVibrationMixer", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetVibrationMixer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDevice),
                    "VibrationManager.IVibrationMixerProvider.GetVibrationMixer", true), value);
        }
    }
