...
public static class OnQuaternionSlerp
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp),
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self)
        {
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self)
        {
        ...
        internal static void HookDoQuatSlerp()
        {
            if (!HookedList.Contains("DoQuatSlerp"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "DoQuatSlerp",
                        true), DoQuatSlerp);
            }
        }
        ...
        private static void DoQuatSlerp(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self);
        ...
        public delegate void DoQuatSlerp_WithArgs(Action<HutongGames.PlayMaker.Actions.QuaternionSlerp> orig,
            HutongGames.PlayMaker.Actions.QuaternionSlerp self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "OnUpdate", true),
                value);
        ...
        public static event Delegates.OnLateUpdate_WithArgs OnLateUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnLateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "OnLateUpdate",
                    true), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "OnFixedUpdate",
                    true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoQuatSlerp_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "DoQuatSlerp",
                    true), value);
            remove => HookEndpointManager.Remove<Delegates.DoQuatSlerp_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.QuaternionSlerp), "DoQuatSlerp",
                    true), value);
        }
    }
