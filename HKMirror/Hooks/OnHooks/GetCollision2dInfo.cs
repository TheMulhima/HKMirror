...
public static class OnGetCollision2dInfo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetCollision2dInfo), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GetCollision2dInfo> orig, GetCollision2dInfo self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetCollision2dInfo), "StoreCollisionInfo"),
                    StoreCollisionInfo);
            }
        }
        ...
        private static void StoreCollisionInfo(Action<GetCollision2dInfo> orig, GetCollision2dInfo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetCollision2dInfo), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<GetCollision2dInfo> orig, GetCollision2dInfo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<GetCollision2dInfo> orig, GetCollision2dInfo self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GetCollision2dInfo> orig, GetCollision2dInfo self);
        ...
        public delegate void StoreCollisionInfo_WithArgs(Action<GetCollision2dInfo> orig, GetCollision2dInfo self);

        public sealed class Params_Reset
        {
            public GetCollision2dInfo self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetCollision2dInfo), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetCollision2dInfo), "OnEnter"), value);
