...
public static class OnGetCollision2dInfo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollision2dInfo), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetCollision2dInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollision2dInfo self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollision2dInfo),
        ...
        private static void StoreCollisionInfo(Action<HutongGames.PlayMaker.Actions.GetCollision2dInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollision2dInfo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollision2dInfo), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetCollision2dInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollision2dInfo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetCollision2dInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollision2dInfo self);
        ...
        public delegate void StoreCollisionInfo_WithArgs(Action<HutongGames.PlayMaker.Actions.GetCollision2dInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollision2dInfo self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetCollision2dInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollision2dInfo self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollision2dInfo), "Reset", true),
                value);
