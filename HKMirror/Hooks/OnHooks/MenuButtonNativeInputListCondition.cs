...
/// <summary>
/// Contains different types of On Hooks for MenuButtonNativeInputListCondition class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnMenuButtonNativeInputListCondition
{
...
On.MenuButtonNativeInputListCondition.IsFulfilled += IsFulfilled;
...
private static bool IsFulfilled(On.MenuButtonNativeInputListCondition.orig_IsFulfilled orig,MenuButtonNativeInputListCondition self)
{
...
{
public MenuButtonNativeInputListCondition self;
}
...
public delegate bool IsFulfilled_WithArgs (Func<MenuButtonNativeInputListCondition, bool> orig, MenuButtonNativeInputListCondition self);
}
...
{
public static event On.MenuButtonNativeInputListCondition.hook_IsFulfilled IsFulfilled
{
add => On.MenuButtonNativeInputListCondition.IsFulfilled += value;
remove => On.MenuButtonNativeInputListCondition.IsFulfilled -= value;
}
}
