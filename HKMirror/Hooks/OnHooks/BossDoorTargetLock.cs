...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock), "get_IsUnlocked", true), get_IsUnlocked);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock), "set_IsUnlocked", true), set_IsUnlocked);
...
private static System.Collections.IEnumerator UnlockSequence(On.BossDoorTargetLock.orig_UnlockSequence orig,BossDoorTargetLock self)
{
...
public delegate void set_IsUnlocked_WithArgs (Action<BossDoorTargetLock,  bool> orig, BossDoorTargetLock self,  bool value);
...
public delegate System.Collections.IEnumerator UnlockSequence_AfterArgs(Params_UnlockSequence args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator UnlockSequence_WithArgs (Func<BossDoorTargetLock, System.Collections.IEnumerator> orig, BossDoorTargetLock self);
...
{
add => HookEndpointManager.Add<Delegates.get_IsUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock), "get_IsUnlocked", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock), "get_IsUnlocked", true), value);
}
public static event Delegates.set_IsUnlocked_WithArgs set_IsUnlocked
{
add => HookEndpointManager.Add<Delegates.set_IsUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock), "set_IsUnlocked", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock), "set_IsUnlocked", true), value);
}
