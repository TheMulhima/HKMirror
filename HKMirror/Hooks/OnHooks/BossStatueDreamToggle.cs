...
public static class OnBossStatueDreamToggle
{
    ...
    {
        public delegate IEnumerator Fade_AfterArgs(Params_Fade args, IEnumerator ret);

        public delegate void Fade_BeforeArgs(Params_Fade args);

        public delegate IEnumerator Fade_WithArgs(Func<BossStatueDreamToggle, bool, IEnumerator> orig,
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<BossStatueDreamToggle, Collider2D> orig,
            BossStatueDreamToggle self, Collider2D collision);
