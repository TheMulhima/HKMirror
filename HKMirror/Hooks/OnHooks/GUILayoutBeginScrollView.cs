...
public static class OnGUILayoutBeginScrollView
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutBeginScrollView), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GUILayoutBeginScrollView> orig, GUILayoutBeginScrollView self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutBeginScrollView), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUILayoutBeginScrollView> orig, GUILayoutBeginScrollView self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUILayoutBeginScrollView> orig, GUILayoutBeginScrollView self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GUILayoutBeginScrollView> orig, GUILayoutBeginScrollView self);

        public sealed class Params_Reset
        {
            public GUILayoutBeginScrollView self;
        }
