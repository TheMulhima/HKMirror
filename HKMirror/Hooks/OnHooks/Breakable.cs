...
public static class OnBreakable
{
    ...
    public static class Delegates
    {
        ...
        public delegate void CreateAdditionalDebrisParts_WithArgs(Action<Breakable, List<GameObject>> orig,
            Breakable self, List<GameObject> debrisParts);
        ...
        public delegate Transform SpawnNailHitEffect_AfterArgs(Params_SpawnNailHitEffect args, Transform ret);

        public delegate void SpawnNailHitEffect_BeforeArgs(Params_SpawnNailHitEffect args);

        public delegate Transform SpawnNailHitEffect_WithArgs(Func<Transform, Vector3, float, Transform> orig,
            Transform nailHitEffectPrefab, Vector3 position, float impactAngle);
