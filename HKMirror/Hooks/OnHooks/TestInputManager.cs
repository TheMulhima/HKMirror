...
public static class OnTestInputManager
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnEnable()
        {
            if (!HookedList.Contains("OnEnable"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "OnEnable", true),
                    OnEnable);
            }
        }
        ...
        internal static void HookHandleInputUpdate()
        {
            if (!HookedList.Contains("HandleInputUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "HandleInputUpdate", true),
                    HandleInputUpdate);
            }
        }
        ...
        private static void HandleInputUpdate(Action<InControl.TestInputManager, ulong, float> orig,
            InControl.TestInputManager self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookCheckForPauseButton()
        {
            if (!HookedList.Contains("CheckForPauseButton"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "CheckForPauseButton", true),
                    CheckForPauseButton);
            }
        }
        ...
        private static void CheckForPauseButton(Action<InControl.TestInputManager> orig,
            InControl.TestInputManager self)
        {
        ...
        internal static void HookSetColor()
        {
            if (!HookedList.Contains("SetColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "SetColor", true),
                    SetColor);
            }
        }
        ...
        private static void SetColor(Action<InControl.TestInputManager, UnityEngine.Color> orig,
            InControl.TestInputManager self, UnityEngine.Color color)
        {
        ...
        internal static void HookDrawUnityInputDebugger()
        {
            if (!HookedList.Contains("DrawUnityInputDebugger"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "DrawUnityInputDebugger", true),
        ...
        private static void DrawUnityInputDebugger(Action<InControl.TestInputManager> orig,
            InControl.TestInputManager self)
        {
        ...
        internal static void HookOnDrawGizmos()
        {
            if (!HookedList.Contains("OnDrawGizmos"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "OnDrawGizmos", true),
                    OnDrawGizmos);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnable_WithArgs(Action<InControl.TestInputManager> orig,
            InControl.TestInputManager self);
        ...
        public delegate void HandleInputUpdate_WithArgs(Action<InControl.TestInputManager, ulong, float> orig,
            InControl.TestInputManager self, ulong updateTick, float deltaTime);
        ...
        public delegate void CheckForPauseButton_WithArgs(Action<InControl.TestInputManager> orig,
            InControl.TestInputManager self);
        ...
        public delegate void SetColor_WithArgs(Action<InControl.TestInputManager, UnityEngine.Color> orig,
            InControl.TestInputManager self, UnityEngine.Color color);
        ...
        public delegate void DrawUnityInputDebugger_WithArgs(Action<InControl.TestInputManager> orig,
            InControl.TestInputManager self);
        ...
        public delegate void OnDrawGizmos_WithArgs(Action<InControl.TestInputManager> orig,
            InControl.TestInputManager self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnEnable_WithArgs OnEnable
        {
            add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "OnEnable", true), value);
        ...
        public static event Delegates.HandleInputUpdate_WithArgs HandleInputUpdate
        {
            add => HookEndpointManager.Add<Delegates.HandleInputUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "HandleInputUpdate", true), value);
        ...
        public static event Delegates.Start_WithArgs Start
        {
            add => HookEndpointManager.Add<Delegates.Start_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "Start", true), value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "Update", true), value);
        ...
        public static event Delegates.CheckForPauseButton_WithArgs CheckForPauseButton
        {
            add => HookEndpointManager.Add<Delegates.CheckForPauseButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "CheckForPauseButton", true), value);
        ...
        public static event Delegates.SetColor_WithArgs SetColor
        {
            add => HookEndpointManager.Add<Delegates.SetColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "SetColor", true), value);
        ...
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "OnGUI", true), value);
        ...
        public static event Delegates.OnDrawGizmos_WithArgs OnDrawGizmos
        {
            add => HookEndpointManager.Add<Delegates.OnDrawGizmos_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TestInputManager), "OnDrawGizmos", true), value);
