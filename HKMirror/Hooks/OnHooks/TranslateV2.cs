...
public static class OnTranslateV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "OnLateUpdate",
                        true), OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
        ...
        internal static void HookDoTranslate()
        {
            if (!HookedList.Contains("DoTranslate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "DoTranslate",
                        true), DoTranslate);
            }
        }
        ...
        private static void DoTranslate(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
        ...
        public delegate void DoTranslate_WithArgs(Action<HutongGames.PlayMaker.Actions.TranslateV2> orig,
            HutongGames.PlayMaker.Actions.TranslateV2 self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "OnPreprocess", true),
                value);
        ...
        public static event Delegates.OnLateUpdate_WithArgs OnLateUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnLateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "OnLateUpdate", true),
                value);
        ...
        public static event Delegates.DoTranslate_WithArgs DoTranslate
        {
            add => HookEndpointManager.Add<Delegates.DoTranslate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.TranslateV2), "DoTranslate", true),
                value);
