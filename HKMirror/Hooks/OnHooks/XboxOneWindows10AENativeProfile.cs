...
public static class OnXboxOneWindows10AENativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.XboxOneWindows10AENativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.XboxOneWindows10AENativeProfile> orig,
            InControl.NativeDeviceProfiles.XboxOneWindows10AENativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.XboxOneWindows10AENativeProfile> orig,
            InControl.NativeDeviceProfiles.XboxOneWindows10AENativeProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.NativeDeviceProfiles.XboxOneWindows10AENativeProfile),
                    "Define", true), value);
