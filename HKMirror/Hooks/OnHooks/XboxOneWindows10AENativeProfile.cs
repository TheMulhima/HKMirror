...
public static class OnXboxOneWindows10AENativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneWindows10AENativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneWindows10AENativeProfile> orig, XboxOneWindows10AENativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneWindows10AENativeProfile> orig,
            XboxOneWindows10AENativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneWindows10AENativeProfile self;
        }
    }
