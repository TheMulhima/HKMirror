...
/// <summary>
/// Contains different types of On Hooks for MenuButtonQuitListCondition class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnMenuButtonQuitListCondition
{
...
On.MenuButtonQuitListCondition.IsFulfilled += IsFulfilled;
...
private static bool IsFulfilled(On.MenuButtonQuitListCondition.orig_IsFulfilled orig,MenuButtonQuitListCondition self)
{
...
{
public MenuButtonQuitListCondition self;
}
...
public delegate bool IsFulfilled_WithArgs (Func<MenuButtonQuitListCondition, bool> orig, MenuButtonQuitListCondition self);
}
...
{
public static event On.MenuButtonQuitListCondition.hook_IsFulfilled IsFulfilled
{
add => On.MenuButtonQuitListCondition.IsFulfilled += value;
remove => On.MenuButtonQuitListCondition.IsFulfilled -= value;
}
}
