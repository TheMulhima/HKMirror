...
public static class OnChaseObject
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObject), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObject), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObject), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObject), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObject), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self)
        {
        ...
        internal static void HookDoBuzz()
        {
            if (!HookedList.Contains("DoBuzz"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObject), "DoBuzz", true),
                    DoBuzz);
            }
        }
        ...
        private static void DoBuzz(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self);
        ...
        public delegate void DoBuzz_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObject> orig,
            HutongGames.PlayMaker.Actions.ChaseObject self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObject), "OnPreprocess", true),
                value);
