...
public static class OnGetCollisionInfo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollisionInfo), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetCollisionInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollisionInfo self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollisionInfo),
        ...
        private static void StoreCollisionInfo(Action<HutongGames.PlayMaker.Actions.GetCollisionInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollisionInfo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollisionInfo), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetCollisionInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollisionInfo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetCollisionInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollisionInfo self);
        ...
        public delegate void StoreCollisionInfo_WithArgs(Action<HutongGames.PlayMaker.Actions.GetCollisionInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollisionInfo self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetCollisionInfo> orig,
            HutongGames.PlayMaker.Actions.GetCollisionInfo self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollisionInfo), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetCollisionInfo), "OnEnter", true),
                value);
