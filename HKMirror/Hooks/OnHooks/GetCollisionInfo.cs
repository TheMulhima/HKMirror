...
public static class OnGetCollisionInfo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetCollisionInfo), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GetCollisionInfo> orig, GetCollisionInfo self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetCollisionInfo), "StoreCollisionInfo"),
                    StoreCollisionInfo);
            }
        }
        ...
        private static void StoreCollisionInfo(Action<GetCollisionInfo> orig, GetCollisionInfo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetCollisionInfo), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<GetCollisionInfo> orig, GetCollisionInfo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<GetCollisionInfo> orig, GetCollisionInfo self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GetCollisionInfo> orig, GetCollisionInfo self);
        ...
        public delegate void StoreCollisionInfo_WithArgs(Action<GetCollisionInfo> orig, GetCollisionInfo self);

        public sealed class Params_Reset
        {
            public GetCollisionInfo self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetCollisionInfo), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetCollisionInfo), "OnEnter"), value);
