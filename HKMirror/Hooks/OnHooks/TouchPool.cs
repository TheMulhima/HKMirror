...
public static class OnTouchPool
{
    internal static class HookHandler
    {
        ...
        internal static void HookFindOrCreateTouch()
        {
            if (!HookedList.Contains("FindOrCreateTouch"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FindOrCreateTouch", true),
                    FindOrCreateTouch);
            }
        }
        ...
        private static InControl.Touch FindOrCreateTouch(Func<InControl.TouchPool, int, InControl.Touch> orig,
            InControl.TouchPool self, int fingerId)
        {
            ...
            {
                foreach (Delegates.FindOrCreateTouch_BeforeArgs toInvoke in
                         _beforeFindOrCreateTouch.GetInvocationList())
                {
                    try
                    {
        ...
        private static InControl.Touch FindTouch(Func<InControl.TouchPool, int, InControl.Touch> orig,
            InControl.TouchPool self, int fingerId)
        {
        ...
        private static InControl.Touch NewTouch(Func<InControl.TouchPool, InControl.Touch> orig,
            InControl.TouchPool self)
        {
        ...
        private static void FreeTouch(Action<InControl.TouchPool, InControl.Touch> orig, InControl.TouchPool self,
            InControl.Touch touch)
        {
        ...
        internal static void HookFreeEndedTouches()
        {
            if (!HookedList.Contains("FreeEndedTouches"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FreeEndedTouches", true),
                    FreeEndedTouches);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate InControl.Touch FindOrCreateTouch_WithArgs(Func<InControl.TouchPool, int, InControl.Touch> orig,
            InControl.TouchPool self, int fingerId);
        ...
        public delegate InControl.Touch FindTouch_WithArgs(Func<InControl.TouchPool, int, InControl.Touch> orig,
            InControl.TouchPool self, int fingerId);
        ...
        public delegate InControl.Touch NewTouch_WithArgs(Func<InControl.TouchPool, InControl.Touch> orig,
            InControl.TouchPool self);
        ...
        public delegate void FreeTouch_WithArgs(Action<InControl.TouchPool, InControl.Touch> orig,
            InControl.TouchPool self, InControl.Touch touch);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.FindOrCreateTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FindOrCreateTouch", true), value);
            remove => HookEndpointManager.Remove<Delegates.FindOrCreateTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FindOrCreateTouch", true), value);
        }

        public static event Delegates.FindTouch_WithArgs FindTouch
        {
            add => HookEndpointManager.Add<Delegates.FindTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FindTouch", true), value);
            remove => HookEndpointManager.Remove<Delegates.FindTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FindTouch", true), value);
        }

        public static event Delegates.NewTouch_WithArgs NewTouch
        {
            add => HookEndpointManager.Add<Delegates.NewTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "NewTouch", true), value);
            remove => HookEndpointManager.Remove<Delegates.NewTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "NewTouch", true), value);
        }

        public static event Delegates.FreeTouch_WithArgs FreeTouch
        {
            add => HookEndpointManager.Add<Delegates.FreeTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FreeTouch", true), value);
            remove => HookEndpointManager.Remove<Delegates.FreeTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FreeTouch", true), value);
        }

        public static event Delegates.FreeEndedTouches_WithArgs FreeEndedTouches
        {
            add => HookEndpointManager.Add<Delegates.FreeEndedTouches_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FreeEndedTouches", true), value);
            remove => HookEndpointManager.Remove<Delegates.FreeEndedTouches_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchPool), "FreeEndedTouches", true), value);
        }
    }
}