...
public static class OnTouchPool
{
    ...
    {
        public delegate Touch FindOrCreateTouch_AfterArgs(Params_FindOrCreateTouch args, Touch ret);

        public delegate void FindOrCreateTouch_BeforeArgs(Params_FindOrCreateTouch args);

        public delegate Touch
            FindOrCreateTouch_WithArgs(Func<TouchPool, int, Touch> orig, TouchPool self, int fingerId);

        public delegate Touch FindTouch_AfterArgs(Params_FindTouch args, Touch ret);

        public delegate void FindTouch_BeforeArgs(Params_FindTouch args);

        public delegate Touch FindTouch_WithArgs(Func<TouchPool, int, Touch> orig, TouchPool self, int fingerId);
        ...
        public delegate void FreeEndedTouches_WithArgs(Action<TouchPool> orig, TouchPool self);
        ...
        public delegate void FreeTouch_WithArgs(Action<TouchPool, Touch> orig, TouchPool self, Touch touch);

        public delegate Touch NewTouch_AfterArgs(Params_NewTouch args, Touch ret);

        public delegate void NewTouch_BeforeArgs(Params_NewTouch args);

        public delegate Touch NewTouch_WithArgs(Func<TouchPool, Touch> orig, TouchPool self);
