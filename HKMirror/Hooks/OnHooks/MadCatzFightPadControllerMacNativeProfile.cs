...
public static class OnMadCatzFightPadControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzFightPadControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzFightPadControllerMacNativeProfile> orig,
            MadCatzFightPadControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzFightPadControllerMacNativeProfile> orig,
            MadCatzFightPadControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzFightPadControllerMacNativeProfile self;
        }
    }
