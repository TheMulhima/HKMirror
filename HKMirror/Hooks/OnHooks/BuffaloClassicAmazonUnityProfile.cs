...
public static class OnBuffaloClassicAmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BuffaloClassicAmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BuffaloClassicAmazonUnityProfile> orig, BuffaloClassicAmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BuffaloClassicAmazonUnityProfile> orig,
            BuffaloClassicAmazonUnityProfile self);

        public sealed class Params_Define
        {
            public BuffaloClassicAmazonUnityProfile self;
        }
    }
