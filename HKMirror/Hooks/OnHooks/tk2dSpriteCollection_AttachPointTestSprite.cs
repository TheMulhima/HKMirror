    ...
    internal static class HookHandler
    {
        ...
        internal static void HookCompareTo()
        {
            if (!HookedList.Contains("CompareTo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection.AttachPointTestSprite), "CompareTo"),
                    CompareTo);
            }
        }
        ...
        private static bool CompareTo(
            Func<tk2dSpriteCollection.AttachPointTestSprite, tk2dSpriteCollection.AttachPointTestSprite, bool> orig,
            tk2dSpriteCollection.AttachPointTestSprite self, tk2dSpriteCollection.AttachPointTestSprite src)
        {
        ...
        internal static void HookCopyFrom()
        {
            if (!HookedList.Contains("CopyFrom"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection.AttachPointTestSprite), "CopyFrom"),
                    CopyFrom);
            }
        }
        ...
        private static void CopyFrom(
            Action<tk2dSpriteCollection.AttachPointTestSprite, tk2dSpriteCollection.AttachPointTestSprite> orig,
            tk2dSpriteCollection.AttachPointTestSprite self, tk2dSpriteCollection.AttachPointTestSprite src)
        {
