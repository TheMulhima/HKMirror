...
public static class OnLogitechF310ModeDWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310ModeDWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310ModeDWindowsNativeProfile> orig,
            LogitechF310ModeDWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310ModeDWindowsNativeProfile> orig,
            LogitechF310ModeDWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF310ModeDWindowsNativeProfile self;
        }
    }
