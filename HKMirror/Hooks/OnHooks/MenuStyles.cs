...
public static class OnMenuStyles
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_CurrentStyle()
        {
            if (!HookedList.Contains("get_CurrentStyle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuStyles), "get_CurrentStyle"), get_CurrentStyle);
            }
        }

        internal static event Delegates.get_CurrentStyle_BeforeArgs _beforeget_CurrentStyle;
        internal static event Delegates.get_CurrentStyle_NormalArgs _afterget_CurrentStyle;
        ...
        private static int get_CurrentStyle(Func<MenuStyles, int> orig, MenuStyles self)
        {
            ...
            if (_afterget_CurrentStyle != null) retVal = _afterget_CurrentStyle.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.LoadStyle_NormalArgs _afterLoadStyle;
        ...
        private static void LoadStyle(On.MenuStyles.orig_LoadStyle orig, MenuStyles self, bool force, bool fade)
        {
            ...
            {
                self = self, force = force, fade = fade
            };
            ...
            if (_afterLoadStyle != null) _afterLoadStyle.Invoke(@params);
        }
        ...
        internal static event Delegates.SetStyle_NormalArgs _afterSetStyle;
        ...
        private static void SetStyle(On.MenuStyles.orig_SetStyle orig, MenuStyles self, int index, bool fade, bool save)
        {
            ...
            {
                self = self, index = index, fade = fade, save = save
            };
            ...
            if (_afterSetStyle != null) _afterSetStyle.Invoke(@params);
        }
        ...
        private static IEnumerator SwitchStyle(On.MenuStyles.orig_SwitchStyle orig, MenuStyles self, int index,
            bool fade, int oldIndex)
        {
            Delegates.Params_SwitchStyle @params = new()
            {
                self = self, index = index, fade = fade, oldIndex = oldIndex
            };
        ...
        internal static event Delegates.StopAudio_NormalArgs _afterStopAudio;
        ...
        private static void StopAudio(On.MenuStyles.orig_StopAudio orig, MenuStyles self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterStopAudio != null) _afterStopAudio.Invoke(@params);
        }
        ...
        private static IEnumerator FadeOutAudio(On.MenuStyles.orig_FadeOutAudio orig, MenuStyles self,
            AudioSource[] audioSources)
        {
            Delegates.Params_FadeOutAudio @params = new()
            {
                self = self, audioSources = audioSources
            };
        ...
        internal static event Delegates.UnlockFromAchievements_NormalArgs _afterUnlockFromAchievements;
        ...
        private static void UnlockFromAchievements(On.MenuStyles.orig_UnlockFromAchievements orig, MenuStyles self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterUnlockFromAchievements != null) _afterUnlockFromAchievements.Invoke(@params);
        }
        ...
        internal static event Delegates.UpdateTitle_NormalArgs _afterUpdateTitle;
        ...
        private static void UpdateTitle(On.MenuStyles.orig_UpdateTitle orig, MenuStyles self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterUpdateTitle != null) _afterUpdateTitle.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator FadeOutAudio_NormalArgs(Params_FadeOutAudio args);

        public delegate void get_CurrentStyle_BeforeArgs(Params_get_CurrentStyle args);

        public delegate int get_CurrentStyle_NormalArgs(Params_get_CurrentStyle args);

        public delegate void LoadStyle_BeforeArgs(Params_LoadStyle args);

        public delegate void LoadStyle_NormalArgs(Params_LoadStyle args);
        ...
        public delegate void SetStyle_NormalArgs(Params_SetStyle args);
        ...
        public delegate void StopAudio_NormalArgs(Params_StopAudio args);

        public delegate void SwitchStyle_BeforeArgs(Params_SwitchStyle args);

        public delegate IEnumerator SwitchStyle_NormalArgs(Params_SwitchStyle args);

        public delegate void UnlockFromAchievements_BeforeArgs(Params_UnlockFromAchievements args);

        public delegate void UnlockFromAchievements_NormalArgs(Params_UnlockFromAchievements args);

        public delegate void UpdateTitle_BeforeArgs(Params_UpdateTitle args);

        public delegate void UpdateTitle_NormalArgs(Params_UpdateTitle args);
    ...
    {
        public static event Delegates.get_CurrentStyle_NormalArgs get_CurrentStyle
        {
            add
            {
        ...
        public static event Delegates.LoadStyle_NormalArgs LoadStyle
        {
            add
            {
        ...
        public static event Delegates.SetStyle_NormalArgs SetStyle
        {
            add
            {
        ...
        public static event Delegates.StopAudio_NormalArgs StopAudio
        {
            add
            {
        ...
        public static event Delegates.UnlockFromAchievements_NormalArgs UnlockFromAchievements
        {
            add
            {
        ...
        public static event Delegates.UpdateTitle_NormalArgs UpdateTitle
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_CurrentStyle_NormalArgs get_CurrentStyle
        {
            add => HookEndpointManager.Add<Delegates.get_CurrentStyle_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuStyles), "get_CurrentStyle"), value);
            remove => HookEndpointManager.Remove<Delegates.get_CurrentStyle_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuStyles), "get_CurrentStyle"), value);
        }
