...
public static class OnMenuStyles
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_CurrentStyle()
        {
            if (!HookedList.Contains("get_CurrentStyle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuStyles), "get_CurrentStyle", true),
                    get_CurrentStyle);
            }
        }
        ...
        private static System.Collections.IEnumerator SwitchStyle(On.MenuStyles.orig_SwitchStyle orig, MenuStyles self,
            int index, bool fade, int oldIndex)
        {
        ...
        private static System.Collections.IEnumerator FadeOutAudio(On.MenuStyles.orig_FadeOutAudio orig,
            MenuStyles self, UnityEngine.AudioSource[] audioSources)
        {
        ...
        private static void UnlockFromAchievements(On.MenuStyles.orig_UnlockFromAchievements orig, MenuStyles self)
        {
            ...
            {
                foreach (Delegates.UnlockFromAchievements_BeforeArgs toInvoke in _beforeUnlockFromAchievements
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.UnlockFromAchievements_AfterArgs toInvoke in _afterUnlockFromAchievements
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void LoadStyle_WithArgs(Action<MenuStyles, bool, bool> orig, MenuStyles self, bool force,
            bool fade);
        ...
        public delegate void SetStyle_WithArgs(Action<MenuStyles, int, bool, bool> orig, MenuStyles self, int index,
            bool fade, bool save);
        ...
        public delegate System.Collections.IEnumerator SwitchStyle_AfterArgs(Params_SwitchStyle args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator SwitchStyle_WithArgs(
            Func<MenuStyles, int, bool, int, System.Collections.IEnumerator> orig, MenuStyles self, int index,
        ...
        public delegate System.Collections.IEnumerator FadeOutAudio_AfterArgs(Params_FadeOutAudio args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator FadeOutAudio_WithArgs(
            Func<MenuStyles, UnityEngine.AudioSource[], System.Collections.IEnumerator> orig, MenuStyles self,
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_CurrentStyle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuStyles), "get_CurrentStyle", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_CurrentStyle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuStyles), "get_CurrentStyle", true), value);
        }
