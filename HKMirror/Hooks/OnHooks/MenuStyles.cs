...
public static class OnMenuStyles
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator FadeOutAudio_AfterArgs(Params_FadeOutAudio args, IEnumerator ret);

        public delegate void FadeOutAudio_BeforeArgs(Params_FadeOutAudio args);

        public delegate IEnumerator FadeOutAudio_WithArgs(Func<MenuStyles, AudioSource[], IEnumerator> orig,
            MenuStyles self, AudioSource[] audioSources);
        ...
        public delegate IEnumerator SwitchStyle_AfterArgs(Params_SwitchStyle args, IEnumerator ret);

        public delegate void SwitchStyle_BeforeArgs(Params_SwitchStyle args);

        public delegate IEnumerator SwitchStyle_WithArgs(Func<MenuStyles, int, bool, int, IEnumerator> orig,
            MenuStyles self, int index, bool fade, int oldIndex);
