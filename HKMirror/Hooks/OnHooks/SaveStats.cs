...
public static class OnSaveStats
{
    internal static class HookHandler
    {
        ...
        private static void set_mapZone(Action<SaveStats, GlobalEnums.MapZone> orig, SaveStats self,
            GlobalEnums.MapZone value)
        {
        ...
        internal static void Hookget_permadeathMode()
        {
            if (!HookedList.Contains("get_permadeathMode"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_permadeathMode", true),
                    get_permadeathMode);
            }
        }
        ...
        private static int get_permadeathMode(Func<SaveStats, int> orig, SaveStats self)
        {
            ...
            {
                foreach (Delegates.get_permadeathMode_BeforeArgs toInvoke in
                         _beforeget_permadeathMode.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_permadeathMode_AfterArgs toInvoke in
                         _afterget_permadeathMode.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_permadeathMode()
        {
            if (!HookedList.Contains("set_permadeathMode"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_permadeathMode", true),
                    set_permadeathMode);
            }
        }
        ...
        private static void set_permadeathMode(Action<SaveStats, int> orig, SaveStats self, int value)
        {
            ...
            {
                foreach (Delegates.set_permadeathMode_BeforeArgs toInvoke in
                         _beforeset_permadeathMode.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_permadeathMode_AfterArgs toInvoke in
                         _afterset_permadeathMode.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_completionPercentage()
        {
            if (!HookedList.Contains("get_completionPercentage"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_completionPercentage", true),
        ...
        private static float get_completionPercentage(Func<SaveStats, float> orig, SaveStats self)
        {
            ...
            {
                foreach (Delegates.get_completionPercentage_BeforeArgs toInvoke in _beforeget_completionPercentage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_completionPercentage_AfterArgs toInvoke in _afterget_completionPercentage
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_completionPercentage()
        {
            if (!HookedList.Contains("set_completionPercentage"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_completionPercentage", true),
        ...
        private static void set_completionPercentage(Action<SaveStats, float> orig, SaveStats self, float value)
        {
            ...
            {
                foreach (Delegates.set_completionPercentage_BeforeArgs toInvoke in _beforeset_completionPercentage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_completionPercentage_AfterArgs toInvoke in _afterset_completionPercentage
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_unlockedCompletionRate()
        {
            if (!HookedList.Contains("get_unlockedCompletionRate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_unlockedCompletionRate", true),
        ...
        private static bool get_unlockedCompletionRate(Func<SaveStats, bool> orig, SaveStats self)
        {
            ...
            {
                foreach (Delegates.get_unlockedCompletionRate_BeforeArgs toInvoke in _beforeget_unlockedCompletionRate
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_unlockedCompletionRate_AfterArgs toInvoke in _afterget_unlockedCompletionRate
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_unlockedCompletionRate()
        {
            if (!HookedList.Contains("set_unlockedCompletionRate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_unlockedCompletionRate", true),
        ...
        private static void set_unlockedCompletionRate(Action<SaveStats, bool> orig, SaveStats self, bool value)
        {
            ...
            {
                foreach (Delegates.set_unlockedCompletionRate_BeforeArgs toInvoke in _beforeset_unlockedCompletionRate
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_unlockedCompletionRate_AfterArgs toInvoke in _afterset_unlockedCompletionRate
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static string GetPlaytimeHHMMSS(On.SaveStats.orig_GetPlaytimeHHMMSS orig, SaveStats self)
        {
            ...
            {
                foreach (Delegates.GetPlaytimeHHMMSS_BeforeArgs toInvoke in
                         _beforeGetPlaytimeHHMMSS.GetInvocationList())
                {
                    try
                    {
        ...
        private static string GetCompletionPercentage(On.SaveStats.orig_GetCompletionPercentage orig, SaveStats self)
        {
            ...
            {
                foreach (Delegates.GetCompletionPercentage_BeforeArgs toInvoke in _beforeGetCompletionPercentage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetCompletionPercentage_AfterArgs toInvoke in _afterGetCompletionPercentage
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static int GetMPSlotsVisible(On.SaveStats.orig_GetMPSlotsVisible orig, SaveStats self)
        {
            ...
            {
                foreach (Delegates.GetMPSlotsVisible_BeforeArgs toInvoke in
                         _beforeGetMPSlotsVisible.GetInvocationList())
                {
                    try
                    {
        ...
        private static System.Collections.Generic.Dictionary<string, string> get_LoadedMods(
            Func<SaveStats, System.Collections.Generic.Dictionary<string, string>> orig, SaveStats self)
        {
        ...
        private static void set_LoadedMods(
            Action<SaveStats, System.Collections.Generic.Dictionary<string, string>> orig, SaveStats self,
    ...
    public static class Delegates
    {
        ...
        public delegate GlobalEnums.MapZone get_mapZone_WithArgs(Func<SaveStats, GlobalEnums.MapZone> orig,
            SaveStats self);
        ...
        public delegate void set_mapZone_WithArgs(Action<SaveStats, GlobalEnums.MapZone> orig, SaveStats self,
            GlobalEnums.MapZone value);
        ...
        public delegate void set_completionPercentage_WithArgs(Action<SaveStats, float> orig, SaveStats self,
            float value);
        ...
        public delegate void set_unlockedCompletionRate_WithArgs(Action<SaveStats, bool> orig, SaveStats self,
            bool value);
        ...
        public delegate System.Collections.Generic.Dictionary<string, string> get_LoadedMods_AfterArgs(
            Params_get_LoadedMods args, System.Collections.Generic.Dictionary<string, string> ret);

        public delegate System.Collections.Generic.Dictionary<string, string> get_LoadedMods_WithArgs(
            Func<SaveStats, System.Collections.Generic.Dictionary<string, string>> orig, SaveStats self);
        ...
        public delegate void set_LoadedMods_WithArgs(
            Action<SaveStats, System.Collections.Generic.Dictionary<string, string>> orig, SaveStats self,
            System.Collections.Generic.Dictionary<string, string> value);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_maxHealth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_maxHealth", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_maxHealth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_maxHealth", true), value);
        }

        public static event Delegates.set_maxHealth_WithArgs set_maxHealth
        {
            add => HookEndpointManager.Add<Delegates.set_maxHealth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_maxHealth", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_maxHealth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_maxHealth", true), value);
        }

        public static event Delegates.get_geo_WithArgs get_geo
        {
            add => HookEndpointManager.Add<Delegates.get_geo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_geo", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_geo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_geo", true), value);
        }

        public static event Delegates.set_geo_WithArgs set_geo
        {
            add => HookEndpointManager.Add<Delegates.set_geo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_geo", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_geo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_geo", true), value);
        }

        public static event Delegates.get_mapZone_WithArgs get_mapZone
        {
            add => HookEndpointManager.Add<Delegates.get_mapZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_mapZone", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_mapZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_mapZone", true), value);
        }

        public static event Delegates.set_mapZone_WithArgs set_mapZone
        {
            add => HookEndpointManager.Add<Delegates.set_mapZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_mapZone", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_mapZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_mapZone", true), value);
        }
        ...
        public static event Delegates.get_playTime_WithArgs get_playTime
        {
            add => HookEndpointManager.Add<Delegates.get_playTime_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_playTime", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_playTime_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_playTime", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_playTime_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_playTime", true), value);
        }

        public static event Delegates.get_maxMPReserve_WithArgs get_maxMPReserve
        {
            add => HookEndpointManager.Add<Delegates.get_maxMPReserve_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_maxMPReserve", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_maxMPReserve_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_maxMPReserve", true), value);
        }

        public static event Delegates.set_maxMPReserve_WithArgs set_maxMPReserve
        {
            add => HookEndpointManager.Add<Delegates.set_maxMPReserve_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_maxMPReserve", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_maxMPReserve_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_maxMPReserve", true), value);
        }

        public static event Delegates.get_permadeathMode_WithArgs get_permadeathMode
        {
            add => HookEndpointManager.Add<Delegates.get_permadeathMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_permadeathMode", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_permadeathMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_permadeathMode", true), value);
        }

        public static event Delegates.set_permadeathMode_WithArgs set_permadeathMode
        {
            add => HookEndpointManager.Add<Delegates.set_permadeathMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_permadeathMode", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_permadeathMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_permadeathMode", true), value);
        }

        public static event Delegates.get_bossRushMode_WithArgs get_bossRushMode
        {
            add => HookEndpointManager.Add<Delegates.get_bossRushMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_bossRushMode", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_bossRushMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_bossRushMode", true), value);
        }

        public static event Delegates.set_bossRushMode_WithArgs set_bossRushMode
        {
            add => HookEndpointManager.Add<Delegates.set_bossRushMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_bossRushMode", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_bossRushMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_bossRushMode", true), value);
        }

        public static event Delegates.get_completionPercentage_WithArgs get_completionPercentage
        {
            add => HookEndpointManager.Add<Delegates.get_completionPercentage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_completionPercentage", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_completionPercentage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_completionPercentage", true), value);
        }

        public static event Delegates.set_completionPercentage_WithArgs set_completionPercentage
        {
            add => HookEndpointManager.Add<Delegates.set_completionPercentage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_completionPercentage", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_completionPercentage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_completionPercentage", true), value);
        }

        public static event Delegates.get_unlockedCompletionRate_WithArgs get_unlockedCompletionRate
        {
            add => HookEndpointManager.Add<Delegates.get_unlockedCompletionRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_unlockedCompletionRate", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_unlockedCompletionRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_unlockedCompletionRate", true), value);
        }

        public static event Delegates.set_unlockedCompletionRate_WithArgs set_unlockedCompletionRate
        {
            add => HookEndpointManager.Add<Delegates.set_unlockedCompletionRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_unlockedCompletionRate", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_unlockedCompletionRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_unlockedCompletionRate", true), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_LoadedMods_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_LoadedMods", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_LoadedMods_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_LoadedMods", true), value);
        }

        public static event Delegates.set_LoadedMods_WithArgs set_LoadedMods
        {
            add => HookEndpointManager.Add<Delegates.set_LoadedMods_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_LoadedMods", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_LoadedMods_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_LoadedMods", true), value);
        }
        ...
        public static event Delegates.get_Name_WithArgs get_Name
        {
            add => HookEndpointManager.Add<Delegates.get_Name_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "get_Name", true), value);
        ...
        public static event Delegates.set_Name_WithArgs set_Name
        {
            add => HookEndpointManager.Add<Delegates.set_Name_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveStats), "set_Name", true), value);
