...
/// <summary>
/// Contains different types of On Hooks for AndroidTVUnityProfile class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnAndroidTVUnityProfile
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.AndroidTVUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.AndroidTVUnityProfile> orig, InControl.UnityDeviceProfiles.AndroidTVUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.AndroidTVUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.AndroidTVUnityProfile> orig, InControl.UnityDeviceProfiles.AndroidTVUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.AndroidTVUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.AndroidTVUnityProfile), "Define", true), value);
}
}
