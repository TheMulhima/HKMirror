...
public static class OnAndroidTVUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AndroidTVUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AndroidTVUnityProfile> orig, AndroidTVUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AndroidTVUnityProfile> orig, AndroidTVUnityProfile self);

        public sealed class Params_Define
        {
            public AndroidTVUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AndroidTVUnityProfile), "Define"), value);
