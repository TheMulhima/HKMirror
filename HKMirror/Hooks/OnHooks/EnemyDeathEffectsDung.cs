...
/// <summary>
/// Contains different types of On Hooks for EnemyDeathEffectsDung class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnEnemyDeathEffectsDung
{
...
On.EnemyDeathEffectsDung.EmitEffects += EmitEffects;
...
private static void EmitEffects(On.EnemyDeathEffectsDung.orig_EmitEffects orig,EnemyDeathEffectsDung self)
{
...
{
public EnemyDeathEffectsDung self;
}
...
public delegate void EmitEffects_WithArgs (Action<EnemyDeathEffectsDung> orig, EnemyDeathEffectsDung self);
}
...
{
public static event On.EnemyDeathEffectsDung.hook_EmitEffects EmitEffects
{
add => On.EnemyDeathEffectsDung.EmitEffects += value;
remove => On.EnemyDeathEffectsDung.EmitEffects -= value;
}
}
