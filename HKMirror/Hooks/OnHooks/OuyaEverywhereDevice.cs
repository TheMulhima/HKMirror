...
public static class OnOuyaEverywhereDevice
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_DeviceIndex()
        {
            if (!HookedList.Contains("get_DeviceIndex"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "get_DeviceIndex", true),
                    get_DeviceIndex);
            }
        }
        ...
        private static int get_DeviceIndex(Func<InControl.OuyaEverywhereDevice, int> orig,
            InControl.OuyaEverywhereDevice self)
        {
        ...
        internal static void Hookset_DeviceIndex()
        {
            if (!HookedList.Contains("set_DeviceIndex"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "set_DeviceIndex", true),
                    set_DeviceIndex);
            }
        }
        ...
        private static void set_DeviceIndex(Action<InControl.OuyaEverywhereDevice, int> orig,
            InControl.OuyaEverywhereDevice self, int value)
        {
        ...
        internal static void HookBeforeAttach()
        {
            if (!HookedList.Contains("BeforeAttach"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "BeforeAttach", true),
                    BeforeAttach);
            }
        }
        ...
        private static void BeforeAttach(Action<InControl.OuyaEverywhereDevice> orig,
            InControl.OuyaEverywhereDevice self)
        {
        ...
        internal static void HookUpdate()
        {
            if (!HookedList.Contains("Update"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "Update", true),
                    Update);
            }
        }
        ...
        private static void Update(Action<InControl.OuyaEverywhereDevice, ulong, float> orig,
            InControl.OuyaEverywhereDevice self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void Hookget_IsConnected()
        {
            if (!HookedList.Contains("get_IsConnected"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "get_IsConnected", true),
                    get_IsConnected);
            }
        }
        ...
        private static bool get_IsConnected(Func<InControl.OuyaEverywhereDevice, bool> orig,
            InControl.OuyaEverywhereDevice self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate int get_DeviceIndex_WithArgs(Func<InControl.OuyaEverywhereDevice, int> orig,
            InControl.OuyaEverywhereDevice self);
        ...
        public delegate void set_DeviceIndex_WithArgs(Action<InControl.OuyaEverywhereDevice, int> orig,
            InControl.OuyaEverywhereDevice self, int value);
        ...
        public delegate void BeforeAttach_WithArgs(Action<InControl.OuyaEverywhereDevice> orig,
            InControl.OuyaEverywhereDevice self);
        ...
        public delegate void Update_WithArgs(Action<InControl.OuyaEverywhereDevice, ulong, float> orig,
            InControl.OuyaEverywhereDevice self, ulong updateTick, float deltaTime);
        ...
        public delegate bool get_IsConnected_WithArgs(Func<InControl.OuyaEverywhereDevice, bool> orig,
            InControl.OuyaEverywhereDevice self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_DeviceIndex_WithArgs get_DeviceIndex
        {
            add => HookEndpointManager.Add<Delegates.get_DeviceIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "get_DeviceIndex", true), value);
        ...
        public static event Delegates.set_DeviceIndex_WithArgs set_DeviceIndex
        {
            add => HookEndpointManager.Add<Delegates.set_DeviceIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "set_DeviceIndex", true), value);
        ...
        public static event Delegates.BeforeAttach_WithArgs BeforeAttach
        {
            add => HookEndpointManager.Add<Delegates.BeforeAttach_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "BeforeAttach", true), value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "Update", true), value);
        ...
        public static event Delegates.get_IsConnected_WithArgs get_IsConnected
        {
            add => HookEndpointManager.Add<Delegates.get_IsConnected_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDevice), "get_IsConnected", true), value);
