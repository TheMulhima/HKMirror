...
new Hook(ReflectionHelper.GetMethodInfo(typeof(CheatManager), "get_IsCheatsEnabled", false), get_IsCheatsEnabled);
...
{
foreach (Delegates.get_IsCheatsEnabled_BeforeArgs toInvoke in _beforeget_IsCheatsEnabled.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsCheatsEnabled_AfterArgs toInvoke in _afterget_IsCheatsEnabled.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(CheatManager), "get_IsInstaKillEnabled", false), get_IsInstaKillEnabled);
...
{
foreach (Delegates.get_IsInstaKillEnabled_BeforeArgs toInvoke in _beforeget_IsInstaKillEnabled.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsInstaKillEnabled_AfterArgs toInvoke in _afterget_IsInstaKillEnabled.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator Start(On.CheatManager.orig_Start orig,CheatManager self)
{
...
private static bool CheatButton(On.CheatManager.orig_CheatButton orig,CheatManager self, ref  int buttonIndex,  string content)
{
...
private static bool SafetyCheatButton(On.CheatManager.orig_SafetyCheatButton orig,CheatManager self, ref  int buttonIndex,  string content)
{
...
{
foreach (Delegates.SafetyCheatButton_BeforeArgs toInvoke in _beforeSafetyCheatButton.GetInvocationList())
{
try
{
...
public delegate System.Collections.IEnumerator Start_WithArgs (Func<CheatManager, System.Collections.IEnumerator> orig, CheatManager self);
...
public delegate bool CheatButton_WithArgs (Func<CheatManager,  int,  string, bool> orig, CheatManager self, ref  int buttonIndex,  string content);
...
public delegate bool SafetyCheatButton_WithArgs (Func<CheatManager,  int,  string, bool> orig, CheatManager self, ref  int buttonIndex,  string content);
...
{
add => HookEndpointManager.Add<Delegates.get_IsCheatsEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CheatManager), "get_IsCheatsEnabled", false), value);
remove => HookEndpointManager.Remove<Delegates.get_IsCheatsEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CheatManager), "get_IsCheatsEnabled", false), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsInstaKillEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CheatManager), "get_IsInstaKillEnabled", false), value);
remove => HookEndpointManager.Remove<Delegates.get_IsInstaKillEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CheatManager), "get_IsInstaKillEnabled", false), value);
}
