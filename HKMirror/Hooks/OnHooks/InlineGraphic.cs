...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "get_mainTexture", true), get_mainTexture);
...
private static UnityEngine.Texture get_mainTexture(Func<TMPro.InlineGraphic, UnityEngine.Texture> orig, TMPro.InlineGraphic self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnTransformParentChanged", true), OnTransformParentChanged);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnRectTransformDimensionsChange", true), OnRectTransformDimensionsChange);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "UpdateMaterial", true), UpdateMaterial);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "UpdateGeometry", true), UpdateGeometry);
...
public delegate UnityEngine.Texture get_mainTexture_WithArgs (Func<TMPro.InlineGraphic, UnityEngine.Texture> orig, TMPro.InlineGraphic self);
...
public delegate void OnTransformParentChanged_WithArgs (Action<TMPro.InlineGraphic> orig, TMPro.InlineGraphic self);
...
public delegate void OnRectTransformDimensionsChange_WithArgs (Action<TMPro.InlineGraphic> orig, TMPro.InlineGraphic self);
...
{
add => HookEndpointManager.Add<Delegates.get_mainTexture_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "get_mainTexture", true), value);
remove => HookEndpointManager.Remove<Delegates.get_mainTexture_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "get_mainTexture", true), value);
}
public static event Delegates.Awake_WithArgs Awake
{
add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "Awake", true), value);
remove => HookEndpointManager.Remove<Delegates.Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "Awake", true), value);
}
public static event Delegates.OnEnable_WithArgs OnEnable
{
add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnEnable", true), value);
remove => HookEndpointManager.Remove<Delegates.OnEnable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnEnable", true), value);
}
public static event Delegates.OnDisable_WithArgs OnDisable
{
add => HookEndpointManager.Add<Delegates.OnDisable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnDisable", true), value);
remove => HookEndpointManager.Remove<Delegates.OnDisable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnDisable", true), value);
}
public static event Delegates.OnTransformParentChanged_WithArgs OnTransformParentChanged
{
add => HookEndpointManager.Add<Delegates.OnTransformParentChanged_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnTransformParentChanged", true), value);
remove => HookEndpointManager.Remove<Delegates.OnTransformParentChanged_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnTransformParentChanged", true), value);
}
public static event Delegates.OnRectTransformDimensionsChange_WithArgs OnRectTransformDimensionsChange
{
add => HookEndpointManager.Add<Delegates.OnRectTransformDimensionsChange_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnRectTransformDimensionsChange", true), value);
remove => HookEndpointManager.Remove<Delegates.OnRectTransformDimensionsChange_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "OnRectTransformDimensionsChange", true), value);
}
public static event Delegates.UpdateMaterial_WithArgs UpdateMaterial
{
add => HookEndpointManager.Add<Delegates.UpdateMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "UpdateMaterial", true), value);
remove => HookEndpointManager.Remove<Delegates.UpdateMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "UpdateMaterial", true), value);
}
public static event Delegates.UpdateGeometry_WithArgs UpdateGeometry
{
add => HookEndpointManager.Add<Delegates.UpdateGeometry_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "UpdateGeometry", true), value);
remove => HookEndpointManager.Remove<Delegates.UpdateGeometry_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.InlineGraphic), "UpdateGeometry", true), value);
}
}
