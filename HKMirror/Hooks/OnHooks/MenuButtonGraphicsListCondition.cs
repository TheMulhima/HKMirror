...
/// <summary>
/// Contains different types of On Hooks for MenuButtonGraphicsListCondition class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnMenuButtonGraphicsListCondition
{
...
On.MenuButtonGraphicsListCondition.IsFulfilled += IsFulfilled;
...
private static bool IsFulfilled(On.MenuButtonGraphicsListCondition.orig_IsFulfilled orig,MenuButtonGraphicsListCondition self)
{
...
{
public MenuButtonGraphicsListCondition self;
}
...
public delegate bool IsFulfilled_WithArgs (Func<MenuButtonGraphicsListCondition, bool> orig, MenuButtonGraphicsListCondition self);
}
...
{
public static event On.MenuButtonGraphicsListCondition.hook_IsFulfilled IsFulfilled
{
add => On.MenuButtonGraphicsListCondition.IsFulfilled += value;
remove => On.MenuButtonGraphicsListCondition.IsFulfilled -= value;
}
}
