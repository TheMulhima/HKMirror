...
public static class OnScreenPick2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick2d), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick2d), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick2d), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self)
        {
        ...
        internal static void HookDoScreenPick()
        {
            if (!HookedList.Contains("DoScreenPick"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick2d), "DoScreenPick",
                        true), DoScreenPick);
            }
        }
        ...
        private static void DoScreenPick(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self);
        ...
        public delegate void DoScreenPick_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick2d> orig,
            HutongGames.PlayMaker.Actions.ScreenPick2d self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick2d), "OnUpdate", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoScreenPick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick2d), "DoScreenPick",
                    true), value);
            remove => HookEndpointManager.Remove<Delegates.DoScreenPick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick2d), "DoScreenPick",
                    true), value);
        }
    }
