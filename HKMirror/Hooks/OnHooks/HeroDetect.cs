...
/// <summary>
/// Contains different types of On Hooks for HeroDetect class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnHeroDetect
{
...
On.HeroDetect.OnTriggerEnter2D += OnTriggerEnter2D;

}
}
internal static event Delegates.OnTriggerEnter2D_BeforeArgs _beforeOnTriggerEnter2D;
internal static event Delegates.OnTriggerEnter2D_AfterArgs _afterOnTriggerEnter2D;
private static void OnTriggerEnter2D(On.HeroDetect.orig_OnTriggerEnter2D orig,HeroDetect self,  UnityEngine.Collider2D collision)
{
...
On.HeroDetect.OnTriggerExit2D += OnTriggerExit2D;
...
private static void OnTriggerExit2D(On.HeroDetect.orig_OnTriggerExit2D orig,HeroDetect self,  UnityEngine.Collider2D collision)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<HeroDetect,  UnityEngine.Collider2D> orig, HeroDetect self,  UnityEngine.Collider2D collision);
...
public delegate void OnTriggerExit2D_WithArgs (Action<HeroDetect,  UnityEngine.Collider2D> orig, HeroDetect self,  UnityEngine.Collider2D collision);
}
...
{
public static event On.HeroDetect.hook_OnTriggerEnter2D OnTriggerEnter2D
{
add => On.HeroDetect.OnTriggerEnter2D += value;
remove => On.HeroDetect.OnTriggerEnter2D -= value;
}
public static event On.HeroDetect.hook_OnTriggerExit2D OnTriggerExit2D
{
add => On.HeroDetect.OnTriggerExit2D += value;
remove => On.HeroDetect.OnTriggerExit2D -= value;
}
}
