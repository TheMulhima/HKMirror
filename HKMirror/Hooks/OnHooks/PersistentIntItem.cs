...
private static void UpdateValueFromFSM(On.PersistentIntItem.orig_UpdateValueFromFSM orig,PersistentIntItem self)
{
...
{
foreach (Delegates.UpdateValueFromFSM_BeforeArgs toInvoke in _beforeUpdateValueFromFSM.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateValueFromFSM_AfterArgs toInvoke in _afterUpdateValueFromFSM.GetInvocationList())
{
try
{
...
private static void SetValueOnFSM(On.PersistentIntItem.orig_SetValueOnFSM orig,PersistentIntItem self,  int newValue)
{
...
public delegate void SetValueOnFSM_WithArgs (Action<PersistentIntItem,  int> orig, PersistentIntItem self,  int newValue);
