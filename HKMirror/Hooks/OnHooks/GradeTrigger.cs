...
private static void OnTriggerEnter2D(On.GradeTrigger.orig_OnTriggerEnter2D orig,GradeTrigger self,  UnityEngine.Collider2D triggerObject)
{
...
private static void OnTriggerExit2D(On.GradeTrigger.orig_OnTriggerExit2D orig,GradeTrigger self,  UnityEngine.Collider2D triggerObject)
{
...
public delegate void Start_WithArgs (Action<GradeTrigger> orig, GradeTrigger self);
public sealed class Params_OnTriggerEnter2D
{
public GradeTrigger self;
public UnityEngine.Collider2D triggerObject;
}
public delegate void OnTriggerEnter2D_BeforeArgs(Params_OnTriggerEnter2D args);
public delegate void OnTriggerEnter2D_AfterArgs(Params_OnTriggerEnter2D args);
public delegate void OnTriggerEnter2D_WithArgs (Action<GradeTrigger,  UnityEngine.Collider2D> orig, GradeTrigger self,  UnityEngine.Collider2D triggerObject);
...
public delegate void OnTriggerExit2D_WithArgs (Action<GradeTrigger,  UnityEngine.Collider2D> orig, GradeTrigger self,  UnityEngine.Collider2D triggerObject);
}
