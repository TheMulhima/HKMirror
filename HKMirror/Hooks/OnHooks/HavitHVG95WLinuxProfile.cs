...
public static class OnHavitHVG95WLinuxProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HavitHVG95WLinuxProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HavitHVG95WLinuxProfile> orig, HavitHVG95WLinuxProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HavitHVG95WLinuxProfile> orig, HavitHVG95WLinuxProfile self);

        public sealed class Params_Define
        {
            public HavitHVG95WLinuxProfile self;
        }
    }
