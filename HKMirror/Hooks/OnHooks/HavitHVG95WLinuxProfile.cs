...
/// <summary>
/// Contains different types of On Hooks for HavitHVG95WLinuxProfile class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnHavitHVG95WLinuxProfile
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile> orig, InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile self)
{
...
{
public InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile> orig, InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.HavitHVG95WLinuxProfile), "Define", true), value);
}
}
