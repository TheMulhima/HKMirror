...
public static class OnAirFloWiredPS3WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AirFloWiredPS3WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AirFloWiredPS3WindowsUnityProfile> orig,
            AirFloWiredPS3WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AirFloWiredPS3WindowsUnityProfile> orig,
            AirFloWiredPS3WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public AirFloWiredPS3WindowsUnityProfile self;
        }
    }
