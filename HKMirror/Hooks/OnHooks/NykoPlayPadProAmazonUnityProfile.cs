...
public static class OnNykoPlayPadProAmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NykoPlayPadProAmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NykoPlayPadProAmazonUnityProfile> orig, NykoPlayPadProAmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NykoPlayPadProAmazonUnityProfile> orig,
            NykoPlayPadProAmazonUnityProfile self);

        public sealed class Params_Define
        {
            public NykoPlayPadProAmazonUnityProfile self;
        }
    }
