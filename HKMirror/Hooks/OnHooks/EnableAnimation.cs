...
public static class OnEnableAnimation
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableAnimation), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.EnableAnimation> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableAnimation), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.EnableAnimation> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self)
        {
        ...
        internal static void HookDoEnableAnimation()
        {
            if (!HookedList.Contains("DoEnableAnimation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableAnimation),
                        "DoEnableAnimation", true), DoEnableAnimation);
            }
        }
        ...
        private static void DoEnableAnimation(
            Action<HutongGames.PlayMaker.Actions.EnableAnimation, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self, UnityEngine.GameObject go)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableAnimation), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.EnableAnimation> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.EnableAnimation> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.EnableAnimation> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self);
        ...
        public delegate void DoEnableAnimation_WithArgs(
            Action<HutongGames.PlayMaker.Actions.EnableAnimation, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self, UnityEngine.GameObject go);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.EnableAnimation> orig,
            HutongGames.PlayMaker.Actions.EnableAnimation self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableAnimation), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableAnimation), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableAnimation), "OnExit", true),
                value);
