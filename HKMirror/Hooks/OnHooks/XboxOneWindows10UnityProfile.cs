...
public static class OnXboxOneWindows10UnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneWindows10UnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneWindows10UnityProfile> orig, XboxOneWindows10UnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneWindows10UnityProfile> orig,
            XboxOneWindows10UnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneWindows10UnityProfile self;
        }
    }
