...
public static class OnNintendoSwitchProMacChromeUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NintendoSwitchProMacChromeUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<NintendoSwitchProMacChromeUnityProfile> orig,
            NintendoSwitchProMacChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NintendoSwitchProMacChromeUnityProfile> orig,
            NintendoSwitchProMacChromeUnityProfile self);

        public sealed class Params_Define
        {
            public NintendoSwitchProMacChromeUnityProfile self;
        }
    }
