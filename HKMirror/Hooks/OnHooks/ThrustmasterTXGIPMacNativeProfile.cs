...
public static class OnThrustmasterTXGIPMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ThrustmasterTXGIPMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<ThrustmasterTXGIPMacNativeProfile> orig,
            ThrustmasterTXGIPMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ThrustmasterTXGIPMacNativeProfile> orig,
            ThrustmasterTXGIPMacNativeProfile self);

        public sealed class Params_Define
        {
            public ThrustmasterTXGIPMacNativeProfile self;
        }
    }
