...
public static class OnuGuiInputFieldSetSelectionColor
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor), "DoSetValue", true),
                    DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor), "OnExit", true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self);
        ...
        public delegate void OnEnter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self);
        ...
        public delegate void DoSetValue_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetSelectionColor),
                    "Reset", true), value);
