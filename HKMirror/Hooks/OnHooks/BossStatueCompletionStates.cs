...
public static class OnBossStatueCompletionStates
{
    internal static class HookHandler
    {
            ...
            On.BossStatueCompletionStates.orig_GetHighestCompletedTier orig, BossStatueCompletionStates self)
        {
            ...
            if (_beforeGetHighestCompletedTier != null)
                foreach (Delegates.GetHighestCompletedTier_BeforeArgs toInvoke in _beforeGetHighestCompletedTier
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterGetHighestCompletedTier != null)
                foreach (Delegates.GetHighestCompletedTier_AfterArgs toInvoke in _afterGetHighestCompletedTier
                             .GetInvocationList())
                    try
                    {
        ...
        private static bool GetIsTierCompleted(On.BossStatueCompletionStates.orig_GetIsTierCompleted orig,
            BossStatueCompletionStates self, BossStatueCompletionStates.Tiers tier)
        {
            ...
            if (_beforeGetIsTierCompleted != null)
                foreach (Delegates.GetIsTierCompleted_BeforeArgs toInvoke in
                         _beforeGetIsTierCompleted.GetInvocationList())
                    try
                    {
            ...
            if (_afterGetIsTierCompleted != null)
                foreach (Delegates.GetIsTierCompleted_AfterArgs toInvoke in
                         _afterGetIsTierCompleted.GetInvocationList())
                    try
                    {
        ...
        private static void CountCompletion(On.BossStatueCompletionStates.orig_CountCompletion orig,
            BossStatueCompletionStates self, BossStatueCompletionStates.Tiers tier, out int completed, out int total)
        {
        ...
        private static bool HasCompletedTier(On.BossStatueCompletionStates.orig_HasCompletedTier orig,
            BossStatueCompletionStates self, BossStatue.Completion completion, BossStatueCompletionStates.Tiers tier)
        {
            Delegates.Params_HasCompletedTier @params = new()
            {
                self = self, completion = completion, tier = tier
            };
    ...
    public static class Delegates
    {
        ...
        public delegate void CountCompletion_WithArgs(
            Action<BossStatueCompletionStates, BossStatueCompletionStates.Tiers, int, int> orig,
            BossStatueCompletionStates self, BossStatueCompletionStates.Tiers tier, out int completed, out int total);

        public delegate BossStatueCompletionStates.Tiers? GetHighestCompletedTier_AfterArgs(
            Params_GetHighestCompletedTier args, BossStatueCompletionStates.Tiers? ret);

        public delegate void GetHighestCompletedTier_BeforeArgs(Params_GetHighestCompletedTier args);

        public delegate BossStatueCompletionStates.Tiers? GetHighestCompletedTier_WithArgs(
            Func<BossStatueCompletionStates, BossStatueCompletionStates.Tiers?> orig, BossStatueCompletionStates self);
        ...
        public delegate bool GetIsTierCompleted_WithArgs(
            Func<BossStatueCompletionStates, BossStatueCompletionStates.Tiers, bool> orig,
            BossStatueCompletionStates self, BossStatueCompletionStates.Tiers tier);
        ...
        public delegate bool HasCompletedTier_WithArgs(
            Func<BossStatueCompletionStates, BossStatue.Completion, BossStatueCompletionStates.Tiers, bool> orig,
            BossStatueCompletionStates self, BossStatue.Completion completion, BossStatueCompletionStates.Tiers tier);
        ...
        public delegate void OnValidate_WithArgs(Action<BossStatueCompletionStates> orig,
            BossStatueCompletionStates self);
