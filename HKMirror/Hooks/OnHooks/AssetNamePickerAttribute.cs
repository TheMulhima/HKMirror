...
public static class OnAssetNamePickerAttribute
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_SearchFilter()
        {
            if (!HookedList.Contains("get_SearchFilter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AssetNamePickerAttribute), "get_SearchFilter", true),
                    get_SearchFilter);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate string get_SearchFilter_WithArgs(Func<AssetNamePickerAttribute, string> orig,
            AssetNamePickerAttribute self);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_SearchFilter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AssetNamePickerAttribute), "get_SearchFilter", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_SearchFilter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AssetNamePickerAttribute), "get_SearchFilter", true), value);
        }
    }
}