...
public static class OnPlayStation4AndroidUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.PlayStation4AndroidUnityProfile), "Define", true), Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.PlayStation4AndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation4AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<InControl.UnityDeviceProfiles.PlayStation4AndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation4AndroidUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.PlayStation4AndroidUnityProfile),
                    "Define", true), value);
