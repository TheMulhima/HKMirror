...
public static class OnPlayStation4AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4AndroidUnityProfile> orig, PlayStation4AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4AndroidUnityProfile> orig,
            PlayStation4AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4AndroidUnityProfile self;
        }
    }
