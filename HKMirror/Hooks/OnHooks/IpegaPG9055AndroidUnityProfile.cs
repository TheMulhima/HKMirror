...
public static class OnIpegaPG9055AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IpegaPG9055AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<IpegaPG9055AndroidUnityProfile> orig, IpegaPG9055AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<IpegaPG9055AndroidUnityProfile> orig,
            IpegaPG9055AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public IpegaPG9055AndroidUnityProfile self;
        }
    }
