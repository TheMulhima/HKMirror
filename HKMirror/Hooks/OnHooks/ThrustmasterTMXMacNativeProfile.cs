...
public static class OnThrustmasterTMXMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ThrustmasterTMXMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<ThrustmasterTMXMacNativeProfile> orig, ThrustmasterTMXMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ThrustmasterTMXMacNativeProfile> orig,
            ThrustmasterTMXMacNativeProfile self);

        public sealed class Params_Define
        {
            public ThrustmasterTMXMacNativeProfile self;
        }
    }
