...
public static class Ontk2dUITweenItem
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_UseOnReleaseInsteadOfOnUp()
        {
            if (!HookedList.Contains("get_UseOnReleaseInsteadOfOnUp"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUITweenItem), "get_UseOnReleaseInsteadOfOnUp", true),
        ...
        private static System.Collections.IEnumerator ScaleTween(On.tk2dUITweenItem.orig_ScaleTween orig,
    ...
    public static class Delegates
    {
        ...
        public delegate System.Collections.IEnumerator ScaleTween_AfterArgs(Params_ScaleTween args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator ScaleTween_WithArgs(
            Func<tk2dUITweenItem, System.Collections.IEnumerator> orig, tk2dUITweenItem self);
    ...
    public static class WithOrig
    {
        public static event Delegates.get_UseOnReleaseInsteadOfOnUp_WithArgs get_UseOnReleaseInsteadOfOnUp
        {
            add => HookEndpointManager.Add<Delegates.get_UseOnReleaseInsteadOfOnUp_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITweenItem), "get_UseOnReleaseInsteadOfOnUp", true), value);
