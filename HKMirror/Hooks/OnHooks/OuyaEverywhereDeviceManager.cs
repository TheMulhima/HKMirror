...
public static class OnOuyaEverywhereDeviceManager
{
    internal static class HookHandler
    {
        ...
        internal static void HookUpdate()
        {
            if (!HookedList.Contains("Update"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDeviceManager), "Update", true),
                    Update);
            }
        }
        ...
        private static void Update(Action<InControl.OuyaEverywhereDeviceManager, ulong, float> orig,
            InControl.OuyaEverywhereDeviceManager self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookEnable()
        {
            if (!HookedList.Contains("Enable"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDeviceManager), "Enable", false),
                    Enable);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Update_WithArgs(Action<InControl.OuyaEverywhereDeviceManager, ulong, float> orig,
            InControl.OuyaEverywhereDeviceManager self, ulong updateTick, float deltaTime);
    ...
    public static class WithOrig
    {
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDeviceManager), "Update", true), value);
        ...
        public static event Delegates.Enable_WithArgs Enable
        {
            add => HookEndpointManager.Add<Delegates.Enable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.OuyaEverywhereDeviceManager), "Enable", false), value);
