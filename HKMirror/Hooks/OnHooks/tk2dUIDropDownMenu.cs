...
public static class Ontk2dUIDropDownMenu
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_ItemList()
        {
            if (!HookedList.Contains("get_ItemList"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_ItemList", true),
                    get_ItemList);
            }
        }
        ...
        private static System.Collections.Generic.List<string> get_ItemList(
            Func<tk2dUIDropDownMenu, System.Collections.Generic.List<string>> orig, tk2dUIDropDownMenu self)
        {
        ...
        internal static void Hookset_ItemList()
        {
            if (!HookedList.Contains("set_ItemList"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_ItemList", true),
                    set_ItemList);
            }
        }
        ...
        private static void set_ItemList(Action<tk2dUIDropDownMenu, System.Collections.Generic.List<string>> orig,
            tk2dUIDropDownMenu self, System.Collections.Generic.List<string> value)
        {
        ...
        internal static void Hookget_SelectedItem()
        {
            if (!HookedList.Contains("get_SelectedItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_SelectedItem", true),
                    get_SelectedItem);
            }
        }
        ...
        internal static void Hookget_SendMessageTarget()
        {
            if (!HookedList.Contains("get_SendMessageTarget"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_SendMessageTarget", true),
        ...
        private static UnityEngine.GameObject get_SendMessageTarget(
            Func<tk2dUIDropDownMenu, UnityEngine.GameObject> orig, tk2dUIDropDownMenu self)
        {
        ...
        internal static void Hookset_SendMessageTarget()
        {
            if (!HookedList.Contains("set_SendMessageTarget"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_SendMessageTarget", true),
        ...
        private static void set_SendMessageTarget(Action<tk2dUIDropDownMenu, UnityEngine.GameObject> orig,
            tk2dUIDropDownMenu self, UnityEngine.GameObject value)
        {
        ...
        internal static void Hookget_MenuLayoutItem()
        {
            if (!HookedList.Contains("get_MenuLayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_MenuLayoutItem", true),
                    get_MenuLayoutItem);
            }
        }
            ...
            tk2dUIDropDownMenu self)
        {
            ...
            {
                foreach (Delegates.get_MenuLayoutItem_BeforeArgs toInvoke in
                         _beforeget_MenuLayoutItem.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_MenuLayoutItem_AfterArgs toInvoke in
                         _afterget_MenuLayoutItem.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_MenuLayoutItem()
        {
            if (!HookedList.Contains("set_MenuLayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_MenuLayoutItem", true),
                    set_MenuLayoutItem);
            }
        }
            ...
            tk2dUILayout value)
        {
            ...
            {
                foreach (Delegates.set_MenuLayoutItem_BeforeArgs toInvoke in
                         _beforeset_MenuLayoutItem.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_MenuLayoutItem_AfterArgs toInvoke in
                         _afterset_MenuLayoutItem.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_TemplateLayoutItem()
        {
            if (!HookedList.Contains("get_TemplateLayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_TemplateLayoutItem", true),
            ...
            tk2dUIDropDownMenu self)
        {
            ...
            {
                foreach (Delegates.get_TemplateLayoutItem_BeforeArgs toInvoke in _beforeget_TemplateLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_TemplateLayoutItem_AfterArgs toInvoke in _afterget_TemplateLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_TemplateLayoutItem()
        {
            if (!HookedList.Contains("set_TemplateLayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_TemplateLayoutItem", true),
            ...
            tk2dUIDropDownMenu self, tk2dUILayout value)
        {
            ...
            {
                foreach (Delegates.set_TemplateLayoutItem_BeforeArgs toInvoke in _beforeset_TemplateLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_TemplateLayoutItem_AfterArgs toInvoke in _afterset_TemplateLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            On.tk2dUIDropDownMenu.orig_CreateAnotherDropDownItem orig, tk2dUIDropDownMenu self)
        {
            ...
            {
                foreach (Delegates.CreateAnotherDropDownItem_BeforeArgs toInvoke in _beforeCreateAnotherDropDownItem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CreateAnotherDropDownItem_AfterArgs toInvoke in _afterCreateAnotherDropDownItem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIDropDownMenu self)
        {
            ...
            {
                foreach (Delegates.ExpandButtonPressed_BeforeArgs toInvoke in _beforeExpandButtonPressed
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ExpandButtonPressed_AfterArgs toInvoke in
                         _afterExpandButtonPressed.GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIDropDownMenu self, tk2dUIUpDownHoverButton upDownHoverButton)
        {
            ...
            {
                foreach (Delegates.DropDownItemHoverBtnToggle_BeforeArgs toInvoke in _beforeDropDownItemHoverBtnToggle
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.DropDownItemHoverBtnToggle_AfterArgs toInvoke in _afterDropDownItemHoverBtnToggle
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate System.Collections.Generic.List<string> get_ItemList_AfterArgs(Params_get_ItemList args,
            System.Collections.Generic.List<string> ret);

        public delegate System.Collections.Generic.List<string> get_ItemList_WithArgs(
            Func<tk2dUIDropDownMenu, System.Collections.Generic.List<string>> orig, tk2dUIDropDownMenu self);
        ...
        public delegate void set_ItemList_WithArgs(
            Action<tk2dUIDropDownMenu, System.Collections.Generic.List<string>> orig, tk2dUIDropDownMenu self,
        ...
        public delegate void set_Index_WithArgs(Action<tk2dUIDropDownMenu, int> orig, tk2dUIDropDownMenu self,
            int value);
        ...
        public delegate string
            get_SelectedItem_WithArgs(Func<tk2dUIDropDownMenu, string> orig, tk2dUIDropDownMenu self);
        ...
        public delegate void set_SendMessageTarget_WithArgs(Action<tk2dUIDropDownMenu, UnityEngine.GameObject> orig,
            tk2dUIDropDownMenu self, UnityEngine.GameObject value);
        ...
        public delegate tk2dUILayout get_MenuLayoutItem_WithArgs(Func<tk2dUIDropDownMenu, tk2dUILayout> orig,
            tk2dUIDropDownMenu self);
        ...
        public delegate void set_MenuLayoutItem_WithArgs(Action<tk2dUIDropDownMenu, tk2dUILayout> orig,
            tk2dUIDropDownMenu self, tk2dUILayout value);
        ...
        public delegate tk2dUILayout get_TemplateLayoutItem_AfterArgs(Params_get_TemplateLayoutItem args,
            tk2dUILayout ret);

        public delegate tk2dUILayout get_TemplateLayoutItem_WithArgs(Func<tk2dUIDropDownMenu, tk2dUILayout> orig,
            tk2dUIDropDownMenu self);
        ...
        public delegate void set_TemplateLayoutItem_WithArgs(Action<tk2dUIDropDownMenu, tk2dUILayout> orig,
            tk2dUIDropDownMenu self, tk2dUILayout value);
        ...
        public delegate tk2dUIDropDownItem CreateAnotherDropDownItem_AfterArgs(Params_CreateAnotherDropDownItem args,
            tk2dUIDropDownItem ret);

        public delegate tk2dUIDropDownItem CreateAnotherDropDownItem_WithArgs(
            Func<tk2dUIDropDownMenu, tk2dUIDropDownItem> orig, tk2dUIDropDownMenu self);
        ...
        public delegate void ItemSelected_WithArgs(Action<tk2dUIDropDownMenu, tk2dUIDropDownItem> orig,
            tk2dUIDropDownMenu self, tk2dUIDropDownItem item);
        ...
        public delegate void DropDownItemHoverBtnToggle_WithArgs(
            Action<tk2dUIDropDownMenu, tk2dUIUpDownHoverButton> orig, tk2dUIDropDownMenu self,
            tk2dUIUpDownHoverButton upDownHoverButton);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_ItemList_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_ItemList", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_ItemList_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_ItemList", true), value);
        }

        public static event Delegates.set_ItemList_WithArgs set_ItemList
        {
            add => HookEndpointManager.Add<Delegates.set_ItemList_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_ItemList", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_ItemList_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_ItemList", true), value);
        }
        ...
        public static event Delegates.get_Index_WithArgs get_Index
        {
            add => HookEndpointManager.Add<Delegates.get_Index_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_Index", true), value);
        ...
        public static event Delegates.set_Index_WithArgs set_Index
        {
            add => HookEndpointManager.Add<Delegates.set_Index_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_Index", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_SelectedItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_SelectedItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_SelectedItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_SelectedItem", true), value);
        }
        ...
        public static event Delegates.get_SendMessageTarget_WithArgs get_SendMessageTarget
        {
            add => HookEndpointManager.Add<Delegates.get_SendMessageTarget_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_SendMessageTarget", true), value);
        ...
        public static event Delegates.set_SendMessageTarget_WithArgs set_SendMessageTarget
        {
            add => HookEndpointManager.Add<Delegates.set_SendMessageTarget_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_SendMessageTarget", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_MenuLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_MenuLayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_MenuLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_MenuLayoutItem", true), value);
        }

        public static event Delegates.set_MenuLayoutItem_WithArgs set_MenuLayoutItem
        {
            add => HookEndpointManager.Add<Delegates.set_MenuLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_MenuLayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_MenuLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_MenuLayoutItem", true), value);
        }

        public static event Delegates.get_TemplateLayoutItem_WithArgs get_TemplateLayoutItem
        {
            add => HookEndpointManager.Add<Delegates.get_TemplateLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_TemplateLayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_TemplateLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "get_TemplateLayoutItem", true), value);
        }

        public static event Delegates.set_TemplateLayoutItem_WithArgs set_TemplateLayoutItem
        {
            add => HookEndpointManager.Add<Delegates.set_TemplateLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_TemplateLayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_TemplateLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownMenu), "set_TemplateLayoutItem", true), value);
        }
