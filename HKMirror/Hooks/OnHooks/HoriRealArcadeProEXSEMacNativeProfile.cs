...
public static class OnHoriRealArcadeProEXSEMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriRealArcadeProEXSEMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriRealArcadeProEXSEMacNativeProfile> orig,
            HoriRealArcadeProEXSEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriRealArcadeProEXSEMacNativeProfile> orig,
            HoriRealArcadeProEXSEMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriRealArcadeProEXSEMacNativeProfile self;
        }
    }
