...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsFadingMenu", true), get_IsFadingMenu);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsAnimatingMenus", true), get_IsAnimatingMenus);
...
{
foreach (Delegates.get_IsAnimatingMenus_BeforeArgs toInvoke in _beforeget_IsAnimatingMenus.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsAnimatingMenus_AfterArgs toInvoke in _afterget_IsAnimatingMenus.GetInvocationList())
{
try
{
...
private static void SetState(On.UIManager.orig_SetState orig,UIManager self,  GlobalEnums.UIState newState)
{
...
private static void SetMenuState(On.UIManager.orig_SetMenuState orig,UIManager self,  GlobalEnums.MainMenuState newState)
{
...
private static void SetUIStartState(On.UIManager.orig_SetUIStartState orig,UIManager self,  GlobalEnums.GameState gameState)
{
...
private static System.Collections.IEnumerator ShowMainMenuHome(On.UIManager.orig_ShowMainMenuHome orig,UIManager self)
{
...
private static UnityEngine.Coroutine StartMenuAnimationCoroutine(On.UIManager.orig_StartMenuAnimationCoroutine orig,UIManager self,  System.Collections.IEnumerator routine)
{
...
{
foreach (Delegates.StartMenuAnimationCoroutine_BeforeArgs toInvoke in _beforeStartMenuAnimationCoroutine.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StartMenuAnimationCoroutine_AfterArgs toInvoke in _afterStartMenuAnimationCoroutine.GetInvocationList())
{
try
{
...
internal static event Delegates.StartMenuAnimationCoroutineWorker_BeforeArgs _beforeStartMenuAnimationCoroutineWorker;
private static System.Collections.IEnumerator StartMenuAnimationCoroutineWorker(On.UIManager.orig_StartMenuAnimationCoroutineWorker orig,UIManager self,  System.Collections.IEnumerator routine)
{
...
{
foreach (Delegates.StartMenuAnimationCoroutineWorker_BeforeArgs toInvoke in _beforeStartMenuAnimationCoroutineWorker.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToOptionsMenu_BeforeArgs toInvoke in _beforeUIGoToOptionsMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UILeaveOptionsMenu_BeforeArgs toInvoke in _beforeUILeaveOptionsMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UILeaveOptionsMenu_AfterArgs toInvoke in _afterUILeaveOptionsMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIExplicitSwitchUser_BeforeArgs toInvoke in _beforeUIExplicitSwitchUser.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIExplicitSwitchUser_AfterArgs toInvoke in _afterUIExplicitSwitchUser.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToProfileMenu_BeforeArgs toInvoke in _beforeUIGoToProfileMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIReturnToProfileMenu_BeforeArgs toInvoke in _beforeUIReturnToProfileMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIReturnToProfileMenu_AfterArgs toInvoke in _afterUIReturnToProfileMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToControllerMenu_BeforeArgs toInvoke in _beforeUIGoToControllerMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToControllerMenu_AfterArgs toInvoke in _afterUIGoToControllerMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToRemapControllerMenu_BeforeArgs toInvoke in _beforeUIGoToRemapControllerMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToRemapControllerMenu_AfterArgs toInvoke in _afterUIGoToRemapControllerMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToKeyboardMenu_BeforeArgs toInvoke in _beforeUIGoToKeyboardMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToKeyboardMenu_AfterArgs toInvoke in _afterUIGoToKeyboardMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToOverscanMenu_BeforeArgs toInvoke in _beforeUIGoToOverscanMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToOverscanMenu_AfterArgs toInvoke in _afterUIGoToOverscanMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToBrightnessMenu_BeforeArgs toInvoke in _beforeUIGoToBrightnessMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToBrightnessMenu_AfterArgs toInvoke in _afterUIGoToBrightnessMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToGameOptionsMenu_BeforeArgs toInvoke in _beforeUIGoToGameOptionsMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToGameOptionsMenu_AfterArgs toInvoke in _afterUIGoToGameOptionsMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToAchievementsMenu_BeforeArgs toInvoke in _beforeUIGoToAchievementsMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToAchievementsMenu_AfterArgs toInvoke in _afterUIGoToAchievementsMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToExtrasContentMenu_BeforeArgs toInvoke in _beforeUIGoToExtrasContentMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToExtrasContentMenu_AfterArgs toInvoke in _afterUIGoToExtrasContentMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIShowQuitGamePrompt_BeforeArgs toInvoke in _beforeUIShowQuitGamePrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIShowQuitGamePrompt_AfterArgs toInvoke in _afterUIShowQuitGamePrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIShowReturnMenuPrompt_BeforeArgs toInvoke in _beforeUIShowReturnMenuPrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIShowReturnMenuPrompt_AfterArgs toInvoke in _afterUIShowReturnMenuPrompt.GetInvocationList())
{
try
{
...
private static void UIShowResolutionPrompt(On.UIManager.orig_UIShowResolutionPrompt orig,UIManager self,  bool startTimer)
{
...
{
foreach (Delegates.UIShowResolutionPrompt_BeforeArgs toInvoke in _beforeUIShowResolutionPrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIShowResolutionPrompt_AfterArgs toInvoke in _afterUIShowResolutionPrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UILeaveExitToMenuPrompt_BeforeArgs toInvoke in _beforeUILeaveExitToMenuPrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UILeaveExitToMenuPrompt_AfterArgs toInvoke in _afterUILeaveExitToMenuPrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToPlayModeMenu_BeforeArgs toInvoke in _beforeUIGoToPlayModeMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToPlayModeMenu_AfterArgs toInvoke in _afterUIGoToPlayModeMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIReturnToMainMenu_BeforeArgs toInvoke in _beforeUIReturnToMainMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIReturnToMainMenu_AfterArgs toInvoke in _afterUIReturnToMainMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIGoToMenuCredits_BeforeArgs toInvoke in _beforeUIGoToMenuCredits.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIStartNewGameContinue_BeforeArgs toInvoke in _beforeUIStartNewGameContinue.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIStartNewGameContinue_AfterArgs toInvoke in _afterUIStartNewGameContinue.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToEngageMenu(On.UIManager.orig_GoToEngageMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToNoSaveMenu(On.UIManager.orig_GoToNoSaveMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToMainMenu(On.UIManager.orig_GoToMainMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToProfileMenu(On.UIManager.orig_GoToProfileMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator PrepareSaveFilesInOrder(On.UIManager.orig_PrepareSaveFilesInOrder orig,UIManager self)
{
...
{
foreach (Delegates.PrepareSaveFilesInOrder_BeforeArgs toInvoke in _beforePrepareSaveFilesInOrder.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToOptionsMenu(On.UIManager.orig_GoToOptionsMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToControllerMenu(On.UIManager.orig_GoToControllerMenu orig,UIManager self)
{
...
{
foreach (Delegates.GoToControllerMenu_BeforeArgs toInvoke in _beforeGoToControllerMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToRemapControllerMenu(On.UIManager.orig_GoToRemapControllerMenu orig,UIManager self)
{
...
{
foreach (Delegates.GoToRemapControllerMenu_BeforeArgs toInvoke in _beforeGoToRemapControllerMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToKeyboardMenu(On.UIManager.orig_GoToKeyboardMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToAudioMenu(On.UIManager.orig_GoToAudioMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToVideoMenu(On.UIManager.orig_GoToVideoMenu orig,UIManager self,  bool rollbackRes)
{
...
private static System.Collections.IEnumerator GoToOverscanMenu(On.UIManager.orig_GoToOverscanMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToBrightnessMenu(On.UIManager.orig_GoToBrightnessMenu orig,UIManager self)
{
...
{
foreach (Delegates.GoToBrightnessMenu_BeforeArgs toInvoke in _beforeGoToBrightnessMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToGameOptionsMenu(On.UIManager.orig_GoToGameOptionsMenu orig,UIManager self)
{
...
{
foreach (Delegates.GoToGameOptionsMenu_BeforeArgs toInvoke in _beforeGoToGameOptionsMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToAchievementsMenu(On.UIManager.orig_GoToAchievementsMenu orig,UIManager self)
{
...
{
foreach (Delegates.GoToAchievementsMenu_BeforeArgs toInvoke in _beforeGoToAchievementsMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToExtrasMenu(On.UIManager.orig_GoToExtrasMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToExtrasContentMenu(On.UIManager.orig_GoToExtrasContentMenu orig,UIManager self)
{
...
{
foreach (Delegates.GoToExtrasContentMenu_BeforeArgs toInvoke in _beforeGoToExtrasContentMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToQuitGamePrompt(On.UIManager.orig_GoToQuitGamePrompt orig,UIManager self)
{
...
{
foreach (Delegates.GoToQuitGamePrompt_BeforeArgs toInvoke in _beforeGoToQuitGamePrompt.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToReturnMenuPrompt(On.UIManager.orig_GoToReturnMenuPrompt orig,UIManager self)
{
...
{
foreach (Delegates.GoToReturnMenuPrompt_BeforeArgs toInvoke in _beforeGoToReturnMenuPrompt.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToResolutionPrompt(On.UIManager.orig_GoToResolutionPrompt orig,UIManager self,  bool startTimer)
{
...
{
foreach (Delegates.GoToResolutionPrompt_BeforeArgs toInvoke in _beforeGoToResolutionPrompt.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator LeaveOptionsMenu(On.UIManager.orig_LeaveOptionsMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator LeaveExitToMenuPrompt(On.UIManager.orig_LeaveExitToMenuPrompt orig,UIManager self)
{
...
{
foreach (Delegates.LeaveExitToMenuPrompt_BeforeArgs toInvoke in _beforeLeaveExitToMenuPrompt.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator GoToPlayModeMenu(On.UIManager.orig_GoToPlayModeMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator ReturnToMainMenu(On.UIManager.orig_ReturnToMainMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToPauseMenu(On.UIManager.orig_GoToPauseMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator GoToMenuCredits(On.UIManager.orig_GoToMenuCredits orig,UIManager self)
{
...
internal static void HookShowCutscenePrompt()
{
if (!HookedList.Contains("ShowCutscenePrompt"))
{
HookedList.Add("ShowCutscenePrompt");
On.UIManager.ShowCutscenePrompt += ShowCutscenePrompt;

}
}
internal static event Delegates.ShowCutscenePrompt_BeforeArgs _beforeShowCutscenePrompt;
internal static event Delegates.ShowCutscenePrompt_AfterArgs _afterShowCutscenePrompt;
private static void ShowCutscenePrompt(On.UIManager.orig_ShowCutscenePrompt orig,UIManager self,  CinematicSkipPopup.Texts text)
{
Delegates.Params_ShowCutscenePrompt @params = new() 
{
self = self
, text = text
};
if (_beforeShowCutscenePrompt != null)
{
foreach (Delegates.ShowCutscenePrompt_BeforeArgs toInvoke in _beforeShowCutscenePrompt.GetInvocationList())
{
try
{
_beforeShowCutscenePrompt?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
text = @params.text;
orig(self, text);
if (_afterShowCutscenePrompt != null)
{
foreach (Delegates.ShowCutscenePrompt_AfterArgs toInvoke in _afterShowCutscenePrompt.GetInvocationList())
{
try
{
_afterShowCutscenePrompt.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
{
foreach (Delegates.HideCutscenePrompt_BeforeArgs toInvoke in _beforeHideCutscenePrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.HideCutscenePrompt_AfterArgs toInvoke in _afterHideCutscenePrompt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyAudioMenuSettings_BeforeArgs toInvoke in _beforeApplyAudioMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyAudioMenuSettings_AfterArgs toInvoke in _afterApplyAudioMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyVideoMenuSettings_BeforeArgs toInvoke in _beforeApplyVideoMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyVideoMenuSettings_AfterArgs toInvoke in _afterApplyVideoMenuSettings.GetInvocationList())
{
try
{
...
private static void ApplyControllerMenuSettings(On.UIManager.orig_ApplyControllerMenuSettings orig,UIManager self)
{
...
{
foreach (Delegates.ApplyControllerMenuSettings_BeforeArgs toInvoke in _beforeApplyControllerMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyControllerMenuSettings_AfterArgs toInvoke in _afterApplyControllerMenuSettings.GetInvocationList())
{
try
{
...
private static void ApplyRemapGamepadMenuSettings(On.UIManager.orig_ApplyRemapGamepadMenuSettings orig,UIManager self)
{
...
{
foreach (Delegates.ApplyRemapGamepadMenuSettings_BeforeArgs toInvoke in _beforeApplyRemapGamepadMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyRemapGamepadMenuSettings_AfterArgs toInvoke in _afterApplyRemapGamepadMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyKeyboardMenuSettings_BeforeArgs toInvoke in _beforeApplyKeyboardMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyKeyboardMenuSettings_AfterArgs toInvoke in _afterApplyKeyboardMenuSettings.GetInvocationList())
{
try
{
...
private static void ApplyOverscanSettings(On.UIManager.orig_ApplyOverscanSettings orig,UIManager self,  bool goToBrightness)
{
Delegates.Params_ApplyOverscanSettings @params = new() 
{
self = self
, goToBrightness = goToBrightness
};
if (_beforeApplyOverscanSettings != null)
{
foreach (Delegates.ApplyOverscanSettings_BeforeArgs toInvoke in _beforeApplyOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyOverscanSettings_AfterArgs toInvoke in _afterApplyOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyBrightnessSettings_BeforeArgs toInvoke in _beforeApplyBrightnessSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyBrightnessSettings_AfterArgs toInvoke in _afterApplyBrightnessSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyGameMenuSettings_BeforeArgs toInvoke in _beforeApplyGameMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyGameMenuSettings_AfterArgs toInvoke in _afterApplyGameMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveOverscanSettings_BeforeArgs toInvoke in _beforeSaveOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveOverscanSettings_AfterArgs toInvoke in _afterSaveOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveBrightnessSettings_BeforeArgs toInvoke in _beforeSaveBrightnessSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveBrightnessSettings_AfterArgs toInvoke in _afterSaveBrightnessSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultAudioMenuSettings_BeforeArgs toInvoke in _beforeDefaultAudioMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultAudioMenuSettings_AfterArgs toInvoke in _afterDefaultAudioMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultVideoMenuSettings_BeforeArgs toInvoke in _beforeDefaultVideoMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultVideoMenuSettings_AfterArgs toInvoke in _afterDefaultVideoMenuSettings.GetInvocationList())
{
try
{
...
private static void DefaultGamepadMenuSettings(On.UIManager.orig_DefaultGamepadMenuSettings orig,UIManager self)
{
...
{
foreach (Delegates.DefaultGamepadMenuSettings_BeforeArgs toInvoke in _beforeDefaultGamepadMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultGamepadMenuSettings_AfterArgs toInvoke in _afterDefaultGamepadMenuSettings.GetInvocationList())
{
try
{
...
private static void DefaultKeyboardMenuSettings(On.UIManager.orig_DefaultKeyboardMenuSettings orig,UIManager self)
{
...
{
foreach (Delegates.DefaultKeyboardMenuSettings_BeforeArgs toInvoke in _beforeDefaultKeyboardMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultKeyboardMenuSettings_AfterArgs toInvoke in _afterDefaultKeyboardMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultGameMenuSettings_BeforeArgs toInvoke in _beforeDefaultGameMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DefaultGameMenuSettings_AfterArgs toInvoke in _afterDefaultGameMenuSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadStoredSettings_BeforeArgs toInvoke in _beforeLoadStoredSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadStoredSettings_AfterArgs toInvoke in _afterLoadStoredSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadAudioSettings_BeforeArgs toInvoke in _beforeLoadAudioSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadVideoSettings_BeforeArgs toInvoke in _beforeLoadVideoSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadGameOptionsSettings_BeforeArgs toInvoke in _beforeLoadGameOptionsSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadGameOptionsSettings_AfterArgs toInvoke in _afterLoadGameOptionsSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadControllerSettings_BeforeArgs toInvoke in _beforeLoadControllerSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadControllerSettings_AfterArgs toInvoke in _afterLoadControllerSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshAudioControls_BeforeArgs toInvoke in _beforeRefreshAudioControls.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshAudioControls_AfterArgs toInvoke in _afterRefreshAudioControls.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshVideoControls_BeforeArgs toInvoke in _beforeRefreshVideoControls.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshVideoControls_AfterArgs toInvoke in _afterRefreshVideoControls.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DisableVsyncSetting_BeforeArgs toInvoke in _beforeDisableVsyncSetting.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DisableVsyncSetting_AfterArgs toInvoke in _afterDisableVsyncSetting.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshKeyboardControls_BeforeArgs toInvoke in _beforeRefreshKeyboardControls.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshKeyboardControls_AfterArgs toInvoke in _afterRefreshKeyboardControls.GetInvocationList())
{
try
{
...
private static void RefreshGameOptionsControls(On.UIManager.orig_RefreshGameOptionsControls orig,UIManager self)
{
...
{
foreach (Delegates.RefreshGameOptionsControls_BeforeArgs toInvoke in _beforeRefreshGameOptionsControls.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshGameOptionsControls_AfterArgs toInvoke in _afterRefreshGameOptionsControls.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshAchievementsList_BeforeArgs toInvoke in _beforeRefreshAchievementsList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshAchievementsList_AfterArgs toInvoke in _afterRefreshAchievementsList.GetInvocationList())
{
try
{
...
private static void UpdateMenuAchievementStatus(On.UIManager.orig_UpdateMenuAchievementStatus orig,UIManager self,  Achievement ach,  MenuAchievement menuAch)
{
...
{
foreach (Delegates.UpdateMenuAchievementStatus_BeforeArgs toInvoke in _beforeUpdateMenuAchievementStatus.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateMenuAchievementStatus_AfterArgs toInvoke in _afterUpdateMenuAchievementStatus.GetInvocationList())
{
try
{
...
private static void AudioGoToPauseMenu(On.UIManager.orig_AudioGoToPauseMenu orig,UIManager self,  float duration)
{
...
{
foreach (Delegates.AudioGoToPauseMenu_BeforeArgs toInvoke in _beforeAudioGoToPauseMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AudioGoToPauseMenu_AfterArgs toInvoke in _afterAudioGoToPauseMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AudioGoToGameplay_BeforeArgs toInvoke in _beforeAudioGoToGameplay.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator HideCurrentMenu(On.UIManager.orig_HideCurrentMenu orig,UIManager self)
{
...
private static System.Collections.IEnumerator ShowMenu(On.UIManager.orig_ShowMenu orig,UIManager self,  MenuScreen menu)
{
...
private static System.Collections.IEnumerator HideMenu(On.UIManager.orig_HideMenu orig,UIManager self,  MenuScreen menu)
{
...
private static System.Collections.IEnumerator HideSaveProfileMenu(On.UIManager.orig_HideSaveProfileMenu orig,UIManager self)
{
...
{
foreach (Delegates.HideSaveProfileMenu_BeforeArgs toInvoke in _beforeHideSaveProfileMenu.GetInvocationList())
{
try
{
...
private static void ShowCanvas(On.UIManager.orig_ShowCanvas orig,UIManager self,  UnityEngine.Canvas canvas)
{
...
private static void HideCanvas(On.UIManager.orig_HideCanvas orig,UIManager self,  UnityEngine.Canvas canvas)
{
...
private static void ShowCanvasGroup(On.UIManager.orig_ShowCanvasGroup orig,UIManager self,  UnityEngine.CanvasGroup cg)
{
...
private static void HideCanvasGroup(On.UIManager.orig_HideCanvasGroup orig,UIManager self,  UnityEngine.CanvasGroup cg)
{
...
private static System.Collections.IEnumerator FadeInCanvasGroup(On.UIManager.orig_FadeInCanvasGroup orig,UIManager self,  UnityEngine.CanvasGroup cg)
{
...
{
foreach (Delegates.FadeInCanvasGroup_BeforeArgs toInvoke in _beforeFadeInCanvasGroup.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator FadeInCanvasGroupAlpha(On.UIManager.orig_FadeInCanvasGroupAlpha orig,UIManager self,  UnityEngine.CanvasGroup cg,  float endAlpha)
{
...
{
foreach (Delegates.FadeInCanvasGroupAlpha_BeforeArgs toInvoke in _beforeFadeInCanvasGroupAlpha.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator FadeOutCanvasGroup(On.UIManager.orig_FadeOutCanvasGroup orig,UIManager self,  UnityEngine.CanvasGroup cg)
{
...
{
foreach (Delegates.FadeOutCanvasGroup_BeforeArgs toInvoke in _beforeFadeOutCanvasGroup.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator FadeInSprite(On.UIManager.orig_FadeInSprite orig,UIManager self,  UnityEngine.SpriteRenderer sprite)
{
...
private static System.Collections.IEnumerator FadeOutSprite(On.UIManager.orig_FadeOutSprite orig,UIManager self,  UnityEngine.SpriteRenderer sprite)
{
...
private static void EnableChildren_RectTransform(On.UIManager.orig_EnableChildren_RectTransform orig,UIManager self,  UnityEngine.RectTransform parent)
{
...
{
foreach (Delegates.EnableChildren_RectTransform_BeforeArgs toInvoke in _beforeEnableChildren_RectTransform.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnableChildren_RectTransform_AfterArgs toInvoke in _afterEnableChildren_RectTransform.GetInvocationList())
{
try
{
...
private static void EnableChildren_Canvas(On.UIManager.orig_EnableChildren_Canvas orig,UIManager self,  UnityEngine.Canvas parent)
{
...
{
foreach (Delegates.EnableChildren_Canvas_BeforeArgs toInvoke in _beforeEnableChildren_Canvas.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnableChildren_Canvas_AfterArgs toInvoke in _afterEnableChildren_Canvas.GetInvocationList())
{
try
{
...
private static void DisableChildren(On.UIManager.orig_DisableChildren orig,UIManager self,  UnityEngine.Canvas parent)
{
...
private static float GetAnimationClipLength(On.UIManager.orig_GetAnimationClipLength orig,UIManager self,  UnityEngine.Animator animator,  string clipName)
{
...
{
foreach (Delegates.GetAnimationClipLength_BeforeArgs toInvoke in _beforeGetAnimationClipLength.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetAnimationClipLength_AfterArgs toInvoke in _afterGetAnimationClipLength.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_currentDynamicMenu", true), get_currentDynamicMenu);
...
{
foreach (Delegates.get_currentDynamicMenu_BeforeArgs toInvoke in _beforeget_currentDynamicMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_currentDynamicMenu_AfterArgs toInvoke in _afterget_currentDynamicMenu.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "set_currentDynamicMenu", true), set_currentDynamicMenu);
...
{
foreach (Delegates.set_currentDynamicMenu_BeforeArgs toInvoke in _beforeset_currentDynamicMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_currentDynamicMenu_AfterArgs toInvoke in _afterset_currentDynamicMenu.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_get_instance", false), orig_get_instance);
...
{
foreach (Delegates.orig_get_instance_BeforeArgs toInvoke in _beforeorig_get_instance.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LoadImage", true), LoadImage);
...
private static UnityEngine.Sprite LoadImage(Func<UIManager, UnityEngine.Sprite> orig, UIManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Awake", true), orig_Awake);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Start", true), orig_Start);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_HideCurrentMenu", true), orig_HideCurrentMenu);

}
}
internal static event Delegates.orig_HideCurrentMenu_BeforeArgs _beforeorig_HideCurrentMenu;
private static System.Collections.IEnumerator orig_HideCurrentMenu(Func<UIManager, System.Collections.IEnumerator> orig, UIManager self)
{
...
{
foreach (Delegates.orig_HideCurrentMenu_BeforeArgs toInvoke in _beforeorig_HideCurrentMenu.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIGoToDynamicMenu", true), UIGoToDynamicMenu);
...
{
foreach (Delegates.UIGoToDynamicMenu_BeforeArgs toInvoke in _beforeUIGoToDynamicMenu.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToDynamicMenu", true), GoToDynamicMenu);

}
}
internal static event Delegates.GoToDynamicMenu_BeforeArgs _beforeGoToDynamicMenu;
private static System.Collections.IEnumerator GoToDynamicMenu(Func<UIManager,  MenuScreen, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen menu)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UILeaveDynamicMenu", true), UILeaveDynamicMenu);
...
private static void UILeaveDynamicMenu(Action<UIManager,  MenuScreen,  GlobalEnums.MainMenuState> orig, UIManager self,  MenuScreen to,  GlobalEnums.MainMenuState state)
{
...
{
foreach (Delegates.UILeaveDynamicMenu_BeforeArgs toInvoke in _beforeUILeaveDynamicMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UILeaveDynamicMenu_AfterArgs toInvoke in _afterUILeaveDynamicMenu.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveDynamicMenu", true), LeaveDynamicMenu);

}
}
internal static event Delegates.LeaveDynamicMenu_BeforeArgs _beforeLeaveDynamicMenu;
private static System.Collections.IEnumerator LeaveDynamicMenu(Func<UIManager,  MenuScreen,  GlobalEnums.MainMenuState, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen to,  GlobalEnums.MainMenuState state)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIPauseToDynamicMenu", true), UIPauseToDynamicMenu);
...
{
foreach (Delegates.UIPauseToDynamicMenu_BeforeArgs toInvoke in _beforeUIPauseToDynamicMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UIPauseToDynamicMenu_AfterArgs toInvoke in _afterUIPauseToDynamicMenu.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UIManager), "PauseToDynamicMenu", true), PauseToDynamicMenu);

}
}
internal static event Delegates.PauseToDynamicMenu_BeforeArgs _beforePauseToDynamicMenu;
private static System.Collections.IEnumerator PauseToDynamicMenu(Func<UIManager,  MenuScreen, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen to)
{
...
{
foreach (Delegates.PauseToDynamicMenu_BeforeArgs toInvoke in _beforePauseToDynamicMenu.GetInvocationList())
{
try
{
...
{
public UIManager self;
public GlobalEnums.UIState newState;
}
...
public delegate void SetState_WithArgs (Action<UIManager,  GlobalEnums.UIState> orig, UIManager self,  GlobalEnums.UIState newState);
public sealed class Params_SetMenuState
{
public UIManager self;
public GlobalEnums.MainMenuState newState;
}
...
public delegate void SetMenuState_WithArgs (Action<UIManager,  GlobalEnums.MainMenuState> orig, UIManager self,  GlobalEnums.MainMenuState newState);
...
public delegate void SetUIStartState_WithArgs (Action<UIManager,  GlobalEnums.GameState> orig, UIManager self,  GlobalEnums.GameState gameState);
public sealed class Params_ShowMainMenuHome
{
public UIManager self;
}
public delegate void ShowMainMenuHome_BeforeArgs(Params_ShowMainMenuHome args);
public delegate System.Collections.IEnumerator ShowMainMenuHome_AfterArgs(Params_ShowMainMenuHome args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ShowMainMenuHome_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate UnityEngine.Coroutine StartMenuAnimationCoroutine_AfterArgs(Params_StartMenuAnimationCoroutine args, UnityEngine.Coroutine ret);
public delegate UnityEngine.Coroutine StartMenuAnimationCoroutine_WithArgs (Func<UIManager,  System.Collections.IEnumerator, UnityEngine.Coroutine> orig, UIManager self,  System.Collections.IEnumerator routine);
public sealed class Params_StartMenuAnimationCoroutineWorker
{
public UIManager self;
public System.Collections.IEnumerator routine;
}
public delegate void StartMenuAnimationCoroutineWorker_BeforeArgs(Params_StartMenuAnimationCoroutineWorker args);
public delegate System.Collections.IEnumerator StartMenuAnimationCoroutineWorker_AfterArgs(Params_StartMenuAnimationCoroutineWorker args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator StartMenuAnimationCoroutineWorker_WithArgs (Func<UIManager,  System.Collections.IEnumerator, System.Collections.IEnumerator> orig, UIManager self,  System.Collections.IEnumerator routine);
...
public delegate void UIShowResolutionPrompt_WithArgs (Action<UIManager,  bool> orig, UIManager self,  bool startTimer);
...
public delegate void StartNewGame_WithArgs (Action<UIManager,  bool,  bool> orig, UIManager self,  bool permaDeath,  bool bossRush);
...
public delegate System.Collections.IEnumerator GoToEngageMenu_AfterArgs(Params_GoToEngageMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToEngageMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToNoSaveMenu
{
public UIManager self;
}
public delegate void GoToNoSaveMenu_BeforeArgs(Params_GoToNoSaveMenu args);
public delegate System.Collections.IEnumerator GoToNoSaveMenu_AfterArgs(Params_GoToNoSaveMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToNoSaveMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToMainMenu
{
public UIManager self;
}
public delegate void GoToMainMenu_BeforeArgs(Params_GoToMainMenu args);
public delegate System.Collections.IEnumerator GoToMainMenu_AfterArgs(Params_GoToMainMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToMainMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToProfileMenu
{
public UIManager self;
}
public delegate void GoToProfileMenu_BeforeArgs(Params_GoToProfileMenu args);
public delegate System.Collections.IEnumerator GoToProfileMenu_AfterArgs(Params_GoToProfileMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToProfileMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator PrepareSaveFilesInOrder_AfterArgs(Params_PrepareSaveFilesInOrder args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PrepareSaveFilesInOrder_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToOptionsMenu
{
public UIManager self;
}
public delegate void GoToOptionsMenu_BeforeArgs(Params_GoToOptionsMenu args);
public delegate System.Collections.IEnumerator GoToOptionsMenu_AfterArgs(Params_GoToOptionsMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToOptionsMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToControllerMenu_AfterArgs(Params_GoToControllerMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToControllerMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToRemapControllerMenu_AfterArgs(Params_GoToRemapControllerMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToRemapControllerMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToKeyboardMenu
{
public UIManager self;
}
public delegate void GoToKeyboardMenu_BeforeArgs(Params_GoToKeyboardMenu args);
public delegate System.Collections.IEnumerator GoToKeyboardMenu_AfterArgs(Params_GoToKeyboardMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToKeyboardMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToAudioMenu
{
public UIManager self;
}
public delegate void GoToAudioMenu_BeforeArgs(Params_GoToAudioMenu args);
public delegate System.Collections.IEnumerator GoToAudioMenu_AfterArgs(Params_GoToAudioMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToAudioMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToVideoMenu_AfterArgs(Params_GoToVideoMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToVideoMenu_WithArgs (Func<UIManager,  bool, System.Collections.IEnumerator> orig, UIManager self,  bool rollbackRes);
public sealed class Params_GoToOverscanMenu
{
public UIManager self;
}
public delegate void GoToOverscanMenu_BeforeArgs(Params_GoToOverscanMenu args);
public delegate System.Collections.IEnumerator GoToOverscanMenu_AfterArgs(Params_GoToOverscanMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToOverscanMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToBrightnessMenu_AfterArgs(Params_GoToBrightnessMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToBrightnessMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToGameOptionsMenu_AfterArgs(Params_GoToGameOptionsMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToGameOptionsMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToAchievementsMenu_AfterArgs(Params_GoToAchievementsMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToAchievementsMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToExtrasMenu
{
public UIManager self;
}
public delegate void GoToExtrasMenu_BeforeArgs(Params_GoToExtrasMenu args);
public delegate System.Collections.IEnumerator GoToExtrasMenu_AfterArgs(Params_GoToExtrasMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToExtrasMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToExtrasContentMenu_AfterArgs(Params_GoToExtrasContentMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToExtrasContentMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToQuitGamePrompt_AfterArgs(Params_GoToQuitGamePrompt args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToQuitGamePrompt_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToReturnMenuPrompt_AfterArgs(Params_GoToReturnMenuPrompt args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToReturnMenuPrompt_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator GoToResolutionPrompt_AfterArgs(Params_GoToResolutionPrompt args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToResolutionPrompt_WithArgs (Func<UIManager,  bool, System.Collections.IEnumerator> orig, UIManager self,  bool startTimer);
public sealed class Params_LeaveOptionsMenu
{
public UIManager self;
}
public delegate void LeaveOptionsMenu_BeforeArgs(Params_LeaveOptionsMenu args);
public delegate System.Collections.IEnumerator LeaveOptionsMenu_AfterArgs(Params_LeaveOptionsMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator LeaveOptionsMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator LeaveExitToMenuPrompt_AfterArgs(Params_LeaveExitToMenuPrompt args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator LeaveExitToMenuPrompt_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToPlayModeMenu
{
public UIManager self;
}
public delegate void GoToPlayModeMenu_BeforeArgs(Params_GoToPlayModeMenu args);
public delegate System.Collections.IEnumerator GoToPlayModeMenu_AfterArgs(Params_GoToPlayModeMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToPlayModeMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator ReturnToMainMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToPauseMenu
{
public UIManager self;
}
public delegate void GoToPauseMenu_BeforeArgs(Params_GoToPauseMenu args);
public delegate System.Collections.IEnumerator GoToPauseMenu_AfterArgs(Params_GoToPauseMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToPauseMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_GoToMenuCredits
{
public UIManager self;
}
public delegate void GoToMenuCredits_BeforeArgs(Params_GoToMenuCredits args);
public delegate System.Collections.IEnumerator GoToMenuCredits_AfterArgs(Params_GoToMenuCredits args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToMenuCredits_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
public sealed class Params_ShowCutscenePrompt
{
public UIManager self;
public CinematicSkipPopup.Texts text;
}
public delegate void ShowCutscenePrompt_BeforeArgs(Params_ShowCutscenePrompt args);
public delegate void ShowCutscenePrompt_AfterArgs(Params_ShowCutscenePrompt args);
public delegate void ShowCutscenePrompt_WithArgs (Action<UIManager,  CinematicSkipPopup.Texts> orig, UIManager self,  CinematicSkipPopup.Texts text);
...
public delegate void ApplyOverscanSettings_WithArgs (Action<UIManager,  bool> orig, UIManager self,  bool goToBrightness);
...
public delegate void UpdateMenuAchievementStatus_WithArgs (Action<UIManager,  Achievement,  MenuAchievement> orig, UIManager self,  Achievement ach,  MenuAchievement menuAch);
...
public delegate System.Collections.IEnumerator HideCurrentMenu_AfterArgs(Params_HideCurrentMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator HideCurrentMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate System.Collections.IEnumerator ShowMenu_AfterArgs(Params_ShowMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ShowMenu_WithArgs (Func<UIManager,  MenuScreen, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen menu);
...
public delegate System.Collections.IEnumerator HideMenu_AfterArgs(Params_HideMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator HideMenu_WithArgs (Func<UIManager,  MenuScreen, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen menu);
...
public delegate void HideMenuInstant_WithArgs (Action<UIManager,  MenuScreen> orig, UIManager self,  MenuScreen menu);
...
public delegate System.Collections.IEnumerator HideSaveProfileMenu_AfterArgs(Params_HideSaveProfileMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator HideSaveProfileMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate void ShowCanvas_WithArgs (Action<UIManager,  UnityEngine.Canvas> orig, UIManager self,  UnityEngine.Canvas canvas);
...
public delegate void HideCanvas_WithArgs (Action<UIManager,  UnityEngine.Canvas> orig, UIManager self,  UnityEngine.Canvas canvas);
...
public delegate void ShowCanvasGroup_WithArgs (Action<UIManager,  UnityEngine.CanvasGroup> orig, UIManager self,  UnityEngine.CanvasGroup cg);
...
public delegate void HideCanvasGroup_WithArgs (Action<UIManager,  UnityEngine.CanvasGroup> orig, UIManager self,  UnityEngine.CanvasGroup cg);
...
public delegate System.Collections.IEnumerator FadeInCanvasGroup_AfterArgs(Params_FadeInCanvasGroup args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FadeInCanvasGroup_WithArgs (Func<UIManager,  UnityEngine.CanvasGroup, System.Collections.IEnumerator> orig, UIManager self,  UnityEngine.CanvasGroup cg);
...
public delegate System.Collections.IEnumerator FadeInCanvasGroupAlpha_AfterArgs(Params_FadeInCanvasGroupAlpha args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FadeInCanvasGroupAlpha_WithArgs (Func<UIManager,  UnityEngine.CanvasGroup,  float, System.Collections.IEnumerator> orig, UIManager self,  UnityEngine.CanvasGroup cg,  float endAlpha);
...
public delegate System.Collections.IEnumerator FadeOutCanvasGroup_AfterArgs(Params_FadeOutCanvasGroup args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FadeOutCanvasGroup_WithArgs (Func<UIManager,  UnityEngine.CanvasGroup, System.Collections.IEnumerator> orig, UIManager self,  UnityEngine.CanvasGroup cg);
...
public delegate System.Collections.IEnumerator FadeInSprite_AfterArgs(Params_FadeInSprite args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FadeInSprite_WithArgs (Func<UIManager,  UnityEngine.SpriteRenderer, System.Collections.IEnumerator> orig, UIManager self,  UnityEngine.SpriteRenderer sprite);
...
public delegate System.Collections.IEnumerator FadeOutSprite_AfterArgs(Params_FadeOutSprite args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FadeOutSprite_WithArgs (Func<UIManager,  UnityEngine.SpriteRenderer, System.Collections.IEnumerator> orig, UIManager self,  UnityEngine.SpriteRenderer sprite);
...
public delegate void EnableChildren_RectTransform_WithArgs (Action<UIManager,  UnityEngine.RectTransform> orig, UIManager self,  UnityEngine.RectTransform parent);
public sealed class Params_EnableChildren_Canvas
{
public UIManager self;
public UnityEngine.Canvas parent;
}
...
public delegate void EnableChildren_Canvas_WithArgs (Action<UIManager,  UnityEngine.Canvas> orig, UIManager self,  UnityEngine.Canvas parent);
...
public delegate void DisableChildren_WithArgs (Action<UIManager,  UnityEngine.Canvas> orig, UIManager self,  UnityEngine.Canvas parent);
...
public delegate float GetAnimationClipLength_WithArgs (Func<UIManager,  UnityEngine.Animator,  string, float> orig, UIManager self,  UnityEngine.Animator animator,  string clipName);
...
public delegate void set_currentDynamicMenu_WithArgs (Action<UIManager,  MenuScreen> orig, UIManager self,  MenuScreen value);
...
public delegate UnityEngine.Sprite LoadImage_AfterArgs(Params_LoadImage args, UnityEngine.Sprite ret);
public delegate UnityEngine.Sprite LoadImage_WithArgs (Func<UIManager, UnityEngine.Sprite> orig, UIManager self);
...
public delegate System.Collections.IEnumerator orig_HideCurrentMenu_AfterArgs(Params_orig_HideCurrentMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator orig_HideCurrentMenu_WithArgs (Func<UIManager, System.Collections.IEnumerator> orig, UIManager self);
...
public delegate void UIGoToDynamicMenu_WithArgs (Action<UIManager,  MenuScreen> orig, UIManager self,  MenuScreen menu);
...
public delegate System.Collections.IEnumerator GoToDynamicMenu_AfterArgs(Params_GoToDynamicMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator GoToDynamicMenu_WithArgs (Func<UIManager,  MenuScreen, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen menu);
public sealed class Params_UILeaveDynamicMenu
{
public UIManager self;
public MenuScreen to;
public GlobalEnums.MainMenuState state;
}
...
public delegate void UILeaveDynamicMenu_WithArgs (Action<UIManager,  MenuScreen,  GlobalEnums.MainMenuState> orig, UIManager self,  MenuScreen to,  GlobalEnums.MainMenuState state);
...
public delegate System.Collections.IEnumerator LeaveDynamicMenu_AfterArgs(Params_LeaveDynamicMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator LeaveDynamicMenu_WithArgs (Func<UIManager,  MenuScreen,  GlobalEnums.MainMenuState, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen to,  GlobalEnums.MainMenuState state);
...
public delegate void UIPauseToDynamicMenu_WithArgs (Action<UIManager,  MenuScreen> orig, UIManager self,  MenuScreen to);
...
public delegate System.Collections.IEnumerator PauseToDynamicMenu_AfterArgs(Params_PauseToDynamicMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PauseToDynamicMenu_WithArgs (Func<UIManager,  MenuScreen, System.Collections.IEnumerator> orig, UIManager self,  MenuScreen to);
}
...
public static event Delegates.ShowCutscenePrompt_BeforeArgs ShowCutscenePrompt
{
add
{

HookHandler._beforeShowCutscenePrompt += value;
HookHandler.HookShowCutscenePrompt();
}
remove => HookHandler._beforeShowCutscenePrompt -= value;
}
...
public static event Delegates.ShowCutscenePrompt_AfterArgs ShowCutscenePrompt
{
add
{

HookHandler._afterShowCutscenePrompt += value;
HookHandler.HookShowCutscenePrompt();
}
remove => HookHandler._afterShowCutscenePrompt -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsFadingMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsFadingMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsFadingMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsFadingMenu", true), value);
}
public static event Delegates.get_IsAnimatingMenus_WithArgs get_IsAnimatingMenus
{
add => HookEndpointManager.Add<Delegates.get_IsAnimatingMenus_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsAnimatingMenus", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsAnimatingMenus_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsAnimatingMenus", true), value);
}
public static event Delegates.get_instance_WithArgs get_instance
{
add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_instance", false), value);
}
...
public static event On.UIManager.hook_ShowCutscenePrompt ShowCutscenePrompt
{
add => On.UIManager.ShowCutscenePrompt += value;
remove => On.UIManager.ShowCutscenePrompt -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.get_currentDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_currentDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.get_currentDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_currentDynamicMenu", true), value);
}
public static event Delegates.set_currentDynamicMenu_WithArgs set_currentDynamicMenu
{
add => HookEndpointManager.Add<Delegates.set_currentDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "set_currentDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.set_currentDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "set_currentDynamicMenu", true), value);
}
public static event Delegates.orig_get_instance_WithArgs orig_get_instance
{
add => HookEndpointManager.Add<Delegates.orig_get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.orig_get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_get_instance", false), value);
}
public static event Delegates.LoadImage_WithArgs LoadImage
{
add => HookEndpointManager.Add<Delegates.LoadImage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LoadImage", true), value);
remove => HookEndpointManager.Remove<Delegates.LoadImage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LoadImage", true), value);
}
public static event Delegates.orig_Awake_WithArgs orig_Awake
{
add => HookEndpointManager.Add<Delegates.orig_Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Awake", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Awake", true), value);
}
public static event Delegates.orig_Start_WithArgs orig_Start
{
add => HookEndpointManager.Add<Delegates.orig_Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Start", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Start", true), value);
}
public static event Delegates.orig_HideCurrentMenu_WithArgs orig_HideCurrentMenu
{
add => HookEndpointManager.Add<Delegates.orig_HideCurrentMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_HideCurrentMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_HideCurrentMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_HideCurrentMenu", true), value);
}
public static event Delegates.UIGoToDynamicMenu_WithArgs UIGoToDynamicMenu
{
add => HookEndpointManager.Add<Delegates.UIGoToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIGoToDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.UIGoToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIGoToDynamicMenu", true), value);
}
public static event Delegates.GoToDynamicMenu_WithArgs GoToDynamicMenu
{
add => HookEndpointManager.Add<Delegates.GoToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.GoToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToDynamicMenu", true), value);
}
public static event Delegates.UILeaveDynamicMenu_WithArgs UILeaveDynamicMenu
{
add => HookEndpointManager.Add<Delegates.UILeaveDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UILeaveDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.UILeaveDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UILeaveDynamicMenu", true), value);
}
public static event Delegates.LeaveDynamicMenu_WithArgs LeaveDynamicMenu
{
add => HookEndpointManager.Add<Delegates.LeaveDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.LeaveDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveDynamicMenu", true), value);
}
public static event Delegates.UIPauseToDynamicMenu_WithArgs UIPauseToDynamicMenu
{
add => HookEndpointManager.Add<Delegates.UIPauseToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIPauseToDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.UIPauseToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIPauseToDynamicMenu", true), value);
}
public static event Delegates.PauseToDynamicMenu_WithArgs PauseToDynamicMenu
{
add => HookEndpointManager.Add<Delegates.PauseToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "PauseToDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.PauseToDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UIManager), "PauseToDynamicMenu", true), value);
}
}
