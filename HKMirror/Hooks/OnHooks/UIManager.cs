...
public static class OnUIManager
{
    internal static class HookHandler
    {
        ...
        private static void ShowCutscenePrompt(On.UIManager.orig_ShowCutscenePrompt orig, UIManager self,
            CinematicSkipPopup.Texts text)
        {
            ...
            if (_beforeShowCutscenePrompt != null)
                foreach (Delegates.ShowCutscenePrompt_BeforeArgs toInvoke in
                         _beforeShowCutscenePrompt.GetInvocationList())
                    try
                    {
            ...
            if (_afterShowCutscenePrompt != null)
                foreach (Delegates.ShowCutscenePrompt_AfterArgs toInvoke in
                         _afterShowCutscenePrompt.GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void ShowCutscenePrompt_WithArgs(Action<UIManager, CinematicSkipPopup.Texts> orig,
            UIManager self, CinematicSkipPopup.Texts text);
