...
public static class OnXboxOneWindows10AEUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneWindows10AEUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneWindows10AEUnityProfile> orig, XboxOneWindows10AEUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneWindows10AEUnityProfile> orig,
            XboxOneWindows10AEUnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneWindows10AEUnityProfile self;
        }
    }
