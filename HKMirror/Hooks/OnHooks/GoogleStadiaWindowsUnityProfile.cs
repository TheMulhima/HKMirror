...
public static class OnGoogleStadiaWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GoogleStadiaWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GoogleStadiaWindowsUnityProfile> orig, GoogleStadiaWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GoogleStadiaWindowsUnityProfile> orig,
            GoogleStadiaWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public GoogleStadiaWindowsUnityProfile self;
        }
    }
