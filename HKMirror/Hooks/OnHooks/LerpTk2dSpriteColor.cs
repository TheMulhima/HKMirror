...
public static class OnLerpTk2dSpriteColor
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor),
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self)
        {
        ...
        private static void DoAction(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self);
        ...
        public delegate void DoAction_WithArgs(Action<HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor> orig,
            HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor), "OnUpdate",
                    true), value);
        ...
        public static event Delegates.DoAction_WithArgs DoAction
        {
            add => HookEndpointManager.Add<Delegates.DoAction_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LerpTk2dSpriteColor), "DoAction",
                    true), value);
