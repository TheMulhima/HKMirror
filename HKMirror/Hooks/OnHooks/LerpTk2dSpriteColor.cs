...
public static class OnLerpTk2dSpriteColor
{
    ...
    public static class Delegates
    {
        ...
        public delegate void DoAction_WithArgs(Action<LerpTk2dSpriteColor> orig, LerpTk2dSpriteColor self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<LerpTk2dSpriteColor> orig, LerpTk2dSpriteColor self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<LerpTk2dSpriteColor> orig, LerpTk2dSpriteColor self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<LerpTk2dSpriteColor> orig, LerpTk2dSpriteColor self);
