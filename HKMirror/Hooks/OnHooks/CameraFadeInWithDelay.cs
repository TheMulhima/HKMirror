...
public static class OnCameraFadeInWithDelay
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CameraFadeInWithDelay), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CameraFadeInWithDelay),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self)
        {
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CameraFadeInWithDelay), "OnGUI",
                        true), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.CameraFadeInWithDelay> orig,
            HutongGames.PlayMaker.Actions.CameraFadeInWithDelay self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CameraFadeInWithDelay), "OnEnter",
                    true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CameraFadeInWithDelay), "OnUpdate",
                    true), value);
