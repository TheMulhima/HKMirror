...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetBoolProxy), "Invoke", true), Invoke);
...
private static bool Invoke(Func<Modding.Delegates.SetBoolProxy,  string,  bool, bool> orig, Modding.Delegates.SetBoolProxy self,  string name,  bool orig_)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetBoolProxy), "EndInvoke", true), EndInvoke);
...
private static bool EndInvoke(Func<Modding.Delegates.SetBoolProxy,  System.IAsyncResult, bool> orig, Modding.Delegates.SetBoolProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.SetBoolProxy self;
public string name;
public bool orig_;
}
...
public delegate bool Invoke_WithArgs (Func<Modding.Delegates.SetBoolProxy,  string,  bool, bool> orig, Modding.Delegates.SetBoolProxy self,  string name,  bool orig_);
...
public delegate bool EndInvoke_WithArgs (Func<Modding.Delegates.SetBoolProxy,  System.IAsyncResult, bool> orig, Modding.Delegates.SetBoolProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetBoolProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetBoolProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetBoolProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetBoolProxy), "EndInvoke", true), value);
}
}
