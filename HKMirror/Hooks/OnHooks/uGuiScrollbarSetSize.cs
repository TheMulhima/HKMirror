...
public static class OnuGuiScrollbarSetSize
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "DoSetValue"), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiScrollbarSetSize> orig, uGuiScrollbarSetSize self);

        public sealed class Params_Reset
        {
            public uGuiScrollbarSetSize self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "OnUpdate"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetSize), "OnExit"), value);
