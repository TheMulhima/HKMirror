...
public static class OnEightBitdoSFC30WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSFC30WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSFC30WindowsUnityProfile> orig,
            EightBitdoSFC30WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSFC30WindowsUnityProfile> orig,
            EightBitdoSFC30WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSFC30WindowsUnityProfile self;
        }
    }
