...
public static class OnNexusPlayerWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NexusPlayerWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NexusPlayerWindowsUnityProfile> orig, NexusPlayerWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NexusPlayerWindowsUnityProfile> orig,
            NexusPlayerWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public NexusPlayerWindowsUnityProfile self;
        }
    }
