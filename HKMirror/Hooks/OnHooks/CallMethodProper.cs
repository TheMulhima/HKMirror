...
public static class OnCallMethodProper
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethodProper), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.CallMethodProper> orig,
        ...
        internal static void HookDoMethodCall()
        {
            if (!HookedList.Contains("DoMethodCall"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethodProper),
        ...
        private static void DoMethodCall(Action<HutongGames.PlayMaker.Actions.CallMethodProper> orig,
            HutongGames.PlayMaker.Actions.CallMethodProper self)
        {
        ...
        internal static void HookDoCache()
        {
            if (!HookedList.Contains("DoCache"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethodProper), "DoCache",
                        true), DoCache);
            }
        }
        ...
        private static bool DoCache(Func<HutongGames.PlayMaker.Actions.CallMethodProper, bool> orig,
            HutongGames.PlayMaker.Actions.CallMethodProper self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.CallMethodProper> orig,
            HutongGames.PlayMaker.Actions.CallMethodProper self);
        ...
        public delegate void DoMethodCall_WithArgs(Action<HutongGames.PlayMaker.Actions.CallMethodProper> orig,
            HutongGames.PlayMaker.Actions.CallMethodProper self);
        ...
        public delegate bool DoCache_WithArgs(Func<HutongGames.PlayMaker.Actions.CallMethodProper, bool> orig,
            HutongGames.PlayMaker.Actions.CallMethodProper self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethodProper), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoMethodCall_WithArgs DoMethodCall
        {
            add => HookEndpointManager.Add<Delegates.DoMethodCall_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethodProper), "DoMethodCall",
                    true), value);
        ...
        public static event Delegates.DoCache_WithArgs DoCache
        {
            add => HookEndpointManager.Add<Delegates.DoCache_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethodProper), "DoCache", true),
                value);
