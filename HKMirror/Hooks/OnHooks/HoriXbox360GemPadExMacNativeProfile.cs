...
public static class OnHoriXbox360GemPadExMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.HoriXbox360GemPadExMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.HoriXbox360GemPadExMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.HoriXbox360GemPadExMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.HoriXbox360GemPadExMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.HoriXbox360GemPadExMacNativeProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.HoriXbox360GemPadExMacNativeProfile), "Define", true), value);
