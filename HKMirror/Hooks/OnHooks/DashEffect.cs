...
public static class OnDashEffect
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.PlayDashPuff_NormalArgs _afterPlayDashPuff;
        ...
        private static void PlayDashPuff(On.DashEffect.orig_PlayDashPuff orig, DashEffect self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterPlayDashPuff != null) _afterPlayDashPuff.Invoke(@params);
        }
        ...
        internal static event Delegates.PlayDust_NormalArgs _afterPlayDust;
        ...
        private static void PlayDust(On.DashEffect.orig_PlayDust orig, DashEffect self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterPlayDust != null) _afterPlayDust.Invoke(@params);
        }
        ...
        internal static event Delegates.PlayGrass_NormalArgs _afterPlayGrass;
        ...
        private static void PlayGrass(On.DashEffect.orig_PlayGrass orig, DashEffect self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterPlayGrass != null) _afterPlayGrass.Invoke(@params);
        }
        ...
        internal static event Delegates.PlayBone_NormalArgs _afterPlayBone;
        ...
        private static void PlayBone(On.DashEffect.orig_PlayBone orig, DashEffect self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterPlayBone != null) _afterPlayBone.Invoke(@params);
        }
        ...
        internal static event Delegates.PlaySpaEffects_NormalArgs _afterPlaySpaEffects;
        ...
        private static void PlaySpaEffects(On.DashEffect.orig_PlaySpaEffects orig, DashEffect self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterPlaySpaEffects != null) _afterPlaySpaEffects.Invoke(@params);
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void PlayBone_NormalArgs(Params_PlayBone args);

        public delegate void PlayDashPuff_BeforeArgs(Params_PlayDashPuff args);

        public delegate void PlayDashPuff_NormalArgs(Params_PlayDashPuff args);

        public delegate void PlayDust_BeforeArgs(Params_PlayDust args);

        public delegate void PlayDust_NormalArgs(Params_PlayDust args);

        public delegate void PlayGrass_BeforeArgs(Params_PlayGrass args);

        public delegate void PlayGrass_NormalArgs(Params_PlayGrass args);

        public delegate void PlaySpaEffects_BeforeArgs(Params_PlaySpaEffects args);

        public delegate void PlaySpaEffects_NormalArgs(Params_PlaySpaEffects args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.PlayDashPuff_NormalArgs PlayDashPuff
        {
            add
            {
        ...
        public static event Delegates.PlayDust_NormalArgs PlayDust
        {
            add
            {
        ...
        public static event Delegates.PlayGrass_NormalArgs PlayGrass
        {
            add
            {
        ...
        public static event Delegates.PlayBone_NormalArgs PlayBone
        {
            add
            {
        ...
        public static event Delegates.PlaySpaEffects_NormalArgs PlaySpaEffects
        {
            add
            {
