...
public static class OnTrigger2dEventToParent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<Trigger2dEventToParent> orig, Trigger2dEventToParent self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Trigger2dEventToParent> orig, Trigger2dEventToParent self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<Trigger2dEventToParent> orig, Trigger2dEventToParent self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "StoreCollisionInfo"),
                    StoreCollisionInfo);
            }
        }
        ...
        private static void StoreCollisionInfo(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo)
        {
        ...
        internal static void HookDoTriggerEnter2D()
        {
            if (!HookedList.Contains("DoTriggerEnter2D"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "DoTriggerEnter2D"),
                    DoTriggerEnter2D);
            }
        }
        ...
        private static void DoTriggerEnter2D(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo)
        {
        ...
        internal static void HookDoTriggerStay2D()
        {
            if (!HookedList.Contains("DoTriggerStay2D"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "DoTriggerStay2D"),
                    DoTriggerStay2D);
            }
        }
        ...
        private static void DoTriggerStay2D(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo)
        {
        ...
        internal static void HookDoTriggerExit2D()
        {
            if (!HookedList.Contains("DoTriggerExit2D"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "DoTriggerExit2D"),
                    DoTriggerExit2D);
            }
        }
        ...
        private static void DoTriggerExit2D(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "ErrorCheck"), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<Trigger2dEventToParent, string> orig, Trigger2dEventToParent self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoTriggerEnter2D_WithArgs(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo);
        ...
        public delegate void DoTriggerExit2D_WithArgs(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo);
        ...
        public delegate void DoTriggerStay2D_WithArgs(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo);
        ...
        public delegate string ErrorCheck_WithArgs(Func<Trigger2dEventToParent, string> orig,
            Trigger2dEventToParent self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<Trigger2dEventToParent> orig, Trigger2dEventToParent self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<Trigger2dEventToParent> orig, Trigger2dEventToParent self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Trigger2dEventToParent> orig, Trigger2dEventToParent self);
        ...
        public delegate void StoreCollisionInfo_WithArgs(Action<Trigger2dEventToParent, Collider2D> orig,
            Trigger2dEventToParent self, Collider2D collisionInfo);

        public sealed class Params_Reset
        {
            public Trigger2dEventToParent self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "Reset"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Trigger2dEventToParent), "OnExit"), value);
