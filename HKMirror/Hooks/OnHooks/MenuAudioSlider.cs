...
private static void RefreshValueFromSettings(On.MenuAudioSlider.orig_RefreshValueFromSettings orig,MenuAudioSlider self)
{
...
{
foreach (Delegates.RefreshValueFromSettings_BeforeArgs toInvoke in _beforeRefreshValueFromSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshValueFromSettings_AfterArgs toInvoke in _afterRefreshValueFromSettings.GetInvocationList())
{
try
{
...
private static void UpdateTextValue(On.MenuAudioSlider.orig_UpdateTextValue orig,MenuAudioSlider self,  float value)
{
...
private static void SetMasterLevel(On.MenuAudioSlider.orig_SetMasterLevel orig,MenuAudioSlider self,  float masterLevel)
{
...
private static void SetMusicLevel(On.MenuAudioSlider.orig_SetMusicLevel orig,MenuAudioSlider self,  float musicLevel)
{
...
private static void SetSoundLevel(On.MenuAudioSlider.orig_SetSoundLevel orig,MenuAudioSlider self,  float soundLevel)
{
...
public delegate void UpdateTextValue_WithArgs (Action<MenuAudioSlider,  float> orig, MenuAudioSlider self,  float value);
...
public delegate void SetMasterLevel_WithArgs (Action<MenuAudioSlider,  float> orig, MenuAudioSlider self,  float masterLevel);
...
public delegate void SetMusicLevel_WithArgs (Action<MenuAudioSlider,  float> orig, MenuAudioSlider self,  float musicLevel);
...
public delegate void SetSoundLevel_WithArgs (Action<MenuAudioSlider,  float> orig, MenuAudioSlider self,  float soundLevel);
...
public delegate float GetVolumeLevel_WithArgs (Func<MenuAudioSlider,  float, float> orig, MenuAudioSlider self,  float x);
}
