...
public static class OnRedSamuraiAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RedSamuraiAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<RedSamuraiAndroidUnityProfile> orig, RedSamuraiAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RedSamuraiAndroidUnityProfile> orig,
            RedSamuraiAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public RedSamuraiAndroidUnityProfile self;
        }
    }
