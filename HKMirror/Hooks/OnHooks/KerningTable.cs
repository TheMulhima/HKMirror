...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "AddKerningPair", true), AddKerningPair);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "AddKerningPair_int_int_float", true), AddKerningPair_int_int_float);
...
private static int AddKerningPair_int_int_float(Func<TMPro.KerningTable,  int,  int,  float, int> orig, TMPro.KerningTable self,  int left,  int right,  float offset)
{
...
{
foreach (Delegates.AddKerningPair_int_int_float_BeforeArgs toInvoke in _beforeAddKerningPair_int_int_float.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddKerningPair_int_int_float_AfterArgs toInvoke in _afterAddKerningPair_int_int_float.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "RemoveKerningPair_int_int", true), RemoveKerningPair_int_int);
...
private static void RemoveKerningPair_int_int(Action<TMPro.KerningTable,  int,  int> orig, TMPro.KerningTable self,  int left,  int right)
{
...
{
foreach (Delegates.RemoveKerningPair_int_int_BeforeArgs toInvoke in _beforeRemoveKerningPair_int_int.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RemoveKerningPair_int_int_AfterArgs toInvoke in _afterRemoveKerningPair_int_int.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "RemoveKerningPair_int", true), RemoveKerningPair_int);
...
private static void RemoveKerningPair_int(Action<TMPro.KerningTable,  int> orig, TMPro.KerningTable self,  int index)
{
...
{
foreach (Delegates.RemoveKerningPair_int_BeforeArgs toInvoke in _beforeRemoveKerningPair_int.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RemoveKerningPair_int_AfterArgs toInvoke in _afterRemoveKerningPair_int.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "SortKerningPairs", true), SortKerningPairs);
...
public delegate int AddKerningPair_int_int_float_WithArgs (Func<TMPro.KerningTable,  int,  int,  float, int> orig, TMPro.KerningTable self,  int left,  int right,  float offset);
...
public delegate void RemoveKerningPair_int_int_WithArgs (Action<TMPro.KerningTable,  int,  int> orig, TMPro.KerningTable self,  int left,  int right);
...
public delegate void RemoveKerningPair_int_WithArgs (Action<TMPro.KerningTable,  int> orig, TMPro.KerningTable self,  int index);
...
{
add => HookEndpointManager.Add<Delegates.AddKerningPair_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "AddKerningPair", true), value);
remove => HookEndpointManager.Remove<Delegates.AddKerningPair_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "AddKerningPair", true), value);
}
public static event Delegates.AddKerningPair_int_int_float_WithArgs AddKerningPair_int_int_float
{
add => HookEndpointManager.Add<Delegates.AddKerningPair_int_int_float_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "AddKerningPair", true), value);
remove => HookEndpointManager.Remove<Delegates.AddKerningPair_int_int_float_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "AddKerningPair", true), value);
}
public static event Delegates.RemoveKerningPair_int_int_WithArgs RemoveKerningPair_int_int
{
add => HookEndpointManager.Add<Delegates.RemoveKerningPair_int_int_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "RemoveKerningPair", true), value);
remove => HookEndpointManager.Remove<Delegates.RemoveKerningPair_int_int_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "RemoveKerningPair", true), value);
}
public static event Delegates.RemoveKerningPair_int_WithArgs RemoveKerningPair_int
{
add => HookEndpointManager.Add<Delegates.RemoveKerningPair_int_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "RemoveKerningPair", true), value);
remove => HookEndpointManager.Remove<Delegates.RemoveKerningPair_int_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "RemoveKerningPair", true), value);
}
public static event Delegates.SortKerningPairs_WithArgs SortKerningPairs
{
add => HookEndpointManager.Add<Delegates.SortKerningPairs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "SortKerningPairs", true), value);
remove => HookEndpointManager.Remove<Delegates.SortKerningPairs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.KerningTable), "SortKerningPairs", true), value);
}
}
