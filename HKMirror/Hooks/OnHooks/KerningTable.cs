...
public static class OnKerningTable
{
    ...
    public static class Delegates
    {
        ...
        public delegate int AddKerningPair_int_int_float_WithArgs(Func<KerningTable, int, int, float, int> orig,
            KerningTable self, int left, int right, float offset);

        public delegate void AddKerningPair_WithArgs(Action<KerningTable> orig, KerningTable self);
        ...
        public delegate void RemoveKerningPair_int_int_WithArgs(Action<KerningTable, int, int> orig, KerningTable self,
            int left, int right);

        public delegate void RemoveKerningPair_int_WithArgs(Action<KerningTable, int> orig, KerningTable self,
            int index);
        ...
        public delegate void SortKerningPairs_WithArgs(Action<KerningTable> orig, KerningTable self);
