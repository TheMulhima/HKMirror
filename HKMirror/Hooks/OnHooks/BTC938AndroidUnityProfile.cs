...
public static class OnBTC938AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BTC938AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BTC938AndroidUnityProfile> orig, BTC938AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BTC938AndroidUnityProfile> orig, BTC938AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public BTC938AndroidUnityProfile self;
        }
    }
