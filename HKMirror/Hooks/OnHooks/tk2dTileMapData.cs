...
public static class Ontk2dTileMapData
{
    internal static class HookHandler
    {
        ...
        private static tk2dRuntime.TileMap.LayerInfo[] get_Layers(
            Func<tk2dTileMapData, tk2dRuntime.TileMap.LayerInfo[]> orig, tk2dTileMapData self)
        {
        ...
        private static tk2dRuntime.TileMap.TileInfo GetTileInfoForSprite(
            On.tk2dTileMapData.orig_GetTileInfoForSprite orig, tk2dTileMapData self, int tileId)
        {
        ...
        private static tk2dRuntime.TileMap.TileInfo[] GetOrCreateTileInfo(
            On.tk2dTileMapData.orig_GetOrCreateTileInfo orig, tk2dTileMapData self, int numTiles)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate tk2dRuntime.TileMap.LayerInfo[] get_Layers_AfterArgs(Params_get_Layers args,
            tk2dRuntime.TileMap.LayerInfo[] ret);

        public delegate tk2dRuntime.TileMap.LayerInfo[] get_Layers_WithArgs(
            Func<tk2dTileMapData, tk2dRuntime.TileMap.LayerInfo[]> orig, tk2dTileMapData self);
        ...
        public delegate tk2dRuntime.TileMap.TileInfo GetTileInfoForSprite_AfterArgs(Params_GetTileInfoForSprite args,
            tk2dRuntime.TileMap.TileInfo ret);

        public delegate tk2dRuntime.TileMap.TileInfo GetTileInfoForSprite_WithArgs(
            Func<tk2dTileMapData, int, tk2dRuntime.TileMap.TileInfo> orig, tk2dTileMapData self, int tileId);
        ...
        public delegate tk2dRuntime.TileMap.TileInfo[] GetOrCreateTileInfo_AfterArgs(Params_GetOrCreateTileInfo args,
            tk2dRuntime.TileMap.TileInfo[] ret);

        public delegate tk2dRuntime.TileMap.TileInfo[] GetOrCreateTileInfo_WithArgs(
            Func<tk2dTileMapData, int, tk2dRuntime.TileMap.TileInfo[]> orig, tk2dTileMapData self, int numTiles);
    ...
    public static class WithOrig
    {
        public static event Delegates.get_NumLayers_WithArgs get_NumLayers
        {
            add => HookEndpointManager.Add<Delegates.get_NumLayers_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_NumLayers", true), value);
        ...
        public static event Delegates.get_Layers_WithArgs get_Layers
        {
            add => HookEndpointManager.Add<Delegates.get_Layers_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_Layers", true), value);
