...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_NumLayers", true), get_NumLayers);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_Layers", true), get_Layers);
...
private static tk2dRuntime.TileMap.LayerInfo[] get_Layers(Func<tk2dTileMapData, tk2dRuntime.TileMap.LayerInfo[]> orig, tk2dTileMapData self)
{
...
private static tk2dRuntime.TileMap.TileInfo GetTileInfoForSprite(On.tk2dTileMapData.orig_GetTileInfoForSprite orig,tk2dTileMapData self,  int tileId)
{
...
{
foreach (Delegates.GetTileInfoForSprite_BeforeArgs toInvoke in _beforeGetTileInfoForSprite.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetTileInfoForSprite_AfterArgs toInvoke in _afterGetTileInfoForSprite.GetInvocationList())
{
try
{
...
private static tk2dRuntime.TileMap.TileInfo[] GetOrCreateTileInfo(On.tk2dTileMapData.orig_GetOrCreateTileInfo orig,tk2dTileMapData self,  int numTiles)
{
...
{
foreach (Delegates.GetOrCreateTileInfo_BeforeArgs toInvoke in _beforeGetOrCreateTileInfo.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetOrCreateTileInfo_AfterArgs toInvoke in _afterGetOrCreateTileInfo.GetInvocationList())
{
try
{
...
private static void GetTileOffset(On.tk2dTileMapData.orig_GetTileOffset orig,tk2dTileMapData self, out  float x, out  float y)
{
...
public delegate tk2dRuntime.TileMap.LayerInfo[] get_Layers_AfterArgs(Params_get_Layers args, tk2dRuntime.TileMap.LayerInfo[] ret);
public delegate tk2dRuntime.TileMap.LayerInfo[] get_Layers_WithArgs (Func<tk2dTileMapData, tk2dRuntime.TileMap.LayerInfo[]> orig, tk2dTileMapData self);
...
public delegate tk2dRuntime.TileMap.TileInfo GetTileInfoForSprite_AfterArgs(Params_GetTileInfoForSprite args, tk2dRuntime.TileMap.TileInfo ret);
public delegate tk2dRuntime.TileMap.TileInfo GetTileInfoForSprite_WithArgs (Func<tk2dTileMapData,  int, tk2dRuntime.TileMap.TileInfo> orig, tk2dTileMapData self,  int tileId);
...
public delegate tk2dRuntime.TileMap.TileInfo[] GetOrCreateTileInfo_AfterArgs(Params_GetOrCreateTileInfo args, tk2dRuntime.TileMap.TileInfo[] ret);
public delegate tk2dRuntime.TileMap.TileInfo[] GetOrCreateTileInfo_WithArgs (Func<tk2dTileMapData,  int, tk2dRuntime.TileMap.TileInfo[]> orig, tk2dTileMapData self,  int numTiles);
...
public delegate void GetTileOffset_WithArgs (Action<tk2dTileMapData,  float,  float> orig, tk2dTileMapData self, out  float x, out  float y);
...
{
add => HookEndpointManager.Add<Delegates.get_NumLayers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_NumLayers", true), value);
remove => HookEndpointManager.Remove<Delegates.get_NumLayers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_NumLayers", true), value);
}
public static event Delegates.get_Layers_WithArgs get_Layers
{
add => HookEndpointManager.Add<Delegates.get_Layers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_Layers", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Layers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMapData), "get_Layers", true), value);
}
