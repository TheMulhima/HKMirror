...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ModalDialog), "get_modalWindow", true), get_modalWindow);
...
private static UnityEngine.CanvasGroup get_modalWindow(Func<ModalDialog, UnityEngine.CanvasGroup> orig, ModalDialog self)
{
...
public delegate UnityEngine.CanvasGroup get_modalWindow_AfterArgs(Params_get_modalWindow args, UnityEngine.CanvasGroup ret);
public delegate UnityEngine.CanvasGroup get_modalWindow_WithArgs (Func<ModalDialog, UnityEngine.CanvasGroup> orig, ModalDialog self);
...
{
add => HookEndpointManager.Add<Delegates.get_modalWindow_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ModalDialog), "get_modalWindow", true), value);
remove => HookEndpointManager.Remove<Delegates.get_modalWindow_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ModalDialog), "get_modalWindow", true), value);
}
