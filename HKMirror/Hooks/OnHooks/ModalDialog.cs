...
public static class OnModalDialog
{
    internal static class HookHandler
    {
        ...
        private static UnityEngine.CanvasGroup get_modalWindow(Func<ModalDialog, UnityEngine.CanvasGroup> orig,
            ModalDialog self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.CanvasGroup get_modalWindow_AfterArgs(Params_get_modalWindow args,
            UnityEngine.CanvasGroup ret);

        public delegate UnityEngine.CanvasGroup get_modalWindow_WithArgs(
            Func<ModalDialog, UnityEngine.CanvasGroup> orig, ModalDialog self);
    ...
    public static class WithOrig
    {
        public static event Delegates.get_modalWindow_WithArgs get_modalWindow
        {
            add => HookEndpointManager.Add<Delegates.get_modalWindow_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ModalDialog), "get_modalWindow", true), value);
