...
public static class OnModalDialog
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.get_modalWindow_NormalArgs _afterget_modalWindow;
        ...
        private static CanvasGroup get_modalWindow(Func<ModalDialog, CanvasGroup> orig, ModalDialog self)
        {
            ...
            if (_afterget_modalWindow != null) retVal = _afterget_modalWindow.Invoke(@params);
            return retVal;
        }
    ...
    public static class Delegates
    {
        ...
        public delegate CanvasGroup get_modalWindow_NormalArgs(Params_get_modalWindow args);
    ...
    {
        public static event Delegates.get_modalWindow_NormalArgs get_modalWindow
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_modalWindow_NormalArgs get_modalWindow
        {
            add => HookEndpointManager.Add<Delegates.get_modalWindow_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ModalDialog), "get_modalWindow"), value);
            remove => HookEndpointManager.Remove<Delegates.get_modalWindow_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ModalDialog), "get_modalWindow"), value);
        }
