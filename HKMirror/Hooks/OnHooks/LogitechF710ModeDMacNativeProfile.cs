...
public static class OnLogitechF710ModeDMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710ModeDMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710ModeDMacNativeProfile> orig,
            LogitechF710ModeDMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710ModeDMacNativeProfile> orig,
            LogitechF710ModeDMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF710ModeDMacNativeProfile self;
        }
    }
