...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile> orig, InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile> orig, InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoFC30ProAndroidUnityProfile), "Define", true), value);
}
}
