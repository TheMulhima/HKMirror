...
public static class OnLogitechF510ModeDWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ModeDWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ModeDWindowsUnityProfile> orig,
            LogitechF510ModeDWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ModeDWindowsUnityProfile> orig,
            LogitechF510ModeDWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ModeDWindowsUnityProfile self;
        }
    }
