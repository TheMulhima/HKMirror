...
public static class OnMenuStyleSetting
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnEnable()
        {
            if (!HookedList.Contains("OnEnable"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "OnEnable", true),
                    OnEnable);
            }
        }
        ...
        internal static void HookOnMove()
        {
            if (!HookedList.Contains("OnMove"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "OnMove", true),
                    OnMove);
            }
        }
        ...
        private static void OnMove(Action<UnityEngine.UI.MenuStyleSetting, UnityEngine.EventSystems.AxisEventData> orig,
            UnityEngine.UI.MenuStyleSetting self, UnityEngine.EventSystems.AxisEventData move)
        {
        ...
        internal static void HookOnPointerClick()
        {
            if (!HookedList.Contains("OnPointerClick"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "OnPointerClick", true),
                    OnPointerClick);
            }
        }
        ...
        private static void OnPointerClick(
            Action<UnityEngine.UI.MenuStyleSetting, UnityEngine.EventSystems.PointerEventData> orig,
            UnityEngine.UI.MenuStyleSetting self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookUpdateStyle()
        {
            if (!HookedList.Contains("UpdateStyle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "UpdateStyle", true),
                    UpdateStyle);
            }
        }
        ...
        private static void UpdateStyle(Action<UnityEngine.UI.MenuStyleSetting> orig,
            UnityEngine.UI.MenuStyleSetting self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnable_WithArgs(Action<UnityEngine.UI.MenuStyleSetting> orig,
            UnityEngine.UI.MenuStyleSetting self);
        ...
        public delegate void OnMove_WithArgs(
            Action<UnityEngine.UI.MenuStyleSetting, UnityEngine.EventSystems.AxisEventData> orig,
            UnityEngine.UI.MenuStyleSetting self, UnityEngine.EventSystems.AxisEventData move);
        ...
        public delegate void UpdateStyle_WithArgs(Action<UnityEngine.UI.MenuStyleSetting> orig,
            UnityEngine.UI.MenuStyleSetting self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnEnable_WithArgs OnEnable
        {
            add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "OnEnable", true), value);
        ...
        public static event Delegates.OnMove_WithArgs OnMove
        {
            add => HookEndpointManager.Add<Delegates.OnMove_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "OnMove", true), value);
        ...
        public static event Delegates.OnPointerClick_WithArgs OnPointerClick
        {
            add => HookEndpointManager.Add<Delegates.OnPointerClick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "OnPointerClick", true), value);
        ...
        public static event Delegates.UpdateStyle_WithArgs UpdateStyle
        {
            add => HookEndpointManager.Add<Delegates.UpdateStyle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuStyleSetting), "UpdateStyle", true), value);
