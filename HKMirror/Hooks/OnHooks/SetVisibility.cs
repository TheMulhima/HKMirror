...
public static class OnSetVisibility
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self)
        {
        ...
        internal static void HookDoSetVisibility()
        {
            if (!HookedList.Contains("DoSetVisibility"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility),
                        "DoSetVisibility", true), DoSetVisibility);
            }
        }
        ...
        private static void DoSetVisibility(
            Action<HutongGames.PlayMaker.Actions.SetVisibility, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self, UnityEngine.GameObject go)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self)
        {
        ...
        internal static void HookResetVisibility()
        {
            if (!HookedList.Contains("ResetVisibility"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility),
                        "ResetVisibility", true), ResetVisibility);
            }
        }
        ...
        private static void ResetVisibility(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self);
        ...
        public delegate void DoSetVisibility_WithArgs(
            Action<HutongGames.PlayMaker.Actions.SetVisibility, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self, UnityEngine.GameObject go);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self);
        ...
        public delegate void ResetVisibility_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVisibility> orig,
            HutongGames.PlayMaker.Actions.SetVisibility self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoSetVisibility_WithArgs DoSetVisibility
        {
            add => HookEndpointManager.Add<Delegates.DoSetVisibility_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility), "DoSetVisibility",
                    true), value);
        ...
        public static event Delegates.ResetVisibility_WithArgs ResetVisibility
        {
            add => HookEndpointManager.Add<Delegates.ResetVisibility_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVisibility), "ResetVisibility",
                    true), value);
