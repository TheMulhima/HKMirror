...
private static UnityEngine.GameObject GetTarget(On.GrimmEnemyRange.orig_GetTarget orig,GrimmEnemyRange self)
{
...
private static void OnTriggerEnter2D(On.GrimmEnemyRange.orig_OnTriggerEnter2D orig,GrimmEnemyRange self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerExit2D(On.GrimmEnemyRange.orig_OnTriggerExit2D orig,GrimmEnemyRange self,  UnityEngine.Collider2D otherCollider)
{
...
public delegate UnityEngine.GameObject GetTarget_WithArgs (Func<GrimmEnemyRange, UnityEngine.GameObject> orig, GrimmEnemyRange self);
...
public delegate void OnTriggerEnter2D_WithArgs (Action<GrimmEnemyRange,  UnityEngine.Collider2D> orig, GrimmEnemyRange self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerExit2D_WithArgs (Action<GrimmEnemyRange,  UnityEngine.Collider2D> orig, GrimmEnemyRange self,  UnityEngine.Collider2D otherCollider);
