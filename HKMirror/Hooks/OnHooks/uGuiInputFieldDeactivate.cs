...
public static class OnuGuiInputFieldDeactivate
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldDeactivate), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldDeactivate), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self)
        {
        ...
        internal static void HookDoAction()
        {
            if (!HookedList.Contains("DoAction"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldDeactivate), "DoAction"), DoAction);
            }
        }
        ...
        private static void DoAction(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldDeactivate), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoAction_WithArgs(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiInputFieldDeactivate> orig, uGuiInputFieldDeactivate self);

        public sealed class Params_Reset
        {
            public uGuiInputFieldDeactivate self;
        }
