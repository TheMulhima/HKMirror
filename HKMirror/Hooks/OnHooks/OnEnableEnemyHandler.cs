...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "Invoke", true), Invoke);
...
private static bool Invoke(Func<Modding.Delegates.OnEnableEnemyHandler,  UnityEngine.GameObject,  bool, bool> orig, Modding.Delegates.OnEnableEnemyHandler self,  UnityEngine.GameObject enemy,  bool isAlreadyDead)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "EndInvoke", true), EndInvoke);
...
private static bool EndInvoke(Func<Modding.Delegates.OnEnableEnemyHandler,  System.IAsyncResult, bool> orig, Modding.Delegates.OnEnableEnemyHandler self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.OnEnableEnemyHandler self;
...
public delegate bool Invoke_WithArgs (Func<Modding.Delegates.OnEnableEnemyHandler,  UnityEngine.GameObject,  bool, bool> orig, Modding.Delegates.OnEnableEnemyHandler self,  UnityEngine.GameObject enemy,  bool isAlreadyDead);
...
public delegate bool EndInvoke_WithArgs (Func<Modding.Delegates.OnEnableEnemyHandler,  System.IAsyncResult, bool> orig, Modding.Delegates.OnEnableEnemyHandler self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "EndInvoke", true), value);
}
}
