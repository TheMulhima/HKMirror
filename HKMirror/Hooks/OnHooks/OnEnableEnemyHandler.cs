...
public static class OnOnEnableEnemyHandler
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static bool Invoke(
            Func<Modding.Delegates.OnEnableEnemyHandler, UnityEngine.GameObject, bool, bool> orig,
            Modding.Delegates.OnEnableEnemyHandler self, UnityEngine.GameObject enemy, bool isAlreadyDead)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static bool EndInvoke(Func<Modding.Delegates.OnEnableEnemyHandler, System.IAsyncResult, bool> orig,
            Modding.Delegates.OnEnableEnemyHandler self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate bool Invoke_WithArgs(
            Func<Modding.Delegates.OnEnableEnemyHandler, UnityEngine.GameObject, bool, bool> orig,
            Modding.Delegates.OnEnableEnemyHandler self, UnityEngine.GameObject enemy, bool isAlreadyDead);
        ...
        public delegate bool EndInvoke_WithArgs(
            Func<Modding.Delegates.OnEnableEnemyHandler, System.IAsyncResult, bool> orig,
            Modding.Delegates.OnEnableEnemyHandler self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnEnableEnemyHandler), "Invoke", true), value);
