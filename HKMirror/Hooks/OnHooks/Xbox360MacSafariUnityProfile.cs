...
public static class OnXbox360MacSafariUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360MacSafariUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360MacSafariUnityProfile> orig, Xbox360MacSafariUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360MacSafariUnityProfile> orig,
            Xbox360MacSafariUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360MacSafariUnityProfile self;
        }
    }
