...
public static class OnGetAnimatorIsMatchingTarget
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget self)
        {
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget self)
        {
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget self)
        {
        ...
        internal static void HookDoCheckIsMatchingActive()
        {
            if (!HookedList.Contains("DoCheckIsMatchingActive"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget),
                        "DoCheckIsMatchingActive", true), DoCheckIsMatchingActive);
            }
        }
        ...
        private static void DoCheckIsMatchingActive(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget self)
        {
            ...
            {
                foreach (Delegates.DoCheckIsMatchingActive_BeforeArgs toInvoke in _beforeDoCheckIsMatchingActive
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.DoCheckIsMatchingActive_AfterArgs toInvoke in _afterDoCheckIsMatchingActive
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget self);
        ...
        public delegate void DoCheckIsMatchingActive_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget self);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoCheckIsMatchingActive_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget),
                    "DoCheckIsMatchingActive", true), value);
            remove => HookEndpointManager.Remove<Delegates.DoCheckIsMatchingActive_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorIsMatchingTarget),
                    "DoCheckIsMatchingActive", true), value);
        }
    }
