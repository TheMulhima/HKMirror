...
public static class OnTextContainer
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_hasChanged()
        {
            if (!HookedList.Contains("get_hasChanged"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_hasChanged", true),
                    get_hasChanged);
            }
        }
        ...
        internal static void Hookset_hasChanged()
        {
            if (!HookedList.Contains("set_hasChanged"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_hasChanged", true),
                    set_hasChanged);
            }
        }
        ...
        private static UnityEngine.Vector2 get_pivot(Func<TMPro.TextContainer, UnityEngine.Vector2> orig,
            TMPro.TextContainer self)
        {
        ...
        private static void set_pivot(Action<TMPro.TextContainer, UnityEngine.Vector2> orig, TMPro.TextContainer self,
        ...
        internal static void Hookget_anchorPosition()
        {
            if (!HookedList.Contains("get_anchorPosition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_anchorPosition", true),
                    get_anchorPosition);
            }
        }
        ...
        private static TMPro.TextContainerAnchors get_anchorPosition(
            Func<TMPro.TextContainer, TMPro.TextContainerAnchors> orig, TMPro.TextContainer self)
        {
            ...
            {
                foreach (Delegates.get_anchorPosition_BeforeArgs toInvoke in
                         _beforeget_anchorPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_anchorPosition_AfterArgs toInvoke in
                         _afterget_anchorPosition.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_anchorPosition()
        {
            if (!HookedList.Contains("set_anchorPosition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_anchorPosition", true),
                    set_anchorPosition);
            }
        }
        ...
        private static void set_anchorPosition(Action<TMPro.TextContainer, TMPro.TextContainerAnchors> orig,
            TMPro.TextContainer self, TMPro.TextContainerAnchors value)
        {
            ...
            {
                foreach (Delegates.set_anchorPosition_BeforeArgs toInvoke in
                         _beforeset_anchorPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_anchorPosition_AfterArgs toInvoke in
                         _afterset_anchorPosition.GetInvocationList())
                {
                    try
                    {
        ...
        private static UnityEngine.Rect get_rect(Func<TMPro.TextContainer, UnityEngine.Rect> orig,
            TMPro.TextContainer self)
        {
        ...
        private static void set_rect(Action<TMPro.TextContainer, UnityEngine.Rect> orig, TMPro.TextContainer self,
        ...
        private static UnityEngine.Vector2 get_size(Func<TMPro.TextContainer, UnityEngine.Vector2> orig,
            TMPro.TextContainer self)
        {
        ...
        private static void set_size(Action<TMPro.TextContainer, UnityEngine.Vector2> orig, TMPro.TextContainer self,
            UnityEngine.Vector2 value)
        {
        ...
        internal static void Hookget_isDefaultWidth()
        {
            if (!HookedList.Contains("get_isDefaultWidth"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isDefaultWidth", true),
                    get_isDefaultWidth);
            }
        }
        ...
        private static bool get_isDefaultWidth(Func<TMPro.TextContainer, bool> orig, TMPro.TextContainer self)
        {
            ...
            {
                foreach (Delegates.get_isDefaultWidth_BeforeArgs toInvoke in
                         _beforeget_isDefaultWidth.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_isDefaultWidth_AfterArgs toInvoke in
                         _afterget_isDefaultWidth.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_isDefaultHeight()
        {
            if (!HookedList.Contains("get_isDefaultHeight"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isDefaultHeight", true),
                    get_isDefaultHeight);
            }
        }
        ...
        private static bool get_isDefaultHeight(Func<TMPro.TextContainer, bool> orig, TMPro.TextContainer self)
        {
            ...
            {
                foreach (Delegates.get_isDefaultHeight_BeforeArgs toInvoke in _beforeget_isDefaultHeight
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_isDefaultHeight_AfterArgs toInvoke in
                         _afterget_isDefaultHeight.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_isAutoFitting()
        {
            if (!HookedList.Contains("get_isAutoFitting"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isAutoFitting", true),
                    get_isAutoFitting);
            }
        }
        ...
        private static bool get_isAutoFitting(Func<TMPro.TextContainer, bool> orig, TMPro.TextContainer self)
        {
            ...
            {
                foreach (Delegates.get_isAutoFitting_BeforeArgs toInvoke in
                         _beforeget_isAutoFitting.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_isAutoFitting()
        {
            if (!HookedList.Contains("set_isAutoFitting"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_isAutoFitting", true),
                    set_isAutoFitting);
            }
        }
        ...
        private static void set_isAutoFitting(Action<TMPro.TextContainer, bool> orig, TMPro.TextContainer self,
            bool value)
        {
            ...
            {
                foreach (Delegates.set_isAutoFitting_BeforeArgs toInvoke in
                         _beforeset_isAutoFitting.GetInvocationList())
                {
                    try
                    {
        ...
        private static UnityEngine.Vector3[] get_corners(Func<TMPro.TextContainer, UnityEngine.Vector3[]> orig,
            TMPro.TextContainer self)
        {
        ...
        internal static void Hookget_worldCorners()
        {
            if (!HookedList.Contains("get_worldCorners"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_worldCorners", true),
                    get_worldCorners);
            }
        }
        ...
        private static UnityEngine.Vector3[] get_worldCorners(Func<TMPro.TextContainer, UnityEngine.Vector3[]> orig,
            TMPro.TextContainer self)
        {
        ...
        private static UnityEngine.Vector4 get_margins(Func<TMPro.TextContainer, UnityEngine.Vector4> orig,
            TMPro.TextContainer self)
        {
        ...
        private static void set_margins(Action<TMPro.TextContainer, UnityEngine.Vector4> orig, TMPro.TextContainer self,
        ...
        internal static void Hookget_rectTransform()
        {
            if (!HookedList.Contains("get_rectTransform"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_rectTransform", true),
                    get_rectTransform);
            }
        }
        ...
        private static UnityEngine.RectTransform get_rectTransform(
            Func<TMPro.TextContainer, UnityEngine.RectTransform> orig, TMPro.TextContainer self)
        {
        ...
        internal static void Hookget_textMeshPro()
        {
            if (!HookedList.Contains("get_textMeshPro"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_textMeshPro", true),
                    get_textMeshPro);
            }
        }
        ...
        private static TMPro.TextMeshPro get_textMeshPro(Func<TMPro.TextContainer, TMPro.TextMeshPro> orig,
            TMPro.TextContainer self)
        {
        ...
        internal static void HookOnContainerChanged()
        {
            if (!HookedList.Contains("OnContainerChanged"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "OnContainerChanged", true),
                    OnContainerChanged);
            }
        }
        ...
        private static void OnContainerChanged(Action<TMPro.TextContainer> orig, TMPro.TextContainer self)
        {
            ...
            {
                foreach (Delegates.OnContainerChanged_BeforeArgs toInvoke in
                         _beforeOnContainerChanged.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.OnContainerChanged_AfterArgs toInvoke in
                         _afterOnContainerChanged.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookOnRectTransformDimensionsChange()
        {
            if (!HookedList.Contains("OnRectTransformDimensionsChange"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "OnRectTransformDimensionsChange",
        ...
        private static void SetRect(Action<TMPro.TextContainer, UnityEngine.Vector2> orig, TMPro.TextContainer self,
        ...
        internal static void HookUpdateCorners()
        {
            if (!HookedList.Contains("UpdateCorners"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "UpdateCorners", true),
                    UpdateCorners);
            }
        }
        ...
        private static UnityEngine.Vector2 GetPivot(
            Func<TMPro.TextContainer, TMPro.TextContainerAnchors, UnityEngine.Vector2> orig, TMPro.TextContainer self,
            TMPro.TextContainerAnchors anchor)
        {
        ...
        internal static void HookGetAnchorPosition()
        {
            if (!HookedList.Contains("GetAnchorPosition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "GetAnchorPosition", true),
                    GetAnchorPosition);
            }
        }
        ...
        private static TMPro.TextContainerAnchors GetAnchorPosition(
            Func<TMPro.TextContainer, UnityEngine.Vector2, TMPro.TextContainerAnchors> orig, TMPro.TextContainer self,
            UnityEngine.Vector2 pivot)
        {
            ...
            {
                foreach (Delegates.GetAnchorPosition_BeforeArgs toInvoke in
                         _beforeGetAnchorPosition.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void set_hasChanged_WithArgs(Action<TMPro.TextContainer, bool> orig, TMPro.TextContainer self,
            bool value);
        ...
        public delegate UnityEngine.Vector2 get_pivot_WithArgs(Func<TMPro.TextContainer, UnityEngine.Vector2> orig,
            TMPro.TextContainer self);
        ...
        public delegate void set_pivot_WithArgs(Action<TMPro.TextContainer, UnityEngine.Vector2> orig,
            TMPro.TextContainer self, UnityEngine.Vector2 value);
        ...
        public delegate TMPro.TextContainerAnchors get_anchorPosition_AfterArgs(Params_get_anchorPosition args,
            TMPro.TextContainerAnchors ret);

        public delegate TMPro.TextContainerAnchors get_anchorPosition_WithArgs(
            Func<TMPro.TextContainer, TMPro.TextContainerAnchors> orig, TMPro.TextContainer self);
        ...
        public delegate void set_anchorPosition_WithArgs(Action<TMPro.TextContainer, TMPro.TextContainerAnchors> orig,
            TMPro.TextContainer self, TMPro.TextContainerAnchors value);
        ...
        public delegate UnityEngine.Rect get_rect_WithArgs(Func<TMPro.TextContainer, UnityEngine.Rect> orig,
            TMPro.TextContainer self);
        ...
        public delegate void set_rect_WithArgs(Action<TMPro.TextContainer, UnityEngine.Rect> orig,
            TMPro.TextContainer self, UnityEngine.Rect value);
        ...
        public delegate UnityEngine.Vector2 get_size_WithArgs(Func<TMPro.TextContainer, UnityEngine.Vector2> orig,
            TMPro.TextContainer self);
        ...
        public delegate void set_size_WithArgs(Action<TMPro.TextContainer, UnityEngine.Vector2> orig,
            TMPro.TextContainer self, UnityEngine.Vector2 value);
        ...
        public delegate void set_width_WithArgs(Action<TMPro.TextContainer, float> orig, TMPro.TextContainer self,
            float value);
        ...
        public delegate void set_height_WithArgs(Action<TMPro.TextContainer, float> orig, TMPro.TextContainer self,
            float value);
        ...
        public delegate bool
            get_isDefaultWidth_WithArgs(Func<TMPro.TextContainer, bool> orig, TMPro.TextContainer self);
        ...
        public delegate bool get_isDefaultHeight_WithArgs(Func<TMPro.TextContainer, bool> orig,
            TMPro.TextContainer self);
        ...
        public delegate void set_isAutoFitting_WithArgs(Action<TMPro.TextContainer, bool> orig,
            TMPro.TextContainer self, bool value);
        ...
        public delegate UnityEngine.Vector3[] get_corners_WithArgs(
            Func<TMPro.TextContainer, UnityEngine.Vector3[]> orig, TMPro.TextContainer self);
        ...
        public delegate UnityEngine.Vector3[] get_worldCorners_AfterArgs(Params_get_worldCorners args,
            UnityEngine.Vector3[] ret);

        public delegate UnityEngine.Vector3[] get_worldCorners_WithArgs(
            Func<TMPro.TextContainer, UnityEngine.Vector3[]> orig, TMPro.TextContainer self);
        ...
        public delegate UnityEngine.Vector4 get_margins_WithArgs(Func<TMPro.TextContainer, UnityEngine.Vector4> orig,
            TMPro.TextContainer self);
        ...
        public delegate void set_margins_WithArgs(Action<TMPro.TextContainer, UnityEngine.Vector4> orig,
            TMPro.TextContainer self, UnityEngine.Vector4 value);
        ...
        public delegate TMPro.TextMeshPro get_textMeshPro_WithArgs(Func<TMPro.TextContainer, TMPro.TextMeshPro> orig,
            TMPro.TextContainer self);
        ...
        public delegate void OnRectTransformDimensionsChange_WithArgs(Action<TMPro.TextContainer> orig,
            TMPro.TextContainer self);
        ...
        public delegate void SetRect_WithArgs(Action<TMPro.TextContainer, UnityEngine.Vector2> orig,
            TMPro.TextContainer self, UnityEngine.Vector2 size);
        ...
        public delegate UnityEngine.Vector2 GetPivot_WithArgs(
            Func<TMPro.TextContainer, TMPro.TextContainerAnchors, UnityEngine.Vector2> orig, TMPro.TextContainer self,
            TMPro.TextContainerAnchors anchor);
        ...
        public delegate TMPro.TextContainerAnchors GetAnchorPosition_AfterArgs(Params_GetAnchorPosition args,
            TMPro.TextContainerAnchors ret);

        public delegate TMPro.TextContainerAnchors GetAnchorPosition_WithArgs(
            Func<TMPro.TextContainer, UnityEngine.Vector2, TMPro.TextContainerAnchors> orig, TMPro.TextContainer self,
            UnityEngine.Vector2 pivot);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_hasChanged_WithArgs get_hasChanged
        {
            add => HookEndpointManager.Add<Delegates.get_hasChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_hasChanged", true), value);
        ...
        public static event Delegates.set_hasChanged_WithArgs set_hasChanged
        {
            add => HookEndpointManager.Add<Delegates.set_hasChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_hasChanged", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_pivot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_pivot", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_pivot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_pivot", true), value);
        }

        public static event Delegates.set_pivot_WithArgs set_pivot
        {
            add => HookEndpointManager.Add<Delegates.set_pivot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_pivot", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_pivot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_pivot", true), value);
        }

        public static event Delegates.get_anchorPosition_WithArgs get_anchorPosition
        {
            add => HookEndpointManager.Add<Delegates.get_anchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_anchorPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_anchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_anchorPosition", true), value);
        }

        public static event Delegates.set_anchorPosition_WithArgs set_anchorPosition
        {
            add => HookEndpointManager.Add<Delegates.set_anchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_anchorPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_anchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_anchorPosition", true), value);
        }

        public static event Delegates.get_rect_WithArgs get_rect
        {
            add => HookEndpointManager.Add<Delegates.get_rect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_rect", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_rect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_rect", true), value);
        }

        public static event Delegates.set_rect_WithArgs set_rect
        {
            add => HookEndpointManager.Add<Delegates.set_rect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_rect", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_rect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_rect", true), value);
        }
        ...
        public static event Delegates.get_size_WithArgs get_size
        {
            add => HookEndpointManager.Add<Delegates.get_size_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_size", true), value);
        ...
        public static event Delegates.set_size_WithArgs set_size
        {
            add => HookEndpointManager.Add<Delegates.set_size_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_size", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_width_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_width", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_width_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_width", true), value);
        }

        public static event Delegates.set_width_WithArgs set_width
        {
            add => HookEndpointManager.Add<Delegates.set_width_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_width", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_width_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_width", true), value);
        }

        public static event Delegates.get_height_WithArgs get_height
        {
            add => HookEndpointManager.Add<Delegates.get_height_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_height", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_height_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_height", true), value);
        }

        public static event Delegates.set_height_WithArgs set_height
        {
            add => HookEndpointManager.Add<Delegates.set_height_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_height", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_height_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_height", true), value);
        }

        public static event Delegates.get_isDefaultWidth_WithArgs get_isDefaultWidth
        {
            add => HookEndpointManager.Add<Delegates.get_isDefaultWidth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isDefaultWidth", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_isDefaultWidth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isDefaultWidth", true), value);
        }

        public static event Delegates.get_isDefaultHeight_WithArgs get_isDefaultHeight
        {
            add => HookEndpointManager.Add<Delegates.get_isDefaultHeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isDefaultHeight", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_isDefaultHeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isDefaultHeight", true), value);
        }

        public static event Delegates.get_isAutoFitting_WithArgs get_isAutoFitting
        {
            add => HookEndpointManager.Add<Delegates.get_isAutoFitting_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isAutoFitting", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_isAutoFitting_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_isAutoFitting", true), value);
        }

        public static event Delegates.set_isAutoFitting_WithArgs set_isAutoFitting
        {
            add => HookEndpointManager.Add<Delegates.set_isAutoFitting_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_isAutoFitting", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_isAutoFitting_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_isAutoFitting", true), value);
        }

        public static event Delegates.get_corners_WithArgs get_corners
        {
            add => HookEndpointManager.Add<Delegates.get_corners_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_corners", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_corners_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_corners", true), value);
        }

        public static event Delegates.get_worldCorners_WithArgs get_worldCorners
        {
            add => HookEndpointManager.Add<Delegates.get_worldCorners_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_worldCorners", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_worldCorners_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_worldCorners", true), value);
        }

        public static event Delegates.get_margins_WithArgs get_margins
        {
            add => HookEndpointManager.Add<Delegates.get_margins_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_margins", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_margins_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_margins", true), value);
        }

        public static event Delegates.set_margins_WithArgs set_margins
        {
            add => HookEndpointManager.Add<Delegates.set_margins_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_margins", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_margins_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "set_margins", true), value);
        }
        ...
        public static event Delegates.get_rectTransform_WithArgs get_rectTransform
        {
            add => HookEndpointManager.Add<Delegates.get_rectTransform_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_rectTransform", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_textMeshPro_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_textMeshPro", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_textMeshPro_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "get_textMeshPro", true), value);
        }
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "Awake", true), value);
        ...
        public static event Delegates.OnEnable_WithArgs OnEnable
        {
            add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "OnEnable", true), value);
        ...
        public static event Delegates.OnDisable_WithArgs OnDisable
        {
            add => HookEndpointManager.Add<Delegates.OnDisable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "OnDisable", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.OnContainerChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "OnContainerChanged", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnContainerChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "OnContainerChanged", true), value);
        }
        ...
        public static event Delegates.OnRectTransformDimensionsChange_WithArgs OnRectTransformDimensionsChange
        {
            add => HookEndpointManager.Add<Delegates.OnRectTransformDimensionsChange_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "OnRectTransformDimensionsChange", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.SetRect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "SetRect", true), value);
            remove => HookEndpointManager.Remove<Delegates.SetRect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "SetRect", true), value);
        }

        public static event Delegates.UpdateCorners_WithArgs UpdateCorners
        {
            add => HookEndpointManager.Add<Delegates.UpdateCorners_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "UpdateCorners", true), value);
            remove => HookEndpointManager.Remove<Delegates.UpdateCorners_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "UpdateCorners", true), value);
        }

        public static event Delegates.GetPivot_WithArgs GetPivot
        {
            add => HookEndpointManager.Add<Delegates.GetPivot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "GetPivot", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetPivot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "GetPivot", true), value);
        }

        public static event Delegates.GetAnchorPosition_WithArgs GetAnchorPosition
        {
            add => HookEndpointManager.Add<Delegates.GetAnchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "GetAnchorPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetAnchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TextContainer), "GetAnchorPosition", true), value);
        }
    }
}