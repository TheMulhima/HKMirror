...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MyGuid), "get_guid", true), get_guid);
...
private static System.Guid get_guid(Func<MyGuid, System.Guid> orig, MyGuid self)
{
...
public delegate System.Guid get_guid_WithArgs (Func<MyGuid, System.Guid> orig, MyGuid self);
...
{
add => HookEndpointManager.Add<Delegates.get_guid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MyGuid), "get_guid", true), value);
remove => HookEndpointManager.Remove<Delegates.get_guid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MyGuid), "get_guid", true), value);
}
