...
public static class OnRazerServalForgeTVUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RazerServalForgeTVUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<RazerServalForgeTVUnityProfile> orig, RazerServalForgeTVUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerServalForgeTVUnityProfile> orig,
            RazerServalForgeTVUnityProfile self);

        public sealed class Params_Define
        {
            public RazerServalForgeTVUnityProfile self;
        }
    }
