...
public static class OnPlayStation2LinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation2LinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation2LinuxUnityProfile> orig, PlayStation2LinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation2LinuxUnityProfile> orig,
            PlayStation2LinuxUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation2LinuxUnityProfile self;
        }
    }
