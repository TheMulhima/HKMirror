...
public static class OnExecutionerXWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ExecutionerXWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<ExecutionerXWindowsUnityProfile> orig, ExecutionerXWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ExecutionerXWindowsUnityProfile> orig,
            ExecutionerXWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public ExecutionerXWindowsUnityProfile self;
        }
    }
