...
public static class OnGodfinderIcon
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator Show_AfterArgs(Params_Show args, IEnumerator ret);

        public delegate void Show_BeforeArgs(Params_Show args);

        public delegate IEnumerator Show_WithArgs(Func<GodfinderIcon, float, IEnumerator> orig, GodfinderIcon self,
            float delay);
