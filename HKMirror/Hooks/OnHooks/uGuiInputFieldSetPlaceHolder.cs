...
public static class OnuGuiInputFieldSetPlaceHolder
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetPlaceHolder), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiInputFieldSetPlaceHolder> orig, uGuiInputFieldSetPlaceHolder self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetPlaceHolder), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiInputFieldSetPlaceHolder> orig, uGuiInputFieldSetPlaceHolder self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetPlaceHolder), "DoSetValue"),
                    DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiInputFieldSetPlaceHolder> orig, uGuiInputFieldSetPlaceHolder self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetPlaceHolder), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiInputFieldSetPlaceHolder> orig, uGuiInputFieldSetPlaceHolder self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiInputFieldSetPlaceHolder> orig,
            uGuiInputFieldSetPlaceHolder self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiInputFieldSetPlaceHolder> orig,
            uGuiInputFieldSetPlaceHolder self);
        ...
        public delegate void OnExit_WithArgs(Action<uGuiInputFieldSetPlaceHolder> orig,
            uGuiInputFieldSetPlaceHolder self);
        ...
        public delegate void Reset_WithArgs(Action<uGuiInputFieldSetPlaceHolder> orig,
            uGuiInputFieldSetPlaceHolder self);

        public sealed class Params_Reset
        {
            public uGuiInputFieldSetPlaceHolder self;
        }
