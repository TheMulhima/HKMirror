...
private static void OnCollisionEnter2D(On.ObjectBounce.orig_OnCollisionEnter2D orig,ObjectBounce self,  UnityEngine.Collision2D col)
{
...
private static void SetBounceAnimation(On.ObjectBounce.orig_SetBounceAnimation orig,ObjectBounce self,  bool set)
{
...
{
foreach (Delegates.SetBounceAnimation_BeforeArgs toInvoke in _beforeSetBounceAnimation.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetBounceAnimation_AfterArgs toInvoke in _afterSetBounceAnimation.GetInvocationList())
{
try
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<ObjectBounce,  UnityEngine.Collision2D> orig, ObjectBounce self,  UnityEngine.Collision2D col);
