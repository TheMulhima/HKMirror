...
public static class OnSetPositionToObject
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetPositionToObject), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetPositionToObject> orig,
            HutongGames.PlayMaker.Actions.SetPositionToObject self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetPositionToObject), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetPositionToObject> orig,
            HutongGames.PlayMaker.Actions.SetPositionToObject self)
        {
        ...
        internal static void HookDoSetPosition()
        {
            if (!HookedList.Contains("DoSetPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetPositionToObject),
                        "DoSetPosition", true), DoSetPosition);
            }
        }
        ...
        private static void DoSetPosition(Action<HutongGames.PlayMaker.Actions.SetPositionToObject> orig,
            HutongGames.PlayMaker.Actions.SetPositionToObject self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetPositionToObject> orig,
            HutongGames.PlayMaker.Actions.SetPositionToObject self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetPositionToObject> orig,
            HutongGames.PlayMaker.Actions.SetPositionToObject self);
        ...
        public delegate void DoSetPosition_WithArgs(Action<HutongGames.PlayMaker.Actions.SetPositionToObject> orig,
            HutongGames.PlayMaker.Actions.SetPositionToObject self);
    }
