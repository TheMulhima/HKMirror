...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButtons), "SelectItem", true), SelectItem);
...
private static void SelectItem(Action<UnityEngine.UI.ControllerProfileButtons,  int> orig, UnityEngine.UI.ControllerProfileButtons self,  int num)
{
...
public delegate void SelectItem_WithArgs (Action<UnityEngine.UI.ControllerProfileButtons,  int> orig, UnityEngine.UI.ControllerProfileButtons self,  int num);
}
...
{
add => HookEndpointManager.Add<Delegates.SelectItem_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButtons), "SelectItem", true), value);
remove => HookEndpointManager.Remove<Delegates.SelectItem_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButtons), "SelectItem", true), value);
}
}
