...
public static class OnRaycastAll
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RaycastAll), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RaycastAll), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RaycastAll), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self)
        {
        ...
        internal static void HookDoRaycast()
        {
            if (!HookedList.Contains("DoRaycast"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RaycastAll), "DoRaycast", true),
                    DoRaycast);
            }
        }
        ...
        private static void DoRaycast(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self);
        ...
        public delegate void DoRaycast_WithArgs(Action<HutongGames.PlayMaker.Actions.RaycastAll> orig,
            HutongGames.PlayMaker.Actions.RaycastAll self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RaycastAll), "Reset", true), value);
