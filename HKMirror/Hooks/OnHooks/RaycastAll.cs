...
public static class OnRaycastAll
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<RaycastAll> orig, RaycastAll self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<RaycastAll> orig, RaycastAll self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<RaycastAll> orig, RaycastAll self)
        {
        ...
        internal static void HookDoRaycast()
        {
            if (!HookedList.Contains("DoRaycast"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "DoRaycast"), DoRaycast);
            }
        }
        ...
        private static void DoRaycast(Action<RaycastAll> orig, RaycastAll self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoRaycast_WithArgs(Action<RaycastAll> orig, RaycastAll self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<RaycastAll> orig, RaycastAll self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<RaycastAll> orig, RaycastAll self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<RaycastAll> orig, RaycastAll self);

        public sealed class Params_Reset
        {
            public RaycastAll self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "OnUpdate"), value);
        ...
        public static event Delegates.DoRaycast_WithArgs DoRaycast
        {
            add => HookEndpointManager.Add<Delegates.DoRaycast_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RaycastAll), "DoRaycast"), value);
