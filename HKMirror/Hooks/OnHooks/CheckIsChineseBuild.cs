...
public static class OnCheckIsChineseBuild
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_IsTrue()
        {
            if (!HookedList.Contains("get_IsTrue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckIsChineseBuild),
                        "get_IsTrue", true), get_IsTrue);
            }
        }
        ...
        private static bool get_IsTrue(Func<HutongGames.PlayMaker.Actions.CheckIsChineseBuild, bool> orig,
            HutongGames.PlayMaker.Actions.CheckIsChineseBuild self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_IsTrue_WithArgs(Func<HutongGames.PlayMaker.Actions.CheckIsChineseBuild, bool> orig,
            HutongGames.PlayMaker.Actions.CheckIsChineseBuild self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_IsTrue_WithArgs get_IsTrue
        {
            add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckIsChineseBuild), "get_IsTrue",
                    true), value);
