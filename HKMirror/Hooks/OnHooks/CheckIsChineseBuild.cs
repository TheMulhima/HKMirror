...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckIsChineseBuild), "get_IsTrue", true), get_IsTrue);
...
private static bool get_IsTrue(Func<HutongGames.PlayMaker.Actions.CheckIsChineseBuild, bool> orig, HutongGames.PlayMaker.Actions.CheckIsChineseBuild self)
{
...
{
public HutongGames.PlayMaker.Actions.CheckIsChineseBuild self;
}
...
public delegate bool get_IsTrue_WithArgs (Func<HutongGames.PlayMaker.Actions.CheckIsChineseBuild, bool> orig, HutongGames.PlayMaker.Actions.CheckIsChineseBuild self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckIsChineseBuild), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckIsChineseBuild), "get_IsTrue", true), value);
}
}
