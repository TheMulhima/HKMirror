...
public static class Ontk2dCameraAnchor
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_AnchorOffsetPixels()
        {
            if (!HookedList.Contains("get_AnchorOffsetPixels"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorOffsetPixels", true),
        ...
        private static UnityEngine.Vector2 get_AnchorOffsetPixels(Func<tk2dCameraAnchor, UnityEngine.Vector2> orig,
            tk2dCameraAnchor self)
        {
            ...
            {
                foreach (Delegates.get_AnchorOffsetPixels_BeforeArgs toInvoke in _beforeget_AnchorOffsetPixels
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_AnchorOffsetPixels_AfterArgs toInvoke in _afterget_AnchorOffsetPixels
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_AnchorOffsetPixels()
        {
            if (!HookedList.Contains("set_AnchorOffsetPixels"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorOffsetPixels", true),
        ...
        private static void set_AnchorOffsetPixels(Action<tk2dCameraAnchor, UnityEngine.Vector2> orig,
            tk2dCameraAnchor self, UnityEngine.Vector2 value)
        {
            ...
            {
                foreach (Delegates.set_AnchorOffsetPixels_BeforeArgs toInvoke in _beforeset_AnchorOffsetPixels
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_AnchorOffsetPixels_AfterArgs toInvoke in _afterset_AnchorOffsetPixels
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_AnchorToNativeBounds()
        {
            if (!HookedList.Contains("get_AnchorToNativeBounds"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorToNativeBounds", true),
        ...
        private static bool get_AnchorToNativeBounds(Func<tk2dCameraAnchor, bool> orig, tk2dCameraAnchor self)
        {
            ...
            {
                foreach (Delegates.get_AnchorToNativeBounds_BeforeArgs toInvoke in _beforeget_AnchorToNativeBounds
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_AnchorToNativeBounds_AfterArgs toInvoke in _afterget_AnchorToNativeBounds
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_AnchorToNativeBounds()
        {
            if (!HookedList.Contains("set_AnchorToNativeBounds"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorToNativeBounds", true),
            ...
            bool value)
        {
            ...
            {
                foreach (Delegates.set_AnchorToNativeBounds_BeforeArgs toInvoke in _beforeset_AnchorToNativeBounds
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_AnchorToNativeBounds_AfterArgs toInvoke in _afterset_AnchorToNativeBounds
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_AnchorCamera()
        {
            if (!HookedList.Contains("get_AnchorCamera"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorCamera", true),
                    get_AnchorCamera);
            }
        }
        ...
        private static UnityEngine.Camera get_AnchorCamera(Func<tk2dCameraAnchor, UnityEngine.Camera> orig,
            tk2dCameraAnchor self)
        {
        ...
        internal static void Hookset_AnchorCamera()
        {
            if (!HookedList.Contains("set_AnchorCamera"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorCamera", true),
                    set_AnchorCamera);
            }
        }
        ...
        private static void set_AnchorCamera(Action<tk2dCameraAnchor, UnityEngine.Camera> orig, tk2dCameraAnchor self,
        ...
        internal static void Hookget_AnchorTk2dCamera()
        {
            if (!HookedList.Contains("get_AnchorTk2dCamera"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorTk2dCamera", true),
        ...
        private static tk2dCamera get_AnchorTk2dCamera(Func<tk2dCameraAnchor, tk2dCamera> orig, tk2dCameraAnchor self)
        {
            ...
            {
                foreach (Delegates.get_AnchorTk2dCamera_BeforeArgs toInvoke in _beforeget_AnchorTk2dCamera
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_AnchorTk2dCamera_AfterArgs toInvoke in _afterget_AnchorTk2dCamera
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_myTransform()
        {
            if (!HookedList.Contains("get_myTransform"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_myTransform", true),
                    get_myTransform);
            }
        }
        ...
        private static UnityEngine.Transform get_myTransform(Func<tk2dCameraAnchor, UnityEngine.Transform> orig,
            tk2dCameraAnchor self)
        {
            ...
            tk2dCameraAnchor self)
        {
            ...
            {
                foreach (Delegates.ForceUpdateTransform_BeforeArgs toInvoke in _beforeForceUpdateTransform
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ForceUpdateTransform_AfterArgs toInvoke in _afterForceUpdateTransform
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Vector2 get_AnchorOffsetPixels_AfterArgs(Params_get_AnchorOffsetPixels args,
            UnityEngine.Vector2 ret);

        public delegate UnityEngine.Vector2 get_AnchorOffsetPixels_WithArgs(
            Func<tk2dCameraAnchor, UnityEngine.Vector2> orig, tk2dCameraAnchor self);
        ...
        public delegate void set_AnchorOffsetPixels_WithArgs(Action<tk2dCameraAnchor, UnityEngine.Vector2> orig,
            tk2dCameraAnchor self, UnityEngine.Vector2 value);
        ...
        public delegate bool
            get_AnchorToNativeBounds_WithArgs(Func<tk2dCameraAnchor, bool> orig, tk2dCameraAnchor self);
        ...
        public delegate void set_AnchorToNativeBounds_WithArgs(Action<tk2dCameraAnchor, bool> orig,
            tk2dCameraAnchor self, bool value);
        ...
        public delegate UnityEngine.Camera get_AnchorCamera_AfterArgs(Params_get_AnchorCamera args,
            UnityEngine.Camera ret);

        public delegate UnityEngine.Camera get_AnchorCamera_WithArgs(Func<tk2dCameraAnchor, UnityEngine.Camera> orig,
            tk2dCameraAnchor self);
        ...
        public delegate void set_AnchorCamera_WithArgs(Action<tk2dCameraAnchor, UnityEngine.Camera> orig,
            tk2dCameraAnchor self, UnityEngine.Camera value);
        ...
        public delegate tk2dCamera get_AnchorTk2dCamera_WithArgs(Func<tk2dCameraAnchor, tk2dCamera> orig,
            tk2dCameraAnchor self);
        ...
        public delegate UnityEngine.Transform get_myTransform_AfterArgs(Params_get_myTransform args,
            UnityEngine.Transform ret);

        public delegate UnityEngine.Transform get_myTransform_WithArgs(
            Func<tk2dCameraAnchor, UnityEngine.Transform> orig, tk2dCameraAnchor self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_AnchorOffsetPixels_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorOffsetPixels", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_AnchorOffsetPixels_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorOffsetPixels", true), value);
        }

        public static event Delegates.set_AnchorOffsetPixels_WithArgs set_AnchorOffsetPixels
        {
            add => HookEndpointManager.Add<Delegates.set_AnchorOffsetPixels_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorOffsetPixels", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_AnchorOffsetPixels_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorOffsetPixels", true), value);
        }

        public static event Delegates.get_AnchorToNativeBounds_WithArgs get_AnchorToNativeBounds
        {
            add => HookEndpointManager.Add<Delegates.get_AnchorToNativeBounds_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorToNativeBounds", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_AnchorToNativeBounds_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorToNativeBounds", true), value);
        }

        public static event Delegates.set_AnchorToNativeBounds_WithArgs set_AnchorToNativeBounds
        {
            add => HookEndpointManager.Add<Delegates.set_AnchorToNativeBounds_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorToNativeBounds", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_AnchorToNativeBounds_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorToNativeBounds", true), value);
        }

        public static event Delegates.get_AnchorCamera_WithArgs get_AnchorCamera
        {
            add => HookEndpointManager.Add<Delegates.get_AnchorCamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorCamera", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_AnchorCamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorCamera", true), value);
        }

        public static event Delegates.set_AnchorCamera_WithArgs set_AnchorCamera
        {
            add => HookEndpointManager.Add<Delegates.set_AnchorCamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorCamera", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_AnchorCamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "set_AnchorCamera", true), value);
        }

        public static event Delegates.get_AnchorTk2dCamera_WithArgs get_AnchorTk2dCamera
        {
            add => HookEndpointManager.Add<Delegates.get_AnchorTk2dCamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorTk2dCamera", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_AnchorTk2dCamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_AnchorTk2dCamera", true), value);
        }

        public static event Delegates.get_myTransform_WithArgs get_myTransform
        {
            add => HookEndpointManager.Add<Delegates.get_myTransform_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_myTransform", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_myTransform_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dCameraAnchor), "get_myTransform", true), value);
        }
