...
public static class OnXbox360MacChromeUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360MacChromeUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360MacChromeUnityProfile> orig, Xbox360MacChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360MacChromeUnityProfile> orig,
            Xbox360MacChromeUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360MacChromeUnityProfile self;
        }
    }
