...
public static class OnGetAnimatorGravityWeight
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self)
        {
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self)
        {
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self)
        {
        ...
        internal static void HookDoGetGravityWeight()
        {
            if (!HookedList.Contains("DoGetGravityWeight"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight),
                        "DoGetGravityWeight", true), DoGetGravityWeight);
            }
        }
        ...
        private static void DoGetGravityWeight(Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self);
        ...
        public delegate void OnActionUpdate_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self);
        ...
        public delegate void DoGetGravityWeight_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorGravityWeight), "Reset",
                    true), value);
