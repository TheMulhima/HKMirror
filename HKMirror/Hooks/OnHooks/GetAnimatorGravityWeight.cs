...
public static class OnGetAnimatorGravityWeight
{
    internal static class HookHandler
    {
        ...
        private static void DoGetGravityWeight(Action<GetAnimatorGravityWeight> orig, GetAnimatorGravityWeight self)
        {
            ...
            if (_beforeDoGetGravityWeight != null)
                foreach (Delegates.DoGetGravityWeight_BeforeArgs toInvoke in
                         _beforeDoGetGravityWeight.GetInvocationList())
                    try
                    {
            ...
            if (_afterDoGetGravityWeight != null)
                foreach (Delegates.DoGetGravityWeight_AfterArgs toInvoke in
                         _afterDoGetGravityWeight.GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetGravityWeight_WithArgs(Action<GetAnimatorGravityWeight> orig,
            GetAnimatorGravityWeight self);
        ...
        public delegate void OnActionUpdate_WithArgs(Action<GetAnimatorGravityWeight> orig,
            GetAnimatorGravityWeight self);
        ...
        public delegate void OnEnter_WithArgs(Action<GetAnimatorGravityWeight> orig, GetAnimatorGravityWeight self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GetAnimatorGravityWeight> orig, GetAnimatorGravityWeight self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoGetGravityWeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetAnimatorGravityWeight), "DoGetGravityWeight"), value);
            remove => HookEndpointManager.Remove<Delegates.DoGetGravityWeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetAnimatorGravityWeight), "DoGetGravityWeight"), value);
        }
    }
}