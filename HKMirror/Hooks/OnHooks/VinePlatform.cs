...
public static class OnVinePlatform
{
    ...
    public static class Delegates
    {
        ...
        public delegate void OnCollisionEnter2D_WithArgs(Action<VinePlatform, Collision2D> orig, VinePlatform self,
            Collision2D collision);
        ...
        public delegate IEnumerator PlayerLand_AfterArgs(Params_PlayerLand args, IEnumerator ret);

        public delegate void PlayerLand_BeforeArgs(Params_PlayerLand args);

        public delegate IEnumerator PlayerLand_WithArgs(Func<VinePlatform, IEnumerator> orig, VinePlatform self);
        ...
        public delegate void PlaySound_WithArgs(Action<VinePlatform, AudioClip> orig, VinePlatform self,
            AudioClip clip);
