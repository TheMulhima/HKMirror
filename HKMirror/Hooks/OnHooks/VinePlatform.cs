...
private static void OnCollisionEnter2D(On.VinePlatform.orig_OnCollisionEnter2D orig,VinePlatform self,  UnityEngine.Collision2D collision)
{
...
private static void PlaySound(On.VinePlatform.orig_PlaySound orig,VinePlatform self,  UnityEngine.AudioClip clip)
{
...
private static System.Collections.IEnumerator PlayerLand(On.VinePlatform.orig_PlayerLand orig,VinePlatform self)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<VinePlatform,  UnityEngine.Collision2D> orig, VinePlatform self,  UnityEngine.Collision2D collision);
...
public delegate void PlaySound_WithArgs (Action<VinePlatform,  UnityEngine.AudioClip> orig, VinePlatform self,  UnityEngine.AudioClip clip);
public sealed class Params_PlayerLand
{
public VinePlatform self;
}
public delegate void PlayerLand_BeforeArgs(Params_PlayerLand args);
public delegate System.Collections.IEnumerator PlayerLand_AfterArgs(Params_PlayerLand args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PlayerLand_WithArgs (Func<VinePlatform, System.Collections.IEnumerator> orig, VinePlatform self);
