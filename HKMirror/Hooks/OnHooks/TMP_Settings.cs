...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableWordWrapping", false), get_enableWordWrapping);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableKerning", false), get_enableKerning);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableExtraPadding", false), get_enableExtraPadding);
...
{
foreach (Delegates.get_enableExtraPadding_BeforeArgs toInvoke in _beforeget_enableExtraPadding.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_enableExtraPadding_AfterArgs toInvoke in _afterget_enableExtraPadding.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableTintAllSprites", false), get_enableTintAllSprites);
...
{
foreach (Delegates.get_enableTintAllSprites_BeforeArgs toInvoke in _beforeget_enableTintAllSprites.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_enableTintAllSprites_AfterArgs toInvoke in _afterget_enableTintAllSprites.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableParseEscapeCharacters", false), get_enableParseEscapeCharacters);

}
}
internal static event Delegates.get_enableParseEscapeCharacters_BeforeArgs _beforeget_enableParseEscapeCharacters;
...
{
foreach (Delegates.get_enableParseEscapeCharacters_BeforeArgs toInvoke in _beforeget_enableParseEscapeCharacters.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_enableParseEscapeCharacters_AfterArgs toInvoke in _afterget_enableParseEscapeCharacters.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_missingGlyphCharacter", false), get_missingGlyphCharacter);
...
{
foreach (Delegates.get_missingGlyphCharacter_BeforeArgs toInvoke in _beforeget_missingGlyphCharacter.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_missingGlyphCharacter_AfterArgs toInvoke in _afterget_missingGlyphCharacter.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_warningsDisabled", false), get_warningsDisabled);
...
{
foreach (Delegates.get_warningsDisabled_BeforeArgs toInvoke in _beforeget_warningsDisabled.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_warningsDisabled_AfterArgs toInvoke in _afterget_warningsDisabled.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontAsset", false), get_defaultFontAsset);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontAssetPath", false), get_defaultFontAssetPath);
...
{
foreach (Delegates.get_defaultFontAssetPath_BeforeArgs toInvoke in _beforeget_defaultFontAssetPath.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_defaultFontAssetPath_AfterArgs toInvoke in _afterget_defaultFontAssetPath.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontSize", false), get_defaultFontSize);
...
{
foreach (Delegates.get_defaultFontSize_BeforeArgs toInvoke in _beforeget_defaultFontSize.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_defaultFontSize_AfterArgs toInvoke in _afterget_defaultFontSize.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultTextContainerWidth", false), get_defaultTextContainerWidth);
...
{
foreach (Delegates.get_defaultTextContainerWidth_BeforeArgs toInvoke in _beforeget_defaultTextContainerWidth.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_defaultTextContainerWidth_AfterArgs toInvoke in _afterget_defaultTextContainerWidth.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultTextContainerHeight", false), get_defaultTextContainerHeight);
...
{
foreach (Delegates.get_defaultTextContainerHeight_BeforeArgs toInvoke in _beforeget_defaultTextContainerHeight.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_defaultTextContainerHeight_AfterArgs toInvoke in _afterget_defaultTextContainerHeight.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_fallbackFontAssets", false), get_fallbackFontAssets);
...
private static System.Collections.Generic.List<TMPro.TMP_FontAsset> get_fallbackFontAssets(Func<System.Collections.Generic.List<TMPro.TMP_FontAsset>> orig)
{
if (_beforeget_fallbackFontAssets != null)
{
foreach (Delegates.get_fallbackFontAssets_BeforeArgs toInvoke in _beforeget_fallbackFontAssets.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_fallbackFontAssets_AfterArgs toInvoke in _afterget_fallbackFontAssets.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_matchMaterialPreset", false), get_matchMaterialPreset);
...
{
foreach (Delegates.get_matchMaterialPreset_BeforeArgs toInvoke in _beforeget_matchMaterialPreset.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_matchMaterialPreset_AfterArgs toInvoke in _afterget_matchMaterialPreset.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultSpriteAsset", false), get_defaultSpriteAsset);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultSpriteAssetPath", false), get_defaultSpriteAssetPath);
...
{
foreach (Delegates.get_defaultSpriteAssetPath_BeforeArgs toInvoke in _beforeget_defaultSpriteAssetPath.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_defaultSpriteAssetPath_AfterArgs toInvoke in _afterget_defaultSpriteAssetPath.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultStyleSheet", false), get_defaultStyleSheet);
...
private static TMPro.TMP_StyleSheet get_defaultStyleSheet(Func<TMPro.TMP_StyleSheet> orig)
{
if (_beforeget_defaultStyleSheet != null)
{
foreach (Delegates.get_defaultStyleSheet_BeforeArgs toInvoke in _beforeget_defaultStyleSheet.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_defaultStyleSheet_AfterArgs toInvoke in _afterget_defaultStyleSheet.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_leadingCharacters", false), get_leadingCharacters);
...
private static UnityEngine.TextAsset get_leadingCharacters(Func<UnityEngine.TextAsset> orig)
{
if (_beforeget_leadingCharacters != null)
{
foreach (Delegates.get_leadingCharacters_BeforeArgs toInvoke in _beforeget_leadingCharacters.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_leadingCharacters_AfterArgs toInvoke in _afterget_leadingCharacters.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_followingCharacters", false), get_followingCharacters);
...
private static UnityEngine.TextAsset get_followingCharacters(Func<UnityEngine.TextAsset> orig)
{
if (_beforeget_followingCharacters != null)
{
foreach (Delegates.get_followingCharacters_BeforeArgs toInvoke in _beforeget_followingCharacters.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_followingCharacters_AfterArgs toInvoke in _afterget_followingCharacters.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_instance", false), get_instance);
...
private static TMPro.TMP_Settings get_instance(Func<TMPro.TMP_Settings> orig)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "LoadDefaultSettings", false), LoadDefaultSettings);
...
private static TMPro.TMP_Settings LoadDefaultSettings(Func<TMPro.TMP_Settings> orig)
{
if (_beforeLoadDefaultSettings != null)
{
foreach (Delegates.LoadDefaultSettings_BeforeArgs toInvoke in _beforeLoadDefaultSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadDefaultSettings_AfterArgs toInvoke in _afterLoadDefaultSettings.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetSettings", false), GetSettings);
...
private static TMPro.TMP_Settings GetSettings(Func<TMPro.TMP_Settings> orig)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetFontAsset", false), GetFontAsset);
...
private static TMPro.TMP_FontAsset GetFontAsset(Func<TMPro.TMP_FontAsset> orig)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetSpriteAsset", false), GetSpriteAsset);
...
private static TMPro.TMP_SpriteAsset GetSpriteAsset(Func<TMPro.TMP_SpriteAsset> orig)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetStyleSheet", false), GetStyleSheet);
...
private static TMPro.TMP_StyleSheet GetStyleSheet(Func<TMPro.TMP_StyleSheet> orig)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "LoadLinebreakingRules", false), LoadLinebreakingRules);
...
{
foreach (Delegates.LoadLinebreakingRules_BeforeArgs toInvoke in _beforeLoadLinebreakingRules.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadLinebreakingRules_AfterArgs toInvoke in _afterLoadLinebreakingRules.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetCharacters", false), GetCharacters);
...
private static System.Collections.Generic.Dictionary<int,char> GetCharacters(Func< UnityEngine.TextAsset, System.Collections.Generic.Dictionary<int,char>> orig,  UnityEngine.TextAsset file)
{
...
public delegate System.Collections.Generic.List<TMPro.TMP_FontAsset> get_fallbackFontAssets_AfterArgs(System.Collections.Generic.List<TMPro.TMP_FontAsset> ret);
public delegate System.Collections.Generic.List<TMPro.TMP_FontAsset> get_fallbackFontAssets_WithArgs (Func<System.Collections.Generic.List<TMPro.TMP_FontAsset>> orig);
...
public delegate TMPro.TMP_StyleSheet get_defaultStyleSheet_AfterArgs(TMPro.TMP_StyleSheet ret);
public delegate TMPro.TMP_StyleSheet get_defaultStyleSheet_WithArgs (Func<TMPro.TMP_StyleSheet> orig);
public delegate void get_leadingCharacters_BeforeArgs();
public delegate UnityEngine.TextAsset get_leadingCharacters_AfterArgs(UnityEngine.TextAsset ret);
public delegate UnityEngine.TextAsset get_leadingCharacters_WithArgs (Func<UnityEngine.TextAsset> orig);
public delegate void get_followingCharacters_BeforeArgs();
public delegate UnityEngine.TextAsset get_followingCharacters_AfterArgs(UnityEngine.TextAsset ret);
public delegate UnityEngine.TextAsset get_followingCharacters_WithArgs (Func<UnityEngine.TextAsset> orig);
public delegate void get_instance_BeforeArgs();
public delegate TMPro.TMP_Settings get_instance_AfterArgs(TMPro.TMP_Settings ret);
public delegate TMPro.TMP_Settings get_instance_WithArgs (Func<TMPro.TMP_Settings> orig);
public delegate void LoadDefaultSettings_BeforeArgs();
public delegate TMPro.TMP_Settings LoadDefaultSettings_AfterArgs(TMPro.TMP_Settings ret);
public delegate TMPro.TMP_Settings LoadDefaultSettings_WithArgs (Func<TMPro.TMP_Settings> orig);
public delegate void GetSettings_BeforeArgs();
public delegate TMPro.TMP_Settings GetSettings_AfterArgs(TMPro.TMP_Settings ret);
public delegate TMPro.TMP_Settings GetSettings_WithArgs (Func<TMPro.TMP_Settings> orig);
public delegate void GetFontAsset_BeforeArgs();
public delegate TMPro.TMP_FontAsset GetFontAsset_AfterArgs(TMPro.TMP_FontAsset ret);
public delegate TMPro.TMP_FontAsset GetFontAsset_WithArgs (Func<TMPro.TMP_FontAsset> orig);
public delegate void GetSpriteAsset_BeforeArgs();
public delegate TMPro.TMP_SpriteAsset GetSpriteAsset_AfterArgs(TMPro.TMP_SpriteAsset ret);
public delegate TMPro.TMP_SpriteAsset GetSpriteAsset_WithArgs (Func<TMPro.TMP_SpriteAsset> orig);
public delegate void GetStyleSheet_BeforeArgs();
public delegate TMPro.TMP_StyleSheet GetStyleSheet_AfterArgs(TMPro.TMP_StyleSheet ret);
public delegate TMPro.TMP_StyleSheet GetStyleSheet_WithArgs (Func<TMPro.TMP_StyleSheet> orig);
...
public delegate System.Collections.Generic.Dictionary<int,char> GetCharacters_AfterArgs(Params_GetCharacters args, System.Collections.Generic.Dictionary<int,char> ret);
public delegate System.Collections.Generic.Dictionary<int,char> GetCharacters_WithArgs (Func< UnityEngine.TextAsset, System.Collections.Generic.Dictionary<int,char>> orig,  UnityEngine.TextAsset file);
}
...
{
add => HookEndpointManager.Add<Delegates.get_enableWordWrapping_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableWordWrapping", false), value);
remove => HookEndpointManager.Remove<Delegates.get_enableWordWrapping_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableWordWrapping", false), value);
}
public static event Delegates.get_enableKerning_WithArgs get_enableKerning
{
add => HookEndpointManager.Add<Delegates.get_enableKerning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableKerning", false), value);
remove => HookEndpointManager.Remove<Delegates.get_enableKerning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableKerning", false), value);
}
public static event Delegates.get_enableExtraPadding_WithArgs get_enableExtraPadding
{
add => HookEndpointManager.Add<Delegates.get_enableExtraPadding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableExtraPadding", false), value);
remove => HookEndpointManager.Remove<Delegates.get_enableExtraPadding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableExtraPadding", false), value);
}
public static event Delegates.get_enableTintAllSprites_WithArgs get_enableTintAllSprites
{
add => HookEndpointManager.Add<Delegates.get_enableTintAllSprites_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableTintAllSprites", false), value);
remove => HookEndpointManager.Remove<Delegates.get_enableTintAllSprites_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableTintAllSprites", false), value);
}
public static event Delegates.get_enableParseEscapeCharacters_WithArgs get_enableParseEscapeCharacters
{
add => HookEndpointManager.Add<Delegates.get_enableParseEscapeCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableParseEscapeCharacters", false), value);
remove => HookEndpointManager.Remove<Delegates.get_enableParseEscapeCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_enableParseEscapeCharacters", false), value);
}
public static event Delegates.get_missingGlyphCharacter_WithArgs get_missingGlyphCharacter
{
add => HookEndpointManager.Add<Delegates.get_missingGlyphCharacter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_missingGlyphCharacter", false), value);
remove => HookEndpointManager.Remove<Delegates.get_missingGlyphCharacter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_missingGlyphCharacter", false), value);
}
public static event Delegates.get_warningsDisabled_WithArgs get_warningsDisabled
{
add => HookEndpointManager.Add<Delegates.get_warningsDisabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_warningsDisabled", false), value);
remove => HookEndpointManager.Remove<Delegates.get_warningsDisabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_warningsDisabled", false), value);
}
public static event Delegates.get_defaultFontAsset_WithArgs get_defaultFontAsset
{
add => HookEndpointManager.Add<Delegates.get_defaultFontAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontAsset", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultFontAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontAsset", false), value);
}
public static event Delegates.get_defaultFontAssetPath_WithArgs get_defaultFontAssetPath
{
add => HookEndpointManager.Add<Delegates.get_defaultFontAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontAssetPath", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultFontAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontAssetPath", false), value);
}
public static event Delegates.get_defaultFontSize_WithArgs get_defaultFontSize
{
add => HookEndpointManager.Add<Delegates.get_defaultFontSize_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontSize", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultFontSize_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultFontSize", false), value);
}
public static event Delegates.get_defaultTextContainerWidth_WithArgs get_defaultTextContainerWidth
{
add => HookEndpointManager.Add<Delegates.get_defaultTextContainerWidth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultTextContainerWidth", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultTextContainerWidth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultTextContainerWidth", false), value);
}
public static event Delegates.get_defaultTextContainerHeight_WithArgs get_defaultTextContainerHeight
{
add => HookEndpointManager.Add<Delegates.get_defaultTextContainerHeight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultTextContainerHeight", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultTextContainerHeight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultTextContainerHeight", false), value);
}
public static event Delegates.get_fallbackFontAssets_WithArgs get_fallbackFontAssets
{
add => HookEndpointManager.Add<Delegates.get_fallbackFontAssets_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_fallbackFontAssets", false), value);
remove => HookEndpointManager.Remove<Delegates.get_fallbackFontAssets_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_fallbackFontAssets", false), value);
}
public static event Delegates.get_matchMaterialPreset_WithArgs get_matchMaterialPreset
{
add => HookEndpointManager.Add<Delegates.get_matchMaterialPreset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_matchMaterialPreset", false), value);
remove => HookEndpointManager.Remove<Delegates.get_matchMaterialPreset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_matchMaterialPreset", false), value);
}
public static event Delegates.get_defaultSpriteAsset_WithArgs get_defaultSpriteAsset
{
add => HookEndpointManager.Add<Delegates.get_defaultSpriteAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultSpriteAsset", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultSpriteAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultSpriteAsset", false), value);
}
public static event Delegates.get_defaultSpriteAssetPath_WithArgs get_defaultSpriteAssetPath
{
add => HookEndpointManager.Add<Delegates.get_defaultSpriteAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultSpriteAssetPath", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultSpriteAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultSpriteAssetPath", false), value);
}
public static event Delegates.get_defaultStyleSheet_WithArgs get_defaultStyleSheet
{
add => HookEndpointManager.Add<Delegates.get_defaultStyleSheet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultStyleSheet", false), value);
remove => HookEndpointManager.Remove<Delegates.get_defaultStyleSheet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_defaultStyleSheet", false), value);
}
public static event Delegates.get_leadingCharacters_WithArgs get_leadingCharacters
{
add => HookEndpointManager.Add<Delegates.get_leadingCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_leadingCharacters", false), value);
remove => HookEndpointManager.Remove<Delegates.get_leadingCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_leadingCharacters", false), value);
}
public static event Delegates.get_followingCharacters_WithArgs get_followingCharacters
{
add => HookEndpointManager.Add<Delegates.get_followingCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_followingCharacters", false), value);
remove => HookEndpointManager.Remove<Delegates.get_followingCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_followingCharacters", false), value);
}
public static event Delegates.get_instance_WithArgs get_instance
{
add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "get_instance", false), value);
}
public static event Delegates.LoadDefaultSettings_WithArgs LoadDefaultSettings
{
add => HookEndpointManager.Add<Delegates.LoadDefaultSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "LoadDefaultSettings", false), value);
remove => HookEndpointManager.Remove<Delegates.LoadDefaultSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "LoadDefaultSettings", false), value);
}
public static event Delegates.GetSettings_WithArgs GetSettings
{
add => HookEndpointManager.Add<Delegates.GetSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetSettings", false), value);
remove => HookEndpointManager.Remove<Delegates.GetSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetSettings", false), value);
}
public static event Delegates.GetFontAsset_WithArgs GetFontAsset
{
add => HookEndpointManager.Add<Delegates.GetFontAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetFontAsset", false), value);
remove => HookEndpointManager.Remove<Delegates.GetFontAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetFontAsset", false), value);
}
public static event Delegates.GetSpriteAsset_WithArgs GetSpriteAsset
{
add => HookEndpointManager.Add<Delegates.GetSpriteAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetSpriteAsset", false), value);
remove => HookEndpointManager.Remove<Delegates.GetSpriteAsset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetSpriteAsset", false), value);
}
public static event Delegates.GetStyleSheet_WithArgs GetStyleSheet
{
add => HookEndpointManager.Add<Delegates.GetStyleSheet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetStyleSheet", false), value);
remove => HookEndpointManager.Remove<Delegates.GetStyleSheet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetStyleSheet", false), value);
}
public static event Delegates.LoadLinebreakingRules_WithArgs LoadLinebreakingRules
{
add => HookEndpointManager.Add<Delegates.LoadLinebreakingRules_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "LoadLinebreakingRules", false), value);
remove => HookEndpointManager.Remove<Delegates.LoadLinebreakingRules_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "LoadLinebreakingRules", false), value);
}
public static event Delegates.GetCharacters_WithArgs GetCharacters
{
add => HookEndpointManager.Add<Delegates.GetCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetCharacters", false), value);
remove => HookEndpointManager.Remove<Delegates.GetCharacters_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Settings), "GetCharacters", false), value);
}
}
