...
public static class OnRunFSM
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self)
        {
        ...
        internal static void HookCheckIfFinished()
        {
            if (!HookedList.Contains("CheckIfFinished"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "CheckIfFinished",
                        true), CheckIfFinished);
            }
        }
        ...
        private static void CheckIfFinished(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self);
        ...
        public delegate void CheckIfFinished_WithArgs(Action<HutongGames.PlayMaker.Actions.RunFSM> orig,
            HutongGames.PlayMaker.Actions.RunFSM self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "Reset", true), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "Awake", true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "OnEnter", true), value);
        ...
        public static event Delegates.CheckIfFinished_WithArgs CheckIfFinished
        {
            add => HookEndpointManager.Add<Delegates.CheckIfFinished_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RunFSM), "CheckIfFinished", true),
                value);
