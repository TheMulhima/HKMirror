...
private static System.Collections.IEnumerator Start(On.OnScreenDebugInfo.orig_Start orig,OnScreenDebugInfo self)
{
...
private static void LevelActivated(On.OnScreenDebugInfo.orig_LevelActivated orig,OnScreenDebugInfo self,  UnityEngine.SceneManagement.Scene sceneFrom,  UnityEngine.SceneManagement.Scene sceneTo)
{
...
private static void ShowTargetFrameRate(On.OnScreenDebugInfo.orig_ShowTargetFrameRate orig,OnScreenDebugInfo self)
{
...
{
foreach (Delegates.ShowTargetFrameRate_BeforeArgs toInvoke in _beforeShowTargetFrameRate.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ShowTargetFrameRate_AfterArgs toInvoke in _afterShowTargetFrameRate.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(OnScreenDebugInfo), "orig_Awake", true), orig_Awake);
...
public delegate System.Collections.IEnumerator Start_WithArgs (Func<OnScreenDebugInfo, System.Collections.IEnumerator> orig, OnScreenDebugInfo self);
...
public delegate void LevelActivated_WithArgs (Action<OnScreenDebugInfo,  UnityEngine.SceneManagement.Scene,  UnityEngine.SceneManagement.Scene> orig, OnScreenDebugInfo self,  UnityEngine.SceneManagement.Scene sceneFrom,  UnityEngine.SceneManagement.Scene sceneTo);
...
{
add => HookEndpointManager.Add<Delegates.orig_Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(OnScreenDebugInfo), "orig_Awake", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(OnScreenDebugInfo), "orig_Awake", true), value);
}
}
