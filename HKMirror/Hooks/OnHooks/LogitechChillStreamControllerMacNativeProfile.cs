...
public static class OnLogitechChillStreamControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.LogitechChillStreamControllerMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.LogitechChillStreamControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechChillStreamControllerMacNativeProfile self)
        {
