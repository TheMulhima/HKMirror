...
public static class OnLogitechChillStreamControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(LogitechChillStreamControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechChillStreamControllerMacNativeProfile> orig,
            LogitechChillStreamControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechChillStreamControllerMacNativeProfile> orig,
            LogitechChillStreamControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechChillStreamControllerMacNativeProfile self;
        }
    }
