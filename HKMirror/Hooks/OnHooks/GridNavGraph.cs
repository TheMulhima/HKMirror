...
public static class OnGridNavGraph
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Columns()
        {
            if (!HookedList.Contains("get_Columns"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "get_Columns", true),
                    get_Columns);
            }
        }
        ...
        internal static void Hookset_Columns()
        {
            if (!HookedList.Contains("set_Columns"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "set_Columns", true),
                    set_Columns);
            }
        }
        ...
        private static void set_Columns(Action<Modding.Menu.GridNavGraph, int> orig, Modding.Menu.GridNavGraph self,
            int value)
        {
        ...
        internal static void HookChangeColumns()
        {
            if (!HookedList.Contains("ChangeColumns"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "ChangeColumns", true),
                    ChangeColumns);
            }
        }
        ...
        private static void ChangeColumns(Action<Modding.Menu.GridNavGraph, int> orig, Modding.Menu.GridNavGraph self,
            int columns)
        {
        ...
        internal static void HookAddNavigationNode()
        {
            if (!HookedList.Contains("AddNavigationNode"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "AddNavigationNode", true),
                    AddNavigationNode);
            }
        }
        ...
        private static void AddNavigationNode(Action<Modding.Menu.GridNavGraph, UnityEngine.UI.Selectable> orig,
            Modding.Menu.GridNavGraph self, UnityEngine.UI.Selectable selectable)
        {
        ...
        internal static void HookBuildNavigation()
        {
            if (!HookedList.Contains("BuildNavigation"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "BuildNavigation", true),
                    BuildNavigation);
            }
        }
        ...
        private static UnityEngine.UI.Selectable BuildNavigation(
            Func<Modding.Menu.GridNavGraph, UnityEngine.UI.Selectable> orig, Modding.Menu.GridNavGraph self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate int get_Columns_WithArgs(Func<Modding.Menu.GridNavGraph, int> orig,
            Modding.Menu.GridNavGraph self);
        ...
        public delegate void set_Columns_WithArgs(Action<Modding.Menu.GridNavGraph, int> orig,
            Modding.Menu.GridNavGraph self, int value);
        ...
        public delegate void ChangeColumns_WithArgs(Action<Modding.Menu.GridNavGraph, int> orig,
            Modding.Menu.GridNavGraph self, int columns);
        ...
        public delegate void AddNavigationNode_WithArgs(
            Action<Modding.Menu.GridNavGraph, UnityEngine.UI.Selectable> orig, Modding.Menu.GridNavGraph self,
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Columns_WithArgs get_Columns
        {
            add => HookEndpointManager.Add<Delegates.get_Columns_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "get_Columns", true), value);
        ...
        public static event Delegates.set_Columns_WithArgs set_Columns
        {
            add => HookEndpointManager.Add<Delegates.set_Columns_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "set_Columns", true), value);
        ...
        public static event Delegates.ChangeColumns_WithArgs ChangeColumns
        {
            add => HookEndpointManager.Add<Delegates.ChangeColumns_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "ChangeColumns", true), value);
        ...
        public static event Delegates.AddNavigationNode_WithArgs AddNavigationNode
        {
            add => HookEndpointManager.Add<Delegates.AddNavigationNode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "AddNavigationNode", true), value);
        ...
        public static event Delegates.BuildNavigation_WithArgs BuildNavigation
        {
            add => HookEndpointManager.Add<Delegates.BuildNavigation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.GridNavGraph), "BuildNavigation", true), value);
