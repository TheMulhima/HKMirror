...
public static class OnConstrainMovement
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ConstrainMovement), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ConstrainMovement), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ConstrainMovement), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ConstrainMovement),
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ConstrainMovement> orig,
            HutongGames.PlayMaker.Actions.ConstrainMovement self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ConstrainMovement), "Reset", true),
                value);
        ...
        public static event Delegates.OnLateUpdate_WithArgs OnLateUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnLateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ConstrainMovement), "OnLateUpdate",
                    true), value);
