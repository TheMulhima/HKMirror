...
public static class OnConstrainMovement
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ConstrainMovement), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<ConstrainMovement> orig, ConstrainMovement self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ConstrainMovement), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<ConstrainMovement> orig, ConstrainMovement self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ConstrainMovement), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<ConstrainMovement> orig, ConstrainMovement self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ConstrainMovement), "OnLateUpdate"), OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<ConstrainMovement> orig, ConstrainMovement self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<ConstrainMovement> orig, ConstrainMovement self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<ConstrainMovement> orig, ConstrainMovement self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<ConstrainMovement> orig, ConstrainMovement self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<ConstrainMovement> orig, ConstrainMovement self);

        public sealed class Params_Reset
        {
            public ConstrainMovement self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ConstrainMovement), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ConstrainMovement), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ConstrainMovement), "OnUpdate"), value);
