...
public static class OnPerformanceHUD
{
    internal static class HookHandler
    {
        ...
        private static void UpdateSceneLoadRecordContent(On.PerformanceHUD.orig_UpdateSceneLoadRecordContent orig,
            PerformanceHUD self, SceneLoad sceneLoad, PerformanceHUD.LoadReport report)
        {
            Delegates.Params_UpdateSceneLoadRecordContent @params = new()
            {
                self = self, sceneLoad = sceneLoad, report = report
            };
            if (_beforeUpdateSceneLoadRecordContent != null)
                foreach (Delegates.UpdateSceneLoadRecordContent_BeforeArgs toInvoke in
                         _beforeUpdateSceneLoadRecordContent.GetInvocationList())
                    try
                    {
            ...
            if (_afterUpdateSceneLoadRecordContent != null)
                foreach (Delegates.UpdateSceneLoadRecordContent_AfterArgs toInvoke in _afterUpdateSceneLoadRecordContent
                             .GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void LabelWithShadow_WithArgs(Action<PerformanceHUD, Rect, GUIContent> orig,
            PerformanceHUD self, Rect rect, GUIContent content);
        ...
        public delegate IEnumerator ReportUpload_AfterArgs(Params_ReportUpload args, IEnumerator ret);

        public delegate void ReportUpload_BeforeArgs(Params_ReportUpload args);

        public delegate IEnumerator ReportUpload_WithArgs(Func<PerformanceHUD, WWW, IEnumerator> orig,
            PerformanceHUD self, WWW www);
        ...
        public delegate void UpdateSceneLoadRecordContent_WithArgs(
            Action<PerformanceHUD, SceneLoad, PerformanceHUD.LoadReport> orig, PerformanceHUD self, SceneLoad sceneLoad,
            PerformanceHUD.LoadReport report);
