...
internal static event Delegates.GameManager_SceneTransitionBegan_BeforeArgs _beforeGameManager_SceneTransitionBegan;
internal static event Delegates.GameManager_SceneTransitionBegan_AfterArgs _afterGameManager_SceneTransitionBegan;
private static void GameManager_SceneTransitionBegan(On.PerformanceHUD.orig_GameManager_SceneTransitionBegan orig,PerformanceHUD self,  SceneLoad sceneLoad)
{
...
{
foreach (Delegates.GameManager_SceneTransitionBegan_BeforeArgs toInvoke in _beforeGameManager_SceneTransitionBegan.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GameManager_SceneTransitionBegan_AfterArgs toInvoke in _afterGameManager_SceneTransitionBegan.GetInvocationList())
{
try
{
...
internal static void HookUpdateSceneLoadRecordContent()
{
if (!HookedList.Contains("UpdateSceneLoadRecordContent"))
{
HookedList.Add("UpdateSceneLoadRecordContent");
On.PerformanceHUD.UpdateSceneLoadRecordContent += UpdateSceneLoadRecordContent;

}
}
internal static event Delegates.UpdateSceneLoadRecordContent_BeforeArgs _beforeUpdateSceneLoadRecordContent;
internal static event Delegates.UpdateSceneLoadRecordContent_AfterArgs _afterUpdateSceneLoadRecordContent;
private static void UpdateSceneLoadRecordContent(On.PerformanceHUD.orig_UpdateSceneLoadRecordContent orig,PerformanceHUD self,  SceneLoad sceneLoad,  PerformanceHUD.LoadReport report)
{
Delegates.Params_UpdateSceneLoadRecordContent @params = new() 
{
self = self
, sceneLoad = sceneLoad
, report = report
};
if (_beforeUpdateSceneLoadRecordContent != null)
{
foreach (Delegates.UpdateSceneLoadRecordContent_BeforeArgs toInvoke in _beforeUpdateSceneLoadRecordContent.GetInvocationList())
{
try
{
_beforeUpdateSceneLoadRecordContent?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
orig(self, sceneLoad, report);
if (_afterUpdateSceneLoadRecordContent != null)
{
foreach (Delegates.UpdateSceneLoadRecordContent_AfterArgs toInvoke in _afterUpdateSceneLoadRecordContent.GetInvocationList())
{
try
{
_afterUpdateSceneLoadRecordContent.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
private static System.Collections.IEnumerator ReportUpload(On.PerformanceHUD.orig_ReportUpload orig,PerformanceHUD self,  UnityEngine.WWW www)
{
...
private static void LabelWithShadow(On.PerformanceHUD.orig_LabelWithShadow orig,PerformanceHUD self,  UnityEngine.Rect rect,  UnityEngine.GUIContent content)
{
...
public delegate void GameManager_SceneTransitionBegan_WithArgs (Action<PerformanceHUD,  SceneLoad> orig, PerformanceHUD self,  SceneLoad sceneLoad);
public sealed class Params_UpdateSceneLoadRecordContent
{
public PerformanceHUD self;
public SceneLoad sceneLoad;
public PerformanceHUD.LoadReport report;
}
public delegate void UpdateSceneLoadRecordContent_BeforeArgs(Params_UpdateSceneLoadRecordContent args);
public delegate void UpdateSceneLoadRecordContent_AfterArgs(Params_UpdateSceneLoadRecordContent args);
public delegate void UpdateSceneLoadRecordContent_WithArgs (Action<PerformanceHUD,  SceneLoad,  PerformanceHUD.LoadReport> orig, PerformanceHUD self,  SceneLoad sceneLoad,  PerformanceHUD.LoadReport report);
...
public delegate System.Collections.IEnumerator ReportUpload_AfterArgs(Params_ReportUpload args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ReportUpload_WithArgs (Func<PerformanceHUD,  UnityEngine.WWW, System.Collections.IEnumerator> orig, PerformanceHUD self,  UnityEngine.WWW www);
...
public delegate void LabelWithShadow_WithArgs (Action<PerformanceHUD,  UnityEngine.Rect,  UnityEngine.GUIContent> orig, PerformanceHUD self,  UnityEngine.Rect rect,  UnityEngine.GUIContent content);
}
...
public static event Delegates.UpdateSceneLoadRecordContent_BeforeArgs UpdateSceneLoadRecordContent
{
add
{

HookHandler._beforeUpdateSceneLoadRecordContent += value;
HookHandler.HookUpdateSceneLoadRecordContent();
}
remove => HookHandler._beforeUpdateSceneLoadRecordContent -= value;
}
...
public static event Delegates.UpdateSceneLoadRecordContent_AfterArgs UpdateSceneLoadRecordContent
{
add
{

HookHandler._afterUpdateSceneLoadRecordContent += value;
HookHandler.HookUpdateSceneLoadRecordContent();
}
remove => HookHandler._afterUpdateSceneLoadRecordContent -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.get_Shared_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_Shared", false), value);
remove => HookEndpointManager.Remove<Delegates.get_Shared_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_Shared", false), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_FpsFrames_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_FpsFrames", true), value);
remove => HookEndpointManager.Remove<Delegates.get_FpsFrames_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_FpsFrames", true), value);
}
public static event Delegates.set_FpsFrames_WithArgs set_FpsFrames
{
add => HookEndpointManager.Add<Delegates.set_FpsFrames_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "set_FpsFrames", true), value);
remove => HookEndpointManager.Remove<Delegates.set_FpsFrames_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "set_FpsFrames", true), value);
}
...
public static event On.PerformanceHUD.hook_UpdateSceneLoadRecordContent UpdateSceneLoadRecordContent
{
add => On.PerformanceHUD.UpdateSceneLoadRecordContent += value;
remove => On.PerformanceHUD.UpdateSceneLoadRecordContent -= value;
}
