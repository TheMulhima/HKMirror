...
public static class OnBuffaloClassicMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BuffaloClassicMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BuffaloClassicMacNativeProfile> orig, BuffaloClassicMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BuffaloClassicMacNativeProfile> orig,
            BuffaloClassicMacNativeProfile self);

        public sealed class Params_Define
        {
            public BuffaloClassicMacNativeProfile self;
        }
    }
