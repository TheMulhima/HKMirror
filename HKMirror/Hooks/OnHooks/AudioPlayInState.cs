...
public static class OnAudioPlayInState
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AudioPlayInState), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<AudioPlayInState> orig, AudioPlayInState self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AudioPlayInState), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<AudioPlayInState> orig, AudioPlayInState self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AudioPlayInState), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<AudioPlayInState> orig, AudioPlayInState self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<AudioPlayInState> orig, AudioPlayInState self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<AudioPlayInState> orig, AudioPlayInState self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<AudioPlayInState> orig, AudioPlayInState self);

        public sealed class Params_Reset
        {
            public AudioPlayInState self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AudioPlayInState), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AudioPlayInState), "OnEnter"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AudioPlayInState), "OnExit"), value);
