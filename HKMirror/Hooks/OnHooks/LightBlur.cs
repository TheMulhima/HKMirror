...
public static class OnLightBlur
{
    ...
    public static class Delegates
    {
        ...
        public delegate void OnRenderImage_WithArgs(Action<LightBlur, RenderTexture, RenderTexture> orig,
            LightBlur self, RenderTexture source, RenderTexture destination);
