...
public static class OnLightBlur
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_PassGroupCount()
        {
            if (!HookedList.Contains("get_PassGroupCount"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LightBlur), "get_PassGroupCount", true),
                    get_PassGroupCount);
            }
        }
        ...
        internal static void Hookset_PassGroupCount()
        {
            if (!HookedList.Contains("set_PassGroupCount"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LightBlur), "set_PassGroupCount", true),
                    set_PassGroupCount);
            }
        }
        ...
        internal static void Hookget_BlurPassCount()
        {
            if (!HookedList.Contains("get_BlurPassCount"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LightBlur), "get_BlurPassCount", true),
                    get_BlurPassCount);
            }
        }
        ...
        private static int get_BlurPassCount(Func<LightBlur, int> orig, LightBlur self)
        {
            ...
            {
                foreach (Delegates.get_BlurPassCount_BeforeArgs toInvoke in
                         _beforeget_BlurPassCount.GetInvocationList())
                {
                    try
                    {
        ...
        private static void OnRenderImage(On.LightBlur.orig_OnRenderImage orig, LightBlur self,
    ...
    public static class Delegates
    {
        ...
        public delegate void OnRenderImage_WithArgs(
            Action<LightBlur, UnityEngine.RenderTexture, UnityEngine.RenderTexture> orig, LightBlur self,
            UnityEngine.RenderTexture source, UnityEngine.RenderTexture destination);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_PassGroupCount_WithArgs get_PassGroupCount
        {
            add => HookEndpointManager.Add<Delegates.get_PassGroupCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlur), "get_PassGroupCount", true), value);
        ...
        public static event Delegates.set_PassGroupCount_WithArgs set_PassGroupCount
        {
            add => HookEndpointManager.Add<Delegates.set_PassGroupCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlur), "set_PassGroupCount", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_BlurPassCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlur), "get_BlurPassCount", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_BlurPassCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlur), "get_BlurPassCount", true), value);
        }
