...
public static class OniTweenMoveTo
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnDrawActionGizmos()
        {
            if (!HookedList.Contains("OnDrawActionGizmos"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenMoveTo),
        ...
        private static void OnDrawActionGizmos(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenMoveTo), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenMoveTo), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenMoveTo), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenMoveTo), "DoiTween",
                        true), DoiTween);
            }
        }
        ...
        private static void DoiTween(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnDrawActionGizmos_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self);
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self);
        ...
        public delegate void DoiTween_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenMoveTo> orig,
            HutongGames.PlayMaker.Actions.iTweenMoveTo self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnDrawActionGizmos_WithArgs OnDrawActionGizmos
        {
            add => HookEndpointManager.Add<Delegates.OnDrawActionGizmos_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenMoveTo), "OnDrawActionGizmos",
                    true), value);
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenMoveTo), "DoiTween", true),
                value);
