...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteDefinition), "get_Valid", true), get_Valid);
...
private static UnityEngine.Bounds GetBounds(On.tk2dSpriteDefinition.orig_GetBounds orig,tk2dSpriteDefinition self)
{
...
private static UnityEngine.Bounds GetUntrimmedBounds(On.tk2dSpriteDefinition.orig_GetUntrimmedBounds orig,tk2dSpriteDefinition self)
{
...
{
foreach (Delegates.GetUntrimmedBounds_BeforeArgs toInvoke in _beforeGetUntrimmedBounds.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetUntrimmedBounds_AfterArgs toInvoke in _afterGetUntrimmedBounds.GetInvocationList())
{
try
{
...
public delegate UnityEngine.Bounds GetBounds_AfterArgs(Params_GetBounds args, UnityEngine.Bounds ret);
public delegate UnityEngine.Bounds GetBounds_WithArgs (Func<tk2dSpriteDefinition, UnityEngine.Bounds> orig, tk2dSpriteDefinition self);
...
public delegate UnityEngine.Bounds GetUntrimmedBounds_AfterArgs(Params_GetUntrimmedBounds args, UnityEngine.Bounds ret);
public delegate UnityEngine.Bounds GetUntrimmedBounds_WithArgs (Func<tk2dSpriteDefinition, UnityEngine.Bounds> orig, tk2dSpriteDefinition self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Valid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteDefinition), "get_Valid", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Valid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteDefinition), "get_Valid", true), value);
}
