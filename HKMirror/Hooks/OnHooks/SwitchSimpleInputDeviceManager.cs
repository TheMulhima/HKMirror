...
public static class OnSwitchSimpleInputDeviceManager
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Device()
        {
            if (!HookedList.Contains("get_Device"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDeviceManager), "get_Device",
                        true), get_Device);
            }
        }
        ...
        private static InControl.SwitchSimpleInputDevice get_Device(
            Func<InControl.SwitchSimpleInputDeviceManager, InControl.SwitchSimpleInputDevice> orig,
            InControl.SwitchSimpleInputDeviceManager self)
        {
        ...
        internal static void HookUpdate()
        {
            if (!HookedList.Contains("Update"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDeviceManager), "Update", true),
                    Update);
            }
        }
        ...
        private static void Update(Action<InControl.SwitchSimpleInputDeviceManager, ulong, float> orig,
            InControl.SwitchSimpleInputDeviceManager self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookCheckPlatformSupport()
        {
            if (!HookedList.Contains("CheckPlatformSupport"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDeviceManager),
                        "CheckPlatformSupport", false), CheckPlatformSupport);
            }
        }
        ...
        internal static void HookEnable()
        {
            if (!HookedList.Contains("Enable"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDeviceManager), "Enable", false),
                    Enable);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate InControl.SwitchSimpleInputDevice get_Device_AfterArgs(Params_get_Device args,
            InControl.SwitchSimpleInputDevice ret);

        public delegate InControl.SwitchSimpleInputDevice get_Device_WithArgs(
            Func<InControl.SwitchSimpleInputDeviceManager, InControl.SwitchSimpleInputDevice> orig,
            InControl.SwitchSimpleInputDeviceManager self);
        ...
        public delegate void Update_WithArgs(Action<InControl.SwitchSimpleInputDeviceManager, ulong, float> orig,
            InControl.SwitchSimpleInputDeviceManager self, ulong updateTick, float deltaTime);
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Device_WithArgs get_Device
        {
            add => HookEndpointManager.Add<Delegates.get_Device_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDeviceManager), "get_Device", true),
                value);
        ...
        public static event Delegates.CheckPlatformSupport_WithArgs CheckPlatformSupport
        {
            add => HookEndpointManager.Add<Delegates.CheckPlatformSupport_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDeviceManager), "CheckPlatformSupport",
                    false), value);
