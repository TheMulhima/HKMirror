...
public static class Ontk2dUIManager
{
    internal static class HookHandler
    {
        ...
        private static tk2dUIManager get_Instance__NoCreate(Func<tk2dUIManager> orig)
        {
            ...
            {
                foreach (Delegates.get_Instance__NoCreate_BeforeArgs toInvoke in _beforeget_Instance__NoCreate
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_Instance__NoCreate_AfterArgs toInvoke in _afterget_Instance__NoCreate
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void set_UICamera(Action<tk2dUIManager, UnityEngine.Camera> orig, tk2dUIManager self,
        ...
        private static UnityEngine.Camera GetUICameraForControl(On.tk2dUIManager.orig_GetUICameraForControl orig,
            tk2dUIManager self, UnityEngine.GameObject go)
        {
            ...
            {
                foreach (Delegates.GetUICameraForControl_BeforeArgs toInvoke in _beforeGetUICameraForControl
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetUICameraForControl_AfterArgs toInvoke in _afterGetUICameraForControl
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_InputEnabled()
        {
            if (!HookedList.Contains("get_InputEnabled"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_InputEnabled", true),
                    get_InputEnabled);
            }
        }
        ...
        internal static void Hookset_InputEnabled()
        {
            if (!HookedList.Contains("set_InputEnabled"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_InputEnabled", true),
                    set_InputEnabled);
            }
        }
        ...
        internal static void Hookget_PressedUIItem()
        {
            if (!HookedList.Contains("get_PressedUIItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_PressedUIItem", true),
                    get_PressedUIItem);
            }
        }
        ...
        private static tk2dUIItem get_PressedUIItem(Func<tk2dUIManager, tk2dUIItem> orig, tk2dUIManager self)
        {
            ...
            {
                foreach (Delegates.get_PressedUIItem_BeforeArgs toInvoke in
                         _beforeget_PressedUIItem.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_PressedUIItems()
        {
            if (!HookedList.Contains("get_PressedUIItems"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_PressedUIItems", true),
                    get_PressedUIItems);
            }
        }
        ...
        private static tk2dUIItem[] get_PressedUIItems(Func<tk2dUIManager, tk2dUIItem[]> orig, tk2dUIManager self)
        {
            ...
            {
                foreach (Delegates.get_PressedUIItems_BeforeArgs toInvoke in
                         _beforeget_PressedUIItems.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_PressedUIItems_AfterArgs toInvoke in
                         _afterget_PressedUIItems.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_UseMultiTouch()
        {
            if (!HookedList.Contains("get_UseMultiTouch"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_UseMultiTouch", true),
                    get_UseMultiTouch);
            }
        }
        ...
        private static bool get_UseMultiTouch(Func<tk2dUIManager, bool> orig, tk2dUIManager self)
        {
            ...
            {
                foreach (Delegates.get_UseMultiTouch_BeforeArgs toInvoke in
                         _beforeget_UseMultiTouch.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_UseMultiTouch()
        {
            if (!HookedList.Contains("set_UseMultiTouch"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_UseMultiTouch", true),
                    set_UseMultiTouch);
            }
        }
        ...
        private static void set_UseMultiTouch(Action<tk2dUIManager, bool> orig, tk2dUIManager self, bool value)
        {
            ...
            {
                foreach (Delegates.set_UseMultiTouch_BeforeArgs toInvoke in
                         _beforeset_UseMultiTouch.GetInvocationList())
                {
                    try
                    {
            ...
            UnityEngine.Camera cam)
        {
            ...
            {
                foreach (Delegates.HookUpLegacyCamera_BeforeArgs toInvoke in
                         _beforeHookUpLegacyCamera.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.HookUpLegacyCamera_AfterArgs toInvoke in
                         _afterHookUpLegacyCamera.GetInvocationList())
                {
                    try
                    {
        ...
        private static void CheckMultiTouchInputs(On.tk2dUIManager.orig_CheckMultiTouchInputs orig, tk2dUIManager self)
        {
            ...
            {
                foreach (Delegates.CheckMultiTouchInputs_BeforeArgs toInvoke in _beforeCheckMultiTouchInputs
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CheckMultiTouchInputs_AfterArgs toInvoke in _afterCheckMultiTouchInputs
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIManager self, tk2dUIItem item)
        {
            ...
            {
                foreach (Delegates.OverrideClearAllChildrenPresses_BeforeArgs toInvoke in
                         _beforeOverrideClearAllChildrenPresses.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.OverrideClearAllChildrenPresses_AfterArgs toInvoke in
                         _afterOverrideClearAllChildrenPresses.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Camera get_UICamera_WithArgs(Func<tk2dUIManager, UnityEngine.Camera> orig,
            tk2dUIManager self);
        ...
        public delegate void set_UICamera_WithArgs(Action<tk2dUIManager, UnityEngine.Camera> orig, tk2dUIManager self,
            UnityEngine.Camera value);
        ...
        public delegate UnityEngine.Camera GetUICameraForControl_AfterArgs(Params_GetUICameraForControl args,
            UnityEngine.Camera ret);

        public delegate UnityEngine.Camera GetUICameraForControl_WithArgs(
            Func<tk2dUIManager, UnityEngine.GameObject, UnityEngine.Camera> orig, tk2dUIManager self,
        ...
        public delegate void
            set_InputEnabled_WithArgs(Action<tk2dUIManager, bool> orig, tk2dUIManager self, bool value);
        ...
        public delegate tk2dUIItem[] get_PressedUIItems_WithArgs(Func<tk2dUIManager, tk2dUIItem[]> orig,
            tk2dUIManager self);
        ...
        public delegate void set_UseMultiTouch_WithArgs(Action<tk2dUIManager, bool> orig, tk2dUIManager self,
            bool value);
        ...
        public delegate void HookUpLegacyCamera_WithArgs(Action<tk2dUIManager, UnityEngine.Camera> orig,
            tk2dUIManager self, UnityEngine.Camera cam);
        ...
        public delegate tk2dUIItem RaycastForUIItem_WithArgs(Func<tk2dUIManager, UnityEngine.Vector2, tk2dUIItem> orig,
            tk2dUIManager self, UnityEngine.Vector2 screenPos);
        ...
        public delegate void OverrideClearAllChildrenPresses_WithArgs(Action<tk2dUIManager, tk2dUIItem> orig,
            tk2dUIManager self, tk2dUIItem item);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_Instance__NoCreate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_Instance__NoCreate", false), value);
            remove => HookEndpointManager.Remove<Delegates.get_Instance__NoCreate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_Instance__NoCreate", false), value);
        }

        public static event Delegates.get_UICamera_WithArgs get_UICamera
        {
            add => HookEndpointManager.Add<Delegates.get_UICamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_UICamera", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_UICamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_UICamera", true), value);
        }

        public static event Delegates.set_UICamera_WithArgs set_UICamera
        {
            add => HookEndpointManager.Add<Delegates.set_UICamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_UICamera", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_UICamera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_UICamera", true), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_InputEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_InputEnabled", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_InputEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_InputEnabled", true), value);
        }

        public static event Delegates.set_InputEnabled_WithArgs set_InputEnabled
        {
            add => HookEndpointManager.Add<Delegates.set_InputEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_InputEnabled", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_InputEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_InputEnabled", true), value);
        }

        public static event Delegates.get_PressedUIItem_WithArgs get_PressedUIItem
        {
            add => HookEndpointManager.Add<Delegates.get_PressedUIItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_PressedUIItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_PressedUIItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_PressedUIItem", true), value);
        }

        public static event Delegates.get_PressedUIItems_WithArgs get_PressedUIItems
        {
            add => HookEndpointManager.Add<Delegates.get_PressedUIItems_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_PressedUIItems", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_PressedUIItems_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_PressedUIItems", true), value);
        }

        public static event Delegates.get_UseMultiTouch_WithArgs get_UseMultiTouch
        {
            add => HookEndpointManager.Add<Delegates.get_UseMultiTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_UseMultiTouch", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_UseMultiTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "get_UseMultiTouch", true), value);
        }

        public static event Delegates.set_UseMultiTouch_WithArgs set_UseMultiTouch
        {
            add => HookEndpointManager.Add<Delegates.set_UseMultiTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_UseMultiTouch", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_UseMultiTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIManager), "set_UseMultiTouch", true), value);
        }
