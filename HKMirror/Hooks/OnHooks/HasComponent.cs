...
public static class OnHasComponent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self)
        {
        ...
        internal static void HookDoHasComponent()
        {
            if (!HookedList.Contains("DoHasComponent"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "DoHasComponent",
                        true), DoHasComponent);
            }
        }
        ...
        private static void DoHasComponent(
            Action<HutongGames.PlayMaker.Actions.HasComponent, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.HasComponent self, UnityEngine.GameObject go)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.HasComponent> orig,
            HutongGames.PlayMaker.Actions.HasComponent self);
        ...
        public delegate void DoHasComponent_WithArgs(
            Action<HutongGames.PlayMaker.Actions.HasComponent, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.HasComponent self, UnityEngine.GameObject go);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "OnUpdate", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoHasComponent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "DoHasComponent",
                    true), value);
            remove => HookEndpointManager.Remove<Delegates.DoHasComponent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HasComponent), "DoHasComponent",
                    true), value);
        }
    }
