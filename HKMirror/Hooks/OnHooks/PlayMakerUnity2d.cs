...
private static void RecordLastRaycastHitInfo(On.PlayMakerUnity2d.orig_RecordLastRaycastHitInfo orig, HutongGames.PlayMaker.Fsm fsm,  UnityEngine.RaycastHit2D info)
{
...
{
foreach (Delegates.RecordLastRaycastHitInfo_BeforeArgs toInvoke in _beforeRecordLastRaycastHitInfo.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RecordLastRaycastHitInfo_AfterArgs toInvoke in _afterRecordLastRaycastHitInfo.GetInvocationList())
{
try
{
...
private static UnityEngine.RaycastHit2D GetLastRaycastHitInfo(On.PlayMakerUnity2d.orig_GetLastRaycastHitInfo orig, HutongGames.PlayMaker.Fsm fsm)
{
...
{
foreach (Delegates.GetLastRaycastHitInfo_BeforeArgs toInvoke in _beforeGetLastRaycastHitInfo.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetLastRaycastHitInfo_AfterArgs toInvoke in _afterGetLastRaycastHitInfo.GetInvocationList())
{
try
{
...
private static void OnLevelWasLoaded(On.PlayMakerUnity2d.orig_OnLevelWasLoaded orig,PlayMakerUnity2d self,  int level)
{
...
private static void ForwardEventToGameObject(On.PlayMakerUnity2d.orig_ForwardEventToGameObject orig, UnityEngine.GameObject target,  string eventName)
{
...
{
foreach (Delegates.ForwardEventToGameObject_BeforeArgs toInvoke in _beforeForwardEventToGameObject.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ForwardEventToGameObject_AfterArgs toInvoke in _afterForwardEventToGameObject.GetInvocationList())
{
try
{
...
internal static void HookForwardCollisionToCurrentState()
{
if (!HookedList.Contains("ForwardCollisionToCurrentState"))
{
HookedList.Add("ForwardCollisionToCurrentState");
On.PlayMakerUnity2d.ForwardCollisionToCurrentState += ForwardCollisionToCurrentState;

}
}
internal static event Delegates.ForwardCollisionToCurrentState_BeforeArgs _beforeForwardCollisionToCurrentState;
internal static event Delegates.ForwardCollisionToCurrentState_AfterArgs _afterForwardCollisionToCurrentState;
private static void ForwardCollisionToCurrentState(On.PlayMakerUnity2d.orig_ForwardCollisionToCurrentState orig, UnityEngine.GameObject target,  PlayMakerUnity2d.Collision2DType type,  UnityEngine.Collision2D CollisionInfo)
{
Delegates.Params_ForwardCollisionToCurrentState @params = new() 
{
target = target
, type = type
, CollisionInfo = CollisionInfo
};
if (_beforeForwardCollisionToCurrentState != null)
{
foreach (Delegates.ForwardCollisionToCurrentState_BeforeArgs toInvoke in _beforeForwardCollisionToCurrentState.GetInvocationList())
{
try
{
_beforeForwardCollisionToCurrentState?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
orig(target, type, CollisionInfo);
if (_afterForwardCollisionToCurrentState != null)
{
foreach (Delegates.ForwardCollisionToCurrentState_AfterArgs toInvoke in _afterForwardCollisionToCurrentState.GetInvocationList())
{
try
{
_afterForwardCollisionToCurrentState.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
public delegate void RecordLastRaycastHitInfo_WithArgs (Action< HutongGames.PlayMaker.Fsm,  UnityEngine.RaycastHit2D> orig,  HutongGames.PlayMaker.Fsm fsm,  UnityEngine.RaycastHit2D info);
...
public delegate UnityEngine.RaycastHit2D GetLastRaycastHitInfo_AfterArgs(Params_GetLastRaycastHitInfo args, UnityEngine.RaycastHit2D ret);
public delegate UnityEngine.RaycastHit2D GetLastRaycastHitInfo_WithArgs (Func< HutongGames.PlayMaker.Fsm, UnityEngine.RaycastHit2D> orig,  HutongGames.PlayMaker.Fsm fsm);
...
public delegate void OnLevelWasLoaded_WithArgs (Action<PlayMakerUnity2d,  int> orig, PlayMakerUnity2d self,  int level);
...
public delegate void ForwardEventToGameObject_WithArgs (Action< UnityEngine.GameObject,  string> orig,  UnityEngine.GameObject target,  string eventName);
public sealed class Params_ForwardCollisionToCurrentState
{
public UnityEngine.GameObject target;
public PlayMakerUnity2d.Collision2DType type;
public UnityEngine.Collision2D CollisionInfo;
}
public delegate void ForwardCollisionToCurrentState_BeforeArgs(Params_ForwardCollisionToCurrentState args);
public delegate void ForwardCollisionToCurrentState_AfterArgs(Params_ForwardCollisionToCurrentState args);
public delegate void ForwardCollisionToCurrentState_WithArgs (Action< UnityEngine.GameObject,  PlayMakerUnity2d.Collision2DType,  UnityEngine.Collision2D> orig,  UnityEngine.GameObject target,  PlayMakerUnity2d.Collision2DType type,  UnityEngine.Collision2D CollisionInfo);
}
...
public static event Delegates.ForwardCollisionToCurrentState_BeforeArgs ForwardCollisionToCurrentState
{
add
{

HookHandler._beforeForwardCollisionToCurrentState += value;
HookHandler.HookForwardCollisionToCurrentState();
}
remove => HookHandler._beforeForwardCollisionToCurrentState -= value;
}
}
...
public static event Delegates.ForwardCollisionToCurrentState_AfterArgs ForwardCollisionToCurrentState
{
add
{

HookHandler._afterForwardCollisionToCurrentState += value;
HookHandler.HookForwardCollisionToCurrentState();
}
remove => HookHandler._afterForwardCollisionToCurrentState -= value;
}
}
...
public static event On.PlayMakerUnity2d.hook_ForwardCollisionToCurrentState ForwardCollisionToCurrentState
{
add => On.PlayMakerUnity2d.ForwardCollisionToCurrentState += value;
remove => On.PlayMakerUnity2d.ForwardCollisionToCurrentState -= value;
}
}
