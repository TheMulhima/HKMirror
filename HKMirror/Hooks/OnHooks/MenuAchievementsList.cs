    ...
    public static class WithOrig
    {
        public static event Delegates.get_init_WithArgs get_init
        {
            add => HookEndpointManager.Add<Delegates.get_init_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuAchievementsList), "get_init", true), value);
        ...
        public static event Delegates.set_init_WithArgs set_init
        {
            add => HookEndpointManager.Add<Delegates.set_init_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuAchievementsList), "set_init", true), value);
