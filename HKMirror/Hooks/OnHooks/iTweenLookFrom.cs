...
public static class OniTweenLookFrom
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<iTweenLookFrom> orig, iTweenLookFrom self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<iTweenLookFrom> orig, iTweenLookFrom self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<iTweenLookFrom> orig, iTweenLookFrom self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "DoiTween"), DoiTween);
            }
        }
        ...
        private static void DoiTween(Action<iTweenLookFrom> orig, iTweenLookFrom self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoiTween_WithArgs(Action<iTweenLookFrom> orig, iTweenLookFrom self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<iTweenLookFrom> orig, iTweenLookFrom self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<iTweenLookFrom> orig, iTweenLookFrom self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<iTweenLookFrom> orig, iTweenLookFrom self);

        public sealed class Params_Reset
        {
            public iTweenLookFrom self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "OnEnter"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "OnExit"), value);
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenLookFrom), "DoiTween"), value);
