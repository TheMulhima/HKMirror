...
public static class OnPowerAMiniProExControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PowerAMiniProExControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PowerAMiniProExControllerMacNativeProfile> orig,
            PowerAMiniProExControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PowerAMiniProExControllerMacNativeProfile> orig,
            PowerAMiniProExControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PowerAMiniProExControllerMacNativeProfile self;
        }
    }
