...
/// <summary>
/// Contains different types of On Hooks for GGCheckIfLastBossScene class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGGCheckIfLastBossScene
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfLastBossScene), "get_IsTrue", true), get_IsTrue);
...
private static bool get_IsTrue(Func<GGCheckIfLastBossScene, bool> orig, GGCheckIfLastBossScene self)
{
...
{
public GGCheckIfLastBossScene self;
}
...
public delegate bool get_IsTrue_WithArgs (Func<GGCheckIfLastBossScene, bool> orig, GGCheckIfLastBossScene self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfLastBossScene), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfLastBossScene), "get_IsTrue", true), value);
}
}
