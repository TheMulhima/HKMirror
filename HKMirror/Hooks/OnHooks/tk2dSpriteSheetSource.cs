...
public static class Ontk2dSpriteSheetSource
{
    ...
    public static class Delegates
    {
        ...
        public delegate void CopyFrom_WithArgs(Action<tk2dSpriteSheetSource, tk2dSpriteSheetSource> orig,
            tk2dSpriteSheetSource self, tk2dSpriteSheetSource src);
        ...
        public delegate bool CompareTo_WithArgs(Func<tk2dSpriteSheetSource, tk2dSpriteSheetSource, bool> orig,
            tk2dSpriteSheetSource self, tk2dSpriteSheetSource src);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.get_Name_WithArgs get_Name
        {
            add => HookEndpointManager.Add<Delegates.get_Name_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteSheetSource), "get_Name", true), value);
