...
public static class OnHarmonixDrumKitMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HarmonixDrumKitMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HarmonixDrumKitMacNativeProfile> orig, HarmonixDrumKitMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HarmonixDrumKitMacNativeProfile> orig,
            HarmonixDrumKitMacNativeProfile self);

        public sealed class Params_Define
        {
            public HarmonixDrumKitMacNativeProfile self;
        }
    }
