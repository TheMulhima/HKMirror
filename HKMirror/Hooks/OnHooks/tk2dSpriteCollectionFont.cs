...
private static void CopyFrom(On.tk2dSpriteCollectionFont.orig_CopyFrom orig,tk2dSpriteCollectionFont self,  tk2dSpriteCollectionFont src)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionFont), "get_InUse", true), get_InUse);
...
public delegate void CopyFrom_WithArgs (Action<tk2dSpriteCollectionFont,  tk2dSpriteCollectionFont> orig, tk2dSpriteCollectionFont self,  tk2dSpriteCollectionFont src);
...
public delegate string get_Name_WithArgs (Func<tk2dSpriteCollectionFont, string> orig, tk2dSpriteCollectionFont self);
...
public delegate bool get_InUse_WithArgs (Func<tk2dSpriteCollectionFont, bool> orig, tk2dSpriteCollectionFont self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Name_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionFont), "get_Name", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Name_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionFont), "get_Name", true), value);
}
public static event Delegates.get_InUse_WithArgs get_InUse
{
add => HookEndpointManager.Add<Delegates.get_InUse_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionFont), "get_InUse", true), value);
remove => HookEndpointManager.Remove<Delegates.get_InUse_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionFont), "get_InUse", true), value);
}
}
