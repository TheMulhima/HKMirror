...
public static class OnSoulOrb
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator Zoom_AfterArgs(Params_Zoom args, IEnumerator ret);

        public delegate void Zoom_BeforeArgs(Params_Zoom args);

        public delegate IEnumerator Zoom_WithArgs(Func<SoulOrb, bool, IEnumerator> orig, SoulOrb self, bool doZoom);
