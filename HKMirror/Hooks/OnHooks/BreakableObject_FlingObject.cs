...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BreakableObject.FlingObject), "Fling", true), Fling);

}
}
internal static event Delegates.Fling_BeforeArgs _beforeFling;
internal static event Delegates.Fling_AfterArgs _afterFling;
private static void Fling(Action<BreakableObject.FlingObject,  UnityEngine.Vector3> orig, BreakableObject.FlingObject self,  UnityEngine.Vector3 origin)
{
...
public delegate void Fling_WithArgs (Action<BreakableObject.FlingObject,  UnityEngine.Vector3> orig, BreakableObject.FlingObject self,  UnityEngine.Vector3 origin);
}
...
{
add => HookEndpointManager.Add<Delegates.Fling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BreakableObject.FlingObject), "Fling", true), value);
remove => HookEndpointManager.Remove<Delegates.Fling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BreakableObject.FlingObject), "Fling", true), value);
}
}
