...
public static class OnMadCatzSF4FightStickRound2TEMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MadCatzSF4FightStickRound2TEMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.MadCatzSF4FightStickRound2TEMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSF4FightStickRound2TEMacNativeProfile self)
        {
