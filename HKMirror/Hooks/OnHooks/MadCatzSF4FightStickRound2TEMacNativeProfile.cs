...
public static class OnMadCatzSF4FightStickRound2TEMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzSF4FightStickRound2TEMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzSF4FightStickRound2TEMacNativeProfile> orig,
            MadCatzSF4FightStickRound2TEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzSF4FightStickRound2TEMacNativeProfile> orig,
            MadCatzSF4FightStickRound2TEMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzSF4FightStickRound2TEMacNativeProfile self;
        }
    }
