...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossStatueLoadManager), "get_ShouldUnload", false), get_ShouldUnload);
...
{
add => HookEndpointManager.Add<Delegates.get_ShouldUnload_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossStatueLoadManager), "get_ShouldUnload", false), value);
remove => HookEndpointManager.Remove<Delegates.get_ShouldUnload_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossStatueLoadManager), "get_ShouldUnload", false), value);
}
