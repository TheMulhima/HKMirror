...
new Hook(ReflectionHelper.GetMethodInfo(typeof(AudioManager), "get_CurrentMusicCue", true), get_CurrentMusicCue);
...
{
foreach (Delegates.get_CurrentMusicCue_BeforeArgs toInvoke in _beforeget_CurrentMusicCue.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_CurrentMusicCue_AfterArgs toInvoke in _afterget_CurrentMusicCue.GetInvocationList())
{
try
{
...
private static void ApplyAtmosCue(On.AudioManager.orig_ApplyAtmosCue orig,AudioManager self,  AtmosCue atmosCue,  float transitionTime)
{
...
private static System.Collections.IEnumerator BeginApplyAtmosCue(On.AudioManager.orig_BeginApplyAtmosCue orig,AudioManager self,  AtmosCue atmosCue,  float transitionTime)
{
...
{
foreach (Delegates.BeginApplyAtmosCue_BeforeArgs toInvoke in _beforeBeginApplyAtmosCue.GetInvocationList())
{
try
{
...
private static void ApplyMusicCue(On.AudioManager.orig_ApplyMusicCue orig,AudioManager self,  MusicCue musicCue,  float delayTime,  float transitionTime,  bool applySnapshot)
{
...
private static System.Collections.IEnumerator BeginApplyMusicCue(On.AudioManager.orig_BeginApplyMusicCue orig,AudioManager self,  MusicCue musicCue,  float delayTime,  float transitionTime,  bool applySnapshot)
{
...
{
foreach (Delegates.BeginApplyMusicCue_BeforeArgs toInvoke in _beforeBeginApplyMusicCue.GetInvocationList())
{
try
{
...
private static void UpdateMusicSync(On.AudioManager.orig_UpdateMusicSync orig,AudioManager self,  MusicChannels musicChannel,  bool isSyncRequired)
{
...
private static void ApplyMusicSnapshot(On.AudioManager.orig_ApplyMusicSnapshot orig,AudioManager self,  UnityEngine.Audio.AudioMixerSnapshot snapshot,  float delayTime,  float transitionTime)
{
...
{
foreach (Delegates.ApplyMusicSnapshot_BeforeArgs toInvoke in _beforeApplyMusicSnapshot.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyMusicSnapshot_AfterArgs toInvoke in _afterApplyMusicSnapshot.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator BeginApplyMusicSnapshot(On.AudioManager.orig_BeginApplyMusicSnapshot orig,AudioManager self,  UnityEngine.Audio.AudioMixerSnapshot snapshot,  float delayTime,  float transitionTime)
{
...
{
foreach (Delegates.BeginApplyMusicSnapshot_BeforeArgs toInvoke in _beforeBeginApplyMusicSnapshot.GetInvocationList())
{
try
{
...
public delegate void ApplyAtmosCue_WithArgs (Action<AudioManager,  AtmosCue,  float> orig, AudioManager self,  AtmosCue atmosCue,  float transitionTime);
...
public delegate System.Collections.IEnumerator BeginApplyAtmosCue_AfterArgs(Params_BeginApplyAtmosCue args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator BeginApplyAtmosCue_WithArgs (Func<AudioManager,  AtmosCue,  float, System.Collections.IEnumerator> orig, AudioManager self,  AtmosCue atmosCue,  float transitionTime);
...
public delegate void ApplyMusicCue_WithArgs (Action<AudioManager,  MusicCue,  float,  float,  bool> orig, AudioManager self,  MusicCue musicCue,  float delayTime,  float transitionTime,  bool applySnapshot);
...
public delegate System.Collections.IEnumerator BeginApplyMusicCue_AfterArgs(Params_BeginApplyMusicCue args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator BeginApplyMusicCue_WithArgs (Func<AudioManager,  MusicCue,  float,  float,  bool, System.Collections.IEnumerator> orig, AudioManager self,  MusicCue musicCue,  float delayTime,  float transitionTime,  bool applySnapshot);
...
public delegate void UpdateMusicSync_WithArgs (Action<AudioManager,  MusicChannels,  bool> orig, AudioManager self,  MusicChannels musicChannel,  bool isSyncRequired);
...
public delegate void ApplyMusicSnapshot_WithArgs (Action<AudioManager,  UnityEngine.Audio.AudioMixerSnapshot,  float,  float> orig, AudioManager self,  UnityEngine.Audio.AudioMixerSnapshot snapshot,  float delayTime,  float transitionTime);
...
public delegate System.Collections.IEnumerator BeginApplyMusicSnapshot_AfterArgs(Params_BeginApplyMusicSnapshot args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator BeginApplyMusicSnapshot_WithArgs (Func<AudioManager,  UnityEngine.Audio.AudioMixerSnapshot,  float,  float, System.Collections.IEnumerator> orig, AudioManager self,  UnityEngine.Audio.AudioMixerSnapshot snapshot,  float delayTime,  float transitionTime);
}
...
{
add => HookEndpointManager.Add<Delegates.get_CurrentMusicCue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AudioManager), "get_CurrentMusicCue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_CurrentMusicCue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AudioManager), "get_CurrentMusicCue", true), value);
}
