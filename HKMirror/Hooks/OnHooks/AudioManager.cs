...
public static class OnAudioManager
{
    ...
    public static class Delegates
    {
        ...
        public delegate void ApplyMusicSnapshot_WithArgs(Action<AudioManager, AudioMixerSnapshot, float, float> orig,
            AudioManager self, AudioMixerSnapshot snapshot, float delayTime, float transitionTime);

        public delegate IEnumerator BeginApplyAtmosCue_AfterArgs(Params_BeginApplyAtmosCue args, IEnumerator ret);

        public delegate void BeginApplyAtmosCue_BeforeArgs(Params_BeginApplyAtmosCue args);

        public delegate IEnumerator BeginApplyAtmosCue_WithArgs(Func<AudioManager, AtmosCue, float, IEnumerator> orig,
            AudioManager self, AtmosCue atmosCue, float transitionTime);

        public delegate IEnumerator BeginApplyMusicCue_AfterArgs(Params_BeginApplyMusicCue args, IEnumerator ret);

        public delegate void BeginApplyMusicCue_BeforeArgs(Params_BeginApplyMusicCue args);

        public delegate IEnumerator BeginApplyMusicCue_WithArgs(
            Func<AudioManager, MusicCue, float, float, bool, IEnumerator> orig, AudioManager self, MusicCue musicCue,
            float delayTime, float transitionTime, bool applySnapshot);

        public delegate IEnumerator BeginApplyMusicSnapshot_AfterArgs(Params_BeginApplyMusicSnapshot args,
            IEnumerator ret);

        public delegate void BeginApplyMusicSnapshot_BeforeArgs(Params_BeginApplyMusicSnapshot args);

        public delegate IEnumerator BeginApplyMusicSnapshot_WithArgs(
            Func<AudioManager, AudioMixerSnapshot, float, float, IEnumerator> orig, AudioManager self,
            AudioMixerSnapshot snapshot, float delayTime, float transitionTime);
