...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile> orig, InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile> orig, InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.IpegaPG9068AndroidUnityProfile), "Define", true), value);
}
}
