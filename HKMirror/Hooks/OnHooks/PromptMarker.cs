...
public static class OnPromptMarker
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator RecycleDelayed_AfterArgs(Params_RecycleDelayed args, IEnumerator ret);

        public delegate void RecycleDelayed_BeforeArgs(Params_RecycleDelayed args);

        public delegate IEnumerator RecycleDelayed_WithArgs(Func<PromptMarker, float, IEnumerator> orig,
        ...
        public delegate void SetOwner_WithArgs(Action<PromptMarker, GameObject> orig, PromptMarker self,
            GameObject obj);
