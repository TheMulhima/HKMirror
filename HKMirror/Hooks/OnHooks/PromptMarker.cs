...
{
foreach (Delegates.RecycleOnLevelLoad_BeforeArgs toInvoke in _beforeRecycleOnLevelLoad.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RecycleOnLevelLoad_AfterArgs toInvoke in _afterRecycleOnLevelLoad.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator RecycleDelayed(On.PromptMarker.orig_RecycleDelayed orig,PromptMarker self,  float delay)
{
...
public delegate System.Collections.IEnumerator RecycleDelayed_AfterArgs(Params_RecycleDelayed args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator RecycleDelayed_WithArgs (Func<PromptMarker,  float, System.Collections.IEnumerator> orig, PromptMarker self,  float delay);
...
public delegate void SetOwner_WithArgs (Action<PromptMarker,  UnityEngine.GameObject> orig, PromptMarker self,  UnityEngine.GameObject obj);
}
