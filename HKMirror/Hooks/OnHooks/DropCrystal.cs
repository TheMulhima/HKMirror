...
private static void OnCollisionEnter2D(On.DropCrystal.orig_OnCollisionEnter2D orig,DropCrystal self,  UnityEngine.Collision2D col)
{
...
private static void StartConveyorMove(On.DropCrystal.orig_StartConveyorMove orig,DropCrystal self,  float c_xSpeed,  float c_ySpeed)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<DropCrystal,  UnityEngine.Collision2D> orig, DropCrystal self,  UnityEngine.Collision2D col);
...
public delegate void StartConveyorMove_WithArgs (Action<DropCrystal,  float,  float> orig, DropCrystal self,  float c_xSpeed,  float c_ySpeed);
