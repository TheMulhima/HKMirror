...
public static class OnIdleBuzzing
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.Buzz_NormalArgs _afterBuzz;
        ...
        private static void Buzz(On.IdleBuzzing.orig_Buzz orig, IdleBuzzing self, float deltaTime)
        {
            ...
            orig(self, deltaTime);
            if (_afterBuzz != null) _afterBuzz.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void Buzz_NormalArgs(Params_Buzz args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.Buzz_NormalArgs Buzz
        {
            add
            {
