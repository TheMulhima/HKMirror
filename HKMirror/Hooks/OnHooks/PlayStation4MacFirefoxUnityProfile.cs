...
public static class OnPlayStation4MacFirefoxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4MacFirefoxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4MacFirefoxUnityProfile> orig,
            PlayStation4MacFirefoxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4MacFirefoxUnityProfile> orig,
            PlayStation4MacFirefoxUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4MacFirefoxUnityProfile self;
        }
    }
