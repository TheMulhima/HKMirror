...
public static class OnuGuiGetColorBlock
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiGetColorBlock), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiGetColorBlock), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiGetColorBlock), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiGetColorBlock),
        ...
        private static void DoGetValue(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self);
        ...
        public delegate void DoGetValue_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiGetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiGetColorBlock self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiGetColorBlock), "Reset", true),
                value);
        ...
        public static event Delegates.DoGetValue_WithArgs DoGetValue
        {
            add => HookEndpointManager.Add<Delegates.DoGetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiGetColorBlock), "DoGetValue",
                    true), value);
