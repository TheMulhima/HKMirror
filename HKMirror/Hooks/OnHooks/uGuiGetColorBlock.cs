...
public static class OnuGuiGetColorBlock
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "DoGetValue"), DoGetValue);
            }
        }
        ...
        private static void DoGetValue(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetValue_WithArgs(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiGetColorBlock> orig, uGuiGetColorBlock self);

        public sealed class Params_Reset
        {
            public uGuiGetColorBlock self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "OnUpdate"), value);
        ...
        public static event Delegates.DoGetValue_WithArgs DoGetValue
        {
            add => HookEndpointManager.Add<Delegates.DoGetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiGetColorBlock), "DoGetValue"), value);
