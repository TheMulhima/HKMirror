...
public static class OnGameSirG3wAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameSirG3wAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameSirG3wAndroidUnityProfile> orig, GameSirG3wAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameSirG3wAndroidUnityProfile> orig,
            GameSirG3wAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public GameSirG3wAndroidUnityProfile self;
        }
    }
