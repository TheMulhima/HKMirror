...
public static class OnGameSirG3wAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.GameSirG3wAndroidUnityProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.GameSirG3wAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.GameSirG3wAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<InControl.UnityDeviceProfiles.GameSirG3wAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.GameSirG3wAndroidUnityProfile self);
    }
