...
public static class OnGUILayoutHorizontalSlider
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutHorizontalSlider), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GUILayoutHorizontalSlider> orig, GUILayoutHorizontalSlider self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutHorizontalSlider), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUILayoutHorizontalSlider> orig, GUILayoutHorizontalSlider self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUILayoutHorizontalSlider> orig, GUILayoutHorizontalSlider self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GUILayoutHorizontalSlider> orig, GUILayoutHorizontalSlider self);

        public sealed class Params_Reset
        {
            public GUILayoutHorizontalSlider self;
        }
