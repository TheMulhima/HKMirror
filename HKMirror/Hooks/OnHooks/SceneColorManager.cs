...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_markerActive", true), get_markerActive);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_markerActive", true), set_markerActive);
...
private static void SetSaturationA(On.SceneColorManager.orig_SetSaturationA orig,SceneColorManager self,  float saturationA)
{
...
private static void SetSaturationB(On.SceneColorManager.orig_SetSaturationB orig,SceneColorManager self,  float saturationB)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_startBufferActive", true), get_startBufferActive);
...
{
foreach (Delegates.get_startBufferActive_BeforeArgs toInvoke in _beforeget_startBufferActive.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_startBufferActive_AfterArgs toInvoke in _afterget_startBufferActive.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_startBufferActive", true), set_startBufferActive);
...
private static void set_startBufferActive(Action<SceneColorManager,  bool> orig, SceneColorManager self,  bool value)
{
...
{
foreach (Delegates.set_startBufferActive_BeforeArgs toInvoke in _beforeset_startBufferActive.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_startBufferActive_AfterArgs toInvoke in _afterset_startBufferActive.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator ForceRefresh(On.SceneColorManager.orig_ForceRefresh orig,SceneColorManager self)
{
...
private static void FinishBufferPeriod(On.SceneColorManager.orig_FinishBufferPeriod orig,SceneColorManager self)
{
...
{
foreach (Delegates.FinishBufferPeriod_BeforeArgs toInvoke in _beforeFinishBufferPeriod.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FinishBufferPeriod_AfterArgs toInvoke in _afterFinishBufferPeriod.GetInvocationList())
{
try
{
...
private static void MarkerActive(On.SceneColorManager.orig_MarkerActive orig,SceneColorManager self,  bool active)
{
...
private static void UpdateScript(On.SceneColorManager.orig_UpdateScript orig,SceneColorManager self,  bool forceUpdate)
{
...
private static System.Collections.Generic.List<UnityEngine.Keyframe[]> PairKeyframes(On.SceneColorManager.orig_PairKeyframes orig, UnityEngine.AnimationCurve curveA,  UnityEngine.AnimationCurve curveB)
{
...
private static System.Collections.Generic.List<UnityEngine.Keyframe[]> SimplePairKeyframes(On.SceneColorManager.orig_SimplePairKeyframes orig, UnityEngine.AnimationCurve curveA,  UnityEngine.AnimationCurve curveB)
{
...
private static UnityEngine.Keyframe CreatePair(On.SceneColorManager.orig_CreatePair orig, UnityEngine.Keyframe kf,  UnityEngine.AnimationCurve curve)
{
...
private static UnityEngine.AnimationCurve CreateCurveFromKeyframes(On.SceneColorManager.orig_CreateCurveFromKeyframes orig, System.Collections.Generic.IList<UnityEngine.Keyframe[]> keyframePairs,  float factor)
{
...
private static UnityEngine.Keyframe AverageKeyframe(On.SceneColorManager.orig_AverageKeyframe orig, UnityEngine.Keyframe a,  UnityEngine.Keyframe b,  float factor)
{
...
private static void PairCurvesKeyframes(On.SceneColorManager.orig_PairCurvesKeyframes orig,SceneColorManager self)
{
...
private static void UpdateScriptParameters(On.SceneColorManager.orig_UpdateScriptParameters orig,SceneColorManager self)
{
...
private static bool PairedListsInitiated(On.SceneColorManager.orig_PairedListsInitiated orig,SceneColorManager self)
{
...
public delegate void set_markerActive_WithArgs (Action<SceneColorManager,  bool> orig, SceneColorManager self,  bool value);
...
public delegate void SetFactor_WithArgs (Action<SceneColorManager,  float> orig, SceneColorManager self,  float factor);
...
public delegate void SetSaturationA_WithArgs (Action<SceneColorManager,  float> orig, SceneColorManager self,  float saturationA);
...
public delegate void SetSaturationB_WithArgs (Action<SceneColorManager,  float> orig, SceneColorManager self,  float saturationB);
...
public delegate void set_startBufferActive_WithArgs (Action<SceneColorManager,  bool> orig, SceneColorManager self,  bool value);
...
public delegate System.Collections.IEnumerator ForceRefresh_AfterArgs(Params_ForceRefresh args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ForceRefresh_WithArgs (Func<SceneColorManager, System.Collections.IEnumerator> orig, SceneColorManager self);
...
public delegate void MarkerActive_WithArgs (Action<SceneColorManager,  bool> orig, SceneColorManager self,  bool active);
...
public delegate void UpdateScript_WithArgs (Action<SceneColorManager,  bool> orig, SceneColorManager self,  bool forceUpdate);
...
{
add => HookEndpointManager.Add<Delegates.get_markerActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_markerActive", true), value);
remove => HookEndpointManager.Remove<Delegates.get_markerActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_markerActive", true), value);
}
public static event Delegates.set_markerActive_WithArgs set_markerActive
{
add => HookEndpointManager.Add<Delegates.set_markerActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_markerActive", true), value);
remove => HookEndpointManager.Remove<Delegates.set_markerActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_markerActive", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_startBufferActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_startBufferActive", true), value);
remove => HookEndpointManager.Remove<Delegates.get_startBufferActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_startBufferActive", true), value);
}
public static event Delegates.set_startBufferActive_WithArgs set_startBufferActive
{
add => HookEndpointManager.Add<Delegates.set_startBufferActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_startBufferActive", true), value);
remove => HookEndpointManager.Remove<Delegates.set_startBufferActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_startBufferActive", true), value);
}
