...
public static class OnSceneColorManager
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.get_markerActive_NormalArgs _afterget_markerActive;
        ...
        private static bool get_markerActive(Func<SceneColorManager, bool> orig, SceneColorManager self)
        {
            ...
            if (_afterget_markerActive != null) retVal = _afterget_markerActive.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.set_markerActive_NormalArgs _afterset_markerActive;
        ...
        private static void set_markerActive(Action<SceneColorManager, bool> orig, SceneColorManager self, bool value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_markerActive != null) _afterset_markerActive.Invoke(@params);
        }
        ...
        internal static event Delegates.get_startBufferActive_NormalArgs _afterget_startBufferActive;
        ...
        private static bool get_startBufferActive(Func<SceneColorManager, bool> orig, SceneColorManager self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_startBufferActive != null) retVal = _afterget_startBufferActive.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.set_startBufferActive_NormalArgs _afterset_startBufferActive;
            ...
            bool value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_startBufferActive != null) _afterset_startBufferActive.Invoke(@params);
        }
        ...
        internal static event Delegates.FinishBufferPeriod_NormalArgs _afterFinishBufferPeriod;
            ...
            SceneColorManager self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterFinishBufferPeriod != null) _afterFinishBufferPeriod.Invoke(@params);
        }
        ...
        internal static event Delegates.MarkerActive_NormalArgs _afterMarkerActive;
            ...
            bool active)
        {
            ...
            orig(self, active);
            if (_afterMarkerActive != null) _afterMarkerActive.Invoke(@params);
        }
        ...
        internal static event Delegates.UpdateSceneType_NormalArgs _afterUpdateSceneType;
        ...
        private static void UpdateSceneType(On.SceneColorManager.orig_UpdateSceneType orig, SceneColorManager self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterUpdateSceneType != null) _afterUpdateSceneType.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void FinishBufferPeriod_NormalArgs(Params_FinishBufferPeriod args);

        public delegate void ForceRefresh_BeforeArgs(Params_ForceRefresh args);

        public delegate IEnumerator ForceRefresh_NormalArgs(Params_ForceRefresh args);
        ...
        public delegate bool get_markerActive_NormalArgs(Params_get_markerActive args);

        public delegate void get_startBufferActive_BeforeArgs(Params_get_startBufferActive args);

        public delegate bool get_startBufferActive_NormalArgs(Params_get_startBufferActive args);

        public delegate void MarkerActive_BeforeArgs(Params_MarkerActive args);

        public delegate void MarkerActive_NormalArgs(Params_MarkerActive args);
        ...
        public delegate void set_markerActive_NormalArgs(Params_set_markerActive args);

        public delegate void set_startBufferActive_BeforeArgs(Params_set_startBufferActive args);

        public delegate void set_startBufferActive_NormalArgs(Params_set_startBufferActive args);
        ...
        public delegate void UpdateSceneType_NormalArgs(Params_UpdateSceneType args);
    ...
    {
        public static event Delegates.get_markerActive_NormalArgs get_markerActive
        {
            add
            {
        ...
        public static event Delegates.set_markerActive_NormalArgs set_markerActive
        {
            add
            {
        ...
        public static event Delegates.get_startBufferActive_NormalArgs get_startBufferActive
        {
            add
            {
        ...
        public static event Delegates.set_startBufferActive_NormalArgs set_startBufferActive
        {
            add
            {
        ...
        public static event Delegates.FinishBufferPeriod_NormalArgs FinishBufferPeriod
        {
            add
            {
        ...
        public static event Delegates.MarkerActive_NormalArgs MarkerActive
        {
            add
            {
        ...
        public static event Delegates.UpdateSceneType_NormalArgs UpdateSceneType
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_markerActive_NormalArgs get_markerActive
        {
            add => HookEndpointManager.Add<Delegates.get_markerActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_markerActive"), value);
            remove => HookEndpointManager.Remove<Delegates.get_markerActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_markerActive"), value);
        }

        public static event Delegates.set_markerActive_NormalArgs set_markerActive
        {
            add => HookEndpointManager.Add<Delegates.set_markerActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_markerActive"), value);
            remove => HookEndpointManager.Remove<Delegates.set_markerActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_markerActive"), value);
        }
        ...
        public static event Delegates.get_startBufferActive_NormalArgs get_startBufferActive
        {
            add => HookEndpointManager.Add<Delegates.get_startBufferActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_startBufferActive"), value);
            remove => HookEndpointManager.Remove<Delegates.get_startBufferActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "get_startBufferActive"), value);
        }

        public static event Delegates.set_startBufferActive_NormalArgs set_startBufferActive
        {
            add => HookEndpointManager.Add<Delegates.set_startBufferActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_startBufferActive"), value);
            remove => HookEndpointManager.Remove<Delegates.set_startBufferActive_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneColorManager), "set_startBufferActive"), value);
        }
