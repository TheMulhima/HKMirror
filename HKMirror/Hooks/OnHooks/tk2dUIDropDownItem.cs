...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "get_LabelText", true), get_LabelText);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "set_LabelText", true), set_LabelText);
...
private static void set_LabelText(Action<tk2dUIDropDownItem,  string> orig, tk2dUIDropDownItem self,  string value)
{
...
public delegate void set_Index_WithArgs (Action<tk2dUIDropDownItem,  int> orig, tk2dUIDropDownItem self,  int value);
...
public delegate void set_LabelText_WithArgs (Action<tk2dUIDropDownItem,  string> orig, tk2dUIDropDownItem self,  string value);
...
{
add => HookEndpointManager.Add<Delegates.get_Index_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "get_Index", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Index_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "get_Index", true), value);
}
public static event Delegates.set_Index_WithArgs set_Index
{
add => HookEndpointManager.Add<Delegates.set_Index_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "set_Index", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Index_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "set_Index", true), value);
}
public static event Delegates.get_LabelText_WithArgs get_LabelText
{
add => HookEndpointManager.Add<Delegates.get_LabelText_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "get_LabelText", true), value);
remove => HookEndpointManager.Remove<Delegates.get_LabelText_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "get_LabelText", true), value);
}
public static event Delegates.set_LabelText_WithArgs set_LabelText
{
add => HookEndpointManager.Add<Delegates.set_LabelText_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "set_LabelText", true), value);
remove => HookEndpointManager.Remove<Delegates.set_LabelText_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIDropDownItem), "set_LabelText", true), value);
}
