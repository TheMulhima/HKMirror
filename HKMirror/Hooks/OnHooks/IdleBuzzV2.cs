...
public static class OnIdleBuzzV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self)
        {
        ...
        internal static void HookDoBuzz()
        {
            if (!HookedList.Contains("DoBuzz"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "DoBuzz", true),
                    DoBuzz);
            }
        }
        ...
        private static void DoBuzz(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self);
        ...
        public delegate void DoBuzz_WithArgs(Action<HutongGames.PlayMaker.Actions.IdleBuzzV2> orig,
            HutongGames.PlayMaker.Actions.IdleBuzzV2 self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "Reset", true), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "Awake", true), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "OnPreprocess", true),
                value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.IdleBuzzV2), "OnFixedUpdate", true),
                value);
