...
public static class OnTk2dSpriteGetColor
{
    internal static class HookHandler
    {
        ...
        internal static void Hook_getSprite()
        {
            if (!HookedList.Contains("_getSprite"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "_getSprite"), _getSprite);
            }
        }
        ...
        private static void _getSprite(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self)
        {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self)
        {
        ...
        internal static void HookDoGetSpriteColor()
        {
            if (!HookedList.Contains("DoGetSpriteColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "DoGetSpriteColor"),
                    DoGetSpriteColor);
            }
        }
        ...
        private static void DoGetSpriteColor(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void _getSprite_WithArgs(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self);
        ...
        public delegate void DoGetSpriteColor_WithArgs(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Tk2dSpriteGetColor> orig, Tk2dSpriteGetColor self);

        public sealed class Params__getSprite
        {
            public Tk2dSpriteGetColor self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates._getSprite_WithArgs _getSprite
        {
            add => HookEndpointManager.Add<Delegates._getSprite_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "_getSprite"), value);
        ...
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteGetColor), "OnUpdate"), value);
