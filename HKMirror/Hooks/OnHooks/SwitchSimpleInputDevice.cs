...
public static class OnSwitchSimpleInputDevice
{
    internal static class HookHandler
    {
        ...
        internal static void HookUpdate()
        {
            if (!HookedList.Contains("Update"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDevice), "Update", true),
                    Update);
            }
        }
        ...
        private static void Update(Action<InControl.SwitchSimpleInputDevice, ulong, float> orig,
            InControl.SwitchSimpleInputDevice self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void Hookget_IsConnected()
        {
            if (!HookedList.Contains("get_IsConnected"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDevice), "get_IsConnected", true),
                    get_IsConnected);
            }
        }
        ...
        private static bool get_IsConnected(Func<InControl.SwitchSimpleInputDevice, bool> orig,
            InControl.SwitchSimpleInputDevice self)
        {
        ...
        internal static void HookGetVibrationMixer()
        {
            if (!HookedList.Contains("GetVibrationMixer"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDevice), "GetVibrationMixer",
                        true), GetVibrationMixer);
            }
        }
        ...
        private static VibrationMixer GetVibrationMixer(Func<InControl.SwitchSimpleInputDevice, VibrationMixer> orig,
            InControl.SwitchSimpleInputDevice self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Update_WithArgs(Action<InControl.SwitchSimpleInputDevice, ulong, float> orig,
            InControl.SwitchSimpleInputDevice self, ulong updateTick, float deltaTime);
        ...
        public delegate bool get_IsConnected_WithArgs(Func<InControl.SwitchSimpleInputDevice, bool> orig,
            InControl.SwitchSimpleInputDevice self);
        ...
        public delegate VibrationMixer GetVibrationMixer_WithArgs(
            Func<InControl.SwitchSimpleInputDevice, VibrationMixer> orig, InControl.SwitchSimpleInputDevice self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDevice), "Update", true), value);
        ...
        public static event Delegates.GetVibrationMixer_WithArgs GetVibrationMixer
        {
            add => HookEndpointManager.Add<Delegates.GetVibrationMixer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.SwitchSimpleInputDevice),
