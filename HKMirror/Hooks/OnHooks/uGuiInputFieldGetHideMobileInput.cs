...
public static class OnuGuiInputFieldGetHideMobileInput
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput), "DoGetValue", true),
                    DoGetValue);
            }
        }
        ...
        private static void DoGetValue(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput self);
        ...
        public delegate void OnEnter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetHideMobileInput),
                    "Reset", true), value);
