...
public static class Ontk2dSpriteCollectionDefinition_ColliderData
{
    internal static class HookHandler
    {
        ...
        internal static void HookCopyFrom()
        {
            if (!HookedList.Contains("CopyFrom"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CopyFrom"),
                    CopyFrom);
            }
        }
        ...
        private static void CopyFrom(
            Action<tk2dSpriteCollectionDefinition.ColliderData, tk2dSpriteCollectionDefinition.ColliderData> orig,
            tk2dSpriteCollectionDefinition.ColliderData self, tk2dSpriteCollectionDefinition.ColliderData src)
        {
        ...
        internal static void HookCompareTo()
        {
            if (!HookedList.Contains("CompareTo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CompareTo"),
                    CompareTo);
            }
        }
        ...
        private static bool CompareTo(
            Func<tk2dSpriteCollectionDefinition.ColliderData, tk2dSpriteCollectionDefinition.ColliderData, bool> orig,
            tk2dSpriteCollectionDefinition.ColliderData self, tk2dSpriteCollectionDefinition.ColliderData src)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate bool CompareTo_WithArgs(
            Func<tk2dSpriteCollectionDefinition.ColliderData, tk2dSpriteCollectionDefinition.ColliderData, bool> orig,
            tk2dSpriteCollectionDefinition.ColliderData self, tk2dSpriteCollectionDefinition.ColliderData src);
        ...
        public delegate void CopyFrom_WithArgs(
            Action<tk2dSpriteCollectionDefinition.ColliderData, tk2dSpriteCollectionDefinition.ColliderData> orig,
            tk2dSpriteCollectionDefinition.ColliderData self, tk2dSpriteCollectionDefinition.ColliderData src);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.CopyFrom_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CopyFrom"), value);
            remove => HookEndpointManager.Remove<Delegates.CopyFrom_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CopyFrom"), value);
        }

        public static event Delegates.CompareTo_WithArgs CompareTo
        {
            add => HookEndpointManager.Add<Delegates.CompareTo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CompareTo"),
                value);
            remove => HookEndpointManager.Remove<Delegates.CompareTo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CompareTo"),
                value);
        }
    }
