...
public static class OnAmazonFireTVUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AmazonFireTVUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AmazonFireTVUnityProfile> orig, AmazonFireTVUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AmazonFireTVUnityProfile> orig, AmazonFireTVUnityProfile self);

        public sealed class Params_Define
        {
            public AmazonFireTVUnityProfile self;
        }
    }
