...
public static class OnBetopBTP2175sWindowsUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.BetopBTP2175sWindowsUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.BetopBTP2175sWindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.BetopBTP2175sWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.BetopBTP2175sWindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.BetopBTP2175sWindowsUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.BetopBTP2175sWindowsUnityProfile),
                    "Define", true), value);
