...
public static class OnBetopBTP2175sWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BetopBTP2175sWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BetopBTP2175sWindowsUnityProfile> orig, BetopBTP2175sWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BetopBTP2175sWindowsUnityProfile> orig,
            BetopBTP2175sWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public BetopBTP2175sWindowsUnityProfile self;
        }
    }
