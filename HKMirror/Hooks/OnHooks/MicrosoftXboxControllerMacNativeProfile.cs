...
public static class OnMicrosoftXboxControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MicrosoftXboxControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MicrosoftXboxControllerMacNativeProfile> orig,
            MicrosoftXboxControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MicrosoftXboxControllerMacNativeProfile> orig,
            MicrosoftXboxControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MicrosoftXboxControllerMacNativeProfile self;
        }
    }
