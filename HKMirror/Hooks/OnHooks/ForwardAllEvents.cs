...
public static class OnForwardAllEvents
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ForwardAllEvents), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ForwardAllEvents> orig,
            HutongGames.PlayMaker.Actions.ForwardAllEvents self)
        {
        ...
        internal static void HookEvent()
        {
            if (!HookedList.Contains("Event"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ForwardAllEvents), "Event",
                        true), Event);
            }
        }
        ...
        private static bool Event(
            Func<HutongGames.PlayMaker.Actions.ForwardAllEvents, HutongGames.PlayMaker.FsmEvent, bool> orig,
            HutongGames.PlayMaker.Actions.ForwardAllEvents self, HutongGames.PlayMaker.FsmEvent fsmEvent)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ForwardAllEvents> orig,
            HutongGames.PlayMaker.Actions.ForwardAllEvents self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ForwardAllEvents), "Reset", true),
                value);
        ...
        public static event Delegates.Event_WithArgs Event
        {
            add => HookEndpointManager.Add<Delegates.Event_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ForwardAllEvents), "Event", true),
                value);
