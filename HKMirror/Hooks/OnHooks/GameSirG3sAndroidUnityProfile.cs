...
public static class OnGameSirG3sAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameSirG3sAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameSirG3sAndroidUnityProfile> orig, GameSirG3sAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameSirG3sAndroidUnityProfile> orig,
            GameSirG3sAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public GameSirG3sAndroidUnityProfile self;
        }
    }
