...
public static class OnHoriRAPNFightingStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriRAPNFightingStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriRAPNFightingStickMacNativeProfile> orig,
            HoriRAPNFightingStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriRAPNFightingStickMacNativeProfile> orig,
            HoriRAPNFightingStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriRAPNFightingStickMacNativeProfile self;
        }
    }
