...
public static class OnGetAnimatorLayerCount
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerCount), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerCount> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerCount self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerCount),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerCount> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerCount self)
        {
        ...
        internal static void HookDoGetLayerCount()
        {
            if (!HookedList.Contains("DoGetLayerCount"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerCount),
                        "DoGetLayerCount", true), DoGetLayerCount);
            }
        }
        ...
        private static void DoGetLayerCount(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerCount> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerCount self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerCount> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerCount self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerCount> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerCount self);
        ...
        public delegate void DoGetLayerCount_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerCount> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerCount self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerCount), "OnEnter",
                    true), value);
