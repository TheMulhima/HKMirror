...
public static class OnLogitechF310ModeDMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310ModeDMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310ModeDMacUnityProfile> orig, LogitechF310ModeDMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310ModeDMacUnityProfile> orig,
            LogitechF310ModeDMacUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF310ModeDMacUnityProfile self;
        }
    }
