...
private static void StartConveyorMove(On.ConveyorMovement.orig_StartConveyorMove orig,ConveyorMovement self,  float c_xSpeed,  float c_ySpeed)
{
...
public delegate void StartConveyorMove_WithArgs (Action<ConveyorMovement,  float,  float> orig, ConveyorMovement self,  float c_xSpeed,  float c_ySpeed);
