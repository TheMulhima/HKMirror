...
private static void LocalizeTextMesh(On.LocalizedTextMesh.orig_LocalizeTextMesh orig,LocalizedTextMesh self,  string keyValue)
{
...
public delegate void LocalizeTextMesh_WithArgs (Action<LocalizedTextMesh,  string> orig, LocalizedTextMesh self,  string keyValue);
}
