...
public static class OnAppleMFiUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AppleMFiUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AppleMFiUnityProfile> orig, AppleMFiUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AppleMFiUnityProfile> orig, AppleMFiUnityProfile self);

        public sealed class Params_Define
        {
            public AppleMFiUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AppleMFiUnityProfile), "Define"), value);
