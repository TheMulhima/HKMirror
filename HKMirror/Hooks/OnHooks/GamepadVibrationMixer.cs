...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "get_IsPaused", true), get_IsPaused);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "set_IsPaused", true), set_IsPaused);
...
private static void set_IsPaused(Action<GamepadVibrationMixer,  bool> orig, GamepadVibrationMixer self,  bool value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "get_PlayingEmissionCount", true), get_PlayingEmissionCount);
...
{
foreach (Delegates.get_PlayingEmissionCount_BeforeArgs toInvoke in _beforeget_PlayingEmissionCount.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_PlayingEmissionCount_AfterArgs toInvoke in _afterget_PlayingEmissionCount.GetInvocationList())
{
try
{
...
private static VibrationEmission GetPlayingEmission(On.GamepadVibrationMixer.orig_GetPlayingEmission orig,GamepadVibrationMixer self,  int playingEmissionIndex)
{
Delegates.Params_GetPlayingEmission @params = new() 
{
self = self
, playingEmissionIndex = playingEmissionIndex
};
if (_beforeGetPlayingEmission != null)
{
foreach (Delegates.GetPlayingEmission_BeforeArgs toInvoke in _beforeGetPlayingEmission.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetPlayingEmission_AfterArgs toInvoke in _afterGetPlayingEmission.GetInvocationList())
{
try
{
...
private static VibrationEmission PlayEmission(On.GamepadVibrationMixer.orig_PlayEmission orig,GamepadVibrationMixer self,  VibrationData vibrationData,  VibrationTarget vibrationTarget,  bool isLooping,  string tag)
{
...
private static void StopAllEmissions(On.GamepadVibrationMixer.orig_StopAllEmissions orig,GamepadVibrationMixer self)
{
...
private static void StopAllEmissionsWithTag(On.GamepadVibrationMixer.orig_StopAllEmissionsWithTag orig,GamepadVibrationMixer self,  string tag)
{
...
{
foreach (Delegates.StopAllEmissionsWithTag_BeforeArgs toInvoke in _beforeStopAllEmissionsWithTag.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StopAllEmissionsWithTag_AfterArgs toInvoke in _afterStopAllEmissionsWithTag.GetInvocationList())
{
try
{
...
private static void Update(On.GamepadVibrationMixer.orig_Update orig,GamepadVibrationMixer self,  float deltaTime)
{
...
private static float AdjustForPlatform(On.GamepadVibrationMixer.orig_AdjustForPlatform orig,GamepadVibrationMixer self,  float val)
{
...
{
foreach (Delegates.AdjustForPlatform_BeforeArgs toInvoke in _beforeAdjustForPlatform.GetInvocationList())
{
try
{
...
public delegate void set_IsPaused_WithArgs (Action<GamepadVibrationMixer,  bool> orig, GamepadVibrationMixer self,  bool value);
...
public delegate int get_PlayingEmissionCount_WithArgs (Func<GamepadVibrationMixer, int> orig, GamepadVibrationMixer self);
...
public delegate VibrationEmission GetPlayingEmission_AfterArgs(Params_GetPlayingEmission args, VibrationEmission ret);
public delegate VibrationEmission GetPlayingEmission_WithArgs (Func<GamepadVibrationMixer,  int, VibrationEmission> orig, GamepadVibrationMixer self,  int playingEmissionIndex);
...
public delegate VibrationEmission PlayEmission_WithArgs (Func<GamepadVibrationMixer,  VibrationData,  VibrationTarget,  bool,  string, VibrationEmission> orig, GamepadVibrationMixer self,  VibrationData vibrationData,  VibrationTarget vibrationTarget,  bool isLooping,  string tag);
...
public delegate void StopAllEmissionsWithTag_WithArgs (Action<GamepadVibrationMixer,  string> orig, GamepadVibrationMixer self,  string tag);
...
public delegate void Update_WithArgs (Action<GamepadVibrationMixer,  float> orig, GamepadVibrationMixer self,  float deltaTime);
...
public delegate float AdjustForPlatform_WithArgs (Func<GamepadVibrationMixer,  float, float> orig, GamepadVibrationMixer self,  float val);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsPaused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "get_IsPaused", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsPaused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "get_IsPaused", true), value);
}
public static event Delegates.set_IsPaused_WithArgs set_IsPaused
{
add => HookEndpointManager.Add<Delegates.set_IsPaused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "set_IsPaused", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsPaused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "set_IsPaused", true), value);
}
public static event Delegates.get_PlayingEmissionCount_WithArgs get_PlayingEmissionCount
{
add => HookEndpointManager.Add<Delegates.get_PlayingEmissionCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "get_PlayingEmissionCount", true), value);
remove => HookEndpointManager.Remove<Delegates.get_PlayingEmissionCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibrationMixer), "get_PlayingEmissionCount", true), value);
}
