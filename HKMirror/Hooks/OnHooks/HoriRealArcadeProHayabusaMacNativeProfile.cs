...
public static class OnHoriRealArcadeProHayabusaMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriRealArcadeProHayabusaMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriRealArcadeProHayabusaMacNativeProfile> orig,
            HoriRealArcadeProHayabusaMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriRealArcadeProHayabusaMacNativeProfile> orig,
            HoriRealArcadeProHayabusaMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriRealArcadeProHayabusaMacNativeProfile self;
        }
    }
