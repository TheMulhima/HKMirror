...
public static class OnArrayListSort
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSort), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayListSort> orig,
            HutongGames.PlayMaker.Actions.ArrayListSort self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSort), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayListSort> orig,
            HutongGames.PlayMaker.Actions.ArrayListSort self)
        {
        ...
        internal static void HookDoArrayListSort()
        {
            if (!HookedList.Contains("DoArrayListSort"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSort),
                        "DoArrayListSort", true), DoArrayListSort);
            }
        }
        ...
        private static void DoArrayListSort(Action<HutongGames.PlayMaker.Actions.ArrayListSort> orig,
            HutongGames.PlayMaker.Actions.ArrayListSort self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListSort> orig,
            HutongGames.PlayMaker.Actions.ArrayListSort self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListSort> orig,
            HutongGames.PlayMaker.Actions.ArrayListSort self);
        ...
        public delegate void DoArrayListSort_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListSort> orig,
            HutongGames.PlayMaker.Actions.ArrayListSort self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSort), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoArrayListSort_WithArgs DoArrayListSort
        {
            add => HookEndpointManager.Add<Delegates.DoArrayListSort_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSort), "DoArrayListSort",
                    true), value);
