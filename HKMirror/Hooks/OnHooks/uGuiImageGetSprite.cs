...
public static class OnuGuiImageGetSprite
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageGetSprite), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiImageGetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageGetSprite self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageGetSprite), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiImageGetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageGetSprite self)
        {
        ...
        internal static void HookDoSetImageSourceValue()
        {
            if (!HookedList.Contains("DoSetImageSourceValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageGetSprite),
        ...
        private static void DoSetImageSourceValue(Action<HutongGames.PlayMaker.Actions.uGuiImageGetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageGetSprite self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiImageGetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageGetSprite self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiImageGetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageGetSprite self);
        ...
        public delegate void DoSetImageSourceValue_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiImageGetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageGetSprite self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageGetSprite), "Reset", true),
                value);
