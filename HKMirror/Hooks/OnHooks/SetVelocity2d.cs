...
public static class OnSetVelocity2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<SetVelocity2d> orig, SetVelocity2d self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<SetVelocity2d> orig, SetVelocity2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<SetVelocity2d> orig, SetVelocity2d self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<SetVelocity2d> orig, SetVelocity2d self)
        {
        ...
        internal static void HookDoSetVelocity()
        {
            if (!HookedList.Contains("DoSetVelocity"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "DoSetVelocity"), DoSetVelocity);
            }
        }
        ...
        private static void DoSetVelocity(Action<SetVelocity2d> orig, SetVelocity2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<SetVelocity2d> orig, SetVelocity2d self);
        ...
        public delegate void DoSetVelocity_WithArgs(Action<SetVelocity2d> orig, SetVelocity2d self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<SetVelocity2d> orig, SetVelocity2d self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<SetVelocity2d> orig, SetVelocity2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<SetVelocity2d> orig, SetVelocity2d self);

        public sealed class Params_Reset
        {
            public SetVelocity2d self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "Awake"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoSetVelocity_WithArgs DoSetVelocity
        {
            add => HookEndpointManager.Add<Delegates.DoSetVelocity_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetVelocity2d), "DoSetVelocity"), value);
