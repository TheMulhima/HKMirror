...
public static class OnSetVelocity2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity2d), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity2d), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity2d), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity2d), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self)
        {
        ...
        internal static void HookDoSetVelocity()
        {
            if (!HookedList.Contains("DoSetVelocity"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity2d), "DoSetVelocity",
                        true), DoSetVelocity);
            }
        }
        ...
        private static void DoSetVelocity(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self);
        ...
        public delegate void DoSetVelocity_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity2d> orig,
            HutongGames.PlayMaker.Actions.SetVelocity2d self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity2d), "OnEnter", true),
                value);
