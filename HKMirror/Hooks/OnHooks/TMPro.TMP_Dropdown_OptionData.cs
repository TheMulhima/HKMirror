...
public static class OnTMPro_TMP_Dropdown_OptionData
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_text()
        {
            if (!HookedList.Contains("get_text"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "get_text"), get_text);
            }
        }
        ...
        private static string get_text(Func<TMP_Dropdown.OptionData, string> orig, TMP_Dropdown.OptionData self)
        {
        ...
        internal static void Hookset_text()
        {
            if (!HookedList.Contains("set_text"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "set_text"), set_text);
            }
        }
        ...
        private static void set_text(Action<TMP_Dropdown.OptionData, string> orig, TMP_Dropdown.OptionData self,
            string value)
        {
        ...
        internal static void Hookget_image()
        {
            if (!HookedList.Contains("get_image"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "get_image"), get_image);
            }
        }
        ...
        private static Sprite get_image(Func<TMP_Dropdown.OptionData, Sprite> orig, TMP_Dropdown.OptionData self)
        {
        ...
        internal static void Hookset_image()
        {
            if (!HookedList.Contains("set_image"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "set_image"), set_image);
            }
        }
        ...
        private static void set_image(Action<TMP_Dropdown.OptionData, Sprite> orig, TMP_Dropdown.OptionData self,
            Sprite value)
        {
    ...
    {
        public delegate Sprite get_image_AfterArgs(Params_get_image args, Sprite ret);

        public delegate void get_image_BeforeArgs(Params_get_image args);

        public delegate Sprite get_image_WithArgs(Func<TMP_Dropdown.OptionData, Sprite> orig,
            TMP_Dropdown.OptionData self);
        ...
        public delegate string get_text_WithArgs(Func<TMP_Dropdown.OptionData, string> orig,
            TMP_Dropdown.OptionData self);
        ...
        public delegate void set_image_WithArgs(Action<TMP_Dropdown.OptionData, Sprite> orig,
            TMP_Dropdown.OptionData self, Sprite value);
        ...
        public delegate void set_text_WithArgs(Action<TMP_Dropdown.OptionData, string> orig,
            TMP_Dropdown.OptionData self, string value);

        public sealed class Params_get_text
        {
            public TMP_Dropdown.OptionData self;
        }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_image_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "get_image"), value);
            remove => HookEndpointManager.Remove<Delegates.get_image_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "get_image"), value);
        }

        public static event Delegates.set_image_WithArgs set_image
        {
            add => HookEndpointManager.Add<Delegates.set_image_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "set_image"), value);
            remove => HookEndpointManager.Remove<Delegates.set_image_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionData), "set_image"), value);
        }
    }
}