...
public static class OnMogaProMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MogaProMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MogaProMacUnityProfile> orig, MogaProMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MogaProMacUnityProfile> orig, MogaProMacUnityProfile self);

        public sealed class Params_Define
        {
            public MogaProMacUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MogaProMacUnityProfile), "Define"), value);
