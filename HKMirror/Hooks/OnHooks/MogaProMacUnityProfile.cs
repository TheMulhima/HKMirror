...
/// <summary>
/// Contains different types of On Hooks for MogaProMacUnityProfile class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnMogaProMacUnityProfile
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.MogaProMacUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.MogaProMacUnityProfile> orig, InControl.UnityDeviceProfiles.MogaProMacUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.MogaProMacUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.MogaProMacUnityProfile> orig, InControl.UnityDeviceProfiles.MogaProMacUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.MogaProMacUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.MogaProMacUnityProfile), "Define", true), value);
}
}
