...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_Dirty", true), get_Dirty);
...
private static bool get_Dirty(Func<tk2dRuntime.TileMap.SpriteChunk, bool> orig, tk2dRuntime.TileMap.SpriteChunk self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "set_Dirty", true), set_Dirty);
...
private static void set_Dirty(Action<tk2dRuntime.TileMap.SpriteChunk,  bool> orig, tk2dRuntime.TileMap.SpriteChunk self,  bool value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_IsEmpty", true), get_IsEmpty);
...
private static bool get_IsEmpty(Func<tk2dRuntime.TileMap.SpriteChunk, bool> orig, tk2dRuntime.TileMap.SpriteChunk self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_HasGameData", true), get_HasGameData);
...
private static bool get_HasGameData(Func<tk2dRuntime.TileMap.SpriteChunk, bool> orig, tk2dRuntime.TileMap.SpriteChunk self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "DestroyGameData", true), DestroyGameData);
...
private static void DestroyGameData(Action<tk2dRuntime.TileMap.SpriteChunk,  tk2dTileMap> orig, tk2dRuntime.TileMap.SpriteChunk self,  tk2dTileMap tileMap)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "DestroyColliderData", true), DestroyColliderData);
...
private static void DestroyColliderData(Action<tk2dRuntime.TileMap.SpriteChunk,  tk2dTileMap> orig, tk2dRuntime.TileMap.SpriteChunk self,  tk2dTileMap tileMap)
{
...
{
foreach (Delegates.DestroyColliderData_BeforeArgs toInvoke in _beforeDestroyColliderData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DestroyColliderData_AfterArgs toInvoke in _afterDestroyColliderData.GetInvocationList())
{
try
{
...
{
public tk2dRuntime.TileMap.SpriteChunk self;
}
...
public delegate bool get_Dirty_WithArgs (Func<tk2dRuntime.TileMap.SpriteChunk, bool> orig, tk2dRuntime.TileMap.SpriteChunk self);
...
public delegate void set_Dirty_WithArgs (Action<tk2dRuntime.TileMap.SpriteChunk,  bool> orig, tk2dRuntime.TileMap.SpriteChunk self,  bool value);
...
public delegate bool get_IsEmpty_WithArgs (Func<tk2dRuntime.TileMap.SpriteChunk, bool> orig, tk2dRuntime.TileMap.SpriteChunk self);
...
public delegate bool get_HasGameData_WithArgs (Func<tk2dRuntime.TileMap.SpriteChunk, bool> orig, tk2dRuntime.TileMap.SpriteChunk self);
...
public delegate void DestroyGameData_WithArgs (Action<tk2dRuntime.TileMap.SpriteChunk,  tk2dTileMap> orig, tk2dRuntime.TileMap.SpriteChunk self,  tk2dTileMap tileMap);
...
public delegate void DestroyColliderData_WithArgs (Action<tk2dRuntime.TileMap.SpriteChunk,  tk2dTileMap> orig, tk2dRuntime.TileMap.SpriteChunk self,  tk2dTileMap tileMap);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Dirty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_Dirty", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Dirty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_Dirty", true), value);
}
public static event Delegates.set_Dirty_WithArgs set_Dirty
{
add => HookEndpointManager.Add<Delegates.set_Dirty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "set_Dirty", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Dirty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "set_Dirty", true), value);
}
public static event Delegates.get_IsEmpty_WithArgs get_IsEmpty
{
add => HookEndpointManager.Add<Delegates.get_IsEmpty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_IsEmpty", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsEmpty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_IsEmpty", true), value);
}
public static event Delegates.get_HasGameData_WithArgs get_HasGameData
{
add => HookEndpointManager.Add<Delegates.get_HasGameData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_HasGameData", true), value);
remove => HookEndpointManager.Remove<Delegates.get_HasGameData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "get_HasGameData", true), value);
}
public static event Delegates.DestroyGameData_WithArgs DestroyGameData
{
add => HookEndpointManager.Add<Delegates.DestroyGameData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "DestroyGameData", true), value);
remove => HookEndpointManager.Remove<Delegates.DestroyGameData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "DestroyGameData", true), value);
}
public static event Delegates.DestroyColliderData_WithArgs DestroyColliderData
{
add => HookEndpointManager.Add<Delegates.DestroyColliderData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "DestroyColliderData", true), value);
remove => HookEndpointManager.Remove<Delegates.DestroyColliderData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.SpriteChunk), "DestroyColliderData", true), value);
}
}
