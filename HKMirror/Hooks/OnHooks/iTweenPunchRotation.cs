...
public static class OniTweenPunchRotation
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenPunchRotation), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenPunchRotation), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenPunchRotation), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenPunchRotation),
        ...
        private static void DoiTween(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self);
        ...
        public delegate void DoiTween_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenPunchRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenPunchRotation self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenPunchRotation), "DoiTween",
                    true), value);
