...
public static class OnGrimmChildFly
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GrimmChildFly> orig, GrimmChildFly self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<GrimmChildFly> orig, GrimmChildFly self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<GrimmChildFly> orig, GrimmChildFly self)
        {
        ...
        internal static void HookDoFace()
        {
            if (!HookedList.Contains("DoFace"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "DoFace"), DoFace);
            }
        }
        ...
        private static void DoFace(Action<GrimmChildFly> orig, GrimmChildFly self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoFace_WithArgs(Action<GrimmChildFly> orig, GrimmChildFly self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<GrimmChildFly> orig, GrimmChildFly self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<GrimmChildFly> orig, GrimmChildFly self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GrimmChildFly> orig, GrimmChildFly self);

        public sealed class Params_Reset
        {
            public GrimmChildFly self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "OnUpdate"), value);
        ...
        public static event Delegates.DoFace_WithArgs DoFace
        {
            add => HookEndpointManager.Add<Delegates.DoFace_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmChildFly), "DoFace"), value);
