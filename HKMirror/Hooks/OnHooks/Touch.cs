...
public static class OnTouch
{
    internal static class HookHandler
    {
        ...
        internal static void HookSetWithTouchData()
        {
            if (!HookedList.Contains("SetWithTouchData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Touch), "SetWithTouchData"),
                    SetWithTouchData);
            }
        }
        ...
        private static void SetWithTouchData(Action<Touch, UnityEngine.Touch, ulong, float> orig,
            Touch self, UnityEngine.Touch touch, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookSetWithMouseData()
        {
            if (!HookedList.Contains("SetWithMouseData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Touch), "SetWithMouseData"),
                    SetWithMouseData);
            }
        }
        ...
        private static bool SetWithMouseData(Func<Touch, int, ulong, float, bool> orig, Touch self,
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_IsMouse_WithArgs(Func<Touch, bool> orig, Touch self);
        ...
        public delegate float get_normalizedPressure_WithArgs(Func<Touch, float> orig, Touch self);
        ...
        public delegate void Reset_WithArgs(Action<Touch> orig, Touch self);
        ...
        public delegate bool SetWithMouseData_WithArgs(Func<Touch, int, ulong, float, bool> orig,
            Touch self, int button, ulong updateTick, float deltaTime);
        ...
        public delegate void SetWithTouchData_WithArgs(Action<Touch, UnityEngine.Touch, ulong, float> orig,
            Touch self, UnityEngine.Touch touch, ulong updateTick, float deltaTime);
