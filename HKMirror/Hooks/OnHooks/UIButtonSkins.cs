...
public static class OnUIButtonSkins
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_listeningKey()
        {
            if (!HookedList.Contains("get_listeningKey"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "get_listeningKey", true),
                    get_listeningKey);
            }
        }
        ...
        internal static void Hookset_listeningKey()
        {
            if (!HookedList.Contains("set_listeningKey"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "set_listeningKey", true),
                    set_listeningKey);
            }
        }
        ...
        internal static void Hookget_listeningButton()
        {
            if (!HookedList.Contains("get_listeningButton"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "get_listeningButton", true),
                    get_listeningButton);
            }
        }
            ...
            UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.get_listeningButton_BeforeArgs toInvoke in _beforeget_listeningButton
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_listeningButton_AfterArgs toInvoke in
                         _afterget_listeningButton.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_listeningButton()
        {
            if (!HookedList.Contains("set_listeningButton"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "set_listeningButton", true),
                    set_listeningButton);
            }
        }
            ...
            UIButtonSkins self, MappableControllerButton value)
        {
            ...
            {
                foreach (Delegates.set_listeningButton_BeforeArgs toInvoke in _beforeset_listeningButton
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_listeningButton_AfterArgs toInvoke in
                         _afterset_listeningButton.GetInvocationList())
                {
                    try
                    {
        ...
        private static ButtonSkin GetButtonSkinFor_PlayerAction(
            On.UIButtonSkins.orig_GetButtonSkinFor_PlayerAction orig, UIButtonSkins self, InControl.PlayerAction action)
        {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_PlayerAction_BeforeArgs toInvoke in
                         _beforeGetButtonSkinFor_PlayerAction.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_PlayerAction_AfterArgs toInvoke in
                         _afterGetButtonSkinFor_PlayerAction.GetInvocationList())
                {
                    try
                    {
            ...
            InControl.PlayerAction action)
        {
            ...
            {
                foreach (Delegates.GetKeyboardSkinFor_BeforeArgs toInvoke in
                         _beforeGetKeyboardSkinFor.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetKeyboardSkinFor_AfterArgs toInvoke in
                         _afterGetKeyboardSkinFor.GetInvocationList())
                {
                    try
                    {
        ...
        private static ButtonSkin GetControllerButtonSkinFor(On.UIButtonSkins.orig_GetControllerButtonSkinFor orig,
            UIButtonSkins self, InControl.PlayerAction action)
        {
            ...
            {
                foreach (Delegates.GetControllerButtonSkinFor_BeforeArgs toInvoke in _beforeGetControllerButtonSkinFor
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetControllerButtonSkinFor_AfterArgs toInvoke in _afterGetControllerButtonSkinFor
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.GetButtonSkinFor_HeroActionButton_AfterArgs
        ...
        private static ButtonSkin GetButtonSkinFor_HeroActionButton(
            ...
            GlobalEnums.HeroActionButton actionButton)
        {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_HeroActionButton_BeforeArgs toInvoke in
                         _beforeGetButtonSkinFor_HeroActionButton.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_HeroActionButton_AfterArgs toInvoke in
                         _afterGetButtonSkinFor_HeroActionButton.GetInvocationList())
                {
                    try
                    {
        ...
        private static System.Collections.IEnumerator ShowCurrentKeyboardMappings(
            On.UIButtonSkins.orig_ShowCurrentKeyboardMappings orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.ShowCurrentKeyboardMappings_BeforeArgs toInvoke in _beforeShowCurrentKeyboardMappings
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static System.Collections.IEnumerator ShowCurrentButtonMappings(
            On.UIButtonSkins.orig_ShowCurrentButtonMappings orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.ShowCurrentButtonMappings_BeforeArgs toInvoke in _beforeShowCurrentButtonMappings
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void RefreshKeyMappings(On.UIButtonSkins.orig_RefreshKeyMappings orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.RefreshKeyMappings_BeforeArgs toInvoke in
                         _beforeRefreshKeyMappings.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.RefreshKeyMappings_AfterArgs toInvoke in
                         _afterRefreshKeyMappings.GetInvocationList())
                {
                    try
                    {
        ...
        private static void RefreshButtonMappings(On.UIButtonSkins.orig_RefreshButtonMappings orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.RefreshButtonMappings_BeforeArgs toInvoke in _beforeRefreshButtonMappings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.RefreshButtonMappings_AfterArgs toInvoke in _afterRefreshButtonMappings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            MappableKey mappableKey)
        {
            ...
            {
                foreach (Delegates.ListeningForKeyRebind_BeforeArgs toInvoke in _beforeListeningForKeyRebind
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ListeningForKeyRebind_AfterArgs toInvoke in _afterListeningForKeyRebind
                             .GetInvocationList())
                {
                    try
                    {
            ...
            UIButtonSkins self, MappableControllerButton mappableButton)
        {
            ...
            {
                foreach (Delegates.ListeningForButtonRebind_BeforeArgs toInvoke in _beforeListeningForButtonRebind
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ListeningForButtonRebind_AfterArgs toInvoke in _afterListeningForButtonRebind
                             .GetInvocationList())
                {
                    try
                    {
            ...
            UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.FinishedListeningForKey_BeforeArgs toInvoke in _beforeFinishedListeningForKey
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.FinishedListeningForKey_AfterArgs toInvoke in _afterFinishedListeningForKey
                             .GetInvocationList())
                {
                    try
                    {
            ...
            UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.FinishedListeningForButton_BeforeArgs toInvoke in _beforeFinishedListeningForButton
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.FinishedListeningForButton_AfterArgs toInvoke in _afterFinishedListeningForButton
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.GetButtonSkinFor_InputControlType_AfterArgs
        ...
        private static ButtonSkin GetButtonSkinFor_InputControlType(
            ...
            InControl.InputControlType inputControlType)
        {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_InputControlType_BeforeArgs toInvoke in
                         _beforeGetButtonSkinFor_InputControlType.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_InputControlType_AfterArgs toInvoke in
                         _afterGetButtonSkinFor_InputControlType.GetInvocationList())
                {
                    try
                    {
            ...
            UIButtonSkins self, string buttonName)
        {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_string_BeforeArgs toInvoke in _beforeGetButtonSkinFor_string
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetButtonSkinFor_string_AfterArgs toInvoke in _afterGetButtonSkinFor_string
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookRemoveMappableKey()
        {
            if (!HookedList.Contains("RemoveMappableKey"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "RemoveMappableKey", true),
                    RemoveMappableKey);
            }
        }
            ...
            MappableKey b)
        {
            ...
            {
                foreach (Delegates.RemoveMappableKey_BeforeArgs toInvoke in
                         _beforeRemoveMappableKey.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddMappableControllerButton()
        {
            if (!HookedList.Contains("AddMappableControllerButton"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "AddMappableControllerButton", true),
            ...
            UIButtonSkins self, MappableControllerButton b)
        {
            ...
            {
                foreach (Delegates.AddMappableControllerButton_BeforeArgs toInvoke in _beforeAddMappableControllerButton
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddMappableControllerButton_AfterArgs toInvoke in _afterAddMappableControllerButton
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookRemoveMappableControllerButton()
        {
            if (!HookedList.Contains("RemoveMappableControllerButton"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "RemoveMappableControllerButton", true),
            ...
            UIButtonSkins self, MappableControllerButton b)
        {
            ...
            {
                foreach (Delegates.RemoveMappableControllerButton_BeforeArgs toInvoke in
                         _beforeRemoveMappableControllerButton.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.RemoveMappableControllerButton_AfterArgs toInvoke in
                         _afterRemoveMappableControllerButton.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookorig_RefreshKeyMappings()
        {
            if (!HookedList.Contains("orig_RefreshKeyMappings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_RefreshKeyMappings", true),
        ...
        private static void orig_RefreshKeyMappings(Action<UIButtonSkins> orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.orig_RefreshKeyMappings_BeforeArgs toInvoke in _beforeorig_RefreshKeyMappings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.orig_RefreshKeyMappings_AfterArgs toInvoke in _afterorig_RefreshKeyMappings
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookorig_ShowCurrentKeyboardMappings()
        {
            if (!HookedList.Contains("orig_ShowCurrentKeyboardMappings"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_ShowCurrentKeyboardMappings", true),
        ...
        private static System.Collections.IEnumerator orig_ShowCurrentKeyboardMappings(
            Func<UIButtonSkins, System.Collections.IEnumerator> orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.orig_ShowCurrentKeyboardMappings_BeforeArgs toInvoke in
                         _beforeorig_ShowCurrentKeyboardMappings.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookorig_RefreshButtonMappings()
        {
            if (!HookedList.Contains("orig_RefreshButtonMappings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_RefreshButtonMappings", true),
        ...
        private static void orig_RefreshButtonMappings(Action<UIButtonSkins> orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.orig_RefreshButtonMappings_BeforeArgs toInvoke in _beforeorig_RefreshButtonMappings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.orig_RefreshButtonMappings_AfterArgs toInvoke in _afterorig_RefreshButtonMappings
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookorig_ShowCurrentButtonMappings()
        {
            if (!HookedList.Contains("orig_ShowCurrentButtonMappings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_ShowCurrentButtonMappings", true),
        ...
        private static System.Collections.IEnumerator orig_ShowCurrentButtonMappings(
            Func<UIButtonSkins, System.Collections.IEnumerator> orig, UIButtonSkins self)
        {
            ...
            {
                foreach (Delegates.orig_ShowCurrentButtonMappings_BeforeArgs toInvoke in
                         _beforeorig_ShowCurrentButtonMappings.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookorig_GetButtonSkinFor()
        {
            if (!HookedList.Contains("orig_GetButtonSkinFor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_GetButtonSkinFor", true),
        ...
        private static ButtonSkin orig_GetButtonSkinFor(
            Func<UIButtonSkins, InControl.InputControlType, ButtonSkin> orig, UIButtonSkins self,
            InControl.InputControlType inputControlType)
        {
            ...
            {
                foreach (Delegates.orig_GetButtonSkinFor_BeforeArgs toInvoke in _beforeorig_GetButtonSkinFor
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.orig_GetButtonSkinFor_AfterArgs toInvoke in _afterorig_GetButtonSkinFor
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate MappableKey
            get_listeningKey_WithArgs(Func<UIButtonSkins, MappableKey> orig, UIButtonSkins self);
        ...
        public delegate void set_listeningKey_WithArgs(Action<UIButtonSkins, MappableKey> orig, UIButtonSkins self,
            MappableKey value);
        ...
        public delegate MappableControllerButton get_listeningButton_AfterArgs(Params_get_listeningButton args,
            MappableControllerButton ret);

        public delegate MappableControllerButton get_listeningButton_WithArgs(
            Func<UIButtonSkins, MappableControllerButton> orig, UIButtonSkins self);
        ...
        public delegate void set_listeningButton_WithArgs(Action<UIButtonSkins, MappableControllerButton> orig,
            UIButtonSkins self, MappableControllerButton value);
        ...
        public delegate ButtonSkin GetButtonSkinFor_PlayerAction_AfterArgs(Params_GetButtonSkinFor_PlayerAction args,
            ButtonSkin ret);

        public delegate ButtonSkin GetButtonSkinFor_PlayerAction_WithArgs(
            Func<UIButtonSkins, InControl.PlayerAction, ButtonSkin> orig, UIButtonSkins self,
            InControl.PlayerAction action);
        ...
        public delegate ButtonSkin GetKeyboardSkinFor_WithArgs(
            Func<UIButtonSkins, InControl.PlayerAction, ButtonSkin> orig, UIButtonSkins self,
            InControl.PlayerAction action);
        ...
        public delegate ButtonSkin GetControllerButtonSkinFor_AfterArgs(Params_GetControllerButtonSkinFor args,
            ButtonSkin ret);

        public delegate ButtonSkin GetControllerButtonSkinFor_WithArgs(
            Func<UIButtonSkins, InControl.PlayerAction, ButtonSkin> orig, UIButtonSkins self,
            InControl.PlayerAction action);
        ...
        public delegate ButtonSkin GetButtonSkinFor_HeroActionButton_AfterArgs(
            Params_GetButtonSkinFor_HeroActionButton args, ButtonSkin ret);

        public delegate ButtonSkin GetButtonSkinFor_HeroActionButton_WithArgs(
            Func<UIButtonSkins, GlobalEnums.HeroActionButton, ButtonSkin> orig, UIButtonSkins self,
            GlobalEnums.HeroActionButton actionButton);
        ...
        public delegate System.Collections.IEnumerator ShowCurrentKeyboardMappings_AfterArgs(
            Params_ShowCurrentKeyboardMappings args, System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator ShowCurrentKeyboardMappings_WithArgs(
            Func<UIButtonSkins, System.Collections.IEnumerator> orig, UIButtonSkins self);
        ...
        public delegate System.Collections.IEnumerator ShowCurrentButtonMappings_AfterArgs(
            Params_ShowCurrentButtonMappings args, System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator ShowCurrentButtonMappings_WithArgs(
            Func<UIButtonSkins, System.Collections.IEnumerator> orig, UIButtonSkins self);
        ...
        public delegate void ListeningForKeyRebind_WithArgs(Action<UIButtonSkins, MappableKey> orig, UIButtonSkins self,
            MappableKey mappableKey);
        ...
        public delegate void ListeningForButtonRebind_WithArgs(Action<UIButtonSkins, MappableControllerButton> orig,
            UIButtonSkins self, MappableControllerButton mappableButton);
        ...
        public delegate ButtonSkin GetButtonSkinFor_InputControlType_AfterArgs(
            Params_GetButtonSkinFor_InputControlType args, ButtonSkin ret);

        public delegate ButtonSkin GetButtonSkinFor_InputControlType_WithArgs(
            Func<UIButtonSkins, InControl.InputControlType, ButtonSkin> orig, UIButtonSkins self,
            InControl.InputControlType inputControlType);
        ...
        public delegate ButtonSkin GetButtonSkinFor_string_AfterArgs(Params_GetButtonSkinFor_string args,
            ButtonSkin ret);

        public delegate ButtonSkin GetButtonSkinFor_string_WithArgs(Func<UIButtonSkins, string, ButtonSkin> orig,
            UIButtonSkins self, string buttonName);
        ...
        public delegate void AddMappableKey_WithArgs(Action<UIButtonSkins, MappableKey> orig, UIButtonSkins self,
            MappableKey b);
        ...
        public delegate void RemoveMappableKey_WithArgs(Action<UIButtonSkins, MappableKey> orig, UIButtonSkins self,
            MappableKey b);
        ...
        public delegate void AddMappableControllerButton_WithArgs(Action<UIButtonSkins, MappableControllerButton> orig,
            UIButtonSkins self, MappableControllerButton b);
        ...
        public delegate void RemoveMappableControllerButton_WithArgs(
            Action<UIButtonSkins, MappableControllerButton> orig, UIButtonSkins self, MappableControllerButton b);
        ...
        public delegate System.Collections.IEnumerator orig_ShowCurrentKeyboardMappings_AfterArgs(
            Params_orig_ShowCurrentKeyboardMappings args, System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator orig_ShowCurrentKeyboardMappings_WithArgs(
            Func<UIButtonSkins, System.Collections.IEnumerator> orig, UIButtonSkins self);
        ...
        public delegate System.Collections.IEnumerator orig_ShowCurrentButtonMappings_AfterArgs(
            Params_orig_ShowCurrentButtonMappings args, System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator orig_ShowCurrentButtonMappings_WithArgs(
            Func<UIButtonSkins, System.Collections.IEnumerator> orig, UIButtonSkins self);
        ...
        public delegate ButtonSkin orig_GetButtonSkinFor_WithArgs(
            Func<UIButtonSkins, InControl.InputControlType, ButtonSkin> orig, UIButtonSkins self,
            InControl.InputControlType inputControlType);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_listeningKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "get_listeningKey", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_listeningKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "get_listeningKey", true), value);
        }

        public static event Delegates.set_listeningKey_WithArgs set_listeningKey
        {
            add => HookEndpointManager.Add<Delegates.set_listeningKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "set_listeningKey", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_listeningKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "set_listeningKey", true), value);
        }

        public static event Delegates.get_listeningButton_WithArgs get_listeningButton
        {
            add => HookEndpointManager.Add<Delegates.get_listeningButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "get_listeningButton", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_listeningButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "get_listeningButton", true), value);
        }

        public static event Delegates.set_listeningButton_WithArgs set_listeningButton
        {
            add => HookEndpointManager.Add<Delegates.set_listeningButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "set_listeningButton", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_listeningButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "set_listeningButton", true), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.AddMappableKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "AddMappableKey", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddMappableKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "AddMappableKey", true), value);
        }

        public static event Delegates.RemoveMappableKey_WithArgs RemoveMappableKey
        {
            add => HookEndpointManager.Add<Delegates.RemoveMappableKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "RemoveMappableKey", true), value);
            remove => HookEndpointManager.Remove<Delegates.RemoveMappableKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "RemoveMappableKey", true), value);
        }

        public static event Delegates.AddMappableControllerButton_WithArgs AddMappableControllerButton
        {
            add => HookEndpointManager.Add<Delegates.AddMappableControllerButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "AddMappableControllerButton", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddMappableControllerButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "AddMappableControllerButton", true), value);
        }

        public static event Delegates.RemoveMappableControllerButton_WithArgs RemoveMappableControllerButton
        {
            add => HookEndpointManager.Add<Delegates.RemoveMappableControllerButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "RemoveMappableControllerButton", true), value);
            remove => HookEndpointManager.Remove<Delegates.RemoveMappableControllerButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "RemoveMappableControllerButton", true), value);
        }

        public static event Delegates.orig_RefreshKeyMappings_WithArgs orig_RefreshKeyMappings
        {
            add => HookEndpointManager.Add<Delegates.orig_RefreshKeyMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_RefreshKeyMappings", true), value);
            remove => HookEndpointManager.Remove<Delegates.orig_RefreshKeyMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_RefreshKeyMappings", true), value);
        }

        public static event Delegates.orig_ShowCurrentKeyboardMappings_WithArgs orig_ShowCurrentKeyboardMappings
        {
            add => HookEndpointManager.Add<Delegates.orig_ShowCurrentKeyboardMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_ShowCurrentKeyboardMappings", true), value);
            remove => HookEndpointManager.Remove<Delegates.orig_ShowCurrentKeyboardMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_ShowCurrentKeyboardMappings", true), value);
        }

        public static event Delegates.orig_RefreshButtonMappings_WithArgs orig_RefreshButtonMappings
        {
            add => HookEndpointManager.Add<Delegates.orig_RefreshButtonMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_RefreshButtonMappings", true), value);
            remove => HookEndpointManager.Remove<Delegates.orig_RefreshButtonMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_RefreshButtonMappings", true), value);
        }

        public static event Delegates.orig_ShowCurrentButtonMappings_WithArgs orig_ShowCurrentButtonMappings
        {
            add => HookEndpointManager.Add<Delegates.orig_ShowCurrentButtonMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_ShowCurrentButtonMappings", true), value);
            remove => HookEndpointManager.Remove<Delegates.orig_ShowCurrentButtonMappings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_ShowCurrentButtonMappings", true), value);
        }

        public static event Delegates.orig_GetButtonSkinFor_WithArgs orig_GetButtonSkinFor
        {
            add => HookEndpointManager.Add<Delegates.orig_GetButtonSkinFor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_GetButtonSkinFor", true), value);
            remove => HookEndpointManager.Remove<Delegates.orig_GetButtonSkinFor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_GetButtonSkinFor", true), value);
        }
        ...
        public static event Delegates.orig_SetupRefs_WithArgs orig_SetupRefs
        {
            add => HookEndpointManager.Add<Delegates.orig_SetupRefs_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UIButtonSkins), "orig_SetupRefs", true), value);
