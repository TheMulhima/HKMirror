...
public static class OnFireAtTarget
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FireAtTarget), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FireAtTarget), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FireAtTarget), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FireAtTarget), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FireAtTarget), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self)
        {
        ...
        internal static void HookDoSetVelocity()
        {
            if (!HookedList.Contains("DoSetVelocity"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FireAtTarget), "DoSetVelocity",
                        true), DoSetVelocity);
            }
        }
        ...
        private static void DoSetVelocity(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self);
        ...
        public delegate void DoSetVelocity_WithArgs(Action<HutongGames.PlayMaker.Actions.FireAtTarget> orig,
            HutongGames.PlayMaker.Actions.FireAtTarget self);
    }
