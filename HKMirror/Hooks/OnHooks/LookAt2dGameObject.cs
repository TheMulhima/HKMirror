...
public static class OnLookAt2dGameObject
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2dGameObject), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2dGameObject), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2dGameObject), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self)
        {
        ...
        internal static void HookDoLookAt()
        {
            if (!HookedList.Contains("DoLookAt"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2dGameObject), "DoLookAt",
                        true), DoLookAt);
            }
        }
        ...
        private static void DoLookAt(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self);
        ...
        public delegate void DoLookAt_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2dGameObject> orig,
            HutongGames.PlayMaker.Actions.LookAt2dGameObject self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2dGameObject), "Reset", true),
                value);
