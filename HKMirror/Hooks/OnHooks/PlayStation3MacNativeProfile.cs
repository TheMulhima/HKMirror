...
public static class OnPlayStation3MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation3MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation3MacNativeProfile> orig, PlayStation3MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation3MacNativeProfile> orig,
            PlayStation3MacNativeProfile self);

        public sealed class Params_Define
        {
            public PlayStation3MacNativeProfile self;
        }
    }
