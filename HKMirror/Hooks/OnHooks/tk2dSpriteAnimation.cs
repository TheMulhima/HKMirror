...
public static class Ontk2dSpriteAnimation
{
    internal static class HookHandler
    {
            ...
            tk2dSpriteAnimation self, string name)
        {
            ...
            {
                foreach (Delegates.GetClipIdByName_string_BeforeArgs toInvoke in _beforeGetClipIdByName_string
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetClipIdByName_string_AfterArgs toInvoke in _afterGetClipIdByName_string
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.GetClipIdByName_tk2dSpriteAnimationClip_AfterArgs
            ...
            tk2dSpriteAnimationClip clip)
        {
            ...
            {
                foreach (Delegates.GetClipIdByName_tk2dSpriteAnimationClip_BeforeArgs toInvoke in
                         _beforeGetClipIdByName_tk2dSpriteAnimationClip.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetClipIdByName_tk2dSpriteAnimationClip_AfterArgs toInvoke in
                         _afterGetClipIdByName_tk2dSpriteAnimationClip.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_FirstValidClip()
        {
            if (!HookedList.Contains("get_FirstValidClip"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteAnimation), "get_FirstValidClip", true),
                    get_FirstValidClip);
            }
        }
            ...
            Func<tk2dSpriteAnimation, tk2dSpriteAnimationClip> orig, tk2dSpriteAnimation self)
        {
            ...
            {
                foreach (Delegates.get_FirstValidClip_BeforeArgs toInvoke in
                         _beforeget_FirstValidClip.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_FirstValidClip_AfterArgs toInvoke in
                         _afterget_FirstValidClip.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate tk2dSpriteAnimationClip GetClipByName_WithArgs(
            Func<tk2dSpriteAnimation, string, tk2dSpriteAnimationClip> orig, tk2dSpriteAnimation self, string name);
        ...
        public delegate tk2dSpriteAnimationClip GetClipById_WithArgs(
            Func<tk2dSpriteAnimation, int, tk2dSpriteAnimationClip> orig, tk2dSpriteAnimation self, int id);
        ...
        public delegate int GetClipIdByName_string_WithArgs(Func<tk2dSpriteAnimation, string, int> orig,
            tk2dSpriteAnimation self, string name);
        ...
        public delegate int GetClipIdByName_tk2dSpriteAnimationClip_AfterArgs(
            Params_GetClipIdByName_tk2dSpriteAnimationClip args, int ret);

        public delegate int GetClipIdByName_tk2dSpriteAnimationClip_WithArgs(
            Func<tk2dSpriteAnimation, tk2dSpriteAnimationClip, int> orig, tk2dSpriteAnimation self,
            tk2dSpriteAnimationClip clip);
        ...
        public delegate tk2dSpriteAnimationClip get_FirstValidClip_AfterArgs(Params_get_FirstValidClip args,
            tk2dSpriteAnimationClip ret);

        public delegate tk2dSpriteAnimationClip get_FirstValidClip_WithArgs(
            Func<tk2dSpriteAnimation, tk2dSpriteAnimationClip> orig, tk2dSpriteAnimation self);
    }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.GetClipIdByName_tk2dSpriteAnimationClip_AfterArgs
            GetClipIdByName_tk2dSpriteAnimationClip
            {
                add
                {
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_FirstValidClip_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteAnimation), "get_FirstValidClip", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_FirstValidClip_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteAnimation), "get_FirstValidClip", true), value);
        }
    }
}