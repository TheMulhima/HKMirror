...
public static class OnMadCatzSSF4FightStickTEMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzSSF4FightStickTEMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzSSF4FightStickTEMacNativeProfile> orig,
            MadCatzSSF4FightStickTEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzSSF4FightStickTEMacNativeProfile> orig,
            MadCatzSSF4FightStickTEMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzSSF4FightStickTEMacNativeProfile self;
        }
    }
