...
public static class OnMadCatzSSF4FightStickTEMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MadCatzSSF4FightStickTEMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.MadCatzSSF4FightStickTEMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSSF4FightStickTEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.MadCatzSSF4FightStickTEMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSSF4FightStickTEMacNativeProfile self);
    }
