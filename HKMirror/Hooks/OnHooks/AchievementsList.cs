...
public static class OnAchievementsList
{
    internal static class HookHandler
    {
            ...
            string key)
        {
            ...
            {
                foreach (Delegates.AchievementExists_BeforeArgs toInvoke in
                         _beforeAchievementExists.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate Achievement FindAchievement_WithArgs(Func<AchievementsList, string, Achievement> orig,
            AchievementsList self, string key);
        ...
        public delegate bool AchievementExists_WithArgs(Func<AchievementsList, string, bool> orig,
            AchievementsList self, string key);
    }
