...
private static void RecieveHitEffect(On.EnemyHitEffectsBlackKnight.orig_RecieveHitEffect orig,EnemyHitEffectsBlackKnight self,  float attackDirection)
{
...
public delegate void Awake_WithArgs (Action<EnemyHitEffectsBlackKnight> orig, EnemyHitEffectsBlackKnight self);
...
public delegate void RecieveHitEffect_WithArgs (Action<EnemyHitEffectsBlackKnight,  float> orig, EnemyHitEffectsBlackKnight self,  float attackDirection);
...
public delegate void Update_WithArgs (Action<EnemyHitEffectsBlackKnight> orig, EnemyHitEffectsBlackKnight self);
}
