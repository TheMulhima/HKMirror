...
new Hook(ReflectionHelper.GetMethodInfo(typeof(AchievementHandler), "get_achievementsList", true), get_achievementsList);
...
private static AchievementsList get_achievementsList(Func<AchievementHandler, AchievementsList> orig, AchievementHandler self)
{
...
{
foreach (Delegates.get_achievementsList_BeforeArgs toInvoke in _beforeget_achievementsList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_achievementsList_AfterArgs toInvoke in _afterget_achievementsList.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(AchievementHandler), "set_achievementsList", true), set_achievementsList);
...
private static void set_achievementsList(Action<AchievementHandler,  AchievementsList> orig, AchievementHandler self,  AchievementsList value)
{
...
{
foreach (Delegates.set_achievementsList_BeforeArgs toInvoke in _beforeset_achievementsList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_achievementsList_AfterArgs toInvoke in _afterset_achievementsList.GetInvocationList())
{
try
{
...
private static void AwardAchievementToPlayer(On.AchievementHandler.orig_AwardAchievementToPlayer orig,AchievementHandler self,  string key)
{
...
{
foreach (Delegates.AwardAchievementToPlayer_BeforeArgs toInvoke in _beforeAwardAchievementToPlayer.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AwardAchievementToPlayer_AfterArgs toInvoke in _afterAwardAchievementToPlayer.GetInvocationList())
{
try
{
...
private static bool AchievementWasAwarded(On.AchievementHandler.orig_AchievementWasAwarded orig,AchievementHandler self,  string key)
{
...
{
foreach (Delegates.AchievementWasAwarded_BeforeArgs toInvoke in _beforeAchievementWasAwarded.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AchievementWasAwarded_AfterArgs toInvoke in _afterAchievementWasAwarded.GetInvocationList())
{
try
{
...
private static void ResetAllAchievements(On.AchievementHandler.orig_ResetAllAchievements orig,AchievementHandler self)
{
...
{
foreach (Delegates.ResetAllAchievements_BeforeArgs toInvoke in _beforeResetAllAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetAllAchievements_AfterArgs toInvoke in _afterResetAllAchievements.GetInvocationList())
{
try
{
...
private static void FlushRecordsToDisk(On.AchievementHandler.orig_FlushRecordsToDisk orig,AchievementHandler self)
{
...
{
foreach (Delegates.FlushRecordsToDisk_BeforeArgs toInvoke in _beforeFlushRecordsToDisk.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlushRecordsToDisk_AfterArgs toInvoke in _afterFlushRecordsToDisk.GetInvocationList())
{
try
{
...
private static void QueueAchievement(On.AchievementHandler.orig_QueueAchievement orig,AchievementHandler self,  string key)
{
...
private static void AwardQueuedAchievements(On.AchievementHandler.orig_AwardQueuedAchievements orig,AchievementHandler self)
{
...
private static void AwardAllAchievements(On.AchievementHandler.orig_AwardAllAchievements orig,AchievementHandler self)
{
...
{
foreach (Delegates.AwardAllAchievements_BeforeArgs toInvoke in _beforeAwardAllAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AwardAllAchievements_AfterArgs toInvoke in _afterAwardAllAchievements.GetInvocationList())
{
try
{
...
private static bool CanAwardAchievement(On.AchievementHandler.orig_CanAwardAchievement orig,AchievementHandler self,  string key)
{
...
{
foreach (Delegates.CanAwardAchievement_BeforeArgs toInvoke in _beforeCanAwardAchievement.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CanAwardAchievement_AfterArgs toInvoke in _afterCanAwardAchievement.GetInvocationList())
{
try
{
...
public delegate AchievementsList get_achievementsList_AfterArgs(Params_get_achievementsList args, AchievementsList ret);
public delegate AchievementsList get_achievementsList_WithArgs (Func<AchievementHandler, AchievementsList> orig, AchievementHandler self);
...
public delegate void set_achievementsList_WithArgs (Action<AchievementHandler,  AchievementsList> orig, AchievementHandler self,  AchievementsList value);
...
public delegate void AwardAchievementToPlayer_WithArgs (Action<AchievementHandler,  string> orig, AchievementHandler self,  string key);
...
public delegate bool AchievementWasAwarded_WithArgs (Func<AchievementHandler,  string, bool> orig, AchievementHandler self,  string key);
...
public delegate void QueueAchievement_WithArgs (Action<AchievementHandler,  string> orig, AchievementHandler self,  string key);
...
public delegate bool CanAwardAchievement_WithArgs (Func<AchievementHandler,  string, bool> orig, AchievementHandler self,  string key);
}
...
{
add => HookEndpointManager.Add<Delegates.get_achievementsList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementHandler), "get_achievementsList", true), value);
remove => HookEndpointManager.Remove<Delegates.get_achievementsList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementHandler), "get_achievementsList", true), value);
}
public static event Delegates.set_achievementsList_WithArgs set_achievementsList
{
add => HookEndpointManager.Add<Delegates.set_achievementsList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementHandler), "set_achievementsList", true), value);
remove => HookEndpointManager.Remove<Delegates.set_achievementsList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementHandler), "set_achievementsList", true), value);
}
