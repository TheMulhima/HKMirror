...
public static class OnLogitechF510ModeXWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ModeXWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ModeXWindowsUnityProfile> orig,
            LogitechF510ModeXWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ModeXWindowsUnityProfile> orig,
            LogitechF510ModeXWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ModeXWindowsUnityProfile self;
        }
    }
