...
public static class OnPlayStation5WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation5WindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation5WindowsNativeProfile> orig, PlayStation5WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation5WindowsNativeProfile> orig,
            PlayStation5WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public PlayStation5WindowsNativeProfile self;
        }
    }
