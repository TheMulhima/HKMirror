...
/// <summary>
/// Contains different types of On Hooks for GGCheckIfBossSequence class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGGCheckIfBossSequence
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfBossSequence), "get_IsTrue", true), get_IsTrue);
...
private static bool get_IsTrue(Func<GGCheckIfBossSequence, bool> orig, GGCheckIfBossSequence self)
{
...
{
public GGCheckIfBossSequence self;
}
...
public delegate bool get_IsTrue_WithArgs (Func<GGCheckIfBossSequence, bool> orig, GGCheckIfBossSequence self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfBossSequence), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfBossSequence), "get_IsTrue", true), value);
}
}
