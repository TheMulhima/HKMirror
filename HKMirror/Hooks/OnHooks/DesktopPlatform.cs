...
public static class OnDesktopPlatform
{
    ...
    public static class Delegates
    {
        ...
        public delegate void ClearSaveSlot_WithArgs(Action<DesktopPlatform, int, Action<bool>> orig,
            DesktopPlatform self, int slotIndex, Action<bool> callback);
        ...
        public delegate void EnsureSaveSlotSpace_WithArgs(Action<DesktopPlatform, int, Action<bool>> orig,
            DesktopPlatform self, int slotIndex, Action<bool> callback);
        ...
        public delegate Texture2D get_EngagedDisplayImage_AfterArgs(Params_get_EngagedDisplayImage args, Texture2D ret);

        public delegate void get_EngagedDisplayImage_BeforeArgs(Params_get_EngagedDisplayImage args);

        public delegate Texture2D get_EngagedDisplayImage_WithArgs(Func<DesktopPlatform, Texture2D> orig,
            DesktopPlatform self);
        ...
        public delegate void IsSaveSlotInUse_WithArgs(Action<DesktopPlatform, int, Action<bool>> orig,
            DesktopPlatform self, int slotIndex, Action<bool> callback);
        ...
        public delegate void LocalIsSaveSlotInUse_WithArgs(Action<DesktopPlatform, int, Action<bool>> orig,
            DesktopPlatform self, int slotIndex, Action<bool> callback);
        ...
        public delegate void LocalReadSaveSlot_WithArgs(Action<DesktopPlatform, int, Action<byte[]>> orig,
            DesktopPlatform self, int slotIndex, Action<byte[]> callback);
        ...
        public delegate void ReadSaveSlot_WithArgs(Action<DesktopPlatform, int, Action<byte[]>> orig,
            DesktopPlatform self, int slotIndex, Action<byte[]> callback);
        ...
        public delegate void WriteSaveSlot_WithArgs(Action<DesktopPlatform, int, byte[], Action<bool>> orig,
            DesktopPlatform self, int slotIndex, byte[] bytes, Action<bool> callback);
