...
public static class OnDesktopPlatform
{
    internal static class HookHandler
    {
            ...
            DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.CreateOnlineSubsystem_BeforeArgs toInvoke in _beforeCreateOnlineSubsystem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CreateOnlineSubsystem_AfterArgs toInvoke in _afterCreateOnlineSubsystem
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_DisplayName()
        {
            if (!HookedList.Contains("get_DisplayName"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_DisplayName", true),
                    get_DisplayName);
            }
        }
        ...
        private static void IsSaveSlotInUse(On.DesktopPlatform.orig_IsSaveSlotInUse orig, DesktopPlatform self,
            int slotIndex, System.Action<bool> callback)
        {
        ...
        private static void LocalIsSaveSlotInUse(On.DesktopPlatform.orig_LocalIsSaveSlotInUse orig,
            DesktopPlatform self, int slotIndex, System.Action<bool> callback)
        {
            ...
            {
                foreach (Delegates.LocalIsSaveSlotInUse_BeforeArgs toInvoke in _beforeLocalIsSaveSlotInUse
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.LocalIsSaveSlotInUse_AfterArgs toInvoke in _afterLocalIsSaveSlotInUse
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void LocalReadSaveSlot(On.DesktopPlatform.orig_LocalReadSaveSlot orig, DesktopPlatform self,
            int slotIndex, System.Action<byte[]> callback)
        {
            ...
            {
                foreach (Delegates.LocalReadSaveSlot_BeforeArgs toInvoke in
                         _beforeLocalReadSaveSlot.GetInvocationList())
                {
                    try
                    {
        ...
        private static void WriteSaveSlot(On.DesktopPlatform.orig_WriteSaveSlot orig, DesktopPlatform self,
            int slotIndex, byte[] bytes, System.Action<bool> callback)
        {
        ...
        internal static void Hookget_AreAchievementsFetched()
        {
            if (!HookedList.Contains("get_AreAchievementsFetched"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_AreAchievementsFetched", true),
        ...
        internal static void Hookget_HasNativeAchievementsDialog()
        {
            if (!HookedList.Contains("get_HasNativeAchievementsDialog"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_HasNativeAchievementsDialog", true),
        ...
        private static bool get_HasNativeAchievementsDialog(Func<DesktopPlatform, bool> orig, DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.get_HasNativeAchievementsDialog_BeforeArgs toInvoke in
                         _beforeget_HasNativeAchievementsDialog.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_HasNativeAchievementsDialog_AfterArgs toInvoke in
                         _afterget_HasNativeAchievementsDialog.GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.OnOnlineSubsystemAchievementsFetched_AfterArgs
            ...
            On.DesktopPlatform.orig_OnOnlineSubsystemAchievementsFetched orig, DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.OnOnlineSubsystemAchievementsFetched_BeforeArgs toInvoke in
                         _beforeOnOnlineSubsystemAchievementsFetched.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.OnOnlineSubsystemAchievementsFetched_AfterArgs toInvoke in
                         _afterOnOnlineSubsystemAchievementsFetched.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_ShowLanguageSelect()
        {
            if (!HookedList.Contains("get_ShowLanguageSelect"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_ShowLanguageSelect", true),
        ...
        private static bool get_ShowLanguageSelect(Func<DesktopPlatform, bool> orig, DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.get_ShowLanguageSelect_BeforeArgs toInvoke in _beforeget_ShowLanguageSelect
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_ShowLanguageSelect_AfterArgs toInvoke in _afterget_ShowLanguageSelect
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_IsControllerImplicit()
        {
            if (!HookedList.Contains("get_IsControllerImplicit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_IsControllerImplicit", true),
        ...
        private static bool get_IsControllerImplicit(Func<DesktopPlatform, bool> orig, DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.get_IsControllerImplicit_BeforeArgs toInvoke in _beforeget_IsControllerImplicit
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsControllerImplicit_AfterArgs toInvoke in _afterget_IsControllerImplicit
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_WillPreloadSaveFiles()
        {
            if (!HookedList.Contains("get_WillPreloadSaveFiles"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_WillPreloadSaveFiles", true),
        ...
        private static bool get_WillPreloadSaveFiles(Func<DesktopPlatform, bool> orig, DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.get_WillPreloadSaveFiles_BeforeArgs toInvoke in _beforeget_WillPreloadSaveFiles
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_WillPreloadSaveFiles_AfterArgs toInvoke in _afterget_WillPreloadSaveFiles
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_EngagedDisplayName()
        {
            if (!HookedList.Contains("get_EngagedDisplayName"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_EngagedDisplayName", true),
        ...
        private static string get_EngagedDisplayName(Func<DesktopPlatform, string> orig, DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.get_EngagedDisplayName_BeforeArgs toInvoke in _beforeget_EngagedDisplayName
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_EngagedDisplayName_AfterArgs toInvoke in _afterget_EngagedDisplayName
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_EngagedDisplayImage()
        {
            if (!HookedList.Contains("get_EngagedDisplayImage"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_EngagedDisplayImage", true),
        ...
        private static UnityEngine.Texture2D get_EngagedDisplayImage(Func<DesktopPlatform, UnityEngine.Texture2D> orig,
            DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.get_EngagedDisplayImage_BeforeArgs toInvoke in _beforeget_EngagedDisplayImage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_EngagedDisplayImage_AfterArgs toInvoke in _afterget_EngagedDisplayImage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            DesktopPlatform self)
        {
            ...
            {
                foreach (Delegates.GetVibrationMixer_BeforeArgs toInvoke in
                         _beforeGetVibrationMixer.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void IsSaveSlotInUse_WithArgs(Action<DesktopPlatform, int, System.Action<bool>> orig,
            DesktopPlatform self, int slotIndex, System.Action<bool> callback);
        ...
        public delegate void LocalIsSaveSlotInUse_WithArgs(Action<DesktopPlatform, int, System.Action<bool>> orig,
            DesktopPlatform self, int slotIndex, System.Action<bool> callback);
        ...
        public delegate void ReadSaveSlot_WithArgs(Action<DesktopPlatform, int, System.Action<byte[]>> orig,
            DesktopPlatform self, int slotIndex, System.Action<byte[]> callback);
        ...
        public delegate void LocalReadSaveSlot_WithArgs(Action<DesktopPlatform, int, System.Action<byte[]>> orig,
            DesktopPlatform self, int slotIndex, System.Action<byte[]> callback);
        ...
        public delegate void EnsureSaveSlotSpace_WithArgs(Action<DesktopPlatform, int, System.Action<bool>> orig,
            DesktopPlatform self, int slotIndex, System.Action<bool> callback);
        ...
        public delegate void WriteSaveSlot_WithArgs(Action<DesktopPlatform, int, byte[], System.Action<bool>> orig,
            DesktopPlatform self, int slotIndex, byte[] bytes, System.Action<bool> callback);
        ...
        public delegate int GetBackupNumber_WithArgs(Func<DesktopPlatform, string, int> orig, DesktopPlatform self,
            string backupPath);
        ...
        public delegate void ClearSaveSlot_WithArgs(Action<DesktopPlatform, int, System.Action<bool>> orig,
            DesktopPlatform self, int slotIndex, System.Action<bool> callback);
        ...
        public delegate bool? IsAchievementUnlocked_WithArgs(Func<DesktopPlatform, string, bool?> orig,
            DesktopPlatform self, string achievementId);
        ...
        public delegate void PushAchievementUnlock_WithArgs(Action<DesktopPlatform, string> orig, DesktopPlatform self,
        ...
        public delegate bool
            get_AreAchievementsFetched_WithArgs(Func<DesktopPlatform, bool> orig, DesktopPlatform self);
        ...
        public delegate bool get_HasNativeAchievementsDialog_AfterArgs(Params_get_HasNativeAchievementsDialog args,
            bool ret);

        public delegate bool get_HasNativeAchievementsDialog_WithArgs(Func<DesktopPlatform, bool> orig,
            DesktopPlatform self);
        ...
        public delegate bool IncludesPlugin_WithArgs(Func<DesktopPlatform, string, bool> orig, DesktopPlatform self,
            string pluginName);
        ...
        public delegate void OnOnlineSubsystemAchievementsFetched_AfterArgs(
            Params_OnOnlineSubsystemAchievementsFetched args);

        public delegate void OnOnlineSubsystemAchievementsFetched_WithArgs(Action<DesktopPlatform> orig,
            DesktopPlatform self);
        ...
        public delegate string
            get_EngagedDisplayName_WithArgs(Func<DesktopPlatform, string> orig, DesktopPlatform self);
        ...
        public delegate UnityEngine.Texture2D get_EngagedDisplayImage_AfterArgs(Params_get_EngagedDisplayImage args,
            UnityEngine.Texture2D ret);

        public delegate UnityEngine.Texture2D get_EngagedDisplayImage_WithArgs(
            Func<DesktopPlatform, UnityEngine.Texture2D> orig, DesktopPlatform self);
        ...
        public delegate VibrationMixer GetVibrationMixer_WithArgs(Func<DesktopPlatform, VibrationMixer> orig,
            DesktopPlatform self);
    }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.OnOnlineSubsystemAchievementsFetched_AfterArgs
            OnOnlineSubsystemAchievementsFetched
            {
                add
                {
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_DisplayName_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_DisplayName", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_DisplayName_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_DisplayName", true), value);
        }
        ...
        public static event Delegates.get_AreAchievementsFetched_WithArgs get_AreAchievementsFetched
        {
            add => HookEndpointManager.Add<Delegates.get_AreAchievementsFetched_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_AreAchievementsFetched", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_HasNativeAchievementsDialog_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_HasNativeAchievementsDialog", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_HasNativeAchievementsDialog_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_HasNativeAchievementsDialog", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_ShowLanguageSelect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_ShowLanguageSelect", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_ShowLanguageSelect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_ShowLanguageSelect", true), value);
        }

        public static event Delegates.get_IsControllerImplicit_WithArgs get_IsControllerImplicit
        {
            add => HookEndpointManager.Add<Delegates.get_IsControllerImplicit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_IsControllerImplicit", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsControllerImplicit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_IsControllerImplicit", true), value);
        }

        public static event Delegates.get_WillPreloadSaveFiles_WithArgs get_WillPreloadSaveFiles
        {
            add => HookEndpointManager.Add<Delegates.get_WillPreloadSaveFiles_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_WillPreloadSaveFiles", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_WillPreloadSaveFiles_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_WillPreloadSaveFiles", true), value);
        }

        public static event Delegates.get_EngagedDisplayName_WithArgs get_EngagedDisplayName
        {
            add => HookEndpointManager.Add<Delegates.get_EngagedDisplayName_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_EngagedDisplayName", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_EngagedDisplayName_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_EngagedDisplayName", true), value);
        }

        public static event Delegates.get_EngagedDisplayImage_WithArgs get_EngagedDisplayImage
        {
            add => HookEndpointManager.Add<Delegates.get_EngagedDisplayImage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_EngagedDisplayImage", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_EngagedDisplayImage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DesktopPlatform), "get_EngagedDisplayImage", true), value);
        }
