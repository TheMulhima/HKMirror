...
public static class OnEnumeratorLayout
{
    internal static class HookHandler
    {
        ...
        internal static void HookModifyNext()
        {
            if (!HookedList.Contains("ModifyNext"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.EnumeratorLayout), "ModifyNext", true),
                    ModifyNext);
            }
        }
        ...
        private static void ModifyNext(Action<Modding.Menu.EnumeratorLayout, UnityEngine.RectTransform> orig,
            Modding.Menu.EnumeratorLayout self, UnityEngine.RectTransform rt)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void ModifyNext_WithArgs(Action<Modding.Menu.EnumeratorLayout, UnityEngine.RectTransform> orig,
            Modding.Menu.EnumeratorLayout self, UnityEngine.RectTransform rt);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.ModifyNext_WithArgs ModifyNext
        {
            add => HookEndpointManager.Add<Delegates.ModifyNext_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.EnumeratorLayout), "ModifyNext", true), value);
