...
public static class OnuGuiSliderSetValue
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetValue), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetValue), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetValue), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetValue),
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetValue), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self);
        ...
        public delegate void DoSetValue_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetValue> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetValue self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetValue), "Reset", true),
                value);
        ...
        public static event Delegates.DoSetValue_WithArgs DoSetValue
        {
            add => HookEndpointManager.Add<Delegates.DoSetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetValue), "DoSetValue",
                    true), value);
