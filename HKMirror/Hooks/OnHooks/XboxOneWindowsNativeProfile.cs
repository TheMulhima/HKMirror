...
public static class OnXboxOneWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneWindowsNativeProfile> orig, XboxOneWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneWindowsNativeProfile> orig,
            XboxOneWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneWindowsNativeProfile self;
        }
    }
