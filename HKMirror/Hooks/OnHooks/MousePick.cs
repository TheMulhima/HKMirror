...
public static class OnMousePick
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePick), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePick), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePick), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self)
        {
        ...
        internal static void HookDoMousePick()
        {
            if (!HookedList.Contains("DoMousePick"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePick), "DoMousePick",
                        true), DoMousePick);
            }
        }
        ...
        private static void DoMousePick(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self);
        ...
        public delegate void DoMousePick_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePick> orig,
            HutongGames.PlayMaker.Actions.MousePick self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePick), "Reset", true), value);
        ...
        public static event Delegates.DoMousePick_WithArgs DoMousePick
        {
            add => HookEndpointManager.Add<Delegates.DoMousePick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePick), "DoMousePick", true),
                value);
