...
public static class OnuGuiInputFieldSetAsterixChar
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetAsterixChar), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiInputFieldSetAsterixChar> orig, uGuiInputFieldSetAsterixChar self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetAsterixChar), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiInputFieldSetAsterixChar> orig, uGuiInputFieldSetAsterixChar self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetAsterixChar), "DoSetValue"),
                    DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiInputFieldSetAsterixChar> orig, uGuiInputFieldSetAsterixChar self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetAsterixChar), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiInputFieldSetAsterixChar> orig, uGuiInputFieldSetAsterixChar self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiInputFieldSetAsterixChar> orig,
            uGuiInputFieldSetAsterixChar self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiInputFieldSetAsterixChar> orig,
            uGuiInputFieldSetAsterixChar self);
        ...
        public delegate void OnExit_WithArgs(Action<uGuiInputFieldSetAsterixChar> orig,
            uGuiInputFieldSetAsterixChar self);
        ...
        public delegate void Reset_WithArgs(Action<uGuiInputFieldSetAsterixChar> orig,
            uGuiInputFieldSetAsterixChar self);

        public sealed class Params_Reset
        {
            public uGuiInputFieldSetAsterixChar self;
        }
