...
public static class OnSceneManager
{
    ...
    public static class Delegates
    {
        ...
        public delegate float AdjustSaturationForPlatform_WithArgs(Func<float, MapZone?, float> orig,
            float originalSaturation, MapZone? mapZone);
        ...
        public delegate void SetLighting_WithArgs(Action<Color, float> orig, Color ambientLightColor,
            float ambientLightIntensity);
