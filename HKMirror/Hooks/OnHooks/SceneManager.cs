...
public static class OnSceneManager
{
    internal static class HookHandler
    {
        ...
        private static void SetLighting(On.SceneManager.orig_SetLighting orig, UnityEngine.Color ambientLightColor,
        ...
        private static float AdjustSaturationForPlatform(On.SceneManager.orig_AdjustSaturationForPlatform orig,
            float originalSaturation, GlobalEnums.MapZone? mapZone)
        {
            ...
            {
                foreach (Delegates.AdjustSaturationForPlatform_BeforeArgs toInvoke in _beforeAdjustSaturationForPlatform
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AdjustSaturationForPlatform_AfterArgs toInvoke in _afterAdjustSaturationForPlatform
                             .GetInvocationList())
                {
                    try
                    {
            ...
            SceneManagerSettings sms)
        {
            ...
            {
                foreach (Delegates.UpdateSceneSettings_BeforeArgs toInvoke in _beforeUpdateSceneSettings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.UpdateSceneSettings_AfterArgs toInvoke in
                         _afterUpdateSceneSettings.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void SetLighting_WithArgs(Action<UnityEngine.Color, float> orig,
            UnityEngine.Color ambientLightColor, float ambientLightIntensity);
        ...
        public delegate float AdjustSaturation_WithArgs(Func<SceneManager, float, float> orig, SceneManager self,
            float originalSaturation);
        ...
        public delegate float AdjustSaturationForPlatform_WithArgs(Func<float, GlobalEnums.MapZone?, float> orig,
            float originalSaturation, GlobalEnums.MapZone? mapZone);
        ...
        public delegate void UpdateSceneSettings_WithArgs(Action<SceneManager, SceneManagerSettings> orig,
            SceneManager self, SceneManagerSettings sms);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.orig_Update_WithArgs orig_Update
        {
            add => HookEndpointManager.Add<Delegates.orig_Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneManager), "orig_Update", true), value);
        ...
        public static event Delegates.orig_Start_WithArgs orig_Start
        {
            add => HookEndpointManager.Add<Delegates.orig_Start_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneManager), "orig_Start", true), value);
