...
public static class OnuGuiRawImageSetTexture
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiRawImageSetTexture), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiRawImageSetTexture), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiRawImageSetTexture), "DoSetValue"), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiRawImageSetTexture), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiRawImageSetTexture> orig, uGuiRawImageSetTexture self);

        public sealed class Params_Reset
        {
            public uGuiRawImageSetTexture self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiRawImageSetTexture), "Reset"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiRawImageSetTexture), "OnExit"), value);
