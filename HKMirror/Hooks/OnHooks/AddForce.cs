...
public static class OnAddForce
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<AddForce> orig, AddForce self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<AddForce> orig, AddForce self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<AddForce> orig, AddForce self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<AddForce> orig, AddForce self)
        {
        ...
        internal static void HookDoAddForce()
        {
            if (!HookedList.Contains("DoAddForce"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce), "DoAddForce"), DoAddForce);
            }
        }
        ...
        private static void DoAddForce(Action<AddForce> orig, AddForce self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoAddForce_WithArgs(Action<AddForce> orig, AddForce self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<AddForce> orig, AddForce self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<AddForce> orig, AddForce self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<AddForce> orig, AddForce self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<AddForce> orig, AddForce self);

        public sealed class Params_Reset
        {
            public AddForce self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce), "Reset"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoAddForce_WithArgs DoAddForce
        {
            add => HookEndpointManager.Add<Delegates.DoAddForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce), "DoAddForce"), value);
