...
private static string GetCharmNumString(On.InvCharmBackboard.orig_GetCharmNumString orig,InvCharmBackboard self)
{
...
{
foreach (Delegates.GetCharmNumString_BeforeArgs toInvoke in _beforeGetCharmNumString.GetInvocationList())
{
try
{
