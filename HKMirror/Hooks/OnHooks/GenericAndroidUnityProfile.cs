...
public static class OnGenericAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GenericAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GenericAndroidUnityProfile> orig, GenericAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GenericAndroidUnityProfile> orig, GenericAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public GenericAndroidUnityProfile self;
        }
    }
