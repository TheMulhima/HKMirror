...
private static void SpawnBlood(On.GlobalPrefabDefaults.orig_SpawnBlood orig,GlobalPrefabDefaults self,  UnityEngine.Vector3 position,  short minCount,  short maxCount,  float minSpeed,  float maxSpeed,  float angleMin,  float angleMax,  UnityEngine.Color? colorOverride)
{
...
public UnityEngine.Color? colorOverride;
}
...
public delegate void SpawnBlood_WithArgs (Action<GlobalPrefabDefaults,  UnityEngine.Vector3,  short,  short,  float,  float,  float,  float,  UnityEngine.Color?> orig, GlobalPrefabDefaults self,  UnityEngine.Vector3 position,  short minCount,  short maxCount,  float minSpeed,  float maxSpeed,  float angleMin,  float angleMax,  UnityEngine.Color? colorOverride);
}
