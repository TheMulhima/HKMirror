...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVariableProxy), "Invoke", true), Invoke);
...
private static System.Object Invoke(Func<Modding.Delegates.GetVariableProxy,  System.Type,  string,  System.Object, System.Object> orig, Modding.Delegates.GetVariableProxy self,  System.Type type,  string name,  System.Object value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVariableProxy), "EndInvoke", true), EndInvoke);
...
private static System.Object EndInvoke(Func<Modding.Delegates.GetVariableProxy,  System.IAsyncResult, System.Object> orig, Modding.Delegates.GetVariableProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.GetVariableProxy self;
...
public delegate System.Object Invoke_WithArgs (Func<Modding.Delegates.GetVariableProxy,  System.Type,  string,  System.Object, System.Object> orig, Modding.Delegates.GetVariableProxy self,  System.Type type,  string name,  System.Object value);
...
public delegate System.Object EndInvoke_WithArgs (Func<Modding.Delegates.GetVariableProxy,  System.IAsyncResult, System.Object> orig, Modding.Delegates.GetVariableProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVariableProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVariableProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVariableProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVariableProxy), "EndInvoke", true), value);
}
}
