...
new Hook(ReflectionHelper.GetMethodInfo(typeof(AlertRange), "get_IsHeroInRange", true), get_IsHeroInRange);
...
{
foreach (Delegates.get_IsHeroInRange_BeforeArgs toInvoke in _beforeget_IsHeroInRange.GetInvocationList())
{
try
{
...
private static void OnTriggerEnter2D(On.AlertRange.orig_OnTriggerEnter2D orig,AlertRange self,  UnityEngine.Collider2D other)
{
...
private static void OnTriggerExit2D(On.AlertRange.orig_OnTriggerExit2D orig,AlertRange self,  UnityEngine.Collider2D other)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<AlertRange,  UnityEngine.Collider2D> orig, AlertRange self,  UnityEngine.Collider2D other);
...
public delegate void OnTriggerExit2D_WithArgs (Action<AlertRange,  UnityEngine.Collider2D> orig, AlertRange self,  UnityEngine.Collider2D other);
...
public delegate AlertRange Find_WithArgs (Func< UnityEngine.GameObject,  string, AlertRange> orig,  UnityEngine.GameObject root,  string childName);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsHeroInRange_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AlertRange), "get_IsHeroInRange", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsHeroInRange_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AlertRange), "get_IsHeroInRange", true), value);
}
