...
public static class OnAlertRange
{
    ...
    public static class Delegates
    {
        ...
        public delegate AlertRange Find_WithArgs(Func<GameObject, string, AlertRange> orig, GameObject root,
            string childName);
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<AlertRange, Collider2D> orig, AlertRange self,
            Collider2D other);
        ...
        public delegate void OnTriggerExit2D_WithArgs(Action<AlertRange, Collider2D> orig, AlertRange self,
            Collider2D other);
