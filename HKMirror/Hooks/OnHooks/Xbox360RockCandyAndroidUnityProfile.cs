...
public static class OnXbox360RockCandyAndroidUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.Xbox360RockCandyAndroidUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.Xbox360RockCandyAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.Xbox360RockCandyAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.Xbox360RockCandyAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.Xbox360RockCandyAndroidUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.UnityDeviceProfiles.Xbox360RockCandyAndroidUnityProfile), "Define", true), value);
