    ...
    internal static class HookHandler
    {
        ...
        internal static void HookLocalizeAsset()
        {
            if (!HookedList.Contains("LocalizeAsset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Language.LocalizedAsset), "LocalizeAsset", true),
                    LocalizeAsset);
            }
        }
        ...
        internal static void HookLocalizeAsset_Object()
        {
            if (!HookedList.Contains("LocalizeAsset_Object"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Language.LocalizedAsset), "LocalizeAsset_Object", false),
        ...
        private static void LocalizeAsset_Object(Action<UnityEngine.Object> orig, UnityEngine.Object target)
        {
            ...
            {
                foreach (Delegates.LocalizeAsset_Object_BeforeArgs toInvoke in _beforeLocalizeAsset_Object
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.LocalizeAsset_Object_AfterArgs toInvoke in _afterLocalizeAsset_Object
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class WithOrig
    {
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Language.LocalizedAsset), "Awake", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.LocalizeAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Language.LocalizedAsset), "LocalizeAsset", true), value);
            remove => HookEndpointManager.Remove<Delegates.LocalizeAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Language.LocalizedAsset), "LocalizeAsset", true), value);
        }

        public static event Delegates.LocalizeAsset_Object_WithArgs LocalizeAsset_Object
        {
            add => HookEndpointManager.Add<Delegates.LocalizeAsset_Object_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Language.LocalizedAsset), "LocalizeAsset", false), value);
            remove => HookEndpointManager.Remove<Delegates.LocalizeAsset_Object_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Language.LocalizedAsset), "LocalizeAsset", false), value);
        }
    }
}