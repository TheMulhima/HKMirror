...
public static class OnMayflashMagicNSMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MayflashMagicNSMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MayflashMagicNSMacNativeProfile> orig, MayflashMagicNSMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MayflashMagicNSMacNativeProfile> orig,
            MayflashMagicNSMacNativeProfile self);

        public sealed class Params_Define
        {
            public MayflashMagicNSMacNativeProfile self;
        }
    }
