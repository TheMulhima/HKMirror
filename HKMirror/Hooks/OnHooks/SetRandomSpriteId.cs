...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SetRandomSpriteId), "InitExternalDebris", true), InitExternalDebris);
...
{
add => HookEndpointManager.Add<Delegates.InitExternalDebris_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SetRandomSpriteId), "IExternalDebris.InitExternalDebris", true), value);
remove => HookEndpointManager.Remove<Delegates.InitExternalDebris_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SetRandomSpriteId), "IExternalDebris.InitExternalDebris", true), value);
}
}
