...
public static class OnuGuiGetIsInteractable
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiGetIsInteractable), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiGetIsInteractable> orig, uGuiGetIsInteractable self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiGetIsInteractable), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiGetIsInteractable> orig, uGuiGetIsInteractable self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiGetIsInteractable), "DoGetValue"), DoGetValue);
            }
        }
        ...
        private static void DoGetValue(Action<uGuiGetIsInteractable> orig, uGuiGetIsInteractable self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetValue_WithArgs(Action<uGuiGetIsInteractable> orig, uGuiGetIsInteractable self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiGetIsInteractable> orig, uGuiGetIsInteractable self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiGetIsInteractable> orig, uGuiGetIsInteractable self);

        public sealed class Params_Reset
        {
            public uGuiGetIsInteractable self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiGetIsInteractable), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiGetIsInteractable), "OnEnter"), value);
