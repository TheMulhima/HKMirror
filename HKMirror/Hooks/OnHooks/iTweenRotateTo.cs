...
public static class OniTweenRotateTo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateTo), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateTo), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateTo), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateTo), "DoiTween",
                        true), DoiTween);
            }
        }
        ...
        private static void DoiTween(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self);
        ...
        public delegate void DoiTween_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateTo> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateTo self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateTo), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateTo), "OnExit", true),
                value);
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateTo), "DoiTween", true),
                value);
