...
public static class OnBossStatueTrophyPlaque
{
    internal static class HookHandler
    {
        ...
        private static void SetDisplay(On.BossStatueTrophyPlaque.orig_SetDisplay orig, BossStatueTrophyPlaque self,
            BossStatueTrophyPlaque.DisplayType type)
        {
        ...
        private static void DoTierCompleteEffect(On.BossStatueTrophyPlaque.orig_DoTierCompleteEffect orig,
            BossStatueTrophyPlaque self, BossStatueTrophyPlaque.DisplayType type)
        {
            ...
            if (_beforeDoTierCompleteEffect != null)
                foreach (Delegates.DoTierCompleteEffect_BeforeArgs toInvoke in _beforeDoTierCompleteEffect
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterDoTierCompleteEffect != null)
                foreach (Delegates.DoTierCompleteEffect_AfterArgs toInvoke in _afterDoTierCompleteEffect
                             .GetInvocationList())
                    try
                    {
            ...
            On.BossStatueTrophyPlaque.orig_TierCompleteEffectDelayed orig, BossStatueTrophyPlaque self)
        {
            ...
            if (_beforeTierCompleteEffectDelayed != null)
                foreach (Delegates.TierCompleteEffectDelayed_BeforeArgs toInvoke in _beforeTierCompleteEffectDelayed
                             .GetInvocationList())
                    try
                    {
        ...
        private static void SetDisplayObject(On.BossStatueTrophyPlaque.orig_SetDisplayObject orig,
            BossStatueTrophyPlaque self, BossStatueTrophyPlaque.DisplayType type)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoTierCompleteEffect_WithArgs(
            Action<BossStatueTrophyPlaque, BossStatueTrophyPlaque.DisplayType> orig, BossStatueTrophyPlaque self,
            BossStatueTrophyPlaque.DisplayType type);
        ...
        public delegate void SetDisplay_WithArgs(
            Action<BossStatueTrophyPlaque, BossStatueTrophyPlaque.DisplayType> orig, BossStatueTrophyPlaque self,
            BossStatueTrophyPlaque.DisplayType type);
        ...
        public delegate void SetDisplayObject_WithArgs(
            Action<BossStatueTrophyPlaque, BossStatueTrophyPlaque.DisplayType> orig, BossStatueTrophyPlaque self,
            BossStatueTrophyPlaque.DisplayType type);

        public delegate IEnumerator TierCompleteEffectDelayed_AfterArgs(Params_TierCompleteEffectDelayed args,
            IEnumerator ret);

        public delegate void TierCompleteEffectDelayed_BeforeArgs(Params_TierCompleteEffectDelayed args);

        public delegate IEnumerator TierCompleteEffectDelayed_WithArgs(Func<BossStatueTrophyPlaque, IEnumerator> orig,
            BossStatueTrophyPlaque self);
