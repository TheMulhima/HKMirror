...
public static class OnRockBandGuitarMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RockBandGuitarMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<RockBandGuitarMacNativeProfile> orig, RockBandGuitarMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RockBandGuitarMacNativeProfile> orig,
            RockBandGuitarMacNativeProfile self);

        public sealed class Params_Define
        {
            public RockBandGuitarMacNativeProfile self;
        }
    }
