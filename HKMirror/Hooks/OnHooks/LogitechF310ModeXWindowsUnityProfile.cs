...
public static class OnLogitechF310ModeXWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310ModeXWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310ModeXWindowsUnityProfile> orig,
            LogitechF310ModeXWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310ModeXWindowsUnityProfile> orig,
            LogitechF310ModeXWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF310ModeXWindowsUnityProfile self;
        }
    }
