...
public static class OnSteelSeriesStratusXLWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SteelSeriesStratusXLWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<SteelSeriesStratusXLWindowsUnityProfile> orig,
            SteelSeriesStratusXLWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SteelSeriesStratusXLWindowsUnityProfile> orig,
            SteelSeriesStratusXLWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public SteelSeriesStratusXLWindowsUnityProfile self;
        }
    }
