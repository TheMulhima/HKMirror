...
public static class OnDroidBoxPS3AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DroidBoxPS3AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<DroidBoxPS3AndroidUnityProfile> orig, DroidBoxPS3AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<DroidBoxPS3AndroidUnityProfile> orig,
            DroidBoxPS3AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public DroidBoxPS3AndroidUnityProfile self;
        }
    }
