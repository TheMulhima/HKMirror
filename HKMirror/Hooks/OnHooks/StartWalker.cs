...
/// <summary>
/// Contains different types of On Hooks for StartWalker class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnStartWalker
{
...
On.StartWalker.Reset += Reset;

}
}
internal static event Delegates.Reset_BeforeArgs _beforeReset;
internal static event Delegates.Reset_AfterArgs _afterReset;
private static void Reset(On.StartWalker.orig_Reset orig,StartWalker self)
{
...
{
public StartWalker self;
}
public delegate void Reset_BeforeArgs(Params_Reset args);
public delegate void Reset_AfterArgs(Params_Reset args);
public delegate void Reset_WithArgs (Action<StartWalker> orig, StartWalker self);
...
public delegate void Apply_WithArgs (Action<StartWalker,  Walker> orig, StartWalker self,  Walker walker);
}
...
{
public static event On.StartWalker.hook_Reset Reset
{
add => On.StartWalker.Reset += value;
remove => On.StartWalker.Reset -= value;
}
public static event On.StartWalker.hook_Apply Apply
{
add => On.StartWalker.Apply += value;
remove => On.StartWalker.Apply -= value;
}
}
