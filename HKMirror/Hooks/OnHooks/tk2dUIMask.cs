...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIMask), "get_ThisMeshFilter", true), get_ThisMeshFilter);
...
private static UnityEngine.MeshFilter get_ThisMeshFilter(Func<tk2dUIMask, UnityEngine.MeshFilter> orig, tk2dUIMask self)
{
...
{
foreach (Delegates.get_ThisMeshFilter_BeforeArgs toInvoke in _beforeget_ThisMeshFilter.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_ThisMeshFilter_AfterArgs toInvoke in _afterget_ThisMeshFilter.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIMask), "get_ThisBoxCollider", true), get_ThisBoxCollider);
...
private static UnityEngine.BoxCollider get_ThisBoxCollider(Func<tk2dUIMask, UnityEngine.BoxCollider> orig, tk2dUIMask self)
{
...
{
foreach (Delegates.get_ThisBoxCollider_BeforeArgs toInvoke in _beforeget_ThisBoxCollider.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_ThisBoxCollider_AfterArgs toInvoke in _afterget_ThisBoxCollider.GetInvocationList())
{
try
{
...
private static UnityEngine.Mesh FillMesh(On.tk2dUIMask.orig_FillMesh orig,tk2dUIMask self,  UnityEngine.Mesh mesh)
{
...
private static void ReshapeBounds(On.tk2dUIMask.orig_ReshapeBounds orig,tk2dUIMask self,  UnityEngine.Vector3 dMin,  UnityEngine.Vector3 dMax)
{
...
public delegate UnityEngine.MeshFilter get_ThisMeshFilter_AfterArgs(Params_get_ThisMeshFilter args, UnityEngine.MeshFilter ret);
public delegate UnityEngine.MeshFilter get_ThisMeshFilter_WithArgs (Func<tk2dUIMask, UnityEngine.MeshFilter> orig, tk2dUIMask self);
...
public delegate UnityEngine.BoxCollider get_ThisBoxCollider_AfterArgs(Params_get_ThisBoxCollider args, UnityEngine.BoxCollider ret);
public delegate UnityEngine.BoxCollider get_ThisBoxCollider_WithArgs (Func<tk2dUIMask, UnityEngine.BoxCollider> orig, tk2dUIMask self);
...
public delegate UnityEngine.Mesh FillMesh_WithArgs (Func<tk2dUIMask,  UnityEngine.Mesh, UnityEngine.Mesh> orig, tk2dUIMask self,  UnityEngine.Mesh mesh);
...
public delegate void ReshapeBounds_WithArgs (Action<tk2dUIMask,  UnityEngine.Vector3,  UnityEngine.Vector3> orig, tk2dUIMask self,  UnityEngine.Vector3 dMin,  UnityEngine.Vector3 dMax);
}
...
{
add => HookEndpointManager.Add<Delegates.get_ThisMeshFilter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIMask), "get_ThisMeshFilter", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ThisMeshFilter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIMask), "get_ThisMeshFilter", true), value);
}
public static event Delegates.get_ThisBoxCollider_WithArgs get_ThisBoxCollider
{
add => HookEndpointManager.Add<Delegates.get_ThisBoxCollider_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIMask), "get_ThisBoxCollider", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ThisBoxCollider_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIMask), "get_ThisBoxCollider", true), value);
}
