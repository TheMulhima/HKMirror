...
public static class Ontk2dUIMask
{
    ...
    public static class Delegates
    {
        ...
        public delegate Mesh FillMesh_AfterArgs(Params_FillMesh args, Mesh ret);

        public delegate void FillMesh_BeforeArgs(Params_FillMesh args);

        public delegate Mesh FillMesh_WithArgs(Func<tk2dUIMask, Mesh, Mesh> orig, tk2dUIMask self, Mesh mesh);

        public delegate BoxCollider get_ThisBoxCollider_AfterArgs(Params_get_ThisBoxCollider args, BoxCollider ret);

        public delegate void get_ThisBoxCollider_BeforeArgs(Params_get_ThisBoxCollider args);

        public delegate BoxCollider get_ThisBoxCollider_WithArgs(Func<tk2dUIMask, BoxCollider> orig, tk2dUIMask self);

        public delegate MeshFilter get_ThisMeshFilter_AfterArgs(Params_get_ThisMeshFilter args, MeshFilter ret);

        public delegate void get_ThisMeshFilter_BeforeArgs(Params_get_ThisMeshFilter args);

        public delegate MeshFilter get_ThisMeshFilter_WithArgs(Func<tk2dUIMask, MeshFilter> orig, tk2dUIMask self);
        ...
        public delegate void ReshapeBounds_WithArgs(Action<tk2dUIMask, Vector3, Vector3> orig, tk2dUIMask self,
