...
public static class OnCinematicVideoPlayerConfig
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_VideoReference()
        {
            if (!HookedList.Contains("get_VideoReference"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_VideoReference", true),
                    get_VideoReference);
            }
        }
            ...
            Func<CinematicVideoPlayerConfig, CinematicVideoReference> orig, CinematicVideoPlayerConfig self)
        {
            ...
            {
                foreach (Delegates.get_VideoReference_BeforeArgs toInvoke in
                         _beforeget_VideoReference.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_VideoReference_AfterArgs toInvoke in
                         _afterget_VideoReference.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_MeshRenderer()
        {
            if (!HookedList.Contains("get_MeshRenderer"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_MeshRenderer", true),
                    get_MeshRenderer);
            }
        }
        ...
        private static UnityEngine.MeshRenderer get_MeshRenderer(
            Func<CinematicVideoPlayerConfig, UnityEngine.MeshRenderer> orig, CinematicVideoPlayerConfig self)
        {
        ...
        internal static void Hookget_AudioSource()
        {
            if (!HookedList.Contains("get_AudioSource"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_AudioSource", true),
                    get_AudioSource);
            }
        }
        ...
        private static UnityEngine.AudioSource get_AudioSource(
            Func<CinematicVideoPlayerConfig, UnityEngine.AudioSource> orig, CinematicVideoPlayerConfig self)
        {
        ...
        internal static void Hookget_FaderStyle()
        {
            if (!HookedList.Contains("get_FaderStyle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_FaderStyle", true),
                    get_FaderStyle);
            }
        }
        ...
        internal static void Hookget_ImplicitVolume()
        {
            if (!HookedList.Contains("get_ImplicitVolume"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_ImplicitVolume", true),
                    get_ImplicitVolume);
            }
        }
            ...
            CinematicVideoPlayerConfig self)
        {
            ...
            {
                foreach (Delegates.get_ImplicitVolume_BeforeArgs toInvoke in
                         _beforeget_ImplicitVolume.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_ImplicitVolume_AfterArgs toInvoke in
                         _afterget_ImplicitVolume.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate CinematicVideoReference get_VideoReference_AfterArgs(Params_get_VideoReference args,
            CinematicVideoReference ret);

        public delegate CinematicVideoReference get_VideoReference_WithArgs(
            Func<CinematicVideoPlayerConfig, CinematicVideoReference> orig, CinematicVideoPlayerConfig self);
        ...
        public delegate UnityEngine.MeshRenderer get_MeshRenderer_AfterArgs(Params_get_MeshRenderer args,
            UnityEngine.MeshRenderer ret);

        public delegate UnityEngine.MeshRenderer get_MeshRenderer_WithArgs(
            Func<CinematicVideoPlayerConfig, UnityEngine.MeshRenderer> orig, CinematicVideoPlayerConfig self);
        ...
        public delegate UnityEngine.AudioSource get_AudioSource_AfterArgs(Params_get_AudioSource args,
            UnityEngine.AudioSource ret);

        public delegate UnityEngine.AudioSource get_AudioSource_WithArgs(
            Func<CinematicVideoPlayerConfig, UnityEngine.AudioSource> orig, CinematicVideoPlayerConfig self);
        ...
        public delegate CinematicVideoFaderStyles get_FaderStyle_AfterArgs(Params_get_FaderStyle args,
            CinematicVideoFaderStyles ret);

        public delegate CinematicVideoFaderStyles get_FaderStyle_WithArgs(
            Func<CinematicVideoPlayerConfig, CinematicVideoFaderStyles> orig, CinematicVideoPlayerConfig self);
        ...
        public delegate float get_ImplicitVolume_WithArgs(Func<CinematicVideoPlayerConfig, float> orig,
            CinematicVideoPlayerConfig self);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_VideoReference_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_VideoReference", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_VideoReference_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_VideoReference", true), value);
        }

        public static event Delegates.get_MeshRenderer_WithArgs get_MeshRenderer
        {
            add => HookEndpointManager.Add<Delegates.get_MeshRenderer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_MeshRenderer", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_MeshRenderer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_MeshRenderer", true), value);
        }

        public static event Delegates.get_AudioSource_WithArgs get_AudioSource
        {
            add => HookEndpointManager.Add<Delegates.get_AudioSource_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_AudioSource", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_AudioSource_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_AudioSource", true), value);
        }

        public static event Delegates.get_FaderStyle_WithArgs get_FaderStyle
        {
            add => HookEndpointManager.Add<Delegates.get_FaderStyle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_FaderStyle", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_FaderStyle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_FaderStyle", true), value);
        }

        public static event Delegates.get_ImplicitVolume_WithArgs get_ImplicitVolume
        {
            add => HookEndpointManager.Add<Delegates.get_ImplicitVolume_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_ImplicitVolume", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_ImplicitVolume_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoPlayerConfig), "get_ImplicitVolume", true), value);
        }
    }
}