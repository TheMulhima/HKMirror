...
public static class OnCinematicVideoPlayerConfig
{
    ...
    {
        public delegate AudioSource get_AudioSource_AfterArgs(Params_get_AudioSource args, AudioSource ret);

        public delegate void get_AudioSource_BeforeArgs(Params_get_AudioSource args);

        public delegate AudioSource get_AudioSource_WithArgs(Func<CinematicVideoPlayerConfig, AudioSource> orig,
            CinematicVideoPlayerConfig self);
        ...
        public delegate MeshRenderer get_MeshRenderer_AfterArgs(Params_get_MeshRenderer args, MeshRenderer ret);

        public delegate void get_MeshRenderer_BeforeArgs(Params_get_MeshRenderer args);

        public delegate MeshRenderer get_MeshRenderer_WithArgs(Func<CinematicVideoPlayerConfig, MeshRenderer> orig,
            CinematicVideoPlayerConfig self);
