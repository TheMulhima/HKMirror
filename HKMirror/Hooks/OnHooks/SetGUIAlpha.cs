...
public static class OnSetGUIAlpha
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGUIAlpha), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetGUIAlpha> orig,
            HutongGames.PlayMaker.Actions.SetGUIAlpha self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGUIAlpha), "OnGUI", true),
                    OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.SetGUIAlpha> orig,
            HutongGames.PlayMaker.Actions.SetGUIAlpha self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGUIAlpha> orig,
            HutongGames.PlayMaker.Actions.SetGUIAlpha self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGUIAlpha> orig,
            HutongGames.PlayMaker.Actions.SetGUIAlpha self);
    }
