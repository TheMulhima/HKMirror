...
public static class OnuGuiToggleGetIsOn
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "DoGetValue"), DoGetValue);
            }
        }
        ...
        private static void DoGetValue(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetValue_WithArgs(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiToggleGetIsOn> orig, uGuiToggleGetIsOn self);

        public sealed class Params_Reset
        {
            public uGuiToggleGetIsOn self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "OnUpdate"), value);
        ...
        public static event Delegates.DoGetValue_WithArgs DoGetValue
        {
            add => HookEndpointManager.Add<Delegates.DoGetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiToggleGetIsOn), "DoGetValue"), value);
