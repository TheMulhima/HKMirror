...
public static class OnuGuiToggleGetIsOn
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn),
        ...
        private static void DoGetValue(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self);
        ...
        public delegate void DoGetValue_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn), "Reset", true),
                value);
        ...
        public static event Delegates.DoGetValue_WithArgs DoGetValue
        {
            add => HookEndpointManager.Add<Delegates.DoGetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleGetIsOn), "DoGetValue",
                    true), value);
