...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_actorState", true), get_actorState);
...
private static GlobalEnums.ActorStates get_actorState(Func<HeroAnimationController, GlobalEnums.ActorStates> orig, HeroAnimationController self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_actorState", true), set_actorState);
...
private static void set_actorState(Action<HeroAnimationController,  GlobalEnums.ActorStates> orig, HeroAnimationController self,  GlobalEnums.ActorStates value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_prevActorState", true), get_prevActorState);
...
private static GlobalEnums.ActorStates get_prevActorState(Func<HeroAnimationController, GlobalEnums.ActorStates> orig, HeroAnimationController self)
{
...
{
foreach (Delegates.get_prevActorState_BeforeArgs toInvoke in _beforeget_prevActorState.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_prevActorState_AfterArgs toInvoke in _afterget_prevActorState.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_prevActorState", true), set_prevActorState);
...
private static void set_prevActorState(Action<HeroAnimationController,  GlobalEnums.ActorStates> orig, HeroAnimationController self,  GlobalEnums.ActorStates value)
{
...
{
foreach (Delegates.set_prevActorState_BeforeArgs toInvoke in _beforeset_prevActorState.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_prevActorState_AfterArgs toInvoke in _afterset_prevActorState.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_stateBeforeControl", true), get_stateBeforeControl);
...
private static GlobalEnums.ActorStates get_stateBeforeControl(Func<HeroAnimationController, GlobalEnums.ActorStates> orig, HeroAnimationController self)
{
...
{
foreach (Delegates.get_stateBeforeControl_BeforeArgs toInvoke in _beforeget_stateBeforeControl.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_stateBeforeControl_AfterArgs toInvoke in _afterget_stateBeforeControl.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_stateBeforeControl", true), set_stateBeforeControl);
...
private static void set_stateBeforeControl(Action<HeroAnimationController,  GlobalEnums.ActorStates> orig, HeroAnimationController self,  GlobalEnums.ActorStates value)
{
...
{
foreach (Delegates.set_stateBeforeControl_BeforeArgs toInvoke in _beforeset_stateBeforeControl.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_stateBeforeControl_AfterArgs toInvoke in _afterset_stateBeforeControl.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_controlEnabled", true), get_controlEnabled);
...
{
foreach (Delegates.get_controlEnabled_BeforeArgs toInvoke in _beforeget_controlEnabled.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_controlEnabled_AfterArgs toInvoke in _afterget_controlEnabled.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_controlEnabled", true), set_controlEnabled);
...
private static void set_controlEnabled(Action<HeroAnimationController,  bool> orig, HeroAnimationController self,  bool value)
{
...
{
foreach (Delegates.set_controlEnabled_BeforeArgs toInvoke in _beforeset_controlEnabled.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_controlEnabled_AfterArgs toInvoke in _afterset_controlEnabled.GetInvocationList())
{
try
{
...
private static void UpdateState(On.HeroAnimationController.orig_UpdateState orig,HeroAnimationController self,  GlobalEnums.ActorStates newState)
{
...
private static void PlayClip(On.HeroAnimationController.orig_PlayClip orig,HeroAnimationController self,  string clipName)
{
...
private static void UpdateAnimation(On.HeroAnimationController.orig_UpdateAnimation orig,HeroAnimationController self)
{
...
private static bool CanPlayLookDown(On.HeroAnimationController.orig_CanPlayLookDown orig,HeroAnimationController self)
{
...
private static void AnimationCompleteDelegate(On.HeroAnimationController.orig_AnimationCompleteDelegate orig,HeroAnimationController self,  tk2dSpriteAnimator sprite,  tk2dSpriteAnimationClip clip)
{
...
private static void Play(On.HeroAnimationController.orig_Play orig,HeroAnimationController self,  string clipName)
{
...
private static void PlayFromFrame(On.HeroAnimationController.orig_PlayFromFrame orig,HeroAnimationController self,  string clipName,  int frame)
{
...
private static void StartControl(On.HeroAnimationController.orig_StartControl orig,HeroAnimationController self)
{
...
internal static event Delegates.StartControlWithoutSettingState_BeforeArgs _beforeStartControlWithoutSettingState;
internal static event Delegates.StartControlWithoutSettingState_AfterArgs _afterStartControlWithoutSettingState;
private static void StartControlWithoutSettingState(On.HeroAnimationController.orig_StartControlWithoutSettingState orig,HeroAnimationController self)
{
...
{
foreach (Delegates.StartControlWithoutSettingState_BeforeArgs toInvoke in _beforeStartControlWithoutSettingState.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StartControlWithoutSettingState_AfterArgs toInvoke in _afterStartControlWithoutSettingState.GetInvocationList())
{
try
{
...
private static void FinishedDash(On.HeroAnimationController.orig_FinishedDash orig,HeroAnimationController self)
{
...
private static float GetCurrentClipDuration(On.HeroAnimationController.orig_GetCurrentClipDuration orig,HeroAnimationController self)
{
...
{
foreach (Delegates.GetCurrentClipDuration_BeforeArgs toInvoke in _beforeGetCurrentClipDuration.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetCurrentClipDuration_AfterArgs toInvoke in _afterGetCurrentClipDuration.GetInvocationList())
{
try
{
...
private static float GetClipDuration(On.HeroAnimationController.orig_GetClipDuration orig,HeroAnimationController self,  string clipName)
{
...
public delegate GlobalEnums.ActorStates get_actorState_AfterArgs(Params_get_actorState args, GlobalEnums.ActorStates ret);
public delegate GlobalEnums.ActorStates get_actorState_WithArgs (Func<HeroAnimationController, GlobalEnums.ActorStates> orig, HeroAnimationController self);
public sealed class Params_set_actorState
{
public HeroAnimationController self;
public GlobalEnums.ActorStates value;
}
...
public delegate void set_actorState_WithArgs (Action<HeroAnimationController,  GlobalEnums.ActorStates> orig, HeroAnimationController self,  GlobalEnums.ActorStates value);
...
public delegate GlobalEnums.ActorStates get_prevActorState_AfterArgs(Params_get_prevActorState args, GlobalEnums.ActorStates ret);
public delegate GlobalEnums.ActorStates get_prevActorState_WithArgs (Func<HeroAnimationController, GlobalEnums.ActorStates> orig, HeroAnimationController self);
...
public delegate void set_prevActorState_WithArgs (Action<HeroAnimationController,  GlobalEnums.ActorStates> orig, HeroAnimationController self,  GlobalEnums.ActorStates value);
...
public delegate GlobalEnums.ActorStates get_stateBeforeControl_AfterArgs(Params_get_stateBeforeControl args, GlobalEnums.ActorStates ret);
public delegate GlobalEnums.ActorStates get_stateBeforeControl_WithArgs (Func<HeroAnimationController, GlobalEnums.ActorStates> orig, HeroAnimationController self);
...
public delegate void set_stateBeforeControl_WithArgs (Action<HeroAnimationController,  GlobalEnums.ActorStates> orig, HeroAnimationController self,  GlobalEnums.ActorStates value);
...
public delegate bool get_controlEnabled_WithArgs (Func<HeroAnimationController, bool> orig, HeroAnimationController self);
...
public delegate void set_controlEnabled_WithArgs (Action<HeroAnimationController,  bool> orig, HeroAnimationController self,  bool value);
...
public delegate void UpdateState_WithArgs (Action<HeroAnimationController,  GlobalEnums.ActorStates> orig, HeroAnimationController self,  GlobalEnums.ActorStates newState);
...
public delegate void PlayClip_WithArgs (Action<HeroAnimationController,  string> orig, HeroAnimationController self,  string clipName);
...
public delegate void UpdateAnimation_WithArgs (Action<HeroAnimationController> orig, HeroAnimationController self);
...
public delegate bool CanPlayIdle_WithArgs (Func<HeroAnimationController, bool> orig, HeroAnimationController self);
...
public delegate bool CanPlayLookDown_WithArgs (Func<HeroAnimationController, bool> orig, HeroAnimationController self);
...
public delegate bool canPlayTurn_WithArgs (Func<HeroAnimationController, bool> orig, HeroAnimationController self);
...
public delegate void AnimationCompleteDelegate_WithArgs (Action<HeroAnimationController,  tk2dSpriteAnimator,  tk2dSpriteAnimationClip> orig, HeroAnimationController self,  tk2dSpriteAnimator sprite,  tk2dSpriteAnimationClip clip);
...
public delegate void Play_WithArgs (Action<HeroAnimationController,  string> orig, HeroAnimationController self,  string clipName);
...
public delegate void PlayFromFrame_WithArgs (Action<HeroAnimationController,  string,  int> orig, HeroAnimationController self,  string clipName,  int frame);
...
public delegate void StartControlWithoutSettingState_WithArgs (Action<HeroAnimationController> orig, HeroAnimationController self);
...
public delegate float GetCurrentClipDuration_WithArgs (Func<HeroAnimationController, float> orig, HeroAnimationController self);
...
public delegate float GetClipDuration_WithArgs (Func<HeroAnimationController,  string, float> orig, HeroAnimationController self,  string clipName);
}
...
{
add => HookEndpointManager.Add<Delegates.get_actorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_actorState", true), value);
remove => HookEndpointManager.Remove<Delegates.get_actorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_actorState", true), value);
}
public static event Delegates.set_actorState_WithArgs set_actorState
{
add => HookEndpointManager.Add<Delegates.set_actorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_actorState", true), value);
remove => HookEndpointManager.Remove<Delegates.set_actorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_actorState", true), value);
}
public static event Delegates.get_prevActorState_WithArgs get_prevActorState
{
add => HookEndpointManager.Add<Delegates.get_prevActorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_prevActorState", true), value);
remove => HookEndpointManager.Remove<Delegates.get_prevActorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_prevActorState", true), value);
}
public static event Delegates.set_prevActorState_WithArgs set_prevActorState
{
add => HookEndpointManager.Add<Delegates.set_prevActorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_prevActorState", true), value);
remove => HookEndpointManager.Remove<Delegates.set_prevActorState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_prevActorState", true), value);
}
public static event Delegates.get_stateBeforeControl_WithArgs get_stateBeforeControl
{
add => HookEndpointManager.Add<Delegates.get_stateBeforeControl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_stateBeforeControl", true), value);
remove => HookEndpointManager.Remove<Delegates.get_stateBeforeControl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_stateBeforeControl", true), value);
}
public static event Delegates.set_stateBeforeControl_WithArgs set_stateBeforeControl
{
add => HookEndpointManager.Add<Delegates.set_stateBeforeControl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_stateBeforeControl", true), value);
remove => HookEndpointManager.Remove<Delegates.set_stateBeforeControl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_stateBeforeControl", true), value);
}
public static event Delegates.get_controlEnabled_WithArgs get_controlEnabled
{
add => HookEndpointManager.Add<Delegates.get_controlEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_controlEnabled", true), value);
remove => HookEndpointManager.Remove<Delegates.get_controlEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "get_controlEnabled", true), value);
}
public static event Delegates.set_controlEnabled_WithArgs set_controlEnabled
{
add => HookEndpointManager.Add<Delegates.set_controlEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_controlEnabled", true), value);
remove => HookEndpointManager.Remove<Delegates.set_controlEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroAnimationController), "set_controlEnabled", true), value);
}
...
public static event On.HeroAnimationController.hook_StartControlWithoutSettingState StartControlWithoutSettingState
{
