...
public static class OnMadCatzMicroControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzMicroControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzMicroControllerMacNativeProfile> orig,
            MadCatzMicroControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzMicroControllerMacNativeProfile> orig,
            MadCatzMicroControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzMicroControllerMacNativeProfile self;
        }
    }
