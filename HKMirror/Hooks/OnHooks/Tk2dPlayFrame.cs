...
public static class OnTk2dPlayFrame
{
    internal static class HookHandler
    {
        ...
        internal static void Hook_getSprite()
        {
            if (!HookedList.Contains("_getSprite"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Tk2dPlayFrame), "_getSprite",
                        true), _getSprite);
            }
        }
        ...
        private static void _getSprite(Action<HutongGames.PlayMaker.Actions.Tk2dPlayFrame> orig,
            HutongGames.PlayMaker.Actions.Tk2dPlayFrame self)
        {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Tk2dPlayFrame), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.Tk2dPlayFrame> orig,
            HutongGames.PlayMaker.Actions.Tk2dPlayFrame self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Tk2dPlayFrame), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.Tk2dPlayFrame> orig,
            HutongGames.PlayMaker.Actions.Tk2dPlayFrame self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void _getSprite_WithArgs(Action<HutongGames.PlayMaker.Actions.Tk2dPlayFrame> orig,
            HutongGames.PlayMaker.Actions.Tk2dPlayFrame self);
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.Tk2dPlayFrame> orig,
            HutongGames.PlayMaker.Actions.Tk2dPlayFrame self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.Tk2dPlayFrame> orig,
            HutongGames.PlayMaker.Actions.Tk2dPlayFrame self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates._getSprite_WithArgs _getSprite
        {
            add => HookEndpointManager.Add<Delegates._getSprite_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Tk2dPlayFrame), "_getSprite", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Tk2dPlayFrame), "OnEnter", true),
                value);
