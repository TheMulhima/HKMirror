...
public static class OnTk2dPlayFrame
{
    internal static class HookHandler
    {
        ...
        internal static void Hook_getSprite()
        {
            if (!HookedList.Contains("_getSprite"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dPlayFrame), "_getSprite"), _getSprite);
            }
        }
        ...
        private static void _getSprite(Action<Tk2dPlayFrame> orig, Tk2dPlayFrame self)
        {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dPlayFrame), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<Tk2dPlayFrame> orig, Tk2dPlayFrame self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dPlayFrame), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Tk2dPlayFrame> orig, Tk2dPlayFrame self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void _getSprite_WithArgs(Action<Tk2dPlayFrame> orig, Tk2dPlayFrame self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<Tk2dPlayFrame> orig, Tk2dPlayFrame self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Tk2dPlayFrame> orig, Tk2dPlayFrame self);

        public sealed class Params__getSprite
        {
            public Tk2dPlayFrame self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates._getSprite_WithArgs _getSprite
        {
            add => HookEndpointManager.Add<Delegates._getSprite_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dPlayFrame), "_getSprite"), value);
        ...
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dPlayFrame), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dPlayFrame), "OnEnter"), value);
