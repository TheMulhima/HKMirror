...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_JoystickId", true), get_JoystickId);
...
private static int get_JoystickId(Func<InControl.UnityInputDevice, int> orig, InControl.UnityInputDevice self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "set_JoystickId", true), set_JoystickId);
...
private static void set_JoystickId(Action<InControl.UnityInputDevice,  int> orig, InControl.UnityInputDevice self,  int value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "Update", true), Update);

}
}
internal static event Delegates.Update_BeforeArgs _beforeUpdate;
internal static event Delegates.Update_AfterArgs _afterUpdate;
private static void Update(Action<InControl.UnityInputDevice,  ulong,  float> orig, InControl.UnityInputDevice self,  ulong updateTick,  float deltaTime)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "SetupAnalogQueries", false), SetupAnalogQueries);
...
{
foreach (Delegates.SetupAnalogQueries_BeforeArgs toInvoke in _beforeSetupAnalogQueries.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupAnalogQueries_AfterArgs toInvoke in _afterSetupAnalogQueries.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "SetupButtonQueries", false), SetupButtonQueries);
...
{
foreach (Delegates.SetupButtonQueries_BeforeArgs toInvoke in _beforeSetupButtonQueries.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupButtonQueries_AfterArgs toInvoke in _afterSetupButtonQueries.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "ReadRawButtonState", true), ReadRawButtonState);
...
private static bool ReadRawButtonState(Func<InControl.UnityInputDevice,  int, bool> orig, InControl.UnityInputDevice self,  int index)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "ReadRawAnalogValue", true), ReadRawAnalogValue);
...
private static float ReadRawAnalogValue(Func<InControl.UnityInputDevice,  int, float> orig, InControl.UnityInputDevice self,  int index)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_IsSupportedOnThisPlatform", true), get_IsSupportedOnThisPlatform);
...
private static bool get_IsSupportedOnThisPlatform(Func<InControl.UnityInputDevice, bool> orig, InControl.UnityInputDevice self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_IsKnown", true), get_IsKnown);
...
private static bool get_IsKnown(Func<InControl.UnityInputDevice, bool> orig, InControl.UnityInputDevice self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_NumUnknownButtons", true), get_NumUnknownButtons);
...
private static int get_NumUnknownButtons(Func<InControl.UnityInputDevice, int> orig, InControl.UnityInputDevice self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_NumUnknownAnalogs", true), get_NumUnknownAnalogs);
...
private static int get_NumUnknownAnalogs(Func<InControl.UnityInputDevice, int> orig, InControl.UnityInputDevice self)
{
...
{
public InControl.UnityInputDevice self;
}
...
public delegate int get_JoystickId_WithArgs (Func<InControl.UnityInputDevice, int> orig, InControl.UnityInputDevice self);
...
public delegate void set_JoystickId_WithArgs (Action<InControl.UnityInputDevice,  int> orig, InControl.UnityInputDevice self,  int value);
...
public delegate void Update_WithArgs (Action<InControl.UnityInputDevice,  ulong,  float> orig, InControl.UnityInputDevice self,  ulong updateTick,  float deltaTime);
...
public delegate bool ReadRawButtonState_WithArgs (Func<InControl.UnityInputDevice,  int, bool> orig, InControl.UnityInputDevice self,  int index);
...
public delegate float ReadRawAnalogValue_WithArgs (Func<InControl.UnityInputDevice,  int, float> orig, InControl.UnityInputDevice self,  int index);
...
public delegate bool get_IsSupportedOnThisPlatform_WithArgs (Func<InControl.UnityInputDevice, bool> orig, InControl.UnityInputDevice self);
...
public delegate bool get_IsKnown_WithArgs (Func<InControl.UnityInputDevice, bool> orig, InControl.UnityInputDevice self);
...
public delegate int get_NumUnknownButtons_WithArgs (Func<InControl.UnityInputDevice, int> orig, InControl.UnityInputDevice self);
...
public delegate int get_NumUnknownAnalogs_WithArgs (Func<InControl.UnityInputDevice, int> orig, InControl.UnityInputDevice self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_JoystickId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_JoystickId", true), value);
remove => HookEndpointManager.Remove<Delegates.get_JoystickId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_JoystickId", true), value);
}
public static event Delegates.set_JoystickId_WithArgs set_JoystickId
{
add => HookEndpointManager.Add<Delegates.set_JoystickId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "set_JoystickId", true), value);
remove => HookEndpointManager.Remove<Delegates.set_JoystickId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "set_JoystickId", true), value);
}
public static event Delegates.Update_WithArgs Update
{
add => HookEndpointManager.Add<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "Update", true), value);
remove => HookEndpointManager.Remove<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "Update", true), value);
}
public static event Delegates.SetupAnalogQueries_WithArgs SetupAnalogQueries
{
add => HookEndpointManager.Add<Delegates.SetupAnalogQueries_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "SetupAnalogQueries", false), value);
remove => HookEndpointManager.Remove<Delegates.SetupAnalogQueries_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "SetupAnalogQueries", false), value);
}
public static event Delegates.SetupButtonQueries_WithArgs SetupButtonQueries
{
add => HookEndpointManager.Add<Delegates.SetupButtonQueries_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "SetupButtonQueries", false), value);
remove => HookEndpointManager.Remove<Delegates.SetupButtonQueries_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "SetupButtonQueries", false), value);
}
public static event Delegates.ReadRawButtonState_WithArgs ReadRawButtonState
{
add => HookEndpointManager.Add<Delegates.ReadRawButtonState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "ReadRawButtonState", true), value);
remove => HookEndpointManager.Remove<Delegates.ReadRawButtonState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "ReadRawButtonState", true), value);
}
public static event Delegates.ReadRawAnalogValue_WithArgs ReadRawAnalogValue
{
add => HookEndpointManager.Add<Delegates.ReadRawAnalogValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "ReadRawAnalogValue", true), value);
remove => HookEndpointManager.Remove<Delegates.ReadRawAnalogValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "ReadRawAnalogValue", true), value);
}
public static event Delegates.get_IsSupportedOnThisPlatform_WithArgs get_IsSupportedOnThisPlatform
{
add => HookEndpointManager.Add<Delegates.get_IsSupportedOnThisPlatform_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_IsSupportedOnThisPlatform", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsSupportedOnThisPlatform_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_IsSupportedOnThisPlatform", true), value);
}
public static event Delegates.get_IsKnown_WithArgs get_IsKnown
{
add => HookEndpointManager.Add<Delegates.get_IsKnown_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_IsKnown", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsKnown_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_IsKnown", true), value);
}
public static event Delegates.get_NumUnknownButtons_WithArgs get_NumUnknownButtons
{
add => HookEndpointManager.Add<Delegates.get_NumUnknownButtons_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_NumUnknownButtons", true), value);
remove => HookEndpointManager.Remove<Delegates.get_NumUnknownButtons_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_NumUnknownButtons", true), value);
}
public static event Delegates.get_NumUnknownAnalogs_WithArgs get_NumUnknownAnalogs
{
add => HookEndpointManager.Add<Delegates.get_NumUnknownAnalogs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_NumUnknownAnalogs", true), value);
remove => HookEndpointManager.Remove<Delegates.get_NumUnknownAnalogs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityInputDevice), "get_NumUnknownAnalogs", true), value);
}
}
