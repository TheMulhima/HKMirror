...
public static class OnGenericBlackBerryUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GenericBlackBerryUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GenericBlackBerryUnityProfile> orig, GenericBlackBerryUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GenericBlackBerryUnityProfile> orig,
            GenericBlackBerryUnityProfile self);

        public sealed class Params_Define
        {
            public GenericBlackBerryUnityProfile self;
        }
    }
