...
public static class OnSmoothFlyTo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<SmoothFlyTo> orig, SmoothFlyTo self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<SmoothFlyTo> orig, SmoothFlyTo self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<SmoothFlyTo> orig, SmoothFlyTo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<SmoothFlyTo> orig, SmoothFlyTo self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<SmoothFlyTo> orig, SmoothFlyTo self)
        {
        ...
        internal static void HookDoChase()
        {
            if (!HookedList.Contains("DoChase"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "DoChase"), DoChase);
            }
        }
        ...
        private static void DoChase(Action<SmoothFlyTo> orig, SmoothFlyTo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<SmoothFlyTo> orig, SmoothFlyTo self);

        public delegate void DoChase_AfterArgs(Params_DoChase args);

        public delegate void DoChase_BeforeArgs(Params_DoChase args);

        public delegate void DoChase_WithArgs(Action<SmoothFlyTo> orig, SmoothFlyTo self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<SmoothFlyTo> orig, SmoothFlyTo self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<SmoothFlyTo> orig, SmoothFlyTo self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<SmoothFlyTo> orig, SmoothFlyTo self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<SmoothFlyTo> orig, SmoothFlyTo self);

        public sealed class Params_Reset
        {
            public SmoothFlyTo self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "Awake"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoChase_WithArgs DoChase
        {
            add => HookEndpointManager.Add<Delegates.DoChase_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothFlyTo), "DoChase"), value);
