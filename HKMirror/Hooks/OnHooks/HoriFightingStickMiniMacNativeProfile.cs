...
public static class OnHoriFightingStickMiniMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriFightingStickMiniMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriFightingStickMiniMacNativeProfile> orig,
            HoriFightingStickMiniMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriFightingStickMiniMacNativeProfile> orig,
            HoriFightingStickMiniMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriFightingStickMiniMacNativeProfile self;
        }
    }
