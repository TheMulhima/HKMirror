...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_playID", true), get_playID);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_playID", true), set_playID);
...
private static void set_playID(Action<SecureplayerPrefsDemoClass,  string> orig, SecureplayerPrefsDemoClass self,  string value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_type", true), get_type);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_type", true), set_type);
...
private static void set_type(Action<SecureplayerPrefsDemoClass,  int> orig, SecureplayerPrefsDemoClass self,  int value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_incremental", true), get_incremental);
...
private static bool get_incremental(Func<SecureplayerPrefsDemoClass, bool> orig, SecureplayerPrefsDemoClass self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_incremental", true), set_incremental);
...
private static void set_incremental(Action<SecureplayerPrefsDemoClass,  bool> orig, SecureplayerPrefsDemoClass self,  bool value)
{
...
public delegate string get_playID_WithArgs (Func<SecureplayerPrefsDemoClass, string> orig, SecureplayerPrefsDemoClass self);
...
public delegate void set_playID_WithArgs (Action<SecureplayerPrefsDemoClass,  string> orig, SecureplayerPrefsDemoClass self,  string value);
...
public delegate int get_type_WithArgs (Func<SecureplayerPrefsDemoClass, int> orig, SecureplayerPrefsDemoClass self);
...
public delegate void set_type_WithArgs (Action<SecureplayerPrefsDemoClass,  int> orig, SecureplayerPrefsDemoClass self,  int value);
...
public delegate bool get_incremental_WithArgs (Func<SecureplayerPrefsDemoClass, bool> orig, SecureplayerPrefsDemoClass self);
...
public delegate void set_incremental_WithArgs (Action<SecureplayerPrefsDemoClass,  bool> orig, SecureplayerPrefsDemoClass self,  bool value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_playID_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_playID", true), value);
remove => HookEndpointManager.Remove<Delegates.get_playID_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_playID", true), value);
}
public static event Delegates.set_playID_WithArgs set_playID
{
add => HookEndpointManager.Add<Delegates.set_playID_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_playID", true), value);
remove => HookEndpointManager.Remove<Delegates.set_playID_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_playID", true), value);
}
public static event Delegates.get_type_WithArgs get_type
{
add => HookEndpointManager.Add<Delegates.get_type_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_type", true), value);
remove => HookEndpointManager.Remove<Delegates.get_type_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_type", true), value);
}
public static event Delegates.set_type_WithArgs set_type
{
add => HookEndpointManager.Add<Delegates.set_type_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_type", true), value);
remove => HookEndpointManager.Remove<Delegates.set_type_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_type", true), value);
}
public static event Delegates.get_incremental_WithArgs get_incremental
{
add => HookEndpointManager.Add<Delegates.get_incremental_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_incremental", true), value);
remove => HookEndpointManager.Remove<Delegates.get_incremental_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "get_incremental", true), value);
}
public static event Delegates.set_incremental_WithArgs set_incremental
{
add => HookEndpointManager.Add<Delegates.set_incremental_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_incremental", true), value);
remove => HookEndpointManager.Remove<Delegates.set_incremental_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SecureplayerPrefsDemoClass), "set_incremental", true), value);
}
}
