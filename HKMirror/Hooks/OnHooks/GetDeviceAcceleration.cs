...
public static class OnGetDeviceAcceleration
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceAcceleration), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceAcceleration),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self)
        {
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self)
        {
        ...
        internal static void HookDoGetDeviceAcceleration()
        {
            if (!HookedList.Contains("DoGetDeviceAcceleration"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceAcceleration),
                        "DoGetDeviceAcceleration", true), DoGetDeviceAcceleration);
            }
        }
        ...
        private static void DoGetDeviceAcceleration(Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self);
        ...
        public delegate void DoGetDeviceAcceleration_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetDeviceAcceleration> orig,
            HutongGames.PlayMaker.Actions.GetDeviceAcceleration self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceAcceleration), "OnEnter",
                    true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceAcceleration), "OnUpdate",
                    true), value);
        ...
        public static event Delegates.DoGetDeviceAcceleration_WithArgs DoGetDeviceAcceleration
        {
            add => HookEndpointManager.Add<Delegates.DoGetDeviceAcceleration_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceAcceleration),
                    "DoGetDeviceAcceleration", true), value);
