...
public static class OnNavMeshAgentAnimatorSynchronizer
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NavMeshAgentAnimatorSynchronizer), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<NavMeshAgentAnimatorSynchronizer> orig, NavMeshAgentAnimatorSynchronizer self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NavMeshAgentAnimatorSynchronizer), "OnPreprocess"),
                    OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<NavMeshAgentAnimatorSynchronizer> orig,
            NavMeshAgentAnimatorSynchronizer self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NavMeshAgentAnimatorSynchronizer), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<NavMeshAgentAnimatorSynchronizer> orig,
            NavMeshAgentAnimatorSynchronizer self)
        {
        ...
        internal static void HookDoAnimatorMove()
        {
            if (!HookedList.Contains("DoAnimatorMove"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NavMeshAgentAnimatorSynchronizer), "DoAnimatorMove"),
                    DoAnimatorMove);
            }
        }
        ...
        private static void DoAnimatorMove(Action<NavMeshAgentAnimatorSynchronizer> orig,
            NavMeshAgentAnimatorSynchronizer self)
        {
    ...
    public static class Delegates
    {
        ...
        {
            public NavMeshAgentAnimatorSynchronizer self;
        }
