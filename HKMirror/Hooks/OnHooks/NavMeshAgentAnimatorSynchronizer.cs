...
public static class OnNavMeshAgentAnimatorSynchronizer
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer> orig,
            HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer), "OnPreprocess", true),
                    OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer> orig,
            HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer> orig,
            HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer self)
        {
        ...
        internal static void HookDoAnimatorMove()
        {
            if (!HookedList.Contains("DoAnimatorMove"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer), "DoAnimatorMove", true),
                    DoAnimatorMove);
            }
        }
        ...
        private static void DoAnimatorMove(Action<HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer> orig,
            HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer> orig,
            HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer self);
        ...
        public delegate void OnPreprocess_WithArgs(
            Action<HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer> orig,
            HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer self);
        ...
        public delegate void DoAnimatorMove_WithArgs(
            Action<HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer> orig,
            HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.NavMeshAgentAnimatorSynchronizer),
                    "Reset", true), value);
