...
internal static event Delegates.InitializeSlicedSpriteDimensions_BeforeArgs _beforeInitializeSlicedSpriteDimensions;
internal static event Delegates.InitializeSlicedSpriteDimensions_AfterArgs _afterInitializeSlicedSpriteDimensions;
private static void InitializeSlicedSpriteDimensions(On.tk2dUIProgressBar.orig_InitializeSlicedSpriteDimensions orig,tk2dUIProgressBar self)
{
...
{
foreach (Delegates.InitializeSlicedSpriteDimensions_BeforeArgs toInvoke in _beforeInitializeSlicedSpriteDimensions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.InitializeSlicedSpriteDimensions_AfterArgs toInvoke in _afterInitializeSlicedSpriteDimensions.GetInvocationList())
{
try
{
...
public delegate void set_Value_WithArgs (Action<tk2dUIProgressBar,  float> orig, tk2dUIProgressBar self,  float value);
...
public delegate void InitializeSlicedSpriteDimensions_WithArgs (Action<tk2dUIProgressBar> orig, tk2dUIProgressBar self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Value_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIProgressBar), "get_Value", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Value_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIProgressBar), "get_Value", true), value);
}
public static event Delegates.set_Value_WithArgs set_Value
{
add => HookEndpointManager.Add<Delegates.set_Value_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIProgressBar), "set_Value", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Value_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIProgressBar), "set_Value", true), value);
}
