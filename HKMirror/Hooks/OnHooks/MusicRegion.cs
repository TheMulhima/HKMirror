...
private static void OnTriggerEnter2D(On.MusicRegion.orig_OnTriggerEnter2D orig,MusicRegion self,  UnityEngine.Collider2D collision)
{
...
private static void OnTriggerExit2D(On.MusicRegion.orig_OnTriggerExit2D orig,MusicRegion self,  UnityEngine.Collider2D collision)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<MusicRegion,  UnityEngine.Collider2D> orig, MusicRegion self,  UnityEngine.Collider2D collision);
...
public delegate void OnTriggerExit2D_WithArgs (Action<MusicRegion,  UnityEngine.Collider2D> orig, MusicRegion self,  UnityEngine.Collider2D collision);
...
public delegate System.Collections.IEnumerator FadeIn_WithArgs (Func<MusicRegion, System.Collections.IEnumerator> orig, MusicRegion self);
