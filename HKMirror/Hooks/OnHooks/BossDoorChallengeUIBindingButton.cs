...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeUIBindingButton), "get_Selected", true), get_Selected);
...
private static bool get_Selected(Func<BossDoorChallengeUIBindingButton, bool> orig, BossDoorChallengeUIBindingButton self)
{
...
private static void Awake(On.BossDoorChallengeUIBindingButton.orig_Awake orig,BossDoorChallengeUIBindingButton self)
{
...
private static void Reset(On.BossDoorChallengeUIBindingButton.orig_Reset orig,BossDoorChallengeUIBindingButton self)
{
...
private static void OnDisable(On.BossDoorChallengeUIBindingButton.orig_OnDisable orig,BossDoorChallengeUIBindingButton self)
{
...
private static void OnSubmit(On.BossDoorChallengeUIBindingButton.orig_OnSubmit orig,BossDoorChallengeUIBindingButton self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
private static void SetAllSelected(On.BossDoorChallengeUIBindingButton.orig_SetAllSelected orig,BossDoorChallengeUIBindingButton self,  bool value)
{
...
private static System.Collections.IEnumerator SetAnimSizeDelayed(On.BossDoorChallengeUIBindingButton.orig_SetAnimSizeDelayed orig,BossDoorChallengeUIBindingButton self,  string anim,  float normalizedTime)
{
...
{
foreach (Delegates.SetAnimSizeDelayed_BeforeArgs toInvoke in _beforeSetAnimSizeDelayed.GetInvocationList())
{
try
{
...
private static void OnCancel(On.BossDoorChallengeUIBindingButton.orig_OnCancel orig,BossDoorChallengeUIBindingButton self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
private static void OnPointerClick(On.BossDoorChallengeUIBindingButton.orig_OnPointerClick orig,BossDoorChallengeUIBindingButton self,  UnityEngine.EventSystems.PointerEventData eventData)
{
...
public delegate bool get_Selected_WithArgs (Func<BossDoorChallengeUIBindingButton, bool> orig, BossDoorChallengeUIBindingButton self);
...
public delegate void Awake_WithArgs (Action<BossDoorChallengeUIBindingButton> orig, BossDoorChallengeUIBindingButton self);
...
public delegate void Reset_WithArgs (Action<BossDoorChallengeUIBindingButton> orig, BossDoorChallengeUIBindingButton self);
...
public delegate void OnDisable_WithArgs (Action<BossDoorChallengeUIBindingButton> orig, BossDoorChallengeUIBindingButton self);
...
public delegate void OnSubmit_WithArgs (Action<BossDoorChallengeUIBindingButton,  UnityEngine.EventSystems.BaseEventData> orig, BossDoorChallengeUIBindingButton self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void SetAllSelected_WithArgs (Action<BossDoorChallengeUIBindingButton,  bool> orig, BossDoorChallengeUIBindingButton self,  bool value);
...
public delegate System.Collections.IEnumerator SetAnimSizeDelayed_AfterArgs(Params_SetAnimSizeDelayed args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator SetAnimSizeDelayed_WithArgs (Func<BossDoorChallengeUIBindingButton,  string,  float, System.Collections.IEnumerator> orig, BossDoorChallengeUIBindingButton self,  string anim,  float normalizedTime);
...
public delegate void OnCancel_WithArgs (Action<BossDoorChallengeUIBindingButton,  UnityEngine.EventSystems.BaseEventData> orig, BossDoorChallengeUIBindingButton self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void OnPointerClick_WithArgs (Action<BossDoorChallengeUIBindingButton,  UnityEngine.EventSystems.PointerEventData> orig, BossDoorChallengeUIBindingButton self,  UnityEngine.EventSystems.PointerEventData eventData);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Selected_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeUIBindingButton), "get_Selected", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Selected_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeUIBindingButton), "get_Selected", true), value);
}
