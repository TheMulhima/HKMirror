...
public static class OnTk2dTextMeshSetScale
{
    ...
    public static class Delegates
    {
        ...
        public delegate void _getTextMesh_WithArgs(Action<Tk2dTextMeshSetScale> orig, Tk2dTextMeshSetScale self);
        ...
        public delegate void DoSetScale_WithArgs(Action<Tk2dTextMeshSetScale> orig, Tk2dTextMeshSetScale self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<Tk2dTextMeshSetScale> orig, Tk2dTextMeshSetScale self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<Tk2dTextMeshSetScale> orig, Tk2dTextMeshSetScale self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Tk2dTextMeshSetScale> orig, Tk2dTextMeshSetScale self);
