...
public static class OnLogitechG920RacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechG920RacingWheelMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechG920RacingWheelMacNativeProfile> orig,
            LogitechG920RacingWheelMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechG920RacingWheelMacNativeProfile> orig,
            LogitechG920RacingWheelMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechG920RacingWheelMacNativeProfile self;
        }
    }
