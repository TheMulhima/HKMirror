...
public static class OnLogitechG920RacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.LogitechG920RacingWheelMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.LogitechG920RacingWheelMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechG920RacingWheelMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.LogitechG920RacingWheelMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechG920RacingWheelMacNativeProfile self);
    }
