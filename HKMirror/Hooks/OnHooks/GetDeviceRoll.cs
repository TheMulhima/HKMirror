...
public static class OnGetDeviceRoll
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceRoll), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceRoll), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceRoll), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self)
        {
        ...
        internal static void HookDoGetDeviceRoll()
        {
            if (!HookedList.Contains("DoGetDeviceRoll"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceRoll),
                        "DoGetDeviceRoll", true), DoGetDeviceRoll);
            }
        }
        ...
        private static void DoGetDeviceRoll(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self);
        ...
        public delegate void DoGetDeviceRoll_WithArgs(Action<HutongGames.PlayMaker.Actions.GetDeviceRoll> orig,
            HutongGames.PlayMaker.Actions.GetDeviceRoll self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceRoll), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceRoll), "OnUpdate", true),
                value);
        ...
        public static event Delegates.DoGetDeviceRoll_WithArgs DoGetDeviceRoll
        {
            add => HookEndpointManager.Add<Delegates.DoGetDeviceRoll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetDeviceRoll), "DoGetDeviceRoll",
                    true), value);
