...
public static class OnMogaHeroPowerAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MogaHeroPowerAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MogaHeroPowerAndroidUnityProfile> orig, MogaHeroPowerAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MogaHeroPowerAndroidUnityProfile> orig,
            MogaHeroPowerAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public MogaHeroPowerAndroidUnityProfile self;
        }
    }
