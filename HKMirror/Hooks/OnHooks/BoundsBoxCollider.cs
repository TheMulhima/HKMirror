...
public static class OnBoundsBoxCollider
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoundsBoxCollider), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self)
        {
        ...
        internal static void HookGetEm()
        {
            if (!HookedList.Contains("GetEm"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoundsBoxCollider), "GetEm",
                        true), GetEm);
            }
        }
        ...
        private static void GetEm(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoundsBoxCollider), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoundsBoxCollider), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self);
        ...
        public delegate void GetEm_WithArgs(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.BoundsBoxCollider> orig,
            HutongGames.PlayMaker.Actions.BoundsBoxCollider self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoundsBoxCollider), "Reset", true),
                value);
        ...
        public static event Delegates.GetEm_WithArgs GetEm
        {
            add => HookEndpointManager.Add<Delegates.GetEm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoundsBoxCollider), "GetEm", true),
                value);
