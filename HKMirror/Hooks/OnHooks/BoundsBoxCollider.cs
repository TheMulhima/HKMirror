...
public static class OnBoundsBoxCollider
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<BoundsBoxCollider> orig, BoundsBoxCollider self)
        {
        ...
        internal static void HookGetEm()
        {
            if (!HookedList.Contains("GetEm"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "GetEm"), GetEm);
            }
        }
        ...
        private static void GetEm(Action<BoundsBoxCollider> orig, BoundsBoxCollider self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<BoundsBoxCollider> orig, BoundsBoxCollider self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<BoundsBoxCollider> orig, BoundsBoxCollider self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void GetEm_WithArgs(Action<BoundsBoxCollider> orig, BoundsBoxCollider self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<BoundsBoxCollider> orig, BoundsBoxCollider self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<BoundsBoxCollider> orig, BoundsBoxCollider self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<BoundsBoxCollider> orig, BoundsBoxCollider self);

        public sealed class Params_Reset
        {
            public BoundsBoxCollider self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "Reset"), value);
        ...
        public static event Delegates.GetEm_WithArgs GetEm
        {
            add => HookEndpointManager.Add<Delegates.GetEm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "GetEm"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BoundsBoxCollider), "OnUpdate"), value);
