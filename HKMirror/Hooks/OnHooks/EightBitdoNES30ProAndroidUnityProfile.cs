...
public static class OnEightBitdoNES30ProAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoNES30ProAndroidUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoNES30ProAndroidUnityProfile> orig,
            EightBitdoNES30ProAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoNES30ProAndroidUnityProfile> orig,
            EightBitdoNES30ProAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoNES30ProAndroidUnityProfile self;
        }
    }
