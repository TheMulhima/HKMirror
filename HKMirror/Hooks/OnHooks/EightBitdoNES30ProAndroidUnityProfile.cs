...
public static class OnEightBitdoNES30ProAndroidUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.EightBitdoNES30ProAndroidUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.EightBitdoNES30ProAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.EightBitdoNES30ProAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.EightBitdoNES30ProAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.EightBitdoNES30ProAndroidUnityProfile self);
    }
