...
public static class OnXboxOneMacSafariUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneMacSafariUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneMacSafariUnityProfile> orig, XboxOneMacSafariUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneMacSafariUnityProfile> orig,
            XboxOneMacSafariUnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneMacSafariUnityProfile self;
        }
    }
