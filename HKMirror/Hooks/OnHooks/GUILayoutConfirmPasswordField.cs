...
public static class OnGUILayoutConfirmPasswordField
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutConfirmPasswordField), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GUILayoutConfirmPasswordField> orig, GUILayoutConfirmPasswordField self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutConfirmPasswordField), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUILayoutConfirmPasswordField> orig, GUILayoutConfirmPasswordField self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUILayoutConfirmPasswordField> orig,
            GUILayoutConfirmPasswordField self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GUILayoutConfirmPasswordField> orig,
            GUILayoutConfirmPasswordField self);

        public sealed class Params_Reset
        {
            public GUILayoutConfirmPasswordField self;
        }
