...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Microsoft.Xbox.GameSaveLoadedArgs), "get_Data", true), get_Data);
...
private static byte[] get_Data(Func<Microsoft.Xbox.GameSaveLoadedArgs, byte[]> orig, Microsoft.Xbox.GameSaveLoadedArgs self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Microsoft.Xbox.GameSaveLoadedArgs), "set_Data", true), set_Data);
...
private static void set_Data(Action<Microsoft.Xbox.GameSaveLoadedArgs,  byte[]> orig, Microsoft.Xbox.GameSaveLoadedArgs self,  byte[] value)
{
...
public delegate byte[] get_Data_WithArgs (Func<Microsoft.Xbox.GameSaveLoadedArgs, byte[]> orig, Microsoft.Xbox.GameSaveLoadedArgs self);
...
public delegate void set_Data_WithArgs (Action<Microsoft.Xbox.GameSaveLoadedArgs,  byte[]> orig, Microsoft.Xbox.GameSaveLoadedArgs self,  byte[] value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Data_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Microsoft.Xbox.GameSaveLoadedArgs), "get_Data", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Data_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Microsoft.Xbox.GameSaveLoadedArgs), "get_Data", true), value);
}
public static event Delegates.set_Data_WithArgs set_Data
{
add => HookEndpointManager.Add<Delegates.set_Data_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Microsoft.Xbox.GameSaveLoadedArgs), "set_Data", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Data_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Microsoft.Xbox.GameSaveLoadedArgs), "set_Data", true), value);
}
}
