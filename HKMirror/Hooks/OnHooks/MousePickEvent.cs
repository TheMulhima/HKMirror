...
public static class OnMousePickEvent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self)
        {
        ...
        internal static void HookDoMousePickEvent()
        {
            if (!HookedList.Contains("DoMousePickEvent"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent),
        ...
        private static void DoMousePickEvent(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self)
        {
        ...
        internal static void HookDoRaycast()
        {
            if (!HookedList.Contains("DoRaycast"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "DoRaycast",
                        true), DoRaycast);
            }
        }
        ...
        private static bool DoRaycast(Func<HutongGames.PlayMaker.Actions.MousePickEvent, bool> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.MousePickEvent, string> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self);
        ...
        public delegate void DoMousePickEvent_WithArgs(Action<HutongGames.PlayMaker.Actions.MousePickEvent> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self);
        ...
        public delegate bool DoRaycast_WithArgs(Func<HutongGames.PlayMaker.Actions.MousePickEvent, bool> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.MousePickEvent, string> orig,
            HutongGames.PlayMaker.Actions.MousePickEvent self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "OnUpdate", true),
                value);
        ...
        public static event Delegates.DoMousePickEvent_WithArgs DoMousePickEvent
        {
            add => HookEndpointManager.Add<Delegates.DoMousePickEvent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "DoMousePickEvent",
                    true), value);
        ...
        public static event Delegates.DoRaycast_WithArgs DoRaycast
        {
            add => HookEndpointManager.Add<Delegates.DoRaycast_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MousePickEvent), "DoRaycast", true),
                value);
