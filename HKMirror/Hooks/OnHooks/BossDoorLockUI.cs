...
public static class OnBossDoorLockUI
{
    internal static class HookHandler
    {
        ...
        private static IEnumerator ShowRoutine(On.BossDoorLockUI.orig_ShowRoutine orig, BossDoorLockUI self)
        {
        ...
        private static IEnumerator HideRoutine(On.BossDoorLockUI.orig_HideRoutine orig, BossDoorLockUI self)
        {
        ...
        private static IEnumerator FadeButtonPrompts(On.BossDoorLockUI.orig_FadeButtonPrompts orig, BossDoorLockUI self,
            float toAlpha, float time)
        {
            Delegates.Params_FadeButtonPrompts @params = new()
            {
                self = self, toAlpha = toAlpha, time = time
            };
            if (_beforeFadeButtonPrompts != null)
                foreach (Delegates.FadeButtonPrompts_BeforeArgs toInvoke in
                         _beforeFadeButtonPrompts.GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator FadeButtonPrompts_AfterArgs(Params_FadeButtonPrompts args, IEnumerator ret);

        public delegate void FadeButtonPrompts_BeforeArgs(Params_FadeButtonPrompts args);

        public delegate IEnumerator FadeButtonPrompts_WithArgs(Func<BossDoorLockUI, float, float, IEnumerator> orig,
            BossDoorLockUI self, float toAlpha, float time);
        ...
        public delegate IEnumerator HideRoutine_AfterArgs(Params_HideRoutine args, IEnumerator ret);

        public delegate void HideRoutine_BeforeArgs(Params_HideRoutine args);

        public delegate IEnumerator HideRoutine_WithArgs(Func<BossDoorLockUI, IEnumerator> orig, BossDoorLockUI self);

        public delegate void Show_AfterArgs(Params_Show args);

        public delegate void Show_BeforeArgs(Params_Show args);

        public delegate void Show_WithArgs(Action<BossDoorLockUI, BossSequenceDoor> orig, BossDoorLockUI self,
        ...
        public delegate IEnumerator ShowRoutine_WithArgs(Func<BossDoorLockUI, IEnumerator> orig, BossDoorLockUI self);
