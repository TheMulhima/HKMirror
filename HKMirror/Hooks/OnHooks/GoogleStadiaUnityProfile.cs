...
public static class OnGoogleStadiaUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GoogleStadiaUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GoogleStadiaUnityProfile> orig, GoogleStadiaUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GoogleStadiaUnityProfile> orig, GoogleStadiaUnityProfile self);

        public sealed class Params_Define
        {
            public GoogleStadiaUnityProfile self;
        }
    }
