...
public static class OnGetQuaternionMultipliedByQuaternion
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion> orig,
            HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion> orig,
            HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion> orig,
            HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "OnLateUpdate",
                        true), OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion> orig,
            HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(
            Action<HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion> orig,
            HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion self)
        {
        ...
        internal static void HookDoQuatMult()
        {
            if (!HookedList.Contains("DoQuatMult"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "DoQuatMult", true),
                    DoQuatMult);
            }
        }
        ...
        private static void DoQuatMult(Action<HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion> orig,
            HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "Reset", true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "OnEnter", true), value);
        ...
        public static event Delegates.OnLateUpdate_WithArgs OnLateUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnLateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "OnLateUpdate", true),
                value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.GetQuaternionMultipliedByQuaternion), "OnFixedUpdate", true),
                value);
