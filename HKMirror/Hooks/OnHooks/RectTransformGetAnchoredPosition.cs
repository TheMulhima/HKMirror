...
public static class OnRectTransformGetAnchoredPosition
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition), "OnActionUpdate", true),
                    OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition self)
        {
        ...
        internal static void HookDoGetValues()
        {
            if (!HookedList.Contains("DoGetValues"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition), "DoGetValues", true),
                    DoGetValues);
            }
        }
        ...
        private static void DoGetValues(Action<HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition self);
        ...
        public delegate void OnEnter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition self);
        ...
        public delegate void DoGetValues_WithArgs(
            Action<HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformGetAnchoredPosition),
                    "Reset", true), value);
