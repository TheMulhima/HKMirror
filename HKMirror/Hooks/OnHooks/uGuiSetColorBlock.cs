...
public static class OnuGuiSetColorBlock
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock),
                        "DoSetValue", true), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self);
        ...
        public delegate void DoSetValue_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSetColorBlock> orig,
            HutongGames.PlayMaker.Actions.uGuiSetColorBlock self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock), "Reset", true),
                value);
        ...
        public static event Delegates.DoSetValue_WithArgs DoSetValue
        {
            add => HookEndpointManager.Add<Delegates.DoSetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock), "DoSetValue",
                    true), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSetColorBlock), "OnExit", true),
                value);
