...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "Invoke", true), Invoke);
...
private static int Invoke(Func<Modding.Delegates.TakeDamageProxy,  int,  int, int> orig, Modding.Delegates.TakeDamageProxy self,  int hazardType,  int damage)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "EndInvoke", true), EndInvoke);
...
private static int EndInvoke(Func<Modding.Delegates.TakeDamageProxy,  int,  System.IAsyncResult, int> orig, Modding.Delegates.TakeDamageProxy self,  int hazardType,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.TakeDamageProxy self;
...
public delegate int Invoke_WithArgs (Func<Modding.Delegates.TakeDamageProxy,  int,  int, int> orig, Modding.Delegates.TakeDamageProxy self,  int hazardType,  int damage);
...
public delegate int EndInvoke_WithArgs (Func<Modding.Delegates.TakeDamageProxy,  int,  System.IAsyncResult, int> orig, Modding.Delegates.TakeDamageProxy self,  int hazardType,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "EndInvoke", true), value);
}
}
