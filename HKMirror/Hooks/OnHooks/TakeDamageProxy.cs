...
public static class OnTakeDamageProxy
{
    ...
    public static class Delegates
    {
        ...
        public delegate int EndInvoke_WithArgs(Func<TakeDamageProxy, int, IAsyncResult, int> orig, TakeDamageProxy self,
            int hazardType, IAsyncResult result);
        ...
        public delegate int Invoke_WithArgs(Func<TakeDamageProxy, int, int, int> orig, TakeDamageProxy self,
            int hazardType, int damage);
