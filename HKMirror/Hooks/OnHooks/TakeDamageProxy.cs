...
public static class OnTakeDamageProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static int Invoke(Func<Modding.Delegates.TakeDamageProxy, int, int, int> orig,
            Modding.Delegates.TakeDamageProxy self, int hazardType, int damage)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static int EndInvoke(Func<Modding.Delegates.TakeDamageProxy, int, System.IAsyncResult, int> orig,
            Modding.Delegates.TakeDamageProxy self, int hazardType, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate int Invoke_WithArgs(Func<Modding.Delegates.TakeDamageProxy, int, int, int> orig,
            Modding.Delegates.TakeDamageProxy self, int hazardType, int damage);
        ...
        public delegate int EndInvoke_WithArgs(
            Func<Modding.Delegates.TakeDamageProxy, int, System.IAsyncResult, int> orig,
            Modding.Delegates.TakeDamageProxy self, int hazardType, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeDamageProxy), "EndInvoke", true), value);
