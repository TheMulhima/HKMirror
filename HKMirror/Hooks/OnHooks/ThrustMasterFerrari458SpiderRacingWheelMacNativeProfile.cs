...
public static class OnThrustMasterFerrari458SpiderRacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile self)
        {
