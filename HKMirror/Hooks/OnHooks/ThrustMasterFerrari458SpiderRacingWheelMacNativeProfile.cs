...
public static class OnThrustMasterFerrari458SpiderRacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile),
                        "Define"), Define);
            }
        }
        ...
        private static void Define(Action<ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile> orig,
            ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile> orig,
            ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile self);

        public sealed class Params_Define
        {
            public ThrustMasterFerrari458SpiderRacingWheelMacNativeProfile self;
        }
    }
