...
public static class OnLogitechF710ModeXWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710ModeXWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710ModeXWindowsNativeProfile> orig,
            LogitechF710ModeXWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710ModeXWindowsNativeProfile> orig,
            LogitechF710ModeXWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF710ModeXWindowsNativeProfile self;
        }
    }
