...
public static class OnBigCentipede
{
    ...
    public static class Delegates
    {
        ...
        public delegate Vector2 get_Direction_AfterArgs(Params_get_Direction args, Vector2 ret);

        public delegate void get_Direction_BeforeArgs(Params_get_Direction args);

        public delegate Vector2 get_Direction_WithArgs(Func<BigCentipede, Vector2> orig, BigCentipede self);

        public delegate Vector2 get_EntryPoint_AfterArgs(Params_get_EntryPoint args, Vector2 ret);

        public delegate void get_EntryPoint_BeforeArgs(Params_get_EntryPoint args);

        public delegate Vector2 get_EntryPoint_WithArgs(Func<BigCentipede, Vector2> orig, BigCentipede self);

        public delegate Vector2 get_ExitPoint_AfterArgs(Params_get_ExitPoint args, Vector2 ret);

        public delegate void get_ExitPoint_BeforeArgs(Params_get_ExitPoint args);

        public delegate Vector2 get_ExitPoint_WithArgs(Func<BigCentipede, Vector2> orig, BigCentipede self);
