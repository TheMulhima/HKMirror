...
public static class OnTk2dSpriteSetId
{
    internal static class HookHandler
    {
        ...
        internal static void Hook_getSprite()
        {
            if (!HookedList.Contains("_getSprite"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "_getSprite"), _getSprite);
            }
        }
        ...
        private static void _getSprite(Action<Tk2dSpriteSetId> orig, Tk2dSpriteSetId self)
        {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<Tk2dSpriteSetId> orig, Tk2dSpriteSetId self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Tk2dSpriteSetId> orig, Tk2dSpriteSetId self)
        {
        ...
        internal static void HookDoSetSpriteID()
        {
            if (!HookedList.Contains("DoSetSpriteID"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "DoSetSpriteID"), DoSetSpriteID);
            }
        }

        internal static event Delegates.DoSetSpriteID_BeforeArgs _beforeDoSetSpriteID;
        internal static event Delegates.DoSetSpriteID_NormalArgs _afterDoSetSpriteID;

        private static void DoSetSpriteID(Action<Tk2dSpriteSetId> orig, Tk2dSpriteSetId self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterDoSetSpriteID != null) _afterDoSetSpriteID.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetSpriteID_NormalArgs(Params_DoSetSpriteID args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.DoSetSpriteID_NormalArgs DoSetSpriteID
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates._getSprite_NormalArgs _getSprite
        {
            add => HookEndpointManager.Add<Delegates._getSprite_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "_getSprite"), value);
        ...
        public static event Delegates.Reset_NormalArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "Reset"), value);
        ...
        public static event Delegates.OnEnter_NormalArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "OnEnter"), value);
        ...
        public static event Delegates.DoSetSpriteID_NormalArgs DoSetSpriteID
        {
            add => HookEndpointManager.Add<Delegates.DoSetSpriteID_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "DoSetSpriteID"), value);
            remove => HookEndpointManager.Remove<Delegates.DoSetSpriteID_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSpriteSetId), "DoSetSpriteID"), value);
        }
    }
}