...
public static class OnLogitechF310ControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.LogitechF310ControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.LogitechF310ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechF310ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.LogitechF310ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechF310ControllerMacNativeProfile self);
    }
