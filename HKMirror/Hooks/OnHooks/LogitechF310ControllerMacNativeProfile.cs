...
public static class OnLogitechF310ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310ControllerMacNativeProfile> orig,
            LogitechF310ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310ControllerMacNativeProfile> orig,
            LogitechF310ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF310ControllerMacNativeProfile self;
        }
    }
