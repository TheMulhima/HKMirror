...
private static void iTweenOnStart(On.iTweenFSMEvents.orig_iTweenOnStart orig,iTweenFSMEvents self,  int aniTweenID)
{
Delegates.Params_iTweenOnStart @params = new() 
{
self = self
, aniTweenID = aniTweenID
};
...
private static void iTweenOnComplete(On.iTweenFSMEvents.orig_iTweenOnComplete orig,iTweenFSMEvents self,  int aniTweenID)
{
...
public delegate void iTweenOnStart_WithArgs (Action<iTweenFSMEvents,  int> orig, iTweenFSMEvents self,  int aniTweenID);
...
public delegate void iTweenOnComplete_WithArgs (Action<iTweenFSMEvents,  int> orig, iTweenFSMEvents self,  int aniTweenID);
}
