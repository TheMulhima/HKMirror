...
public static class OnEightBitdoNES30ProWindowsUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.EightBitdoNES30ProWindowsUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.EightBitdoNES30ProWindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.EightBitdoNES30ProWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.EightBitdoNES30ProWindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.EightBitdoNES30ProWindowsUnityProfile self);
    }
