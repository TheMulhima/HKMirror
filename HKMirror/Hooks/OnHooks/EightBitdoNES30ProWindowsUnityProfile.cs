...
public static class OnEightBitdoNES30ProWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoNES30ProWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoNES30ProWindowsUnityProfile> orig,
            EightBitdoNES30ProWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoNES30ProWindowsUnityProfile> orig,
            EightBitdoNES30ProWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoNES30ProWindowsUnityProfile self;
        }
    }
