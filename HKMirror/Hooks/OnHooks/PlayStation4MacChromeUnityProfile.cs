...
public static class OnPlayStation4MacChromeUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4MacChromeUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4MacChromeUnityProfile> orig,
            PlayStation4MacChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4MacChromeUnityProfile> orig,
            PlayStation4MacChromeUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4MacChromeUnityProfile self;
        }
    }
