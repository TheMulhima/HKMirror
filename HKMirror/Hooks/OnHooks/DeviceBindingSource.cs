...
public static class OnDeviceBindingSource
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Control()
        {
            if (!HookedList.Contains("get_Control"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_Control"), get_Control);
            }
        }
        ...
        private static InputControlType get_Control(Func<DeviceBindingSource, InputControlType> orig,
            DeviceBindingSource self)
        {
        ...
        internal static void Hookset_Control()
        {
            if (!HookedList.Contains("set_Control"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "set_Control"), set_Control);
            }
        }
        ...
        private static void set_Control(Action<DeviceBindingSource, InputControlType> orig, DeviceBindingSource self,
        ...
        internal static void HookGetValue()
        {
            if (!HookedList.Contains("GetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "GetValue"), GetValue);
            }
        }
        ...
        private static float GetValue(Func<DeviceBindingSource, InputDevice, float> orig, DeviceBindingSource self,
        ...
        internal static void HookGetState()
        {
            if (!HookedList.Contains("GetState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "GetState"), GetState);
            }
        }
        ...
        private static bool GetState(Func<DeviceBindingSource, InputDevice, bool> orig, DeviceBindingSource self,
            InputDevice inputDevice)
        {
        ...
        internal static void Hookget_Name()
        {
            if (!HookedList.Contains("get_Name"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_Name"), get_Name);
            }
        }
        ...
        private static string get_Name(Func<DeviceBindingSource, string> orig, DeviceBindingSource self)
        {
        ...
        internal static void Hookget_DeviceName()
        {
            if (!HookedList.Contains("get_DeviceName"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_DeviceName"), get_DeviceName);
            }
        }
        ...
        private static string get_DeviceName(Func<DeviceBindingSource, string> orig, DeviceBindingSource self)
        {
        ...
        internal static void Hookget_DeviceClass()
        {
            if (!HookedList.Contains("get_DeviceClass"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_DeviceClass"),
                    get_DeviceClass);
            }
        }
        ...
        private static InputDeviceClass get_DeviceClass(Func<DeviceBindingSource, InputDeviceClass> orig,
            DeviceBindingSource self)
        {
        ...
        internal static void Hookget_DeviceStyle()
        {
            if (!HookedList.Contains("get_DeviceStyle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_DeviceStyle"),
                    get_DeviceStyle);
            }
        }
        ...
        private static InputDeviceStyle get_DeviceStyle(Func<DeviceBindingSource, InputDeviceStyle> orig,
            DeviceBindingSource self)
        {
        ...
        internal static void HookEquals_BindingSource()
        {
            if (!HookedList.Contains("Equals_BindingSource"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "Equals_BindingSource"),
        ...
        private static bool Equals_BindingSource(Func<DeviceBindingSource, BindingSource, bool> orig,
            DeviceBindingSource self, BindingSource other)
        {
        ...
        internal static void HookEquals_Object()
        {
            if (!HookedList.Contains("Equals_Object"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "Equals_Object"), Equals_Object);
            }
        }
        ...
        private static bool Equals_Object(Func<DeviceBindingSource, object, bool> orig, DeviceBindingSource self,
            object other)
        {
        ...
        internal static void Hookget_BindingSourceType()
        {
            if (!HookedList.Contains("get_BindingSourceType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_BindingSourceType"),
        ...
        private static BindingSourceType get_BindingSourceType(Func<DeviceBindingSource, BindingSourceType> orig,
            DeviceBindingSource self)
        {
        ...
        internal static void HookSave()
        {
            ...
            {
                HookedList.Add("Save");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "Save"), Save);
            }
        }
        ...
        private static void Save(Action<DeviceBindingSource, BinaryWriter> orig, DeviceBindingSource self,
            BinaryWriter writer)
        {
        ...
        internal static void HookLoad()
        {
            ...
            {
                HookedList.Add("Load");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "Load"), Load);
            }
        }
        ...
        private static void Load(Action<DeviceBindingSource, BinaryReader, ushort> orig, DeviceBindingSource self,
        ...
        internal static void Hookget_IsValid()
        {
            if (!HookedList.Contains("get_IsValid"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_IsValid"), get_IsValid);
            }
        }
        ...
        private static bool get_IsValid(Func<DeviceBindingSource, bool> orig, DeviceBindingSource self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate bool Equals_BindingSource_WithArgs(Func<DeviceBindingSource, BindingSource, bool> orig,
            DeviceBindingSource self, BindingSource other);
        ...
        public delegate bool Equals_Object_WithArgs(Func<DeviceBindingSource, object, bool> orig,
            DeviceBindingSource self, object other);
        ...
        public delegate BindingSourceType get_BindingSourceType_WithArgs(
            Func<DeviceBindingSource, BindingSourceType> orig, DeviceBindingSource self);

        public delegate InputControlType get_Control_AfterArgs(Params_get_Control args, InputControlType ret);

        public delegate void get_Control_BeforeArgs(Params_get_Control args);

        public delegate InputControlType get_Control_WithArgs(Func<DeviceBindingSource, InputControlType> orig,
            DeviceBindingSource self);
        ...
        public delegate InputDeviceClass get_DeviceClass_WithArgs(Func<DeviceBindingSource, InputDeviceClass> orig,
            DeviceBindingSource self);
        ...
        public delegate string
            get_DeviceName_WithArgs(Func<DeviceBindingSource, string> orig, DeviceBindingSource self);
        ...
        public delegate InputDeviceStyle get_DeviceStyle_WithArgs(Func<DeviceBindingSource, InputDeviceStyle> orig,
            DeviceBindingSource self);
        ...
        public delegate bool get_IsValid_WithArgs(Func<DeviceBindingSource, bool> orig, DeviceBindingSource self);
        ...
        public delegate string get_Name_WithArgs(Func<DeviceBindingSource, string> orig, DeviceBindingSource self);
        ...
        public delegate bool GetState_WithArgs(Func<DeviceBindingSource, InputDevice, bool> orig,
            DeviceBindingSource self, InputDevice inputDevice);
        ...
        public delegate float GetValue_WithArgs(Func<DeviceBindingSource, InputDevice, float> orig,
            DeviceBindingSource self, InputDevice inputDevice);
        ...
        public delegate void Load_WithArgs(Action<DeviceBindingSource, BinaryReader, ushort> orig,
            DeviceBindingSource self, BinaryReader reader, ushort dataFormatVersion);

        public delegate void Save_AfterArgs(Params_Save args);

        public delegate void Save_BeforeArgs(Params_Save args);

        public delegate void Save_WithArgs(Action<DeviceBindingSource, BinaryWriter> orig, DeviceBindingSource self,
            BinaryWriter writer);
        ...
        public delegate void set_Control_WithArgs(Action<DeviceBindingSource, InputControlType> orig,
            DeviceBindingSource self, InputControlType value);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.GetValue_WithArgs GetValue
        {
            add => HookEndpointManager.Add<Delegates.GetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "GetValue"), value);
        ...
        public static event Delegates.GetState_WithArgs GetState
        {
            add => HookEndpointManager.Add<Delegates.GetState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "GetState"), value);
        ...
        public static event Delegates.get_Name_WithArgs get_Name
        {
            add => HookEndpointManager.Add<Delegates.get_Name_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "get_Name"), value);
        ...
        public static event Delegates.Save_WithArgs Save
        {
            add => HookEndpointManager.Add<Delegates.Save_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "Save"), value);
        ...
        public static event Delegates.Load_WithArgs Load
        {
            add => HookEndpointManager.Add<Delegates.Load_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DeviceBindingSource), "Load"), value);
