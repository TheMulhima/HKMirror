...
public static class OnPlayStation4MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4MacNativeProfile> orig, PlayStation4MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4MacNativeProfile> orig,
            PlayStation4MacNativeProfile self);

        public sealed class Params_Define
        {
            public PlayStation4MacNativeProfile self;
        }
    }
