...
private static float GetFontScale(On.ChangeFontByLanguage.orig_GetFontScale orig,ChangeFontByLanguage self,  string lang)
{
...
public delegate float GetFontScale_WithArgs (Func<ChangeFontByLanguage,  string, float> orig, ChangeFontByLanguage self,  string lang);
}
