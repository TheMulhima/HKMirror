...
public static class OniTweenRotateUpdate
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "DoiTween"), DoiTween);
            }
        }
        ...
        private static void DoiTween(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoiTween_WithArgs(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<iTweenRotateUpdate> orig, iTweenRotateUpdate self);

        public sealed class Params_Reset
        {
            public iTweenRotateUpdate self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "OnEnter"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "OnExit"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "OnUpdate"), value);
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenRotateUpdate), "DoiTween"), value);
