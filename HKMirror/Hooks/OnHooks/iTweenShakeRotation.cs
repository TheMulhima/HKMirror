...
public static class OniTweenShakeRotation
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenShakeRotation), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenShakeRotation), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenShakeRotation), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenShakeRotation),
        ...
        private static void DoiTween(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self);
        ...
        public delegate void DoiTween_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenShakeRotation> orig,
            HutongGames.PlayMaker.Actions.iTweenShakeRotation self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenShakeRotation), "DoiTween",
                    true), value);
