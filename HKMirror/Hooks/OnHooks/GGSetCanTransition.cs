...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGSetCanTransition), "set_BoolValue", true), set_BoolValue);
...
public delegate void set_BoolValue_WithArgs (Action<GGSetCanTransition,  bool> orig, GGSetCanTransition self,  bool value);
}
...
{
add => HookEndpointManager.Add<Delegates.set_BoolValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGSetCanTransition), "set_BoolValue", true), value);
remove => HookEndpointManager.Remove<Delegates.set_BoolValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGSetCanTransition), "set_BoolValue", true), value);
}
}
