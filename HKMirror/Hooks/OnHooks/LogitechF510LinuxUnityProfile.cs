...
public static class OnLogitechF510LinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510LinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510LinuxUnityProfile> orig, LogitechF510LinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510LinuxUnityProfile> orig,
            LogitechF510LinuxUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF510LinuxUnityProfile self;
        }
    }
