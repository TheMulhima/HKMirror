...
public static class OnTMP_StyleSheet
{
    ...
    {
        public delegate TMP_StyleSheet get_instance_AfterArgs(TMP_StyleSheet ret);

        public delegate void get_instance_BeforeArgs();

        public delegate TMP_StyleSheet get_instance_WithArgs(Func<TMP_StyleSheet> orig);

        public delegate TMP_Style GetStyle_AfterArgs(Params_GetStyle args, TMP_Style ret);

        public delegate void GetStyle_BeforeArgs(Params_GetStyle args);

        public delegate TMP_Style GetStyle_WithArgs(Func<int, TMP_Style> orig, int hashCode);

        public delegate TMP_Style GetStyleInternal_AfterArgs(Params_GetStyleInternal args, TMP_Style ret);

        public delegate void GetStyleInternal_BeforeArgs(Params_GetStyleInternal args);

        public delegate TMP_Style GetStyleInternal_WithArgs(Func<TMP_StyleSheet, int, TMP_Style> orig,
            TMP_StyleSheet self, int hashCode);

        public delegate TMP_StyleSheet LoadDefaultStyleSheet_AfterArgs(TMP_StyleSheet ret);

        public delegate void LoadDefaultStyleSheet_BeforeArgs();

        public delegate TMP_StyleSheet LoadDefaultStyleSheet_WithArgs(Func<TMP_StyleSheet> orig);
        ...
        public delegate void LoadStyleDictionaryInternal_WithArgs(Action<TMP_StyleSheet> orig, TMP_StyleSheet self);
        ...
        public delegate void UpdateStyleDictionaryKey_WithArgs(Action<TMP_StyleSheet, int, int> orig,
            TMP_StyleSheet self, int old_key, int new_key);
