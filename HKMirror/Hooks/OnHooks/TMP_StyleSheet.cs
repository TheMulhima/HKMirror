...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "get_instance", false), get_instance);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "LoadDefaultStyleSheet", false), LoadDefaultStyleSheet);
...
{
foreach (Delegates.LoadDefaultStyleSheet_BeforeArgs toInvoke in _beforeLoadDefaultStyleSheet.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadDefaultStyleSheet_AfterArgs toInvoke in _afterLoadDefaultStyleSheet.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "GetStyleInternal", true), GetStyleInternal);
...
private static TMPro.TMP_Style GetStyleInternal(Func<TMPro.TMP_StyleSheet,  int, TMPro.TMP_Style> orig, TMPro.TMP_StyleSheet self,  int hashCode)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "UpdateStyleDictionaryKey", true), UpdateStyleDictionaryKey);
...
private static void UpdateStyleDictionaryKey(Action<TMPro.TMP_StyleSheet,  int,  int> orig, TMPro.TMP_StyleSheet self,  int old_key,  int new_key)
{
...
{
foreach (Delegates.UpdateStyleDictionaryKey_BeforeArgs toInvoke in _beforeUpdateStyleDictionaryKey.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateStyleDictionaryKey_AfterArgs toInvoke in _afterUpdateStyleDictionaryKey.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "RefreshStyles", false), RefreshStyles);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "LoadStyleDictionaryInternal", true), LoadStyleDictionaryInternal);
...
{
foreach (Delegates.LoadStyleDictionaryInternal_BeforeArgs toInvoke in _beforeLoadStyleDictionaryInternal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadStyleDictionaryInternal_AfterArgs toInvoke in _afterLoadStyleDictionaryInternal.GetInvocationList())
{
try
{
...
public delegate TMPro.TMP_Style GetStyleInternal_WithArgs (Func<TMPro.TMP_StyleSheet,  int, TMPro.TMP_Style> orig, TMPro.TMP_StyleSheet self,  int hashCode);
...
public delegate void UpdateStyleDictionaryKey_WithArgs (Action<TMPro.TMP_StyleSheet,  int,  int> orig, TMPro.TMP_StyleSheet self,  int old_key,  int new_key);
...
public delegate void LoadStyleDictionaryInternal_WithArgs (Action<TMPro.TMP_StyleSheet> orig, TMPro.TMP_StyleSheet self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "get_instance", false), value);
}
public static event Delegates.LoadDefaultStyleSheet_WithArgs LoadDefaultStyleSheet
{
add => HookEndpointManager.Add<Delegates.LoadDefaultStyleSheet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "LoadDefaultStyleSheet", false), value);
remove => HookEndpointManager.Remove<Delegates.LoadDefaultStyleSheet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "LoadDefaultStyleSheet", false), value);
}
public static event Delegates.GetStyle_WithArgs GetStyle
{
add => HookEndpointManager.Add<Delegates.GetStyle_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "GetStyle", false), value);
remove => HookEndpointManager.Remove<Delegates.GetStyle_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "GetStyle", false), value);
}
public static event Delegates.GetStyleInternal_WithArgs GetStyleInternal
{
add => HookEndpointManager.Add<Delegates.GetStyleInternal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "GetStyleInternal", true), value);
remove => HookEndpointManager.Remove<Delegates.GetStyleInternal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "GetStyleInternal", true), value);
}
public static event Delegates.UpdateStyleDictionaryKey_WithArgs UpdateStyleDictionaryKey
{
add => HookEndpointManager.Add<Delegates.UpdateStyleDictionaryKey_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "UpdateStyleDictionaryKey", true), value);
remove => HookEndpointManager.Remove<Delegates.UpdateStyleDictionaryKey_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "UpdateStyleDictionaryKey", true), value);
}
public static event Delegates.RefreshStyles_WithArgs RefreshStyles
{
add => HookEndpointManager.Add<Delegates.RefreshStyles_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "RefreshStyles", false), value);
remove => HookEndpointManager.Remove<Delegates.RefreshStyles_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "RefreshStyles", false), value);
}
public static event Delegates.LoadStyleDictionaryInternal_WithArgs LoadStyleDictionaryInternal
{
add => HookEndpointManager.Add<Delegates.LoadStyleDictionaryInternal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "LoadStyleDictionaryInternal", true), value);
remove => HookEndpointManager.Remove<Delegates.LoadStyleDictionaryInternal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_StyleSheet), "LoadStyleDictionaryInternal", true), value);
}
}
