...
public static class OnHoriRealArcadeProVXSAMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriRealArcadeProVXSAMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriRealArcadeProVXSAMacNativeProfile> orig,
            HoriRealArcadeProVXSAMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriRealArcadeProVXSAMacNativeProfile> orig,
            HoriRealArcadeProVXSAMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriRealArcadeProVXSAMacNativeProfile self;
        }
    }
