...
public static class Ontk2dButton
{
    ...
    {
        public delegate IEnumerator coHandleButtonPress_AfterArgs(Params_coHandleButtonPress args, IEnumerator ret);

        public delegate void coHandleButtonPress_BeforeArgs(Params_coHandleButtonPress args);

        public delegate IEnumerator coHandleButtonPress_WithArgs(Func<tk2dButton, int, IEnumerator> orig,
            tk2dButton self, int fingerId);

        public delegate IEnumerator coScale_AfterArgs(Params_coScale args, IEnumerator ret);

        public delegate void coScale_BeforeArgs(Params_coScale args);

        public delegate IEnumerator coScale_WithArgs(Func<tk2dButton, Vector3, float, float, IEnumerator> orig,
            tk2dButton self, Vector3 defaultScale, float startScale, float endScale);

        public delegate IEnumerator LocalWaitForSeconds_AfterArgs(Params_LocalWaitForSeconds args, IEnumerator ret);

        public delegate void LocalWaitForSeconds_BeforeArgs(Params_LocalWaitForSeconds args);

        public delegate IEnumerator LocalWaitForSeconds_WithArgs(Func<tk2dButton, float, IEnumerator> orig,
        ...
        public delegate void PlaySound_WithArgs(Action<tk2dButton, AudioClip> orig, tk2dButton self, AudioClip source);
