...
private static System.Collections.IEnumerator coScale(On.tk2dButton.orig_coScale orig,tk2dButton self,  UnityEngine.Vector3 defaultScale,  float startScale,  float endScale)
{
...
private static System.Collections.IEnumerator LocalWaitForSeconds(On.tk2dButton.orig_LocalWaitForSeconds orig,tk2dButton self,  float seconds)
{
...
{
foreach (Delegates.LocalWaitForSeconds_BeforeArgs toInvoke in _beforeLocalWaitForSeconds.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator coHandleButtonPress(On.tk2dButton.orig_coHandleButtonPress orig,tk2dButton self,  int fingerId)
{
...
{
foreach (Delegates.coHandleButtonPress_BeforeArgs toInvoke in _beforecoHandleButtonPress.GetInvocationList())
{
try
{
...
public delegate void PlaySound_WithArgs (Action<tk2dButton,  UnityEngine.AudioClip> orig, tk2dButton self,  UnityEngine.AudioClip source);
...
public delegate System.Collections.IEnumerator coScale_AfterArgs(Params_coScale args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator coScale_WithArgs (Func<tk2dButton,  UnityEngine.Vector3,  float,  float, System.Collections.IEnumerator> orig, tk2dButton self,  UnityEngine.Vector3 defaultScale,  float startScale,  float endScale);
...
public delegate System.Collections.IEnumerator LocalWaitForSeconds_AfterArgs(Params_LocalWaitForSeconds args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator LocalWaitForSeconds_WithArgs (Func<tk2dButton,  float, System.Collections.IEnumerator> orig, tk2dButton self,  float seconds);
...
public delegate System.Collections.IEnumerator coHandleButtonPress_AfterArgs(Params_coHandleButtonPress args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator coHandleButtonPress_WithArgs (Func<tk2dButton,  int, System.Collections.IEnumerator> orig, tk2dButton self,  int fingerId);
