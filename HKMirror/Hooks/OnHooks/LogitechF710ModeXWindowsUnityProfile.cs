...
public static class OnLogitechF710ModeXWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710ModeXWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710ModeXWindowsUnityProfile> orig,
            LogitechF710ModeXWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710ModeXWindowsUnityProfile> orig,
            LogitechF710ModeXWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF710ModeXWindowsUnityProfile self;
        }
    }
