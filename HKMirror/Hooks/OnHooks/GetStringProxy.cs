...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetStringProxy), "Invoke", true), Invoke);
...
private static string Invoke(Func<Modding.Delegates.GetStringProxy,  string,  string, string> orig, Modding.Delegates.GetStringProxy self,  string name,  string res)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetStringProxy), "EndInvoke", true), EndInvoke);
...
private static string EndInvoke(Func<Modding.Delegates.GetStringProxy,  System.IAsyncResult, string> orig, Modding.Delegates.GetStringProxy self,  System.IAsyncResult result)
{
...
public delegate string Invoke_WithArgs (Func<Modding.Delegates.GetStringProxy,  string,  string, string> orig, Modding.Delegates.GetStringProxy self,  string name,  string res);
...
public delegate string EndInvoke_WithArgs (Func<Modding.Delegates.GetStringProxy,  System.IAsyncResult, string> orig, Modding.Delegates.GetStringProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetStringProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetStringProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetStringProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetStringProxy), "EndInvoke", true), value);
}
}
