...
public static class OnPlayStation4MacUSBUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4MacUSBUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4MacUSBUnityProfile> orig, PlayStation4MacUSBUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4MacUSBUnityProfile> orig,
            PlayStation4MacUSBUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4MacUSBUnityProfile self;
        }
    }
