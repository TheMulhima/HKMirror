...
public static class OnBoolNoneTrue
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoolNoneTrue), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoolNoneTrue), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoolNoneTrue), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self)
        {
        ...
        internal static void HookDoNoneTrue()
        {
            if (!HookedList.Contains("DoNoneTrue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoolNoneTrue), "DoNoneTrue",
                        true), DoNoneTrue);
            }
        }
        ...
        private static void DoNoneTrue(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self);
        ...
        public delegate void DoNoneTrue_WithArgs(Action<HutongGames.PlayMaker.Actions.BoolNoneTrue> orig,
            HutongGames.PlayMaker.Actions.BoolNoneTrue self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoolNoneTrue), "OnUpdate", true),
                value);
        ...
        public static event Delegates.DoNoneTrue_WithArgs DoNoneTrue
        {
            add => HookEndpointManager.Add<Delegates.DoNoneTrue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.BoolNoneTrue), "DoNoneTrue", true),
                value);
