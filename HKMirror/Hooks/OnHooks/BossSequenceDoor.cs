...
public static class OnBossSequenceDoor
{
    ...
    {
        public delegate IEnumerator DoorUnlockSequence_AfterArgs(Params_DoorUnlockSequence args, IEnumerator ret);

        public delegate void DoorUnlockSequence_BeforeArgs(Params_DoorUnlockSequence args);

        public delegate IEnumerator DoorUnlockSequence_WithArgs(Func<BossSequenceDoor, IEnumerator> orig,
            BossSequenceDoor self);
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<BossSequenceDoor, Collider2D> orig, BossSequenceDoor self,
            Collider2D collision);
