...
private static void OnTriggerEnter2D(On.BossSequenceDoor.orig_OnTriggerEnter2D orig,BossSequenceDoor self,  UnityEngine.Collider2D collision)
{
...
private static System.Collections.IEnumerator DoorUnlockSequence(On.BossSequenceDoor.orig_DoorUnlockSequence orig,BossSequenceDoor self)
{
...
{
foreach (Delegates.DoorUnlockSequence_BeforeArgs toInvoke in _beforeDoorUnlockSequence.GetInvocationList())
{
try
{
...
public delegate void ShowLockUI_WithArgs (Action<BossSequenceDoor,  bool> orig, BossSequenceDoor self,  bool value);
...
public delegate void OnTriggerEnter2D_WithArgs (Action<BossSequenceDoor,  UnityEngine.Collider2D> orig, BossSequenceDoor self,  UnityEngine.Collider2D collision);
...
public delegate System.Collections.IEnumerator DoorUnlockSequence_AfterArgs(Params_DoorUnlockSequence args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DoorUnlockSequence_WithArgs (Func<BossSequenceDoor, System.Collections.IEnumerator> orig, BossSequenceDoor self);
}
