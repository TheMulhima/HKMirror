...
public static class OnHashTableCreate
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self)
        {
        ...
        internal static void HookDoAddPlayMakerHashTable()
        {
            if (!HookedList.Contains("DoAddPlayMakerHashTable"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate),
                        "DoAddPlayMakerHashTable", true), DoAddPlayMakerHashTable);
            }
        }
        ...
        private static void DoAddPlayMakerHashTable(Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self);
        ...
        public delegate void DoAddPlayMakerHashTable_WithArgs(
            Action<HutongGames.PlayMaker.Actions.HashTableCreate> orig,
            HutongGames.PlayMaker.Actions.HashTableCreate self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate), "OnExit", true),
                value);
        ...
        public static event Delegates.DoAddPlayMakerHashTable_WithArgs DoAddPlayMakerHashTable
        {
            add => HookEndpointManager.Add<Delegates.DoAddPlayMakerHashTable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableCreate),
                    "DoAddPlayMakerHashTable", true), value);
