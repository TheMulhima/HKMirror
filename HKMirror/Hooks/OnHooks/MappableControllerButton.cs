...
private static void ListenForNewButton(On.MappableControllerButton.orig_ListenForNewButton orig,MappableControllerButton self)
{
...
private static void ShowCurrentBinding(On.MappableControllerButton.orig_ShowCurrentBinding orig,MappableControllerButton self)
{
...
private static void AbortRebind(On.MappableControllerButton.orig_AbortRebind orig,MappableControllerButton self)
{
...
private static void StopActionListening(On.MappableControllerButton.orig_StopActionListening orig,MappableControllerButton self)
{
...
private static bool OnBindingFound(On.MappableControllerButton.orig_OnBindingFound orig,MappableControllerButton self,  InControl.PlayerAction action,  InControl.BindingSource binding)
{
...
private static void OnBindingAdded(On.MappableControllerButton.orig_OnBindingAdded orig,MappableControllerButton self,  InControl.PlayerAction action,  InControl.BindingSource binding)
{
...
private static void OnBindingRejected(On.MappableControllerButton.orig_OnBindingRejected orig,MappableControllerButton self,  InControl.PlayerAction action,  InControl.BindingSource binding,  InControl.BindingSourceRejectionType rejection)
{
...
private static void OnSubmit(On.MappableControllerButton.orig_OnSubmit orig,MappableControllerButton self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
private static void OnPointerClick(On.MappableControllerButton.orig_OnPointerClick orig,MappableControllerButton self,  UnityEngine.EventSystems.PointerEventData eventData)
{
...
private static void OnCancel(On.MappableControllerButton.orig_OnCancel orig,MappableControllerButton self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
private static void StopListeningForNewButton(On.MappableControllerButton.orig_StopListeningForNewButton orig,MappableControllerButton self)
{
...
{
foreach (Delegates.StopListeningForNewButton_BeforeArgs toInvoke in _beforeStopListeningForNewButton.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StopListeningForNewButton_AfterArgs toInvoke in _afterStopListeningForNewButton.GetInvocationList())
{
try
{
...
private static void SetupUnmappableButtons(On.MappableControllerButton.orig_SetupUnmappableButtons orig,MappableControllerButton self)
{
...
{
foreach (Delegates.SetupUnmappableButtons_BeforeArgs toInvoke in _beforeSetupUnmappableButtons.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupUnmappableButtons_AfterArgs toInvoke in _afterSetupUnmappableButtons.GetInvocationList())
{
try
{
...
private static void SetupBindingListenOptions(On.MappableControllerButton.orig_SetupBindingListenOptions orig,MappableControllerButton self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupUnmappableButtons", true), orig_SetupUnmappableButtons);
...
private static void orig_SetupUnmappableButtons(Action<MappableControllerButton> orig, MappableControllerButton self)
{
...
{
foreach (Delegates.orig_SetupUnmappableButtons_BeforeArgs toInvoke in _beforeorig_SetupUnmappableButtons.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_SetupUnmappableButtons_AfterArgs toInvoke in _afterorig_SetupUnmappableButtons.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "InitCustomActions", true), InitCustomActions);
...
private static void InitCustomActions(Action<MappableControllerButton,  InControl.PlayerActionSet,  InControl.PlayerAction> orig, MappableControllerButton self,  InControl.PlayerActionSet actionSet,  InControl.PlayerAction playerAction)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "OnDestroy", true), OnDestroy);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "GetBindingPublic", true), GetBindingPublic);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_GetBinding", true), orig_GetBinding);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupBindingListenOptions", true), orig_SetupBindingListenOptions);
...
private static void orig_SetupBindingListenOptions(Action<MappableControllerButton> orig, MappableControllerButton self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_ShowCurrentBinding", true), orig_ShowCurrentBinding);
...
private static void orig_ShowCurrentBinding(Action<MappableControllerButton> orig, MappableControllerButton self)
{
...
{
foreach (Delegates.orig_ShowCurrentBinding_BeforeArgs toInvoke in _beforeorig_ShowCurrentBinding.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_ShowCurrentBinding_AfterArgs toInvoke in _afterorig_ShowCurrentBinding.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupRefs", true), orig_SetupRefs);
...
public delegate void ListenForNewButton_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void ShowCurrentBinding_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void StopActionListening_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate bool OnBindingFound_WithArgs (Func<MappableControllerButton,  InControl.PlayerAction,  InControl.BindingSource, bool> orig, MappableControllerButton self,  InControl.PlayerAction action,  InControl.BindingSource binding);
...
public delegate void OnBindingAdded_WithArgs (Action<MappableControllerButton,  InControl.PlayerAction,  InControl.BindingSource> orig, MappableControllerButton self,  InControl.PlayerAction action,  InControl.BindingSource binding);
...
public delegate void OnBindingRejected_WithArgs (Action<MappableControllerButton,  InControl.PlayerAction,  InControl.BindingSource,  InControl.BindingSourceRejectionType> orig, MappableControllerButton self,  InControl.PlayerAction action,  InControl.BindingSource binding,  InControl.BindingSourceRejectionType rejection);
...
public delegate void OnSubmit_WithArgs (Action<MappableControllerButton,  UnityEngine.EventSystems.BaseEventData> orig, MappableControllerButton self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void OnPointerClick_WithArgs (Action<MappableControllerButton,  UnityEngine.EventSystems.PointerEventData> orig, MappableControllerButton self,  UnityEngine.EventSystems.PointerEventData eventData);
...
public delegate void OnCancel_WithArgs (Action<MappableControllerButton,  UnityEngine.EventSystems.BaseEventData> orig, MappableControllerButton self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void StopListeningForNewButton_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void SetupUnmappableButtons_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void SetupBindingListenOptions_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void orig_SetupUnmappableButtons_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void InitCustomActions_WithArgs (Action<MappableControllerButton,  InControl.PlayerActionSet,  InControl.PlayerAction> orig, MappableControllerButton self,  InControl.PlayerActionSet actionSet,  InControl.PlayerAction playerAction);
...
public delegate void GetBindingPublic_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void orig_GetBinding_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void orig_SetupBindingListenOptions_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void orig_ShowCurrentBinding_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
...
public delegate void orig_SetupRefs_WithArgs (Action<MappableControllerButton> orig, MappableControllerButton self);
}
...
{
add => HookEndpointManager.Add<Delegates.orig_SetupUnmappableButtons_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupUnmappableButtons", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_SetupUnmappableButtons_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupUnmappableButtons", true), value);
}
public static event Delegates.InitCustomActions_WithArgs InitCustomActions
{
add => HookEndpointManager.Add<Delegates.InitCustomActions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "InitCustomActions", true), value);
remove => HookEndpointManager.Remove<Delegates.InitCustomActions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "InitCustomActions", true), value);
}
public static event Delegates.OnDestroy_WithArgs OnDestroy
{
add => HookEndpointManager.Add<Delegates.OnDestroy_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "OnDestroy", true), value);
remove => HookEndpointManager.Remove<Delegates.OnDestroy_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "OnDestroy", true), value);
}
public static event Delegates.GetBindingPublic_WithArgs GetBindingPublic
{
add => HookEndpointManager.Add<Delegates.GetBindingPublic_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "GetBindingPublic", true), value);
remove => HookEndpointManager.Remove<Delegates.GetBindingPublic_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "GetBindingPublic", true), value);
}
public static event Delegates.orig_GetBinding_WithArgs orig_GetBinding
{
add => HookEndpointManager.Add<Delegates.orig_GetBinding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_GetBinding", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_GetBinding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_GetBinding", true), value);
}
public static event Delegates.orig_SetupBindingListenOptions_WithArgs orig_SetupBindingListenOptions
{
add => HookEndpointManager.Add<Delegates.orig_SetupBindingListenOptions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupBindingListenOptions", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_SetupBindingListenOptions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupBindingListenOptions", true), value);
}
public static event Delegates.orig_ShowCurrentBinding_WithArgs orig_ShowCurrentBinding
{
add => HookEndpointManager.Add<Delegates.orig_ShowCurrentBinding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_ShowCurrentBinding", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_ShowCurrentBinding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_ShowCurrentBinding", true), value);
}
public static event Delegates.orig_SetupRefs_WithArgs orig_SetupRefs
{
add => HookEndpointManager.Add<Delegates.orig_SetupRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupRefs", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_SetupRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableControllerButton), "orig_SetupRefs", true), value);
}
}
