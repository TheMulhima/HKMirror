...
public static class OnNintendoSwitchProWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NintendoSwitchProWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<NintendoSwitchProWindowsNativeProfile> orig,
            NintendoSwitchProWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NintendoSwitchProWindowsNativeProfile> orig,
            NintendoSwitchProWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public NintendoSwitchProWindowsNativeProfile self;
        }
    }
