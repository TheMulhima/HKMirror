...
private static void SetUnlocked(On.BossDoorLockUIIcon.orig_SetUnlocked orig,BossDoorLockUIIcon self,  bool unlocked,  bool doUnlockAnim,  int indexAnimOffset)
{
Delegates.Params_SetUnlocked @params = new() 
{
self = self
, unlocked = unlocked
, doUnlockAnim = doUnlockAnim
, indexAnimOffset = indexAnimOffset
};
...
private static System.Collections.IEnumerator PlayAnimWithDelay(On.BossDoorLockUIIcon.orig_PlayAnimWithDelay orig,BossDoorLockUIIcon self,  string anim,  bool doAnim,  float delay)
{
...
{
foreach (Delegates.PlayAnimWithDelay_BeforeArgs toInvoke in _beforePlayAnimWithDelay.GetInvocationList())
{
try
{
...
public delegate void SetUnlocked_WithArgs (Action<BossDoorLockUIIcon,  bool,  bool,  int> orig, BossDoorLockUIIcon self,  bool unlocked,  bool doUnlockAnim,  int indexAnimOffset);
...
public delegate System.Collections.IEnumerator PlayAnimWithDelay_AfterArgs(Params_PlayAnimWithDelay args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PlayAnimWithDelay_WithArgs (Func<BossDoorLockUIIcon,  string,  bool,  float, System.Collections.IEnumerator> orig, BossDoorLockUIIcon self,  string anim,  bool doAnim,  float delay);
}
