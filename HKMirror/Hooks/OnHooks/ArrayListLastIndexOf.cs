...
public static class OnArrayListLastIndexOf
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListLastIndexOf), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayListLastIndexOf> orig,
            HutongGames.PlayMaker.Actions.ArrayListLastIndexOf self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListLastIndexOf),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayListLastIndexOf> orig,
            HutongGames.PlayMaker.Actions.ArrayListLastIndexOf self)
        {
        ...
        internal static void HookDoArrayListLastIndex()
        {
            if (!HookedList.Contains("DoArrayListLastIndex"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListLastIndexOf),
                        "DoArrayListLastIndex", true), DoArrayListLastIndex);
            }
        }
        ...
        private static void DoArrayListLastIndex(Action<HutongGames.PlayMaker.Actions.ArrayListLastIndexOf> orig,
            HutongGames.PlayMaker.Actions.ArrayListLastIndexOf self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListLastIndexOf> orig,
            HutongGames.PlayMaker.Actions.ArrayListLastIndexOf self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListLastIndexOf> orig,
            HutongGames.PlayMaker.Actions.ArrayListLastIndexOf self);
        ...
        public delegate void DoArrayListLastIndex_WithArgs(
            Action<HutongGames.PlayMaker.Actions.ArrayListLastIndexOf> orig,
            HutongGames.PlayMaker.Actions.ArrayListLastIndexOf self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListLastIndexOf), "OnEnter",
                    true), value);
        ...
        public static event Delegates.DoArrayListLastIndex_WithArgs DoArrayListLastIndex
        {
            add => HookEndpointManager.Add<Delegates.DoArrayListLastIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListLastIndexOf),
                    "DoArrayListLastIndex", true), value);
