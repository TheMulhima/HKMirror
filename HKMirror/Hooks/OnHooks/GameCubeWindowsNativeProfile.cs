...
public static class OnGameCubeWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameCubeWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameCubeWindowsNativeProfile> orig, GameCubeWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameCubeWindowsNativeProfile> orig,
            GameCubeWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public GameCubeWindowsNativeProfile self;
        }
    }
