...
public static class OnLogitechF310ModeDMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310ModeDMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310ModeDMacNativeProfile> orig,
            LogitechF310ModeDMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310ModeDMacNativeProfile> orig,
            LogitechF310ModeDMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF310ModeDMacNativeProfile self;
        }
    }
