...
public static class OnCheckTargetDirection
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckTargetDirection), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckTargetDirection),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self)
        {
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self)
        {
        ...
        internal static void HookDoCheckDirection()
        {
            if (!HookedList.Contains("DoCheckDirection"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckTargetDirection),
                        "DoCheckDirection", true), DoCheckDirection);
            }
        }
        ...
        private static void DoCheckDirection(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self);
        ...
        public delegate void DoCheckDirection_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckTargetDirection> orig,
            HutongGames.PlayMaker.Actions.CheckTargetDirection self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckTargetDirection), "OnEnter",
                    true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckTargetDirection), "OnUpdate",
                    true), value);
