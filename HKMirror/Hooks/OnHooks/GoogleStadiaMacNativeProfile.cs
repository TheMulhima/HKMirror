...
public static class OnGoogleStadiaMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GoogleStadiaMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GoogleStadiaMacNativeProfile> orig, GoogleStadiaMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GoogleStadiaMacNativeProfile> orig,
            GoogleStadiaMacNativeProfile self);

        public sealed class Params_Define
        {
            public GoogleStadiaMacNativeProfile self;
        }
    }
