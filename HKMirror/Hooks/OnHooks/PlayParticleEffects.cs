...
public static class OnPlayParticleEffects
{
    internal static class HookHandler
    {
            ...
            PlayParticleEffects self)
        {
            ...
            {
                foreach (Delegates.PlayParticleSystems_BeforeArgs toInvoke in _beforePlayParticleSystems
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.PlayParticleSystems_AfterArgs toInvoke in
                         _afterPlayParticleSystems.GetInvocationList())
                {
                    try
                    {
