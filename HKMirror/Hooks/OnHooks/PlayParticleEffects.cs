...
public static class OnPlayParticleEffects
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.PlayParticleSystems_NormalArgs _afterPlayParticleSystems;

        private static void PlayParticleSystems(On.PlayParticleEffects.orig_PlayParticleSystems orig,
            PlayParticleEffects self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterPlayParticleSystems != null) _afterPlayParticleSystems.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void PlayParticleSystems_NormalArgs(Params_PlayParticleSystems args);
    ...
    {
        public static event Delegates.PlayParticleSystems_NormalArgs PlayParticleSystems
        {
            add
            {
