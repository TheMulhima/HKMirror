...
public static class OnExecutionerXMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ExecutionerXMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<ExecutionerXMacUnityProfile> orig, ExecutionerXMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ExecutionerXMacUnityProfile> orig,
            ExecutionerXMacUnityProfile self);

        public sealed class Params_Define
        {
            public ExecutionerXMacUnityProfile self;
        }
    }
