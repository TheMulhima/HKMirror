...
public static class OnEightBitdoN30Pro2AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoN30Pro2AndroidUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoN30Pro2AndroidUnityProfile> orig,
            EightBitdoN30Pro2AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoN30Pro2AndroidUnityProfile> orig,
            EightBitdoN30Pro2AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoN30Pro2AndroidUnityProfile self;
        }
    }
