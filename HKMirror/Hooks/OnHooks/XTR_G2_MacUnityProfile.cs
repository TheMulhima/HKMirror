...
/// <summary>
/// Contains different types of On Hooks for XTR_G2_MacUnityProfile class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnXTR_G2_MacUnityProfile
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile> orig, InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile> orig, InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XTR_G2_MacUnityProfile), "Define", true), value);
}
}
