...
public static class OnXTR_G2_MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XTR_G2_MacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XTR_G2_MacUnityProfile> orig, XTR_G2_MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XTR_G2_MacUnityProfile> orig, XTR_G2_MacUnityProfile self);

        public sealed class Params_Define
        {
            public XTR_G2_MacUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(XTR_G2_MacUnityProfile), "Define"), value);
