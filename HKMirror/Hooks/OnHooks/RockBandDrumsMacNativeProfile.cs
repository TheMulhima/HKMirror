...
public static class OnRockBandDrumsMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RockBandDrumsMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<RockBandDrumsMacNativeProfile> orig, RockBandDrumsMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RockBandDrumsMacNativeProfile> orig,
            RockBandDrumsMacNativeProfile self);

        public sealed class Params_Define
        {
            public RockBandDrumsMacNativeProfile self;
        }
    }
