...
public static class OnLogitechF310ModeDWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310ModeDWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310ModeDWindowsUnityProfile> orig,
            LogitechF310ModeDWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310ModeDWindowsUnityProfile> orig,
            LogitechF310ModeDWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF310ModeDWindowsUnityProfile self;
        }
    }
