...
public static class OnXboxOneDriverMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneDriverMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneDriverMacNativeProfile> orig, XboxOneDriverMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneDriverMacNativeProfile> orig,
            XboxOneDriverMacNativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneDriverMacNativeProfile self;
        }
    }
