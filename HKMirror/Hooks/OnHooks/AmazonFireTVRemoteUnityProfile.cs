...
public static class OnAmazonFireTVRemoteUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AmazonFireTVRemoteUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AmazonFireTVRemoteUnityProfile> orig, AmazonFireTVRemoteUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AmazonFireTVRemoteUnityProfile> orig,
            AmazonFireTVRemoteUnityProfile self);

        public sealed class Params_Define
        {
            public AmazonFireTVRemoteUnityProfile self;
        }
    }
