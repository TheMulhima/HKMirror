...
public static class OnEightBitdoSNES30AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSNES30AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSNES30AndroidUnityProfile> orig,
            EightBitdoSNES30AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSNES30AndroidUnityProfile> orig,
            EightBitdoSNES30AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSNES30AndroidUnityProfile self;
        }
    }
