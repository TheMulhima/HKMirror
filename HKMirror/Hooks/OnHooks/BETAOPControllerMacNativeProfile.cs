...
public static class OnBETAOPControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BETAOPControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BETAOPControllerMacNativeProfile> orig, BETAOPControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BETAOPControllerMacNativeProfile> orig,
            BETAOPControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public BETAOPControllerMacNativeProfile self;
        }
    }
