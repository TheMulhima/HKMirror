...
private static void RecieveExtraDamage(On.ExtraDamageable.orig_RecieveExtraDamage orig,ExtraDamageable self,  ExtraDamageTypes extraDamageType)
{
...
{
foreach (Delegates.RecieveExtraDamage_BeforeArgs toInvoke in _beforeRecieveExtraDamage.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RecieveExtraDamage_AfterArgs toInvoke in _afterRecieveExtraDamage.GetInvocationList())
{
try
{
...
private static int GetDamageOfType(On.ExtraDamageable.orig_GetDamageOfType orig, ExtraDamageTypes extraDamageTypes)
{
...
internal static event Delegates.ApplyExtraDamageToHealthManager_BeforeArgs _beforeApplyExtraDamageToHealthManager;
internal static event Delegates.ApplyExtraDamageToHealthManager_AfterArgs _afterApplyExtraDamageToHealthManager;
private static void ApplyExtraDamageToHealthManager(On.ExtraDamageable.orig_ApplyExtraDamageToHealthManager orig,ExtraDamageable self,  int damageAmount)
{
...
{
foreach (Delegates.ApplyExtraDamageToHealthManager_BeforeArgs toInvoke in _beforeApplyExtraDamageToHealthManager.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ApplyExtraDamageToHealthManager_AfterArgs toInvoke in _afterApplyExtraDamageToHealthManager.GetInvocationList())
{
try
{
...
public delegate void RecieveExtraDamage_WithArgs (Action<ExtraDamageable,  ExtraDamageTypes> orig, ExtraDamageable self,  ExtraDamageTypes extraDamageType);
...
public delegate int GetDamageOfType_WithArgs (Func< ExtraDamageTypes, int> orig,  ExtraDamageTypes extraDamageTypes);
...
public delegate void ApplyExtraDamageToHealthManager_WithArgs (Action<ExtraDamageable,  int> orig, ExtraDamageable self,  int damageAmount);
}
