...
public static class OnNVidiaShieldWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NVidiaShieldWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NVidiaShieldWindowsNativeProfile> orig, NVidiaShieldWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NVidiaShieldWindowsNativeProfile> orig,
            NVidiaShieldWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public NVidiaShieldWindowsNativeProfile self;
        }
    }
