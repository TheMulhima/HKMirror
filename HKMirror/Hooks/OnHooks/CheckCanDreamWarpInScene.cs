...
new Hook(ReflectionHelper.GetMethodInfo(typeof(CheckCanDreamWarpInScene), "get_IsTrue", true), get_IsTrue);
...
public delegate bool get_IsTrue_WithArgs (Func<CheckCanDreamWarpInScene, bool> orig, CheckCanDreamWarpInScene self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CheckCanDreamWarpInScene), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CheckCanDreamWarpInScene), "get_IsTrue", true), value);
}
}
