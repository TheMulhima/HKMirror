...
public static class OnSteelSeriesFreeLinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SteelSeriesFreeLinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<SteelSeriesFreeLinuxUnityProfile> orig, SteelSeriesFreeLinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SteelSeriesFreeLinuxUnityProfile> orig,
            SteelSeriesFreeLinuxUnityProfile self);

        public sealed class Params_Define
        {
            public SteelSeriesFreeLinuxUnityProfile self;
        }
    }
