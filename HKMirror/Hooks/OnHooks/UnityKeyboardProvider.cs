...
public static class OnUnityKeyboardProvider
{
    internal static class HookHandler
    {
        ...
        internal static void HookUpdate()
        {
            if (!HookedList.Contains("Update"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "Update", true),
                    Update);
            }
        }
        ...
        internal static void HookAnyKeyIsPressed()
        {
            if (!HookedList.Contains("AnyKeyIsPressed"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "AnyKeyIsPressed", true),
                    AnyKeyIsPressed);
            }
        }
        ...
        private static bool AnyKeyIsPressed(Func<InControl.UnityKeyboardProvider, bool> orig,
            InControl.UnityKeyboardProvider self)
        {
        ...
        internal static void HookGetKeyIsPressed()
        {
            if (!HookedList.Contains("GetKeyIsPressed"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "GetKeyIsPressed", true),
                    GetKeyIsPressed);
            }
        }
        ...
        private static bool GetKeyIsPressed(Func<InControl.UnityKeyboardProvider, InControl.Key, bool> orig,
            InControl.UnityKeyboardProvider self, InControl.Key control)
        {
        ...
        internal static void HookGetNameForKey()
        {
            if (!HookedList.Contains("GetNameForKey"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "GetNameForKey", true),
                    GetNameForKey);
            }
        }
        ...
        private static string GetNameForKey(Func<InControl.UnityKeyboardProvider, InControl.Key, string> orig,
            InControl.UnityKeyboardProvider self, InControl.Key control)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Setup_WithArgs(Action<InControl.UnityKeyboardProvider> orig,
            InControl.UnityKeyboardProvider self);
        ...
        public delegate void Reset_WithArgs(Action<InControl.UnityKeyboardProvider> orig,
            InControl.UnityKeyboardProvider self);
        ...
        public delegate void Update_WithArgs(Action<InControl.UnityKeyboardProvider> orig,
            InControl.UnityKeyboardProvider self);
        ...
        public delegate bool AnyKeyIsPressed_WithArgs(Func<InControl.UnityKeyboardProvider, bool> orig,
            InControl.UnityKeyboardProvider self);
        ...
        public delegate bool GetKeyIsPressed_WithArgs(Func<InControl.UnityKeyboardProvider, InControl.Key, bool> orig,
            InControl.UnityKeyboardProvider self, InControl.Key control);
        ...
        public delegate string GetNameForKey_WithArgs(Func<InControl.UnityKeyboardProvider, InControl.Key, string> orig,
            InControl.UnityKeyboardProvider self, InControl.Key control);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Setup_WithArgs Setup
        {
            add => HookEndpointManager.Add<Delegates.Setup_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "Setup", true), value);
        ...
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "Reset", true), value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "Update", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.AnyKeyIsPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "AnyKeyIsPressed", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.AnyKeyIsPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "AnyKeyIsPressed", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetKeyIsPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "GetKeyIsPressed", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.GetKeyIsPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "GetKeyIsPressed", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetNameForKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "GetNameForKey", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetNameForKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityKeyboardProvider), "GetNameForKey", true), value);
        }
    }
}