...
public static class OnRazerSabertoothEliteControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(RazerSabertoothEliteControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RazerSabertoothEliteControllerMacNativeProfile> orig,
            RazerSabertoothEliteControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerSabertoothEliteControllerMacNativeProfile> orig,
            RazerSabertoothEliteControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public RazerSabertoothEliteControllerMacNativeProfile self;
        }
    }
