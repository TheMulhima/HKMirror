...
public static class OnRazerSabertoothEliteControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.RazerSabertoothEliteControllerMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.RazerSabertoothEliteControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.RazerSabertoothEliteControllerMacNativeProfile self)
        {
