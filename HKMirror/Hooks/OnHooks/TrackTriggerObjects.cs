...
public static class OnTrackTriggerObjects
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_InsideCount()
        {
            if (!HookedList.Contains("get_InsideCount"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TrackTriggerObjects), "get_InsideCount", true),
                    get_InsideCount);
            }
        }
        ...
        private static void OnTriggerEnter2D(On.TrackTriggerObjects.orig_OnTriggerEnter2D orig,
            TrackTriggerObjects self, UnityEngine.Collider2D collision)
        {
        ...
        private static void OnExit(On.TrackTriggerObjects.orig_OnExit orig, TrackTriggerObjects self,
    ...
    public static class Delegates
    {
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<TrackTriggerObjects, UnityEngine.Collider2D> orig,
            TrackTriggerObjects self, UnityEngine.Collider2D collision);
        ...
        public delegate void OnTriggerExit2D_WithArgs(Action<TrackTriggerObjects, UnityEngine.Collider2D> orig,
            TrackTriggerObjects self, UnityEngine.Collider2D collision);
        ...
        public delegate void OnExit_WithArgs(Action<TrackTriggerObjects, UnityEngine.GameObject> orig,
            TrackTriggerObjects self, UnityEngine.GameObject obj);
        ...
        public delegate bool IsIgnored_WithArgs(Func<TrackTriggerObjects, UnityEngine.GameObject, bool> orig,
            TrackTriggerObjects self, UnityEngine.GameObject obj);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_InsideCount_WithArgs get_InsideCount
        {
            add => HookEndpointManager.Add<Delegates.get_InsideCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TrackTriggerObjects), "get_InsideCount", true), value);
