...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TrackTriggerObjects), "get_InsideCount", true), get_InsideCount);
...
private static void OnHeroInPosition(On.TrackTriggerObjects.orig_OnHeroInPosition orig,TrackTriggerObjects self,  bool forceDirect)
{
...
private static void GetOverlappedColliders(On.TrackTriggerObjects.orig_GetOverlappedColliders orig,TrackTriggerObjects self,  bool isRefresh)
{
...
{
foreach (Delegates.GetOverlappedColliders_BeforeArgs toInvoke in _beforeGetOverlappedColliders.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetOverlappedColliders_AfterArgs toInvoke in _afterGetOverlappedColliders.GetInvocationList())
{
try
{
...
private static void OnTriggerEnter2D(On.TrackTriggerObjects.orig_OnTriggerEnter2D orig,TrackTriggerObjects self,  UnityEngine.Collider2D collision)
{
...
private static void OnTriggerExit2D(On.TrackTriggerObjects.orig_OnTriggerExit2D orig,TrackTriggerObjects self,  UnityEngine.Collider2D collision)
{
...
private static void OnExit(On.TrackTriggerObjects.orig_OnExit orig,TrackTriggerObjects self,  UnityEngine.GameObject obj)
{
...
private static bool IsIgnored(On.TrackTriggerObjects.orig_IsIgnored orig,TrackTriggerObjects self,  UnityEngine.GameObject obj)
{
...
public delegate void OnHeroInPosition_WithArgs (Action<TrackTriggerObjects,  bool> orig, TrackTriggerObjects self,  bool forceDirect);
...
public delegate void GetOverlappedColliders_WithArgs (Action<TrackTriggerObjects,  bool> orig, TrackTriggerObjects self,  bool isRefresh);
...
public delegate void OnTriggerEnter2D_WithArgs (Action<TrackTriggerObjects,  UnityEngine.Collider2D> orig, TrackTriggerObjects self,  UnityEngine.Collider2D collision);
...
public delegate void OnTriggerExit2D_WithArgs (Action<TrackTriggerObjects,  UnityEngine.Collider2D> orig, TrackTriggerObjects self,  UnityEngine.Collider2D collision);
...
public delegate void OnExit_WithArgs (Action<TrackTriggerObjects,  UnityEngine.GameObject> orig, TrackTriggerObjects self,  UnityEngine.GameObject obj);
...
public delegate bool IsIgnored_WithArgs (Func<TrackTriggerObjects,  UnityEngine.GameObject, bool> orig, TrackTriggerObjects self,  UnityEngine.GameObject obj);
}
...
{
add => HookEndpointManager.Add<Delegates.get_InsideCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TrackTriggerObjects), "get_InsideCount", true), value);
remove => HookEndpointManager.Remove<Delegates.get_InsideCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TrackTriggerObjects), "get_InsideCount", true), value);
}
