...
public static class OnRockCandyXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RockCandyXbox360ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RockCandyXbox360ControllerMacNativeProfile> orig,
            RockCandyXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RockCandyXbox360ControllerMacNativeProfile> orig,
            RockCandyXbox360ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public RockCandyXbox360ControllerMacNativeProfile self;
        }
    }
