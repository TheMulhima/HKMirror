...
public static class OnRedOctaneGuitarMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RedOctaneGuitarMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<RedOctaneGuitarMacNativeProfile> orig, RedOctaneGuitarMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RedOctaneGuitarMacNativeProfile> orig,
            RedOctaneGuitarMacNativeProfile self);

        public sealed class Params_Define
        {
            public RedOctaneGuitarMacNativeProfile self;
        }
    }
