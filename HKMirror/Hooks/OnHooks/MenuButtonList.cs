...
private static System.Collections.IEnumerator SelectDelayed(On.MenuButtonList.orig_SelectDelayed orig,MenuButtonList self,  UnityEngine.UI.Selectable selectable)
{
...
{
foreach (Delegates.ClearLastSelected_BeforeArgs toInvoke in _beforeClearLastSelected.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearAllLastSelected_BeforeArgs toInvoke in _beforeClearAllLastSelected.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearAllLastSelected_AfterArgs toInvoke in _afterClearAllLastSelected.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectable_Selectable", true), AddSelectable_Selectable);
...
private static void AddSelectable_Selectable(Action<MenuButtonList,  UnityEngine.UI.Selectable> orig, MenuButtonList self,  UnityEngine.UI.Selectable sel)
{
...
{
foreach (Delegates.AddSelectable_Selectable_BeforeArgs toInvoke in _beforeAddSelectable_Selectable.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddSelectable_Selectable_AfterArgs toInvoke in _afterAddSelectable_Selectable.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectableEnd", true), AddSelectableEnd);
...
private static void AddSelectableEnd(Action<MenuButtonList,  UnityEngine.UI.Selectable,  int> orig, MenuButtonList self,  UnityEngine.UI.Selectable sel,  int controlButtons)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectable_Selectable_int", true), AddSelectable_Selectable_int);
...
private static void AddSelectable_Selectable_int(Action<MenuButtonList,  UnityEngine.UI.Selectable,  int> orig, MenuButtonList self,  UnityEngine.UI.Selectable sel,  int index)
{
...
{
foreach (Delegates.AddSelectable_Selectable_int_BeforeArgs toInvoke in _beforeAddSelectable_Selectable_int.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddSelectable_Selectable_int_AfterArgs toInvoke in _afterAddSelectable_Selectable_int.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "ClearSelectables", true), ClearSelectables);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "RecalculateNavigation", true), RecalculateNavigation);
...
{
foreach (Delegates.RecalculateNavigation_BeforeArgs toInvoke in _beforeRecalculateNavigation.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RecalculateNavigation_AfterArgs toInvoke in _afterRecalculateNavigation.GetInvocationList())
{
try
{
...
public delegate System.Collections.IEnumerator SelectDelayed_AfterArgs(Params_SelectDelayed args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator SelectDelayed_WithArgs (Func<MenuButtonList,  UnityEngine.UI.Selectable, System.Collections.IEnumerator> orig, MenuButtonList self,  UnityEngine.UI.Selectable selectable);
...
public delegate void AddSelectable_Selectable_WithArgs (Action<MenuButtonList,  UnityEngine.UI.Selectable> orig, MenuButtonList self,  UnityEngine.UI.Selectable sel);
...
public delegate void AddSelectableEnd_WithArgs (Action<MenuButtonList,  UnityEngine.UI.Selectable,  int> orig, MenuButtonList self,  UnityEngine.UI.Selectable sel,  int controlButtons);
...
public delegate void AddSelectable_Selectable_int_WithArgs (Action<MenuButtonList,  UnityEngine.UI.Selectable,  int> orig, MenuButtonList self,  UnityEngine.UI.Selectable sel,  int index);
...
{
add => HookEndpointManager.Add<Delegates.AddSelectable_Selectable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectable", true), value);
remove => HookEndpointManager.Remove<Delegates.AddSelectable_Selectable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectable", true), value);
}
public static event Delegates.AddSelectableEnd_WithArgs AddSelectableEnd
{
add => HookEndpointManager.Add<Delegates.AddSelectableEnd_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectableEnd", true), value);
remove => HookEndpointManager.Remove<Delegates.AddSelectableEnd_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectableEnd", true), value);
}
public static event Delegates.AddSelectable_Selectable_int_WithArgs AddSelectable_Selectable_int
{
add => HookEndpointManager.Add<Delegates.AddSelectable_Selectable_int_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectable", true), value);
remove => HookEndpointManager.Remove<Delegates.AddSelectable_Selectable_int_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "AddSelectable", true), value);
}
public static event Delegates.ClearSelectables_WithArgs ClearSelectables
{
add => HookEndpointManager.Add<Delegates.ClearSelectables_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "ClearSelectables", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearSelectables_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "ClearSelectables", true), value);
}
public static event Delegates.RecalculateNavigation_WithArgs RecalculateNavigation
{
add => HookEndpointManager.Add<Delegates.RecalculateNavigation_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "RecalculateNavigation", true), value);
remove => HookEndpointManager.Remove<Delegates.RecalculateNavigation_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonList), "RecalculateNavigation", true), value);
}
}
