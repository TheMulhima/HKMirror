...
public static class OnFaceObject
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceObject), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceObject), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceObject), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self)
        {
        ...
        internal static void HookDoFace()
        {
            if (!HookedList.Contains("DoFace"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceObject), "DoFace", true),
                    DoFace);
            }
        }
        ...
        private static void DoFace(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self);
        ...
        public delegate void DoFace_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceObject> orig,
            HutongGames.PlayMaker.Actions.FaceObject self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceObject), "Reset", true), value);
