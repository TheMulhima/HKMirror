...
public static class OnAndroidTVRemoteUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AndroidTVRemoteUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AndroidTVRemoteUnityProfile> orig, AndroidTVRemoteUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AndroidTVRemoteUnityProfile> orig,
            AndroidTVRemoteUnityProfile self);

        public sealed class Params_Define
        {
            public AndroidTVRemoteUnityProfile self;
        }
    }
