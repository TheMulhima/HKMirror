...
public static class OnGamepadVibration
{
    ...
    {
        public delegate AnimationCurve get_LargeMotor_AfterArgs(Params_get_LargeMotor args, AnimationCurve ret);

        public delegate void get_LargeMotor_BeforeArgs(Params_get_LargeMotor args);

        public delegate AnimationCurve get_LargeMotor_WithArgs(Func<GamepadVibration, AnimationCurve> orig,
            GamepadVibration self);
        ...
        public delegate AnimationCurve get_SmallMotor_AfterArgs(Params_get_SmallMotor args, AnimationCurve ret);

        public delegate void get_SmallMotor_BeforeArgs(Params_get_SmallMotor args);

        public delegate AnimationCurve get_SmallMotor_WithArgs(Func<GamepadVibration, AnimationCurve> orig,
            GamepadVibration self);
        ...
        public delegate float GetDuration_AnimationCurve_WithArgs(Func<AnimationCurve, float> orig,
            AnimationCurve animationCurve);
