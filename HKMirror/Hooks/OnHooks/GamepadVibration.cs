...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_SmallMotor", true), get_SmallMotor);
...
private static UnityEngine.AnimationCurve get_SmallMotor(Func<GamepadVibration, UnityEngine.AnimationCurve> orig, GamepadVibration self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_LargeMotor", true), get_LargeMotor);
...
private static UnityEngine.AnimationCurve get_LargeMotor(Func<GamepadVibration, UnityEngine.AnimationCurve> orig, GamepadVibration self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_PlaybackRate", true), get_PlaybackRate);
...
private static float GetDuration_AnimationCurve(On.GamepadVibration.orig_GetDuration_AnimationCurve orig, UnityEngine.AnimationCurve animationCurve)
{
...
{
foreach (Delegates.GetDuration_AnimationCurve_BeforeArgs toInvoke in _beforeGetDuration_AnimationCurve.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetDuration_AnimationCurve_AfterArgs toInvoke in _afterGetDuration_AnimationCurve.GetInvocationList())
{
try
{
...
public delegate UnityEngine.AnimationCurve get_SmallMotor_AfterArgs(Params_get_SmallMotor args, UnityEngine.AnimationCurve ret);
public delegate UnityEngine.AnimationCurve get_SmallMotor_WithArgs (Func<GamepadVibration, UnityEngine.AnimationCurve> orig, GamepadVibration self);
public sealed class Params_get_LargeMotor
{
public GamepadVibration self;
}
public delegate void get_LargeMotor_BeforeArgs(Params_get_LargeMotor args);
public delegate UnityEngine.AnimationCurve get_LargeMotor_AfterArgs(Params_get_LargeMotor args, UnityEngine.AnimationCurve ret);
public delegate UnityEngine.AnimationCurve get_LargeMotor_WithArgs (Func<GamepadVibration, UnityEngine.AnimationCurve> orig, GamepadVibration self);
...
public delegate float GetDuration_AnimationCurve_WithArgs (Func< UnityEngine.AnimationCurve, float> orig,  UnityEngine.AnimationCurve animationCurve);
}
...
{
add => HookEndpointManager.Add<Delegates.get_SmallMotor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_SmallMotor", true), value);
remove => HookEndpointManager.Remove<Delegates.get_SmallMotor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_SmallMotor", true), value);
}
public static event Delegates.get_LargeMotor_WithArgs get_LargeMotor
{
add => HookEndpointManager.Add<Delegates.get_LargeMotor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_LargeMotor", true), value);
remove => HookEndpointManager.Remove<Delegates.get_LargeMotor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_LargeMotor", true), value);
}
public static event Delegates.get_PlaybackRate_WithArgs get_PlaybackRate
{
add => HookEndpointManager.Add<Delegates.get_PlaybackRate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_PlaybackRate", true), value);
remove => HookEndpointManager.Remove<Delegates.get_PlaybackRate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GamepadVibration), "get_PlaybackRate", true), value);
}
