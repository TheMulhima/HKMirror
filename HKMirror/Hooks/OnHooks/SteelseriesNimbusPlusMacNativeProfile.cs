...
public static class OnSteelseriesNimbusPlusMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SteelseriesNimbusPlusMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<SteelseriesNimbusPlusMacNativeProfile> orig,
            SteelseriesNimbusPlusMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SteelseriesNimbusPlusMacNativeProfile> orig,
            SteelseriesNimbusPlusMacNativeProfile self);

        public sealed class Params_Define
        {
            public SteelseriesNimbusPlusMacNativeProfile self;
        }
    }
