...
public static class OnIpegaPG9023AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IpegaPG9023AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<IpegaPG9023AndroidUnityProfile> orig, IpegaPG9023AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<IpegaPG9023AndroidUnityProfile> orig,
            IpegaPG9023AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public IpegaPG9023AndroidUnityProfile self;
        }
    }
