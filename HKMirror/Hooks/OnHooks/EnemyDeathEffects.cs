...
private static void RecieveDeathEvent(On.EnemyDeathEffects.orig_RecieveDeathEvent orig,EnemyDeathEffects self,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery)
{
...
{
foreach (Delegates.RecieveDeathEvent_BeforeArgs toInvoke in _beforeRecieveDeathEvent.GetInvocationList())
{
try
{
...
private static void RecordKillForJournal(On.EnemyDeathEffects.orig_RecordKillForJournal orig,EnemyDeathEffects self)
{
...
{
foreach (Delegates.RecordKillForJournal_BeforeArgs toInvoke in _beforeRecordKillForJournal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RecordKillForJournal_AfterArgs toInvoke in _afterRecordKillForJournal.GetInvocationList())
{
try
{
...
private static void EmitInfectedEffects(On.EnemyDeathEffects.orig_EmitInfectedEffects orig,EnemyDeathEffects self)
{
...
{
foreach (Delegates.EmitInfectedEffects_BeforeArgs toInvoke in _beforeEmitInfectedEffects.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EmitInfectedEffects_AfterArgs toInvoke in _afterEmitInfectedEffects.GetInvocationList())
{
try
{
...
private static void EmitSmallInfectedEffects(On.EnemyDeathEffects.orig_EmitSmallInfectedEffects orig,EnemyDeathEffects self)
{
...
{
foreach (Delegates.EmitSmallInfectedEffects_BeforeArgs toInvoke in _beforeEmitSmallInfectedEffects.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EmitSmallInfectedEffects_AfterArgs toInvoke in _afterEmitSmallInfectedEffects.GetInvocationList())
{
try
{
...
private static void EmitLargeInfectedEffects(On.EnemyDeathEffects.orig_EmitLargeInfectedEffects orig,EnemyDeathEffects self)
{
...
{
foreach (Delegates.EmitLargeInfectedEffects_BeforeArgs toInvoke in _beforeEmitLargeInfectedEffects.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EmitLargeInfectedEffects_AfterArgs toInvoke in _afterEmitLargeInfectedEffects.GetInvocationList())
{
try
{
...
private static void ShakeCameraIfVisible(On.EnemyDeathEffects.orig_ShakeCameraIfVisible orig,EnemyDeathEffects self,  string eventName)
{
...
{
foreach (Delegates.ShakeCameraIfVisible_BeforeArgs toInvoke in _beforeShakeCameraIfVisible.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ShakeCameraIfVisible_AfterArgs toInvoke in _afterShakeCameraIfVisible.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(EnemyDeathEffects), "orig_RecieveDeathEvent", true), orig_RecieveDeathEvent);
...
private static void orig_RecieveDeathEvent(Action<EnemyDeathEffects,  float?,  bool,  bool,  bool> orig, EnemyDeathEffects self,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery)
{
...
{
foreach (Delegates.orig_RecieveDeathEvent_BeforeArgs toInvoke in _beforeorig_RecieveDeathEvent.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_RecieveDeathEvent_AfterArgs toInvoke in _afterorig_RecieveDeathEvent.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(EnemyDeathEffects), "orig_RecordKillForJournal", true), orig_RecordKillForJournal);
...
{
foreach (Delegates.orig_RecordKillForJournal_BeforeArgs toInvoke in _beforeorig_RecordKillForJournal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_RecordKillForJournal_AfterArgs toInvoke in _afterorig_RecordKillForJournal.GetInvocationList())
{
try
{
...
public delegate void RecieveDeathEvent_WithArgs (Action<EnemyDeathEffects,  float?,  bool,  bool,  bool> orig, EnemyDeathEffects self,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery);
...
public delegate void EmitCorpse_WithArgs (Action<EnemyDeathEffects,  float?,  bool,  bool> orig, EnemyDeathEffects self,  float? attackDirection,  bool isWatery,  bool spellBurn);
...
public delegate void ShakeCameraIfVisible_WithArgs (Action<EnemyDeathEffects,  string> orig, EnemyDeathEffects self,  string eventName);
...
public delegate void orig_RecieveDeathEvent_WithArgs (Action<EnemyDeathEffects,  float?,  bool,  bool,  bool> orig, EnemyDeathEffects self,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery);
...
{
add => HookEndpointManager.Add<Delegates.orig_RecieveDeathEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(EnemyDeathEffects), "orig_RecieveDeathEvent", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_RecieveDeathEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(EnemyDeathEffects), "orig_RecieveDeathEvent", true), value);
}
public static event Delegates.orig_RecordKillForJournal_WithArgs orig_RecordKillForJournal
{
add => HookEndpointManager.Add<Delegates.orig_RecordKillForJournal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(EnemyDeathEffects), "orig_RecordKillForJournal", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_RecordKillForJournal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(EnemyDeathEffects), "orig_RecordKillForJournal", true), value);
}
}
