...
public static class OnRayCast2dV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RayCast2dV2), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RayCast2dV2), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RayCast2dV2), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self)
        {
        ...
        internal static void HookDoRaycast()
        {
            if (!HookedList.Contains("DoRaycast"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RayCast2dV2), "DoRaycast",
                        true), DoRaycast);
            }
        }
        ...
        private static void DoRaycast(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self);
        ...
        public delegate void DoRaycast_WithArgs(Action<HutongGames.PlayMaker.Actions.RayCast2dV2> orig,
            HutongGames.PlayMaker.Actions.RayCast2dV2 self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoRaycast_WithArgs DoRaycast
        {
            add => HookEndpointManager.Add<Delegates.DoRaycast_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RayCast2dV2), "DoRaycast", true),
                value);
