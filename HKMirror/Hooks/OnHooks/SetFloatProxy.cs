...
public static class OnSetFloatProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetFloatProxy), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static float Invoke(Func<Modding.Delegates.SetFloatProxy, string, float, float> orig,
            Modding.Delegates.SetFloatProxy self, string name, float orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetFloatProxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static float EndInvoke(Func<Modding.Delegates.SetFloatProxy, System.IAsyncResult, float> orig,
            Modding.Delegates.SetFloatProxy self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate float Invoke_WithArgs(Func<Modding.Delegates.SetFloatProxy, string, float, float> orig,
            Modding.Delegates.SetFloatProxy self, string name, float orig_);
        ...
        public delegate float EndInvoke_WithArgs(Func<Modding.Delegates.SetFloatProxy, System.IAsyncResult, float> orig,
            Modding.Delegates.SetFloatProxy self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetFloatProxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetFloatProxy), "EndInvoke", true), value);
