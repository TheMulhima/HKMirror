...
public static class OnSetFloatProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetFloatProxy), "Invoke"), Invoke);
            }
        }
        ...
        private static float Invoke(Func<SetFloatProxy, string, float, float> orig, SetFloatProxy self, string name,
            float orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetFloatProxy), "EndInvoke"), EndInvoke);
            }
        }
        ...
        private static float EndInvoke(Func<SetFloatProxy, IAsyncResult, float> orig, SetFloatProxy self,
            IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate float EndInvoke_WithArgs(Func<SetFloatProxy, IAsyncResult, float> orig, SetFloatProxy self,
            IAsyncResult result);
        ...
        public delegate float Invoke_WithArgs(Func<SetFloatProxy, string, float, float> orig, SetFloatProxy self,
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetFloatProxy), "Invoke"), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetFloatProxy), "EndInvoke"), value);
