...
public static class OnGetACosine
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.DoACosine_NormalArgs _afterDoACosine;
        ...
        private static void DoACosine(Action<GetACosine> orig, GetACosine self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterDoACosine != null) _afterDoACosine.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void DoACosine_NormalArgs(Params_DoACosine args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.DoACosine_NormalArgs DoACosine
        {
            add
            {
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoACosine_NormalArgs DoACosine
        {
            add => HookEndpointManager.Add<Delegates.DoACosine_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetACosine), "DoACosine"), value);
            remove => HookEndpointManager.Remove<Delegates.DoACosine_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetACosine), "DoACosine"), value);
        }
    }
}