...
public static class OnGetACosine
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetACosine), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetACosine), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetACosine), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self)
        {
        ...
        internal static void HookDoACosine()
        {
            if (!HookedList.Contains("DoACosine"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetACosine), "DoACosine", true),
                    DoACosine);
            }
        }
        ...
        private static void DoACosine(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self);
        ...
        public delegate void DoACosine_WithArgs(Action<HutongGames.PlayMaker.Actions.GetACosine> orig,
            HutongGames.PlayMaker.Actions.GetACosine self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetACosine), "Reset", true), value);
