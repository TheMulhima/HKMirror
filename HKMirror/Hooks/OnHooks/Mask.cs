...
internal static void Hookset_maskMappingWorldAxis()
{
if (!HookedList.Contains("set_maskMappingWorldAxis"))
{
HookedList.Add("set_maskMappingWorldAxis");
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_maskMappingWorldAxis", true), set_maskMappingWorldAxis);

}
}
internal static event Delegates.set_maskMappingWorldAxis_BeforeArgs _beforeset_maskMappingWorldAxis;
internal static event Delegates.set_maskMappingWorldAxis_AfterArgs _afterset_maskMappingWorldAxis;
private static void set_maskMappingWorldAxis(Action<ToJ.Mask,  ToJ.Mask.MappingAxis> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis value)
{
Delegates.Params_set_maskMappingWorldAxis @params = new() 
{
self = self
, value = value
};
if (_beforeset_maskMappingWorldAxis != null)
{
foreach (Delegates.set_maskMappingWorldAxis_BeforeArgs toInvoke in _beforeset_maskMappingWorldAxis.GetInvocationList())
{
try
{
_beforeset_maskMappingWorldAxis?.Invoke(@params);
}
catch (Exception e) 
...
value = @params.value;
orig(self, value);
if (_afterset_maskMappingWorldAxis != null)
{
foreach (Delegates.set_maskMappingWorldAxis_AfterArgs toInvoke in _afterset_maskMappingWorldAxis.GetInvocationList())
{
try
{
_afterset_maskMappingWorldAxis.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampAlphaHorizontally", true), get_clampAlphaHorizontally);
...
{
foreach (Delegates.get_clampAlphaHorizontally_BeforeArgs toInvoke in _beforeget_clampAlphaHorizontally.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_clampAlphaHorizontally_AfterArgs toInvoke in _afterget_clampAlphaHorizontally.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampAlphaHorizontally", true), set_clampAlphaHorizontally);
...
{
foreach (Delegates.set_clampAlphaHorizontally_BeforeArgs toInvoke in _beforeset_clampAlphaHorizontally.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_clampAlphaHorizontally_AfterArgs toInvoke in _afterset_clampAlphaHorizontally.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampAlphaVertically", true), get_clampAlphaVertically);
...
{
foreach (Delegates.get_clampAlphaVertically_BeforeArgs toInvoke in _beforeget_clampAlphaVertically.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_clampAlphaVertically_AfterArgs toInvoke in _afterget_clampAlphaVertically.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampAlphaVertically", true), set_clampAlphaVertically);
...
{
foreach (Delegates.set_clampAlphaVertically_BeforeArgs toInvoke in _beforeset_clampAlphaVertically.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_clampAlphaVertically_AfterArgs toInvoke in _afterset_clampAlphaVertically.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampingBorder", true), get_clampingBorder);
...
{
foreach (Delegates.get_clampingBorder_BeforeArgs toInvoke in _beforeget_clampingBorder.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_clampingBorder_AfterArgs toInvoke in _afterget_clampingBorder.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampingBorder", true), set_clampingBorder);
...
{
foreach (Delegates.set_clampingBorder_BeforeArgs toInvoke in _beforeset_clampingBorder.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_clampingBorder_AfterArgs toInvoke in _afterset_clampingBorder.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_useMaskAlphaChannel", true), get_useMaskAlphaChannel);
...
{
foreach (Delegates.get_useMaskAlphaChannel_BeforeArgs toInvoke in _beforeget_useMaskAlphaChannel.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_useMaskAlphaChannel_AfterArgs toInvoke in _afterget_useMaskAlphaChannel.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_useMaskAlphaChannel", true), set_useMaskAlphaChannel);
...
{
foreach (Delegates.set_useMaskAlphaChannel_BeforeArgs toInvoke in _beforeset_useMaskAlphaChannel.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_useMaskAlphaChannel_AfterArgs toInvoke in _afterset_useMaskAlphaChannel.GetInvocationList())
{
try
{
...
private static UnityEngine.Vector3 RotateVector(Func<ToJ.Mask,  UnityEngine.Vector3,  UnityEngine.Vector3, UnityEngine.Vector3> orig, ToJ.Mask self,  UnityEngine.Vector3 point,  UnityEngine.Vector3 angles)
{
...
internal static void HookSetMaskMappingAxisInMaterials()
{
if (!HookedList.Contains("SetMaskMappingAxisInMaterials"))
{
HookedList.Add("SetMaskMappingAxisInMaterials");
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskMappingAxisInMaterials", true), SetMaskMappingAxisInMaterials);

}
}
internal static event Delegates.SetMaskMappingAxisInMaterials_BeforeArgs _beforeSetMaskMappingAxisInMaterials;
internal static event Delegates.SetMaskMappingAxisInMaterials_AfterArgs _afterSetMaskMappingAxisInMaterials;
private static void SetMaskMappingAxisInMaterials(Action<ToJ.Mask,  ToJ.Mask.MappingAxis> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis mappingAxis)
{
Delegates.Params_SetMaskMappingAxisInMaterials @params = new() 
{
self = self
, mappingAxis = mappingAxis
};
if (_beforeSetMaskMappingAxisInMaterials != null)
{
foreach (Delegates.SetMaskMappingAxisInMaterials_BeforeArgs toInvoke in _beforeSetMaskMappingAxisInMaterials.GetInvocationList())
{
try
{
_beforeSetMaskMappingAxisInMaterials?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
self = @params.self;
mappingAxis = @params.mappingAxis;
orig(self, mappingAxis);
if (_afterSetMaskMappingAxisInMaterials != null)
{
foreach (Delegates.SetMaskMappingAxisInMaterials_AfterArgs toInvoke in _afterSetMaskMappingAxisInMaterials.GetInvocationList())
{
try
{
_afterSetMaskMappingAxisInMaterials.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
internal static void HookSetMaskMappingAxisInMaterial()
{
if (!HookedList.Contains("SetMaskMappingAxisInMaterial"))
{
HookedList.Add("SetMaskMappingAxisInMaterial");
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskMappingAxisInMaterial", true), SetMaskMappingAxisInMaterial);

}
}
internal static event Delegates.SetMaskMappingAxisInMaterial_BeforeArgs _beforeSetMaskMappingAxisInMaterial;
internal static event Delegates.SetMaskMappingAxisInMaterial_AfterArgs _afterSetMaskMappingAxisInMaterial;
private static void SetMaskMappingAxisInMaterial(Action<ToJ.Mask,  ToJ.Mask.MappingAxis,  UnityEngine.Material> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis mappingAxis,  UnityEngine.Material material)
{
Delegates.Params_SetMaskMappingAxisInMaterial @params = new() 
{
self = self
, mappingAxis = mappingAxis
, material = material
};
if (_beforeSetMaskMappingAxisInMaterial != null)
{
foreach (Delegates.SetMaskMappingAxisInMaterial_BeforeArgs toInvoke in _beforeSetMaskMappingAxisInMaterial.GetInvocationList())
{
try
{
_beforeSetMaskMappingAxisInMaterial?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
orig(self, mappingAxis, material);
if (_afterSetMaskMappingAxisInMaterial != null)
{
foreach (Delegates.SetMaskMappingAxisInMaterial_AfterArgs toInvoke in _afterSetMaskMappingAxisInMaterial.GetInvocationList())
{
try
{
_afterSetMaskMappingAxisInMaterial.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskFloatValueInMaterials", true), SetMaskFloatValueInMaterials);
...
private static void SetMaskFloatValueInMaterials(Action<ToJ.Mask,  string,  float> orig, ToJ.Mask self,  string variable,  float value)
{
...
{
foreach (Delegates.SetMaskFloatValueInMaterials_BeforeArgs toInvoke in _beforeSetMaskFloatValueInMaterials.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetMaskFloatValueInMaterials_AfterArgs toInvoke in _afterSetMaskFloatValueInMaterials.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskBoolValueInMaterials", true), SetMaskBoolValueInMaterials);
...
private static void SetMaskBoolValueInMaterials(Action<ToJ.Mask,  string,  bool> orig, ToJ.Mask self,  string variable,  bool value)
{
...
{
foreach (Delegates.SetMaskBoolValueInMaterials_BeforeArgs toInvoke in _beforeSetMaskBoolValueInMaterials.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetMaskBoolValueInMaterials_AfterArgs toInvoke in _afterSetMaskBoolValueInMaterials.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskBoolValueInMaterial", true), SetMaskBoolValueInMaterial);
...
private static void SetMaskBoolValueInMaterial(Action<ToJ.Mask,  string,  bool,  UnityEngine.Material> orig, ToJ.Mask self,  string variable,  bool value,  UnityEngine.Material material)
{
...
{
foreach (Delegates.SetMaskBoolValueInMaterial_BeforeArgs toInvoke in _beforeSetMaskBoolValueInMaterial.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetMaskBoolValueInMaterial_AfterArgs toInvoke in _afterSetMaskBoolValueInMaterial.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "CreateAndAssignQuad", true), CreateAndAssignQuad);
...
private static void CreateAndAssignQuad(Action<ToJ.Mask,  UnityEngine.Mesh,  float,  float,  float,  float> orig, ToJ.Mask self,  UnityEngine.Mesh mesh,  float minX,  float maxX,  float minY,  float maxY)
{
...
{
foreach (Delegates.CreateAndAssignQuad_BeforeArgs toInvoke in _beforeCreateAndAssignQuad.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CreateAndAssignQuad_AfterArgs toInvoke in _afterCreateAndAssignQuad.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskRendererActive", true), SetMaskRendererActive);
...
{
foreach (Delegates.SetMaskRendererActive_BeforeArgs toInvoke in _beforeSetMaskRendererActive.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetMaskRendererActive_AfterArgs toInvoke in _afterSetMaskRendererActive.GetInvocationList())
{
try
{
...
internal static void HookChangeMappingAxis()
{
if (!HookedList.Contains("ChangeMappingAxis"))
{
HookedList.Add("ChangeMappingAxis");
new Hook(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "ChangeMappingAxis", true), ChangeMappingAxis);

}
}
internal static event Delegates.ChangeMappingAxis_BeforeArgs _beforeChangeMappingAxis;
internal static event Delegates.ChangeMappingAxis_AfterArgs _afterChangeMappingAxis;
private static void ChangeMappingAxis(Action<ToJ.Mask,  ToJ.Mask.MappingAxis,  ToJ.Mask.MappingAxis,  bool> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis currMaskMappingWorldAxis,  ToJ.Mask.MappingAxis prevMaskMappingWorldAxis,  bool currInvertAxis)
{
Delegates.Params_ChangeMappingAxis @params = new() 
{
self = self
, currMaskMappingWorldAxis = currMaskMappingWorldAxis
, prevMaskMappingWorldAxis = prevMaskMappingWorldAxis
, currInvertAxis = currInvertAxis
};
if (_beforeChangeMappingAxis != null)
{
foreach (Delegates.ChangeMappingAxis_BeforeArgs toInvoke in _beforeChangeMappingAxis.GetInvocationList())
{
try
{
_beforeChangeMappingAxis?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
self = @params.self;
currMaskMappingWorldAxis = @params.currMaskMappingWorldAxis;
prevMaskMappingWorldAxis = @params.prevMaskMappingWorldAxis;
currInvertAxis = @params.currInvertAxis;
orig(self, currMaskMappingWorldAxis, prevMaskMappingWorldAxis, currInvertAxis);
if (_afterChangeMappingAxis != null)
{
foreach (Delegates.ChangeMappingAxis_AfterArgs toInvoke in _afterChangeMappingAxis.GetInvocationList())
{
try
{
_afterChangeMappingAxis.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
{
public sealed class Params_set_maskMappingWorldAxis
{
public ToJ.Mask self;
public ToJ.Mask.MappingAxis value;
}
public delegate void set_maskMappingWorldAxis_BeforeArgs(Params_set_maskMappingWorldAxis args);
public delegate void set_maskMappingWorldAxis_AfterArgs(Params_set_maskMappingWorldAxis args);
public delegate void set_maskMappingWorldAxis_WithArgs (Action<ToJ.Mask,  ToJ.Mask.MappingAxis> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis value);
...
public delegate void set_clampAlphaHorizontally_WithArgs (Action<ToJ.Mask,  bool> orig, ToJ.Mask self,  bool value);
...
public delegate UnityEngine.Vector3 RotateVector_WithArgs (Func<ToJ.Mask,  UnityEngine.Vector3,  UnityEngine.Vector3, UnityEngine.Vector3> orig, ToJ.Mask self,  UnityEngine.Vector3 point,  UnityEngine.Vector3 angles);
public sealed class Params_SetMaskMappingAxisInMaterials
{
public ToJ.Mask self;
public ToJ.Mask.MappingAxis mappingAxis;
}
public delegate void SetMaskMappingAxisInMaterials_BeforeArgs(Params_SetMaskMappingAxisInMaterials args);
public delegate void SetMaskMappingAxisInMaterials_AfterArgs(Params_SetMaskMappingAxisInMaterials args);
public delegate void SetMaskMappingAxisInMaterials_WithArgs (Action<ToJ.Mask,  ToJ.Mask.MappingAxis> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis mappingAxis);
public sealed class Params_SetMaskMappingAxisInMaterial
{
public ToJ.Mask self;
public ToJ.Mask.MappingAxis mappingAxis;
public UnityEngine.Material material;
}
public delegate void SetMaskMappingAxisInMaterial_BeforeArgs(Params_SetMaskMappingAxisInMaterial args);
public delegate void SetMaskMappingAxisInMaterial_AfterArgs(Params_SetMaskMappingAxisInMaterial args);
public delegate void SetMaskMappingAxisInMaterial_WithArgs (Action<ToJ.Mask,  ToJ.Mask.MappingAxis,  UnityEngine.Material> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis mappingAxis,  UnityEngine.Material material);
...
public delegate void SetMaskFloatValueInMaterials_WithArgs (Action<ToJ.Mask,  string,  float> orig, ToJ.Mask self,  string variable,  float value);
...
public delegate void SetMaskBoolValueInMaterials_WithArgs (Action<ToJ.Mask,  string,  bool> orig, ToJ.Mask self,  string variable,  bool value);
...
public delegate void SetMaskBoolValueInMaterial_WithArgs (Action<ToJ.Mask,  string,  bool,  UnityEngine.Material> orig, ToJ.Mask self,  string variable,  bool value,  UnityEngine.Material material);
...
public delegate void CreateAndAssignQuad_WithArgs (Action<ToJ.Mask,  UnityEngine.Mesh,  float,  float,  float,  float> orig, ToJ.Mask self,  UnityEngine.Mesh mesh,  float minX,  float maxX,  float minY,  float maxY);
...
public sealed class Params_ChangeMappingAxis
{
public ToJ.Mask self;
public ToJ.Mask.MappingAxis currMaskMappingWorldAxis;
public ToJ.Mask.MappingAxis prevMaskMappingWorldAxis;
public bool currInvertAxis;
}
public delegate void ChangeMappingAxis_BeforeArgs(Params_ChangeMappingAxis args);
public delegate void ChangeMappingAxis_AfterArgs(Params_ChangeMappingAxis args);
public delegate void ChangeMappingAxis_WithArgs (Action<ToJ.Mask,  ToJ.Mask.MappingAxis,  ToJ.Mask.MappingAxis,  bool> orig, ToJ.Mask self,  ToJ.Mask.MappingAxis currMaskMappingWorldAxis,  ToJ.Mask.MappingAxis prevMaskMappingWorldAxis,  bool currInvertAxis);
}
...
{
public static event Delegates.set_maskMappingWorldAxis_BeforeArgs set_maskMappingWorldAxis
{
add
{

HookHandler._beforeset_maskMappingWorldAxis += value;
HookHandler.Hookset_maskMappingWorldAxis();
}
remove => HookHandler._beforeset_maskMappingWorldAxis -= value;
}
...
public static event Delegates.SetMaskMappingAxisInMaterials_BeforeArgs SetMaskMappingAxisInMaterials
{
add
{

HookHandler._beforeSetMaskMappingAxisInMaterials += value;
HookHandler.HookSetMaskMappingAxisInMaterials();
}
remove => HookHandler._beforeSetMaskMappingAxisInMaterials -= value;
}
public static event Delegates.SetMaskMappingAxisInMaterial_BeforeArgs SetMaskMappingAxisInMaterial
{
add
{

HookHandler._beforeSetMaskMappingAxisInMaterial += value;
HookHandler.HookSetMaskMappingAxisInMaterial();
}
remove => HookHandler._beforeSetMaskMappingAxisInMaterial -= value;
}
...
public static event Delegates.ChangeMappingAxis_BeforeArgs ChangeMappingAxis
{
add
{

HookHandler._beforeChangeMappingAxis += value;
HookHandler.HookChangeMappingAxis();
}
remove => HookHandler._beforeChangeMappingAxis -= value;
}
}
...
{
public static event Delegates.set_maskMappingWorldAxis_AfterArgs set_maskMappingWorldAxis
{
add
{

HookHandler._afterset_maskMappingWorldAxis += value;
HookHandler.Hookset_maskMappingWorldAxis();
}
remove => HookHandler._afterset_maskMappingWorldAxis -= value;
}
...
public static event Delegates.SetMaskMappingAxisInMaterials_AfterArgs SetMaskMappingAxisInMaterials
{
add
{

HookHandler._afterSetMaskMappingAxisInMaterials += value;
HookHandler.HookSetMaskMappingAxisInMaterials();
}
remove => HookHandler._afterSetMaskMappingAxisInMaterials -= value;
}
public static event Delegates.SetMaskMappingAxisInMaterial_AfterArgs SetMaskMappingAxisInMaterial
{
add
{

HookHandler._afterSetMaskMappingAxisInMaterial += value;
HookHandler.HookSetMaskMappingAxisInMaterial();
}
remove => HookHandler._afterSetMaskMappingAxisInMaterial -= value;
}
...
public static event Delegates.ChangeMappingAxis_AfterArgs ChangeMappingAxis
{
add
{

HookHandler._afterChangeMappingAxis += value;
HookHandler.HookChangeMappingAxis();
}
remove => HookHandler._afterChangeMappingAxis -= value;
}
}
...
{
public static event Delegates.set_maskMappingWorldAxis_WithArgs set_maskMappingWorldAxis
{
add => HookEndpointManager.Add<Delegates.set_maskMappingWorldAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_maskMappingWorldAxis", true), value);
remove => HookEndpointManager.Remove<Delegates.set_maskMappingWorldAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_maskMappingWorldAxis", true), value);
}
public static event Delegates.get_invertAxis_WithArgs get_invertAxis
{
add => HookEndpointManager.Add<Delegates.get_invertAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_invertAxis", true), value);
remove => HookEndpointManager.Remove<Delegates.get_invertAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_invertAxis", true), value);
}
public static event Delegates.set_invertAxis_WithArgs set_invertAxis
{
add => HookEndpointManager.Add<Delegates.set_invertAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_invertAxis", true), value);
remove => HookEndpointManager.Remove<Delegates.set_invertAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_invertAxis", true), value);
}
public static event Delegates.get_clampAlphaHorizontally_WithArgs get_clampAlphaHorizontally
{
add => HookEndpointManager.Add<Delegates.get_clampAlphaHorizontally_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampAlphaHorizontally", true), value);
remove => HookEndpointManager.Remove<Delegates.get_clampAlphaHorizontally_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampAlphaHorizontally", true), value);
}
public static event Delegates.set_clampAlphaHorizontally_WithArgs set_clampAlphaHorizontally
{
add => HookEndpointManager.Add<Delegates.set_clampAlphaHorizontally_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampAlphaHorizontally", true), value);
remove => HookEndpointManager.Remove<Delegates.set_clampAlphaHorizontally_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampAlphaHorizontally", true), value);
}
public static event Delegates.get_clampAlphaVertically_WithArgs get_clampAlphaVertically
{
add => HookEndpointManager.Add<Delegates.get_clampAlphaVertically_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampAlphaVertically", true), value);
remove => HookEndpointManager.Remove<Delegates.get_clampAlphaVertically_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampAlphaVertically", true), value);
}
public static event Delegates.set_clampAlphaVertically_WithArgs set_clampAlphaVertically
{
add => HookEndpointManager.Add<Delegates.set_clampAlphaVertically_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampAlphaVertically", true), value);
remove => HookEndpointManager.Remove<Delegates.set_clampAlphaVertically_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampAlphaVertically", true), value);
}
public static event Delegates.get_clampingBorder_WithArgs get_clampingBorder
{
add => HookEndpointManager.Add<Delegates.get_clampingBorder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampingBorder", true), value);
remove => HookEndpointManager.Remove<Delegates.get_clampingBorder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_clampingBorder", true), value);
}
public static event Delegates.set_clampingBorder_WithArgs set_clampingBorder
{
add => HookEndpointManager.Add<Delegates.set_clampingBorder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampingBorder", true), value);
remove => HookEndpointManager.Remove<Delegates.set_clampingBorder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_clampingBorder", true), value);
}
public static event Delegates.get_useMaskAlphaChannel_WithArgs get_useMaskAlphaChannel
{
add => HookEndpointManager.Add<Delegates.get_useMaskAlphaChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_useMaskAlphaChannel", true), value);
remove => HookEndpointManager.Remove<Delegates.get_useMaskAlphaChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "get_useMaskAlphaChannel", true), value);
}
public static event Delegates.set_useMaskAlphaChannel_WithArgs set_useMaskAlphaChannel
{
add => HookEndpointManager.Add<Delegates.set_useMaskAlphaChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_useMaskAlphaChannel", true), value);
remove => HookEndpointManager.Remove<Delegates.set_useMaskAlphaChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "set_useMaskAlphaChannel", true), value);
}
public static event Delegates.Start_WithArgs Start
{
add => HookEndpointManager.Add<Delegates.Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "Start", true), value);
remove => HookEndpointManager.Remove<Delegates.Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "Start", true), value);
}
public static event Delegates.Update_WithArgs Update
{
add => HookEndpointManager.Add<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "Update", true), value);
remove => HookEndpointManager.Remove<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "Update", true), value);
}
public static event Delegates.RotateVector_WithArgs RotateVector
{
add => HookEndpointManager.Add<Delegates.RotateVector_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "RotateVector", true), value);
remove => HookEndpointManager.Remove<Delegates.RotateVector_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "RotateVector", true), value);
}
public static event Delegates.SetMaskMappingAxisInMaterials_WithArgs SetMaskMappingAxisInMaterials
{
add => HookEndpointManager.Add<Delegates.SetMaskMappingAxisInMaterials_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskMappingAxisInMaterials", true), value);
remove => HookEndpointManager.Remove<Delegates.SetMaskMappingAxisInMaterials_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskMappingAxisInMaterials", true), value);
}
public static event Delegates.SetMaskMappingAxisInMaterial_WithArgs SetMaskMappingAxisInMaterial
{
add => HookEndpointManager.Add<Delegates.SetMaskMappingAxisInMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskMappingAxisInMaterial", true), value);
remove => HookEndpointManager.Remove<Delegates.SetMaskMappingAxisInMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskMappingAxisInMaterial", true), value);
}
public static event Delegates.SetMaskFloatValueInMaterials_WithArgs SetMaskFloatValueInMaterials
{
add => HookEndpointManager.Add<Delegates.SetMaskFloatValueInMaterials_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskFloatValueInMaterials", true), value);
remove => HookEndpointManager.Remove<Delegates.SetMaskFloatValueInMaterials_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskFloatValueInMaterials", true), value);
}
public static event Delegates.SetMaskBoolValueInMaterials_WithArgs SetMaskBoolValueInMaterials
{
add => HookEndpointManager.Add<Delegates.SetMaskBoolValueInMaterials_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskBoolValueInMaterials", true), value);
remove => HookEndpointManager.Remove<Delegates.SetMaskBoolValueInMaterials_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskBoolValueInMaterials", true), value);
}
public static event Delegates.SetMaskBoolValueInMaterial_WithArgs SetMaskBoolValueInMaterial
{
add => HookEndpointManager.Add<Delegates.SetMaskBoolValueInMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskBoolValueInMaterial", true), value);
remove => HookEndpointManager.Remove<Delegates.SetMaskBoolValueInMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskBoolValueInMaterial", true), value);
}
public static event Delegates.CreateAndAssignQuad_WithArgs CreateAndAssignQuad
{
add => HookEndpointManager.Add<Delegates.CreateAndAssignQuad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "CreateAndAssignQuad", true), value);
remove => HookEndpointManager.Remove<Delegates.CreateAndAssignQuad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "CreateAndAssignQuad", true), value);
}
public static event Delegates.SetMaskRendererActive_WithArgs SetMaskRendererActive
{
add => HookEndpointManager.Add<Delegates.SetMaskRendererActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskRendererActive", true), value);
remove => HookEndpointManager.Remove<Delegates.SetMaskRendererActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "SetMaskRendererActive", true), value);
}
public static event Delegates.ChangeMappingAxis_WithArgs ChangeMappingAxis
{
add => HookEndpointManager.Add<Delegates.ChangeMappingAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "ChangeMappingAxis", true), value);
remove => HookEndpointManager.Remove<Delegates.ChangeMappingAxis_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ToJ.Mask), "ChangeMappingAxis", true), value);
}
}
