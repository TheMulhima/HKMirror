...
public static class OnArrayListGetVertexColors
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListGetVertexColors),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayListGetVertexColors> orig,
            HutongGames.PlayMaker.Actions.ArrayListGetVertexColors self)
        {
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayListGetVertexColors> orig,
            HutongGames.PlayMaker.Actions.ArrayListGetVertexColors self)
        {
        ...
        internal static void HookgetVertexColors()
        {
            if (!HookedList.Contains("getVertexColors"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListGetVertexColors),
                        "getVertexColors", true), getVertexColors);
            }
        }
        ...
        private static void getVertexColors(Action<HutongGames.PlayMaker.Actions.ArrayListGetVertexColors> orig,
            HutongGames.PlayMaker.Actions.ArrayListGetVertexColors self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListGetVertexColors> orig,
            HutongGames.PlayMaker.Actions.ArrayListGetVertexColors self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListGetVertexColors> orig,
            HutongGames.PlayMaker.Actions.ArrayListGetVertexColors self);
        ...
        public delegate void getVertexColors_WithArgs(
            Action<HutongGames.PlayMaker.Actions.ArrayListGetVertexColors> orig,
            HutongGames.PlayMaker.Actions.ArrayListGetVertexColors self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListGetVertexColors), "Reset",
                    true), value);
