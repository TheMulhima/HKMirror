...
public static class OnIntTestToBool
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<IntTestToBool> orig, IntTestToBool self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<IntTestToBool> orig, IntTestToBool self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<IntTestToBool> orig, IntTestToBool self)
        {
        ...
        internal static void HookDoCompare()
        {
            if (!HookedList.Contains("DoCompare"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "DoCompare"), DoCompare);
            }
        }
        ...
        private static void DoCompare(Action<IntTestToBool> orig, IntTestToBool self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoCompare_WithArgs(Action<IntTestToBool> orig, IntTestToBool self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<IntTestToBool> orig, IntTestToBool self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<IntTestToBool> orig, IntTestToBool self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<IntTestToBool> orig, IntTestToBool self);

        public sealed class Params_Reset
        {
            public IntTestToBool self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "OnUpdate"), value);
        ...
        public static event Delegates.DoCompare_WithArgs DoCompare
        {
            add => HookEndpointManager.Add<Delegates.DoCompare_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IntTestToBool), "DoCompare"), value);
