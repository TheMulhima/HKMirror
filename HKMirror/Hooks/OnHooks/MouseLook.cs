...
public static class OnMouseLook
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self)
        {
        ...
        internal static void HookDoMouseLook()
        {
            if (!HookedList.Contains("DoMouseLook"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "DoMouseLook",
                        true), DoMouseLook);
            }
        }
        ...
        private static void DoMouseLook(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self)
        {
        ...
        internal static void HookGetXRotation()
        {
            if (!HookedList.Contains("GetXRotation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "GetXRotation",
                        true), GetXRotation);
            }
        }
        ...
        private static float GetXRotation(Func<HutongGames.PlayMaker.Actions.MouseLook, float> orig,
            HutongGames.PlayMaker.Actions.MouseLook self)
        {
        ...
        internal static void HookGetYRotation()
        {
            if (!HookedList.Contains("GetYRotation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "GetYRotation",
                        true), GetYRotation);
            }
        }
        ...
        private static float GetYRotation(Func<HutongGames.PlayMaker.Actions.MouseLook, float> orig,
            HutongGames.PlayMaker.Actions.MouseLook self)
        {
        ...
        internal static void HookClampAngle()
        {
            if (!HookedList.Contains("ClampAngle"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "ClampAngle",
                        false), ClampAngle);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self);
        ...
        public delegate void DoMouseLook_WithArgs(Action<HutongGames.PlayMaker.Actions.MouseLook> orig,
            HutongGames.PlayMaker.Actions.MouseLook self);
        ...
        public delegate float GetXRotation_WithArgs(Func<HutongGames.PlayMaker.Actions.MouseLook, float> orig,
            HutongGames.PlayMaker.Actions.MouseLook self);
        ...
        public delegate float GetYRotation_WithArgs(Func<HutongGames.PlayMaker.Actions.MouseLook, float> orig,
            HutongGames.PlayMaker.Actions.MouseLook self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "Reset", true), value);
        ...
        public static event Delegates.DoMouseLook_WithArgs DoMouseLook
        {
            add => HookEndpointManager.Add<Delegates.DoMouseLook_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "DoMouseLook", true),
                value);
        ...
        public static event Delegates.GetXRotation_WithArgs GetXRotation
        {
            add => HookEndpointManager.Add<Delegates.GetXRotation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "GetXRotation", true),
                value);
        ...
        public static event Delegates.GetYRotation_WithArgs GetYRotation
        {
            add => HookEndpointManager.Add<Delegates.GetYRotation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "GetYRotation", true),
                value);
        ...
        public static event Delegates.ClampAngle_WithArgs ClampAngle
        {
            add => HookEndpointManager.Add<Delegates.ClampAngle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.MouseLook), "ClampAngle", false),
                value);
