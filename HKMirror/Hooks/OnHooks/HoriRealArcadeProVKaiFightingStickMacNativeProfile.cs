...
public static class OnHoriRealArcadeProVKaiFightingStickMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.HoriRealArcadeProVKaiFightingStickMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.HoriRealArcadeProVKaiFightingStickMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.HoriRealArcadeProVKaiFightingStickMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.HoriRealArcadeProVKaiFightingStickMacNativeProfile), "Define",
                    true), value);
