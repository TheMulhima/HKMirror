...
public static class OnHoriRealArcadeProVKaiFightingStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HoriRealArcadeProVKaiFightingStickMacNativeProfile),
                        "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HoriRealArcadeProVKaiFightingStickMacNativeProfile> orig,
            HoriRealArcadeProVKaiFightingStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriRealArcadeProVKaiFightingStickMacNativeProfile> orig,
            HoriRealArcadeProVKaiFightingStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriRealArcadeProVKaiFightingStickMacNativeProfile self;
        }
    }
