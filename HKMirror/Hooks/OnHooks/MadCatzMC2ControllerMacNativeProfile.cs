...
public static class OnMadCatzMC2ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzMC2ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzMC2ControllerMacNativeProfile> orig,
            MadCatzMC2ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzMC2ControllerMacNativeProfile> orig,
            MadCatzMC2ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzMC2ControllerMacNativeProfile self;
        }
    }
