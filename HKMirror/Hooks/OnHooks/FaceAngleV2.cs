...
public static class OnFaceAngleV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<FaceAngleV2> orig, FaceAngleV2 self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<FaceAngleV2> orig, FaceAngleV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<FaceAngleV2> orig, FaceAngleV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<FaceAngleV2> orig, FaceAngleV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<FaceAngleV2> orig, FaceAngleV2 self)
        {
        ...
        internal static void HookDoAngle()
        {
            if (!HookedList.Contains("DoAngle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "DoAngle"), DoAngle);
            }
        }
        ...
        private static void DoAngle(Action<FaceAngleV2> orig, FaceAngleV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<FaceAngleV2> orig, FaceAngleV2 self);

        public delegate void DoAngle_AfterArgs(Params_DoAngle args);

        public delegate void DoAngle_BeforeArgs(Params_DoAngle args);

        public delegate void DoAngle_WithArgs(Action<FaceAngleV2> orig, FaceAngleV2 self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<FaceAngleV2> orig, FaceAngleV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<FaceAngleV2> orig, FaceAngleV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<FaceAngleV2> orig, FaceAngleV2 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<FaceAngleV2> orig, FaceAngleV2 self);

        public sealed class Params_Reset
        {
            public FaceAngleV2 self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "Awake"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoAngle_WithArgs DoAngle
        {
            add => HookEndpointManager.Add<Delegates.DoAngle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngleV2), "DoAngle"), value);
