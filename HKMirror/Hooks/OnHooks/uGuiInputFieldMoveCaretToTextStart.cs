...
public static class OnuGuiInputFieldMoveCaretToTextStart
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart self)
        {
        ...
        internal static void HookDoAction()
        {
            if (!HookedList.Contains("DoAction"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart), "DoAction", true),
                    DoAction);
            }
        }
        ...
        private static void DoAction(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldMoveCaretToTextStart),
                    "Reset", true), value);
