...
private static void startInvulnerablePulse(On.InvulnerablePulse.orig_startInvulnerablePulse orig,InvulnerablePulse self)
{
...
{
foreach (Delegates.startInvulnerablePulse_BeforeArgs toInvoke in _beforestartInvulnerablePulse.GetInvocationList())
{
try
{
...
{
foreach (Delegates.startInvulnerablePulse_AfterArgs toInvoke in _afterstartInvulnerablePulse.GetInvocationList())
{
try
{
...
private static void stopInvulnerablePulse(On.InvulnerablePulse.orig_stopInvulnerablePulse orig,InvulnerablePulse self)
{
...
{
foreach (Delegates.stopInvulnerablePulse_BeforeArgs toInvoke in _beforestopInvulnerablePulse.GetInvocationList())
{
try
{
...
{
foreach (Delegates.stopInvulnerablePulse_AfterArgs toInvoke in _afterstopInvulnerablePulse.GetInvocationList())
{
try
{
...
private static void updateSpriteColor(On.InvulnerablePulse.orig_updateSpriteColor orig,InvulnerablePulse self,  UnityEngine.Color color)
{
...
public delegate void updateSpriteColor_WithArgs (Action<InvulnerablePulse,  UnityEngine.Color> orig, InvulnerablePulse self,  UnityEngine.Color color);
}
