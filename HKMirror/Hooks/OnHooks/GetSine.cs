...
public static class OnGetSine
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self)
        {
        ...
        internal static void HookDoSine()
        {
            if (!HookedList.Contains("DoSine"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "DoSine", true),
                    DoSine);
            }
        }
        ...
        private static void DoSine(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self);
        ...
        public delegate void DoSine_WithArgs(Action<HutongGames.PlayMaker.Actions.GetSine> orig,
            HutongGames.PlayMaker.Actions.GetSine self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "Reset", true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "OnEnter", true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "OnUpdate", true), value);
        ...
        public static event Delegates.DoSine_WithArgs DoSine
        {
            add => HookEndpointManager.Add<Delegates.DoSine_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetSine), "DoSine", true), value);
