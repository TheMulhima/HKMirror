...
public static class OnTk2dSetAnimationFrameRate
{
    internal static class HookHandler
    {
        ...
        internal static void Hook_getSprite()
        {
            if (!HookedList.Contains("_getSprite"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSetAnimationFrameRate), "_getSprite"), _getSprite);
            }
        }
        ...
        private static void _getSprite(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self)
        {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSetAnimationFrameRate), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSetAnimationFrameRate), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSetAnimationFrameRate), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self)
        {
        ...
        internal static void HookDoSetAnimationFPS()
        {
            if (!HookedList.Contains("DoSetAnimationFPS"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dSetAnimationFrameRate), "DoSetAnimationFPS"),
                    DoSetAnimationFPS);
            }
        }
        ...
        private static void DoSetAnimationFPS(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self)
        {
            ...
            if (_beforeDoSetAnimationFPS != null)
                foreach (Delegates.DoSetAnimationFPS_BeforeArgs toInvoke in
                         _beforeDoSetAnimationFPS.GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void _getSprite_WithArgs(Action<Tk2dSetAnimationFrameRate> orig,
            Tk2dSetAnimationFrameRate self);
        ...
        public delegate void DoSetAnimationFPS_WithArgs(Action<Tk2dSetAnimationFrameRate> orig,
            Tk2dSetAnimationFrameRate self);
        ...
        public delegate void OnEnter_WithArgs(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Tk2dSetAnimationFrameRate> orig, Tk2dSetAnimationFrameRate self);

        public sealed class Params__getSprite
        {
            public Tk2dSetAnimationFrameRate self;
        }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoSetAnimationFPS_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSetAnimationFrameRate), "DoSetAnimationFPS"), value);
            remove => HookEndpointManager.Remove<Delegates.DoSetAnimationFPS_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dSetAnimationFrameRate), "DoSetAnimationFPS"), value);
        }
    }
}