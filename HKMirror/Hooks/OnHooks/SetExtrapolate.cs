...
public static class OnSetExtrapolate
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetExtrapolate), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetExtrapolate> orig,
            HutongGames.PlayMaker.Actions.SetExtrapolate self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetExtrapolate), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetExtrapolate> orig,
            HutongGames.PlayMaker.Actions.SetExtrapolate self)
        {
        ...
        internal static void HookDoSetExtrapolate()
        {
            if (!HookedList.Contains("DoSetExtrapolate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetExtrapolate),
        ...
        private static void DoSetExtrapolate(Action<HutongGames.PlayMaker.Actions.SetExtrapolate> orig,
            HutongGames.PlayMaker.Actions.SetExtrapolate self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetExtrapolate> orig,
            HutongGames.PlayMaker.Actions.SetExtrapolate self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetExtrapolate> orig,
            HutongGames.PlayMaker.Actions.SetExtrapolate self);
        ...
        public delegate void DoSetExtrapolate_WithArgs(Action<HutongGames.PlayMaker.Actions.SetExtrapolate> orig,
            HutongGames.PlayMaker.Actions.SetExtrapolate self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetExtrapolate), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoSetExtrapolate_WithArgs DoSetExtrapolate
        {
            add => HookEndpointManager.Add<Delegates.DoSetExtrapolate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetExtrapolate), "DoSetExtrapolate",
                    true), value);
