...
public static class OnMogaProAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MogaProAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MogaProAndroidUnityProfile> orig, MogaProAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MogaProAndroidUnityProfile> orig, MogaProAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public MogaProAndroidUnityProfile self;
        }
    }
