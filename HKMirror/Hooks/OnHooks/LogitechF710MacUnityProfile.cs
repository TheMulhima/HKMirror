...
public static class OnLogitechF710MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710MacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710MacUnityProfile> orig, LogitechF710MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710MacUnityProfile> orig,
            LogitechF710MacUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF710MacUnityProfile self;
        }
    }
