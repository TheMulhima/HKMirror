...
public static class OnXboxOneSBluetoothMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneSBluetoothMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneSBluetoothMacNativeProfile> orig,
            XboxOneSBluetoothMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneSBluetoothMacNativeProfile> orig,
            XboxOneSBluetoothMacNativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneSBluetoothMacNativeProfile self;
        }
    }
