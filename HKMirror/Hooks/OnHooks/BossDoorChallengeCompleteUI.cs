...
private static System.Collections.IEnumerator ShowAchievements(On.BossDoorChallengeCompleteUI.orig_ShowAchievements orig,BossDoorChallengeCompleteUI self)
{
...
private static System.Collections.IEnumerator Sequence(On.BossDoorChallengeCompleteUI.orig_Sequence orig,BossDoorChallengeCompleteUI self)
{
...
public delegate void Update_WithArgs (Action<BossDoorChallengeCompleteUI> orig, BossDoorChallengeCompleteUI self);
public sealed class Params_ShowAchievements
{
public BossDoorChallengeCompleteUI self;
}
public delegate void ShowAchievements_BeforeArgs(Params_ShowAchievements args);
public delegate System.Collections.IEnumerator ShowAchievements_AfterArgs(Params_ShowAchievements args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ShowAchievements_WithArgs (Func<BossDoorChallengeCompleteUI, System.Collections.IEnumerator> orig, BossDoorChallengeCompleteUI self);
public sealed class Params_Sequence
{
public BossDoorChallengeCompleteUI self;
}
public delegate void Sequence_BeforeArgs(Params_Sequence args);
public delegate System.Collections.IEnumerator Sequence_AfterArgs(Params_Sequence args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Sequence_WithArgs (Func<BossDoorChallengeCompleteUI, System.Collections.IEnumerator> orig, BossDoorChallengeCompleteUI self);
}
