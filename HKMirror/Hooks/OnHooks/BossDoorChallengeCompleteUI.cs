...
public static class OnBossDoorChallengeCompleteUI
{
    ...
    {
        public delegate IEnumerator Sequence_AfterArgs(Params_Sequence args, IEnumerator ret);

        public delegate void Sequence_BeforeArgs(Params_Sequence args);

        public delegate IEnumerator Sequence_WithArgs(Func<BossDoorChallengeCompleteUI, IEnumerator> orig,
            BossDoorChallengeCompleteUI self);

        public delegate IEnumerator ShowAchievements_AfterArgs(Params_ShowAchievements args, IEnumerator ret);

        public delegate void ShowAchievements_BeforeArgs(Params_ShowAchievements args);

        public delegate IEnumerator ShowAchievements_WithArgs(Func<BossDoorChallengeCompleteUI, IEnumerator> orig,
            BossDoorChallengeCompleteUI self);
