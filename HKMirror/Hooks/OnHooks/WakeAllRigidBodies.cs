...
public static class OnWakeAllRigidBodies
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self)
        {
        ...
        internal static void HookDoWakeAll()
        {
            if (!HookedList.Contains("DoWakeAll"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies),
        ...
        private static void DoWakeAll(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self);
        ...
        public delegate void DoWakeAll_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies), "Reset", true),
                value);
        ...
        public static event Delegates.DoWakeAll_WithArgs DoWakeAll
        {
            add => HookEndpointManager.Add<Delegates.DoWakeAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies), "DoWakeAll",
                    true), value);
