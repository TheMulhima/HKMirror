...
public static class OnPlayMakerAnimatorStateSynchronization
{
    ...
    public static class Delegates
    {
        ...
        public delegate void RegisterHash_WithArgs(Action<PlayMakerAnimatorStateSynchronization, string, FsmState> orig,
            PlayMakerAnimatorStateSynchronization self, string key, FsmState state);
        ...
        public delegate void SwitchState_WithArgs(Action<PlayMakerAnimatorStateSynchronization, Fsm, FsmState> orig,
            PlayMakerAnimatorStateSynchronization self, Fsm fsm, FsmState state);
