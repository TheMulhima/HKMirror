...
private static void Start(On.PlayMakerAnimatorStateSynchronization.orig_Start orig,PlayMakerAnimatorStateSynchronization self)
{
...
private static void RegisterHash(On.PlayMakerAnimatorStateSynchronization.orig_RegisterHash orig,PlayMakerAnimatorStateSynchronization self,  string key,  HutongGames.PlayMaker.FsmState state)
{
...
private static void Update(On.PlayMakerAnimatorStateSynchronization.orig_Update orig,PlayMakerAnimatorStateSynchronization self)
{
...
private static void Synchronize(On.PlayMakerAnimatorStateSynchronization.orig_Synchronize orig,PlayMakerAnimatorStateSynchronization self)
{
...
private static void SwitchState(On.PlayMakerAnimatorStateSynchronization.orig_SwitchState orig,PlayMakerAnimatorStateSynchronization self,  HutongGames.PlayMaker.Fsm fsm,  HutongGames.PlayMaker.FsmState state)
{
...
public delegate void Start_WithArgs (Action<PlayMakerAnimatorStateSynchronization> orig, PlayMakerAnimatorStateSynchronization self);
...
public delegate void RegisterHash_WithArgs (Action<PlayMakerAnimatorStateSynchronization,  string,  HutongGames.PlayMaker.FsmState> orig, PlayMakerAnimatorStateSynchronization self,  string key,  HutongGames.PlayMaker.FsmState state);
...
public delegate void Update_WithArgs (Action<PlayMakerAnimatorStateSynchronization> orig, PlayMakerAnimatorStateSynchronization self);
...
public delegate void Synchronize_WithArgs (Action<PlayMakerAnimatorStateSynchronization> orig, PlayMakerAnimatorStateSynchronization self);
...
public delegate void SwitchState_WithArgs (Action<PlayMakerAnimatorStateSynchronization,  HutongGames.PlayMaker.Fsm,  HutongGames.PlayMaker.FsmState> orig, PlayMakerAnimatorStateSynchronization self,  HutongGames.PlayMaker.Fsm fsm,  HutongGames.PlayMaker.FsmState state);
}
