...
public static class OnJoytekXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.JoytekXbox360ControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.JoytekXbox360ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.JoytekXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.JoytekXbox360ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.JoytekXbox360ControllerMacNativeProfile self);
    }
