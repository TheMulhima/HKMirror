...
public static class OnClearSaveButton
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnSubmit()
        {
            if (!HookedList.Contains("OnSubmit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ClearSaveButton), "OnSubmit", true),
                    OnSubmit);
            }
        }
        ...
        private static void OnSubmit(
            Action<UnityEngine.UI.ClearSaveButton, UnityEngine.EventSystems.BaseEventData> orig,
            UnityEngine.UI.ClearSaveButton self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookOnPointerClick()
        {
            if (!HookedList.Contains("OnPointerClick"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ClearSaveButton), "OnPointerClick", true),
                    OnPointerClick);
            }
        }
        ...
        private static void OnPointerClick(
            Action<UnityEngine.UI.ClearSaveButton, UnityEngine.EventSystems.PointerEventData> orig,
            UnityEngine.UI.ClearSaveButton self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookOnSelect()
        {
            if (!HookedList.Contains("OnSelect"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ClearSaveButton), "OnSelect", true),
                    OnSelect);
            }
        }
        ...
        internal static void HookSelectAfterFrame()
        {
            if (!HookedList.Contains("SelectAfterFrame"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ClearSaveButton), "SelectAfterFrame", true),
                    SelectAfterFrame);
            }
        }
        ...
        private static System.Collections.IEnumerator SelectAfterFrame(
            Func<UnityEngine.UI.ClearSaveButton, UnityEngine.GameObject, System.Collections.IEnumerator> orig,
            UnityEngine.UI.ClearSaveButton self, UnityEngine.GameObject gameObject)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate System.Collections.IEnumerator SelectAfterFrame_AfterArgs(Params_SelectAfterFrame args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator SelectAfterFrame_WithArgs(
            Func<UnityEngine.UI.ClearSaveButton, UnityEngine.GameObject, System.Collections.IEnumerator> orig,
            UnityEngine.UI.ClearSaveButton self, UnityEngine.GameObject gameObject);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnSubmit_WithArgs OnSubmit
        {
            add => HookEndpointManager.Add<Delegates.OnSubmit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ClearSaveButton), "OnSubmit", true), value);
        ...
        public static event Delegates.OnPointerClick_WithArgs OnPointerClick
        {
            add => HookEndpointManager.Add<Delegates.OnPointerClick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ClearSaveButton), "OnPointerClick", true), value);
        ...
        public static event Delegates.OnSelect_WithArgs OnSelect
        {
            add => HookEndpointManager.Add<Delegates.OnSelect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ClearSaveButton), "OnSelect", true), value);
