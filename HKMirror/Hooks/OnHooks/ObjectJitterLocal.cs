...
public static class OnObjectJitterLocal
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitterLocal), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitterLocal),
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitterLocal), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self)
        {
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self)
        {
        ...
        private static void DoTranslate(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self);
        ...
        public delegate void DoTranslate_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitterLocal> orig,
            HutongGames.PlayMaker.Actions.ObjectJitterLocal self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitterLocal), "Reset", true),
                value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitterLocal), "OnPreprocess",
                    true), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitterLocal), "OnFixedUpdate",
                    true), value);
        ...
        public static event Delegates.DoTranslate_WithArgs DoTranslate
        {
            add => HookEndpointManager.Add<Delegates.DoTranslate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitterLocal), "DoTranslate",
                    true), value);
