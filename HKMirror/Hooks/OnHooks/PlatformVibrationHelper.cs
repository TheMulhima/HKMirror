...
private static void UpdateVibration(On.PlatformVibrationHelper.orig_UpdateVibration orig,PlatformVibrationHelper self)
{
...
private static VibrationMixer GetMixer(On.PlatformVibrationHelper.orig_GetMixer orig,PlatformVibrationHelper self)
{
...
public delegate void UpdateVibration_WithArgs (Action<PlatformVibrationHelper> orig, PlatformVibrationHelper self);
...
public delegate VibrationMixer GetMixer_WithArgs (Func<PlatformVibrationHelper, VibrationMixer> orig, PlatformVibrationHelper self);
}
