...
public static class OnXboxOneMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneMacUnityProfile> orig, XboxOneMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneMacUnityProfile> orig, XboxOneMacUnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneMacUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(XboxOneMacUnityProfile), "Define"), value);
