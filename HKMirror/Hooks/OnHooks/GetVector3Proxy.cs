    ...
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVector3Proxy), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static UnityEngine.Vector3 Invoke(
            Func<Modding.Delegates.GetVector3Proxy, string, UnityEngine.Vector3, UnityEngine.Vector3> orig,
            Modding.Delegates.GetVector3Proxy self, string name, UnityEngine.Vector3 orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVector3Proxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static UnityEngine.Vector3 EndInvoke(
            Func<Modding.Delegates.GetVector3Proxy, System.IAsyncResult, UnityEngine.Vector3> orig,
            Modding.Delegates.GetVector3Proxy self, System.IAsyncResult result)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVector3Proxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetVector3Proxy), "EndInvoke", true), value);
