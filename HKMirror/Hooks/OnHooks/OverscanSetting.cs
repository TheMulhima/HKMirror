...
private static void UpdateTextValue(On.OverscanSetting.orig_UpdateTextValue orig,OverscanSetting self,  float value)
{
...
private static void RefreshValueFromSettings(On.OverscanSetting.orig_RefreshValueFromSettings orig,OverscanSetting self)
{
...
public delegate void UpdateTextValue_WithArgs (Action<OverscanSetting,  float> orig, OverscanSetting self,  float value);
...
public delegate void SetOverscan_WithArgs (Action<OverscanSetting,  float> orig, OverscanSetting self,  float value);
