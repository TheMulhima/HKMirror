...
public static class OnPS4SimpleInputDeviceManager
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Device()
        {
            if (!HookedList.Contains("get_Device"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "get_Device", true),
                    get_Device);
            }
        }
        ...
        private static InControl.PS4SimpleInputDevice get_Device(
            Func<InControl.PS4SimpleInputDeviceManager, InControl.PS4SimpleInputDevice> orig,
            InControl.PS4SimpleInputDeviceManager self)
        {
        ...
        internal static void HookUpdate()
        {
            if (!HookedList.Contains("Update"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Update", true),
                    Update);
            }
        }
        ...
        private static void Update(Action<InControl.PS4SimpleInputDeviceManager, ulong, float> orig,
            InControl.PS4SimpleInputDeviceManager self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookCheckPlatformSupport()
        {
            if (!HookedList.Contains("CheckPlatformSupport"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager),
        ...
        internal static void HookEnable()
        {
            if (!HookedList.Contains("Enable"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Enable", false),
                    Enable);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate InControl.PS4SimpleInputDevice get_Device_AfterArgs(Params_get_Device args,
            InControl.PS4SimpleInputDevice ret);

        public delegate InControl.PS4SimpleInputDevice get_Device_WithArgs(
            Func<InControl.PS4SimpleInputDeviceManager, InControl.PS4SimpleInputDevice> orig,
            InControl.PS4SimpleInputDeviceManager self);
        ...
        public delegate void Update_WithArgs(Action<InControl.PS4SimpleInputDeviceManager, ulong, float> orig,
            InControl.PS4SimpleInputDeviceManager self, ulong updateTick, float deltaTime);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Update", true), value);
        ...
        public static event Delegates.CheckPlatformSupport_WithArgs CheckPlatformSupport
        {
            add => HookEndpointManager.Add<Delegates.CheckPlatformSupport_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "CheckPlatformSupport",
                    false), value);
        ...
        public static event Delegates.Enable_WithArgs Enable
        {
            add => HookEndpointManager.Add<Delegates.Enable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Enable", false), value);
