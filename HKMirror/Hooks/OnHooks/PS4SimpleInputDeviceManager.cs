...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "get_Device", true), get_Device);
...
private static InControl.PS4SimpleInputDevice get_Device(Func<InControl.PS4SimpleInputDeviceManager, InControl.PS4SimpleInputDevice> orig, InControl.PS4SimpleInputDeviceManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Update", true), Update);

}
}
internal static event Delegates.Update_BeforeArgs _beforeUpdate;
internal static event Delegates.Update_AfterArgs _afterUpdate;
private static void Update(Action<InControl.PS4SimpleInputDeviceManager,  ulong,  float> orig, InControl.PS4SimpleInputDeviceManager self,  ulong updateTick,  float deltaTime)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "CheckPlatformSupport", false), CheckPlatformSupport);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Enable", false), Enable);
...
{
public InControl.PS4SimpleInputDeviceManager self;
}
public delegate void get_Device_BeforeArgs(Params_get_Device args);
public delegate InControl.PS4SimpleInputDevice get_Device_AfterArgs(Params_get_Device args, InControl.PS4SimpleInputDevice ret);
public delegate InControl.PS4SimpleInputDevice get_Device_WithArgs (Func<InControl.PS4SimpleInputDeviceManager, InControl.PS4SimpleInputDevice> orig, InControl.PS4SimpleInputDeviceManager self);
...
public delegate void Update_WithArgs (Action<InControl.PS4SimpleInputDeviceManager,  ulong,  float> orig, InControl.PS4SimpleInputDeviceManager self,  ulong updateTick,  float deltaTime);
...
{
add => HookEndpointManager.Add<Delegates.get_Device_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "get_Device", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Device_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "get_Device", true), value);
}
public static event Delegates.Update_WithArgs Update
{
add => HookEndpointManager.Add<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Update", true), value);
remove => HookEndpointManager.Remove<Delegates.Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Update", true), value);
}
public static event Delegates.CheckPlatformSupport_WithArgs CheckPlatformSupport
{
add => HookEndpointManager.Add<Delegates.CheckPlatformSupport_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "CheckPlatformSupport", false), value);
remove => HookEndpointManager.Remove<Delegates.CheckPlatformSupport_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "CheckPlatformSupport", false), value);
}
public static event Delegates.Enable_WithArgs Enable
{
add => HookEndpointManager.Add<Delegates.Enable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Enable", false), value);
remove => HookEndpointManager.Remove<Delegates.Enable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.PS4SimpleInputDeviceManager), "Enable", false), value);
}
}
