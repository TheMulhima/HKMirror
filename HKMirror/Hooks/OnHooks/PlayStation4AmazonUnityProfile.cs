...
public static class OnPlayStation4AmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4AmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4AmazonUnityProfile> orig, PlayStation4AmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4AmazonUnityProfile> orig,
            PlayStation4AmazonUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4AmazonUnityProfile self;
        }
    }
