...
public static class Ontk2dSpriteColliderDefinition
{
    ...
    public static class Delegates
    {
        ...
        public delegate Vector3 get_Size_AfterArgs(Params_get_Size args, Vector3 ret);

        public delegate void get_Size_BeforeArgs(Params_get_Size args);

        public delegate Vector3 get_Size_WithArgs(Func<tk2dSpriteColliderDefinition, Vector3> orig,
            tk2dSpriteColliderDefinition self);
