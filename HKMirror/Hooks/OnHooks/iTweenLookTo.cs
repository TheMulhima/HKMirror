...
public static class OniTweenLookTo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenLookTo), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenLookTo), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenLookTo), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenLookTo), "DoiTween",
                        true), DoiTween);
            }
        }
        ...
        private static void DoiTween(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self);
        ...
        public delegate void DoiTween_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenLookTo> orig,
            HutongGames.PlayMaker.Actions.iTweenLookTo self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenLookTo), "DoiTween", true),
                value);
