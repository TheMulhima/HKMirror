...
public static class OnAchievementIDMap
{
    internal static class HookHandler
    {
            ...
            AchievementIDMap self, string internalId)
        {
            ...
            {
                foreach (Delegates.GetServiceIdForInternalId_BeforeArgs toInvoke in _beforeGetServiceIdForInternalId
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetServiceIdForInternalId_AfterArgs toInvoke in _afterGetServiceIdForInternalId
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate int? GetServiceIdForInternalId_WithArgs(Func<AchievementIDMap, string, int?> orig,
            AchievementIDMap self, string internalId);
    }
