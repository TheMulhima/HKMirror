    ...
    internal static class HookHandler
    {
        ...
        internal static void HookOnSelect()
        {
            if (!HookedList.Contains("OnSelect"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButton), "OnSelect", true),
                    OnSelect);
            }
        }
        ...
        private static void OnSelect(
            Action<UnityEngine.UI.ControllerProfileButton, UnityEngine.EventSystems.BaseEventData> orig,
            UnityEngine.UI.ControllerProfileButton self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookOnDeselect()
        {
            if (!HookedList.Contains("OnDeselect"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButton), "OnDeselect", true),
                    OnDeselect);
            }
        }
        ...
        internal static void HookOnSubmit()
        {
            if (!HookedList.Contains("OnSubmit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButton), "OnSubmit", true),
                    OnSubmit);
            }
        }
        ...
        internal static void HookOnPointerClick()
        {
            if (!HookedList.Contains("OnPointerClick"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButton), "OnPointerClick",
                        true), OnPointerClick);
            }
        }
        ...
        private static void OnPointerClick(
            Action<UnityEngine.UI.ControllerProfileButton, UnityEngine.EventSystems.PointerEventData> orig,
            UnityEngine.UI.ControllerProfileButton self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookValidateDeselect()
        {
            if (!HookedList.Contains("ValidateDeselect"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButton), "ValidateDeselect",
        ...
        private static System.Collections.IEnumerator ValidateDeselect(
            Func<UnityEngine.UI.ControllerProfileButton, System.Collections.IEnumerator> orig,
            UnityEngine.UI.ControllerProfileButton self)
        {
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnPointerClick_WithArgs OnPointerClick
        {
            add => HookEndpointManager.Add<Delegates.OnPointerClick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.ControllerProfileButton), "OnPointerClick", true),
                value);
