...
public static class OnAirFloWiredPS3MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AirFloWiredPS3MacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AirFloWiredPS3MacUnityProfile> orig, AirFloWiredPS3MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AirFloWiredPS3MacUnityProfile> orig,
            AirFloWiredPS3MacUnityProfile self);

        public sealed class Params_Define
        {
            public AirFloWiredPS3MacUnityProfile self;
        }
    }
