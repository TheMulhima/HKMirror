...
public static class OnSendTrigger2DEvent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendTrigger2DEvent), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SendTrigger2DEvent> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendTrigger2DEvent), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SendTrigger2DEvent> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendTrigger2DEvent), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.SendTrigger2DEvent> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendTrigger2DEvent),
        ...
        private static void StoreCollisionInfo(
            Action<HutongGames.PlayMaker.Actions.SendTrigger2DEvent, UnityEngine.Collider2D> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self, UnityEngine.Collider2D collisionInfo)
        {
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.SendTrigger2DEvent, string> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SendTrigger2DEvent> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SendTrigger2DEvent> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.SendTrigger2DEvent> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.SendTrigger2DEvent, string> orig,
            HutongGames.PlayMaker.Actions.SendTrigger2DEvent self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendTrigger2DEvent), "Reset", true),
                value);
        ...
        public static event Delegates.ErrorCheck_WithArgs ErrorCheck
        {
            add => HookEndpointManager.Add<Delegates.ErrorCheck_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendTrigger2DEvent), "ErrorCheck",
                    true), value);
