...
public static class OnXTR55_G2_MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XTR55_G2_MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XTR55_G2_MacNativeProfile> orig, XTR55_G2_MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XTR55_G2_MacNativeProfile> orig, XTR55_G2_MacNativeProfile self);

        public sealed class Params_Define
        {
            public XTR55_G2_MacNativeProfile self;
        }
    }
