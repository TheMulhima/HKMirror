...
public static class OnProEXXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ProEXXbox360ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<ProEXXbox360ControllerMacNativeProfile> orig,
            ProEXXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ProEXXbox360ControllerMacNativeProfile> orig,
            ProEXXbox360ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public ProEXXbox360ControllerMacNativeProfile self;
        }
    }
