...
public static class OnProEXXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.ProEXXbox360ControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.ProEXXbox360ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.ProEXXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.ProEXXbox360ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.ProEXXbox360ControllerMacNativeProfile self);
    }
