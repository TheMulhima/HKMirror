...
public static class OnEasySmxEsm9101AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EasySmxEsm9101AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EasySmxEsm9101AndroidUnityProfile> orig,
            EasySmxEsm9101AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EasySmxEsm9101AndroidUnityProfile> orig,
            EasySmxEsm9101AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public EasySmxEsm9101AndroidUnityProfile self;
        }
    }
