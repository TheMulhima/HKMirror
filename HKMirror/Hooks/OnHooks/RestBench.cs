...
private static void OnTriggerEnter2D(On.RestBench.orig_OnTriggerEnter2D orig,RestBench self,  UnityEngine.Collider2D otherObject)
{
...
private static void OnTriggerExit2D(On.RestBench.orig_OnTriggerExit2D orig,RestBench self,  UnityEngine.Collider2D otherObject)
{
...
public delegate void Start_WithArgs (Action<RestBench> orig, RestBench self);
public sealed class Params_OnTriggerEnter2D
{
public RestBench self;
public UnityEngine.Collider2D otherObject;
}
public delegate void OnTriggerEnter2D_BeforeArgs(Params_OnTriggerEnter2D args);
public delegate void OnTriggerEnter2D_AfterArgs(Params_OnTriggerEnter2D args);
public delegate void OnTriggerEnter2D_WithArgs (Action<RestBench,  UnityEngine.Collider2D> orig, RestBench self,  UnityEngine.Collider2D otherObject);
...
public delegate void OnTriggerExit2D_WithArgs (Action<RestBench,  UnityEngine.Collider2D> orig, RestBench self,  UnityEngine.Collider2D otherObject);
}
