...
private static bool IsCurrentPositionTerminus(On.RuinsLift.orig_IsCurrentPositionTerminus orig,RuinsLift self,  int position)
{
...
{
foreach (Delegates.IsCurrentPositionTerminus_BeforeArgs toInvoke in _beforeIsCurrentPositionTerminus.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsCurrentPositionTerminus_AfterArgs toInvoke in _afterIsCurrentPositionTerminus.GetInvocationList())
{
try
{
...
public delegate System.Collections.IEnumerator HideChains_AfterArgs(Params_HideChains args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator HideChains_WithArgs (Func<RuinsLift, System.Collections.IEnumerator> orig, RuinsLift self);
...
public delegate bool IsCurrentPositionTerminus_WithArgs (Func<RuinsLift,  int, bool> orig, RuinsLift self,  int position);
