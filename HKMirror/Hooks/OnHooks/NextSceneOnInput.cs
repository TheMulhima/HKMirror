    ...
    internal static class HookHandler
    {
        ...
        internal static void Hookget_AcceptingInput()
        {
            if (!HookedList.Contains("get_AcceptingInput"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NextSceneOnInput), "get_AcceptingInput", true),
                    get_AcceptingInput);
            }
        }
        ...
        internal static void Hookget_ButtonPressed()
        {
            if (!HookedList.Contains("get_ButtonPressed"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NextSceneOnInput), "get_ButtonPressed", true),
                    get_ButtonPressed);
            }
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_AcceptingInput_WithArgs get_AcceptingInput
        {
            add => HookEndpointManager.Add<Delegates.get_AcceptingInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NextSceneOnInput), "get_AcceptingInput", true), value);
        ...
        public static event Delegates.get_ButtonPressed_WithArgs get_ButtonPressed
        {
            add => HookEndpointManager.Add<Delegates.get_ButtonPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NextSceneOnInput), "get_ButtonPressed", true), value);
