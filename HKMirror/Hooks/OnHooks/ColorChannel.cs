...
public static class OnColorChannel
{
    internal static class HookHandler
    {
        ...
        private static void Init(Action<tk2dRuntime.TileMap.ColorChannel, int, int, int, int> orig,
            tk2dRuntime.TileMap.ColorChannel self, int width, int height, int divX, int divY)
        {
        ...
        internal static void HookFindChunkAndCoordinate()
        {
            if (!HookedList.Contains("FindChunkAndCoordinate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "FindChunkAndCoordinate",
                        true), FindChunkAndCoordinate);
            }
        }
        ...
        private static tk2dRuntime.TileMap.ColorChunk FindChunkAndCoordinate(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, int, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y, int offset)
        {
        ...
        internal static void HookGetColor()
        {
            if (!HookedList.Contains("GetColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "GetColor", true),
                    GetColor);
            }
        }
        ...
        private static UnityEngine.Color GetColor(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, UnityEngine.Color> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y)
        {
        ...
        internal static void HookInitChunk()
        {
            if (!HookedList.Contains("InitChunk"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "InitChunk", true),
                    InitChunk);
            }
        }
        ...
        private static void InitChunk(Action<tk2dRuntime.TileMap.ColorChannel, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, tk2dRuntime.TileMap.ColorChunk chunk)
        {
        ...
        internal static void HookSetColor()
        {
            if (!HookedList.Contains("SetColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "SetColor", true),
                    SetColor);
            }
        }
        ...
        private static void SetColor(Action<tk2dRuntime.TileMap.ColorChannel, int, int, UnityEngine.Color> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y, UnityEngine.Color color)
        {
        ...
        internal static void HookGetChunk_int_int()
        {
            if (!HookedList.Contains("GetChunk_int_int"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "GetChunk_int_int", true),
                    GetChunk_int_int);
            }
        }
        ...
        private static tk2dRuntime.TileMap.ColorChunk GetChunk_int_int(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y)
        {
        ...
        internal static void HookGetChunk_int_int_bool()
        {
            if (!HookedList.Contains("GetChunk_int_int_bool"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "GetChunk_int_int_bool",
                        true), GetChunk_int_int_bool);
            }
        }
        ...
        private static tk2dRuntime.TileMap.ColorChunk GetChunk_int_int_bool(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, bool, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y, bool init)
        {
        ...
        internal static void HookClearChunk()
        {
            if (!HookedList.Contains("ClearChunk"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "ClearChunk", true),
                    ClearChunk);
            }
        }
        ...
        private static void ClearChunk(Action<tk2dRuntime.TileMap.ColorChannel, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, tk2dRuntime.TileMap.ColorChunk chunk)
        {
        ...
        internal static void HookClearDirtyFlag()
        {
            if (!HookedList.Contains("ClearDirtyFlag"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "ClearDirtyFlag", true),
                    ClearDirtyFlag);
            }
        }
        ...
        private static void ClearDirtyFlag(Action<tk2dRuntime.TileMap.ColorChannel> orig,
            tk2dRuntime.TileMap.ColorChannel self)
        {
        ...
        internal static void HookClear()
        {
            if (!HookedList.Contains("Clear"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Clear", true),
                    Clear);
            }
        }
        ...
        private static void Clear(Action<tk2dRuntime.TileMap.ColorChannel, UnityEngine.Color> orig,
            tk2dRuntime.TileMap.ColorChannel self, UnityEngine.Color color)
        {
        ...
        internal static void HookDelete()
        {
            if (!HookedList.Contains("Delete"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Delete", true),
                    Delete);
            }
        }
        ...
        internal static void HookCreate()
        {
            if (!HookedList.Contains("Create"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Create", true),
                    Create);
            }
        }
        ...
        internal static void HookOptimize_ColorChunk()
        {
            if (!HookedList.Contains("Optimize_ColorChunk"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Optimize_ColorChunk",
                        true), Optimize_ColorChunk);
            }
        }
        ...
        private static void Optimize_ColorChunk(
            Action<tk2dRuntime.TileMap.ColorChannel, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, tk2dRuntime.TileMap.ColorChunk chunk)
        {
        ...
        internal static void HookOptimize()
        {
            if (!HookedList.Contains("Optimize"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Optimize", true),
                    Optimize);
            }
        }
        ...
        private static void Optimize(Action<tk2dRuntime.TileMap.ColorChannel> orig,
            tk2dRuntime.TileMap.ColorChannel self)
        {
        ...
        internal static void Hookget_IsEmpty()
        {
            if (!HookedList.Contains("get_IsEmpty"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "get_IsEmpty", true),
                    get_IsEmpty);
            }
        }
        ...
        private static bool get_IsEmpty(Func<tk2dRuntime.TileMap.ColorChannel, bool> orig,
            tk2dRuntime.TileMap.ColorChannel self)
        {
        ...
        internal static void Hookget_NumActiveChunks()
        {
            if (!HookedList.Contains("get_NumActiveChunks"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "get_NumActiveChunks",
                        true), get_NumActiveChunks);
            }
        }
        ...
        private static int get_NumActiveChunks(Func<tk2dRuntime.TileMap.ColorChannel, int> orig,
            tk2dRuntime.TileMap.ColorChannel self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Init_WithArgs(Action<tk2dRuntime.TileMap.ColorChannel, int, int, int, int> orig,
            tk2dRuntime.TileMap.ColorChannel self, int width, int height, int divX, int divY);
        ...
        public delegate tk2dRuntime.TileMap.ColorChunk FindChunkAndCoordinate_AfterArgs(
            Params_FindChunkAndCoordinate args, tk2dRuntime.TileMap.ColorChunk ret);

        public delegate tk2dRuntime.TileMap.ColorChunk FindChunkAndCoordinate_WithArgs(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, int, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y, int offset);
        ...
        public delegate UnityEngine.Color GetColor_WithArgs(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, UnityEngine.Color> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y);
        ...
        public delegate void InitChunk_WithArgs(
            Action<tk2dRuntime.TileMap.ColorChannel, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, tk2dRuntime.TileMap.ColorChunk chunk);
        ...
        public delegate void SetColor_WithArgs(
            Action<tk2dRuntime.TileMap.ColorChannel, int, int, UnityEngine.Color> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y, UnityEngine.Color color);
        ...
        public delegate tk2dRuntime.TileMap.ColorChunk GetChunk_int_int_AfterArgs(Params_GetChunk_int_int args,
            tk2dRuntime.TileMap.ColorChunk ret);

        public delegate tk2dRuntime.TileMap.ColorChunk GetChunk_int_int_WithArgs(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y);
        ...
        public delegate tk2dRuntime.TileMap.ColorChunk GetChunk_int_int_bool_AfterArgs(
            Params_GetChunk_int_int_bool args, tk2dRuntime.TileMap.ColorChunk ret);

        public delegate tk2dRuntime.TileMap.ColorChunk GetChunk_int_int_bool_WithArgs(
            Func<tk2dRuntime.TileMap.ColorChannel, int, int, bool, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, int x, int y, bool init);
        ...
        public delegate void ClearChunk_WithArgs(
            Action<tk2dRuntime.TileMap.ColorChannel, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, tk2dRuntime.TileMap.ColorChunk chunk);
        ...
        public delegate void ClearDirtyFlag_WithArgs(Action<tk2dRuntime.TileMap.ColorChannel> orig,
            tk2dRuntime.TileMap.ColorChannel self);
        ...
        public delegate void Clear_WithArgs(Action<tk2dRuntime.TileMap.ColorChannel, UnityEngine.Color> orig,
            tk2dRuntime.TileMap.ColorChannel self, UnityEngine.Color color);
        ...
        public delegate void Delete_WithArgs(Action<tk2dRuntime.TileMap.ColorChannel> orig,
            tk2dRuntime.TileMap.ColorChannel self);
        ...
        public delegate void Create_WithArgs(Action<tk2dRuntime.TileMap.ColorChannel> orig,
            tk2dRuntime.TileMap.ColorChannel self);
        ...
        public delegate void Optimize_ColorChunk_WithArgs(
            Action<tk2dRuntime.TileMap.ColorChannel, tk2dRuntime.TileMap.ColorChunk> orig,
            tk2dRuntime.TileMap.ColorChannel self, tk2dRuntime.TileMap.ColorChunk chunk);
        ...
        public delegate void Optimize_WithArgs(Action<tk2dRuntime.TileMap.ColorChannel> orig,
            tk2dRuntime.TileMap.ColorChannel self);
        ...
        public delegate bool get_IsEmpty_WithArgs(Func<tk2dRuntime.TileMap.ColorChannel, bool> orig,
            tk2dRuntime.TileMap.ColorChannel self);
        ...
        public delegate int get_NumActiveChunks_WithArgs(Func<tk2dRuntime.TileMap.ColorChannel, int> orig,
            tk2dRuntime.TileMap.ColorChannel self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Init_WithArgs Init
        {
            add => HookEndpointManager.Add<Delegates.Init_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Init", true), value);
        ...
        public static event Delegates.GetColor_WithArgs GetColor
        {
            add => HookEndpointManager.Add<Delegates.GetColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "GetColor", true), value);
        ...
        public static event Delegates.InitChunk_WithArgs InitChunk
        {
            add => HookEndpointManager.Add<Delegates.InitChunk_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "InitChunk", true), value);
        ...
        public static event Delegates.SetColor_WithArgs SetColor
        {
            add => HookEndpointManager.Add<Delegates.SetColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "SetColor", true), value);
        ...
        public static event Delegates.GetChunk_int_int_WithArgs GetChunk_int_int
        {
            add => HookEndpointManager.Add<Delegates.GetChunk_int_int_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "GetChunk", true), value);
        ...
        public static event Delegates.ClearChunk_WithArgs ClearChunk
        {
            add => HookEndpointManager.Add<Delegates.ClearChunk_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "ClearChunk", true), value);
        ...
        public static event Delegates.Clear_WithArgs Clear
        {
            add => HookEndpointManager.Add<Delegates.Clear_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Clear", true), value);
        ...
        public static event Delegates.Delete_WithArgs Delete
        {
            add => HookEndpointManager.Add<Delegates.Delete_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Delete", true), value);
        ...
        public static event Delegates.Create_WithArgs Create
        {
            add => HookEndpointManager.Add<Delegates.Create_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Create", true), value);
        ...
        public static event Delegates.Optimize_ColorChunk_WithArgs Optimize_ColorChunk
        {
            add => HookEndpointManager.Add<Delegates.Optimize_ColorChunk_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "Optimize", true), value);
        ...
        public static event Delegates.get_IsEmpty_WithArgs get_IsEmpty
        {
            add => HookEndpointManager.Add<Delegates.get_IsEmpty_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "get_IsEmpty", true), value);
        ...
        public static event Delegates.get_NumActiveChunks_WithArgs get_NumActiveChunks
        {
            add => HookEndpointManager.Add<Delegates.get_NumActiveChunks_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dRuntime.TileMap.ColorChannel), "get_NumActiveChunks", true),
                value);
