...
public static class OnuGuiSliderGetMinMax
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax),
        ...
        private static void DoGetValue(Action<HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax self);
        ...
        public delegate void DoGetValue_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoGetValue_WithArgs DoGetValue
        {
            add => HookEndpointManager.Add<Delegates.DoGetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderGetMinMax), "DoGetValue",
                    true), value);
