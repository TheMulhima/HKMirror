...
public static class OnTrustPredatorJoystickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TrustPredatorJoystickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<TrustPredatorJoystickMacNativeProfile> orig,
            TrustPredatorJoystickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<TrustPredatorJoystickMacNativeProfile> orig,
            TrustPredatorJoystickMacNativeProfile self);

        public sealed class Params_Define
        {
            public TrustPredatorJoystickMacNativeProfile self;
        }
    }
