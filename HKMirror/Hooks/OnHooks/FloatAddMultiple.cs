...
public static class OnFloatAddMultiple
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatAddMultiple), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatAddMultiple), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatAddMultiple), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self)
        {
        ...
        internal static void HookDoFloatAdd()
        {
            if (!HookedList.Contains("DoFloatAdd"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatAddMultiple), "DoFloatAdd",
                        true), DoFloatAdd);
            }
        }
        ...
        private static void DoFloatAdd(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self);
        ...
        public delegate void DoFloatAdd_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatAddMultiple> orig,
            HutongGames.PlayMaker.Actions.FloatAddMultiple self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatAddMultiple), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatAddMultiple), "OnEnter", true),
                value);
