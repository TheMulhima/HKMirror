...
public static class OnEightBitdoSNES30MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSNES30MacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSNES30MacUnityProfile> orig, EightBitdoSNES30MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSNES30MacUnityProfile> orig,
            EightBitdoSNES30MacUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSNES30MacUnityProfile self;
        }
    }
