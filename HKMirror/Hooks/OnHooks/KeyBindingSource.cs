...
public static class OnKeyBindingSource
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Control()
        {
            if (!HookedList.Contains("get_Control"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_Control", true),
                    get_Control);
            }
        }
        ...
        private static InControl.KeyCombo get_Control(Func<InControl.KeyBindingSource, InControl.KeyCombo> orig,
            InControl.KeyBindingSource self)
        {
        ...
        internal static void Hookset_Control()
        {
            if (!HookedList.Contains("set_Control"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "set_Control", true),
                    set_Control);
            }
        }
        ...
        private static void set_Control(Action<InControl.KeyBindingSource, InControl.KeyCombo> orig,
            InControl.KeyBindingSource self, InControl.KeyCombo value)
        {
        ...
        internal static void HookGetValue()
        {
            if (!HookedList.Contains("GetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "GetValue", true),
                    GetValue);
            }
        }
        ...
        private static float GetValue(Func<InControl.KeyBindingSource, InControl.InputDevice, float> orig,
            InControl.KeyBindingSource self, InControl.InputDevice inputDevice)
        {
        ...
        internal static void HookGetState()
        {
            if (!HookedList.Contains("GetState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "GetState", true),
                    GetState);
            }
        }
        ...
        private static bool GetState(Func<InControl.KeyBindingSource, InControl.InputDevice, bool> orig,
            InControl.KeyBindingSource self, InControl.InputDevice inputDevice)
        {
        ...
        internal static void Hookget_Name()
        {
            if (!HookedList.Contains("get_Name"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_Name", true),
                    get_Name);
            }
        }
        ...
        internal static void Hookget_DeviceName()
        {
            if (!HookedList.Contains("get_DeviceName"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_DeviceName", true),
                    get_DeviceName);
            }
        }
        ...
        private static string get_DeviceName(Func<InControl.KeyBindingSource, string> orig,
            InControl.KeyBindingSource self)
        {
        ...
        internal static void Hookget_DeviceClass()
        {
            if (!HookedList.Contains("get_DeviceClass"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_DeviceClass", true),
                    get_DeviceClass);
            }
        }
        ...
        private static InControl.InputDeviceClass get_DeviceClass(
            Func<InControl.KeyBindingSource, InControl.InputDeviceClass> orig, InControl.KeyBindingSource self)
        {
        ...
        internal static void Hookget_DeviceStyle()
        {
            if (!HookedList.Contains("get_DeviceStyle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_DeviceStyle", true),
                    get_DeviceStyle);
            }
        }
        ...
        private static InControl.InputDeviceStyle get_DeviceStyle(
            Func<InControl.KeyBindingSource, InControl.InputDeviceStyle> orig, InControl.KeyBindingSource self)
        {
        ...
        internal static void HookEquals_BindingSource()
        {
            if (!HookedList.Contains("Equals_BindingSource"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "Equals_BindingSource", true),
        ...
        private static bool Equals_BindingSource(Func<InControl.KeyBindingSource, InControl.BindingSource, bool> orig,
            InControl.KeyBindingSource self, InControl.BindingSource other)
        {
        ...
        internal static void HookEquals_Object()
        {
            if (!HookedList.Contains("Equals_Object"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "Equals_Object", true),
                    Equals_Object);
            }
        }
        ...
        private static bool Equals_Object(Func<InControl.KeyBindingSource, System.Object, bool> orig,
            InControl.KeyBindingSource self, System.Object other)
        {
        ...
        internal static void Hookget_BindingSourceType()
        {
            if (!HookedList.Contains("get_BindingSourceType"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_BindingSourceType", true),
        ...
        private static InControl.BindingSourceType get_BindingSourceType(
            Func<InControl.KeyBindingSource, InControl.BindingSourceType> orig, InControl.KeyBindingSource self)
        {
        ...
        private static void Load(Action<InControl.KeyBindingSource, System.IO.BinaryReader, ushort> orig,
            InControl.KeyBindingSource self, System.IO.BinaryReader reader, ushort dataFormatVersion)
        {
        ...
        private static void Save(Action<InControl.KeyBindingSource, System.IO.BinaryWriter> orig,
            InControl.KeyBindingSource self, System.IO.BinaryWriter writer)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate InControl.KeyCombo get_Control_WithArgs(
            Func<InControl.KeyBindingSource, InControl.KeyCombo> orig, InControl.KeyBindingSource self);
        ...
        public delegate void set_Control_WithArgs(Action<InControl.KeyBindingSource, InControl.KeyCombo> orig,
            InControl.KeyBindingSource self, InControl.KeyCombo value);
        ...
        public delegate float GetValue_WithArgs(Func<InControl.KeyBindingSource, InControl.InputDevice, float> orig,
            InControl.KeyBindingSource self, InControl.InputDevice inputDevice);
        ...
        public delegate bool GetState_WithArgs(Func<InControl.KeyBindingSource, InControl.InputDevice, bool> orig,
            InControl.KeyBindingSource self, InControl.InputDevice inputDevice);
        ...
        public delegate string get_Name_WithArgs(Func<InControl.KeyBindingSource, string> orig,
            InControl.KeyBindingSource self);
        ...
        public delegate string get_DeviceName_WithArgs(Func<InControl.KeyBindingSource, string> orig,
            InControl.KeyBindingSource self);
        ...
        public delegate bool Equals_BindingSource_WithArgs(
            Func<InControl.KeyBindingSource, InControl.BindingSource, bool> orig, InControl.KeyBindingSource self,
        ...
        public delegate bool Equals_Object_WithArgs(Func<InControl.KeyBindingSource, System.Object, bool> orig,
            InControl.KeyBindingSource self, System.Object other);
        ...
        public delegate void Load_WithArgs(Action<InControl.KeyBindingSource, System.IO.BinaryReader, ushort> orig,
            InControl.KeyBindingSource self, System.IO.BinaryReader reader, ushort dataFormatVersion);
        ...
        public delegate void Save_WithArgs(Action<InControl.KeyBindingSource, System.IO.BinaryWriter> orig,
            InControl.KeyBindingSource self, System.IO.BinaryWriter writer);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Control_WithArgs get_Control
        {
            add => HookEndpointManager.Add<Delegates.get_Control_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_Control", true), value);
        ...
        public static event Delegates.set_Control_WithArgs set_Control
        {
            add => HookEndpointManager.Add<Delegates.set_Control_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "set_Control", true), value);
        ...
        public static event Delegates.GetValue_WithArgs GetValue
        {
            add => HookEndpointManager.Add<Delegates.GetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "GetValue", true), value);
        ...
        public static event Delegates.GetState_WithArgs GetState
        {
            add => HookEndpointManager.Add<Delegates.GetState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "GetState", true), value);
        ...
        public static event Delegates.get_Name_WithArgs get_Name
        {
            add => HookEndpointManager.Add<Delegates.get_Name_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_Name", true), value);
        ...
        public static event Delegates.get_DeviceName_WithArgs get_DeviceName
        {
            add => HookEndpointManager.Add<Delegates.get_DeviceName_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_DeviceName", true), value);
        ...
        public static event Delegates.get_DeviceClass_WithArgs get_DeviceClass
        {
            add => HookEndpointManager.Add<Delegates.get_DeviceClass_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_DeviceClass", true), value);
        ...
        public static event Delegates.get_DeviceStyle_WithArgs get_DeviceStyle
        {
            add => HookEndpointManager.Add<Delegates.get_DeviceStyle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "get_DeviceStyle", true), value);
        ...
        public static event Delegates.Equals_BindingSource_WithArgs Equals_BindingSource
        {
            add => HookEndpointManager.Add<Delegates.Equals_BindingSource_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "Equals", true), value);
        ...
        public static event Delegates.Load_WithArgs Load
        {
            add => HookEndpointManager.Add<Delegates.Load_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "Load", true), value);
        ...
        public static event Delegates.Save_WithArgs Save
        {
            add => HookEndpointManager.Add<Delegates.Save_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.KeyBindingSource), "Save", true), value);
