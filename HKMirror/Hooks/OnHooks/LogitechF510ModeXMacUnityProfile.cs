...
public static class OnLogitechF510ModeXMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ModeXMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ModeXMacUnityProfile> orig, LogitechF510ModeXMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ModeXMacUnityProfile> orig,
            LogitechF510ModeXMacUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ModeXMacUnityProfile self;
        }
    }
