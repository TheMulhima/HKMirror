...
public static class OnXInputWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XInputWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XInputWindowsNativeProfile> orig, XInputWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XInputWindowsNativeProfile> orig, XInputWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public XInputWindowsNativeProfile self;
        }
    }
