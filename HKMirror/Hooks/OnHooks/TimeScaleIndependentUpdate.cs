...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TimeScaleIndependentUpdate), "get_deltaTime", true), get_deltaTime);
...
private static float get_deltaTime(Func<TimeScaleIndependentUpdate, float> orig, TimeScaleIndependentUpdate self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TimeScaleIndependentUpdate), "set_deltaTime", true), set_deltaTime);
...
private static void set_deltaTime(Action<TimeScaleIndependentUpdate,  float> orig, TimeScaleIndependentUpdate self,  float value)
{
...
internal static event Delegates.TimeScaleIndependentWaitForSeconds_BeforeArgs _beforeTimeScaleIndependentWaitForSeconds;
private static System.Collections.IEnumerator TimeScaleIndependentWaitForSeconds(On.TimeScaleIndependentUpdate.orig_TimeScaleIndependentWaitForSeconds orig,TimeScaleIndependentUpdate self,  float seconds)
{
...
{
foreach (Delegates.TimeScaleIndependentWaitForSeconds_BeforeArgs toInvoke in _beforeTimeScaleIndependentWaitForSeconds.GetInvocationList())
{
try
{
...
public delegate float get_deltaTime_WithArgs (Func<TimeScaleIndependentUpdate, float> orig, TimeScaleIndependentUpdate self);
...
public delegate void set_deltaTime_WithArgs (Action<TimeScaleIndependentUpdate,  float> orig, TimeScaleIndependentUpdate self,  float value);
...
public delegate void TimeScaleIndependentWaitForSeconds_BeforeArgs(Params_TimeScaleIndependentWaitForSeconds args);
public delegate System.Collections.IEnumerator TimeScaleIndependentWaitForSeconds_AfterArgs(Params_TimeScaleIndependentWaitForSeconds args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator TimeScaleIndependentWaitForSeconds_WithArgs (Func<TimeScaleIndependentUpdate,  float, System.Collections.IEnumerator> orig, TimeScaleIndependentUpdate self,  float seconds);
}
...
{
add => HookEndpointManager.Add<Delegates.get_deltaTime_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TimeScaleIndependentUpdate), "get_deltaTime", true), value);
remove => HookEndpointManager.Remove<Delegates.get_deltaTime_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TimeScaleIndependentUpdate), "get_deltaTime", true), value);
}
public static event Delegates.set_deltaTime_WithArgs set_deltaTime
{
add => HookEndpointManager.Add<Delegates.set_deltaTime_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TimeScaleIndependentUpdate), "set_deltaTime", true), value);
remove => HookEndpointManager.Remove<Delegates.set_deltaTime_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TimeScaleIndependentUpdate), "set_deltaTime", true), value);
}
...
public static event On.TimeScaleIndependentUpdate.hook_TimeScaleIndependentWaitForSeconds TimeScaleIndependentWaitForSeconds
{
