...
public static class OnTimeScaleIndependentUpdate
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator TimeScaleIndependentWaitForSeconds_AfterArgs(
            Params_TimeScaleIndependentWaitForSeconds args, IEnumerator ret);

        public delegate void TimeScaleIndependentWaitForSeconds_BeforeArgs(
            Params_TimeScaleIndependentWaitForSeconds args);

        public delegate IEnumerator TimeScaleIndependentWaitForSeconds_WithArgs(
            Func<TimeScaleIndependentUpdate, float, IEnumerator> orig, TimeScaleIndependentUpdate self, float seconds);
