...
public static class OnTouchButtonControl
{
    internal static class HookHandler
    {
        ...
        internal static void HookCreateControl()
        {
            if (!HookedList.Contains("CreateControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "CreateControl", true),
                    CreateControl);
            }
        }
        ...
        internal static void HookDestroyControl()
        {
            if (!HookedList.Contains("DestroyControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "DestroyControl", true),
                    DestroyControl);
            }
        }
        ...
        internal static void HookConfigureControl()
        {
            if (!HookedList.Contains("ConfigureControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "ConfigureControl", true),
                    ConfigureControl);
            }
        }
        ...
        private static void ConfigureControl(Action<InControl.TouchButtonControl> orig,
            InControl.TouchButtonControl self)
        {
        ...
        internal static void HookDrawGizmos()
        {
            if (!HookedList.Contains("DrawGizmos"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "DrawGizmos", true),
                    DrawGizmos);
            }
        }
        ...
        internal static void HookSubmitControlState()
        {
            if (!HookedList.Contains("SubmitControlState"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "SubmitControlState", true),
                    SubmitControlState);
            }
        }
        ...
        private static void SubmitControlState(Action<InControl.TouchButtonControl, ulong, float> orig,
            InControl.TouchButtonControl self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookCommitControlState()
        {
            if (!HookedList.Contains("CommitControlState"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "CommitControlState", true),
                    CommitControlState);
            }
        }
        ...
        private static void CommitControlState(Action<InControl.TouchButtonControl, ulong, float> orig,
            InControl.TouchButtonControl self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookTouchBegan()
        {
            if (!HookedList.Contains("TouchBegan"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "TouchBegan", true),
                    TouchBegan);
            }
        }
        ...
        private static void TouchBegan(Action<InControl.TouchButtonControl, InControl.Touch> orig,
            InControl.TouchButtonControl self, InControl.Touch touch)
        {
        ...
        internal static void HookTouchMoved()
        {
            if (!HookedList.Contains("TouchMoved"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "TouchMoved", true),
                    TouchMoved);
            }
        }
        ...
        private static void TouchMoved(Action<InControl.TouchButtonControl, InControl.Touch> orig,
            InControl.TouchButtonControl self, InControl.Touch touch)
        {
        ...
        internal static void HookTouchEnded()
        {
            if (!HookedList.Contains("TouchEnded"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "TouchEnded", true),
                    TouchEnded);
            }
        }
        ...
        private static void TouchEnded(Action<InControl.TouchButtonControl, InControl.Touch> orig,
            InControl.TouchButtonControl self, InControl.Touch touch)
        {
        ...
        internal static void Hookget_ButtonState()
        {
            if (!HookedList.Contains("get_ButtonState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_ButtonState", true),
                    get_ButtonState);
            }
        }
        ...
        private static bool get_ButtonState(Func<InControl.TouchButtonControl, bool> orig,
            InControl.TouchButtonControl self)
        {
        ...
        internal static void Hookset_ButtonState()
        {
            if (!HookedList.Contains("set_ButtonState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_ButtonState", true),
                    set_ButtonState);
            }
        }
        ...
        private static void set_ButtonState(Action<InControl.TouchButtonControl, bool> orig,
            InControl.TouchButtonControl self, bool value)
        {
        ...
        internal static void Hookget_ButtonPosition()
        {
            if (!HookedList.Contains("get_ButtonPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_ButtonPosition", true),
                    get_ButtonPosition);
            }
        }
        ...
        private static UnityEngine.Vector3 get_ButtonPosition(
            Func<InControl.TouchButtonControl, UnityEngine.Vector3> orig, InControl.TouchButtonControl self)
        {
            ...
            {
                foreach (Delegates.get_ButtonPosition_BeforeArgs toInvoke in
                         _beforeget_ButtonPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_ButtonPosition_AfterArgs toInvoke in
                         _afterget_ButtonPosition.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_ButtonPosition()
        {
            if (!HookedList.Contains("set_ButtonPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_ButtonPosition", true),
                    set_ButtonPosition);
            }
        }
        ...
        private static void set_ButtonPosition(Action<InControl.TouchButtonControl, UnityEngine.Vector3> orig,
            InControl.TouchButtonControl self, UnityEngine.Vector3 value)
        {
            ...
            {
                foreach (Delegates.set_ButtonPosition_BeforeArgs toInvoke in
                         _beforeset_ButtonPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_ButtonPosition_AfterArgs toInvoke in
                         _afterset_ButtonPosition.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_Anchor()
        {
            if (!HookedList.Contains("get_Anchor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_Anchor", true),
                    get_Anchor);
            }
        }
        ...
        private static InControl.TouchControlAnchor get_Anchor(
            Func<InControl.TouchButtonControl, InControl.TouchControlAnchor> orig, InControl.TouchButtonControl self)
        {
        ...
        internal static void Hookset_Anchor()
        {
            if (!HookedList.Contains("set_Anchor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_Anchor", true),
                    set_Anchor);
            }
        }
        ...
        private static void set_Anchor(Action<InControl.TouchButtonControl, InControl.TouchControlAnchor> orig,
            InControl.TouchButtonControl self, InControl.TouchControlAnchor value)
        {
        ...
        internal static void Hookget_Offset()
        {
            if (!HookedList.Contains("get_Offset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_Offset", true),
                    get_Offset);
            }
        }
        ...
        private static UnityEngine.Vector2 get_Offset(Func<InControl.TouchButtonControl, UnityEngine.Vector2> orig,
            InControl.TouchButtonControl self)
        {
        ...
        internal static void Hookset_Offset()
        {
            if (!HookedList.Contains("set_Offset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_Offset", true),
                    set_Offset);
            }
        }
        ...
        private static void set_Offset(Action<InControl.TouchButtonControl, UnityEngine.Vector2> orig,
            InControl.TouchButtonControl self, UnityEngine.Vector2 value)
        {
        ...
        internal static void Hookget_OffsetUnitType()
        {
            if (!HookedList.Contains("get_OffsetUnitType"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_OffsetUnitType", true),
                    get_OffsetUnitType);
            }
        }
        ...
        private static InControl.TouchUnitType get_OffsetUnitType(
            Func<InControl.TouchButtonControl, InControl.TouchUnitType> orig, InControl.TouchButtonControl self)
        {
        ...
        internal static void Hookset_OffsetUnitType()
        {
            if (!HookedList.Contains("set_OffsetUnitType"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_OffsetUnitType", true),
                    set_OffsetUnitType);
            }
        }
        ...
        private static void set_OffsetUnitType(Action<InControl.TouchButtonControl, InControl.TouchUnitType> orig,
            InControl.TouchButtonControl self, InControl.TouchUnitType value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void CreateControl_WithArgs(Action<InControl.TouchButtonControl> orig,
            InControl.TouchButtonControl self);
        ...
        public delegate void DestroyControl_WithArgs(Action<InControl.TouchButtonControl> orig,
            InControl.TouchButtonControl self);
        ...
        public delegate void ConfigureControl_WithArgs(Action<InControl.TouchButtonControl> orig,
            InControl.TouchButtonControl self);
        ...
        public delegate void DrawGizmos_WithArgs(Action<InControl.TouchButtonControl> orig,
            InControl.TouchButtonControl self);
        ...
        public delegate void Update_WithArgs(Action<InControl.TouchButtonControl> orig,
            InControl.TouchButtonControl self);
        ...
        public delegate void SubmitControlState_WithArgs(Action<InControl.TouchButtonControl, ulong, float> orig,
            InControl.TouchButtonControl self, ulong updateTick, float deltaTime);
        ...
        public delegate void CommitControlState_WithArgs(Action<InControl.TouchButtonControl, ulong, float> orig,
            InControl.TouchButtonControl self, ulong updateTick, float deltaTime);
        ...
        public delegate void TouchBegan_WithArgs(Action<InControl.TouchButtonControl, InControl.Touch> orig,
            InControl.TouchButtonControl self, InControl.Touch touch);
        ...
        public delegate void TouchMoved_WithArgs(Action<InControl.TouchButtonControl, InControl.Touch> orig,
            InControl.TouchButtonControl self, InControl.Touch touch);
        ...
        public delegate void TouchEnded_WithArgs(Action<InControl.TouchButtonControl, InControl.Touch> orig,
            InControl.TouchButtonControl self, InControl.Touch touch);
        ...
        public delegate bool get_ButtonState_WithArgs(Func<InControl.TouchButtonControl, bool> orig,
            InControl.TouchButtonControl self);
        ...
        public delegate void set_ButtonState_WithArgs(Action<InControl.TouchButtonControl, bool> orig,
            InControl.TouchButtonControl self, bool value);
        ...
        public delegate UnityEngine.Vector3 get_ButtonPosition_AfterArgs(Params_get_ButtonPosition args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 get_ButtonPosition_WithArgs(
            Func<InControl.TouchButtonControl, UnityEngine.Vector3> orig, InControl.TouchButtonControl self);
        ...
        public delegate void set_ButtonPosition_WithArgs(Action<InControl.TouchButtonControl, UnityEngine.Vector3> orig,
            InControl.TouchButtonControl self, UnityEngine.Vector3 value);
        ...
        public delegate void set_Anchor_WithArgs(
            Action<InControl.TouchButtonControl, InControl.TouchControlAnchor> orig, InControl.TouchButtonControl self,
            InControl.TouchControlAnchor value);
        ...
        public delegate UnityEngine.Vector2 get_Offset_WithArgs(
            Func<InControl.TouchButtonControl, UnityEngine.Vector2> orig, InControl.TouchButtonControl self);
        ...
        public delegate void set_Offset_WithArgs(Action<InControl.TouchButtonControl, UnityEngine.Vector2> orig,
            InControl.TouchButtonControl self, UnityEngine.Vector2 value);
        ...
        public delegate void set_OffsetUnitType_WithArgs(
            Action<InControl.TouchButtonControl, InControl.TouchUnitType> orig, InControl.TouchButtonControl self,
    ...
    public static class WithOrig
    {
        public static event Delegates.CreateControl_WithArgs CreateControl
        {
            add => HookEndpointManager.Add<Delegates.CreateControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "CreateControl", true), value);
        ...
        public static event Delegates.DestroyControl_WithArgs DestroyControl
        {
            add => HookEndpointManager.Add<Delegates.DestroyControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "DestroyControl", true), value);
        ...
        public static event Delegates.ConfigureControl_WithArgs ConfigureControl
        {
            add => HookEndpointManager.Add<Delegates.ConfigureControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "ConfigureControl", true), value);
        ...
        public static event Delegates.DrawGizmos_WithArgs DrawGizmos
        {
            add => HookEndpointManager.Add<Delegates.DrawGizmos_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "DrawGizmos", true), value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "Update", true), value);
        ...
        public static event Delegates.TouchBegan_WithArgs TouchBegan
        {
            add => HookEndpointManager.Add<Delegates.TouchBegan_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "TouchBegan", true), value);
        ...
        public static event Delegates.TouchMoved_WithArgs TouchMoved
        {
            add => HookEndpointManager.Add<Delegates.TouchMoved_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "TouchMoved", true), value);
        ...
        public static event Delegates.TouchEnded_WithArgs TouchEnded
        {
            add => HookEndpointManager.Add<Delegates.TouchEnded_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "TouchEnded", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_ButtonState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_ButtonState", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_ButtonState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_ButtonState", true), value);
        }

        public static event Delegates.set_ButtonState_WithArgs set_ButtonState
        {
            add => HookEndpointManager.Add<Delegates.set_ButtonState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_ButtonState", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_ButtonState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_ButtonState", true), value);
        }

        public static event Delegates.get_ButtonPosition_WithArgs get_ButtonPosition
        {
            add => HookEndpointManager.Add<Delegates.get_ButtonPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_ButtonPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_ButtonPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_ButtonPosition", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_ButtonPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_ButtonPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_ButtonPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_ButtonPosition", true),
                value);
        }
        ...
        public static event Delegates.get_Anchor_WithArgs get_Anchor
        {
            add => HookEndpointManager.Add<Delegates.get_Anchor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_Anchor", true), value);
        ...
        public static event Delegates.set_Anchor_WithArgs set_Anchor
        {
            add => HookEndpointManager.Add<Delegates.set_Anchor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_Anchor", true), value);
        ...
        public static event Delegates.get_Offset_WithArgs get_Offset
        {
            add => HookEndpointManager.Add<Delegates.get_Offset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "get_Offset", true), value);
        ...
        public static event Delegates.set_Offset_WithArgs set_Offset
        {
            add => HookEndpointManager.Add<Delegates.set_Offset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchButtonControl), "set_Offset", true), value);
