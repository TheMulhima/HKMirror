...
public static class OnPowerANintendoSwitchMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PowerANintendoSwitchMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PowerANintendoSwitchMacNativeProfile> orig,
            PowerANintendoSwitchMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PowerANintendoSwitchMacNativeProfile> orig,
            PowerANintendoSwitchMacNativeProfile self);

        public sealed class Params_Define
        {
            public PowerANintendoSwitchMacNativeProfile self;
        }
    }
