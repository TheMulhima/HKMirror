...
public static class OnXbox360WiredWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360WiredWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360WiredWindowsNativeProfile> orig, Xbox360WiredWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360WiredWindowsNativeProfile> orig,
            Xbox360WiredWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public Xbox360WiredWindowsNativeProfile self;
        }
    }
