...
private static void OnTriggerEnter2D(On.BreakableInfectedVine.orig_OnTriggerEnter2D orig,BreakableInfectedVine self,  UnityEngine.Collider2D collision)
{
...
private static void SpawnSpatters(On.BreakableInfectedVine.orig_SpawnSpatters orig,BreakableInfectedVine self,  UnityEngine.Vector3 position)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<BreakableInfectedVine,  UnityEngine.Collider2D> orig, BreakableInfectedVine self,  UnityEngine.Collider2D collision);
...
public delegate void SpawnSpatters_WithArgs (Action<BreakableInfectedVine,  UnityEngine.Vector3> orig, BreakableInfectedVine self,  UnityEngine.Vector3 position);
}
