...
private static void StartConveyorMove(On.ConveyorMovementHero.orig_StartConveyorMove orig,ConveyorMovementHero self,  float c_xSpeed,  float c_ySpeed)
{
...
{
foreach (Delegates.StartConveyorMove_BeforeArgs toInvoke in _beforeStartConveyorMove.GetInvocationList())
{
try
{
...
private static void StopConveyorMove(On.ConveyorMovementHero.orig_StopConveyorMove orig,ConveyorMovementHero self)
{
...
public delegate void StartConveyorMove_WithArgs (Action<ConveyorMovementHero,  float,  float> orig, ConveyorMovementHero self,  float c_xSpeed,  float c_ySpeed);
