...
public static class OnGradeMarker
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator OnStart_AfterArgs(Params_OnStart args, IEnumerator ret);

        public delegate void OnStart_BeforeArgs(Params_OnStart args);

        public delegate IEnumerator OnStart_WithArgs(Func<GradeMarker, IEnumerator> orig, GradeMarker self);
