...
{
foreach (Delegates.SetStartSizeForTrigger_BeforeArgs toInvoke in _beforeSetStartSizeForTrigger.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartSizeForTrigger_AfterArgs toInvoke in _afterSetStartSizeForTrigger.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DeactivateGradual_BeforeArgs toInvoke in _beforeDeactivateGradual.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator OnStart(Func<GradeMarker, System.Collections.IEnumerator> orig, GradeMarker self)
{
...
public delegate System.Collections.IEnumerator OnStart_AfterArgs(Params_OnStart args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator OnStart_WithArgs (Func<GradeMarker, System.Collections.IEnumerator> orig, GradeMarker self);
...
{
add => HookEndpointManager.Add<Delegates.orig_Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_Start", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_Start", true), value);
}
public static event Delegates.OnStart_WithArgs OnStart
{
add => HookEndpointManager.Add<Delegates.OnStart_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "OnStart", true), value);
remove => HookEndpointManager.Remove<Delegates.OnStart_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "OnStart", true), value);
}
public static event Delegates.orig_Update_WithArgs orig_Update
{
add => HookEndpointManager.Add<Delegates.orig_Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_Update", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_Update", true), value);
}
public static event Delegates.orig_UpdateLow_WithArgs orig_UpdateLow
{
add => HookEndpointManager.Add<Delegates.orig_UpdateLow_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_UpdateLow", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_UpdateLow_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_UpdateLow", true), value);
}
public static event Delegates.orig_Deactivate_WithArgs orig_Deactivate
{
add => HookEndpointManager.Add<Delegates.orig_Deactivate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_Deactivate", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Deactivate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GradeMarker), "orig_Deactivate", true), value);
}
}
