...
public static class OnRectTransformGetScale
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetScale), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<RectTransformGetScale> orig, RectTransformGetScale self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetScale), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<RectTransformGetScale> orig, RectTransformGetScale self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetScale), "OnActionUpdate"),
                    OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(Action<RectTransformGetScale> orig, RectTransformGetScale self)
        {
        ...
        internal static void HookDoGetValues()
        {
            if (!HookedList.Contains("DoGetValues"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetScale), "DoGetValues"), DoGetValues);
            }
        }
        ...
        private static void DoGetValues(Action<RectTransformGetScale> orig, RectTransformGetScale self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetValues_WithArgs(Action<RectTransformGetScale> orig, RectTransformGetScale self);
        ...
        public delegate void OnActionUpdate_WithArgs(Action<RectTransformGetScale> orig, RectTransformGetScale self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<RectTransformGetScale> orig, RectTransformGetScale self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<RectTransformGetScale> orig, RectTransformGetScale self);

        public sealed class Params_Reset
        {
            public RectTransformGetScale self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RectTransformGetScale), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RectTransformGetScale), "OnEnter"), value);
