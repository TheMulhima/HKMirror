...
public static class OnFloatDivideV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<FloatDivideV2> orig, FloatDivideV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<FloatDivideV2> orig, FloatDivideV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<FloatDivideV2> orig, FloatDivideV2 self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<FloatDivideV2> orig, FloatDivideV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<FloatDivideV2> orig, FloatDivideV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<FloatDivideV2> orig, FloatDivideV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<FloatDivideV2> orig, FloatDivideV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<FloatDivideV2> orig, FloatDivideV2 self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<FloatDivideV2> orig, FloatDivideV2 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<FloatDivideV2> orig, FloatDivideV2 self);

        public sealed class Params_Reset
        {
            public FloatDivideV2 self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnEnter"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnPreprocess"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnUpdate"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatDivideV2), "OnFixedUpdate"), value);
