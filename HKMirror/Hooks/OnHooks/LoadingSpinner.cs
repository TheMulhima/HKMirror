...
public static class OnLoadingSpinner
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_DisplayDelayAdjustment()
        {
            if (!HookedList.Contains("get_DisplayDelayAdjustment"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelayAdjustment"),
                    get_DisplayDelayAdjustment);
            }
        }

        internal static event Delegates.get_DisplayDelayAdjustment_BeforeArgs _beforeget_DisplayDelayAdjustment;
        internal static event Delegates.get_DisplayDelayAdjustment_NormalArgs _afterget_DisplayDelayAdjustment;
        ...
        private static float get_DisplayDelayAdjustment(Func<LoadingSpinner, float> orig, LoadingSpinner self)
        {
            ...
            if (_afterget_DisplayDelayAdjustment != null) retVal = _afterget_DisplayDelayAdjustment.Invoke(@params);
            return retVal;
        }
        ...
        internal static void Hookset_DisplayDelayAdjustment()
        {
            if (!HookedList.Contains("set_DisplayDelayAdjustment"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "set_DisplayDelayAdjustment"),
                    set_DisplayDelayAdjustment);
            }
        }

        internal static event Delegates.set_DisplayDelayAdjustment_BeforeArgs _beforeset_DisplayDelayAdjustment;
        internal static event Delegates.set_DisplayDelayAdjustment_NormalArgs _afterset_DisplayDelayAdjustment;

        private static void set_DisplayDelayAdjustment(Action<LoadingSpinner, float> orig, LoadingSpinner self,
            float value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_DisplayDelayAdjustment != null) _afterset_DisplayDelayAdjustment.Invoke(@params);
        }
        ...
        internal static void Hookget_DisplayDelay()
        {
            if (!HookedList.Contains("get_DisplayDelay"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelay"), get_DisplayDelay);
            }
        }

        internal static event Delegates.get_DisplayDelay_BeforeArgs _beforeget_DisplayDelay;
        internal static event Delegates.get_DisplayDelay_NormalArgs _afterget_DisplayDelay;
        ...
        private static float get_DisplayDelay(Func<LoadingSpinner, float> orig, LoadingSpinner self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_DisplayDelay != null) retVal = _afterget_DisplayDelay.Invoke(@params);
            return retVal;
        }
    ...
    public static class Delegates
    {
        ...
        public delegate float get_DisplayDelay_NormalArgs(Params_get_DisplayDelay args);

        public delegate void get_DisplayDelayAdjustment_BeforeArgs(Params_get_DisplayDelayAdjustment args);

        public delegate float get_DisplayDelayAdjustment_NormalArgs(Params_get_DisplayDelayAdjustment args);
        ...
        public delegate void set_DisplayDelayAdjustment_NormalArgs(Params_set_DisplayDelayAdjustment args);
    ...
    {
        public static event Delegates.get_DisplayDelayAdjustment_NormalArgs get_DisplayDelayAdjustment
        {
            add
            {
        ...
        public static event Delegates.set_DisplayDelayAdjustment_NormalArgs set_DisplayDelayAdjustment
        {
            add
            {
        ...
        public static event Delegates.get_DisplayDelay_NormalArgs get_DisplayDelay
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_DisplayDelayAdjustment_NormalArgs get_DisplayDelayAdjustment
        {
            add => HookEndpointManager.Add<Delegates.get_DisplayDelayAdjustment_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelayAdjustment"), value);
            remove => HookEndpointManager.Remove<Delegates.get_DisplayDelayAdjustment_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelayAdjustment"), value);
        }

        public static event Delegates.set_DisplayDelayAdjustment_NormalArgs set_DisplayDelayAdjustment
        {
            add => HookEndpointManager.Add<Delegates.set_DisplayDelayAdjustment_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "set_DisplayDelayAdjustment"), value);
            remove => HookEndpointManager.Remove<Delegates.set_DisplayDelayAdjustment_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "set_DisplayDelayAdjustment"), value);
        }

        public static event Delegates.get_DisplayDelay_NormalArgs get_DisplayDelay
        {
            add => HookEndpointManager.Add<Delegates.get_DisplayDelay_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelay"), value);
            remove => HookEndpointManager.Remove<Delegates.get_DisplayDelay_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelay"), value);
        }
