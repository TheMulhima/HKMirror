...
public static class OnLoadingSpinner
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_DisplayDelayAdjustment()
        {
            if (!HookedList.Contains("get_DisplayDelayAdjustment"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelayAdjustment", true),
        ...
        private static float get_DisplayDelayAdjustment(Func<LoadingSpinner, float> orig, LoadingSpinner self)
        {
            ...
            {
                foreach (Delegates.get_DisplayDelayAdjustment_BeforeArgs toInvoke in _beforeget_DisplayDelayAdjustment
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_DisplayDelayAdjustment_AfterArgs toInvoke in _afterget_DisplayDelayAdjustment
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_DisplayDelayAdjustment()
        {
            if (!HookedList.Contains("set_DisplayDelayAdjustment"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "set_DisplayDelayAdjustment", true),
            ...
            float value)
        {
            ...
            {
                foreach (Delegates.set_DisplayDelayAdjustment_BeforeArgs toInvoke in _beforeset_DisplayDelayAdjustment
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_DisplayDelayAdjustment_AfterArgs toInvoke in _afterset_DisplayDelayAdjustment
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_DisplayDelay()
        {
            if (!HookedList.Contains("get_DisplayDelay"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelay", true),
                    get_DisplayDelay);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate float
            get_DisplayDelayAdjustment_WithArgs(Func<LoadingSpinner, float> orig, LoadingSpinner self);
        ...
        public delegate void set_DisplayDelayAdjustment_WithArgs(Action<LoadingSpinner, float> orig,
            LoadingSpinner self, float value);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_DisplayDelayAdjustment_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelayAdjustment", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_DisplayDelayAdjustment_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelayAdjustment", true), value);
        }

        public static event Delegates.set_DisplayDelayAdjustment_WithArgs set_DisplayDelayAdjustment
        {
            add => HookEndpointManager.Add<Delegates.set_DisplayDelayAdjustment_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "set_DisplayDelayAdjustment", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_DisplayDelayAdjustment_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "set_DisplayDelayAdjustment", true), value);
        }

        public static event Delegates.get_DisplayDelay_WithArgs get_DisplayDelay
        {
            add => HookEndpointManager.Add<Delegates.get_DisplayDelay_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelay", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_DisplayDelay_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LoadingSpinner), "get_DisplayDelay", true), value);
        }
