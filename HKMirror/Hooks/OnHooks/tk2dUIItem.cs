...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_IsPressed", true), get_IsPressed);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_Touch", true), get_Touch);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_ParentUIItem", true), get_ParentUIItem);
...
private static void ManuallySetParent(On.tk2dUIItem.orig_ManuallySetParent orig,tk2dUIItem self,  tk2dUIItem newParentUIItem)
{
Delegates.Params_ManuallySetParent @params = new() 
{
self = self
, newParentUIItem = newParentUIItem
};
if (_beforeManuallySetParent != null)
{
foreach (Delegates.ManuallySetParent_BeforeArgs toInvoke in _beforeManuallySetParent.GetInvocationList())
{
try
{
...
private static bool Press_tk2dUITouch(On.tk2dUIItem.orig_Press_tk2dUITouch orig,tk2dUIItem self,  tk2dUITouch touch)
{
...
{
foreach (Delegates.Press_tk2dUITouch_BeforeArgs toInvoke in _beforePress_tk2dUITouch.GetInvocationList())
{
try
{
...
private static bool Press_tk2dUITouch_tk2dUIItem(On.tk2dUIItem.orig_Press_tk2dUITouch_tk2dUIItem orig,tk2dUIItem self,  tk2dUITouch touch,  tk2dUIItem sentFromChild)
{
Delegates.Params_Press_tk2dUITouch_tk2dUIItem @params = new() 
{
self = self
, touch = touch
, sentFromChild = sentFromChild
};
if (_beforePress_tk2dUITouch_tk2dUIItem != null)
{
foreach (Delegates.Press_tk2dUITouch_tk2dUIItem_BeforeArgs toInvoke in _beforePress_tk2dUITouch_tk2dUIItem.GetInvocationList())
{
try
{
...
{
foreach (Delegates.Press_tk2dUITouch_tk2dUIItem_AfterArgs toInvoke in _afterPress_tk2dUITouch_tk2dUIItem.GetInvocationList())
{
try
{
...
private static void CurrentOverUIItem(On.tk2dUIItem.orig_CurrentOverUIItem orig,tk2dUIItem self,  tk2dUIItem overUIItem)
{
Delegates.Params_CurrentOverUIItem @params = new() 
{
self = self
, overUIItem = overUIItem
};
if (_beforeCurrentOverUIItem != null)
{
foreach (Delegates.CurrentOverUIItem_BeforeArgs toInvoke in _beforeCurrentOverUIItem.GetInvocationList())
{
try
{
...
private static bool CheckIsUIItemChildOfMe(On.tk2dUIItem.orig_CheckIsUIItemChildOfMe orig,tk2dUIItem self,  tk2dUIItem uiItem)
{
...
{
foreach (Delegates.CheckIsUIItemChildOfMe_BeforeArgs toInvoke in _beforeCheckIsUIItemChildOfMe.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckIsUIItemChildOfMe_AfterArgs toInvoke in _afterCheckIsUIItemChildOfMe.GetInvocationList())
{
try
{
...
{
self = self
, currHoverButton = currHoverButton
};
...
internal static event Delegates.InternalSetIsChildOfAnotherUIItem_BeforeArgs _beforeInternalSetIsChildOfAnotherUIItem;
internal static event Delegates.InternalSetIsChildOfAnotherUIItem_AfterArgs _afterInternalSetIsChildOfAnotherUIItem;
private static void InternalSetIsChildOfAnotherUIItem(On.tk2dUIItem.orig_InternalSetIsChildOfAnotherUIItem orig,tk2dUIItem self,  bool state)
{
...
{
foreach (Delegates.InternalSetIsChildOfAnotherUIItem_BeforeArgs toInvoke in _beforeInternalSetIsChildOfAnotherUIItem.GetInvocationList())
{
try
{
...
{
foreach (Delegates.InternalSetIsChildOfAnotherUIItem_AfterArgs toInvoke in _afterInternalSetIsChildOfAnotherUIItem.GetInvocationList())
{
try
{
...
internal static event Delegates.InternalGetIsChildOfAnotherUIItem_BeforeArgs _beforeInternalGetIsChildOfAnotherUIItem;
internal static event Delegates.InternalGetIsChildOfAnotherUIItem_AfterArgs _afterInternalGetIsChildOfAnotherUIItem;
private static bool InternalGetIsChildOfAnotherUIItem(On.tk2dUIItem.orig_InternalGetIsChildOfAnotherUIItem orig,tk2dUIItem self)
{
...
{
foreach (Delegates.InternalGetIsChildOfAnotherUIItem_BeforeArgs toInvoke in _beforeInternalGetIsChildOfAnotherUIItem.GetInvocationList())
{
try
{
...
{
foreach (Delegates.InternalGetIsChildOfAnotherUIItem_AfterArgs toInvoke in _afterInternalGetIsChildOfAnotherUIItem.GetInvocationList())
{
try
{
...
public delegate void ManuallySetParent_WithArgs (Action<tk2dUIItem,  tk2dUIItem> orig, tk2dUIItem self,  tk2dUIItem newParentUIItem);
...
public delegate bool Press_tk2dUITouch_WithArgs (Func<tk2dUIItem,  tk2dUITouch, bool> orig, tk2dUIItem self,  tk2dUITouch touch);
...
public delegate bool Press_tk2dUITouch_tk2dUIItem_WithArgs (Func<tk2dUIItem,  tk2dUITouch,  tk2dUIItem, bool> orig, tk2dUIItem self,  tk2dUITouch touch,  tk2dUIItem sentFromChild);
...
public delegate void UpdateTouch_WithArgs (Action<tk2dUIItem,  tk2dUITouch> orig, tk2dUIItem self,  tk2dUITouch touch);
...
public delegate void DoSendMessage_WithArgs (Action<tk2dUIItem,  string> orig, tk2dUIItem self,  string methodName);
...
public delegate void CurrentOverUIItem_WithArgs (Action<tk2dUIItem,  tk2dUIItem> orig, tk2dUIItem self,  tk2dUIItem overUIItem);
...
public delegate bool CheckIsUIItemChildOfMe_WithArgs (Func<tk2dUIItem,  tk2dUIItem, bool> orig, tk2dUIItem self,  tk2dUIItem uiItem);
...
public delegate bool HoverOver_WithArgs (Func<tk2dUIItem,  tk2dUIItem, bool> orig, tk2dUIItem self,  tk2dUIItem prevHover);
...
public delegate void HoverOut_WithArgs (Action<tk2dUIItem,  tk2dUIItem> orig, tk2dUIItem self,  tk2dUIItem currHoverButton);
...
public delegate void InternalSetIsChildOfAnotherUIItem_BeforeArgs(Params_InternalSetIsChildOfAnotherUIItem args);
public delegate void InternalSetIsChildOfAnotherUIItem_AfterArgs(Params_InternalSetIsChildOfAnotherUIItem args);
public delegate void InternalSetIsChildOfAnotherUIItem_WithArgs (Action<tk2dUIItem,  bool> orig, tk2dUIItem self,  bool state);
public sealed class Params_InternalGetIsChildOfAnotherUIItem
{
public tk2dUIItem self;
}
public delegate void InternalGetIsChildOfAnotherUIItem_BeforeArgs(Params_InternalGetIsChildOfAnotherUIItem args);
public delegate bool InternalGetIsChildOfAnotherUIItem_AfterArgs(Params_InternalGetIsChildOfAnotherUIItem args, bool ret);
...
{
add => HookEndpointManager.Add<Delegates.get_IsPressed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_IsPressed", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsPressed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_IsPressed", true), value);
}
public static event Delegates.get_Touch_WithArgs get_Touch
{
add => HookEndpointManager.Add<Delegates.get_Touch_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_Touch", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Touch_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_Touch", true), value);
}
public static event Delegates.get_ParentUIItem_WithArgs get_ParentUIItem
{
add => HookEndpointManager.Add<Delegates.get_ParentUIItem_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_ParentUIItem", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ParentUIItem_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIItem), "get_ParentUIItem", true), value);
}
