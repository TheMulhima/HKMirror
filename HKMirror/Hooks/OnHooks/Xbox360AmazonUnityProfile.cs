...
public static class OnXbox360AmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360AmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360AmazonUnityProfile> orig, Xbox360AmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360AmazonUnityProfile> orig, Xbox360AmazonUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360AmazonUnityProfile self;
        }
    }
