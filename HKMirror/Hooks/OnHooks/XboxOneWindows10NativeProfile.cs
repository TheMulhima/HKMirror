...
public static class OnXboxOneWindows10NativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneWindows10NativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneWindows10NativeProfile> orig, XboxOneWindows10NativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneWindows10NativeProfile> orig,
            XboxOneWindows10NativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneWindows10NativeProfile self;
        }
    }
