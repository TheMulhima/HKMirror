...
public static class OnAchievementListener
{
    internal static class HookHandler
    {
            ...
            AchievementListener self, string achievementKey)
        {
            ...
            {
                foreach (Delegates.CaptureAchievementEvent_BeforeArgs toInvoke in _beforeCaptureAchievementEvent
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CaptureAchievementEvent_AfterArgs toInvoke in _afterCaptureAchievementEvent
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void CaptureAchievementEvent_WithArgs(Action<AchievementListener, string> orig,
            AchievementListener self, string achievementKey);
    }
