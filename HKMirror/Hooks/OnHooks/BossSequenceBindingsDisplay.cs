...
private static void CountBindings(On.BossSequenceBindingsDisplay.orig_CountBindings orig,out  int total, out  int completed)
{
...
{
foreach (Delegates.CountCompletedBindings_BeforeArgs toInvoke in _beforeCountCompletedBindings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CountCompletedBindings_AfterArgs toInvoke in _afterCountCompletedBindings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CountTotalBindings_BeforeArgs toInvoke in _beforeCountTotalBindings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CountTotalBindings_AfterArgs toInvoke in _afterCountTotalBindings.GetInvocationList())
{
try
{
