...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile> orig, InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile> orig, InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XTR55_G2_WindowsUnityProfile), "Define", true), value);
}
}
