...
public static class OnGlowResponse
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.HandleUpgrade_NormalArgs _afterHandleUpgrade;
        ...
        private static void HandleUpgrade(On.GlowResponse.orig_HandleUpgrade orig, GlowResponse self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterHandleUpgrade != null) _afterHandleUpgrade.Invoke(@params);
        }
        ...
        internal static event Delegates.FadeTo_NormalArgs _afterFadeTo;
        ...
        private static void FadeTo(On.GlowResponse.orig_FadeTo orig, GlowResponse self, float alpha)
        {
            ...
            alpha = @params.alpha;
            orig(self, alpha);
            if (_afterFadeTo != null) _afterFadeTo.Invoke(@params);
        }
        ...
        private static IEnumerator Fade(On.GlowResponse.orig_Fade orig, GlowResponse self, float toAlpha,
        ...
        internal static event Delegates.FadeEnd_NormalArgs _afterFadeEnd;
        ...
        private static void FadeEnd(On.GlowResponse.orig_FadeEnd orig, GlowResponse self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterFadeEnd != null) _afterFadeEnd.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void FadeEnd_NormalArgs(Params_FadeEnd args);

        public delegate void FadeTo_BeforeArgs(Params_FadeTo args);

        public delegate void FadeTo_NormalArgs(Params_FadeTo args);

        public delegate void HandleUpgrade_BeforeArgs(Params_HandleUpgrade args);

        public delegate void HandleUpgrade_NormalArgs(Params_HandleUpgrade args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.HandleUpgrade_NormalArgs HandleUpgrade
        {
            add
            {
        ...
        public static event Delegates.FadeTo_NormalArgs FadeTo
        {
            add
            {
        ...
        public static event Delegates.FadeEnd_NormalArgs FadeEnd
        {
            add
            {
