...
private static void DeactivateChildren(On.MapNextAreaDisplay.orig_DeactivateChildren orig,MapNextAreaDisplay self)
{
...
{
foreach (Delegates.DeactivateChildren_BeforeArgs toInvoke in _beforeDeactivateChildren.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DeactivateChildren_AfterArgs toInvoke in _afterDeactivateChildren.GetInvocationList())
{
try
{
