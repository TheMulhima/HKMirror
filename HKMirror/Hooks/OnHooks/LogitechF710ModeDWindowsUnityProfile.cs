...
public static class OnLogitechF710ModeDWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710ModeDWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710ModeDWindowsUnityProfile> orig,
            LogitechF710ModeDWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710ModeDWindowsUnityProfile> orig,
            LogitechF710ModeDWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF710ModeDWindowsUnityProfile self;
        }
    }
