...
public static class OnNexusPlayerMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NexusPlayerMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NexusPlayerMacUnityProfile> orig, NexusPlayerMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NexusPlayerMacUnityProfile> orig, NexusPlayerMacUnityProfile self);

        public sealed class Params_Define
        {
            public NexusPlayerMacUnityProfile self;
        }
    }
