...
public static class OnBetopBTPAX1TAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BetopBTPAX1TAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BetopBTPAX1TAndroidUnityProfile> orig, BetopBTPAX1TAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BetopBTPAX1TAndroidUnityProfile> orig,
            BetopBTPAX1TAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public BetopBTPAX1TAndroidUnityProfile self;
        }
    }
