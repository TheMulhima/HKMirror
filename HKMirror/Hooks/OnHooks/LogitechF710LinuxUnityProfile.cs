...
public static class OnLogitechF710LinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710LinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710LinuxUnityProfile> orig, LogitechF710LinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710LinuxUnityProfile> orig,
            LogitechF710LinuxUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF710LinuxUnityProfile self;
        }
    }
