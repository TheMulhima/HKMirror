...
public static class OnEightBitdoNES30ProUSBMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.EightBitdoNES30ProUSBMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.EightBitdoNES30ProUSBMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.EightBitdoNES30ProUSBMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.EightBitdoNES30ProUSBMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.EightBitdoNES30ProUSBMacNativeProfile self);
    }
