...
public static class OnEightBitdoNES30ProUSBMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoNES30ProUSBMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoNES30ProUSBMacNativeProfile> orig,
            EightBitdoNES30ProUSBMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoNES30ProUSBMacNativeProfile> orig,
            EightBitdoNES30ProUSBMacNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoNES30ProUSBMacNativeProfile self;
        }
    }
