...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MuteAudioChannel), "get_Volume", true), get_Volume);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MuteAudioChannel), "set_Volume", true), set_Volume);
...
private static float LinearToDecibel(On.MuteAudioChannel.orig_LinearToDecibel orig,MuteAudioChannel self,  float linear)
{
...
private static float DecibelToLinear(On.MuteAudioChannel.orig_DecibelToLinear orig,MuteAudioChannel self,  float dB)
{
...
public delegate void set_Volume_WithArgs (Action<MuteAudioChannel,  float> orig, MuteAudioChannel self,  float value);
...
public delegate float LinearToDecibel_WithArgs (Func<MuteAudioChannel,  float, float> orig, MuteAudioChannel self,  float linear);
...
public delegate float DecibelToLinear_WithArgs (Func<MuteAudioChannel,  float, float> orig, MuteAudioChannel self,  float dB);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MuteAudioChannel), "get_Volume", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MuteAudioChannel), "get_Volume", true), value);
}
public static event Delegates.set_Volume_WithArgs set_Volume
{
add => HookEndpointManager.Add<Delegates.set_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MuteAudioChannel), "set_Volume", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MuteAudioChannel), "set_Volume", true), value);
}
