...
public static class OnRockCandyPS3ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RockCandyPS3ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RockCandyPS3ControllerMacNativeProfile> orig,
            RockCandyPS3ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RockCandyPS3ControllerMacNativeProfile> orig,
            RockCandyPS3ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public RockCandyPS3ControllerMacNativeProfile self;
        }
    }
