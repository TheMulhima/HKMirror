...
public static class OnRockCandyPS3ControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.RockCandyPS3ControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.RockCandyPS3ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.RockCandyPS3ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.RockCandyPS3ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.RockCandyPS3ControllerMacNativeProfile self);
    }
