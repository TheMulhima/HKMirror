...
public static class OnHORIFightingCommanderControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HORIFightingCommanderControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HORIFightingCommanderControllerMacNativeProfile> orig,
            HORIFightingCommanderControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HORIFightingCommanderControllerMacNativeProfile> orig,
            HORIFightingCommanderControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public HORIFightingCommanderControllerMacNativeProfile self;
        }
    }
