...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeHealthProxy), "Invoke", true), Invoke);
...
private static int Invoke(Func<Modding.Delegates.TakeHealthProxy,  int, int> orig, Modding.Delegates.TakeHealthProxy self,  int damage)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeHealthProxy), "EndInvoke", true), EndInvoke);
...
private static int EndInvoke(Func<Modding.Delegates.TakeHealthProxy,  System.IAsyncResult, int> orig, Modding.Delegates.TakeHealthProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.TakeHealthProxy self;
public int damage;
}
public delegate void Invoke_BeforeArgs(Params_Invoke args);
public delegate int Invoke_AfterArgs(Params_Invoke args, int ret);
public delegate int Invoke_WithArgs (Func<Modding.Delegates.TakeHealthProxy,  int, int> orig, Modding.Delegates.TakeHealthProxy self,  int damage);
...
public delegate int EndInvoke_WithArgs (Func<Modding.Delegates.TakeHealthProxy,  System.IAsyncResult, int> orig, Modding.Delegates.TakeHealthProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeHealthProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeHealthProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeHealthProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.TakeHealthProxy), "EndInvoke", true), value);
}
}
