...
public static class OnTrigger2dEventLayer
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEventLayer), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.Trigger2dEventLayer> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEventLayer), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.Trigger2dEventLayer> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEventLayer), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.Trigger2dEventLayer> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEventLayer),
        ...
        private static void StoreCollisionInfo(
            Action<HutongGames.PlayMaker.Actions.Trigger2dEventLayer, UnityEngine.Collider2D> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self, UnityEngine.Collider2D collisionInfo)
        {
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.Trigger2dEventLayer, string> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.Trigger2dEventLayer> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.Trigger2dEventLayer> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.Trigger2dEventLayer> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.Trigger2dEventLayer, string> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEventLayer self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.ErrorCheck_WithArgs ErrorCheck
        {
            add => HookEndpointManager.Add<Delegates.ErrorCheck_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEventLayer), "ErrorCheck",
                    true), value);
