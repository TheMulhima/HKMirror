...
public static class OnArrayGetNext
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetNext), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayGetNext> orig,
            HutongGames.PlayMaker.Actions.ArrayGetNext self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetNext), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayGetNext> orig,
            HutongGames.PlayMaker.Actions.ArrayGetNext self)
        {
        ...
        internal static void HookDoGetNextItem()
        {
            if (!HookedList.Contains("DoGetNextItem"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetNext), "DoGetNextItem",
                        true), DoGetNextItem);
            }
        }
        ...
        private static void DoGetNextItem(Action<HutongGames.PlayMaker.Actions.ArrayGetNext> orig,
            HutongGames.PlayMaker.Actions.ArrayGetNext self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayGetNext> orig,
            HutongGames.PlayMaker.Actions.ArrayGetNext self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayGetNext> orig,
            HutongGames.PlayMaker.Actions.ArrayGetNext self);
        ...
        public delegate void DoGetNextItem_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayGetNext> orig,
            HutongGames.PlayMaker.Actions.ArrayGetNext self);
    }
