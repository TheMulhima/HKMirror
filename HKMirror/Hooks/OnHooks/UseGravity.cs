...
public static class OnUseGravity
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.UseGravity), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.UseGravity> orig,
            HutongGames.PlayMaker.Actions.UseGravity self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.UseGravity), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.UseGravity> orig,
            HutongGames.PlayMaker.Actions.UseGravity self)
        {
        ...
        internal static void HookDoUseGravity()
        {
            if (!HookedList.Contains("DoUseGravity"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.UseGravity), "DoUseGravity",
                        true), DoUseGravity);
            }
        }
        ...
        private static void DoUseGravity(Action<HutongGames.PlayMaker.Actions.UseGravity> orig,
            HutongGames.PlayMaker.Actions.UseGravity self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.UseGravity> orig,
            HutongGames.PlayMaker.Actions.UseGravity self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.UseGravity> orig,
            HutongGames.PlayMaker.Actions.UseGravity self);
        ...
        public delegate void DoUseGravity_WithArgs(Action<HutongGames.PlayMaker.Actions.UseGravity> orig,
            HutongGames.PlayMaker.Actions.UseGravity self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.UseGravity), "Reset", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoUseGravity_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.UseGravity), "DoUseGravity", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.DoUseGravity_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.UseGravity), "DoUseGravity", true),
                value);
        }
    }
