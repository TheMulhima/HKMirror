...
public static class OnLensCAAndDistortion
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_material()
        {
            if (!HookedList.Contains("get_material"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LensCAAndDistortion), "get_material", true),
                    get_material);
            }
        }
        ...
        private static UnityEngine.Material get_material(Func<LensCAAndDistortion, UnityEngine.Material> orig,
        ...
        private static void OnRenderImage(On.LensCAAndDistortion.orig_OnRenderImage orig, LensCAAndDistortion self,
            UnityEngine.RenderTexture sourceTexture, UnityEngine.RenderTexture destTexture)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Material get_material_WithArgs(Func<LensCAAndDistortion, UnityEngine.Material> orig,
            LensCAAndDistortion self);
        ...
        public delegate void OnRenderImage_WithArgs(
            Action<LensCAAndDistortion, UnityEngine.RenderTexture, UnityEngine.RenderTexture> orig,
            LensCAAndDistortion self, UnityEngine.RenderTexture sourceTexture, UnityEngine.RenderTexture destTexture);
    ...
    public static class WithOrig
    {
        public static event Delegates.get_material_WithArgs get_material
        {
            add => HookEndpointManager.Add<Delegates.get_material_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LensCAAndDistortion), "get_material", true), value);
