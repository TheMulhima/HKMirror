...
public static class OnRazerStrikeControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RazerStrikeControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RazerStrikeControllerMacNativeProfile> orig,
            RazerStrikeControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerStrikeControllerMacNativeProfile> orig,
            RazerStrikeControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public RazerStrikeControllerMacNativeProfile self;
        }
    }
