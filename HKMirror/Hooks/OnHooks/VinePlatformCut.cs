...
private static void OnTriggerEnter2D(On.VinePlatformCut.orig_OnTriggerEnter2D orig,VinePlatformCut self,  UnityEngine.Collider2D collision)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<VinePlatformCut,  UnityEngine.Collider2D> orig, VinePlatformCut self,  UnityEngine.Collider2D collision);
...
public delegate void Disable_WithArgs (Action<VinePlatformCut,  bool> orig, VinePlatformCut self,  bool disableAll);
}
