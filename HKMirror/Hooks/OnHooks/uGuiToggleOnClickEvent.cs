...
public static class OnuGuiToggleOnClickEvent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleOnClickEvent), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiToggleOnClickEvent> orig, uGuiToggleOnClickEvent self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleOnClickEvent), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiToggleOnClickEvent> orig, uGuiToggleOnClickEvent self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleOnClickEvent), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiToggleOnClickEvent> orig, uGuiToggleOnClickEvent self)
        {
        ...
        internal static void HookDoOnValueChanged()
        {
            if (!HookedList.Contains("DoOnValueChanged"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiToggleOnClickEvent), "DoOnValueChanged"),
                    DoOnValueChanged);
            }
        }
        ...
        private static void DoOnValueChanged(Action<uGuiToggleOnClickEvent, bool> orig, uGuiToggleOnClickEvent self,
            bool value)
        {
    ...
    public static class Delegates
    {
        ...
        {
            public uGuiToggleOnClickEvent self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_NormalArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiToggleOnClickEvent), "Reset"), value);
        ...
        public static event Delegates.OnExit_NormalArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiToggleOnClickEvent), "OnExit"), value);
