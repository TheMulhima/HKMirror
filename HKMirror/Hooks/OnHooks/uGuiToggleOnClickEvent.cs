...
public static class OnuGuiToggleOnClickEvent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self)
        {
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self)
        {
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self)
        {
        ...
        internal static void HookDoOnValueChanged()
        {
            if (!HookedList.Contains("DoOnValueChanged"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent),
                        "DoOnValueChanged", true), DoOnValueChanged);
            }
        }
        ...
        private static void DoOnValueChanged(Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent, bool> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self, bool value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self);
        ...
        public delegate void DoOnValueChanged_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent, bool> orig,
            HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent self, bool value);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent), "Reset",
                    true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent), "OnEnter",
                    true), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiToggleOnClickEvent), "OnExit",
                    true), value);
