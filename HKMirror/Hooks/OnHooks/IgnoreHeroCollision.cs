...
public static class OnIgnoreHeroCollision
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.Ignore_NormalArgs _afterIgnore;
        ...
        private static void Ignore(On.IgnoreHeroCollision.orig_Ignore orig, IgnoreHeroCollision self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterIgnore != null) _afterIgnore.Invoke(@params);
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Ignore_NormalArgs(Params_Ignore args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.Ignore_NormalArgs Ignore
        {
            add
            {
