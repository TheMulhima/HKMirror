...
public static class OnNailSlash
{
    internal static class HookHandler
    {
        ...
        private static void Bounce(On.NailSlash.orig_Bounce orig, NailSlash self, UnityEngine.Collider2D otherCollider,
            bool useEffects)
        {
        ...
        internal static void Hookorig_OnTriggerEnter2D()
        {
            if (!HookedList.Contains("orig_OnTriggerEnter2D"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NailSlash), "orig_OnTriggerEnter2D", true),
        ...
        private static void orig_OnTriggerEnter2D(Action<NailSlash, UnityEngine.Collider2D> orig, NailSlash self,
            UnityEngine.Collider2D otherCollider)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<NailSlash, UnityEngine.Collider2D> orig, NailSlash self,
            UnityEngine.Collider2D otherCollider);
        ...
        public delegate void Bounce_WithArgs(Action<NailSlash, UnityEngine.Collider2D, bool> orig, NailSlash self,
            UnityEngine.Collider2D otherCollider, bool useEffects);
        ...
        public delegate void OnTriggerStay2D_WithArgs(Action<NailSlash, UnityEngine.Collider2D> orig, NailSlash self,
            UnityEngine.Collider2D otherCollider);
        ...
        public delegate void orig_OnTriggerEnter2D_WithArgs(Action<NailSlash, UnityEngine.Collider2D> orig,
            NailSlash self, UnityEngine.Collider2D otherCollider);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.orig_OnTriggerEnter2D_WithArgs orig_OnTriggerEnter2D
        {
            add => HookEndpointManager.Add<Delegates.orig_OnTriggerEnter2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NailSlash), "orig_OnTriggerEnter2D", true), value);
