...
private static void OnCollisionEnter2D(On.DropPlatform.orig_OnCollisionEnter2D orig,DropPlatform self,  UnityEngine.Collision2D collision)
{
...
private static void PlaySound(On.DropPlatform.orig_PlaySound orig,DropPlatform self,  UnityEngine.AudioClip clip)
{
...
private static System.Collections.IEnumerator Jitter(On.DropPlatform.orig_Jitter orig,DropPlatform self,  float duration)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<DropPlatform,  UnityEngine.Collision2D> orig, DropPlatform self,  UnityEngine.Collision2D collision);
...
public delegate void PlaySound_WithArgs (Action<DropPlatform,  UnityEngine.AudioClip> orig, DropPlatform self,  UnityEngine.AudioClip clip);
...
public delegate System.Collections.IEnumerator Flip_AfterArgs(Params_Flip args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Flip_WithArgs (Func<DropPlatform, System.Collections.IEnumerator> orig, DropPlatform self);
...
public delegate System.Collections.IEnumerator Jitter_WithArgs (Func<DropPlatform,  float, System.Collections.IEnumerator> orig, DropPlatform self,  float duration);
}
