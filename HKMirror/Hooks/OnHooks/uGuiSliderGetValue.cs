...
public static class OnuGuiSliderGetValue
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "DoGetValue"), DoGetValue);
            }
        }
        ...
        private static void DoGetValue(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetValue_WithArgs(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiSliderGetValue> orig, uGuiSliderGetValue self);

        public sealed class Params_Reset
        {
            public uGuiSliderGetValue self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "OnUpdate"), value);
        ...
        public static event Delegates.DoGetValue_WithArgs DoGetValue
        {
            add => HookEndpointManager.Add<Delegates.DoGetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderGetValue), "DoGetValue"), value);
