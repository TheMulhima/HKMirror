...
/// <summary>
/// Contains different types of On Hooks for OuyaWindowsUnityProfile class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnOuyaWindowsUnityProfile
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile> orig, InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile> orig, InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.OuyaWindowsUnityProfile), "Define", true), value);
}
}
