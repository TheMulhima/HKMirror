...
public static class OnOuyaWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(OuyaWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<OuyaWindowsUnityProfile> orig, OuyaWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<OuyaWindowsUnityProfile> orig, OuyaWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public OuyaWindowsUnityProfile self;
        }
    }
