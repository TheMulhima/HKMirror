...
public static class OnStalactiteControl
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator Fall_AfterArgs(Params_Fall args, IEnumerator ret);

        public delegate void Fall_BeforeArgs(Params_Fall args);

        public delegate IEnumerator Fall_WithArgs(Func<StalactiteControl, float, IEnumerator> orig,
            StalactiteControl self, float delay);
        ...
        public delegate void HandleTriggerEnter_WithArgs(Action<StalactiteControl, Collider2D, GameObject> orig,
            StalactiteControl self, Collider2D collider, GameObject sender);
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<StalactiteControl, Collider2D> orig,
            StalactiteControl self, Collider2D collision);
