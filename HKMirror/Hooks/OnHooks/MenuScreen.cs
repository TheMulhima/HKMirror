...
public static class OnMenuScreen
{
    ...
    {
        public delegate CanvasGroup get_screenCanvasGroup_AfterArgs(Params_get_screenCanvasGroup args, CanvasGroup ret);

        public delegate void get_screenCanvasGroup_BeforeArgs(Params_get_screenCanvasGroup args);

        public delegate CanvasGroup get_screenCanvasGroup_WithArgs(Func<MenuScreen, CanvasGroup> orig, MenuScreen self);
