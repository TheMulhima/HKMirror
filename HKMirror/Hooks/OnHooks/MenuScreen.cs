...
public static class OnMenuScreen
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_screenCanvasGroup()
        {
            if (!HookedList.Contains("get_screenCanvasGroup"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuScreen), "get_screenCanvasGroup"),
                    get_screenCanvasGroup);
            }
        }

        internal static event Delegates.get_screenCanvasGroup_BeforeArgs _beforeget_screenCanvasGroup;
        internal static event Delegates.get_screenCanvasGroup_NormalArgs _afterget_screenCanvasGroup;

        private static CanvasGroup get_screenCanvasGroup(Func<MenuScreen, CanvasGroup> orig, MenuScreen self)
        {
            ...
            if (_afterget_screenCanvasGroup != null) retVal = _afterget_screenCanvasGroup.Invoke(@params);
            return retVal;
        }
    ...
    public static class Delegates
    {
        ...
        public delegate CanvasGroup get_screenCanvasGroup_NormalArgs(Params_get_screenCanvasGroup args);
    ...
    {
        public static event Delegates.get_screenCanvasGroup_NormalArgs get_screenCanvasGroup
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_screenCanvasGroup_NormalArgs get_screenCanvasGroup
        {
            add => HookEndpointManager.Add<Delegates.get_screenCanvasGroup_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuScreen), "get_screenCanvasGroup"), value);
            remove => HookEndpointManager.Remove<Delegates.get_screenCanvasGroup_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuScreen), "get_screenCanvasGroup"), value);
        }
