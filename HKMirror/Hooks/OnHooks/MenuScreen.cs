...
public static class OnMenuScreen
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_screenCanvasGroup()
        {
            if (!HookedList.Contains("get_screenCanvasGroup"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuScreen), "get_screenCanvasGroup", true),
        ...
        private static UnityEngine.CanvasGroup get_screenCanvasGroup(Func<MenuScreen, UnityEngine.CanvasGroup> orig,
            MenuScreen self)
        {
            ...
            {
                foreach (Delegates.get_screenCanvasGroup_BeforeArgs toInvoke in _beforeget_screenCanvasGroup
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_screenCanvasGroup_AfterArgs toInvoke in _afterget_screenCanvasGroup
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.CanvasGroup get_screenCanvasGroup_AfterArgs(Params_get_screenCanvasGroup args,
            UnityEngine.CanvasGroup ret);

        public delegate UnityEngine.CanvasGroup get_screenCanvasGroup_WithArgs(
            Func<MenuScreen, UnityEngine.CanvasGroup> orig, MenuScreen self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_screenCanvasGroup_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuScreen), "get_screenCanvasGroup", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_screenCanvasGroup_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuScreen), "get_screenCanvasGroup", true), value);
        }
