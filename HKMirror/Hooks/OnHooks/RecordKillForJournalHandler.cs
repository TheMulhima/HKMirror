...
/// <summary>
/// Contains different types of On Hooks for RecordKillForJournalHandler class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnRecordKillForJournalHandler
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "Invoke", true), Invoke);
...
private static void Invoke(Action<Modding.Delegates.RecordKillForJournalHandler,  EnemyDeathEffects,  string,  string,  string,  string> orig, Modding.Delegates.RecordKillForJournalHandler self,  EnemyDeathEffects enemyDeathEffects,  string playerDataName,  string killedBoolPlayerDataLookupKey,  string killCountIntPlayerDataLookupKey,  string newDataBoolPlayerDataLookupKey)
{
...
orig(self, enemyDeathEffects, playerDataName, killedBoolPlayerDataLookupKey, killCountIntPlayerDataLookupKey, newDataBoolPlayerDataLookupKey);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "EndInvoke", true), EndInvoke);
...
private static void EndInvoke(Action<Modding.Delegates.RecordKillForJournalHandler,  System.IAsyncResult> orig, Modding.Delegates.RecordKillForJournalHandler self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.RecordKillForJournalHandler self;
...
public delegate void Invoke_WithArgs (Action<Modding.Delegates.RecordKillForJournalHandler,  EnemyDeathEffects,  string,  string,  string,  string> orig, Modding.Delegates.RecordKillForJournalHandler self,  EnemyDeathEffects enemyDeathEffects,  string playerDataName,  string killedBoolPlayerDataLookupKey,  string killCountIntPlayerDataLookupKey,  string newDataBoolPlayerDataLookupKey);
...
public delegate void EndInvoke_WithArgs (Action<Modding.Delegates.RecordKillForJournalHandler,  System.IAsyncResult> orig, Modding.Delegates.RecordKillForJournalHandler self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "EndInvoke", true), value);
}
}
