...
public static class OnRecordKillForJournalHandler
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RecordKillForJournalHandler), "Invoke"), Invoke);
            }
        }
        ...
        private static void Invoke(
            Action<RecordKillForJournalHandler, EnemyDeathEffects, string, string, string, string> orig,
            RecordKillForJournalHandler self, EnemyDeathEffects enemyDeathEffects, string playerDataName,
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RecordKillForJournalHandler), "EndInvoke"), EndInvoke);
            }
        }
        ...
        private static void EndInvoke(Action<RecordKillForJournalHandler, IAsyncResult> orig,
            RecordKillForJournalHandler self, IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public sealed class Params_Invoke
        {
            ...
            public RecordKillForJournalHandler self;
        }
