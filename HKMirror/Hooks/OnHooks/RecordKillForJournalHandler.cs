...
public static class OnRecordKillForJournalHandler
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "Invoke",
                        true), Invoke);
            }
        }
        ...
        private static void Invoke(
            Action<Modding.Delegates.RecordKillForJournalHandler, EnemyDeathEffects, string, string, string, string>
                orig, Modding.Delegates.RecordKillForJournalHandler self, EnemyDeathEffects enemyDeathEffects,
            ...
            string newDataBoolPlayerDataLookupKey)
        {
            ...
            {
                self = self, enemyDeathEffects = enemyDeathEffects, playerDataName = playerDataName,
            ...
            orig(self, enemyDeathEffects, playerDataName, killedBoolPlayerDataLookupKey,
                killCountIntPlayerDataLookupKey, newDataBoolPlayerDataLookupKey);
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "EndInvoke",
                        true), EndInvoke);
            }
        }
        ...
        private static void EndInvoke(Action<Modding.Delegates.RecordKillForJournalHandler, System.IAsyncResult> orig,
            Modding.Delegates.RecordKillForJournalHandler self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void EndInvoke_WithArgs(
            Action<Modding.Delegates.RecordKillForJournalHandler, System.IAsyncResult> orig,
            Modding.Delegates.RecordKillForJournalHandler self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.RecordKillForJournalHandler), "Invoke", true),
                value);
