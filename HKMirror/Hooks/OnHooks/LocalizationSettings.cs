...
private static Language.LanguageCode GetLanguageEnum(On.LocalizationSettings.orig_GetLanguageEnum orig, string langCode)
{
...
public delegate Language.LanguageCode GetLanguageEnum_AfterArgs(Params_GetLanguageEnum args, Language.LanguageCode ret);
public delegate Language.LanguageCode GetLanguageEnum_WithArgs (Func< string, Language.LanguageCode> orig,  string langCode);
}
