...
public static class OnLocalizationSettings
{
    ...
    {
        public delegate LanguageCode GetLanguageEnum_AfterArgs(Params_GetLanguageEnum args, LanguageCode ret);

        public delegate void GetLanguageEnum_BeforeArgs(Params_GetLanguageEnum args);

        public delegate LanguageCode GetLanguageEnum_WithArgs(Func<string, LanguageCode> orig, string langCode);
