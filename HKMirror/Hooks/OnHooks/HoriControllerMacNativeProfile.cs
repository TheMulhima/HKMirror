...
public static class OnHoriControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HoriControllerMacNativeProfile> orig, HoriControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriControllerMacNativeProfile> orig,
            HoriControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriControllerMacNativeProfile self;
        }
    }
