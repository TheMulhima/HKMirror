...
private static void LateUpdate(On.KeepWorldScalePositiveLate.orig_LateUpdate orig,KeepWorldScalePositiveLate self)
{
...
public delegate void LateUpdate_WithArgs (Action<KeepWorldScalePositiveLate> orig, KeepWorldScalePositiveLate self);
}
