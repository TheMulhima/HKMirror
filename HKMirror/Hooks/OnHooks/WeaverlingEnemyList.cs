...
public static class OnWeaverlingEnemyList
{
    internal static class HookHandler
    {
        ...
        private static void OnTriggerEnter2D(On.WeaverlingEnemyList.orig_OnTriggerEnter2D orig,
            WeaverlingEnemyList self, UnityEngine.Collider2D otherCollider)
        {
        ...
        private static UnityEngine.GameObject GetTarget(On.WeaverlingEnemyList.orig_GetTarget orig,
            WeaverlingEnemyList self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<WeaverlingEnemyList, UnityEngine.Collider2D> orig,
            WeaverlingEnemyList self, UnityEngine.Collider2D otherCollider);
        ...
        public delegate void OnTriggerExit2D_WithArgs(Action<WeaverlingEnemyList, UnityEngine.Collider2D> orig,
            WeaverlingEnemyList self, UnityEngine.Collider2D otherCollider);
        ...
        public delegate UnityEngine.GameObject GetTarget_WithArgs(
            Func<WeaverlingEnemyList, UnityEngine.GameObject> orig, WeaverlingEnemyList self);
    }
