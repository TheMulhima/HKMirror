...
{
foreach (Delegates.StartMarkerPlacement_BeforeArgs toInvoke in _beforeStartMarkerPlacement.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StartMarkerPlacement_AfterArgs toInvoke in _afterStartMarkerPlacement.GetInvocationList())
{
try
{
...
{
foreach (Delegates.MarkerSelectRight_BeforeArgs toInvoke in _beforeMarkerSelectRight.GetInvocationList())
{
try
{
...
private static void AddToCollidingList(On.MapMarkerMenu.orig_AddToCollidingList orig,MapMarkerMenu self,  UnityEngine.GameObject go)
{
...
{
foreach (Delegates.AddToCollidingList_BeforeArgs toInvoke in _beforeAddToCollidingList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddToCollidingList_AfterArgs toInvoke in _afterAddToCollidingList.GetInvocationList())
{
try
{
...
private static void RemoveFromCollidingList(On.MapMarkerMenu.orig_RemoveFromCollidingList orig,MapMarkerMenu self,  UnityEngine.GameObject go)
{
...
{
foreach (Delegates.RemoveFromCollidingList_BeforeArgs toInvoke in _beforeRemoveFromCollidingList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RemoveFromCollidingList_AfterArgs toInvoke in _afterRemoveFromCollidingList.GetInvocationList())
{
try
{
...
public delegate void AddToCollidingList_WithArgs (Action<MapMarkerMenu,  UnityEngine.GameObject> orig, MapMarkerMenu self,  UnityEngine.GameObject go);
...
public delegate void RemoveFromCollidingList_WithArgs (Action<MapMarkerMenu,  UnityEngine.GameObject> orig, MapMarkerMenu self,  UnityEngine.GameObject go);
