...
public static class OnMadCatzMLGFightStickTEMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzMLGFightStickTEMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzMLGFightStickTEMacNativeProfile> orig,
            MadCatzMLGFightStickTEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzMLGFightStickTEMacNativeProfile> orig,
            MadCatzMLGFightStickTEMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzMLGFightStickTEMacNativeProfile self;
        }
    }
