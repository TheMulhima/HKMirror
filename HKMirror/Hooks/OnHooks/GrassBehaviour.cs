...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GrassBehaviour), "get_SharedMaterial", true), get_SharedMaterial);
...
private static UnityEngine.Material get_SharedMaterial(Func<GrassBehaviour, UnityEngine.Material> orig, GrassBehaviour self)
{
...
private static System.Collections.IEnumerator DelayedInfectedCheck(On.GrassBehaviour.orig_DelayedInfectedCheck orig,GrassBehaviour self)
{
...
{
foreach (Delegates.DelayedInfectedCheck_BeforeArgs toInvoke in _beforeDelayedInfectedCheck.GetInvocationList())
{
try
{
...
private static void OnTriggerEnter2D(On.GrassBehaviour.orig_OnTriggerEnter2D orig,GrassBehaviour self,  UnityEngine.Collider2D collision)
{
...
private static void OnTriggerExit2D(On.GrassBehaviour.orig_OnTriggerExit2D orig,GrassBehaviour self,  UnityEngine.Collider2D collision)
{
...
private static void CutReact(On.GrassBehaviour.orig_CutReact orig,GrassBehaviour self,  UnityEngine.Collider2D collision)
{
...
private static void WindReact(On.GrassBehaviour.orig_WindReact orig,GrassBehaviour self,  UnityEngine.Collider2D collision)
{
...
private static void PlayRandomSound(On.GrassBehaviour.orig_PlayRandomSound orig,GrassBehaviour self,  UnityEngine.AudioClip[] clips)
{
...
private static void SetPushAmount(On.GrassBehaviour.orig_SetPushAmount orig,GrassBehaviour self,  UnityEngine.Renderer rend,  float value)
{
...
public delegate UnityEngine.Material get_SharedMaterial_WithArgs (Func<GrassBehaviour, UnityEngine.Material> orig, GrassBehaviour self);
...
public delegate System.Collections.IEnumerator DelayedInfectedCheck_AfterArgs(Params_DelayedInfectedCheck args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DelayedInfectedCheck_WithArgs (Func<GrassBehaviour, System.Collections.IEnumerator> orig, GrassBehaviour self);
...
public delegate void OnTriggerEnter2D_WithArgs (Action<GrassBehaviour,  UnityEngine.Collider2D> orig, GrassBehaviour self,  UnityEngine.Collider2D collision);
...
public delegate void OnTriggerExit2D_WithArgs (Action<GrassBehaviour,  UnityEngine.Collider2D> orig, GrassBehaviour self,  UnityEngine.Collider2D collision);
...
public delegate void CutReact_WithArgs (Action<GrassBehaviour,  UnityEngine.Collider2D> orig, GrassBehaviour self,  UnityEngine.Collider2D collision);
...
public delegate void WindReact_WithArgs (Action<GrassBehaviour,  UnityEngine.Collider2D> orig, GrassBehaviour self,  UnityEngine.Collider2D collision);
...
public delegate void PlayRandomSound_WithArgs (Action<GrassBehaviour,  UnityEngine.AudioClip[]> orig, GrassBehaviour self,  UnityEngine.AudioClip[] clips);
...
public delegate void SetPushAmount_WithArgs (Action<GrassBehaviour,  UnityEngine.Renderer,  float> orig, GrassBehaviour self,  UnityEngine.Renderer rend,  float value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_SharedMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrassBehaviour), "get_SharedMaterial", true), value);
remove => HookEndpointManager.Remove<Delegates.get_SharedMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrassBehaviour), "get_SharedMaterial", true), value);
}
