...
public static class OnGrassBehaviour
{
    ...
    public static class Delegates
    {
        ...
        public delegate void CutReact_WithArgs(Action<GrassBehaviour, Collider2D> orig, GrassBehaviour self,
            Collider2D collision);

        public delegate IEnumerator DelayedInfectedCheck_AfterArgs(Params_DelayedInfectedCheck args, IEnumerator ret);

        public delegate void DelayedInfectedCheck_BeforeArgs(Params_DelayedInfectedCheck args);

        public delegate IEnumerator DelayedInfectedCheck_WithArgs(Func<GrassBehaviour, IEnumerator> orig,
            GrassBehaviour self);
        ...
        public delegate Material get_SharedMaterial_WithArgs(Func<GrassBehaviour, Material> orig, GrassBehaviour self);
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<GrassBehaviour, Collider2D> orig, GrassBehaviour self,
            Collider2D collision);
        ...
        public delegate void OnTriggerExit2D_WithArgs(Action<GrassBehaviour, Collider2D> orig, GrassBehaviour self,
            Collider2D collision);
        ...
        public delegate void PlayRandomSound_WithArgs(Action<GrassBehaviour, AudioClip[]> orig, GrassBehaviour self,
            AudioClip[] clips);
        ...
        public delegate void SetPushAmount_WithArgs(Action<GrassBehaviour, Renderer, float> orig, GrassBehaviour self,
            Renderer rend, float value);
        ...
        public delegate void WindReact_WithArgs(Action<GrassBehaviour, Collider2D> orig, GrassBehaviour self,
            Collider2D collision);
