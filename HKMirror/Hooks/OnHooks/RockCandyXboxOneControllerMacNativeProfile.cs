...
public static class OnRockCandyXboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RockCandyXboxOneControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RockCandyXboxOneControllerMacNativeProfile> orig,
            RockCandyXboxOneControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RockCandyXboxOneControllerMacNativeProfile> orig,
            RockCandyXboxOneControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public RockCandyXboxOneControllerMacNativeProfile self;
        }
    }
