...
public static class OnCollision2dEventLayer
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<Collision2dEventLayer> orig, Collision2dEventLayer self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Collision2dEventLayer> orig, Collision2dEventLayer self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<Collision2dEventLayer> orig, Collision2dEventLayer self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "StoreCollisionInfo"),
                    StoreCollisionInfo);
            }
        }
        ...
        private static void StoreCollisionInfo(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo)
        {
        ...
        internal static void HookDoCollisionEnter2D()
        {
            if (!HookedList.Contains("DoCollisionEnter2D"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "DoCollisionEnter2D"),
                    DoCollisionEnter2D);
            }
        }
        ...
        private static void DoCollisionEnter2D(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo)
        {
        ...
        internal static void HookDoCollisionStay2D()
        {
            if (!HookedList.Contains("DoCollisionStay2D"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "DoCollisionStay2D"),
                    DoCollisionStay2D);
            }
        }
        ...
        private static void DoCollisionStay2D(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo)
        {
        ...
        internal static void HookDoCollisionExit2D()
        {
            if (!HookedList.Contains("DoCollisionExit2D"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "DoCollisionExit2D"),
                    DoCollisionExit2D);
            }
        }
        ...
        private static void DoCollisionExit2D(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "ErrorCheck"), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<Collision2dEventLayer, string> orig, Collision2dEventLayer self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoCollisionEnter2D_WithArgs(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo);
        ...
        public delegate void DoCollisionExit2D_WithArgs(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo);
        ...
        public delegate void DoCollisionStay2D_WithArgs(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo);
        ...
        public delegate string ErrorCheck_WithArgs(Func<Collision2dEventLayer, string> orig,
            Collision2dEventLayer self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<Collision2dEventLayer> orig, Collision2dEventLayer self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<Collision2dEventLayer> orig, Collision2dEventLayer self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Collision2dEventLayer> orig, Collision2dEventLayer self);
        ...
        public delegate void StoreCollisionInfo_WithArgs(Action<Collision2dEventLayer, Collision2D> orig,
            Collision2dEventLayer self, Collision2D collisionInfo);

        public sealed class Params_Reset
        {
            public Collision2dEventLayer self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "OnEnter"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Collision2dEventLayer), "OnExit"), value);
