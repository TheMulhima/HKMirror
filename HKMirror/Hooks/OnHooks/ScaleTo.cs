...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "Reset", true), Reset);

}
}
internal static event Delegates.Reset_BeforeArgs _beforeReset;
internal static event Delegates.Reset_AfterArgs _afterReset;
private static void Reset(Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "OnEnter", true), OnEnter);

}
}
internal static event Delegates.OnEnter_BeforeArgs _beforeOnEnter;
internal static event Delegates.OnEnter_AfterArgs _afterOnEnter;
private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "OnUpdate", true), OnUpdate);

}
}
internal static event Delegates.OnUpdate_BeforeArgs _beforeOnUpdate;
internal static event Delegates.OnUpdate_AfterArgs _afterOnUpdate;
private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "UpdateScaling", true), UpdateScaling);
...
private static void UpdateScaling(Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "GetCurved", false), GetCurved);
...
private static float GetCurved(Func< float,  HutongGames.PlayMaker.Actions.ScaleToCurves, float> orig,  float val,  HutongGames.PlayMaker.Actions.ScaleToCurves curve)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "Linear", false), Linear);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "QuadraticOut", false), QuadraticOut);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "SinusoidalOut", false), SinusoidalOut);
...
public delegate void Reset_WithArgs (Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self);
...
public delegate void OnEnter_WithArgs (Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self);
...
public delegate void OnUpdate_WithArgs (Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self);
...
public delegate void UpdateScaling_WithArgs (Action<HutongGames.PlayMaker.Actions.ScaleTo> orig, HutongGames.PlayMaker.Actions.ScaleTo self);
...
public delegate float GetCurved_WithArgs (Func< float,  HutongGames.PlayMaker.Actions.ScaleToCurves, float> orig,  float val,  HutongGames.PlayMaker.Actions.ScaleToCurves curve);
...
{
add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "Reset", true), value);
remove => HookEndpointManager.Remove<Delegates.Reset_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "Reset", true), value);
}
public static event Delegates.OnEnter_WithArgs OnEnter
{
add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "OnEnter", true), value);
remove => HookEndpointManager.Remove<Delegates.OnEnter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "OnEnter", true), value);
}
public static event Delegates.OnUpdate_WithArgs OnUpdate
{
add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "OnUpdate", true), value);
remove => HookEndpointManager.Remove<Delegates.OnUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "OnUpdate", true), value);
}
public static event Delegates.UpdateScaling_WithArgs UpdateScaling
{
add => HookEndpointManager.Add<Delegates.UpdateScaling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "UpdateScaling", true), value);
remove => HookEndpointManager.Remove<Delegates.UpdateScaling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "UpdateScaling", true), value);
}
public static event Delegates.GetCurved_WithArgs GetCurved
{
add => HookEndpointManager.Add<Delegates.GetCurved_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "GetCurved", false), value);
remove => HookEndpointManager.Remove<Delegates.GetCurved_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "GetCurved", false), value);
}
public static event Delegates.Linear_WithArgs Linear
{
add => HookEndpointManager.Add<Delegates.Linear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "Linear", false), value);
remove => HookEndpointManager.Remove<Delegates.Linear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "Linear", false), value);
}
public static event Delegates.QuadraticOut_WithArgs QuadraticOut
{
add => HookEndpointManager.Add<Delegates.QuadraticOut_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "QuadraticOut", false), value);
remove => HookEndpointManager.Remove<Delegates.QuadraticOut_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "QuadraticOut", false), value);
}
public static event Delegates.SinusoidalOut_WithArgs SinusoidalOut
{
add => HookEndpointManager.Add<Delegates.SinusoidalOut_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "SinusoidalOut", false), value);
remove => HookEndpointManager.Remove<Delegates.SinusoidalOut_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScaleTo), "SinusoidalOut", false), value);
}
}
