...
public static class OnEightBitdoSFC30MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSFC30MacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSFC30MacUnityProfile> orig, EightBitdoSFC30MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSFC30MacUnityProfile> orig,
            EightBitdoSFC30MacUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSFC30MacUnityProfile self;
        }
    }
