...
public static class OnEightBitdoSFC30MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoSFC30MacUnityProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.EightBitdoSFC30MacUnityProfile> orig,
            InControl.UnityDeviceProfiles.EightBitdoSFC30MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<InControl.UnityDeviceProfiles.EightBitdoSFC30MacUnityProfile> orig,
            InControl.UnityDeviceProfiles.EightBitdoSFC30MacUnityProfile self);
    }
