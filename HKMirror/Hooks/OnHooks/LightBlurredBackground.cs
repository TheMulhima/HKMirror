...
public static class OnLightBlurredBackground
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_RenderTextureHeight()
        {
            if (!HookedList.Contains("get_RenderTextureHeight"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "get_RenderTextureHeight", true),
        ...
        private static int get_RenderTextureHeight(Func<LightBlurredBackground, int> orig, LightBlurredBackground self)
        {
            ...
            {
                foreach (Delegates.get_RenderTextureHeight_BeforeArgs toInvoke in _beforeget_RenderTextureHeight
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_RenderTextureHeight_AfterArgs toInvoke in _afterget_RenderTextureHeight
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_RenderTextureHeight()
        {
            if (!HookedList.Contains("set_RenderTextureHeight"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "set_RenderTextureHeight", true),
            ...
            LightBlurredBackground self, int value)
        {
            ...
            {
                foreach (Delegates.set_RenderTextureHeight_BeforeArgs toInvoke in _beforeset_RenderTextureHeight
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_RenderTextureHeight_AfterArgs toInvoke in _afterset_RenderTextureHeight
                             .GetInvocationList())
                {
                    try
                    {
            ...
            LightBlurredBackground self, float aspect)
        {
            ...
            {
                foreach (Delegates.OnCameraAspectChanged_BeforeArgs toInvoke in _beforeOnCameraAspectChanged
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.OnCameraAspectChanged_AfterArgs toInvoke in _afterOnCameraAspectChanged
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_PassGroupCount()
        {
            if (!HookedList.Contains("get_PassGroupCount"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "get_PassGroupCount", true),
                    get_PassGroupCount);
            }
        }
        ...
        private static int get_PassGroupCount(Func<LightBlurredBackground, int> orig, LightBlurredBackground self)
        {
            ...
            {
                foreach (Delegates.get_PassGroupCount_BeforeArgs toInvoke in
                         _beforeget_PassGroupCount.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_PassGroupCount_AfterArgs toInvoke in
                         _afterget_PassGroupCount.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_PassGroupCount()
        {
            if (!HookedList.Contains("set_PassGroupCount"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "set_PassGroupCount", true),
                    set_PassGroupCount);
            }
        }
            ...
            int value)
        {
            ...
            {
                foreach (Delegates.set_PassGroupCount_BeforeArgs toInvoke in
                         _beforeset_PassGroupCount.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_PassGroupCount_AfterArgs toInvoke in
                         _afterset_PassGroupCount.GetInvocationList())
                {
                    try
                    {
            ...
            LightBlurredBackground self)
        {
            ...
            {
                foreach (Delegates.OnBlurPlanesChanged_BeforeArgs toInvoke in _beforeOnBlurPlanesChanged
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.OnBlurPlanesChanged_AfterArgs toInvoke in
                         _afterOnBlurPlanesChanged.GetInvocationList())
                {
                    try
                    {
            ...
            LightBlurredBackground self)
        {
            ...
            {
                foreach (Delegates.UpdateCameraClipPlanes_BeforeArgs toInvoke in _beforeUpdateCameraClipPlanes
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.UpdateCameraClipPlanes_AfterArgs toInvoke in _afterUpdateCameraClipPlanes
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate int get_RenderTextureHeight_WithArgs(Func<LightBlurredBackground, int> orig,
            LightBlurredBackground self);
        ...
        public delegate void set_RenderTextureHeight_WithArgs(Action<LightBlurredBackground, int> orig,
            LightBlurredBackground self, int value);
        ...
        public delegate void OnCameraAspectChanged_WithArgs(Action<LightBlurredBackground, float> orig,
            LightBlurredBackground self, float aspect);
        ...
        public delegate int get_PassGroupCount_WithArgs(Func<LightBlurredBackground, int> orig,
            LightBlurredBackground self);
        ...
        public delegate void set_PassGroupCount_WithArgs(Action<LightBlurredBackground, int> orig,
            LightBlurredBackground self, int value);
        ...
        public delegate void OnBlurPlanesChanged_WithArgs(Action<LightBlurredBackground> orig,
            LightBlurredBackground self);
        ...
        public delegate void UpdateCameraClipPlanes_WithArgs(Action<LightBlurredBackground> orig,
            LightBlurredBackground self);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_RenderTextureHeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "get_RenderTextureHeight", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_RenderTextureHeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "get_RenderTextureHeight", true), value);
        }

        public static event Delegates.set_RenderTextureHeight_WithArgs set_RenderTextureHeight
        {
            add => HookEndpointManager.Add<Delegates.set_RenderTextureHeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "set_RenderTextureHeight", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_RenderTextureHeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "set_RenderTextureHeight", true), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_PassGroupCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "get_PassGroupCount", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_PassGroupCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "get_PassGroupCount", true), value);
        }

        public static event Delegates.set_PassGroupCount_WithArgs set_PassGroupCount
        {
            add => HookEndpointManager.Add<Delegates.set_PassGroupCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "set_PassGroupCount", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_PassGroupCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LightBlurredBackground), "set_PassGroupCount", true), value);
        }
