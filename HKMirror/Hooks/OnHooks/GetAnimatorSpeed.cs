...
public static class OnGetAnimatorSpeed
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorSpeed), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorSpeed), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorSpeed),
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self)
        {
        ...
        internal static void HookGetPlaybackSpeed()
        {
            if (!HookedList.Contains("GetPlaybackSpeed"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorSpeed),
                        "GetPlaybackSpeed", true), GetPlaybackSpeed);
            }
        }
        ...
        private static void GetPlaybackSpeed(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self);
        ...
        public delegate void OnActionUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self);
        ...
        public delegate void GetPlaybackSpeed_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorSpeed> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorSpeed self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorSpeed), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorSpeed), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnActionUpdate_WithArgs OnActionUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnActionUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorSpeed), "OnActionUpdate",
                    true), value);
