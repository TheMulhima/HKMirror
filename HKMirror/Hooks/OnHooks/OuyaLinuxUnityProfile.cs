...
public static class OnOuyaLinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(OuyaLinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<OuyaLinuxUnityProfile> orig, OuyaLinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<OuyaLinuxUnityProfile> orig, OuyaLinuxUnityProfile self);

        public sealed class Params_Define
        {
            public OuyaLinuxUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(OuyaLinuxUnityProfile), "Define"), value);
