...
/// <summary>
/// Contains different types of On Hooks for OuyaLinuxUnityProfile class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnOuyaLinuxUnityProfile
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile> orig, InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile> orig, InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.OuyaLinuxUnityProfile), "Define", true), value);
}
}
