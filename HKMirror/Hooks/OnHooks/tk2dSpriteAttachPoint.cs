...
public static class Ontk2dSpriteAttachPoint
{
    internal static class HookHandler
    {
        ...
        private static void UpdateAttachPointTransform(On.tk2dSpriteAttachPoint.orig_UpdateAttachPointTransform orig,
            tk2dSpriteAttachPoint self, tk2dSpriteDefinition.AttachPoint attachPoint, Transform t)
        {
            Delegates.Params_UpdateAttachPointTransform @params = new()
            {
                self = self, attachPoint = attachPoint, t = t
            };
            if (_beforeUpdateAttachPointTransform != null)
                foreach (Delegates.UpdateAttachPointTransform_BeforeArgs toInvoke in _beforeUpdateAttachPointTransform
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterUpdateAttachPointTransform != null)
                foreach (Delegates.UpdateAttachPointTransform_AfterArgs toInvoke in _afterUpdateAttachPointTransform
                             .GetInvocationList())
                    try
                    {
            ...
            tk2dSpriteAttachPoint self, tk2dBaseSprite spr)
        {
            ...
            if (_beforeHandleSpriteChanged != null)
                foreach (Delegates.HandleSpriteChanged_BeforeArgs toInvoke in _beforeHandleSpriteChanged
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterHandleSpriteChanged != null)
                foreach (Delegates.HandleSpriteChanged_AfterArgs toInvoke in
                         _afterHandleSpriteChanged.GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate string GetInstanceName_WithArgs(Func<tk2dSpriteAttachPoint, Transform, string> orig,
            tk2dSpriteAttachPoint self, Transform t);
        ...
        public delegate void HandleSpriteChanged_WithArgs(Action<tk2dSpriteAttachPoint, tk2dBaseSprite> orig,
            tk2dSpriteAttachPoint self, tk2dBaseSprite spr);
        ...
        public delegate void UpdateAttachPointTransform_WithArgs(
            Action<tk2dSpriteAttachPoint, tk2dSpriteDefinition.AttachPoint, Transform> orig, tk2dSpriteAttachPoint self,
            tk2dSpriteDefinition.AttachPoint attachPoint, Transform t);
