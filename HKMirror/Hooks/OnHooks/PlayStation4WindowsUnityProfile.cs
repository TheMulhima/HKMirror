...
public static class OnPlayStation4WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4WindowsUnityProfile> orig, PlayStation4WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4WindowsUnityProfile> orig,
            PlayStation4WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4WindowsUnityProfile self;
        }
    }
