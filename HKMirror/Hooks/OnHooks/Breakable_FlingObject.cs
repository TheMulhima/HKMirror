...
public static class OnBreakable_FlingObject
{
    internal static class HookHandler
    {
        ...
        internal static void HookFling()
        {
            if (!HookedList.Contains("Fling"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Breakable.FlingObject), "Fling"), Fling);
            }
        }
        ...
        private static void Fling(Action<Breakable.FlingObject, Vector3> orig, Breakable.FlingObject self,
            Vector3 origin)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Fling_WithArgs(Action<Breakable.FlingObject, Vector3> orig, Breakable.FlingObject self,
            Vector3 origin);
    ...
    public static class WithOrig
    {
        public static event Delegates.Fling_WithArgs Fling
        {
            add => HookEndpointManager.Add<Delegates.Fling_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Breakable.FlingObject), "Fling"), value);
