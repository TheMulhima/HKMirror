...
public static class OnSaveSlotBackgrounds
{
    internal static class HookHandler
    {
            ...
            SaveSlotBackgrounds self, string areaName)
        {
            ...
            {
                foreach (Delegates.GetBackground_string_BeforeArgs toInvoke in _beforeGetBackground_string
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetBackground_string_AfterArgs toInvoke in _afterGetBackground_string
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static AreaBackground GetBackground_MapZone(On.SaveSlotBackgrounds.orig_GetBackground_MapZone orig,
            SaveSlotBackgrounds self, GlobalEnums.MapZone mapZone)
        {
            ...
            {
                foreach (Delegates.GetBackground_MapZone_BeforeArgs toInvoke in _beforeGetBackground_MapZone
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetBackground_MapZone_AfterArgs toInvoke in _afterGetBackground_MapZone
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate AreaBackground GetBackground_string_AfterArgs(Params_GetBackground_string args,
            AreaBackground ret);

        public delegate AreaBackground GetBackground_string_WithArgs(
            Func<SaveSlotBackgrounds, string, AreaBackground> orig, SaveSlotBackgrounds self, string areaName);
        ...
        public delegate AreaBackground GetBackground_MapZone_AfterArgs(Params_GetBackground_MapZone args,
            AreaBackground ret);

        public delegate AreaBackground GetBackground_MapZone_WithArgs(
            Func<SaveSlotBackgrounds, GlobalEnums.MapZone, AreaBackground> orig, SaveSlotBackgrounds self,
