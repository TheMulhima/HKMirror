...
internal static event Delegates.GetBackground_string_AfterArgs _afterGetBackground_string;
private static AreaBackground GetBackground_string(On.SaveSlotBackgrounds.orig_GetBackground_string orig,SaveSlotBackgrounds self,  string areaName)
{
...
if (_beforeGetBackground_string != null)
{
foreach (Delegates.GetBackground_string_BeforeArgs toInvoke in _beforeGetBackground_string.GetInvocationList())
{
try
{
...
if (_afterGetBackground_string != null)
{
foreach (Delegates.GetBackground_string_AfterArgs toInvoke in _afterGetBackground_string.GetInvocationList())
{
try
{
retVal = _afterGetBackground_string.Invoke(@params, retVal);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
internal static event Delegates.GetBackground_MapZone_AfterArgs _afterGetBackground_MapZone;
private static AreaBackground GetBackground_MapZone(On.SaveSlotBackgrounds.orig_GetBackground_MapZone orig,SaveSlotBackgrounds self,  GlobalEnums.MapZone mapZone)
{
...
if (_beforeGetBackground_MapZone != null)
{
foreach (Delegates.GetBackground_MapZone_BeforeArgs toInvoke in _beforeGetBackground_MapZone.GetInvocationList())
{
try
{
...
if (_afterGetBackground_MapZone != null)
{
foreach (Delegates.GetBackground_MapZone_AfterArgs toInvoke in _afterGetBackground_MapZone.GetInvocationList())
{
try
{
retVal = _afterGetBackground_MapZone.Invoke(@params, retVal);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
public delegate AreaBackground GetBackground_string_AfterArgs(Params_GetBackground_string args, AreaBackground ret);
public delegate AreaBackground GetBackground_string_WithArgs (Func<SaveSlotBackgrounds,  string, AreaBackground> orig, SaveSlotBackgrounds self,  string areaName);
...
public delegate AreaBackground GetBackground_MapZone_AfterArgs(Params_GetBackground_MapZone args, AreaBackground ret);
public delegate AreaBackground GetBackground_MapZone_WithArgs (Func<SaveSlotBackgrounds,  GlobalEnums.MapZone, AreaBackground> orig, SaveSlotBackgrounds self,  GlobalEnums.MapZone mapZone);
}
...
{
public static event Delegates.GetBackground_string_AfterArgs GetBackground_string
{
add
{
...
public static event Delegates.GetBackground_MapZone_AfterArgs GetBackground_MapZone
{
add
{
