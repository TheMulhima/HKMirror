...
public static class OnGodfinderInvIcon_BossSceneExtra
{
    internal static class HookHandler
    {
        ...
        internal static void HookIsUnlocked()
        {
            if (!HookedList.Contains("IsUnlocked"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GodfinderInvIcon.BossSceneExtra), "IsUnlocked"),
                    IsUnlocked);
            }
        }
        ...
        private static bool IsUnlocked(Func<GodfinderInvIcon.BossSceneExtra, bool> orig,
            GodfinderInvIcon.BossSceneExtra self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate bool IsUnlocked_WithArgs(Func<GodfinderInvIcon.BossSceneExtra, bool> orig,
            GodfinderInvIcon.BossSceneExtra self);
