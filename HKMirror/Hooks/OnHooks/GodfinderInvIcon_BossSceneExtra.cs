...
/// <summary>
/// Contains different types of On Hooks for GodfinderInvIcon_BossSceneExtra class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGodfinderInvIcon_BossSceneExtra
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GodfinderInvIcon.BossSceneExtra), "IsUnlocked", true), IsUnlocked);
...
private static bool IsUnlocked(Func<GodfinderInvIcon.BossSceneExtra, bool> orig, GodfinderInvIcon.BossSceneExtra self)
{
...
{
public GodfinderInvIcon.BossSceneExtra self;
}
...
public delegate bool IsUnlocked_WithArgs (Func<GodfinderInvIcon.BossSceneExtra, bool> orig, GodfinderInvIcon.BossSceneExtra self);
}
...
{
add => HookEndpointManager.Add<Delegates.IsUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GodfinderInvIcon.BossSceneExtra), "IsUnlocked", true), value);
remove => HookEndpointManager.Remove<Delegates.IsUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GodfinderInvIcon.BossSceneExtra), "IsUnlocked", true), value);
}
}
