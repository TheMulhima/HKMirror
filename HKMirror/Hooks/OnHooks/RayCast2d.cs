...
public static class OnRayCast2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<RayCast2d> orig, RayCast2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<RayCast2d> orig, RayCast2d self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<RayCast2d> orig, RayCast2d self)
        {
        ...
        internal static void HookDoRaycast()
        {
            if (!HookedList.Contains("DoRaycast"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "DoRaycast"), DoRaycast);
            }
        }
        ...
        private static void DoRaycast(Action<RayCast2d> orig, RayCast2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoRaycast_WithArgs(Action<RayCast2d> orig, RayCast2d self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<RayCast2d> orig, RayCast2d self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<RayCast2d> orig, RayCast2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<RayCast2d> orig, RayCast2d self);

        public sealed class Params_Reset
        {
            public RayCast2d self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "OnUpdate"), value);
        ...
        public static event Delegates.DoRaycast_WithArgs DoRaycast
        {
            add => HookEndpointManager.Add<Delegates.DoRaycast_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RayCast2d), "DoRaycast"), value);
