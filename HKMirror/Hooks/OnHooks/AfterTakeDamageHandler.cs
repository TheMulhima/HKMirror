...
public static class OnAfterTakeDamageHandler
{
    ...
    public static class Delegates
    {
        ...
        public delegate int EndInvoke_WithArgs(Func<AfterTakeDamageHandler, IAsyncResult, int> orig,
            AfterTakeDamageHandler self, IAsyncResult result);

        public delegate int Invoke_AfterArgs(Params_Invoke args, int ret);

        public delegate void Invoke_BeforeArgs(Params_Invoke args);

        public delegate int Invoke_WithArgs(Func<AfterTakeDamageHandler, int, int, int> orig,
            AfterTakeDamageHandler self, int hazardType, int damageAmount);
