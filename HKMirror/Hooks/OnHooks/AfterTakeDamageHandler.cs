...
public static class OnAfterTakeDamageHandler
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.AfterTakeDamageHandler), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static int Invoke(Func<Modding.Delegates.AfterTakeDamageHandler, int, int, int> orig,
            Modding.Delegates.AfterTakeDamageHandler self, int hazardType, int damageAmount)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.AfterTakeDamageHandler), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static int EndInvoke(Func<Modding.Delegates.AfterTakeDamageHandler, System.IAsyncResult, int> orig,
            Modding.Delegates.AfterTakeDamageHandler self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate int Invoke_WithArgs(Func<Modding.Delegates.AfterTakeDamageHandler, int, int, int> orig,
            Modding.Delegates.AfterTakeDamageHandler self, int hazardType, int damageAmount);
        ...
        public delegate int EndInvoke_WithArgs(
            Func<Modding.Delegates.AfterTakeDamageHandler, System.IAsyncResult, int> orig,
            Modding.Delegates.AfterTakeDamageHandler self, System.IAsyncResult result);
    }
