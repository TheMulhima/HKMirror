...
public static class OnXbox360MortalKombatFightStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Xbox360MortalKombatFightStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<Xbox360MortalKombatFightStickMacNativeProfile> orig,
            Xbox360MortalKombatFightStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360MortalKombatFightStickMacNativeProfile> orig,
            Xbox360MortalKombatFightStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public Xbox360MortalKombatFightStickMacNativeProfile self;
        }
    }
