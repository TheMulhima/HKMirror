...
public static class OnXbox360MortalKombatFightStickMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.Xbox360MortalKombatFightStickMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.Xbox360MortalKombatFightStickMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.Xbox360MortalKombatFightStickMacNativeProfile self)
        {
