...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossChallengeUI.ButtonDisplay), "SetupNavigation", true), SetupNavigation);
...
private static void SetupNavigation(Action<BossChallengeUI.ButtonDisplay,  bool,  BossChallengeUI.ButtonDisplay,  BossChallengeUI.ButtonDisplay> orig, BossChallengeUI.ButtonDisplay self,  bool isActive,  BossChallengeUI.ButtonDisplay selectOnUp,  BossChallengeUI.ButtonDisplay selectOnDown)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossChallengeUI.ButtonDisplay), "SetState", true), SetState);
...
private static void SetState(Action<BossChallengeUI.ButtonDisplay,  bool> orig, BossChallengeUI.ButtonDisplay self,  bool isComplete)
{
...
public delegate void SetupNavigation_WithArgs (Action<BossChallengeUI.ButtonDisplay,  bool,  BossChallengeUI.ButtonDisplay,  BossChallengeUI.ButtonDisplay> orig, BossChallengeUI.ButtonDisplay self,  bool isActive,  BossChallengeUI.ButtonDisplay selectOnUp,  BossChallengeUI.ButtonDisplay selectOnDown);
...
public delegate void SetState_WithArgs (Action<BossChallengeUI.ButtonDisplay,  bool> orig, BossChallengeUI.ButtonDisplay self,  bool isComplete);
}
...
{
add => HookEndpointManager.Add<Delegates.SetupNavigation_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossChallengeUI.ButtonDisplay), "SetupNavigation", true), value);
remove => HookEndpointManager.Remove<Delegates.SetupNavigation_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossChallengeUI.ButtonDisplay), "SetupNavigation", true), value);
}
public static event Delegates.SetState_WithArgs SetState
{
add => HookEndpointManager.Add<Delegates.SetState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossChallengeUI.ButtonDisplay), "SetState", true), value);
remove => HookEndpointManager.Remove<Delegates.SetState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossChallengeUI.ButtonDisplay), "SetState", true), value);
}
}
