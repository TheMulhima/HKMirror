...
public static class OnGetNamedParent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNamedParent), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetNamedParent> orig,
            HutongGames.PlayMaker.Actions.GetNamedParent self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNamedParent), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetNamedParent> orig,
            HutongGames.PlayMaker.Actions.GetNamedParent self)
        {
        ...
        internal static void HookDoGetParentByName()
        {
            if (!HookedList.Contains("DoGetParentByName"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNamedParent),
                        "DoGetParentByName", false), DoGetParentByName);
            }
        }
        ...
        private static UnityEngine.GameObject DoGetParentByName(
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNamedParent), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.GetNamedParent, string> orig,
            HutongGames.PlayMaker.Actions.GetNamedParent self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNamedParent> orig,
            HutongGames.PlayMaker.Actions.GetNamedParent self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNamedParent> orig,
            HutongGames.PlayMaker.Actions.GetNamedParent self);
        ...
        public delegate UnityEngine.GameObject DoGetParentByName_AfterArgs(Params_DoGetParentByName args,
            UnityEngine.GameObject ret);

        public delegate UnityEngine.GameObject DoGetParentByName_WithArgs(
            Func<UnityEngine.GameObject, string, string, UnityEngine.GameObject> orig, UnityEngine.GameObject root,
            string name, string tag);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.GetNamedParent, string> orig,
            HutongGames.PlayMaker.Actions.GetNamedParent self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNamedParent), "OnEnter", true),
                value);
