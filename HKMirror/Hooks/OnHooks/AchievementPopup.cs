...
private static void Setup(On.AchievementPopup.orig_Setup orig,AchievementPopup self,  UnityEngine.Sprite icon,  string name,  string description)
{
...
public delegate void Setup_WithArgs (Action<AchievementPopup,  UnityEngine.Sprite,  string,  string> orig, AchievementPopup self,  UnityEngine.Sprite icon,  string name,  string description);
