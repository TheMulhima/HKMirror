...
public static class OnEightBitdoSF30ProAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSF30ProAndroidUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSF30ProAndroidUnityProfile> orig,
            EightBitdoSF30ProAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSF30ProAndroidUnityProfile> orig,
            EightBitdoSF30ProAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSF30ProAndroidUnityProfile self;
        }
    }
