...
private static float GetLeftmostVertex(On.GetTMProLeftVertex.orig_GetLeftmostVertex orig,GetTMProLeftVertex self)
{
...
{
foreach (Delegates.GetLeftmostVertex_BeforeArgs toInvoke in _beforeGetLeftmostVertex.GetInvocationList())
{
try
{
