...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.UpdateHelper), "SetDirty", false), SetDirty);
...
{
add => HookEndpointManager.Add<Delegates.SetDirty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.UpdateHelper), "SetDirty", false), value);
remove => HookEndpointManager.Remove<Delegates.SetDirty_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.UpdateHelper), "SetDirty", false), value);
}
}
