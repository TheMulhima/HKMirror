...
public static class OnResetGUIMatrix
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ResetGUIMatrix), "OnGUI", true),
                    OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.ResetGUIMatrix> orig,
            HutongGames.PlayMaker.Actions.ResetGUIMatrix self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.ResetGUIMatrix> orig,
            HutongGames.PlayMaker.Actions.ResetGUIMatrix self);
    }
