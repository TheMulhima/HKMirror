...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ResetGUIMatrix), "OnGUI", true), OnGUI);

}
}
internal static event Delegates.OnGUI_BeforeArgs _beforeOnGUI;
internal static event Delegates.OnGUI_AfterArgs _afterOnGUI;
private static void OnGUI(Action<HutongGames.PlayMaker.Actions.ResetGUIMatrix> orig, HutongGames.PlayMaker.Actions.ResetGUIMatrix self)
{
...
{
public HutongGames.PlayMaker.Actions.ResetGUIMatrix self;
}
public delegate void OnGUI_BeforeArgs(Params_OnGUI args);
public delegate void OnGUI_AfterArgs(Params_OnGUI args);
public delegate void OnGUI_WithArgs (Action<HutongGames.PlayMaker.Actions.ResetGUIMatrix> orig, HutongGames.PlayMaker.Actions.ResetGUIMatrix self);
}
...
{
add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ResetGUIMatrix), "OnGUI", true), value);
remove => HookEndpointManager.Remove<Delegates.OnGUI_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ResetGUIMatrix), "OnGUI", true), value);
}
}
