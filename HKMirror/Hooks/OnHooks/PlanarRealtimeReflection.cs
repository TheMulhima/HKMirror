...
public static class OnPlanarRealtimeReflection
{
    internal static class HookHandler
    {
        ...
        private static Vector4 CameraSpacePlane(On.PlanarRealtimeReflection.orig_CameraSpacePlane orig,
            PlanarRealtimeReflection self, Camera cam, Vector3 pos, Vector3 normal, float sideSign)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void CalculateObliqueMatrix_WithArgs(Action<Matrix4x4, Vector4> orig, ref Matrix4x4 projection,
            Vector4 clipPlane);
        ...
        public delegate void CalculateReflectionMatrix_WithArgs(Action<Matrix4x4, Vector4> orig,
            ref Matrix4x4 reflectionMat, Vector4 plane);

        public delegate Vector4 CameraSpacePlane_AfterArgs(Params_CameraSpacePlane args, Vector4 ret);

        public delegate void CameraSpacePlane_BeforeArgs(Params_CameraSpacePlane args);

        public delegate Vector4 CameraSpacePlane_WithArgs(
            Func<PlanarRealtimeReflection, Camera, Vector3, Vector3, float, Vector4> orig,
            PlanarRealtimeReflection self, Camera cam, Vector3 pos, Vector3 normal, float sideSign);
        ...
        public delegate void CreateSurfaceObjects_WithArgs(Action<PlanarRealtimeReflection, Camera, Camera> orig,
            PlanarRealtimeReflection self, Camera currentCamera, out Camera reflectionCamera);
        ...
        public delegate void UpdateCameraModes_WithArgs(Action<PlanarRealtimeReflection, Camera, Camera> orig,
            PlanarRealtimeReflection self, Camera src, Camera dest);
