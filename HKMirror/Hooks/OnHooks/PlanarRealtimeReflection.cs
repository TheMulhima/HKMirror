...
public static class OnPlanarRealtimeReflection
{
    internal static class HookHandler
    {
            ...
            PlanarRealtimeReflection self)
        {
            ...
            {
                foreach (Delegates.OnWillRenderObject_BeforeArgs toInvoke in
                         _beforeOnWillRenderObject.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.OnWillRenderObject_AfterArgs toInvoke in
                         _afterOnWillRenderObject.GetInvocationList())
                {
                    try
                    {
        ...
        private static void UpdateCameraModes(On.PlanarRealtimeReflection.orig_UpdateCameraModes orig,
            PlanarRealtimeReflection self, UnityEngine.Camera src, UnityEngine.Camera dest)
        {
            ...
            {
                foreach (Delegates.UpdateCameraModes_BeforeArgs toInvoke in
                         _beforeUpdateCameraModes.GetInvocationList())
                {
                    try
                    {
        ...
        private static void CreateSurfaceObjects(On.PlanarRealtimeReflection.orig_CreateSurfaceObjects orig,
            PlanarRealtimeReflection self, UnityEngine.Camera currentCamera, out UnityEngine.Camera reflectionCamera)
        {
            ...
            {
                foreach (Delegates.CreateSurfaceObjects_BeforeArgs toInvoke in _beforeCreateSurfaceObjects
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CreateSurfaceObjects_AfterArgs toInvoke in _afterCreateSurfaceObjects
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static UnityEngine.Vector4 CameraSpacePlane(On.PlanarRealtimeReflection.orig_CameraSpacePlane orig,
            PlanarRealtimeReflection self, UnityEngine.Camera cam, UnityEngine.Vector3 pos, UnityEngine.Vector3 normal,
            float sideSign)
        {
        ...
        private static void CalculateObliqueMatrix(On.PlanarRealtimeReflection.orig_CalculateObliqueMatrix orig,
            ref UnityEngine.Matrix4x4 projection, UnityEngine.Vector4 clipPlane)
        {
            ...
            {
                foreach (Delegates.CalculateObliqueMatrix_BeforeArgs toInvoke in _beforeCalculateObliqueMatrix
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CalculateObliqueMatrix_AfterArgs toInvoke in _afterCalculateObliqueMatrix
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void CalculateReflectionMatrix(On.PlanarRealtimeReflection.orig_CalculateReflectionMatrix orig,
            ref UnityEngine.Matrix4x4 reflectionMat, UnityEngine.Vector4 plane)
        {
            ...
            {
                foreach (Delegates.CalculateReflectionMatrix_BeforeArgs toInvoke in _beforeCalculateReflectionMatrix
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CalculateReflectionMatrix_AfterArgs toInvoke in _afterCalculateReflectionMatrix
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnWillRenderObject_WithArgs(Action<PlanarRealtimeReflection> orig,
            PlanarRealtimeReflection self);
        ...
        public delegate void UpdateCameraModes_WithArgs(
            Action<PlanarRealtimeReflection, UnityEngine.Camera, UnityEngine.Camera> orig,
            PlanarRealtimeReflection self, UnityEngine.Camera src, UnityEngine.Camera dest);
        ...
        public delegate void CreateSurfaceObjects_WithArgs(
            Action<PlanarRealtimeReflection, UnityEngine.Camera, UnityEngine.Camera> orig,
            PlanarRealtimeReflection self, UnityEngine.Camera currentCamera, out UnityEngine.Camera reflectionCamera);
        ...
        public delegate UnityEngine.Vector4 CameraSpacePlane_AfterArgs(Params_CameraSpacePlane args,
            UnityEngine.Vector4 ret);

        public delegate UnityEngine.Vector4 CameraSpacePlane_WithArgs(
            Func<PlanarRealtimeReflection, UnityEngine.Camera, UnityEngine.Vector3, UnityEngine.Vector3, float,
                UnityEngine.Vector4> orig, PlanarRealtimeReflection self, UnityEngine.Camera cam,
            UnityEngine.Vector3 pos, UnityEngine.Vector3 normal, float sideSign);
        ...
        public delegate void CalculateObliqueMatrix_WithArgs(Action<UnityEngine.Matrix4x4, UnityEngine.Vector4> orig,
            ref UnityEngine.Matrix4x4 projection, UnityEngine.Vector4 clipPlane);
        ...
        public delegate void CalculateReflectionMatrix_WithArgs(Action<UnityEngine.Matrix4x4, UnityEngine.Vector4> orig,
            ref UnityEngine.Matrix4x4 reflectionMat, UnityEngine.Vector4 plane);
    }
