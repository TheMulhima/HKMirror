...
public static class OnLanguageGetProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static string Invoke(Func<Modding.Delegates.LanguageGetProxy, string, string, string, string> orig,
            Modding.Delegates.LanguageGetProxy self, string key, string sheetTitle, string orig_)
        {
            Delegates.Params_Invoke @params = new()
            {
                self = self, key = key, sheetTitle = sheetTitle, orig_ = orig_
            };
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static string EndInvoke(Func<Modding.Delegates.LanguageGetProxy, System.IAsyncResult, string> orig,
            Modding.Delegates.LanguageGetProxy self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate string Invoke_WithArgs(
            Func<Modding.Delegates.LanguageGetProxy, string, string, string, string> orig,
            Modding.Delegates.LanguageGetProxy self, string key, string sheetTitle, string orig_);
        ...
        public delegate string EndInvoke_WithArgs(
            Func<Modding.Delegates.LanguageGetProxy, System.IAsyncResult, string> orig,
            Modding.Delegates.LanguageGetProxy self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "EndInvoke", true), value);
