...
public static class OnLanguageGetProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LanguageGetProxy), "Invoke"), Invoke);
            }
        }
        ...
        private static string Invoke(Func<LanguageGetProxy, string, string, string, string> orig, LanguageGetProxy self,
            string key, string sheetTitle, string orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LanguageGetProxy), "EndInvoke"), EndInvoke);
            }
        }
        ...
        private static string EndInvoke(Func<LanguageGetProxy, IAsyncResult, string> orig, LanguageGetProxy self,
            IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate string EndInvoke_WithArgs(Func<LanguageGetProxy, IAsyncResult, string> orig,
            LanguageGetProxy self, IAsyncResult result);
        ...
        public delegate string Invoke_WithArgs(Func<LanguageGetProxy, string, string, string, string> orig,
            LanguageGetProxy self, string key, string sheetTitle, string orig_);

        public sealed class Params_Invoke
        {
            public string key;
            public string orig_;
            public LanguageGetProxy self;
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LanguageGetProxy), "Invoke"), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LanguageGetProxy), "EndInvoke"), value);
