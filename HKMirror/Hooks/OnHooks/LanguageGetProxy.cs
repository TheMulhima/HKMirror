...
/// <summary>
/// Contains different types of On Hooks for LanguageGetProxy class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnLanguageGetProxy
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "Invoke", true), Invoke);
...
private static string Invoke(Func<Modding.Delegates.LanguageGetProxy,  string,  string,  string, string> orig, Modding.Delegates.LanguageGetProxy self,  string key,  string sheetTitle,  string orig_)
{
...
orig_ = @params.orig_;
var retVal = orig(self, key, sheetTitle, orig_);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "EndInvoke", true), EndInvoke);
...
private static string EndInvoke(Func<Modding.Delegates.LanguageGetProxy,  System.IAsyncResult, string> orig, Modding.Delegates.LanguageGetProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.LanguageGetProxy self;
public string key;
...
public delegate string Invoke_WithArgs (Func<Modding.Delegates.LanguageGetProxy,  string,  string,  string, string> orig, Modding.Delegates.LanguageGetProxy self,  string key,  string sheetTitle,  string orig_);
...
public delegate string EndInvoke_WithArgs (Func<Modding.Delegates.LanguageGetProxy,  System.IAsyncResult, string> orig, Modding.Delegates.LanguageGetProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.LanguageGetProxy), "EndInvoke", true), value);
}
}
