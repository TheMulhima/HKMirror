...
public static class OnSetAmbientLight
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetAmbientLight), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetAmbientLight), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetAmbientLight), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self)
        {
        ...
        internal static void HookDoSetAmbientColor()
        {
            if (!HookedList.Contains("DoSetAmbientColor"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetAmbientLight),
                        "DoSetAmbientColor", true), DoSetAmbientColor);
            }
        }
        ...
        private static void DoSetAmbientColor(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self);
        ...
        public delegate void DoSetAmbientColor_WithArgs(Action<HutongGames.PlayMaker.Actions.SetAmbientLight> orig,
            HutongGames.PlayMaker.Actions.SetAmbientLight self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetAmbientLight), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetAmbientLight), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetAmbientLight), "OnUpdate", true),
                value);
