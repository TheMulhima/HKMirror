...
public static class OnAppleTVWirelessControllerUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AppleTVWirelessControllerUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<AppleTVWirelessControllerUnityProfile> orig,
            AppleTVWirelessControllerUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AppleTVWirelessControllerUnityProfile> orig,
            AppleTVWirelessControllerUnityProfile self);

        public sealed class Params_Define
        {
            public AppleTVWirelessControllerUnityProfile self;
        }
    }
