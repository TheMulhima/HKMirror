...
public static class OnuGuiNavigationExplicitSetProperties
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties), "DoSetValue", true),
                    DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties), "Reset", true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties), "OnEnter", true), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitSetProperties), "OnExit", true), value);
