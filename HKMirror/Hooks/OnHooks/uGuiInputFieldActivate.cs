...
public static class OnuGuiInputFieldActivate
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldActivate), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldActivate), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self)
        {
        ...
        internal static void HookDoAction()
        {
            if (!HookedList.Contains("DoAction"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldActivate), "DoAction"), DoAction);
            }
        }
        ...
        private static void DoAction(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldActivate), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoAction_WithArgs(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiInputFieldActivate> orig, uGuiInputFieldActivate self);

        public sealed class Params_Reset
        {
            public uGuiInputFieldActivate self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldActivate), "Reset"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldActivate), "OnExit"), value);
