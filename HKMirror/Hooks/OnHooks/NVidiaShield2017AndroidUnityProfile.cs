...
public static class OnNVidiaShield2017AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NVidiaShield2017AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NVidiaShield2017AndroidUnityProfile> orig,
            NVidiaShield2017AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NVidiaShield2017AndroidUnityProfile> orig,
            NVidiaShield2017AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public NVidiaShield2017AndroidUnityProfile self;
        }
    }
