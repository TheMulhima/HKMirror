...
public static class OnObjectJitter
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitter), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitter), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitter), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitter), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self)
        {
        ...
        internal static void HookDoTranslate()
        {
            if (!HookedList.Contains("DoTranslate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitter), "DoTranslate",
                        true), DoTranslate);
            }
        }
        ...
        private static void DoTranslate(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self);
        ...
        public delegate void DoTranslate_WithArgs(Action<HutongGames.PlayMaker.Actions.ObjectJitter> orig,
            HutongGames.PlayMaker.Actions.ObjectJitter self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoTranslate_WithArgs DoTranslate
        {
            add => HookEndpointManager.Add<Delegates.DoTranslate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ObjectJitter), "DoTranslate", true),
                value);
