...
public static class OnObjectJitter
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<ObjectJitter> orig, ObjectJitter self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<ObjectJitter> orig, ObjectJitter self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<ObjectJitter> orig, ObjectJitter self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<ObjectJitter> orig, ObjectJitter self)
        {
        ...
        internal static void HookDoTranslate()
        {
            if (!HookedList.Contains("DoTranslate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "DoTranslate"), DoTranslate);
            }
        }
        ...
        private static void DoTranslate(Action<ObjectJitter> orig, ObjectJitter self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoTranslate_WithArgs(Action<ObjectJitter> orig, ObjectJitter self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<ObjectJitter> orig, ObjectJitter self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<ObjectJitter> orig, ObjectJitter self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<ObjectJitter> orig, ObjectJitter self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<ObjectJitter> orig, ObjectJitter self);

        public sealed class Params_Reset
        {
            public ObjectJitter self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "Reset"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoTranslate_WithArgs DoTranslate
        {
            add => HookEndpointManager.Add<Delegates.DoTranslate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ObjectJitter), "DoTranslate"), value);
