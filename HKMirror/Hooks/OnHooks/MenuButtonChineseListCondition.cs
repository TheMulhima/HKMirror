...
/// <summary>
/// Contains different types of On Hooks for MenuButtonChineseListCondition class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnMenuButtonChineseListCondition
{
...
On.MenuButtonChineseListCondition.IsFulfilled += IsFulfilled;
...
private static bool IsFulfilled(On.MenuButtonChineseListCondition.orig_IsFulfilled orig,MenuButtonChineseListCondition self)
{
...
{
public MenuButtonChineseListCondition self;
}
...
public delegate bool IsFulfilled_WithArgs (Func<MenuButtonChineseListCondition, bool> orig, MenuButtonChineseListCondition self);
}
...
{
public static event On.MenuButtonChineseListCondition.hook_IsFulfilled IsFulfilled
{
add => On.MenuButtonChineseListCondition.IsFulfilled += value;
remove => On.MenuButtonChineseListCondition.IsFulfilled -= value;
}
}
