...
public static class Ontk2dEditorSpriteDataUnloader
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.Register_NormalArgs _afterRegister;
        ...
        private static void Register(On.tk2dEditorSpriteDataUnloader.orig_Register orig, tk2dSpriteCollectionData data)
        {
            ...
            data = @params.data;
            orig(data);
            if (_afterRegister != null) _afterRegister.Invoke(@params);
        }
        ...
        internal static event Delegates.Unregister_NormalArgs _afterUnregister;
            ...
            tk2dSpriteCollectionData data)
        {
            ...
            data = @params.data;
            orig(data);
            if (_afterUnregister != null) _afterUnregister.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void Register_NormalArgs(Params_Register args);

        public delegate void Unregister_BeforeArgs(Params_Unregister args);

        public delegate void Unregister_NormalArgs(Params_Unregister args);
    ...
    {
        public static event Delegates.Register_NormalArgs Register
        {
            add
            {
        ...
        public static event Delegates.Unregister_NormalArgs Unregister
        {
            add
            {
