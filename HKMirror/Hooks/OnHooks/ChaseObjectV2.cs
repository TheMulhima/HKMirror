...
public static class OnChaseObjectV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self)
        {
        ...
        internal static void HookDoChase()
        {
            if (!HookedList.Contains("DoChase"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "DoChase",
                        true), DoChase);
            }
        }
        ...
        private static void DoChase(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self);
        ...
        public delegate void DoChase_WithArgs(Action<HutongGames.PlayMaker.Actions.ChaseObjectV2> orig,
            HutongGames.PlayMaker.Actions.ChaseObjectV2 self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoChase_WithArgs DoChase
        {
            add => HookEndpointManager.Add<Delegates.DoChase_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ChaseObjectV2), "DoChase", true),
                value);
