...
public static class OnAndroidTVMiBoxRemoteUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.AndroidTVMiBoxRemoteUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.AndroidTVMiBoxRemoteUnityProfile> orig,
            InControl.UnityDeviceProfiles.AndroidTVMiBoxRemoteUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.AndroidTVMiBoxRemoteUnityProfile> orig,
            InControl.UnityDeviceProfiles.AndroidTVMiBoxRemoteUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.AndroidTVMiBoxRemoteUnityProfile),
                    "Define", true), value);
