...
public static class OnAndroidTVMiBoxRemoteUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AndroidTVMiBoxRemoteUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AndroidTVMiBoxRemoteUnityProfile> orig, AndroidTVMiBoxRemoteUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AndroidTVMiBoxRemoteUnityProfile> orig,
            AndroidTVMiBoxRemoteUnityProfile self);

        public sealed class Params_Define
        {
            public AndroidTVMiBoxRemoteUnityProfile self;
        }
    }
