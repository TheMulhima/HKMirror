...
public static class OnuGuiInputFieldScreenToLocal
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldScreenToLocal), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiInputFieldScreenToLocal> orig, uGuiInputFieldScreenToLocal self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldScreenToLocal), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiInputFieldScreenToLocal> orig, uGuiInputFieldScreenToLocal self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldScreenToLocal), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<uGuiInputFieldScreenToLocal> orig, uGuiInputFieldScreenToLocal self)
        {
        ...
        internal static void HookDoAction()
        {
            if (!HookedList.Contains("DoAction"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldScreenToLocal), "DoAction"), DoAction);
            }
        }
        ...
        private static void DoAction(Action<uGuiInputFieldScreenToLocal> orig, uGuiInputFieldScreenToLocal self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoAction_WithArgs(Action<uGuiInputFieldScreenToLocal> orig,
            uGuiInputFieldScreenToLocal self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiInputFieldScreenToLocal> orig,
            uGuiInputFieldScreenToLocal self);
        ...
        public delegate void OnUpdate_WithArgs(Action<uGuiInputFieldScreenToLocal> orig,
            uGuiInputFieldScreenToLocal self);
        ...
        public delegate void Reset_WithArgs(Action<uGuiInputFieldScreenToLocal> orig, uGuiInputFieldScreenToLocal self);

        public sealed class Params_Reset
        {
            public uGuiInputFieldScreenToLocal self;
        }
