...
public static class OnGGCheckIfFirstBossScene
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_IsTrue()
        {
            if (!HookedList.Contains("get_IsTrue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfFirstBossScene), "get_IsTrue"), get_IsTrue);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_IsTrue_WithArgs(Func<GGCheckIfFirstBossScene, bool> orig,
            GGCheckIfFirstBossScene self);
