...
/// <summary>
/// Contains different types of On Hooks for GGCheckIfFirstBossScene class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGGCheckIfFirstBossScene
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfFirstBossScene), "get_IsTrue", true), get_IsTrue);
...
private static bool get_IsTrue(Func<GGCheckIfFirstBossScene, bool> orig, GGCheckIfFirstBossScene self)
{
...
{
public GGCheckIfFirstBossScene self;
}
...
public delegate bool get_IsTrue_WithArgs (Func<GGCheckIfFirstBossScene, bool> orig, GGCheckIfFirstBossScene self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfFirstBossScene), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckIfFirstBossScene), "get_IsTrue", true), value);
}
}
