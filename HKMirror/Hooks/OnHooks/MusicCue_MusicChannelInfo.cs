...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_Clip", true), get_Clip);
...
private static UnityEngine.AudioClip get_Clip(Func<MusicCue.MusicChannelInfo, UnityEngine.AudioClip> orig, MusicCue.MusicChannelInfo self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_IsEnabled", true), get_IsEnabled);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_IsSyncRequired", true), get_IsSyncRequired);
...
private static bool get_IsSyncRequired(Func<MusicCue.MusicChannelInfo, bool> orig, MusicCue.MusicChannelInfo self)
{
...
{
foreach (Delegates.get_IsSyncRequired_BeforeArgs toInvoke in _beforeget_IsSyncRequired.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsSyncRequired_AfterArgs toInvoke in _afterget_IsSyncRequired.GetInvocationList())
{
try
{
...
public delegate UnityEngine.AudioClip get_Clip_AfterArgs(Params_get_Clip args, UnityEngine.AudioClip ret);
public delegate UnityEngine.AudioClip get_Clip_WithArgs (Func<MusicCue.MusicChannelInfo, UnityEngine.AudioClip> orig, MusicCue.MusicChannelInfo self);
...
public delegate bool get_IsEnabled_WithArgs (Func<MusicCue.MusicChannelInfo, bool> orig, MusicCue.MusicChannelInfo self);
...
public delegate bool get_IsSyncRequired_WithArgs (Func<MusicCue.MusicChannelInfo, bool> orig, MusicCue.MusicChannelInfo self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Clip_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_Clip", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Clip_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_Clip", true), value);
}
public static event Delegates.get_IsEnabled_WithArgs get_IsEnabled
{
add => HookEndpointManager.Add<Delegates.get_IsEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_IsEnabled", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_IsEnabled", true), value);
}
public static event Delegates.get_IsSyncRequired_WithArgs get_IsSyncRequired
{
add => HookEndpointManager.Add<Delegates.get_IsSyncRequired_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_IsSyncRequired", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsSyncRequired_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue.MusicChannelInfo), "get_IsSyncRequired", true), value);
}
}
