...
public static class OnPlayStation2WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation2WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation2WindowsUnityProfile> orig, PlayStation2WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation2WindowsUnityProfile> orig,
            PlayStation2WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation2WindowsUnityProfile self;
        }
    }
