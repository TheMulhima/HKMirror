...
public static class OnLogitechF510ModeDMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ModeDMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ModeDMacNativeProfile> orig,
            LogitechF510ModeDMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ModeDMacNativeProfile> orig,
            LogitechF510ModeDMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ModeDMacNativeProfile self;
        }
    }
