...
public static class OnHashTableContains
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContains), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HashTableContains> orig,
            HutongGames.PlayMaker.Actions.HashTableContains self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContains), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HashTableContains> orig,
            HutongGames.PlayMaker.Actions.HashTableContains self)
        {
        ...
        internal static void HookcheckIfContainsKey()
        {
            if (!HookedList.Contains("checkIfContainsKey"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContains),
        ...
        private static void checkIfContainsKey(Action<HutongGames.PlayMaker.Actions.HashTableContains> orig,
            HutongGames.PlayMaker.Actions.HashTableContains self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableContains> orig,
            HutongGames.PlayMaker.Actions.HashTableContains self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableContains> orig,
            HutongGames.PlayMaker.Actions.HashTableContains self);
        ...
        public delegate void checkIfContainsKey_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableContains> orig,
            HutongGames.PlayMaker.Actions.HashTableContains self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContains), "Reset", true),
                value);
