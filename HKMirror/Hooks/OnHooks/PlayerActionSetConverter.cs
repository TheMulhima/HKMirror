...
public static class OnPlayerActionSetConverter
{
    ...
    public static class Delegates
    {
        ...
        public delegate bool CanConvert_WithArgs(Func<PlayerActionSetConverter, Type, bool> orig,
            PlayerActionSetConverter self, Type objectType);

        public delegate object ReadJson_AfterArgs(Params_ReadJson args, object ret);

        public delegate void ReadJson_BeforeArgs(Params_ReadJson args);

        public delegate object ReadJson_WithArgs(
            Func<PlayerActionSetConverter, JsonReader, Type, object, JsonSerializer, object> orig,
            PlayerActionSetConverter self, JsonReader reader, Type objectType, object existingValue,
            JsonSerializer serializer);
        ...
        public delegate void WriteJson_WithArgs(
            Action<PlayerActionSetConverter, JsonWriter, object, JsonSerializer> orig, PlayerActionSetConverter self,
