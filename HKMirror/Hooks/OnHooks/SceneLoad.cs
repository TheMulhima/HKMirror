...
public static class OnSceneLoad
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_TargetSceneName()
        {
            if (!HookedList.Contains("get_TargetSceneName"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_TargetSceneName", true),
                    get_TargetSceneName);
            }
        }
        ...
        private static string get_TargetSceneName(Func<SceneLoad, string> orig, SceneLoad self)
        {
            ...
            {
                foreach (Delegates.get_TargetSceneName_BeforeArgs toInvoke in _beforeget_TargetSceneName
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_TargetSceneName_AfterArgs toInvoke in
                         _afterget_TargetSceneName.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_IsFetchAllowed()
        {
            if (!HookedList.Contains("get_IsFetchAllowed"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsFetchAllowed", true),
                    get_IsFetchAllowed);
            }
        }
        ...
        private static bool get_IsFetchAllowed(Func<SceneLoad, bool> orig, SceneLoad self)
        {
            ...
            {
                foreach (Delegates.get_IsFetchAllowed_BeforeArgs toInvoke in
                         _beforeget_IsFetchAllowed.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsFetchAllowed_AfterArgs toInvoke in
                         _afterget_IsFetchAllowed.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_IsFetchAllowed()
        {
            if (!HookedList.Contains("set_IsFetchAllowed"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsFetchAllowed", true),
                    set_IsFetchAllowed);
            }
        }
        ...
        private static void set_IsFetchAllowed(Action<SceneLoad, bool> orig, SceneLoad self, bool value)
        {
            ...
            {
                foreach (Delegates.set_IsFetchAllowed_BeforeArgs toInvoke in
                         _beforeset_IsFetchAllowed.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_IsFetchAllowed_AfterArgs toInvoke in
                         _afterset_IsFetchAllowed.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_IsActivationAllowed()
        {
            if (!HookedList.Contains("get_IsActivationAllowed"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsActivationAllowed", true),
        ...
        private static bool get_IsActivationAllowed(Func<SceneLoad, bool> orig, SceneLoad self)
        {
            ...
            {
                foreach (Delegates.get_IsActivationAllowed_BeforeArgs toInvoke in _beforeget_IsActivationAllowed
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsActivationAllowed_AfterArgs toInvoke in _afterget_IsActivationAllowed
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_IsActivationAllowed()
        {
            if (!HookedList.Contains("set_IsActivationAllowed"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsActivationAllowed", true),
        ...
        private static void set_IsActivationAllowed(Action<SceneLoad, bool> orig, SceneLoad self, bool value)
        {
            ...
            {
                foreach (Delegates.set_IsActivationAllowed_BeforeArgs toInvoke in _beforeset_IsActivationAllowed
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_IsActivationAllowed_AfterArgs toInvoke in _afterset_IsActivationAllowed
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_IsUnloadAssetsRequired()
        {
            if (!HookedList.Contains("get_IsUnloadAssetsRequired"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsUnloadAssetsRequired", true),
        ...
        private static bool get_IsUnloadAssetsRequired(Func<SceneLoad, bool> orig, SceneLoad self)
        {
            ...
            {
                foreach (Delegates.get_IsUnloadAssetsRequired_BeforeArgs toInvoke in _beforeget_IsUnloadAssetsRequired
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsUnloadAssetsRequired_AfterArgs toInvoke in _afterget_IsUnloadAssetsRequired
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_IsUnloadAssetsRequired()
        {
            if (!HookedList.Contains("set_IsUnloadAssetsRequired"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsUnloadAssetsRequired", true),
        ...
        private static void set_IsUnloadAssetsRequired(Action<SceneLoad, bool> orig, SceneLoad self, bool value)
        {
            ...
            {
                foreach (Delegates.set_IsUnloadAssetsRequired_BeforeArgs toInvoke in _beforeset_IsUnloadAssetsRequired
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_IsUnloadAssetsRequired_AfterArgs toInvoke in _afterset_IsUnloadAssetsRequired
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_IsGarbageCollectRequired()
        {
            if (!HookedList.Contains("get_IsGarbageCollectRequired"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsGarbageCollectRequired", true),
        ...
        private static bool get_IsGarbageCollectRequired(Func<SceneLoad, bool> orig, SceneLoad self)
        {
            ...
            {
                foreach (Delegates.get_IsGarbageCollectRequired_BeforeArgs toInvoke in
                         _beforeget_IsGarbageCollectRequired.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsGarbageCollectRequired_AfterArgs toInvoke in _afterget_IsGarbageCollectRequired
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_IsGarbageCollectRequired()
        {
            if (!HookedList.Contains("set_IsGarbageCollectRequired"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsGarbageCollectRequired", true),
        ...
        private static void set_IsGarbageCollectRequired(Action<SceneLoad, bool> orig, SceneLoad self, bool value)
        {
            ...
            {
                foreach (Delegates.set_IsGarbageCollectRequired_BeforeArgs toInvoke in
                         _beforeset_IsGarbageCollectRequired.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_IsGarbageCollectRequired_AfterArgs toInvoke in _afterset_IsGarbageCollectRequired
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void set_IsUnloadAssetsRequired_WithArgs(Action<SceneLoad, bool> orig, SceneLoad self,
            bool value);
        ...
        public delegate void set_IsGarbageCollectRequired_WithArgs(Action<SceneLoad, bool> orig, SceneLoad self,
            bool value);
        ...
        public delegate System.Collections.IEnumerator BeginRoutine_AfterArgs(Params_BeginRoutine args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator BeginRoutine_WithArgs(
            Func<SceneLoad, System.Collections.IEnumerator> orig, SceneLoad self);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_TargetSceneName_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_TargetSceneName", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_TargetSceneName_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_TargetSceneName", true), value);
        }

        public static event Delegates.get_IsFetchAllowed_WithArgs get_IsFetchAllowed
        {
            add => HookEndpointManager.Add<Delegates.get_IsFetchAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsFetchAllowed", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsFetchAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsFetchAllowed", true), value);
        }

        public static event Delegates.set_IsFetchAllowed_WithArgs set_IsFetchAllowed
        {
            add => HookEndpointManager.Add<Delegates.set_IsFetchAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsFetchAllowed", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsFetchAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsFetchAllowed", true), value);
        }

        public static event Delegates.get_IsActivationAllowed_WithArgs get_IsActivationAllowed
        {
            add => HookEndpointManager.Add<Delegates.get_IsActivationAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsActivationAllowed", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsActivationAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsActivationAllowed", true), value);
        }

        public static event Delegates.set_IsActivationAllowed_WithArgs set_IsActivationAllowed
        {
            add => HookEndpointManager.Add<Delegates.set_IsActivationAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsActivationAllowed", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsActivationAllowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsActivationAllowed", true), value);
        }

        public static event Delegates.get_IsUnloadAssetsRequired_WithArgs get_IsUnloadAssetsRequired
        {
            add => HookEndpointManager.Add<Delegates.get_IsUnloadAssetsRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsUnloadAssetsRequired", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsUnloadAssetsRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsUnloadAssetsRequired", true), value);
        }

        public static event Delegates.set_IsUnloadAssetsRequired_WithArgs set_IsUnloadAssetsRequired
        {
            add => HookEndpointManager.Add<Delegates.set_IsUnloadAssetsRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsUnloadAssetsRequired", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsUnloadAssetsRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsUnloadAssetsRequired", true), value);
        }

        public static event Delegates.get_IsGarbageCollectRequired_WithArgs get_IsGarbageCollectRequired
        {
            add => HookEndpointManager.Add<Delegates.get_IsGarbageCollectRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsGarbageCollectRequired", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsGarbageCollectRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsGarbageCollectRequired", true), value);
        }

        public static event Delegates.set_IsGarbageCollectRequired_WithArgs set_IsGarbageCollectRequired
        {
            add => HookEndpointManager.Add<Delegates.set_IsGarbageCollectRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsGarbageCollectRequired", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsGarbageCollectRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsGarbageCollectRequired", true), value);
        }

        public static event Delegates.get_IsFinished_WithArgs get_IsFinished
        {
            add => HookEndpointManager.Add<Delegates.get_IsFinished_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsFinished", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsFinished_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_IsFinished", true), value);
        }

        public static event Delegates.set_IsFinished_WithArgs set_IsFinished
        {
            add => HookEndpointManager.Add<Delegates.set_IsFinished_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsFinished", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsFinished_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "set_IsFinished", true), value);
        }

        public static event Delegates.get_BeginTime_WithArgs get_BeginTime
        {
            add => HookEndpointManager.Add<Delegates.get_BeginTime_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_BeginTime", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_BeginTime_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneLoad), "get_BeginTime", true), value);
        }
