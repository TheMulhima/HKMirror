...
public static class OnXboxOneMacFirefoxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneMacFirefoxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneMacFirefoxUnityProfile> orig, XboxOneMacFirefoxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneMacFirefoxUnityProfile> orig,
            XboxOneMacFirefoxUnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneMacFirefoxUnityProfile self;
        }
    }
