...
public static class OnPlayStation4WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4WindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4WindowsNativeProfile> orig, PlayStation4WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4WindowsNativeProfile> orig,
            PlayStation4WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public PlayStation4WindowsNativeProfile self;
        }
    }
