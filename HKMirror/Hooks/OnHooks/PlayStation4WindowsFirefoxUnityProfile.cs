...
public static class OnPlayStation4WindowsFirefoxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4WindowsFirefoxUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4WindowsFirefoxUnityProfile> orig,
            PlayStation4WindowsFirefoxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4WindowsFirefoxUnityProfile> orig,
            PlayStation4WindowsFirefoxUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4WindowsFirefoxUnityProfile self;
        }
    }
