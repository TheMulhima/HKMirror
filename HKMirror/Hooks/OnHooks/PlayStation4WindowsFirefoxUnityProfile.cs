...
public static class OnPlayStation4WindowsFirefoxUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.PlayStation4WindowsFirefoxUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.PlayStation4WindowsFirefoxUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation4WindowsFirefoxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.PlayStation4WindowsFirefoxUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation4WindowsFirefoxUnityProfile self);
    }
