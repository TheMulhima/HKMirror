...
public static class OnSaitekAviatorWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaitekAviatorWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<SaitekAviatorWindowsUnityProfile> orig, SaitekAviatorWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SaitekAviatorWindowsUnityProfile> orig,
            SaitekAviatorWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public SaitekAviatorWindowsUnityProfile self;
        }
    }
