...
public static class OnHoriDOA4ArcadeStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriDOA4ArcadeStickMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HoriDOA4ArcadeStickMacNativeProfile> orig,
            HoriDOA4ArcadeStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriDOA4ArcadeStickMacNativeProfile> orig,
            HoriDOA4ArcadeStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriDOA4ArcadeStickMacNativeProfile self;
        }
    }
