...
private static void RefreshValueFromGameSettings(On.MenuSetting.orig_RefreshValueFromGameSettings orig,MenuSetting self,  bool alsoApplySetting)
{
Delegates.Params_RefreshValueFromGameSettings @params = new() 
{
self = self
, alsoApplySetting = alsoApplySetting
};
if (_beforeRefreshValueFromGameSettings != null)
{
foreach (Delegates.RefreshValueFromGameSettings_BeforeArgs toInvoke in _beforeRefreshValueFromGameSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshValueFromGameSettings_AfterArgs toInvoke in _afterRefreshValueFromGameSettings.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuSetting), "orig_UpdateSetting", true), orig_UpdateSetting);
...
{
foreach (Delegates.orig_UpdateSetting_BeforeArgs toInvoke in _beforeorig_UpdateSetting.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_UpdateSetting_AfterArgs toInvoke in _afterorig_UpdateSetting.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuSetting), "orig_RefreshValueFromGameSettings", true), orig_RefreshValueFromGameSettings);

}
}
internal static event Delegates.orig_RefreshValueFromGameSettings_BeforeArgs _beforeorig_RefreshValueFromGameSettings;
internal static event Delegates.orig_RefreshValueFromGameSettings_AfterArgs _afterorig_RefreshValueFromGameSettings;
private static void orig_RefreshValueFromGameSettings(Action<MenuSetting,  bool> orig, MenuSetting self,  bool alsoApplySetting)
{
...
{
foreach (Delegates.orig_RefreshValueFromGameSettings_BeforeArgs toInvoke in _beforeorig_RefreshValueFromGameSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_RefreshValueFromGameSettings_AfterArgs toInvoke in _afterorig_RefreshValueFromGameSettings.GetInvocationList())
{
try
{
...
public delegate void RefreshValueFromGameSettings_WithArgs (Action<MenuSetting,  bool> orig, MenuSetting self,  bool alsoApplySetting);
...
public delegate void orig_UpdateSetting_WithArgs (Action<MenuSetting,  int> orig, MenuSetting self,  int settingIndex);
public sealed class Params_orig_RefreshValueFromGameSettings
{
public MenuSetting self;
public bool alsoApplySetting;
}
public delegate void orig_RefreshValueFromGameSettings_BeforeArgs(Params_orig_RefreshValueFromGameSettings args);
public delegate void orig_RefreshValueFromGameSettings_AfterArgs(Params_orig_RefreshValueFromGameSettings args);
public delegate void orig_RefreshValueFromGameSettings_WithArgs (Action<MenuSetting,  bool> orig, MenuSetting self,  bool alsoApplySetting);
}
...
{
add => HookEndpointManager.Add<Delegates.orig_UpdateSetting_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuSetting), "orig_UpdateSetting", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_UpdateSetting_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuSetting), "orig_UpdateSetting", true), value);
}
public static event Delegates.orig_RefreshValueFromGameSettings_WithArgs orig_RefreshValueFromGameSettings
{
add => HookEndpointManager.Add<Delegates.orig_RefreshValueFromGameSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuSetting), "orig_RefreshValueFromGameSettings", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_RefreshValueFromGameSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuSetting), "orig_RefreshValueFromGameSettings", true), value);
}
}
