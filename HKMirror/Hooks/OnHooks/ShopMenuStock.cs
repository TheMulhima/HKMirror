...
public static class OnShopMenuStock
{
    ...
    public static class Delegates
    {
        ...
        public delegate GameObject GetItemGameObject_AfterArgs(Params_GetItemGameObject args, GameObject ret);

        public delegate void GetItemGameObject_BeforeArgs(Params_GetItemGameObject args);

        public delegate GameObject GetItemGameObject_WithArgs(Func<ShopMenuStock, int, GameObject> orig,
            ShopMenuStock self, int itemNum);

        public delegate Sprite GetItemSprite_AfterArgs(Params_GetItemSprite args, Sprite ret);

        public delegate void GetItemSprite_BeforeArgs(Params_GetItemSprite args);

        public delegate Sprite GetItemSprite_WithArgs(Func<ShopMenuStock, int, Sprite> orig, ShopMenuStock self,
            int itemNum);

        public delegate Vector3 GetItemSpriteScale_AfterArgs(Params_GetItemSpriteScale args, Vector3 ret);

        public delegate void GetItemSpriteScale_BeforeArgs(Params_GetItemSpriteScale args);

        public delegate Vector3 GetItemSpriteScale_WithArgs(Func<ShopMenuStock, int, Vector3> orig, ShopMenuStock self,
            int itemNum);
