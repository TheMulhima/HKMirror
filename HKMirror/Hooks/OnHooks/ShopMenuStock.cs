...
public static class OnShopMenuStock
{
    internal static class HookHandler
    {
        ...
        private static void BuildFromMasterList(On.ShopMenuStock.orig_BuildFromMasterList orig, ShopMenuStock self)
        {
            ...
            {
                foreach (Delegates.BuildFromMasterList_BeforeArgs toInvoke in _beforeBuildFromMasterList
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.BuildFromMasterList_AfterArgs toInvoke in
                         _afterBuildFromMasterList.GetInvocationList())
                {
                    try
                    {
            ...
            int itemNum)
        {
            ...
            {
                foreach (Delegates.GetCharmsRequired_BeforeArgs toInvoke in
                         _beforeGetCharmsRequired.GetInvocationList())
                {
                    try
                    {
        ...
        private static UnityEngine.Sprite GetItemSprite(On.ShopMenuStock.orig_GetItemSprite orig, ShopMenuStock self,
            int itemNum)
        {
        ...
        private static UnityEngine.Vector3 GetItemSpriteScale(On.ShopMenuStock.orig_GetItemSpriteScale orig,
            ShopMenuStock self, int itemNum)
        {
            ...
            {
                foreach (Delegates.GetItemSpriteScale_BeforeArgs toInvoke in
                         _beforeGetItemSpriteScale.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetItemSpriteScale_AfterArgs toInvoke in
                         _afterGetItemSpriteScale.GetInvocationList())
                {
                    try
                    {
        ...
        private static UnityEngine.GameObject GetItemGameObject(On.ShopMenuStock.orig_GetItemGameObject orig,
            ShopMenuStock self, int itemNum)
        {
            ...
            {
                foreach (Delegates.GetItemGameObject_BeforeArgs toInvoke in
                         _beforeGetItemGameObject.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate string GetNameConvo_WithArgs(Func<ShopMenuStock, int, string> orig, ShopMenuStock self,
            int itemNum);
        ...
        public delegate string GetDescConvo_WithArgs(Func<ShopMenuStock, int, string> orig, ShopMenuStock self,
            int itemNum);
        ...
        public delegate string GetPlayerDataBoolName_WithArgs(Func<ShopMenuStock, int, string> orig, ShopMenuStock self,
            int itemNum);
        ...
        public delegate int GetSpecialType_WithArgs(Func<ShopMenuStock, int, int> orig, ShopMenuStock self,
            int itemNum);
        ...
        public delegate int GetRelicNumber_WithArgs(Func<ShopMenuStock, int, int> orig, ShopMenuStock self,
            int itemNum);
        ...
        public delegate int GetCharmsRequired_WithArgs(Func<ShopMenuStock, int, int> orig, ShopMenuStock self,
            int itemNum);
        ...
        public delegate UnityEngine.Sprite GetItemSprite_WithArgs(Func<ShopMenuStock, int, UnityEngine.Sprite> orig,
            ShopMenuStock self, int itemNum);
        ...
        public delegate UnityEngine.Vector3 GetItemSpriteScale_AfterArgs(Params_GetItemSpriteScale args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 GetItemSpriteScale_WithArgs(
            Func<ShopMenuStock, int, UnityEngine.Vector3> orig, ShopMenuStock self, int itemNum);
        ...
        public delegate UnityEngine.GameObject GetItemGameObject_AfterArgs(Params_GetItemGameObject args,
            UnityEngine.GameObject ret);

        public delegate UnityEngine.GameObject GetItemGameObject_WithArgs(
            Func<ShopMenuStock, int, UnityEngine.GameObject> orig, ShopMenuStock self, int itemNum);
    }
