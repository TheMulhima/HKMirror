...
public static class OnHashTableTakeSnapShot
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableTakeSnapShot), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HashTableTakeSnapShot> orig,
            HutongGames.PlayMaker.Actions.HashTableTakeSnapShot self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableTakeSnapShot),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HashTableTakeSnapShot> orig,
            HutongGames.PlayMaker.Actions.HashTableTakeSnapShot self)
        {
        ...
        internal static void HookDoHashTableTakeSnapShot()
        {
            if (!HookedList.Contains("DoHashTableTakeSnapShot"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableTakeSnapShot),
                        "DoHashTableTakeSnapShot", true), DoHashTableTakeSnapShot);
            }
        }
        ...
        private static void DoHashTableTakeSnapShot(Action<HutongGames.PlayMaker.Actions.HashTableTakeSnapShot> orig,
            HutongGames.PlayMaker.Actions.HashTableTakeSnapShot self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableTakeSnapShot> orig,
            HutongGames.PlayMaker.Actions.HashTableTakeSnapShot self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableTakeSnapShot> orig,
            HutongGames.PlayMaker.Actions.HashTableTakeSnapShot self);
        ...
        public delegate void DoHashTableTakeSnapShot_WithArgs(
            Action<HutongGames.PlayMaker.Actions.HashTableTakeSnapShot> orig,
            HutongGames.PlayMaker.Actions.HashTableTakeSnapShot self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableTakeSnapShot), "OnEnter",
                    true), value);
        ...
        public static event Delegates.DoHashTableTakeSnapShot_WithArgs DoHashTableTakeSnapShot
        {
            add => HookEndpointManager.Add<Delegates.DoHashTableTakeSnapShot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableTakeSnapShot),
                    "DoHashTableTakeSnapShot", true), value);
