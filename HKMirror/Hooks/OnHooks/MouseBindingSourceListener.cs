...
public static class OnMouseBindingSourceListener
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<InControl.MouseBindingSourceListener> orig,
            InControl.MouseBindingSourceListener self)
        {
        ...
        internal static void HookListen()
        {
            if (!HookedList.Contains("Listen"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "Listen", true),
                    Listen);
            }
        }
        ...
        private static InControl.BindingSource Listen(
            Func<InControl.MouseBindingSourceListener, InControl.BindingListenOptions, InControl.InputDevice,
                InControl.BindingSource> orig, InControl.MouseBindingSourceListener self,
        ...
        internal static void HookIsPressed()
        {
            if (!HookedList.Contains("IsPressed"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "IsPressed", true),
                    IsPressed);
            }
        }
        ...
        private static bool IsPressed(Func<InControl.MouseBindingSourceListener, InControl.Mouse, bool> orig,
            InControl.MouseBindingSourceListener self, InControl.Mouse control)
        {
        ...
        internal static void HookListenForControl()
        {
            if (!HookedList.Contains("ListenForControl"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "ListenForControl",
        ...
        private static InControl.Mouse ListenForControl(
            Func<InControl.MouseBindingSourceListener, InControl.BindingListenOptions, InControl.Mouse> orig,
            InControl.MouseBindingSourceListener self, InControl.BindingListenOptions listenOptions)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<InControl.MouseBindingSourceListener> orig,
            InControl.MouseBindingSourceListener self);
        ...
        public delegate bool IsPressed_WithArgs(Func<InControl.MouseBindingSourceListener, InControl.Mouse, bool> orig,
            InControl.MouseBindingSourceListener self, InControl.Mouse control);
        ...
        public delegate InControl.Mouse ListenForControl_WithArgs(
            Func<InControl.MouseBindingSourceListener, InControl.BindingListenOptions, InControl.Mouse> orig,
            InControl.MouseBindingSourceListener self, InControl.BindingListenOptions listenOptions);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "Reset", true), value);
        ...
        public static event Delegates.Listen_WithArgs Listen
        {
            add => HookEndpointManager.Add<Delegates.Listen_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "Listen", true), value);
        ...
        public static event Delegates.IsPressed_WithArgs IsPressed
        {
            add => HookEndpointManager.Add<Delegates.IsPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "IsPressed", true), value);
        ...
        public static event Delegates.ListenForControl_WithArgs ListenForControl
        {
            add => HookEndpointManager.Add<Delegates.ListenForControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSourceListener), "ListenForControl", true),
                value);
