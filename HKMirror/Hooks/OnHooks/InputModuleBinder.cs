...
internal static event Delegates.OnAcceptRejectInputStyleChanged_BeforeArgs _beforeOnAcceptRejectInputStyleChanged;
internal static event Delegates.OnAcceptRejectInputStyleChanged_AfterArgs _afterOnAcceptRejectInputStyleChanged;
private static void OnAcceptRejectInputStyleChanged(On.InputModuleBinder.orig_OnAcceptRejectInputStyleChanged orig,InputModuleBinder self)
{
...
{
foreach (Delegates.OnAcceptRejectInputStyleChanged_BeforeArgs toInvoke in _beforeOnAcceptRejectInputStyleChanged.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnAcceptRejectInputStyleChanged_AfterArgs toInvoke in _afterOnAcceptRejectInputStyleChanged.GetInvocationList())
{
try
{
...
private static void BindAndApplyActions(On.InputModuleBinder.orig_BindAndApplyActions orig,InputModuleBinder self)
{
...
{
foreach (Delegates.BindAndApplyActions_BeforeArgs toInvoke in _beforeBindAndApplyActions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.BindAndApplyActions_AfterArgs toInvoke in _afterBindAndApplyActions.GetInvocationList())
{
try
{
...
public delegate void OnAcceptRejectInputStyleChanged_WithArgs (Action<InputModuleBinder> orig, InputModuleBinder self);
