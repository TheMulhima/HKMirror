...
public static class OnuGuiSliderSetMinMax
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax),
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self)
        {
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self);
        ...
        public delegate void DoSetValue_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax), "OnUpdate",
                    true), value);
        ...
        public static event Delegates.DoSetValue_WithArgs DoSetValue
        {
            add => HookEndpointManager.Add<Delegates.DoSetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetMinMax), "DoSetValue",
                    true), value);
