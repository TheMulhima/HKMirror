...
public static class OnSingleContentLayout
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Position()
        {
            if (!HookedList.Contains("get_Position"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.SingleContentLayout), "get_Position", true),
                    get_Position);
            }
        }
        ...
        private static Modding.Menu.AnchoredPosition get_Position(
            Func<Modding.Menu.SingleContentLayout, Modding.Menu.AnchoredPosition> orig,
            Modding.Menu.SingleContentLayout self)
        {
        ...
        internal static void Hookset_Position()
        {
            if (!HookedList.Contains("set_Position"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.SingleContentLayout), "set_Position", true),
                    set_Position);
            }
        }
        ...
        private static void set_Position(Action<Modding.Menu.SingleContentLayout, Modding.Menu.AnchoredPosition> orig,
            Modding.Menu.SingleContentLayout self, Modding.Menu.AnchoredPosition value)
        {
        ...
        internal static void HookModifyNext()
        {
            if (!HookedList.Contains("ModifyNext"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.SingleContentLayout), "ModifyNext", true),
                    ModifyNext);
            }
        }
        ...
        private static void ModifyNext(Action<Modding.Menu.SingleContentLayout, UnityEngine.RectTransform> orig,
            Modding.Menu.SingleContentLayout self, UnityEngine.RectTransform rt)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate Modding.Menu.AnchoredPosition get_Position_AfterArgs(Params_get_Position args,
            Modding.Menu.AnchoredPosition ret);

        public delegate Modding.Menu.AnchoredPosition get_Position_WithArgs(
            Func<Modding.Menu.SingleContentLayout, Modding.Menu.AnchoredPosition> orig,
            Modding.Menu.SingleContentLayout self);
        ...
        public delegate void set_Position_WithArgs(
            Action<Modding.Menu.SingleContentLayout, Modding.Menu.AnchoredPosition> orig,
            Modding.Menu.SingleContentLayout self, Modding.Menu.AnchoredPosition value);
        ...
        public delegate void ModifyNext_WithArgs(
            Action<Modding.Menu.SingleContentLayout, UnityEngine.RectTransform> orig,
            Modding.Menu.SingleContentLayout self, UnityEngine.RectTransform rt);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Position_WithArgs get_Position
        {
            add => HookEndpointManager.Add<Delegates.get_Position_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.SingleContentLayout), "get_Position", true), value);
        ...
        public static event Delegates.set_Position_WithArgs set_Position
        {
            add => HookEndpointManager.Add<Delegates.set_Position_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.SingleContentLayout), "set_Position", true), value);
        ...
        public static event Delegates.ModifyNext_WithArgs ModifyNext
        {
            add => HookEndpointManager.Add<Delegates.ModifyNext_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Menu.SingleContentLayout), "ModifyNext", true), value);
