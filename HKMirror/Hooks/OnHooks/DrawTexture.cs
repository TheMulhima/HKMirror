...
public static class OnDrawTexture
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DrawTexture), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.DrawTexture> orig,
            HutongGames.PlayMaker.Actions.DrawTexture self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DrawTexture), "OnGUI", true),
                    OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.DrawTexture> orig,
            HutongGames.PlayMaker.Actions.DrawTexture self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.DrawTexture> orig,
            HutongGames.PlayMaker.Actions.DrawTexture self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.DrawTexture> orig,
            HutongGames.PlayMaker.Actions.DrawTexture self);
    }
