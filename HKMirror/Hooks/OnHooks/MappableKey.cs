...
{
foreach (Delegates.ListenForNewButton_BeforeArgs toInvoke in _beforeListenForNewButton.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ListenForNewButton_AfterArgs toInvoke in _afterListenForNewButton.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ShowCurrentBinding_BeforeArgs toInvoke in _beforeShowCurrentBinding.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ShowCurrentBinding_AfterArgs toInvoke in _afterShowCurrentBinding.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StopActionListening_BeforeArgs toInvoke in _beforeStopActionListening.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StopActionListening_AfterArgs toInvoke in _afterStopActionListening.GetInvocationList())
{
try
{
...
private static bool OnBindingFound(On.MappableKey.orig_OnBindingFound orig,MappableKey self,  InControl.PlayerAction action,  InControl.BindingSource binding)
{
...
private static void OnBindingAdded(On.MappableKey.orig_OnBindingAdded orig,MappableKey self,  InControl.PlayerAction action,  InControl.BindingSource binding)
{
...
private static void OnBindingRejected(On.MappableKey.orig_OnBindingRejected orig,MappableKey self,  InControl.PlayerAction action,  InControl.BindingSource binding,  InControl.BindingSourceRejectionType rejection)
{
...
{
foreach (Delegates.OnBindingRejected_BeforeArgs toInvoke in _beforeOnBindingRejected.GetInvocationList())
{
try
{
...
private static void OnSubmit(On.MappableKey.orig_OnSubmit orig,MappableKey self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
private static void OnPointerClick(On.MappableKey.orig_OnPointerClick orig,MappableKey self,  UnityEngine.EventSystems.PointerEventData eventData)
{
...
private static void OnCancel(On.MappableKey.orig_OnCancel orig,MappableKey self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
{
foreach (Delegates.StopListeningForNewKey_BeforeArgs toInvoke in _beforeStopListeningForNewKey.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StopListeningForNewKey_AfterArgs toInvoke in _afterStopListeningForNewKey.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupUnmappableKeys_BeforeArgs toInvoke in _beforeSetupUnmappableKeys.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupUnmappableKeys_AfterArgs toInvoke in _afterSetupUnmappableKeys.GetInvocationList())
{
try
{
...
private static void SetupBindingListenOptions(On.MappableKey.orig_SetupBindingListenOptions orig,MappableKey self)
{
...
{
foreach (Delegates.SetupBindingListenOptions_BeforeArgs toInvoke in _beforeSetupBindingListenOptions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupBindingListenOptions_AfterArgs toInvoke in _afterSetupBindingListenOptions.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "InitCustomActions", true), InitCustomActions);
...
private static void InitCustomActions(Action<MappableKey,  InControl.PlayerActionSet,  InControl.PlayerAction> orig, MappableKey self,  InControl.PlayerActionSet actionSet,  InControl.PlayerAction playerAction)
{
...
{
foreach (Delegates.InitCustomActions_BeforeArgs toInvoke in _beforeInitCustomActions.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "OnDestroy", true), OnDestroy);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_GetBinding", true), orig_GetBinding);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupBindingListenOptions", true), orig_SetupBindingListenOptions);
...
{
foreach (Delegates.orig_SetupBindingListenOptions_BeforeArgs toInvoke in _beforeorig_SetupBindingListenOptions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_SetupBindingListenOptions_AfterArgs toInvoke in _afterorig_SetupBindingListenOptions.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupRefs", true), orig_SetupRefs);
...
public delegate bool OnBindingFound_WithArgs (Func<MappableKey,  InControl.PlayerAction,  InControl.BindingSource, bool> orig, MappableKey self,  InControl.PlayerAction action,  InControl.BindingSource binding);
...
public delegate void OnBindingAdded_WithArgs (Action<MappableKey,  InControl.PlayerAction,  InControl.BindingSource> orig, MappableKey self,  InControl.PlayerAction action,  InControl.BindingSource binding);
...
public delegate void OnBindingRejected_WithArgs (Action<MappableKey,  InControl.PlayerAction,  InControl.BindingSource,  InControl.BindingSourceRejectionType> orig, MappableKey self,  InControl.PlayerAction action,  InControl.BindingSource binding,  InControl.BindingSourceRejectionType rejection);
...
public delegate void OnSubmit_WithArgs (Action<MappableKey,  UnityEngine.EventSystems.BaseEventData> orig, MappableKey self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void OnPointerClick_WithArgs (Action<MappableKey,  UnityEngine.EventSystems.PointerEventData> orig, MappableKey self,  UnityEngine.EventSystems.PointerEventData eventData);
...
public delegate void OnCancel_WithArgs (Action<MappableKey,  UnityEngine.EventSystems.BaseEventData> orig, MappableKey self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void InitCustomActions_WithArgs (Action<MappableKey,  InControl.PlayerActionSet,  InControl.PlayerAction> orig, MappableKey self,  InControl.PlayerActionSet actionSet,  InControl.PlayerAction playerAction);
...
{
add => HookEndpointManager.Add<Delegates.InitCustomActions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "InitCustomActions", true), value);
remove => HookEndpointManager.Remove<Delegates.InitCustomActions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "InitCustomActions", true), value);
}
public static event Delegates.OnDestroy_WithArgs OnDestroy
{
add => HookEndpointManager.Add<Delegates.OnDestroy_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "OnDestroy", true), value);
remove => HookEndpointManager.Remove<Delegates.OnDestroy_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "OnDestroy", true), value);
}
public static event Delegates.orig_GetBinding_WithArgs orig_GetBinding
{
add => HookEndpointManager.Add<Delegates.orig_GetBinding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_GetBinding", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_GetBinding_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_GetBinding", true), value);
}
public static event Delegates.orig_SetupBindingListenOptions_WithArgs orig_SetupBindingListenOptions
{
add => HookEndpointManager.Add<Delegates.orig_SetupBindingListenOptions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupBindingListenOptions", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_SetupBindingListenOptions_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupBindingListenOptions", true), value);
}
public static event Delegates.orig_SetupRefs_WithArgs orig_SetupRefs
{
add => HookEndpointManager.Add<Delegates.orig_SetupRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupRefs", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_SetupRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupRefs", true), value);
}
}
