...
public static class OnMappableKey
{
    internal static class HookHandler
    {
        ...
        private static void OnSubmit(On.MappableKey.orig_OnSubmit orig, MappableKey self,
        ...
        private static void OnCancel(On.MappableKey.orig_OnCancel orig, MappableKey self,
            UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookInitCustomActions()
        {
            if (!HookedList.Contains("InitCustomActions"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "InitCustomActions", true),
                    InitCustomActions);
            }
        }
        ...
        private static void InitCustomActions(
            Action<MappableKey, InControl.PlayerActionSet, InControl.PlayerAction> orig, MappableKey self,
            InControl.PlayerActionSet actionSet, InControl.PlayerAction playerAction)
        {
        ...
        internal static void Hookorig_SetupBindingListenOptions()
        {
            if (!HookedList.Contains("orig_SetupBindingListenOptions"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupBindingListenOptions", true),
    ...
    public static class Delegates
    {
        ...
        public delegate bool OnBindingFound_WithArgs(
            Func<MappableKey, InControl.PlayerAction, InControl.BindingSource, bool> orig, MappableKey self,
            InControl.PlayerAction action, InControl.BindingSource binding);
        ...
        public delegate void OnBindingAdded_WithArgs(
            Action<MappableKey, InControl.PlayerAction, InControl.BindingSource> orig, MappableKey self,
            InControl.PlayerAction action, InControl.BindingSource binding);
        ...
        public delegate void OnBindingRejected_WithArgs(
            Action<MappableKey, InControl.PlayerAction, InControl.BindingSource, InControl.BindingSourceRejectionType>
                orig, MappableKey self, InControl.PlayerAction action, InControl.BindingSource binding,
            InControl.BindingSourceRejectionType rejection);
        ...
        public delegate void OnSubmit_WithArgs(Action<MappableKey, UnityEngine.EventSystems.BaseEventData> orig,
            MappableKey self, UnityEngine.EventSystems.BaseEventData eventData);
        ...
        public delegate void OnPointerClick_WithArgs(
            Action<MappableKey, UnityEngine.EventSystems.PointerEventData> orig, MappableKey self,
            UnityEngine.EventSystems.PointerEventData eventData);
        ...
        public delegate void OnCancel_WithArgs(Action<MappableKey, UnityEngine.EventSystems.BaseEventData> orig,
            MappableKey self, UnityEngine.EventSystems.BaseEventData eventData);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.InitCustomActions_WithArgs InitCustomActions
        {
            add => HookEndpointManager.Add<Delegates.InitCustomActions_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MappableKey), "InitCustomActions", true), value);
        ...
        public static event Delegates.OnDestroy_WithArgs OnDestroy
        {
            add => HookEndpointManager.Add<Delegates.OnDestroy_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MappableKey), "OnDestroy", true), value);
        ...
        public static event Delegates.orig_GetBinding_WithArgs orig_GetBinding
        {
            add => HookEndpointManager.Add<Delegates.orig_GetBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_GetBinding", true), value);
        ...
        public static event Delegates.orig_SetupBindingListenOptions_WithArgs orig_SetupBindingListenOptions
        {
            add => HookEndpointManager.Add<Delegates.orig_SetupBindingListenOptions_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupBindingListenOptions", true), value);
        ...
        public static event Delegates.orig_SetupRefs_WithArgs orig_SetupRefs
        {
            add => HookEndpointManager.Add<Delegates.orig_SetupRefs_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MappableKey), "orig_SetupRefs", true), value);
