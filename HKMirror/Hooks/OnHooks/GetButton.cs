...
public static class OnGetButton
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetButton), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GetButton> orig, GetButton self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetButton), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<GetButton> orig, GetButton self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetButton), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<GetButton> orig, GetButton self)
        {
        ...
        internal static void HookDoGetButton()
        {
            if (!HookedList.Contains("DoGetButton"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetButton), "DoGetButton"), DoGetButton);
            }
        }
        ...
        private static void DoGetButton(Action<GetButton> orig, GetButton self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetButton_WithArgs(Action<GetButton> orig, GetButton self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<GetButton> orig, GetButton self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<GetButton> orig, GetButton self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GetButton> orig, GetButton self);

        public sealed class Params_Reset
        {
            public GetButton self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetButton), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetButton), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetButton), "OnUpdate"), value);
        ...
        public static event Delegates.DoGetButton_WithArgs DoGetButton
        {
            add => HookEndpointManager.Add<Delegates.DoGetButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetButton), "DoGetButton"), value);
