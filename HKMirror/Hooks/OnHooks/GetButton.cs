...
public static class OnGetButton
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetButton), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetButton), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetButton), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self)
        {
        ...
        internal static void HookDoGetButton()
        {
            if (!HookedList.Contains("DoGetButton"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetButton), "DoGetButton",
                        true), DoGetButton);
            }
        }
        ...
        private static void DoGetButton(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self);
        ...
        public delegate void DoGetButton_WithArgs(Action<HutongGames.PlayMaker.Actions.GetButton> orig,
            HutongGames.PlayMaker.Actions.GetButton self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetButton), "Reset", true), value);
        ...
        public static event Delegates.DoGetButton_WithArgs DoGetButton
        {
            add => HookEndpointManager.Add<Delegates.DoGetButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetButton), "DoGetButton", true),
                value);
