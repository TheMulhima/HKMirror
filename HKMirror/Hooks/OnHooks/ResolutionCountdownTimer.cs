...
private static void CancelTimer(On.ResolutionCountdownTimer.orig_CancelTimer orig,ResolutionCountdownTimer self)
{
...
private static System.Collections.IEnumerator CountDown(On.ResolutionCountdownTimer.orig_CountDown orig,ResolutionCountdownTimer self)
{
...
private static System.Collections.IEnumerator RollbackRes(On.ResolutionCountdownTimer.orig_RollbackRes orig,ResolutionCountdownTimer self)
{
...
public delegate System.Collections.IEnumerator CountDown_AfterArgs(Params_CountDown args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator CountDown_WithArgs (Func<ResolutionCountdownTimer, System.Collections.IEnumerator> orig, ResolutionCountdownTimer self);
public sealed class Params_RollbackRes
{
public ResolutionCountdownTimer self;
}
public delegate void RollbackRes_BeforeArgs(Params_RollbackRes args);
public delegate System.Collections.IEnumerator RollbackRes_AfterArgs(Params_RollbackRes args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator RollbackRes_WithArgs (Func<ResolutionCountdownTimer, System.Collections.IEnumerator> orig, ResolutionCountdownTimer self);
}
