...
public static class OnTouchShake
{
    ...
    {
        public delegate IEnumerator DoAnimation_AfterArgs(Params_DoAnimation args, IEnumerator ret);

        public delegate void DoAnimation_BeforeArgs(Params_DoAnimation args);

        public delegate IEnumerator DoAnimation_WithArgs(Func<TouchShake, IEnumerator> orig, TouchShake self);

        public delegate void OnTriggerEnter2D_AfterArgs(Params_OnTriggerEnter2D args);

        public delegate void OnTriggerEnter2D_BeforeArgs(Params_OnTriggerEnter2D args);

        public delegate void OnTriggerEnter2D_WithArgs(Action<TouchShake, Collider2D> orig, TouchShake self,
            Collider2D collision);

        public delegate IEnumerator SpriteAnimation_AfterArgs(Params_SpriteAnimation args, IEnumerator ret);

        public delegate void SpriteAnimation_BeforeArgs(Params_SpriteAnimation args);

        public delegate IEnumerator SpriteAnimation_WithArgs(Func<TouchShake, IEnumerator> orig, TouchShake self);
        ...
        public delegate IEnumerator tk2dAnimation_AfterArgs(Params_tk2dAnimation args, IEnumerator ret);

        public delegate void tk2dAnimation_BeforeArgs(Params_tk2dAnimation args);

        public delegate IEnumerator tk2dAnimation_WithArgs(Func<TouchShake, IEnumerator> orig, TouchShake self);
