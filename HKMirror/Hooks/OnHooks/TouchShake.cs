...
private static void OnTriggerEnter2D(On.TouchShake.orig_OnTriggerEnter2D orig,TouchShake self,  UnityEngine.Collider2D collision)
{
...
private static System.Collections.IEnumerator SpriteAnimation(On.TouchShake.orig_SpriteAnimation orig,TouchShake self)
{
...
private static System.Collections.IEnumerator tk2dAnimation(On.TouchShake.orig_tk2dAnimation orig,TouchShake self)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<TouchShake,  UnityEngine.Collider2D> orig, TouchShake self,  UnityEngine.Collider2D collision);
public sealed class Params_DoAnimation
{
public TouchShake self;
}
public delegate void DoAnimation_BeforeArgs(Params_DoAnimation args);
public delegate System.Collections.IEnumerator DoAnimation_AfterArgs(Params_DoAnimation args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DoAnimation_WithArgs (Func<TouchShake, System.Collections.IEnumerator> orig, TouchShake self);
public sealed class Params_SpriteAnimation
{
public TouchShake self;
}
public delegate void SpriteAnimation_BeforeArgs(Params_SpriteAnimation args);
public delegate System.Collections.IEnumerator SpriteAnimation_AfterArgs(Params_SpriteAnimation args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator SpriteAnimation_WithArgs (Func<TouchShake, System.Collections.IEnumerator> orig, TouchShake self);
public sealed class Params_tk2dAnimation
{
public TouchShake self;
}
public delegate void tk2dAnimation_BeforeArgs(Params_tk2dAnimation args);
public delegate System.Collections.IEnumerator tk2dAnimation_AfterArgs(Params_tk2dAnimation args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator tk2dAnimation_WithArgs (Func<TouchShake, System.Collections.IEnumerator> orig, TouchShake self);
}
