...
public static class OnGameCoreUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameCoreUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameCoreUnityProfile> orig, GameCoreUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameCoreUnityProfile> orig, GameCoreUnityProfile self);

        public sealed class Params_Define
        {
            public GameCoreUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameCoreUnityProfile), "Define"), value);
