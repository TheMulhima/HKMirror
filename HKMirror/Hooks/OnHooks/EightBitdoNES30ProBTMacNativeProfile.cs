...
public static class OnEightBitdoNES30ProBTMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.EightBitdoNES30ProBTMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.EightBitdoNES30ProBTMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.EightBitdoNES30ProBTMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.EightBitdoNES30ProBTMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.EightBitdoNES30ProBTMacNativeProfile self);
    }
