...
public static class OnEightBitdoNES30ProBTMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoNES30ProBTMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoNES30ProBTMacNativeProfile> orig,
            EightBitdoNES30ProBTMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoNES30ProBTMacNativeProfile> orig,
            EightBitdoNES30ProBTMacNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoNES30ProBTMacNativeProfile self;
        }
    }
