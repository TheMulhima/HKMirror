...
public static class OnRectTransformSetAnchorRectPosition
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition), "OnActionUpdate",
                        true), OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(
            Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition self)
        {
        ...
        internal static void HookDoSetAnchor()
        {
            if (!HookedList.Contains("DoSetAnchor"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition), "DoSetAnchor", true),
                    DoSetAnchor);
            }
        }
        ...
        private static void DoSetAnchor(Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetAnchor_WithArgs(
            Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchorRectPosition),
                    "Reset", true), value);
