...
public static class OnSaveSlotButton
{
    internal static class HookHandler
    {
        ...
        internal static void Hookset_state()
        {
            if (!HookedList.Contains("set_state"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "set_state"), set_state);
            }
        }
        ...
        private static void set_state(Action<SaveSlotButton, SaveSlotButton.SlotState> orig, SaveSlotButton self,
            SaveSlotButton.SlotState value)
        {
        ...
        internal static void HookChangeSaveFileState()
        {
            if (!HookedList.Contains("ChangeSaveFileState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "ChangeSaveFileState"),
                    ChangeSaveFileState);
            }
        }
        ...
        private static void ChangeSaveFileState(Action<SaveSlotButton, SaveSlotButton.SaveFileStates> orig,
            SaveSlotButton self, SaveSlotButton.SaveFileStates nextSaveFileState)
        {
            Delegates.Params_ChangeSaveFileState @params = new()
            {
                self = self, nextSaveFileState = nextSaveFileState
            };
            if (_beforeChangeSaveFileState != null)
                foreach (Delegates.ChangeSaveFileState_BeforeArgs toInvoke in _beforeChangeSaveFileState
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterChangeSaveFileState != null)
                foreach (Delegates.ChangeSaveFileState_AfterArgs toInvoke in
                         _afterChangeSaveFileState.GetInvocationList())
                    try
                    {
        ...
        internal static void HookAnimateToSlotState()
        {
            if (!HookedList.Contains("AnimateToSlotState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "AnimateToSlotState"),
                    AnimateToSlotState);
            }
        }
        ...
        private static IEnumerator AnimateToSlotState(Func<SaveSlotButton, SaveSlotButton.SlotState, IEnumerator> orig,
            SaveSlotButton self, SaveSlotButton.SlotState nextState)
        {
            Delegates.Params_AnimateToSlotState @params = new()
            {
                self = self, nextState = nextState
            };
            if (_beforeAnimateToSlotState != null)
                foreach (Delegates.AnimateToSlotState_BeforeArgs toInvoke in
                         _beforeAnimateToSlotState.GetInvocationList())
                    try
                    {
    ...
    {
        public delegate IEnumerator AnimateToSlotState_AfterArgs(Params_AnimateToSlotState args, IEnumerator ret);

        public delegate void AnimateToSlotState_BeforeArgs(Params_AnimateToSlotState args);

        public delegate IEnumerator AnimateToSlotState_WithArgs(
            Func<SaveSlotButton, SaveSlotButton.SlotState, IEnumerator> orig, SaveSlotButton self,
        ...
        public delegate void Awake_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate void CancelClearSave_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate void ChangeSaveFileState_WithArgs(Action<SaveSlotButton, SaveSlotButton.SaveFileStates> orig,
            SaveSlotButton self, SaveSlotButton.SaveFileStates nextSaveFileState);
        ...
        public delegate void ClearCache_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate void ClearSaveFile_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate void ClearSavePrompt_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);

        public delegate IEnumerator FadeInCanvasGroupAfterDelay_AfterArgs(Params_FadeInCanvasGroupAfterDelay args,
            IEnumerator ret);

        public delegate void FadeInCanvasGroupAfterDelay_BeforeArgs(Params_FadeInCanvasGroupAfterDelay args);

        public delegate IEnumerator FadeInCanvasGroupAfterDelay_WithArgs(
            Func<SaveSlotButton, float, CanvasGroup, IEnumerator> orig, SaveSlotButton self, float delay,
            CanvasGroup cg);
        ...
        public delegate int get_SaveSlotIndex_WithArgs(Func<SaveSlotButton, int> orig, SaveSlotButton self);
        ...
        public delegate void HideSaveSlot_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate void OnDeselect_WithArgs(Action<SaveSlotButton, BaseEventData> orig, SaveSlotButton self,
            BaseEventData eventData);
        ...
        public delegate void OnEnable_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate void OnPointerClick_WithArgs(Action<SaveSlotButton, PointerEventData> orig, SaveSlotButton self,
            PointerEventData eventData);
        ...
        public delegate void OnSelect_WithArgs(Action<SaveSlotButton, BaseEventData> orig, SaveSlotButton self,
            BaseEventData eventData);
        ...
        public delegate void OnSubmit_WithArgs(Action<SaveSlotButton, BaseEventData> orig, SaveSlotButton self,
            BaseEventData eventData);
        ...
        public delegate void Prepare_WithArgs(Action<SaveSlotButton, GameManager, bool> orig, SaveSlotButton self,
            GameManager gameManager, bool isReload);
        ...
        public delegate void PresentSaveSlot_WithArgs(Action<SaveSlotButton, SaveStats> orig, SaveSlotButton self,
            SaveStats saveStats);

        public delegate IEnumerator ReloadCorrupted_AfterArgs(Params_ReloadCorrupted args, IEnumerator ret);

        public delegate void ReloadCorrupted_BeforeArgs(Params_ReloadCorrupted args);

        public delegate IEnumerator ReloadCorrupted_WithArgs(Func<SaveSlotButton, IEnumerator> orig,
            SaveSlotButton self);
        ...
        public delegate void set_state_WithArgs(Action<SaveSlotButton, SaveSlotButton.SlotState> orig,
            SaveSlotButton self, SaveSlotButton.SlotState value);
        ...
        public delegate void SetupNavs_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate void
            ShowRelevantModeForSaveFileState_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);

        public delegate void Start_AfterArgs(Params_Start args);

        public delegate void Start_BeforeArgs(Params_Start args);

        public delegate void Start_WithArgs(Action<SaveSlotButton> orig, SaveSlotButton self);
        ...
        public delegate IEnumerator ValidateDeselect_WithArgs(Func<SaveSlotButton, IEnumerator> orig,
            SaveSlotButton self);

        public sealed class Params_set_state
        {
            public SaveSlotButton self;
            public SaveSlotButton.SlotState value;
        }
        ...
        {
            public SaveSlotButton.SaveFileStates nextSaveFileState;
            public SaveSlotButton self;
        }
        ...
        {
            public SaveSlotButton.SlotState nextState;
            public SaveSlotButton self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.set_state_WithArgs set_state
        {
            add => HookEndpointManager.Add<Delegates.set_state_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "set_state"), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.ChangeSaveFileState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "ChangeSaveFileState"), value);
            remove => HookEndpointManager.Remove<Delegates.ChangeSaveFileState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "ChangeSaveFileState"), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.AnimateToSlotState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "AnimateToSlotState"), value);
            remove => HookEndpointManager.Remove<Delegates.AnimateToSlotState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SaveSlotButton), "AnimateToSlotState"), value);
        }
