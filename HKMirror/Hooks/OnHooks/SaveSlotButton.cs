...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "set_state", true), set_state);
...
private static void set_state(Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.UI.SaveSlotButton.SlotState> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.UI.SaveSlotButton.SlotState value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "get_SaveSlotIndex", true), get_SaveSlotIndex);
...
private static int get_SaveSlotIndex(Func<UnityEngine.UI.SaveSlotButton, int> orig, UnityEngine.UI.SaveSlotButton self)
{
...
{
foreach (Delegates.get_SaveSlotIndex_BeforeArgs toInvoke in _beforeget_SaveSlotIndex.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnEnable", true), OnEnable);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "Prepare", true), Prepare);
...
private static void Prepare(Action<UnityEngine.UI.SaveSlotButton,  GameManager,  bool> orig, UnityEngine.UI.SaveSlotButton self,  GameManager gameManager,  bool isReload)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearCache", true), ClearCache);
...
internal static void HookChangeSaveFileState()
{
if (!HookedList.Contains("ChangeSaveFileState"))
{
HookedList.Add("ChangeSaveFileState");
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ChangeSaveFileState", true), ChangeSaveFileState);

}
}
internal static event Delegates.ChangeSaveFileState_BeforeArgs _beforeChangeSaveFileState;
internal static event Delegates.ChangeSaveFileState_AfterArgs _afterChangeSaveFileState;
private static void ChangeSaveFileState(Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.UI.SaveSlotButton.SaveFileStates> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.UI.SaveSlotButton.SaveFileStates nextSaveFileState)
{
Delegates.Params_ChangeSaveFileState @params = new() 
{
self = self
, nextSaveFileState = nextSaveFileState
};
if (_beforeChangeSaveFileState != null)
{
foreach (Delegates.ChangeSaveFileState_BeforeArgs toInvoke in _beforeChangeSaveFileState.GetInvocationList())
{
try
{
_beforeChangeSaveFileState?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
self = @params.self;
nextSaveFileState = @params.nextSaveFileState;
orig(self, nextSaveFileState);
if (_afterChangeSaveFileState != null)
{
foreach (Delegates.ChangeSaveFileState_AfterArgs toInvoke in _afterChangeSaveFileState.GetInvocationList())
{
try
{
_afterChangeSaveFileState.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnSubmit", true), OnSubmit);
...
private static void OnSubmit(Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.BaseEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ReloadCorrupted", true), ReloadCorrupted);

}
}
internal static event Delegates.ReloadCorrupted_BeforeArgs _beforeReloadCorrupted;
private static System.Collections.IEnumerator ReloadCorrupted(Func<UnityEngine.UI.SaveSlotButton, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnPointerClick", true), OnPointerClick);
...
private static void OnPointerClick(Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.PointerEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.PointerEventData eventData)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnSelect", true), OnSelect);
...
private static void OnSelect(Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.BaseEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnDeselect", true), OnDeselect);
...
private static void OnDeselect(Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.BaseEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.BaseEventData eventData)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ShowRelevantModeForSaveFileState", true), ShowRelevantModeForSaveFileState);

}
}
internal static event Delegates.ShowRelevantModeForSaveFileState_BeforeArgs _beforeShowRelevantModeForSaveFileState;
internal static event Delegates.ShowRelevantModeForSaveFileState_AfterArgs _afterShowRelevantModeForSaveFileState;
private static void ShowRelevantModeForSaveFileState(Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self)
{
...
{
foreach (Delegates.ShowRelevantModeForSaveFileState_BeforeArgs toInvoke in _beforeShowRelevantModeForSaveFileState.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ShowRelevantModeForSaveFileState_AfterArgs toInvoke in _afterShowRelevantModeForSaveFileState.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "HideSaveSlot", true), HideSaveSlot);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearSavePrompt", true), ClearSavePrompt);
...
private static void ClearSavePrompt(Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "CancelClearSave", true), CancelClearSave);
...
private static void CancelClearSave(Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearSaveFile", true), ClearSaveFile);
...
private static void ClearSaveFile(Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "FadeInCanvasGroupAfterDelay", true), FadeInCanvasGroupAfterDelay);

}
}
internal static event Delegates.FadeInCanvasGroupAfterDelay_BeforeArgs _beforeFadeInCanvasGroupAfterDelay;
private static System.Collections.IEnumerator FadeInCanvasGroupAfterDelay(Func<UnityEngine.UI.SaveSlotButton,  float,  UnityEngine.CanvasGroup, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self,  float delay,  UnityEngine.CanvasGroup cg)
{
...
{
foreach (Delegates.FadeInCanvasGroupAfterDelay_BeforeArgs toInvoke in _beforeFadeInCanvasGroupAfterDelay.GetInvocationList())
{
try
{
...
internal static void HookAnimateToSlotState()
{
if (!HookedList.Contains("AnimateToSlotState"))
{
HookedList.Add("AnimateToSlotState");
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "AnimateToSlotState", true), AnimateToSlotState);

}
}
internal static event Delegates.AnimateToSlotState_BeforeArgs _beforeAnimateToSlotState;
private static System.Collections.IEnumerator AnimateToSlotState(Func<UnityEngine.UI.SaveSlotButton,  UnityEngine.UI.SaveSlotButton.SlotState, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.UI.SaveSlotButton.SlotState nextState)
{
Delegates.Params_AnimateToSlotState @params = new() 
{
self = self
, nextState = nextState
};
if (_beforeAnimateToSlotState != null)
{
foreach (Delegates.AnimateToSlotState_BeforeArgs toInvoke in _beforeAnimateToSlotState.GetInvocationList())
{
try
{
_beforeAnimateToSlotState?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "PresentSaveSlot", true), PresentSaveSlot);
...
private static void PresentSaveSlot(Action<UnityEngine.UI.SaveSlotButton,  SaveStats> orig, UnityEngine.UI.SaveSlotButton self,  SaveStats saveStats)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "SetupNavs", true), SetupNavs);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ValidateDeselect", true), ValidateDeselect);

}
}
internal static event Delegates.ValidateDeselect_BeforeArgs _beforeValidateDeselect;
private static System.Collections.IEnumerator ValidateDeselect(Func<UnityEngine.UI.SaveSlotButton, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self)
{
...
public UnityEngine.UI.SaveSlotButton.SlotState value;
}
...
public delegate void set_state_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.UI.SaveSlotButton.SlotState> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.UI.SaveSlotButton.SlotState value);
...
public delegate int get_SaveSlotIndex_WithArgs (Func<UnityEngine.UI.SaveSlotButton, int> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void Awake_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void OnEnable_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void Start_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void Prepare_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  GameManager,  bool> orig, UnityEngine.UI.SaveSlotButton self,  GameManager gameManager,  bool isReload);
...
public delegate void ClearCache_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
public sealed class Params_ChangeSaveFileState
{
public UnityEngine.UI.SaveSlotButton self;
public UnityEngine.UI.SaveSlotButton.SaveFileStates nextSaveFileState;
}
public delegate void ChangeSaveFileState_BeforeArgs(Params_ChangeSaveFileState args);
public delegate void ChangeSaveFileState_AfterArgs(Params_ChangeSaveFileState args);
public delegate void ChangeSaveFileState_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.UI.SaveSlotButton.SaveFileStates> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.UI.SaveSlotButton.SaveFileStates nextSaveFileState);
...
public delegate void OnSubmit_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.BaseEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.BaseEventData eventData);
public sealed class Params_ReloadCorrupted
{
public UnityEngine.UI.SaveSlotButton self;
}
public delegate void ReloadCorrupted_BeforeArgs(Params_ReloadCorrupted args);
public delegate System.Collections.IEnumerator ReloadCorrupted_AfterArgs(Params_ReloadCorrupted args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ReloadCorrupted_WithArgs (Func<UnityEngine.UI.SaveSlotButton, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void OnPointerClick_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.PointerEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.PointerEventData eventData);
...
public delegate void OnSelect_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.BaseEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void OnDeselect_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  UnityEngine.EventSystems.BaseEventData> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.EventSystems.BaseEventData eventData);
...
public delegate void ShowRelevantModeForSaveFileState_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void HideSaveSlot_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void ClearSavePrompt_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void CancelClearSave_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate void ClearSaveFile_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate System.Collections.IEnumerator FadeInCanvasGroupAfterDelay_AfterArgs(Params_FadeInCanvasGroupAfterDelay args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FadeInCanvasGroupAfterDelay_WithArgs (Func<UnityEngine.UI.SaveSlotButton,  float,  UnityEngine.CanvasGroup, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self,  float delay,  UnityEngine.CanvasGroup cg);
public sealed class Params_AnimateToSlotState
{
public UnityEngine.UI.SaveSlotButton self;
public UnityEngine.UI.SaveSlotButton.SlotState nextState;
}
public delegate void AnimateToSlotState_BeforeArgs(Params_AnimateToSlotState args);
public delegate System.Collections.IEnumerator AnimateToSlotState_AfterArgs(Params_AnimateToSlotState args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator AnimateToSlotState_WithArgs (Func<UnityEngine.UI.SaveSlotButton,  UnityEngine.UI.SaveSlotButton.SlotState, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self,  UnityEngine.UI.SaveSlotButton.SlotState nextState);
...
public delegate void PresentSaveSlot_WithArgs (Action<UnityEngine.UI.SaveSlotButton,  SaveStats> orig, UnityEngine.UI.SaveSlotButton self,  SaveStats saveStats);
...
public delegate void SetupNavs_WithArgs (Action<UnityEngine.UI.SaveSlotButton> orig, UnityEngine.UI.SaveSlotButton self);
...
public delegate System.Collections.IEnumerator ValidateDeselect_WithArgs (Func<UnityEngine.UI.SaveSlotButton, System.Collections.IEnumerator> orig, UnityEngine.UI.SaveSlotButton self);
}
...
public static event Delegates.ChangeSaveFileState_BeforeArgs ChangeSaveFileState
{
add
{

HookHandler._beforeChangeSaveFileState += value;
HookHandler.HookChangeSaveFileState();
}
remove => HookHandler._beforeChangeSaveFileState -= value;
}
...
public static event Delegates.AnimateToSlotState_BeforeArgs AnimateToSlotState
{
add
{

HookHandler._beforeAnimateToSlotState += value;
HookHandler.HookAnimateToSlotState();
}
remove => HookHandler._beforeAnimateToSlotState -= value;
}
...
public static event Delegates.ChangeSaveFileState_AfterArgs ChangeSaveFileState
{
add
{

HookHandler._afterChangeSaveFileState += value;
HookHandler.HookChangeSaveFileState();
}
remove => HookHandler._afterChangeSaveFileState -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.set_state_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "set_state", true), value);
remove => HookEndpointManager.Remove<Delegates.set_state_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "set_state", true), value);
}
public static event Delegates.get_SaveSlotIndex_WithArgs get_SaveSlotIndex
{
add => HookEndpointManager.Add<Delegates.get_SaveSlotIndex_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "get_SaveSlotIndex", true), value);
remove => HookEndpointManager.Remove<Delegates.get_SaveSlotIndex_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "get_SaveSlotIndex", true), value);
}
public static event Delegates.Awake_WithArgs Awake
{
add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "Awake", true), value);
remove => HookEndpointManager.Remove<Delegates.Awake_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "Awake", true), value);
}
public static event Delegates.OnEnable_WithArgs OnEnable
{
add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnEnable", true), value);
remove => HookEndpointManager.Remove<Delegates.OnEnable_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnEnable", true), value);
}
public static event Delegates.Start_WithArgs Start
{
add => HookEndpointManager.Add<Delegates.Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "Start", true), value);
remove => HookEndpointManager.Remove<Delegates.Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "Start", true), value);
}
public static event Delegates.Prepare_WithArgs Prepare
{
add => HookEndpointManager.Add<Delegates.Prepare_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "Prepare", true), value);
remove => HookEndpointManager.Remove<Delegates.Prepare_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "Prepare", true), value);
}
public static event Delegates.ClearCache_WithArgs ClearCache
{
add => HookEndpointManager.Add<Delegates.ClearCache_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearCache", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearCache_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearCache", true), value);
}
public static event Delegates.ChangeSaveFileState_WithArgs ChangeSaveFileState
{
add => HookEndpointManager.Add<Delegates.ChangeSaveFileState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ChangeSaveFileState", true), value);
remove => HookEndpointManager.Remove<Delegates.ChangeSaveFileState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ChangeSaveFileState", true), value);
}
public static event Delegates.OnSubmit_WithArgs OnSubmit
{
add => HookEndpointManager.Add<Delegates.OnSubmit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnSubmit", true), value);
remove => HookEndpointManager.Remove<Delegates.OnSubmit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnSubmit", true), value);
}
public static event Delegates.ReloadCorrupted_WithArgs ReloadCorrupted
{
add => HookEndpointManager.Add<Delegates.ReloadCorrupted_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ReloadCorrupted", true), value);
remove => HookEndpointManager.Remove<Delegates.ReloadCorrupted_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ReloadCorrupted", true), value);
}
public static event Delegates.OnPointerClick_WithArgs OnPointerClick
{
add => HookEndpointManager.Add<Delegates.OnPointerClick_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnPointerClick", true), value);
remove => HookEndpointManager.Remove<Delegates.OnPointerClick_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnPointerClick", true), value);
}
public static event Delegates.OnSelect_WithArgs OnSelect
{
add => HookEndpointManager.Add<Delegates.OnSelect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnSelect", true), value);
remove => HookEndpointManager.Remove<Delegates.OnSelect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnSelect", true), value);
}
public static event Delegates.OnDeselect_WithArgs OnDeselect
{
add => HookEndpointManager.Add<Delegates.OnDeselect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnDeselect", true), value);
remove => HookEndpointManager.Remove<Delegates.OnDeselect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "OnDeselect", true), value);
}
public static event Delegates.ShowRelevantModeForSaveFileState_WithArgs ShowRelevantModeForSaveFileState
{
add => HookEndpointManager.Add<Delegates.ShowRelevantModeForSaveFileState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ShowRelevantModeForSaveFileState", true), value);
remove => HookEndpointManager.Remove<Delegates.ShowRelevantModeForSaveFileState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ShowRelevantModeForSaveFileState", true), value);
}
public static event Delegates.HideSaveSlot_WithArgs HideSaveSlot
{
add => HookEndpointManager.Add<Delegates.HideSaveSlot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "HideSaveSlot", true), value);
remove => HookEndpointManager.Remove<Delegates.HideSaveSlot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "HideSaveSlot", true), value);
}
public static event Delegates.ClearSavePrompt_WithArgs ClearSavePrompt
{
add => HookEndpointManager.Add<Delegates.ClearSavePrompt_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearSavePrompt", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearSavePrompt_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearSavePrompt", true), value);
}
public static event Delegates.CancelClearSave_WithArgs CancelClearSave
{
add => HookEndpointManager.Add<Delegates.CancelClearSave_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "CancelClearSave", true), value);
remove => HookEndpointManager.Remove<Delegates.CancelClearSave_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "CancelClearSave", true), value);
}
public static event Delegates.ClearSaveFile_WithArgs ClearSaveFile
{
add => HookEndpointManager.Add<Delegates.ClearSaveFile_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearSaveFile", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearSaveFile_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ClearSaveFile", true), value);
}
public static event Delegates.FadeInCanvasGroupAfterDelay_WithArgs FadeInCanvasGroupAfterDelay
{
add => HookEndpointManager.Add<Delegates.FadeInCanvasGroupAfterDelay_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "FadeInCanvasGroupAfterDelay", true), value);
remove => HookEndpointManager.Remove<Delegates.FadeInCanvasGroupAfterDelay_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "FadeInCanvasGroupAfterDelay", true), value);
}
public static event Delegates.AnimateToSlotState_WithArgs AnimateToSlotState
{
add => HookEndpointManager.Add<Delegates.AnimateToSlotState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "AnimateToSlotState", true), value);
remove => HookEndpointManager.Remove<Delegates.AnimateToSlotState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "AnimateToSlotState", true), value);
}
public static event Delegates.PresentSaveSlot_WithArgs PresentSaveSlot
{
add => HookEndpointManager.Add<Delegates.PresentSaveSlot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "PresentSaveSlot", true), value);
remove => HookEndpointManager.Remove<Delegates.PresentSaveSlot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "PresentSaveSlot", true), value);
}
public static event Delegates.SetupNavs_WithArgs SetupNavs
{
add => HookEndpointManager.Add<Delegates.SetupNavs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "SetupNavs", true), value);
remove => HookEndpointManager.Remove<Delegates.SetupNavs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "SetupNavs", true), value);
}
public static event Delegates.ValidateDeselect_WithArgs ValidateDeselect
{
add => HookEndpointManager.Add<Delegates.ValidateDeselect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ValidateDeselect", true), value);
remove => HookEndpointManager.Remove<Delegates.ValidateDeselect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.SaveSlotButton), "ValidateDeselect", true), value);
}
}
