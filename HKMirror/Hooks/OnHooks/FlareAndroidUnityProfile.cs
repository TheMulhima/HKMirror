...
public static class OnFlareAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FlareAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<FlareAndroidUnityProfile> orig, FlareAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<FlareAndroidUnityProfile> orig, FlareAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public FlareAndroidUnityProfile self;
        }
    }
