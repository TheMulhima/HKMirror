...
public static class OnXboxOneMacChromeUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneMacChromeUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneMacChromeUnityProfile> orig, XboxOneMacChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneMacChromeUnityProfile> orig,
            XboxOneMacChromeUnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneMacChromeUnityProfile self;
        }
    }
