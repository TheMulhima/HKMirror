...
new Hook(ReflectionHelper.GetMethodInfo(typeof(AchievementIDMap.AchievementIDPair), "get_InternalId", true), get_InternalId);
...
private static string get_InternalId(Func<AchievementIDMap.AchievementIDPair, string> orig, AchievementIDMap.AchievementIDPair self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(AchievementIDMap.AchievementIDPair), "get_ServiceId", true), get_ServiceId);
...
private static int get_ServiceId(Func<AchievementIDMap.AchievementIDPair, int> orig, AchievementIDMap.AchievementIDPair self)
{
...
public delegate string get_InternalId_WithArgs (Func<AchievementIDMap.AchievementIDPair, string> orig, AchievementIDMap.AchievementIDPair self);
...
public delegate int get_ServiceId_WithArgs (Func<AchievementIDMap.AchievementIDPair, int> orig, AchievementIDMap.AchievementIDPair self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_InternalId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementIDMap.AchievementIDPair), "get_InternalId", true), value);
remove => HookEndpointManager.Remove<Delegates.get_InternalId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementIDMap.AchievementIDPair), "get_InternalId", true), value);
}
public static event Delegates.get_ServiceId_WithArgs get_ServiceId
{
add => HookEndpointManager.Add<Delegates.get_ServiceId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementIDMap.AchievementIDPair), "get_ServiceId", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ServiceId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AchievementIDMap.AchievementIDPair), "get_ServiceId", true), value);
}
}
