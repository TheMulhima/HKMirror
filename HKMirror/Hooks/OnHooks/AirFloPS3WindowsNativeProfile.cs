...
public static class OnAirFloPS3WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AirFloPS3WindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AirFloPS3WindowsNativeProfile> orig, AirFloPS3WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AirFloPS3WindowsNativeProfile> orig,
            AirFloPS3WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public AirFloPS3WindowsNativeProfile self;
        }
    }
