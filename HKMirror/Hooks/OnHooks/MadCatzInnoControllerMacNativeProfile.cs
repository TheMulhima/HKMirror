...
public static class OnMadCatzInnoControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzInnoControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzInnoControllerMacNativeProfile> orig,
            MadCatzInnoControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzInnoControllerMacNativeProfile> orig,
            MadCatzInnoControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzInnoControllerMacNativeProfile self;
        }
    }
