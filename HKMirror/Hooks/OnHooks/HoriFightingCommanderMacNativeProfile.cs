...
public static class OnHoriFightingCommanderMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriFightingCommanderMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriFightingCommanderMacNativeProfile> orig,
            HoriFightingCommanderMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriFightingCommanderMacNativeProfile> orig,
            HoriFightingCommanderMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriFightingCommanderMacNativeProfile self;
        }
    }
