...
private static void OnCollisionEnter2D(On.ConveyorBelt.orig_OnCollisionEnter2D orig,ConveyorBelt self,  UnityEngine.Collision2D collision)
{
...
private static void OnCollisionExit2D(On.ConveyorBelt.orig_OnCollisionExit2D orig,ConveyorBelt self,  UnityEngine.Collision2D collision)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<ConveyorBelt,  UnityEngine.Collision2D> orig, ConveyorBelt self,  UnityEngine.Collision2D collision);
...
public delegate void OnCollisionExit2D_WithArgs (Action<ConveyorBelt,  UnityEngine.Collision2D> orig, ConveyorBelt self,  UnityEngine.Collision2D collision);
}
