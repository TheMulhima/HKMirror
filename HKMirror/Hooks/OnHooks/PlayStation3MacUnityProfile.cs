...
public static class OnPlayStation3MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.PlayStation3MacUnityProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.PlayStation3MacUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation3MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<InControl.UnityDeviceProfiles.PlayStation3MacUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation3MacUnityProfile self);
    }
