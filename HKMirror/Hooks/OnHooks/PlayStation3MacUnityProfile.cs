...
public static class OnPlayStation3MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation3MacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation3MacUnityProfile> orig, PlayStation3MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation3MacUnityProfile> orig,
            PlayStation3MacUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation3MacUnityProfile self;
        }
    }
