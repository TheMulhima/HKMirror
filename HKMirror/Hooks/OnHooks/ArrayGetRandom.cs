...
public static class OnArrayGetRandom
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetRandom), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetRandom), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetRandom), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self)
        {
        ...
        internal static void HookDoGetRandomValue()
        {
            if (!HookedList.Contains("DoGetRandomValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetRandom),
                        "DoGetRandomValue", true), DoGetRandomValue);
            }
        }
        ...
        private static void DoGetRandomValue(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self);
        ...
        public delegate void DoGetRandomValue_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayGetRandom> orig,
            HutongGames.PlayMaker.Actions.ArrayGetRandom self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetRandom), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetRandom), "OnUpdate", true),
                value);
        ...
        public static event Delegates.DoGetRandomValue_WithArgs DoGetRandomValue
        {
            add => HookEndpointManager.Add<Delegates.DoGetRandomValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayGetRandom), "DoGetRandomValue",
                    true), value);
