...
private static void OnTriggerEnter2D(On.PaintBullet.orig_OnTriggerEnter2D orig,PaintBullet self,  UnityEngine.Collider2D collision)
{
...
private static void OnTriggerExit2D(On.PaintBullet.orig_OnTriggerExit2D orig,PaintBullet self,  UnityEngine.Collider2D collision)
{
...
private static void OnCollisionEnter2D(On.PaintBullet.orig_OnCollisionEnter2D orig,PaintBullet self,  UnityEngine.Collision2D collision)
{
...
private static void OrbitShieldHit(On.PaintBullet.orig_OrbitShieldHit orig,PaintBullet self,  UnityEngine.Transform shield)
{
...
private static System.Collections.IEnumerator Collision(On.PaintBullet.orig_Collision orig,PaintBullet self,  UnityEngine.Vector2 normal,  bool doRotation)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<PaintBullet,  UnityEngine.Collider2D> orig, PaintBullet self,  UnityEngine.Collider2D collision);
...
public delegate void OnTriggerExit2D_WithArgs (Action<PaintBullet,  UnityEngine.Collider2D> orig, PaintBullet self,  UnityEngine.Collider2D collision);
...
public delegate void OnCollisionEnter2D_WithArgs (Action<PaintBullet,  UnityEngine.Collision2D> orig, PaintBullet self,  UnityEngine.Collision2D collision);
...
public delegate void OrbitShieldHit_WithArgs (Action<PaintBullet,  UnityEngine.Transform> orig, PaintBullet self,  UnityEngine.Transform shield);
...
public delegate System.Collections.IEnumerator Collision_WithArgs (Func<PaintBullet,  UnityEngine.Vector2,  bool, System.Collections.IEnumerator> orig, PaintBullet self,  UnityEngine.Vector2 normal,  bool doRotation);
