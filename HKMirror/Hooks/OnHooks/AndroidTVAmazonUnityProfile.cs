...
public static class OnAndroidTVAmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AndroidTVAmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AndroidTVAmazonUnityProfile> orig, AndroidTVAmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AndroidTVAmazonUnityProfile> orig,
            AndroidTVAmazonUnityProfile self);

        public sealed class Params_Define
        {
            public AndroidTVAmazonUnityProfile self;
        }
    }
