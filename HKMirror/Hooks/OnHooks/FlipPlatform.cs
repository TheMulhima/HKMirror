...
private static void OnCollisionEnter2D(On.FlipPlatform.orig_OnCollisionEnter2D orig,FlipPlatform self,  UnityEngine.Collision2D collision)
{
...
private static void PlaySound(On.FlipPlatform.orig_PlaySound orig,FlipPlatform self,  UnityEngine.AudioClip clip)
{
...
private static System.Collections.IEnumerator Jitter(On.FlipPlatform.orig_Jitter orig,FlipPlatform self,  float duration)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<FlipPlatform,  UnityEngine.Collision2D> orig, FlipPlatform self,  UnityEngine.Collision2D collision);
...
public delegate void PlaySound_WithArgs (Action<FlipPlatform,  UnityEngine.AudioClip> orig, FlipPlatform self,  UnityEngine.AudioClip clip);
...
public delegate System.Collections.IEnumerator Idle_WithArgs (Func<FlipPlatform, System.Collections.IEnumerator> orig, FlipPlatform self);
...
public delegate System.Collections.IEnumerator Flip_WithArgs (Func<FlipPlatform, System.Collections.IEnumerator> orig, FlipPlatform self);
...
public delegate System.Collections.IEnumerator Jitter_WithArgs (Func<FlipPlatform,  float, System.Collections.IEnumerator> orig, FlipPlatform self,  float duration);
}
