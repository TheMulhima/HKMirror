...
private static void OnTriggerEnter2D(On.HeroBox.orig_OnTriggerEnter2D orig,HeroBox self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerStay2D(On.HeroBox.orig_OnTriggerStay2D orig,HeroBox self,  UnityEngine.Collider2D otherCollider)
{
...
private static void CheckForDamage(On.HeroBox.orig_CheckForDamage orig,HeroBox self,  UnityEngine.Collider2D otherCollider)
{
...
{
foreach (Delegates.IsHitTypeBuffered_BeforeArgs toInvoke in _beforeIsHitTypeBuffered.GetInvocationList())
{
try
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<HeroBox,  UnityEngine.Collider2D> orig, HeroBox self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerStay2D_WithArgs (Action<HeroBox,  UnityEngine.Collider2D> orig, HeroBox self,  UnityEngine.Collider2D otherCollider);
...
public delegate void CheckForDamage_WithArgs (Action<HeroBox,  UnityEngine.Collider2D> orig, HeroBox self,  UnityEngine.Collider2D otherCollider);
