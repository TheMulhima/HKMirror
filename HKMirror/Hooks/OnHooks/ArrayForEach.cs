...
public static class OnArrayForEach
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "OnLateUpdate",
                        true), OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookStartNextFsm()
        {
            if (!HookedList.Contains("StartNextFsm"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "StartNextFsm",
                        true), StartNextFsm);
            }
        }
        ...
        private static void StartNextFsm(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookStartFsm()
        {
            if (!HookedList.Contains("StartFsm"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "StartFsm",
                        true), StartFsm);
            }
        }
        ...
        private static void StartFsm(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookDoStartFsm()
        {
            if (!HookedList.Contains("DoStartFsm"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "DoStartFsm",
                        true), DoStartFsm);
            }
        }
        ...
        private static void DoStartFsm(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
        ...
        internal static void HookCheckIfFinished()
        {
            if (!HookedList.Contains("CheckIfFinished"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach),
                        "CheckIfFinished", true), CheckIfFinished);
            }
        }
        ...
        private static void CheckIfFinished(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void StartNextFsm_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void StartFsm_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void DoStartFsm_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
        ...
        public delegate void CheckIfFinished_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayForEach> orig,
            HutongGames.PlayMaker.Actions.ArrayForEach self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "OnUpdate", true),
                value);
        ...
        public static event Delegates.StartFsm_WithArgs StartFsm
        {
            add => HookEndpointManager.Add<Delegates.StartFsm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "StartFsm", true),
                value);
        ...
        public static event Delegates.DoStartFsm_WithArgs DoStartFsm
        {
            add => HookEndpointManager.Add<Delegates.DoStartFsm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "DoStartFsm", true),
                value);
        ...
        public static event Delegates.CheckIfFinished_WithArgs CheckIfFinished
        {
            add => HookEndpointManager.Add<Delegates.CheckIfFinished_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayForEach), "CheckIfFinished",
                    true), value);
