...
public static class OnMadCatzSF4FightStickTEMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MadCatzSF4FightStickTEMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.MadCatzSF4FightStickTEMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSF4FightStickTEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.MadCatzSF4FightStickTEMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSF4FightStickTEMacNativeProfile self);
    }
