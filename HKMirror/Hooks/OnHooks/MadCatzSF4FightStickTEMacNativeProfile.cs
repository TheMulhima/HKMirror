...
public static class OnMadCatzSF4FightStickTEMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzSF4FightStickTEMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzSF4FightStickTEMacNativeProfile> orig,
            MadCatzSF4FightStickTEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzSF4FightStickTEMacNativeProfile> orig,
            MadCatzSF4FightStickTEMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzSF4FightStickTEMacNativeProfile self;
        }
    }
