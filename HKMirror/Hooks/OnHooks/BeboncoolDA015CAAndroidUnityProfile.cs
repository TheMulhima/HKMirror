...
public static class OnBeboncoolDA015CAAndroidUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.BeboncoolDA015CAAndroidUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.BeboncoolDA015CAAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.BeboncoolDA015CAAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.BeboncoolDA015CAAndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.BeboncoolDA015CAAndroidUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.UnityDeviceProfiles.BeboncoolDA015CAAndroidUnityProfile), "Define", true), value);
