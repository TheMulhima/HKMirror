...
public static class OnFaceAngle
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self)
        {
        ...
        internal static void HookDoAngle()
        {
            if (!HookedList.Contains("DoAngle"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "DoAngle", true),
                    DoAngle);
            }
        }
        ...
        private static void DoAngle(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self);
        ...
        public delegate void DoAngle_WithArgs(Action<HutongGames.PlayMaker.Actions.FaceAngle> orig,
            HutongGames.PlayMaker.Actions.FaceAngle self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "Reset", true), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "Awake", true), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "OnPreprocess", true),
                value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "OnFixedUpdate", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoAngle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "DoAngle", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.DoAngle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FaceAngle), "DoAngle", true),
                value);
        }
    }
