...
public static class OnFaceAngle
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<FaceAngle> orig, FaceAngle self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<FaceAngle> orig, FaceAngle self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<FaceAngle> orig, FaceAngle self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<FaceAngle> orig, FaceAngle self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<FaceAngle> orig, FaceAngle self)
        {
        ...
        internal static void HookDoAngle()
        {
            if (!HookedList.Contains("DoAngle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "DoAngle"), DoAngle);
            }
        }
        ...
        private static void DoAngle(Action<FaceAngle> orig, FaceAngle self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<FaceAngle> orig, FaceAngle self);

        public delegate void DoAngle_AfterArgs(Params_DoAngle args);

        public delegate void DoAngle_BeforeArgs(Params_DoAngle args);

        public delegate void DoAngle_WithArgs(Action<FaceAngle> orig, FaceAngle self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<FaceAngle> orig, FaceAngle self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<FaceAngle> orig, FaceAngle self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<FaceAngle> orig, FaceAngle self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<FaceAngle> orig, FaceAngle self);

        public sealed class Params_Reset
        {
            public FaceAngle self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "Awake"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoAngle_WithArgs DoAngle
        {
            add => HookEndpointManager.Add<Delegates.DoAngle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FaceAngle), "DoAngle"), value);
