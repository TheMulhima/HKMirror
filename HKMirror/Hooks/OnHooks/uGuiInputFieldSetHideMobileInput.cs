...
public static class OnuGuiInputFieldSetHideMobileInput
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput), "DoSetValue", true),
                    DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput self);
        ...
        public delegate void OnEnter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetHideMobileInput),
                    "Reset", true), value);
