...
public static class OnuGuiInputFieldSetHideMobileInput
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetHideMobileInput), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiInputFieldSetHideMobileInput> orig, uGuiInputFieldSetHideMobileInput self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetHideMobileInput), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiInputFieldSetHideMobileInput> orig,
            uGuiInputFieldSetHideMobileInput self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetHideMobileInput), "DoSetValue"),
                    DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiInputFieldSetHideMobileInput> orig,
            uGuiInputFieldSetHideMobileInput self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldSetHideMobileInput), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiInputFieldSetHideMobileInput> orig, uGuiInputFieldSetHideMobileInput self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiInputFieldSetHideMobileInput> orig,
            uGuiInputFieldSetHideMobileInput self);
        ...
        public delegate void OnEnter_WithArgs(Action<uGuiInputFieldSetHideMobileInput> orig,
            uGuiInputFieldSetHideMobileInput self);
        ...
        public delegate void OnExit_WithArgs(Action<uGuiInputFieldSetHideMobileInput> orig,
            uGuiInputFieldSetHideMobileInput self);
        ...
        public delegate void Reset_WithArgs(Action<uGuiInputFieldSetHideMobileInput> orig,
            uGuiInputFieldSetHideMobileInput self);

        public sealed class Params_Reset
        {
            public uGuiInputFieldSetHideMobileInput self;
        }
