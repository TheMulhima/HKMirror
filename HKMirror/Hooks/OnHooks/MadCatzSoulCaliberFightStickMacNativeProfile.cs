...
public static class OnMadCatzSoulCaliberFightStickMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MadCatzSoulCaliberFightStickMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.MadCatzSoulCaliberFightStickMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSoulCaliberFightStickMacNativeProfile self)
        {
