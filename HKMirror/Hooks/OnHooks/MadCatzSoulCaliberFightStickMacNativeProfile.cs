...
public static class OnMadCatzSoulCaliberFightStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzSoulCaliberFightStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzSoulCaliberFightStickMacNativeProfile> orig,
            MadCatzSoulCaliberFightStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzSoulCaliberFightStickMacNativeProfile> orig,
            MadCatzSoulCaliberFightStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzSoulCaliberFightStickMacNativeProfile self;
        }
    }
