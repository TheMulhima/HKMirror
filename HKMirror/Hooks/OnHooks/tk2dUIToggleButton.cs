...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "get_IsInToggleGroup", true), get_IsInToggleGroup);
...
{
foreach (Delegates.get_IsInToggleGroup_BeforeArgs toInvoke in _beforeget_IsInToggleGroup.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsInToggleGroup_AfterArgs toInvoke in _afterget_IsInToggleGroup.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "set_IsInToggleGroup", true), set_IsInToggleGroup);
...
private static void set_IsInToggleGroup(Action<tk2dUIToggleButton,  bool> orig, tk2dUIToggleButton self,  bool value)
{
...
{
foreach (Delegates.set_IsInToggleGroup_BeforeArgs toInvoke in _beforeset_IsInToggleGroup.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_IsInToggleGroup_AfterArgs toInvoke in _afterset_IsInToggleGroup.GetInvocationList())
{
try
{
...
public delegate void set_IsOn_WithArgs (Action<tk2dUIToggleButton,  bool> orig, tk2dUIToggleButton self,  bool value);
...
public delegate void set_IsInToggleGroup_WithArgs (Action<tk2dUIToggleButton,  bool> orig, tk2dUIToggleButton self,  bool value);
...
{
add => HookEndpointManager.Add<Delegates.get_IsOn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "get_IsOn", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsOn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "get_IsOn", true), value);
}
public static event Delegates.set_IsOn_WithArgs set_IsOn
{
add => HookEndpointManager.Add<Delegates.set_IsOn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "set_IsOn", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsOn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "set_IsOn", true), value);
}
public static event Delegates.get_IsInToggleGroup_WithArgs get_IsInToggleGroup
{
add => HookEndpointManager.Add<Delegates.get_IsInToggleGroup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "get_IsInToggleGroup", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsInToggleGroup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "get_IsInToggleGroup", true), value);
}
public static event Delegates.set_IsInToggleGroup_WithArgs set_IsInToggleGroup
{
add => HookEndpointManager.Add<Delegates.set_IsInToggleGroup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "set_IsInToggleGroup", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsInToggleGroup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButton), "set_IsInToggleGroup", true), value);
}
