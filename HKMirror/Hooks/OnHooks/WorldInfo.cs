...
public static class OnWorldInfo
{
    internal static class HookHandler
    {
            ...
            string sceneName)
        {
            ...
            {
                foreach (Delegates.NameLooksLikeGameplayScene_BeforeArgs toInvoke in _beforeNameLooksLikeGameplayScene
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.NameLooksLikeGameplayScene_AfterArgs toInvoke in _afterNameLooksLikeGameplayScene
                             .GetInvocationList())
                {
                    try
                    {
