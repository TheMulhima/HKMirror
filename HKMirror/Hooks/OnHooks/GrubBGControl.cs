...
public static class OnGrubBGControl
{
    internal static class HookHandler
    {
        ...
        private static IEnumerator Idle(On.GrubBGControl.orig_Idle orig, GrubBGControl self)
        {
        ...
        private static IEnumerator Wave(On.GrubBGControl.orig_Wave orig, GrubBGControl self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator Idle_WithArgs(Func<GrubBGControl, IEnumerator> orig, GrubBGControl self);
        ...
        public delegate IEnumerator Wave_AfterArgs(Params_Wave args, IEnumerator ret);

        public delegate void Wave_BeforeArgs(Params_Wave args);

        public delegate IEnumerator Wave_WithArgs(Func<GrubBGControl, IEnumerator> orig, GrubBGControl self);
