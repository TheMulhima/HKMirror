...
public static class OnDistanceWalk
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "Awake", true),
                    Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self)
        {
        ...
        internal static void HookDoWalk()
        {
            if (!HookedList.Contains("DoWalk"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "DoWalk", true),
                    DoWalk);
            }
        }
        ...
        private static void DoWalk(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self);
        ...
        public delegate void DoWalk_WithArgs(Action<HutongGames.PlayMaker.Actions.DistanceWalk> orig,
            HutongGames.PlayMaker.Actions.DistanceWalk self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DistanceWalk), "OnUpdate", true),
                value);
