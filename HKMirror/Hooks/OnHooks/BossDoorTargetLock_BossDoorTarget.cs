...
public static class OnBossDoorTargetLock_BossDoorTarget
{
    internal static class HookHandler
    {
        ...
        internal static void HookEvaluate()
        {
            if (!HookedList.Contains("Evaluate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock.BossDoorTarget), "Evaluate"),
                    Evaluate);
            }
        }
        ...
        private static bool Evaluate(Func<BossDoorTargetLock.BossDoorTarget, bool> orig,
            BossDoorTargetLock.BossDoorTarget self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate bool Evaluate_WithArgs(Func<BossDoorTargetLock.BossDoorTarget, bool> orig,
            BossDoorTargetLock.BossDoorTarget self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.Evaluate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock.BossDoorTarget), "Evaluate"), value);
            remove => HookEndpointManager.Remove<Delegates.Evaluate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossDoorTargetLock.BossDoorTarget), "Evaluate"), value);
        }
    }
}