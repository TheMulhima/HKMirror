...
public static class OnIpegaPG9025AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IpegaPG9025AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<IpegaPG9025AndroidUnityProfile> orig, IpegaPG9025AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<IpegaPG9025AndroidUnityProfile> orig,
            IpegaPG9025AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public IpegaPG9025AndroidUnityProfile self;
        }
    }
