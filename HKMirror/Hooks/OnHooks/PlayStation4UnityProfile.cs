...
public static class OnPlayStation4UnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4UnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4UnityProfile> orig, PlayStation4UnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4UnityProfile> orig, PlayStation4UnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4UnityProfile self;
        }
    }
