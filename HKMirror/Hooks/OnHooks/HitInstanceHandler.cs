...
public static class OnHitInstanceHandler
{
    ...
    public static class Delegates
    {
        ...
        public delegate HitInstance EndInvoke_WithArgs(Func<HitInstanceHandler, IAsyncResult, HitInstance> orig,
            HitInstanceHandler self, IAsyncResult result);
        ...
        public delegate HitInstance Invoke_WithArgs(Func<HitInstanceHandler, Fsm, HitInstance, HitInstance> orig,
            HitInstanceHandler self, Fsm owner, HitInstance hit);
