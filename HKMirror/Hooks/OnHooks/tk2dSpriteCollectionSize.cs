...
private static tk2dSpriteCollectionSize Explicit(On.tk2dSpriteCollectionSize.orig_Explicit orig, float orthoSize,  float targetHeight)
{
...
private static tk2dSpriteCollectionSize PixelsPerMeter(On.tk2dSpriteCollectionSize.orig_PixelsPerMeter orig, float pixelsPerMeter)
{
...
private static tk2dSpriteCollectionSize ForResolution(On.tk2dSpriteCollectionSize.orig_ForResolution orig, float orthoSize,  float width,  float height)
{
...
private static tk2dSpriteCollectionSize ForTk2dCamera_tk2dCamera(On.tk2dSpriteCollectionSize.orig_ForTk2dCamera_tk2dCamera orig, tk2dCamera camera)
{
...
{
foreach (Delegates.ForTk2dCamera_tk2dCamera_BeforeArgs toInvoke in _beforeForTk2dCamera_tk2dCamera.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ForTk2dCamera_tk2dCamera_AfterArgs toInvoke in _afterForTk2dCamera_tk2dCamera.GetInvocationList())
{
try
{
...
private static void CopyFromLegacy(On.tk2dSpriteCollectionSize.orig_CopyFromLegacy orig,tk2dSpriteCollectionSize self,  bool useTk2dCamera,  float orthoSize,  float targetHeight)
{
Delegates.Params_CopyFromLegacy @params = new() 
{
self = self
, useTk2dCamera = useTk2dCamera
, orthoSize = orthoSize
, targetHeight = targetHeight
};
...
private static void CopyFrom(On.tk2dSpriteCollectionSize.orig_CopyFrom orig,tk2dSpriteCollectionSize self,  tk2dSpriteCollectionSize source)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionSize), "get_OrthoSize", true), get_OrthoSize);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionSize), "get_TargetHeight", true), get_TargetHeight);
...
public delegate tk2dSpriteCollectionSize Explicit_WithArgs (Func< float,  float, tk2dSpriteCollectionSize> orig,  float orthoSize,  float targetHeight);
public sealed class Params_PixelsPerMeter
{
public float pixelsPerMeter;
}
public delegate void PixelsPerMeter_BeforeArgs(Params_PixelsPerMeter args);
public delegate tk2dSpriteCollectionSize PixelsPerMeter_AfterArgs(Params_PixelsPerMeter args, tk2dSpriteCollectionSize ret);
public delegate tk2dSpriteCollectionSize PixelsPerMeter_WithArgs (Func< float, tk2dSpriteCollectionSize> orig,  float pixelsPerMeter);
...
public delegate tk2dSpriteCollectionSize ForResolution_AfterArgs(Params_ForResolution args, tk2dSpriteCollectionSize ret);
public delegate tk2dSpriteCollectionSize ForResolution_WithArgs (Func< float,  float,  float, tk2dSpriteCollectionSize> orig,  float orthoSize,  float width,  float height);
...
public delegate tk2dSpriteCollectionSize ForTk2dCamera_tk2dCamera_AfterArgs(Params_ForTk2dCamera_tk2dCamera args, tk2dSpriteCollectionSize ret);
public delegate tk2dSpriteCollectionSize ForTk2dCamera_tk2dCamera_WithArgs (Func< tk2dCamera, tk2dSpriteCollectionSize> orig,  tk2dCamera camera);
...
public delegate void CopyFromLegacy_WithArgs (Action<tk2dSpriteCollectionSize,  bool,  float,  float> orig, tk2dSpriteCollectionSize self,  bool useTk2dCamera,  float orthoSize,  float targetHeight);
...
public delegate void CopyFrom_WithArgs (Action<tk2dSpriteCollectionSize,  tk2dSpriteCollectionSize> orig, tk2dSpriteCollectionSize self,  tk2dSpriteCollectionSize source);
...
public delegate float get_OrthoSize_WithArgs (Func<tk2dSpriteCollectionSize, float> orig, tk2dSpriteCollectionSize self);
...
public delegate float get_TargetHeight_WithArgs (Func<tk2dSpriteCollectionSize, float> orig, tk2dSpriteCollectionSize self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_OrthoSize_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionSize), "get_OrthoSize", true), value);
remove => HookEndpointManager.Remove<Delegates.get_OrthoSize_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionSize), "get_OrthoSize", true), value);
}
public static event Delegates.get_TargetHeight_WithArgs get_TargetHeight
{
add => HookEndpointManager.Add<Delegates.get_TargetHeight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionSize), "get_TargetHeight", true), value);
remove => HookEndpointManager.Remove<Delegates.get_TargetHeight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionSize), "get_TargetHeight", true), value);
}
}
