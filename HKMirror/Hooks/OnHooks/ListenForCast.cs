...
public static class OnListenForCast
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ListenForCast), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ListenForCast), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ListenForCast), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self)
        {
        ...
        internal static void HookCheckForInput()
        {
            if (!HookedList.Contains("CheckForInput"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ListenForCast), "CheckForInput",
                        true), CheckForInput);
            }
        }
        ...
        private static void CheckForInput(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self);
        ...
        public delegate void CheckForInput_WithArgs(Action<HutongGames.PlayMaker.Actions.ListenForCast> orig,
            HutongGames.PlayMaker.Actions.ListenForCast self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ListenForCast), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ListenForCast), "OnUpdate", true),
                value);
