...
public static class OnLogitechF510ControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.LogitechF510ControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.LogitechF510ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechF510ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.LogitechF510ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechF510ControllerMacNativeProfile self);
    }
