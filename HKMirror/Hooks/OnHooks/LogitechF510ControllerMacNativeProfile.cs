...
public static class OnLogitechF510ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ControllerMacNativeProfile> orig,
            LogitechF510ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ControllerMacNativeProfile> orig,
            LogitechF510ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ControllerMacNativeProfile self;
        }
    }
