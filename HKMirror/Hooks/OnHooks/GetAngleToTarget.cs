...
public static class OnGetAngleToTarget
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAngleToTarget), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAngleToTarget),
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self)
        {
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self)
        {
        ...
        internal static void HookDoGetAngleToTarget()
        {
            if (!HookedList.Contains("DoGetAngleToTarget"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAngleToTarget),
                        "DoGetAngleToTarget", true), DoGetAngleToTarget);
            }
        }
        ...
        private static void DoGetAngleToTarget(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self);
        ...
        public delegate void DoGetAngleToTarget_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAngleToTarget> orig,
            HutongGames.PlayMaker.Actions.GetAngleToTarget self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAngleToTarget), "Reset", true),
                value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAngleToTarget), "OnPreprocess",
                    true), value);
        ...
        public static event Delegates.OnLateUpdate_WithArgs OnLateUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnLateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAngleToTarget), "OnLateUpdate",
                    true), value);
