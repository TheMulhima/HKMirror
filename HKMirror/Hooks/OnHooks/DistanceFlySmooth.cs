...
public static class OnDistanceFlySmooth
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<DistanceFlySmooth> orig, DistanceFlySmooth self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<DistanceFlySmooth> orig, DistanceFlySmooth self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<DistanceFlySmooth> orig, DistanceFlySmooth self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<DistanceFlySmooth> orig, DistanceFlySmooth self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<DistanceFlySmooth> orig, DistanceFlySmooth self)
        {
        ...
        internal static void HookDoChase()
        {
            if (!HookedList.Contains("DoChase"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "DoChase"), DoChase);
            }
        }
        ...
        private static void DoChase(Action<DistanceFlySmooth> orig, DistanceFlySmooth self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<DistanceFlySmooth> orig, DistanceFlySmooth self);

        public delegate void DoChase_AfterArgs(Params_DoChase args);

        public delegate void DoChase_BeforeArgs(Params_DoChase args);

        public delegate void DoChase_WithArgs(Action<DistanceFlySmooth> orig, DistanceFlySmooth self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<DistanceFlySmooth> orig, DistanceFlySmooth self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<DistanceFlySmooth> orig, DistanceFlySmooth self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<DistanceFlySmooth> orig, DistanceFlySmooth self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<DistanceFlySmooth> orig, DistanceFlySmooth self);

        public sealed class Params_Reset
        {
            public DistanceFlySmooth self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "Awake"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "OnEnter"), value);
        ...
        public static event Delegates.DoChase_WithArgs DoChase
        {
            add => HookEndpointManager.Add<Delegates.DoChase_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFlySmooth), "DoChase"), value);
