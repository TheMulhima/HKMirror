...
public static class OnVibrationPlayer
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_VibrationData()
        {
            if (!HookedList.Contains("get_VibrationData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationData"),
                    get_VibrationData);
            }
        }

        internal static event Delegates.get_VibrationData_BeforeArgs _beforeget_VibrationData;
        internal static event Delegates.get_VibrationData_NormalArgs _afterget_VibrationData;
        ...
        private static VibrationData get_VibrationData(Func<VibrationPlayer, VibrationData> orig, VibrationPlayer self)
        {
            ...
            if (_afterget_VibrationData != null) retVal = _afterget_VibrationData.Invoke(@params);
            return retVal;
        }
        ...
        internal static void Hookset_VibrationData()
        {
            if (!HookedList.Contains("set_VibrationData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationData"),
                    set_VibrationData);
            }
        }

        internal static event Delegates.set_VibrationData_BeforeArgs _beforeset_VibrationData;
        internal static event Delegates.set_VibrationData_NormalArgs _afterset_VibrationData;

        private static void set_VibrationData(Action<VibrationPlayer, VibrationData> orig, VibrationPlayer self,
            VibrationData value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_VibrationData != null) _afterset_VibrationData.Invoke(@params);
        }
        ...
        internal static void Hookget_Target()
        {
            if (!HookedList.Contains("get_Target"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_Target"), get_Target);
            }
        }
        ...
        internal static void Hookset_Target()
        {
            if (!HookedList.Contains("set_Target"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_Target"), set_Target);
            }
        }
        ...
        private static void set_Target(Action<VibrationPlayer, VibrationTarget> orig, VibrationPlayer self,
            VibrationTarget value)
        {
        ...
        internal static void Hookget_PlayAutomatically()
        {
            if (!HookedList.Contains("get_PlayAutomatically"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_PlayAutomatically"),
                    get_PlayAutomatically);
            }
        }

        internal static event Delegates.get_PlayAutomatically_BeforeArgs _beforeget_PlayAutomatically;
        internal static event Delegates.get_PlayAutomatically_NormalArgs _afterget_PlayAutomatically;
        ...
        private static bool get_PlayAutomatically(Func<VibrationPlayer, bool> orig, VibrationPlayer self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_PlayAutomatically != null) retVal = _afterget_PlayAutomatically.Invoke(@params);
            return retVal;
        }
        ...
        internal static void Hookset_PlayAutomatically()
        {
            if (!HookedList.Contains("set_PlayAutomatically"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_PlayAutomatically"),
                    set_PlayAutomatically);
            }
        }

        internal static event Delegates.set_PlayAutomatically_BeforeArgs _beforeset_PlayAutomatically;
        internal static event Delegates.set_PlayAutomatically_NormalArgs _afterset_PlayAutomatically;
        ...
        private static void set_PlayAutomatically(Action<VibrationPlayer, bool> orig, VibrationPlayer self, bool value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_PlayAutomatically != null) _afterset_PlayAutomatically.Invoke(@params);
        }
        ...
        internal static void Hookget_IsLooping()
        {
            if (!HookedList.Contains("get_IsLooping"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_IsLooping"), get_IsLooping);
            }
        }
        ...
        internal static void Hookset_IsLooping()
        {
            if (!HookedList.Contains("set_IsLooping"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_IsLooping"), set_IsLooping);
            }
        }
        ...
        internal static void Hookget_VibrationTag()
        {
            if (!HookedList.Contains("get_VibrationTag"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationTag"), get_VibrationTag);
            }
        }

        internal static event Delegates.get_VibrationTag_BeforeArgs _beforeget_VibrationTag;
        internal static event Delegates.get_VibrationTag_NormalArgs _afterget_VibrationTag;
        ...
        private static string get_VibrationTag(Func<VibrationPlayer, string> orig, VibrationPlayer self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_VibrationTag != null) retVal = _afterget_VibrationTag.Invoke(@params);
            return retVal;
        }
        ...
        internal static void Hookset_VibrationTag()
        {
            if (!HookedList.Contains("set_VibrationTag"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationTag"), set_VibrationTag);
            }
        }

        internal static event Delegates.set_VibrationTag_BeforeArgs _beforeset_VibrationTag;
        internal static event Delegates.set_VibrationTag_NormalArgs _afterset_VibrationTag;
        ...
        private static void set_VibrationTag(Action<VibrationPlayer, string> orig, VibrationPlayer self, string value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_VibrationTag != null) _afterset_VibrationTag.Invoke(@params);
        }
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_PlayAutomatically_NormalArgs(Params_get_PlayAutomatically args);
        ...
        public delegate VibrationData get_VibrationData_NormalArgs(Params_get_VibrationData args);

        public delegate void get_VibrationTag_BeforeArgs(Params_get_VibrationTag args);

        public delegate string get_VibrationTag_NormalArgs(Params_get_VibrationTag args);
        ...
        public delegate void set_PlayAutomatically_NormalArgs(Params_set_PlayAutomatically args);
        ...
        public delegate void set_VibrationData_NormalArgs(Params_set_VibrationData args);

        public delegate void set_VibrationTag_BeforeArgs(Params_set_VibrationTag args);

        public delegate void set_VibrationTag_NormalArgs(Params_set_VibrationTag args);
    ...
    {
        public static event Delegates.get_VibrationData_NormalArgs get_VibrationData
        {
            add
            {
        ...
        public static event Delegates.set_VibrationData_NormalArgs set_VibrationData
        {
            add
            {
        ...
        public static event Delegates.get_PlayAutomatically_NormalArgs get_PlayAutomatically
        {
            add
            {
        ...
        public static event Delegates.set_PlayAutomatically_NormalArgs set_PlayAutomatically
        {
            add
            {
        ...
        public static event Delegates.get_VibrationTag_NormalArgs get_VibrationTag
        {
            add
            {
        ...
        public static event Delegates.set_VibrationTag_NormalArgs set_VibrationTag
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_VibrationData_NormalArgs get_VibrationData
        {
            add => HookEndpointManager.Add<Delegates.get_VibrationData_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationData"), value);
            remove => HookEndpointManager.Remove<Delegates.get_VibrationData_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationData"), value);
        }

        public static event Delegates.set_VibrationData_NormalArgs set_VibrationData
        {
            add => HookEndpointManager.Add<Delegates.set_VibrationData_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationData"), value);
            remove => HookEndpointManager.Remove<Delegates.set_VibrationData_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationData"), value);
        }
        ...
        public static event Delegates.get_Target_NormalArgs get_Target
        {
            add => HookEndpointManager.Add<Delegates.get_Target_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_Target"), value);
        ...
        public static event Delegates.set_Target_NormalArgs set_Target
        {
            add => HookEndpointManager.Add<Delegates.set_Target_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_Target"), value);
        ...
        public static event Delegates.get_PlayAutomatically_NormalArgs get_PlayAutomatically
        {
            add => HookEndpointManager.Add<Delegates.get_PlayAutomatically_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_PlayAutomatically"), value);
            remove => HookEndpointManager.Remove<Delegates.get_PlayAutomatically_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_PlayAutomatically"), value);
        }

        public static event Delegates.set_PlayAutomatically_NormalArgs set_PlayAutomatically
        {
            add => HookEndpointManager.Add<Delegates.set_PlayAutomatically_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_PlayAutomatically"), value);
            remove => HookEndpointManager.Remove<Delegates.set_PlayAutomatically_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_PlayAutomatically"), value);
        }
        ...
        public static event Delegates.get_IsLooping_NormalArgs get_IsLooping
        {
            add => HookEndpointManager.Add<Delegates.get_IsLooping_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_IsLooping"), value);
        ...
        public static event Delegates.set_IsLooping_NormalArgs set_IsLooping
        {
            add => HookEndpointManager.Add<Delegates.set_IsLooping_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_IsLooping"), value);
        ...
        public static event Delegates.get_VibrationTag_NormalArgs get_VibrationTag
        {
            add => HookEndpointManager.Add<Delegates.get_VibrationTag_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationTag"), value);
            remove => HookEndpointManager.Remove<Delegates.get_VibrationTag_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationTag"), value);
        }

        public static event Delegates.set_VibrationTag_NormalArgs set_VibrationTag
        {
            add => HookEndpointManager.Add<Delegates.set_VibrationTag_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationTag"), value);
            remove => HookEndpointManager.Remove<Delegates.set_VibrationTag_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationTag"), value);
        }
