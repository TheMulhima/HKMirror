...
public static class OnVibrationPlayer
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_VibrationData()
        {
            if (!HookedList.Contains("get_VibrationData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationData", true),
                    get_VibrationData);
            }
        }
        ...
        private static VibrationData get_VibrationData(Func<VibrationPlayer, VibrationData> orig, VibrationPlayer self)
        {
            ...
            {
                foreach (Delegates.get_VibrationData_BeforeArgs toInvoke in
                         _beforeget_VibrationData.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_VibrationData()
        {
            if (!HookedList.Contains("set_VibrationData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationData", true),
                    set_VibrationData);
            }
        }
            ...
            VibrationData value)
        {
            ...
            {
                foreach (Delegates.set_VibrationData_BeforeArgs toInvoke in
                         _beforeset_VibrationData.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_PlayAutomatically()
        {
            if (!HookedList.Contains("get_PlayAutomatically"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_PlayAutomatically", true),
        ...
        private static bool get_PlayAutomatically(Func<VibrationPlayer, bool> orig, VibrationPlayer self)
        {
            ...
            {
                foreach (Delegates.get_PlayAutomatically_BeforeArgs toInvoke in _beforeget_PlayAutomatically
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_PlayAutomatically_AfterArgs toInvoke in _afterget_PlayAutomatically
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_PlayAutomatically()
        {
            if (!HookedList.Contains("set_PlayAutomatically"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_PlayAutomatically", true),
        ...
        private static void set_PlayAutomatically(Action<VibrationPlayer, bool> orig, VibrationPlayer self, bool value)
        {
            ...
            {
                foreach (Delegates.set_PlayAutomatically_BeforeArgs toInvoke in _beforeset_PlayAutomatically
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_PlayAutomatically_AfterArgs toInvoke in _afterset_PlayAutomatically
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_VibrationTag()
        {
            if (!HookedList.Contains("get_VibrationTag"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationTag", true),
                    get_VibrationTag);
            }
        }
        ...
        internal static void Hookset_VibrationTag()
        {
            if (!HookedList.Contains("set_VibrationTag"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationTag", true),
                    set_VibrationTag);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate VibrationData get_VibrationData_WithArgs(Func<VibrationPlayer, VibrationData> orig,
            VibrationPlayer self);
        ...
        public delegate void set_VibrationData_WithArgs(Action<VibrationPlayer, VibrationData> orig,
            VibrationPlayer self, VibrationData value);
        ...
        public delegate VibrationTarget get_Target_WithArgs(Func<VibrationPlayer, VibrationTarget> orig,
            VibrationPlayer self);
        ...
        public delegate void set_Target_WithArgs(Action<VibrationPlayer, VibrationTarget> orig, VibrationPlayer self,
            VibrationTarget value);
        ...
        public delegate void set_PlayAutomatically_WithArgs(Action<VibrationPlayer, bool> orig, VibrationPlayer self,
            bool value);
        ...
        public delegate void set_IsLooping_WithArgs(Action<VibrationPlayer, bool> orig, VibrationPlayer self,
            bool value);
        ...
        public delegate void set_VibrationTag_WithArgs(Action<VibrationPlayer, string> orig, VibrationPlayer self,
            string value);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_VibrationData_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationData", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_VibrationData_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationData", true), value);
        }

        public static event Delegates.set_VibrationData_WithArgs set_VibrationData
        {
            add => HookEndpointManager.Add<Delegates.set_VibrationData_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationData", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_VibrationData_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationData", true), value);
        }
        ...
        public static event Delegates.get_Target_WithArgs get_Target
        {
            add => HookEndpointManager.Add<Delegates.get_Target_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_Target", true), value);
        ...
        public static event Delegates.set_Target_WithArgs set_Target
        {
            add => HookEndpointManager.Add<Delegates.set_Target_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_Target", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_PlayAutomatically_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_PlayAutomatically", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_PlayAutomatically_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_PlayAutomatically", true), value);
        }

        public static event Delegates.set_PlayAutomatically_WithArgs set_PlayAutomatically
        {
            add => HookEndpointManager.Add<Delegates.set_PlayAutomatically_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_PlayAutomatically", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_PlayAutomatically_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_PlayAutomatically", true), value);
        }
        ...
        public static event Delegates.get_IsLooping_WithArgs get_IsLooping
        {
            add => HookEndpointManager.Add<Delegates.get_IsLooping_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_IsLooping", true), value);
        ...
        public static event Delegates.set_IsLooping_WithArgs set_IsLooping
        {
            add => HookEndpointManager.Add<Delegates.set_IsLooping_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_IsLooping", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_VibrationTag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationTag", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_VibrationTag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "get_VibrationTag", true), value);
        }

        public static event Delegates.set_VibrationTag_WithArgs set_VibrationTag
        {
            add => HookEndpointManager.Add<Delegates.set_VibrationTag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationTag", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_VibrationTag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(VibrationPlayer), "set_VibrationTag", true), value);
        }
