...
public static class OnEightBitdoSFC30WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSFC30WindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSFC30WindowsNativeProfile> orig,
            EightBitdoSFC30WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSFC30WindowsNativeProfile> orig,
            EightBitdoSFC30WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSFC30WindowsNativeProfile self;
        }
    }
