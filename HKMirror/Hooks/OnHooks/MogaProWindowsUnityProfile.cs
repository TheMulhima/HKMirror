...
public static class OnMogaProWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MogaProWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MogaProWindowsUnityProfile> orig, MogaProWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MogaProWindowsUnityProfile> orig, MogaProWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public MogaProWindowsUnityProfile self;
        }
    }
