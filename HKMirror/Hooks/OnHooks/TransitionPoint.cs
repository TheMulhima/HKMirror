...
public static class OnTransitionPoint
{
    internal static class HookHandler
    {
        ...
        private static System.Collections.Generic.List<TransitionPoint> get_TransitionPoints(
            Func<System.Collections.Generic.List<TransitionPoint>> orig)
        {
            if (_beforeget_TransitionPoints != null)
            {
                foreach (Delegates.get_TransitionPoints_BeforeArgs toInvoke in _beforeget_TransitionPoints
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_TransitionPoints_AfterArgs toInvoke in _afterget_TransitionPoints
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void OnTriggerEnter2D(On.TransitionPoint.orig_OnTriggerEnter2D orig, TransitionPoint self,
            UnityEngine.Collider2D movingObj)
        {
        ...
        private static GlobalEnums.GatePosition GetGatePosition(On.TransitionPoint.orig_GetGatePosition orig,
    ...
    public static class Delegates
    {
        ...
        public delegate System.Collections.Generic.List<TransitionPoint> get_TransitionPoints_AfterArgs(
            System.Collections.Generic.List<TransitionPoint> ret);

        public delegate System.Collections.Generic.List<TransitionPoint> get_TransitionPoints_WithArgs(
            Func<System.Collections.Generic.List<TransitionPoint>> orig);
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<TransitionPoint, UnityEngine.Collider2D> orig,
            TransitionPoint self, UnityEngine.Collider2D movingObj);
        ...
        public delegate void OnTriggerStay2D_WithArgs(Action<TransitionPoint, UnityEngine.Collider2D> orig,
            TransitionPoint self, UnityEngine.Collider2D movingObj);
        ...
        public delegate GlobalEnums.GatePosition GetGatePosition_AfterArgs(Params_GetGatePosition args,
            GlobalEnums.GatePosition ret);

        public delegate GlobalEnums.GatePosition GetGatePosition_WithArgs(
            Func<TransitionPoint, GlobalEnums.GatePosition> orig, TransitionPoint self);
        ...
        public delegate void SetTargetScene_WithArgs(Action<TransitionPoint, string> orig, TransitionPoint self,
            string newScene);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_TransitionPoints_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TransitionPoint), "get_TransitionPoints", false), value);
            remove => HookEndpointManager.Remove<Delegates.get_TransitionPoints_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TransitionPoint), "get_TransitionPoints", false), value);
        }
