...
public static class OnTransitionPoint
{
    ...
    public static class Delegates
    {
        ...
        public delegate List<TransitionPoint> get_TransitionPoints_AfterArgs(List<TransitionPoint> ret);

        public delegate void get_TransitionPoints_BeforeArgs();

        public delegate List<TransitionPoint> get_TransitionPoints_WithArgs(Func<List<TransitionPoint>> orig);

        public delegate GatePosition GetGatePosition_AfterArgs(Params_GetGatePosition args, GatePosition ret);

        public delegate void GetGatePosition_BeforeArgs(Params_GetGatePosition args);

        public delegate GatePosition GetGatePosition_WithArgs(Func<TransitionPoint, GatePosition> orig,
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<TransitionPoint, Collider2D> orig, TransitionPoint self,
            Collider2D movingObj);
        ...
        public delegate void OnTriggerStay2D_WithArgs(Action<TransitionPoint, Collider2D> orig, TransitionPoint self,
            Collider2D movingObj);
