...
private static string GetPlayerDataBoolName(On.JournalList.orig_GetPlayerDataBoolName orig,JournalList self,  int itemNum)
{
...
private static string GetPlayerDataKillsName(On.JournalList.orig_GetPlayerDataKillsName orig,JournalList self,  int itemNum)
{
...
private static string GetPlayerDataNewDataName(On.JournalList.orig_GetPlayerDataNewDataName orig,JournalList self,  int itemNum)
{
...
public delegate string GetNameConvo_WithArgs (Func<JournalList,  int, string> orig, JournalList self,  int itemNum);
...
public delegate string GetDescConvo_WithArgs (Func<JournalList,  int, string> orig, JournalList self,  int itemNum);
...
public delegate string GetNotesConvo_WithArgs (Func<JournalList,  int, string> orig, JournalList self,  int itemNum);
...
public delegate string GetPlayerDataBoolName_WithArgs (Func<JournalList,  int, string> orig, JournalList self,  int itemNum);
...
public delegate string GetPlayerDataKillsName_WithArgs (Func<JournalList,  int, string> orig, JournalList self,  int itemNum);
...
public delegate string GetPlayerDataNewDataName_WithArgs (Func<JournalList,  int, string> orig, JournalList self,  int itemNum);
...
public delegate UnityEngine.Sprite GetSprite_WithArgs (Func<JournalList,  int, UnityEngine.Sprite> orig, JournalList self,  int itemNum);
