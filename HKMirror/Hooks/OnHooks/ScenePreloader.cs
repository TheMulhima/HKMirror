...
private static System.Collections.IEnumerator LoadRoutine(On.ScenePreloader.orig_LoadRoutine orig,ScenePreloader self)
{
...
private static System.Collections.IEnumerator FinishPendingOperations(On.ScenePreloader.orig_FinishPendingOperations orig)
{
if (_beforeFinishPendingOperations != null)
{
foreach (Delegates.FinishPendingOperations_BeforeArgs toInvoke in _beforeFinishPendingOperations.GetInvocationList())
{
try
{
...
public delegate System.Collections.IEnumerator LoadRoutine_WithArgs (Func<ScenePreloader, System.Collections.IEnumerator> orig, ScenePreloader self);
public delegate void FinishPendingOperations_BeforeArgs();
public delegate System.Collections.IEnumerator FinishPendingOperations_AfterArgs(System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FinishPendingOperations_WithArgs (Func<System.Collections.IEnumerator> orig);
