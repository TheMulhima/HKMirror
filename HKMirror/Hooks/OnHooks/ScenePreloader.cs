...
public static class OnScenePreloader
{
    internal static class HookHandler
    {
        ...
        private static IEnumerator LoadRoutine(On.ScenePreloader.orig_LoadRoutine orig, ScenePreloader self)
        {
        ...
        private static IEnumerator FinishPendingOperations(On.ScenePreloader.orig_FinishPendingOperations orig)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator FinishPendingOperations_AfterArgs(IEnumerator ret);

        public delegate void FinishPendingOperations_BeforeArgs();

        public delegate IEnumerator FinishPendingOperations_WithArgs(Func<IEnumerator> orig);
        ...
        public delegate IEnumerator LoadRoutine_WithArgs(Func<ScenePreloader, IEnumerator> orig, ScenePreloader self);
