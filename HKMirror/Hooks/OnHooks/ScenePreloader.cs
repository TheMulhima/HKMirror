...
public static class OnScenePreloader
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.Cleanup_NormalArgs _afterCleanup;

        private static void Cleanup(On.ScenePreloader.orig_Cleanup orig)
        {
            _beforeCleanup?.Invoke();
            orig();
            if (_afterCleanup != null) _afterCleanup.Invoke();
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void Cleanup_NormalArgs();

        public delegate void FinishPendingOperations_BeforeArgs();

        public delegate IEnumerator FinishPendingOperations_NormalArgs();
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.Cleanup_NormalArgs Cleanup
        {
            add
            {
