...
public static class OnControllerDetect
{
    internal static class HookHandler
    {
        ...
        private static void ControllerActivated(On.ControllerDetect.orig_ControllerActivated orig,
            ControllerDetect self, InControl.InputDevice inputDevice)
        {
            ...
            ControllerDetect self)
        {
            ...
            {
                foreach (Delegates.LookForActiveController_BeforeArgs toInvoke in _beforeLookForActiveController
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.LookForActiveController_AfterArgs toInvoke in _afterLookForActiveController
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void ControllerActivated_WithArgs(Action<ControllerDetect, InControl.InputDevice> orig,
            ControllerDetect self, InControl.InputDevice inputDevice);
        ...
        public delegate void ControllerAttached_WithArgs(Action<ControllerDetect, InControl.InputDevice> orig,
            ControllerDetect self, InControl.InputDevice inputDevice);
        ...
        public delegate void ControllerDetached_WithArgs(Action<ControllerDetect, InControl.InputDevice> orig,
            ControllerDetect self, InControl.InputDevice inputDevice);
        ...
        public delegate void ShowController_WithArgs(Action<ControllerDetect, GlobalEnums.GamepadType> orig,
            ControllerDetect self, GlobalEnums.GamepadType gamepadType);
