...
private static void OnTriggerEnter2D(On.PushableRubble.orig_OnTriggerEnter2D orig,PushableRubble self,  UnityEngine.Collider2D collider)
{
...
private static void EndRubbleContinuation(On.PushableRubble.orig_EndRubbleContinuation orig,PushableRubble self)
{
...
{
foreach (Delegates.EndRubbleContinuation_BeforeArgs toInvoke in _beforeEndRubbleContinuation.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EndRubbleContinuation_AfterArgs toInvoke in _afterEndRubbleContinuation.GetInvocationList())
{
try
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<PushableRubble,  UnityEngine.Collider2D> orig, PushableRubble self,  UnityEngine.Collider2D collider);
