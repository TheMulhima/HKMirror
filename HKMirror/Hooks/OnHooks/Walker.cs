...
{
foreach (Delegates.BeginWaitingForConditions_BeforeArgs toInvoke in _beforeBeginWaitingForConditions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.BeginWaitingForConditions_AfterArgs toInvoke in _afterBeginWaitingForConditions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateWaitingForConditions_BeforeArgs toInvoke in _beforeUpdateWaitingForConditions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateWaitingForConditions_AfterArgs toInvoke in _afterUpdateWaitingForConditions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.BeginWalkingOrTurning_BeforeArgs toInvoke in _beforeBeginWalkingOrTurning.GetInvocationList())
{
try
{
...
{
foreach (Delegates.BeginWalkingOrTurning_AfterArgs toInvoke in _afterBeginWalkingOrTurning.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearTurnCooldown_BeforeArgs toInvoke in _beforeClearTurnCooldown.GetInvocationList())
{
try
{
...
public delegate void Stop_WithArgs (Action<Walker,  Walker.StopReasons> orig, Walker self,  Walker.StopReasons reason);
...
public delegate void BeginStopped_WithArgs (Action<Walker,  Walker.StopReasons> orig, Walker self,  Walker.StopReasons reason);
