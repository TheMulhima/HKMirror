...
public static class OnIonDrumRockerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IonDrumRockerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<IonDrumRockerMacNativeProfile> orig, IonDrumRockerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<IonDrumRockerMacNativeProfile> orig,
            IonDrumRockerMacNativeProfile self);

        public sealed class Params_Define
        {
            public IonDrumRockerMacNativeProfile self;
        }
    }
