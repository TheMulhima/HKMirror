...
private static void OnEnable(On.PerBuildTypeOnEnableResponse.orig_OnEnable orig,PerBuildTypeOnEnableResponse self)
{
...
private static void DoEvent(On.PerBuildTypeOnEnableResponse.orig_DoEvent orig,PerBuildTypeOnEnableResponse self,  bool value)
{
...
public delegate void OnEnable_WithArgs (Action<PerBuildTypeOnEnableResponse> orig, PerBuildTypeOnEnableResponse self);
...
public delegate void DoEvent_WithArgs (Action<PerBuildTypeOnEnableResponse,  bool> orig, PerBuildTypeOnEnableResponse self,  bool value);
}
