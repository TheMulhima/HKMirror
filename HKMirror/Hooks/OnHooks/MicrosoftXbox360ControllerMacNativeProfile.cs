...
public static class OnMicrosoftXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MicrosoftXbox360ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MicrosoftXbox360ControllerMacNativeProfile> orig,
            MicrosoftXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MicrosoftXbox360ControllerMacNativeProfile> orig,
            MicrosoftXbox360ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MicrosoftXbox360ControllerMacNativeProfile self;
        }
    }
