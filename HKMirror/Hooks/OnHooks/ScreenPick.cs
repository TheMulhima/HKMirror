...
public static class OnScreenPick
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self)
        {
        ...
        internal static void HookDoScreenPick()
        {
            if (!HookedList.Contains("DoScreenPick"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick), "DoScreenPick",
                        true), DoScreenPick);
            }
        }
        ...
        private static void DoScreenPick(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self);
        ...
        public delegate void DoScreenPick_WithArgs(Action<HutongGames.PlayMaker.Actions.ScreenPick> orig,
            HutongGames.PlayMaker.Actions.ScreenPick self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick), "Reset", true), value);
        ...
        public static event Delegates.DoScreenPick_WithArgs DoScreenPick
        {
            add => HookEndpointManager.Add<Delegates.DoScreenPick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ScreenPick), "DoScreenPick", true),
                value);
