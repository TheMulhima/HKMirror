...
public static class OnScreenPick
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<ScreenPick> orig, ScreenPick self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<ScreenPick> orig, ScreenPick self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<ScreenPick> orig, ScreenPick self)
        {
        ...
        internal static void HookDoScreenPick()
        {
            if (!HookedList.Contains("DoScreenPick"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "DoScreenPick"), DoScreenPick);
            }
        }
        ...
        private static void DoScreenPick(Action<ScreenPick> orig, ScreenPick self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoScreenPick_WithArgs(Action<ScreenPick> orig, ScreenPick self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<ScreenPick> orig, ScreenPick self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<ScreenPick> orig, ScreenPick self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<ScreenPick> orig, ScreenPick self);

        public sealed class Params_Reset
        {
            public ScreenPick self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "OnUpdate"), value);
        ...
        public static event Delegates.DoScreenPick_WithArgs DoScreenPick
        {
            add => HookEndpointManager.Add<Delegates.DoScreenPick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ScreenPick), "DoScreenPick"), value);
