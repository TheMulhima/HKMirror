...
public static class OnTMP_InputField
{
    internal static class HookHandler
    {
        ...
        private static UnityEngine.Mesh get_mesh(Func<TMPro.TMP_InputField, UnityEngine.Mesh> orig,
            TMPro.TMP_InputField self)
        {
        ...
        internal static void Hookset_shouldHideMobileInput()
        {
            if (!HookedList.Contains("set_shouldHideMobileInput"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_shouldHideMobileInput", true),
        ...
        private static void set_shouldHideMobileInput(Action<TMPro.TMP_InputField, bool> orig,
            TMPro.TMP_InputField self, bool value)
        {
            ...
            {
                foreach (Delegates.set_shouldHideMobileInput_BeforeArgs toInvoke in _beforeset_shouldHideMobileInput
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_shouldHideMobileInput_AfterArgs toInvoke in _afterset_shouldHideMobileInput
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_shouldHideMobileInput()
        {
            if (!HookedList.Contains("get_shouldHideMobileInput"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_shouldHideMobileInput", true),
        ...
        private static bool get_shouldHideMobileInput(Func<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_shouldHideMobileInput_BeforeArgs toInvoke in _beforeget_shouldHideMobileInput
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_shouldHideMobileInput_AfterArgs toInvoke in _afterget_shouldHideMobileInput
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_isFocused()
        {
            if (!HookedList.Contains("get_isFocused"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_isFocused", true),
                    get_isFocused);
            }
        }
        ...
        internal static void Hookget_caretBlinkRate()
        {
            if (!HookedList.Contains("get_caretBlinkRate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretBlinkRate", true),
                    get_caretBlinkRate);
            }
        }
        ...
        private static float get_caretBlinkRate(Func<TMPro.TMP_InputField, float> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_caretBlinkRate_BeforeArgs toInvoke in
                         _beforeget_caretBlinkRate.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_caretBlinkRate_AfterArgs toInvoke in
                         _afterget_caretBlinkRate.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_caretBlinkRate()
        {
            if (!HookedList.Contains("set_caretBlinkRate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretBlinkRate", true),
                    set_caretBlinkRate);
            }
        }
        ...
        private static void set_caretBlinkRate(Action<TMPro.TMP_InputField, float> orig, TMPro.TMP_InputField self,
            float value)
        {
            ...
            {
                foreach (Delegates.set_caretBlinkRate_BeforeArgs toInvoke in
                         _beforeset_caretBlinkRate.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_caretBlinkRate_AfterArgs toInvoke in
                         _afterset_caretBlinkRate.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_caretWidth()
        {
            if (!HookedList.Contains("get_caretWidth"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretWidth", true),
                    get_caretWidth);
            }
        }
        ...
        internal static void Hookset_caretWidth()
        {
            if (!HookedList.Contains("set_caretWidth"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretWidth", true),
                    set_caretWidth);
            }
        }
        ...
        internal static void Hookget_textViewport()
        {
            if (!HookedList.Contains("get_textViewport"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_textViewport", true),
                    get_textViewport);
            }
        }
        ...
        private static UnityEngine.RectTransform get_textViewport(
            Func<TMPro.TMP_InputField, UnityEngine.RectTransform> orig, TMPro.TMP_InputField self)
        {
        ...
        internal static void Hookset_textViewport()
        {
            if (!HookedList.Contains("set_textViewport"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_textViewport", true),
                    set_textViewport);
            }
        }
        ...
        private static void set_textViewport(Action<TMPro.TMP_InputField, UnityEngine.RectTransform> orig,
            TMPro.TMP_InputField self, UnityEngine.RectTransform value)
        {
        ...
        internal static void Hookget_textComponent()
        {
            if (!HookedList.Contains("get_textComponent"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_textComponent", true),
                    get_textComponent);
            }
        }
        ...
        private static TMPro.TMP_Text get_textComponent(Func<TMPro.TMP_InputField, TMPro.TMP_Text> orig,
            TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_textComponent_BeforeArgs toInvoke in
                         _beforeget_textComponent.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_textComponent()
        {
            if (!HookedList.Contains("set_textComponent"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_textComponent", true),
                    set_textComponent);
            }
        }
        ...
        private static void set_textComponent(Action<TMPro.TMP_InputField, TMPro.TMP_Text> orig,
            TMPro.TMP_InputField self, TMPro.TMP_Text value)
        {
            ...
            {
                foreach (Delegates.set_textComponent_BeforeArgs toInvoke in
                         _beforeset_textComponent.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_placeholder()
        {
            if (!HookedList.Contains("get_placeholder"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_placeholder", true),
                    get_placeholder);
            }
        }
        ...
        private static UnityEngine.UI.Graphic get_placeholder(Func<TMPro.TMP_InputField, UnityEngine.UI.Graphic> orig,
            TMPro.TMP_InputField self)
        {
        ...
        internal static void Hookset_placeholder()
        {
            if (!HookedList.Contains("set_placeholder"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_placeholder", true),
                    set_placeholder);
            }
        }
        ...
        private static void set_placeholder(Action<TMPro.TMP_InputField, UnityEngine.UI.Graphic> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.Graphic value)
        {
        ...
        internal static void Hookget_caretColor()
        {
            if (!HookedList.Contains("get_caretColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretColor", true),
                    get_caretColor);
            }
        }
        ...
        private static UnityEngine.Color get_caretColor(Func<TMPro.TMP_InputField, UnityEngine.Color> orig,
            TMPro.TMP_InputField self)
        {
        ...
        internal static void Hookset_caretColor()
        {
            if (!HookedList.Contains("set_caretColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretColor", true),
                    set_caretColor);
            }
        }
        ...
        private static void set_caretColor(Action<TMPro.TMP_InputField, UnityEngine.Color> orig,
            TMPro.TMP_InputField self, UnityEngine.Color value)
        {
        ...
        internal static void Hookget_customCaretColor()
        {
            if (!HookedList.Contains("get_customCaretColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_customCaretColor", true),
        ...
        private static bool get_customCaretColor(Func<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_customCaretColor_BeforeArgs toInvoke in _beforeget_customCaretColor
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_customCaretColor_AfterArgs toInvoke in _afterget_customCaretColor
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_customCaretColor()
        {
            if (!HookedList.Contains("set_customCaretColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_customCaretColor", true),
        ...
        private static void set_customCaretColor(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool value)
        {
            ...
            {
                foreach (Delegates.set_customCaretColor_BeforeArgs toInvoke in _beforeset_customCaretColor
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_customCaretColor_AfterArgs toInvoke in _afterset_customCaretColor
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_selectionColor()
        {
            if (!HookedList.Contains("get_selectionColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionColor", true),
                    get_selectionColor);
            }
        }
        ...
        private static UnityEngine.Color get_selectionColor(Func<TMPro.TMP_InputField, UnityEngine.Color> orig,
            TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_selectionColor_BeforeArgs toInvoke in
                         _beforeget_selectionColor.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_selectionColor_AfterArgs toInvoke in
                         _afterget_selectionColor.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_selectionColor()
        {
            if (!HookedList.Contains("set_selectionColor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionColor", true),
                    set_selectionColor);
            }
        }
        ...
        private static void set_selectionColor(Action<TMPro.TMP_InputField, UnityEngine.Color> orig,
            TMPro.TMP_InputField self, UnityEngine.Color value)
        {
            ...
            {
                foreach (Delegates.set_selectionColor_BeforeArgs toInvoke in
                         _beforeset_selectionColor.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_selectionColor_AfterArgs toInvoke in
                         _afterset_selectionColor.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_onEndEdit()
        {
            if (!HookedList.Contains("set_onEndEdit"))
            {
                HookedList.Add("set_onEndEdit");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onEndEdit", true),
                    set_onEndEdit);
            }
        }

        internal static event Delegates.set_onEndEdit_BeforeArgs _beforeset_onEndEdit;
        internal static event Delegates.set_onEndEdit_AfterArgs _afterset_onEndEdit;

        private static void set_onEndEdit(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.SubmitEvent> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.SubmitEvent value)
        {
            Delegates.Params_set_onEndEdit @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_onEndEdit != null)
            {
                foreach (Delegates.set_onEndEdit_BeforeArgs toInvoke in _beforeset_onEndEdit.GetInvocationList())
                {
                    try
                    {
                        _beforeset_onEndEdit?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_onEndEdit != null)
            {
                foreach (Delegates.set_onEndEdit_AfterArgs toInvoke in _afterset_onEndEdit.GetInvocationList())
                {
                    try
                    {
                        _afterset_onEndEdit.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookset_onSubmit()
        {
            if (!HookedList.Contains("set_onSubmit"))
            {
                HookedList.Add("set_onSubmit");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onSubmit", true),
                    set_onSubmit);
            }
        }

        internal static event Delegates.set_onSubmit_BeforeArgs _beforeset_onSubmit;
        internal static event Delegates.set_onSubmit_AfterArgs _afterset_onSubmit;

        private static void set_onSubmit(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.SubmitEvent> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.SubmitEvent value)
        {
            Delegates.Params_set_onSubmit @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_onSubmit != null)
            {
                foreach (Delegates.set_onSubmit_BeforeArgs toInvoke in _beforeset_onSubmit.GetInvocationList())
                {
                    try
                    {
                        _beforeset_onSubmit?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_onSubmit != null)
            {
                foreach (Delegates.set_onSubmit_AfterArgs toInvoke in _afterset_onSubmit.GetInvocationList())
                {
                    try
                    {
                        _afterset_onSubmit.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookset_onFocusLost()
        {
            if (!HookedList.Contains("set_onFocusLost"))
            {
                HookedList.Add("set_onFocusLost");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onFocusLost", true),
                    set_onFocusLost);
            }
        }

        internal static event Delegates.set_onFocusLost_BeforeArgs _beforeset_onFocusLost;
        internal static event Delegates.set_onFocusLost_AfterArgs _afterset_onFocusLost;

        private static void set_onFocusLost(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.SubmitEvent> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.SubmitEvent value)
        {
            Delegates.Params_set_onFocusLost @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_onFocusLost != null)
            {
                foreach (Delegates.set_onFocusLost_BeforeArgs toInvoke in _beforeset_onFocusLost.GetInvocationList())
                {
                    try
                    {
                        _beforeset_onFocusLost?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_onFocusLost != null)
            {
                foreach (Delegates.set_onFocusLost_AfterArgs toInvoke in _afterset_onFocusLost.GetInvocationList())
                {
                    try
                    {
                        _afterset_onFocusLost.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookset_onValueChanged()
        {
            if (!HookedList.Contains("set_onValueChanged"))
            {
                HookedList.Add("set_onValueChanged");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onValueChanged", true),
                    set_onValueChanged);
            }
        }

        internal static event Delegates.set_onValueChanged_BeforeArgs _beforeset_onValueChanged;
        internal static event Delegates.set_onValueChanged_AfterArgs _afterset_onValueChanged;

        private static void set_onValueChanged(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.OnChangeEvent> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.OnChangeEvent value)
        {
            Delegates.Params_set_onValueChanged @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_onValueChanged != null)
            {
                foreach (Delegates.set_onValueChanged_BeforeArgs toInvoke in
                         _beforeset_onValueChanged.GetInvocationList())
                {
                    try
                    {
                        _beforeset_onValueChanged?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_onValueChanged != null)
            {
                foreach (Delegates.set_onValueChanged_AfterArgs toInvoke in
                         _afterset_onValueChanged.GetInvocationList())
                {
                    try
                    {
                        _afterset_onValueChanged.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookset_onValidateInput()
        {
            if (!HookedList.Contains("set_onValidateInput"))
            {
                HookedList.Add("set_onValidateInput");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onValidateInput", true),
                    set_onValidateInput);
            }
        }

        internal static event Delegates.set_onValidateInput_BeforeArgs _beforeset_onValidateInput;
        internal static event Delegates.set_onValidateInput_AfterArgs _afterset_onValidateInput;

        private static void set_onValidateInput(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.OnValidateInput> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.OnValidateInput value)
        {
            Delegates.Params_set_onValidateInput @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_onValidateInput != null)
            {
                foreach (Delegates.set_onValidateInput_BeforeArgs toInvoke in _beforeset_onValidateInput
                             .GetInvocationList())
                {
                    try
                    {
                        _beforeset_onValidateInput?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_onValidateInput != null)
            {
                foreach (Delegates.set_onValidateInput_AfterArgs toInvoke in
                         _afterset_onValidateInput.GetInvocationList())
                {
                    try
                    {
                        _afterset_onValidateInput.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookget_characterLimit()
        {
            if (!HookedList.Contains("get_characterLimit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_characterLimit", true),
                    get_characterLimit);
            }
        }
        ...
        private static int get_characterLimit(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_characterLimit_BeforeArgs toInvoke in
                         _beforeget_characterLimit.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_characterLimit_AfterArgs toInvoke in
                         _afterget_characterLimit.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_characterLimit()
        {
            if (!HookedList.Contains("set_characterLimit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_characterLimit", true),
                    set_characterLimit);
            }
        }
        ...
        private static void set_characterLimit(Action<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self,
            int value)
        {
            ...
            {
                foreach (Delegates.set_characterLimit_BeforeArgs toInvoke in
                         _beforeset_characterLimit.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_characterLimit_AfterArgs toInvoke in
                         _afterset_characterLimit.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_contentType()
        {
            if (!HookedList.Contains("set_contentType"))
            {
                HookedList.Add("set_contentType");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_contentType", true),
                    set_contentType);
            }
        }

        internal static event Delegates.set_contentType_BeforeArgs _beforeset_contentType;
        internal static event Delegates.set_contentType_AfterArgs _afterset_contentType;

        private static void set_contentType(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.ContentType> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.ContentType value)
        {
            Delegates.Params_set_contentType @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_contentType != null)
            {
                foreach (Delegates.set_contentType_BeforeArgs toInvoke in _beforeset_contentType.GetInvocationList())
                {
                    try
                    {
                        _beforeset_contentType?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_contentType != null)
            {
                foreach (Delegates.set_contentType_AfterArgs toInvoke in _afterset_contentType.GetInvocationList())
                {
                    try
                    {
                        _afterset_contentType.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookset_lineType()
        {
            if (!HookedList.Contains("set_lineType"))
            {
                HookedList.Add("set_lineType");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_lineType", true),
                    set_lineType);
            }
        }

        internal static event Delegates.set_lineType_BeforeArgs _beforeset_lineType;
        internal static event Delegates.set_lineType_AfterArgs _afterset_lineType;

        private static void set_lineType(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.LineType> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.LineType value)
        {
            Delegates.Params_set_lineType @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_lineType != null)
            {
                foreach (Delegates.set_lineType_BeforeArgs toInvoke in _beforeset_lineType.GetInvocationList())
                {
                    try
                    {
                        _beforeset_lineType?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_lineType != null)
            {
                foreach (Delegates.set_lineType_AfterArgs toInvoke in _afterset_lineType.GetInvocationList())
                {
                    try
                    {
                        _afterset_lineType.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookset_inputType()
        {
            if (!HookedList.Contains("set_inputType"))
            {
                HookedList.Add("set_inputType");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_inputType", true),
                    set_inputType);
            }
        }

        internal static event Delegates.set_inputType_BeforeArgs _beforeset_inputType;
        internal static event Delegates.set_inputType_AfterArgs _afterset_inputType;

        private static void set_inputType(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.InputType> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.InputType value)
        {
            Delegates.Params_set_inputType @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_inputType != null)
            {
                foreach (Delegates.set_inputType_BeforeArgs toInvoke in _beforeset_inputType.GetInvocationList())
                {
                    try
                    {
                        _beforeset_inputType?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_inputType != null)
            {
                foreach (Delegates.set_inputType_AfterArgs toInvoke in _afterset_inputType.GetInvocationList())
                {
                    try
                    {
                        _afterset_inputType.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookget_keyboardType()
        {
            if (!HookedList.Contains("get_keyboardType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_keyboardType", true),
                    get_keyboardType);
            }
        }
        ...
        private static UnityEngine.TouchScreenKeyboardType get_keyboardType(
            Func<TMPro.TMP_InputField, UnityEngine.TouchScreenKeyboardType> orig, TMPro.TMP_InputField self)
        {
        ...
        internal static void Hookset_keyboardType()
        {
            if (!HookedList.Contains("set_keyboardType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_keyboardType", true),
                    set_keyboardType);
            }
        }
        ...
        private static void set_keyboardType(Action<TMPro.TMP_InputField, UnityEngine.TouchScreenKeyboardType> orig,
            TMPro.TMP_InputField self, UnityEngine.TouchScreenKeyboardType value)
        {
        ...
        internal static void Hookset_characterValidation()
        {
            if (!HookedList.Contains("set_characterValidation"))
            {
                HookedList.Add("set_characterValidation");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_characterValidation", true),
                    set_characterValidation);
            }
        }

        internal static event Delegates.set_characterValidation_BeforeArgs _beforeset_characterValidation;
        internal static event Delegates.set_characterValidation_AfterArgs _afterset_characterValidation;

        private static void set_characterValidation(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.CharacterValidation> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.CharacterValidation value)
        {
            Delegates.Params_set_characterValidation @params = new()
            {
                self = self, value = value
            };
            if (_beforeset_characterValidation != null)
            {
                foreach (Delegates.set_characterValidation_BeforeArgs toInvoke in _beforeset_characterValidation
                             .GetInvocationList())
                {
                    try
                    {
                        _beforeset_characterValidation?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_characterValidation != null)
            {
                foreach (Delegates.set_characterValidation_AfterArgs toInvoke in _afterset_characterValidation
                             .GetInvocationList())
                {
                    try
                    {
                        _afterset_characterValidation.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void Hookget_readOnly()
        {
            if (!HookedList.Contains("get_readOnly"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_readOnly", true),
                    get_readOnly);
            }
        }
        ...
        internal static void Hookset_readOnly()
        {
            if (!HookedList.Contains("set_readOnly"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_readOnly", true),
                    set_readOnly);
            }
        }
        ...
        internal static void Hookget_richText()
        {
            if (!HookedList.Contains("get_richText"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_richText", true),
                    get_richText);
            }
        }
        ...
        internal static void Hookset_richText()
        {
            if (!HookedList.Contains("set_richText"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_richText", true),
                    set_richText);
            }
        }
        ...
        internal static void Hookget_multiLine()
        {
            if (!HookedList.Contains("get_multiLine"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_multiLine", true),
                    get_multiLine);
            }
        }
        ...
        internal static void Hookget_asteriskChar()
        {
            if (!HookedList.Contains("get_asteriskChar"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_asteriskChar", true),
                    get_asteriskChar);
            }
        }
        ...
        internal static void Hookset_asteriskChar()
        {
            if (!HookedList.Contains("set_asteriskChar"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_asteriskChar", true),
                    set_asteriskChar);
            }
        }
        ...
        private static void set_asteriskChar(Action<TMPro.TMP_InputField, char> orig, TMPro.TMP_InputField self,
            char value)
        {
        ...
        internal static void Hookget_wasCanceled()
        {
            if (!HookedList.Contains("get_wasCanceled"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_wasCanceled", true),
                    get_wasCanceled);
            }
        }
        ...
        internal static void Hookget_caretPositionInternal()
        {
            if (!HookedList.Contains("get_caretPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretPositionInternal", true),
        ...
        private static int get_caretPositionInternal(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_caretPositionInternal_BeforeArgs toInvoke in _beforeget_caretPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_caretPositionInternal_AfterArgs toInvoke in _afterget_caretPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_caretPositionInternal()
        {
            if (!HookedList.Contains("set_caretPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretPositionInternal", true),
        ...
        private static void set_caretPositionInternal(Action<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self,
            int value)
        {
            ...
            {
                foreach (Delegates.set_caretPositionInternal_BeforeArgs toInvoke in _beforeset_caretPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_caretPositionInternal_AfterArgs toInvoke in _afterset_caretPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_stringPositionInternal()
        {
            if (!HookedList.Contains("get_stringPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_stringPositionInternal", true),
        ...
        private static int get_stringPositionInternal(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_stringPositionInternal_BeforeArgs toInvoke in _beforeget_stringPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_stringPositionInternal_AfterArgs toInvoke in _afterget_stringPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_stringPositionInternal()
        {
            if (!HookedList.Contains("set_stringPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_stringPositionInternal", true),
        ...
        private static void set_stringPositionInternal(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value)
        {
            ...
            {
                foreach (Delegates.set_stringPositionInternal_BeforeArgs toInvoke in _beforeset_stringPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_stringPositionInternal_AfterArgs toInvoke in _afterset_stringPositionInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_caretSelectPositionInternal()
        {
            if (!HookedList.Contains("get_caretSelectPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretSelectPositionInternal",
                        true), get_caretSelectPositionInternal);
            }
        }
        ...
        private static int get_caretSelectPositionInternal(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_caretSelectPositionInternal_BeforeArgs toInvoke in
                         _beforeget_caretSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_caretSelectPositionInternal_AfterArgs toInvoke in
                         _afterget_caretSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_caretSelectPositionInternal()
        {
            if (!HookedList.Contains("set_caretSelectPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretSelectPositionInternal",
                        true), set_caretSelectPositionInternal);
            }
        }
        ...
        private static void set_caretSelectPositionInternal(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value)
        {
            ...
            {
                foreach (Delegates.set_caretSelectPositionInternal_BeforeArgs toInvoke in
                         _beforeset_caretSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_caretSelectPositionInternal_AfterArgs toInvoke in
                         _afterset_caretSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_stringSelectPositionInternal()
        {
            if (!HookedList.Contains("get_stringSelectPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_stringSelectPositionInternal",
                        true), get_stringSelectPositionInternal);
            }
        }
        ...
        internal static event Delegates.get_stringSelectPositionInternal_AfterArgs
            _afterget_stringSelectPositionInternal;

        private static int get_stringSelectPositionInternal(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_stringSelectPositionInternal_BeforeArgs toInvoke in
                         _beforeget_stringSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_stringSelectPositionInternal_AfterArgs toInvoke in
                         _afterget_stringSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_stringSelectPositionInternal()
        {
            if (!HookedList.Contains("set_stringSelectPositionInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_stringSelectPositionInternal",
                        true), set_stringSelectPositionInternal);
            }
        }
        ...
        internal static event Delegates.set_stringSelectPositionInternal_AfterArgs
            _afterset_stringSelectPositionInternal;

        private static void set_stringSelectPositionInternal(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value)
        {
            ...
            {
                foreach (Delegates.set_stringSelectPositionInternal_BeforeArgs toInvoke in
                         _beforeset_stringSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_stringSelectPositionInternal_AfterArgs toInvoke in
                         _afterset_stringSelectPositionInternal.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_hasSelection()
        {
            if (!HookedList.Contains("get_hasSelection"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_hasSelection", true),
                    get_hasSelection);
            }
        }
        ...
        internal static void Hookget_caretPosition()
        {
            if (!HookedList.Contains("get_caretPosition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretPosition", true),
                    get_caretPosition);
            }
        }
        ...
        private static int get_caretPosition(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_caretPosition_BeforeArgs toInvoke in
                         _beforeget_caretPosition.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_caretPosition()
        {
            if (!HookedList.Contains("set_caretPosition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretPosition", true),
                    set_caretPosition);
            }
        }
        ...
        private static void set_caretPosition(Action<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self,
            int value)
        {
            ...
            {
                foreach (Delegates.set_caretPosition_BeforeArgs toInvoke in
                         _beforeset_caretPosition.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_selectionAnchorPosition()
        {
            if (!HookedList.Contains("get_selectionAnchorPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionAnchorPosition", true),
        ...
        private static int get_selectionAnchorPosition(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_selectionAnchorPosition_BeforeArgs toInvoke in _beforeget_selectionAnchorPosition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_selectionAnchorPosition_AfterArgs toInvoke in _afterget_selectionAnchorPosition
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_selectionAnchorPosition()
        {
            if (!HookedList.Contains("set_selectionAnchorPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionAnchorPosition", true),
        ...
        private static void set_selectionAnchorPosition(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value)
        {
            ...
            {
                foreach (Delegates.set_selectionAnchorPosition_BeforeArgs toInvoke in _beforeset_selectionAnchorPosition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_selectionAnchorPosition_AfterArgs toInvoke in _afterset_selectionAnchorPosition
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_selectionFocusPosition()
        {
            if (!HookedList.Contains("get_selectionFocusPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionFocusPosition", true),
        ...
        private static int get_selectionFocusPosition(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.get_selectionFocusPosition_BeforeArgs toInvoke in _beforeget_selectionFocusPosition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_selectionFocusPosition_AfterArgs toInvoke in _afterget_selectionFocusPosition
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_selectionFocusPosition()
        {
            if (!HookedList.Contains("set_selectionFocusPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionFocusPosition", true),
        ...
        private static void set_selectionFocusPosition(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value)
        {
            ...
            {
                foreach (Delegates.set_selectionFocusPosition_BeforeArgs toInvoke in _beforeset_selectionFocusPosition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_selectionFocusPosition_AfterArgs toInvoke in _afterset_selectionFocusPosition
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static System.Collections.IEnumerator CaretBlink(
            Func<TMPro.TMP_InputField, System.Collections.IEnumerator> orig, TMPro.TMP_InputField self)
        {
        ...
        internal static void HookSetCaretVisible()
        {
            if (!HookedList.Contains("SetCaretVisible"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetCaretVisible", true),
                    SetCaretVisible);
            }
        }
        ...
        internal static void HookSetCaretActive()
        {
            if (!HookedList.Contains("SetCaretActive"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetCaretActive", true),
                    SetCaretActive);
            }
        }
        ...
        internal static void HookMoveTextEnd()
        {
            if (!HookedList.Contains("MoveTextEnd"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveTextEnd", true),
                    MoveTextEnd);
            }
        }
        ...
        internal static void HookMoveTextStart()
        {
            if (!HookedList.Contains("MoveTextStart"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveTextStart", true),
                    MoveTextStart);
            }
        }
        ...
        private static void MoveTextStart(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool shift)
        {
        ...
        internal static void Hookget_clipboard()
        {
            if (!HookedList.Contains("get_clipboard"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_clipboard", false),
                    get_clipboard);
            }
        }
        ...
        internal static void Hookset_clipboard()
        {
            if (!HookedList.Contains("set_clipboard"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_clipboard", false),
                    set_clipboard);
            }
        }
        ...
        internal static void HookInPlaceEditing()
        {
            if (!HookedList.Contains("InPlaceEditing"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "InPlaceEditing", true),
                    InPlaceEditing);
            }
        }
        ...
        internal static void HookGetCharacterIndexFromPosition()
        {
            if (!HookedList.Contains("GetCharacterIndexFromPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetCharacterIndexFromPosition", true),
        ...
        private static int GetCharacterIndexFromPosition(Func<TMPro.TMP_InputField, UnityEngine.Vector2, int> orig,
            TMPro.TMP_InputField self, UnityEngine.Vector2 pos)
        {
            ...
            {
                foreach (Delegates.GetCharacterIndexFromPosition_BeforeArgs toInvoke in
                         _beforeGetCharacterIndexFromPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetCharacterIndexFromPosition_AfterArgs toInvoke in
                         _afterGetCharacterIndexFromPosition.GetInvocationList())
                {
                    try
                    {
        ...
        private static bool MayDrag(Func<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData, bool> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookOnBeginDrag()
        {
            if (!HookedList.Contains("OnBeginDrag"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnBeginDrag", true),
                    OnBeginDrag);
            }
        }
        ...
        private static void OnBeginDrag(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        private static void OnDrag(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookMouseDragOutsideRect()
        {
            if (!HookedList.Contains("MouseDragOutsideRect"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MouseDragOutsideRect", true),
        ...
        private static System.Collections.IEnumerator MouseDragOutsideRect(
            Func<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData, System.Collections.IEnumerator> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData)
        {
            ...
            {
                foreach (Delegates.MouseDragOutsideRect_BeforeArgs toInvoke in _beforeMouseDragOutsideRect
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void OnEndDrag(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookOnPointerDown()
        {
            if (!HookedList.Contains("OnPointerDown"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnPointerDown", true),
                    OnPointerDown);
            }
        }
        ...
        private static void OnPointerDown(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookIsValidChar()
        {
            if (!HookedList.Contains("IsValidChar"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "IsValidChar", true),
                    IsValidChar);
            }
        }
        ...
        internal static void HookProcessEvent()
        {
            if (!HookedList.Contains("ProcessEvent"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ProcessEvent", true),
                    ProcessEvent);
            }
        }
        ...
        private static void ProcessEvent(Action<TMPro.TMP_InputField, UnityEngine.Event> orig,
            TMPro.TMP_InputField self, UnityEngine.Event e)
        {
        ...
        internal static void HookOnUpdateSelected()
        {
            if (!HookedList.Contains("OnUpdateSelected"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnUpdateSelected", true),
                    OnUpdateSelected);
            }
        }
        ...
        private static void OnUpdateSelected(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.BaseEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookGetSelectedString()
        {
            if (!HookedList.Contains("GetSelectedString"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetSelectedString", true),
                    GetSelectedString);
            }
        }
        ...
        private static string GetSelectedString(Func<TMPro.TMP_InputField, string> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.GetSelectedString_BeforeArgs toInvoke in
                         _beforeGetSelectedString.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookFindtNextWordBegin()
        {
            if (!HookedList.Contains("FindtNextWordBegin"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "FindtNextWordBegin", true),
                    FindtNextWordBegin);
            }
        }
        ...
        private static int FindtNextWordBegin(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.FindtNextWordBegin_BeforeArgs toInvoke in
                         _beforeFindtNextWordBegin.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.FindtNextWordBegin_AfterArgs toInvoke in
                         _afterFindtNextWordBegin.GetInvocationList())
                {
                    try
                    {
        ...
        private static void MoveRight(Action<TMPro.TMP_InputField, bool, bool> orig, TMPro.TMP_InputField self,
        ...
        internal static void HookFindtPrevWordBegin()
        {
            if (!HookedList.Contains("FindtPrevWordBegin"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "FindtPrevWordBegin", true),
                    FindtPrevWordBegin);
            }
        }
        ...
        private static int FindtPrevWordBegin(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.FindtPrevWordBegin_BeforeArgs toInvoke in
                         _beforeFindtPrevWordBegin.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.FindtPrevWordBegin_AfterArgs toInvoke in
                         _afterFindtPrevWordBegin.GetInvocationList())
                {
                    try
                    {
        ...
        private static void MoveLeft(Action<TMPro.TMP_InputField, bool, bool> orig, TMPro.TMP_InputField self,
            bool shift, bool ctrl)
        {
        ...
        internal static void HookLineUpCharacterPosition()
        {
            if (!HookedList.Contains("LineUpCharacterPosition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LineUpCharacterPosition", true),
        ...
        private static int LineUpCharacterPosition(Func<TMPro.TMP_InputField, int, bool, int> orig,
            TMPro.TMP_InputField self, int originalPos, bool goToFirstChar)
        {
            ...
            {
                foreach (Delegates.LineUpCharacterPosition_BeforeArgs toInvoke in _beforeLineUpCharacterPosition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.LineUpCharacterPosition_AfterArgs toInvoke in _afterLineUpCharacterPosition
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookLineDownCharacterPosition()
        {
            if (!HookedList.Contains("LineDownCharacterPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LineDownCharacterPosition", true),
        ...
        private static int LineDownCharacterPosition(Func<TMPro.TMP_InputField, int, bool, int> orig,
            TMPro.TMP_InputField self, int originalPos, bool goToLastChar)
        {
            ...
            {
                foreach (Delegates.LineDownCharacterPosition_BeforeArgs toInvoke in _beforeLineDownCharacterPosition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.LineDownCharacterPosition_AfterArgs toInvoke in _afterLineDownCharacterPosition
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookMoveDown_bool()
        {
            if (!HookedList.Contains("MoveDown_bool"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveDown_bool", true),
                    MoveDown_bool);
            }
        }
        ...
        private static void MoveDown_bool(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool shift)
        {
        ...
        internal static void HookMoveDown_bool_bool()
        {
            if (!HookedList.Contains("MoveDown_bool_bool"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveDown_bool_bool", true),
                    MoveDown_bool_bool);
            }
        }
        ...
        private static void MoveDown_bool_bool(Action<TMPro.TMP_InputField, bool, bool> orig, TMPro.TMP_InputField self,
            bool shift, bool goToLastChar)
        {
            ...
            {
                foreach (Delegates.MoveDown_bool_bool_BeforeArgs toInvoke in
                         _beforeMoveDown_bool_bool.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.MoveDown_bool_bool_AfterArgs toInvoke in
                         _afterMoveDown_bool_bool.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookMoveUp_bool()
        {
            if (!HookedList.Contains("MoveUp_bool"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveUp_bool", true),
                    MoveUp_bool);
            }
        }
        ...
        internal static void HookMoveUp_bool_bool()
        {
            if (!HookedList.Contains("MoveUp_bool_bool"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveUp_bool_bool", true),
                    MoveUp_bool_bool);
            }
        }
        ...
        private static void MoveUp_bool_bool(Action<TMPro.TMP_InputField, bool, bool> orig, TMPro.TMP_InputField self,
            bool shift, bool goToFirstChar)
        {
        ...
        internal static void HookForwardSpace()
        {
            if (!HookedList.Contains("ForwardSpace"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ForwardSpace", true),
                    ForwardSpace);
            }
        }
        ...
        internal static void HookSendOnValueChangedAndUpdateLabel()
        {
            if (!HookedList.Contains("SendOnValueChangedAndUpdateLabel"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnValueChangedAndUpdateLabel",
                        true), SendOnValueChangedAndUpdateLabel);
            }
        }
        ...
        internal static event Delegates.SendOnValueChangedAndUpdateLabel_AfterArgs
            _afterSendOnValueChangedAndUpdateLabel;

        private static void SendOnValueChangedAndUpdateLabel(Action<TMPro.TMP_InputField> orig,
            TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.SendOnValueChangedAndUpdateLabel_BeforeArgs toInvoke in
                         _beforeSendOnValueChangedAndUpdateLabel.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SendOnValueChangedAndUpdateLabel_AfterArgs toInvoke in
                         _afterSendOnValueChangedAndUpdateLabel.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookSendOnValueChanged()
        {
            if (!HookedList.Contains("SendOnValueChanged"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnValueChanged", true),
                    SendOnValueChanged);
            }
        }
        ...
        private static void SendOnValueChanged(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.SendOnValueChanged_BeforeArgs toInvoke in
                         _beforeSendOnValueChanged.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SendOnValueChanged_AfterArgs toInvoke in
                         _afterSendOnValueChanged.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookSendOnSubmit()
        {
            if (!HookedList.Contains("SendOnSubmit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnSubmit", true),
                    SendOnSubmit);
            }
        }
        ...
        internal static void HookSendOnFocusLost()
        {
            if (!HookedList.Contains("SendOnFocusLost"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnFocusLost", true),
                    SendOnFocusLost);
            }
        }
        ...
        internal static void HookAppend_string()
        {
            if (!HookedList.Contains("Append_string"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Append_string", true),
                    Append_string);
            }
        }
        ...
        private static void Append_string(Action<TMPro.TMP_InputField, string> orig, TMPro.TMP_InputField self,
            string input)
        {
        ...
        internal static void HookAppend_Char()
        {
            if (!HookedList.Contains("Append_Char"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Append_Char", true),
                    Append_Char);
            }
        }
        ...
        internal static void HookUpdateLabel()
        {
            if (!HookedList.Contains("UpdateLabel"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "UpdateLabel", true),
                    UpdateLabel);
            }
        }
        ...
        internal static void HookGetCaretPositionFromStringIndex()
        {
            if (!HookedList.Contains("GetCaretPositionFromStringIndex"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetCaretPositionFromStringIndex",
                        true), GetCaretPositionFromStringIndex);
            }
        }
        ...
        private static int GetCaretPositionFromStringIndex(Func<TMPro.TMP_InputField, int, int> orig,
            TMPro.TMP_InputField self, int stringIndex)
        {
            ...
            {
                foreach (Delegates.GetCaretPositionFromStringIndex_BeforeArgs toInvoke in
                         _beforeGetCaretPositionFromStringIndex.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetCaretPositionFromStringIndex_AfterArgs toInvoke in
                         _afterGetCaretPositionFromStringIndex.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookGetStringIndexFromCaretPosition()
        {
            if (!HookedList.Contains("GetStringIndexFromCaretPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetStringIndexFromCaretPosition",
                        true), GetStringIndexFromCaretPosition);
            }
        }
        ...
        private static int GetStringIndexFromCaretPosition(Func<TMPro.TMP_InputField, int, int> orig,
            TMPro.TMP_InputField self, int caretPosition)
        {
            ...
            {
                foreach (Delegates.GetStringIndexFromCaretPosition_BeforeArgs toInvoke in
                         _beforeGetStringIndexFromCaretPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetStringIndexFromCaretPosition_AfterArgs toInvoke in
                         _afterGetStringIndexFromCaretPosition.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookForceLabelUpdate()
        {
            if (!HookedList.Contains("ForceLabelUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ForceLabelUpdate", true),
                    ForceLabelUpdate);
            }
        }
        ...
        internal static void HookMarkGeometryAsDirty()
        {
            if (!HookedList.Contains("MarkGeometryAsDirty"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MarkGeometryAsDirty", true),
                    MarkGeometryAsDirty);
            }
        }
        ...
        private static void MarkGeometryAsDirty(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.MarkGeometryAsDirty_BeforeArgs toInvoke in _beforeMarkGeometryAsDirty
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.MarkGeometryAsDirty_AfterArgs toInvoke in
                         _afterMarkGeometryAsDirty.GetInvocationList())
                {
                    try
                    {
        ...
        private static void Rebuild(Action<TMPro.TMP_InputField, UnityEngine.UI.CanvasUpdate> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.CanvasUpdate update)
        {
        ...
        internal static void HookLayoutComplete()
        {
            if (!HookedList.Contains("LayoutComplete"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LayoutComplete", true),
                    LayoutComplete);
            }
        }
        ...
        internal static void HookGraphicUpdateComplete()
        {
            if (!HookedList.Contains("GraphicUpdateComplete"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GraphicUpdateComplete", true),
        ...
        private static void GraphicUpdateComplete(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.GraphicUpdateComplete_BeforeArgs toInvoke in _beforeGraphicUpdateComplete
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GraphicUpdateComplete_AfterArgs toInvoke in _afterGraphicUpdateComplete
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookUpdateGeometry()
        {
            if (!HookedList.Contains("UpdateGeometry"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "UpdateGeometry", true),
                    UpdateGeometry);
            }
        }
        ...
        internal static void HookAssignPositioningIfNeeded()
        {
            if (!HookedList.Contains("AssignPositioningIfNeeded"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "AssignPositioningIfNeeded", true),
        ...
        private static void AssignPositioningIfNeeded(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.AssignPositioningIfNeeded_BeforeArgs toInvoke in _beforeAssignPositioningIfNeeded
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AssignPositioningIfNeeded_AfterArgs toInvoke in _afterAssignPositioningIfNeeded
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void OnFillVBO(Action<TMPro.TMP_InputField, UnityEngine.Mesh> orig, TMPro.TMP_InputField self,
            UnityEngine.Mesh vbo)
        {
        ...
        internal static void HookGenerateCaret()
        {
            if (!HookedList.Contains("GenerateCaret"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GenerateCaret", true),
                    GenerateCaret);
            }
        }
        ...
        private static void GenerateCaret(
            Action<TMPro.TMP_InputField, UnityEngine.UI.VertexHelper, UnityEngine.Vector2> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.VertexHelper vbo, UnityEngine.Vector2 roundingOffset)
        {
        ...
        internal static void HookCreateCursorVerts()
        {
            if (!HookedList.Contains("CreateCursorVerts"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "CreateCursorVerts", true),
                    CreateCursorVerts);
            }
        }
        ...
        private static void CreateCursorVerts(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.CreateCursorVerts_BeforeArgs toInvoke in
                         _beforeCreateCursorVerts.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookGenerateHightlight()
        {
            if (!HookedList.Contains("GenerateHightlight"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GenerateHightlight", true),
                    GenerateHightlight);
            }
        }
        ...
        private static void GenerateHightlight(
            Action<TMPro.TMP_InputField, UnityEngine.UI.VertexHelper, UnityEngine.Vector2> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.VertexHelper vbo, UnityEngine.Vector2 roundingOffset)
        {
            ...
            {
                foreach (Delegates.GenerateHightlight_BeforeArgs toInvoke in
                         _beforeGenerateHightlight.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GenerateHightlight_AfterArgs toInvoke in
                         _afterGenerateHightlight.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAdjustRectTransformRelativeToViewport()
        {
            if (!HookedList.Contains("AdjustRectTransformRelativeToViewport"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField),
                        "AdjustRectTransformRelativeToViewport", true), AdjustRectTransformRelativeToViewport);
            }
        }
        ...
        internal static event Delegates.AdjustRectTransformRelativeToViewport_AfterArgs
            _afterAdjustRectTransformRelativeToViewport;

        private static void AdjustRectTransformRelativeToViewport(
            Action<TMPro.TMP_InputField, UnityEngine.Vector2, float, bool> orig, TMPro.TMP_InputField self,
            UnityEngine.Vector2 startPosition, float height, bool isCharVisible)
        {
            ...
            {
                foreach (Delegates.AdjustRectTransformRelativeToViewport_BeforeArgs toInvoke in
                         _beforeAdjustRectTransformRelativeToViewport.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AdjustRectTransformRelativeToViewport_AfterArgs toInvoke in
                         _afterAdjustRectTransformRelativeToViewport.GetInvocationList())
                {
                    try
                    {
        ...
        private static char Validate(Func<TMPro.TMP_InputField, string, int, char, char> orig,
            TMPro.TMP_InputField self, string text, int pos, char ch)
        {
        ...
        internal static void HookActivateInputField()
        {
            if (!HookedList.Contains("ActivateInputField"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ActivateInputField", true),
                    ActivateInputField);
            }
        }
        ...
        private static void ActivateInputField(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.ActivateInputField_BeforeArgs toInvoke in
                         _beforeActivateInputField.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ActivateInputField_AfterArgs toInvoke in
                         _afterActivateInputField.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookActivateInputFieldInternal()
        {
            if (!HookedList.Contains("ActivateInputFieldInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ActivateInputFieldInternal", true),
        ...
        private static void ActivateInputFieldInternal(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.ActivateInputFieldInternal_BeforeArgs toInvoke in _beforeActivateInputFieldInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ActivateInputFieldInternal_AfterArgs toInvoke in _afterActivateInputFieldInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void OnSelect(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.BaseEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookOnPointerClick()
        {
            if (!HookedList.Contains("OnPointerClick"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnPointerClick", true),
                    OnPointerClick);
            }
        }
        ...
        private static void OnPointerClick(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData)
        {
        ...
        internal static void HookDeactivateInputField()
        {
            if (!HookedList.Contains("DeactivateInputField"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "DeactivateInputField", true),
        ...
        private static void DeactivateInputField(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.DeactivateInputField_BeforeArgs toInvoke in _beforeDeactivateInputField
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.DeactivateInputField_AfterArgs toInvoke in _afterDeactivateInputField
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void OnDeselect(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.BaseEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        private static void OnSubmit(Action<TMPro.TMP_InputField, UnityEngine.EventSystems.BaseEventData> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookEnforceContentType()
        {
            if (!HookedList.Contains("EnforceContentType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "EnforceContentType", true),
                    EnforceContentType);
            }
        }
        ...
        private static void EnforceContentType(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.EnforceContentType_BeforeArgs toInvoke in
                         _beforeEnforceContentType.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.EnforceContentType_AfterArgs toInvoke in
                         _afterEnforceContentType.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookSetTextComponentWrapMode()
        {
            if (!HookedList.Contains("SetTextComponentWrapMode"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetTextComponentWrapMode", true),
        ...
        private static void SetTextComponentWrapMode(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.SetTextComponentWrapMode_BeforeArgs toInvoke in _beforeSetTextComponentWrapMode
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SetTextComponentWrapMode_AfterArgs toInvoke in _afterSetTextComponentWrapMode
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookSetTextComponentRichTextMode()
        {
            if (!HookedList.Contains("SetTextComponentRichTextMode"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetTextComponentRichTextMode", true),
        ...
        private static void SetTextComponentRichTextMode(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self)
        {
            ...
            {
                foreach (Delegates.SetTextComponentRichTextMode_BeforeArgs toInvoke in
                         _beforeSetTextComponentRichTextMode.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SetTextComponentRichTextMode_AfterArgs toInvoke in _afterSetTextComponentRichTextMode
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookSetToCustomIfContentTypeIsNot()
        {
            if (!HookedList.Contains("SetToCustomIfContentTypeIsNot"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetToCustomIfContentTypeIsNot", true),
        ...
        private static void SetToCustomIfContentTypeIsNot(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.ContentType[]> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.ContentType[] allowedContentTypes)
        {
            ...
            {
                foreach (Delegates.SetToCustomIfContentTypeIsNot_BeforeArgs toInvoke in
                         _beforeSetToCustomIfContentTypeIsNot.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SetToCustomIfContentTypeIsNot_AfterArgs toInvoke in
                         _afterSetToCustomIfContentTypeIsNot.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookSetToCustom()
        {
            if (!HookedList.Contains("SetToCustom"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetToCustom", true),
                    SetToCustom);
            }
        }
        ...
        internal static void Hookget_transform()
        {
            if (!HookedList.Contains("get_transform"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_transform", true),
                    get_transform);
            }
        }
        ...
        private static UnityEngine.Transform get_transform(Func<TMPro.TMP_InputField, UnityEngine.Transform> orig,
            TMPro.TMP_InputField self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Mesh get_mesh_WithArgs(Func<TMPro.TMP_InputField, UnityEngine.Mesh> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_shouldHideMobileInput_WithArgs(Action<TMPro.TMP_InputField, bool> orig,
            TMPro.TMP_InputField self, bool value);
        ...
        public delegate bool get_shouldHideMobileInput_WithArgs(Func<TMPro.TMP_InputField, bool> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_text_WithArgs(Action<TMPro.TMP_InputField, string> orig, TMPro.TMP_InputField self,
            string value);
        ...
        public delegate float get_caretBlinkRate_WithArgs(Func<TMPro.TMP_InputField, float> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_caretBlinkRate_WithArgs(Action<TMPro.TMP_InputField, float> orig,
            TMPro.TMP_InputField self, float value);
        ...
        public delegate void set_caretWidth_WithArgs(Action<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self,
            int value);
        ...
        public delegate UnityEngine.RectTransform get_textViewport_AfterArgs(Params_get_textViewport args,
            UnityEngine.RectTransform ret);

        public delegate UnityEngine.RectTransform get_textViewport_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.RectTransform> orig, TMPro.TMP_InputField self);
        ...
        public delegate void set_textViewport_WithArgs(Action<TMPro.TMP_InputField, UnityEngine.RectTransform> orig,
            TMPro.TMP_InputField self, UnityEngine.RectTransform value);
        ...
        public delegate TMPro.TMP_Text get_textComponent_WithArgs(Func<TMPro.TMP_InputField, TMPro.TMP_Text> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_textComponent_WithArgs(Action<TMPro.TMP_InputField, TMPro.TMP_Text> orig,
            TMPro.TMP_InputField self, TMPro.TMP_Text value);
        ...
        public delegate UnityEngine.UI.Graphic get_placeholder_AfterArgs(Params_get_placeholder args,
            UnityEngine.UI.Graphic ret);

        public delegate UnityEngine.UI.Graphic get_placeholder_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.UI.Graphic> orig, TMPro.TMP_InputField self);
        ...
        public delegate void set_placeholder_WithArgs(Action<TMPro.TMP_InputField, UnityEngine.UI.Graphic> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.Graphic value);
        ...
        public delegate UnityEngine.Color get_caretColor_WithArgs(Func<TMPro.TMP_InputField, UnityEngine.Color> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_caretColor_WithArgs(Action<TMPro.TMP_InputField, UnityEngine.Color> orig,
            TMPro.TMP_InputField self, UnityEngine.Color value);
        ...
        public delegate bool get_customCaretColor_WithArgs(Func<TMPro.TMP_InputField, bool> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_customCaretColor_WithArgs(Action<TMPro.TMP_InputField, bool> orig,
            TMPro.TMP_InputField self, bool value);
        ...
        public delegate UnityEngine.Color get_selectionColor_AfterArgs(Params_get_selectionColor args,
            UnityEngine.Color ret);

        public delegate UnityEngine.Color get_selectionColor_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.Color> orig, TMPro.TMP_InputField self);
        ...
        public delegate void set_selectionColor_WithArgs(Action<TMPro.TMP_InputField, UnityEngine.Color> orig,
            TMPro.TMP_InputField self, UnityEngine.Color value);

        public sealed class Params_set_onEndEdit
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.SubmitEvent value;
        }

        public delegate void set_onEndEdit_BeforeArgs(Params_set_onEndEdit args);

        public delegate void set_onEndEdit_AfterArgs(Params_set_onEndEdit args);

        public delegate void set_onEndEdit_WithArgs(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.SubmitEvent> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.SubmitEvent value);

        public sealed class Params_set_onSubmit
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.SubmitEvent value;
        }

        public delegate void set_onSubmit_BeforeArgs(Params_set_onSubmit args);

        public delegate void set_onSubmit_AfterArgs(Params_set_onSubmit args);

        public delegate void set_onSubmit_WithArgs(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.SubmitEvent> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.SubmitEvent value);

        public sealed class Params_set_onFocusLost
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.SubmitEvent value;
        }

        public delegate void set_onFocusLost_BeforeArgs(Params_set_onFocusLost args);

        public delegate void set_onFocusLost_AfterArgs(Params_set_onFocusLost args);

        public delegate void set_onFocusLost_WithArgs(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.SubmitEvent> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.SubmitEvent value);

        public sealed class Params_set_onValueChanged
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.OnChangeEvent value;
        }

        public delegate void set_onValueChanged_BeforeArgs(Params_set_onValueChanged args);

        public delegate void set_onValueChanged_AfterArgs(Params_set_onValueChanged args);

        public delegate void set_onValueChanged_WithArgs(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.OnChangeEvent> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.OnChangeEvent value);

        public sealed class Params_set_onValidateInput
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.OnValidateInput value;
        }

        public delegate void set_onValidateInput_BeforeArgs(Params_set_onValidateInput args);

        public delegate void set_onValidateInput_AfterArgs(Params_set_onValidateInput args);

        public delegate void set_onValidateInput_WithArgs(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.OnValidateInput> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.OnValidateInput value);
        ...
        public delegate int
            get_characterLimit_WithArgs(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self);
        ...
        public delegate void set_characterLimit_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);

        public sealed class Params_set_contentType
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.ContentType value;
        }

        public delegate void set_contentType_BeforeArgs(Params_set_contentType args);

        public delegate void set_contentType_AfterArgs(Params_set_contentType args);

        public delegate void set_contentType_WithArgs(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.ContentType> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.ContentType value);

        public sealed class Params_set_lineType
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.LineType value;
        }

        public delegate void set_lineType_BeforeArgs(Params_set_lineType args);

        public delegate void set_lineType_AfterArgs(Params_set_lineType args);

        public delegate void set_lineType_WithArgs(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.LineType> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.LineType value);

        public sealed class Params_set_inputType
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.InputType value;
        }

        public delegate void set_inputType_BeforeArgs(Params_set_inputType args);

        public delegate void set_inputType_AfterArgs(Params_set_inputType args);

        public delegate void set_inputType_WithArgs(Action<TMPro.TMP_InputField, TMPro.TMP_InputField.InputType> orig,
            TMPro.TMP_InputField self, TMPro.TMP_InputField.InputType value);
        ...
        public delegate UnityEngine.TouchScreenKeyboardType get_keyboardType_AfterArgs(Params_get_keyboardType args,
            UnityEngine.TouchScreenKeyboardType ret);

        public delegate UnityEngine.TouchScreenKeyboardType get_keyboardType_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.TouchScreenKeyboardType> orig, TMPro.TMP_InputField self);
        ...
        public delegate void set_keyboardType_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.TouchScreenKeyboardType> orig, TMPro.TMP_InputField self,
            UnityEngine.TouchScreenKeyboardType value);

        public sealed class Params_set_characterValidation
        {
            public TMPro.TMP_InputField self;
            public TMPro.TMP_InputField.CharacterValidation value;
        }

        public delegate void set_characterValidation_BeforeArgs(Params_set_characterValidation args);

        public delegate void set_characterValidation_AfterArgs(Params_set_characterValidation args);

        public delegate void set_characterValidation_WithArgs(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.CharacterValidation> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.CharacterValidation value);
        ...
        public delegate void set_readOnly_WithArgs(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool value);
        ...
        public delegate void set_richText_WithArgs(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool value);
        ...
        public delegate char
            get_asteriskChar_WithArgs(Func<TMPro.TMP_InputField, char> orig, TMPro.TMP_InputField self);
        ...
        public delegate void set_asteriskChar_WithArgs(Action<TMPro.TMP_InputField, char> orig,
            TMPro.TMP_InputField self, char value);
        ...
        public delegate void ClampPos_WithArgs(Action<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self,
            int pos);
        ...
        public delegate int get_caretPositionInternal_WithArgs(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_caretPositionInternal_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);
        ...
        public delegate int get_stringPositionInternal_WithArgs(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_stringPositionInternal_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);
        ...
        public delegate int get_caretSelectPositionInternal_AfterArgs(Params_get_caretSelectPositionInternal args,
            int ret);

        public delegate int get_caretSelectPositionInternal_WithArgs(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_caretSelectPositionInternal_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);
        ...
        public delegate int get_stringSelectPositionInternal_AfterArgs(Params_get_stringSelectPositionInternal args,
            int ret);

        public delegate int get_stringSelectPositionInternal_WithArgs(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_stringSelectPositionInternal_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);
        ...
        public delegate bool
            get_hasSelection_WithArgs(Func<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self);
        ...
        public delegate void set_caretPosition_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);
        ...
        public delegate int get_selectionAnchorPosition_WithArgs(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_selectionAnchorPosition_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);
        ...
        public delegate int get_selectionFocusPosition_WithArgs(Func<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void set_selectionFocusPosition_WithArgs(Action<TMPro.TMP_InputField, int> orig,
            TMPro.TMP_InputField self, int value);
        ...
        public delegate System.Collections.IEnumerator CaretBlink_AfterArgs(Params_CaretBlink args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator CaretBlink_WithArgs(
            Func<TMPro.TMP_InputField, System.Collections.IEnumerator> orig, TMPro.TMP_InputField self);
        ...
        public delegate void MoveTextEnd_WithArgs(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool shift);
        ...
        public delegate void MoveTextStart_WithArgs(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool shift);
        ...
        public delegate int GetCharacterIndexFromPosition_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.Vector2, int> orig, TMPro.TMP_InputField self,
        ...
        public delegate bool MayDrag_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData, bool> orig, TMPro.TMP_InputField self,
        ...
        public delegate void OnBeginDrag_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig, TMPro.TMP_InputField self,
            UnityEngine.EventSystems.PointerEventData eventData);
        ...
        public delegate void OnDrag_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig, TMPro.TMP_InputField self,
            UnityEngine.EventSystems.PointerEventData eventData);
        ...
        public delegate System.Collections.IEnumerator MouseDragOutsideRect_AfterArgs(Params_MouseDragOutsideRect args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator MouseDragOutsideRect_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData, System.Collections.IEnumerator> orig,
            TMPro.TMP_InputField self, UnityEngine.EventSystems.PointerEventData eventData);
        ...
        public delegate void OnEndDrag_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.EventSystems.PointerEventData> orig, TMPro.TMP_InputField self,
            UnityEngine.EventSystems.PointerEventData eventData);
        ...
        public delegate bool IsValidChar_WithArgs(Func<TMPro.TMP_InputField, char, bool> orig,
            TMPro.TMP_InputField self, char c);
        ...
        public delegate void ProcessEvent_WithArgs(Action<TMPro.TMP_InputField, UnityEngine.Event> orig,
            TMPro.TMP_InputField self, UnityEngine.Event e);
        ...
        public delegate void OnUpdateSelected_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.EventSystems.BaseEventData> orig, TMPro.TMP_InputField self,
        ...
        public delegate string GetSelectedString_WithArgs(Func<TMPro.TMP_InputField, string> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate int
            FindtNextWordBegin_WithArgs(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self);
        ...
        public delegate void MoveRight_WithArgs(Action<TMPro.TMP_InputField, bool, bool> orig,
            TMPro.TMP_InputField self, bool shift, bool ctrl);
        ...
        public delegate int
            FindtPrevWordBegin_WithArgs(Func<TMPro.TMP_InputField, int> orig, TMPro.TMP_InputField self);
        ...
        public delegate void MoveLeft_WithArgs(Action<TMPro.TMP_InputField, bool, bool> orig, TMPro.TMP_InputField self,
            bool shift, bool ctrl);
        ...
        public delegate int LineUpCharacterPosition_WithArgs(Func<TMPro.TMP_InputField, int, bool, int> orig,
            TMPro.TMP_InputField self, int originalPos, bool goToFirstChar);
        ...
        public delegate int LineDownCharacterPosition_WithArgs(Func<TMPro.TMP_InputField, int, bool, int> orig,
            TMPro.TMP_InputField self, int originalPos, bool goToLastChar);
        ...
        public delegate void MoveDown_bool_WithArgs(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool shift);
        ...
        public delegate void MoveDown_bool_bool_WithArgs(Action<TMPro.TMP_InputField, bool, bool> orig,
            TMPro.TMP_InputField self, bool shift, bool goToLastChar);
        ...
        public delegate void MoveUp_bool_WithArgs(Action<TMPro.TMP_InputField, bool> orig, TMPro.TMP_InputField self,
            bool shift);
        ...
        public delegate void MoveUp_bool_bool_WithArgs(Action<TMPro.TMP_InputField, bool, bool> orig,
            TMPro.TMP_InputField self, bool shift, bool goToFirstChar);
        ...
        public delegate void Insert_WithArgs(Action<TMPro.TMP_InputField, char> orig, TMPro.TMP_InputField self,
            char c);
        ...
        public delegate void SendOnValueChangedAndUpdateLabel_WithArgs(Action<TMPro.TMP_InputField> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void Append_string_WithArgs(Action<TMPro.TMP_InputField, string> orig,
            TMPro.TMP_InputField self, string input);
        ...
        public delegate void Append_Char_WithArgs(Action<TMPro.TMP_InputField, char> orig, TMPro.TMP_InputField self,
            char input);
        ...
        public delegate int GetCaretPositionFromStringIndex_AfterArgs(Params_GetCaretPositionFromStringIndex args,
            int ret);

        public delegate int GetCaretPositionFromStringIndex_WithArgs(Func<TMPro.TMP_InputField, int, int> orig,
            TMPro.TMP_InputField self, int stringIndex);
        ...
        public delegate int GetStringIndexFromCaretPosition_AfterArgs(Params_GetStringIndexFromCaretPosition args,
            int ret);

        public delegate int GetStringIndexFromCaretPosition_WithArgs(Func<TMPro.TMP_InputField, int, int> orig,
            TMPro.TMP_InputField self, int caretPosition);
        ...
        public delegate void Rebuild_WithArgs(Action<TMPro.TMP_InputField, UnityEngine.UI.CanvasUpdate> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.CanvasUpdate update);
        ...
        public delegate void GraphicUpdateComplete_WithArgs(Action<TMPro.TMP_InputField> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void AssignPositioningIfNeeded_WithArgs(Action<TMPro.TMP_InputField> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void OnFillVBO_WithArgs(Action<TMPro.TMP_InputField, UnityEngine.Mesh> orig,
            TMPro.TMP_InputField self, UnityEngine.Mesh vbo);
        ...
        public delegate void GenerateCaret_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.UI.VertexHelper, UnityEngine.Vector2> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.VertexHelper vbo, UnityEngine.Vector2 roundingOffset);
        ...
        public delegate void GenerateHightlight_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.UI.VertexHelper, UnityEngine.Vector2> orig,
            TMPro.TMP_InputField self, UnityEngine.UI.VertexHelper vbo, UnityEngine.Vector2 roundingOffset);
        ...
        public delegate void AdjustRectTransformRelativeToViewport_AfterArgs(
            Params_AdjustRectTransformRelativeToViewport args);

        public delegate void AdjustRectTransformRelativeToViewport_WithArgs(
            Action<TMPro.TMP_InputField, UnityEngine.Vector2, float, bool> orig, TMPro.TMP_InputField self,
            UnityEngine.Vector2 startPosition, float height, bool isCharVisible);
        ...
        public delegate char Validate_WithArgs(Func<TMPro.TMP_InputField, string, int, char, char> orig,
            TMPro.TMP_InputField self, string text, int pos, char ch);
        ...
        public delegate void ActivateInputFieldInternal_WithArgs(Action<TMPro.TMP_InputField> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void
            DeactivateInputField_WithArgs(Action<TMPro.TMP_InputField> orig, TMPro.TMP_InputField self);
        ...
        public delegate void SetTextComponentWrapMode_WithArgs(Action<TMPro.TMP_InputField> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void SetTextComponentRichTextMode_WithArgs(Action<TMPro.TMP_InputField> orig,
            TMPro.TMP_InputField self);
        ...
        public delegate void SetToCustomIfContentTypeIsNot_WithArgs(
            Action<TMPro.TMP_InputField, TMPro.TMP_InputField.ContentType[]> orig, TMPro.TMP_InputField self,
            TMPro.TMP_InputField.ContentType[] allowedContentTypes);
        ...
        public delegate UnityEngine.Transform get_transform_WithArgs(
            Func<TMPro.TMP_InputField, UnityEngine.Transform> orig, TMPro.TMP_InputField self);
    }
    ...
    public static class BeforeOrig
    {
        ...
        public static event Delegates.set_onEndEdit_BeforeArgs set_onEndEdit
        {
            add
            {
                HookHandler._beforeset_onEndEdit += value;
                HookHandler.Hookset_onEndEdit();
            }
            remove => HookHandler._beforeset_onEndEdit -= value;
        }

        public static event Delegates.set_onSubmit_BeforeArgs set_onSubmit
        {
            add
            {
                HookHandler._beforeset_onSubmit += value;
                HookHandler.Hookset_onSubmit();
            }
            remove => HookHandler._beforeset_onSubmit -= value;
        }

        public static event Delegates.set_onFocusLost_BeforeArgs set_onFocusLost
        {
            add
            {
                HookHandler._beforeset_onFocusLost += value;
                HookHandler.Hookset_onFocusLost();
            }
            remove => HookHandler._beforeset_onFocusLost -= value;
        }

        public static event Delegates.set_onValueChanged_BeforeArgs set_onValueChanged
        {
            add
            {
                HookHandler._beforeset_onValueChanged += value;
                HookHandler.Hookset_onValueChanged();
            }
            remove => HookHandler._beforeset_onValueChanged -= value;
        }

        public static event Delegates.set_onValidateInput_BeforeArgs set_onValidateInput
        {
            add
            {
                HookHandler._beforeset_onValidateInput += value;
                HookHandler.Hookset_onValidateInput();
            }
            remove => HookHandler._beforeset_onValidateInput -= value;
        }
        ...
        public static event Delegates.set_contentType_BeforeArgs set_contentType
        {
            add
            {
                HookHandler._beforeset_contentType += value;
                HookHandler.Hookset_contentType();
            }
            remove => HookHandler._beforeset_contentType -= value;
        }

        public static event Delegates.set_lineType_BeforeArgs set_lineType
        {
            add
            {
                HookHandler._beforeset_lineType += value;
                HookHandler.Hookset_lineType();
            }
            remove => HookHandler._beforeset_lineType -= value;
        }

        public static event Delegates.set_inputType_BeforeArgs set_inputType
        {
            add
            {
                HookHandler._beforeset_inputType += value;
                HookHandler.Hookset_inputType();
            }
            remove => HookHandler._beforeset_inputType -= value;
        }
        ...
        public static event Delegates.set_characterValidation_BeforeArgs set_characterValidation
        {
            add
            {
                HookHandler._beforeset_characterValidation += value;
                HookHandler.Hookset_characterValidation();
            }
            remove => HookHandler._beforeset_characterValidation -= value;
        }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.set_onEndEdit_AfterArgs set_onEndEdit
        {
            add
            {
                HookHandler._afterset_onEndEdit += value;
                HookHandler.Hookset_onEndEdit();
            }
            remove => HookHandler._afterset_onEndEdit -= value;
        }

        public static event Delegates.set_onSubmit_AfterArgs set_onSubmit
        {
            add
            {
                HookHandler._afterset_onSubmit += value;
                HookHandler.Hookset_onSubmit();
            }
            remove => HookHandler._afterset_onSubmit -= value;
        }

        public static event Delegates.set_onFocusLost_AfterArgs set_onFocusLost
        {
            add
            {
                HookHandler._afterset_onFocusLost += value;
                HookHandler.Hookset_onFocusLost();
            }
            remove => HookHandler._afterset_onFocusLost -= value;
        }

        public static event Delegates.set_onValueChanged_AfterArgs set_onValueChanged
        {
            add
            {
                HookHandler._afterset_onValueChanged += value;
                HookHandler.Hookset_onValueChanged();
            }
            remove => HookHandler._afterset_onValueChanged -= value;
        }

        public static event Delegates.set_onValidateInput_AfterArgs set_onValidateInput
        {
            add
            {
                HookHandler._afterset_onValidateInput += value;
                HookHandler.Hookset_onValidateInput();
            }
            remove => HookHandler._afterset_onValidateInput -= value;
        }
        ...
        public static event Delegates.set_contentType_AfterArgs set_contentType
        {
            add
            {
                HookHandler._afterset_contentType += value;
                HookHandler.Hookset_contentType();
            }
            remove => HookHandler._afterset_contentType -= value;
        }

        public static event Delegates.set_lineType_AfterArgs set_lineType
        {
            add
            {
                HookHandler._afterset_lineType += value;
                HookHandler.Hookset_lineType();
            }
            remove => HookHandler._afterset_lineType -= value;
        }

        public static event Delegates.set_inputType_AfterArgs set_inputType
        {
            add
            {
                HookHandler._afterset_inputType += value;
                HookHandler.Hookset_inputType();
            }
            remove => HookHandler._afterset_inputType -= value;
        }
        ...
        public static event Delegates.set_characterValidation_AfterArgs set_characterValidation
        {
            add
            {
                HookHandler._afterset_characterValidation += value;
                HookHandler.Hookset_characterValidation();
            }
            remove => HookHandler._afterset_characterValidation -= value;
        }
        ...
        public static event Delegates.AdjustRectTransformRelativeToViewport_AfterArgs
            AdjustRectTransformRelativeToViewport
            {
                add
                {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_mesh_WithArgs get_mesh
        {
            add => HookEndpointManager.Add<Delegates.get_mesh_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_mesh", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_shouldHideMobileInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_shouldHideMobileInput", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_shouldHideMobileInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_shouldHideMobileInput", true), value);
        }

        public static event Delegates.get_shouldHideMobileInput_WithArgs get_shouldHideMobileInput
        {
            add => HookEndpointManager.Add<Delegates.get_shouldHideMobileInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_shouldHideMobileInput", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_shouldHideMobileInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_shouldHideMobileInput", true), value);
        }
        ...
        public static event Delegates.get_text_WithArgs get_text
        {
            add => HookEndpointManager.Add<Delegates.get_text_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_text", true), value);
        ...
        public static event Delegates.set_text_WithArgs set_text
        {
            add => HookEndpointManager.Add<Delegates.set_text_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_text", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_isFocused_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_isFocused", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_isFocused_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_isFocused", true), value);
        }

        public static event Delegates.get_caretBlinkRate_WithArgs get_caretBlinkRate
        {
            add => HookEndpointManager.Add<Delegates.get_caretBlinkRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretBlinkRate", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_caretBlinkRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretBlinkRate", true), value);
        }

        public static event Delegates.set_caretBlinkRate_WithArgs set_caretBlinkRate
        {
            add => HookEndpointManager.Add<Delegates.set_caretBlinkRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretBlinkRate", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_caretBlinkRate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretBlinkRate", true), value);
        }

        public static event Delegates.get_caretWidth_WithArgs get_caretWidth
        {
            add => HookEndpointManager.Add<Delegates.get_caretWidth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretWidth", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_caretWidth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretWidth", true), value);
        }

        public static event Delegates.set_caretWidth_WithArgs set_caretWidth
        {
            add => HookEndpointManager.Add<Delegates.set_caretWidth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretWidth", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_caretWidth_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretWidth", true), value);
        }

        public static event Delegates.get_textViewport_WithArgs get_textViewport
        {
            add => HookEndpointManager.Add<Delegates.get_textViewport_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_textViewport", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_textViewport_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_textViewport", true), value);
        }

        public static event Delegates.set_textViewport_WithArgs set_textViewport
        {
            add => HookEndpointManager.Add<Delegates.set_textViewport_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_textViewport", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_textViewport_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_textViewport", true), value);
        }

        public static event Delegates.get_textComponent_WithArgs get_textComponent
        {
            add => HookEndpointManager.Add<Delegates.get_textComponent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_textComponent", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_textComponent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_textComponent", true), value);
        }

        public static event Delegates.set_textComponent_WithArgs set_textComponent
        {
            add => HookEndpointManager.Add<Delegates.set_textComponent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_textComponent", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_textComponent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_textComponent", true), value);
        }

        public static event Delegates.get_placeholder_WithArgs get_placeholder
        {
            add => HookEndpointManager.Add<Delegates.get_placeholder_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_placeholder", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_placeholder_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_placeholder", true), value);
        }

        public static event Delegates.set_placeholder_WithArgs set_placeholder
        {
            add => HookEndpointManager.Add<Delegates.set_placeholder_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_placeholder", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_placeholder_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_placeholder", true), value);
        }

        public static event Delegates.get_caretColor_WithArgs get_caretColor
        {
            add => HookEndpointManager.Add<Delegates.get_caretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretColor", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_caretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretColor", true), value);
        }

        public static event Delegates.set_caretColor_WithArgs set_caretColor
        {
            add => HookEndpointManager.Add<Delegates.set_caretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretColor", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_caretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretColor", true), value);
        }

        public static event Delegates.get_customCaretColor_WithArgs get_customCaretColor
        {
            add => HookEndpointManager.Add<Delegates.get_customCaretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_customCaretColor", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_customCaretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_customCaretColor", true), value);
        }

        public static event Delegates.set_customCaretColor_WithArgs set_customCaretColor
        {
            add => HookEndpointManager.Add<Delegates.set_customCaretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_customCaretColor", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_customCaretColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_customCaretColor", true), value);
        }

        public static event Delegates.get_selectionColor_WithArgs get_selectionColor
        {
            add => HookEndpointManager.Add<Delegates.get_selectionColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionColor", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_selectionColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionColor", true), value);
        }

        public static event Delegates.set_selectionColor_WithArgs set_selectionColor
        {
            add => HookEndpointManager.Add<Delegates.set_selectionColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionColor", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_selectionColor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionColor", true), value);
        }

        public static event Delegates.set_onEndEdit_WithArgs set_onEndEdit
        {
            add => HookEndpointManager.Add<Delegates.set_onEndEdit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onEndEdit", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_onEndEdit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onEndEdit", true), value);
        }

        public static event Delegates.set_onSubmit_WithArgs set_onSubmit
        {
            add => HookEndpointManager.Add<Delegates.set_onSubmit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onSubmit", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_onSubmit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onSubmit", true), value);
        }

        public static event Delegates.set_onFocusLost_WithArgs set_onFocusLost
        {
            add => HookEndpointManager.Add<Delegates.set_onFocusLost_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onFocusLost", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_onFocusLost_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onFocusLost", true), value);
        }

        public static event Delegates.set_onValueChanged_WithArgs set_onValueChanged
        {
            add => HookEndpointManager.Add<Delegates.set_onValueChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onValueChanged", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_onValueChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onValueChanged", true), value);
        }

        public static event Delegates.set_onValidateInput_WithArgs set_onValidateInput
        {
            add => HookEndpointManager.Add<Delegates.set_onValidateInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onValidateInput", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_onValidateInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_onValidateInput", true), value);
        }

        public static event Delegates.get_characterLimit_WithArgs get_characterLimit
        {
            add => HookEndpointManager.Add<Delegates.get_characterLimit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_characterLimit", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_characterLimit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_characterLimit", true), value);
        }

        public static event Delegates.set_characterLimit_WithArgs set_characterLimit
        {
            add => HookEndpointManager.Add<Delegates.set_characterLimit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_characterLimit", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_characterLimit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_characterLimit", true), value);
        }

        public static event Delegates.set_contentType_WithArgs set_contentType
        {
            add => HookEndpointManager.Add<Delegates.set_contentType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_contentType", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_contentType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_contentType", true), value);
        }

        public static event Delegates.set_lineType_WithArgs set_lineType
        {
            add => HookEndpointManager.Add<Delegates.set_lineType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_lineType", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_lineType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_lineType", true), value);
        }

        public static event Delegates.set_inputType_WithArgs set_inputType
        {
            add => HookEndpointManager.Add<Delegates.set_inputType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_inputType", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_inputType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_inputType", true), value);
        }

        public static event Delegates.get_keyboardType_WithArgs get_keyboardType
        {
            add => HookEndpointManager.Add<Delegates.get_keyboardType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_keyboardType", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_keyboardType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_keyboardType", true), value);
        }

        public static event Delegates.set_keyboardType_WithArgs set_keyboardType
        {
            add => HookEndpointManager.Add<Delegates.set_keyboardType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_keyboardType", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_keyboardType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_keyboardType", true), value);
        }

        public static event Delegates.set_characterValidation_WithArgs set_characterValidation
        {
            add => HookEndpointManager.Add<Delegates.set_characterValidation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_characterValidation", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_characterValidation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_characterValidation", true), value);
        }

        public static event Delegates.get_readOnly_WithArgs get_readOnly
        {
            add => HookEndpointManager.Add<Delegates.get_readOnly_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_readOnly", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_readOnly_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_readOnly", true), value);
        }

        public static event Delegates.set_readOnly_WithArgs set_readOnly
        {
            add => HookEndpointManager.Add<Delegates.set_readOnly_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_readOnly", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_readOnly_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_readOnly", true), value);
        }
        ...
        public static event Delegates.get_richText_WithArgs get_richText
        {
            add => HookEndpointManager.Add<Delegates.get_richText_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_richText", true), value);
        ...
        public static event Delegates.set_richText_WithArgs set_richText
        {
            add => HookEndpointManager.Add<Delegates.set_richText_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_richText", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_multiLine_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_multiLine", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_multiLine_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_multiLine", true), value);
        }

        public static event Delegates.get_asteriskChar_WithArgs get_asteriskChar
        {
            add => HookEndpointManager.Add<Delegates.get_asteriskChar_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_asteriskChar", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_asteriskChar_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_asteriskChar", true), value);
        }

        public static event Delegates.set_asteriskChar_WithArgs set_asteriskChar
        {
            add => HookEndpointManager.Add<Delegates.set_asteriskChar_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_asteriskChar", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_asteriskChar_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_asteriskChar", true), value);
        }

        public static event Delegates.get_wasCanceled_WithArgs get_wasCanceled
        {
            add => HookEndpointManager.Add<Delegates.get_wasCanceled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_wasCanceled", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_wasCanceled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_wasCanceled", true), value);
        }

        public static event Delegates.ClampPos_WithArgs ClampPos
        {
            add => HookEndpointManager.Add<Delegates.ClampPos_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ClampPos", true), value);
            remove => HookEndpointManager.Remove<Delegates.ClampPos_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ClampPos", true), value);
        }

        public static event Delegates.get_caretPositionInternal_WithArgs get_caretPositionInternal
        {
            add => HookEndpointManager.Add<Delegates.get_caretPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretPositionInternal", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_caretPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretPositionInternal", true), value);
        }

        public static event Delegates.set_caretPositionInternal_WithArgs set_caretPositionInternal
        {
            add => HookEndpointManager.Add<Delegates.set_caretPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretPositionInternal", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_caretPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretPositionInternal", true), value);
        }

        public static event Delegates.get_stringPositionInternal_WithArgs get_stringPositionInternal
        {
            add => HookEndpointManager.Add<Delegates.get_stringPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_stringPositionInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_stringPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_stringPositionInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_stringPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_stringPositionInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_stringPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_stringPositionInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_caretSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretSelectPositionInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_caretSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretSelectPositionInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_caretSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretSelectPositionInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_caretSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretSelectPositionInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_stringSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_stringSelectPositionInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_stringSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_stringSelectPositionInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_stringSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_stringSelectPositionInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_stringSelectPositionInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_stringSelectPositionInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_hasSelection_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_hasSelection", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_hasSelection_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_hasSelection", true), value);
        }

        public static event Delegates.get_caretPosition_WithArgs get_caretPosition
        {
            add => HookEndpointManager.Add<Delegates.get_caretPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_caretPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_caretPosition", true), value);
        }

        public static event Delegates.set_caretPosition_WithArgs set_caretPosition
        {
            add => HookEndpointManager.Add<Delegates.set_caretPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_caretPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_caretPosition", true), value);
        }

        public static event Delegates.get_selectionAnchorPosition_WithArgs get_selectionAnchorPosition
        {
            add => HookEndpointManager.Add<Delegates.get_selectionAnchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionAnchorPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_selectionAnchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionAnchorPosition", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_selectionAnchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionAnchorPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_selectionAnchorPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionAnchorPosition", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_selectionFocusPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionFocusPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_selectionFocusPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_selectionFocusPosition", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_selectionFocusPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionFocusPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_selectionFocusPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_selectionFocusPosition", true),
                value);
        }
        ...
        public static event Delegates.OnEnable_WithArgs OnEnable
        {
            add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnEnable", true), value);
        ...
        public static event Delegates.OnDisable_WithArgs OnDisable
        {
            add => HookEndpointManager.Add<Delegates.OnDisable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnDisable", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.CaretBlink_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "CaretBlink", true), value);
            remove => HookEndpointManager.Remove<Delegates.CaretBlink_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "CaretBlink", true), value);
        }

        public static event Delegates.SetCaretVisible_WithArgs SetCaretVisible
        {
            add => HookEndpointManager.Add<Delegates.SetCaretVisible_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetCaretVisible", true), value);
            remove => HookEndpointManager.Remove<Delegates.SetCaretVisible_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetCaretVisible", true), value);
        }

        public static event Delegates.SetCaretActive_WithArgs SetCaretActive
        {
            add => HookEndpointManager.Add<Delegates.SetCaretActive_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetCaretActive", true), value);
            remove => HookEndpointManager.Remove<Delegates.SetCaretActive_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetCaretActive", true), value);
        }

        public static event Delegates.OnFocus_WithArgs OnFocus
        {
            add => HookEndpointManager.Add<Delegates.OnFocus_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnFocus", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnFocus_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnFocus", true), value);
        }

        public static event Delegates.SelectAll_WithArgs SelectAll
        {
            add => HookEndpointManager.Add<Delegates.SelectAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SelectAll", true), value);
            remove => HookEndpointManager.Remove<Delegates.SelectAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SelectAll", true), value);
        }

        public static event Delegates.MoveTextEnd_WithArgs MoveTextEnd
        {
            add => HookEndpointManager.Add<Delegates.MoveTextEnd_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveTextEnd", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveTextEnd_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveTextEnd", true), value);
        }

        public static event Delegates.MoveTextStart_WithArgs MoveTextStart
        {
            add => HookEndpointManager.Add<Delegates.MoveTextStart_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveTextStart", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveTextStart_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveTextStart", true), value);
        }

        public static event Delegates.get_clipboard_WithArgs get_clipboard
        {
            add => HookEndpointManager.Add<Delegates.get_clipboard_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_clipboard", false), value);
            remove => HookEndpointManager.Remove<Delegates.get_clipboard_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "get_clipboard", false), value);
        }

        public static event Delegates.set_clipboard_WithArgs set_clipboard
        {
            add => HookEndpointManager.Add<Delegates.set_clipboard_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_clipboard", false), value);
            remove => HookEndpointManager.Remove<Delegates.set_clipboard_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "set_clipboard", false), value);
        }

        public static event Delegates.InPlaceEditing_WithArgs InPlaceEditing
        {
            add => HookEndpointManager.Add<Delegates.InPlaceEditing_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "InPlaceEditing", true), value);
            remove => HookEndpointManager.Remove<Delegates.InPlaceEditing_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "InPlaceEditing", true), value);
        }
        ...
        public static event Delegates.LateUpdate_WithArgs LateUpdate
        {
            add => HookEndpointManager.Add<Delegates.LateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LateUpdate", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetCharacterIndexFromPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetCharacterIndexFromPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.GetCharacterIndexFromPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetCharacterIndexFromPosition", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.MayDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MayDrag", true), value);
            remove => HookEndpointManager.Remove<Delegates.MayDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MayDrag", true), value);
        }

        public static event Delegates.OnBeginDrag_WithArgs OnBeginDrag
        {
            add => HookEndpointManager.Add<Delegates.OnBeginDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnBeginDrag", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnBeginDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnBeginDrag", true), value);
        }

        public static event Delegates.OnDrag_WithArgs OnDrag
        {
            add => HookEndpointManager.Add<Delegates.OnDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnDrag", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnDrag", true), value);
        }

        public static event Delegates.MouseDragOutsideRect_WithArgs MouseDragOutsideRect
        {
            add => HookEndpointManager.Add<Delegates.MouseDragOutsideRect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MouseDragOutsideRect", true), value);
            remove => HookEndpointManager.Remove<Delegates.MouseDragOutsideRect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MouseDragOutsideRect", true), value);
        }

        public static event Delegates.OnEndDrag_WithArgs OnEndDrag
        {
            add => HookEndpointManager.Add<Delegates.OnEndDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnEndDrag", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnEndDrag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnEndDrag", true), value);
        }

        public static event Delegates.OnPointerDown_WithArgs OnPointerDown
        {
            add => HookEndpointManager.Add<Delegates.OnPointerDown_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnPointerDown", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnPointerDown_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnPointerDown", true), value);
        }

        public static event Delegates.IsValidChar_WithArgs IsValidChar
        {
            add => HookEndpointManager.Add<Delegates.IsValidChar_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "IsValidChar", true), value);
            remove => HookEndpointManager.Remove<Delegates.IsValidChar_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "IsValidChar", true), value);
        }

        public static event Delegates.ProcessEvent_WithArgs ProcessEvent
        {
            add => HookEndpointManager.Add<Delegates.ProcessEvent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ProcessEvent", true), value);
            remove => HookEndpointManager.Remove<Delegates.ProcessEvent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ProcessEvent", true), value);
        }

        public static event Delegates.OnUpdateSelected_WithArgs OnUpdateSelected
        {
            add => HookEndpointManager.Add<Delegates.OnUpdateSelected_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnUpdateSelected", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnUpdateSelected_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnUpdateSelected", true), value);
        }

        public static event Delegates.GetSelectedString_WithArgs GetSelectedString
        {
            add => HookEndpointManager.Add<Delegates.GetSelectedString_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetSelectedString", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetSelectedString_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetSelectedString", true), value);
        }

        public static event Delegates.FindtNextWordBegin_WithArgs FindtNextWordBegin
        {
            add => HookEndpointManager.Add<Delegates.FindtNextWordBegin_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "FindtNextWordBegin", true), value);
            remove => HookEndpointManager.Remove<Delegates.FindtNextWordBegin_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "FindtNextWordBegin", true), value);
        }

        public static event Delegates.MoveRight_WithArgs MoveRight
        {
            add => HookEndpointManager.Add<Delegates.MoveRight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveRight", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveRight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveRight", true), value);
        }

        public static event Delegates.FindtPrevWordBegin_WithArgs FindtPrevWordBegin
        {
            add => HookEndpointManager.Add<Delegates.FindtPrevWordBegin_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "FindtPrevWordBegin", true), value);
            remove => HookEndpointManager.Remove<Delegates.FindtPrevWordBegin_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "FindtPrevWordBegin", true), value);
        }

        public static event Delegates.MoveLeft_WithArgs MoveLeft
        {
            add => HookEndpointManager.Add<Delegates.MoveLeft_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveLeft", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveLeft_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveLeft", true), value);
        }

        public static event Delegates.LineUpCharacterPosition_WithArgs LineUpCharacterPosition
        {
            add => HookEndpointManager.Add<Delegates.LineUpCharacterPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LineUpCharacterPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.LineUpCharacterPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LineUpCharacterPosition", true), value);
        }

        public static event Delegates.LineDownCharacterPosition_WithArgs LineDownCharacterPosition
        {
            add => HookEndpointManager.Add<Delegates.LineDownCharacterPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LineDownCharacterPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.LineDownCharacterPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LineDownCharacterPosition", true), value);
        }

        public static event Delegates.MoveDown_bool_WithArgs MoveDown_bool
        {
            add => HookEndpointManager.Add<Delegates.MoveDown_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveDown", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveDown_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveDown", true), value);
        }

        public static event Delegates.MoveDown_bool_bool_WithArgs MoveDown_bool_bool
        {
            add => HookEndpointManager.Add<Delegates.MoveDown_bool_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveDown", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveDown_bool_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveDown", true), value);
        }

        public static event Delegates.MoveUp_bool_WithArgs MoveUp_bool
        {
            add => HookEndpointManager.Add<Delegates.MoveUp_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveUp", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveUp_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveUp", true), value);
        }

        public static event Delegates.MoveUp_bool_bool_WithArgs MoveUp_bool_bool
        {
            add => HookEndpointManager.Add<Delegates.MoveUp_bool_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveUp", true), value);
            remove => HookEndpointManager.Remove<Delegates.MoveUp_bool_bool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MoveUp", true), value);
        }
        ...
        public static event Delegates.Delete_WithArgs Delete
        {
            add => HookEndpointManager.Add<Delegates.Delete_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Delete", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.ForwardSpace_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ForwardSpace", true), value);
            remove => HookEndpointManager.Remove<Delegates.ForwardSpace_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ForwardSpace", true), value);
        }

        public static event Delegates.Backspace_WithArgs Backspace
        {
            add => HookEndpointManager.Add<Delegates.Backspace_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Backspace", true), value);
            remove => HookEndpointManager.Remove<Delegates.Backspace_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Backspace", true), value);
        }

        public static event Delegates.Insert_WithArgs Insert
        {
            add => HookEndpointManager.Add<Delegates.Insert_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Insert", true), value);
            remove => HookEndpointManager.Remove<Delegates.Insert_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Insert", true), value);
        }

        public static event Delegates.SendOnValueChangedAndUpdateLabel_WithArgs SendOnValueChangedAndUpdateLabel
        {
            add => HookEndpointManager.Add<Delegates.SendOnValueChangedAndUpdateLabel_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnValueChangedAndUpdateLabel", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.SendOnValueChangedAndUpdateLabel_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnValueChangedAndUpdateLabel", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.SendOnValueChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnValueChanged", true), value);
            remove => HookEndpointManager.Remove<Delegates.SendOnValueChanged_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnValueChanged", true), value);
        }

        public static event Delegates.SendOnSubmit_WithArgs SendOnSubmit
        {
            add => HookEndpointManager.Add<Delegates.SendOnSubmit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnSubmit", true), value);
            remove => HookEndpointManager.Remove<Delegates.SendOnSubmit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnSubmit", true), value);
        }

        public static event Delegates.SendOnFocusLost_WithArgs SendOnFocusLost
        {
            add => HookEndpointManager.Add<Delegates.SendOnFocusLost_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnFocusLost", true), value);
            remove => HookEndpointManager.Remove<Delegates.SendOnFocusLost_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SendOnFocusLost", true), value);
        }
        ...
        public static event Delegates.Append_string_WithArgs Append_string
        {
            add => HookEndpointManager.Add<Delegates.Append_string_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Append", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.Append_Char_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Append", true), value);
            remove => HookEndpointManager.Remove<Delegates.Append_Char_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Append", true), value);
        }

        public static event Delegates.UpdateLabel_WithArgs UpdateLabel
        {
            add => HookEndpointManager.Add<Delegates.UpdateLabel_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "UpdateLabel", true), value);
            remove => HookEndpointManager.Remove<Delegates.UpdateLabel_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "UpdateLabel", true), value);
        }

        public static event Delegates.GetCaretPositionFromStringIndex_WithArgs GetCaretPositionFromStringIndex
        {
            add => HookEndpointManager.Add<Delegates.GetCaretPositionFromStringIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetCaretPositionFromStringIndex", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.GetCaretPositionFromStringIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetCaretPositionFromStringIndex", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetStringIndexFromCaretPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetStringIndexFromCaretPosition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.GetStringIndexFromCaretPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GetStringIndexFromCaretPosition", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.ForceLabelUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ForceLabelUpdate", true), value);
            remove => HookEndpointManager.Remove<Delegates.ForceLabelUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ForceLabelUpdate", true), value);
        }

        public static event Delegates.MarkGeometryAsDirty_WithArgs MarkGeometryAsDirty
        {
            add => HookEndpointManager.Add<Delegates.MarkGeometryAsDirty_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MarkGeometryAsDirty", true), value);
            remove => HookEndpointManager.Remove<Delegates.MarkGeometryAsDirty_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "MarkGeometryAsDirty", true), value);
        }
        ...
        public static event Delegates.Rebuild_WithArgs Rebuild
        {
            add => HookEndpointManager.Add<Delegates.Rebuild_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Rebuild", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.LayoutComplete_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LayoutComplete", true), value);
            remove => HookEndpointManager.Remove<Delegates.LayoutComplete_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "LayoutComplete", true), value);
        }

        public static event Delegates.GraphicUpdateComplete_WithArgs GraphicUpdateComplete
        {
            add => HookEndpointManager.Add<Delegates.GraphicUpdateComplete_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GraphicUpdateComplete", true), value);
            remove => HookEndpointManager.Remove<Delegates.GraphicUpdateComplete_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GraphicUpdateComplete", true), value);
        }
        ...
        public static event Delegates.UpdateGeometry_WithArgs UpdateGeometry
        {
            add => HookEndpointManager.Add<Delegates.UpdateGeometry_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "UpdateGeometry", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.AssignPositioningIfNeeded_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "AssignPositioningIfNeeded", true), value);
            remove => HookEndpointManager.Remove<Delegates.AssignPositioningIfNeeded_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "AssignPositioningIfNeeded", true), value);
        }

        public static event Delegates.OnFillVBO_WithArgs OnFillVBO
        {
            add => HookEndpointManager.Add<Delegates.OnFillVBO_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnFillVBO", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnFillVBO_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnFillVBO", true), value);
        }

        public static event Delegates.GenerateCaret_WithArgs GenerateCaret
        {
            add => HookEndpointManager.Add<Delegates.GenerateCaret_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GenerateCaret", true), value);
            remove => HookEndpointManager.Remove<Delegates.GenerateCaret_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GenerateCaret", true), value);
        }

        public static event Delegates.CreateCursorVerts_WithArgs CreateCursorVerts
        {
            add => HookEndpointManager.Add<Delegates.CreateCursorVerts_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "CreateCursorVerts", true), value);
            remove => HookEndpointManager.Remove<Delegates.CreateCursorVerts_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "CreateCursorVerts", true), value);
        }

        public static event Delegates.GenerateHightlight_WithArgs GenerateHightlight
        {
            add => HookEndpointManager.Add<Delegates.GenerateHightlight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GenerateHightlight", true), value);
            remove => HookEndpointManager.Remove<Delegates.GenerateHightlight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "GenerateHightlight", true), value);
        }

        public static event Delegates.AdjustRectTransformRelativeToViewport_WithArgs
            AdjustRectTransformRelativeToViewport
            {
                add => HookEndpointManager.Add<Delegates.AdjustRectTransformRelativeToViewport_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField),
                        "AdjustRectTransformRelativeToViewport", true), value);
                remove => HookEndpointManager.Remove<Delegates.AdjustRectTransformRelativeToViewport_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField),
                        "AdjustRectTransformRelativeToViewport", true), value);
            }
        ...
        {
            add => HookEndpointManager.Add<Delegates.Validate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Validate", true), value);
            remove => HookEndpointManager.Remove<Delegates.Validate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "Validate", true), value);
        }

        public static event Delegates.ActivateInputField_WithArgs ActivateInputField
        {
            add => HookEndpointManager.Add<Delegates.ActivateInputField_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ActivateInputField", true), value);
            remove => HookEndpointManager.Remove<Delegates.ActivateInputField_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ActivateInputField", true), value);
        }

        public static event Delegates.ActivateInputFieldInternal_WithArgs ActivateInputFieldInternal
        {
            add => HookEndpointManager.Add<Delegates.ActivateInputFieldInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ActivateInputFieldInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.ActivateInputFieldInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "ActivateInputFieldInternal", true),
                value);
        }
        ...
        public static event Delegates.OnSelect_WithArgs OnSelect
        {
            add => HookEndpointManager.Add<Delegates.OnSelect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnSelect", true), value);
        ...
        public static event Delegates.OnPointerClick_WithArgs OnPointerClick
        {
            add => HookEndpointManager.Add<Delegates.OnPointerClick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnPointerClick", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DeactivateInputField_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "DeactivateInputField", true), value);
            remove => HookEndpointManager.Remove<Delegates.DeactivateInputField_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "DeactivateInputField", true), value);
        }
        ...
        public static event Delegates.OnDeselect_WithArgs OnDeselect
        {
            add => HookEndpointManager.Add<Delegates.OnDeselect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnDeselect", true), value);
        ...
        public static event Delegates.OnSubmit_WithArgs OnSubmit
        {
            add => HookEndpointManager.Add<Delegates.OnSubmit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "OnSubmit", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.EnforceContentType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "EnforceContentType", true), value);
            remove => HookEndpointManager.Remove<Delegates.EnforceContentType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "EnforceContentType", true), value);
        }

        public static event Delegates.SetTextComponentWrapMode_WithArgs SetTextComponentWrapMode
        {
            add => HookEndpointManager.Add<Delegates.SetTextComponentWrapMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetTextComponentWrapMode", true), value);
            remove => HookEndpointManager.Remove<Delegates.SetTextComponentWrapMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetTextComponentWrapMode", true), value);
        }

        public static event Delegates.SetTextComponentRichTextMode_WithArgs SetTextComponentRichTextMode
        {
            add => HookEndpointManager.Add<Delegates.SetTextComponentRichTextMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetTextComponentRichTextMode", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.SetTextComponentRichTextMode_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetTextComponentRichTextMode", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.SetToCustomIfContentTypeIsNot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetToCustomIfContentTypeIsNot", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.SetToCustomIfContentTypeIsNot_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetToCustomIfContentTypeIsNot", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.SetToCustom_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetToCustom", true), value);
            remove => HookEndpointManager.Remove<Delegates.SetToCustom_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField), "SetToCustom", true), value);
        }
        ...
        public static event Delegates.get_transform_WithArgs get_transform
        {
            add => HookEndpointManager.Add<Delegates.get_transform_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_InputField),
                    "UnityEngine.UI.ICanvasElement.get_transform", true), value);
