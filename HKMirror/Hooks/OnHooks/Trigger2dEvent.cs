...
public static class OnTrigger2dEvent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.Trigger2dEvent> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.Trigger2dEvent> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.Trigger2dEvent> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent),
        ...
        private static void StoreCollisionInfo(
            Action<HutongGames.PlayMaker.Actions.Trigger2dEvent, UnityEngine.Collider2D> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self, UnityEngine.Collider2D collisionInfo)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.Trigger2dEvent, string> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.Trigger2dEvent> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.Trigger2dEvent> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.Trigger2dEvent> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.Trigger2dEvent, string> orig,
            HutongGames.PlayMaker.Actions.Trigger2dEvent self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "OnExit", true),
                value);
        ...
        public static event Delegates.DoTriggerEnter2D_WithArgs DoTriggerEnter2D
        {
            add => HookEndpointManager.Add<Delegates.DoTriggerEnter2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "DoTriggerEnter2D",
                    true), value);
        ...
        public static event Delegates.DoTriggerStay2D_WithArgs DoTriggerStay2D
        {
            add => HookEndpointManager.Add<Delegates.DoTriggerStay2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "DoTriggerStay2D",
                    true), value);
        ...
        public static event Delegates.DoTriggerExit2D_WithArgs DoTriggerExit2D
        {
            add => HookEndpointManager.Add<Delegates.DoTriggerExit2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Trigger2dEvent), "DoTriggerExit2D",
                    true), value);
