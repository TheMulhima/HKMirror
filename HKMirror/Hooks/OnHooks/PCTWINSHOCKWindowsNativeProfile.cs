...
public static class OnPCTWINSHOCKWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PCTWINSHOCKWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PCTWINSHOCKWindowsNativeProfile> orig, PCTWINSHOCKWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PCTWINSHOCKWindowsNativeProfile> orig,
            PCTWINSHOCKWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public PCTWINSHOCKWindowsNativeProfile self;
        }
    }
