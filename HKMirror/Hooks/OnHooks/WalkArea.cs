...
private static void OnTriggerEnter2D(On.WalkArea.orig_OnTriggerEnter2D orig,WalkArea self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerStay2D(On.WalkArea.orig_OnTriggerStay2D orig,WalkArea self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerExit2D(On.WalkArea.orig_OnTriggerExit2D orig,WalkArea self,  UnityEngine.Collider2D otherCollider)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<WalkArea,  UnityEngine.Collider2D> orig, WalkArea self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerStay2D_WithArgs (Action<WalkArea,  UnityEngine.Collider2D> orig, WalkArea self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerExit2D_WithArgs (Action<WalkArea,  UnityEngine.Collider2D> orig, WalkArea self,  UnityEngine.Collider2D otherCollider);
