...
public static class OnDeviceBindingSourceListener
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<InControl.DeviceBindingSourceListener> orig,
            InControl.DeviceBindingSourceListener self)
        {
        ...
        internal static void HookListen()
        {
            if (!HookedList.Contains("Listen"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "Listen", true),
                    Listen);
            }
        }
        ...
        private static InControl.BindingSource Listen(
            Func<InControl.DeviceBindingSourceListener, InControl.BindingListenOptions, InControl.InputDevice,
                InControl.BindingSource> orig, InControl.DeviceBindingSourceListener self,
        ...
        internal static void HookIsPressed_InputControl()
        {
            if (!HookedList.Contains("IsPressed_InputControl"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener),
                        "IsPressed_InputControl", true), IsPressed_InputControl);
            }
        }
        ...
        private static bool IsPressed_InputControl(
            Func<InControl.DeviceBindingSourceListener, InControl.InputControl, bool> orig,
            InControl.DeviceBindingSourceListener self, InControl.InputControl control)
        {
            ...
            {
                foreach (Delegates.IsPressed_InputControl_BeforeArgs toInvoke in _beforeIsPressed_InputControl
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.IsPressed_InputControl_AfterArgs toInvoke in _afterIsPressed_InputControl
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookIsPressed_InputControlType_InputDevice()
        {
            if (!HookedList.Contains("IsPressed_InputControlType_InputDevice"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener),
                        "IsPressed_InputControlType_InputDevice", true), IsPressed_InputControlType_InputDevice);
            }
        }
        ...
        internal static event Delegates.IsPressed_InputControlType_InputDevice_AfterArgs
            _afterIsPressed_InputControlType_InputDevice;

        private static bool IsPressed_InputControlType_InputDevice(
            Func<InControl.DeviceBindingSourceListener, InControl.InputControlType, InControl.InputDevice, bool> orig,
            InControl.DeviceBindingSourceListener self, InControl.InputControlType control,
            InControl.InputDevice device)
        {
            ...
            {
                foreach (Delegates.IsPressed_InputControlType_InputDevice_BeforeArgs toInvoke in
                         _beforeIsPressed_InputControlType_InputDevice.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.IsPressed_InputControlType_InputDevice_AfterArgs toInvoke in
                         _afterIsPressed_InputControlType_InputDevice.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookListenForControl()
        {
            if (!HookedList.Contains("ListenForControl"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "ListenForControl",
                        true), ListenForControl);
            }
        }
        ...
        private static InControl.InputControlType ListenForControl(
            Func<InControl.DeviceBindingSourceListener, InControl.BindingListenOptions, InControl.InputDevice,
                InControl.InputControlType> orig, InControl.DeviceBindingSourceListener self,
            InControl.BindingListenOptions listenOptions, InControl.InputDevice device)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<InControl.DeviceBindingSourceListener> orig,
            InControl.DeviceBindingSourceListener self);
        ...
        public delegate bool IsPressed_InputControl_WithArgs(
            Func<InControl.DeviceBindingSourceListener, InControl.InputControl, bool> orig,
            InControl.DeviceBindingSourceListener self, InControl.InputControl control);
        ...
        public delegate bool IsPressed_InputControlType_InputDevice_AfterArgs(
            Params_IsPressed_InputControlType_InputDevice args, bool ret);

        public delegate bool IsPressed_InputControlType_InputDevice_WithArgs(
            Func<InControl.DeviceBindingSourceListener, InControl.InputControlType, InControl.InputDevice, bool> orig,
            InControl.DeviceBindingSourceListener self, InControl.InputControlType control,
            InControl.InputDevice device);
        ...
        public delegate InControl.InputControlType ListenForControl_AfterArgs(Params_ListenForControl args,
            InControl.InputControlType ret);

        public delegate InControl.InputControlType ListenForControl_WithArgs(
            Func<InControl.DeviceBindingSourceListener, InControl.BindingListenOptions, InControl.InputDevice,
                InControl.InputControlType> orig, InControl.DeviceBindingSourceListener self,
            InControl.BindingListenOptions listenOptions, InControl.InputDevice device);
    }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.IsPressed_InputControlType_InputDevice_AfterArgs
            IsPressed_InputControlType_InputDevice
            {
                add
                {
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "Reset", true), value);
        ...
        public static event Delegates.Listen_WithArgs Listen
        {
            add => HookEndpointManager.Add<Delegates.Listen_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "Listen", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.IsPressed_InputControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "IsPressed", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.IsPressed_InputControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "IsPressed", true),
                value);
        }

        public static event Delegates.IsPressed_InputControlType_InputDevice_WithArgs
            IsPressed_InputControlType_InputDevice
            {
                add => HookEndpointManager.Add<Delegates.IsPressed_InputControlType_InputDevice_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "IsPressed", true),
                    value);
                remove => HookEndpointManager.Remove<Delegates.IsPressed_InputControlType_InputDevice_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "IsPressed", true),
                    value);
            }
        ...
        public static event Delegates.ListenForControl_WithArgs ListenForControl
        {
            add => HookEndpointManager.Add<Delegates.ListenForControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.DeviceBindingSourceListener), "ListenForControl", true),
                value);
