...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_IsBossScene", false), get_IsBossScene);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_HasTransitionedIn", true), get_HasTransitionedIn);
...
{
foreach (Delegates.get_HasTransitionedIn_BeforeArgs toInvoke in _beforeget_HasTransitionedIn.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_HasTransitionedIn_AfterArgs toInvoke in _afterget_HasTransitionedIn.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_HasTransitionedIn", true), set_HasTransitionedIn);
...
private static void set_HasTransitionedIn(Action<BossSceneController,  bool> orig, BossSceneController self,  bool value)
{
...
{
foreach (Delegates.set_HasTransitionedIn_BeforeArgs toInvoke in _beforeset_HasTransitionedIn.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_HasTransitionedIn_AfterArgs toInvoke in _afterset_HasTransitionedIn.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_IsTransitioning", false), get_IsTransitioning);
...
{
foreach (Delegates.get_IsTransitioning_BeforeArgs toInvoke in _beforeget_IsTransitioning.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsTransitioning_AfterArgs toInvoke in _afterget_IsTransitioning.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_CanTransition", true), get_CanTransition);
...
{
foreach (Delegates.get_CanTransition_BeforeArgs toInvoke in _beforeget_CanTransition.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_CanTransition", true), set_CanTransition);
...
private static void set_CanTransition(Action<BossSceneController,  bool> orig, BossSceneController self,  bool value)
{
...
{
foreach (Delegates.set_CanTransition_BeforeArgs toInvoke in _beforeset_CanTransition.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_BossLevel", true), get_BossLevel);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossLevel", true), set_BossLevel);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_DreamReturnEvent", true), get_DreamReturnEvent);
...
{
foreach (Delegates.get_DreamReturnEvent_BeforeArgs toInvoke in _beforeget_DreamReturnEvent.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_DreamReturnEvent_AfterArgs toInvoke in _afterget_DreamReturnEvent.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_DreamReturnEvent", true), set_DreamReturnEvent);
...
private static void set_DreamReturnEvent(Action<BossSceneController,  string> orig, BossSceneController self,  string value)
{
...
{
foreach (Delegates.set_DreamReturnEvent_BeforeArgs toInvoke in _beforeset_DreamReturnEvent.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_DreamReturnEvent_AfterArgs toInvoke in _afterset_DreamReturnEvent.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_BossHealthLookup", true), get_BossHealthLookup);
...
private static System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails> get_BossHealthLookup(Func<BossSceneController, System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails>> orig, BossSceneController self)
{
...
{
foreach (Delegates.get_BossHealthLookup_BeforeArgs toInvoke in _beforeget_BossHealthLookup.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_BossHealthLookup_AfterArgs toInvoke in _afterget_BossHealthLookup.GetInvocationList())
{
try
{
...
internal static void Hookset_BossHealthLookup()
{
if (!HookedList.Contains("set_BossHealthLookup"))
{
HookedList.Add("set_BossHealthLookup");
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossHealthLookup", true), set_BossHealthLookup);

}
}
internal static event Delegates.set_BossHealthLookup_BeforeArgs _beforeset_BossHealthLookup;
internal static event Delegates.set_BossHealthLookup_AfterArgs _afterset_BossHealthLookup;
private static void set_BossHealthLookup(Action<BossSceneController,  System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails>> orig, BossSceneController self,  System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails> value)
{
Delegates.Params_set_BossHealthLookup @params = new() 
{
self = self
, value = value
};
if (_beforeset_BossHealthLookup != null)
{
foreach (Delegates.set_BossHealthLookup_BeforeArgs toInvoke in _beforeset_BossHealthLookup.GetInvocationList())
{
try
{
_beforeset_BossHealthLookup?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
value = @params.value;
orig(self, value);
if (_afterset_BossHealthLookup != null)
{
foreach (Delegates.set_BossHealthLookup_AfterArgs toInvoke in _afterset_BossHealthLookup.GetInvocationList())
{
try
{
_afterset_BossHealthLookup.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
private static System.Collections.IEnumerator Start(On.BossSceneController.orig_Start orig,BossSceneController self)
{
...
private static void SetKnightDamaged(On.BossSceneController.orig_SetKnightDamaged orig,BossSceneController self)
{
...
private static System.Collections.IEnumerator EndSceneDelayed(On.BossSceneController.orig_EndSceneDelayed orig,BossSceneController self)
{
...
private static void ReportHealth(On.BossSceneController.orig_ReportHealth orig, HealthManager healthManager,  int baseHP,  int adjustedHP,  bool forceAdd)
{
...
public delegate bool get_HasTransitionedIn_WithArgs (Func<BossSceneController, bool> orig, BossSceneController self);
...
public delegate void set_HasTransitionedIn_WithArgs (Action<BossSceneController,  bool> orig, BossSceneController self,  bool value);
...
public delegate void set_CanTransition_WithArgs (Action<BossSceneController,  bool> orig, BossSceneController self,  bool value);
...
public delegate void set_BossLevel_WithArgs (Action<BossSceneController,  int> orig, BossSceneController self,  int value);
...
public delegate string get_DreamReturnEvent_WithArgs (Func<BossSceneController, string> orig, BossSceneController self);
...
public delegate void set_DreamReturnEvent_WithArgs (Action<BossSceneController,  string> orig, BossSceneController self,  string value);
...
public delegate System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails> get_BossHealthLookup_AfterArgs(Params_get_BossHealthLookup args, System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails> ret);
public delegate System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails> get_BossHealthLookup_WithArgs (Func<BossSceneController, System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails>> orig, BossSceneController self);
public sealed class Params_set_BossHealthLookup
{
public BossSceneController self;
public System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails> value;
}
public delegate void set_BossHealthLookup_BeforeArgs(Params_set_BossHealthLookup args);
public delegate void set_BossHealthLookup_AfterArgs(Params_set_BossHealthLookup args);
public delegate void set_BossHealthLookup_WithArgs (Action<BossSceneController,  System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails>> orig, BossSceneController self,  System.Collections.Generic.Dictionary<HealthManager,BossSceneController.BossHealthDetails> value);
...
public delegate System.Collections.IEnumerator Start_WithArgs (Func<BossSceneController, System.Collections.IEnumerator> orig, BossSceneController self);
...
public delegate System.Collections.IEnumerator EndSceneDelayed_AfterArgs(Params_EndSceneDelayed args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator EndSceneDelayed_WithArgs (Func<BossSceneController, System.Collections.IEnumerator> orig, BossSceneController self);
...
public delegate void ReportHealth_WithArgs (Action< HealthManager,  int,  int,  bool> orig,  HealthManager healthManager,  int baseHP,  int adjustedHP,  bool forceAdd);
}
...
public static event Delegates.set_BossHealthLookup_BeforeArgs set_BossHealthLookup
{
add
{

HookHandler._beforeset_BossHealthLookup += value;
HookHandler.Hookset_BossHealthLookup();
}
remove => HookHandler._beforeset_BossHealthLookup -= value;
}
...
public static event Delegates.set_BossHealthLookup_AfterArgs set_BossHealthLookup
{
add
{

HookHandler._afterset_BossHealthLookup += value;
HookHandler.Hookset_BossHealthLookup();
}
remove => HookHandler._afterset_BossHealthLookup -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsBossScene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_IsBossScene", false), value);
remove => HookEndpointManager.Remove<Delegates.get_IsBossScene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_IsBossScene", false), value);
}
public static event Delegates.get_HasTransitionedIn_WithArgs get_HasTransitionedIn
{
add => HookEndpointManager.Add<Delegates.get_HasTransitionedIn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_HasTransitionedIn", true), value);
remove => HookEndpointManager.Remove<Delegates.get_HasTransitionedIn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_HasTransitionedIn", true), value);
}
public static event Delegates.set_HasTransitionedIn_WithArgs set_HasTransitionedIn
{
add => HookEndpointManager.Add<Delegates.set_HasTransitionedIn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_HasTransitionedIn", true), value);
remove => HookEndpointManager.Remove<Delegates.set_HasTransitionedIn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_HasTransitionedIn", true), value);
}
public static event Delegates.get_IsTransitioning_WithArgs get_IsTransitioning
{
add => HookEndpointManager.Add<Delegates.get_IsTransitioning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_IsTransitioning", false), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTransitioning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_IsTransitioning", false), value);
}
public static event Delegates.get_CanTransition_WithArgs get_CanTransition
{
add => HookEndpointManager.Add<Delegates.get_CanTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_CanTransition", true), value);
remove => HookEndpointManager.Remove<Delegates.get_CanTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_CanTransition", true), value);
}
public static event Delegates.set_CanTransition_WithArgs set_CanTransition
{
add => HookEndpointManager.Add<Delegates.set_CanTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_CanTransition", true), value);
remove => HookEndpointManager.Remove<Delegates.set_CanTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_CanTransition", true), value);
}
public static event Delegates.get_BossLevel_WithArgs get_BossLevel
{
add => HookEndpointManager.Add<Delegates.get_BossLevel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_BossLevel", true), value);
remove => HookEndpointManager.Remove<Delegates.get_BossLevel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_BossLevel", true), value);
}
public static event Delegates.set_BossLevel_WithArgs set_BossLevel
{
add => HookEndpointManager.Add<Delegates.set_BossLevel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossLevel", true), value);
remove => HookEndpointManager.Remove<Delegates.set_BossLevel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossLevel", true), value);
}
public static event Delegates.get_DreamReturnEvent_WithArgs get_DreamReturnEvent
{
add => HookEndpointManager.Add<Delegates.get_DreamReturnEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_DreamReturnEvent", true), value);
remove => HookEndpointManager.Remove<Delegates.get_DreamReturnEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_DreamReturnEvent", true), value);
}
public static event Delegates.set_DreamReturnEvent_WithArgs set_DreamReturnEvent
{
add => HookEndpointManager.Add<Delegates.set_DreamReturnEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_DreamReturnEvent", true), value);
remove => HookEndpointManager.Remove<Delegates.set_DreamReturnEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_DreamReturnEvent", true), value);
}
public static event Delegates.get_BossHealthLookup_WithArgs get_BossHealthLookup
{
add => HookEndpointManager.Add<Delegates.get_BossHealthLookup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_BossHealthLookup", true), value);
remove => HookEndpointManager.Remove<Delegates.get_BossHealthLookup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "get_BossHealthLookup", true), value);
}
public static event Delegates.set_BossHealthLookup_WithArgs set_BossHealthLookup
{
add => HookEndpointManager.Add<Delegates.set_BossHealthLookup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossHealthLookup", true), value);
remove => HookEndpointManager.Remove<Delegates.set_BossHealthLookup_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossHealthLookup", true), value);
}
