...
public static class OnBossSceneController
{
    internal static class HookHandler
    {
        ...
        internal static void Hookset_BossHealthLookup()
        {
            if (!HookedList.Contains("set_BossHealthLookup"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossHealthLookup"),
                    set_BossHealthLookup);
            }
        }
        ...
        private static void set_BossHealthLookup(
            Action<BossSceneController, Dictionary<HealthManager, BossSceneController.BossHealthDetails>> orig,
            BossSceneController self, Dictionary<HealthManager, BossSceneController.BossHealthDetails> value)
        {
            ...
            if (_beforeset_BossHealthLookup != null)
                foreach (Delegates.set_BossHealthLookup_BeforeArgs toInvoke in _beforeset_BossHealthLookup
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterset_BossHealthLookup != null)
                foreach (Delegates.set_BossHealthLookup_AfterArgs toInvoke in _afterset_BossHealthLookup
                             .GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator EndSceneDelayed_AfterArgs(Params_EndSceneDelayed args, IEnumerator ret);

        public delegate void EndSceneDelayed_BeforeArgs(Params_EndSceneDelayed args);

        public delegate IEnumerator EndSceneDelayed_WithArgs(Func<BossSceneController, IEnumerator> orig,
            BossSceneController self);

        public delegate Dictionary<HealthManager, BossSceneController.BossHealthDetails> get_BossHealthLookup_AfterArgs(
            Params_get_BossHealthLookup args, Dictionary<HealthManager, BossSceneController.BossHealthDetails> ret);

        public delegate void get_BossHealthLookup_BeforeArgs(Params_get_BossHealthLookup args);

        public delegate Dictionary<HealthManager, BossSceneController.BossHealthDetails> get_BossHealthLookup_WithArgs(
            Func<BossSceneController, Dictionary<HealthManager, BossSceneController.BossHealthDetails>> orig,
            BossSceneController self);
        ...
        public delegate void set_BossHealthLookup_WithArgs(
            Action<BossSceneController, Dictionary<HealthManager, BossSceneController.BossHealthDetails>> orig,
            BossSceneController self, Dictionary<HealthManager, BossSceneController.BossHealthDetails> value);
        ...
        public delegate IEnumerator Start_WithArgs(Func<BossSceneController, IEnumerator> orig,
            BossSceneController self);
        ...
        {
            public BossSceneController self;
            public Dictionary<HealthManager, BossSceneController.BossHealthDetails> value;
        }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_BossHealthLookup_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossHealthLookup"), value);
            remove => HookEndpointManager.Remove<Delegates.set_BossHealthLookup_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossSceneController), "set_BossHealthLookup"), value);
        }
