...
public static class OnPlayerAction
{
    internal static class HookHandler
    {
        ...
        private static void set_Name(Action<InControl.PlayerAction, string> orig, InControl.PlayerAction self,
            string value)
        {
        ...
        private static InControl.PlayerActionSet get_Owner(Func<InControl.PlayerAction, InControl.PlayerActionSet> orig,
            InControl.PlayerAction self)
        {
        ...
        private static void set_Owner(Action<InControl.PlayerAction, InControl.PlayerActionSet> orig,
            InControl.PlayerAction self, InControl.PlayerActionSet value)
        {
        ...
        internal static void Hookget_UserData()
        {
            if (!HookedList.Contains("get_UserData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_UserData", true),
                    get_UserData);
            }
        }
        ...
        private static System.Object get_UserData(Func<InControl.PlayerAction, System.Object> orig,
            InControl.PlayerAction self)
        {
        ...
        internal static void Hookset_UserData()
        {
            if (!HookedList.Contains("set_UserData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_UserData", true),
                    set_UserData);
            }
        }
        ...
        private static void set_UserData(Action<InControl.PlayerAction, System.Object> orig,
            InControl.PlayerAction self, System.Object value)
        {
        ...
        internal static void HookAddDefaultBinding_BindingSource()
        {
            if (!HookedList.Contains("AddDefaultBinding_BindingSource"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding_BindingSource",
                        true), AddDefaultBinding_BindingSource);
            }
        }
        ...
        private static void AddDefaultBinding_BindingSource(
            Action<InControl.PlayerAction, InControl.BindingSource> orig, InControl.PlayerAction self,
            InControl.BindingSource binding)
        {
            ...
            {
                foreach (Delegates.AddDefaultBinding_BindingSource_BeforeArgs toInvoke in
                         _beforeAddDefaultBinding_BindingSource.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddDefaultBinding_BindingSource_AfterArgs toInvoke in
                         _afterAddDefaultBinding_BindingSource.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddDefaultBinding_Array()
        {
            if (!HookedList.Contains("AddDefaultBinding_Array"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding_Array", true),
        ...
        private static void AddDefaultBinding_Array(Action<InControl.PlayerAction, InControl.Key[]> orig,
            InControl.PlayerAction self, InControl.Key[] keys)
        {
            ...
            {
                foreach (Delegates.AddDefaultBinding_Array_BeforeArgs toInvoke in _beforeAddDefaultBinding_Array
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddDefaultBinding_Array_AfterArgs toInvoke in _afterAddDefaultBinding_Array
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddDefaultBinding_KeyCombo()
        {
            if (!HookedList.Contains("AddDefaultBinding_KeyCombo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding_KeyCombo", true),
        ...
        private static void AddDefaultBinding_KeyCombo(Action<InControl.PlayerAction, InControl.KeyCombo> orig,
            InControl.PlayerAction self, InControl.KeyCombo keyCombo)
        {
            ...
            {
                foreach (Delegates.AddDefaultBinding_KeyCombo_BeforeArgs toInvoke in _beforeAddDefaultBinding_KeyCombo
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddDefaultBinding_KeyCombo_AfterArgs toInvoke in _afterAddDefaultBinding_KeyCombo
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddDefaultBinding_Mouse()
        {
            if (!HookedList.Contains("AddDefaultBinding_Mouse"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding_Mouse", true),
        ...
        private static void AddDefaultBinding_Mouse(Action<InControl.PlayerAction, InControl.Mouse> orig,
            InControl.PlayerAction self, InControl.Mouse control)
        {
            ...
            {
                foreach (Delegates.AddDefaultBinding_Mouse_BeforeArgs toInvoke in _beforeAddDefaultBinding_Mouse
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddDefaultBinding_Mouse_AfterArgs toInvoke in _afterAddDefaultBinding_Mouse
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddDefaultBinding_InputControlType()
        {
            if (!HookedList.Contains("AddDefaultBinding_InputControlType"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding_InputControlType",
                        true), AddDefaultBinding_InputControlType);
            }
        }
        ...
        internal static event Delegates.AddDefaultBinding_InputControlType_AfterArgs
            _afterAddDefaultBinding_InputControlType;

        private static void AddDefaultBinding_InputControlType(
            Action<InControl.PlayerAction, InControl.InputControlType> orig, InControl.PlayerAction self,
            InControl.InputControlType control)
        {
            ...
            {
                foreach (Delegates.AddDefaultBinding_InputControlType_BeforeArgs toInvoke in
                         _beforeAddDefaultBinding_InputControlType.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddDefaultBinding_InputControlType_AfterArgs toInvoke in
                         _afterAddDefaultBinding_InputControlType.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddBinding()
        {
            if (!HookedList.Contains("AddBinding"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddBinding", true),
                    AddBinding);
            }
        }
        ...
        private static bool AddBinding(Func<InControl.PlayerAction, InControl.BindingSource, bool> orig,
            InControl.PlayerAction self, InControl.BindingSource binding)
        {
        ...
        internal static void HookInsertBindingAt()
        {
            if (!HookedList.Contains("InsertBindingAt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "InsertBindingAt", true),
                    InsertBindingAt);
            }
        }
        ...
        private static bool InsertBindingAt(Func<InControl.PlayerAction, int, InControl.BindingSource, bool> orig,
            InControl.PlayerAction self, int index, InControl.BindingSource binding)
        {
        ...
        internal static void HookReplaceBinding()
        {
            if (!HookedList.Contains("ReplaceBinding"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ReplaceBinding", true),
                    ReplaceBinding);
            }
        }
        ...
        private static bool ReplaceBinding(
            Func<InControl.PlayerAction, InControl.BindingSource, InControl.BindingSource, bool> orig,
            InControl.PlayerAction self, InControl.BindingSource findBinding, InControl.BindingSource withBinding)
        {
        ...
        internal static void HookHasBinding()
        {
            if (!HookedList.Contains("HasBinding"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "HasBinding", true),
                    HasBinding);
            }
        }
        ...
        private static bool HasBinding(Func<InControl.PlayerAction, InControl.BindingSource, bool> orig,
            InControl.PlayerAction self, InControl.BindingSource binding)
        {
        ...
        internal static void HookFindBinding()
        {
            if (!HookedList.Contains("FindBinding"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "FindBinding", true),
                    FindBinding);
            }
        }
        ...
        private static InControl.BindingSource FindBinding(
            Func<InControl.PlayerAction, InControl.BindingSource, InControl.BindingSource> orig,
            InControl.PlayerAction self, InControl.BindingSource binding)
        {
        ...
        internal static void HookHardRemoveBinding()
        {
            if (!HookedList.Contains("HardRemoveBinding"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "HardRemoveBinding", true),
                    HardRemoveBinding);
            }
        }
        ...
        private static void HardRemoveBinding(Action<InControl.PlayerAction, InControl.BindingSource> orig,
            InControl.PlayerAction self, InControl.BindingSource binding)
        {
            ...
            {
                foreach (Delegates.HardRemoveBinding_BeforeArgs toInvoke in
                         _beforeHardRemoveBinding.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookRemoveBinding()
        {
            if (!HookedList.Contains("RemoveBinding"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveBinding", true),
                    RemoveBinding);
            }
        }
        ...
        private static void RemoveBinding(Action<InControl.PlayerAction, InControl.BindingSource> orig,
            InControl.PlayerAction self, InControl.BindingSource binding)
        {
        ...
        internal static void HookRemoveBindingAt()
        {
            if (!HookedList.Contains("RemoveBindingAt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveBindingAt", true),
                    RemoveBindingAt);
            }
        }
        ...
        private static void RemoveBindingAt(Action<InControl.PlayerAction, int> orig, InControl.PlayerAction self,
            int index)
        {
        ...
        internal static void HookCountBindingsOfType()
        {
            if (!HookedList.Contains("CountBindingsOfType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "CountBindingsOfType", true),
                    CountBindingsOfType);
            }
        }
        ...
        private static int CountBindingsOfType(Func<InControl.PlayerAction, InControl.BindingSourceType, int> orig,
            InControl.PlayerAction self, InControl.BindingSourceType bindingSourceType)
        {
            ...
            {
                foreach (Delegates.CountBindingsOfType_BeforeArgs toInvoke in _beforeCountBindingsOfType
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CountBindingsOfType_AfterArgs toInvoke in
                         _afterCountBindingsOfType.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookRemoveFirstBindingOfType()
        {
            if (!HookedList.Contains("RemoveFirstBindingOfType"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveFirstBindingOfType", true),
        ...
        private static void RemoveFirstBindingOfType(Action<InControl.PlayerAction, InControl.BindingSourceType> orig,
            InControl.PlayerAction self, InControl.BindingSourceType bindingSourceType)
        {
            ...
            {
                foreach (Delegates.RemoveFirstBindingOfType_BeforeArgs toInvoke in _beforeRemoveFirstBindingOfType
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.RemoveFirstBindingOfType_AfterArgs toInvoke in _afterRemoveFirstBindingOfType
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookIndexOfFirstInvalidBinding()
        {
            if (!HookedList.Contains("IndexOfFirstInvalidBinding"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "IndexOfFirstInvalidBinding", true),
        ...
        private static int IndexOfFirstInvalidBinding(Func<InControl.PlayerAction, int> orig,
            InControl.PlayerAction self)
        {
            ...
            {
                foreach (Delegates.IndexOfFirstInvalidBinding_BeforeArgs toInvoke in _beforeIndexOfFirstInvalidBinding
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.IndexOfFirstInvalidBinding_AfterArgs toInvoke in _afterIndexOfFirstInvalidBinding
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookClearBindings()
        {
            if (!HookedList.Contains("ClearBindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ClearBindings", true),
                    ClearBindings);
            }
        }
        ...
        internal static void HookResetBindings()
        {
            if (!HookedList.Contains("ResetBindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ResetBindings", true),
                    ResetBindings);
            }
        }
        ...
        internal static void HookListenForBinding()
        {
            if (!HookedList.Contains("ListenForBinding"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ListenForBinding", true),
                    ListenForBinding);
            }
        }
        ...
        internal static void HookListenForBindingReplacing()
        {
            if (!HookedList.Contains("ListenForBindingReplacing"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ListenForBindingReplacing", true),
        ...
        private static void ListenForBindingReplacing(Action<InControl.PlayerAction, InControl.BindingSource> orig,
            InControl.PlayerAction self, InControl.BindingSource binding)
        {
            ...
            {
                foreach (Delegates.ListenForBindingReplacing_BeforeArgs toInvoke in _beforeListenForBindingReplacing
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ListenForBindingReplacing_AfterArgs toInvoke in _afterListenForBindingReplacing
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookStopListeningForBinding()
        {
            if (!HookedList.Contains("StopListeningForBinding"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "StopListeningForBinding", true),
        ...
        private static void StopListeningForBinding(Action<InControl.PlayerAction> orig, InControl.PlayerAction self)
        {
            ...
            {
                foreach (Delegates.StopListeningForBinding_BeforeArgs toInvoke in _beforeStopListeningForBinding
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.StopListeningForBinding_AfterArgs toInvoke in _afterStopListeningForBinding
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_IsListeningForBinding()
        {
            if (!HookedList.Contains("get_IsListeningForBinding"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_IsListeningForBinding", true),
        ...
        private static bool get_IsListeningForBinding(Func<InControl.PlayerAction, bool> orig,
            InControl.PlayerAction self)
        {
            ...
            {
                foreach (Delegates.get_IsListeningForBinding_BeforeArgs toInvoke in _beforeget_IsListeningForBinding
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsListeningForBinding_AfterArgs toInvoke in _afterget_IsListeningForBinding
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_Bindings()
        {
            if (!HookedList.Contains("get_Bindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Bindings", true),
                    get_Bindings);
            }
        }
        ...
        private static System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource> get_Bindings(
            Func<InControl.PlayerAction, System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>>
                orig, InControl.PlayerAction self)
        {
        ...
        internal static void Hookget_UnfilteredBindings()
        {
            if (!HookedList.Contains("get_UnfilteredBindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_UnfilteredBindings", true),
        ...
        private static System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>
            get_UnfilteredBindings(
                Func<InControl.PlayerAction, System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>>
                    orig, InControl.PlayerAction self)
        {
            ...
            {
                foreach (Delegates.get_UnfilteredBindings_BeforeArgs toInvoke in _beforeget_UnfilteredBindings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_UnfilteredBindings_AfterArgs toInvoke in _afterget_UnfilteredBindings
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookRemoveOrphanedBindings()
        {
            if (!HookedList.Contains("RemoveOrphanedBindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveOrphanedBindings", true),
        ...
        private static void RemoveOrphanedBindings(Action<InControl.PlayerAction> orig, InControl.PlayerAction self)
        {
            ...
            {
                foreach (Delegates.RemoveOrphanedBindings_BeforeArgs toInvoke in _beforeRemoveOrphanedBindings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.RemoveOrphanedBindings_AfterArgs toInvoke in _afterRemoveOrphanedBindings
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void Update(Action<InControl.PlayerAction, ulong, float, InControl.InputDevice> orig,
            InControl.PlayerAction self, ulong updateTick, float deltaTime, InControl.InputDevice device)
        {
        ...
        internal static void HookUpdateBindings()
        {
            if (!HookedList.Contains("UpdateBindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "UpdateBindings", true),
                    UpdateBindings);
            }
        }
        ...
        private static void UpdateBindings(Action<InControl.PlayerAction, ulong, float> orig,
            InControl.PlayerAction self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookDetectBindings()
        {
            if (!HookedList.Contains("DetectBindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "DetectBindings", true),
                    DetectBindings);
            }
        }
        ...
        internal static void HookUpdateVisibleBindings()
        {
            if (!HookedList.Contains("UpdateVisibleBindings"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "UpdateVisibleBindings", true),
        ...
        private static void UpdateVisibleBindings(Action<InControl.PlayerAction> orig, InControl.PlayerAction self)
        {
            ...
            {
                foreach (Delegates.UpdateVisibleBindings_BeforeArgs toInvoke in _beforeUpdateVisibleBindings
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.UpdateVisibleBindings_AfterArgs toInvoke in _afterUpdateVisibleBindings
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_Device()
        {
            if (!HookedList.Contains("get_Device"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Device", true),
                    get_Device);
            }
        }
        ...
        private static InControl.InputDevice get_Device(Func<InControl.PlayerAction, InControl.InputDevice> orig,
            InControl.PlayerAction self)
        {
        ...
        internal static void Hookset_Device()
        {
            if (!HookedList.Contains("set_Device"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_Device", true),
                    set_Device);
            }
        }
        ...
        private static void set_Device(Action<InControl.PlayerAction, InControl.InputDevice> orig,
            InControl.PlayerAction self, InControl.InputDevice value)
        {
        ...
        internal static void Hookget_ActiveDevice()
        {
            if (!HookedList.Contains("get_ActiveDevice"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_ActiveDevice", true),
                    get_ActiveDevice);
            }
        }
        ...
        private static InControl.InputDevice get_ActiveDevice(Func<InControl.PlayerAction, InControl.InputDevice> orig,
            InControl.PlayerAction self)
        {
        ...
        internal static void Hookget_LastInputTypeIsDevice()
        {
            if (!HookedList.Contains("get_LastInputTypeIsDevice"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_LastInputTypeIsDevice", true),
        ...
        private static bool get_LastInputTypeIsDevice(Func<InControl.PlayerAction, bool> orig,
            InControl.PlayerAction self)
        {
            ...
            {
                foreach (Delegates.get_LastInputTypeIsDevice_BeforeArgs toInvoke in _beforeget_LastInputTypeIsDevice
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_LastInputTypeIsDevice_AfterArgs toInvoke in _afterget_LastInputTypeIsDevice
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_LowerDeadZone()
        {
            if (!HookedList.Contains("get_LowerDeadZone"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_LowerDeadZone", true),
                    get_LowerDeadZone);
            }
        }
        ...
        internal static void Hookset_LowerDeadZone()
        {
            if (!HookedList.Contains("set_LowerDeadZone"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_LowerDeadZone", true),
                    set_LowerDeadZone);
            }
        }
        ...
        private static void set_LowerDeadZone(Action<InControl.PlayerAction, float> orig, InControl.PlayerAction self,
            float value)
        {
        ...
        internal static void Hookget_UpperDeadZone()
        {
            if (!HookedList.Contains("get_UpperDeadZone"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_UpperDeadZone", true),
                    get_UpperDeadZone);
            }
        }
        ...
        internal static void Hookset_UpperDeadZone()
        {
            if (!HookedList.Contains("set_UpperDeadZone"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_UpperDeadZone", true),
                    set_UpperDeadZone);
            }
        }
        ...
        private static void set_UpperDeadZone(Action<InControl.PlayerAction, float> orig, InControl.PlayerAction self,
            float value)
        {
        ...
        private static void Load(Action<InControl.PlayerAction, System.IO.BinaryReader, ushort> orig,
            InControl.PlayerAction self, System.IO.BinaryReader reader, ushort dataFormatVersion)
        {
        ...
        private static void Save(Action<InControl.PlayerAction, System.IO.BinaryWriter> orig,
            InControl.PlayerAction self, System.IO.BinaryWriter writer)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate string get_Name_WithArgs(Func<InControl.PlayerAction, string> orig,
            InControl.PlayerAction self);
        ...
        public delegate void set_Name_WithArgs(Action<InControl.PlayerAction, string> orig, InControl.PlayerAction self,
            string value);
        ...
        public delegate InControl.PlayerActionSet get_Owner_AfterArgs(Params_get_Owner args,
            InControl.PlayerActionSet ret);

        public delegate InControl.PlayerActionSet get_Owner_WithArgs(
            Func<InControl.PlayerAction, InControl.PlayerActionSet> orig, InControl.PlayerAction self);
        ...
        public delegate void set_Owner_WithArgs(Action<InControl.PlayerAction, InControl.PlayerActionSet> orig,
            InControl.PlayerAction self, InControl.PlayerActionSet value);
        ...
        public delegate System.Object get_UserData_WithArgs(Func<InControl.PlayerAction, System.Object> orig,
            InControl.PlayerAction self);
        ...
        public delegate void set_UserData_WithArgs(Action<InControl.PlayerAction, System.Object> orig,
            InControl.PlayerAction self, System.Object value);
        ...
        public delegate void AddDefaultBinding_BindingSource_WithArgs(
            Action<InControl.PlayerAction, InControl.BindingSource> orig, InControl.PlayerAction self,
            InControl.BindingSource binding);
        ...
        public delegate void AddDefaultBinding_Array_WithArgs(Action<InControl.PlayerAction, InControl.Key[]> orig,
            InControl.PlayerAction self, InControl.Key[] keys);
        ...
        public delegate void AddDefaultBinding_KeyCombo_WithArgs(
            Action<InControl.PlayerAction, InControl.KeyCombo> orig, InControl.PlayerAction self,
            InControl.KeyCombo keyCombo);
        ...
        public delegate void AddDefaultBinding_Mouse_WithArgs(Action<InControl.PlayerAction, InControl.Mouse> orig,
            InControl.PlayerAction self, InControl.Mouse control);
        ...
        public delegate void AddDefaultBinding_InputControlType_AfterArgs(
            Params_AddDefaultBinding_InputControlType args);

        public delegate void AddDefaultBinding_InputControlType_WithArgs(
            Action<InControl.PlayerAction, InControl.InputControlType> orig, InControl.PlayerAction self,
            InControl.InputControlType control);
        ...
        public delegate bool AddBinding_WithArgs(Func<InControl.PlayerAction, InControl.BindingSource, bool> orig,
            InControl.PlayerAction self, InControl.BindingSource binding);
        ...
        public delegate bool InsertBindingAt_WithArgs(
            Func<InControl.PlayerAction, int, InControl.BindingSource, bool> orig, InControl.PlayerAction self,
            int index, InControl.BindingSource binding);
        ...
        public delegate bool ReplaceBinding_WithArgs(
            Func<InControl.PlayerAction, InControl.BindingSource, InControl.BindingSource, bool> orig,
            InControl.PlayerAction self, InControl.BindingSource findBinding, InControl.BindingSource withBinding);
        ...
        public delegate bool HasBinding_WithArgs(Func<InControl.PlayerAction, InControl.BindingSource, bool> orig,
            InControl.PlayerAction self, InControl.BindingSource binding);
        ...
        public delegate InControl.BindingSource FindBinding_AfterArgs(Params_FindBinding args,
            InControl.BindingSource ret);

        public delegate InControl.BindingSource FindBinding_WithArgs(
            Func<InControl.PlayerAction, InControl.BindingSource, InControl.BindingSource> orig,
            InControl.PlayerAction self, InControl.BindingSource binding);
        ...
        public delegate void HardRemoveBinding_WithArgs(Action<InControl.PlayerAction, InControl.BindingSource> orig,
            InControl.PlayerAction self, InControl.BindingSource binding);
        ...
        public delegate void RemoveBinding_WithArgs(Action<InControl.PlayerAction, InControl.BindingSource> orig,
            InControl.PlayerAction self, InControl.BindingSource binding);
        ...
        public delegate void RemoveBindingAt_WithArgs(Action<InControl.PlayerAction, int> orig,
            InControl.PlayerAction self, int index);
        ...
        public delegate int CountBindingsOfType_WithArgs(
            Func<InControl.PlayerAction, InControl.BindingSourceType, int> orig, InControl.PlayerAction self,
            InControl.BindingSourceType bindingSourceType);
        ...
        public delegate void RemoveFirstBindingOfType_WithArgs(
            Action<InControl.PlayerAction, InControl.BindingSourceType> orig, InControl.PlayerAction self,
            InControl.BindingSourceType bindingSourceType);
        ...
        public delegate int IndexOfFirstInvalidBinding_WithArgs(Func<InControl.PlayerAction, int> orig,
            InControl.PlayerAction self);
        ...
        public delegate void
            ListenForBinding_WithArgs(Action<InControl.PlayerAction> orig, InControl.PlayerAction self);
        ...
        public delegate void ListenForBindingReplacing_WithArgs(
            Action<InControl.PlayerAction, InControl.BindingSource> orig, InControl.PlayerAction self,
            InControl.BindingSource binding);
        ...
        public delegate void StopListeningForBinding_WithArgs(Action<InControl.PlayerAction> orig,
            InControl.PlayerAction self);
        ...
        public delegate bool get_IsListeningForBinding_WithArgs(Func<InControl.PlayerAction, bool> orig,
            InControl.PlayerAction self);
        ...
        public delegate System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>
            get_Bindings_AfterArgs(Params_get_Bindings args,
                System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource> ret);

        public delegate System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>
            get_Bindings_WithArgs(
                Func<InControl.PlayerAction, System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>>
                    orig, InControl.PlayerAction self);
        ...
        public delegate System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>
            get_UnfilteredBindings_AfterArgs(Params_get_UnfilteredBindings args,
                System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource> ret);

        public delegate System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>
            get_UnfilteredBindings_WithArgs(
                Func<InControl.PlayerAction, System.Collections.ObjectModel.ReadOnlyCollection<InControl.BindingSource>>
                    orig, InControl.PlayerAction self);
        ...
        public delegate void RemoveOrphanedBindings_WithArgs(Action<InControl.PlayerAction> orig,
            InControl.PlayerAction self);
        ...
        public delegate void Update_WithArgs(Action<InControl.PlayerAction, ulong, float, InControl.InputDevice> orig,
            InControl.PlayerAction self, ulong updateTick, float deltaTime, InControl.InputDevice device);
        ...
        public delegate void UpdateBindings_WithArgs(Action<InControl.PlayerAction, ulong, float> orig,
            InControl.PlayerAction self, ulong updateTick, float deltaTime);
        ...
        public delegate void UpdateVisibleBindings_WithArgs(Action<InControl.PlayerAction> orig,
            InControl.PlayerAction self);
        ...
        public delegate InControl.InputDevice get_Device_WithArgs(
            Func<InControl.PlayerAction, InControl.InputDevice> orig, InControl.PlayerAction self);
        ...
        public delegate void set_Device_WithArgs(Action<InControl.PlayerAction, InControl.InputDevice> orig,
            InControl.PlayerAction self, InControl.InputDevice value);
        ...
        public delegate InControl.InputDevice get_ActiveDevice_AfterArgs(Params_get_ActiveDevice args,
            InControl.InputDevice ret);

        public delegate InControl.InputDevice get_ActiveDevice_WithArgs(
            Func<InControl.PlayerAction, InControl.InputDevice> orig, InControl.PlayerAction self);
        ...
        public delegate bool get_LastInputTypeIsDevice_WithArgs(Func<InControl.PlayerAction, bool> orig,
            InControl.PlayerAction self);
        ...
        public delegate float get_LowerDeadZone_WithArgs(Func<InControl.PlayerAction, float> orig,
            InControl.PlayerAction self);
        ...
        public delegate void set_LowerDeadZone_WithArgs(Action<InControl.PlayerAction, float> orig,
            InControl.PlayerAction self, float value);
        ...
        public delegate float get_UpperDeadZone_WithArgs(Func<InControl.PlayerAction, float> orig,
            InControl.PlayerAction self);
        ...
        public delegate void set_UpperDeadZone_WithArgs(Action<InControl.PlayerAction, float> orig,
            InControl.PlayerAction self, float value);
        ...
        public delegate void Load_WithArgs(Action<InControl.PlayerAction, System.IO.BinaryReader, ushort> orig,
            InControl.PlayerAction self, System.IO.BinaryReader reader, ushort dataFormatVersion);
        ...
        public delegate void Save_WithArgs(Action<InControl.PlayerAction, System.IO.BinaryWriter> orig,
            InControl.PlayerAction self, System.IO.BinaryWriter writer);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Name_WithArgs get_Name
        {
            add => HookEndpointManager.Add<Delegates.get_Name_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Name", true), value);
        ...
        public static event Delegates.set_Name_WithArgs set_Name
        {
            add => HookEndpointManager.Add<Delegates.set_Name_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_Name", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_Owner_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Owner", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_Owner_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Owner", true), value);
        }

        public static event Delegates.set_Owner_WithArgs set_Owner
        {
            add => HookEndpointManager.Add<Delegates.set_Owner_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_Owner", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_Owner_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_Owner", true), value);
        }
        ...
        public static event Delegates.get_UserData_WithArgs get_UserData
        {
            add => HookEndpointManager.Add<Delegates.get_UserData_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_UserData", true), value);
        ...
        public static event Delegates.set_UserData_WithArgs set_UserData
        {
            add => HookEndpointManager.Add<Delegates.set_UserData_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_UserData", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.AddDefaultBinding_BindingSource_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddDefaultBinding_BindingSource_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
        }

        public static event Delegates.AddDefaultBinding_Array_WithArgs AddDefaultBinding_Array
        {
            add => HookEndpointManager.Add<Delegates.AddDefaultBinding_Array_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddDefaultBinding_Array_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
        }

        public static event Delegates.AddDefaultBinding_KeyCombo_WithArgs AddDefaultBinding_KeyCombo
        {
            add => HookEndpointManager.Add<Delegates.AddDefaultBinding_KeyCombo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddDefaultBinding_KeyCombo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
        }

        public static event Delegates.AddDefaultBinding_Mouse_WithArgs AddDefaultBinding_Mouse
        {
            add => HookEndpointManager.Add<Delegates.AddDefaultBinding_Mouse_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddDefaultBinding_Mouse_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
        }

        public static event Delegates.AddDefaultBinding_InputControlType_WithArgs AddDefaultBinding_InputControlType
        {
            add => HookEndpointManager.Add<Delegates.AddDefaultBinding_InputControlType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddDefaultBinding_InputControlType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddDefaultBinding", true), value);
        }

        public static event Delegates.AddBinding_WithArgs AddBinding
        {
            add => HookEndpointManager.Add<Delegates.AddBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.AddBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "AddBinding", true), value);
        }

        public static event Delegates.InsertBindingAt_WithArgs InsertBindingAt
        {
            add => HookEndpointManager.Add<Delegates.InsertBindingAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "InsertBindingAt", true), value);
            remove => HookEndpointManager.Remove<Delegates.InsertBindingAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "InsertBindingAt", true), value);
        }

        public static event Delegates.ReplaceBinding_WithArgs ReplaceBinding
        {
            add => HookEndpointManager.Add<Delegates.ReplaceBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ReplaceBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.ReplaceBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ReplaceBinding", true), value);
        }

        public static event Delegates.HasBinding_WithArgs HasBinding
        {
            add => HookEndpointManager.Add<Delegates.HasBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "HasBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.HasBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "HasBinding", true), value);
        }

        public static event Delegates.FindBinding_WithArgs FindBinding
        {
            add => HookEndpointManager.Add<Delegates.FindBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "FindBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.FindBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "FindBinding", true), value);
        }

        public static event Delegates.HardRemoveBinding_WithArgs HardRemoveBinding
        {
            add => HookEndpointManager.Add<Delegates.HardRemoveBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "HardRemoveBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.HardRemoveBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "HardRemoveBinding", true), value);
        }

        public static event Delegates.RemoveBinding_WithArgs RemoveBinding
        {
            add => HookEndpointManager.Add<Delegates.RemoveBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.RemoveBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveBinding", true), value);
        }

        public static event Delegates.RemoveBindingAt_WithArgs RemoveBindingAt
        {
            add => HookEndpointManager.Add<Delegates.RemoveBindingAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveBindingAt", true), value);
            remove => HookEndpointManager.Remove<Delegates.RemoveBindingAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveBindingAt", true), value);
        }

        public static event Delegates.CountBindingsOfType_WithArgs CountBindingsOfType
        {
            add => HookEndpointManager.Add<Delegates.CountBindingsOfType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "CountBindingsOfType", true), value);
            remove => HookEndpointManager.Remove<Delegates.CountBindingsOfType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "CountBindingsOfType", true), value);
        }

        public static event Delegates.RemoveFirstBindingOfType_WithArgs RemoveFirstBindingOfType
        {
            add => HookEndpointManager.Add<Delegates.RemoveFirstBindingOfType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveFirstBindingOfType", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.RemoveFirstBindingOfType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveFirstBindingOfType", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.IndexOfFirstInvalidBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "IndexOfFirstInvalidBinding", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.IndexOfFirstInvalidBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "IndexOfFirstInvalidBinding", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.ClearBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ClearBindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.ClearBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ClearBindings", true), value);
        }

        public static event Delegates.ResetBindings_WithArgs ResetBindings
        {
            add => HookEndpointManager.Add<Delegates.ResetBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ResetBindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.ResetBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ResetBindings", true), value);
        }

        public static event Delegates.ListenForBinding_WithArgs ListenForBinding
        {
            add => HookEndpointManager.Add<Delegates.ListenForBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ListenForBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.ListenForBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ListenForBinding", true), value);
        }

        public static event Delegates.ListenForBindingReplacing_WithArgs ListenForBindingReplacing
        {
            add => HookEndpointManager.Add<Delegates.ListenForBindingReplacing_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ListenForBindingReplacing", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.ListenForBindingReplacing_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "ListenForBindingReplacing", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.StopListeningForBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "StopListeningForBinding", true), value);
            remove => HookEndpointManager.Remove<Delegates.StopListeningForBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "StopListeningForBinding", true), value);
        }

        public static event Delegates.get_IsListeningForBinding_WithArgs get_IsListeningForBinding
        {
            add => HookEndpointManager.Add<Delegates.get_IsListeningForBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_IsListeningForBinding", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_IsListeningForBinding_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_IsListeningForBinding", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_Bindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Bindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_Bindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Bindings", true), value);
        }

        public static event Delegates.get_UnfilteredBindings_WithArgs get_UnfilteredBindings
        {
            add => HookEndpointManager.Add<Delegates.get_UnfilteredBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_UnfilteredBindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_UnfilteredBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_UnfilteredBindings", true), value);
        }

        public static event Delegates.RemoveOrphanedBindings_WithArgs RemoveOrphanedBindings
        {
            add => HookEndpointManager.Add<Delegates.RemoveOrphanedBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveOrphanedBindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.RemoveOrphanedBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "RemoveOrphanedBindings", true), value);
        }
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "Update", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.UpdateBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "UpdateBindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.UpdateBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "UpdateBindings", true), value);
        }

        public static event Delegates.DetectBindings_WithArgs DetectBindings
        {
            add => HookEndpointManager.Add<Delegates.DetectBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "DetectBindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.DetectBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "DetectBindings", true), value);
        }

        public static event Delegates.UpdateVisibleBindings_WithArgs UpdateVisibleBindings
        {
            add => HookEndpointManager.Add<Delegates.UpdateVisibleBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "UpdateVisibleBindings", true), value);
            remove => HookEndpointManager.Remove<Delegates.UpdateVisibleBindings_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "UpdateVisibleBindings", true), value);
        }
        ...
        public static event Delegates.get_Device_WithArgs get_Device
        {
            add => HookEndpointManager.Add<Delegates.get_Device_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_Device", true), value);
        ...
        public static event Delegates.set_Device_WithArgs set_Device
        {
            add => HookEndpointManager.Add<Delegates.set_Device_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_Device", true), value);
        ...
        public static event Delegates.get_ActiveDevice_WithArgs get_ActiveDevice
        {
            add => HookEndpointManager.Add<Delegates.get_ActiveDevice_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_ActiveDevice", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_LastInputTypeIsDevice_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_LastInputTypeIsDevice", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_LastInputTypeIsDevice_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_LastInputTypeIsDevice", true),
                value);
        }
        ...
        public static event Delegates.get_LowerDeadZone_WithArgs get_LowerDeadZone
        {
            add => HookEndpointManager.Add<Delegates.get_LowerDeadZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_LowerDeadZone", true), value);
        ...
        public static event Delegates.set_LowerDeadZone_WithArgs set_LowerDeadZone
        {
            add => HookEndpointManager.Add<Delegates.set_LowerDeadZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_LowerDeadZone", true), value);
        ...
        public static event Delegates.get_UpperDeadZone_WithArgs get_UpperDeadZone
        {
            add => HookEndpointManager.Add<Delegates.get_UpperDeadZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "get_UpperDeadZone", true), value);
        ...
        public static event Delegates.set_UpperDeadZone_WithArgs set_UpperDeadZone
        {
            add => HookEndpointManager.Add<Delegates.set_UpperDeadZone_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "set_UpperDeadZone", true), value);
        ...
        public static event Delegates.Load_WithArgs Load
        {
            add => HookEndpointManager.Add<Delegates.Load_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "Load", true), value);
        ...
        public static event Delegates.Save_WithArgs Save
        {
            add => HookEndpointManager.Add<Delegates.Save_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.PlayerAction), "Save", true), value);
