...
public static class OnCoroutineQueue
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.Enqueue_NormalArgs _afterEnqueue;
        ...
        private static void Enqueue(On.CoroutineQueue.orig_Enqueue orig, CoroutineQueue self, IEnumerator coroutine)
        {
            ...
            orig(self, coroutine);
            if (_afterEnqueue != null) _afterEnqueue.Invoke(@params);
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Enqueue_NormalArgs(Params_Enqueue args);
    ...
    {
        public static event Delegates.Enqueue_NormalArgs Enqueue
        {
            add
            {
