...
public static class Ontk2dSpriteFromTexture
{
    internal static class HookHandler
    {
        ...
        private static void Create(On.tk2dSpriteFromTexture.orig_Create orig, tk2dSpriteFromTexture self,
            tk2dSpriteCollectionSize spriteCollectionSize, Texture texture, tk2dBaseSprite.Anchor anchor)
        {
            Delegates.Params_Create @params = new()
            {
                self = self, spriteCollectionSize = spriteCollectionSize, texture = texture, anchor = anchor
            };
    ...
    public static class Delegates
    {
        ...
        public delegate void Create_WithArgs(
            Action<tk2dSpriteFromTexture, tk2dSpriteCollectionSize, Texture, tk2dBaseSprite.Anchor> orig,
            tk2dSpriteFromTexture self, tk2dSpriteCollectionSize spriteCollectionSize, Texture texture,
