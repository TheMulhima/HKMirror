...
public static class OnSceneAdditiveLoadConditional
{
    internal static class HookHandler
    {
            ...
            SceneAdditiveLoadConditional self)
        {
            ...
            if (_beforeget_SceneNameToLoad != null)
                foreach (Delegates.get_SceneNameToLoad_BeforeArgs toInvoke in _beforeget_SceneNameToLoad
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterget_SceneNameToLoad != null)
                foreach (Delegates.get_SceneNameToLoad_AfterArgs toInvoke in
                         _afterget_SceneNameToLoad.GetInvocationList())
                    try
                    {
        ...
        private static bool get_ShouldLoadBoss(Func<bool> orig)
        {
            if (_beforeget_ShouldLoadBoss != null)
                foreach (Delegates.get_ShouldLoadBoss_BeforeArgs toInvoke in
                         _beforeget_ShouldLoadBoss.GetInvocationList())
                    try
                    {
            ...
            if (_afterget_ShouldLoadBoss != null)
                foreach (Delegates.get_ShouldLoadBoss_AfterArgs toInvoke in
                         _afterget_ShouldLoadBoss.GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate string get_SceneNameToLoad_WithArgs(Func<SceneAdditiveLoadConditional, string> orig,
            SceneAdditiveLoadConditional self);
        ...
        public delegate IEnumerator LoadAll_AfterArgs(IEnumerator ret);

        public delegate void LoadAll_BeforeArgs();

        public delegate IEnumerator LoadAll_WithArgs(Func<IEnumerator> orig);

        public delegate IEnumerator LoadRoutine_AfterArgs(Params_LoadRoutine args, IEnumerator ret);

        public delegate void LoadRoutine_BeforeArgs(Params_LoadRoutine args);

        public delegate IEnumerator LoadRoutine_WithArgs(Func<SceneAdditiveLoadConditional, bool, IEnumerator> orig,
            SceneAdditiveLoadConditional self, bool callEvent);
        ...
        public delegate void OnDisable_WithArgs(Action<SceneAdditiveLoadConditional> orig,
            SceneAdditiveLoadConditional self);
        ...
        public delegate void OnEnable_WithArgs(Action<SceneAdditiveLoadConditional> orig,
            SceneAdditiveLoadConditional self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_SceneNameToLoad_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneAdditiveLoadConditional), "get_SceneNameToLoad"), value);
            remove => HookEndpointManager.Remove<Delegates.get_SceneNameToLoad_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneAdditiveLoadConditional), "get_SceneNameToLoad"), value);
        }

        public static event Delegates.get_ShouldLoadBoss_WithArgs get_ShouldLoadBoss
        {
            add => HookEndpointManager.Add<Delegates.get_ShouldLoadBoss_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneAdditiveLoadConditional), "get_ShouldLoadBoss", false),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_ShouldLoadBoss_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneAdditiveLoadConditional), "get_ShouldLoadBoss", false),
                value);
        }
