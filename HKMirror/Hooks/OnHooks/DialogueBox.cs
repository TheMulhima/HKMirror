...
public static class OnDialogueBox
{
    internal static class HookHandler
    {
            ...
            string convName, string sheetName)
        {
            ...
            {
                foreach (Delegates.StartConversation_BeforeArgs toInvoke in
                         _beforeStartConversation.GetInvocationList())
                {
                    try
                    {
        ...
        private static System.Collections.IEnumerator TypewriteCurrentPage(
            On.DialogueBox.orig_TypewriteCurrentPage orig, DialogueBox self)
        {
            ...
            {
                foreach (Delegates.TypewriteCurrentPage_BeforeArgs toInvoke in _beforeTypewriteCurrentPage
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void SpeedupTypewriter(On.DialogueBox.orig_SpeedupTypewriter orig, DialogueBox self)
        {
            ...
            {
                foreach (Delegates.SpeedupTypewriter_BeforeArgs toInvoke in
                         _beforeSpeedupTypewriter.GetInvocationList())
                {
                    try
                    {
        ...
        private static void RestoreTypewriter(On.DialogueBox.orig_RestoreTypewriter orig, DialogueBox self)
        {
            ...
            {
                foreach (Delegates.RestoreTypewriter_BeforeArgs toInvoke in
                         _beforeRestoreTypewriter.GetInvocationList())
                {
                    try
                    {
        ...
        private static int GetFirstCharIndexOnPage(On.DialogueBox.orig_GetFirstCharIndexOnPage orig, DialogueBox self)
        {
            ...
            {
                foreach (Delegates.GetFirstCharIndexOnPage_BeforeArgs toInvoke in _beforeGetFirstCharIndexOnPage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetFirstCharIndexOnPage_AfterArgs toInvoke in _afterGetFirstCharIndexOnPage
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static int GetLastCharIndexOnPage(On.DialogueBox.orig_GetLastCharIndexOnPage orig, DialogueBox self)
        {
            ...
            {
                foreach (Delegates.GetLastCharIndexOnPage_BeforeArgs toInvoke in _beforeGetLastCharIndexOnPage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetLastCharIndexOnPage_AfterArgs toInvoke in _afterGetLastCharIndexOnPage
                             .GetInvocationList())
                {
                    try
                    {
            ...
            DialogueBox self)
        {
            ...
            {
                foreach (Delegates.PrintCurrentConversation_BeforeArgs toInvoke in _beforePrintCurrentConversation
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.PrintCurrentConversation_AfterArgs toInvoke in _afterPrintCurrentConversation
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void SetConversation_WithArgs(Action<DialogueBox, string, string> orig, DialogueBox self,
            string convName, string sheetName);
        ...
        public delegate void StartConversation_WithArgs(Action<DialogueBox, string, string> orig, DialogueBox self,
            string convName, string sheetName);
        ...
        public delegate System.Collections.IEnumerator TypewriteCurrentPage_AfterArgs(Params_TypewriteCurrentPage args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator TypewriteCurrentPage_WithArgs(
            Func<DialogueBox, System.Collections.IEnumerator> orig, DialogueBox self);
