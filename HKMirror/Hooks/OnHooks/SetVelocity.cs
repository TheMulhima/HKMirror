...
public static class OnSetVelocity
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self)
        {
        ...
        internal static void HookDoSetVelocity()
        {
            if (!HookedList.Contains("DoSetVelocity"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity), "DoSetVelocity",
                        true), DoSetVelocity);
            }
        }
        ...
        private static void DoSetVelocity(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self);
        ...
        public delegate void DoSetVelocity_WithArgs(Action<HutongGames.PlayMaker.Actions.SetVelocity> orig,
            HutongGames.PlayMaker.Actions.SetVelocity self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetVelocity), "OnPreprocess", true),
                value);
