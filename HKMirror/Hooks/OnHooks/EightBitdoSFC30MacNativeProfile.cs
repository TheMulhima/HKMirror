...
public static class OnEightBitdoSFC30MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSFC30MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSFC30MacNativeProfile> orig, EightBitdoSFC30MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSFC30MacNativeProfile> orig,
            EightBitdoSFC30MacNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSFC30MacNativeProfile self;
        }
    }
