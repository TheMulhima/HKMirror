...
public static class OnPlayStation5MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation5MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation5MacNativeProfile> orig, PlayStation5MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation5MacNativeProfile> orig,
            PlayStation5MacNativeProfile self);

        public sealed class Params_Define
        {
            public PlayStation5MacNativeProfile self;
        }
    }
