...
public static class OnXTR_G2_WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.XTR_G2_WindowsUnityProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.XTR_G2_WindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.XTR_G2_WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<InControl.UnityDeviceProfiles.XTR_G2_WindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.XTR_G2_WindowsUnityProfile self);
    }
