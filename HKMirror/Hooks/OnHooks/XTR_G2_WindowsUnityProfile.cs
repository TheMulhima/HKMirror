...
public static class OnXTR_G2_WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XTR_G2_WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XTR_G2_WindowsUnityProfile> orig, XTR_G2_WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XTR_G2_WindowsUnityProfile> orig, XTR_G2_WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public XTR_G2_WindowsUnityProfile self;
        }
    }
