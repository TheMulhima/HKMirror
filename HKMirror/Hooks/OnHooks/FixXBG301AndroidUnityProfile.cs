...
public static class OnFixXBG301AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FixXBG301AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<FixXBG301AndroidUnityProfile> orig, FixXBG301AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<FixXBG301AndroidUnityProfile> orig,
            FixXBG301AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public FixXBG301AndroidUnityProfile self;
        }
    }
