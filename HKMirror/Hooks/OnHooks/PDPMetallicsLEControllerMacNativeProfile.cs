...
public static class OnPDPMetallicsLEControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PDPMetallicsLEControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PDPMetallicsLEControllerMacNativeProfile> orig,
            PDPMetallicsLEControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PDPMetallicsLEControllerMacNativeProfile> orig,
            PDPMetallicsLEControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PDPMetallicsLEControllerMacNativeProfile self;
        }
    }
