...
public static class OnScrollPaneSelector
{
    ...
    {
        public delegate RectTransform get_MaskRect_AfterArgs(Params_get_MaskRect args, RectTransform ret);

        public delegate void get_MaskRect_BeforeArgs(Params_get_MaskRect args);

        public delegate RectTransform get_MaskRect_WithArgs(Func<ScrollPaneSelector, RectTransform> orig,
            ScrollPaneSelector self);

        public delegate RectTransform get_PaneRect_AfterArgs(Params_get_PaneRect args, RectTransform ret);

        public delegate void get_PaneRect_BeforeArgs(Params_get_PaneRect args);

        public delegate RectTransform get_PaneRect_WithArgs(Func<ScrollPaneSelector, RectTransform> orig,
            ScrollPaneSelector self);

        public delegate Scrollbar get_Scrollbar_AfterArgs(Params_get_Scrollbar args, Scrollbar ret);

        public delegate void get_Scrollbar_BeforeArgs(Params_get_Scrollbar args);

        public delegate Scrollbar get_Scrollbar_WithArgs(Func<ScrollPaneSelector, Scrollbar> orig,
            ScrollPaneSelector self);

        public delegate Func<RectTransform, ValueTuple<float, float>> get_SelectionPadding_AfterArgs(
            Params_get_SelectionPadding args, Func<RectTransform, ValueTuple<float, float>> ret);

        public delegate void get_SelectionPadding_BeforeArgs(Params_get_SelectionPadding args);

        public delegate Func<RectTransform, ValueTuple<float, float>> get_SelectionPadding_WithArgs(
            Func<ScrollPaneSelector, Func<RectTransform, ValueTuple<float, float>>> orig, ScrollPaneSelector self);
        ...
        public delegate void OnSelect_WithArgs(Action<ScrollPaneSelector, BaseEventData> orig, ScrollPaneSelector self,
            BaseEventData eventData);
        ...
        public delegate void set_MaskRect_WithArgs(Action<ScrollPaneSelector, RectTransform> orig,
            ScrollPaneSelector self, RectTransform value);
        ...
        public delegate void set_PaneRect_WithArgs(Action<ScrollPaneSelector, RectTransform> orig,
            ScrollPaneSelector self, RectTransform value);
        ...
        public delegate void set_Scrollbar_WithArgs(Action<ScrollPaneSelector, Scrollbar> orig, ScrollPaneSelector self,
            Scrollbar value);
