...
public static class OnXbox360MacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360MacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360MacUnityProfile> orig, Xbox360MacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360MacUnityProfile> orig, Xbox360MacUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360MacUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Xbox360MacUnityProfile), "Define"), value);
