...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Editor__SpriteCollection", true), get_Editor__SpriteCollection);
...
private static tk2dSpriteCollectionData get_Editor__SpriteCollection(Func<tk2dTileMap, tk2dSpriteCollectionData> orig, tk2dTileMap self)
{
...
{
foreach (Delegates.get_Editor__SpriteCollection_BeforeArgs toInvoke in _beforeget_Editor__SpriteCollection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_Editor__SpriteCollection_AfterArgs toInvoke in _afterget_Editor__SpriteCollection.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Editor__SpriteCollection", true), set_Editor__SpriteCollection);
...
private static void set_Editor__SpriteCollection(Action<tk2dTileMap,  tk2dSpriteCollectionData> orig, tk2dTileMap self,  tk2dSpriteCollectionData value)
{
...
{
foreach (Delegates.set_Editor__SpriteCollection_BeforeArgs toInvoke in _beforeset_Editor__SpriteCollection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_Editor__SpriteCollection_AfterArgs toInvoke in _afterset_Editor__SpriteCollection.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_SpriteCollectionInst", true), get_SpriteCollectionInst);
...
private static tk2dSpriteCollectionData get_SpriteCollectionInst(Func<tk2dTileMap, tk2dSpriteCollectionData> orig, tk2dTileMap self)
{
...
{
foreach (Delegates.get_SpriteCollectionInst_BeforeArgs toInvoke in _beforeget_SpriteCollectionInst.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_SpriteCollectionInst_AfterArgs toInvoke in _afterget_SpriteCollectionInst.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_AllowEdit", true), get_AllowEdit);
...
{
foreach (Delegates.ClearSpawnedInstances_BeforeArgs toInvoke in _beforeClearSpawnedInstances.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearSpawnedInstances_AfterArgs toInvoke in _afterClearSpawnedInstances.GetInvocationList())
{
try
{
...
private static void SetPrefabsRootActive(On.tk2dTileMap.orig_SetPrefabsRootActive orig,tk2dTileMap self,  bool active)
{
...
{
foreach (Delegates.SetPrefabsRootActive_BeforeArgs toInvoke in _beforeSetPrefabsRootActive.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPrefabsRootActive_AfterArgs toInvoke in _afterSetPrefabsRootActive.GetInvocationList())
{
try
{
...
internal static void HookBuild_BuildFlags()
{
if (!HookedList.Contains("Build_BuildFlags"))
{
HookedList.Add("Build_BuildFlags");
On.tk2dTileMap.Build_BuildFlags += Build_BuildFlags;

}
}
internal static event Delegates.Build_BuildFlags_BeforeArgs _beforeBuild_BuildFlags;
internal static event Delegates.Build_BuildFlags_AfterArgs _afterBuild_BuildFlags;
private static void Build_BuildFlags(On.tk2dTileMap.orig_Build_BuildFlags orig,tk2dTileMap self,  tk2dTileMap.BuildFlags buildFlags)
{
Delegates.Params_Build_BuildFlags @params = new() 
{
self = self
, buildFlags = buildFlags
};
if (_beforeBuild_BuildFlags != null)
{
foreach (Delegates.Build_BuildFlags_BeforeArgs toInvoke in _beforeBuild_BuildFlags.GetInvocationList())
{
try
{
_beforeBuild_BuildFlags?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
orig(self, buildFlags);
if (_afterBuild_BuildFlags != null)
{
foreach (Delegates.Build_BuildFlags_AfterArgs toInvoke in _afterBuild_BuildFlags.GetInvocationList())
{
try
{
_afterBuild_BuildFlags.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
private static bool GetTileAtPosition(On.tk2dTileMap.orig_GetTileAtPosition orig,tk2dTileMap self,  UnityEngine.Vector3 position, out  int x, out  int y)
{
...
{
foreach (Delegates.GetTileAtPosition_BeforeArgs toInvoke in _beforeGetTileAtPosition.GetInvocationList())
{
try
{
...
private static bool GetTileFracAtPosition(On.tk2dTileMap.orig_GetTileFracAtPosition orig,tk2dTileMap self,  UnityEngine.Vector3 position, out  float x, out  float y)
{
...
{
foreach (Delegates.GetTileFracAtPosition_BeforeArgs toInvoke in _beforeGetTileFracAtPosition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetTileFracAtPosition_AfterArgs toInvoke in _afterGetTileFracAtPosition.GetInvocationList())
{
try
{
...
private static UnityEngine.Vector3 GetTilePosition(On.tk2dTileMap.orig_GetTilePosition orig,tk2dTileMap self,  int x,  int y)
{
...
private static int GetTileIdAtPosition(On.tk2dTileMap.orig_GetTileIdAtPosition orig,tk2dTileMap self,  UnityEngine.Vector3 position,  int layer)
{
...
{
foreach (Delegates.GetTileIdAtPosition_BeforeArgs toInvoke in _beforeGetTileIdAtPosition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetTileIdAtPosition_AfterArgs toInvoke in _afterGetTileIdAtPosition.GetInvocationList())
{
try
{
...
private static tk2dRuntime.TileMap.TileInfo GetTileInfoForTileId(On.tk2dTileMap.orig_GetTileInfoForTileId orig,tk2dTileMap self,  int tileId)
{
...
{
foreach (Delegates.GetTileInfoForTileId_BeforeArgs toInvoke in _beforeGetTileInfoForTileId.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetTileInfoForTileId_AfterArgs toInvoke in _afterGetTileInfoForTileId.GetInvocationList())
{
try
{
...
private static UnityEngine.Color GetInterpolatedColorAtPosition(On.tk2dTileMap.orig_GetInterpolatedColorAtPosition orig,tk2dTileMap self,  UnityEngine.Vector3 position)
{
...
{
foreach (Delegates.GetInterpolatedColorAtPosition_BeforeArgs toInvoke in _beforeGetInterpolatedColorAtPosition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetInterpolatedColorAtPosition_AfterArgs toInvoke in _afterGetInterpolatedColorAtPosition.GetInvocationList())
{
try
{
...
private static bool UsesSpriteCollection(On.tk2dTileMap.orig_UsesSpriteCollection orig,tk2dTileMap self,  tk2dSpriteCollectionData spriteCollection)
{
...
private static void TouchMesh(On.tk2dTileMap.orig_TouchMesh orig,tk2dTileMap self,  UnityEngine.Mesh mesh)
{
...
private static void DestroyMesh(On.tk2dTileMap.orig_DestroyMesh orig,tk2dTileMap self,  UnityEngine.Mesh mesh)
{
...
{
foreach (Delegates.GetTilePrefabsListCount_BeforeArgs toInvoke in _beforeGetTilePrefabsListCount.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetTilePrefabsListCount_AfterArgs toInvoke in _afterGetTilePrefabsListCount.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_TilePrefabsList", true), get_TilePrefabsList);
...
private static System.Collections.Generic.List<tk2dTileMap.TilemapPrefabInstance> get_TilePrefabsList(Func<tk2dTileMap, System.Collections.Generic.List<tk2dTileMap.TilemapPrefabInstance>> orig, tk2dTileMap self)
{
...
{
foreach (Delegates.get_TilePrefabsList_BeforeArgs toInvoke in _beforeget_TilePrefabsList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_TilePrefabsList_AfterArgs toInvoke in _afterget_TilePrefabsList.GetInvocationList())
{
try
{
...
private static void GetTilePrefabsListItem(On.tk2dTileMap.orig_GetTilePrefabsListItem orig,tk2dTileMap self,  int index, out  int x, out  int y, out  int layer, out  UnityEngine.GameObject instance)
{
...
{
foreach (Delegates.GetTilePrefabsListItem_BeforeArgs toInvoke in _beforeGetTilePrefabsListItem.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetTilePrefabsListItem_AfterArgs toInvoke in _afterGetTilePrefabsListItem.GetInvocationList())
{
try
{
...
private static void SetTilePrefabsList(On.tk2dTileMap.orig_SetTilePrefabsList orig,tk2dTileMap self,  System.Collections.Generic.List<int> xs,  System.Collections.Generic.List<int> ys,  System.Collections.Generic.List<int> layers,  System.Collections.Generic.List<UnityEngine.GameObject> instances)
{
...
{
foreach (Delegates.SetTilePrefabsList_BeforeArgs toInvoke in _beforeSetTilePrefabsList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetTilePrefabsList_AfterArgs toInvoke in _afterSetTilePrefabsList.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Layers", true), get_Layers);
...
private static tk2dRuntime.TileMap.Layer[] get_Layers(Func<tk2dTileMap, tk2dRuntime.TileMap.Layer[]> orig, tk2dTileMap self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Layers", true), set_Layers);
...
private static void set_Layers(Action<tk2dTileMap,  tk2dRuntime.TileMap.Layer[]> orig, tk2dTileMap self,  tk2dRuntime.TileMap.Layer[] value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_ColorChannel", true), get_ColorChannel);
...
private static tk2dRuntime.TileMap.ColorChannel get_ColorChannel(Func<tk2dTileMap, tk2dRuntime.TileMap.ColorChannel> orig, tk2dTileMap self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_ColorChannel", true), set_ColorChannel);
...
private static void set_ColorChannel(Action<tk2dTileMap,  tk2dRuntime.TileMap.ColorChannel> orig, tk2dTileMap self,  tk2dRuntime.TileMap.ColorChannel value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_PrefabsRoot", true), get_PrefabsRoot);
...
private static UnityEngine.GameObject get_PrefabsRoot(Func<tk2dTileMap, UnityEngine.GameObject> orig, tk2dTileMap self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_PrefabsRoot", true), set_PrefabsRoot);
...
private static void set_PrefabsRoot(Action<tk2dTileMap,  UnityEngine.GameObject> orig, tk2dTileMap self,  UnityEngine.GameObject value)
{
...
private static tk2dTileFlags GetTileFlags(On.tk2dTileMap.orig_GetTileFlags orig,tk2dTileMap self,  int x,  int y,  int layer)
{
...
private static void SetTile(On.tk2dTileMap.orig_SetTile orig,tk2dTileMap self,  int x,  int y,  int layer,  int tile)
{
...
private static void SetTileFlags(On.tk2dTileMap.orig_SetTileFlags orig,tk2dTileMap self,  int x,  int y,  int layer,  tk2dTileFlags flags)
{
...
public delegate tk2dSpriteCollectionData get_Editor__SpriteCollection_AfterArgs(Params_get_Editor__SpriteCollection args, tk2dSpriteCollectionData ret);
public delegate tk2dSpriteCollectionData get_Editor__SpriteCollection_WithArgs (Func<tk2dTileMap, tk2dSpriteCollectionData> orig, tk2dTileMap self);
...
public delegate void set_Editor__SpriteCollection_WithArgs (Action<tk2dTileMap,  tk2dSpriteCollectionData> orig, tk2dTileMap self,  tk2dSpriteCollectionData value);
...
public delegate tk2dSpriteCollectionData get_SpriteCollectionInst_AfterArgs(Params_get_SpriteCollectionInst args, tk2dSpriteCollectionData ret);
public delegate tk2dSpriteCollectionData get_SpriteCollectionInst_WithArgs (Func<tk2dTileMap, tk2dSpriteCollectionData> orig, tk2dTileMap self);
...
public delegate void SetPrefabsRootActive_WithArgs (Action<tk2dTileMap,  bool> orig, tk2dTileMap self,  bool active);
public sealed class Params_Build_BuildFlags
{
public tk2dTileMap self;
public tk2dTileMap.BuildFlags buildFlags;
}
public delegate void Build_BuildFlags_BeforeArgs(Params_Build_BuildFlags args);
public delegate void Build_BuildFlags_AfterArgs(Params_Build_BuildFlags args);
public delegate void Build_BuildFlags_WithArgs (Action<tk2dTileMap,  tk2dTileMap.BuildFlags> orig, tk2dTileMap self,  tk2dTileMap.BuildFlags buildFlags);
...
public delegate bool GetTileAtPosition_WithArgs (Func<tk2dTileMap,  UnityEngine.Vector3,  int,  int, bool> orig, tk2dTileMap self,  UnityEngine.Vector3 position, out  int x, out  int y);
...
public delegate bool GetTileFracAtPosition_WithArgs (Func<tk2dTileMap,  UnityEngine.Vector3,  float,  float, bool> orig, tk2dTileMap self,  UnityEngine.Vector3 position, out  float x, out  float y);
...
public delegate UnityEngine.Vector3 GetTilePosition_AfterArgs(Params_GetTilePosition args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 GetTilePosition_WithArgs (Func<tk2dTileMap,  int,  int, UnityEngine.Vector3> orig, tk2dTileMap self,  int x,  int y);
...
public delegate int GetTileIdAtPosition_WithArgs (Func<tk2dTileMap,  UnityEngine.Vector3,  int, int> orig, tk2dTileMap self,  UnityEngine.Vector3 position,  int layer);
...
public delegate tk2dRuntime.TileMap.TileInfo GetTileInfoForTileId_AfterArgs(Params_GetTileInfoForTileId args, tk2dRuntime.TileMap.TileInfo ret);
public delegate tk2dRuntime.TileMap.TileInfo GetTileInfoForTileId_WithArgs (Func<tk2dTileMap,  int, tk2dRuntime.TileMap.TileInfo> orig, tk2dTileMap self,  int tileId);
...
public delegate UnityEngine.Color GetInterpolatedColorAtPosition_AfterArgs(Params_GetInterpolatedColorAtPosition args, UnityEngine.Color ret);
public delegate UnityEngine.Color GetInterpolatedColorAtPosition_WithArgs (Func<tk2dTileMap,  UnityEngine.Vector3, UnityEngine.Color> orig, tk2dTileMap self,  UnityEngine.Vector3 position);
...
public delegate bool UsesSpriteCollection_WithArgs (Func<tk2dTileMap,  tk2dSpriteCollectionData, bool> orig, tk2dTileMap self,  tk2dSpriteCollectionData spriteCollection);
...
public delegate void TouchMesh_WithArgs (Action<tk2dTileMap,  UnityEngine.Mesh> orig, tk2dTileMap self,  UnityEngine.Mesh mesh);
...
public delegate void DestroyMesh_WithArgs (Action<tk2dTileMap,  UnityEngine.Mesh> orig, tk2dTileMap self,  UnityEngine.Mesh mesh);
...
public delegate System.Collections.Generic.List<tk2dTileMap.TilemapPrefabInstance> get_TilePrefabsList_AfterArgs(Params_get_TilePrefabsList args, System.Collections.Generic.List<tk2dTileMap.TilemapPrefabInstance> ret);
public delegate System.Collections.Generic.List<tk2dTileMap.TilemapPrefabInstance> get_TilePrefabsList_WithArgs (Func<tk2dTileMap, System.Collections.Generic.List<tk2dTileMap.TilemapPrefabInstance>> orig, tk2dTileMap self);
...
public delegate void GetTilePrefabsListItem_WithArgs (Action<tk2dTileMap,  int,  int,  int,  int,  UnityEngine.GameObject> orig, tk2dTileMap self,  int index, out  int x, out  int y, out  int layer, out  UnityEngine.GameObject instance);
...
public System.Collections.Generic.List<int> layers;
public System.Collections.Generic.List<UnityEngine.GameObject> instances;
}
...
public delegate void SetTilePrefabsList_WithArgs (Action<tk2dTileMap,  System.Collections.Generic.List<int>,  System.Collections.Generic.List<int>,  System.Collections.Generic.List<int>,  System.Collections.Generic.List<UnityEngine.GameObject>> orig, tk2dTileMap self,  System.Collections.Generic.List<int> xs,  System.Collections.Generic.List<int> ys,  System.Collections.Generic.List<int> layers,  System.Collections.Generic.List<UnityEngine.GameObject> instances);
public sealed class Params_get_Layers
{
public tk2dTileMap self;
}
public delegate void get_Layers_BeforeArgs(Params_get_Layers args);
public delegate tk2dRuntime.TileMap.Layer[] get_Layers_AfterArgs(Params_get_Layers args, tk2dRuntime.TileMap.Layer[] ret);
public delegate tk2dRuntime.TileMap.Layer[] get_Layers_WithArgs (Func<tk2dTileMap, tk2dRuntime.TileMap.Layer[]> orig, tk2dTileMap self);
public sealed class Params_set_Layers
{
public tk2dTileMap self;
public tk2dRuntime.TileMap.Layer[] value;
}
...
public delegate void set_Layers_WithArgs (Action<tk2dTileMap,  tk2dRuntime.TileMap.Layer[]> orig, tk2dTileMap self,  tk2dRuntime.TileMap.Layer[] value);
public sealed class Params_get_ColorChannel
{
public tk2dTileMap self;
}
public delegate void get_ColorChannel_BeforeArgs(Params_get_ColorChannel args);
public delegate tk2dRuntime.TileMap.ColorChannel get_ColorChannel_AfterArgs(Params_get_ColorChannel args, tk2dRuntime.TileMap.ColorChannel ret);
public delegate tk2dRuntime.TileMap.ColorChannel get_ColorChannel_WithArgs (Func<tk2dTileMap, tk2dRuntime.TileMap.ColorChannel> orig, tk2dTileMap self);
public sealed class Params_set_ColorChannel
{
public tk2dTileMap self;
public tk2dRuntime.TileMap.ColorChannel value;
}
...
public delegate void set_ColorChannel_WithArgs (Action<tk2dTileMap,  tk2dRuntime.TileMap.ColorChannel> orig, tk2dTileMap self,  tk2dRuntime.TileMap.ColorChannel value);
public sealed class Params_get_PrefabsRoot
{
public tk2dTileMap self;
}
public delegate void get_PrefabsRoot_BeforeArgs(Params_get_PrefabsRoot args);
public delegate UnityEngine.GameObject get_PrefabsRoot_AfterArgs(Params_get_PrefabsRoot args, UnityEngine.GameObject ret);
public delegate UnityEngine.GameObject get_PrefabsRoot_WithArgs (Func<tk2dTileMap, UnityEngine.GameObject> orig, tk2dTileMap self);
...
public delegate void set_PrefabsRoot_WithArgs (Action<tk2dTileMap,  UnityEngine.GameObject> orig, tk2dTileMap self,  UnityEngine.GameObject value);
...
public delegate int GetTile_WithArgs (Func<tk2dTileMap,  int,  int,  int, int> orig, tk2dTileMap self,  int x,  int y,  int layer);
...
public delegate tk2dTileFlags GetTileFlags_WithArgs (Func<tk2dTileMap,  int,  int,  int, tk2dTileFlags> orig, tk2dTileMap self,  int x,  int y,  int layer);
...
public delegate void SetTile_WithArgs (Action<tk2dTileMap,  int,  int,  int,  int> orig, tk2dTileMap self,  int x,  int y,  int layer,  int tile);
...
public delegate void SetTileFlags_WithArgs (Action<tk2dTileMap,  int,  int,  int,  tk2dTileFlags> orig, tk2dTileMap self,  int x,  int y,  int layer,  tk2dTileFlags flags);
...
public delegate void ClearTile_WithArgs (Action<tk2dTileMap,  int,  int,  int> orig, tk2dTileMap self,  int x,  int y,  int layer);
}
...
public static event Delegates.Build_BuildFlags_BeforeArgs Build_BuildFlags
{
add
{

HookHandler._beforeBuild_BuildFlags += value;
HookHandler.HookBuild_BuildFlags();
}
remove => HookHandler._beforeBuild_BuildFlags -= value;
}
...
public static event Delegates.Build_BuildFlags_AfterArgs Build_BuildFlags
{
add
{

HookHandler._afterBuild_BuildFlags += value;
HookHandler.HookBuild_BuildFlags();
}
remove => HookHandler._afterBuild_BuildFlags -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.get_Editor__SpriteCollection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Editor__SpriteCollection", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Editor__SpriteCollection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Editor__SpriteCollection", true), value);
}
public static event Delegates.set_Editor__SpriteCollection_WithArgs set_Editor__SpriteCollection
{
add => HookEndpointManager.Add<Delegates.set_Editor__SpriteCollection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Editor__SpriteCollection", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Editor__SpriteCollection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Editor__SpriteCollection", true), value);
}
public static event Delegates.get_SpriteCollectionInst_WithArgs get_SpriteCollectionInst
{
add => HookEndpointManager.Add<Delegates.get_SpriteCollectionInst_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_SpriteCollectionInst", true), value);
remove => HookEndpointManager.Remove<Delegates.get_SpriteCollectionInst_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_SpriteCollectionInst", true), value);
}
public static event Delegates.get_AllowEdit_WithArgs get_AllowEdit
{
add => HookEndpointManager.Add<Delegates.get_AllowEdit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_AllowEdit", true), value);
remove => HookEndpointManager.Remove<Delegates.get_AllowEdit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_AllowEdit", true), value);
}
...
public static event On.tk2dTileMap.hook_Build_BuildFlags Build_BuildFlags
{
add => On.tk2dTileMap.Build_BuildFlags += value;
remove => On.tk2dTileMap.Build_BuildFlags -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.get_TilePrefabsList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_TilePrefabsList", true), value);
remove => HookEndpointManager.Remove<Delegates.get_TilePrefabsList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_TilePrefabsList", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Layers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Layers", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Layers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Layers", true), value);
}
public static event Delegates.set_Layers_WithArgs set_Layers
{
add => HookEndpointManager.Add<Delegates.set_Layers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Layers", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Layers_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Layers", true), value);
}
public static event Delegates.get_ColorChannel_WithArgs get_ColorChannel
{
add => HookEndpointManager.Add<Delegates.get_ColorChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_ColorChannel", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ColorChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_ColorChannel", true), value);
}
public static event Delegates.set_ColorChannel_WithArgs set_ColorChannel
{
add => HookEndpointManager.Add<Delegates.set_ColorChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_ColorChannel", true), value);
remove => HookEndpointManager.Remove<Delegates.set_ColorChannel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_ColorChannel", true), value);
}
public static event Delegates.get_PrefabsRoot_WithArgs get_PrefabsRoot
{
add => HookEndpointManager.Add<Delegates.get_PrefabsRoot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_PrefabsRoot", true), value);
remove => HookEndpointManager.Remove<Delegates.get_PrefabsRoot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_PrefabsRoot", true), value);
}
public static event Delegates.set_PrefabsRoot_WithArgs set_PrefabsRoot
{
add => HookEndpointManager.Add<Delegates.set_PrefabsRoot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_PrefabsRoot", true), value);
remove => HookEndpointManager.Remove<Delegates.set_PrefabsRoot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_PrefabsRoot", true), value);
}
