...
public static class Ontk2dTileMap
{
    internal static class HookHandler
    {
        ...
        private static Vector3 GetTilePosition(On.tk2dTileMap.orig_GetTilePosition orig, tk2dTileMap self,
            int x, int y)
        {
        ...
        private static TileInfo GetTileInfoForTileId(On.tk2dTileMap.orig_GetTileInfoForTileId orig,
        ...
        private static Color GetInterpolatedColorAtPosition(
            On.tk2dTileMap.orig_GetInterpolatedColorAtPosition orig, tk2dTileMap self, Vector3 position)
        {
        ...
        private static List<tk2dTileMap.TilemapPrefabInstance> get_TilePrefabsList(
            Func<tk2dTileMap, List<tk2dTileMap.TilemapPrefabInstance>> orig,
            tk2dTileMap self)
        {
        ...
        private static Layer[] get_Layers(Func<tk2dTileMap, Layer[]> orig,
            tk2dTileMap self)
        {
        ...
        private static void set_Layers(Action<tk2dTileMap, Layer[]> orig, tk2dTileMap self,
            Layer[] value)
        {
        ...
        internal static void Hookget_ColorChannel()
        {
            if (!HookedList.Contains("get_ColorChannel"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_ColorChannel"),
                    get_ColorChannel);
            }
        }
        ...
        private static ColorChannel get_ColorChannel(
            Func<tk2dTileMap, ColorChannel> orig, tk2dTileMap self)
        {
        ...
        internal static void Hookset_ColorChannel()
        {
            if (!HookedList.Contains("set_ColorChannel"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_ColorChannel"),
                    set_ColorChannel);
            }
        }
        ...
        private static void set_ColorChannel(Action<tk2dTileMap, ColorChannel> orig,
            tk2dTileMap self, ColorChannel value)
        {
        ...
        private static GameObject get_PrefabsRoot(Func<tk2dTileMap, GameObject> orig,
            tk2dTileMap self)
        {
        ...
        private static void set_PrefabsRoot(Action<tk2dTileMap, GameObject> orig, tk2dTileMap self,
            GameObject value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DestroyMesh_WithArgs(Action<tk2dTileMap, Mesh> orig, tk2dTileMap self,
            Mesh mesh);
        ...
        public delegate ColorChannel get_ColorChannel_AfterArgs(Params_get_ColorChannel args,
            ColorChannel ret);

        public delegate void get_ColorChannel_BeforeArgs(Params_get_ColorChannel args);

        public delegate ColorChannel get_ColorChannel_WithArgs(
            Func<tk2dTileMap, ColorChannel> orig, tk2dTileMap self);
        ...
        public delegate Layer[] get_Layers_AfterArgs(Params_get_Layers args,
            Layer[] ret);

        public delegate void get_Layers_BeforeArgs(Params_get_Layers args);

        public delegate Layer[] get_Layers_WithArgs(
            Func<tk2dTileMap, Layer[]> orig, tk2dTileMap self);

        public delegate GameObject get_PrefabsRoot_AfterArgs(Params_get_PrefabsRoot args,
            GameObject ret);

        public delegate void get_PrefabsRoot_BeforeArgs(Params_get_PrefabsRoot args);

        public delegate GameObject get_PrefabsRoot_WithArgs(Func<tk2dTileMap, GameObject> orig,
            tk2dTileMap self);
        ...
        public delegate List<tk2dTileMap.TilemapPrefabInstance>
            get_TilePrefabsList_AfterArgs(Params_get_TilePrefabsList args,
                List<tk2dTileMap.TilemapPrefabInstance> ret);
        ...
        public delegate Color GetInterpolatedColorAtPosition_AfterArgs(
            Params_GetInterpolatedColorAtPosition args, Color ret);

        public delegate void GetInterpolatedColorAtPosition_BeforeArgs(Params_GetInterpolatedColorAtPosition args);

        public delegate Color GetInterpolatedColorAtPosition_WithArgs(
            Func<tk2dTileMap, Vector3, Color> orig, tk2dTileMap self,
            Vector3 position);
        ...
        public delegate bool GetTileFracAtPosition_WithArgs(
            Func<tk2dTileMap, Vector3, float, float, bool> orig, tk2dTileMap self,
            Vector3 position, out float x, out float y);
        ...
        public delegate int GetTileIdAtPosition_WithArgs(Func<tk2dTileMap, Vector3, int, int> orig,
            tk2dTileMap self, Vector3 position, int layer);

        public delegate TileInfo GetTileInfoForTileId_AfterArgs(Params_GetTileInfoForTileId args,
            TileInfo ret);

        public delegate void GetTileInfoForTileId_BeforeArgs(Params_GetTileInfoForTileId args);

        public delegate TileInfo GetTileInfoForTileId_WithArgs(
            Func<tk2dTileMap, int, TileInfo> orig, tk2dTileMap self, int tileId);

        public delegate Vector3 GetTilePosition_AfterArgs(Params_GetTilePosition args,
            Vector3 ret);

        public delegate void GetTilePosition_BeforeArgs(Params_GetTilePosition args);

        public delegate Vector3 GetTilePosition_WithArgs(
            Func<tk2dTileMap, int, int, Vector3> orig, tk2dTileMap self, int x, int y);
        ...
        public delegate void GetTilePrefabsListItem_WithArgs(
            Action<tk2dTileMap, int, int, int, int, GameObject> orig, tk2dTileMap self, int index,
            out int x, out int y, out int layer, out GameObject instance);
        ...
        public delegate void set_ColorChannel_WithArgs(Action<tk2dTileMap, ColorChannel> orig,
            tk2dTileMap self, ColorChannel value);
        ...
        public delegate void set_Layers_WithArgs(Action<tk2dTileMap, Layer[]> orig,
            tk2dTileMap self, Layer[] value);
        ...
        public delegate void set_PrefabsRoot_WithArgs(Action<tk2dTileMap, GameObject> orig,
            tk2dTileMap self, GameObject value);
        ...
        public delegate void SetTilePrefabsList_WithArgs(
            Action<tk2dTileMap, List<int>, List<int>,
                List<int>, List<GameObject>> orig,
            tk2dTileMap self, List<int> xs, List<int> ys,
            List<int> layers,
            List<GameObject> instances);
        ...
        public delegate void TouchMesh_WithArgs(Action<tk2dTileMap, Mesh> orig, tk2dTileMap self,
            Mesh mesh);
