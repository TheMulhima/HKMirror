...
public static class OnXbox360MacFirefoxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360MacFirefoxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360MacFirefoxUnityProfile> orig, Xbox360MacFirefoxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360MacFirefoxUnityProfile> orig,
            Xbox360MacFirefoxUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360MacFirefoxUnityProfile self;
        }
    }
