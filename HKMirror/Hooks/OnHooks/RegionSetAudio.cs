...
private static void OnTriggerEnter2D(On.RegionSetAudio.orig_OnTriggerEnter2D orig,RegionSetAudio self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerStay2D(On.RegionSetAudio.orig_OnTriggerStay2D orig,RegionSetAudio self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerExit2D(On.RegionSetAudio.orig_OnTriggerExit2D orig,RegionSetAudio self,  UnityEngine.Collider2D otherCollider)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<RegionSetAudio,  UnityEngine.Collider2D> orig, RegionSetAudio self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerStay2D_WithArgs (Action<RegionSetAudio,  UnityEngine.Collider2D> orig, RegionSetAudio self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerExit2D_WithArgs (Action<RegionSetAudio,  UnityEngine.Collider2D> orig, RegionSetAudio self,  UnityEngine.Collider2D otherCollider);
}
