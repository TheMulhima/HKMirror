...
/// <summary>
/// Contains different types of On Hooks for GGCheckBoundNail class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGGCheckBoundNail
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundNail), "get_IsTrue", true), get_IsTrue);
...
private static bool get_IsTrue(Func<GGCheckBoundNail, bool> orig, GGCheckBoundNail self)
{
...
public delegate bool get_IsTrue_WithArgs (Func<GGCheckBoundNail, bool> orig, GGCheckBoundNail self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundNail), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundNail), "get_IsTrue", true), value);
}
}
