...
public static class OnPlayStation4SteamLinkMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4SteamLinkMacUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4SteamLinkMacUnityProfile> orig,
            PlayStation4SteamLinkMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4SteamLinkMacUnityProfile> orig,
            PlayStation4SteamLinkMacUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4SteamLinkMacUnityProfile self;
        }
    }
