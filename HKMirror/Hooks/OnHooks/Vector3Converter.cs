...
public static class OnVector3Converter
{
    internal static class HookHandler
    {
        ...
        internal static void HookReadJson()
        {
            if (!HookedList.Contains("ReadJson"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "ReadJson", true),
                    ReadJson);
            }
        }
        ...
        private static UnityEngine.Vector3 ReadJson(
            Func<Modding.Converters.Vector3Converter, System.Collections.Generic.Dictionary<string, System.Object>,
                System.Object, UnityEngine.Vector3> orig, Modding.Converters.Vector3Converter self,
        ...
        internal static void HookWriteJson()
        {
            if (!HookedList.Contains("WriteJson"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "WriteJson", true),
                    WriteJson);
            }
        }
        ...
        private static void WriteJson(
            Action<Modding.Converters.Vector3Converter, Newtonsoft.Json.JsonWriter, UnityEngine.Vector3> orig,
            Modding.Converters.Vector3Converter self, Newtonsoft.Json.JsonWriter writer, UnityEngine.Vector3 value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Vector3 ReadJson_WithArgs(
            Func<Modding.Converters.Vector3Converter, System.Collections.Generic.Dictionary<string, System.Object>,
                System.Object, UnityEngine.Vector3> orig, Modding.Converters.Vector3Converter self,
            System.Collections.Generic.Dictionary<string, System.Object> token, System.Object existingValue);
    ...
    public static class WithOrig
    {
        public static event Delegates.ReadJson_WithArgs ReadJson
        {
            add => HookEndpointManager.Add<Delegates.ReadJson_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "ReadJson", true), value);
        ...
        public static event Delegates.WriteJson_WithArgs WriteJson
        {
            add => HookEndpointManager.Add<Delegates.WriteJson_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "WriteJson", true), value);
