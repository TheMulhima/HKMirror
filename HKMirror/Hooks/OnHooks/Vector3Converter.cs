...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "ReadJson", true), ReadJson);
...
private static UnityEngine.Vector3 ReadJson(Func<Modding.Converters.Vector3Converter,  System.Collections.Generic.Dictionary<string,System.Object>,  System.Object, UnityEngine.Vector3> orig, Modding.Converters.Vector3Converter self,  System.Collections.Generic.Dictionary<string,System.Object> token,  System.Object existingValue)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "WriteJson", true), WriteJson);
...
private static void WriteJson(Action<Modding.Converters.Vector3Converter,  Newtonsoft.Json.JsonWriter,  UnityEngine.Vector3> orig, Modding.Converters.Vector3Converter self,  Newtonsoft.Json.JsonWriter writer,  UnityEngine.Vector3 value)
{
...
{
public Modding.Converters.Vector3Converter self;
...
public delegate UnityEngine.Vector3 ReadJson_AfterArgs(Params_ReadJson args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 ReadJson_WithArgs (Func<Modding.Converters.Vector3Converter,  System.Collections.Generic.Dictionary<string,System.Object>,  System.Object, UnityEngine.Vector3> orig, Modding.Converters.Vector3Converter self,  System.Collections.Generic.Dictionary<string,System.Object> token,  System.Object existingValue);
...
public delegate void WriteJson_WithArgs (Action<Modding.Converters.Vector3Converter,  Newtonsoft.Json.JsonWriter,  UnityEngine.Vector3> orig, Modding.Converters.Vector3Converter self,  Newtonsoft.Json.JsonWriter writer,  UnityEngine.Vector3 value);
}
...
{
add => HookEndpointManager.Add<Delegates.ReadJson_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "ReadJson", true), value);
remove => HookEndpointManager.Remove<Delegates.ReadJson_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "ReadJson", true), value);
}
public static event Delegates.WriteJson_WithArgs WriteJson
{
add => HookEndpointManager.Add<Delegates.WriteJson_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "WriteJson", true), value);
remove => HookEndpointManager.Remove<Delegates.WriteJson_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Converters.Vector3Converter), "WriteJson", true), value);
}
}
