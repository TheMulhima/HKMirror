...
public static class OnLayer
{
    internal static class HookHandler
    {
        ...
        private static void Init(Action<Layer, int, int, int, int, int> orig,
            Layer self, int hash, int width, int height, int divX, int divY)
        {
        ...
        internal static void Hookget_IsEmpty()
        {
            if (!HookedList.Contains("get_IsEmpty"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "get_IsEmpty"),
                    get_IsEmpty);
            }
        }
        ...
        internal static void HookGetChunkData()
        {
            if (!HookedList.Contains("GetChunkData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "GetChunkData"),
                    GetChunkData);
            }
        }
        ...
        private static int[] GetChunkData(Func<Layer, int, int, int[]> orig,
            Layer self, int x, int y)
        {
        ...
        private static SpriteChunk GetChunk(
            Func<Layer, int, int, SpriteChunk> orig,
            Layer self, int x, int y)
        {
        ...
        internal static void HookFindChunkAndCoordinate()
        {
            if (!HookedList.Contains("FindChunkAndCoordinate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Layer), "FindChunkAndCoordinate"),
        ...
        private static SpriteChunk FindChunkAndCoordinate(
            Func<Layer, int, int, int, SpriteChunk> orig,
            Layer self, int x, int y, int offset)
        {
        ...
        internal static void HookGetRawTileValue()
        {
            if (!HookedList.Contains("GetRawTileValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "GetRawTileValue"),
                    GetRawTileValue);
            }
        }
        ...
        private static bool GetRawTileValue(Func<Layer, int, int, int, bool> orig,
            Layer self, int x, int y, int value)
        {
        ...
        internal static void HookSetRawTileValue()
        {
            if (!HookedList.Contains("SetRawTileValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "SetRawTileValue"),
                    SetRawTileValue);
            }
        }
        ...
        private static void SetRawTileValue(Action<Layer, int, int, int> orig,
            Layer self, int x, int y, int value)
        {
        ...
        internal static void HookDestroyGameData()
        {
            if (!HookedList.Contains("DestroyGameData"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "DestroyGameData"),
                    DestroyGameData);
            }
        }
        ...
        private static void DestroyGameData(Action<Layer, tk2dTileMap> orig,
            Layer self, tk2dTileMap tilemap)
        {
        ...
        private static int GetTile(Func<Layer, int, int, int> orig, Layer self,
            int x, int y)
        {
        ...
        internal static void HookGetTileFlags()
        {
            if (!HookedList.Contains("GetTileFlags"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "GetTileFlags"),
                    GetTileFlags);
            }
        }
        ...
        private static tk2dTileFlags GetTileFlags(Func<Layer, int, int, tk2dTileFlags> orig,
            Layer self, int x, int y)
        {
        ...
        internal static void HookGetRawTile()
        {
            if (!HookedList.Contains("GetRawTile"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "GetRawTile"),
                    GetRawTile);
            }
        }
        ...
        private static int GetRawTile(Func<Layer, int, int, int> orig,
            Layer self, int x, int y)
        {
        ...
        private static void SetTile(Action<Layer, int, int, int> orig,
            Layer self, int x, int y, int tile)
        {
        ...
        internal static void HookSetTileFlags()
        {
            if (!HookedList.Contains("SetTileFlags"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "SetTileFlags"),
                    SetTileFlags);
            }
        }
        ...
        private static void SetTileFlags(Action<Layer, int, int, tk2dTileFlags> orig,
            Layer self, int x, int y, tk2dTileFlags flags)
        {
        ...
        internal static void HookClearTile()
        {
            if (!HookedList.Contains("ClearTile"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "ClearTile"),
                    ClearTile);
            }
        }
        ...
        private static void ClearTile(Action<Layer, int, int> orig, Layer self,
            int x, int y)
        {
        ...
        internal static void HookSetRawTile()
        {
            if (!HookedList.Contains("SetRawTile"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "SetRawTile"),
                    SetRawTile);
            }
        }
        ...
        private static void SetRawTile(Action<Layer, int, int, int> orig,
            Layer self, int x, int y, int rawTile)
        {
        ...
        internal static void HookCreateChunk()
        {
            if (!HookedList.Contains("CreateChunk"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "CreateChunk"),
                    CreateChunk);
            }
        }
        ...
        private static void CreateChunk(Action<Layer, SpriteChunk> orig,
            Layer self, SpriteChunk chunk)
        {
        ...
        internal static void HookOptimize_SpriteChunk()
        {
            if (!HookedList.Contains("Optimize_SpriteChunk"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Layer), "Optimize_SpriteChunk"),
        ...
        private static void Optimize_SpriteChunk(
            Action<Layer, SpriteChunk> orig, Layer self,
            SpriteChunk chunk)
        {
        ...
        internal static void HookOptimizeIncremental()
        {
            if (!HookedList.Contains("OptimizeIncremental"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "OptimizeIncremental"),
                    OptimizeIncremental);
            }
        }
        ...
        internal static void HookClearDirtyFlag()
        {
            if (!HookedList.Contains("ClearDirtyFlag"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "ClearDirtyFlag"),
                    ClearDirtyFlag);
            }
        }
        ...
        internal static void Hookget_NumActiveChunks()
        {
            if (!HookedList.Contains("get_NumActiveChunks"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Layer), "get_NumActiveChunks"),
                    get_NumActiveChunks);
            }
        }
        ...
        private static int get_NumActiveChunks(Func<Layer, int> orig,
            Layer self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void ClearDirtyFlag_WithArgs(Action<Layer> orig,
            Layer self);
        ...
        public delegate void ClearTile_WithArgs(Action<Layer, int, int> orig,
            Layer self, int x, int y);
        ...
        public delegate void Create_WithArgs(Action<Layer> orig, Layer self);
        ...
        public delegate void DestroyGameData_WithArgs(Action<Layer, tk2dTileMap> orig,
            Layer self, tk2dTileMap tilemap);

        public delegate SpriteChunk FindChunkAndCoordinate_AfterArgs(
            Params_FindChunkAndCoordinate args, SpriteChunk ret);

        public delegate void FindChunkAndCoordinate_BeforeArgs(Params_FindChunkAndCoordinate args);

        public delegate SpriteChunk FindChunkAndCoordinate_WithArgs(
            Func<Layer, int, int, int, SpriteChunk> orig,
            Layer self, int x, int y, int offset);
        ...
        public delegate bool get_IsEmpty_WithArgs(Func<Layer, bool> orig,
            Layer self);
        ...
        public delegate int get_NumActiveChunks_WithArgs(Func<Layer, int> orig,
            Layer self);

        public delegate SpriteChunk GetChunk_AfterArgs(Params_GetChunk args,
            SpriteChunk ret);

        public delegate void GetChunk_BeforeArgs(Params_GetChunk args);

        public delegate SpriteChunk GetChunk_WithArgs(
            Func<Layer, int, int, SpriteChunk> orig,
            Layer self, int x, int y);
        ...
        public delegate int[] GetChunkData_WithArgs(Func<Layer, int, int, int[]> orig,
            Layer self, int x, int y);
        ...
        public delegate int GetRawTile_WithArgs(Func<Layer, int, int, int> orig,
            Layer self, int x, int y);
        ...
        public delegate bool GetRawTileValue_WithArgs(Func<Layer, int, int, int, bool> orig,
            Layer self, int x, int y, int value);
        ...
        public delegate int GetTile_WithArgs(Func<Layer, int, int, int> orig,
            Layer self, int x, int y);
        ...
        public delegate tk2dTileFlags GetTileFlags_WithArgs(
            Func<Layer, int, int, tk2dTileFlags> orig, Layer self, int x,
            int y);
        ...
        public delegate void Init_WithArgs(Action<Layer, int, int, int, int, int> orig,
            Layer self, int hash, int width, int height, int divX, int divY);
        ...
        public delegate void Optimize_WithArgs(Action<Layer> orig, Layer self);
        ...
        public delegate void OptimizeIncremental_WithArgs(Action<Layer> orig,
            Layer self);
        ...
        public delegate void SetRawTile_WithArgs(Action<Layer, int, int, int> orig,
            Layer self, int x, int y, int rawTile);
        ...
        public delegate void SetRawTileValue_WithArgs(Action<Layer, int, int, int> orig,
            Layer self, int x, int y, int value);
        ...
        public delegate void SetTile_WithArgs(Action<Layer, int, int, int> orig,
            Layer self, int x, int y, int tile);
        ...
        public delegate void SetTileFlags_WithArgs(Action<Layer, int, int, tk2dTileFlags> orig,
            Layer self, int x, int y, tk2dTileFlags flags);
