...
public static class OnMLGControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MLGControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MLGControllerMacNativeProfile> orig, MLGControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MLGControllerMacNativeProfile> orig,
            MLGControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MLGControllerMacNativeProfile self;
        }
    }
