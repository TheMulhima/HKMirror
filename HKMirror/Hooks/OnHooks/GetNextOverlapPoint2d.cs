...
public static class OnGetNextOverlapPoint2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self)
        {
        ...
        private static void DoGetNextCollider(Action<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self)
        {
        ...
        internal static void HookGetOverlapPointAll()
        {
            if (!HookedList.Contains("GetOverlapPointAll"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d),
                        "GetOverlapPointAll", true), GetOverlapPointAll);
            }
        }
        ...
        private static UnityEngine.Collider2D[] GetOverlapPointAll(
            Func<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d, UnityEngine.Collider2D[]> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self);
        ...
        public delegate void DoGetNextCollider_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self);
        ...
        public delegate UnityEngine.Collider2D[] GetOverlapPointAll_AfterArgs(Params_GetOverlapPointAll args,
            UnityEngine.Collider2D[] ret);

        public delegate UnityEngine.Collider2D[] GetOverlapPointAll_WithArgs(
            Func<HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d, UnityEngine.Collider2D[]> orig,
            HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextOverlapPoint2d), "OnEnter",
                    true), value);
