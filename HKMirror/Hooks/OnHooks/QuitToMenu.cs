...
public static class OnQuitToMenu
{
    internal static class HookHandler
    {
        ...
        private static IEnumerator Start(On.QuitToMenu.orig_Start orig, QuitToMenu self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator Start_WithArgs(Func<QuitToMenu, IEnumerator> orig, QuitToMenu self);
