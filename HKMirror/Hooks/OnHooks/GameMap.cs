...
{
foreach (Delegates.GetTilemapDimensions_BeforeArgs toInvoke in _beforeGetTilemapDimensions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetTilemapDimensions_AfterArgs toInvoke in _afterGetTilemapDimensions.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapAncientBasin_BeforeArgs toInvoke in _beforeQuickMapAncientBasin.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapAncientBasin_AfterArgs toInvoke in _afterQuickMapAncientBasin.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapCrossroads_BeforeArgs toInvoke in _beforeQuickMapCrossroads.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapCrossroads_AfterArgs toInvoke in _afterQuickMapCrossroads.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapCrystalPeak_BeforeArgs toInvoke in _beforeQuickMapCrystalPeak.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapCrystalPeak_AfterArgs toInvoke in _afterQuickMapCrystalPeak.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapFogCanyon_BeforeArgs toInvoke in _beforeQuickMapFogCanyon.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapFungalWastes_BeforeArgs toInvoke in _beforeQuickMapFungalWastes.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapFungalWastes_AfterArgs toInvoke in _afterQuickMapFungalWastes.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapGreenpath_BeforeArgs toInvoke in _beforeQuickMapGreenpath.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapKingdomsEdge_BeforeArgs toInvoke in _beforeQuickMapKingdomsEdge.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapKingdomsEdge_AfterArgs toInvoke in _afterQuickMapKingdomsEdge.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapQueensGardens_BeforeArgs toInvoke in _beforeQuickMapQueensGardens.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapQueensGardens_AfterArgs toInvoke in _afterQuickMapQueensGardens.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapRestingGrounds_BeforeArgs toInvoke in _beforeQuickMapRestingGrounds.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapRestingGrounds_AfterArgs toInvoke in _afterQuickMapRestingGrounds.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapDirtmouth_BeforeArgs toInvoke in _beforeQuickMapDirtmouth.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QuickMapWaterways_BeforeArgs toInvoke in _beforeQuickMapWaterways.GetInvocationList())
{
try
{
...
{
foreach (Delegates.PositionDreamGateMarker_BeforeArgs toInvoke in _beforePositionDreamGateMarker.GetInvocationList())
{
try
{
...
{
foreach (Delegates.PositionDreamGateMarker_AfterArgs toInvoke in _afterPositionDreamGateMarker.GetInvocationList())
{
try
{
...
private static void SetManualTilemap(On.GameMap.orig_SetManualTilemap orig,GameMap self,  float offsetX,  float offsetY,  float width,  float height)
{
...
private static void SetDoorValues(On.GameMap.orig_SetDoorValues orig,GameMap self,  float x,  float y,  string scene,  string mapZone)
{
...
private static void SetCustomCompassPos(On.GameMap.orig_SetCustomCompassPos orig,GameMap self,  float x,  float y,  string scene,  string mapZone,  float offsetX,  float offsetY,  float width,  float height)
{
...
{
foreach (Delegates.SetCustomCompassPos_BeforeArgs toInvoke in _beforeSetCustomCompassPos.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetCustomCompassPos_AfterArgs toInvoke in _afterSetCustomCompassPos.GetInvocationList())
{
try
{
...
private static void SetPanArrows(On.GameMap.orig_SetPanArrows orig,GameMap self,  UnityEngine.GameObject arrowU,  UnityEngine.GameObject arrowD,  UnityEngine.GameObject arrowL,  UnityEngine.GameObject arrowR)
{
...
public delegate void SetManualTilemap_WithArgs (Action<GameMap,  float,  float,  float,  float> orig, GameMap self,  float offsetX,  float offsetY,  float width,  float height);
...
public delegate void SetDoorValues_WithArgs (Action<GameMap,  float,  float,  string,  string> orig, GameMap self,  float x,  float y,  string scene,  string mapZone);
...
public delegate void SetCustomCompassPos_WithArgs (Action<GameMap,  float,  float,  string,  string,  float,  float,  float,  float> orig, GameMap self,  float x,  float y,  string scene,  string mapZone,  float offsetX,  float offsetY,  float width,  float height);
...
{
public GameMap self;
public UnityEngine.GameObject arrowU;
public UnityEngine.GameObject arrowD;
public UnityEngine.GameObject arrowL;
public UnityEngine.GameObject arrowR;
}
...
public delegate void SetPanArrows_WithArgs (Action<GameMap,  UnityEngine.GameObject,  UnityEngine.GameObject,  UnityEngine.GameObject,  UnityEngine.GameObject> orig, GameMap self,  UnityEngine.GameObject arrowU,  UnityEngine.GameObject arrowD,  UnityEngine.GameObject arrowL,  UnityEngine.GameObject arrowR);
