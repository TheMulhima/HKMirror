...
public static class OnXboxOneEliteWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneEliteWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneEliteWindowsNativeProfile> orig, XboxOneEliteWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneEliteWindowsNativeProfile> orig,
            XboxOneEliteWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneEliteWindowsNativeProfile self;
        }
    }
