...
public static class OnGGCheckBossSequenceList
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_IsTrue()
        {
            if (!HookedList.Contains("get_IsTrue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckBossSequenceList), "get_IsTrue"), get_IsTrue);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_IsTrue_WithArgs(Func<GGCheckBossSequenceList, bool> orig,
            GGCheckBossSequenceList self);
