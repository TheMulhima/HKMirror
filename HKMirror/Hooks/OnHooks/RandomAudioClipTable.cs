...
public static class OnRandomAudioClipTable
{
    internal static class HookHandler
    {
        ...
        private static UnityEngine.AudioClip SelectClip(On.RandomAudioClipTable.orig_SelectClip orig,
            RandomAudioClipTable self)
        {
        ...
        private static void PlayOneShotUnsafe(On.RandomAudioClipTable.orig_PlayOneShotUnsafe orig,
            RandomAudioClipTable self, UnityEngine.AudioSource audioSource)
        {
            ...
            {
                foreach (Delegates.PlayOneShotUnsafe_BeforeArgs toInvoke in
                         _beforePlayOneShotUnsafe.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.AudioClip SelectClip_WithArgs(
            Func<RandomAudioClipTable, UnityEngine.AudioClip> orig, RandomAudioClipTable self);
        ...
        public delegate void PlayOneShotUnsafe_WithArgs(Action<RandomAudioClipTable, UnityEngine.AudioSource> orig,
            RandomAudioClipTable self, UnityEngine.AudioSource audioSource);
    }
