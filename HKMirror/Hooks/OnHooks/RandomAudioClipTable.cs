...
public static class OnRandomAudioClipTable
{
    ...
    public static class Delegates
    {
        ...
        public delegate void PlayOneShotUnsafe_WithArgs(Action<RandomAudioClipTable, AudioSource> orig,
            RandomAudioClipTable self, AudioSource audioSource);
        ...
        public delegate AudioClip SelectClip_AfterArgs(Params_SelectClip args, AudioClip ret);

        public delegate void SelectClip_BeforeArgs(Params_SelectClip args);

        public delegate AudioClip SelectClip_WithArgs(Func<RandomAudioClipTable, AudioClip> orig,
