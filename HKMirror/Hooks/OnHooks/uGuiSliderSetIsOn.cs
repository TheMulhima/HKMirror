...
public static class OnuGuiSliderSetIsOn
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn),
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self);
        ...
        public delegate void DoSetValue_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn> orig,
            HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn), "Reset", true),
                value);
        ...
        public static event Delegates.DoSetValue_WithArgs DoSetValue
        {
            add => HookEndpointManager.Add<Delegates.DoSetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn), "DoSetValue",
                    true), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiSliderSetIsOn), "OnExit", true),
                value);
