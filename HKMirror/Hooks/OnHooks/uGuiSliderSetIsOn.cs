...
public static class OnuGuiSliderSetIsOn
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "DoSetValue"), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiSliderSetIsOn> orig, uGuiSliderSetIsOn self);

        public sealed class Params_Reset
        {
            public uGuiSliderSetIsOn self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "OnEnter"), value);
        ...
        public static event Delegates.DoSetValue_WithArgs DoSetValue
        {
            add => HookEndpointManager.Add<Delegates.DoSetValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "DoSetValue"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetIsOn), "OnExit"), value);
