...
public static class OnNVidiaShield2016AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NVidiaShield2016AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NVidiaShield2016AndroidUnityProfile> orig,
            NVidiaShield2016AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NVidiaShield2016AndroidUnityProfile> orig,
            NVidiaShield2016AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public NVidiaShield2016AndroidUnityProfile self;
        }
    }
