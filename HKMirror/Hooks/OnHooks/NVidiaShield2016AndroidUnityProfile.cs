...
public static class OnNVidiaShield2016AndroidUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.NVidiaShield2016AndroidUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.NVidiaShield2016AndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.NVidiaShield2016AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.NVidiaShield2016AndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.NVidiaShield2016AndroidUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.UnityDeviceProfiles.NVidiaShield2016AndroidUnityProfile), "Define", true), value);
