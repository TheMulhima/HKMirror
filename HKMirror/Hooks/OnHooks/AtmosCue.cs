...
private static UnityEngine.Audio.AudioMixerSnapshot get_Snapshot(Func<AtmosCue, UnityEngine.Audio.AudioMixerSnapshot> orig, AtmosCue self)
{
...
private static bool IsChannelEnabled(On.AtmosCue.orig_IsChannelEnabled orig,AtmosCue self,  AtmosChannels channel)
{
...
public delegate UnityEngine.Audio.AudioMixerSnapshot get_Snapshot_WithArgs (Func<AtmosCue, UnityEngine.Audio.AudioMixerSnapshot> orig, AtmosCue self);
...
public delegate bool IsChannelEnabled_WithArgs (Func<AtmosCue,  AtmosChannels, bool> orig, AtmosCue self,  AtmosChannels channel);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Snapshot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AtmosCue), "get_Snapshot", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Snapshot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(AtmosCue), "get_Snapshot", true), value);
}
