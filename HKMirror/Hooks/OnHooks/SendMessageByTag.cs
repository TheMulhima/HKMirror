...
public static class OnSendMessageByTag
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageByTag), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SendMessageByTag> orig,
            HutongGames.PlayMaker.Actions.SendMessageByTag self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageByTag), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.SendMessageByTag> orig,
            HutongGames.PlayMaker.Actions.SendMessageByTag self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SendMessageByTag> orig,
            HutongGames.PlayMaker.Actions.SendMessageByTag self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.SendMessageByTag> orig,
            HutongGames.PlayMaker.Actions.SendMessageByTag self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageByTag), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageByTag), "OnExit", true),
                value);
