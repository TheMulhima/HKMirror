...
public static class OnPrefabSwapper
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.contains_NormalArgs _aftercontains;
        ...
        private static bool contains(On.PrefabSwapper.orig_contains orig, PrefabSwapper self, string testGo)
        {
            ...
            {
                self = self, testGo = testGo
            };
            _beforecontains?.Invoke(@params);
            self = @params.self;
            testGo = @params.testGo;
            var retVal = orig(self, testGo);
            if (_aftercontains != null) retVal = _aftercontains.Invoke(@params);
            return retVal;
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate bool contains_NormalArgs(Params_contains args);
    ...
    {
        public static event Delegates.contains_NormalArgs contains
        {
            add
            {
