...
public static class OnMadCatzFightStickTE2MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzFightStickTE2MacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzFightStickTE2MacNativeProfile> orig,
            MadCatzFightStickTE2MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzFightStickTE2MacNativeProfile> orig,
            MadCatzFightStickTE2MacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzFightStickTE2MacNativeProfile self;
        }
    }
