...
public static class OnStagTravel
{
    internal static class HookHandler
    {
        ...
        private static System.Collections.IEnumerator FadeInRoutine(On.StagTravel.orig_FadeInRoutine orig,
            StagTravel self)
        {
        ...
        internal static void Hookget_IsReadyToActivate()
        {
            if (!HookedList.Contains("get_IsReadyToActivate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(StagTravel), "get_IsReadyToActivate", true),
        ...
        private static bool get_IsReadyToActivate(Func<StagTravel, bool> orig, StagTravel self)
        {
            ...
            {
                foreach (Delegates.get_IsReadyToActivate_BeforeArgs toInvoke in _beforeget_IsReadyToActivate
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsReadyToActivate_AfterArgs toInvoke in _afterget_IsReadyToActivate
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate System.Collections.IEnumerator Start_WithArgs(
            Func<StagTravel, System.Collections.IEnumerator> orig, StagTravel self);
        ...
        public delegate System.Collections.IEnumerator FadeInRoutine_AfterArgs(Params_FadeInRoutine args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator FadeInRoutine_WithArgs(
            Func<StagTravel, System.Collections.IEnumerator> orig, StagTravel self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_IsReadyToActivate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(StagTravel), "get_IsReadyToActivate", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsReadyToActivate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(StagTravel), "get_IsReadyToActivate", true), value);
        }
