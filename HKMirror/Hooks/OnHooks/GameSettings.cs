...
private static void LoadGameOptionsSettings(On.GameSettings.orig_LoadGameOptionsSettings orig,GameSettings self)
{
...
private static void SaveGameOptionsSettings(On.GameSettings.orig_SaveGameOptionsSettings orig,GameSettings self)
{
...
{
foreach (Delegates.SaveGameOptionsSettings_BeforeArgs toInvoke in _beforeSaveGameOptionsSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveGameOptionsSettings_AfterArgs toInvoke in _afterSaveGameOptionsSettings.GetInvocationList())
{
try
{
...
private static void ResetGameOptionsSettings(On.GameSettings.orig_ResetGameOptionsSettings orig,GameSettings self)
{
...
{
foreach (Delegates.ResetGameOptionsSettings_BeforeArgs toInvoke in _beforeResetGameOptionsSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetGameOptionsSettings_AfterArgs toInvoke in _afterResetGameOptionsSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveVideoSettings_BeforeArgs toInvoke in _beforeSaveVideoSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetVideoSettings_BeforeArgs toInvoke in _beforeResetVideoSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetVideoSettings_AfterArgs toInvoke in _afterResetVideoSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadOverscanSettings_BeforeArgs toInvoke in _beforeLoadOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadOverscanSettings_AfterArgs toInvoke in _afterLoadOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetOverscanSettings_BeforeArgs toInvoke in _beforeResetOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetOverscanSettings_AfterArgs toInvoke in _afterResetOverscanSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadOverscanConfigured_BeforeArgs toInvoke in _beforeLoadOverscanConfigured.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadOverscanConfigured_AfterArgs toInvoke in _afterLoadOverscanConfigured.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadBrightnessSettings_BeforeArgs toInvoke in _beforeLoadBrightnessSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadBrightnessSettings_AfterArgs toInvoke in _afterLoadBrightnessSettings.GetInvocationList())
{
try
{
...
private static void ResetBrightnessSettings(On.GameSettings.orig_ResetBrightnessSettings orig,GameSettings self)
{
...
{
foreach (Delegates.ResetBrightnessSettings_BeforeArgs toInvoke in _beforeResetBrightnessSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetBrightnessSettings_AfterArgs toInvoke in _afterResetBrightnessSettings.GetInvocationList())
{
try
{
...
private static void LoadBrightnessConfigured(On.GameSettings.orig_LoadBrightnessConfigured orig,GameSettings self)
{
...
{
foreach (Delegates.LoadBrightnessConfigured_BeforeArgs toInvoke in _beforeLoadBrightnessConfigured.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadBrightnessConfigured_AfterArgs toInvoke in _afterLoadBrightnessConfigured.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveAudioSettings_BeforeArgs toInvoke in _beforeSaveAudioSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetAudioSettings_BeforeArgs toInvoke in _beforeResetAudioSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetAudioSettings_AfterArgs toInvoke in _afterResetAudioSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadKeyboardSettings_BeforeArgs toInvoke in _beforeLoadKeyboardSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadKeyboardSettings_AfterArgs toInvoke in _afterLoadKeyboardSettings.GetInvocationList())
{
try
{
...
private static void LoadAndUpgradeKeyboardKey(On.GameSettings.orig_LoadAndUpgradeKeyboardKey orig,GameSettings self,  string prefsKey, ref  string setString,  InControl.Key defaultKey)
{
...
{
foreach (Delegates.LoadAndUpgradeKeyboardKey_BeforeArgs toInvoke in _beforeLoadAndUpgradeKeyboardKey.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadAndUpgradeKeyboardKey_AfterArgs toInvoke in _afterLoadAndUpgradeKeyboardKey.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveKeyboardSettings_BeforeArgs toInvoke in _beforeSaveKeyboardSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveKeyboardSettings_AfterArgs toInvoke in _afterSaveKeyboardSettings.GetInvocationList())
{
try
{
...
private static bool LoadGamepadSettings(On.GameSettings.orig_LoadGamepadSettings orig,GameSettings self,  GlobalEnums.GamepadType gamepadType)
{
...
{
foreach (Delegates.LoadGamepadSettings_BeforeArgs toInvoke in _beforeLoadGamepadSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadGamepadSettings_AfterArgs toInvoke in _afterLoadGamepadSettings.GetInvocationList())
{
try
{
...
private static void SaveGamepadSettings(On.GameSettings.orig_SaveGamepadSettings orig,GameSettings self,  GlobalEnums.GamepadType gamepadType)
{
...
{
foreach (Delegates.SaveGamepadSettings_BeforeArgs toInvoke in _beforeSaveGamepadSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveGamepadSettings_AfterArgs toInvoke in _afterSaveGamepadSettings.GetInvocationList())
{
try
{
...
private static void ResetGamepadSettings(On.GameSettings.orig_ResetGamepadSettings orig,GameSettings self,  GlobalEnums.GamepadType gamepadType)
{
...
{
foreach (Delegates.ResetGamepadSettings_BeforeArgs toInvoke in _beforeResetGamepadSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetGamepadSettings_AfterArgs toInvoke in _afterResetGamepadSettings.GetInvocationList())
{
try
{
...
private static GlobalEnums.GamepadType RemapGamepadTypeForSettings(On.GameSettings.orig_RemapGamepadTypeForSettings orig,GameSettings self,  GlobalEnums.GamepadType sourceType)
{
...
{
foreach (Delegates.RemapGamepadTypeForSettings_BeforeArgs toInvoke in _beforeRemapGamepadTypeForSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RemapGamepadTypeForSettings_AfterArgs toInvoke in _afterRemapGamepadTypeForSettings.GetInvocationList())
{
try
{
...
private static bool LoadInt(On.GameSettings.orig_LoadInt orig,GameSettings self,  string key, ref  int val,  int def)
{
...
private static bool LoadBool(On.GameSettings.orig_LoadBool orig,GameSettings self,  string key, ref  bool val,  bool def)
{
...
private static bool LoadFloat(On.GameSettings.orig_LoadFloat orig,GameSettings self,  string key, ref  float val,  float def)
{
...
private static bool LoadString(On.GameSettings.orig_LoadString orig,GameSettings self,  string key, ref  string val,  string def)
{
...
private static void LogLoadedKey_string_int(On.GameSettings.orig_LogLoadedKey_string_int orig,GameSettings self,  string key,  int value)
{
...
{
foreach (Delegates.LogLoadedKey_string_int_BeforeArgs toInvoke in _beforeLogLoadedKey_string_int.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LogLoadedKey_string_int_AfterArgs toInvoke in _afterLogLoadedKey_string_int.GetInvocationList())
{
try
{
...
private static void LogLoadedKey_string_float(On.GameSettings.orig_LogLoadedKey_string_float orig,GameSettings self,  string key,  float value)
{
...
{
foreach (Delegates.LogLoadedKey_string_float_BeforeArgs toInvoke in _beforeLogLoadedKey_string_float.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LogLoadedKey_string_float_AfterArgs toInvoke in _afterLogLoadedKey_string_float.GetInvocationList())
{
try
{
...
private static void LogLoadedKey_string_string(On.GameSettings.orig_LogLoadedKey_string_string orig,GameSettings self,  string key,  string value)
{
...
{
foreach (Delegates.LogLoadedKey_string_string_BeforeArgs toInvoke in _beforeLogLoadedKey_string_string.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LogLoadedKey_string_string_AfterArgs toInvoke in _afterLogLoadedKey_string_string.GetInvocationList())
{
try
{
...
private static void LogSavedKey_string_int(On.GameSettings.orig_LogSavedKey_string_int orig,GameSettings self,  string key,  int value)
{
...
{
foreach (Delegates.LogSavedKey_string_int_BeforeArgs toInvoke in _beforeLogSavedKey_string_int.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LogSavedKey_string_int_AfterArgs toInvoke in _afterLogSavedKey_string_int.GetInvocationList())
{
try
{
...
private static void LogSavedKey_string_float(On.GameSettings.orig_LogSavedKey_string_float orig,GameSettings self,  string key,  float value)
{
...
{
foreach (Delegates.LogSavedKey_string_float_BeforeArgs toInvoke in _beforeLogSavedKey_string_float.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LogSavedKey_string_float_AfterArgs toInvoke in _afterLogSavedKey_string_float.GetInvocationList())
{
try
{
...
private static void LogSavedKey_string_string(On.GameSettings.orig_LogSavedKey_string_string orig,GameSettings self,  string key,  string value)
{
...
{
foreach (Delegates.LogSavedKey_string_string_BeforeArgs toInvoke in _beforeLogSavedKey_string_string.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LogSavedKey_string_string_AfterArgs toInvoke in _afterLogSavedKey_string_string.GetInvocationList())
{
try
{
...
private static bool CommandArgumentUsed(On.GameSettings.orig_CommandArgumentUsed orig,GameSettings self,  string arg)
{
...
{
foreach (Delegates.CommandArgumentUsed_BeforeArgs toInvoke in _beforeCommandArgumentUsed.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CommandArgumentUsed_AfterArgs toInvoke in _afterCommandArgumentUsed.GetInvocationList())
{
try
{
...
public InControl.Key defaultKey;
}
...
public delegate void LoadAndUpgradeKeyboardKey_WithArgs (Action<GameSettings,  string,  string,  InControl.Key> orig, GameSettings self,  string prefsKey, ref  string setString,  InControl.Key defaultKey);
...
public delegate bool LoadGamepadSettings_WithArgs (Func<GameSettings,  GlobalEnums.GamepadType, bool> orig, GameSettings self,  GlobalEnums.GamepadType gamepadType);
...
public delegate void SaveGamepadSettings_WithArgs (Action<GameSettings,  GlobalEnums.GamepadType> orig, GameSettings self,  GlobalEnums.GamepadType gamepadType);
...
public delegate void ResetGamepadSettings_WithArgs (Action<GameSettings,  GlobalEnums.GamepadType> orig, GameSettings self,  GlobalEnums.GamepadType gamepadType);
public sealed class Params_RemapGamepadTypeForSettings
{
public GameSettings self;
public GlobalEnums.GamepadType sourceType;
}
public delegate void RemapGamepadTypeForSettings_BeforeArgs(Params_RemapGamepadTypeForSettings args);
public delegate GlobalEnums.GamepadType RemapGamepadTypeForSettings_AfterArgs(Params_RemapGamepadTypeForSettings args, GlobalEnums.GamepadType ret);
public delegate GlobalEnums.GamepadType RemapGamepadTypeForSettings_WithArgs (Func<GameSettings,  GlobalEnums.GamepadType, GlobalEnums.GamepadType> orig, GameSettings self,  GlobalEnums.GamepadType sourceType);
...
public delegate bool LoadInt_WithArgs (Func<GameSettings,  string,  int,  int, bool> orig, GameSettings self,  string key, ref  int val,  int def);
...
public delegate bool LoadBool_WithArgs (Func<GameSettings,  string,  bool,  bool, bool> orig, GameSettings self,  string key, ref  bool val,  bool def);
...
public delegate bool LoadFloat_WithArgs (Func<GameSettings,  string,  float,  float, bool> orig, GameSettings self,  string key, ref  float val,  float def);
...
public delegate bool LoadString_WithArgs (Func<GameSettings,  string,  string,  string, bool> orig, GameSettings self,  string key, ref  string val,  string def);
...
public delegate void LogLoadedKey_string_int_WithArgs (Action<GameSettings,  string,  int> orig, GameSettings self,  string key,  int value);
...
public delegate void LogLoadedKey_string_float_WithArgs (Action<GameSettings,  string,  float> orig, GameSettings self,  string key,  float value);
...
public delegate void LogLoadedKey_string_string_WithArgs (Action<GameSettings,  string,  string> orig, GameSettings self,  string key,  string value);
...
public delegate void LogSavedKey_string_int_WithArgs (Action<GameSettings,  string,  int> orig, GameSettings self,  string key,  int value);
...
public delegate void LogSavedKey_string_float_WithArgs (Action<GameSettings,  string,  float> orig, GameSettings self,  string key,  float value);
...
public delegate void LogSavedKey_string_string_WithArgs (Action<GameSettings,  string,  string> orig, GameSettings self,  string key,  string value);
...
public delegate bool CommandArgumentUsed_WithArgs (Func<GameSettings,  string, bool> orig, GameSettings self,  string arg);
}
