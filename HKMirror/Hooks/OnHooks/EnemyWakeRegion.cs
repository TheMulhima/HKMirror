...
private static void OnTriggerEnter2D(On.EnemyWakeRegion.orig_OnTriggerEnter2D orig,EnemyWakeRegion self,  UnityEngine.Collider2D collision)
{
...
private static void OnTriggerExit2D(On.EnemyWakeRegion.orig_OnTriggerExit2D orig,EnemyWakeRegion self,  UnityEngine.Collider2D collision)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<EnemyWakeRegion,  UnityEngine.Collider2D> orig, EnemyWakeRegion self,  UnityEngine.Collider2D collision);
...
public delegate void OnTriggerExit2D_WithArgs (Action<EnemyWakeRegion,  UnityEngine.Collider2D> orig, EnemyWakeRegion self,  UnityEngine.Collider2D collision);
}
