...
public static class OnCharmUpdateHandler
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static void Invoke(Action<Modding.Delegates.CharmUpdateHandler, PlayerData, HeroController> orig,
            Modding.Delegates.CharmUpdateHandler self, PlayerData data, HeroController controller)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static void EndInvoke(Action<Modding.Delegates.CharmUpdateHandler, System.IAsyncResult> orig,
            Modding.Delegates.CharmUpdateHandler self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Invoke_WithArgs(
            Action<Modding.Delegates.CharmUpdateHandler, PlayerData, HeroController> orig,
            Modding.Delegates.CharmUpdateHandler self, PlayerData data, HeroController controller);
        ...
        public delegate void EndInvoke_WithArgs(Action<Modding.Delegates.CharmUpdateHandler, System.IAsyncResult> orig,
            Modding.Delegates.CharmUpdateHandler self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "EndInvoke", true), value);
