...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "Invoke", true), Invoke);
...
private static void Invoke(Action<Modding.Delegates.CharmUpdateHandler,  PlayerData,  HeroController> orig, Modding.Delegates.CharmUpdateHandler self,  PlayerData data,  HeroController controller)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "EndInvoke", true), EndInvoke);
...
private static void EndInvoke(Action<Modding.Delegates.CharmUpdateHandler,  System.IAsyncResult> orig, Modding.Delegates.CharmUpdateHandler self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.CharmUpdateHandler self;
...
public delegate void Invoke_WithArgs (Action<Modding.Delegates.CharmUpdateHandler,  PlayerData,  HeroController> orig, Modding.Delegates.CharmUpdateHandler self,  PlayerData data,  HeroController controller);
...
public delegate void EndInvoke_WithArgs (Action<Modding.Delegates.CharmUpdateHandler,  System.IAsyncResult> orig, Modding.Delegates.CharmUpdateHandler self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.CharmUpdateHandler), "EndInvoke", true), value);
}
}
