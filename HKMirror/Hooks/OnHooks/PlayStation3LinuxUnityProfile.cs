...
public static class OnPlayStation3LinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation3LinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation3LinuxUnityProfile> orig, PlayStation3LinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation3LinuxUnityProfile> orig,
            PlayStation3LinuxUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation3LinuxUnityProfile self;
        }
    }
