...
public static class OnMouseLook2
{
    ...
    public static class Delegates
    {
        ...
        public delegate void DoMouseLook_WithArgs(Action<MouseLook2> orig, MouseLook2 self);
        ...
        public delegate float GetXRotation_WithArgs(Func<MouseLook2, float> orig, MouseLook2 self);
        ...
        public delegate float GetYRotation_WithArgs(Func<MouseLook2, float> orig, MouseLook2 self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<MouseLook2> orig, MouseLook2 self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<MouseLook2> orig, MouseLook2 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<MouseLook2> orig, MouseLook2 self);
