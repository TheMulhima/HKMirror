...
public static class OnPowerASpectraIlluminatedControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(PowerASpectraIlluminatedControllerMacNativeProfile),
                        "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PowerASpectraIlluminatedControllerMacNativeProfile> orig,
            PowerASpectraIlluminatedControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PowerASpectraIlluminatedControllerMacNativeProfile> orig,
            PowerASpectraIlluminatedControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PowerASpectraIlluminatedControllerMacNativeProfile self;
        }
    }
