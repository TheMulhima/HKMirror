...
public static class OnPowerASpectraIlluminatedControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.PowerASpectraIlluminatedControllerMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.PowerASpectraIlluminatedControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.PowerASpectraIlluminatedControllerMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.PowerASpectraIlluminatedControllerMacNativeProfile), "Define",
                    true), value);
