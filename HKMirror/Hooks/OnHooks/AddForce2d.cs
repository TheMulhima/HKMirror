...
public static class OnAddForce2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<AddForce2d> orig, AddForce2d self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<AddForce2d> orig, AddForce2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<AddForce2d> orig, AddForce2d self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<AddForce2d> orig, AddForce2d self)
        {
        ...
        internal static void HookDoAddForce()
        {
            if (!HookedList.Contains("DoAddForce"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "DoAddForce"), DoAddForce);
            }
        }
        ...
        private static void DoAddForce(Action<AddForce2d> orig, AddForce2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoAddForce_WithArgs(Action<AddForce2d> orig, AddForce2d self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<AddForce2d> orig, AddForce2d self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<AddForce2d> orig, AddForce2d self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<AddForce2d> orig, AddForce2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<AddForce2d> orig, AddForce2d self);

        public sealed class Params_Reset
        {
            public AddForce2d self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "Reset"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoAddForce_WithArgs DoAddForce
        {
            add => HookEndpointManager.Add<Delegates.DoAddForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AddForce2d), "DoAddForce"), value);
