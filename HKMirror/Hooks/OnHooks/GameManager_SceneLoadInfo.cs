...
public static class OnGameManager_SceneLoadInfo
{
    internal static class HookHandler
    {
        ...
        internal static void HookNotifyFetchComplete()
        {
            if (!HookedList.Contains("NotifyFetchComplete"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "NotifyFetchComplete"),
                    NotifyFetchComplete);
            }
        }
        ...
        private static void NotifyFetchComplete(Action<GameManager.SceneLoadInfo> orig, GameManager.SceneLoadInfo self)
        {
            ...
            if (_beforeNotifyFetchComplete != null)
                foreach (Delegates.NotifyFetchComplete_BeforeArgs toInvoke in _beforeNotifyFetchComplete
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterNotifyFetchComplete != null)
                foreach (Delegates.NotifyFetchComplete_AfterArgs toInvoke in
                         _afterNotifyFetchComplete.GetInvocationList())
                    try
                    {
        ...
        internal static void HookIsReadyToActivate()
        {
            if (!HookedList.Contains("IsReadyToActivate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "IsReadyToActivate"),
                    IsReadyToActivate);
            }
        }
        ...
        private static bool IsReadyToActivate(Func<GameManager.SceneLoadInfo, bool> orig,
            GameManager.SceneLoadInfo self)
        {
            ...
            if (_beforeIsReadyToActivate != null)
                foreach (Delegates.IsReadyToActivate_BeforeArgs toInvoke in
                         _beforeIsReadyToActivate.GetInvocationList())
                    try
                    {
        ...
        internal static void HookNotifyFinished()
        {
            if (!HookedList.Contains("NotifyFinished"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "NotifyFinished"),
                    NotifyFinished);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate bool IsReadyToActivate_WithArgs(Func<GameManager.SceneLoadInfo, bool> orig,
            GameManager.SceneLoadInfo self);
        ...
        public delegate void NotifyFetchComplete_WithArgs(Action<GameManager.SceneLoadInfo> orig,
            GameManager.SceneLoadInfo self);
        ...
        public delegate void NotifyFinished_WithArgs(Action<GameManager.SceneLoadInfo> orig,
            GameManager.SceneLoadInfo self);
