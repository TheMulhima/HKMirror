...
public static class OnSetIntProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetIntProxy), "Invoke"), Invoke);
            }
        }
        ...
        private static int Invoke(Func<SetIntProxy, string, int, int> orig, SetIntProxy self, string name, int orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetIntProxy), "EndInvoke"), EndInvoke);
            }
        }
        ...
        private static int EndInvoke(Func<SetIntProxy, IAsyncResult, int> orig, SetIntProxy self, IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate int EndInvoke_WithArgs(Func<SetIntProxy, IAsyncResult, int> orig, SetIntProxy self,
            IAsyncResult result);
        ...
        public delegate int Invoke_WithArgs(Func<SetIntProxy, string, int, int> orig, SetIntProxy self, string name,
            int orig_);
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetIntProxy), "Invoke"), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetIntProxy), "EndInvoke"), value);
