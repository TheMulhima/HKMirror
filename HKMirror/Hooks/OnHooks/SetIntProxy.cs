...
/// <summary>
/// Contains different types of On Hooks for SetIntProxy class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnSetIntProxy
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "Invoke", true), Invoke);
...
private static int Invoke(Func<Modding.Delegates.SetIntProxy,  string,  int, int> orig, Modding.Delegates.SetIntProxy self,  string name,  int orig_)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "EndInvoke", true), EndInvoke);
...
private static int EndInvoke(Func<Modding.Delegates.SetIntProxy,  System.IAsyncResult, int> orig, Modding.Delegates.SetIntProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.SetIntProxy self;
public string name;
public int orig_;
}
public delegate void Invoke_BeforeArgs(Params_Invoke args);
public delegate int Invoke_AfterArgs(Params_Invoke args, int ret);
public delegate int Invoke_WithArgs (Func<Modding.Delegates.SetIntProxy,  string,  int, int> orig, Modding.Delegates.SetIntProxy self,  string name,  int orig_);
...
public delegate int EndInvoke_WithArgs (Func<Modding.Delegates.SetIntProxy,  System.IAsyncResult, int> orig, Modding.Delegates.SetIntProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "EndInvoke", true), value);
}
}
