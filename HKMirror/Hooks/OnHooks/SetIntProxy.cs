...
public static class OnSetIntProxy
{
    internal static class HookHandler
    {
        ...
        private static int Invoke(Func<Modding.Delegates.SetIntProxy, string, int, int> orig,
            Modding.Delegates.SetIntProxy self, string name, int orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static int EndInvoke(Func<Modding.Delegates.SetIntProxy, System.IAsyncResult, int> orig,
            Modding.Delegates.SetIntProxy self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate int Invoke_WithArgs(Func<Modding.Delegates.SetIntProxy, string, int, int> orig,
            Modding.Delegates.SetIntProxy self, string name, int orig_);
        ...
        public delegate int EndInvoke_WithArgs(Func<Modding.Delegates.SetIntProxy, System.IAsyncResult, int> orig,
            Modding.Delegates.SetIntProxy self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetIntProxy), "EndInvoke", true), value);
