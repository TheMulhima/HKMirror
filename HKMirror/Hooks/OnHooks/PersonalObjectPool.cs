...
public static class OnPersonalObjectPool
{
    ...
    public static class Delegates
    {
        ...
        public delegate void CreatePool_WithArgs(Action<PersonalObjectPool, UnityEngine.GameObject, int> orig,
            PersonalObjectPool self, UnityEngine.GameObject prefab, int initialPoolSize);
