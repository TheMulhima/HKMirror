...
private static void CreateStartupPools(On.PersonalObjectPool.orig_CreateStartupPools orig,PersonalObjectPool self)
{
...
private static void CreatePool(On.PersonalObjectPool.orig_CreatePool orig,PersonalObjectPool self,  UnityEngine.GameObject prefab,  int initialPoolSize)
{
...
private static void DestroyMyPooledObjects(On.PersonalObjectPool.orig_DestroyMyPooledObjects orig,PersonalObjectPool self)
{
...
{
foreach (Delegates.DestroyMyPooledObjects_BeforeArgs toInvoke in _beforeDestroyMyPooledObjects.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DestroyMyPooledObjects_AfterArgs toInvoke in _afterDestroyMyPooledObjects.GetInvocationList())
{
try
{
...
public delegate void CreatePool_WithArgs (Action<PersonalObjectPool,  UnityEngine.GameObject,  int> orig, PersonalObjectPool self,  UnityEngine.GameObject prefab,  int initialPoolSize);
