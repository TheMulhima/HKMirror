...
public static class OnFloatCompare
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self)
        {
        ...
        internal static void HookDoCompare()
        {
            if (!HookedList.Contains("DoCompare"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "DoCompare",
                        true), DoCompare);
            }
        }
        ...
        private static void DoCompare(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.FloatCompare, string> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self);
        ...
        public delegate void DoCompare_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatCompare> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.FloatCompare, string> orig,
            HutongGames.PlayMaker.Actions.FloatCompare self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "OnUpdate", true),
                value);
        ...
        public static event Delegates.DoCompare_WithArgs DoCompare
        {
            add => HookEndpointManager.Add<Delegates.DoCompare_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "DoCompare", true),
                value);
        ...
        public static event Delegates.ErrorCheck_WithArgs ErrorCheck
        {
            add => HookEndpointManager.Add<Delegates.ErrorCheck_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatCompare), "ErrorCheck", true),
                value);
