...
public static class OnSetParticleEmissionSpeed
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self)
        {
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self)
        {
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self)
        {
        ...
        internal static void HookDoSetEmitSpeed()
        {
            if (!HookedList.Contains("DoSetEmitSpeed"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed),
                        "DoSetEmitSpeed", true), DoSetEmitSpeed);
            }
        }
        ...
        private static void DoSetEmitSpeed(Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self);
        ...
        public delegate void DoSetEmitSpeed_WithArgs(
            Action<HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed> orig,
            HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetParticleEmissionSpeed), "Reset",
                    true), value);
