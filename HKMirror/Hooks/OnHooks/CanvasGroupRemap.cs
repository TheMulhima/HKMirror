...
public static class OnCanvasGroupRemap
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.Sync_NormalArgs _afterSync;
        ...
        private static void Sync(On.CanvasGroupRemap.orig_Sync orig, CanvasGroupRemap self, float alpha)
        {
            ...
            alpha = @params.alpha;
            orig(self, alpha);
            if (_afterSync != null) _afterSync.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void Sync_NormalArgs(Params_Sync args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.Sync_NormalArgs Sync
        {
            add
            {
