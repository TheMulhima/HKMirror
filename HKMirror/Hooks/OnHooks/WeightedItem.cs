...
public static class OnWeightedItem
{
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_Weight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(WeightedItem), "get_Weight", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_Weight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(WeightedItem), "get_Weight", true), value);
        }
    }
}