...
public static class OnMenuButtonIcon
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Action()
        {
            if (!HookedList.Contains("get_Action"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MenuButtonIcon), "get_Action", true), get_Action);
            }
        }
        ...
        private static GlobalEnums.HeroActionButton get_Action(Func<MenuButtonIcon, GlobalEnums.HeroActionButton> orig,
            MenuButtonIcon self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate GlobalEnums.HeroActionButton get_Action_WithArgs(
            Func<MenuButtonIcon, GlobalEnums.HeroActionButton> orig, MenuButtonIcon self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Action_WithArgs get_Action
        {
            add => HookEndpointManager.Add<Delegates.get_Action_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(MenuButtonIcon), "get_Action", true), value);
