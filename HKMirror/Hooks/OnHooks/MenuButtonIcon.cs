...
private static GlobalEnums.HeroActionButton get_Action(Func<MenuButtonIcon, GlobalEnums.HeroActionButton> orig, MenuButtonIcon self)
{
...
public delegate GlobalEnums.HeroActionButton get_Action_WithArgs (Func<MenuButtonIcon, GlobalEnums.HeroActionButton> orig, MenuButtonIcon self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Action_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonIcon), "get_Action", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Action_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MenuButtonIcon), "get_Action", true), value);
}
}
