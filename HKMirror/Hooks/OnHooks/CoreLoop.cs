...
public static class OnCoreLoop
{
    internal static class HookHandler
    {
        ...
        private static void EnqueueInvokeNext(On.CoreLoop.orig_EnqueueInvokeNext orig)
        {
            if (_beforeEnqueueInvokeNext != null)
                foreach (Delegates.EnqueueInvokeNext_BeforeArgs toInvoke in
                         _beforeEnqueueInvokeNext.GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void InvokeNext_WithArgs(Action<Action> orig, Action action);
