...
public static class OnOuyaAmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(OuyaAmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<OuyaAmazonUnityProfile> orig, OuyaAmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<OuyaAmazonUnityProfile> orig, OuyaAmazonUnityProfile self);

        public sealed class Params_Define
        {
            public OuyaAmazonUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(OuyaAmazonUnityProfile), "Define"), value);
