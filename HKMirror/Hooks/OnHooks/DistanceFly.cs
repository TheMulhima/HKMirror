...
public static class OnDistanceFly
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<DistanceFly> orig, DistanceFly self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<DistanceFly> orig, DistanceFly self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<DistanceFly> orig, DistanceFly self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<DistanceFly> orig, DistanceFly self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<DistanceFly> orig, DistanceFly self)
        {
        ...
        internal static void HookDoBuzz()
        {
            if (!HookedList.Contains("DoBuzz"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "DoBuzz"), DoBuzz);
            }
        }
        ...
        private static void DoBuzz(Action<DistanceFly> orig, DistanceFly self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<DistanceFly> orig, DistanceFly self);

        public delegate void DoBuzz_AfterArgs(Params_DoBuzz args);

        public delegate void DoBuzz_BeforeArgs(Params_DoBuzz args);

        public delegate void DoBuzz_WithArgs(Action<DistanceFly> orig, DistanceFly self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<DistanceFly> orig, DistanceFly self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<DistanceFly> orig, DistanceFly self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<DistanceFly> orig, DistanceFly self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<DistanceFly> orig, DistanceFly self);

        public sealed class Params_Reset
        {
            public DistanceFly self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "Awake"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoBuzz_WithArgs DoBuzz
        {
            add => HookEndpointManager.Add<Delegates.DoBuzz_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DistanceFly), "DoBuzz"), value);
