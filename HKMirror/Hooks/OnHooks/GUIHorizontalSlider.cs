...
public static class OnGUIHorizontalSlider
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUIHorizontalSlider), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GUIHorizontalSlider> orig,
            HutongGames.PlayMaker.Actions.GUIHorizontalSlider self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUIHorizontalSlider), "OnGUI",
                        true), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.GUIHorizontalSlider> orig,
            HutongGames.PlayMaker.Actions.GUIHorizontalSlider self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GUIHorizontalSlider> orig,
            HutongGames.PlayMaker.Actions.GUIHorizontalSlider self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.GUIHorizontalSlider> orig,
            HutongGames.PlayMaker.Actions.GUIHorizontalSlider self);
    }
