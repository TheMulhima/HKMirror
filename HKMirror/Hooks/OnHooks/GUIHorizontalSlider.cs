...
public static class OnGUIHorizontalSlider
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUIHorizontalSlider), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GUIHorizontalSlider> orig, GUIHorizontalSlider self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUIHorizontalSlider), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUIHorizontalSlider> orig, GUIHorizontalSlider self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUIHorizontalSlider> orig, GUIHorizontalSlider self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GUIHorizontalSlider> orig, GUIHorizontalSlider self);

        public sealed class Params_Reset
        {
            public GUIHorizontalSlider self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUIHorizontalSlider), "Reset"), value);
        ...
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUIHorizontalSlider), "OnGUI"), value);
