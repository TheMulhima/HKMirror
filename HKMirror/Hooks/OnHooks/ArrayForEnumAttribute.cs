...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ArrayForEnumAttribute), "get_IsValid", true), get_IsValid);
...
{
add => HookEndpointManager.Add<Delegates.get_IsValid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ArrayForEnumAttribute), "get_IsValid", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsValid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ArrayForEnumAttribute), "get_IsValid", true), value);
}
}
