...
public static class OnEightBitdoSNES30WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSNES30WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSNES30WindowsUnityProfile> orig,
            EightBitdoSNES30WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSNES30WindowsUnityProfile> orig,
            EightBitdoSNES30WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSNES30WindowsUnityProfile self;
        }
    }
