...
public static class OnuGuiInputFieldGetCaretBlinkRate
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate), "DoGetValue", true),
                    DoGetValue);
            }
        }
        ...
        private static void DoGetValue(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate self);
        ...
        public delegate void OnEnter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldGetCaretBlinkRate),
                    "Reset", true), value);
