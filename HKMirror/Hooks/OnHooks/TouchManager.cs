...
public static class OnTouchManager
{
    internal static class HookHandler
    {
        ...
        internal static void HookUpdateScreenSizeAtEndOfFrame()
        {
            if (!HookedList.Contains("UpdateScreenSizeAtEndOfFrame"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateScreenSizeAtEndOfFrame",
                        true), UpdateScreenSizeAtEndOfFrame);
            }
        }

        internal static event Delegates.UpdateScreenSizeAtEndOfFrame_BeforeArgs _beforeUpdateScreenSizeAtEndOfFrame;

        private static System.Collections.IEnumerator UpdateScreenSizeAtEndOfFrame(
            Func<InControl.TouchManager, System.Collections.IEnumerator> orig, InControl.TouchManager self)
        {
        ...
        internal static void HookCreateDevice()
        {
            if (!HookedList.Contains("CreateDevice"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CreateDevice", true),
                    CreateDevice);
            }
        }
        ...
        internal static void HookUpdateDevice()
        {
            if (!HookedList.Contains("UpdateDevice"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateDevice", true),
                    UpdateDevice);
            }
        }
        ...
        private static void UpdateDevice(Action<InControl.TouchManager, ulong, float> orig, InControl.TouchManager self,
        ...
        internal static void HookCommitDevice()
        {
            if (!HookedList.Contains("CommitDevice"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CommitDevice", true),
                    CommitDevice);
            }
        }
        ...
        private static void CommitDevice(Action<InControl.TouchManager, ulong, float> orig, InControl.TouchManager self,
            ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookSubmitControlStates()
        {
            if (!HookedList.Contains("SubmitControlStates"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SubmitControlStates", true),
                    SubmitControlStates);
            }
        }
        ...
        private static void SubmitControlStates(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookCommitControlStates()
        {
            if (!HookedList.Contains("CommitControlStates"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CommitControlStates", true),
                    CommitControlStates);
            }
        }
        ...
        private static void CommitControlStates(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookUpdateScreenSize()
        {
            if (!HookedList.Contains("UpdateScreenSize"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateScreenSize", true),
                    UpdateScreenSize);
            }
        }
        ...
        private static void UpdateScreenSize(Action<InControl.TouchManager, UnityEngine.Vector2> orig,
            InControl.TouchManager self, UnityEngine.Vector2 currentScreenSize)
        {
        ...
        internal static void HookCreateTouches()
        {
            if (!HookedList.Contains("CreateTouches"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CreateTouches", true),
                    CreateTouches);
            }
        }
        ...
        internal static void HookUpdateTouches()
        {
            if (!HookedList.Contains("UpdateTouches"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateTouches", true),
                    UpdateTouches);
            }
        }
        ...
        private static void UpdateTouches(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookSendTouchBegan()
        {
            if (!HookedList.Contains("SendTouchBegan"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SendTouchBegan", true),
                    SendTouchBegan);
            }
        }
        ...
        private static void SendTouchBegan(Action<InControl.TouchManager, InControl.Touch> orig,
            InControl.TouchManager self, InControl.Touch touch)
        {
        ...
        internal static void HookSendTouchMoved()
        {
            if (!HookedList.Contains("SendTouchMoved"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SendTouchMoved", true),
                    SendTouchMoved);
            }
        }
        ...
        private static void SendTouchMoved(Action<InControl.TouchManager, InControl.Touch> orig,
            InControl.TouchManager self, InControl.Touch touch)
        {
        ...
        internal static void HookSendTouchEnded()
        {
            if (!HookedList.Contains("SendTouchEnded"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SendTouchEnded", true),
                    SendTouchEnded);
            }
        }
        ...
        private static void SendTouchEnded(Action<InControl.TouchManager, InControl.Touch> orig,
            InControl.TouchManager self, InControl.Touch touch)
        {
        ...
        internal static void HookInvokeTouchEvents()
        {
            if (!HookedList.Contains("InvokeTouchEvents"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "InvokeTouchEvents", true),
                    InvokeTouchEvents);
            }
        }
        ...
        internal static void HookTouchCameraIsValid()
        {
            if (!HookedList.Contains("TouchCameraIsValid"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "TouchCameraIsValid", true),
                    TouchCameraIsValid);
            }
        }
        ...
        internal static void HookConvertScreenToWorldPoint()
        {
            if (!HookedList.Contains("ConvertScreenToWorldPoint"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ConvertScreenToWorldPoint", true),
        ...
        private static UnityEngine.Vector3 ConvertScreenToWorldPoint(
            Func<InControl.TouchManager, UnityEngine.Vector2, UnityEngine.Vector3> orig, InControl.TouchManager self,
        ...
        internal static void HookConvertViewToWorldPoint()
        {
            if (!HookedList.Contains("ConvertViewToWorldPoint"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ConvertViewToWorldPoint", true),
        ...
        private static UnityEngine.Vector3 ConvertViewToWorldPoint(
            Func<InControl.TouchManager, UnityEngine.Vector2, UnityEngine.Vector3> orig, InControl.TouchManager self,
            UnityEngine.Vector2 point)
        {
        ...
        internal static void HookConvertScreenToViewPoint()
        {
            if (!HookedList.Contains("ConvertScreenToViewPoint"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ConvertScreenToViewPoint", true),
        ...
        private static UnityEngine.Vector3 ConvertScreenToViewPoint(
            Func<InControl.TouchManager, UnityEngine.Vector2, UnityEngine.Vector3> orig, InControl.TouchManager self,
            UnityEngine.Vector2 point)
        {
        ...
        internal static void HookGetCurrentScreenSize()
        {
            if (!HookedList.Contains("GetCurrentScreenSize"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "GetCurrentScreenSize", true),
        ...
        private static UnityEngine.Vector2 GetCurrentScreenSize(Func<InControl.TouchManager, UnityEngine.Vector2> orig,
            InControl.TouchManager self)
        {
        ...
        internal static void Hookget_controlsEnabled()
        {
            if (!HookedList.Contains("get_controlsEnabled"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_controlsEnabled", true),
                    get_controlsEnabled);
            }
        }
        ...
        internal static void Hookset_controlsEnabled()
        {
            if (!HookedList.Contains("set_controlsEnabled"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "set_controlsEnabled", true),
                    set_controlsEnabled);
            }
        }
        ...
        private static void set_controlsEnabled(Action<InControl.TouchManager, bool> orig, InControl.TouchManager self,
            bool value)
        {
        ...
        internal static void Hookget_Touches()
        {
            if (!HookedList.Contains("get_Touches"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_Touches", false),
                    get_Touches);
            }
        }
        ...
        private static System.Collections.ObjectModel.ReadOnlyCollection<InControl.Touch> get_Touches(
            Func<System.Collections.ObjectModel.ReadOnlyCollection<InControl.Touch>> orig)
        {
        ...
        internal static void Hookget_TouchCount()
        {
            if (!HookedList.Contains("get_TouchCount"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_TouchCount", false),
                    get_TouchCount);
            }
        }
        ...
        internal static void HookGetTouchByFingerId()
        {
            if (!HookedList.Contains("GetTouchByFingerId"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "GetTouchByFingerId", false),
                    GetTouchByFingerId);
            }
        }
        ...
        internal static void HookScreenToWorldPoint()
        {
            if (!HookedList.Contains("ScreenToWorldPoint"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ScreenToWorldPoint", false),
                    ScreenToWorldPoint);
            }
        }
        ...
        private static UnityEngine.Vector3 ScreenToWorldPoint(Func<UnityEngine.Vector2, UnityEngine.Vector3> orig,
            UnityEngine.Vector2 point)
        {
        ...
        internal static void HookViewToWorldPoint()
        {
            if (!HookedList.Contains("ViewToWorldPoint"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ViewToWorldPoint", false),
                    ViewToWorldPoint);
            }
        }
        ...
        private static UnityEngine.Vector3 ViewToWorldPoint(Func<UnityEngine.Vector2, UnityEngine.Vector3> orig,
            UnityEngine.Vector2 point)
        {
        ...
        internal static void HookScreenToViewPoint()
        {
            if (!HookedList.Contains("ScreenToViewPoint"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ScreenToViewPoint", false),
                    ScreenToViewPoint);
            }
        }
        ...
        private static UnityEngine.Vector3 ScreenToViewPoint(Func<UnityEngine.Vector2, UnityEngine.Vector3> orig,
            UnityEngine.Vector2 point)
        {
        ...
        internal static void HookConvertToWorld_float_TouchUnitType()
        {
            if (!HookedList.Contains("ConvertToWorld_float_TouchUnitType"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ConvertToWorld_float_TouchUnitType",
                        false), ConvertToWorld_float_TouchUnitType);
            }
        }
        ...
        private static float ConvertToWorld_float_TouchUnitType(Func<float, InControl.TouchUnitType, float> orig,
            float value, InControl.TouchUnitType unitType)
        {
        ...
        internal static void HookPercentToWorldRect()
        {
            if (!HookedList.Contains("PercentToWorldRect"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "PercentToWorldRect", false),
                    PercentToWorldRect);
            }
        }
        ...
        private static UnityEngine.Rect PercentToWorldRect(Func<UnityEngine.Rect, UnityEngine.Rect> orig,
        ...
        internal static void HookPixelToWorldRect()
        {
            if (!HookedList.Contains("PixelToWorldRect"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "PixelToWorldRect", false),
                    PixelToWorldRect);
            }
        }
        ...
        private static UnityEngine.Rect PixelToWorldRect(Func<UnityEngine.Rect, UnityEngine.Rect> orig,
            UnityEngine.Rect rect)
        {
        ...
        internal static void HookConvertToWorld_Rect_TouchUnitType()
        {
            if (!HookedList.Contains("ConvertToWorld_Rect_TouchUnitType"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ConvertToWorld_Rect_TouchUnitType",
                        false), ConvertToWorld_Rect_TouchUnitType);
            }
        }
        ...
        private static UnityEngine.Rect ConvertToWorld_Rect_TouchUnitType(
            Func<UnityEngine.Rect, InControl.TouchUnitType, UnityEngine.Rect> orig, UnityEngine.Rect rect,
            InControl.TouchUnitType unitType)
        {
        ...
        internal static void Hookget_Camera()
        {
            if (!HookedList.Contains("get_Camera"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_Camera", false),
                    get_Camera);
            }
        }
        ...
        internal static void Hookget_Device()
        {
            if (!HookedList.Contains("get_Device"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_Device", false),
                    get_Device);
            }
        }
        ...
        internal static void Hookget_ViewSize()
        {
            if (!HookedList.Contains("get_ViewSize"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_ViewSize", false),
                    get_ViewSize);
            }
        }
        ...
        internal static void Hookget_PercentToWorld()
        {
            if (!HookedList.Contains("get_PercentToWorld"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_PercentToWorld", false),
                    get_PercentToWorld);
            }
        }
        ...
        internal static void Hookget_HalfPercentToWorld()
        {
            if (!HookedList.Contains("get_HalfPercentToWorld"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_HalfPercentToWorld", false),
        ...
        internal static void Hookget_PixelToWorld()
        {
            if (!HookedList.Contains("get_PixelToWorld"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_PixelToWorld", false),
                    get_PixelToWorld);
            }
        }
        ...
        internal static void Hookget_HalfPixelToWorld()
        {
            if (!HookedList.Contains("get_HalfPixelToWorld"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_HalfPixelToWorld", false),
        ...
        internal static void Hookget_ScreenSize()
        {
            if (!HookedList.Contains("get_ScreenSize"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_ScreenSize", false),
                    get_ScreenSize);
            }
        }
        ...
        internal static void Hookget_HalfScreenSize()
        {
            if (!HookedList.Contains("get_HalfScreenSize"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_HalfScreenSize", false),
                    get_HalfScreenSize);
            }
        }
        ...
        internal static void Hookget_ControlsEnabled()
        {
            ...
            {
                HookedList.Add("get_ControlsEnabled");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_ControlsEnabled", false),
                    get_ControlsEnabled);
            }
        }
        ...
        internal static void Hookset_ControlsEnabled()
        {
            ...
            {
                HookedList.Add("set_ControlsEnabled");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "set_ControlsEnabled", false),
                    set_ControlsEnabled);
            }
        }
        ...
        internal static void Hookop_Implicit()
        {
            if (!HookedList.Contains("op_Implicit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "op_Implicit", false),
                    op_Implicit);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate System.Collections.IEnumerator UpdateScreenSizeAtEndOfFrame_AfterArgs(
            Params_UpdateScreenSizeAtEndOfFrame args, System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator UpdateScreenSizeAtEndOfFrame_WithArgs(
            Func<InControl.TouchManager, System.Collections.IEnumerator> orig, InControl.TouchManager self);
        ...
        public delegate void UpdateDevice_WithArgs(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime);
        ...
        public delegate void CommitDevice_WithArgs(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime);
        ...
        public delegate void SubmitControlStates_WithArgs(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime);
        ...
        public delegate void CommitControlStates_WithArgs(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime);
        ...
        public delegate void UpdateScreenSize_WithArgs(Action<InControl.TouchManager, UnityEngine.Vector2> orig,
            InControl.TouchManager self, UnityEngine.Vector2 currentScreenSize);
        ...
        public delegate void UpdateTouches_WithArgs(Action<InControl.TouchManager, ulong, float> orig,
            InControl.TouchManager self, ulong updateTick, float deltaTime);
        ...
        public delegate void SendTouchBegan_WithArgs(Action<InControl.TouchManager, InControl.Touch> orig,
            InControl.TouchManager self, InControl.Touch touch);
        ...
        public delegate void SendTouchMoved_WithArgs(Action<InControl.TouchManager, InControl.Touch> orig,
            InControl.TouchManager self, InControl.Touch touch);
        ...
        public delegate void SendTouchEnded_WithArgs(Action<InControl.TouchManager, InControl.Touch> orig,
            InControl.TouchManager self, InControl.Touch touch);
        ...
        public delegate void InvokeTouchEvents_WithArgs(Action<InControl.TouchManager> orig,
            InControl.TouchManager self);
        ...
        public delegate bool TouchCameraIsValid_WithArgs(Func<InControl.TouchManager, bool> orig,
            InControl.TouchManager self);
        ...
        public delegate UnityEngine.Vector3 ConvertScreenToWorldPoint_AfterArgs(Params_ConvertScreenToWorldPoint args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 ConvertScreenToWorldPoint_WithArgs(
            Func<InControl.TouchManager, UnityEngine.Vector2, UnityEngine.Vector3> orig, InControl.TouchManager self,
            UnityEngine.Vector2 point);
        ...
        public delegate UnityEngine.Vector3 ConvertViewToWorldPoint_AfterArgs(Params_ConvertViewToWorldPoint args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 ConvertViewToWorldPoint_WithArgs(
            Func<InControl.TouchManager, UnityEngine.Vector2, UnityEngine.Vector3> orig, InControl.TouchManager self,
            UnityEngine.Vector2 point);
        ...
        public delegate UnityEngine.Vector3 ConvertScreenToViewPoint_AfterArgs(Params_ConvertScreenToViewPoint args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 ConvertScreenToViewPoint_WithArgs(
            Func<InControl.TouchManager, UnityEngine.Vector2, UnityEngine.Vector3> orig, InControl.TouchManager self,
            UnityEngine.Vector2 point);
        ...
        public delegate UnityEngine.Vector2 GetCurrentScreenSize_AfterArgs(Params_GetCurrentScreenSize args,
            UnityEngine.Vector2 ret);

        public delegate UnityEngine.Vector2 GetCurrentScreenSize_WithArgs(
            Func<InControl.TouchManager, UnityEngine.Vector2> orig, InControl.TouchManager self);
        ...
        public delegate bool get_controlsEnabled_WithArgs(Func<InControl.TouchManager, bool> orig,
            InControl.TouchManager self);
        ...
        public delegate void set_controlsEnabled_WithArgs(Action<InControl.TouchManager, bool> orig,
            InControl.TouchManager self, bool value);

        public delegate void get_Touches_BeforeArgs();

        public delegate System.Collections.ObjectModel.ReadOnlyCollection<InControl.Touch> get_Touches_AfterArgs(
            System.Collections.ObjectModel.ReadOnlyCollection<InControl.Touch> ret);

        public delegate System.Collections.ObjectModel.ReadOnlyCollection<InControl.Touch> get_Touches_WithArgs(
            Func<System.Collections.ObjectModel.ReadOnlyCollection<InControl.Touch>> orig);
        ...
        public delegate InControl.Touch GetTouchByFingerId_AfterArgs(Params_GetTouchByFingerId args,
            InControl.Touch ret);
        ...
        public delegate UnityEngine.Vector3 ScreenToWorldPoint_AfterArgs(Params_ScreenToWorldPoint args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 ScreenToWorldPoint_WithArgs(
            Func<UnityEngine.Vector2, UnityEngine.Vector3> orig, UnityEngine.Vector2 point);
        ...
        public delegate UnityEngine.Vector3 ViewToWorldPoint_AfterArgs(Params_ViewToWorldPoint args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 ViewToWorldPoint_WithArgs(
            Func<UnityEngine.Vector2, UnityEngine.Vector3> orig, UnityEngine.Vector2 point);
        ...
        public delegate UnityEngine.Vector3 ScreenToViewPoint_AfterArgs(Params_ScreenToViewPoint args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 ScreenToViewPoint_WithArgs(
            Func<UnityEngine.Vector2, UnityEngine.Vector3> orig, UnityEngine.Vector2 point);
        ...
        public delegate float ConvertToWorld_float_TouchUnitType_WithArgs(
            Func<float, InControl.TouchUnitType, float> orig, float value, InControl.TouchUnitType unitType);
        ...
        public delegate UnityEngine.Rect PercentToWorldRect_AfterArgs(Params_PercentToWorldRect args,
            UnityEngine.Rect ret);

        public delegate UnityEngine.Rect PercentToWorldRect_WithArgs(Func<UnityEngine.Rect, UnityEngine.Rect> orig,
            UnityEngine.Rect rect);
        ...
        public delegate UnityEngine.Rect PixelToWorldRect_WithArgs(Func<UnityEngine.Rect, UnityEngine.Rect> orig,
            UnityEngine.Rect rect);
        ...
        public delegate UnityEngine.Rect ConvertToWorld_Rect_TouchUnitType_AfterArgs(
            Params_ConvertToWorld_Rect_TouchUnitType args, UnityEngine.Rect ret);

        public delegate UnityEngine.Rect ConvertToWorld_Rect_TouchUnitType_WithArgs(
            Func<UnityEngine.Rect, InControl.TouchUnitType, UnityEngine.Rect> orig, UnityEngine.Rect rect,
            InControl.TouchUnitType unitType);
        ...
        public delegate bool op_Implicit_WithArgs(Func<InControl.TouchManager, bool> orig,
            InControl.TouchManager instance);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnEnable_WithArgs OnEnable
        {
            add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "OnEnable", true), value);
        ...
        public static event Delegates.OnDisable_WithArgs OnDisable
        {
            add => HookEndpointManager.Add<Delegates.OnDisable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "OnDisable", true), value);
        ...
        public static event Delegates.Setup_WithArgs Setup
        {
            add => HookEndpointManager.Add<Delegates.Setup_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "Setup", true), value);
        ...
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "Reset", true), value);
        ...
        public static event Delegates.UpdateScreenSizeAtEndOfFrame_WithArgs UpdateScreenSizeAtEndOfFrame
        {
            add => HookEndpointManager.Add<Delegates.UpdateScreenSizeAtEndOfFrame_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateScreenSizeAtEndOfFrame", true),
                value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "Update", true), value);
        ...
        public static event Delegates.CreateDevice_WithArgs CreateDevice
        {
            add => HookEndpointManager.Add<Delegates.CreateDevice_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CreateDevice", true), value);
        ...
        public static event Delegates.UpdateDevice_WithArgs UpdateDevice
        {
            add => HookEndpointManager.Add<Delegates.UpdateDevice_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateDevice", true), value);
        ...
        public static event Delegates.CommitDevice_WithArgs CommitDevice
        {
            add => HookEndpointManager.Add<Delegates.CommitDevice_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CommitDevice", true), value);
        ...
        public static event Delegates.SubmitControlStates_WithArgs SubmitControlStates
        {
            add => HookEndpointManager.Add<Delegates.SubmitControlStates_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SubmitControlStates", true), value);
        ...
        public static event Delegates.CommitControlStates_WithArgs CommitControlStates
        {
            add => HookEndpointManager.Add<Delegates.CommitControlStates_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CommitControlStates", true), value);
        ...
        public static event Delegates.UpdateScreenSize_WithArgs UpdateScreenSize
        {
            add => HookEndpointManager.Add<Delegates.UpdateScreenSize_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateScreenSize", true), value);
        ...
        public static event Delegates.CreateTouches_WithArgs CreateTouches
        {
            add => HookEndpointManager.Add<Delegates.CreateTouches_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "CreateTouches", true), value);
        ...
        public static event Delegates.UpdateTouches_WithArgs UpdateTouches
        {
            add => HookEndpointManager.Add<Delegates.UpdateTouches_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "UpdateTouches", true), value);
        ...
        public static event Delegates.SendTouchBegan_WithArgs SendTouchBegan
        {
            add => HookEndpointManager.Add<Delegates.SendTouchBegan_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SendTouchBegan", true), value);
        ...
        public static event Delegates.SendTouchMoved_WithArgs SendTouchMoved
        {
            add => HookEndpointManager.Add<Delegates.SendTouchMoved_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SendTouchMoved", true), value);
        ...
        public static event Delegates.SendTouchEnded_WithArgs SendTouchEnded
        {
            add => HookEndpointManager.Add<Delegates.SendTouchEnded_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "SendTouchEnded", true), value);
        ...
        public static event Delegates.InvokeTouchEvents_WithArgs InvokeTouchEvents
        {
            add => HookEndpointManager.Add<Delegates.InvokeTouchEvents_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "InvokeTouchEvents", true), value);
        ...
        public static event Delegates.TouchCameraIsValid_WithArgs TouchCameraIsValid
        {
            add => HookEndpointManager.Add<Delegates.TouchCameraIsValid_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "TouchCameraIsValid", true), value);
        ...
        public static event Delegates.ConvertViewToWorldPoint_WithArgs ConvertViewToWorldPoint
        {
            add => HookEndpointManager.Add<Delegates.ConvertViewToWorldPoint_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ConvertViewToWorldPoint", true), value);
        ...
        public static event Delegates.GetCurrentScreenSize_WithArgs GetCurrentScreenSize
        {
            add => HookEndpointManager.Add<Delegates.GetCurrentScreenSize_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "GetCurrentScreenSize", true), value);
        ...
        public static event Delegates.get_controlsEnabled_WithArgs get_controlsEnabled
        {
            add => HookEndpointManager.Add<Delegates.get_controlsEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_controlsEnabled", true), value);
        ...
        public static event Delegates.set_controlsEnabled_WithArgs set_controlsEnabled
        {
            add => HookEndpointManager.Add<Delegates.set_controlsEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "set_controlsEnabled", true), value);
        ...
        public static event Delegates.get_Touches_WithArgs get_Touches
        {
            add => HookEndpointManager.Add<Delegates.get_Touches_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_Touches", false), value);
        ...
        public static event Delegates.get_TouchCount_WithArgs get_TouchCount
        {
            add => HookEndpointManager.Add<Delegates.get_TouchCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_TouchCount", false), value);
        ...
        public static event Delegates.GetTouch_WithArgs GetTouch
        {
            add => HookEndpointManager.Add<Delegates.GetTouch_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "GetTouch", false), value);
        ...
        public static event Delegates.GetTouchByFingerId_WithArgs GetTouchByFingerId
        {
            add => HookEndpointManager.Add<Delegates.GetTouchByFingerId_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "GetTouchByFingerId", false), value);
        ...
        public static event Delegates.ScreenToWorldPoint_WithArgs ScreenToWorldPoint
        {
            add => HookEndpointManager.Add<Delegates.ScreenToWorldPoint_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ScreenToWorldPoint", false), value);
        ...
        public static event Delegates.ViewToWorldPoint_WithArgs ViewToWorldPoint
        {
            add => HookEndpointManager.Add<Delegates.ViewToWorldPoint_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ViewToWorldPoint", false), value);
        ...
        public static event Delegates.ScreenToViewPoint_WithArgs ScreenToViewPoint
        {
            add => HookEndpointManager.Add<Delegates.ScreenToViewPoint_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ScreenToViewPoint", false), value);
        ...
        public static event Delegates.ConvertToWorld_float_TouchUnitType_WithArgs ConvertToWorld_float_TouchUnitType
        {
            add => HookEndpointManager.Add<Delegates.ConvertToWorld_float_TouchUnitType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "ConvertToWorld", false), value);
        ...
        public static event Delegates.PercentToWorldRect_WithArgs PercentToWorldRect
        {
            add => HookEndpointManager.Add<Delegates.PercentToWorldRect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "PercentToWorldRect", false), value);
        ...
        public static event Delegates.PixelToWorldRect_WithArgs PixelToWorldRect
        {
            add => HookEndpointManager.Add<Delegates.PixelToWorldRect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "PixelToWorldRect", false), value);
        ...
        public static event Delegates.get_Camera_WithArgs get_Camera
        {
            add => HookEndpointManager.Add<Delegates.get_Camera_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_Camera", false), value);
        ...
        public static event Delegates.get_Device_WithArgs get_Device
        {
            add => HookEndpointManager.Add<Delegates.get_Device_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_Device", false), value);
        ...
        public static event Delegates.get_ViewSize_WithArgs get_ViewSize
        {
            add => HookEndpointManager.Add<Delegates.get_ViewSize_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_ViewSize", false), value);
        ...
        public static event Delegates.get_PercentToWorld_WithArgs get_PercentToWorld
        {
            add => HookEndpointManager.Add<Delegates.get_PercentToWorld_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_PercentToWorld", false), value);
        ...
        public static event Delegates.get_HalfPercentToWorld_WithArgs get_HalfPercentToWorld
        {
            add => HookEndpointManager.Add<Delegates.get_HalfPercentToWorld_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_HalfPercentToWorld", false), value);
        ...
        public static event Delegates.get_PixelToWorld_WithArgs get_PixelToWorld
        {
            add => HookEndpointManager.Add<Delegates.get_PixelToWorld_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_PixelToWorld", false), value);
        ...
        public static event Delegates.get_HalfPixelToWorld_WithArgs get_HalfPixelToWorld
        {
            add => HookEndpointManager.Add<Delegates.get_HalfPixelToWorld_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_HalfPixelToWorld", false), value);
        ...
        public static event Delegates.get_ScreenSize_WithArgs get_ScreenSize
        {
            add => HookEndpointManager.Add<Delegates.get_ScreenSize_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_ScreenSize", false), value);
        ...
        public static event Delegates.get_HalfScreenSize_WithArgs get_HalfScreenSize
        {
            add => HookEndpointManager.Add<Delegates.get_HalfScreenSize_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_HalfScreenSize", false), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_ControlsEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_ControlsEnabled", false), value);
            remove => HookEndpointManager.Remove<Delegates.get_ControlsEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "get_ControlsEnabled", false), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_ControlsEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "set_ControlsEnabled", false), value);
            remove => HookEndpointManager.Remove<Delegates.set_ControlsEnabled_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "set_ControlsEnabled", false), value);
        }
        ...
        public static event Delegates.op_Implicit_WithArgs op_Implicit
        {
            add => HookEndpointManager.Add<Delegates.op_Implicit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchManager), "op_Implicit", false), value);
