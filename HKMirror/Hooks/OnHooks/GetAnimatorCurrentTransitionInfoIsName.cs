...
public static class OnGetAnimatorCurrentTransitionInfoIsName
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName), "OnActionUpdate",
                        true), OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName self)
        {
        ...
        internal static void HookIsName()
        {
            if (!HookedList.Contains("IsName"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName), "IsName", true),
                    IsName);
            }
        }
        ...
        private static void IsName(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfoIsName self)
        {
