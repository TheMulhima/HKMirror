...
public static class OnDeadZoneFunc
{
    ...
    {
        public delegate Vector2 EndInvoke_AfterArgs(Params_EndInvoke args, Vector2 ret);

        public delegate void EndInvoke_BeforeArgs(Params_EndInvoke args);

        public delegate Vector2 EndInvoke_WithArgs(Func<DeadZoneFunc, IAsyncResult, Vector2> orig, DeadZoneFunc self,
            IAsyncResult result);

        public delegate Vector2 Invoke_AfterArgs(Params_Invoke args, Vector2 ret);

        public delegate void Invoke_BeforeArgs(Params_Invoke args);

        public delegate Vector2 Invoke_WithArgs(Func<DeadZoneFunc, float, float, float, float, Vector2> orig,
            DeadZoneFunc self, float x, float y, float lowerDeadZone, float upperDeadZone);
