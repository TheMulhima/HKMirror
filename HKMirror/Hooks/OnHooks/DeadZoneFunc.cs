...
private static UnityEngine.Vector2 Invoke(Func<InControl.DeadZoneFunc,  float,  float,  float,  float, UnityEngine.Vector2> orig, InControl.DeadZoneFunc self,  float x,  float y,  float lowerDeadZone,  float upperDeadZone)
{
...
private static UnityEngine.Vector2 EndInvoke(Func<InControl.DeadZoneFunc,  System.IAsyncResult, UnityEngine.Vector2> orig, InControl.DeadZoneFunc self,  System.IAsyncResult result)
{
...
public delegate UnityEngine.Vector2 Invoke_WithArgs (Func<InControl.DeadZoneFunc,  float,  float,  float,  float, UnityEngine.Vector2> orig, InControl.DeadZoneFunc self,  float x,  float y,  float lowerDeadZone,  float upperDeadZone);
...
public delegate UnityEngine.Vector2 EndInvoke_WithArgs (Func<InControl.DeadZoneFunc,  System.IAsyncResult, UnityEngine.Vector2> orig, InControl.DeadZoneFunc self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.DeadZoneFunc), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.DeadZoneFunc), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.DeadZoneFunc), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.DeadZoneFunc), "EndInvoke", true), value);
}
}
