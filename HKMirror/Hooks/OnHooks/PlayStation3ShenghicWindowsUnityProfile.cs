...
public static class OnPlayStation3ShenghicWindowsUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.PlayStation3ShenghicWindowsUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.PlayStation3ShenghicWindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation3ShenghicWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.PlayStation3ShenghicWindowsUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation3ShenghicWindowsUnityProfile self);
    }
