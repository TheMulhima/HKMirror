...
public static class OnPlayStation3ShenghicWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation3ShenghicWindowsUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PlayStation3ShenghicWindowsUnityProfile> orig,
            PlayStation3ShenghicWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation3ShenghicWindowsUnityProfile> orig,
            PlayStation3ShenghicWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation3ShenghicWindowsUnityProfile self;
        }
    }
