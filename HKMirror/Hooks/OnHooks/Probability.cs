...
public static class OnProbability
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.GetRandomGameObjectByProbability_NormalArgs
            ...
            On.Probability.orig_GetRandomGameObjectByProbability orig, Probability.ProbabilityGameObject[] array)
        {
            ...
            if (_afterGetRandomGameObjectByProbability != null)
                retVal = _afterGetRandomGameObjectByProbability.Invoke(@params);
            return retVal;
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate GameObject GetRandomGameObjectByProbability_NormalArgs(
            Params_GetRandomGameObjectByProbability args);
    ...
    {
        public static event Delegates.GetRandomGameObjectByProbability_NormalArgs GetRandomGameObjectByProbability
        {
            add
            {
