...
internal static event Delegates.GetRandomGameObjectByProbability_BeforeArgs _beforeGetRandomGameObjectByProbability;
internal static event Delegates.GetRandomGameObjectByProbability_AfterArgs _afterGetRandomGameObjectByProbability;
private static UnityEngine.GameObject GetRandomGameObjectByProbability(On.Probability.orig_GetRandomGameObjectByProbability orig, Probability.ProbabilityGameObject[] array)
{
...
{
foreach (Delegates.GetRandomGameObjectByProbability_BeforeArgs toInvoke in _beforeGetRandomGameObjectByProbability.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetRandomGameObjectByProbability_AfterArgs toInvoke in _afterGetRandomGameObjectByProbability.GetInvocationList())
{
try
{
...
public delegate UnityEngine.GameObject GetRandomGameObjectByProbability_AfterArgs(Params_GetRandomGameObjectByProbability args, UnityEngine.GameObject ret);
public delegate UnityEngine.GameObject GetRandomGameObjectByProbability_WithArgs (Func< Probability.ProbabilityGameObject[], UnityEngine.GameObject> orig,  Probability.ProbabilityGameObject[] array);
}
