...
public static class OnMadCatzSaitekAV8R02MacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile), "Define", true), value);
