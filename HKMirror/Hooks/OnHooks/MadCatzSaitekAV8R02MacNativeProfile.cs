...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile), "Define", true), Define);
...
private static void Define(Action<InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile> orig, InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile self)
{
...
{
public InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile> orig, InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.NativeDeviceProfiles.MadCatzSaitekAV8R02MacNativeProfile), "Define", true), value);
}
}
