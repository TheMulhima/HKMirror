...
public static class OnGUILayoutRepeatButton
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutRepeatButton), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GUILayoutRepeatButton> orig,
            HutongGames.PlayMaker.Actions.GUILayoutRepeatButton self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutRepeatButton), "OnGUI",
                        true), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.GUILayoutRepeatButton> orig,
            HutongGames.PlayMaker.Actions.GUILayoutRepeatButton self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GUILayoutRepeatButton> orig,
            HutongGames.PlayMaker.Actions.GUILayoutRepeatButton self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.GUILayoutRepeatButton> orig,
            HutongGames.PlayMaker.Actions.GUILayoutRepeatButton self);
    }
