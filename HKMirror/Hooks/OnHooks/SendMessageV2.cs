...
public static class OnSendMessageV2
{
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSendMessage_WithArgs(Action<SendMessageV2> orig, SendMessageV2 self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<SendMessageV2> orig, SendMessageV2 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<SendMessageV2> orig, SendMessageV2 self);
