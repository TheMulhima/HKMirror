...
public static class OnSendMessageV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageV2), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SendMessageV2> orig,
            HutongGames.PlayMaker.Actions.SendMessageV2 self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageV2), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.SendMessageV2> orig,
            HutongGames.PlayMaker.Actions.SendMessageV2 self)
        {
        ...
        internal static void HookDoSendMessage()
        {
            if (!HookedList.Contains("DoSendMessage"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageV2), "DoSendMessage",
                        true), DoSendMessage);
            }
        }
        ...
        private static void DoSendMessage(Action<HutongGames.PlayMaker.Actions.SendMessageV2> orig,
            HutongGames.PlayMaker.Actions.SendMessageV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SendMessageV2> orig,
            HutongGames.PlayMaker.Actions.SendMessageV2 self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SendMessageV2> orig,
            HutongGames.PlayMaker.Actions.SendMessageV2 self);
        ...
        public delegate void DoSendMessage_WithArgs(Action<HutongGames.PlayMaker.Actions.SendMessageV2> orig,
            HutongGames.PlayMaker.Actions.SendMessageV2 self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SendMessageV2), "OnUpdate", true),
                value);
