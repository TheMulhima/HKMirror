...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGGetTotalBindings), "get_IntValue", true), get_IntValue);
...
public delegate int get_IntValue_WithArgs (Func<GGGetTotalBindings, int> orig, GGGetTotalBindings self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IntValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGGetTotalBindings), "get_IntValue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IntValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGGetTotalBindings), "get_IntValue", true), value);
}
}
