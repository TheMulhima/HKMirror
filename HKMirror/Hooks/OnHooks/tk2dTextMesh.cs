...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_FormattedText", true), get_FormattedText);
...
{
foreach (Delegates.get_FormattedText_BeforeArgs toInvoke in _beforeget_FormattedText.GetInvocationList())
{
try
{
...
private static int GetInlineStyleCommandLength(On.tk2dTextMesh.orig_GetInlineStyleCommandLength orig, int cmdSymbol)
{
...
{
foreach (Delegates.GetInlineStyleCommandLength_BeforeArgs toInvoke in _beforeGetInlineStyleCommandLength.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetInlineStyleCommandLength_AfterArgs toInvoke in _afterGetInlineStyleCommandLength.GetInvocationList())
{
try
{
...
private static string FormatText_string(On.tk2dTextMesh.orig_FormatText_string orig,tk2dTextMesh self,  string unformattedString)
{
...
{
foreach (Delegates.FormatText_string_BeforeArgs toInvoke in _beforeFormatText_string.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "FormatText_string_string", true), FormatText_string_string);
...
private static void FormatText_string_string(Action<tk2dTextMesh,  string,  string> orig, tk2dTextMesh self,  string _targetString,  string _source)
{
...
{
foreach (Delegates.FormatText_string_string_BeforeArgs toInvoke in _beforeFormatText_string_string.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FormatText_string_string_AfterArgs toInvoke in _afterFormatText_string_string.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_font", true), get_font);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_font", true), set_font);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_formatting", true), get_formatting);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_formatting", true), set_formatting);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_wordWrapWidth", true), get_wordWrapWidth);
...
{
foreach (Delegates.get_wordWrapWidth_BeforeArgs toInvoke in _beforeget_wordWrapWidth.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_wordWrapWidth", true), set_wordWrapWidth);
...
{
foreach (Delegates.set_wordWrapWidth_BeforeArgs toInvoke in _beforeset_wordWrapWidth.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_text", true), get_text);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_text", true), set_text);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_color", true), get_color);
...
private static UnityEngine.Color get_color(Func<tk2dTextMesh, UnityEngine.Color> orig, tk2dTextMesh self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_color", true), set_color);
...
private static void set_color(Action<tk2dTextMesh,  UnityEngine.Color> orig, tk2dTextMesh self,  UnityEngine.Color value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_color2", true), get_color2);
...
private static UnityEngine.Color get_color2(Func<tk2dTextMesh, UnityEngine.Color> orig, tk2dTextMesh self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_color2", true), set_color2);
...
private static void set_color2(Action<tk2dTextMesh,  UnityEngine.Color> orig, tk2dTextMesh self,  UnityEngine.Color value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_useGradient", true), get_useGradient);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_useGradient", true), set_useGradient);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_anchor", true), get_anchor);
...
private static UnityEngine.TextAnchor get_anchor(Func<tk2dTextMesh, UnityEngine.TextAnchor> orig, tk2dTextMesh self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_anchor", true), set_anchor);
...
private static void set_anchor(Action<tk2dTextMesh,  UnityEngine.TextAnchor> orig, tk2dTextMesh self,  UnityEngine.TextAnchor value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_scale", true), get_scale);
...
private static UnityEngine.Vector3 get_scale(Func<tk2dTextMesh, UnityEngine.Vector3> orig, tk2dTextMesh self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_scale", true), set_scale);
...
private static void set_scale(Action<tk2dTextMesh,  UnityEngine.Vector3> orig, tk2dTextMesh self,  UnityEngine.Vector3 value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_kerning", true), get_kerning);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_kerning", true), set_kerning);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_maxChars", true), get_maxChars);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_maxChars", true), set_maxChars);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_textureGradient", true), get_textureGradient);
...
{
foreach (Delegates.get_textureGradient_BeforeArgs toInvoke in _beforeget_textureGradient.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_textureGradient_AfterArgs toInvoke in _afterget_textureGradient.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_textureGradient", true), set_textureGradient);
...
{
foreach (Delegates.set_textureGradient_BeforeArgs toInvoke in _beforeset_textureGradient.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_textureGradient_AfterArgs toInvoke in _afterset_textureGradient.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_inlineStyling", true), get_inlineStyling);
...
{
foreach (Delegates.get_inlineStyling_BeforeArgs toInvoke in _beforeget_inlineStyling.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_inlineStyling", true), set_inlineStyling);
...
{
foreach (Delegates.set_inlineStyling_BeforeArgs toInvoke in _beforeset_inlineStyling.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_Spacing", true), get_Spacing);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_Spacing", true), set_Spacing);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_LineSpacing", true), get_LineSpacing);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_LineSpacing", true), set_LineSpacing);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_SortingOrder", true), get_SortingOrder);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_SortingOrder", true), set_SortingOrder);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_CachedRenderer", true), get_CachedRenderer);
...
private static UnityEngine.Renderer get_CachedRenderer(Func<tk2dTextMesh, UnityEngine.Renderer> orig, tk2dTextMesh self)
{
...
{
foreach (Delegates.get_CachedRenderer_BeforeArgs toInvoke in _beforeget_CachedRenderer.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_CachedRenderer_AfterArgs toInvoke in _afterget_CachedRenderer.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_useInlineStyling", true), get_useInlineStyling);
...
{
foreach (Delegates.get_useInlineStyling_BeforeArgs toInvoke in _beforeget_useInlineStyling.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_useInlineStyling_AfterArgs toInvoke in _afterget_useInlineStyling.GetInvocationList())
{
try
{
...
{
foreach (Delegates.NumDrawnCharacters_BeforeArgs toInvoke in _beforeNumDrawnCharacters.GetInvocationList())
{
try
{
...
{
foreach (Delegates.NumDrawnCharacters_AfterArgs toInvoke in _afterNumDrawnCharacters.GetInvocationList())
{
try
{
...
{
foreach (Delegates.NumTotalCharacters_BeforeArgs toInvoke in _beforeNumTotalCharacters.GetInvocationList())
{
try
{
...
{
foreach (Delegates.NumTotalCharacters_AfterArgs toInvoke in _afterNumTotalCharacters.GetInvocationList())
{
try
{
...
private static UnityEngine.Vector2 GetMeshDimensionsForString(On.tk2dTextMesh.orig_GetMeshDimensionsForString orig,tk2dTextMesh self,  string str)
{
...
{
foreach (Delegates.GetMeshDimensionsForString_BeforeArgs toInvoke in _beforeGetMeshDimensionsForString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetMeshDimensionsForString_AfterArgs toInvoke in _afterGetMeshDimensionsForString.GetInvocationList())
{
try
{
...
internal static event Delegates.GetEstimatedMeshBoundsForString_BeforeArgs _beforeGetEstimatedMeshBoundsForString;
internal static event Delegates.GetEstimatedMeshBoundsForString_AfterArgs _afterGetEstimatedMeshBoundsForString;
private static UnityEngine.Bounds GetEstimatedMeshBoundsForString(On.tk2dTextMesh.orig_GetEstimatedMeshBoundsForString orig,tk2dTextMesh self,  string str)
{
...
{
foreach (Delegates.GetEstimatedMeshBoundsForString_BeforeArgs toInvoke in _beforeGetEstimatedMeshBoundsForString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetEstimatedMeshBoundsForString_AfterArgs toInvoke in _afterGetEstimatedMeshBoundsForString.GetInvocationList())
{
try
{
...
private static void DoNotUse__CommitInternal(On.tk2dTextMesh.orig_DoNotUse__CommitInternal orig,tk2dTextMesh self)
{
...
{
foreach (Delegates.DoNotUse__CommitInternal_BeforeArgs toInvoke in _beforeDoNotUse__CommitInternal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DoNotUse__CommitInternal_AfterArgs toInvoke in _afterDoNotUse__CommitInternal.GetInvocationList())
{
try
{
...
private static bool UsesSpriteCollection(On.tk2dTextMesh.orig_UsesSpriteCollection orig,tk2dTextMesh self,  tk2dSpriteCollectionData spriteCollection)
{
...
public delegate string FormatText_string_WithArgs (Func<tk2dTextMesh,  string, string> orig, tk2dTextMesh self,  string unformattedString);
...
public delegate void FormatText_string_string_WithArgs (Action<tk2dTextMesh,  string,  string> orig, tk2dTextMesh self,  string _targetString,  string _source);
...
public delegate void set_font_WithArgs (Action<tk2dTextMesh,  tk2dFontData> orig, tk2dTextMesh self,  tk2dFontData value);
...
public delegate UnityEngine.Color get_color_WithArgs (Func<tk2dTextMesh, UnityEngine.Color> orig, tk2dTextMesh self);
...
public delegate void set_color_WithArgs (Action<tk2dTextMesh,  UnityEngine.Color> orig, tk2dTextMesh self,  UnityEngine.Color value);
public sealed class Params_get_color2
{
public tk2dTextMesh self;
}
public delegate void get_color2_BeforeArgs(Params_get_color2 args);
public delegate UnityEngine.Color get_color2_AfterArgs(Params_get_color2 args, UnityEngine.Color ret);
public delegate UnityEngine.Color get_color2_WithArgs (Func<tk2dTextMesh, UnityEngine.Color> orig, tk2dTextMesh self);
...
public delegate void set_color2_WithArgs (Action<tk2dTextMesh,  UnityEngine.Color> orig, tk2dTextMesh self,  UnityEngine.Color value);
...
public delegate UnityEngine.TextAnchor get_anchor_AfterArgs(Params_get_anchor args, UnityEngine.TextAnchor ret);
public delegate UnityEngine.TextAnchor get_anchor_WithArgs (Func<tk2dTextMesh, UnityEngine.TextAnchor> orig, tk2dTextMesh self);
...
public delegate void set_anchor_WithArgs (Action<tk2dTextMesh,  UnityEngine.TextAnchor> orig, tk2dTextMesh self,  UnityEngine.TextAnchor value);
public sealed class Params_get_scale
{
public tk2dTextMesh self;
}
public delegate void get_scale_BeforeArgs(Params_get_scale args);
public delegate UnityEngine.Vector3 get_scale_AfterArgs(Params_get_scale args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 get_scale_WithArgs (Func<tk2dTextMesh, UnityEngine.Vector3> orig, tk2dTextMesh self);
...
public delegate void set_scale_WithArgs (Action<tk2dTextMesh,  UnityEngine.Vector3> orig, tk2dTextMesh self,  UnityEngine.Vector3 value);
...
public delegate UnityEngine.Renderer get_CachedRenderer_AfterArgs(Params_get_CachedRenderer args, UnityEngine.Renderer ret);
public delegate UnityEngine.Renderer get_CachedRenderer_WithArgs (Func<tk2dTextMesh, UnityEngine.Renderer> orig, tk2dTextMesh self);
...
public delegate UnityEngine.Vector2 GetMeshDimensionsForString_AfterArgs(Params_GetMeshDimensionsForString args, UnityEngine.Vector2 ret);
public delegate UnityEngine.Vector2 GetMeshDimensionsForString_WithArgs (Func<tk2dTextMesh,  string, UnityEngine.Vector2> orig, tk2dTextMesh self,  string str);
...
public delegate UnityEngine.Bounds GetEstimatedMeshBoundsForString_AfterArgs(Params_GetEstimatedMeshBoundsForString args, UnityEngine.Bounds ret);
public delegate UnityEngine.Bounds GetEstimatedMeshBoundsForString_WithArgs (Func<tk2dTextMesh,  string, UnityEngine.Bounds> orig, tk2dTextMesh self,  string str);
...
public delegate bool UsesSpriteCollection_WithArgs (Func<tk2dTextMesh,  tk2dSpriteCollectionData, bool> orig, tk2dTextMesh self,  tk2dSpriteCollectionData spriteCollection);
...
{
add => HookEndpointManager.Add<Delegates.get_FormattedText_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_FormattedText", true), value);
remove => HookEndpointManager.Remove<Delegates.get_FormattedText_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_FormattedText", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.FormatText_string_string_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "FormatText", true), value);
remove => HookEndpointManager.Remove<Delegates.FormatText_string_string_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "FormatText", true), value);
}
public static event Delegates.get_font_WithArgs get_font
{
add => HookEndpointManager.Add<Delegates.get_font_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_font", true), value);
remove => HookEndpointManager.Remove<Delegates.get_font_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_font", true), value);
}
public static event Delegates.set_font_WithArgs set_font
{
add => HookEndpointManager.Add<Delegates.set_font_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_font", true), value);
remove => HookEndpointManager.Remove<Delegates.set_font_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_font", true), value);
}
public static event Delegates.get_formatting_WithArgs get_formatting
{
add => HookEndpointManager.Add<Delegates.get_formatting_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_formatting", true), value);
remove => HookEndpointManager.Remove<Delegates.get_formatting_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_formatting", true), value);
}
public static event Delegates.set_formatting_WithArgs set_formatting
{
add => HookEndpointManager.Add<Delegates.set_formatting_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_formatting", true), value);
remove => HookEndpointManager.Remove<Delegates.set_formatting_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_formatting", true), value);
}
public static event Delegates.get_wordWrapWidth_WithArgs get_wordWrapWidth
{
add => HookEndpointManager.Add<Delegates.get_wordWrapWidth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_wordWrapWidth", true), value);
remove => HookEndpointManager.Remove<Delegates.get_wordWrapWidth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_wordWrapWidth", true), value);
}
public static event Delegates.set_wordWrapWidth_WithArgs set_wordWrapWidth
{
add => HookEndpointManager.Add<Delegates.set_wordWrapWidth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_wordWrapWidth", true), value);
remove => HookEndpointManager.Remove<Delegates.set_wordWrapWidth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_wordWrapWidth", true), value);
}
public static event Delegates.get_text_WithArgs get_text
{
add => HookEndpointManager.Add<Delegates.get_text_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_text", true), value);
remove => HookEndpointManager.Remove<Delegates.get_text_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_text", true), value);
}
public static event Delegates.set_text_WithArgs set_text
{
add => HookEndpointManager.Add<Delegates.set_text_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_text", true), value);
remove => HookEndpointManager.Remove<Delegates.set_text_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_text", true), value);
}
public static event Delegates.get_color_WithArgs get_color
{
add => HookEndpointManager.Add<Delegates.get_color_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_color", true), value);
remove => HookEndpointManager.Remove<Delegates.get_color_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_color", true), value);
}
public static event Delegates.set_color_WithArgs set_color
{
add => HookEndpointManager.Add<Delegates.set_color_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_color", true), value);
remove => HookEndpointManager.Remove<Delegates.set_color_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_color", true), value);
}
public static event Delegates.get_color2_WithArgs get_color2
{
add => HookEndpointManager.Add<Delegates.get_color2_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_color2", true), value);
remove => HookEndpointManager.Remove<Delegates.get_color2_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_color2", true), value);
}
public static event Delegates.set_color2_WithArgs set_color2
{
add => HookEndpointManager.Add<Delegates.set_color2_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_color2", true), value);
remove => HookEndpointManager.Remove<Delegates.set_color2_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_color2", true), value);
}
public static event Delegates.get_useGradient_WithArgs get_useGradient
{
add => HookEndpointManager.Add<Delegates.get_useGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_useGradient", true), value);
remove => HookEndpointManager.Remove<Delegates.get_useGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_useGradient", true), value);
}
public static event Delegates.set_useGradient_WithArgs set_useGradient
{
add => HookEndpointManager.Add<Delegates.set_useGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_useGradient", true), value);
remove => HookEndpointManager.Remove<Delegates.set_useGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_useGradient", true), value);
}
public static event Delegates.get_anchor_WithArgs get_anchor
{
add => HookEndpointManager.Add<Delegates.get_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_anchor", true), value);
remove => HookEndpointManager.Remove<Delegates.get_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_anchor", true), value);
}
public static event Delegates.set_anchor_WithArgs set_anchor
{
add => HookEndpointManager.Add<Delegates.set_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_anchor", true), value);
remove => HookEndpointManager.Remove<Delegates.set_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_anchor", true), value);
}
public static event Delegates.get_scale_WithArgs get_scale
{
add => HookEndpointManager.Add<Delegates.get_scale_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_scale", true), value);
remove => HookEndpointManager.Remove<Delegates.get_scale_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_scale", true), value);
}
public static event Delegates.set_scale_WithArgs set_scale
{
add => HookEndpointManager.Add<Delegates.set_scale_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_scale", true), value);
remove => HookEndpointManager.Remove<Delegates.set_scale_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_scale", true), value);
}
public static event Delegates.get_kerning_WithArgs get_kerning
{
add => HookEndpointManager.Add<Delegates.get_kerning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_kerning", true), value);
remove => HookEndpointManager.Remove<Delegates.get_kerning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_kerning", true), value);
}
public static event Delegates.set_kerning_WithArgs set_kerning
{
add => HookEndpointManager.Add<Delegates.set_kerning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_kerning", true), value);
remove => HookEndpointManager.Remove<Delegates.set_kerning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_kerning", true), value);
}
public static event Delegates.get_maxChars_WithArgs get_maxChars
{
add => HookEndpointManager.Add<Delegates.get_maxChars_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_maxChars", true), value);
remove => HookEndpointManager.Remove<Delegates.get_maxChars_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_maxChars", true), value);
}
public static event Delegates.set_maxChars_WithArgs set_maxChars
{
add => HookEndpointManager.Add<Delegates.set_maxChars_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_maxChars", true), value);
remove => HookEndpointManager.Remove<Delegates.set_maxChars_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_maxChars", true), value);
}
public static event Delegates.get_textureGradient_WithArgs get_textureGradient
{
add => HookEndpointManager.Add<Delegates.get_textureGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_textureGradient", true), value);
remove => HookEndpointManager.Remove<Delegates.get_textureGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_textureGradient", true), value);
}
public static event Delegates.set_textureGradient_WithArgs set_textureGradient
{
add => HookEndpointManager.Add<Delegates.set_textureGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_textureGradient", true), value);
remove => HookEndpointManager.Remove<Delegates.set_textureGradient_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_textureGradient", true), value);
}
public static event Delegates.get_inlineStyling_WithArgs get_inlineStyling
{
add => HookEndpointManager.Add<Delegates.get_inlineStyling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_inlineStyling", true), value);
remove => HookEndpointManager.Remove<Delegates.get_inlineStyling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_inlineStyling", true), value);
}
public static event Delegates.set_inlineStyling_WithArgs set_inlineStyling
{
add => HookEndpointManager.Add<Delegates.set_inlineStyling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_inlineStyling", true), value);
remove => HookEndpointManager.Remove<Delegates.set_inlineStyling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_inlineStyling", true), value);
}
public static event Delegates.get_Spacing_WithArgs get_Spacing
{
add => HookEndpointManager.Add<Delegates.get_Spacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_Spacing", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Spacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_Spacing", true), value);
}
public static event Delegates.set_Spacing_WithArgs set_Spacing
{
add => HookEndpointManager.Add<Delegates.set_Spacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_Spacing", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Spacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_Spacing", true), value);
}
public static event Delegates.get_LineSpacing_WithArgs get_LineSpacing
{
add => HookEndpointManager.Add<Delegates.get_LineSpacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_LineSpacing", true), value);
remove => HookEndpointManager.Remove<Delegates.get_LineSpacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_LineSpacing", true), value);
}
public static event Delegates.set_LineSpacing_WithArgs set_LineSpacing
{
add => HookEndpointManager.Add<Delegates.set_LineSpacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_LineSpacing", true), value);
remove => HookEndpointManager.Remove<Delegates.set_LineSpacing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_LineSpacing", true), value);
}
public static event Delegates.get_SortingOrder_WithArgs get_SortingOrder
{
add => HookEndpointManager.Add<Delegates.get_SortingOrder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_SortingOrder", true), value);
remove => HookEndpointManager.Remove<Delegates.get_SortingOrder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_SortingOrder", true), value);
}
public static event Delegates.set_SortingOrder_WithArgs set_SortingOrder
{
add => HookEndpointManager.Add<Delegates.set_SortingOrder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_SortingOrder", true), value);
remove => HookEndpointManager.Remove<Delegates.set_SortingOrder_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "set_SortingOrder", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_CachedRenderer_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_CachedRenderer", true), value);
remove => HookEndpointManager.Remove<Delegates.get_CachedRenderer_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_CachedRenderer", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_useInlineStyling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_useInlineStyling", true), value);
remove => HookEndpointManager.Remove<Delegates.get_useInlineStyling_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTextMesh), "get_useInlineStyling", true), value);
}
