...
public static class OnBuildMetadata
{
    ...
    public static class Delegates
    {
        ...
        public delegate BuildMetadata Create_WithArgs(
            Func<string, string, DateTime, string, DateTime, BuildMetadata> orig, string branchName, string revision,
            DateTime commitTime, string machineName, DateTime buildTime);
        ...
        public delegate DateTime get_BuildTime_AfterArgs(Params_get_BuildTime args, DateTime ret);

        public delegate void get_BuildTime_BeforeArgs(Params_get_BuildTime args);

        public delegate DateTime get_BuildTime_WithArgs(Func<BuildMetadata, DateTime> orig, BuildMetadata self);

        public delegate DateTime get_CommitTime_AfterArgs(Params_get_CommitTime args, DateTime ret);

        public delegate void get_CommitTime_BeforeArgs(Params_get_CommitTime args);

        public delegate DateTime get_CommitTime_WithArgs(Func<BuildMetadata, DateTime> orig, BuildMetadata self);
