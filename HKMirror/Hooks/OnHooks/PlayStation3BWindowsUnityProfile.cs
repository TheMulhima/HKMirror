...
public static class OnPlayStation3BWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation3BWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation3BWindowsUnityProfile> orig, PlayStation3BWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation3BWindowsUnityProfile> orig,
            PlayStation3BWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation3BWindowsUnityProfile self;
        }
    }
