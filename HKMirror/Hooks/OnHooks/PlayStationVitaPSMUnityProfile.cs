...
public static class OnPlayStationVitaPSMUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStationVitaPSMUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStationVitaPSMUnityProfile> orig, PlayStationVitaPSMUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStationVitaPSMUnityProfile> orig,
            PlayStationVitaPSMUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStationVitaPSMUnityProfile self;
        }
    }
