...
public static class OnRazerServalMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RazerServalMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<RazerServalMacUnityProfile> orig, RazerServalMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerServalMacUnityProfile> orig, RazerServalMacUnityProfile self);

        public sealed class Params_Define
        {
            public RazerServalMacUnityProfile self;
        }
    }
