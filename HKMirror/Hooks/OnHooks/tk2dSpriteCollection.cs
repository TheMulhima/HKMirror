...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "get_DoNotUse__TextureRefs", true), get_DoNotUse__TextureRefs);
...
private static UnityEngine.Texture2D[] get_DoNotUse__TextureRefs(Func<tk2dSpriteCollection, UnityEngine.Texture2D[]> orig, tk2dSpriteCollection self)
{
...
{
foreach (Delegates.get_DoNotUse__TextureRefs_BeforeArgs toInvoke in _beforeget_DoNotUse__TextureRefs.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_DoNotUse__TextureRefs_AfterArgs toInvoke in _afterget_DoNotUse__TextureRefs.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "set_DoNotUse__TextureRefs", true), set_DoNotUse__TextureRefs);
...
private static void set_DoNotUse__TextureRefs(Action<tk2dSpriteCollection,  UnityEngine.Texture2D[]> orig, tk2dSpriteCollection self,  UnityEngine.Texture2D[] value)
{
...
{
foreach (Delegates.set_DoNotUse__TextureRefs_BeforeArgs toInvoke in _beforeset_DoNotUse__TextureRefs.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_DoNotUse__TextureRefs_AfterArgs toInvoke in _afterset_DoNotUse__TextureRefs.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "get_HasPlatformData", true), get_HasPlatformData);
...
{
foreach (Delegates.get_HasPlatformData_BeforeArgs toInvoke in _beforeget_HasPlatformData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_HasPlatformData_AfterArgs toInvoke in _afterget_HasPlatformData.GetInvocationList())
{
try
{
...
public delegate UnityEngine.Texture2D[] get_DoNotUse__TextureRefs_AfterArgs(Params_get_DoNotUse__TextureRefs args, UnityEngine.Texture2D[] ret);
public delegate UnityEngine.Texture2D[] get_DoNotUse__TextureRefs_WithArgs (Func<tk2dSpriteCollection, UnityEngine.Texture2D[]> orig, tk2dSpriteCollection self);
...
public delegate void set_DoNotUse__TextureRefs_WithArgs (Action<tk2dSpriteCollection,  UnityEngine.Texture2D[]> orig, tk2dSpriteCollection self,  UnityEngine.Texture2D[] value);
...
public delegate bool get_HasPlatformData_WithArgs (Func<tk2dSpriteCollection, bool> orig, tk2dSpriteCollection self);
...
{
add => HookEndpointManager.Add<Delegates.get_DoNotUse__TextureRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "get_DoNotUse__TextureRefs", true), value);
remove => HookEndpointManager.Remove<Delegates.get_DoNotUse__TextureRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "get_DoNotUse__TextureRefs", true), value);
}
public static event Delegates.set_DoNotUse__TextureRefs_WithArgs set_DoNotUse__TextureRefs
{
add => HookEndpointManager.Add<Delegates.set_DoNotUse__TextureRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "set_DoNotUse__TextureRefs", true), value);
remove => HookEndpointManager.Remove<Delegates.set_DoNotUse__TextureRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "set_DoNotUse__TextureRefs", true), value);
}
public static event Delegates.get_HasPlatformData_WithArgs get_HasPlatformData
{
add => HookEndpointManager.Add<Delegates.get_HasPlatformData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "get_HasPlatformData", true), value);
remove => HookEndpointManager.Remove<Delegates.get_HasPlatformData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollection), "get_HasPlatformData", true), value);
}
