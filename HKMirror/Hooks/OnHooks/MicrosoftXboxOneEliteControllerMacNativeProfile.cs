...
public static class OnMicrosoftXboxOneEliteControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(MicrosoftXboxOneEliteControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MicrosoftXboxOneEliteControllerMacNativeProfile> orig,
            MicrosoftXboxOneEliteControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MicrosoftXboxOneEliteControllerMacNativeProfile> orig,
            MicrosoftXboxOneEliteControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MicrosoftXboxOneEliteControllerMacNativeProfile self;
        }
    }
