...
public static class OnMicrosoftXboxOneEliteControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MicrosoftXboxOneEliteControllerMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.MicrosoftXboxOneEliteControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MicrosoftXboxOneEliteControllerMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.MicrosoftXboxOneEliteControllerMacNativeProfile), "Define",
                    true), value);
