...
new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoFileName", true), get_VideoFileName);
...
private static string get_VideoFileName(Func<CinematicVideoReference, string> orig, CinematicVideoReference self)
{
...
{
foreach (Delegates.get_VideoFileName_BeforeArgs toInvoke in _beforeget_VideoFileName.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoAssetPath", true), get_VideoAssetPath);
...
private static string get_VideoAssetPath(Func<CinematicVideoReference, string> orig, CinematicVideoReference self)
{
...
{
foreach (Delegates.get_VideoAssetPath_BeforeArgs toInvoke in _beforeget_VideoAssetPath.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_VideoAssetPath_AfterArgs toInvoke in _afterget_VideoAssetPath.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_AudioAssetPath", true), get_AudioAssetPath);
...
private static string get_AudioAssetPath(Func<CinematicVideoReference, string> orig, CinematicVideoReference self)
{
...
{
foreach (Delegates.get_AudioAssetPath_BeforeArgs toInvoke in _beforeget_AudioAssetPath.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_AudioAssetPath_AfterArgs toInvoke in _afterget_AudioAssetPath.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_EmbeddedVideoClip", true), get_EmbeddedVideoClip);
...
private static UnityEngine.Video.VideoClip get_EmbeddedVideoClip(Func<CinematicVideoReference, UnityEngine.Video.VideoClip> orig, CinematicVideoReference self)
{
...
{
foreach (Delegates.get_EmbeddedVideoClip_BeforeArgs toInvoke in _beforeget_EmbeddedVideoClip.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_EmbeddedVideoClip_AfterArgs toInvoke in _afterget_EmbeddedVideoClip.GetInvocationList())
{
try
{
...
public delegate string get_VideoFileName_WithArgs (Func<CinematicVideoReference, string> orig, CinematicVideoReference self);
...
public delegate string get_VideoAssetPath_WithArgs (Func<CinematicVideoReference, string> orig, CinematicVideoReference self);
...
public delegate string get_AudioAssetPath_WithArgs (Func<CinematicVideoReference, string> orig, CinematicVideoReference self);
...
public delegate UnityEngine.Video.VideoClip get_EmbeddedVideoClip_AfterArgs(Params_get_EmbeddedVideoClip args, UnityEngine.Video.VideoClip ret);
public delegate UnityEngine.Video.VideoClip get_EmbeddedVideoClip_WithArgs (Func<CinematicVideoReference, UnityEngine.Video.VideoClip> orig, CinematicVideoReference self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_VideoFileName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoFileName", true), value);
remove => HookEndpointManager.Remove<Delegates.get_VideoFileName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoFileName", true), value);
}
public static event Delegates.get_VideoAssetPath_WithArgs get_VideoAssetPath
{
add => HookEndpointManager.Add<Delegates.get_VideoAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoAssetPath", true), value);
remove => HookEndpointManager.Remove<Delegates.get_VideoAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoAssetPath", true), value);
}
public static event Delegates.get_AudioAssetPath_WithArgs get_AudioAssetPath
{
add => HookEndpointManager.Add<Delegates.get_AudioAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_AudioAssetPath", true), value);
remove => HookEndpointManager.Remove<Delegates.get_AudioAssetPath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_AudioAssetPath", true), value);
}
public static event Delegates.get_EmbeddedVideoClip_WithArgs get_EmbeddedVideoClip
{
add => HookEndpointManager.Add<Delegates.get_EmbeddedVideoClip_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_EmbeddedVideoClip", true), value);
remove => HookEndpointManager.Remove<Delegates.get_EmbeddedVideoClip_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_EmbeddedVideoClip", true), value);
}
}
