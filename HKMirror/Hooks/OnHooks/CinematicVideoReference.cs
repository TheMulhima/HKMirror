...
public static class OnCinematicVideoReference
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.get_VideoFileName_NormalArgs _afterget_VideoFileName;
            ...
            CinematicVideoReference self)
        {
            ...
            if (_afterget_VideoFileName != null) retVal = _afterget_VideoFileName.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.get_VideoAssetPath_NormalArgs _afterget_VideoAssetPath;
            ...
            CinematicVideoReference self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_VideoAssetPath != null) retVal = _afterget_VideoAssetPath.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.get_AudioAssetPath_NormalArgs _afterget_AudioAssetPath;
            ...
            CinematicVideoReference self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_AudioAssetPath != null) retVal = _afterget_AudioAssetPath.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.get_EmbeddedVideoClip_NormalArgs _afterget_EmbeddedVideoClip;
            ...
            CinematicVideoReference self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_EmbeddedVideoClip != null) retVal = _afterget_EmbeddedVideoClip.Invoke(@params);
            return retVal;
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate string get_AudioAssetPath_NormalArgs(Params_get_AudioAssetPath args);

        public delegate void get_EmbeddedVideoClip_BeforeArgs(Params_get_EmbeddedVideoClip args);

        public delegate VideoClip get_EmbeddedVideoClip_NormalArgs(Params_get_EmbeddedVideoClip args);

        public delegate void get_VideoAssetPath_BeforeArgs(Params_get_VideoAssetPath args);

        public delegate string get_VideoAssetPath_NormalArgs(Params_get_VideoAssetPath args);

        public delegate void get_VideoFileName_BeforeArgs(Params_get_VideoFileName args);

        public delegate string get_VideoFileName_NormalArgs(Params_get_VideoFileName args);
    ...
    {
        public static event Delegates.get_VideoFileName_NormalArgs get_VideoFileName
        {
            add
            {
        ...
        public static event Delegates.get_VideoAssetPath_NormalArgs get_VideoAssetPath
        {
            add
            {
        ...
        public static event Delegates.get_AudioAssetPath_NormalArgs get_AudioAssetPath
        {
            add
            {
        ...
        public static event Delegates.get_EmbeddedVideoClip_NormalArgs get_EmbeddedVideoClip
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_VideoFileName_NormalArgs get_VideoFileName
        {
            add => HookEndpointManager.Add<Delegates.get_VideoFileName_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoFileName"), value);
            remove => HookEndpointManager.Remove<Delegates.get_VideoFileName_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoFileName"), value);
        }

        public static event Delegates.get_VideoAssetPath_NormalArgs get_VideoAssetPath
        {
            add => HookEndpointManager.Add<Delegates.get_VideoAssetPath_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoAssetPath"), value);
            remove => HookEndpointManager.Remove<Delegates.get_VideoAssetPath_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_VideoAssetPath"), value);
        }

        public static event Delegates.get_AudioAssetPath_NormalArgs get_AudioAssetPath
        {
            add => HookEndpointManager.Add<Delegates.get_AudioAssetPath_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_AudioAssetPath"), value);
            remove => HookEndpointManager.Remove<Delegates.get_AudioAssetPath_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_AudioAssetPath"), value);
        }

        public static event Delegates.get_EmbeddedVideoClip_NormalArgs get_EmbeddedVideoClip
        {
            add => HookEndpointManager.Add<Delegates.get_EmbeddedVideoClip_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_EmbeddedVideoClip"), value);
            remove => HookEndpointManager.Remove<Delegates.get_EmbeddedVideoClip_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CinematicVideoReference), "get_EmbeddedVideoClip"), value);
        }
    }
}