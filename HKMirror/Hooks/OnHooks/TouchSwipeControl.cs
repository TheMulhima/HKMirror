...
public static class OnTouchSwipeControl
{
    internal static class HookHandler
    {
        ...
        internal static void HookCreateControl()
        {
            if (!HookedList.Contains("CreateControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "CreateControl", true),
                    CreateControl);
            }
        }
        ...
        internal static void HookDestroyControl()
        {
            if (!HookedList.Contains("DestroyControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "DestroyControl", true),
                    DestroyControl);
            }
        }
        ...
        internal static void HookConfigureControl()
        {
            if (!HookedList.Contains("ConfigureControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "ConfigureControl", true),
                    ConfigureControl);
            }
        }
        ...
        internal static void HookDrawGizmos()
        {
            if (!HookedList.Contains("DrawGizmos"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "DrawGizmos", true),
                    DrawGizmos);
            }
        }
        ...
        internal static void HookSubmitControlState()
        {
            if (!HookedList.Contains("SubmitControlState"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "SubmitControlState", true),
                    SubmitControlState);
            }
        }
        ...
        private static void SubmitControlState(Action<InControl.TouchSwipeControl, ulong, float> orig,
            InControl.TouchSwipeControl self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookCommitControlState()
        {
            if (!HookedList.Contains("CommitControlState"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "CommitControlState", true),
                    CommitControlState);
            }
        }
        ...
        private static void CommitControlState(Action<InControl.TouchSwipeControl, ulong, float> orig,
            InControl.TouchSwipeControl self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookTouchBegan()
        {
            if (!HookedList.Contains("TouchBegan"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "TouchBegan", true),
                    TouchBegan);
            }
        }
        ...
        private static void TouchBegan(Action<InControl.TouchSwipeControl, InControl.Touch> orig,
            InControl.TouchSwipeControl self, InControl.Touch touch)
        {
        ...
        internal static void HookTouchMoved()
        {
            if (!HookedList.Contains("TouchMoved"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "TouchMoved", true),
                    TouchMoved);
            }
        }
        ...
        private static void TouchMoved(Action<InControl.TouchSwipeControl, InControl.Touch> orig,
            InControl.TouchSwipeControl self, InControl.Touch touch)
        {
        ...
        internal static void HookTouchEnded()
        {
            if (!HookedList.Contains("TouchEnded"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "TouchEnded", true),
                    TouchEnded);
            }
        }
        ...
        private static void TouchEnded(Action<InControl.TouchSwipeControl, InControl.Touch> orig,
            InControl.TouchSwipeControl self, InControl.Touch touch)
        {
        ...
        internal static void Hookget_ActiveArea()
        {
            if (!HookedList.Contains("get_ActiveArea"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "get_ActiveArea", true),
                    get_ActiveArea);
            }
        }
        ...
        private static UnityEngine.Rect get_ActiveArea(Func<InControl.TouchSwipeControl, UnityEngine.Rect> orig,
            InControl.TouchSwipeControl self)
        {
        ...
        internal static void Hookset_ActiveArea()
        {
            if (!HookedList.Contains("set_ActiveArea"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "set_ActiveArea", true),
                    set_ActiveArea);
            }
        }
        ...
        private static void set_ActiveArea(Action<InControl.TouchSwipeControl, UnityEngine.Rect> orig,
            InControl.TouchSwipeControl self, UnityEngine.Rect value)
        {
        ...
        internal static void Hookget_AreaUnitType()
        {
            if (!HookedList.Contains("get_AreaUnitType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "get_AreaUnitType", true),
                    get_AreaUnitType);
            }
        }
        ...
        private static InControl.TouchUnitType get_AreaUnitType(
            Func<InControl.TouchSwipeControl, InControl.TouchUnitType> orig, InControl.TouchSwipeControl self)
        {
        ...
        internal static void Hookset_AreaUnitType()
        {
            if (!HookedList.Contains("set_AreaUnitType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "set_AreaUnitType", true),
                    set_AreaUnitType);
            }
        }
        ...
        private static void set_AreaUnitType(Action<InControl.TouchSwipeControl, InControl.TouchUnitType> orig,
            InControl.TouchSwipeControl self, InControl.TouchUnitType value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void CreateControl_WithArgs(Action<InControl.TouchSwipeControl> orig,
            InControl.TouchSwipeControl self);
        ...
        public delegate void DestroyControl_WithArgs(Action<InControl.TouchSwipeControl> orig,
            InControl.TouchSwipeControl self);
        ...
        public delegate void ConfigureControl_WithArgs(Action<InControl.TouchSwipeControl> orig,
            InControl.TouchSwipeControl self);
        ...
        public delegate void DrawGizmos_WithArgs(Action<InControl.TouchSwipeControl> orig,
            InControl.TouchSwipeControl self);
        ...
        public delegate void Update_WithArgs(Action<InControl.TouchSwipeControl> orig,
            InControl.TouchSwipeControl self);
        ...
        public delegate void SubmitControlState_WithArgs(Action<InControl.TouchSwipeControl, ulong, float> orig,
            InControl.TouchSwipeControl self, ulong updateTick, float deltaTime);
        ...
        public delegate void CommitControlState_WithArgs(Action<InControl.TouchSwipeControl, ulong, float> orig,
            InControl.TouchSwipeControl self, ulong updateTick, float deltaTime);
        ...
        public delegate void TouchBegan_WithArgs(Action<InControl.TouchSwipeControl, InControl.Touch> orig,
            InControl.TouchSwipeControl self, InControl.Touch touch);
        ...
        public delegate void TouchMoved_WithArgs(Action<InControl.TouchSwipeControl, InControl.Touch> orig,
            InControl.TouchSwipeControl self, InControl.Touch touch);
        ...
        public delegate void TouchEnded_WithArgs(Action<InControl.TouchSwipeControl, InControl.Touch> orig,
            InControl.TouchSwipeControl self, InControl.Touch touch);
        ...
        public delegate UnityEngine.Rect get_ActiveArea_WithArgs(
            Func<InControl.TouchSwipeControl, UnityEngine.Rect> orig, InControl.TouchSwipeControl self);
        ...
        public delegate void set_ActiveArea_WithArgs(Action<InControl.TouchSwipeControl, UnityEngine.Rect> orig,
            InControl.TouchSwipeControl self, UnityEngine.Rect value);
        ...
        public delegate void set_AreaUnitType_WithArgs(
            Action<InControl.TouchSwipeControl, InControl.TouchUnitType> orig, InControl.TouchSwipeControl self,
    ...
    public static class WithOrig
    {
        public static event Delegates.CreateControl_WithArgs CreateControl
        {
            add => HookEndpointManager.Add<Delegates.CreateControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "CreateControl", true), value);
        ...
        public static event Delegates.DestroyControl_WithArgs DestroyControl
        {
            add => HookEndpointManager.Add<Delegates.DestroyControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "DestroyControl", true), value);
        ...
        public static event Delegates.ConfigureControl_WithArgs ConfigureControl
        {
            add => HookEndpointManager.Add<Delegates.ConfigureControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "ConfigureControl", true), value);
        ...
        public static event Delegates.DrawGizmos_WithArgs DrawGizmos
        {
            add => HookEndpointManager.Add<Delegates.DrawGizmos_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "DrawGizmos", true), value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "Update", true), value);
        ...
        public static event Delegates.SubmitControlState_WithArgs SubmitControlState
        {
            add => HookEndpointManager.Add<Delegates.SubmitControlState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "SubmitControlState", true), value);
        ...
        public static event Delegates.CommitControlState_WithArgs CommitControlState
        {
            add => HookEndpointManager.Add<Delegates.CommitControlState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "CommitControlState", true), value);
        ...
        public static event Delegates.TouchBegan_WithArgs TouchBegan
        {
            add => HookEndpointManager.Add<Delegates.TouchBegan_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "TouchBegan", true), value);
        ...
        public static event Delegates.TouchMoved_WithArgs TouchMoved
        {
            add => HookEndpointManager.Add<Delegates.TouchMoved_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "TouchMoved", true), value);
        ...
        public static event Delegates.TouchEnded_WithArgs TouchEnded
        {
            add => HookEndpointManager.Add<Delegates.TouchEnded_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "TouchEnded", true), value);
        ...
        public static event Delegates.get_ActiveArea_WithArgs get_ActiveArea
        {
            add => HookEndpointManager.Add<Delegates.get_ActiveArea_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "get_ActiveArea", true), value);
        ...
        public static event Delegates.set_ActiveArea_WithArgs set_ActiveArea
        {
            add => HookEndpointManager.Add<Delegates.set_ActiveArea_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "set_ActiveArea", true), value);
        ...
        public static event Delegates.get_AreaUnitType_WithArgs get_AreaUnitType
        {
            add => HookEndpointManager.Add<Delegates.get_AreaUnitType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "get_AreaUnitType", true), value);
        ...
        public static event Delegates.set_AreaUnitType_WithArgs set_AreaUnitType
        {
            add => HookEndpointManager.Add<Delegates.set_AreaUnitType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchSwipeControl), "set_AreaUnitType", true), value);
