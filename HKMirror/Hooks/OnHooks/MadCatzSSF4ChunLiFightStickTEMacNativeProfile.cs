...
public static class OnMadCatzSSF4ChunLiFightStickTEMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(MadCatzSSF4ChunLiFightStickTEMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzSSF4ChunLiFightStickTEMacNativeProfile> orig,
            MadCatzSSF4ChunLiFightStickTEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzSSF4ChunLiFightStickTEMacNativeProfile> orig,
            MadCatzSSF4ChunLiFightStickTEMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzSSF4ChunLiFightStickTEMacNativeProfile self;
        }
    }
