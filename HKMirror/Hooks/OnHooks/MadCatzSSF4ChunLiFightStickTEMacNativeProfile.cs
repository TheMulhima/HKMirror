...
public static class OnMadCatzSSF4ChunLiFightStickTEMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MadCatzSSF4ChunLiFightStickTEMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.MadCatzSSF4ChunLiFightStickTEMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzSSF4ChunLiFightStickTEMacNativeProfile self)
        {
