...
public static class OnMadCatzArcadeStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzArcadeStickMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MadCatzArcadeStickMacNativeProfile> orig,
            MadCatzArcadeStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzArcadeStickMacNativeProfile> orig,
            MadCatzArcadeStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzArcadeStickMacNativeProfile self;
        }
    }
