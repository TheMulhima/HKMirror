...
private static void OnTriggerEnter2D(On.DreamPlantOrb.orig_OnTriggerEnter2D orig,DreamPlantOrb self,  UnityEngine.Collider2D collision)
{
...
private static System.Collections.IEnumerator Spread(On.DreamPlantOrb.orig_Spread orig,DreamPlantOrb self)
{
...
private static System.Collections.IEnumerator DisableAfterTime(On.DreamPlantOrb.orig_DisableAfterTime orig,DreamPlantOrb self,  UnityEngine.GameObject obj,  float time)
{
...
private static System.Collections.IEnumerator TweenPosition(On.DreamPlantOrb.orig_TweenPosition orig,DreamPlantOrb self,  UnityEngine.Vector3 position,  float time,  UnityEngine.AnimationCurve curve)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<DreamPlantOrb,  UnityEngine.Collider2D> orig, DreamPlantOrb self,  UnityEngine.Collider2D collision);
...
public delegate System.Collections.IEnumerator Spread_AfterArgs(Params_Spread args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Spread_WithArgs (Func<DreamPlantOrb, System.Collections.IEnumerator> orig, DreamPlantOrb self);
...
public delegate System.Collections.IEnumerator DisableAfterTime_AfterArgs(Params_DisableAfterTime args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DisableAfterTime_WithArgs (Func<DreamPlantOrb,  UnityEngine.GameObject,  float, System.Collections.IEnumerator> orig, DreamPlantOrb self,  UnityEngine.GameObject obj,  float time);
...
public delegate System.Collections.IEnumerator TweenPosition_AfterArgs(Params_TweenPosition args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator TweenPosition_WithArgs (Func<DreamPlantOrb,  UnityEngine.Vector3,  float,  UnityEngine.AnimationCurve, System.Collections.IEnumerator> orig, DreamPlantOrb self,  UnityEngine.Vector3 position,  float time,  UnityEngine.AnimationCurve curve);
}
