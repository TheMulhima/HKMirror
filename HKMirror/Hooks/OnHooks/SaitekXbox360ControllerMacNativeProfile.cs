...
public static class OnSaitekXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.SaitekXbox360ControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.SaitekXbox360ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.SaitekXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.SaitekXbox360ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.SaitekXbox360ControllerMacNativeProfile self);
    }
