...
public static class OnSaitekXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SaitekXbox360ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<SaitekXbox360ControllerMacNativeProfile> orig,
            SaitekXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SaitekXbox360ControllerMacNativeProfile> orig,
            SaitekXbox360ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public SaitekXbox360ControllerMacNativeProfile self;
        }
    }
