...
public static class OnHashTableContainsKey
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContainsKey), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HashTableContainsKey> orig,
            HutongGames.PlayMaker.Actions.HashTableContainsKey self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContainsKey),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HashTableContainsKey> orig,
            HutongGames.PlayMaker.Actions.HashTableContainsKey self)
        {
        ...
        internal static void HookcheckIfContainsKey()
        {
            if (!HookedList.Contains("checkIfContainsKey"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContainsKey),
                        "checkIfContainsKey", true), checkIfContainsKey);
            }
        }
        ...
        private static void checkIfContainsKey(Action<HutongGames.PlayMaker.Actions.HashTableContainsKey> orig,
            HutongGames.PlayMaker.Actions.HashTableContainsKey self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableContainsKey> orig,
            HutongGames.PlayMaker.Actions.HashTableContainsKey self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableContainsKey> orig,
            HutongGames.PlayMaker.Actions.HashTableContainsKey self);
        ...
        public delegate void checkIfContainsKey_WithArgs(
            Action<HutongGames.PlayMaker.Actions.HashTableContainsKey> orig,
            HutongGames.PlayMaker.Actions.HashTableContainsKey self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableContainsKey), "OnEnter",
                    true), value);
