...
private static void OnTriggerStay2D(On.SendEnemyMessageTrigger.orig_OnTriggerStay2D orig,SendEnemyMessageTrigger self,  UnityEngine.Collider2D collision)
{
...
private static void SendEvent(On.SendEnemyMessageTrigger.orig_SendEvent orig,SendEnemyMessageTrigger self,  UnityEngine.GameObject obj)
{
...
private static void SendWalkerGoInDirection(On.SendEnemyMessageTrigger.orig_SendWalkerGoInDirection orig, UnityEngine.GameObject target,  int facing)
{
...
public delegate void OnTriggerStay2D_WithArgs (Action<SendEnemyMessageTrigger,  UnityEngine.Collider2D> orig, SendEnemyMessageTrigger self,  UnityEngine.Collider2D collision);
...
public delegate void SendEvent_WithArgs (Action<SendEnemyMessageTrigger,  UnityEngine.GameObject> orig, SendEnemyMessageTrigger self,  UnityEngine.GameObject obj);
