...
new Hook(ReflectionHelper.GetMethodInfo(typeof(LineOfSightDetector), "get_CanSeeHero", true), get_CanSeeHero);
...
{
add => HookEndpointManager.Add<Delegates.get_CanSeeHero_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(LineOfSightDetector), "get_CanSeeHero", true), value);
remove => HookEndpointManager.Remove<Delegates.get_CanSeeHero_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(LineOfSightDetector), "get_CanSeeHero", true), value);
}
