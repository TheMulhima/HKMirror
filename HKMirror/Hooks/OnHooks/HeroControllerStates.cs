...
private static bool GetState(On.HeroControllerStates.orig_GetState orig,HeroControllerStates self,  string stateName)
{
...
private static void SetState(On.HeroControllerStates.orig_SetState orig,HeroControllerStates self,  string stateName,  bool value)
{
...
public delegate bool GetState_WithArgs (Func<HeroControllerStates,  string, bool> orig, HeroControllerStates self,  string stateName);
...
public delegate void SetState_WithArgs (Action<HeroControllerStates,  string,  bool> orig, HeroControllerStates self,  string stateName,  bool value);
