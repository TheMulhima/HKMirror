...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearMeshInfo", true), ClearMeshInfo);
...
private static void ClearMeshInfo(Action<TMPro.TMP_TextInfo,  bool> orig, TMPro.TMP_TextInfo self,  bool updateMesh)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearAllMeshInfo", true), ClearAllMeshInfo);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ResetVertexLayout", true), ResetVertexLayout);
...
private static void ResetVertexLayout(Action<TMPro.TMP_TextInfo,  bool> orig, TMPro.TMP_TextInfo self,  bool isVolumetric)
{
...
{
foreach (Delegates.ResetVertexLayout_BeforeArgs toInvoke in _beforeResetVertexLayout.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearUnusedVertices", true), ClearUnusedVertices);
...
private static void ClearUnusedVertices(Action<TMPro.TMP_TextInfo,  TMPro.MaterialReference[]> orig, TMPro.TMP_TextInfo self,  TMPro.MaterialReference[] materials)
{
...
{
foreach (Delegates.ClearUnusedVertices_BeforeArgs toInvoke in _beforeClearUnusedVertices.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearUnusedVertices_AfterArgs toInvoke in _afterClearUnusedVertices.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearLineInfo", true), ClearLineInfo);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "CopyMeshInfoVertexData", true), CopyMeshInfoVertexData);
...
private static TMPro.TMP_MeshInfo[] CopyMeshInfoVertexData(Func<TMPro.TMP_TextInfo, TMPro.TMP_MeshInfo[]> orig, TMPro.TMP_TextInfo self)
{
...
{
foreach (Delegates.CopyMeshInfoVertexData_BeforeArgs toInvoke in _beforeCopyMeshInfoVertexData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CopyMeshInfoVertexData_AfterArgs toInvoke in _afterCopyMeshInfoVertexData.GetInvocationList())
{
try
{
...
public delegate void ClearMeshInfo_WithArgs (Action<TMPro.TMP_TextInfo,  bool> orig, TMPro.TMP_TextInfo self,  bool updateMesh);
...
public delegate void ResetVertexLayout_WithArgs (Action<TMPro.TMP_TextInfo,  bool> orig, TMPro.TMP_TextInfo self,  bool isVolumetric);
...
public delegate void ClearUnusedVertices_WithArgs (Action<TMPro.TMP_TextInfo,  TMPro.MaterialReference[]> orig, TMPro.TMP_TextInfo self,  TMPro.MaterialReference[] materials);
...
public delegate TMPro.TMP_MeshInfo[] CopyMeshInfoVertexData_AfterArgs(Params_CopyMeshInfoVertexData args, TMPro.TMP_MeshInfo[] ret);
public delegate TMPro.TMP_MeshInfo[] CopyMeshInfoVertexData_WithArgs (Func<TMPro.TMP_TextInfo, TMPro.TMP_MeshInfo[]> orig, TMPro.TMP_TextInfo self);
}
...
{
add => HookEndpointManager.Add<Delegates.Clear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "Clear", true), value);
remove => HookEndpointManager.Remove<Delegates.Clear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "Clear", true), value);
}
public static event Delegates.ClearMeshInfo_WithArgs ClearMeshInfo
{
add => HookEndpointManager.Add<Delegates.ClearMeshInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearMeshInfo", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearMeshInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearMeshInfo", true), value);
}
public static event Delegates.ClearAllMeshInfo_WithArgs ClearAllMeshInfo
{
add => HookEndpointManager.Add<Delegates.ClearAllMeshInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearAllMeshInfo", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearAllMeshInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearAllMeshInfo", true), value);
}
public static event Delegates.ResetVertexLayout_WithArgs ResetVertexLayout
{
add => HookEndpointManager.Add<Delegates.ResetVertexLayout_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ResetVertexLayout", true), value);
remove => HookEndpointManager.Remove<Delegates.ResetVertexLayout_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ResetVertexLayout", true), value);
}
public static event Delegates.ClearUnusedVertices_WithArgs ClearUnusedVertices
{
add => HookEndpointManager.Add<Delegates.ClearUnusedVertices_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearUnusedVertices", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearUnusedVertices_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearUnusedVertices", true), value);
}
public static event Delegates.ClearLineInfo_WithArgs ClearLineInfo
{
add => HookEndpointManager.Add<Delegates.ClearLineInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearLineInfo", true), value);
remove => HookEndpointManager.Remove<Delegates.ClearLineInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "ClearLineInfo", true), value);
}
public static event Delegates.CopyMeshInfoVertexData_WithArgs CopyMeshInfoVertexData
{
add => HookEndpointManager.Add<Delegates.CopyMeshInfoVertexData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "CopyMeshInfoVertexData", true), value);
remove => HookEndpointManager.Remove<Delegates.CopyMeshInfoVertexData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_TextInfo), "CopyMeshInfoVertexData", true), value);
}
}
