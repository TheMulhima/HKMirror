...
private static void Update_float(On.CheckpointSprite.orig_Update_float orig,CheckpointSprite self,  float deltaTime)
{
...
public delegate void Update_float_WithArgs (Action<CheckpointSprite,  float> orig, CheckpointSprite self,  float deltaTime);
}
