...
public static class OnGUILayoutBeginAreaFollowObject
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject self)
        {
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject self)
        {
        ...
        internal static void HookDummyBeginArea()
        {
            if (!HookedList.Contains("DummyBeginArea"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject),
                        "DummyBeginArea", false), DummyBeginArea);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.DummyBeginArea_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject),
                    "DummyBeginArea", false), value);
            remove => HookEndpointManager.Remove<Delegates.DummyBeginArea_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutBeginAreaFollowObject),
                    "DummyBeginArea", false), value);
        }
    }
