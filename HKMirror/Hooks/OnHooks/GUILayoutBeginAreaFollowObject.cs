...
public static class OnGUILayoutBeginAreaFollowObject
{
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUILayoutBeginAreaFollowObject> orig,
            GUILayoutBeginAreaFollowObject self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GUILayoutBeginAreaFollowObject> orig,
            GUILayoutBeginAreaFollowObject self);
