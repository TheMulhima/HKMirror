...
public static class OnRazerServalWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RazerServalWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<RazerServalWindowsNativeProfile> orig, RazerServalWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerServalWindowsNativeProfile> orig,
            RazerServalWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public RazerServalWindowsNativeProfile self;
        }
    }
