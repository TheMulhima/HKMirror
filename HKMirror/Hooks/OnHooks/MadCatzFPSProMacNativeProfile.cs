...
public static class OnMadCatzFPSProMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzFPSProMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MadCatzFPSProMacNativeProfile> orig, MadCatzFPSProMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzFPSProMacNativeProfile> orig,
            MadCatzFPSProMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzFPSProMacNativeProfile self;
        }
    }
