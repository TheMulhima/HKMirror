...
public static class OnLogitechF710ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710ControllerMacNativeProfile> orig,
            LogitechF710ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710ControllerMacNativeProfile> orig,
            LogitechF710ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF710ControllerMacNativeProfile self;
        }
    }
