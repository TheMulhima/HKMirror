...
public static class OnLogitechF710ControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.LogitechF710ControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.LogitechF710ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechF710ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.LogitechF710ControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechF710ControllerMacNativeProfile self);
    }
