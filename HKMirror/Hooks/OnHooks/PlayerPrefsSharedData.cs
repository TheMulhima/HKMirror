...
public static class OnPlayerPrefsSharedData
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_IsEncrypted()
        {
            if (!HookedList.Contains("get_IsEncrypted"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayerPrefsSharedData), "get_IsEncrypted", true),
                    get_IsEncrypted);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_IsEncrypted_WithArgs(Func<PlayerPrefsSharedData, bool> orig,
            PlayerPrefsSharedData self);
        ...
        public delegate string ReadEncrypted_WithArgs(Func<PlayerPrefsSharedData, string, string> orig,
            PlayerPrefsSharedData self, string key);
        ...
        public delegate void WriteEncrypted_WithArgs(Action<PlayerPrefsSharedData, string, string> orig,
            PlayerPrefsSharedData self, string key, string val);
        ...
        public delegate bool HasKey_WithArgs(Func<PlayerPrefsSharedData, string, bool> orig, PlayerPrefsSharedData self,
            string key);
        ...
        public delegate void DeleteKey_WithArgs(Action<PlayerPrefsSharedData, string> orig, PlayerPrefsSharedData self,
            string key);
        ...
        public delegate bool GetBool_WithArgs(Func<PlayerPrefsSharedData, string, bool, bool> orig,
            PlayerPrefsSharedData self, string key, bool def);
        ...
        public delegate void SetBool_WithArgs(Action<PlayerPrefsSharedData, string, bool> orig,
            PlayerPrefsSharedData self, string key, bool val);
        ...
        public delegate int GetInt_WithArgs(Func<PlayerPrefsSharedData, string, int, int> orig,
            PlayerPrefsSharedData self, string key, int def);
        ...
        public delegate void SetInt_WithArgs(Action<PlayerPrefsSharedData, string, int> orig,
            PlayerPrefsSharedData self, string key, int val);
        ...
        public delegate float GetFloat_WithArgs(Func<PlayerPrefsSharedData, string, float, float> orig,
            PlayerPrefsSharedData self, string key, float def);
        ...
        public delegate void SetFloat_WithArgs(Action<PlayerPrefsSharedData, string, float> orig,
            PlayerPrefsSharedData self, string key, float val);
        ...
        public delegate string GetString_WithArgs(Func<PlayerPrefsSharedData, string, string, string> orig,
            PlayerPrefsSharedData self, string key, string def);
        ...
        public delegate void SetString_WithArgs(Action<PlayerPrefsSharedData, string, string> orig,
            PlayerPrefsSharedData self, string key, string val);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_IsEncrypted_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(PlayerPrefsSharedData), "get_IsEncrypted", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsEncrypted_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(PlayerPrefsSharedData), "get_IsEncrypted", true), value);
        }
