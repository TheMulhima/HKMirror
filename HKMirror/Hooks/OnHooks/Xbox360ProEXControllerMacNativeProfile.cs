...
public static class OnXbox360ProEXControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.Xbox360ProEXControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.Xbox360ProEXControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.Xbox360ProEXControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.Xbox360ProEXControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.Xbox360ProEXControllerMacNativeProfile self);
    }
