...
public static class OnMaterialReferenceManager
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_instance()
        {
            if (!HookedList.Contains("get_instance"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "get_instance", false),
                    get_instance);
            }
        }
        ...
        internal static void HookAddFontAsset()
        {
            if (!HookedList.Contains("AddFontAsset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontAsset", false),
                    AddFontAsset);
            }
        }
        ...
        internal static void HookAddFontAssetInternal()
        {
            if (!HookedList.Contains("AddFontAssetInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontAssetInternal",
                        true), AddFontAssetInternal);
            }
        }
        ...
        private static void AddFontAssetInternal(Action<TMPro.MaterialReferenceManager, TMPro.TMP_FontAsset> orig,
            TMPro.MaterialReferenceManager self, TMPro.TMP_FontAsset fontAsset)
        {
            ...
            {
                foreach (Delegates.AddFontAssetInternal_BeforeArgs toInvoke in _beforeAddFontAssetInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddFontAssetInternal_AfterArgs toInvoke in _afterAddFontAssetInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddSpriteAsset_TMP_SpriteAsset()
        {
            if (!HookedList.Contains("AddSpriteAsset_TMP_SpriteAsset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager),
                        "AddSpriteAsset_TMP_SpriteAsset", false), AddSpriteAsset_TMP_SpriteAsset);
            }
        }
        ...
        private static void AddSpriteAsset_TMP_SpriteAsset(Action<TMPro.TMP_SpriteAsset> orig,
            TMPro.TMP_SpriteAsset spriteAsset)
        {
            ...
            {
                foreach (Delegates.AddSpriteAsset_TMP_SpriteAsset_BeforeArgs toInvoke in
                         _beforeAddSpriteAsset_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddSpriteAsset_TMP_SpriteAsset_AfterArgs toInvoke in
                         _afterAddSpriteAsset_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddSpriteAssetInternal_TMP_SpriteAsset()
        {
            if (!HookedList.Contains("AddSpriteAssetInternal_TMP_SpriteAsset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager),
                        "AddSpriteAssetInternal_TMP_SpriteAsset", true), AddSpriteAssetInternal_TMP_SpriteAsset);
            }
        }
        ...
        internal static event Delegates.AddSpriteAssetInternal_TMP_SpriteAsset_AfterArgs
            _afterAddSpriteAssetInternal_TMP_SpriteAsset;

        private static void AddSpriteAssetInternal_TMP_SpriteAsset(
            Action<TMPro.MaterialReferenceManager, TMPro.TMP_SpriteAsset> orig, TMPro.MaterialReferenceManager self,
            TMPro.TMP_SpriteAsset spriteAsset)
        {
            ...
            {
                foreach (Delegates.AddSpriteAssetInternal_TMP_SpriteAsset_BeforeArgs toInvoke in
                         _beforeAddSpriteAssetInternal_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddSpriteAssetInternal_TMP_SpriteAsset_AfterArgs toInvoke in
                         _afterAddSpriteAssetInternal_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.AddSpriteAsset_int_TMP_SpriteAsset_AfterArgs
            _afterAddSpriteAsset_int_TMP_SpriteAsset;

        private static void AddSpriteAsset_int_TMP_SpriteAsset(Action<int, TMPro.TMP_SpriteAsset> orig, int hashCode,
            TMPro.TMP_SpriteAsset spriteAsset)
        {
            ...
            {
                foreach (Delegates.AddSpriteAsset_int_TMP_SpriteAsset_BeforeArgs toInvoke in
                         _beforeAddSpriteAsset_int_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddSpriteAsset_int_TMP_SpriteAsset_AfterArgs toInvoke in
                         _afterAddSpriteAsset_int_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddSpriteAssetInternal_int_TMP_SpriteAsset()
        {
            if (!HookedList.Contains("AddSpriteAssetInternal_int_TMP_SpriteAsset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager),
                        "AddSpriteAssetInternal_int_TMP_SpriteAsset", true),
        ...
        internal static event Delegates.AddSpriteAssetInternal_int_TMP_SpriteAsset_AfterArgs
            _afterAddSpriteAssetInternal_int_TMP_SpriteAsset;

        private static void AddSpriteAssetInternal_int_TMP_SpriteAsset(
            Action<TMPro.MaterialReferenceManager, int, TMPro.TMP_SpriteAsset> orig,
            TMPro.MaterialReferenceManager self, int hashCode, TMPro.TMP_SpriteAsset spriteAsset)
        {
            ...
            {
                foreach (Delegates.AddSpriteAssetInternal_int_TMP_SpriteAsset_BeforeArgs toInvoke in
                         _beforeAddSpriteAssetInternal_int_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddSpriteAssetInternal_int_TMP_SpriteAsset_AfterArgs toInvoke in
                         _afterAddSpriteAssetInternal_int_TMP_SpriteAsset.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookAddFontMaterial()
        {
            if (!HookedList.Contains("AddFontMaterial"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontMaterial", false),
                    AddFontMaterial);
            }
        }
        ...
        private static void AddFontMaterial(Action<int, UnityEngine.Material> orig, int hashCode,
        ...
        internal static void HookAddFontMaterialInternal()
        {
            if (!HookedList.Contains("AddFontMaterialInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontMaterialInternal",
                        true), AddFontMaterialInternal);
            }
        }
        ...
        private static void AddFontMaterialInternal(
            Action<TMPro.MaterialReferenceManager, int, UnityEngine.Material> orig, TMPro.MaterialReferenceManager self,
            int hashCode, UnityEngine.Material material)
        {
            ...
            {
                foreach (Delegates.AddFontMaterialInternal_BeforeArgs toInvoke in _beforeAddFontMaterialInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddFontMaterialInternal_AfterArgs toInvoke in _afterAddFontMaterialInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookContains_TMP_FontAsset()
        {
            if (!HookedList.Contains("Contains_TMP_FontAsset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "Contains_TMP_FontAsset",
                        true), Contains_TMP_FontAsset);
            }
        }
        ...
        private static bool Contains_TMP_FontAsset(Func<TMPro.MaterialReferenceManager, TMPro.TMP_FontAsset, bool> orig,
            TMPro.MaterialReferenceManager self, TMPro.TMP_FontAsset font)
        {
            ...
            {
                foreach (Delegates.Contains_TMP_FontAsset_BeforeArgs toInvoke in _beforeContains_TMP_FontAsset
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.Contains_TMP_FontAsset_AfterArgs toInvoke in _afterContains_TMP_FontAsset
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookContains_TMP_SpriteAsset()
        {
            if (!HookedList.Contains("Contains_TMP_SpriteAsset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "Contains_TMP_SpriteAsset",
                        true), Contains_TMP_SpriteAsset);
            }
        }
        ...
        private static bool Contains_TMP_SpriteAsset(
            Func<TMPro.MaterialReferenceManager, TMPro.TMP_SpriteAsset, bool> orig, TMPro.MaterialReferenceManager self,
            TMPro.TMP_SpriteAsset sprite)
        {
            ...
            {
                foreach (Delegates.Contains_TMP_SpriteAsset_BeforeArgs toInvoke in _beforeContains_TMP_SpriteAsset
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.Contains_TMP_SpriteAsset_AfterArgs toInvoke in _afterContains_TMP_SpriteAsset
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookTryGetFontAsset()
        {
            if (!HookedList.Contains("TryGetFontAsset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetFontAsset", false),
                    TryGetFontAsset);
            }
        }
        ...
        private static bool TryGetFontAsset(Func<int, TMPro.TMP_FontAsset, bool> orig, int hashCode,
        ...
        internal static void HookTryGetFontAssetInternal()
        {
            if (!HookedList.Contains("TryGetFontAssetInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetFontAssetInternal",
                        true), TryGetFontAssetInternal);
            }
        }
        ...
        private static bool TryGetFontAssetInternal(
            Func<TMPro.MaterialReferenceManager, int, TMPro.TMP_FontAsset, bool> orig,
            TMPro.MaterialReferenceManager self, int hashCode, TMPro.TMP_FontAsset fontAsset)
        {
            ...
            {
                foreach (Delegates.TryGetFontAssetInternal_BeforeArgs toInvoke in _beforeTryGetFontAssetInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.TryGetFontAssetInternal_AfterArgs toInvoke in _afterTryGetFontAssetInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookTryGetSpriteAsset()
        {
            if (!HookedList.Contains("TryGetSpriteAsset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetSpriteAsset", false),
                    TryGetSpriteAsset);
            }
        }
        ...
        private static bool TryGetSpriteAsset(Func<int, TMPro.TMP_SpriteAsset, bool> orig, int hashCode,
            TMPro.TMP_SpriteAsset spriteAsset)
        {
            ...
            {
                foreach (Delegates.TryGetSpriteAsset_BeforeArgs toInvoke in
                         _beforeTryGetSpriteAsset.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookTryGetSpriteAssetInternal()
        {
            if (!HookedList.Contains("TryGetSpriteAssetInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetSpriteAssetInternal",
                        true), TryGetSpriteAssetInternal);
            }
        }
        ...
        private static bool TryGetSpriteAssetInternal(
            Func<TMPro.MaterialReferenceManager, int, TMPro.TMP_SpriteAsset, bool> orig,
            TMPro.MaterialReferenceManager self, int hashCode, TMPro.TMP_SpriteAsset spriteAsset)
        {
            ...
            {
                foreach (Delegates.TryGetSpriteAssetInternal_BeforeArgs toInvoke in _beforeTryGetSpriteAssetInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.TryGetSpriteAssetInternal_AfterArgs toInvoke in _afterTryGetSpriteAssetInternal
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookTryGetMaterial()
        {
            if (!HookedList.Contains("TryGetMaterial"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetMaterial", false),
                    TryGetMaterial);
            }
        }
        ...
        private static bool TryGetMaterial(Func<int, UnityEngine.Material, bool> orig, int hashCode,
            UnityEngine.Material material)
        {
        ...
        internal static void HookTryGetMaterialInternal()
        {
            if (!HookedList.Contains("TryGetMaterialInternal"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetMaterialInternal",
                        true), TryGetMaterialInternal);
            }
        }
        ...
        private static bool TryGetMaterialInternal(
            Func<TMPro.MaterialReferenceManager, int, UnityEngine.Material, bool> orig,
            TMPro.MaterialReferenceManager self, int hashCode, UnityEngine.Material material)
        {
            ...
            {
                foreach (Delegates.TryGetMaterialInternal_BeforeArgs toInvoke in _beforeTryGetMaterialInternal
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.TryGetMaterialInternal_AfterArgs toInvoke in _afterTryGetMaterialInternal
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void AddFontAssetInternal_WithArgs(
            Action<TMPro.MaterialReferenceManager, TMPro.TMP_FontAsset> orig, TMPro.MaterialReferenceManager self,
            TMPro.TMP_FontAsset fontAsset);
        ...
        public delegate void AddSpriteAsset_TMP_SpriteAsset_WithArgs(Action<TMPro.TMP_SpriteAsset> orig,
            TMPro.TMP_SpriteAsset spriteAsset);
        ...
        public delegate void AddSpriteAssetInternal_TMP_SpriteAsset_AfterArgs(
            Params_AddSpriteAssetInternal_TMP_SpriteAsset args);

        public delegate void AddSpriteAssetInternal_TMP_SpriteAsset_WithArgs(
            Action<TMPro.MaterialReferenceManager, TMPro.TMP_SpriteAsset> orig, TMPro.MaterialReferenceManager self,
            TMPro.TMP_SpriteAsset spriteAsset);
        ...
        public delegate void AddSpriteAsset_int_TMP_SpriteAsset_AfterArgs(
            Params_AddSpriteAsset_int_TMP_SpriteAsset args);

        public delegate void AddSpriteAsset_int_TMP_SpriteAsset_WithArgs(Action<int, TMPro.TMP_SpriteAsset> orig,
            int hashCode, TMPro.TMP_SpriteAsset spriteAsset);
        ...
        public delegate void AddSpriteAssetInternal_int_TMP_SpriteAsset_AfterArgs(
            Params_AddSpriteAssetInternal_int_TMP_SpriteAsset args);

        public delegate void AddSpriteAssetInternal_int_TMP_SpriteAsset_WithArgs(
            Action<TMPro.MaterialReferenceManager, int, TMPro.TMP_SpriteAsset> orig,
            TMPro.MaterialReferenceManager self, int hashCode, TMPro.TMP_SpriteAsset spriteAsset);
        ...
        public delegate void AddFontMaterial_WithArgs(Action<int, UnityEngine.Material> orig, int hashCode,
            UnityEngine.Material material);
        ...
        public delegate void AddFontMaterialInternal_WithArgs(
            Action<TMPro.MaterialReferenceManager, int, UnityEngine.Material> orig, TMPro.MaterialReferenceManager self,
            int hashCode, UnityEngine.Material material);
        ...
        public delegate bool Contains_TMP_FontAsset_WithArgs(
            Func<TMPro.MaterialReferenceManager, TMPro.TMP_FontAsset, bool> orig, TMPro.MaterialReferenceManager self,
        ...
        public delegate bool Contains_TMP_SpriteAsset_WithArgs(
            Func<TMPro.MaterialReferenceManager, TMPro.TMP_SpriteAsset, bool> orig, TMPro.MaterialReferenceManager self,
            TMPro.TMP_SpriteAsset sprite);
        ...
        public delegate bool TryGetFontAsset_WithArgs(Func<int, TMPro.TMP_FontAsset, bool> orig, int hashCode,
            TMPro.TMP_FontAsset fontAsset);
        ...
        public delegate bool TryGetFontAssetInternal_WithArgs(
            Func<TMPro.MaterialReferenceManager, int, TMPro.TMP_FontAsset, bool> orig,
            TMPro.MaterialReferenceManager self, int hashCode, TMPro.TMP_FontAsset fontAsset);
        ...
        public delegate bool TryGetSpriteAsset_WithArgs(Func<int, TMPro.TMP_SpriteAsset, bool> orig, int hashCode,
            TMPro.TMP_SpriteAsset spriteAsset);
        ...
        public delegate bool TryGetSpriteAssetInternal_WithArgs(
            Func<TMPro.MaterialReferenceManager, int, TMPro.TMP_SpriteAsset, bool> orig,
            TMPro.MaterialReferenceManager self, int hashCode, TMPro.TMP_SpriteAsset spriteAsset);
        ...
        public delegate bool TryGetMaterial_WithArgs(Func<int, UnityEngine.Material, bool> orig, int hashCode,
            UnityEngine.Material material);
        ...
        public delegate bool TryGetMaterialInternal_WithArgs(
            Func<TMPro.MaterialReferenceManager, int, UnityEngine.Material, bool> orig,
            TMPro.MaterialReferenceManager self, int hashCode, UnityEngine.Material material);
    }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.AddSpriteAssetInternal_TMP_SpriteAsset_AfterArgs
            AddSpriteAssetInternal_TMP_SpriteAsset
            {
                add
                {
        ...
        public static event Delegates.AddSpriteAssetInternal_int_TMP_SpriteAsset_AfterArgs
            AddSpriteAssetInternal_int_TMP_SpriteAsset
            {
                add
                {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_instance_WithArgs get_instance
        {
            add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "get_instance", false), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.AddFontAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontAsset", false), value);
            remove => HookEndpointManager.Remove<Delegates.AddFontAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontAsset", false), value);
        }

        public static event Delegates.AddFontAssetInternal_WithArgs AddFontAssetInternal
        {
            add => HookEndpointManager.Add<Delegates.AddFontAssetInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontAssetInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.AddFontAssetInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontAssetInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.AddSpriteAsset_TMP_SpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAsset", false), value);
            remove => HookEndpointManager.Remove<Delegates.AddSpriteAsset_TMP_SpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAsset", false), value);
        }

        public static event Delegates.AddSpriteAssetInternal_TMP_SpriteAsset_WithArgs
            AddSpriteAssetInternal_TMP_SpriteAsset
            {
                add => HookEndpointManager.Add<Delegates.AddSpriteAssetInternal_TMP_SpriteAsset_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAssetInternal",
                        true), value);
                remove => HookEndpointManager.Remove<Delegates.AddSpriteAssetInternal_TMP_SpriteAsset_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAssetInternal",
                        true), value);
            }
        ...
        {
            add => HookEndpointManager.Add<Delegates.AddSpriteAsset_int_TMP_SpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAsset", false), value);
            remove => HookEndpointManager.Remove<Delegates.AddSpriteAsset_int_TMP_SpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAsset", false), value);
        }

        public static event Delegates.AddSpriteAssetInternal_int_TMP_SpriteAsset_WithArgs
            AddSpriteAssetInternal_int_TMP_SpriteAsset
            {
                add => HookEndpointManager.Add<Delegates.AddSpriteAssetInternal_int_TMP_SpriteAsset_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAssetInternal",
                        true), value);
                remove => HookEndpointManager.Remove<Delegates.AddSpriteAssetInternal_int_TMP_SpriteAsset_WithArgs>(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddSpriteAssetInternal",
                        true), value);
            }
        ...
        {
            add => HookEndpointManager.Add<Delegates.AddFontMaterial_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontMaterial", false),
                value);
            remove => HookEndpointManager.Remove<Delegates.AddFontMaterial_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontMaterial", false),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.AddFontMaterialInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontMaterialInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.AddFontMaterialInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "AddFontMaterialInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.Contains_TMP_FontAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "Contains", true), value);
            remove => HookEndpointManager.Remove<Delegates.Contains_TMP_FontAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "Contains", true), value);
        }

        public static event Delegates.Contains_TMP_SpriteAsset_WithArgs Contains_TMP_SpriteAsset
        {
            add => HookEndpointManager.Add<Delegates.Contains_TMP_SpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "Contains", true), value);
            remove => HookEndpointManager.Remove<Delegates.Contains_TMP_SpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "Contains", true), value);
        }

        public static event Delegates.TryGetFontAsset_WithArgs TryGetFontAsset
        {
            add => HookEndpointManager.Add<Delegates.TryGetFontAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetFontAsset", false),
                value);
            remove => HookEndpointManager.Remove<Delegates.TryGetFontAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetFontAsset", false),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.TryGetFontAssetInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetFontAssetInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.TryGetFontAssetInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetFontAssetInternal", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.TryGetSpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetSpriteAsset", false),
                value);
            remove => HookEndpointManager.Remove<Delegates.TryGetSpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetSpriteAsset", false),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.TryGetSpriteAssetInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetSpriteAssetInternal",
                    true), value);
            remove => HookEndpointManager.Remove<Delegates.TryGetSpriteAssetInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetSpriteAssetInternal",
                    true), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.TryGetMaterial_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetMaterial", false), value);
            remove => HookEndpointManager.Remove<Delegates.TryGetMaterial_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetMaterial", false), value);
        }

        public static event Delegates.TryGetMaterialInternal_WithArgs TryGetMaterialInternal
        {
            add => HookEndpointManager.Add<Delegates.TryGetMaterialInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetMaterialInternal", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.TryGetMaterialInternal_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.MaterialReferenceManager), "TryGetMaterialInternal", true),
                value);
        }
    }
