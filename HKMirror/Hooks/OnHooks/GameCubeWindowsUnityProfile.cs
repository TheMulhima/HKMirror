...
public static class OnGameCubeWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameCubeWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameCubeWindowsUnityProfile> orig, GameCubeWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameCubeWindowsUnityProfile> orig,
            GameCubeWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public GameCubeWindowsUnityProfile self;
        }
    }
