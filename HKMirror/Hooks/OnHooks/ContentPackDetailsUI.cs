...
public static class OnContentPackDetailsUI
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator UpdateDelayed_AfterArgs(Params_UpdateDelayed args, IEnumerator ret);

        public delegate void UpdateDelayed_BeforeArgs(Params_UpdateDelayed args);

        public delegate IEnumerator UpdateDelayed_WithArgs(Func<ContentPackDetailsUI, IEnumerator> orig,
            ContentPackDetailsUI self);
