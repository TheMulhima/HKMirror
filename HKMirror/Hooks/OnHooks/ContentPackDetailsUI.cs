...
private static void ShowPackDetails(On.ContentPackDetailsUI.orig_ShowPackDetails orig,ContentPackDetailsUI self,  int index)
{
...
private static System.Collections.IEnumerator UpdateDelayed(On.ContentPackDetailsUI.orig_UpdateDelayed orig,ContentPackDetailsUI self)
{
...
public delegate void ShowPackDetails_WithArgs (Action<ContentPackDetailsUI,  int> orig, ContentPackDetailsUI self,  int index);
...
public delegate System.Collections.IEnumerator UpdateDelayed_AfterArgs(Params_UpdateDelayed args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator UpdateDelayed_WithArgs (Func<ContentPackDetailsUI, System.Collections.IEnumerator> orig, ContentPackDetailsUI self);
