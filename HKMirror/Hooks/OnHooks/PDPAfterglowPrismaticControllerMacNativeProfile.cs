...
public static class OnPDPAfterglowPrismaticControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(PDPAfterglowPrismaticControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PDPAfterglowPrismaticControllerMacNativeProfile> orig,
            PDPAfterglowPrismaticControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PDPAfterglowPrismaticControllerMacNativeProfile> orig,
            PDPAfterglowPrismaticControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PDPAfterglowPrismaticControllerMacNativeProfile self;
        }
    }
