...
public static class OnPDPAfterglowPrismaticControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.PDPAfterglowPrismaticControllerMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.PDPAfterglowPrismaticControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.PDPAfterglowPrismaticControllerMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.PDPAfterglowPrismaticControllerMacNativeProfile), "Define",
                    true), value);
