...
public static class OnHarmonixGuitarMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HarmonixGuitarMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HarmonixGuitarMacNativeProfile> orig, HarmonixGuitarMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HarmonixGuitarMacNativeProfile> orig,
            HarmonixGuitarMacNativeProfile self);

        public sealed class Params_Define
        {
            public HarmonixGuitarMacNativeProfile self;
        }
    }
