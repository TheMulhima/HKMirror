...
public static class OnHoriRealArcadeProVHayabusaMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriRealArcadeProVHayabusaMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriRealArcadeProVHayabusaMacNativeProfile> orig,
            HoriRealArcadeProVHayabusaMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriRealArcadeProVHayabusaMacNativeProfile> orig,
            HoriRealArcadeProVHayabusaMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriRealArcadeProVHayabusaMacNativeProfile self;
        }
    }
