...
public static class OnHoriBlueSoloControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriBlueSoloControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriBlueSoloControllerMacNativeProfile> orig,
            HoriBlueSoloControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriBlueSoloControllerMacNativeProfile> orig,
            HoriBlueSoloControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriBlueSoloControllerMacNativeProfile self;
        }
    }
