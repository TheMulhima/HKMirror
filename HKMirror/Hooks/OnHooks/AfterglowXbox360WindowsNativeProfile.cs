...
public static class OnAfterglowXbox360WindowsNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.AfterglowXbox360WindowsNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.AfterglowXbox360WindowsNativeProfile> orig,
            InControl.NativeDeviceProfiles.AfterglowXbox360WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.AfterglowXbox360WindowsNativeProfile> orig,
            InControl.NativeDeviceProfiles.AfterglowXbox360WindowsNativeProfile self);
    }
