...
public static class OnAfterglowXbox360WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AfterglowXbox360WindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<AfterglowXbox360WindowsNativeProfile> orig,
            AfterglowXbox360WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AfterglowXbox360WindowsNativeProfile> orig,
            AfterglowXbox360WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public AfterglowXbox360WindowsNativeProfile self;
        }
    }
