...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile), "Define", true), Define);
...
private static void Define(Action<InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile> orig, InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile self)
{
...
{
public InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile self;
}
public delegate void Define_BeforeArgs(Params_Define args);
public delegate void Define_AfterArgs(Params_Define args);
public delegate void Define_WithArgs (Action<InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile> orig, InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile self);
}
...
{
add => HookEndpointManager.Add<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile), "Define", true), value);
remove => HookEndpointManager.Remove<Delegates.Define_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.EightBitdoSFC30AndroidUnityProfile), "Define", true), value);
}
}
