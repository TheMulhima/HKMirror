...
public static class OnHashTableRemove
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableRemove), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HashTableRemove> orig,
            HutongGames.PlayMaker.Actions.HashTableRemove self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableRemove), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HashTableRemove> orig,
            HutongGames.PlayMaker.Actions.HashTableRemove self)
        {
        ...
        internal static void HookdoHashTableRemove()
        {
            if (!HookedList.Contains("doHashTableRemove"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableRemove),
                        "doHashTableRemove", true), doHashTableRemove);
            }
        }
        ...
        private static void doHashTableRemove(Action<HutongGames.PlayMaker.Actions.HashTableRemove> orig,
            HutongGames.PlayMaker.Actions.HashTableRemove self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableRemove> orig,
            HutongGames.PlayMaker.Actions.HashTableRemove self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableRemove> orig,
            HutongGames.PlayMaker.Actions.HashTableRemove self);
        ...
        public delegate void doHashTableRemove_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableRemove> orig,
            HutongGames.PlayMaker.Actions.HashTableRemove self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableRemove), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableRemove), "OnEnter", true),
                value);
