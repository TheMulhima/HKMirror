...
public static class OnLogitechF310ModeXWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310ModeXWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310ModeXWindowsNativeProfile> orig,
            LogitechF310ModeXWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310ModeXWindowsNativeProfile> orig,
            LogitechF310ModeXWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF310ModeXWindowsNativeProfile self;
        }
    }
