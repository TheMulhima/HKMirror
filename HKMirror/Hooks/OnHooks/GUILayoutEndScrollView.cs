...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutEndScrollView), "OnGUI", true), OnGUI);

}
}
internal static event Delegates.OnGUI_BeforeArgs _beforeOnGUI;
internal static event Delegates.OnGUI_AfterArgs _afterOnGUI;
private static void OnGUI(Action<HutongGames.PlayMaker.Actions.GUILayoutEndScrollView> orig, HutongGames.PlayMaker.Actions.GUILayoutEndScrollView self)
{
...
public delegate void OnGUI_WithArgs (Action<HutongGames.PlayMaker.Actions.GUILayoutEndScrollView> orig, HutongGames.PlayMaker.Actions.GUILayoutEndScrollView self);
}
...
{
add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutEndScrollView), "OnGUI", true), value);
remove => HookEndpointManager.Remove<Delegates.OnGUI_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutEndScrollView), "OnGUI", true), value);
}
}
