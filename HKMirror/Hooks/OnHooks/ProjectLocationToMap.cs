...
public static class OnProjectLocationToMap
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self)
        {
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self)
        {
        ...
        internal static void HookDoProjectGPSLocation()
        {
            if (!HookedList.Contains("DoProjectGPSLocation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                        "DoProjectGPSLocation", true), DoProjectGPSLocation);
            }
        }
        ...
        private static void DoProjectGPSLocation(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self)
        {
        ...
        internal static void HookDoEquidistantCylindrical()
        {
            if (!HookedList.Contains("DoEquidistantCylindrical"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                        "DoEquidistantCylindrical", true), DoEquidistantCylindrical);
            }
        }
        ...
        private static void DoEquidistantCylindrical(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self)
        {
        ...
        internal static void HookDoMercatorProjection()
        {
            if (!HookedList.Contains("DoMercatorProjection"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                        "DoMercatorProjection", true), DoMercatorProjection);
            }
        }
        ...
        private static void DoMercatorProjection(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self)
        {
        ...
        internal static void HookLatitudeToMercator()
        {
            if (!HookedList.Contains("LatitudeToMercator"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                        "LatitudeToMercator", false), LatitudeToMercator);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self);
        ...
        public delegate void DoProjectGPSLocation_WithArgs(
            Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self);
        ...
        public delegate void DoEquidistantCylindrical_WithArgs(
            Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self);
        ...
        public delegate void DoMercatorProjection_WithArgs(
            Action<HutongGames.PlayMaker.Actions.ProjectLocationToMap> orig,
            HutongGames.PlayMaker.Actions.ProjectLocationToMap self);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap), "OnEnter",
                    true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap), "OnUpdate",
                    true), value);
        ...
        public static event Delegates.DoProjectGPSLocation_WithArgs DoProjectGPSLocation
        {
            add => HookEndpointManager.Add<Delegates.DoProjectGPSLocation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                    "DoProjectGPSLocation", true), value);
        ...
        public static event Delegates.DoEquidistantCylindrical_WithArgs DoEquidistantCylindrical
        {
            add => HookEndpointManager.Add<Delegates.DoEquidistantCylindrical_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                    "DoEquidistantCylindrical", true), value);
        ...
        public static event Delegates.DoMercatorProjection_WithArgs DoMercatorProjection
        {
            add => HookEndpointManager.Add<Delegates.DoMercatorProjection_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                    "DoMercatorProjection", true), value);
        ...
        public static event Delegates.LatitudeToMercator_WithArgs LatitudeToMercator
        {
            add => HookEndpointManager.Add<Delegates.LatitudeToMercator_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ProjectLocationToMap),
                    "LatitudeToMercator", false), value);
