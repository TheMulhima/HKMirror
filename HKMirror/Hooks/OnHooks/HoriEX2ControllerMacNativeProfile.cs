...
public static class OnHoriEX2ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriEX2ControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HoriEX2ControllerMacNativeProfile> orig,
            HoriEX2ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriEX2ControllerMacNativeProfile> orig,
            HoriEX2ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriEX2ControllerMacNativeProfile self;
        }
    }
