...
private static void LevelActivated(On.GeoRock.orig_LevelActivated orig,GeoRock self,  UnityEngine.SceneManagement.Scene sceneFrom,  UnityEngine.SceneManagement.Scene sceneTo)
{
...
{
foreach (Delegates.UpdateHitsLeftFromFSM_BeforeArgs toInvoke in _beforeUpdateHitsLeftFromFSM.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateHitsLeftFromFSM_AfterArgs toInvoke in _afterUpdateHitsLeftFromFSM.GetInvocationList())
{
try
{
...
public delegate void LevelActivated_WithArgs (Action<GeoRock,  UnityEngine.SceneManagement.Scene,  UnityEngine.SceneManagement.Scene> orig, GeoRock self,  UnityEngine.SceneManagement.Scene sceneFrom,  UnityEngine.SceneManagement.Scene sceneTo);
