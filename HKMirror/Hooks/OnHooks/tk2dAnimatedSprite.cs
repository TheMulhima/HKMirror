...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Animator", true), get_Animator);
...
private static tk2dSpriteAnimator get_Animator(Func<tk2dAnimatedSprite, tk2dSpriteAnimator> orig, tk2dAnimatedSprite self)
{
...
private static void CheckAddAnimatorInternal(On.tk2dAnimatedSprite.orig_CheckAddAnimatorInternal orig,tk2dAnimatedSprite self)
{
...
{
foreach (Delegates.CheckAddAnimatorInternal_BeforeArgs toInvoke in _beforeCheckAddAnimatorInternal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckAddAnimatorInternal_AfterArgs toInvoke in _afterCheckAddAnimatorInternal.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Library", true), get_Library);
...
private static tk2dSpriteAnimation get_Library(Func<tk2dAnimatedSprite, tk2dSpriteAnimation> orig, tk2dAnimatedSprite self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_Library", true), set_Library);
...
private static void set_Library(Action<tk2dAnimatedSprite,  tk2dSpriteAnimation> orig, tk2dAnimatedSprite self,  tk2dSpriteAnimation value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_DefaultClipId", true), get_DefaultClipId);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_DefaultClipId", true), set_DefaultClipId);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_g_paused", false), get_g_paused);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_g_paused", false), set_g_paused);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Paused", true), get_Paused);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_Paused", true), set_Paused);
...
private static void ProxyCompletedHandler(On.tk2dAnimatedSprite.orig_ProxyCompletedHandler orig,tk2dAnimatedSprite self,  tk2dSpriteAnimator anim,  tk2dSpriteAnimationClip clip)
{
...
{
foreach (Delegates.ProxyCompletedHandler_BeforeArgs toInvoke in _beforeProxyCompletedHandler.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ProxyCompletedHandler_AfterArgs toInvoke in _afterProxyCompletedHandler.GetInvocationList())
{
try
{
...
private static void ProxyEventTriggeredHandler(On.tk2dAnimatedSprite.orig_ProxyEventTriggeredHandler orig,tk2dAnimatedSprite self,  tk2dSpriteAnimator anim,  tk2dSpriteAnimationClip clip,  int frame)
{
...
{
foreach (Delegates.ProxyEventTriggeredHandler_BeforeArgs toInvoke in _beforeProxyEventTriggeredHandler.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ProxyEventTriggeredHandler_AfterArgs toInvoke in _afterProxyEventTriggeredHandler.GetInvocationList())
{
try
{
...
private static tk2dAnimatedSprite AddComponent(On.tk2dAnimatedSprite.orig_AddComponent orig, UnityEngine.GameObject go,  tk2dSpriteAnimation anim,  int clipId)
{
...
private static void Play_float(On.tk2dAnimatedSprite.orig_Play_float orig,tk2dAnimatedSprite self,  float clipStartTime)
{
...
private static void PlayFromFrame_int(On.tk2dAnimatedSprite.orig_PlayFromFrame_int orig,tk2dAnimatedSprite self,  int frame)
{
...
private static void Play_string(On.tk2dAnimatedSprite.orig_Play_string orig,tk2dAnimatedSprite self,  string name)
{
...
private static void PlayFromFrame_string_int(On.tk2dAnimatedSprite.orig_PlayFromFrame_string_int orig,tk2dAnimatedSprite self,  string name,  int frame)
{
...
private static void Play_string_float(On.tk2dAnimatedSprite.orig_Play_string_float orig,tk2dAnimatedSprite self,  string name,  float clipStartTime)
{
...
{
foreach (Delegates.Play_string_float_BeforeArgs toInvoke in _beforePlay_string_float.GetInvocationList())
{
try
{
...
internal static event Delegates.Play_tk2dSpriteAnimationClip_float_BeforeArgs _beforePlay_tk2dSpriteAnimationClip_float;
internal static event Delegates.Play_tk2dSpriteAnimationClip_float_AfterArgs _afterPlay_tk2dSpriteAnimationClip_float;
private static void Play_tk2dSpriteAnimationClip_float(On.tk2dAnimatedSprite.orig_Play_tk2dSpriteAnimationClip_float orig,tk2dAnimatedSprite self,  tk2dSpriteAnimationClip clip,  float clipStartTime)
{
...
{
foreach (Delegates.Play_tk2dSpriteAnimationClip_float_BeforeArgs toInvoke in _beforePlay_tk2dSpriteAnimationClip_float.GetInvocationList())
{
try
{
...
{
foreach (Delegates.Play_tk2dSpriteAnimationClip_float_AfterArgs toInvoke in _afterPlay_tk2dSpriteAnimationClip_float.GetInvocationList())
{
try
{
...
On.tk2dAnimatedSprite.Play_tk2dSpriteAnimationClip_float_float += Play_tk2dSpriteAnimationClip_float_float;
...
private static void Play_tk2dSpriteAnimationClip_float_float(On.tk2dAnimatedSprite.orig_Play_tk2dSpriteAnimationClip_float_float orig,tk2dAnimatedSprite self,  tk2dSpriteAnimationClip clip,  float clipStartTime,  float overrideFps)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_CurrentClip", true), get_CurrentClip);
...
private static tk2dSpriteAnimationClip get_CurrentClip(Func<tk2dAnimatedSprite, tk2dSpriteAnimationClip> orig, tk2dAnimatedSprite self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_ClipTimeSeconds", true), get_ClipTimeSeconds);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_ClipFps", true), get_ClipFps);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_ClipFps", true), set_ClipFps);
...
private static void StopAndResetFrame(On.tk2dAnimatedSprite.orig_StopAndResetFrame orig,tk2dAnimatedSprite self)
{
...
private static bool IsPlaying_string(On.tk2dAnimatedSprite.orig_IsPlaying_string orig,tk2dAnimatedSprite self,  string name)
{
...
private static bool IsPlaying_tk2dSpriteAnimationClip(On.tk2dAnimatedSprite.orig_IsPlaying_tk2dSpriteAnimationClip orig,tk2dAnimatedSprite self,  tk2dSpriteAnimationClip clip)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Playing", true), get_Playing);
...
private static int GetClipIdByName(On.tk2dAnimatedSprite.orig_GetClipIdByName orig,tk2dAnimatedSprite self,  string name)
{
...
private static tk2dSpriteAnimationClip GetClipByName(On.tk2dAnimatedSprite.orig_GetClipByName orig,tk2dAnimatedSprite self,  string name)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_DefaultFps", false), get_DefaultFps);
...
private static void SetFrame_int(On.tk2dAnimatedSprite.orig_SetFrame_int orig,tk2dAnimatedSprite self,  int currFrame)
{
...
private static void SetFrame_int_bool(On.tk2dAnimatedSprite.orig_SetFrame_int_bool orig,tk2dAnimatedSprite self,  int currFrame,  bool triggerEvent)
{
...
private static void UpdateAnimation(On.tk2dAnimatedSprite.orig_UpdateAnimation orig,tk2dAnimatedSprite self,  float deltaTime)
{
...
public delegate tk2dSpriteAnimator get_Animator_WithArgs (Func<tk2dAnimatedSprite, tk2dSpriteAnimator> orig, tk2dAnimatedSprite self);
...
public delegate void CheckAddAnimatorInternal_WithArgs (Action<tk2dAnimatedSprite> orig, tk2dAnimatedSprite self);
...
public delegate tk2dSpriteAnimation get_Library_WithArgs (Func<tk2dAnimatedSprite, tk2dSpriteAnimation> orig, tk2dAnimatedSprite self);
...
public delegate void set_Library_WithArgs (Action<tk2dAnimatedSprite,  tk2dSpriteAnimation> orig, tk2dAnimatedSprite self,  tk2dSpriteAnimation value);
...
public delegate void set_DefaultClipId_WithArgs (Action<tk2dAnimatedSprite,  int> orig, tk2dAnimatedSprite self,  int value);
...
public delegate void set_Paused_WithArgs (Action<tk2dAnimatedSprite,  bool> orig, tk2dAnimatedSprite self,  bool value);
...
public delegate void ProxyCompletedHandler_WithArgs (Action<tk2dAnimatedSprite,  tk2dSpriteAnimator,  tk2dSpriteAnimationClip> orig, tk2dAnimatedSprite self,  tk2dSpriteAnimator anim,  tk2dSpriteAnimationClip clip);
...
public delegate void ProxyEventTriggeredHandler_WithArgs (Action<tk2dAnimatedSprite,  tk2dSpriteAnimator,  tk2dSpriteAnimationClip,  int> orig, tk2dAnimatedSprite self,  tk2dSpriteAnimator anim,  tk2dSpriteAnimationClip clip,  int frame);
...
public delegate tk2dAnimatedSprite AddComponent_WithArgs (Func< UnityEngine.GameObject,  tk2dSpriteAnimation,  int, tk2dAnimatedSprite> orig,  UnityEngine.GameObject go,  tk2dSpriteAnimation anim,  int clipId);
...
public delegate void Play_float_WithArgs (Action<tk2dAnimatedSprite,  float> orig, tk2dAnimatedSprite self,  float clipStartTime);
...
public delegate void PlayFromFrame_int_WithArgs (Action<tk2dAnimatedSprite,  int> orig, tk2dAnimatedSprite self,  int frame);
...
public delegate void Play_string_WithArgs (Action<tk2dAnimatedSprite,  string> orig, tk2dAnimatedSprite self,  string name);
...
public delegate void PlayFromFrame_string_int_WithArgs (Action<tk2dAnimatedSprite,  string,  int> orig, tk2dAnimatedSprite self,  string name,  int frame);
...
public delegate void Play_string_float_WithArgs (Action<tk2dAnimatedSprite,  string,  float> orig, tk2dAnimatedSprite self,  string name,  float clipStartTime);
...
public delegate void Play_tk2dSpriteAnimationClip_float_BeforeArgs(Params_Play_tk2dSpriteAnimationClip_float args);
public delegate void Play_tk2dSpriteAnimationClip_float_AfterArgs(Params_Play_tk2dSpriteAnimationClip_float args);
public delegate void Play_tk2dSpriteAnimationClip_float_WithArgs (Action<tk2dAnimatedSprite,  tk2dSpriteAnimationClip,  float> orig, tk2dAnimatedSprite self,  tk2dSpriteAnimationClip clip,  float clipStartTime);
...
public delegate void Play_tk2dSpriteAnimationClip_float_float_WithArgs (Action<tk2dAnimatedSprite,  tk2dSpriteAnimationClip,  float,  float> orig, tk2dAnimatedSprite self,  tk2dSpriteAnimationClip clip,  float clipStartTime,  float overrideFps);
...
public delegate tk2dSpriteAnimationClip get_CurrentClip_WithArgs (Func<tk2dAnimatedSprite, tk2dSpriteAnimationClip> orig, tk2dAnimatedSprite self);
...
public delegate float get_ClipTimeSeconds_WithArgs (Func<tk2dAnimatedSprite, float> orig, tk2dAnimatedSprite self);
...
public delegate void set_ClipFps_WithArgs (Action<tk2dAnimatedSprite,  float> orig, tk2dAnimatedSprite self,  float value);
...
public delegate bool IsPlaying_string_WithArgs (Func<tk2dAnimatedSprite,  string, bool> orig, tk2dAnimatedSprite self,  string name);
...
public delegate bool IsPlaying_tk2dSpriteAnimationClip_WithArgs (Func<tk2dAnimatedSprite,  tk2dSpriteAnimationClip, bool> orig, tk2dAnimatedSprite self,  tk2dSpriteAnimationClip clip);
...
public delegate int GetClipIdByName_WithArgs (Func<tk2dAnimatedSprite,  string, int> orig, tk2dAnimatedSprite self,  string name);
...
public delegate tk2dSpriteAnimationClip GetClipByName_WithArgs (Func<tk2dAnimatedSprite,  string, tk2dSpriteAnimationClip> orig, tk2dAnimatedSprite self,  string name);
...
public delegate void SetFrame_int_WithArgs (Action<tk2dAnimatedSprite,  int> orig, tk2dAnimatedSprite self,  int currFrame);
...
public delegate void SetFrame_int_bool_WithArgs (Action<tk2dAnimatedSprite,  int,  bool> orig, tk2dAnimatedSprite self,  int currFrame,  bool triggerEvent);
...
public delegate void UpdateAnimation_WithArgs (Action<tk2dAnimatedSprite,  float> orig, tk2dAnimatedSprite self,  float deltaTime);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Animator_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Animator", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Animator_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Animator", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Library_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Library", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Library_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Library", true), value);
}
public static event Delegates.set_Library_WithArgs set_Library
{
add => HookEndpointManager.Add<Delegates.set_Library_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_Library", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Library_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_Library", true), value);
}
public static event Delegates.get_DefaultClipId_WithArgs get_DefaultClipId
{
add => HookEndpointManager.Add<Delegates.get_DefaultClipId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_DefaultClipId", true), value);
remove => HookEndpointManager.Remove<Delegates.get_DefaultClipId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_DefaultClipId", true), value);
}
public static event Delegates.set_DefaultClipId_WithArgs set_DefaultClipId
{
add => HookEndpointManager.Add<Delegates.set_DefaultClipId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_DefaultClipId", true), value);
remove => HookEndpointManager.Remove<Delegates.set_DefaultClipId_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_DefaultClipId", true), value);
}
public static event Delegates.get_g_paused_WithArgs get_g_paused
{
add => HookEndpointManager.Add<Delegates.get_g_paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_g_paused", false), value);
remove => HookEndpointManager.Remove<Delegates.get_g_paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_g_paused", false), value);
}
public static event Delegates.set_g_paused_WithArgs set_g_paused
{
add => HookEndpointManager.Add<Delegates.set_g_paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_g_paused", false), value);
remove => HookEndpointManager.Remove<Delegates.set_g_paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_g_paused", false), value);
}
public static event Delegates.get_Paused_WithArgs get_Paused
{
add => HookEndpointManager.Add<Delegates.get_Paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Paused", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Paused", true), value);
}
public static event Delegates.set_Paused_WithArgs set_Paused
{
add => HookEndpointManager.Add<Delegates.set_Paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_Paused", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Paused_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_Paused", true), value);
}
...
public static event On.tk2dAnimatedSprite.hook_Play_tk2dSpriteAnimationClip_float Play_tk2dSpriteAnimationClip_float
{
...
public static event On.tk2dAnimatedSprite.hook_Play_tk2dSpriteAnimationClip_float_float Play_tk2dSpriteAnimationClip_float_float
{
...
{
add => HookEndpointManager.Add<Delegates.get_CurrentClip_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_CurrentClip", true), value);
remove => HookEndpointManager.Remove<Delegates.get_CurrentClip_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_CurrentClip", true), value);
}
public static event Delegates.get_ClipTimeSeconds_WithArgs get_ClipTimeSeconds
{
add => HookEndpointManager.Add<Delegates.get_ClipTimeSeconds_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_ClipTimeSeconds", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ClipTimeSeconds_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_ClipTimeSeconds", true), value);
}
public static event Delegates.get_ClipFps_WithArgs get_ClipFps
{
add => HookEndpointManager.Add<Delegates.get_ClipFps_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_ClipFps", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ClipFps_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_ClipFps", true), value);
}
public static event Delegates.set_ClipFps_WithArgs set_ClipFps
{
add => HookEndpointManager.Add<Delegates.set_ClipFps_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_ClipFps", true), value);
remove => HookEndpointManager.Remove<Delegates.set_ClipFps_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "set_ClipFps", true), value);
}
...
public static event On.tk2dAnimatedSprite.hook_IsPlaying_tk2dSpriteAnimationClip IsPlaying_tk2dSpriteAnimationClip
{
...
{
add => HookEndpointManager.Add<Delegates.get_Playing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Playing", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Playing_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_Playing", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_DefaultFps_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_DefaultFps", false), value);
remove => HookEndpointManager.Remove<Delegates.get_DefaultFps_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dAnimatedSprite), "get_DefaultFps", false), value);
}
