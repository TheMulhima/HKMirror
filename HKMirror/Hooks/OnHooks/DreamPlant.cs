...
public static class OnDreamPlant
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator CheckOrbs_AfterArgs(Params_CheckOrbs args, IEnumerator ret);

        public delegate void CheckOrbs_BeforeArgs(Params_CheckOrbs args);

        public delegate IEnumerator CheckOrbs_WithArgs(Func<DreamPlant, IEnumerator> orig, DreamPlant self);

        public delegate void OnTriggerEnter2D_AfterArgs(Params_OnTriggerEnter2D args);

        public delegate void OnTriggerEnter2D_BeforeArgs(Params_OnTriggerEnter2D args);

        public delegate void OnTriggerEnter2D_WithArgs(Action<DreamPlant, Collider2D> orig, DreamPlant self,
            Collider2D collision);
