...
public static class OnCameraController
{
    internal static class HookHandler
    {
            ...
            CameraController self, bool isGameplayLevel, bool isBloomForced)
        {
            ...
            if (_beforeApplyEffectConfiguration != null)
                foreach (Delegates.ApplyEffectConfiguration_BeforeArgs toInvoke in _beforeApplyEffectConfiguration
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterApplyEffectConfiguration != null)
                foreach (Delegates.ApplyEffectConfiguration_AfterArgs toInvoke in _afterApplyEffectConfiguration
                             .GetInvocationList())
                    try
                    {
        ...
        private static void FadeOut(On.CameraController.orig_FadeOut orig, CameraController self, CameraFadeType type)
        {
            ...
            CameraController self)
        {
            ...
            if (_beforeUpdateTargetDestinationDelta != null)
                foreach (Delegates.UpdateTargetDestinationDelta_BeforeArgs toInvoke in
                         _beforeUpdateTargetDestinationDelta.GetInvocationList())
                    try
                    {
            ...
            if (_afterUpdateTargetDestinationDelta != null)
                foreach (Delegates.UpdateTargetDestinationDelta_AfterArgs toInvoke in _afterUpdateTargetDestinationDelta
                             .GetInvocationList())
                    try
                    {
        ...
        internal static void HookSetMode()
        {
            if (!HookedList.Contains("SetMode"))
            {
                HookedList.Add("SetMode");
                On.CameraController.SetMode += SetMode;
            }
        }

        internal static event Delegates.SetMode_BeforeArgs _beforeSetMode;
        internal static event Delegates.SetMode_AfterArgs _afterSetMode;

        private static void SetMode(On.CameraController.orig_SetMode orig, CameraController self,
            CameraController.CameraMode newMode)
        {
            Delegates.Params_SetMode @params = new()
            {
                self = self, newMode = newMode
            };
            if (_beforeSetMode != null)
                foreach (Delegates.SetMode_BeforeArgs toInvoke in _beforeSetMode.GetInvocationList())
                    try
                    {
                        _beforeSetMode?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            orig(self, newMode);
            if (_afterSetMode != null)
                foreach (Delegates.SetMode_AfterArgs toInvoke in _afterSetMode.GetInvocationList())
                    try
                    {
                        _afterSetMode.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        private static Vector3 KeepWithinSceneBounds_Vector3(
            On.CameraController.orig_KeepWithinSceneBounds_Vector3 orig, CameraController self, Vector3 targetDest)
        {
            ...
            if (_beforeKeepWithinSceneBounds_Vector3 != null)
                foreach (Delegates.KeepWithinSceneBounds_Vector3_BeforeArgs toInvoke in
                         _beforeKeepWithinSceneBounds_Vector3.GetInvocationList())
                    try
                    {
            ...
            if (_afterKeepWithinSceneBounds_Vector3 != null)
                foreach (Delegates.KeepWithinSceneBounds_Vector3_AfterArgs toInvoke in
                         _afterKeepWithinSceneBounds_Vector3.GetInvocationList())
                    try
                    {
        ...
        private static Vector2 KeepWithinSceneBounds_Vector2(
            On.CameraController.orig_KeepWithinSceneBounds_Vector2 orig, CameraController self, Vector2 targetDest)
        {
            ...
            if (_beforeKeepWithinSceneBounds_Vector2 != null)
                foreach (Delegates.KeepWithinSceneBounds_Vector2_BeforeArgs toInvoke in
                         _beforeKeepWithinSceneBounds_Vector2.GetInvocationList())
                    try
                    {
            ...
            if (_afterKeepWithinSceneBounds_Vector2 != null)
                foreach (Delegates.KeepWithinSceneBounds_Vector2_AfterArgs toInvoke in
                         _afterKeepWithinSceneBounds_Vector2.GetInvocationList())
                    try
                    {
            ...
            CameraController self, Vector2 targetDest, out bool leftSide)
        {
            ...
            if (_beforeIsAtHorizontalSceneBounds != null)
                foreach (Delegates.IsAtHorizontalSceneBounds_BeforeArgs toInvoke in _beforeIsAtHorizontalSceneBounds
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterIsAtHorizontalSceneBounds != null)
                foreach (Delegates.IsAtHorizontalSceneBounds_AfterArgs toInvoke in _afterIsAtHorizontalSceneBounds
                             .GetInvocationList())
                    try
                    {
            ...
            CameraController self, Vector2 targetDest)
        {
            ...
            if (_beforeKeepWithinLockBounds != null)
                foreach (Delegates.KeepWithinLockBounds_BeforeArgs toInvoke in _beforeKeepWithinLockBounds
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterKeepWithinLockBounds != null)
                foreach (Delegates.KeepWithinLockBounds_AfterArgs toInvoke in _afterKeepWithinLockBounds
                             .GetInvocationList())
                    try
                    {
            ...
            CameraController self)
        {
            ...
            if (_beforePositionToHeroFacing != null)
                foreach (Delegates.PositionToHeroFacing_BeforeArgs toInvoke in _beforePositionToHeroFacing
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterPositionToHeroFacing != null)
                foreach (Delegates.PositionToHeroFacing_AfterArgs toInvoke in _afterPositionToHeroFacing
                             .GetInvocationList())
                    try
                    {
        ...
        internal static event Delegates.PositionToHeroFacing_Vector2_bool_AfterArgs
            _afterPositionToHeroFacing_Vector2_bool;

        private static void PositionToHeroFacing_Vector2_bool(
            On.CameraController.orig_PositionToHeroFacing_Vector2_bool orig, CameraController self, Vector2 newPosition,
            bool useXOffset)
        {
            ...
            if (_beforePositionToHeroFacing_Vector2_bool != null)
                foreach (Delegates.PositionToHeroFacing_Vector2_bool_BeforeArgs toInvoke in
                         _beforePositionToHeroFacing_Vector2_bool.GetInvocationList())
                    try
                    {
            ...
            if (_afterPositionToHeroFacing_Vector2_bool != null)
                foreach (Delegates.PositionToHeroFacing_Vector2_bool_AfterArgs toInvoke in
                         _afterPositionToHeroFacing_Vector2_bool.GetInvocationList())
                    try
                    {
        ...
        private static Vector2 GetPositionToHeroFacing(On.CameraController.orig_GetPositionToHeroFacing orig,
            CameraController self, Vector2 newPosition, bool useXOffset)
        {
            ...
            if (_beforeGetPositionToHeroFacing != null)
                foreach (Delegates.GetPositionToHeroFacing_BeforeArgs toInvoke in _beforeGetPositionToHeroFacing
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterGetPositionToHeroFacing != null)
                foreach (Delegates.GetPositionToHeroFacing_AfterArgs toInvoke in _afterGetPositionToHeroFacing
                             .GetInvocationList())
                    try
                    {
        ...
        private static IEnumerator FadeInFailSafe(On.CameraController.orig_FadeInFailSafe orig, CameraController self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void ApplyEffectConfiguration_WithArgs(Action<CameraController, bool, bool> orig,
            CameraController self, bool isGameplayLevel, bool isBloomForced);

        public delegate IEnumerator DoPositionToHero_AfterArgs(Params_DoPositionToHero args, IEnumerator ret);

        public delegate void DoPositionToHero_BeforeArgs(Params_DoPositionToHero args);

        public delegate IEnumerator DoPositionToHero_WithArgs(Func<CameraController, bool, IEnumerator> orig,
            CameraController self, bool forceDirect);

        public delegate IEnumerator FadeInFailSafe_AfterArgs(Params_FadeInFailSafe args, IEnumerator ret);

        public delegate void FadeInFailSafe_BeforeArgs(Params_FadeInFailSafe args);

        public delegate IEnumerator FadeInFailSafe_WithArgs(Func<CameraController, IEnumerator> orig,
            CameraController self);
        ...
        public delegate void FadeOut_WithArgs(Action<CameraController, CameraFadeType> orig, CameraController self,
            CameraFadeType type);
        ...
        public delegate void FreezeInPlace_WithArgs(Action<CameraController, bool> orig, CameraController self,
            bool freezeTargetAlso);
        ...
        public delegate Vector2 GetPositionToHeroFacing_AfterArgs(Params_GetPositionToHeroFacing args, Vector2 ret);

        public delegate void GetPositionToHeroFacing_BeforeArgs(Params_GetPositionToHeroFacing args);

        public delegate Vector2 GetPositionToHeroFacing_WithArgs(Func<CameraController, Vector2, bool, Vector2> orig,
            CameraController self, Vector2 newPosition, bool useXOffset);
        ...
        public delegate bool IsAtHorizontalSceneBounds_WithArgs(Func<CameraController, Vector2, bool, bool> orig,
            CameraController self, Vector2 targetDest, out bool leftSide);
        ...
        public delegate bool IsAtSceneBounds_WithArgs(Func<CameraController, Vector2, bool> orig, CameraController self,
            Vector2 targetDest);
        ...
        public delegate bool IsTouchingSides_WithArgs(Func<CameraController, float, bool> orig, CameraController self,
            float x);

        public delegate Vector2 KeepWithinLockBounds_AfterArgs(Params_KeepWithinLockBounds args, Vector2 ret);

        public delegate void KeepWithinLockBounds_BeforeArgs(Params_KeepWithinLockBounds args);

        public delegate Vector2 KeepWithinLockBounds_WithArgs(Func<CameraController, Vector2, Vector2> orig,
            CameraController self, Vector2 targetDest);

        public delegate Vector2 KeepWithinSceneBounds_Vector2_AfterArgs(Params_KeepWithinSceneBounds_Vector2 args,
            Vector2 ret);

        public delegate void KeepWithinSceneBounds_Vector2_BeforeArgs(Params_KeepWithinSceneBounds_Vector2 args);

        public delegate Vector2 KeepWithinSceneBounds_Vector2_WithArgs(Func<CameraController, Vector2, Vector2> orig,
            CameraController self, Vector2 targetDest);

        public delegate Vector3 KeepWithinSceneBounds_Vector3_AfterArgs(Params_KeepWithinSceneBounds_Vector3 args,
            Vector3 ret);

        public delegate void KeepWithinSceneBounds_Vector3_BeforeArgs(Params_KeepWithinSceneBounds_Vector3 args);

        public delegate Vector3 KeepWithinSceneBounds_Vector3_WithArgs(Func<CameraController, Vector3, Vector3> orig,
            CameraController self, Vector3 targetDest);
        ...
        public delegate void LockToArea_WithArgs(Action<CameraController, CameraLockArea> orig, CameraController self,
            CameraLockArea lockArea);
        ...
        public delegate void PositionToHero_WithArgs(Action<CameraController, bool> orig, CameraController self,
            bool forceDirect);
        ...
        public delegate void PositionToHeroFacing_Vector2_bool_WithArgs(Action<CameraController, Vector2, bool> orig,
            CameraController self, Vector2 newPosition, bool useXOffset);
        ...
        public delegate void ReleaseLock_WithArgs(Action<CameraController, CameraLockArea> orig, CameraController self,
            CameraLockArea lockarea);
        ...
        public delegate void SetMode_AfterArgs(Params_SetMode args);

        public delegate void SetMode_BeforeArgs(Params_SetMode args);

        public delegate void SetMode_WithArgs(Action<CameraController, CameraController.CameraMode> orig,
            CameraController self, CameraController.CameraMode newMode);

        public delegate void SnapTo_AfterArgs(Params_SnapTo args);

        public delegate void SnapTo_BeforeArgs(Params_SnapTo args);

        public delegate void SnapTo_WithArgs(Action<CameraController, float, float> orig, CameraController self,
            float x, float y);
        ...
        public delegate void
            UpdateTargetDestinationDelta_WithArgs(Action<CameraController> orig, CameraController self);
        ...
        public sealed class Params_SetMode
        {
            public CameraController.CameraMode newMode;
            public CameraController self;
        }
    ...
    public static class BeforeOrig
    {
        ...
        public static event Delegates.SetMode_BeforeArgs SetMode
        {
            add
            {
                HookHandler._beforeSetMode += value;
                HookHandler.HookSetMode();
            }
            remove => HookHandler._beforeSetMode -= value;
        }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.SetMode_AfterArgs SetMode
        {
            add
            {
                HookHandler._afterSetMode += value;
                HookHandler.HookSetMode();
            }
            remove => HookHandler._afterSetMode -= value;
        }
    ...
    public static class WithOrig
    {
        ...
        public static event On.CameraController.hook_SetMode SetMode
        {
            add => On.CameraController.SetMode += value;
            remove => On.CameraController.SetMode -= value;
        }
