...
public static class OnuGuiSliderSetWholeNumbers
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetWholeNumbers), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiSliderSetWholeNumbers> orig, uGuiSliderSetWholeNumbers self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetWholeNumbers), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiSliderSetWholeNumbers> orig, uGuiSliderSetWholeNumbers self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetWholeNumbers), "DoSetValue"), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiSliderSetWholeNumbers> orig, uGuiSliderSetWholeNumbers self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetWholeNumbers), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiSliderSetWholeNumbers> orig, uGuiSliderSetWholeNumbers self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiSliderSetWholeNumbers> orig,
            uGuiSliderSetWholeNumbers self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiSliderSetWholeNumbers> orig, uGuiSliderSetWholeNumbers self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiSliderSetWholeNumbers> orig, uGuiSliderSetWholeNumbers self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiSliderSetWholeNumbers> orig, uGuiSliderSetWholeNumbers self);

        public sealed class Params_Reset
        {
            public uGuiSliderSetWholeNumbers self;
        }
