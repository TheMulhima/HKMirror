...
public static class OnGameSirG4sAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameSirG4sAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameSirG4sAndroidUnityProfile> orig, GameSirG4sAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameSirG4sAndroidUnityProfile> orig,
            GameSirG4sAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public GameSirG4sAndroidUnityProfile self;
        }
    }
