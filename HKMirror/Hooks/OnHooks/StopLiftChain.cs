...
/// <summary>
/// Contains different types of On Hooks for StopLiftChain class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnStopLiftChain
{
...
On.StopLiftChain.Apply += Apply;

}
}
internal static event Delegates.Apply_BeforeArgs _beforeApply;
internal static event Delegates.Apply_AfterArgs _afterApply;
private static void Apply(On.StopLiftChain.orig_Apply orig,StopLiftChain self,  LiftChain liftChain)
{
...
public delegate void Apply_WithArgs (Action<StopLiftChain,  LiftChain> orig, StopLiftChain self,  LiftChain liftChain);
}
...
{
public static event On.StopLiftChain.hook_Apply Apply
{
add => On.StopLiftChain.Apply += value;
remove => On.StopLiftChain.Apply -= value;
}
}
