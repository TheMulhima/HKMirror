...
public static class OnBuildEquippedCharms
{
    ...
    public static class Delegates
    {
        ...
        public delegate GameObject GetObjectAt_AfterArgs(Params_GetObjectAt args, GameObject ret);

        public delegate void GetObjectAt_BeforeArgs(Params_GetObjectAt args);

        public delegate GameObject GetObjectAt_WithArgs(Func<BuildEquippedCharms, int, GameObject> orig,
