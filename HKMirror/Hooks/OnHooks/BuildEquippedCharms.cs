...
public static class OnBuildEquippedCharms
{
    internal static class HookHandler
    {
        ...
        private static UnityEngine.GameObject GetObjectAt(On.BuildEquippedCharms.orig_GetObjectAt orig,
            BuildEquippedCharms self, int listNumber)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.GameObject GetObjectAt_AfterArgs(Params_GetObjectAt args,
            UnityEngine.GameObject ret);

        public delegate UnityEngine.GameObject GetObjectAt_WithArgs(
            Func<BuildEquippedCharms, int, UnityEngine.GameObject> orig, BuildEquippedCharms self, int listNumber);
        ...
        public delegate string GetItemName_WithArgs(Func<BuildEquippedCharms, int, string> orig,
            BuildEquippedCharms self, int itemNum);
    }
