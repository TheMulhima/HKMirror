...
public static class OnGetAnimatorCurrentTransitionInfo
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo), "OnActionUpdate", true),
                    OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo self)
        {
        ...
        internal static void HookGetTransitionInfo()
        {
            if (!HookedList.Contains("GetTransitionInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo), "GetTransitionInfo",
                        true), GetTransitionInfo);
            }
        }
        ...
        private static void GetTransitionInfo(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo self);
        ...
        public delegate void GetTransitionInfo_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentTransitionInfo),
                    "Reset", true), value);
