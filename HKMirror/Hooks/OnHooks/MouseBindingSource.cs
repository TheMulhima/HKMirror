...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_Control", true), get_Control);
...
private static InControl.Mouse get_Control(Func<InControl.MouseBindingSource, InControl.Mouse> orig, InControl.MouseBindingSource self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "set_Control", true), set_Control);
...
private static void set_Control(Action<InControl.MouseBindingSource,  InControl.Mouse> orig, InControl.MouseBindingSource self,  InControl.Mouse value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "ButtonIsPressed", false), ButtonIsPressed);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "NegativeScrollWheelIsActive", false), NegativeScrollWheelIsActive);
...
{
foreach (Delegates.NegativeScrollWheelIsActive_BeforeArgs toInvoke in _beforeNegativeScrollWheelIsActive.GetInvocationList())
{
try
{
...
{
foreach (Delegates.NegativeScrollWheelIsActive_AfterArgs toInvoke in _afterNegativeScrollWheelIsActive.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "PositiveScrollWheelIsActive", false), PositiveScrollWheelIsActive);
...
{
foreach (Delegates.PositiveScrollWheelIsActive_BeforeArgs toInvoke in _beforePositiveScrollWheelIsActive.GetInvocationList())
{
try
{
...
{
foreach (Delegates.PositiveScrollWheelIsActive_AfterArgs toInvoke in _afterPositiveScrollWheelIsActive.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetValue_Mouse", false), GetValue_Mouse);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetValue_InputDevice", true), GetValue_InputDevice);
...
private static float GetValue_InputDevice(Func<InControl.MouseBindingSource,  InControl.InputDevice, float> orig, InControl.MouseBindingSource self,  InControl.InputDevice inputDevice)
{
...
{
foreach (Delegates.GetValue_InputDevice_BeforeArgs toInvoke in _beforeGetValue_InputDevice.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetValue_InputDevice_AfterArgs toInvoke in _afterGetValue_InputDevice.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetState", true), GetState);
...
private static bool GetState(Func<InControl.MouseBindingSource,  InControl.InputDevice, bool> orig, InControl.MouseBindingSource self,  InControl.InputDevice inputDevice)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_Name", true), get_Name);
...
private static string get_Name(Func<InControl.MouseBindingSource, string> orig, InControl.MouseBindingSource self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceName", true), get_DeviceName);
...
private static string get_DeviceName(Func<InControl.MouseBindingSource, string> orig, InControl.MouseBindingSource self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceClass", true), get_DeviceClass);
...
private static InControl.InputDeviceClass get_DeviceClass(Func<InControl.MouseBindingSource, InControl.InputDeviceClass> orig, InControl.MouseBindingSource self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceStyle", true), get_DeviceStyle);
...
private static InControl.InputDeviceStyle get_DeviceStyle(Func<InControl.MouseBindingSource, InControl.InputDeviceStyle> orig, InControl.MouseBindingSource self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Equals_BindingSource", true), Equals_BindingSource);
...
private static bool Equals_BindingSource(Func<InControl.MouseBindingSource,  InControl.BindingSource, bool> orig, InControl.MouseBindingSource self,  InControl.BindingSource other)
{
...
{
foreach (Delegates.Equals_BindingSource_BeforeArgs toInvoke in _beforeEquals_BindingSource.GetInvocationList())
{
try
{
...
{
foreach (Delegates.Equals_BindingSource_AfterArgs toInvoke in _afterEquals_BindingSource.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Equals_Object", true), Equals_Object);
...
private static bool Equals_Object(Func<InControl.MouseBindingSource,  System.Object, bool> orig, InControl.MouseBindingSource self,  System.Object other)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_BindingSourceType", true), get_BindingSourceType);
...
private static InControl.BindingSourceType get_BindingSourceType(Func<InControl.MouseBindingSource, InControl.BindingSourceType> orig, InControl.MouseBindingSource self)
{
...
{
foreach (Delegates.get_BindingSourceType_BeforeArgs toInvoke in _beforeget_BindingSourceType.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_BindingSourceType_AfterArgs toInvoke in _afterget_BindingSourceType.GetInvocationList())
{
try
{
...
private static void Save(Action<InControl.MouseBindingSource,  System.IO.BinaryWriter> orig, InControl.MouseBindingSource self,  System.IO.BinaryWriter writer)
{
...
private static void Load(Action<InControl.MouseBindingSource,  System.IO.BinaryReader,  ushort> orig, InControl.MouseBindingSource self,  System.IO.BinaryReader reader,  ushort dataFormatVersion)
{
...
public delegate InControl.Mouse get_Control_WithArgs (Func<InControl.MouseBindingSource, InControl.Mouse> orig, InControl.MouseBindingSource self);
...
public delegate void set_Control_WithArgs (Action<InControl.MouseBindingSource,  InControl.Mouse> orig, InControl.MouseBindingSource self,  InControl.Mouse value);
...
public delegate float GetValue_InputDevice_WithArgs (Func<InControl.MouseBindingSource,  InControl.InputDevice, float> orig, InControl.MouseBindingSource self,  InControl.InputDevice inputDevice);
...
public delegate bool GetState_WithArgs (Func<InControl.MouseBindingSource,  InControl.InputDevice, bool> orig, InControl.MouseBindingSource self,  InControl.InputDevice inputDevice);
...
public delegate string get_Name_WithArgs (Func<InControl.MouseBindingSource, string> orig, InControl.MouseBindingSource self);
...
public delegate string get_DeviceName_WithArgs (Func<InControl.MouseBindingSource, string> orig, InControl.MouseBindingSource self);
...
public delegate InControl.InputDeviceClass get_DeviceClass_WithArgs (Func<InControl.MouseBindingSource, InControl.InputDeviceClass> orig, InControl.MouseBindingSource self);
...
public delegate InControl.InputDeviceStyle get_DeviceStyle_WithArgs (Func<InControl.MouseBindingSource, InControl.InputDeviceStyle> orig, InControl.MouseBindingSource self);
...
public delegate bool Equals_BindingSource_WithArgs (Func<InControl.MouseBindingSource,  InControl.BindingSource, bool> orig, InControl.MouseBindingSource self,  InControl.BindingSource other);
...
public delegate bool Equals_Object_WithArgs (Func<InControl.MouseBindingSource,  System.Object, bool> orig, InControl.MouseBindingSource self,  System.Object other);
...
public delegate InControl.BindingSourceType get_BindingSourceType_AfterArgs(Params_get_BindingSourceType args, InControl.BindingSourceType ret);
public delegate InControl.BindingSourceType get_BindingSourceType_WithArgs (Func<InControl.MouseBindingSource, InControl.BindingSourceType> orig, InControl.MouseBindingSource self);
...
public delegate void Save_WithArgs (Action<InControl.MouseBindingSource,  System.IO.BinaryWriter> orig, InControl.MouseBindingSource self,  System.IO.BinaryWriter writer);
...
public delegate void Load_WithArgs (Action<InControl.MouseBindingSource,  System.IO.BinaryReader,  ushort> orig, InControl.MouseBindingSource self,  System.IO.BinaryReader reader,  ushort dataFormatVersion);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Control_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_Control", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Control_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_Control", true), value);
}
public static event Delegates.set_Control_WithArgs set_Control
{
add => HookEndpointManager.Add<Delegates.set_Control_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "set_Control", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Control_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "set_Control", true), value);
}
public static event Delegates.ButtonIsPressed_WithArgs ButtonIsPressed
{
add => HookEndpointManager.Add<Delegates.ButtonIsPressed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "ButtonIsPressed", false), value);
remove => HookEndpointManager.Remove<Delegates.ButtonIsPressed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "ButtonIsPressed", false), value);
}
public static event Delegates.NegativeScrollWheelIsActive_WithArgs NegativeScrollWheelIsActive
{
add => HookEndpointManager.Add<Delegates.NegativeScrollWheelIsActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "NegativeScrollWheelIsActive", false), value);
remove => HookEndpointManager.Remove<Delegates.NegativeScrollWheelIsActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "NegativeScrollWheelIsActive", false), value);
}
public static event Delegates.PositiveScrollWheelIsActive_WithArgs PositiveScrollWheelIsActive
{
add => HookEndpointManager.Add<Delegates.PositiveScrollWheelIsActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "PositiveScrollWheelIsActive", false), value);
remove => HookEndpointManager.Remove<Delegates.PositiveScrollWheelIsActive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "PositiveScrollWheelIsActive", false), value);
}
public static event Delegates.GetValue_Mouse_WithArgs GetValue_Mouse
{
add => HookEndpointManager.Add<Delegates.GetValue_Mouse_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetValue", false), value);
remove => HookEndpointManager.Remove<Delegates.GetValue_Mouse_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetValue", false), value);
}
public static event Delegates.GetValue_InputDevice_WithArgs GetValue_InputDevice
{
add => HookEndpointManager.Add<Delegates.GetValue_InputDevice_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetValue", true), value);
remove => HookEndpointManager.Remove<Delegates.GetValue_InputDevice_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetValue", true), value);
}
public static event Delegates.GetState_WithArgs GetState
{
add => HookEndpointManager.Add<Delegates.GetState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetState", true), value);
remove => HookEndpointManager.Remove<Delegates.GetState_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "GetState", true), value);
}
public static event Delegates.get_Name_WithArgs get_Name
{
add => HookEndpointManager.Add<Delegates.get_Name_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_Name", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Name_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_Name", true), value);
}
public static event Delegates.get_DeviceName_WithArgs get_DeviceName
{
add => HookEndpointManager.Add<Delegates.get_DeviceName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceName", true), value);
remove => HookEndpointManager.Remove<Delegates.get_DeviceName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceName", true), value);
}
public static event Delegates.get_DeviceClass_WithArgs get_DeviceClass
{
add => HookEndpointManager.Add<Delegates.get_DeviceClass_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceClass", true), value);
remove => HookEndpointManager.Remove<Delegates.get_DeviceClass_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceClass", true), value);
}
public static event Delegates.get_DeviceStyle_WithArgs get_DeviceStyle
{
add => HookEndpointManager.Add<Delegates.get_DeviceStyle_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceStyle", true), value);
remove => HookEndpointManager.Remove<Delegates.get_DeviceStyle_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_DeviceStyle", true), value);
}
public static event Delegates.Equals_BindingSource_WithArgs Equals_BindingSource
{
add => HookEndpointManager.Add<Delegates.Equals_BindingSource_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Equals", true), value);
remove => HookEndpointManager.Remove<Delegates.Equals_BindingSource_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Equals", true), value);
}
public static event Delegates.Equals_Object_WithArgs Equals_Object
{
add => HookEndpointManager.Add<Delegates.Equals_Object_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Equals", true), value);
remove => HookEndpointManager.Remove<Delegates.Equals_Object_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Equals", true), value);
}
public static event Delegates.get_BindingSourceType_WithArgs get_BindingSourceType
{
add => HookEndpointManager.Add<Delegates.get_BindingSourceType_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_BindingSourceType", true), value);
remove => HookEndpointManager.Remove<Delegates.get_BindingSourceType_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "get_BindingSourceType", true), value);
}
public static event Delegates.Save_WithArgs Save
{
add => HookEndpointManager.Add<Delegates.Save_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Save", true), value);
remove => HookEndpointManager.Remove<Delegates.Save_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Save", true), value);
}
public static event Delegates.Load_WithArgs Load
{
add => HookEndpointManager.Add<Delegates.Load_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Load", true), value);
remove => HookEndpointManager.Remove<Delegates.Load_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InControl.MouseBindingSource), "Load", true), value);
}
}
