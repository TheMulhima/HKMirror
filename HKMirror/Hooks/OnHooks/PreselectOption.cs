...
public static class OnPreselectOption
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator ForceDeselect_AfterArgs(Params_ForceDeselect args, IEnumerator ret);

        public delegate void ForceDeselect_BeforeArgs(Params_ForceDeselect args);

        public delegate IEnumerator ForceDeselect_WithArgs(Func<PreselectOption, IEnumerator> orig,
        ...
        public delegate void SetDefaultHighlight_WithArgs(Action<PreselectOption, Button> orig, PreselectOption self,
            Button button);
