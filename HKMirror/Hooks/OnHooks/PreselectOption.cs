...
public static class OnPreselectOption
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.HighlightDefault_NormalArgs _afterHighlightDefault;
            ...
            bool deselect)
        {
            ...
            orig(self, deselect);
            if (_afterHighlightDefault != null) _afterHighlightDefault.Invoke(@params);
        }
        ...
        internal static event Delegates.SetDefaultHighlight_NormalArgs _afterSetDefaultHighlight;
            ...
            Button button)
        {
            ...
            orig(self, button);
            if (_afterSetDefaultHighlight != null) _afterSetDefaultHighlight.Invoke(@params);
        }
        ...
        internal static event Delegates.DeselectAll_NormalArgs _afterDeselectAll;
        ...
        private static void DeselectAll(On.PreselectOption.orig_DeselectAll orig, PreselectOption self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterDeselectAll != null) _afterDeselectAll.Invoke(@params);
        }
        ...
        private static IEnumerator ForceDeselect(On.PreselectOption.orig_ForceDeselect orig, PreselectOption self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DeselectAll_NormalArgs(Params_DeselectAll args);

        public delegate void ForceDeselect_BeforeArgs(Params_ForceDeselect args);

        public delegate IEnumerator ForceDeselect_NormalArgs(Params_ForceDeselect args);

        public delegate void HighlightDefault_BeforeArgs(Params_HighlightDefault args);

        public delegate void HighlightDefault_NormalArgs(Params_HighlightDefault args);

        public delegate void SetDefaultHighlight_BeforeArgs(Params_SetDefaultHighlight args);

        public delegate void SetDefaultHighlight_NormalArgs(Params_SetDefaultHighlight args);
    ...
    {
        public static event Delegates.HighlightDefault_NormalArgs HighlightDefault
        {
            add
            {
        ...
        public static event Delegates.SetDefaultHighlight_NormalArgs SetDefaultHighlight
        {
            add
            {
        ...
        public static event Delegates.DeselectAll_NormalArgs DeselectAll
        {
            add
            {
