...
private static void HighlightDefault(On.PreselectOption.orig_HighlightDefault orig,PreselectOption self,  bool deselect)
{
...
private static void SetDefaultHighlight(On.PreselectOption.orig_SetDefaultHighlight orig,PreselectOption self,  UnityEngine.UI.Button button)
{
...
{
foreach (Delegates.SetDefaultHighlight_BeforeArgs toInvoke in _beforeSetDefaultHighlight.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetDefaultHighlight_AfterArgs toInvoke in _afterSetDefaultHighlight.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator ForceDeselect(On.PreselectOption.orig_ForceDeselect orig,PreselectOption self)
{
...
public delegate void HighlightDefault_WithArgs (Action<PreselectOption,  bool> orig, PreselectOption self,  bool deselect);
...
public delegate void SetDefaultHighlight_WithArgs (Action<PreselectOption,  UnityEngine.UI.Button> orig, PreselectOption self,  UnityEngine.UI.Button button);
...
public delegate System.Collections.IEnumerator ForceDeselect_AfterArgs(Params_ForceDeselect args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ForceDeselect_WithArgs (Func<PreselectOption, System.Collections.IEnumerator> orig, PreselectOption self);
}
