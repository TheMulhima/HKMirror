...
private static void Setup(On.BossChallengeUI.orig_Setup orig,BossChallengeUI self,  BossStatue bossStatue,  string bossNameSheet,  string bossNameKey,  string descriptionSheet,  string descriptionKey)
{
Delegates.Params_Setup @params = new() 
{
self = self
, bossStatue = bossStatue
, bossNameSheet = bossNameSheet
...
private static System.Collections.IEnumerator ShowUnlockEffect(On.BossChallengeUI.orig_ShowUnlockEffect orig,BossChallengeUI self)
{
...
private static System.Collections.IEnumerator SetFirstSelected(On.BossChallengeUI.orig_SetFirstSelected orig,BossChallengeUI self)
{
...
private static System.Collections.IEnumerator HideAnim(On.BossChallengeUI.orig_HideAnim orig,BossChallengeUI self)
{
...
private static void LoadBoss_int_bool(On.BossChallengeUI.orig_LoadBoss_int_bool orig,BossChallengeUI self,  int level,  bool doHideAnim)
{
Delegates.Params_LoadBoss_int_bool @params = new() 
{
self = self
, level = level
, doHideAnim = doHideAnim
};
if (_beforeLoadBoss_int_bool != null)
{
foreach (Delegates.LoadBoss_int_bool_BeforeArgs toInvoke in _beforeLoadBoss_int_bool.GetInvocationList())
{
try
{
...
private static void RecordLastSelected(On.BossChallengeUI.orig_RecordLastSelected orig,BossChallengeUI self,  int index)
{
...
{
foreach (Delegates.RecordLastSelected_BeforeArgs toInvoke in _beforeRecordLastSelected.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RecordLastSelected_AfterArgs toInvoke in _afterRecordLastSelected.GetInvocationList())
{
try
{
...
public delegate void Setup_WithArgs (Action<BossChallengeUI,  BossStatue,  string,  string,  string,  string> orig, BossChallengeUI self,  BossStatue bossStatue,  string bossNameSheet,  string bossNameKey,  string descriptionSheet,  string descriptionKey);
public sealed class Params_ShowUnlockEffect
{
public BossChallengeUI self;
}
public delegate void ShowUnlockEffect_BeforeArgs(Params_ShowUnlockEffect args);
public delegate System.Collections.IEnumerator ShowUnlockEffect_AfterArgs(Params_ShowUnlockEffect args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ShowUnlockEffect_WithArgs (Func<BossChallengeUI, System.Collections.IEnumerator> orig, BossChallengeUI self);
public sealed class Params_SetFirstSelected
{
public BossChallengeUI self;
}
public delegate void SetFirstSelected_BeforeArgs(Params_SetFirstSelected args);
public delegate System.Collections.IEnumerator SetFirstSelected_AfterArgs(Params_SetFirstSelected args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator SetFirstSelected_WithArgs (Func<BossChallengeUI, System.Collections.IEnumerator> orig, BossChallengeUI self);
...
public delegate System.Collections.IEnumerator HideAnim_AfterArgs(Params_HideAnim args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator HideAnim_WithArgs (Func<BossChallengeUI, System.Collections.IEnumerator> orig, BossChallengeUI self);
...
public delegate void LoadBoss_int_bool_WithArgs (Action<BossChallengeUI,  int,  bool> orig, BossChallengeUI self,  int level,  bool doHideAnim);
...
public delegate void RecordLastSelected_WithArgs (Action<BossChallengeUI,  int> orig, BossChallengeUI self,  int index);
}
