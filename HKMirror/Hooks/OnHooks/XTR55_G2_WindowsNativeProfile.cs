...
public static class OnXTR55_G2_WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XTR55_G2_WindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XTR55_G2_WindowsNativeProfile> orig, XTR55_G2_WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XTR55_G2_WindowsNativeProfile> orig,
            XTR55_G2_WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public XTR55_G2_WindowsNativeProfile self;
        }
    }
