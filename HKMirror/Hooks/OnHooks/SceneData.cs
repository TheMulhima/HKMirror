...
private static void SaveMyState_GeoRockData(On.SceneData.orig_SaveMyState_GeoRockData orig,SceneData self,  GeoRockData geoRockData)
{
...
{
foreach (Delegates.SaveMyState_GeoRockData_BeforeArgs toInvoke in _beforeSaveMyState_GeoRockData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveMyState_GeoRockData_AfterArgs toInvoke in _afterSaveMyState_GeoRockData.GetInvocationList())
{
try
{
...
private static void SaveMyState_PersistentBoolData(On.SceneData.orig_SaveMyState_PersistentBoolData orig,SceneData self,  PersistentBoolData persistentBoolData)
{
...
{
foreach (Delegates.SaveMyState_PersistentBoolData_BeforeArgs toInvoke in _beforeSaveMyState_PersistentBoolData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveMyState_PersistentBoolData_AfterArgs toInvoke in _afterSaveMyState_PersistentBoolData.GetInvocationList())
{
try
{
...
private static void SaveMyState_PersistentIntData(On.SceneData.orig_SaveMyState_PersistentIntData orig,SceneData self,  PersistentIntData persistentIntData)
{
...
{
foreach (Delegates.SaveMyState_PersistentIntData_BeforeArgs toInvoke in _beforeSaveMyState_PersistentIntData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveMyState_PersistentIntData_AfterArgs toInvoke in _afterSaveMyState_PersistentIntData.GetInvocationList())
{
try
{
...
private static GeoRockData FindMyState_GeoRockData(On.SceneData.orig_FindMyState_GeoRockData orig,SceneData self,  GeoRockData grd)
{
...
{
foreach (Delegates.FindMyState_GeoRockData_BeforeArgs toInvoke in _beforeFindMyState_GeoRockData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindMyState_GeoRockData_AfterArgs toInvoke in _afterFindMyState_GeoRockData.GetInvocationList())
{
try
{
...
private static PersistentBoolData FindMyState_PersistentBoolData(On.SceneData.orig_FindMyState_PersistentBoolData orig,SceneData self,  PersistentBoolData persistentBoolData)
{
...
{
foreach (Delegates.FindMyState_PersistentBoolData_BeforeArgs toInvoke in _beforeFindMyState_PersistentBoolData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindMyState_PersistentBoolData_AfterArgs toInvoke in _afterFindMyState_PersistentBoolData.GetInvocationList())
{
try
{
...
private static PersistentIntData FindMyState_PersistentIntData(On.SceneData.orig_FindMyState_PersistentIntData orig,SceneData self,  PersistentIntData persistentIntData)
{
...
{
foreach (Delegates.FindMyState_PersistentIntData_BeforeArgs toInvoke in _beforeFindMyState_PersistentIntData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindMyState_PersistentIntData_AfterArgs toInvoke in _afterFindMyState_PersistentIntData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupNewSceneData_BeforeArgs toInvoke in _beforeSetupNewSceneData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindGeoRockInList_BeforeArgs toInvoke in _beforeFindGeoRockInList.GetInvocationList())
{
try
{
...
private static int FindPersistentBoolItemInList(On.SceneData.orig_FindPersistentBoolItemInList orig,SceneData self,  PersistentBoolData pbd)
{
...
{
foreach (Delegates.FindPersistentBoolItemInList_BeforeArgs toInvoke in _beforeFindPersistentBoolItemInList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindPersistentBoolItemInList_AfterArgs toInvoke in _afterFindPersistentBoolItemInList.GetInvocationList())
{
try
{
...
private static int FindPersistentIntItemInList(On.SceneData.orig_FindPersistentIntItemInList orig,SceneData self,  PersistentIntData pid)
{
...
{
foreach (Delegates.FindPersistentIntItemInList_BeforeArgs toInvoke in _beforeFindPersistentIntItemInList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindPersistentIntItemInList_AfterArgs toInvoke in _afterFindPersistentIntItemInList.GetInvocationList())
{
try
{
...
public delegate void SaveMyState_GeoRockData_WithArgs (Action<SceneData,  GeoRockData> orig, SceneData self,  GeoRockData geoRockData);
...
public delegate void SaveMyState_PersistentBoolData_WithArgs (Action<SceneData,  PersistentBoolData> orig, SceneData self,  PersistentBoolData persistentBoolData);
...
public delegate void SaveMyState_PersistentIntData_WithArgs (Action<SceneData,  PersistentIntData> orig, SceneData self,  PersistentIntData persistentIntData);
...
public delegate GeoRockData FindMyState_GeoRockData_AfterArgs(Params_FindMyState_GeoRockData args, GeoRockData ret);
public delegate GeoRockData FindMyState_GeoRockData_WithArgs (Func<SceneData,  GeoRockData, GeoRockData> orig, SceneData self,  GeoRockData grd);
...
public delegate PersistentBoolData FindMyState_PersistentBoolData_AfterArgs(Params_FindMyState_PersistentBoolData args, PersistentBoolData ret);
public delegate PersistentBoolData FindMyState_PersistentBoolData_WithArgs (Func<SceneData,  PersistentBoolData, PersistentBoolData> orig, SceneData self,  PersistentBoolData persistentBoolData);
...
public delegate PersistentIntData FindMyState_PersistentIntData_AfterArgs(Params_FindMyState_PersistentIntData args, PersistentIntData ret);
public delegate PersistentIntData FindMyState_PersistentIntData_WithArgs (Func<SceneData,  PersistentIntData, PersistentIntData> orig, SceneData self,  PersistentIntData persistentIntData);
...
public delegate int FindGeoRockInList_WithArgs (Func<SceneData,  GeoRockData, int> orig, SceneData self,  GeoRockData grd);
...
public delegate int FindPersistentBoolItemInList_WithArgs (Func<SceneData,  PersistentBoolData, int> orig, SceneData self,  PersistentBoolData pbd);
...
public delegate int FindPersistentIntItemInList_WithArgs (Func<SceneData,  PersistentIntData, int> orig, SceneData self,  PersistentIntData pid);
}
...
{
add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneData), "get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneData), "get_instance", false), value);
}
public static event Delegates.set_instance_WithArgs set_instance
{
add => HookEndpointManager.Add<Delegates.set_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneData), "set_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.set_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SceneData), "set_instance", false), value);
}
