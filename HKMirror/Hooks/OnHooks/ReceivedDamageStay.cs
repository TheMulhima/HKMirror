...
public static class OnReceivedDamageStay
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self)
        {
        ...
        internal static void HookDoCollisionEnter2D()
        {
            if (!HookedList.Contains("DoCollisionEnter2D"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay),
        ...
        private static void DoCollisionEnter2D(
            Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay, UnityEngine.Collision2D> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self, UnityEngine.Collision2D collisionInfo)
        {
        ...
        private static void DoTriggerEnter2D(
            Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay, UnityEngine.Collider2D> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self, UnityEngine.Collider2D collisionInfo)
        {
        ...
        internal static void HookStoreCollisionInfo_Collision2D()
        {
            if (!HookedList.Contains("StoreCollisionInfo_Collision2D"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay),
                        "StoreCollisionInfo_Collision2D", true), StoreCollisionInfo_Collision2D);
            }
        }
        ...
        private static void StoreCollisionInfo_Collision2D(
            Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay, UnityEngine.Collision2D> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self, UnityEngine.Collision2D collisionInfo)
        {
            ...
            {
                foreach (Delegates.StoreCollisionInfo_Collision2D_BeforeArgs toInvoke in
                         _beforeStoreCollisionInfo_Collision2D.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.StoreCollisionInfo_Collision2D_AfterArgs toInvoke in
                         _afterStoreCollisionInfo_Collision2D.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookStoreCollisionInfo_Collider2D()
        {
            if (!HookedList.Contains("StoreCollisionInfo_Collider2D"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay),
                        "StoreCollisionInfo_Collider2D", true), StoreCollisionInfo_Collider2D);
            }
        }
        ...
        private static void StoreCollisionInfo_Collider2D(
            Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay, UnityEngine.Collider2D> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self, UnityEngine.Collider2D collisionInfo)
        {
            ...
            {
                foreach (Delegates.StoreCollisionInfo_Collider2D_BeforeArgs toInvoke in
                         _beforeStoreCollisionInfo_Collider2D.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.StoreCollisionInfo_Collider2D_AfterArgs toInvoke in
                         _afterStoreCollisionInfo_Collider2D.GetInvocationList())
                {
                    try
                    {
        ...
        private static void StoreIfDamagingObject(
            Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self, UnityEngine.GameObject go)
        {
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.ReceivedDamageStay, string> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self);
        ...
        public delegate void StoreCollisionInfo_Collision2D_WithArgs(
            Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay, UnityEngine.Collision2D> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self, UnityEngine.Collision2D collisionInfo);
        ...
        public delegate void StoreCollisionInfo_Collider2D_WithArgs(
            Action<HutongGames.PlayMaker.Actions.ReceivedDamageStay, UnityEngine.Collider2D> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self, UnityEngine.Collider2D collisionInfo);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.ReceivedDamageStay, string> orig,
            HutongGames.PlayMaker.Actions.ReceivedDamageStay self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay), "Reset", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.StoreCollisionInfo_Collision2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay),
                    "StoreCollisionInfo", true), value);
            remove => HookEndpointManager.Remove<Delegates.StoreCollisionInfo_Collision2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay),
                    "StoreCollisionInfo", true), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.StoreCollisionInfo_Collider2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay),
                    "StoreCollisionInfo", true), value);
            remove => HookEndpointManager.Remove<Delegates.StoreCollisionInfo_Collider2D_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay),
                    "StoreCollisionInfo", true), value);
        }
        ...
        public static event Delegates.ErrorCheck_WithArgs ErrorCheck
        {
            add => HookEndpointManager.Add<Delegates.ErrorCheck_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ReceivedDamageStay), "ErrorCheck",
                    true), value);
