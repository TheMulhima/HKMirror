...
public static class OnMadCatzCTRLRAmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzCTRLRAmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MadCatzCTRLRAmazonUnityProfile> orig, MadCatzCTRLRAmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzCTRLRAmazonUnityProfile> orig,
            MadCatzCTRLRAmazonUnityProfile self);

        public sealed class Params_Define
        {
            public MadCatzCTRLRAmazonUnityProfile self;
        }
    }
