...
public static class OnGUIBox
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUIBox), "OnGUI"),
                    OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUIBox> orig,
            GUIBox self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUIBox> orig,
            GUIBox self);
    ...
    public static class WithOrig
    {
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUIBox), "OnGUI"), value);
