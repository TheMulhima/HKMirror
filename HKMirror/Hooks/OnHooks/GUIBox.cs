...
/// <summary>
/// Contains different types of On Hooks for GUIBox class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGUIBox
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUIBox), "OnGUI", true),
                    OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.GUIBox> orig,
            HutongGames.PlayMaker.Actions.GUIBox self)
        {
    ...
    public static class Delegates
    {
        ...
        {
            public HutongGames.PlayMaker.Actions.GUIBox self;
        }
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.GUIBox> orig,
            HutongGames.PlayMaker.Actions.GUIBox self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUIBox), "OnGUI", true), value);
