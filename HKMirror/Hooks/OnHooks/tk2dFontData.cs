...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dFontData), "get_inst", true), get_inst);
...
private static void SetDictionary(On.tk2dFontData.orig_SetDictionary orig,tk2dFontData self,  System.Collections.Generic.Dictionary<int,tk2dFontChar> dict)
{
...
{
public tk2dFontData self;
public System.Collections.Generic.Dictionary<int,tk2dFontChar> dict;
}
...
public delegate void SetDictionary_WithArgs (Action<tk2dFontData,  System.Collections.Generic.Dictionary<int,tk2dFontChar>> orig, tk2dFontData self,  System.Collections.Generic.Dictionary<int,tk2dFontChar> dict);
}
...
{
add => HookEndpointManager.Add<Delegates.get_inst_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dFontData), "get_inst", true), value);
remove => HookEndpointManager.Remove<Delegates.get_inst_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dFontData), "get_inst", true), value);
}
