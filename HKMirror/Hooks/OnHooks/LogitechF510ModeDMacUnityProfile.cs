...
public static class OnLogitechF510ModeDMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ModeDMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ModeDMacUnityProfile> orig, LogitechF510ModeDMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ModeDMacUnityProfile> orig,
            LogitechF510ModeDMacUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ModeDMacUnityProfile self;
        }
    }
