...
private static void SetupUI(On.BossSummaryUI.orig_SetupUI orig,BossSummaryUI self,  System.Collections.Generic.List<BossStatue> bossStatues)
{
Delegates.Params_SetupUI @params = new() 
{
self = self
, bossStatues = bossStatues
};
...
private static void CreateListItem(On.BossSummaryUI.orig_CreateListItem orig,BossSummaryUI self,  BossStatue bossStatue,  bool isAlt)
{
...
private static System.Collections.IEnumerator Close(On.BossSummaryUI.orig_Close orig,BossSummaryUI self)
{
...
public delegate void SetupUI_WithArgs (Action<BossSummaryUI,  System.Collections.Generic.List<BossStatue>> orig, BossSummaryUI self,  System.Collections.Generic.List<BossStatue> bossStatues);
...
public delegate void CreateListItem_WithArgs (Action<BossSummaryUI,  BossStatue,  bool> orig, BossSummaryUI self,  BossStatue bossStatue,  bool isAlt);
...
public delegate System.Collections.IEnumerator Close_AfterArgs(Params_Close args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Close_WithArgs (Func<BossSummaryUI, System.Collections.IEnumerator> orig, BossSummaryUI self);
}
