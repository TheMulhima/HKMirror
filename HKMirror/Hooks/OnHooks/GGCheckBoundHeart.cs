...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundHeart), "get_IsTrue", true), get_IsTrue);
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundHeart), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundHeart), "get_IsTrue", true), value);
}
}
