...
public static class OnSetTagsOnChildren
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetTagsOnChildren), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetTagsOnChildren), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self)
        {
        ...
        internal static void HookSetTag()
        {
            if (!HookedList.Contains("SetTag"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetTagsOnChildren), "SetTag",
                        true), SetTag);
            }
        }
        ...
        private static void SetTag(Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self, UnityEngine.GameObject parent)
        {
        ...
        internal static void HookUpdateComponentFilter()
        {
            if (!HookedList.Contains("UpdateComponentFilter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetTagsOnChildren),
                        "UpdateComponentFilter", true), UpdateComponentFilter);
            }
        }
        ...
        private static void UpdateComponentFilter(Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self);
        ...
        public delegate void SetTag_WithArgs(
            Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self, UnityEngine.GameObject parent);
        ...
        public delegate void UpdateComponentFilter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.SetTagsOnChildren> orig,
            HutongGames.PlayMaker.Actions.SetTagsOnChildren self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetTagsOnChildren), "Reset", true),
                value);
        ...
        public static event Delegates.SetTag_WithArgs SetTag
        {
            add => HookEndpointManager.Add<Delegates.SetTag_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetTagsOnChildren), "SetTag", true),
                value);
        ...
        public static event Delegates.UpdateComponentFilter_WithArgs UpdateComponentFilter
        {
            add => HookEndpointManager.Add<Delegates.UpdateComponentFilter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetTagsOnChildren),
                    "UpdateComponentFilter", true), value);
