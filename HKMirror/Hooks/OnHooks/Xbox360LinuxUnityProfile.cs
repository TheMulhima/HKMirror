...
public static class OnXbox360LinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360LinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360LinuxUnityProfile> orig, Xbox360LinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360LinuxUnityProfile> orig, Xbox360LinuxUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360LinuxUnityProfile self;
        }
    }
