...
public static class OnSceneryTriggerCircle
{
    internal static class HookHandler
    {
        ...
        private static void OnTriggerEnter2D(On.SceneryTriggerCircle.orig_OnTriggerEnter2D orig,
            SceneryTriggerCircle self, UnityEngine.Collider2D other)
        {
        ...
        private static void RandomizePitch(On.SceneryTriggerCircle.orig_RandomizePitch orig, SceneryTriggerCircle self,
            UnityEngine.AudioSource src, float minPitch, float maxPitch)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<SceneryTriggerCircle, UnityEngine.Collider2D> orig,
            SceneryTriggerCircle self, UnityEngine.Collider2D other);
        ...
        public delegate void OnTriggerStay2D_WithArgs(Action<SceneryTriggerCircle, UnityEngine.Collider2D> orig,
            SceneryTriggerCircle self, UnityEngine.Collider2D other);
        ...
        public delegate void OnTriggerExit2D_WithArgs(Action<SceneryTriggerCircle, UnityEngine.Collider2D> orig,
            SceneryTriggerCircle self, UnityEngine.Collider2D other);
        ...
        public delegate void RandomizePitch_WithArgs(
            Action<SceneryTriggerCircle, UnityEngine.AudioSource, float, float> orig, SceneryTriggerCircle self,
            UnityEngine.AudioSource src, float minPitch, float maxPitch);
        ...
        public delegate void ResetPitch_WithArgs(Action<SceneryTriggerCircle, UnityEngine.AudioSource> orig,
            SceneryTriggerCircle self, UnityEngine.AudioSource src);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_active_WithArgs get_active
        {
            add => HookEndpointManager.Add<Delegates.get_active_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneryTriggerCircle), "get_active", true), value);
        ...
        public static event Delegates.set_active_WithArgs set_active
        {
            add => HookEndpointManager.Add<Delegates.set_active_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SceneryTriggerCircle), "set_active", true), value);
