...
public static class OnXInputWindowsFirefoxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XInputWindowsFirefoxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XInputWindowsFirefoxUnityProfile> orig, XInputWindowsFirefoxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XInputWindowsFirefoxUnityProfile> orig,
            XInputWindowsFirefoxUnityProfile self);

        public sealed class Params_Define
        {
            public XInputWindowsFirefoxUnityProfile self;
        }
    }
