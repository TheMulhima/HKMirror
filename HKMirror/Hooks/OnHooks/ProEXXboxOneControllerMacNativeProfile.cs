...
public static class OnProEXXboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ProEXXboxOneControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<ProEXXboxOneControllerMacNativeProfile> orig,
            ProEXXboxOneControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ProEXXboxOneControllerMacNativeProfile> orig,
            ProEXXboxOneControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public ProEXXboxOneControllerMacNativeProfile self;
        }
    }
