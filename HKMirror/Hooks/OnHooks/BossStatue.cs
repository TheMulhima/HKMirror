...
public static class OnBossStatue
{
    internal static class HookHandler
    {
        ...
        internal static void Hookset_StatueState()
        {
            if (!HookedList.Contains("set_StatueState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BossStatue), "set_StatueState"), set_StatueState);
            }
        }
        ...
        private static void set_StatueState(Action<BossStatue, BossStatue.Completion> orig, BossStatue self,
            BossStatue.Completion value)
        {
        ...
        internal static void Hookset_DreamStatueState()
        {
            if (!HookedList.Contains("set_DreamStatueState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BossStatue), "set_DreamStatueState"),
                    set_DreamStatueState);
            }
        }
        ...
        private static void set_DreamStatueState(Action<BossStatue, BossStatue.Completion> orig, BossStatue self,
            BossStatue.Completion value)
        {
            ...
            if (_beforeset_DreamStatueState != null)
                foreach (Delegates.set_DreamStatueState_BeforeArgs toInvoke in _beforeset_DreamStatueState
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterset_DreamStatueState != null)
                foreach (Delegates.set_DreamStatueState_AfterArgs toInvoke in _afterset_DreamStatueState
                             .GetInvocationList())
                    try
                    {
        ...
        private static void SetPlaqueState(On.BossStatue.orig_SetPlaqueState orig, BossStatue self,
            BossStatue.Completion statueState, BossStatueTrophyPlaque plaque, string playerDataKey)
        {
            Delegates.Params_SetPlaqueState @params = new()
            {
                self = self, statueState = statueState, plaque = plaque, playerDataKey = playerDataKey
            };
    ...
    public static class Delegates
    {
        ...
        public delegate void set_DreamStatueState_WithArgs(Action<BossStatue, BossStatue.Completion> orig,
            BossStatue self, BossStatue.Completion value);
        ...
        public delegate void set_StatueState_WithArgs(Action<BossStatue, BossStatue.Completion> orig, BossStatue self,
            BossStatue.Completion value);
        ...
        public delegate void SetPlaqueState_WithArgs(
            Action<BossStatue, BossStatue.Completion, BossStatueTrophyPlaque, string> orig, BossStatue self,
            BossStatue.Completion statueState, BossStatueTrophyPlaque plaque, string playerDataKey);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_StatueState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossStatue), "set_StatueState"), value);
            remove => HookEndpointManager.Remove<Delegates.set_StatueState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossStatue), "set_StatueState"), value);
        }

        public static event Delegates.set_DreamStatueState_WithArgs set_DreamStatueState
        {
            add => HookEndpointManager.Add<Delegates.set_DreamStatueState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossStatue), "set_DreamStatueState"), value);
            remove => HookEndpointManager.Remove<Delegates.set_DreamStatueState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(BossStatue), "set_DreamStatueState"), value);
        }
