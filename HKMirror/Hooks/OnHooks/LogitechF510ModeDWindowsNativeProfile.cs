...
public static class OnLogitechF510ModeDWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ModeDWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ModeDWindowsNativeProfile> orig,
            LogitechF510ModeDWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ModeDWindowsNativeProfile> orig,
            LogitechF510ModeDWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ModeDWindowsNativeProfile self;
        }
    }
