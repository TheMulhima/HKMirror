...
public static class OnPlayAnimation
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self)
        {
        ...
        internal static void HookDoPlayAnimation()
        {
            if (!HookedList.Contains("DoPlayAnimation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation),
        ...
        private static void DoPlayAnimation(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self)
        {
        ...
        internal static void HookStopAnimation()
        {
            if (!HookedList.Contains("StopAnimation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "StopAnimation",
                        true), StopAnimation);
            }
        }
        ...
        private static void StopAnimation(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self);
        ...
        public delegate void DoPlayAnimation_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self);
        ...
        public delegate void StopAnimation_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayAnimation self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoPlayAnimation_WithArgs DoPlayAnimation
        {
            add => HookEndpointManager.Add<Delegates.DoPlayAnimation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "DoPlayAnimation",
                    true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayAnimation), "OnUpdate", true),
                value);
