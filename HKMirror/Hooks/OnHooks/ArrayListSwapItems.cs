...
public static class OnArrayListSwapItems
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSwapItems), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayListSwapItems> orig,
            HutongGames.PlayMaker.Actions.ArrayListSwapItems self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSwapItems), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayListSwapItems> orig,
            HutongGames.PlayMaker.Actions.ArrayListSwapItems self)
        {
        ...
        internal static void HookdoArrayListSwap()
        {
            if (!HookedList.Contains("doArrayListSwap"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSwapItems),
                        "doArrayListSwap", true), doArrayListSwap);
            }
        }
        ...
        private static void doArrayListSwap(Action<HutongGames.PlayMaker.Actions.ArrayListSwapItems> orig,
            HutongGames.PlayMaker.Actions.ArrayListSwapItems self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListSwapItems> orig,
            HutongGames.PlayMaker.Actions.ArrayListSwapItems self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListSwapItems> orig,
            HutongGames.PlayMaker.Actions.ArrayListSwapItems self);
        ...
        public delegate void doArrayListSwap_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayListSwapItems> orig,
            HutongGames.PlayMaker.Actions.ArrayListSwapItems self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSwapItems), "Reset", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.doArrayListSwap_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSwapItems),
                    "doArrayListSwap", true), value);
            remove => HookEndpointManager.Remove<Delegates.doArrayListSwap_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayListSwapItems),
                    "doArrayListSwap", true), value);
        }
    }
