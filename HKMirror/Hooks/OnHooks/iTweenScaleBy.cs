...
public static class OniTweenScaleBy
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<iTweenScaleBy> orig, iTweenScaleBy self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<iTweenScaleBy> orig, iTweenScaleBy self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<iTweenScaleBy> orig, iTweenScaleBy self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "DoiTween"), DoiTween);
            }
        }
        ...
        private static void DoiTween(Action<iTweenScaleBy> orig, iTweenScaleBy self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoiTween_WithArgs(Action<iTweenScaleBy> orig, iTweenScaleBy self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<iTweenScaleBy> orig, iTweenScaleBy self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<iTweenScaleBy> orig, iTweenScaleBy self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<iTweenScaleBy> orig, iTweenScaleBy self);

        public sealed class Params_Reset
        {
            public iTweenScaleBy self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "OnEnter"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "OnExit"), value);
        ...
        public static event Delegates.DoiTween_WithArgs DoiTween
        {
            add => HookEndpointManager.Add<Delegates.DoiTween_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(iTweenScaleBy), "DoiTween"), value);
