...
public static class OnGUILayoutBeginVertical
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutBeginVertical), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GUILayoutBeginVertical> orig, GUILayoutBeginVertical self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutBeginVertical), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUILayoutBeginVertical> orig, GUILayoutBeginVertical self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUILayoutBeginVertical> orig, GUILayoutBeginVertical self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GUILayoutBeginVertical> orig, GUILayoutBeginVertical self);

        public sealed class Params_Reset
        {
            public GUILayoutBeginVertical self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUILayoutBeginVertical), "Reset"), value);
        ...
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUILayoutBeginVertical), "OnGUI"), value);
