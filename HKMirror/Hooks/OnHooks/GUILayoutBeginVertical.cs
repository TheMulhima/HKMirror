...
public static class OnGUILayoutBeginVertical
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutBeginVertical),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginVertical> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginVertical self)
        {
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginVertical> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginVertical self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginVertical> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginVertical self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.GUILayoutBeginVertical> orig,
            HutongGames.PlayMaker.Actions.GUILayoutBeginVertical self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutBeginVertical), "Reset",
                    true), value);
        ...
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILayoutBeginVertical), "OnGUI",
                    true), value);
