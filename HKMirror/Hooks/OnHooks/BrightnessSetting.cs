...
private static void UpdateTextValue(On.BrightnessSetting.orig_UpdateTextValue orig,BrightnessSetting self,  float value)
{
...
private static void SetBrightness(On.BrightnessSetting.orig_SetBrightness orig,BrightnessSetting self,  float value)
{
...
private static void RefreshValueFromSettings(On.BrightnessSetting.orig_RefreshValueFromSettings orig,BrightnessSetting self)
{
...
public delegate void UpdateTextValue_WithArgs (Action<BrightnessSetting,  float> orig, BrightnessSetting self,  float value);
...
public delegate void SetBrightness_WithArgs (Action<BrightnessSetting,  float> orig, BrightnessSetting self,  float value);
