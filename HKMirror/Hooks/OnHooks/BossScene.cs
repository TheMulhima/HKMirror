...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_ForceAssetUnload", true), get_ForceAssetUnload);
...
{
foreach (Delegates.get_ForceAssetUnload_BeforeArgs toInvoke in _beforeget_ForceAssetUnload.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_ForceAssetUnload_AfterArgs toInvoke in _afterget_ForceAssetUnload.GetInvocationList())
{
try
{
...
private static bool IsUnlockedSelf(On.BossScene.orig_IsUnlockedSelf orig,BossScene self,  BossSceneCheckSource source)
{
...
public delegate UnityEngine.Sprite get_DisplayIcon_AfterArgs(Params_get_DisplayIcon args, UnityEngine.Sprite ret);
public delegate UnityEngine.Sprite get_DisplayIcon_WithArgs (Func<BossScene, UnityEngine.Sprite> orig, BossScene self);
...
public delegate bool IsUnlocked_WithArgs (Func<BossScene,  BossSceneCheckSource, bool> orig, BossScene self,  BossSceneCheckSource source);
...
public delegate bool IsUnlockedSelf_WithArgs (Func<BossScene,  BossSceneCheckSource, bool> orig, BossScene self,  BossSceneCheckSource source);
}
...
{
add => HookEndpointManager.Add<Delegates.get_DisplayIcon_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_DisplayIcon", true), value);
remove => HookEndpointManager.Remove<Delegates.get_DisplayIcon_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_DisplayIcon", true), value);
}
public static event Delegates.get_ForceAssetUnload_WithArgs get_ForceAssetUnload
{
add => HookEndpointManager.Add<Delegates.get_ForceAssetUnload_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_ForceAssetUnload", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ForceAssetUnload_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_ForceAssetUnload", true), value);
}
public static event Delegates.get_Tier1Scene_WithArgs get_Tier1Scene
{
add => HookEndpointManager.Add<Delegates.get_Tier1Scene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_Tier1Scene", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Tier1Scene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_Tier1Scene", true), value);
}
public static event Delegates.get_Tier2Scene_WithArgs get_Tier2Scene
{
add => HookEndpointManager.Add<Delegates.get_Tier2Scene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_Tier2Scene", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Tier2Scene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_Tier2Scene", true), value);
}
public static event Delegates.get_Tier3Scene_WithArgs get_Tier3Scene
{
add => HookEndpointManager.Add<Delegates.get_Tier3Scene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_Tier3Scene", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Tier3Scene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossScene), "get_Tier3Scene", true), value);
}
