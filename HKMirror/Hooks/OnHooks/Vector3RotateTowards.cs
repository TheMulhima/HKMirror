...
public static class OnVector3RotateTowards
{
    ...
    public static class Delegates
    {
        ...
        public delegate void OnUpdate_WithArgs(Action<Vector3RotateTowards> orig, Vector3RotateTowards self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Vector3RotateTowards> orig, Vector3RotateTowards self);
