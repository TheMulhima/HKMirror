...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_anchor", true), set_anchor);
...
private static void set_anchor(Action<tk2dTiledSprite,  tk2dBaseSprite.Anchor> orig, tk2dTiledSprite self,  tk2dBaseSprite.Anchor value)
{
...
public delegate void set_anchor_WithArgs (Action<tk2dTiledSprite,  tk2dBaseSprite.Anchor> orig, tk2dTiledSprite self,  tk2dBaseSprite.Anchor value);
...
{
add => HookEndpointManager.Add<Delegates.set_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_anchor", true), value);
remove => HookEndpointManager.Remove<Delegates.set_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_anchor", true), value);
}
