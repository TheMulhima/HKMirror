...
public static class Ontk2dTiledSprite
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_dimensions()
        {
            if (!HookedList.Contains("get_dimensions"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_dimensions", true),
                    get_dimensions);
            }
        }
        ...
        private static UnityEngine.Vector2 get_dimensions(Func<tk2dTiledSprite, UnityEngine.Vector2> orig,
        ...
        internal static void Hookset_dimensions()
        {
            if (!HookedList.Contains("set_dimensions"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_dimensions", true),
                    set_dimensions);
            }
        }
        ...
        private static void set_dimensions(Action<tk2dTiledSprite, UnityEngine.Vector2> orig, tk2dTiledSprite self,
        ...
        internal static void Hookget_CreateBoxCollider()
        {
            if (!HookedList.Contains("get_CreateBoxCollider"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_CreateBoxCollider", true),
        ...
        internal static void Hookset_CreateBoxCollider()
        {
            if (!HookedList.Contains("set_CreateBoxCollider"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_CreateBoxCollider", true),
        ...
        private static void SetColors(On.tk2dTiledSprite.orig_SetColors orig, tk2dTiledSprite self,
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Vector2 get_dimensions_WithArgs(Func<tk2dTiledSprite, UnityEngine.Vector2> orig,
            tk2dTiledSprite self);
        ...
        public delegate void set_dimensions_WithArgs(Action<tk2dTiledSprite, UnityEngine.Vector2> orig,
            tk2dTiledSprite self, UnityEngine.Vector2 value);
        ...
        public delegate void set_CreateBoxCollider_WithArgs(Action<tk2dTiledSprite, bool> orig, tk2dTiledSprite self,
            bool value);
        ...
        public delegate void SetColors_WithArgs(Action<tk2dTiledSprite, UnityEngine.Color32[]> orig,
            tk2dTiledSprite self, UnityEngine.Color32[] dest);
        ...
        public delegate void ReshapeBounds_WithArgs(
            Action<tk2dTiledSprite, UnityEngine.Vector3, UnityEngine.Vector3> orig, tk2dTiledSprite self,
            UnityEngine.Vector3 dMin, UnityEngine.Vector3 dMax);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_dimensions_WithArgs get_dimensions
        {
            add => HookEndpointManager.Add<Delegates.get_dimensions_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_dimensions", true), value);
        ...
        public static event Delegates.set_dimensions_WithArgs set_dimensions
        {
            add => HookEndpointManager.Add<Delegates.set_dimensions_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_dimensions", true), value);
        ...
        public static event Delegates.get_CreateBoxCollider_WithArgs get_CreateBoxCollider
        {
            add => HookEndpointManager.Add<Delegates.get_CreateBoxCollider_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_CreateBoxCollider", true), value);
        ...
        public static event Delegates.set_CreateBoxCollider_WithArgs set_CreateBoxCollider
        {
            add => HookEndpointManager.Add<Delegates.set_CreateBoxCollider_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_CreateBoxCollider", true), value);
