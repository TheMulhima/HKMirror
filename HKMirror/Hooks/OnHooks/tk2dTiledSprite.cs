...
public static class Ontk2dTiledSprite
{
    internal static class HookHandler
    {
        ...
        internal static void Hookset_anchor()
        {
            if (!HookedList.Contains("set_anchor"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_anchor"), set_anchor);
            }
        }
        ...
        private static void set_anchor(Action<tk2dTiledSprite, tk2dBaseSprite.Anchor> orig, tk2dTiledSprite self,
    ...
    public static class Delegates
    {
        ...
        public delegate Vector2 get_dimensions_WithArgs(Func<tk2dTiledSprite, Vector2> orig, tk2dTiledSprite self);
        ...
        public delegate void ReshapeBounds_WithArgs(Action<tk2dTiledSprite, Vector3, Vector3> orig,
            tk2dTiledSprite self, Vector3 dMin, Vector3 dMax);
        ...
        public delegate void set_anchor_WithArgs(Action<tk2dTiledSprite, tk2dBaseSprite.Anchor> orig,
            tk2dTiledSprite self, tk2dBaseSprite.Anchor value);
        ...
        public delegate void set_dimensions_WithArgs(Action<tk2dTiledSprite, Vector2> orig, tk2dTiledSprite self,
            Vector2 value);
        ...
        public delegate void SetColors_WithArgs(Action<tk2dTiledSprite, Color32[]> orig, tk2dTiledSprite self,
            Color32[] dest);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.set_anchor_WithArgs set_anchor
        {
            add => HookEndpointManager.Add<Delegates.set_anchor_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_anchor"), value);
