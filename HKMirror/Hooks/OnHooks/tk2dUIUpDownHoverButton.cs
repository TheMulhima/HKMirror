...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "get_UseOnReleaseInsteadOfOnUp", true), get_UseOnReleaseInsteadOfOnUp);
...
private static bool get_UseOnReleaseInsteadOfOnUp(Func<tk2dUIUpDownHoverButton, bool> orig, tk2dUIUpDownHoverButton self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "get_IsOver", true), get_IsOver);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "set_IsOver", true), set_IsOver);
...
private static void set_IsOver(Action<tk2dUIUpDownHoverButton,  bool> orig, tk2dUIUpDownHoverButton self,  bool value)
{
...
private static void ButtonHoverOver(On.tk2dUIUpDownHoverButton.orig_ButtonHoverOver orig,tk2dUIUpDownHoverButton self)
{
...
private static void ButtonHoverOut(On.tk2dUIUpDownHoverButton.orig_ButtonHoverOut orig,tk2dUIUpDownHoverButton self)
{
...
private static void InternalSetUseOnReleaseInsteadOfOnUp(On.tk2dUIUpDownHoverButton.orig_InternalSetUseOnReleaseInsteadOfOnUp orig,tk2dUIUpDownHoverButton self,  bool state)
{
...
public delegate bool get_UseOnReleaseInsteadOfOnUp_WithArgs (Func<tk2dUIUpDownHoverButton, bool> orig, tk2dUIUpDownHoverButton self);
...
public delegate bool get_IsOver_WithArgs (Func<tk2dUIUpDownHoverButton, bool> orig, tk2dUIUpDownHoverButton self);
...
public delegate void set_IsOver_WithArgs (Action<tk2dUIUpDownHoverButton,  bool> orig, tk2dUIUpDownHoverButton self,  bool value);
...
public delegate void ButtonHoverOver_WithArgs (Action<tk2dUIUpDownHoverButton> orig, tk2dUIUpDownHoverButton self);
...
public delegate void ButtonHoverOut_WithArgs (Action<tk2dUIUpDownHoverButton> orig, tk2dUIUpDownHoverButton self);
...
public delegate void InternalSetUseOnReleaseInsteadOfOnUp_WithArgs (Action<tk2dUIUpDownHoverButton,  bool> orig, tk2dUIUpDownHoverButton self,  bool state);
}
...
{
add => HookEndpointManager.Add<Delegates.get_UseOnReleaseInsteadOfOnUp_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "get_UseOnReleaseInsteadOfOnUp", true), value);
remove => HookEndpointManager.Remove<Delegates.get_UseOnReleaseInsteadOfOnUp_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "get_UseOnReleaseInsteadOfOnUp", true), value);
}
public static event Delegates.get_IsOver_WithArgs get_IsOver
{
add => HookEndpointManager.Add<Delegates.get_IsOver_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "get_IsOver", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsOver_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "get_IsOver", true), value);
}
public static event Delegates.set_IsOver_WithArgs set_IsOver
{
add => HookEndpointManager.Add<Delegates.set_IsOver_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "set_IsOver", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsOver_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUIUpDownHoverButton), "set_IsOver", true), value);
}
...
public static event On.tk2dUIUpDownHoverButton.hook_InternalSetUseOnReleaseInsteadOfOnUp InternalSetUseOnReleaseInsteadOfOnUp
{
