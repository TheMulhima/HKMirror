...
public static class OnLogitechF710ModeDWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF710ModeDWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF710ModeDWindowsNativeProfile> orig,
            LogitechF710ModeDWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF710ModeDWindowsNativeProfile> orig,
            LogitechF710ModeDWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF710ModeDWindowsNativeProfile self;
        }
    }
