...
public static class OnAnimateFloatV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<AnimateFloatV2> orig, AnimateFloatV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<AnimateFloatV2> orig, AnimateFloatV2 self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<AnimateFloatV2> orig, AnimateFloatV2 self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<AnimateFloatV2> orig, AnimateFloatV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<AnimateFloatV2> orig, AnimateFloatV2 self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<AnimateFloatV2> orig, AnimateFloatV2 self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<AnimateFloatV2> orig, AnimateFloatV2 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<AnimateFloatV2> orig, AnimateFloatV2 self);

        public sealed class Params_Reset
        {
            public AnimateFloatV2 self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "OnEnter"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "OnExit"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AnimateFloatV2), "OnUpdate"), value);
