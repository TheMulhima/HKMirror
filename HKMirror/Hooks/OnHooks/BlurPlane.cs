...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_OriginalMaterial", true), get_OriginalMaterial);
...
private static UnityEngine.Material get_OriginalMaterial(Func<BlurPlane, UnityEngine.Material> orig, BlurPlane self)
{
...
{
foreach (Delegates.get_OriginalMaterial_BeforeArgs toInvoke in _beforeget_OriginalMaterial.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_OriginalMaterial_AfterArgs toInvoke in _afterget_OriginalMaterial.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "set_OriginalMaterial", true), set_OriginalMaterial);
...
private static void set_OriginalMaterial(Action<BlurPlane,  UnityEngine.Material> orig, BlurPlane self,  UnityEngine.Material value)
{
...
{
foreach (Delegates.set_OriginalMaterial_BeforeArgs toInvoke in _beforeset_OriginalMaterial.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_OriginalMaterial_AfterArgs toInvoke in _afterset_OriginalMaterial.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_BlurPlaneCount", false), get_BlurPlaneCount);
...
{
foreach (Delegates.get_BlurPlaneCount_BeforeArgs toInvoke in _beforeget_BlurPlaneCount.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_BlurPlaneCount_AfterArgs toInvoke in _afterget_BlurPlaneCount.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_ClosestBlurPlane", false), get_ClosestBlurPlane);
...
{
foreach (Delegates.get_ClosestBlurPlane_BeforeArgs toInvoke in _beforeget_ClosestBlurPlane.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_ClosestBlurPlane_AfterArgs toInvoke in _afterget_ClosestBlurPlane.GetInvocationList())
{
try
{
...
private static void SetPlaneVisibility(On.BlurPlane.orig_SetPlaneVisibility orig,BlurPlane self,  bool isVisible)
{
...
{
foreach (Delegates.SetPlaneVisibility_BeforeArgs toInvoke in _beforeSetPlaneVisibility.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPlaneVisibility_AfterArgs toInvoke in _afterSetPlaneVisibility.GetInvocationList())
{
try
{
...
private static void SetPlaneMaterial(On.BlurPlane.orig_SetPlaneMaterial orig,BlurPlane self,  UnityEngine.Material material)
{
...
public delegate UnityEngine.Material get_OriginalMaterial_AfterArgs(Params_get_OriginalMaterial args, UnityEngine.Material ret);
public delegate UnityEngine.Material get_OriginalMaterial_WithArgs (Func<BlurPlane, UnityEngine.Material> orig, BlurPlane self);
...
public delegate void set_OriginalMaterial_WithArgs (Action<BlurPlane,  UnityEngine.Material> orig, BlurPlane self,  UnityEngine.Material value);
...
public delegate void SetPlaneMaterial_WithArgs (Action<BlurPlane,  UnityEngine.Material> orig, BlurPlane self,  UnityEngine.Material material);
}
...
{
add => HookEndpointManager.Add<Delegates.get_OriginalMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_OriginalMaterial", true), value);
remove => HookEndpointManager.Remove<Delegates.get_OriginalMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_OriginalMaterial", true), value);
}
public static event Delegates.set_OriginalMaterial_WithArgs set_OriginalMaterial
{
add => HookEndpointManager.Add<Delegates.set_OriginalMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "set_OriginalMaterial", true), value);
remove => HookEndpointManager.Remove<Delegates.set_OriginalMaterial_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "set_OriginalMaterial", true), value);
}
public static event Delegates.get_BlurPlaneCount_WithArgs get_BlurPlaneCount
{
add => HookEndpointManager.Add<Delegates.get_BlurPlaneCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_BlurPlaneCount", false), value);
remove => HookEndpointManager.Remove<Delegates.get_BlurPlaneCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_BlurPlaneCount", false), value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_ClosestBlurPlane_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_ClosestBlurPlane", false), value);
remove => HookEndpointManager.Remove<Delegates.get_ClosestBlurPlane_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_ClosestBlurPlane", false), value);
}
public static event Delegates.get_PlaneZ_WithArgs get_PlaneZ
{
add => HookEndpointManager.Add<Delegates.get_PlaneZ_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_PlaneZ", true), value);
remove => HookEndpointManager.Remove<Delegates.get_PlaneZ_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BlurPlane), "get_PlaneZ", true), value);
}
