...
public static class OnMcbazelAdapterMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(McbazelAdapterMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<McbazelAdapterMacNativeProfile> orig, McbazelAdapterMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<McbazelAdapterMacNativeProfile> orig,
            McbazelAdapterMacNativeProfile self);

        public sealed class Params_Define
        {
            public McbazelAdapterMacNativeProfile self;
        }
    }
