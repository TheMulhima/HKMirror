...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BasicSpriteAnimator), "get_Length", true), get_Length);
...
private static System.Collections.IEnumerator Animate(On.BasicSpriteAnimator.orig_Animate orig,BasicSpriteAnimator self)
{
...
public delegate System.Collections.IEnumerator Animate_WithArgs (Func<BasicSpriteAnimator, System.Collections.IEnumerator> orig, BasicSpriteAnimator self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Length_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BasicSpriteAnimator), "get_Length", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Length_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BasicSpriteAnimator), "get_Length", true), value);
}
