...
public static class OnuGuiInputFieldOnEndEditEvent
{
    ...
    public static class Delegates
    {
        ...
        public delegate void DoOnEndEdit_WithArgs(Action<uGuiInputFieldOnEndEditEvent, string> orig,
            uGuiInputFieldOnEndEditEvent self, string value);
        ...
        public delegate void OnEnter_WithArgs(Action<uGuiInputFieldOnEndEditEvent> orig,
            uGuiInputFieldOnEndEditEvent self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiInputFieldOnEndEditEvent> orig,
            uGuiInputFieldOnEndEditEvent self);
        ...
        public delegate void Reset_WithArgs(Action<uGuiInputFieldOnEndEditEvent> orig,
            uGuiInputFieldOnEndEditEvent self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoOnEndEdit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldOnEndEditEvent), "DoOnEndEdit"), value);
            remove => HookEndpointManager.Remove<Delegates.DoOnEndEdit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiInputFieldOnEndEditEvent), "DoOnEndEdit"), value);
        }
    }
}