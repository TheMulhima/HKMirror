...
public static class OnPlayRandomAnimation
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self)
        {
        ...
        internal static void HookDoPlayRandomAnimation()
        {
            if (!HookedList.Contains("DoPlayRandomAnimation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation),
                        "DoPlayRandomAnimation", true), DoPlayRandomAnimation);
            }
        }
        ...
        private static void DoPlayRandomAnimation(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self)
        {
        ...
        internal static void HookDoPlayAnimation()
        {
            if (!HookedList.Contains("DoPlayAnimation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation),
                        "DoPlayAnimation", true), DoPlayAnimation);
            }
        }
        ...
        private static void DoPlayAnimation(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation, string> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self, string animName)
        {
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self)
        {
        ...
        internal static void HookStopAnimation()
        {
            if (!HookedList.Contains("StopAnimation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation),
                        "StopAnimation", true), StopAnimation);
            }
        }
        ...
        private static void StopAnimation(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self);
        ...
        public delegate void DoPlayRandomAnimation_WithArgs(
            Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self);
        ...
        public delegate void DoPlayAnimation_WithArgs(
            Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation, string> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self, string animName);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self);
        ...
        public delegate void StopAnimation_WithArgs(Action<HutongGames.PlayMaker.Actions.PlayRandomAnimation> orig,
            HutongGames.PlayMaker.Actions.PlayRandomAnimation self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoPlayRandomAnimation_WithArgs DoPlayRandomAnimation
        {
            add => HookEndpointManager.Add<Delegates.DoPlayRandomAnimation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation),
                    "DoPlayRandomAnimation", true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.PlayRandomAnimation), "OnUpdate",
                    true), value);
