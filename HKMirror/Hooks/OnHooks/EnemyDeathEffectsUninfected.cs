...
/// <summary>
/// Contains different types of On Hooks for EnemyDeathEffectsUninfected class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnEnemyDeathEffectsUninfected
{
...
On.EnemyDeathEffectsUninfected.EmitEffects += EmitEffects;
...
private static void EmitEffects(On.EnemyDeathEffectsUninfected.orig_EmitEffects orig,EnemyDeathEffectsUninfected self)
{
...
{
public EnemyDeathEffectsUninfected self;
}
...
public delegate void EmitEffects_WithArgs (Action<EnemyDeathEffectsUninfected> orig, EnemyDeathEffectsUninfected self);
}
...
{
public static event On.EnemyDeathEffectsUninfected.hook_EmitEffects EmitEffects
{
add => On.EnemyDeathEffectsUninfected.EmitEffects += value;
remove => On.EnemyDeathEffectsUninfected.EmitEffects -= value;
}
}
