...
public static class OnGetNextChild
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextChild), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetNextChild> orig,
            HutongGames.PlayMaker.Actions.GetNextChild self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextChild), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetNextChild> orig,
            HutongGames.PlayMaker.Actions.GetNextChild self)
        {
        ...
        internal static void HookDoGetNextChild()
        {
            if (!HookedList.Contains("DoGetNextChild"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextChild), "DoGetNextChild",
                        true), DoGetNextChild);
            }
        }
        ...
        private static void DoGetNextChild(
            Action<HutongGames.PlayMaker.Actions.GetNextChild, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.GetNextChild self, UnityEngine.GameObject parent)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNextChild> orig,
            HutongGames.PlayMaker.Actions.GetNextChild self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNextChild> orig,
            HutongGames.PlayMaker.Actions.GetNextChild self);
        ...
        public delegate void DoGetNextChild_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetNextChild, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.GetNextChild self, UnityEngine.GameObject parent);
    }
