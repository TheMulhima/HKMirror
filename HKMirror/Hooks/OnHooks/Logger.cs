...
public static class OnLogger
{
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.LogInfo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.Logger), "LogInfo", false), value);
            remove => HookEndpointManager.Remove<Delegates.LogInfo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.Logger), "LogInfo", false), value);
        }
        ...
        public static event Delegates.LogWarning_WithArgs LogWarning
        {
            add => HookEndpointManager.Add<Delegates.LogWarning_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.Logger), "LogWarning", false), value);
        ...
        public static event Delegates.LogError_WithArgs LogError
        {
            add => HookEndpointManager.Add<Delegates.LogError_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.Logger), "LogError", false), value);
