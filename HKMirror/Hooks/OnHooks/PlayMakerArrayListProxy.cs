...
new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayMakerArrayListProxy), "get_arrayList", true), get_arrayList);
...
private static System.Collections.ArrayList get_arrayList(Func<PlayMakerArrayListProxy, System.Collections.ArrayList> orig, PlayMakerArrayListProxy self)
{
...
private static bool isCollectionDefined(On.PlayMakerArrayListProxy.orig_isCollectionDefined orig,PlayMakerArrayListProxy self)
{
...
{
foreach (Delegates.isCollectionDefined_BeforeArgs toInvoke in _beforeisCollectionDefined.GetInvocationList())
{
try
{
...
{
foreach (Delegates.isCollectionDefined_AfterArgs toInvoke in _afterisCollectionDefined.GetInvocationList())
{
try
{
...
private static void TakeSnapShot(On.PlayMakerArrayListProxy.orig_TakeSnapShot orig,PlayMakerArrayListProxy self)
{
...
private static void RevertToSnapShot(On.PlayMakerArrayListProxy.orig_RevertToSnapShot orig,PlayMakerArrayListProxy self)
{
...
private static void Add(On.PlayMakerArrayListProxy.orig_Add orig,PlayMakerArrayListProxy self,  System.Object value,  string type,  bool silent)
{
...
private static int AddRange(On.PlayMakerArrayListProxy.orig_AddRange orig,PlayMakerArrayListProxy self,  System.Collections.ICollection collection,  string type)
{
...
private static void InspectorEdit(On.PlayMakerArrayListProxy.orig_InspectorEdit orig,PlayMakerArrayListProxy self,  int index)
{
...
private static void Set(On.PlayMakerArrayListProxy.orig_Set orig,PlayMakerArrayListProxy self,  int index,  System.Object value,  string type)
{
...
private static bool Remove(On.PlayMakerArrayListProxy.orig_Remove orig,PlayMakerArrayListProxy self,  System.Object value,  string type,  bool silent)
{
...
private static void PreFillArrayList(On.PlayMakerArrayListProxy.orig_PreFillArrayList orig,PlayMakerArrayListProxy self)
{
...
public delegate System.Collections.ArrayList get_arrayList_AfterArgs(Params_get_arrayList args, System.Collections.ArrayList ret);
public delegate System.Collections.ArrayList get_arrayList_WithArgs (Func<PlayMakerArrayListProxy, System.Collections.ArrayList> orig, PlayMakerArrayListProxy self);
...
public delegate bool isCollectionDefined_WithArgs (Func<PlayMakerArrayListProxy, bool> orig, PlayMakerArrayListProxy self);
...
public delegate void RevertToSnapShot_WithArgs (Action<PlayMakerArrayListProxy> orig, PlayMakerArrayListProxy self);
...
public delegate void Add_WithArgs (Action<PlayMakerArrayListProxy,  System.Object,  string,  bool> orig, PlayMakerArrayListProxy self,  System.Object value,  string type,  bool silent);
public sealed class Params_AddRange
{
public PlayMakerArrayListProxy self;
public System.Collections.ICollection collection;
public string type;
}
...
public delegate int AddRange_WithArgs (Func<PlayMakerArrayListProxy,  System.Collections.ICollection,  string, int> orig, PlayMakerArrayListProxy self,  System.Collections.ICollection collection,  string type);
...
public delegate void InspectorEdit_WithArgs (Action<PlayMakerArrayListProxy,  int> orig, PlayMakerArrayListProxy self,  int index);
...
public delegate void Set_WithArgs (Action<PlayMakerArrayListProxy,  int,  System.Object,  string> orig, PlayMakerArrayListProxy self,  int index,  System.Object value,  string type);
...
public delegate bool Remove_WithArgs (Func<PlayMakerArrayListProxy,  System.Object,  string,  bool, bool> orig, PlayMakerArrayListProxy self,  System.Object value,  string type,  bool silent);
...
public delegate void PreFillArrayList_WithArgs (Action<PlayMakerArrayListProxy> orig, PlayMakerArrayListProxy self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_arrayList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PlayMakerArrayListProxy), "get_arrayList", true), value);
remove => HookEndpointManager.Remove<Delegates.get_arrayList_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PlayMakerArrayListProxy), "get_arrayList", true), value);
}
