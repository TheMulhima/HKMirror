...
public static class OnRemoveMixingTransform
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RemoveMixingTransform), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RemoveMixingTransform> orig,
            HutongGames.PlayMaker.Actions.RemoveMixingTransform self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RemoveMixingTransform),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RemoveMixingTransform> orig,
            HutongGames.PlayMaker.Actions.RemoveMixingTransform self)
        {
        ...
        internal static void HookDoRemoveMixingTransform()
        {
            if (!HookedList.Contains("DoRemoveMixingTransform"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RemoveMixingTransform),
                        "DoRemoveMixingTransform", true), DoRemoveMixingTransform);
            }
        }
        ...
        private static void DoRemoveMixingTransform(Action<HutongGames.PlayMaker.Actions.RemoveMixingTransform> orig,
            HutongGames.PlayMaker.Actions.RemoveMixingTransform self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.RemoveMixingTransform> orig,
            HutongGames.PlayMaker.Actions.RemoveMixingTransform self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.RemoveMixingTransform> orig,
            HutongGames.PlayMaker.Actions.RemoveMixingTransform self);
        ...
        public delegate void DoRemoveMixingTransform_WithArgs(
            Action<HutongGames.PlayMaker.Actions.RemoveMixingTransform> orig,
            HutongGames.PlayMaker.Actions.RemoveMixingTransform self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RemoveMixingTransform), "OnEnter",
                    true), value);
        ...
        public static event Delegates.DoRemoveMixingTransform_WithArgs DoRemoveMixingTransform
        {
            add => HookEndpointManager.Add<Delegates.DoRemoveMixingTransform_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RemoveMixingTransform),
                    "DoRemoveMixingTransform", true), value);
