...
public static class OnMadCatzFightPadMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzFightPadMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MadCatzFightPadMacNativeProfile> orig, MadCatzFightPadMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzFightPadMacNativeProfile> orig,
            MadCatzFightPadMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzFightPadMacNativeProfile self;
        }
    }
