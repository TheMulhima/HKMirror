...
public static class OnNaconGC100XFControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.NaconGC100XFControllerMacNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.NaconGC100XFControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.NaconGC100XFControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.NaconGC100XFControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.NaconGC100XFControllerMacNativeProfile self);
    }
