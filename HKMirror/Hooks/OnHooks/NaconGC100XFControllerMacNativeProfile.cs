...
public static class OnNaconGC100XFControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NaconGC100XFControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<NaconGC100XFControllerMacNativeProfile> orig,
            NaconGC100XFControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NaconGC100XFControllerMacNativeProfile> orig,
            NaconGC100XFControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public NaconGC100XFControllerMacNativeProfile self;
        }
    }
