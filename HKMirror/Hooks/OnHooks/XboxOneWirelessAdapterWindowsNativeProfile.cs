...
public static class OnXboxOneWirelessAdapterWindowsNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.XboxOneWirelessAdapterWindowsNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.XboxOneWirelessAdapterWindowsNativeProfile> orig,
            InControl.NativeDeviceProfiles.XboxOneWirelessAdapterWindowsNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.XboxOneWirelessAdapterWindowsNativeProfile), "Define", true),
                value);
