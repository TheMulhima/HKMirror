...
public static class OnBrightnessEffect
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.SetContrast_NormalArgs _afterSetContrast;
        ...
        private static void SetContrast(On.BrightnessEffect.orig_SetContrast orig, BrightnessEffect self, float value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterSetContrast != null) _afterSetContrast.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void SetContrast_NormalArgs(Params_SetContrast args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.SetContrast_NormalArgs SetContrast
        {
            add
            {
