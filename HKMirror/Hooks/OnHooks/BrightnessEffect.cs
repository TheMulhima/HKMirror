...
private static void OnRenderImage(On.BrightnessEffect.orig_OnRenderImage orig,BrightnessEffect self,  UnityEngine.RenderTexture source,  UnityEngine.RenderTexture destination)
{
...
private static void SetBrightness(On.BrightnessEffect.orig_SetBrightness orig,BrightnessEffect self,  float value)
{
...
public delegate void OnRenderImage_WithArgs (Action<BrightnessEffect,  UnityEngine.RenderTexture,  UnityEngine.RenderTexture> orig, BrightnessEffect self,  UnityEngine.RenderTexture source,  UnityEngine.RenderTexture destination);
...
public delegate void SetBrightness_WithArgs (Action<BrightnessEffect,  float> orig, BrightnessEffect self,  float value);
...
public delegate void SetContrast_WithArgs (Action<BrightnessEffect,  float> orig, BrightnessEffect self,  float value);
}
