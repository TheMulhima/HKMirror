...
public static class OnRaycast
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Raycast), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Raycast), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Raycast), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self)
        {
        ...
        internal static void HookDoRaycast()
        {
            if (!HookedList.Contains("DoRaycast"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Raycast), "DoRaycast", true),
                    DoRaycast);
            }
        }
        ...
        private static void DoRaycast(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self);
        ...
        public delegate void DoRaycast_WithArgs(Action<HutongGames.PlayMaker.Actions.Raycast> orig,
            HutongGames.PlayMaker.Actions.Raycast self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Raycast), "Reset", true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Raycast), "OnEnter", true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Raycast), "OnUpdate", true), value);
