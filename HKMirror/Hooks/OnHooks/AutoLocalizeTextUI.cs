...
private static void RefreshTextFromLocalization(On.AutoLocalizeTextUI.orig_RefreshTextFromLocalization orig,AutoLocalizeTextUI self)
{
...
{
foreach (Delegates.RefreshTextFromLocalization_BeforeArgs toInvoke in _beforeRefreshTextFromLocalization.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshTextFromLocalization_AfterArgs toInvoke in _afterRefreshTextFromLocalization.GetInvocationList())
{
try
{
...
public delegate void RefreshTextFromLocalization_WithArgs (Action<AutoLocalizeTextUI> orig, AutoLocalizeTextUI self);
}
