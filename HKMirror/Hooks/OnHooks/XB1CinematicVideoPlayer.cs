...
new Hook(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_Volume", true), get_Volume);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "set_Volume", true), set_Volume);
...
private static void set_Volume(Action<XB1CinematicVideoPlayer,  float> orig, XB1CinematicVideoPlayer self,  float value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsLoading", true), get_IsLoading);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsLooping", true), get_IsLooping);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "set_IsLooping", true), set_IsLooping);
...
private static void set_IsLooping(Action<XB1CinematicVideoPlayer,  bool> orig, XB1CinematicVideoPlayer self,  bool value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsPlaying", true), get_IsPlaying);
...
private static void OnPrepareCompleted(On.XB1CinematicVideoPlayer.orig_OnPrepareCompleted orig,XB1CinematicVideoPlayer self,  UnityEngine.Video.VideoPlayer source)
{
...
{
foreach (Delegates.OnPrepareCompleted_BeforeArgs toInvoke in _beforeOnPrepareCompleted.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnPrepareCompleted_AfterArgs toInvoke in _afterOnPrepareCompleted.GetInvocationList())
{
try
{
...
public delegate float get_Volume_WithArgs (Func<XB1CinematicVideoPlayer, float> orig, XB1CinematicVideoPlayer self);
...
public delegate void set_Volume_WithArgs (Action<XB1CinematicVideoPlayer,  float> orig, XB1CinematicVideoPlayer self,  float value);
...
public delegate bool get_IsLoading_WithArgs (Func<XB1CinematicVideoPlayer, bool> orig, XB1CinematicVideoPlayer self);
...
public delegate bool get_IsLooping_WithArgs (Func<XB1CinematicVideoPlayer, bool> orig, XB1CinematicVideoPlayer self);
...
public delegate void set_IsLooping_WithArgs (Action<XB1CinematicVideoPlayer,  bool> orig, XB1CinematicVideoPlayer self,  bool value);
...
public delegate bool get_IsPlaying_WithArgs (Func<XB1CinematicVideoPlayer, bool> orig, XB1CinematicVideoPlayer self);
...
public delegate void OnPrepareCompleted_WithArgs (Action<XB1CinematicVideoPlayer,  UnityEngine.Video.VideoPlayer> orig, XB1CinematicVideoPlayer self,  UnityEngine.Video.VideoPlayer source);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_Volume", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_Volume", true), value);
}
public static event Delegates.set_Volume_WithArgs set_Volume
{
add => HookEndpointManager.Add<Delegates.set_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "set_Volume", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Volume_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "set_Volume", true), value);
}
public static event Delegates.get_IsLoading_WithArgs get_IsLoading
{
add => HookEndpointManager.Add<Delegates.get_IsLoading_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsLoading", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsLoading_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsLoading", true), value);
}
public static event Delegates.get_IsLooping_WithArgs get_IsLooping
{
add => HookEndpointManager.Add<Delegates.get_IsLooping_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsLooping", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsLooping_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsLooping", true), value);
}
public static event Delegates.set_IsLooping_WithArgs set_IsLooping
{
add => HookEndpointManager.Add<Delegates.set_IsLooping_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "set_IsLooping", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsLooping_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "set_IsLooping", true), value);
}
public static event Delegates.get_IsPlaying_WithArgs get_IsPlaying
{
add => HookEndpointManager.Add<Delegates.get_IsPlaying_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsPlaying", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsPlaying_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(XB1CinematicVideoPlayer), "get_IsPlaying", true), value);
}
