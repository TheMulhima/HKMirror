...
public static class OnRazerWildcatControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RazerWildcatControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RazerWildcatControllerMacNativeProfile> orig,
            RazerWildcatControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerWildcatControllerMacNativeProfile> orig,
            RazerWildcatControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public RazerWildcatControllerMacNativeProfile self;
        }
    }
