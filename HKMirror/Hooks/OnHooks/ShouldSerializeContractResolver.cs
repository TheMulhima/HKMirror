...
public static class OnShouldSerializeContractResolver
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.CreateProperty_NormalArgs _afterCreateProperty;
            ...
            ShouldSerializeContractResolver self, MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            if (_afterCreateProperty != null) retVal = _afterCreateProperty.Invoke(@params);
            return retVal;
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate JsonProperty CreateProperty_NormalArgs(Params_CreateProperty args);
    ...
    {
        public static event Delegates.CreateProperty_NormalArgs CreateProperty
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.CreateProperty_NormalArgs CreateProperty
        {
            add => HookEndpointManager.Add<Delegates.CreateProperty_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ShouldSerializeContractResolver), "CreateProperty"), value);
            remove => HookEndpointManager.Remove<Delegates.CreateProperty_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ShouldSerializeContractResolver), "CreateProperty"), value);
        }
    }
}