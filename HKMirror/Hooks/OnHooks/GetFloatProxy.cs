...
public static class OnGetFloatProxy
{
    ...
    public static class Delegates
    {
        ...
        public delegate float EndInvoke_WithArgs(Func<GetFloatProxy, IAsyncResult, float> orig, GetFloatProxy self,
            IAsyncResult result);
        ...
        public delegate float Invoke_WithArgs(Func<GetFloatProxy, string, float, float> orig, GetFloatProxy self,
            string name, float orig_);
