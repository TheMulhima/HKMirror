...
public static class Ontk2dUIToggleButtonGroup
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_ToggleBtns()
        {
            if (!HookedList.Contains("get_ToggleBtns"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_ToggleBtns", true),
                    get_ToggleBtns);
            }
        }
        ...
        internal static void Hookget_SelectedIndex()
        {
            if (!HookedList.Contains("get_SelectedIndex"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_SelectedIndex", true),
                    get_SelectedIndex);
            }
        }
        ...
        private static int get_SelectedIndex(Func<tk2dUIToggleButtonGroup, int> orig, tk2dUIToggleButtonGroup self)
        {
            ...
            {
                foreach (Delegates.get_SelectedIndex_BeforeArgs toInvoke in
                         _beforeget_SelectedIndex.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_SelectedIndex()
        {
            if (!HookedList.Contains("set_SelectedIndex"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "set_SelectedIndex", true),
                    set_SelectedIndex);
            }
        }
            ...
            int value)
        {
            ...
            {
                foreach (Delegates.set_SelectedIndex_BeforeArgs toInvoke in
                         _beforeset_SelectedIndex.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_SelectedToggleButton()
        {
            if (!HookedList.Contains("get_SelectedToggleButton"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_SelectedToggleButton", true),
            ...
            Func<tk2dUIToggleButtonGroup, tk2dUIToggleButton> orig, tk2dUIToggleButtonGroup self)
        {
            ...
            {
                foreach (Delegates.get_SelectedToggleButton_BeforeArgs toInvoke in _beforeget_SelectedToggleButton
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_SelectedToggleButton_AfterArgs toInvoke in _afterget_SelectedToggleButton
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_SelectedToggleButton()
        {
            if (!HookedList.Contains("set_SelectedToggleButton"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "set_SelectedToggleButton", true),
            ...
            tk2dUIToggleButtonGroup self, tk2dUIToggleButton value)
        {
            ...
            {
                foreach (Delegates.set_SelectedToggleButton_BeforeArgs toInvoke in _beforeset_SelectedToggleButton
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_SelectedToggleButton_AfterArgs toInvoke in _afterset_SelectedToggleButton
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIToggleButtonGroup self, tk2dUIToggleButton[] newToggleBtns)
        {
            ...
            {
                foreach (Delegates.AddNewToggleButtons_BeforeArgs toInvoke in _beforeAddNewToggleButtons
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.AddNewToggleButtons_AfterArgs toInvoke in
                         _afterAddNewToggleButtons.GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIToggleButtonGroup self)
        {
            ...
            {
                foreach (Delegates.ClearExistingToggleBtns_BeforeArgs toInvoke in _beforeClearExistingToggleBtns
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ClearExistingToggleBtns_AfterArgs toInvoke in _afterClearExistingToggleBtns
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.SetToggleButtonUsingSelectedIndex_AfterArgs
            ...
            On.tk2dUIToggleButtonGroup.orig_SetToggleButtonUsingSelectedIndex orig, tk2dUIToggleButtonGroup self)
        {
            ...
            {
                foreach (Delegates.SetToggleButtonUsingSelectedIndex_BeforeArgs toInvoke in
                         _beforeSetToggleButtonUsingSelectedIndex.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SetToggleButtonUsingSelectedIndex_AfterArgs toInvoke in
                         _afterSetToggleButtonUsingSelectedIndex.GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.SetSelectedIndexFromSelectedToggleButton_AfterArgs
            ...
            On.tk2dUIToggleButtonGroup.orig_SetSelectedIndexFromSelectedToggleButton orig, tk2dUIToggleButtonGroup self)
        {
            ...
            {
                foreach (Delegates.SetSelectedIndexFromSelectedToggleButton_BeforeArgs toInvoke in
                         _beforeSetSelectedIndexFromSelectedToggleButton.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SetSelectedIndexFromSelectedToggleButton_AfterArgs toInvoke in
                         _afterSetSelectedIndexFromSelectedToggleButton.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate tk2dUIToggleButton[] get_ToggleBtns_AfterArgs(Params_get_ToggleBtns args,
            tk2dUIToggleButton[] ret);

        public delegate tk2dUIToggleButton[] get_ToggleBtns_WithArgs(
            Func<tk2dUIToggleButtonGroup, tk2dUIToggleButton[]> orig, tk2dUIToggleButtonGroup self);
        ...
        public delegate int get_SelectedIndex_WithArgs(Func<tk2dUIToggleButtonGroup, int> orig,
            tk2dUIToggleButtonGroup self);
        ...
        public delegate void set_SelectedIndex_WithArgs(Action<tk2dUIToggleButtonGroup, int> orig,
            tk2dUIToggleButtonGroup self, int value);
        ...
        public delegate tk2dUIToggleButton get_SelectedToggleButton_AfterArgs(Params_get_SelectedToggleButton args,
            tk2dUIToggleButton ret);

        public delegate tk2dUIToggleButton get_SelectedToggleButton_WithArgs(
            Func<tk2dUIToggleButtonGroup, tk2dUIToggleButton> orig, tk2dUIToggleButtonGroup self);
        ...
        public delegate void set_SelectedToggleButton_WithArgs(Action<tk2dUIToggleButtonGroup, tk2dUIToggleButton> orig,
            tk2dUIToggleButtonGroup self, tk2dUIToggleButton value);
        ...
        public delegate void AddNewToggleButtons_WithArgs(Action<tk2dUIToggleButtonGroup, tk2dUIToggleButton[]> orig,
            tk2dUIToggleButtonGroup self, tk2dUIToggleButton[] newToggleBtns);
        ...
        public delegate void ClearExistingToggleBtns_WithArgs(Action<tk2dUIToggleButtonGroup> orig,
            tk2dUIToggleButtonGroup self);
        ...
        public delegate void SetToggleButtonUsingSelectedIndex_WithArgs(Action<tk2dUIToggleButtonGroup> orig,
            tk2dUIToggleButtonGroup self);
        ...
        public delegate void ButtonToggle_WithArgs(Action<tk2dUIToggleButtonGroup, tk2dUIToggleButton> orig,
            tk2dUIToggleButtonGroup self, tk2dUIToggleButton toggleButton);
        ...
        public delegate void SetSelectedIndexFromSelectedToggleButton_AfterArgs(
            Params_SetSelectedIndexFromSelectedToggleButton args);

        public delegate void SetSelectedIndexFromSelectedToggleButton_WithArgs(Action<tk2dUIToggleButtonGroup> orig,
            tk2dUIToggleButtonGroup self);
    }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.SetSelectedIndexFromSelectedToggleButton_AfterArgs
            SetSelectedIndexFromSelectedToggleButton
            {
                add
                {
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_ToggleBtns_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_ToggleBtns", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_ToggleBtns_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_ToggleBtns", true), value);
        }

        public static event Delegates.get_SelectedIndex_WithArgs get_SelectedIndex
        {
            add => HookEndpointManager.Add<Delegates.get_SelectedIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_SelectedIndex", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_SelectedIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_SelectedIndex", true), value);
        }

        public static event Delegates.set_SelectedIndex_WithArgs set_SelectedIndex
        {
            add => HookEndpointManager.Add<Delegates.set_SelectedIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "set_SelectedIndex", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_SelectedIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "set_SelectedIndex", true), value);
        }

        public static event Delegates.get_SelectedToggleButton_WithArgs get_SelectedToggleButton
        {
            add => HookEndpointManager.Add<Delegates.get_SelectedToggleButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_SelectedToggleButton", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_SelectedToggleButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "get_SelectedToggleButton", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_SelectedToggleButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "set_SelectedToggleButton", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_SelectedToggleButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIToggleButtonGroup), "set_SelectedToggleButton", true),
                value);
        }
