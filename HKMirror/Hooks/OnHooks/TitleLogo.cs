...
public static class OnTitleLogo
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.AnimationFinished_NormalArgs _afterAnimationFinished;
        ...
        private static void AnimationFinished(On.TitleLogo.orig_AnimationFinished orig, TitleLogo self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterAnimationFinished != null) _afterAnimationFinished.Invoke(@params);
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void AnimationFinished_NormalArgs(Params_AnimationFinished args);
    ...
    {
        public static event Delegates.AnimationFinished_NormalArgs AnimationFinished
        {
            add
            {
