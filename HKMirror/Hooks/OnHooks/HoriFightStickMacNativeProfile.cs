...
public static class OnHoriFightStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriFightStickMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HoriFightStickMacNativeProfile> orig, HoriFightStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriFightStickMacNativeProfile> orig,
            HoriFightStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriFightStickMacNativeProfile self;
        }
    }
