...
public static class OnEightBitdoSNES30MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSNES30MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSNES30MacNativeProfile> orig, EightBitdoSNES30MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSNES30MacNativeProfile> orig,
            EightBitdoSNES30MacNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSNES30MacNativeProfile self;
        }
    }
