...
public static class OnKiwitataNESWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(KiwitataNESWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<KiwitataNESWindowsNativeProfile> orig, KiwitataNESWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<KiwitataNESWindowsNativeProfile> orig,
            KiwitataNESWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public KiwitataNESWindowsNativeProfile self;
        }
    }
