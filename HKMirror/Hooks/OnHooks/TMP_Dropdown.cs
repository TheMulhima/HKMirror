...
private static void set_options(Action<TMPro.TMP_Dropdown,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData>> orig, TMPro.TMP_Dropdown self,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData> value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "set_onValueChanged", true), set_onValueChanged);
...
private static void set_onValueChanged(Action<TMPro.TMP_Dropdown,  TMPro.TMP_Dropdown.DropdownEvent> orig, TMPro.TMP_Dropdown self,  TMPro.TMP_Dropdown.DropdownEvent value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "AddOptions_OptionData", true), AddOptions_OptionData);
...
private static void AddOptions_OptionData(Action<TMPro.TMP_Dropdown,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData>> orig, TMPro.TMP_Dropdown self,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData> options)
{
...
{
foreach (Delegates.AddOptions_OptionData_BeforeArgs toInvoke in _beforeAddOptions_OptionData.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddOptions_OptionData_AfterArgs toInvoke in _afterAddOptions_OptionData.GetInvocationList())
{
try
{
...
internal static void HookDestroyItem()
{
if (!HookedList.Contains("DestroyItem"))
{
HookedList.Add("DestroyItem");
new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "DestroyItem", true), DestroyItem);

}
}
internal static event Delegates.DestroyItem_BeforeArgs _beforeDestroyItem;
internal static event Delegates.DestroyItem_AfterArgs _afterDestroyItem;
private static void DestroyItem(Action<TMPro.TMP_Dropdown,  TMPro.TMP_Dropdown.DropdownItem> orig, TMPro.TMP_Dropdown self,  TMPro.TMP_Dropdown.DropdownItem item)
{
Delegates.Params_DestroyItem @params = new() 
{
self = self
, item = item
};
if (_beforeDestroyItem != null)
{
foreach (Delegates.DestroyItem_BeforeArgs toInvoke in _beforeDestroyItem.GetInvocationList())
{
try
{
_beforeDestroyItem?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
item = @params.item;
orig(self, item);
if (_afterDestroyItem != null)
{
foreach (Delegates.DestroyItem_AfterArgs toInvoke in _afterDestroyItem.GetInvocationList())
{
try
{
_afterDestroyItem.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
public delegate void set_options_WithArgs (Action<TMPro.TMP_Dropdown,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData>> orig, TMPro.TMP_Dropdown self,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData> value);
...
public delegate void set_onValueChanged_WithArgs (Action<TMPro.TMP_Dropdown,  TMPro.TMP_Dropdown.DropdownEvent> orig, TMPro.TMP_Dropdown self,  TMPro.TMP_Dropdown.DropdownEvent value);
...
public delegate void AddOptions_OptionData_WithArgs (Action<TMPro.TMP_Dropdown,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData>> orig, TMPro.TMP_Dropdown self,  System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData> options);
...
public sealed class Params_DestroyItem
{
public TMPro.TMP_Dropdown self;
public TMPro.TMP_Dropdown.DropdownItem item;
}
public delegate void DestroyItem_BeforeArgs(Params_DestroyItem args);
public delegate void DestroyItem_AfterArgs(Params_DestroyItem args);
public delegate void DestroyItem_WithArgs (Action<TMPro.TMP_Dropdown,  TMPro.TMP_Dropdown.DropdownItem> orig, TMPro.TMP_Dropdown self,  TMPro.TMP_Dropdown.DropdownItem item);
...
public static event Delegates.DestroyItem_BeforeArgs DestroyItem
{
add
{

HookHandler._beforeDestroyItem += value;
HookHandler.HookDestroyItem();
}
remove => HookHandler._beforeDestroyItem -= value;
}
...
public static event Delegates.DestroyItem_AfterArgs DestroyItem
{
add
{

HookHandler._afterDestroyItem += value;
HookHandler.HookDestroyItem();
}
remove => HookHandler._afterDestroyItem -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.set_options_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "set_options", true), value);
remove => HookEndpointManager.Remove<Delegates.set_options_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "set_options", true), value);
}
public static event Delegates.set_onValueChanged_WithArgs set_onValueChanged
{
add => HookEndpointManager.Add<Delegates.set_onValueChanged_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "set_onValueChanged", true), value);
remove => HookEndpointManager.Remove<Delegates.set_onValueChanged_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "set_onValueChanged", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.AddOptions_OptionData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "AddOptions", true), value);
remove => HookEndpointManager.Remove<Delegates.AddOptions_OptionData_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "AddOptions", true), value);
}
...
public static event Delegates.DestroyItem_WithArgs DestroyItem
{
add => HookEndpointManager.Add<Delegates.DestroyItem_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "DestroyItem", true), value);
remove => HookEndpointManager.Remove<Delegates.DestroyItem_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_Dropdown), "DestroyItem", true), value);
}
