...
public static class OnMadCatzSF4FightStickSEMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzSF4FightStickSEMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzSF4FightStickSEMacNativeProfile> orig,
            MadCatzSF4FightStickSEMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzSF4FightStickSEMacNativeProfile> orig,
            MadCatzSF4FightStickSEMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzSF4FightStickSEMacNativeProfile self;
        }
    }
