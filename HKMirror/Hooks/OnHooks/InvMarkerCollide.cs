...
/// <summary>
/// Contains different types of On Hooks for InvMarkerCollide class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnInvMarkerCollide
{
...
On.InvMarkerCollide.OnTriggerEnter2D += OnTriggerEnter2D;

}
}
internal static event Delegates.OnTriggerEnter2D_BeforeArgs _beforeOnTriggerEnter2D;
internal static event Delegates.OnTriggerEnter2D_AfterArgs _afterOnTriggerEnter2D;
private static void OnTriggerEnter2D(On.InvMarkerCollide.orig_OnTriggerEnter2D orig,InvMarkerCollide self,  UnityEngine.Collider2D collision)
{
...
On.InvMarkerCollide.OnTriggerExit2D += OnTriggerExit2D;
...
private static void OnTriggerExit2D(On.InvMarkerCollide.orig_OnTriggerExit2D orig,InvMarkerCollide self,  UnityEngine.Collider2D collision)
{
...
public delegate void OnTriggerEnter2D_WithArgs (Action<InvMarkerCollide,  UnityEngine.Collider2D> orig, InvMarkerCollide self,  UnityEngine.Collider2D collision);
...
public delegate void OnTriggerExit2D_WithArgs (Action<InvMarkerCollide,  UnityEngine.Collider2D> orig, InvMarkerCollide self,  UnityEngine.Collider2D collision);
}
...
{
public static event On.InvMarkerCollide.hook_OnTriggerEnter2D OnTriggerEnter2D
{
add => On.InvMarkerCollide.OnTriggerEnter2D += value;
remove => On.InvMarkerCollide.OnTriggerEnter2D -= value;
}
public static event On.InvMarkerCollide.hook_OnTriggerExit2D OnTriggerExit2D
{
add => On.InvMarkerCollide.OnTriggerExit2D += value;
remove => On.InvMarkerCollide.OnTriggerExit2D -= value;
}
}
