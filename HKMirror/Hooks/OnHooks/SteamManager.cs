...
new Hook(ReflectionHelper.GetMethodInfo(typeof(SteamManager), "get_Initialized", false), get_Initialized);
...
private static void SteamAPIDebugTextHook(On.SteamManager.orig_SteamAPIDebugTextHook orig, int nSeverity,  System.Text.StringBuilder pchDebugText)
{
Delegates.Params_SteamAPIDebugTextHook @params = new() 
{
nSeverity = nSeverity
, pchDebugText = pchDebugText
};
if (_beforeSteamAPIDebugTextHook != null)
{
foreach (Delegates.SteamAPIDebugTextHook_BeforeArgs toInvoke in _beforeSteamAPIDebugTextHook.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SteamAPIDebugTextHook_AfterArgs toInvoke in _afterSteamAPIDebugTextHook.GetInvocationList())
{
try
{
...
public System.Text.StringBuilder pchDebugText;
}
...
public delegate void SteamAPIDebugTextHook_WithArgs (Action< int,  System.Text.StringBuilder> orig,  int nSeverity,  System.Text.StringBuilder pchDebugText);
...
{
add => HookEndpointManager.Add<Delegates.get_Instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SteamManager), "get_Instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_Instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SteamManager), "get_Instance", false), value);
}
public static event Delegates.get_Initialized_WithArgs get_Initialized
{
add => HookEndpointManager.Add<Delegates.get_Initialized_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SteamManager), "get_Initialized", false), value);
remove => HookEndpointManager.Remove<Delegates.get_Initialized_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(SteamManager), "get_Initialized", false), value);
}
