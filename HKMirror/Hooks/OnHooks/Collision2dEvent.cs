...
public static class OnCollision2dEvent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Collision2dEvent), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.Collision2dEvent> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Collision2dEvent),
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.Collision2dEvent> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self)
        {
        ...
        private static void StoreCollisionInfo(
            Action<HutongGames.PlayMaker.Actions.Collision2dEvent, UnityEngine.Collision2D> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self, UnityEngine.Collision2D collisionInfo)
        {
        ...
        private static void DoParticleCollision(
            Action<HutongGames.PlayMaker.Actions.Collision2dEvent, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self, UnityEngine.GameObject other)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Collision2dEvent), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.Collision2dEvent, string> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.Collision2dEvent> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.Collision2dEvent> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.Collision2dEvent, string> orig,
            HutongGames.PlayMaker.Actions.Collision2dEvent self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Collision2dEvent), "Reset", true),
                value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Collision2dEvent), "OnPreprocess",
                    true), value);
