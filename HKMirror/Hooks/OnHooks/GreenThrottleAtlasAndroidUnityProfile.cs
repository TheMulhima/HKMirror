...
public static class OnGreenThrottleAtlasAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GreenThrottleAtlasAndroidUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<GreenThrottleAtlasAndroidUnityProfile> orig,
            GreenThrottleAtlasAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GreenThrottleAtlasAndroidUnityProfile> orig,
            GreenThrottleAtlasAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public GreenThrottleAtlasAndroidUnityProfile self;
        }
    }
