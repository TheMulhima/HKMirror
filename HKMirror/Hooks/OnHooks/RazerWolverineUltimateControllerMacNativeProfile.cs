...
public static class OnRazerWolverineUltimateControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(RazerWolverineUltimateControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<RazerWolverineUltimateControllerMacNativeProfile> orig,
            RazerWolverineUltimateControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<RazerWolverineUltimateControllerMacNativeProfile> orig,
            RazerWolverineUltimateControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public RazerWolverineUltimateControllerMacNativeProfile self;
        }
    }
