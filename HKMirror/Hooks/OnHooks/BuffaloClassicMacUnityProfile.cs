...
public static class OnBuffaloClassicMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BuffaloClassicMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BuffaloClassicMacUnityProfile> orig, BuffaloClassicMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BuffaloClassicMacUnityProfile> orig,
            BuffaloClassicMacUnityProfile self);

        public sealed class Params_Define
        {
            public BuffaloClassicMacUnityProfile self;
        }
    }
