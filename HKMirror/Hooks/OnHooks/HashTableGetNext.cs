...
public static class OnHashTableGetNext
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableGetNext), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableGetNext), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self)
        {
        ...
        internal static void HookDoGetNextItem()
        {
            if (!HookedList.Contains("DoGetNextItem"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableGetNext),
        ...
        private static void DoGetNextItem(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self)
        {
        ...
        private static void GetItemAtIndex(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self);
        ...
        public delegate void DoGetNextItem_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self);
        ...
        public delegate void GetItemAtIndex_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableGetNext> orig,
            HutongGames.PlayMaker.Actions.HashTableGetNext self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableGetNext), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableGetNext), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoGetNextItem_WithArgs DoGetNextItem
        {
            add => HookEndpointManager.Add<Delegates.DoGetNextItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableGetNext), "DoGetNextItem",
                    true), value);
        ...
        public static event Delegates.GetItemAtIndex_WithArgs GetItemAtIndex
        {
            add => HookEndpointManager.Add<Delegates.GetItemAtIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableGetNext), "GetItemAtIndex",
                    true), value);
