...
public static class OnFusionXboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FusionXboxOneControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<FusionXboxOneControllerMacNativeProfile> orig,
            FusionXboxOneControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<FusionXboxOneControllerMacNativeProfile> orig,
            FusionXboxOneControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public FusionXboxOneControllerMacNativeProfile self;
        }
    }
