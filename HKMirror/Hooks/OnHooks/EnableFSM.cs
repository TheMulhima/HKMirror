...
public static class OnEnableFSM
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableFSM), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableFSM), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self)
        {
        ...
        internal static void HookDoEnableFSM()
        {
            if (!HookedList.Contains("DoEnableFSM"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableFSM), "DoEnableFSM",
                        true), DoEnableFSM);
            }
        }
        ...
        private static void DoEnableFSM(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableFSM), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self);
        ...
        public delegate void DoEnableFSM_WithArgs(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.EnableFSM> orig,
            HutongGames.PlayMaker.Actions.EnableFSM self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableFSM), "Reset", true), value);
        ...
        public static event Delegates.DoEnableFSM_WithArgs DoEnableFSM
        {
            add => HookEndpointManager.Add<Delegates.DoEnableFSM_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableFSM), "DoEnableFSM", true),
                value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EnableFSM), "OnExit", true), value);
