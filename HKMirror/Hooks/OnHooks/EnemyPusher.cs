...
/// <summary>
/// Contains different types of On Hooks for EnemyPusher class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnEnemyPusher
{
...
On.EnemyPusher.OnCollisionEnter2D += OnCollisionEnter2D;
...
private static void OnCollisionEnter2D(On.EnemyPusher.orig_OnCollisionEnter2D orig,EnemyPusher self,  UnityEngine.Collision2D collision)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<EnemyPusher,  UnityEngine.Collision2D> orig, EnemyPusher self,  UnityEngine.Collision2D collision);
}
...
{
public static event On.EnemyPusher.hook_OnCollisionEnter2D OnCollisionEnter2D
{
add => On.EnemyPusher.OnCollisionEnter2D += value;
remove => On.EnemyPusher.OnCollisionEnter2D -= value;
}
}
