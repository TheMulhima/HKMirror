...
public static class OnSteelSeriesStratusXLAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SteelSeriesStratusXLAndroidUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<SteelSeriesStratusXLAndroidUnityProfile> orig,
            SteelSeriesStratusXLAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SteelSeriesStratusXLAndroidUnityProfile> orig,
            SteelSeriesStratusXLAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public SteelSeriesStratusXLAndroidUnityProfile self;
        }
    }
