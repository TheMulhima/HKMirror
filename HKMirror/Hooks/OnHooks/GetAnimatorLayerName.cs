...
public static class OnGetAnimatorLayerName
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerName), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerName self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerName),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerName self)
        {
        ...
        internal static void HookDoGetLayerName()
        {
            if (!HookedList.Contains("DoGetLayerName"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerName),
                        "DoGetLayerName", true), DoGetLayerName);
            }
        }
        ...
        private static void DoGetLayerName(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerName self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerName self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerName self);
        ...
        public delegate void DoGetLayerName_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorLayerName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorLayerName self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorLayerName), "OnEnter",
                    true), value);
