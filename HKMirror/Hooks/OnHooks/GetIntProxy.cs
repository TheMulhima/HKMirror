...
public static class OnGetIntProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetIntProxy), "Invoke"), Invoke);
            }
        }
        ...
        private static int Invoke(Func<GetIntProxy, string, int, int> orig, GetIntProxy self, string name, int orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GetIntProxy), "EndInvoke"), EndInvoke);
            }
        }
        ...
        private static int EndInvoke(Func<GetIntProxy, IAsyncResult, int> orig, GetIntProxy self, IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate int EndInvoke_WithArgs(Func<GetIntProxy, IAsyncResult, int> orig, GetIntProxy self,
            IAsyncResult result);
        ...
        public delegate int Invoke_WithArgs(Func<GetIntProxy, string, int, int> orig, GetIntProxy self, string name,
            int orig_);
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetIntProxy), "Invoke"), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GetIntProxy), "EndInvoke"), value);
