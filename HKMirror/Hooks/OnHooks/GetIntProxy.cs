...
/// <summary>
/// Contains different types of On Hooks for GetIntProxy class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGetIntProxy
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetIntProxy), "Invoke", true), Invoke);
...
private static int Invoke(Func<Modding.Delegates.GetIntProxy,  string,  int, int> orig, Modding.Delegates.GetIntProxy self,  string name,  int orig_)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetIntProxy), "EndInvoke", true), EndInvoke);
...
private static int EndInvoke(Func<Modding.Delegates.GetIntProxy,  System.IAsyncResult, int> orig, Modding.Delegates.GetIntProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.GetIntProxy self;
public string name;
public int orig_;
}
public delegate void Invoke_BeforeArgs(Params_Invoke args);
public delegate int Invoke_AfterArgs(Params_Invoke args, int ret);
public delegate int Invoke_WithArgs (Func<Modding.Delegates.GetIntProxy,  string,  int, int> orig, Modding.Delegates.GetIntProxy self,  string name,  int orig_);
...
public delegate int EndInvoke_WithArgs (Func<Modding.Delegates.GetIntProxy,  System.IAsyncResult, int> orig, Modding.Delegates.GetIntProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetIntProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetIntProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetIntProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetIntProxy), "EndInvoke", true), value);
}
}
