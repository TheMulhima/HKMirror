...
public static class OnLogitechF510ModeXWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF510ModeXWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechF510ModeXWindowsNativeProfile> orig,
            LogitechF510ModeXWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF510ModeXWindowsNativeProfile> orig,
            LogitechF510ModeXWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechF510ModeXWindowsNativeProfile self;
        }
    }
