...
public static class OnCallStaticMethod
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.CallStaticMethod> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.CallStaticMethod> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self)
        {
        ...
        internal static void HookDoMethodCall()
        {
            if (!HookedList.Contains("DoMethodCall"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod),
                        "DoMethodCall", true), DoMethodCall);
            }
        }
        ...
        private static void DoMethodCall(Action<HutongGames.PlayMaker.Actions.CallStaticMethod> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self)
        {
        ...
        internal static void HookDoCache()
        {
            if (!HookedList.Contains("DoCache"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod), "DoCache",
                        true), DoCache);
            }
        }
        ...
        private static bool DoCache(Func<HutongGames.PlayMaker.Actions.CallStaticMethod, bool> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.CallStaticMethod, string> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.CallStaticMethod> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.CallStaticMethod> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self);
        ...
        public delegate void DoMethodCall_WithArgs(Action<HutongGames.PlayMaker.Actions.CallStaticMethod> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self);
        ...
        public delegate bool DoCache_WithArgs(Func<HutongGames.PlayMaker.Actions.CallStaticMethod, bool> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.CallStaticMethod, string> orig,
            HutongGames.PlayMaker.Actions.CallStaticMethod self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoMethodCall_WithArgs DoMethodCall
        {
            add => HookEndpointManager.Add<Delegates.DoMethodCall_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod), "DoMethodCall",
                    true), value);
        ...
        public static event Delegates.DoCache_WithArgs DoCache
        {
            add => HookEndpointManager.Add<Delegates.DoCache_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallStaticMethod), "DoCache", true),
                value);
