...
public static class OnListenForDown
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<ListenForDown> orig, ListenForDown self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<ListenForDown> orig, ListenForDown self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<ListenForDown> orig, ListenForDown self)
        {
        ...
        internal static void HookCheckForInput()
        {
            if (!HookedList.Contains("CheckForInput"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "CheckForInput"), CheckForInput);
            }
        }
        ...
        private static void CheckForInput(Action<ListenForDown> orig, ListenForDown self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void CheckForInput_WithArgs(Action<ListenForDown> orig, ListenForDown self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<ListenForDown> orig, ListenForDown self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<ListenForDown> orig, ListenForDown self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<ListenForDown> orig, ListenForDown self);

        public sealed class Params_Reset
        {
            public ListenForDown self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "OnUpdate"), value);
        ...
        public static event Delegates.CheckForInput_WithArgs CheckForInput
        {
            add => HookEndpointManager.Add<Delegates.CheckForInput_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ListenForDown), "CheckForInput"), value);
