...
public static class OnEaseVector3
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EaseVector3), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EaseVector3), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EaseVector3), "OnExit", true),
                    OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.EaseVector3), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.EaseVector3> orig,
            HutongGames.PlayMaker.Actions.EaseVector3 self);
    }
