...
public static class OnPlayStation3WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation3WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation3WindowsUnityProfile> orig, PlayStation3WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation3WindowsUnityProfile> orig,
            PlayStation3WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation3WindowsUnityProfile self;
        }
    }
