...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetBoolProxy), "Invoke", true), Invoke);
...
private static bool Invoke(Func<Modding.Delegates.GetBoolProxy,  string,  bool, bool> orig, Modding.Delegates.GetBoolProxy self,  string name,  bool orig_)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetBoolProxy), "EndInvoke", true), EndInvoke);
...
private static bool EndInvoke(Func<Modding.Delegates.GetBoolProxy,  System.IAsyncResult, bool> orig, Modding.Delegates.GetBoolProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.GetBoolProxy self;
public string name;
public bool orig_;
}
...
public delegate bool Invoke_WithArgs (Func<Modding.Delegates.GetBoolProxy,  string,  bool, bool> orig, Modding.Delegates.GetBoolProxy self,  string name,  bool orig_);
...
public delegate bool EndInvoke_WithArgs (Func<Modding.Delegates.GetBoolProxy,  System.IAsyncResult, bool> orig, Modding.Delegates.GetBoolProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetBoolProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetBoolProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetBoolProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.GetBoolProxy), "EndInvoke", true), value);
}
}
