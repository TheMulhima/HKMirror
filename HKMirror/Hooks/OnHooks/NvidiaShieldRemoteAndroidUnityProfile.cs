...
public static class OnNvidiaShieldRemoteAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NvidiaShieldRemoteAndroidUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<NvidiaShieldRemoteAndroidUnityProfile> orig,
            NvidiaShieldRemoteAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NvidiaShieldRemoteAndroidUnityProfile> orig,
            NvidiaShieldRemoteAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public NvidiaShieldRemoteAndroidUnityProfile self;
        }
    }
