...
public static class OnSetZ
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator SetPosition_AfterArgs(Params_SetPosition args,
            IEnumerator ret);

        public delegate void SetPosition_BeforeArgs(Params_SetPosition args);

        public delegate IEnumerator SetPosition_WithArgs(
            Func<SetZ, IEnumerator> orig, SetZ self);
