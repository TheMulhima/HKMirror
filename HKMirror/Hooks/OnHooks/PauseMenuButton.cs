...
public static class OnPauseMenuButton
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_cancelAction()
        {
            if (!HookedList.Contains("get_cancelAction"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "get_cancelAction", true),
                    get_cancelAction);
            }
        }
        ...
        private static GlobalEnums.CancelAction get_cancelAction(
            Func<UnityEngine.UI.PauseMenuButton, GlobalEnums.CancelAction> orig, UnityEngine.UI.PauseMenuButton self)
        {
        ...
        internal static void Hookset_cancelAction()
        {
            if (!HookedList.Contains("set_cancelAction"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "set_cancelAction", true),
                    set_cancelAction);
            }
        }
        ...
        private static void set_cancelAction(Action<UnityEngine.UI.PauseMenuButton, GlobalEnums.CancelAction> orig,
            UnityEngine.UI.PauseMenuButton self, GlobalEnums.CancelAction value)
        {
        ...
        internal static void HookOnSubmit()
        {
            if (!HookedList.Contains("OnSubmit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "OnSubmit", true),
                    OnSubmit);
            }
        }
        ...
        private static void OnSubmit(
            Action<UnityEngine.UI.PauseMenuButton, UnityEngine.EventSystems.BaseEventData> orig,
            UnityEngine.UI.PauseMenuButton self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookOnCancel()
        {
            if (!HookedList.Contains("OnCancel"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "OnCancel", true),
                    OnCancel);
            }
        }
        ...
        internal static void HookOnPointerClick()
        {
            if (!HookedList.Contains("OnPointerClick"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "OnPointerClick", true),
                    OnPointerClick);
            }
        }
        ...
        private static void OnPointerClick(
            Action<UnityEngine.UI.PauseMenuButton, UnityEngine.EventSystems.PointerEventData> orig,
            UnityEngine.UI.PauseMenuButton self, UnityEngine.EventSystems.PointerEventData eventData)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate GlobalEnums.CancelAction get_cancelAction_AfterArgs(Params_get_cancelAction args,
            GlobalEnums.CancelAction ret);

        public delegate GlobalEnums.CancelAction get_cancelAction_WithArgs(
            Func<UnityEngine.UI.PauseMenuButton, GlobalEnums.CancelAction> orig, UnityEngine.UI.PauseMenuButton self);
        ...
        public delegate void set_cancelAction_WithArgs(
            Action<UnityEngine.UI.PauseMenuButton, GlobalEnums.CancelAction> orig, UnityEngine.UI.PauseMenuButton self,
            GlobalEnums.CancelAction value);
        ...
        public delegate void Start_WithArgs(Action<UnityEngine.UI.PauseMenuButton> orig,
            UnityEngine.UI.PauseMenuButton self);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.Start_WithArgs Start
        {
            add => HookEndpointManager.Add<Delegates.Start_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "Start", true), value);
        ...
        public static event Delegates.OnSubmit_WithArgs OnSubmit
        {
            add => HookEndpointManager.Add<Delegates.OnSubmit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "OnSubmit", true), value);
        ...
        public static event Delegates.OnCancel_WithArgs OnCancel
        {
            add => HookEndpointManager.Add<Delegates.OnCancel_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "OnCancel", true), value);
        ...
        public static event Delegates.OnPointerClick_WithArgs OnPointerClick
        {
            add => HookEndpointManager.Add<Delegates.OnPointerClick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.PauseMenuButton), "OnPointerClick", true), value);
