...
public static class OnPauseMenuButton
{
    ...
    {
        public delegate CancelAction get_cancelAction_AfterArgs(Params_get_cancelAction args, CancelAction ret);

        public delegate void get_cancelAction_BeforeArgs(Params_get_cancelAction args);

        public delegate CancelAction get_cancelAction_WithArgs(Func<PauseMenuButton, CancelAction> orig,
            PauseMenuButton self);
        ...
        public delegate void OnCancel_WithArgs(Action<PauseMenuButton, BaseEventData> orig, PauseMenuButton self,
            BaseEventData eventData);
        ...
        public delegate void OnPointerClick_WithArgs(Action<PauseMenuButton, PointerEventData> orig,
            PauseMenuButton self, PointerEventData eventData);
        ...
        public delegate void OnSubmit_WithArgs(Action<PauseMenuButton, BaseEventData> orig, PauseMenuButton self,
            BaseEventData eventData);
        ...
        public delegate void set_cancelAction_WithArgs(Action<PauseMenuButton, CancelAction> orig, PauseMenuButton self,
            CancelAction value);
        ...
        public delegate void Start_WithArgs(Action<PauseMenuButton> orig, PauseMenuButton self);
