...
public static class OnNativeInputModuleManager
{
    internal static class HookHandler
    {
        ...
        private static bool get_IsRestartRequired(Func<bool> orig)
        {
            ...
            {
                foreach (Delegates.get_IsRestartRequired_BeforeArgs toInvoke in _beforeget_IsRestartRequired
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_IsRestartRequired_AfterArgs toInvoke in _afterget_IsRestartRequired
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_IsUsed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NativeInputModuleManager), "get_IsUsed", false), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsUsed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NativeInputModuleManager), "get_IsUsed", false), value);
        }

        public static event Delegates.set_IsUsed_WithArgs set_IsUsed
        {
            add => HookEndpointManager.Add<Delegates.set_IsUsed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NativeInputModuleManager), "set_IsUsed", false), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsUsed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NativeInputModuleManager), "set_IsUsed", false), value);
        }

        public static event Delegates.get_IsRestartRequired_WithArgs get_IsRestartRequired
        {
            add => HookEndpointManager.Add<Delegates.get_IsRestartRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NativeInputModuleManager), "get_IsRestartRequired", false),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_IsRestartRequired_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(NativeInputModuleManager), "get_IsRestartRequired", false),
                value);
        }
