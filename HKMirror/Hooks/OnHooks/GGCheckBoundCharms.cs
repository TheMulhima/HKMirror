...
/// <summary>
/// Contains different types of On Hooks for GGCheckBoundCharms class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGGCheckBoundCharms
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundCharms), "get_IsTrue", true), get_IsTrue);
...
private static bool get_IsTrue(Func<GGCheckBoundCharms, bool> orig, GGCheckBoundCharms self)
{
...
{
public GGCheckBoundCharms self;
}
...
public delegate bool get_IsTrue_WithArgs (Func<GGCheckBoundCharms, bool> orig, GGCheckBoundCharms self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundCharms), "get_IsTrue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsTrue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGCheckBoundCharms), "get_IsTrue", true), value);
}
}
