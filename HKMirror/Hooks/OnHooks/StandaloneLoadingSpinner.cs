...
private static void Setup(On.StandaloneLoadingSpinner.orig_Setup orig,StandaloneLoadingSpinner self,  GameManager lastGameManager)
{
Delegates.Params_Setup @params = new() 
{
self = self
, lastGameManager = lastGameManager
};
...
public delegate void Setup_WithArgs (Action<StandaloneLoadingSpinner,  GameManager> orig, StandaloneLoadingSpinner self,  GameManager lastGameManager);
