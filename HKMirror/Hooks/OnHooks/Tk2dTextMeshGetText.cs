...
public static class OnTk2dTextMeshGetText
{
    internal static class HookHandler
    {
        ...
        internal static void Hook_getTextMesh()
        {
            if (!HookedList.Contains("_getTextMesh"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "_getTextMesh"), _getTextMesh);
            }
        }
        ...
        private static void _getTextMesh(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self)
        {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self)
        {
        ...
        internal static void HookDoGetText()
        {
            if (!HookedList.Contains("DoGetText"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "DoGetText"), DoGetText);
            }
        }
        ...
        private static void DoGetText(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void _getTextMesh_WithArgs(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self);
        ...
        public delegate void DoGetText_WithArgs(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Tk2dTextMeshGetText> orig, Tk2dTextMeshGetText self);

        public sealed class Params__getTextMesh
        {
            public Tk2dTextMeshGetText self;
        }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "OnUpdate"), value);
        ...
        public static event Delegates.DoGetText_WithArgs DoGetText
        {
            add => HookEndpointManager.Add<Delegates.DoGetText_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Tk2dTextMeshGetText), "DoGetText"), value);
