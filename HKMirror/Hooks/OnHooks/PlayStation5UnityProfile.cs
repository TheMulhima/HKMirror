...
public static class OnPlayStation5UnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation5UnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation5UnityProfile> orig, PlayStation5UnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation5UnityProfile> orig, PlayStation5UnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation5UnityProfile self;
        }
    }
