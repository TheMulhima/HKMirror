...
public static class OnMogaProLinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MogaProLinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MogaProLinuxUnityProfile> orig, MogaProLinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MogaProLinuxUnityProfile> orig, MogaProLinuxUnityProfile self);

        public sealed class Params_Define
        {
            public MogaProLinuxUnityProfile self;
        }
    }
