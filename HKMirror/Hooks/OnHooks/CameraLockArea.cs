...
public static class OnCameraLockArea
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.IsInApplicableGameState_NormalArgs _afterIsInApplicableGameState;
            ...
            CameraLockArea self)
        {
            ...
            if (_afterIsInApplicableGameState != null) retVal = _afterIsInApplicableGameState.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.ValidateBounds_NormalArgs _afterValidateBounds;
        ...
        private static bool ValidateBounds(On.CameraLockArea.orig_ValidateBounds orig, CameraLockArea self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterValidateBounds != null) retVal = _afterValidateBounds.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.SetXMin_NormalArgs _afterSetXMin;
        ...
        private static void SetXMin(On.CameraLockArea.orig_SetXMin orig, CameraLockArea self, float xmin)
        {
            ...
            xmin = @params.xmin;
            orig(self, xmin);
            if (_afterSetXMin != null) _afterSetXMin.Invoke(@params);
        }
        ...
        internal static event Delegates.SetXMax_NormalArgs _afterSetXMax;
        ...
        private static void SetXMax(On.CameraLockArea.orig_SetXMax orig, CameraLockArea self, float xmax)
        {
            ...
            xmax = @params.xmax;
            orig(self, xmax);
            if (_afterSetXMax != null) _afterSetXMax.Invoke(@params);
        }
    ...
    public static class Delegates
    {
        ...
        public delegate bool IsInApplicableGameState_NormalArgs(Params_IsInApplicableGameState args);
        ...
        public delegate void SetXMax_NormalArgs(Params_SetXMax args);

        public delegate void SetXMin_BeforeArgs(Params_SetXMin args);

        public delegate void SetXMin_NormalArgs(Params_SetXMin args);
        ...
        public delegate bool ValidateBounds_NormalArgs(Params_ValidateBounds args);
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.IsInApplicableGameState_NormalArgs IsInApplicableGameState
        {
            add
            {
        ...
        public static event Delegates.ValidateBounds_NormalArgs ValidateBounds
        {
            add
            {
        ...
        public static event Delegates.SetXMin_NormalArgs SetXMin
        {
            add
            {
        ...
        public static event Delegates.SetXMax_NormalArgs SetXMax
        {
            add
            {
