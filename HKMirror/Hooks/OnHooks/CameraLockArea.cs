...
private static bool IsInApplicableGameState(On.CameraLockArea.orig_IsInApplicableGameState orig,CameraLockArea self)
{
...
{
foreach (Delegates.IsInApplicableGameState_BeforeArgs toInvoke in _beforeIsInApplicableGameState.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsInApplicableGameState_AfterArgs toInvoke in _afterIsInApplicableGameState.GetInvocationList())
{
try
{
...
private static void OnTriggerEnter2D(On.CameraLockArea.orig_OnTriggerEnter2D orig,CameraLockArea self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerStay2D(On.CameraLockArea.orig_OnTriggerStay2D orig,CameraLockArea self,  UnityEngine.Collider2D otherCollider)
{
...
private static void OnTriggerExit2D(On.CameraLockArea.orig_OnTriggerExit2D orig,CameraLockArea self,  UnityEngine.Collider2D otherCollider)
{
...
private static System.Collections.IEnumerator orig_Start(Func<CameraLockArea, System.Collections.IEnumerator> orig, CameraLockArea self)
{
...
public delegate System.Collections.IEnumerator Start_WithArgs (Func<CameraLockArea, System.Collections.IEnumerator> orig, CameraLockArea self);
...
public delegate void OnTriggerEnter2D_WithArgs (Action<CameraLockArea,  UnityEngine.Collider2D> orig, CameraLockArea self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerStay2D_WithArgs (Action<CameraLockArea,  UnityEngine.Collider2D> orig, CameraLockArea self,  UnityEngine.Collider2D otherCollider);
...
public delegate void OnTriggerExit2D_WithArgs (Action<CameraLockArea,  UnityEngine.Collider2D> orig, CameraLockArea self,  UnityEngine.Collider2D otherCollider);
...
public delegate System.Collections.IEnumerator orig_Start_WithArgs (Func<CameraLockArea, System.Collections.IEnumerator> orig, CameraLockArea self);
}
...
{
add => HookEndpointManager.Add<Delegates.orig_Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CameraLockArea), "orig_Start", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Start_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(CameraLockArea), "orig_Start", true), value);
}
}
