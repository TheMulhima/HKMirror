...
private static void flash(On.SpriteFlash.orig_flash orig,SpriteFlash self,  UnityEngine.Color flashColour_var,  float amount_var,  float timeUp_var,  float stayTime_var,  float timeDown_var)
{
Delegates.Params_flash @params = new() 
{
self = self
, flashColour_var = flashColour_var
, amount_var = amount_var
, timeUp_var = timeUp_var
, stayTime_var = stayTime_var
, timeDown_var = timeDown_var
};
...
{
foreach (Delegates.FlashingSuperDash_BeforeArgs toInvoke in _beforeFlashingSuperDash.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlashingGhostWounded_BeforeArgs toInvoke in _beforeFlashingGhostWounded.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlashingGhostWounded_AfterArgs toInvoke in _afterFlashingGhostWounded.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlashingWhiteStay_BeforeArgs toInvoke in _beforeFlashingWhiteStay.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlashingWhiteStayMoth_BeforeArgs toInvoke in _beforeFlashingWhiteStayMoth.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlashingWhiteStayMoth_AfterArgs toInvoke in _afterFlashingWhiteStayMoth.GetInvocationList())
{
try
{
...
{
foreach (Delegates.flashInfectedLong_BeforeArgs toInvoke in _beforeflashInfectedLong.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlashShadowRecharge_BeforeArgs toInvoke in _beforeFlashShadowRecharge.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlashShadowRecharge_AfterArgs toInvoke in _afterFlashShadowRecharge.GetInvocationList())
{
try
{
...
{
foreach (Delegates.flashInfectedLoop_BeforeArgs toInvoke in _beforeflashInfectedLoop.GetInvocationList())
{
try
{
...
private static void SendToChildren(On.SpriteFlash.orig_SendToChildren orig,SpriteFlash self,  System.Action function)
{
...
public delegate void flash_WithArgs (Action<SpriteFlash,  UnityEngine.Color,  float,  float,  float,  float> orig, SpriteFlash self,  UnityEngine.Color flashColour_var,  float amount_var,  float timeUp_var,  float stayTime_var,  float timeDown_var);
...
public delegate void SendToChildren_WithArgs (Action<SpriteFlash,  System.Action> orig, SpriteFlash self,  System.Action function);
}
