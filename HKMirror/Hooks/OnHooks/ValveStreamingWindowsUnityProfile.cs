...
public static class OnValveStreamingWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ValveStreamingWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<ValveStreamingWindowsUnityProfile> orig,
            ValveStreamingWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ValveStreamingWindowsUnityProfile> orig,
            ValveStreamingWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public ValveStreamingWindowsUnityProfile self;
        }
    }
