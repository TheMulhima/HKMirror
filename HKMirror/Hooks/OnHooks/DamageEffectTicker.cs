...
public static class OnDamageEffectTicker
{
    internal static class HookHandler
    {
            ...
            DamageEffectTicker self, float newInterval)
        {
            ...
            {
                foreach (Delegates.SetDamageInterval_BeforeArgs toInvoke in
                         _beforeSetDamageInterval.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<DamageEffectTicker, UnityEngine.Collider2D> orig,
            DamageEffectTicker self, UnityEngine.Collider2D otherCollider);
        ...
        public delegate void OnTriggerExit2D_WithArgs(Action<DamageEffectTicker, UnityEngine.Collider2D> orig,
            DamageEffectTicker self, UnityEngine.Collider2D otherCollider);
        ...
        public delegate void SetDamageEvent_WithArgs(Action<DamageEffectTicker, string> orig, DamageEffectTicker self,
            string newEvent);
        ...
        public delegate void SetDamageInterval_WithArgs(Action<DamageEffectTicker, float> orig, DamageEffectTicker self,
            float newInterval);
    }
