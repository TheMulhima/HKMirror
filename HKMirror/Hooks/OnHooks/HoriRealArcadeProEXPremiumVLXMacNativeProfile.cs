...
public static class OnHoriRealArcadeProEXPremiumVLXMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.HoriRealArcadeProEXPremiumVLXMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.HoriRealArcadeProEXPremiumVLXMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.HoriRealArcadeProEXPremiumVLXMacNativeProfile self)
        {
