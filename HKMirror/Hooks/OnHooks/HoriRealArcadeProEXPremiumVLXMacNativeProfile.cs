...
public static class OnHoriRealArcadeProEXPremiumVLXMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HoriRealArcadeProEXPremiumVLXMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriRealArcadeProEXPremiumVLXMacNativeProfile> orig,
            HoriRealArcadeProEXPremiumVLXMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriRealArcadeProEXPremiumVLXMacNativeProfile> orig,
            HoriRealArcadeProEXPremiumVLXMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriRealArcadeProEXPremiumVLXMacNativeProfile self;
        }
    }
