...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ForceCameraAspect), "get_CurrentViewportAspect", false), get_CurrentViewportAspect);
...
{
foreach (Delegates.get_CurrentViewportAspect_BeforeArgs toInvoke in _beforeget_CurrentViewportAspect.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_CurrentViewportAspect_AfterArgs toInvoke in _afterget_CurrentViewportAspect.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ForceCameraAspect), "set_CurrentViewportAspect", false), set_CurrentViewportAspect);
...
{
foreach (Delegates.set_CurrentViewportAspect_BeforeArgs toInvoke in _beforeset_CurrentViewportAspect.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_CurrentViewportAspect_AfterArgs toInvoke in _afterset_CurrentViewportAspect.GetInvocationList())
{
try
{
...
private static void SetOverscanViewport(On.ForceCameraAspect.orig_SetOverscanViewport orig,ForceCameraAspect self,  float adjustment)
{
...
{
foreach (Delegates.SetOverscanViewport_BeforeArgs toInvoke in _beforeSetOverscanViewport.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetOverscanViewport_AfterArgs toInvoke in _afterSetOverscanViewport.GetInvocationList())
{
try
{
...
public delegate void SetOverscanViewport_WithArgs (Action<ForceCameraAspect,  float> orig, ForceCameraAspect self,  float adjustment);
...
{
add => HookEndpointManager.Add<Delegates.get_CurrentViewportAspect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ForceCameraAspect), "get_CurrentViewportAspect", false), value);
remove => HookEndpointManager.Remove<Delegates.get_CurrentViewportAspect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ForceCameraAspect), "get_CurrentViewportAspect", false), value);
}
public static event Delegates.set_CurrentViewportAspect_WithArgs set_CurrentViewportAspect
{
add => HookEndpointManager.Add<Delegates.set_CurrentViewportAspect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ForceCameraAspect), "set_CurrentViewportAspect", false), value);
remove => HookEndpointManager.Remove<Delegates.set_CurrentViewportAspect_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ForceCameraAspect), "set_CurrentViewportAspect", false), value);
}
