...
public static class OnBrookPS2ConverterMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BrookPS2ConverterMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BrookPS2ConverterMacNativeProfile> orig,
            BrookPS2ConverterMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BrookPS2ConverterMacNativeProfile> orig,
            BrookPS2ConverterMacNativeProfile self);

        public sealed class Params_Define
        {
            public BrookPS2ConverterMacNativeProfile self;
        }
    }
