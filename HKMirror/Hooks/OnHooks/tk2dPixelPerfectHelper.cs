...
internal static event Delegates.CalculateScaleForPerspectiveCamera_BeforeArgs _beforeCalculateScaleForPerspectiveCamera;
internal static event Delegates.CalculateScaleForPerspectiveCamera_AfterArgs _afterCalculateScaleForPerspectiveCamera;
private static float CalculateScaleForPerspectiveCamera(On.tk2dPixelPerfectHelper.orig_CalculateScaleForPerspectiveCamera orig, float fov,  float zdist)
{
...
if (_beforeCalculateScaleForPerspectiveCamera != null)
{
foreach (Delegates.CalculateScaleForPerspectiveCamera_BeforeArgs toInvoke in _beforeCalculateScaleForPerspectiveCamera.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CalculateScaleForPerspectiveCamera_AfterArgs toInvoke in _afterCalculateScaleForPerspectiveCamera.GetInvocationList())
{
try
{
retVal = _afterCalculateScaleForPerspectiveCamera.Invoke(@params, retVal);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_CameraIsOrtho", true), get_CameraIsOrtho);

}
}
internal static event Delegates.get_CameraIsOrtho_BeforeArgs _beforeget_CameraIsOrtho;
internal static event Delegates.get_CameraIsOrtho_AfterArgs _afterget_CameraIsOrtho;
...
if (_beforeget_CameraIsOrtho != null)
{
foreach (Delegates.get_CameraIsOrtho_BeforeArgs toInvoke in _beforeget_CameraIsOrtho.GetInvocationList())
{
try
{
...
if (_afterget_CameraIsOrtho != null)
{
foreach (Delegates.get_CameraIsOrtho_AfterArgs toInvoke in _afterget_CameraIsOrtho.GetInvocationList())
{
try
{
retVal = _afterget_CameraIsOrtho.Invoke(@params, retVal);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
public delegate tk2dPixelPerfectHelper get_inst_AfterArgs(tk2dPixelPerfectHelper ret);
public delegate tk2dPixelPerfectHelper get_inst_WithArgs (Func<tk2dPixelPerfectHelper> orig);
...
public delegate void Awake_WithArgs (Action<tk2dPixelPerfectHelper> orig, tk2dPixelPerfectHelper self);
...
public delegate void Setup_WithArgs (Action<tk2dPixelPerfectHelper> orig, tk2dPixelPerfectHelper self);
public sealed class Params_CalculateScaleForPerspectiveCamera
{
public float fov;
public float zdist;
}
public delegate void CalculateScaleForPerspectiveCamera_BeforeArgs(Params_CalculateScaleForPerspectiveCamera args);
public delegate float CalculateScaleForPerspectiveCamera_AfterArgs(Params_CalculateScaleForPerspectiveCamera args, float ret);
public delegate float CalculateScaleForPerspectiveCamera_WithArgs (Func< float,  float, float> orig,  float fov,  float zdist);
...
public delegate bool get_CameraIsOrtho_AfterArgs(Params_get_CameraIsOrtho args, bool ret);
public delegate bool get_CameraIsOrtho_WithArgs (Func<tk2dPixelPerfectHelper, bool> orig, tk2dPixelPerfectHelper self);
}
...
public static event Delegates.CalculateScaleForPerspectiveCamera_AfterArgs CalculateScaleForPerspectiveCamera
{
add
{
...
public static event Delegates.get_CameraIsOrtho_AfterArgs get_CameraIsOrtho
{
add
{
...
{
add => HookEndpointManager.Add<Delegates.get_inst_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_inst", false), value);
remove => HookEndpointManager.Remove<Delegates.get_inst_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_inst", false), value);
}
...
public static event On.tk2dPixelPerfectHelper.hook_CalculateScaleForPerspectiveCamera CalculateScaleForPerspectiveCamera
{
...
public static event Delegates.get_CameraIsOrtho_WithArgs get_CameraIsOrtho
{
add => HookEndpointManager.Add<Delegates.get_CameraIsOrtho_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_CameraIsOrtho", true), value);
remove => HookEndpointManager.Remove<Delegates.get_CameraIsOrtho_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_CameraIsOrtho", true), value);
}
}
