...
public static class Ontk2dPixelPerfectHelper
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.CalculateScaleForPerspectiveCamera_AfterArgs
            ...
            On.tk2dPixelPerfectHelper.orig_CalculateScaleForPerspectiveCamera orig, float fov, float zdist)
        {
            ...
            {
                foreach (Delegates.CalculateScaleForPerspectiveCamera_BeforeArgs toInvoke in
                         _beforeCalculateScaleForPerspectiveCamera.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CalculateScaleForPerspectiveCamera_AfterArgs toInvoke in
                         _afterCalculateScaleForPerspectiveCamera.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_CameraIsOrtho()
        {
            if (!HookedList.Contains("get_CameraIsOrtho"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_CameraIsOrtho", true),
                    get_CameraIsOrtho);
            }
        }
        ...
        private static bool get_CameraIsOrtho(Func<tk2dPixelPerfectHelper, bool> orig, tk2dPixelPerfectHelper self)
        {
            ...
            {
                foreach (Delegates.get_CameraIsOrtho_BeforeArgs toInvoke in
                         _beforeget_CameraIsOrtho.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate float CalculateScaleForPerspectiveCamera_AfterArgs(
            Params_CalculateScaleForPerspectiveCamera args, float ret);

        public delegate float CalculateScaleForPerspectiveCamera_WithArgs(Func<float, float, float> orig, float fov,
            float zdist);
        ...
        public delegate bool get_CameraIsOrtho_WithArgs(Func<tk2dPixelPerfectHelper, bool> orig,
            tk2dPixelPerfectHelper self);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_CameraIsOrtho_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_CameraIsOrtho", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_CameraIsOrtho_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dPixelPerfectHelper), "get_CameraIsOrtho", true), value);
        }
    }
}