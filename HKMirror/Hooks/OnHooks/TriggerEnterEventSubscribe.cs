...
private static void SendEnteredEvent(On.TriggerEnterEventSubscribe.orig_SendEnteredEvent orig,TriggerEnterEventSubscribe self,  UnityEngine.Collider2D collider,  UnityEngine.GameObject sender)
{
...
private static void SendExitedEvent(On.TriggerEnterEventSubscribe.orig_SendExitedEvent orig,TriggerEnterEventSubscribe self,  UnityEngine.Collider2D collider,  UnityEngine.GameObject sender)
{
...
private static void SendStayedEvent(On.TriggerEnterEventSubscribe.orig_SendStayedEvent orig,TriggerEnterEventSubscribe self,  UnityEngine.Collider2D collider,  UnityEngine.GameObject sender)
{
...
public delegate void SendEnteredEvent_WithArgs (Action<TriggerEnterEventSubscribe,  UnityEngine.Collider2D,  UnityEngine.GameObject> orig, TriggerEnterEventSubscribe self,  UnityEngine.Collider2D collider,  UnityEngine.GameObject sender);
...
public delegate void SendExitedEvent_WithArgs (Action<TriggerEnterEventSubscribe,  UnityEngine.Collider2D,  UnityEngine.GameObject> orig, TriggerEnterEventSubscribe self,  UnityEngine.Collider2D collider,  UnityEngine.GameObject sender);
...
public delegate void SendStayedEvent_WithArgs (Action<TriggerEnterEventSubscribe,  UnityEngine.Collider2D,  UnityEngine.GameObject> orig, TriggerEnterEventSubscribe self,  UnityEngine.Collider2D collider,  UnityEngine.GameObject sender);
}
