...
private static string GetGameVersionString(On.GameVersionData.orig_GetGameVersionString orig,GameVersionData self)
{
...
{
foreach (Delegates.GetGameVersionString_BeforeArgs toInvoke in _beforeGetGameVersionString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetGameVersionString_AfterArgs toInvoke in _afterGetGameVersionString.GetInvocationList())
{
try
{
