...
public static class OnPDPTitanfall2XboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.PDPTitanfall2XboxOneControllerMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.PDPTitanfall2XboxOneControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.PDPTitanfall2XboxOneControllerMacNativeProfile self)
        {
