...
public static class OnPDPTitanfall2XboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(PDPTitanfall2XboxOneControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PDPTitanfall2XboxOneControllerMacNativeProfile> orig,
            PDPTitanfall2XboxOneControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PDPTitanfall2XboxOneControllerMacNativeProfile> orig,
            PDPTitanfall2XboxOneControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PDPTitanfall2XboxOneControllerMacNativeProfile self;
        }
    }
