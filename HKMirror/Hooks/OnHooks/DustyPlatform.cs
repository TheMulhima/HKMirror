...
private static void OnCollisionEnter2D(On.DustyPlatform.orig_OnCollisionEnter2D orig,DustyPlatform self,  UnityEngine.Collision2D collision)
{
...
private static void SetRateOverTime(On.DustyPlatform.orig_SetRateOverTime orig,DustyPlatform self,  UnityEngine.ParticleSystem ps,  float rateOverTime)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<DustyPlatform,  UnityEngine.Collision2D> orig, DustyPlatform self,  UnityEngine.Collision2D collision);
...
public delegate void SetRateOverTime_WithArgs (Action<DustyPlatform,  UnityEngine.ParticleSystem,  float> orig, DustyPlatform self,  UnityEngine.ParticleSystem ps,  float rateOverTime);
}
