...
public static class OnCallMethod
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
        ...
        internal static void HookDoMethodCall()
        {
            if (!HookedList.Contains("DoMethodCall"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "DoMethodCall",
                        true), DoMethodCall);
            }
        }
        ...
        private static void DoMethodCall(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
        ...
        internal static void HookNeedToUpdateCache()
        {
            if (!HookedList.Contains("NeedToUpdateCache"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod),
                        "NeedToUpdateCache", true), NeedToUpdateCache);
            }
        }
        ...
        private static bool NeedToUpdateCache(Func<HutongGames.PlayMaker.Actions.CallMethod, bool> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
        ...
        internal static void HookClearCache()
        {
            if (!HookedList.Contains("ClearCache"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "ClearCache",
                        true), ClearCache);
            }
        }
        ...
        private static void ClearCache(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
        ...
        internal static void HookDoCache()
        {
            if (!HookedList.Contains("DoCache"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "DoCache", true),
                    DoCache);
            }
        }
        ...
        private static bool DoCache(Func<HutongGames.PlayMaker.Actions.CallMethod, bool> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.CallMethod, string> orig,
            HutongGames.PlayMaker.Actions.CallMethod self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
        ...
        public delegate void DoMethodCall_WithArgs(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
        ...
        public delegate bool NeedToUpdateCache_WithArgs(Func<HutongGames.PlayMaker.Actions.CallMethod, bool> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
        ...
        public delegate void ClearCache_WithArgs(Action<HutongGames.PlayMaker.Actions.CallMethod> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
        ...
        public delegate bool DoCache_WithArgs(Func<HutongGames.PlayMaker.Actions.CallMethod, bool> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.CallMethod, string> orig,
            HutongGames.PlayMaker.Actions.CallMethod self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "Reset", true), value);
        ...
        public static event Delegates.DoMethodCall_WithArgs DoMethodCall
        {
            add => HookEndpointManager.Add<Delegates.DoMethodCall_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "DoMethodCall", true),
                value);
        ...
        public static event Delegates.NeedToUpdateCache_WithArgs NeedToUpdateCache
        {
            add => HookEndpointManager.Add<Delegates.NeedToUpdateCache_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "NeedToUpdateCache",
                    true), value);
        ...
        public static event Delegates.ClearCache_WithArgs ClearCache
        {
            add => HookEndpointManager.Add<Delegates.ClearCache_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "ClearCache", true),
                value);
        ...
        public static event Delegates.ErrorCheck_WithArgs ErrorCheck
        {
            add => HookEndpointManager.Add<Delegates.ErrorCheck_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CallMethod), "ErrorCheck", true),
                value);
