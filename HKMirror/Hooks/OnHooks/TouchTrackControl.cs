...
public static class OnTouchTrackControl
{
    internal static class HookHandler
    {
        ...
        internal static void HookCreateControl()
        {
            if (!HookedList.Contains("CreateControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "CreateControl", true),
                    CreateControl);
            }
        }
        ...
        internal static void HookDestroyControl()
        {
            if (!HookedList.Contains("DestroyControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "DestroyControl", true),
                    DestroyControl);
            }
        }
        ...
        internal static void HookConfigureControl()
        {
            if (!HookedList.Contains("ConfigureControl"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "ConfigureControl", true),
                    ConfigureControl);
            }
        }
        ...
        internal static void HookDrawGizmos()
        {
            if (!HookedList.Contains("DrawGizmos"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "DrawGizmos", true),
                    DrawGizmos);
            }
        }
        ...
        internal static void HookOnValidate()
        {
            if (!HookedList.Contains("OnValidate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "OnValidate", true),
                    OnValidate);
            }
        }
        ...
        internal static void HookSubmitControlState()
        {
            if (!HookedList.Contains("SubmitControlState"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "SubmitControlState", true),
                    SubmitControlState);
            }
        }
        ...
        private static void SubmitControlState(Action<InControl.TouchTrackControl, ulong, float> orig,
            InControl.TouchTrackControl self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookCommitControlState()
        {
            if (!HookedList.Contains("CommitControlState"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "CommitControlState", true),
                    CommitControlState);
            }
        }
        ...
        private static void CommitControlState(Action<InControl.TouchTrackControl, ulong, float> orig,
            InControl.TouchTrackControl self, ulong updateTick, float deltaTime)
        {
        ...
        internal static void HookTouchBegan()
        {
            if (!HookedList.Contains("TouchBegan"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "TouchBegan", true),
                    TouchBegan);
            }
        }
        ...
        private static void TouchBegan(Action<InControl.TouchTrackControl, InControl.Touch> orig,
            InControl.TouchTrackControl self, InControl.Touch touch)
        {
        ...
        internal static void HookTouchMoved()
        {
            if (!HookedList.Contains("TouchMoved"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "TouchMoved", true),
                    TouchMoved);
            }
        }
        ...
        private static void TouchMoved(Action<InControl.TouchTrackControl, InControl.Touch> orig,
            InControl.TouchTrackControl self, InControl.Touch touch)
        {
        ...
        internal static void HookTouchEnded()
        {
            if (!HookedList.Contains("TouchEnded"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "TouchEnded", true),
                    TouchEnded);
            }
        }
        ...
        private static void TouchEnded(Action<InControl.TouchTrackControl, InControl.Touch> orig,
            InControl.TouchTrackControl self, InControl.Touch touch)
        {
        ...
        internal static void Hookget_ActiveArea()
        {
            if (!HookedList.Contains("get_ActiveArea"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "get_ActiveArea", true),
                    get_ActiveArea);
            }
        }
        ...
        private static UnityEngine.Rect get_ActiveArea(Func<InControl.TouchTrackControl, UnityEngine.Rect> orig,
            InControl.TouchTrackControl self)
        {
        ...
        internal static void Hookset_ActiveArea()
        {
            if (!HookedList.Contains("set_ActiveArea"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "set_ActiveArea", true),
                    set_ActiveArea);
            }
        }
        ...
        private static void set_ActiveArea(Action<InControl.TouchTrackControl, UnityEngine.Rect> orig,
            InControl.TouchTrackControl self, UnityEngine.Rect value)
        {
        ...
        internal static void Hookget_AreaUnitType()
        {
            if (!HookedList.Contains("get_AreaUnitType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "get_AreaUnitType", true),
                    get_AreaUnitType);
            }
        }
        ...
        private static InControl.TouchUnitType get_AreaUnitType(
            Func<InControl.TouchTrackControl, InControl.TouchUnitType> orig, InControl.TouchTrackControl self)
        {
        ...
        internal static void Hookset_AreaUnitType()
        {
            if (!HookedList.Contains("set_AreaUnitType"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "set_AreaUnitType", true),
                    set_AreaUnitType);
            }
        }
        ...
        private static void set_AreaUnitType(Action<InControl.TouchTrackControl, InControl.TouchUnitType> orig,
            InControl.TouchTrackControl self, InControl.TouchUnitType value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void CreateControl_WithArgs(Action<InControl.TouchTrackControl> orig,
            InControl.TouchTrackControl self);
        ...
        public delegate void DestroyControl_WithArgs(Action<InControl.TouchTrackControl> orig,
            InControl.TouchTrackControl self);
        ...
        public delegate void ConfigureControl_WithArgs(Action<InControl.TouchTrackControl> orig,
            InControl.TouchTrackControl self);
        ...
        public delegate void DrawGizmos_WithArgs(Action<InControl.TouchTrackControl> orig,
            InControl.TouchTrackControl self);
        ...
        public delegate void OnValidate_WithArgs(Action<InControl.TouchTrackControl> orig,
            InControl.TouchTrackControl self);
        ...
        public delegate void Update_WithArgs(Action<InControl.TouchTrackControl> orig,
            InControl.TouchTrackControl self);
        ...
        public delegate void SubmitControlState_WithArgs(Action<InControl.TouchTrackControl, ulong, float> orig,
            InControl.TouchTrackControl self, ulong updateTick, float deltaTime);
        ...
        public delegate void CommitControlState_WithArgs(Action<InControl.TouchTrackControl, ulong, float> orig,
            InControl.TouchTrackControl self, ulong updateTick, float deltaTime);
        ...
        public delegate void TouchBegan_WithArgs(Action<InControl.TouchTrackControl, InControl.Touch> orig,
            InControl.TouchTrackControl self, InControl.Touch touch);
        ...
        public delegate void TouchMoved_WithArgs(Action<InControl.TouchTrackControl, InControl.Touch> orig,
            InControl.TouchTrackControl self, InControl.Touch touch);
        ...
        public delegate void TouchEnded_WithArgs(Action<InControl.TouchTrackControl, InControl.Touch> orig,
            InControl.TouchTrackControl self, InControl.Touch touch);
        ...
        public delegate UnityEngine.Rect get_ActiveArea_WithArgs(
            Func<InControl.TouchTrackControl, UnityEngine.Rect> orig, InControl.TouchTrackControl self);
        ...
        public delegate void set_ActiveArea_WithArgs(Action<InControl.TouchTrackControl, UnityEngine.Rect> orig,
            InControl.TouchTrackControl self, UnityEngine.Rect value);
        ...
        public delegate void set_AreaUnitType_WithArgs(
            Action<InControl.TouchTrackControl, InControl.TouchUnitType> orig, InControl.TouchTrackControl self,
    ...
    public static class WithOrig
    {
        public static event Delegates.CreateControl_WithArgs CreateControl
        {
            add => HookEndpointManager.Add<Delegates.CreateControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "CreateControl", true), value);
        ...
        public static event Delegates.DestroyControl_WithArgs DestroyControl
        {
            add => HookEndpointManager.Add<Delegates.DestroyControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "DestroyControl", true), value);
        ...
        public static event Delegates.ConfigureControl_WithArgs ConfigureControl
        {
            add => HookEndpointManager.Add<Delegates.ConfigureControl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "ConfigureControl", true), value);
        ...
        public static event Delegates.DrawGizmos_WithArgs DrawGizmos
        {
            add => HookEndpointManager.Add<Delegates.DrawGizmos_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "DrawGizmos", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.OnValidate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "OnValidate", true), value);
            remove => HookEndpointManager.Remove<Delegates.OnValidate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "OnValidate", true), value);
        }
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "Update", true), value);
        ...
        public static event Delegates.SubmitControlState_WithArgs SubmitControlState
        {
            add => HookEndpointManager.Add<Delegates.SubmitControlState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "SubmitControlState", true), value);
        ...
        public static event Delegates.CommitControlState_WithArgs CommitControlState
        {
            add => HookEndpointManager.Add<Delegates.CommitControlState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "CommitControlState", true), value);
        ...
        public static event Delegates.TouchBegan_WithArgs TouchBegan
        {
            add => HookEndpointManager.Add<Delegates.TouchBegan_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "TouchBegan", true), value);
        ...
        public static event Delegates.TouchMoved_WithArgs TouchMoved
        {
            add => HookEndpointManager.Add<Delegates.TouchMoved_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "TouchMoved", true), value);
        ...
        public static event Delegates.TouchEnded_WithArgs TouchEnded
        {
            add => HookEndpointManager.Add<Delegates.TouchEnded_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "TouchEnded", true), value);
        ...
        public static event Delegates.get_ActiveArea_WithArgs get_ActiveArea
        {
            add => HookEndpointManager.Add<Delegates.get_ActiveArea_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "get_ActiveArea", true), value);
        ...
        public static event Delegates.set_ActiveArea_WithArgs set_ActiveArea
        {
            add => HookEndpointManager.Add<Delegates.set_ActiveArea_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "set_ActiveArea", true), value);
        ...
        public static event Delegates.get_AreaUnitType_WithArgs get_AreaUnitType
        {
            add => HookEndpointManager.Add<Delegates.get_AreaUnitType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "get_AreaUnitType", true), value);
        ...
        public static event Delegates.set_AreaUnitType_WithArgs set_AreaUnitType
        {
            add => HookEndpointManager.Add<Delegates.set_AreaUnitType_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.TouchTrackControl), "set_AreaUnitType", true), value);
