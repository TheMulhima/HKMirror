...
public static class OnChaseObjectVertical
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<ChaseObjectVertical> orig, ChaseObjectVertical self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<ChaseObjectVertical> orig, ChaseObjectVertical self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<ChaseObjectVertical> orig, ChaseObjectVertical self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<ChaseObjectVertical> orig, ChaseObjectVertical self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<ChaseObjectVertical> orig, ChaseObjectVertical self)
        {
        ...
        internal static void HookDoChase()
        {
            if (!HookedList.Contains("DoChase"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "DoChase"), DoChase);
            }
        }
        ...
        private static void DoChase(Action<ChaseObjectVertical> orig, ChaseObjectVertical self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<ChaseObjectVertical> orig, ChaseObjectVertical self);

        public delegate void DoChase_AfterArgs(Params_DoChase args);

        public delegate void DoChase_BeforeArgs(Params_DoChase args);

        public delegate void DoChase_WithArgs(Action<ChaseObjectVertical> orig, ChaseObjectVertical self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<ChaseObjectVertical> orig, ChaseObjectVertical self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<ChaseObjectVertical> orig, ChaseObjectVertical self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<ChaseObjectVertical> orig, ChaseObjectVertical self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<ChaseObjectVertical> orig, ChaseObjectVertical self);

        public sealed class Params_Reset
        {
            public ChaseObjectVertical self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "Awake"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "OnEnter"), value);
        ...
        public static event Delegates.DoChase_WithArgs DoChase
        {
            add => HookEndpointManager.Add<Delegates.DoChase_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectVertical), "DoChase"), value);
