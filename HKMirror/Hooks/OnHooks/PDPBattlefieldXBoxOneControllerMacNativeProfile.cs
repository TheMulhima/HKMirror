...
public static class OnPDPBattlefieldXBoxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(PDPBattlefieldXBoxOneControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PDPBattlefieldXBoxOneControllerMacNativeProfile> orig,
            PDPBattlefieldXBoxOneControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PDPBattlefieldXBoxOneControllerMacNativeProfile> orig,
            PDPBattlefieldXBoxOneControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PDPBattlefieldXBoxOneControllerMacNativeProfile self;
        }
    }
