...
public static class OnPDPBattlefieldXBoxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.PDPBattlefieldXBoxOneControllerMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.PDPBattlefieldXBoxOneControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.PDPBattlefieldXBoxOneControllerMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.PDPBattlefieldXBoxOneControllerMacNativeProfile), "Define",
                    true), value);
