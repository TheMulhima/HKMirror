...
public static class OnCapturePoseAsAnimationClip
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip> orig,
            HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self)
        {
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip> orig,
            HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self)
        {
        ...
        internal static void HookDoCaptureAnimationClip()
        {
            if (!HookedList.Contains("DoCaptureAnimationClip"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                        "DoCaptureAnimationClip", true), DoCaptureAnimationClip);
            }
        }
        ...
        private static void DoCaptureAnimationClip(
            Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip> orig,
            HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self)
        {
        ...
        internal static void HookCaptureTransform()
        {
            if (!HookedList.Contains("CaptureTransform"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                        "CaptureTransform", true), CaptureTransform);
            }
        }
        ...
        private static void CaptureTransform(
            Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip, UnityEngine.Transform, string,
                UnityEngine.AnimationClip> orig, HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self,
            UnityEngine.Transform transform, string path, UnityEngine.AnimationClip clip)
        {
        ...
        internal static void HookCapturePosition()
        {
            if (!HookedList.Contains("CapturePosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                        "CapturePosition", true), CapturePosition);
            }
        }
        ...
        internal static void HookCaptureRotation()
        {
            if (!HookedList.Contains("CaptureRotation"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                        "CaptureRotation", true), CaptureRotation);
            }
        }
        ...
        internal static void HookCaptureScale()
        {
            if (!HookedList.Contains("CaptureScale"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                        "CaptureScale", true), CaptureScale);
            }
        }
        ...
        private static void CaptureScale(
            Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip, UnityEngine.Transform, string,
                UnityEngine.AnimationClip> orig, HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self,
            UnityEngine.Transform transform, string path, UnityEngine.AnimationClip clip)
        {
        ...
        internal static void HookSetConstantCurve()
        {
            if (!HookedList.Contains("SetConstantCurve"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                        "SetConstantCurve", true), SetConstantCurve);
            }
        }
        ...
        private static void SetConstantCurve(
            Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip, UnityEngine.AnimationClip, string, string,
                float> orig, HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self,
            UnityEngine.AnimationClip clip, string childPath, string propertyPath, float value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip> orig,
            HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip> orig,
            HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self);
        ...
        public delegate void DoCaptureAnimationClip_WithArgs(
            Action<HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip> orig,
            HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip self);
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoCaptureAnimationClip_WithArgs DoCaptureAnimationClip
        {
            add => HookEndpointManager.Add<Delegates.DoCaptureAnimationClip_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CapturePoseAsAnimationClip),
                    "DoCaptureAnimationClip", true), value);
