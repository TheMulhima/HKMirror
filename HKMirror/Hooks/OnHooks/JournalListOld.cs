...
private static bool GetWarriorGhost(On.JournalListOld.orig_GetWarriorGhost orig,JournalListOld self,  int itemNum)
{
...
private static string GetPlayerDataBoolName(On.JournalListOld.orig_GetPlayerDataBoolName orig,JournalListOld self,  int itemNum)
{
...
private static string GetPlayerDataKillsName(On.JournalListOld.orig_GetPlayerDataKillsName orig,JournalListOld self,  int itemNum)
{
...
private static string GetPlayerDataNewDataName(On.JournalListOld.orig_GetPlayerDataNewDataName orig,JournalListOld self,  int itemNum)
{
...
private static UnityEngine.Sprite GetSprite(On.JournalListOld.orig_GetSprite orig,JournalListOld self,  int itemNum)
{
...
public delegate string GetNameConvo_WithArgs (Func<JournalListOld,  int, string> orig, JournalListOld self,  int itemNum);
...
public delegate string GetDescConvo_WithArgs (Func<JournalListOld,  int, string> orig, JournalListOld self,  int itemNum);
...
public delegate bool GetWarriorGhost_WithArgs (Func<JournalListOld,  int, bool> orig, JournalListOld self,  int itemNum);
...
public delegate string GetNotesConvo_WithArgs (Func<JournalListOld,  int, string> orig, JournalListOld self,  int itemNum);
...
public delegate string GetPlayerDataBoolName_WithArgs (Func<JournalListOld,  int, string> orig, JournalListOld self,  int itemNum);
...
public delegate string GetPlayerDataKillsName_WithArgs (Func<JournalListOld,  int, string> orig, JournalListOld self,  int itemNum);
...
public delegate string GetPlayerDataNewDataName_WithArgs (Func<JournalListOld,  int, string> orig, JournalListOld self,  int itemNum);
...
public delegate UnityEngine.Sprite GetSprite_WithArgs (Func<JournalListOld,  int, UnityEngine.Sprite> orig, JournalListOld self,  int itemNum);
