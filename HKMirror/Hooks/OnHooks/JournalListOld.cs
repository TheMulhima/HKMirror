...
public static class OnJournalListOld
{
    internal static class HookHandler
    {
        ...
        private static UnityEngine.Sprite GetSprite(On.JournalListOld.orig_GetSprite orig, JournalListOld self,
            int itemNum)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Sprite GetSprite_WithArgs(Func<JournalListOld, int, UnityEngine.Sprite> orig,
            JournalListOld self, int itemNum);
