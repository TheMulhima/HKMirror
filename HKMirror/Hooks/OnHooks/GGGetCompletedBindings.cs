...
/// <summary>
/// Contains different types of On Hooks for GGGetCompletedBindings class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGGGetCompletedBindings
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GGGetCompletedBindings), "get_IntValue", true), get_IntValue);
...
private static int get_IntValue(Func<GGGetCompletedBindings, int> orig, GGGetCompletedBindings self)
{
...
{
public GGGetCompletedBindings self;
}
...
public delegate int get_IntValue_WithArgs (Func<GGGetCompletedBindings, int> orig, GGGetCompletedBindings self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_IntValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGGetCompletedBindings), "get_IntValue", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IntValue_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GGGetCompletedBindings), "get_IntValue", true), value);
}
}
