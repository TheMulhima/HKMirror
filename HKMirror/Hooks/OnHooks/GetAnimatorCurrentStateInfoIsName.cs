...
public static class OnGetAnimatorCurrentStateInfoIsName
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName), "OnActionUpdate",
                        true), OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName self)
        {
        ...
        internal static void HookIsName()
        {
            if (!HookedList.Contains("IsName"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName), "IsName", true),
                    IsName);
            }
        }
        ...
        private static void IsName(Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorCurrentStateInfoIsName),
                    "Reset", true), value);
