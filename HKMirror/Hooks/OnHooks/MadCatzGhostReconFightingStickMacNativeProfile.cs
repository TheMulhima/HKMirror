...
public static class OnMadCatzGhostReconFightingStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(MadCatzGhostReconFightingStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzGhostReconFightingStickMacNativeProfile> orig,
            MadCatzGhostReconFightingStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzGhostReconFightingStickMacNativeProfile> orig,
            MadCatzGhostReconFightingStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzGhostReconFightingStickMacNativeProfile self;
        }
    }
