...
public static class OnMadCatzGhostReconFightingStickMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.MadCatzGhostReconFightingStickMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.MadCatzGhostReconFightingStickMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.MadCatzGhostReconFightingStickMacNativeProfile self)
        {
