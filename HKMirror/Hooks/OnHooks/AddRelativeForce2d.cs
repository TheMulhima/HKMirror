...
public static class OnAddRelativeForce2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d),
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self)
        {
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self)
        {
        ...
        internal static void HookDoAddRelativeForce()
        {
            if (!HookedList.Contains("DoAddRelativeForce"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d),
                        "DoAddRelativeForce", true), DoAddRelativeForce);
            }
        }
        ...
        private static void DoAddRelativeForce(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self)
        {
            ...
            {
                foreach (Delegates.DoAddRelativeForce_BeforeArgs toInvoke in
                         _beforeDoAddRelativeForce.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.DoAddRelativeForce_AfterArgs toInvoke in
                         _afterDoAddRelativeForce.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self);
        ...
        public delegate void DoAddRelativeForce_WithArgs(Action<HutongGames.PlayMaker.Actions.AddRelativeForce2d> orig,
            HutongGames.PlayMaker.Actions.AddRelativeForce2d self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d), "Reset", true),
                value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d), "OnPreprocess",
                    true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoAddRelativeForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d),
                    "DoAddRelativeForce", true), value);
            remove => HookEndpointManager.Remove<Delegates.DoAddRelativeForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddRelativeForce2d),
                    "DoAddRelativeForce", true), value);
        }
    }
