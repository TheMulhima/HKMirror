...
public static class OnLogitechModeXAmazonUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechModeXAmazonUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechModeXAmazonUnityProfile> orig, LogitechModeXAmazonUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechModeXAmazonUnityProfile> orig,
            LogitechModeXAmazonUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechModeXAmazonUnityProfile self;
        }
    }
