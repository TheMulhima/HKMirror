...
public static class OnIpegaPG9037AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IpegaPG9037AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<IpegaPG9037AndroidUnityProfile> orig, IpegaPG9037AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<IpegaPG9037AndroidUnityProfile> orig,
            IpegaPG9037AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public IpegaPG9037AndroidUnityProfile self;
        }
    }
