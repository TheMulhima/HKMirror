...
public static class OnIpegaPG9037AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.IpegaPG9037AndroidUnityProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.IpegaPG9037AndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.IpegaPG9037AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<InControl.UnityDeviceProfiles.IpegaPG9037AndroidUnityProfile> orig,
            InControl.UnityDeviceProfiles.IpegaPG9037AndroidUnityProfile self);
    }
