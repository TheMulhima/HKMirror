...
private static void SetPlayerDataBoolTrue(On.CaptureAnimationEvent.orig_SetPlayerDataBoolTrue orig,CaptureAnimationEvent self,  string boolName)
{
...
{
foreach (Delegates.SetPlayerDataBoolTrue_BeforeArgs toInvoke in _beforeSetPlayerDataBoolTrue.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPlayerDataBoolTrue_AfterArgs toInvoke in _afterSetPlayerDataBoolTrue.GetInvocationList())
{
try
{
...
private static void SetPlayerDataBoolFalse(On.CaptureAnimationEvent.orig_SetPlayerDataBoolFalse orig,CaptureAnimationEvent self,  string boolName)
{
...
{
foreach (Delegates.SetPlayerDataBoolFalse_BeforeArgs toInvoke in _beforeSetPlayerDataBoolFalse.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPlayerDataBoolFalse_AfterArgs toInvoke in _afterSetPlayerDataBoolFalse.GetInvocationList())
{
try
{
...
private static void IncrementPlayerDataInt(On.CaptureAnimationEvent.orig_IncrementPlayerDataInt orig,CaptureAnimationEvent self,  string intName)
{
...
private static void DecrementPlayerDataInt(On.CaptureAnimationEvent.orig_DecrementPlayerDataInt orig,CaptureAnimationEvent self,  string intName)
{
...
private static bool GetPlayerDataBool(On.CaptureAnimationEvent.orig_GetPlayerDataBool orig,CaptureAnimationEvent self,  string boolName)
{
...
private static int GetPlayerDataInt(On.CaptureAnimationEvent.orig_GetPlayerDataInt orig,CaptureAnimationEvent self,  string intName)
{
...
private static float GetPlayerDataFloat(On.CaptureAnimationEvent.orig_GetPlayerDataFloat orig,CaptureAnimationEvent self,  string floatName)
{
...
private static string GetPlayerDataString(On.CaptureAnimationEvent.orig_GetPlayerDataString orig,CaptureAnimationEvent self,  string stringName)
{
...
private static void EquipCharm(On.CaptureAnimationEvent.orig_EquipCharm orig,CaptureAnimationEvent self,  int charmNum)
{
...
private static void UnequipCharm(On.CaptureAnimationEvent.orig_UnequipCharm orig,CaptureAnimationEvent self,  int charmNum)
{
...
private static void UpdateBlueHealth(On.CaptureAnimationEvent.orig_UpdateBlueHealth orig,CaptureAnimationEvent self)
{
...
public delegate void SetPlayerDataBoolTrue_WithArgs (Action<CaptureAnimationEvent,  string> orig, CaptureAnimationEvent self,  string boolName);
...
public delegate void SetPlayerDataBoolFalse_WithArgs (Action<CaptureAnimationEvent,  string> orig, CaptureAnimationEvent self,  string boolName);
...
public delegate void IncrementPlayerDataInt_WithArgs (Action<CaptureAnimationEvent,  string> orig, CaptureAnimationEvent self,  string intName);
...
public delegate void DecrementPlayerDataInt_WithArgs (Action<CaptureAnimationEvent,  string> orig, CaptureAnimationEvent self,  string intName);
...
public delegate bool GetPlayerDataBool_WithArgs (Func<CaptureAnimationEvent,  string, bool> orig, CaptureAnimationEvent self,  string boolName);
...
public delegate int GetPlayerDataInt_WithArgs (Func<CaptureAnimationEvent,  string, int> orig, CaptureAnimationEvent self,  string intName);
...
public delegate float GetPlayerDataFloat_WithArgs (Func<CaptureAnimationEvent,  string, float> orig, CaptureAnimationEvent self,  string floatName);
...
public delegate string GetPlayerDataString_WithArgs (Func<CaptureAnimationEvent,  string, string> orig, CaptureAnimationEvent self,  string stringName);
...
public delegate void EquipCharm_WithArgs (Action<CaptureAnimationEvent,  int> orig, CaptureAnimationEvent self,  int charmNum);
...
public delegate void UnequipCharm_WithArgs (Action<CaptureAnimationEvent,  int> orig, CaptureAnimationEvent self,  int charmNum);
