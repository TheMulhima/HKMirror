...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InGameCutsceneInfo), "get_IsInCutscene", false), get_IsInCutscene);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(InGameCutsceneInfo), "get_CameraPosition", false), get_CameraPosition);
...
{
foreach (Delegates.get_CameraPosition_BeforeArgs toInvoke in _beforeget_CameraPosition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_CameraPosition_AfterArgs toInvoke in _afterget_CameraPosition.GetInvocationList())
{
try
{
...
{
add => HookEndpointManager.Add<Delegates.get_IsInCutscene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InGameCutsceneInfo), "get_IsInCutscene", false), value);
remove => HookEndpointManager.Remove<Delegates.get_IsInCutscene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InGameCutsceneInfo), "get_IsInCutscene", false), value);
}
public static event Delegates.get_CameraPosition_WithArgs get_CameraPosition
{
add => HookEndpointManager.Add<Delegates.get_CameraPosition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InGameCutsceneInfo), "get_CameraPosition", false), value);
remove => HookEndpointManager.Remove<Delegates.get_CameraPosition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(InGameCutsceneInfo), "get_CameraPosition", false), value);
}
