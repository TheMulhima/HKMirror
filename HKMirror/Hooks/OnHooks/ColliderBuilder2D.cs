...
/// <summary>
///     Contains different types of On Hooks for ColliderBuilder2D class.<br />
///     Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnColliderBuilder2D
{
    internal static class HookHandler
    {
        ...
        internal static void HookBuild()
        {
            if (!HookedList.Contains("Build"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "Build", false), Build);
            }
        }
        ...
        internal static void HookBuildForChunk()
        {
            if (!HookedList.Contains("BuildForChunk"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "BuildForChunk", false),
                    BuildForChunk);
            }
        }
        ...
        internal static void HookBuildLocalMeshForChunk()
        {
            if (!HookedList.Contains("BuildLocalMeshForChunk"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "BuildLocalMeshForChunk", false),
        ...
        private static void BuildLocalMeshForChunk(Action<tk2dTileMap, SpriteChunk, int, int, Vector2[], int[]> orig,
            tk2dTileMap tileMap, SpriteChunk chunk, int baseX, int baseY, Vector2[] vertices, int[] indices)
        {
        ...
        internal static void HookCompareWeldVertices()
        {
            if (!HookedList.Contains("CompareWeldVertices"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "CompareWeldVertices", false),
                    CompareWeldVertices);
            }
        }
        ...
        private static int CompareWeldVertices(Func<Vector2, Vector2, int> orig, Vector2 a, Vector2 b)
        {
        ...
        internal static void HookWeldVertices()
        {
            if (!HookedList.Contains("WeldVertices"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "WeldVertices", false),
                    WeldVertices);
            }
        }
        ...
        private static Vector2[] WeldVertices(Func<Vector2[], int[], Vector2[]> orig, Vector2[] vertices, int[] indices)
        {
        ...
        internal static void HookCompareDuplicateFaces()
        {
            if (!HookedList.Contains("CompareDuplicateFaces"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "CompareDuplicateFaces", false),
        ...
        internal static void HookRemoveDuplicateEdges()
        {
            if (!HookedList.Contains("RemoveDuplicateEdges"))
            {
                HookedList.Add("RemoveDuplicateEdges");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "RemoveDuplicateEdges", false),
                    RemoveDuplicateEdges);
            }
        }

        internal static event Delegates.RemoveDuplicateEdges_BeforeArgs _beforeRemoveDuplicateEdges;
        internal static event Delegates.RemoveDuplicateEdges_AfterArgs _afterRemoveDuplicateEdges;

        private static int[] RemoveDuplicateEdges(Func<int[], int[]> orig, int[] indices)
        {
            Delegates.Params_RemoveDuplicateEdges @params = new()
            {
                indices = indices
            };
            if (_beforeRemoveDuplicateEdges != null)
                foreach (Delegates.RemoveDuplicateEdges_BeforeArgs toInvoke in _beforeRemoveDuplicateEdges
                             .GetInvocationList())
                    try
                    {
                        _beforeRemoveDuplicateEdges?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            if (_afterRemoveDuplicateEdges != null)
                foreach (Delegates.RemoveDuplicateEdges_AfterArgs toInvoke in _afterRemoveDuplicateEdges
                             .GetInvocationList())
                    try
                    {
                        retVal = _afterRemoveDuplicateEdges.Invoke(@params, retVal);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
        ...
        internal static void HookMergeEdges()
        {
            if (!HookedList.Contains("MergeEdges"))
            {
                HookedList.Add("MergeEdges");
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "MergeEdges", false), MergeEdges);
            }
        }

        internal static event Delegates.MergeEdges_BeforeArgs _beforeMergeEdges;
        internal static event Delegates.MergeEdges_AfterArgs _afterMergeEdges;

        private static List<Vector2[]> MergeEdges(Func<Vector2[], int[], List<Vector2[]>> orig, Vector2[] verts,
            int[] indices)
        {
            Delegates.Params_MergeEdges @params = new()
            {
                verts = verts, indices = indices
            };
            if (_beforeMergeEdges != null)
                foreach (Delegates.MergeEdges_BeforeArgs toInvoke in _beforeMergeEdges.GetInvocationList())
                    try
                    {
                        _beforeMergeEdges?.Invoke(@params);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
            ...
            verts = @params.verts;
            indices = @params.indices;
            var retVal = orig(verts, indices);
            if (_afterMergeEdges != null)
                foreach (Delegates.MergeEdges_AfterArgs toInvoke in _afterMergeEdges.GetInvocationList())
                    try
                    {
                        retVal = _afterMergeEdges.Invoke(@params, retVal);
                    }
                    catch (Exception e)
                    {
                        HKMirrorMod.DoLogError(e);
    ...
    public static class Delegates
    {
        ...
        public delegate void BuildLocalMeshForChunk_WithArgs(
            Action<tk2dTileMap, SpriteChunk, int, int, Vector2[], int[]> orig, tk2dTileMap tileMap, SpriteChunk chunk,
            int baseX, int baseY, Vector2[] vertices, int[] indices);
        ...
        public delegate int CompareWeldVertices_WithArgs(Func<Vector2, Vector2, int> orig, Vector2 a, Vector2 b);

        public delegate List<Vector2[]> MergeEdges_AfterArgs(Params_MergeEdges args, List<Vector2[]> ret);

        public delegate void MergeEdges_BeforeArgs(Params_MergeEdges args);

        public delegate List<Vector2[]> MergeEdges_WithArgs(Func<Vector2[], int[], List<Vector2[]>> orig,
            Vector2[] verts, int[] indices);

        public delegate int[] RemoveDuplicateEdges_AfterArgs(Params_RemoveDuplicateEdges args, int[] ret);

        public delegate void RemoveDuplicateEdges_BeforeArgs(Params_RemoveDuplicateEdges args);

        public delegate int[] RemoveDuplicateEdges_WithArgs(Func<int[], int[]> orig, int[] indices);

        public delegate Vector2[] WeldVertices_AfterArgs(Params_WeldVertices args, Vector2[] ret);

        public delegate void WeldVertices_BeforeArgs(Params_WeldVertices args);

        public delegate Vector2[] WeldVertices_WithArgs(Func<Vector2[], int[], Vector2[]> orig, Vector2[] vertices,
            int[] indices);
        ...
        public sealed class Params_RemoveDuplicateEdges
        {
            public int[] indices;
        }

        public sealed class Params_MergeEdges
        {
            public int[] indices;
    ...
    public static class BeforeOrig
    {
        ...
        public static event Delegates.RemoveDuplicateEdges_BeforeArgs RemoveDuplicateEdges
        {
            add
            {
                HookHandler._beforeRemoveDuplicateEdges += value;
                HookHandler.HookRemoveDuplicateEdges();
            }
            remove => HookHandler._beforeRemoveDuplicateEdges -= value;
        }

        public static event Delegates.MergeEdges_BeforeArgs MergeEdges
        {
            add
            {
                HookHandler._beforeMergeEdges += value;
                HookHandler.HookMergeEdges();
            }
            remove => HookHandler._beforeMergeEdges -= value;
        }
    }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.RemoveDuplicateEdges_AfterArgs RemoveDuplicateEdges
        {
            add
            {
                HookHandler._afterRemoveDuplicateEdges += value;
                HookHandler.HookRemoveDuplicateEdges();
            }
            remove => HookHandler._afterRemoveDuplicateEdges -= value;
        }

        public static event Delegates.MergeEdges_AfterArgs MergeEdges
        {
            add
            {
                HookHandler._afterMergeEdges += value;
                HookHandler.HookMergeEdges();
            }
            remove => HookHandler._afterMergeEdges -= value;
        }
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.RemoveDuplicateEdges_WithArgs RemoveDuplicateEdges
        {
            add => HookEndpointManager.Add<Delegates.RemoveDuplicateEdges_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "RemoveDuplicateEdges", false), value);
            remove => HookEndpointManager.Remove<Delegates.RemoveDuplicateEdges_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "RemoveDuplicateEdges", false), value);
        }

        public static event Delegates.MergeEdges_WithArgs MergeEdges
        {
            add => HookEndpointManager.Add<Delegates.MergeEdges_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "MergeEdges", false), value);
            remove => HookEndpointManager.Remove<Delegates.MergeEdges_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ColliderBuilder2D), "MergeEdges", false), value);
        }
    }
}