...
public static class OnFloatMultiplyV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnEnter_WithArgs(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<FloatMultiplyV2> orig, FloatMultiplyV2 self);

        public sealed class Params_Reset
        {
            public FloatMultiplyV2 self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "Reset"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnUpdate"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(FloatMultiplyV2), "OnFixedUpdate"), value);
