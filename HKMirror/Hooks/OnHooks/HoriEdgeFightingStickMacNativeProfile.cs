...
public static class OnHoriEdgeFightingStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriEdgeFightingStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriEdgeFightingStickMacNativeProfile> orig,
            HoriEdgeFightingStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriEdgeFightingStickMacNativeProfile> orig,
            HoriEdgeFightingStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriEdgeFightingStickMacNativeProfile self;
        }
    }
