...
public static class OnCheckCollisionSide
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckCollisionSide), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckCollisionSide), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckCollisionSide), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckCollisionSide), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self)
        {
        ...
        internal static void HookDoCollisionStay2D()
        {
            if (!HookedList.Contains("DoCollisionStay2D"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckCollisionSide),
        ...
        private static void DoCollisionStay2D(
            Action<HutongGames.PlayMaker.Actions.CheckCollisionSide, UnityEngine.Collision2D> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self, UnityEngine.Collision2D collision)
        {
        ...
        internal static void HookCheckTouching()
        {
            if (!HookedList.Contains("CheckTouching"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckCollisionSide),
                        "CheckTouching", true), CheckTouching);
            }
        }
        ...
        private static void CheckTouching(
            Action<HutongGames.PlayMaker.Actions.CheckCollisionSide, UnityEngine.LayerMask> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self, UnityEngine.LayerMask layer)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.CheckCollisionSide> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self);
        ...
        public delegate void CheckTouching_WithArgs(
            Action<HutongGames.PlayMaker.Actions.CheckCollisionSide, UnityEngine.LayerMask> orig,
            HutongGames.PlayMaker.Actions.CheckCollisionSide self, UnityEngine.LayerMask layer);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CheckCollisionSide), "Reset", true),
                value);
