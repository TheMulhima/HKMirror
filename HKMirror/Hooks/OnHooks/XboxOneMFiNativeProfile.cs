...
public static class OnXboxOneMFiNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneMFiNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneMFiNativeProfile> orig, XboxOneMFiNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneMFiNativeProfile> orig, XboxOneMFiNativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneMFiNativeProfile self;
        }
    }
