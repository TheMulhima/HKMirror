...
public static class OnEndBossSceneTimer
{
    ...
    {
        public delegate IEnumerator Delayed_AfterArgs(Params_Delayed args, IEnumerator ret);

        public delegate void Delayed_BeforeArgs(Params_Delayed args);

        public delegate IEnumerator Delayed_WithArgs(Func<EndBossSceneTimer, IEnumerator> orig, EndBossSceneTimer self);
