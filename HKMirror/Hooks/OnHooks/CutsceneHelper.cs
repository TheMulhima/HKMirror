...
public static class OnCutsceneHelper
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator SkipCutscene_AfterArgs(Params_SkipCutscene args, IEnumerator ret);

        public delegate void SkipCutscene_BeforeArgs(Params_SkipCutscene args);

        public delegate IEnumerator SkipCutscene_WithArgs(Func<CutsceneHelper, IEnumerator> orig, CutsceneHelper self);

        public delegate IEnumerator Start_AfterArgs(Params_Start args, IEnumerator ret);

        public delegate void Start_BeforeArgs(Params_Start args);

        public delegate IEnumerator Start_WithArgs(Func<CutsceneHelper, IEnumerator> orig, CutsceneHelper self);
