...
public static class OnSamsungGP20AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SamsungGP20AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<SamsungGP20AndroidUnityProfile> orig, SamsungGP20AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SamsungGP20AndroidUnityProfile> orig,
            SamsungGP20AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public SamsungGP20AndroidUnityProfile self;
        }
    }
