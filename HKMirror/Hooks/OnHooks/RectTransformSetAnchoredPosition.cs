...
public static class OnRectTransformSetAnchoredPosition
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition), "OnActionUpdate", true),
                    OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition self)
        {
        ...
        internal static void HookDoSetAnchoredPosition()
        {
            if (!HookedList.Contains("DoSetAnchoredPosition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition), "DoSetAnchoredPosition",
                        true), DoSetAnchoredPosition);
            }
        }
        ...
        private static void DoSetAnchoredPosition(
            Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition self)
        {
            ...
            {
                foreach (Delegates.DoSetAnchoredPosition_BeforeArgs toInvoke in _beforeDoSetAnchoredPosition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.DoSetAnchoredPosition_AfterArgs toInvoke in _afterDoSetAnchoredPosition
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition self);
        ...
        public delegate void DoSetAnchoredPosition_WithArgs(
            Action<HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition),
                    "Reset", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoSetAnchoredPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition),
                    "DoSetAnchoredPosition", true), value);
            remove => HookEndpointManager.Remove<Delegates.DoSetAnchoredPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetAnchoredPosition),
                    "DoSetAnchoredPosition", true), value);
        }
    }
