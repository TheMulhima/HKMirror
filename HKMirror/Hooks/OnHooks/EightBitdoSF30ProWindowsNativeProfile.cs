...
public static class OnEightBitdoSF30ProWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSF30ProWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSF30ProWindowsNativeProfile> orig,
            EightBitdoSF30ProWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSF30ProWindowsNativeProfile> orig,
            EightBitdoSF30ProWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSF30ProWindowsNativeProfile self;
        }
    }
