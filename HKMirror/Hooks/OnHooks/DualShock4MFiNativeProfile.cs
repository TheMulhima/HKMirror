...
public static class OnDualShock4MFiNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DualShock4MFiNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<DualShock4MFiNativeProfile> orig, DualShock4MFiNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<DualShock4MFiNativeProfile> orig, DualShock4MFiNativeProfile self);

        public sealed class Params_Define
        {
            public DualShock4MFiNativeProfile self;
        }
    }
