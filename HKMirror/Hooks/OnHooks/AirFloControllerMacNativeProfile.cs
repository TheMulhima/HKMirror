...
public static class OnAirFloControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AirFloControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<AirFloControllerMacNativeProfile> orig, AirFloControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<AirFloControllerMacNativeProfile> orig,
            AirFloControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public AirFloControllerMacNativeProfile self;
        }
    }
