...
public static class OnRectTransformGetRect
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetRect), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<RectTransformGetRect> orig, RectTransformGetRect self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetRect), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<RectTransformGetRect> orig, RectTransformGetRect self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetRect), "OnActionUpdate"),
                    OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(Action<RectTransformGetRect> orig, RectTransformGetRect self)
        {
        ...
        internal static void HookDoGetValues()
        {
            if (!HookedList.Contains("DoGetValues"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetRect), "DoGetValues"), DoGetValues);
            }
        }
        ...
        private static void DoGetValues(Action<RectTransformGetRect> orig, RectTransformGetRect self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetValues_WithArgs(Action<RectTransformGetRect> orig, RectTransformGetRect self);
        ...
        public delegate void OnActionUpdate_WithArgs(Action<RectTransformGetRect> orig, RectTransformGetRect self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<RectTransformGetRect> orig, RectTransformGetRect self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<RectTransformGetRect> orig, RectTransformGetRect self);

        public sealed class Params_Reset
        {
            public RectTransformGetRect self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RectTransformGetRect), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RectTransformGetRect), "OnEnter"), value);
