...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "SetAlreadyVisible", true), SetAlreadyVisible);
...
private static void SetAlreadyVisible(Action<BossDoorChallengeCompleteUI.BindingIcon,  bool,  bool> orig, BossDoorChallengeCompleteUI.BindingIcon self,  bool value,  bool allUnlocked)
{
...
{
foreach (Delegates.SetAlreadyVisible_BeforeArgs toInvoke in _beforeSetAlreadyVisible.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "DoAppearAnim", true), DoAppearAnim);

}
}
internal static event Delegates.DoAppearAnim_BeforeArgs _beforeDoAppearAnim;
private static System.Collections.IEnumerator DoAppearAnim(Func<BossDoorChallengeCompleteUI.BindingIcon,  float, System.Collections.IEnumerator> orig, BossDoorChallengeCompleteUI.BindingIcon self,  float appearDelay)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "DoAllAppearAnim", true), DoAllAppearAnim);

}
}
internal static event Delegates.DoAllAppearAnim_BeforeArgs _beforeDoAllAppearAnim;
private static System.Collections.IEnumerator DoAllAppearAnim(Func<BossDoorChallengeCompleteUI.BindingIcon,  float, System.Collections.IEnumerator> orig, BossDoorChallengeCompleteUI.BindingIcon self,  float appearDelay)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "SetAllUnlocked", true), SetAllUnlocked);
...
private static void SetAllUnlocked(Action<BossDoorChallengeCompleteUI.BindingIcon> orig, BossDoorChallengeCompleteUI.BindingIcon self)
{
...
public delegate void SetAlreadyVisible_WithArgs (Action<BossDoorChallengeCompleteUI.BindingIcon,  bool,  bool> orig, BossDoorChallengeCompleteUI.BindingIcon self,  bool value,  bool allUnlocked);
...
public delegate System.Collections.IEnumerator DoAppearAnim_AfterArgs(Params_DoAppearAnim args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DoAppearAnim_WithArgs (Func<BossDoorChallengeCompleteUI.BindingIcon,  float, System.Collections.IEnumerator> orig, BossDoorChallengeCompleteUI.BindingIcon self,  float appearDelay);
...
public delegate System.Collections.IEnumerator DoAllAppearAnim_AfterArgs(Params_DoAllAppearAnim args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DoAllAppearAnim_WithArgs (Func<BossDoorChallengeCompleteUI.BindingIcon,  float, System.Collections.IEnumerator> orig, BossDoorChallengeCompleteUI.BindingIcon self,  float appearDelay);
...
public delegate void SetAllUnlocked_WithArgs (Action<BossDoorChallengeCompleteUI.BindingIcon> orig, BossDoorChallengeCompleteUI.BindingIcon self);
}
...
{
add => HookEndpointManager.Add<Delegates.SetAlreadyVisible_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "SetAlreadyVisible", true), value);
remove => HookEndpointManager.Remove<Delegates.SetAlreadyVisible_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "SetAlreadyVisible", true), value);
}
public static event Delegates.DoAppearAnim_WithArgs DoAppearAnim
{
add => HookEndpointManager.Add<Delegates.DoAppearAnim_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "DoAppearAnim", true), value);
remove => HookEndpointManager.Remove<Delegates.DoAppearAnim_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "DoAppearAnim", true), value);
}
public static event Delegates.DoAllAppearAnim_WithArgs DoAllAppearAnim
{
add => HookEndpointManager.Add<Delegates.DoAllAppearAnim_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "DoAllAppearAnim", true), value);
remove => HookEndpointManager.Remove<Delegates.DoAllAppearAnim_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "DoAllAppearAnim", true), value);
}
public static event Delegates.SetAllUnlocked_WithArgs SetAllUnlocked
{
add => HookEndpointManager.Add<Delegates.SetAllUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "SetAllUnlocked", true), value);
remove => HookEndpointManager.Remove<Delegates.SetAllUnlocked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(BossDoorChallengeCompleteUI.BindingIcon), "SetAllUnlocked", true), value);
}
}
