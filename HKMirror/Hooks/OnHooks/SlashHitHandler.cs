...
public static class OnSlashHitHandler
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static void Invoke(
            Action<Modding.Delegates.SlashHitHandler, UnityEngine.Collider2D, UnityEngine.GameObject> orig,
            Modding.Delegates.SlashHitHandler self, UnityEngine.Collider2D otherCollider, UnityEngine.GameObject slash)
        {
            Delegates.Params_Invoke @params = new()
            {
                self = self, otherCollider = otherCollider, slash = slash
            };
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static void EndInvoke(Action<Modding.Delegates.SlashHitHandler, System.IAsyncResult> orig,
            Modding.Delegates.SlashHitHandler self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void EndInvoke_WithArgs(Action<Modding.Delegates.SlashHitHandler, System.IAsyncResult> orig,
            Modding.Delegates.SlashHitHandler self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "EndInvoke", true), value);
