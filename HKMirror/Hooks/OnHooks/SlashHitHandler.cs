...
/// <summary>
/// Contains different types of On Hooks for SlashHitHandler class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnSlashHitHandler
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "Invoke", true), Invoke);
...
private static void Invoke(Action<Modding.Delegates.SlashHitHandler,  UnityEngine.Collider2D,  UnityEngine.GameObject> orig, Modding.Delegates.SlashHitHandler self,  UnityEngine.Collider2D otherCollider,  UnityEngine.GameObject slash)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "EndInvoke", true), EndInvoke);
...
private static void EndInvoke(Action<Modding.Delegates.SlashHitHandler,  System.IAsyncResult> orig, Modding.Delegates.SlashHitHandler self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.SlashHitHandler self;
...
public delegate void Invoke_WithArgs (Action<Modding.Delegates.SlashHitHandler,  UnityEngine.Collider2D,  UnityEngine.GameObject> orig, Modding.Delegates.SlashHitHandler self,  UnityEngine.Collider2D otherCollider,  UnityEngine.GameObject slash);
...
public delegate void EndInvoke_WithArgs (Action<Modding.Delegates.SlashHitHandler,  System.IAsyncResult> orig, Modding.Delegates.SlashHitHandler self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SlashHitHandler), "EndInvoke", true), value);
}
}
