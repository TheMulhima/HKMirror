    ...
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SlashHitHandler), "Invoke"), Invoke);
            }
        }
        ...
        private static void Invoke(Action<SlashHitHandler, Collider2D, GameObject> orig, SlashHitHandler self,
            Collider2D otherCollider, GameObject slash)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SlashHitHandler), "EndInvoke"), EndInvoke);
            }
        }
        ...
        private static void EndInvoke(Action<SlashHitHandler, IAsyncResult> orig, SlashHitHandler self,
            IAsyncResult result)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_NormalArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SlashHitHandler), "Invoke"), value);
        ...
        public static event Delegates.EndInvoke_NormalArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SlashHitHandler), "EndInvoke"), value);
