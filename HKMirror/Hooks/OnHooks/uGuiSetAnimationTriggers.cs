...
public static class OnuGuiSetAnimationTriggers
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSetAnimationTriggers), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSetAnimationTriggers), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSetAnimationTriggers), "DoSetValue"), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSetAnimationTriggers), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiSetAnimationTriggers> orig, uGuiSetAnimationTriggers self);

        public sealed class Params_Reset
        {
            public uGuiSetAnimationTriggers self;
        }
