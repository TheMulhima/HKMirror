...
public static class OnTMP_SpriteAsset
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_defaultSpriteAsset()
        {
            if (!HookedList.Contains("get_defaultSpriteAsset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_SpriteAsset), "get_defaultSpriteAsset", false),
        ...
        internal static void HookGetDefaultSpriteMaterial()
        {
            if (!HookedList.Contains("GetDefaultSpriteMaterial"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_SpriteAsset), "GetDefaultSpriteMaterial", true),
        ...
        private static UnityEngine.Material GetDefaultSpriteMaterial(
            Func<TMPro.TMP_SpriteAsset, UnityEngine.Material> orig, TMPro.TMP_SpriteAsset self)
        {
        ...
        internal static void HookGetSpriteIndex()
        {
            if (!HookedList.Contains("GetSpriteIndex"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_SpriteAsset), "GetSpriteIndex", true),
                    GetSpriteIndex);
            }
        }
        ...
        private static int GetSpriteIndex(Func<TMPro.TMP_SpriteAsset, int, int> orig, TMPro.TMP_SpriteAsset self,
            int hashCode)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Material GetDefaultSpriteMaterial_AfterArgs(Params_GetDefaultSpriteMaterial args,
            UnityEngine.Material ret);

        public delegate UnityEngine.Material GetDefaultSpriteMaterial_WithArgs(
            Func<TMPro.TMP_SpriteAsset, UnityEngine.Material> orig, TMPro.TMP_SpriteAsset self);
        ...
        public delegate int GetSpriteIndex_WithArgs(Func<TMPro.TMP_SpriteAsset, int, int> orig,
            TMPro.TMP_SpriteAsset self, int hashCode);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_defaultSpriteAsset_WithArgs get_defaultSpriteAsset
        {
            add => HookEndpointManager.Add<Delegates.get_defaultSpriteAsset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_SpriteAsset), "get_defaultSpriteAsset", false), value);
        ...
        public static event Delegates.OnEnable_WithArgs OnEnable
        {
            add => HookEndpointManager.Add<Delegates.OnEnable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_SpriteAsset), "OnEnable", true), value);
        ...
        public static event Delegates.GetDefaultSpriteMaterial_WithArgs GetDefaultSpriteMaterial
        {
            add => HookEndpointManager.Add<Delegates.GetDefaultSpriteMaterial_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_SpriteAsset), "GetDefaultSpriteMaterial", true), value);
        ...
        public static event Delegates.GetSpriteIndex_WithArgs GetSpriteIndex
        {
            add => HookEndpointManager.Add<Delegates.GetSpriteIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TMPro.TMP_SpriteAsset), "GetSpriteIndex", true), value);
