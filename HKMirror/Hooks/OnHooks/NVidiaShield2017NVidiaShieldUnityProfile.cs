...
public static class OnNVidiaShield2017NVidiaShieldUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NVidiaShield2017NVidiaShieldUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<NVidiaShield2017NVidiaShieldUnityProfile> orig,
            NVidiaShield2017NVidiaShieldUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NVidiaShield2017NVidiaShieldUnityProfile> orig,
            NVidiaShield2017NVidiaShieldUnityProfile self);

        public sealed class Params_Define
        {
            public NVidiaShield2017NVidiaShieldUnityProfile self;
        }
    }
