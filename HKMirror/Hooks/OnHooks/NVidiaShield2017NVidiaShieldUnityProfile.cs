...
public static class OnNVidiaShield2017NVidiaShieldUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.NVidiaShield2017NVidiaShieldUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.NVidiaShield2017NVidiaShieldUnityProfile> orig,
            InControl.UnityDeviceProfiles.NVidiaShield2017NVidiaShieldUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.NVidiaShield2017NVidiaShieldUnityProfile> orig,
            InControl.UnityDeviceProfiles.NVidiaShield2017NVidiaShieldUnityProfile self);
    }
