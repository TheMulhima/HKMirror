...
public static class OnPowerAAirflowControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PowerAAirflowControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PowerAAirflowControllerMacNativeProfile> orig,
            PowerAAirflowControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PowerAAirflowControllerMacNativeProfile> orig,
            PowerAAirflowControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PowerAAirflowControllerMacNativeProfile self;
        }
    }
