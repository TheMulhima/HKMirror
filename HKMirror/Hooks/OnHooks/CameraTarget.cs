...
private static void EnterLockZone(On.CameraTarget.orig_EnterLockZone orig,CameraTarget self,  float xLockMin_var,  float xLockMax_var,  float yLockMin_var,  float yLockMax_var)
{
Delegates.Params_EnterLockZone @params = new() 
{
self = self
, xLockMin_var = xLockMin_var
, xLockMax_var = xLockMax_var
, yLockMin_var = yLockMin_var
...
private static void EnterLockZoneInstant(On.CameraTarget.orig_EnterLockZoneInstant orig,CameraTarget self,  float xLockMin_var,  float xLockMax_var,  float yLockMin_var,  float yLockMax_var)
{
...
{
foreach (Delegates.EnterLockZoneInstant_BeforeArgs toInvoke in _beforeEnterLockZoneInstant.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnterLockZoneInstant_AfterArgs toInvoke in _afterEnterLockZoneInstant.GetInvocationList())
{
try
{
...
public delegate void EnterLockZone_WithArgs (Action<CameraTarget,  float,  float,  float,  float> orig, CameraTarget self,  float xLockMin_var,  float xLockMax_var,  float yLockMin_var,  float yLockMax_var);
...
public delegate void EnterLockZoneInstant_WithArgs (Action<CameraTarget,  float,  float,  float,  float> orig, CameraTarget self,  float xLockMin_var,  float xLockMax_var,  float yLockMin_var,  float yLockMax_var);
