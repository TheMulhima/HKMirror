...
public static class OnSetGravity
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self)
        {
        ...
        internal static void HookDoSetGravity()
        {
            if (!HookedList.Contains("DoSetGravity"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity), "DoSetGravity",
                        true), DoSetGravity);
            }
        }
        ...
        private static void DoSetGravity(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self);
        ...
        public delegate void DoSetGravity_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity> orig,
            HutongGames.PlayMaker.Actions.SetGravity self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity), "Reset", true), value);
        ...
        public static event Delegates.DoSetGravity_WithArgs DoSetGravity
        {
            add => HookEndpointManager.Add<Delegates.DoSetGravity_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity), "DoSetGravity", true),
                value);
