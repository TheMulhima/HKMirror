...
public static class OnPOWERAFUS1ONTournamentControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.POWERAFUS1ONTournamentControllerMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.POWERAFUS1ONTournamentControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.POWERAFUS1ONTournamentControllerMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.POWERAFUS1ONTournamentControllerMacNativeProfile), "Define",
                    true), value);
