...
public static class OnPOWERAFUS1ONTournamentControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(POWERAFUS1ONTournamentControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<POWERAFUS1ONTournamentControllerMacNativeProfile> orig,
            POWERAFUS1ONTournamentControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<POWERAFUS1ONTournamentControllerMacNativeProfile> orig,
            POWERAFUS1ONTournamentControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public POWERAFUS1ONTournamentControllerMacNativeProfile self;
        }
    }
