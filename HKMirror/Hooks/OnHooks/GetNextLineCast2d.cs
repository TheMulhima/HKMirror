...
public static class OnGetNextLineCast2d
{
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetNextCollider_WithArgs(Action<GetNextLineCast2d> orig, GetNextLineCast2d self);

        public delegate RaycastHit2D[] GetLineCastAll_AfterArgs(Params_GetLineCastAll args, RaycastHit2D[] ret);

        public delegate void GetLineCastAll_BeforeArgs(Params_GetLineCastAll args);

        public delegate RaycastHit2D[] GetLineCastAll_WithArgs(Func<GetNextLineCast2d, RaycastHit2D[]> orig,
            GetNextLineCast2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<GetNextLineCast2d> orig, GetNextLineCast2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GetNextLineCast2d> orig, GetNextLineCast2d self);
