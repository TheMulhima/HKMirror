...
public static class OnGetNextLineCast2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextLineCast2d), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetNextLineCast2d> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextLineCast2d), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetNextLineCast2d> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self)
        {
        ...
        internal static void HookDoGetNextCollider()
        {
            if (!HookedList.Contains("DoGetNextCollider"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextLineCast2d),
        ...
        private static void DoGetNextCollider(Action<HutongGames.PlayMaker.Actions.GetNextLineCast2d> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self)
        {
        ...
        internal static void HookGetLineCastAll()
        {
            if (!HookedList.Contains("GetLineCastAll"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextLineCast2d),
                        "GetLineCastAll", true), GetLineCastAll);
            }
        }
        ...
        private static UnityEngine.RaycastHit2D[] GetLineCastAll(
            Func<HutongGames.PlayMaker.Actions.GetNextLineCast2d, UnityEngine.RaycastHit2D[]> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNextLineCast2d> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNextLineCast2d> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self);
        ...
        public delegate void DoGetNextCollider_WithArgs(Action<HutongGames.PlayMaker.Actions.GetNextLineCast2d> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self);
        ...
        public delegate UnityEngine.RaycastHit2D[] GetLineCastAll_AfterArgs(Params_GetLineCastAll args,
            UnityEngine.RaycastHit2D[] ret);

        public delegate UnityEngine.RaycastHit2D[] GetLineCastAll_WithArgs(
            Func<HutongGames.PlayMaker.Actions.GetNextLineCast2d, UnityEngine.RaycastHit2D[]> orig,
            HutongGames.PlayMaker.Actions.GetNextLineCast2d self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextLineCast2d), "Reset", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetLineCastAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextLineCast2d),
                    "GetLineCastAll", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetLineCastAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetNextLineCast2d),
                    "GetLineCastAll", true), value);
        }
    }
