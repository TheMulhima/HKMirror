...
public static class OnBigBenControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(BigBenControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<BigBenControllerMacNativeProfile> orig, BigBenControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<BigBenControllerMacNativeProfile> orig,
            BigBenControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public BigBenControllerMacNativeProfile self;
        }
    }
