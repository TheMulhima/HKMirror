...
public static class OnSpellFluke
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator BurstSequence_AfterArgs(Params_BurstSequence args, IEnumerator ret);

        public delegate void BurstSequence_BeforeArgs(Params_BurstSequence args);

        public delegate IEnumerator BurstSequence_WithArgs(Func<SpellFluke, IEnumerator> orig, SpellFluke self);
        ...
        public delegate void DoDamage_WithArgs(Action<SpellFluke, GameObject, int, bool> orig, SpellFluke self,
            GameObject obj, int upwardRecursionAmount, bool burst);
