...
public static class OnInputControl
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Handle()
        {
            if (!HookedList.Contains("get_Handle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_Handle", true),
                    get_Handle);
            }
        }
        ...
        internal static void Hookset_Handle()
        {
            if (!HookedList.Contains("set_Handle"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_Handle", true),
                    set_Handle);
            }
        }
        ...
        private static void set_Handle(Action<InControl.InputControl, string> orig, InControl.InputControl self,
            string value)
        {
        ...
        internal static void Hookget_Target()
        {
            if (!HookedList.Contains("get_Target"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_Target", true),
                    get_Target);
            }
        }
        ...
        private static InControl.InputControlType get_Target(
            Func<InControl.InputControl, InControl.InputControlType> orig, InControl.InputControl self)
        {
        ...
        internal static void Hookset_Target()
        {
            if (!HookedList.Contains("set_Target"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_Target", true),
                    set_Target);
            }
        }
        ...
        private static void set_Target(Action<InControl.InputControl, InControl.InputControlType> orig,
            InControl.InputControl self, InControl.InputControlType value)
        {
        ...
        internal static void Hookget_IsButton()
        {
            if (!HookedList.Contains("get_IsButton"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsButton", true),
                    get_IsButton);
            }
        }
        ...
        internal static void Hookset_IsButton()
        {
            if (!HookedList.Contains("set_IsButton"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_IsButton", true),
                    set_IsButton);
            }
        }
        ...
        private static void set_IsButton(Action<InControl.InputControl, bool> orig, InControl.InputControl self,
            bool value)
        {
        ...
        internal static void Hookget_IsAnalog()
        {
            if (!HookedList.Contains("get_IsAnalog"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsAnalog", true),
                    get_IsAnalog);
            }
        }
        ...
        internal static void Hookset_IsAnalog()
        {
            if (!HookedList.Contains("set_IsAnalog"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_IsAnalog", true),
                    set_IsAnalog);
            }
        }
        ...
        private static void set_IsAnalog(Action<InControl.InputControl, bool> orig, InControl.InputControl self,
            bool value)
        {
        ...
        internal static void HookSetZeroTick()
        {
            if (!HookedList.Contains("SetZeroTick"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "SetZeroTick", true),
                    SetZeroTick);
            }
        }
        ...
        internal static void Hookget_IsOnZeroTick()
        {
            if (!HookedList.Contains("get_IsOnZeroTick"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsOnZeroTick", true),
                    get_IsOnZeroTick);
            }
        }
        ...
        internal static void Hookget_IsStandard()
        {
            if (!HookedList.Contains("get_IsStandard"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsStandard", true),
                    get_IsStandard);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate string get_Handle_WithArgs(Func<InControl.InputControl, string> orig,
            InControl.InputControl self);
        ...
        public delegate void set_Handle_WithArgs(Action<InControl.InputControl, string> orig,
            InControl.InputControl self, string value);
        ...
        public delegate void set_Target_WithArgs(Action<InControl.InputControl, InControl.InputControlType> orig,
            InControl.InputControl self, InControl.InputControlType value);
        ...
        public delegate bool get_IsButton_WithArgs(Func<InControl.InputControl, bool> orig,
            InControl.InputControl self);
        ...
        public delegate void set_IsButton_WithArgs(Action<InControl.InputControl, bool> orig,
            InControl.InputControl self, bool value);
        ...
        public delegate bool get_IsAnalog_WithArgs(Func<InControl.InputControl, bool> orig,
            InControl.InputControl self);
        ...
        public delegate void set_IsAnalog_WithArgs(Action<InControl.InputControl, bool> orig,
            InControl.InputControl self, bool value);
        ...
        public delegate bool get_IsOnZeroTick_WithArgs(Func<InControl.InputControl, bool> orig,
            InControl.InputControl self);
        ...
        public delegate bool get_IsStandard_WithArgs(Func<InControl.InputControl, bool> orig,
            InControl.InputControl self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Handle_WithArgs get_Handle
        {
            add => HookEndpointManager.Add<Delegates.get_Handle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_Handle", true), value);
        ...
        public static event Delegates.set_Handle_WithArgs set_Handle
        {
            add => HookEndpointManager.Add<Delegates.set_Handle_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_Handle", true), value);
        ...
        public static event Delegates.get_Target_WithArgs get_Target
        {
            add => HookEndpointManager.Add<Delegates.get_Target_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_Target", true), value);
        ...
        public static event Delegates.set_Target_WithArgs set_Target
        {
            add => HookEndpointManager.Add<Delegates.set_Target_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_Target", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_IsButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsButton", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsButton", true), value);
        }

        public static event Delegates.set_IsButton_WithArgs set_IsButton
        {
            add => HookEndpointManager.Add<Delegates.set_IsButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_IsButton", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_IsButton", true), value);
        }

        public static event Delegates.get_IsAnalog_WithArgs get_IsAnalog
        {
            add => HookEndpointManager.Add<Delegates.get_IsAnalog_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsAnalog", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsAnalog_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsAnalog", true), value);
        }

        public static event Delegates.set_IsAnalog_WithArgs set_IsAnalog
        {
            add => HookEndpointManager.Add<Delegates.set_IsAnalog_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_IsAnalog", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsAnalog_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "set_IsAnalog", true), value);
        }

        public static event Delegates.SetZeroTick_WithArgs SetZeroTick
        {
            add => HookEndpointManager.Add<Delegates.SetZeroTick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "SetZeroTick", true), value);
            remove => HookEndpointManager.Remove<Delegates.SetZeroTick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "SetZeroTick", true), value);
        }

        public static event Delegates.get_IsOnZeroTick_WithArgs get_IsOnZeroTick
        {
            add => HookEndpointManager.Add<Delegates.get_IsOnZeroTick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsOnZeroTick", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsOnZeroTick_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsOnZeroTick", true), value);
        }

        public static event Delegates.get_IsStandard_WithArgs get_IsStandard
        {
            add => HookEndpointManager.Add<Delegates.get_IsStandard_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsStandard", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsStandard_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.InputControl), "get_IsStandard", true), value);
        }
    }
}