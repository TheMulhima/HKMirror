...
public static class OnFlarePlayAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(FlarePlayAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<FlarePlayAndroidUnityProfile> orig, FlarePlayAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<FlarePlayAndroidUnityProfile> orig,
            FlarePlayAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public FlarePlayAndroidUnityProfile self;
        }
    }
