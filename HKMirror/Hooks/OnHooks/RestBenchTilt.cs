...
public static class OnRestBenchTilt
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.GetTilt_NormalArgs _afterGetTilt;
        ...
        private static float GetTilt(On.RestBenchTilt.orig_GetTilt orig, RestBenchTilt self)
        {
            ...
            if (_afterGetTilt != null) retVal = _afterGetTilt.Invoke(@params);
            return retVal;
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate float GetTilt_NormalArgs(Params_GetTilt args);
    ...
    {
        public static event Delegates.GetTilt_NormalArgs GetTilt
        {
            add
            {
