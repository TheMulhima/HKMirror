...
public static class OnThrustmasterFerrari458RacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(ThrustmasterFerrari458RacingWheelMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<ThrustmasterFerrari458RacingWheelMacNativeProfile> orig,
            ThrustmasterFerrari458RacingWheelMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ThrustmasterFerrari458RacingWheelMacNativeProfile> orig,
            ThrustmasterFerrari458RacingWheelMacNativeProfile self);

        public sealed class Params_Define
        {
            public ThrustmasterFerrari458RacingWheelMacNativeProfile self;
        }
    }
