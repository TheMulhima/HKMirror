...
public static class OnThrustmasterFerrari458RacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.ThrustmasterFerrari458RacingWheelMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.ThrustmasterFerrari458RacingWheelMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.ThrustmasterFerrari458RacingWheelMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.ThrustmasterFerrari458RacingWheelMacNativeProfile), "Define",
                    true), value);
