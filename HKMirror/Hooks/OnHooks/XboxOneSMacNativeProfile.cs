...
public static class OnXboxOneSMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneSMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneSMacNativeProfile> orig, XboxOneSMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneSMacNativeProfile> orig, XboxOneSMacNativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneSMacNativeProfile self;
        }
    }
