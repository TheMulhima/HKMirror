...
public static class OnHealthManager
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_IsInvincible()
        {
            if (!HookedList.Contains("get_IsInvincible"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_IsInvincible", true),
                    get_IsInvincible);
            }
        }
        ...
        internal static void Hookset_IsInvincible()
        {
            if (!HookedList.Contains("set_IsInvincible"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_IsInvincible", true),
                    set_IsInvincible);
            }
        }
        ...
        internal static void Hookget_InvincibleFromDirection()
        {
            if (!HookedList.Contains("get_InvincibleFromDirection"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_InvincibleFromDirection", true),
        ...
        internal static void Hookset_InvincibleFromDirection()
        {
            if (!HookedList.Contains("set_InvincibleFromDirection"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_InvincibleFromDirection", true),
        ...
        private static System.Collections.IEnumerator CheckPersistence(On.HealthManager.orig_CheckPersistence orig,
            HealthManager self)
        {
        ...
        private static void SetGeoFlashing(On.HealthManager.orig_SetGeoFlashing orig, HealthManager self,
            UnityEngine.GameObject[] gameObjects, int originalAmount)
        {
        ...
        private static void SetBattleScene(On.HealthManager.orig_SetBattleScene orig, HealthManager self,
            UnityEngine.GameObject newBattleScene)
        {
        ...
        private static void SetSendKilledToObject(On.HealthManager.orig_SetSendKilledToObject orig, HealthManager self,
            UnityEngine.GameObject killedObject)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate System.Collections.IEnumerator CheckPersistence_AfterArgs(Params_CheckPersistence args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator CheckPersistence_WithArgs(
            Func<HealthManager, System.Collections.IEnumerator> orig, HealthManager self);
        ...
        public delegate void SetGeoFlashing_WithArgs(Action<HealthManager, UnityEngine.GameObject[], int> orig,
            HealthManager self, UnityEngine.GameObject[] gameObjects, int originalAmount);
        ...
        public delegate void SetBattleScene_WithArgs(Action<HealthManager, UnityEngine.GameObject> orig,
            HealthManager self, UnityEngine.GameObject newBattleScene);
        ...
        public delegate void SetSendKilledToObject_WithArgs(Action<HealthManager, UnityEngine.GameObject> orig,
            HealthManager self, UnityEngine.GameObject killedObject);
    ...
    public static class WithOrig
    {
        public static event Delegates.get_IsInvincible_WithArgs get_IsInvincible
        {
            add => HookEndpointManager.Add<Delegates.get_IsInvincible_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_IsInvincible", true), value);
        ...
        public static event Delegates.set_IsInvincible_WithArgs set_IsInvincible
        {
            add => HookEndpointManager.Add<Delegates.set_IsInvincible_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_IsInvincible", true), value);
        ...
        public static event Delegates.get_InvincibleFromDirection_WithArgs get_InvincibleFromDirection
        {
            add => HookEndpointManager.Add<Delegates.get_InvincibleFromDirection_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_InvincibleFromDirection", true), value);
        ...
        public static event Delegates.set_InvincibleFromDirection_WithArgs set_InvincibleFromDirection
        {
            add => HookEndpointManager.Add<Delegates.set_InvincibleFromDirection_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_InvincibleFromDirection", true), value);
