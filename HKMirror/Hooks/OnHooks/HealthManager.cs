...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_IsInvincible", true), get_IsInvincible);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_IsInvincible", true), set_IsInvincible);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_InvincibleFromDirection", true), get_InvincibleFromDirection);
...
{
foreach (Delegates.get_InvincibleFromDirection_BeforeArgs toInvoke in _beforeget_InvincibleFromDirection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_InvincibleFromDirection_AfterArgs toInvoke in _afterget_InvincibleFromDirection.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_InvincibleFromDirection", true), set_InvincibleFromDirection);
...
{
foreach (Delegates.set_InvincibleFromDirection_BeforeArgs toInvoke in _beforeset_InvincibleFromDirection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_InvincibleFromDirection_AfterArgs toInvoke in _afterset_InvincibleFromDirection.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator CheckPersistence(On.HealthManager.orig_CheckPersistence orig,HealthManager self)
{
...
private static void Invincible(On.HealthManager.orig_Invincible orig,HealthManager self,  HitInstance hitInstance)
{
...
private static void ApplyExtraDamage(On.HealthManager.orig_ApplyExtraDamage orig,HealthManager self,  int damageAmount)
{
...
private static void Die(On.HealthManager.orig_Die orig,HealthManager self,  float? attackDirection,  AttackTypes attackType,  bool ignoreEvasion)
{
...
private static void SetGeoFlashing(On.HealthManager.orig_SetGeoFlashing orig,HealthManager self,  UnityEngine.GameObject[] gameObjects,  int originalAmount)
{
...
private static bool IsBlockingByDirection(On.HealthManager.orig_IsBlockingByDirection orig,HealthManager self,  int cardinalDirection,  AttackTypes attackType)
{
...
{
foreach (Delegates.IsBlockingByDirection_BeforeArgs toInvoke in _beforeIsBlockingByDirection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsBlockingByDirection_AfterArgs toInvoke in _afterIsBlockingByDirection.GetInvocationList())
{
try
{
...
private static void SetBattleScene(On.HealthManager.orig_SetBattleScene orig,HealthManager self,  UnityEngine.GameObject newBattleScene)
{
Delegates.Params_SetBattleScene @params = new() 
{
self = self
, newBattleScene = newBattleScene
};
...
{
foreach (Delegates.GetAttackDirection_BeforeArgs toInvoke in _beforeGetAttackDirection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetAttackDirection_AfterArgs toInvoke in _afterGetAttackDirection.GetInvocationList())
{
try
{
...
private static void SetPreventInvincibleEffect(On.HealthManager.orig_SetPreventInvincibleEffect orig,HealthManager self,  bool set)
{
...
{
foreach (Delegates.SetPreventInvincibleEffect_BeforeArgs toInvoke in _beforeSetPreventInvincibleEffect.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPreventInvincibleEffect_AfterArgs toInvoke in _afterSetPreventInvincibleEffect.GetInvocationList())
{
try
{
...
private static void SetDamageOverride(On.HealthManager.orig_SetDamageOverride orig,HealthManager self,  bool set)
{
...
{
foreach (Delegates.SetDamageOverride_BeforeArgs toInvoke in _beforeSetDamageOverride.GetInvocationList())
{
try
{
...
private static void SetSendKilledToObject(On.HealthManager.orig_SetSendKilledToObject orig,HealthManager self,  UnityEngine.GameObject killedObject)
{
...
{
foreach (Delegates.SetSendKilledToObject_BeforeArgs toInvoke in _beforeSetSendKilledToObject.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetSendKilledToObject_AfterArgs toInvoke in _afterSetSendKilledToObject.GetInvocationList())
{
try
{
...
public delegate void set_IsInvincible_WithArgs (Action<HealthManager,  bool> orig, HealthManager self,  bool value);
...
public delegate void set_InvincibleFromDirection_WithArgs (Action<HealthManager,  int> orig, HealthManager self,  int value);
...
public delegate System.Collections.IEnumerator CheckPersistence_AfterArgs(Params_CheckPersistence args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator CheckPersistence_WithArgs (Func<HealthManager, System.Collections.IEnumerator> orig, HealthManager self);
...
public delegate void Hit_WithArgs (Action<HealthManager,  HitInstance> orig, HealthManager self,  HitInstance hitInstance);
...
public delegate void Invincible_WithArgs (Action<HealthManager,  HitInstance> orig, HealthManager self,  HitInstance hitInstance);
...
public delegate void TakeDamage_WithArgs (Action<HealthManager,  HitInstance> orig, HealthManager self,  HitInstance hitInstance);
...
public delegate void NonFatalHit_WithArgs (Action<HealthManager,  bool> orig, HealthManager self,  bool ignoreEvasion);
...
public delegate void ApplyExtraDamage_WithArgs (Action<HealthManager,  int> orig, HealthManager self,  int damageAmount);
...
public delegate void Die_WithArgs (Action<HealthManager,  float?,  AttackTypes,  bool> orig, HealthManager self,  float? attackDirection,  AttackTypes attackType,  bool ignoreEvasion);
...
{
public HealthManager self;
public UnityEngine.GameObject[] gameObjects;
...
public delegate void SetGeoFlashing_WithArgs (Action<HealthManager,  UnityEngine.GameObject[],  int> orig, HealthManager self,  UnityEngine.GameObject[] gameObjects,  int originalAmount);
...
public delegate bool IsBlockingByDirection_WithArgs (Func<HealthManager,  int,  AttackTypes, bool> orig, HealthManager self,  int cardinalDirection,  AttackTypes attackType);
public sealed class Params_SetBattleScene
{
public HealthManager self;
public UnityEngine.GameObject newBattleScene;
}
...
public delegate void SetBattleScene_WithArgs (Action<HealthManager,  UnityEngine.GameObject> orig, HealthManager self,  UnityEngine.GameObject newBattleScene);
...
public delegate void SetPreventInvincibleEffect_WithArgs (Action<HealthManager,  bool> orig, HealthManager self,  bool set);
...
{
public HealthManager self;
public UnityEngine.GameObject killedObject;
}
...
public delegate void SetSendKilledToObject_WithArgs (Action<HealthManager,  UnityEngine.GameObject> orig, HealthManager self,  UnityEngine.GameObject killedObject);
...
{
add => HookEndpointManager.Add<Delegates.get_IsInvincible_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_IsInvincible", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsInvincible_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_IsInvincible", true), value);
}
public static event Delegates.set_IsInvincible_WithArgs set_IsInvincible
{
add => HookEndpointManager.Add<Delegates.set_IsInvincible_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_IsInvincible", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsInvincible_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_IsInvincible", true), value);
}
public static event Delegates.get_InvincibleFromDirection_WithArgs get_InvincibleFromDirection
{
add => HookEndpointManager.Add<Delegates.get_InvincibleFromDirection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_InvincibleFromDirection", true), value);
remove => HookEndpointManager.Remove<Delegates.get_InvincibleFromDirection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_InvincibleFromDirection", true), value);
}
public static event Delegates.set_InvincibleFromDirection_WithArgs set_InvincibleFromDirection
{
add => HookEndpointManager.Add<Delegates.set_InvincibleFromDirection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_InvincibleFromDirection", true), value);
remove => HookEndpointManager.Remove<Delegates.set_InvincibleFromDirection_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_InvincibleFromDirection", true), value);
}
