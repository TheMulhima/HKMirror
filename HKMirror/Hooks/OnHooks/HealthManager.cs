...
public static class OnHealthManager
{
    internal static class HookHandler
    {
        ...
        internal static event Delegates.get_IsInvincible_NormalArgs _afterget_IsInvincible;
        ...
        private static bool get_IsInvincible(Func<HealthManager, bool> orig, HealthManager self)
        {
            ...
            if (_afterget_IsInvincible != null) retVal = _afterget_IsInvincible.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.set_IsInvincible_NormalArgs _afterset_IsInvincible;
        ...
        private static void set_IsInvincible(Action<HealthManager, bool> orig, HealthManager self, bool value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_IsInvincible != null) _afterset_IsInvincible.Invoke(@params);
        }
        ...
        internal static event Delegates.get_InvincibleFromDirection_NormalArgs _afterget_InvincibleFromDirection;
        ...
        private static int get_InvincibleFromDirection(Func<HealthManager, int> orig, HealthManager self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_InvincibleFromDirection != null) retVal = _afterget_InvincibleFromDirection.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.set_InvincibleFromDirection_NormalArgs _afterset_InvincibleFromDirection;
        ...
        private static void set_InvincibleFromDirection(Action<HealthManager, int> orig, HealthManager self, int value)
        {
            ...
            value = @params.value;
            orig(self, value);
            if (_afterset_InvincibleFromDirection != null) _afterset_InvincibleFromDirection.Invoke(@params);
        }
        ...
        internal static event Delegates.Invincible_NormalArgs _afterInvincible;
            ...
            HitInstance hitInstance)
        {
            ...
            hitInstance = @params.hitInstance;
            orig(self, hitInstance);
            if (_afterInvincible != null) _afterInvincible.Invoke(@params);
        }
        ...
        internal static event Delegates.NonFatalHit_NormalArgs _afterNonFatalHit;
        ...
        private static void NonFatalHit(On.HealthManager.orig_NonFatalHit orig, HealthManager self, bool ignoreEvasion)
        {
            ...
            if (_afterNonFatalHit != null) _afterNonFatalHit.Invoke(@params);
        }
        ...
        internal static event Delegates.ApplyExtraDamage_NormalArgs _afterApplyExtraDamage;
            ...
            int damageAmount)
        {
            ...
            if (_afterApplyExtraDamage != null) _afterApplyExtraDamage.Invoke(@params);
        }
        ...
        internal static event Delegates.SendDeathEvent_NormalArgs _afterSendDeathEvent;
        ...
        private static void SendDeathEvent(On.HealthManager.orig_SendDeathEvent orig, HealthManager self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterSendDeathEvent != null) _afterSendDeathEvent.Invoke(@params);
        }
        ...
        internal static event Delegates.SetGeoFlashing_NormalArgs _afterSetGeoFlashing;
            ...
            GameObject[] gameObjects, int originalAmount)
        {
            ...
            if (_afterSetGeoFlashing != null) _afterSetGeoFlashing.Invoke(@params);
        }
        ...
        internal static event Delegates.IsBlockingByDirection_NormalArgs _afterIsBlockingByDirection;
            ...
            int cardinalDirection, AttackTypes attackType)
        {
            ...
            if (_afterIsBlockingByDirection != null) retVal = _afterIsBlockingByDirection.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.SetBattleScene_NormalArgs _afterSetBattleScene;
            ...
            GameObject newBattleScene)
        {
            ...
            if (_afterSetBattleScene != null) _afterSetBattleScene.Invoke(@params);
        }
        ...
        internal static event Delegates.GetAttackDirection_NormalArgs _afterGetAttackDirection;
        ...
        private static int GetAttackDirection(On.HealthManager.orig_GetAttackDirection orig, HealthManager self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterGetAttackDirection != null) retVal = _afterGetAttackDirection.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.SetPreventInvincibleEffect_NormalArgs _afterSetPreventInvincibleEffect;
            ...
            HealthManager self, bool set)
        {
            ...
            set = @params.set;
            orig(self, set);
            if (_afterSetPreventInvincibleEffect != null) _afterSetPreventInvincibleEffect.Invoke(@params);
        }
        ...
        internal static event Delegates.SetGeoSmall_NormalArgs _afterSetGeoSmall;
        ...
        private static void SetGeoSmall(On.HealthManager.orig_SetGeoSmall orig, HealthManager self, int amount)
        {
            ...
            orig(self, amount);
            if (_afterSetGeoSmall != null) _afterSetGeoSmall.Invoke(@params);
        }
        ...
        internal static event Delegates.SetGeoMedium_NormalArgs _afterSetGeoMedium;
        ...
        private static void SetGeoMedium(On.HealthManager.orig_SetGeoMedium orig, HealthManager self, int amount)
        {
            ...
            amount = @params.amount;
            orig(self, amount);
            if (_afterSetGeoMedium != null) _afterSetGeoMedium.Invoke(@params);
        }
        ...
        internal static event Delegates.SetGeoLarge_NormalArgs _afterSetGeoLarge;
        ...
        private static void SetGeoLarge(On.HealthManager.orig_SetGeoLarge orig, HealthManager self, int amount)
        {
            ...
            amount = @params.amount;
            orig(self, amount);
            if (_afterSetGeoLarge != null) _afterSetGeoLarge.Invoke(@params);
        }
        ...
        internal static event Delegates.GetIsDead_NormalArgs _afterGetIsDead;
        ...
        private static bool GetIsDead(On.HealthManager.orig_GetIsDead orig, HealthManager self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterGetIsDead != null) retVal = _afterGetIsDead.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.SetIsDead_NormalArgs _afterSetIsDead;
        ...
        private static void SetIsDead(On.HealthManager.orig_SetIsDead orig, HealthManager self, bool set)
        {
            ...
            set = @params.set;
            orig(self, set);
            if (_afterSetIsDead != null) _afterSetIsDead.Invoke(@params);
        }
        ...
        internal static event Delegates.SetDamageOverride_NormalArgs _afterSetDamageOverride;
            ...
            bool set)
        {
            ...
            set = @params.set;
            orig(self, set);
            if (_afterSetDamageOverride != null) _afterSetDamageOverride.Invoke(@params);
        }
        ...
        internal static event Delegates.SetSendKilledToObject_NormalArgs _afterSetSendKilledToObject;
            ...
            GameObject killedObject)
        {
            ...
            if (_afterSetSendKilledToObject != null) _afterSetSendKilledToObject.Invoke(@params);
        }
        ...
        internal static event Delegates.CheckInvincible_NormalArgs _afterCheckInvincible;
        ...
        private static bool CheckInvincible(On.HealthManager.orig_CheckInvincible orig, HealthManager self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterCheckInvincible != null) retVal = _afterCheckInvincible.Invoke(@params);
            return retVal;
        }
    }
    ...
    public static class Delegates
    {
        ...
        public delegate void ApplyExtraDamage_NormalArgs(Params_ApplyExtraDamage args);
        ...
        public delegate bool CheckInvincible_NormalArgs(Params_CheckInvincible args);

        public delegate void CheckPersistence_BeforeArgs(Params_CheckPersistence args);

        public delegate IEnumerator CheckPersistence_NormalArgs(Params_CheckPersistence args);
        ...
        public delegate int get_InvincibleFromDirection_NormalArgs(Params_get_InvincibleFromDirection args);

        public delegate void get_IsInvincible_BeforeArgs(Params_get_IsInvincible args);

        public delegate bool get_IsInvincible_NormalArgs(Params_get_IsInvincible args);

        public delegate void GetAttackDirection_BeforeArgs(Params_GetAttackDirection args);

        public delegate int GetAttackDirection_NormalArgs(Params_GetAttackDirection args);

        public delegate void GetIsDead_BeforeArgs(Params_GetIsDead args);

        public delegate bool GetIsDead_NormalArgs(Params_GetIsDead args);
        ...
        public delegate void Invincible_NormalArgs(Params_Invincible args);

        public delegate void IsBlockingByDirection_BeforeArgs(Params_IsBlockingByDirection args);

        public delegate bool IsBlockingByDirection_NormalArgs(Params_IsBlockingByDirection args);

        public delegate void NonFatalHit_BeforeArgs(Params_NonFatalHit args);

        public delegate void NonFatalHit_NormalArgs(Params_NonFatalHit args);
        ...
        public delegate void SendDeathEvent_NormalArgs(Params_SendDeathEvent args);

        public delegate void set_InvincibleFromDirection_BeforeArgs(Params_set_InvincibleFromDirection args);

        public delegate void set_InvincibleFromDirection_NormalArgs(Params_set_InvincibleFromDirection args);

        public delegate void set_IsInvincible_BeforeArgs(Params_set_IsInvincible args);

        public delegate void set_IsInvincible_NormalArgs(Params_set_IsInvincible args);

        public delegate void SetBattleScene_BeforeArgs(Params_SetBattleScene args);

        public delegate void SetBattleScene_NormalArgs(Params_SetBattleScene args);

        public delegate void SetDamageOverride_BeforeArgs(Params_SetDamageOverride args);

        public delegate void SetDamageOverride_NormalArgs(Params_SetDamageOverride args);

        public delegate void SetGeoFlashing_BeforeArgs(Params_SetGeoFlashing args);

        public delegate void SetGeoFlashing_NormalArgs(Params_SetGeoFlashing args);

        public delegate void SetGeoLarge_BeforeArgs(Params_SetGeoLarge args);

        public delegate void SetGeoLarge_NormalArgs(Params_SetGeoLarge args);

        public delegate void SetGeoMedium_BeforeArgs(Params_SetGeoMedium args);

        public delegate void SetGeoMedium_NormalArgs(Params_SetGeoMedium args);

        public delegate void SetGeoSmall_BeforeArgs(Params_SetGeoSmall args);

        public delegate void SetGeoSmall_NormalArgs(Params_SetGeoSmall args);

        public delegate void SetIsDead_BeforeArgs(Params_SetIsDead args);

        public delegate void SetIsDead_NormalArgs(Params_SetIsDead args);

        public delegate void SetPreventInvincibleEffect_BeforeArgs(Params_SetPreventInvincibleEffect args);

        public delegate void SetPreventInvincibleEffect_NormalArgs(Params_SetPreventInvincibleEffect args);

        public delegate void SetSendKilledToObject_BeforeArgs(Params_SetSendKilledToObject args);

        public delegate void SetSendKilledToObject_NormalArgs(Params_SetSendKilledToObject args);
    ...
    {
        public static event Delegates.get_IsInvincible_NormalArgs get_IsInvincible
        {
            add
            {
        ...
        public static event Delegates.set_IsInvincible_NormalArgs set_IsInvincible
        {
            add
            {
        ...
        public static event Delegates.get_InvincibleFromDirection_NormalArgs get_InvincibleFromDirection
        {
            add
            {
        ...
        public static event Delegates.set_InvincibleFromDirection_NormalArgs set_InvincibleFromDirection
        {
            add
            {
        ...
        public static event Delegates.Invincible_NormalArgs Invincible
        {
            add
            {
        ...
        public static event Delegates.NonFatalHit_NormalArgs NonFatalHit
        {
            add
            {
        ...
        public static event Delegates.ApplyExtraDamage_NormalArgs ApplyExtraDamage
        {
            add
            {
        ...
        public static event Delegates.SendDeathEvent_NormalArgs SendDeathEvent
        {
            add
            {
        ...
        public static event Delegates.SetGeoFlashing_NormalArgs SetGeoFlashing
        {
            add
            {
        ...
        public static event Delegates.IsBlockingByDirection_NormalArgs IsBlockingByDirection
        {
            add
            {
        ...
        public static event Delegates.SetBattleScene_NormalArgs SetBattleScene
        {
            add
            {
        ...
        public static event Delegates.GetAttackDirection_NormalArgs GetAttackDirection
        {
            add
            {
        ...
        public static event Delegates.SetPreventInvincibleEffect_NormalArgs SetPreventInvincibleEffect
        {
            add
            {
        ...
        public static event Delegates.SetGeoSmall_NormalArgs SetGeoSmall
        {
            add
            {
        ...
        public static event Delegates.SetGeoMedium_NormalArgs SetGeoMedium
        {
            add
            {
        ...
        public static event Delegates.SetGeoLarge_NormalArgs SetGeoLarge
        {
            add
            {
        ...
        public static event Delegates.GetIsDead_NormalArgs GetIsDead
        {
            add
            {
        ...
        public static event Delegates.SetIsDead_NormalArgs SetIsDead
        {
            add
            {
        ...
        public static event Delegates.SetDamageOverride_NormalArgs SetDamageOverride
        {
            add
            {
        ...
        public static event Delegates.SetSendKilledToObject_NormalArgs SetSendKilledToObject
        {
            add
            {
        ...
        public static event Delegates.CheckInvincible_NormalArgs CheckInvincible
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_IsInvincible_NormalArgs get_IsInvincible
        {
            add => HookEndpointManager.Add<Delegates.get_IsInvincible_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_IsInvincible"), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsInvincible_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_IsInvincible"), value);
        }

        public static event Delegates.set_IsInvincible_NormalArgs set_IsInvincible
        {
            add => HookEndpointManager.Add<Delegates.set_IsInvincible_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_IsInvincible"), value);
            remove => HookEndpointManager.Remove<Delegates.set_IsInvincible_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_IsInvincible"), value);
        }

        public static event Delegates.get_InvincibleFromDirection_NormalArgs get_InvincibleFromDirection
        {
            add => HookEndpointManager.Add<Delegates.get_InvincibleFromDirection_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_InvincibleFromDirection"), value);
            remove => HookEndpointManager.Remove<Delegates.get_InvincibleFromDirection_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "get_InvincibleFromDirection"), value);
        }

        public static event Delegates.set_InvincibleFromDirection_NormalArgs set_InvincibleFromDirection
        {
            add => HookEndpointManager.Add<Delegates.set_InvincibleFromDirection_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_InvincibleFromDirection"), value);
            remove => HookEndpointManager.Remove<Delegates.set_InvincibleFromDirection_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HealthManager), "set_InvincibleFromDirection"), value);
        }
