...
public static class OnElecomControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ElecomControllerMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<ElecomControllerMacNativeProfile> orig, ElecomControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ElecomControllerMacNativeProfile> orig,
            ElecomControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public ElecomControllerMacNativeProfile self;
        }
    }
