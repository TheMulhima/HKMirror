...
public static class Ontk2dUITextInput
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_LayoutItem()
        {
            if (!HookedList.Contains("get_LayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_LayoutItem", true),
                    get_LayoutItem);
            }
        }
        ...
        internal static void Hookset_LayoutItem()
        {
            if (!HookedList.Contains("set_LayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "set_LayoutItem", true),
                    set_LayoutItem);
            }
        }
        ...
        internal static void Hookget_SendMessageTarget()
        {
            if (!HookedList.Contains("get_SendMessageTarget"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_SendMessageTarget", true),
        ...
        private static UnityEngine.GameObject get_SendMessageTarget(Func<tk2dUITextInput, UnityEngine.GameObject> orig,
        ...
        internal static void Hookset_SendMessageTarget()
        {
            if (!HookedList.Contains("set_SendMessageTarget"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "set_SendMessageTarget", true),
        ...
        private static void set_SendMessageTarget(Action<tk2dUITextInput, UnityEngine.GameObject> orig,
            tk2dUITextInput self, UnityEngine.GameObject value)
        {
            ...
            tk2dUITextInput self, string modifiedText)
        {
            ...
            {
                foreach (Delegates.FormatTextForDisplay_BeforeArgs toInvoke in _beforeFormatTextForDisplay
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.FormatTextForDisplay_AfterArgs toInvoke in _afterFormatTextForDisplay
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUITextInput self)
        {
            ...
            {
                foreach (Delegates.ListenForKeyboardTextUpdate_BeforeArgs toInvoke in _beforeListenForKeyboardTextUpdate
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ListenForKeyboardTextUpdate_AfterArgs toInvoke in _afterListenForKeyboardTextUpdate
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void SetCursorPosition(On.tk2dUITextInput.orig_SetCursorPosition orig, tk2dUITextInput self)
        {
            ...
            {
                foreach (Delegates.SetCursorPosition_BeforeArgs toInvoke in
                         _beforeSetCursorPosition.GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate tk2dUILayout get_LayoutItem_WithArgs(Func<tk2dUITextInput, tk2dUILayout> orig,
            tk2dUITextInput self);
        ...
        public delegate void set_LayoutItem_WithArgs(Action<tk2dUITextInput, tk2dUILayout> orig, tk2dUITextInput self,
            tk2dUILayout value);
        ...
        public delegate UnityEngine.GameObject get_SendMessageTarget_WithArgs(
            Func<tk2dUITextInput, UnityEngine.GameObject> orig, tk2dUITextInput self);
        ...
        public delegate void set_SendMessageTarget_WithArgs(Action<tk2dUITextInput, UnityEngine.GameObject> orig,
            tk2dUITextInput self, UnityEngine.GameObject value);
        ...
        public delegate void set_Text_WithArgs(Action<tk2dUITextInput, string> orig, tk2dUITextInput self,
            string value);
        ...
        public delegate void SetFocus_bool_WithArgs(Action<tk2dUITextInput, bool> orig, tk2dUITextInput self,
            bool focus);
        ...
        public delegate void FormatTextForDisplay_WithArgs(Action<tk2dUITextInput, string> orig, tk2dUITextInput self,
            string modifiedText);
        ...
        public delegate void LayoutReshaped_WithArgs(
            Action<tk2dUITextInput, UnityEngine.Vector3, UnityEngine.Vector3> orig, tk2dUITextInput self,
            UnityEngine.Vector3 dMin, UnityEngine.Vector3 dMax);
    }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_LayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_LayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_LayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_LayoutItem", true), value);
        }

        public static event Delegates.set_LayoutItem_WithArgs set_LayoutItem
        {
            add => HookEndpointManager.Add<Delegates.set_LayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "set_LayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_LayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "set_LayoutItem", true), value);
        }
        ...
        public static event Delegates.get_SendMessageTarget_WithArgs get_SendMessageTarget
        {
            add => HookEndpointManager.Add<Delegates.get_SendMessageTarget_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_SendMessageTarget", true), value);
        ...
        public static event Delegates.set_SendMessageTarget_WithArgs set_SendMessageTarget
        {
            add => HookEndpointManager.Add<Delegates.set_SendMessageTarget_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "set_SendMessageTarget", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_IsFocus_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_IsFocus", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_IsFocus_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_IsFocus", true), value);
        }
        ...
        public static event Delegates.get_Text_WithArgs get_Text
        {
            add => HookEndpointManager.Add<Delegates.get_Text_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "get_Text", true), value);
        ...
        public static event Delegates.set_Text_WithArgs set_Text
        {
            add => HookEndpointManager.Add<Delegates.set_Text_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUITextInput), "set_Text", true), value);
