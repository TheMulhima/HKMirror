...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_fallTimer", true), get_fallTimer);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_fallTimer", true), set_fallTimer);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_geoCounter", true), get_geoCounter);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_geoCounter", true), set_geoCounter);
...
private static void set_geoCounter(Action<HeroController,  GeoCounter> orig, HeroController self,  GeoCounter value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_proxyFSM", true), get_proxyFSM);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_proxyFSM", true), set_proxyFSM);
...
private static void set_proxyFSM(Action<HeroController,  PlayMakerFSM> orig, HeroController self,  PlayMakerFSM value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_sceneEntryGate", true), get_sceneEntryGate);
...
private static TransitionPoint get_sceneEntryGate(Func<HeroController, TransitionPoint> orig, HeroController self)
{
...
{
foreach (Delegates.get_sceneEntryGate_BeforeArgs toInvoke in _beforeget_sceneEntryGate.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_sceneEntryGate_AfterArgs toInvoke in _afterget_sceneEntryGate.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_sceneEntryGate", true), set_sceneEntryGate);
...
private static void set_sceneEntryGate(Action<HeroController,  TransitionPoint> orig, HeroController self,  TransitionPoint value)
{
...
{
foreach (Delegates.set_sceneEntryGate_BeforeArgs toInvoke in _beforeset_sceneEntryGate.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_sceneEntryGate_AfterArgs toInvoke in _afterset_sceneEntryGate.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_IsDreamReturning", true), get_IsDreamReturning);
...
{
foreach (Delegates.get_IsDreamReturning_BeforeArgs toInvoke in _beforeget_IsDreamReturning.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsDreamReturning_AfterArgs toInvoke in _afterget_IsDreamReturning.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_SilentInstance", false), get_SilentInstance);
...
{
foreach (Delegates.get_SilentInstance_BeforeArgs toInvoke in _beforeget_SilentInstance.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_SilentInstance_AfterArgs toInvoke in _afterget_SilentInstance.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_UnsafeInstance", false), get_UnsafeInstance);
...
{
foreach (Delegates.get_UnsafeInstance_BeforeArgs toInvoke in _beforeget_UnsafeInstance.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_UnsafeInstance_AfterArgs toInvoke in _afterget_UnsafeInstance.GetInvocationList())
{
try
{
...
private static void Attack(On.HeroController.orig_Attack orig,HeroController self,  GlobalEnums.AttackDirection attackDir)
{
...
private static void SetStartWithWallslide(On.HeroController.orig_SetStartWithWallslide orig,HeroController self)
{
...
{
foreach (Delegates.SetStartWithWallslide_BeforeArgs toInvoke in _beforeSetStartWithWallslide.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartWithWallslide_AfterArgs toInvoke in _afterSetStartWithWallslide.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartWithFullJump_BeforeArgs toInvoke in _beforeSetStartWithFullJump.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartWithFullJump_AfterArgs toInvoke in _afterSetStartWithFullJump.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartWithAttack_BeforeArgs toInvoke in _beforeSetStartWithAttack.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartWithAttack_AfterArgs toInvoke in _afterSetStartWithAttack.GetInvocationList())
{
try
{
...
private static void SetHeroParent(On.HeroController.orig_SetHeroParent orig,HeroController self,  UnityEngine.Transform newParent)
{
...
private static void SetConveyorSpeed(On.HeroController.orig_SetConveyorSpeed orig,HeroController self,  float speed)
{
...
private static void SetConveyorSpeedV(On.HeroController.orig_SetConveyorSpeedV orig,HeroController self,  float speed)
{
...
{
foreach (Delegates.SetConveyorSpeedV_BeforeArgs toInvoke in _beforeSetConveyorSpeedV.GetInvocationList())
{
try
{
...
private static void EnterWithoutInput(On.HeroController.orig_EnterWithoutInput orig,HeroController self,  bool flag)
{
...
{
foreach (Delegates.EnterWithoutInput_BeforeArgs toInvoke in _beforeEnterWithoutInput.GetInvocationList())
{
try
{
...
private static void SetBenchRespawn(On.HeroController.orig_SetBenchRespawn orig,HeroController self,  string spawnMarker,  string sceneName,  int spawnType,  bool facingRight)
{
...
private static void SetHazardRespawn(On.HeroController.orig_SetHazardRespawn orig,HeroController self,  UnityEngine.Vector3 position,  bool facingRight)
{
...
private static void AddGeoToCounter(On.HeroController.orig_AddGeoToCounter orig,HeroController self,  int amount)
{
...
{
foreach (Delegates.CancelParryInvuln_BeforeArgs toInvoke in _beforeCancelParryInvuln.GetInvocationList())
{
try
{
...
private static void SetWieldingLantern(On.HeroController.orig_SetWieldingLantern orig,HeroController self,  bool set)
{
...
{
foreach (Delegates.SetWieldingLantern_BeforeArgs toInvoke in _beforeSetWieldingLantern.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetWieldingLantern_AfterArgs toInvoke in _afterSetWieldingLantern.GetInvocationList())
{
try
{
...
private static void TakeDamage(On.HeroController.orig_TakeDamage orig,HeroController self,  UnityEngine.GameObject go,  GlobalEnums.CollisionSide damageSide,  int damageAmount,  int hazardType)
{
...
private static bool TryAddMPChargeSpa(On.HeroController.orig_TryAddMPChargeSpa orig,HeroController self,  int amount)
{
...
{
foreach (Delegates.TryAddMPChargeSpa_BeforeArgs toInvoke in _beforeTryAddMPChargeSpa.GetInvocationList())
{
try
{
...
{
foreach (Delegates.MaxHealthKeepBlue_BeforeArgs toInvoke in _beforeMaxHealthKeepBlue.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearMPSendEvents_BeforeArgs toInvoke in _beforeClearMPSendEvents.GetInvocationList())
{
try
{
...
private static void AddToMaxMPReserve(On.HeroController.orig_AddToMaxMPReserve orig,HeroController self,  int amount)
{
...
{
foreach (Delegates.AddToMaxMPReserve_BeforeArgs toInvoke in _beforeAddToMaxMPReserve.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnterSceneDreamGate_BeforeArgs toInvoke in _beforeEnterSceneDreamGate.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnterSceneDreamGate_AfterArgs toInvoke in _afterEnterSceneDreamGate.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator EnterScene(On.HeroController.orig_EnterScene orig,HeroController self,  TransitionPoint enterGate,  float delayBeforeEnter)
{
Delegates.Params_EnterScene @params = new() 
{
self = self
, enterGate = enterGate
, delayBeforeEnter = delayBeforeEnter
};
...
private static void LeaveScene(On.HeroController.orig_LeaveScene orig,HeroController self,  GlobalEnums.GatePosition? gate)
{
...
private static System.Collections.IEnumerator BetaLeave(On.HeroController.orig_BetaLeave orig,HeroController self,  EndBeta betaEndTrigger)
{
Delegates.Params_BetaLeave @params = new() 
{
self = self
, betaEndTrigger = betaEndTrigger
};
...
private static System.Collections.IEnumerator BetaReturn(On.HeroController.orig_BetaReturn orig,HeroController self)
{
...
private static System.Collections.IEnumerator Respawn(On.HeroController.orig_Respawn orig,HeroController self)
{
...
private static System.Collections.IEnumerator HazardRespawn(On.HeroController.orig_HazardRespawn orig,HeroController self)
{
...
private static void SetCState(On.HeroController.orig_SetCState orig,HeroController self,  string stateName,  bool value)
{
...
private static void ResetHardLandingTimer(On.HeroController.orig_ResetHardLandingTimer orig,HeroController self)
{
...
{
foreach (Delegates.ResetHardLandingTimer_BeforeArgs toInvoke in _beforeResetHardLandingTimer.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetHardLandingTimer_AfterArgs toInvoke in _afterResetHardLandingTimer.GetInvocationList())
{
try
{
...
private static void RelinquishControlNotVelocity(On.HeroController.orig_RelinquishControlNotVelocity orig,HeroController self)
{
...
{
foreach (Delegates.RelinquishControlNotVelocity_BeforeArgs toInvoke in _beforeRelinquishControlNotVelocity.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RelinquishControlNotVelocity_AfterArgs toInvoke in _afterRelinquishControlNotVelocity.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RelinquishControl_BeforeArgs toInvoke in _beforeRelinquishControl.GetInvocationList())
{
try
{
...
private static void PreventCastByDialogueEnd(On.HeroController.orig_PreventCastByDialogueEnd orig,HeroController self)
{
...
{
foreach (Delegates.PreventCastByDialogueEnd_BeforeArgs toInvoke in _beforePreventCastByDialogueEnd.GetInvocationList())
{
try
{
...
{
foreach (Delegates.PreventCastByDialogueEnd_AfterArgs toInvoke in _afterPreventCastByDialogueEnd.GetInvocationList())
{
try
{
...
private static void SetDamageMode_int(On.HeroController.orig_SetDamageMode_int orig,HeroController self,  int invincibilityType)
{
Delegates.Params_SetDamageMode_int @params = new() 
{
self = self
, invincibilityType = invincibilityType
};
if (_beforeSetDamageMode_int != null)
{
foreach (Delegates.SetDamageMode_int_BeforeArgs toInvoke in _beforeSetDamageMode_int.GetInvocationList())
{
try
{
...
private static void SetDamageModeFSM(On.HeroController.orig_SetDamageModeFSM orig,HeroController self,  int invincibilityType)
{
...
private static void SetDamageMode_DamageMode(On.HeroController.orig_SetDamageMode_DamageMode orig,HeroController self,  GlobalEnums.DamageMode newDamageMode)
{
Delegates.Params_SetDamageMode_DamageMode @params = new() 
{
self = self
, newDamageMode = newDamageMode
};
if (_beforeSetDamageMode_DamageMode != null)
{
foreach (Delegates.SetDamageMode_DamageMode_BeforeArgs toInvoke in _beforeSetDamageMode_DamageMode.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetDamageMode_DamageMode_AfterArgs toInvoke in _afterSetDamageMode_DamageMode.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StopAnimationControl_BeforeArgs toInvoke in _beforeStopAnimationControl.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StopAnimationControl_AfterArgs toInvoke in _afterStopAnimationControl.GetInvocationList())
{
try
{
...
private static void StartAnimationControl(On.HeroController.orig_StartAnimationControl orig,HeroController self)
{
...
{
foreach (Delegates.StartAnimationControl_BeforeArgs toInvoke in _beforeStartAnimationControl.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StartAnimationControl_AfterArgs toInvoke in _afterStartAnimationControl.GetInvocationList())
{
try
{
...
private static void IgnoreInputWithoutReset(On.HeroController.orig_IgnoreInputWithoutReset orig,HeroController self)
{
...
{
foreach (Delegates.IgnoreInputWithoutReset_BeforeArgs toInvoke in _beforeIgnoreInputWithoutReset.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IgnoreInputWithoutReset_AfterArgs toInvoke in _afterIgnoreInputWithoutReset.GetInvocationList())
{
try
{
...
private static void SpawnSoftLandingPrefab(On.HeroController.orig_SpawnSoftLandingPrefab orig,HeroController self)
{
...
{
foreach (Delegates.SpawnSoftLandingPrefab_BeforeArgs toInvoke in _beforeSpawnSoftLandingPrefab.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SpawnSoftLandingPrefab_AfterArgs toInvoke in _afterSpawnSoftLandingPrefab.GetInvocationList())
{
try
{
...
private static void AffectedByGravity(On.HeroController.orig_AffectedByGravity orig,HeroController self,  bool gravityApplies)
{
Delegates.Params_AffectedByGravity @params = new() 
{
self = self
, gravityApplies = gravityApplies
};
if (_beforeAffectedByGravity != null)
{
foreach (Delegates.AffectedByGravity_BeforeArgs toInvoke in _beforeAffectedByGravity.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LookForQueueInput_BeforeArgs toInvoke in _beforeLookForQueueInput.GetInvocationList())
{
try
{
...
private static void SetState(On.HeroController.orig_SetState orig,HeroController self,  GlobalEnums.ActorStates newState)
{
...
{
self = self
, setHazardMarker = setHazardMarker
, preventRunBob = preventRunBob
};
if (_beforeFinishedEnteringScene != null)
{
foreach (Delegates.FinishedEnteringScene_BeforeArgs toInvoke in _beforeFinishedEnteringScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FinishedEnteringScene_AfterArgs toInvoke in _afterFinishedEnteringScene.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator Die(On.HeroController.orig_Die orig,HeroController self)
{
...
private static System.Collections.IEnumerator DieFromHazard(On.HeroController.orig_DieFromHazard orig,HeroController self,  GlobalEnums.HazardType hazardType,  float angle)
{
...
private static System.Collections.IEnumerator StartRecoil(On.HeroController.orig_StartRecoil orig,HeroController self,  GlobalEnums.CollisionSide impactSide,  bool spawnDamageEffect,  int damageAmount)
{
Delegates.Params_StartRecoil @params = new() 
{
self = self
, impactSide = impactSide
, spawnDamageEffect = spawnDamageEffect
, damageAmount = damageAmount
};
...
private static System.Collections.IEnumerator Invulnerable(On.HeroController.orig_Invulnerable orig,HeroController self,  float duration)
{
...
private static System.Collections.IEnumerator FirstFadeIn(On.HeroController.orig_FirstFadeIn orig,HeroController self)
{
...
{
foreach (Delegates.ConfirmOutOfBounds_BeforeArgs toInvoke in _beforeConfirmOutOfBounds.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ConfirmOutOfBounds_AfterArgs toInvoke in _afterConfirmOutOfBounds.GetInvocationList())
{
try
{
...
private static UnityEngine.Transform LocateSpawnPoint(On.HeroController.orig_LocateSpawnPoint orig,HeroController self)
{
...
{
foreach (Delegates.CancelWallsliding_BeforeArgs toInvoke in _beforeCancelWallsliding.GetInvocationList())
{
try
{
...
private static void CancelRecoilHorizontal(On.HeroController.orig_CancelRecoilHorizontal orig,HeroController self)
{
...
{
foreach (Delegates.CancelRecoilHorizontal_BeforeArgs toInvoke in _beforeCancelRecoilHorizontal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CancelRecoilHorizontal_AfterArgs toInvoke in _afterCancelRecoilHorizontal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CancelDamageRecoil_BeforeArgs toInvoke in _beforeCancelDamageRecoil.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CancelDamageRecoil_AfterArgs toInvoke in _afterCancelDamageRecoil.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CancelFallEffects_BeforeArgs toInvoke in _beforeCancelFallEffects.GetInvocationList())
{
try
{
...
private static void ResetMotionNotVelocity(On.HeroController.orig_ResetMotionNotVelocity orig,HeroController self)
{
...
{
foreach (Delegates.ResetMotionNotVelocity_BeforeArgs toInvoke in _beforeResetMotionNotVelocity.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetMotionNotVelocity_AfterArgs toInvoke in _afterResetMotionNotVelocity.GetInvocationList())
{
try
{
...
private static void SetStartingMotionState(On.HeroController.orig_SetStartingMotionState orig,HeroController self)
{
...
{
foreach (Delegates.SetStartingMotionState_BeforeArgs toInvoke in _beforeSetStartingMotionState.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartingMotionState_AfterArgs toInvoke in _afterSetStartingMotionState.GetInvocationList())
{
try
{
...
private static void SetStartingMotionState_bool(On.HeroController.orig_SetStartingMotionState_bool orig,HeroController self,  bool preventRunDip)
{
Delegates.Params_SetStartingMotionState_bool @params = new() 
{
self = self
, preventRunDip = preventRunDip
};
if (_beforeSetStartingMotionState_bool != null)
{
foreach (Delegates.SetStartingMotionState_bool_BeforeArgs toInvoke in _beforeSetStartingMotionState_bool.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStartingMotionState_bool_AfterArgs toInvoke in _afterSetStartingMotionState_bool.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator TilemapTestPause(On.HeroController.orig_TilemapTestPause orig,HeroController self)
{
...
private static System.Collections.IEnumerator CheckForTerrainThunk(On.HeroController.orig_CheckForTerrainThunk orig,HeroController self,  GlobalEnums.AttackDirection attackDir)
{
...
{
foreach (Delegates.CheckForTerrainThunk_BeforeArgs toInvoke in _beforeCheckForTerrainThunk.GetInvocationList())
{
try
{
...
private static bool CheckStillTouchingWall(On.HeroController.orig_CheckStillTouchingWall orig,HeroController self,  GlobalEnums.CollisionSide side,  bool checkTop)
{
...
{
foreach (Delegates.CheckStillTouchingWall_BeforeArgs toInvoke in _beforeCheckStillTouchingWall.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckStillTouchingWall_AfterArgs toInvoke in _afterCheckStillTouchingWall.GetInvocationList())
{
try
{
...
private static bool CheckForBump(On.HeroController.orig_CheckForBump orig,HeroController self,  GlobalEnums.CollisionSide side)
{
...
{
foreach (Delegates.CheckTouchingGround_BeforeArgs toInvoke in _beforeCheckTouchingGround.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckTouchingGround_AfterArgs toInvoke in _afterCheckTouchingGround.GetInvocationList())
{
try
{
...
private static System.Collections.Generic.List<GlobalEnums.CollisionSide> CheckTouching(On.HeroController.orig_CheckTouching orig,HeroController self,  GlobalEnums.PhysLayers layer)
{
...
private static System.Collections.Generic.List<GlobalEnums.CollisionSide> CheckTouchingAdvanced(On.HeroController.orig_CheckTouchingAdvanced orig,HeroController self,  GlobalEnums.PhysLayers layer)
{
...
{
foreach (Delegates.CheckTouchingAdvanced_BeforeArgs toInvoke in _beforeCheckTouchingAdvanced.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckTouchingAdvanced_AfterArgs toInvoke in _afterCheckTouchingAdvanced.GetInvocationList())
{
try
{
...
private static GlobalEnums.CollisionSide FindCollisionDirection(On.HeroController.orig_FindCollisionDirection orig,HeroController self,  UnityEngine.Collision2D collision)
{
...
{
foreach (Delegates.FindCollisionDirection_BeforeArgs toInvoke in _beforeFindCollisionDirection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindCollisionDirection_AfterArgs toInvoke in _afterFindCollisionDirection.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CanInfiniteAirJump_BeforeArgs toInvoke in _beforeCanInfiniteAirJump.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CanInfiniteAirJump_AfterArgs toInvoke in _afterCanInfiniteAirJump.GetInvocationList())
{
try
{
...
private static bool ShouldHardLand(On.HeroController.orig_ShouldHardLand orig,HeroController self,  UnityEngine.Collision2D collision)
{
...
private static void OnCollisionEnter2D(On.HeroController.orig_OnCollisionEnter2D orig,HeroController self,  UnityEngine.Collision2D collision)
{
...
private static void OnCollisionStay2D(On.HeroController.orig_OnCollisionStay2D orig,HeroController self,  UnityEngine.Collision2D collision)
{
...
private static void OnCollisionExit2D(On.HeroController.orig_OnCollisionExit2D orig,HeroController self,  UnityEngine.Collision2D collision)
{
...
private static UnityEngine.Vector3 FindGroundPoint(On.HeroController.orig_FindGroundPoint orig,HeroController self,  UnityEngine.Vector2 startPoint,  bool useExtended)
{
...
private static float FindGroundPointY(On.HeroController.orig_FindGroundPointY orig,HeroController self,  float x,  float y,  bool useExtended)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_StartMPDrain", true), orig_StartMPDrain);
...
{
foreach (Delegates.orig_StartMPDrain_BeforeArgs toInvoke in _beforeorig_StartMPDrain.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "OrigDashVector", true), OrigDashVector);
...
private static UnityEngine.Vector2 OrigDashVector(Func<HeroController, UnityEngine.Vector2> orig, HeroController self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_Dash", true), orig_Dash);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_CharmUpdate", true), orig_CharmUpdate);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_DoAttack", true), orig_DoAttack);
...
public delegate void set_fallTimer_WithArgs (Action<HeroController,  float> orig, HeroController self,  float value);
...
public delegate void set_geoCounter_WithArgs (Action<HeroController,  GeoCounter> orig, HeroController self,  GeoCounter value);
...
public delegate PlayMakerFSM get_proxyFSM_WithArgs (Func<HeroController, PlayMakerFSM> orig, HeroController self);
...
public delegate void set_proxyFSM_WithArgs (Action<HeroController,  PlayMakerFSM> orig, HeroController self,  PlayMakerFSM value);
...
public delegate TransitionPoint get_sceneEntryGate_AfterArgs(Params_get_sceneEntryGate args, TransitionPoint ret);
public delegate TransitionPoint get_sceneEntryGate_WithArgs (Func<HeroController, TransitionPoint> orig, HeroController self);
...
public delegate void set_sceneEntryGate_WithArgs (Action<HeroController,  TransitionPoint> orig, HeroController self,  TransitionPoint value);
...
public delegate void Move_WithArgs (Action<HeroController,  float> orig, HeroController self,  float move_direction);
...
{
public HeroController self;
public GlobalEnums.AttackDirection attackDir;
}
public delegate void Attack_BeforeArgs(Params_Attack args);
public delegate void Attack_AfterArgs(Params_Attack args);
public delegate void Attack_WithArgs (Action<HeroController,  GlobalEnums.AttackDirection> orig, HeroController self,  GlobalEnums.AttackDirection attackDir);
...
public delegate void SetHeroParent_WithArgs (Action<HeroController,  UnityEngine.Transform> orig, HeroController self,  UnityEngine.Transform newParent);
...
public delegate void SetConveyorSpeed_WithArgs (Action<HeroController,  float> orig, HeroController self,  float speed);
...
public delegate void SetConveyorSpeedV_WithArgs (Action<HeroController,  float> orig, HeroController self,  float speed);
...
public delegate void EnterWithoutInput_WithArgs (Action<HeroController,  bool> orig, HeroController self,  bool flag);
...
public delegate void SetBenchRespawn_WithArgs (Action<HeroController,  string,  string,  int,  bool> orig, HeroController self,  string spawnMarker,  string sceneName,  int spawnType,  bool facingRight);
...
public delegate void SetHazardRespawn_WithArgs (Action<HeroController,  UnityEngine.Vector3,  bool> orig, HeroController self,  UnityEngine.Vector3 position,  bool facingRight);
...
public delegate void AddGeoToCounter_WithArgs (Action<HeroController,  int> orig, HeroController self,  int amount);
...
public delegate void SetWieldingLantern_WithArgs (Action<HeroController,  bool> orig, HeroController self,  bool set);
public sealed class Params_TakeDamage
{
public HeroController self;
public UnityEngine.GameObject go;
public GlobalEnums.CollisionSide damageSide;
...
public delegate void TakeDamage_WithArgs (Action<HeroController,  UnityEngine.GameObject,  GlobalEnums.CollisionSide,  int,  int> orig, HeroController self,  UnityEngine.GameObject go,  GlobalEnums.CollisionSide damageSide,  int damageAmount,  int hazardType);
...
public delegate bool TryAddMPChargeSpa_WithArgs (Func<HeroController,  int, bool> orig, HeroController self,  int amount);
...
public delegate void AddToMaxMPReserve_WithArgs (Action<HeroController,  int> orig, HeroController self,  int amount);
...
public delegate System.Collections.IEnumerator EnterScene_AfterArgs(Params_EnterScene args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator EnterScene_WithArgs (Func<HeroController,  TransitionPoint,  float, System.Collections.IEnumerator> orig, HeroController self,  TransitionPoint enterGate,  float delayBeforeEnter);
public sealed class Params_LeaveScene
{
public HeroController self;
public GlobalEnums.GatePosition? gate;
}
...
public delegate void LeaveScene_WithArgs (Action<HeroController,  GlobalEnums.GatePosition?> orig, HeroController self,  GlobalEnums.GatePosition? gate);
...
public delegate System.Collections.IEnumerator BetaLeave_AfterArgs(Params_BetaLeave args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator BetaLeave_WithArgs (Func<HeroController,  EndBeta, System.Collections.IEnumerator> orig, HeroController self,  EndBeta betaEndTrigger);
public sealed class Params_BetaReturn
{
public HeroController self;
}
public delegate void BetaReturn_BeforeArgs(Params_BetaReturn args);
public delegate System.Collections.IEnumerator BetaReturn_AfterArgs(Params_BetaReturn args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator BetaReturn_WithArgs (Func<HeroController, System.Collections.IEnumerator> orig, HeroController self);
public sealed class Params_Respawn
{
public HeroController self;
}
public delegate void Respawn_BeforeArgs(Params_Respawn args);
public delegate System.Collections.IEnumerator Respawn_AfterArgs(Params_Respawn args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Respawn_WithArgs (Func<HeroController, System.Collections.IEnumerator> orig, HeroController self);
public sealed class Params_HazardRespawn
{
public HeroController self;
}
public delegate void HazardRespawn_BeforeArgs(Params_HazardRespawn args);
public delegate System.Collections.IEnumerator HazardRespawn_AfterArgs(Params_HazardRespawn args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator HazardRespawn_WithArgs (Func<HeroController, System.Collections.IEnumerator> orig, HeroController self);
...
public delegate bool GetState_WithArgs (Func<HeroController,  string, bool> orig, HeroController self,  string stateName);
...
public delegate bool GetCState_WithArgs (Func<HeroController,  string, bool> orig, HeroController self,  string stateName);
...
public delegate void SetCState_WithArgs (Action<HeroController,  string,  bool> orig, HeroController self,  string stateName,  bool value);
...
public delegate void SetDamageMode_int_WithArgs (Action<HeroController,  int> orig, HeroController self,  int invincibilityType);
...
public delegate void SetDamageModeFSM_WithArgs (Action<HeroController,  int> orig, HeroController self,  int invincibilityType);
...
{
public HeroController self;
public GlobalEnums.DamageMode newDamageMode;
}
...
public delegate void SetDamageMode_DamageMode_WithArgs (Action<HeroController,  GlobalEnums.DamageMode> orig, HeroController self,  GlobalEnums.DamageMode newDamageMode);
...
public delegate void NearBench_WithArgs (Action<HeroController,  bool> orig, HeroController self,  bool isNearBench);
...
public delegate void SetWalkZone_WithArgs (Action<HeroController,  bool> orig, HeroController self,  bool inWalkZone);
...
public delegate void AffectedByGravity_WithArgs (Action<HeroController,  bool> orig, HeroController self,  bool gravityApplies);
...
{
public HeroController self;
public GlobalEnums.ActorStates newState;
}
...
public delegate void SetState_WithArgs (Action<HeroController,  GlobalEnums.ActorStates> orig, HeroController self,  GlobalEnums.ActorStates newState);
...
public delegate void FinishedEnteringScene_WithArgs (Action<HeroController,  bool,  bool> orig, HeroController self,  bool setHazardMarker,  bool preventRunBob);
public sealed class Params_Die
{
public HeroController self;
}
public delegate void Die_BeforeArgs(Params_Die args);
public delegate System.Collections.IEnumerator Die_AfterArgs(Params_Die args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Die_WithArgs (Func<HeroController, System.Collections.IEnumerator> orig, HeroController self);
public sealed class Params_DieFromHazard
{
public HeroController self;
public GlobalEnums.HazardType hazardType;
public float angle;
}
public delegate void DieFromHazard_BeforeArgs(Params_DieFromHazard args);
public delegate System.Collections.IEnumerator DieFromHazard_AfterArgs(Params_DieFromHazard args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DieFromHazard_WithArgs (Func<HeroController,  GlobalEnums.HazardType,  float, System.Collections.IEnumerator> orig, HeroController self,  GlobalEnums.HazardType hazardType,  float angle);
public sealed class Params_StartRecoil
{
public HeroController self;
public GlobalEnums.CollisionSide impactSide;
public bool spawnDamageEffect;
public int damageAmount;
}
public delegate void StartRecoil_BeforeArgs(Params_StartRecoil args);
public delegate System.Collections.IEnumerator StartRecoil_AfterArgs(Params_StartRecoil args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator StartRecoil_WithArgs (Func<HeroController,  GlobalEnums.CollisionSide,  bool,  int, System.Collections.IEnumerator> orig, HeroController self,  GlobalEnums.CollisionSide impactSide,  bool spawnDamageEffect,  int damageAmount);
...
public delegate System.Collections.IEnumerator Invulnerable_AfterArgs(Params_Invulnerable args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Invulnerable_WithArgs (Func<HeroController,  float, System.Collections.IEnumerator> orig, HeroController self,  float duration);
public sealed class Params_FirstFadeIn
{
public HeroController self;
}
public delegate void FirstFadeIn_BeforeArgs(Params_FirstFadeIn args);
public delegate System.Collections.IEnumerator FirstFadeIn_AfterArgs(Params_FirstFadeIn args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FirstFadeIn_WithArgs (Func<HeroController, System.Collections.IEnumerator> orig, HeroController self);
...
public delegate UnityEngine.Transform LocateSpawnPoint_AfterArgs(Params_LocateSpawnPoint args, UnityEngine.Transform ret);
public delegate UnityEngine.Transform LocateSpawnPoint_WithArgs (Func<HeroController, UnityEngine.Transform> orig, HeroController self);
...
public delegate void SetStartingMotionState_bool_WithArgs (Action<HeroController,  bool> orig, HeroController self,  bool preventRunDip);
...
public delegate System.Collections.IEnumerator TilemapTestPause_AfterArgs(Params_TilemapTestPause args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator TilemapTestPause_WithArgs (Func<HeroController, System.Collections.IEnumerator> orig, HeroController self);
...
public delegate System.Collections.IEnumerator CheckForTerrainThunk_AfterArgs(Params_CheckForTerrainThunk args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator CheckForTerrainThunk_WithArgs (Func<HeroController,  GlobalEnums.AttackDirection, System.Collections.IEnumerator> orig, HeroController self,  GlobalEnums.AttackDirection attackDir);
...
public delegate bool CheckStillTouchingWall_WithArgs (Func<HeroController,  GlobalEnums.CollisionSide,  bool, bool> orig, HeroController self,  GlobalEnums.CollisionSide side,  bool checkTop);
...
public delegate bool CheckForBump_WithArgs (Func<HeroController,  GlobalEnums.CollisionSide, bool> orig, HeroController self,  GlobalEnums.CollisionSide side);
...
{
public HeroController self;
public GlobalEnums.PhysLayers layer;
}
public delegate void CheckTouching_BeforeArgs(Params_CheckTouching args);
public delegate System.Collections.Generic.List<GlobalEnums.CollisionSide> CheckTouching_AfterArgs(Params_CheckTouching args, System.Collections.Generic.List<GlobalEnums.CollisionSide> ret);
public delegate System.Collections.Generic.List<GlobalEnums.CollisionSide> CheckTouching_WithArgs (Func<HeroController,  GlobalEnums.PhysLayers, System.Collections.Generic.List<GlobalEnums.CollisionSide>> orig, HeroController self,  GlobalEnums.PhysLayers layer);
...
public delegate System.Collections.Generic.List<GlobalEnums.CollisionSide> CheckTouchingAdvanced_AfterArgs(Params_CheckTouchingAdvanced args, System.Collections.Generic.List<GlobalEnums.CollisionSide> ret);
public delegate System.Collections.Generic.List<GlobalEnums.CollisionSide> CheckTouchingAdvanced_WithArgs (Func<HeroController,  GlobalEnums.PhysLayers, System.Collections.Generic.List<GlobalEnums.CollisionSide>> orig, HeroController self,  GlobalEnums.PhysLayers layer);
...
public delegate GlobalEnums.CollisionSide FindCollisionDirection_AfterArgs(Params_FindCollisionDirection args, GlobalEnums.CollisionSide ret);
public delegate GlobalEnums.CollisionSide FindCollisionDirection_WithArgs (Func<HeroController,  UnityEngine.Collision2D, GlobalEnums.CollisionSide> orig, HeroController self,  UnityEngine.Collision2D collision);
...
public delegate bool ShouldHardLand_WithArgs (Func<HeroController,  UnityEngine.Collision2D, bool> orig, HeroController self,  UnityEngine.Collision2D collision);
...
public delegate void OnCollisionEnter2D_WithArgs (Action<HeroController,  UnityEngine.Collision2D> orig, HeroController self,  UnityEngine.Collision2D collision);
...
public delegate void OnCollisionStay2D_WithArgs (Action<HeroController,  UnityEngine.Collision2D> orig, HeroController self,  UnityEngine.Collision2D collision);
...
public delegate void OnCollisionExit2D_WithArgs (Action<HeroController,  UnityEngine.Collision2D> orig, HeroController self,  UnityEngine.Collision2D collision);
...
public delegate UnityEngine.Vector3 FindGroundPoint_AfterArgs(Params_FindGroundPoint args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 FindGroundPoint_WithArgs (Func<HeroController,  UnityEngine.Vector2,  bool, UnityEngine.Vector3> orig, HeroController self,  UnityEngine.Vector2 startPoint,  bool useExtended);
...
public delegate float FindGroundPointY_WithArgs (Func<HeroController,  float,  float,  bool, float> orig, HeroController self,  float x,  float y,  bool useExtended);
...
public delegate void orig_StartMPDrain_WithArgs (Action<HeroController,  float> orig, HeroController self,  float time);
...
public delegate UnityEngine.Vector2 OrigDashVector_AfterArgs(Params_OrigDashVector args, UnityEngine.Vector2 ret);
public delegate UnityEngine.Vector2 OrigDashVector_WithArgs (Func<HeroController, UnityEngine.Vector2> orig, HeroController self);
...
{
add => HookEndpointManager.Add<Delegates.get_fallTimer_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_fallTimer", true), value);
remove => HookEndpointManager.Remove<Delegates.get_fallTimer_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_fallTimer", true), value);
}
public static event Delegates.set_fallTimer_WithArgs set_fallTimer
{
add => HookEndpointManager.Add<Delegates.set_fallTimer_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_fallTimer", true), value);
remove => HookEndpointManager.Remove<Delegates.set_fallTimer_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_fallTimer", true), value);
}
public static event Delegates.get_geoCounter_WithArgs get_geoCounter
{
add => HookEndpointManager.Add<Delegates.get_geoCounter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_geoCounter", true), value);
remove => HookEndpointManager.Remove<Delegates.get_geoCounter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_geoCounter", true), value);
}
public static event Delegates.set_geoCounter_WithArgs set_geoCounter
{
add => HookEndpointManager.Add<Delegates.set_geoCounter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_geoCounter", true), value);
remove => HookEndpointManager.Remove<Delegates.set_geoCounter_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_geoCounter", true), value);
}
public static event Delegates.get_proxyFSM_WithArgs get_proxyFSM
{
add => HookEndpointManager.Add<Delegates.get_proxyFSM_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_proxyFSM", true), value);
remove => HookEndpointManager.Remove<Delegates.get_proxyFSM_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_proxyFSM", true), value);
}
public static event Delegates.set_proxyFSM_WithArgs set_proxyFSM
{
add => HookEndpointManager.Add<Delegates.set_proxyFSM_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_proxyFSM", true), value);
remove => HookEndpointManager.Remove<Delegates.set_proxyFSM_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_proxyFSM", true), value);
}
public static event Delegates.get_sceneEntryGate_WithArgs get_sceneEntryGate
{
add => HookEndpointManager.Add<Delegates.get_sceneEntryGate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_sceneEntryGate", true), value);
remove => HookEndpointManager.Remove<Delegates.get_sceneEntryGate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_sceneEntryGate", true), value);
}
public static event Delegates.set_sceneEntryGate_WithArgs set_sceneEntryGate
{
add => HookEndpointManager.Add<Delegates.set_sceneEntryGate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_sceneEntryGate", true), value);
remove => HookEndpointManager.Remove<Delegates.set_sceneEntryGate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "set_sceneEntryGate", true), value);
}
public static event Delegates.get_IsDreamReturning_WithArgs get_IsDreamReturning
{
add => HookEndpointManager.Add<Delegates.get_IsDreamReturning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_IsDreamReturning", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsDreamReturning_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_IsDreamReturning", true), value);
}
public static event Delegates.get_instance_WithArgs get_instance
{
add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_instance", false), value);
}
public static event Delegates.get_SilentInstance_WithArgs get_SilentInstance
{
add => HookEndpointManager.Add<Delegates.get_SilentInstance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_SilentInstance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_SilentInstance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_SilentInstance", false), value);
}
public static event Delegates.get_UnsafeInstance_WithArgs get_UnsafeInstance
{
add => HookEndpointManager.Add<Delegates.get_UnsafeInstance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_UnsafeInstance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_UnsafeInstance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "get_UnsafeInstance", false), value);
}
...
{
add => HookEndpointManager.Add<Delegates.orig_StartMPDrain_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_StartMPDrain", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_StartMPDrain_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_StartMPDrain", true), value);
}
public static event Delegates.orig_Update_WithArgs orig_Update
{
add => HookEndpointManager.Add<Delegates.orig_Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_Update", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Update_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_Update", true), value);
}
public static event Delegates.OrigDashVector_WithArgs OrigDashVector
{
add => HookEndpointManager.Add<Delegates.OrigDashVector_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "OrigDashVector", true), value);
remove => HookEndpointManager.Remove<Delegates.OrigDashVector_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "OrigDashVector", true), value);
}
public static event Delegates.orig_Dash_WithArgs orig_Dash
{
add => HookEndpointManager.Add<Delegates.orig_Dash_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_Dash", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_Dash_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_Dash", true), value);
}
public static event Delegates.orig_CharmUpdate_WithArgs orig_CharmUpdate
{
add => HookEndpointManager.Add<Delegates.orig_CharmUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_CharmUpdate", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_CharmUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_CharmUpdate", true), value);
}
public static event Delegates.orig_DoAttack_WithArgs orig_DoAttack
{
add => HookEndpointManager.Add<Delegates.orig_DoAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_DoAttack", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_DoAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HeroController), "orig_DoAttack", true), value);
}
}
