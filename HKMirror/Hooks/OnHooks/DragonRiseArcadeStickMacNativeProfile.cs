...
public static class OnDragonRiseArcadeStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DragonRiseArcadeStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<DragonRiseArcadeStickMacNativeProfile> orig,
            DragonRiseArcadeStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<DragonRiseArcadeStickMacNativeProfile> orig,
            DragonRiseArcadeStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public DragonRiseArcadeStickMacNativeProfile self;
        }
    }
