...
public static class OnuGuiSliderSetDirection
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetDirection), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetDirection), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetDirection), "DoSetValue"), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetDirection), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiSliderSetDirection> orig, uGuiSliderSetDirection self);

        public sealed class Params_Reset
        {
            public uGuiSliderSetDirection self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetDirection), "Reset"), value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(uGuiSliderSetDirection), "OnExit"), value);
