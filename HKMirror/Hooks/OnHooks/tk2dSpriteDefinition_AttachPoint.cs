...
public static class Ontk2dSpriteDefinition_AttachPoint
{
    internal static class HookHandler
    {
        ...
        internal static void HookCopyFrom()
        {
            if (!HookedList.Contains("CopyFrom"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteDefinition.AttachPoint), "CopyFrom"),
                    CopyFrom);
            }
        }
        ...
        private static void CopyFrom(Action<tk2dSpriteDefinition.AttachPoint, tk2dSpriteDefinition.AttachPoint> orig,
            tk2dSpriteDefinition.AttachPoint self, tk2dSpriteDefinition.AttachPoint src)
        {
        ...
        internal static void HookCompareTo()
        {
            if (!HookedList.Contains("CompareTo"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteDefinition.AttachPoint), "CompareTo"),
                    CompareTo);
            }
        }
        ...
        private static bool CompareTo(
            Func<tk2dSpriteDefinition.AttachPoint, tk2dSpriteDefinition.AttachPoint, bool> orig,
            tk2dSpriteDefinition.AttachPoint self, tk2dSpriteDefinition.AttachPoint src)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void CopyFrom_WithArgs(
            Action<tk2dSpriteDefinition.AttachPoint, tk2dSpriteDefinition.AttachPoint> orig,
            tk2dSpriteDefinition.AttachPoint self, tk2dSpriteDefinition.AttachPoint src);
