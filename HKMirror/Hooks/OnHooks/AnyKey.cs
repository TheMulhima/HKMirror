...
public static class OnAnyKey
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AnyKey), "Reset"),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<AnyKey> orig,
            AnyKey self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(AnyKey), "OnUpdate"),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<AnyKey> orig,
            AnyKey self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnUpdate_WithArgs(Action<AnyKey> orig,
            AnyKey self);
        ...
        public delegate void Reset_WithArgs(Action<AnyKey> orig,
            AnyKey self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AnyKey), "Reset"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(AnyKey), "OnUpdate"), value);
