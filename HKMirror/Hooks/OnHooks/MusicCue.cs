...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_OriginalMusicEventName", true), get_OriginalMusicEventName);
...
{
foreach (Delegates.get_OriginalMusicEventName_BeforeArgs toInvoke in _beforeget_OriginalMusicEventName.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_OriginalMusicEventName_AfterArgs toInvoke in _afterget_OriginalMusicEventName.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_OriginalMusicTrackNumber", true), get_OriginalMusicTrackNumber);
...
{
foreach (Delegates.get_OriginalMusicTrackNumber_BeforeArgs toInvoke in _beforeget_OriginalMusicTrackNumber.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_OriginalMusicTrackNumber_AfterArgs toInvoke in _afterget_OriginalMusicTrackNumber.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_Snapshot", true), get_Snapshot);
...
private static UnityEngine.Audio.AudioMixerSnapshot get_Snapshot(Func<MusicCue, UnityEngine.Audio.AudioMixerSnapshot> orig, MusicCue self)
{
...
private static MusicCue ResolveAlternatives(On.MusicCue.orig_ResolveAlternatives orig,MusicCue self,  PlayerData playerData)
{
...
{
foreach (Delegates.ResolveAlternatives_BeforeArgs toInvoke in _beforeResolveAlternatives.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResolveAlternatives_AfterArgs toInvoke in _afterResolveAlternatives.GetInvocationList())
{
try
{
...
public delegate UnityEngine.Audio.AudioMixerSnapshot get_Snapshot_AfterArgs(Params_get_Snapshot args, UnityEngine.Audio.AudioMixerSnapshot ret);
public delegate UnityEngine.Audio.AudioMixerSnapshot get_Snapshot_WithArgs (Func<MusicCue, UnityEngine.Audio.AudioMixerSnapshot> orig, MusicCue self);
...
public delegate MusicCue ResolveAlternatives_WithArgs (Func<MusicCue,  PlayerData, MusicCue> orig, MusicCue self,  PlayerData playerData);
}
...
{
add => HookEndpointManager.Add<Delegates.get_OriginalMusicEventName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_OriginalMusicEventName", true), value);
remove => HookEndpointManager.Remove<Delegates.get_OriginalMusicEventName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_OriginalMusicEventName", true), value);
}
public static event Delegates.get_OriginalMusicTrackNumber_WithArgs get_OriginalMusicTrackNumber
{
add => HookEndpointManager.Add<Delegates.get_OriginalMusicTrackNumber_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_OriginalMusicTrackNumber", true), value);
remove => HookEndpointManager.Remove<Delegates.get_OriginalMusicTrackNumber_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_OriginalMusicTrackNumber", true), value);
}
public static event Delegates.get_Snapshot_WithArgs get_Snapshot
{
add => HookEndpointManager.Add<Delegates.get_Snapshot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_Snapshot", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Snapshot_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(MusicCue), "get_Snapshot", true), value);
}
