...
public static class OnUnityMouseProvider
{
    internal static class HookHandler
    {
        ...
        internal static void HookSafeGetMouseButton()
        {
            if (!HookedList.Contains("SafeGetMouseButton"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "SafeGetMouseButton", false),
                    SafeGetMouseButton);
            }
        }
        ...
        private static bool SafeGetMouseButton(Func<int, bool> orig, int button)
        {
            ...
            {
                foreach (Delegates.SafeGetMouseButton_BeforeArgs toInvoke in
                         _beforeSafeGetMouseButton.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SafeGetMouseButton_AfterArgs toInvoke in
                         _afterSafeGetMouseButton.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookClearState()
        {
            if (!HookedList.Contains("ClearState"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "ClearState", true),
                    ClearState);
            }
        }
        ...
        internal static void HookGetPosition()
        {
            if (!HookedList.Contains("GetPosition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetPosition", true),
                    GetPosition);
            }
        }
        ...
        private static UnityEngine.Vector2 GetPosition(Func<InControl.UnityMouseProvider, UnityEngine.Vector2> orig,
            InControl.UnityMouseProvider self)
        {
        ...
        internal static void HookGetDeltaX()
        {
            if (!HookedList.Contains("GetDeltaX"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaX", true),
                    GetDeltaX);
            }
        }
        ...
        private static float GetDeltaX(Func<InControl.UnityMouseProvider, float> orig,
            InControl.UnityMouseProvider self)
        {
        ...
        internal static void HookGetDeltaY()
        {
            if (!HookedList.Contains("GetDeltaY"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaY", true),
                    GetDeltaY);
            }
        }
        ...
        private static float GetDeltaY(Func<InControl.UnityMouseProvider, float> orig,
            InControl.UnityMouseProvider self)
        {
        ...
        internal static void HookGetDeltaScroll()
        {
            if (!HookedList.Contains("GetDeltaScroll"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaScroll", true),
                    GetDeltaScroll);
            }
        }
        ...
        private static float GetDeltaScroll(Func<InControl.UnityMouseProvider, float> orig,
            InControl.UnityMouseProvider self)
        {
        ...
        internal static void HookGetButtonIsPressed()
        {
            if (!HookedList.Contains("GetButtonIsPressed"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonIsPressed", true),
                    GetButtonIsPressed);
            }
        }
        ...
        private static bool GetButtonIsPressed(Func<InControl.UnityMouseProvider, InControl.Mouse, bool> orig,
            InControl.UnityMouseProvider self, InControl.Mouse control)
        {
            ...
            {
                foreach (Delegates.GetButtonIsPressed_BeforeArgs toInvoke in
                         _beforeGetButtonIsPressed.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetButtonIsPressed_AfterArgs toInvoke in
                         _afterGetButtonIsPressed.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookGetButtonWasPressed()
        {
            if (!HookedList.Contains("GetButtonWasPressed"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonWasPressed", true),
                    GetButtonWasPressed);
            }
        }
        ...
        private static bool GetButtonWasPressed(Func<InControl.UnityMouseProvider, InControl.Mouse, bool> orig,
            InControl.UnityMouseProvider self, InControl.Mouse control)
        {
            ...
            {
                foreach (Delegates.GetButtonWasPressed_BeforeArgs toInvoke in _beforeGetButtonWasPressed
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetButtonWasPressed_AfterArgs toInvoke in
                         _afterGetButtonWasPressed.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookGetButtonWasReleased()
        {
            if (!HookedList.Contains("GetButtonWasReleased"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonWasReleased", true),
        ...
        private static bool GetButtonWasReleased(Func<InControl.UnityMouseProvider, InControl.Mouse, bool> orig,
            InControl.UnityMouseProvider self, InControl.Mouse control)
        {
            ...
            {
                foreach (Delegates.GetButtonWasReleased_BeforeArgs toInvoke in _beforeGetButtonWasReleased
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetButtonWasReleased_AfterArgs toInvoke in _afterGetButtonWasReleased
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookHasMousePresent()
        {
            if (!HookedList.Contains("HasMousePresent"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "HasMousePresent", true),
                    HasMousePresent);
            }
        }
        ...
        private static bool HasMousePresent(Func<InControl.UnityMouseProvider, bool> orig,
            InControl.UnityMouseProvider self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Setup_WithArgs(Action<InControl.UnityMouseProvider> orig,
            InControl.UnityMouseProvider self);
        ...
        public delegate void Reset_WithArgs(Action<InControl.UnityMouseProvider> orig,
            InControl.UnityMouseProvider self);
        ...
        public delegate void Update_WithArgs(Action<InControl.UnityMouseProvider> orig,
            InControl.UnityMouseProvider self);
        ...
        public delegate void ClearState_WithArgs(Action<InControl.UnityMouseProvider> orig,
            InControl.UnityMouseProvider self);
        ...
        public delegate UnityEngine.Vector2 GetPosition_WithArgs(
            Func<InControl.UnityMouseProvider, UnityEngine.Vector2> orig, InControl.UnityMouseProvider self);
        ...
        public delegate float GetDeltaX_WithArgs(Func<InControl.UnityMouseProvider, float> orig,
            InControl.UnityMouseProvider self);
        ...
        public delegate float GetDeltaY_WithArgs(Func<InControl.UnityMouseProvider, float> orig,
            InControl.UnityMouseProvider self);
        ...
        public delegate float GetDeltaScroll_WithArgs(Func<InControl.UnityMouseProvider, float> orig,
            InControl.UnityMouseProvider self);
        ...
        public delegate bool GetButtonIsPressed_WithArgs(Func<InControl.UnityMouseProvider, InControl.Mouse, bool> orig,
            InControl.UnityMouseProvider self, InControl.Mouse control);
        ...
        public delegate bool GetButtonWasPressed_WithArgs(
            Func<InControl.UnityMouseProvider, InControl.Mouse, bool> orig, InControl.UnityMouseProvider self,
            InControl.Mouse control);
        ...
        public delegate bool GetButtonWasReleased_WithArgs(
            Func<InControl.UnityMouseProvider, InControl.Mouse, bool> orig, InControl.UnityMouseProvider self,
            InControl.Mouse control);
        ...
        public delegate bool HasMousePresent_WithArgs(Func<InControl.UnityMouseProvider, bool> orig,
            InControl.UnityMouseProvider self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Setup_WithArgs Setup
        {
            add => HookEndpointManager.Add<Delegates.Setup_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "Setup", true), value);
        ...
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "Reset", true), value);
        ...
        public static event Delegates.Update_WithArgs Update
        {
            add => HookEndpointManager.Add<Delegates.Update_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "Update", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.SafeGetMouseButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "SafeGetMouseButton", false),
                value);
            remove => HookEndpointManager.Remove<Delegates.SafeGetMouseButton_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "SafeGetMouseButton", false),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.ClearState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "ClearState", true), value);
            remove => HookEndpointManager.Remove<Delegates.ClearState_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "ClearState", true), value);
        }
        ...
        public static event Delegates.GetPosition_WithArgs GetPosition
        {
            add => HookEndpointManager.Add<Delegates.GetPosition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetPosition", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetDeltaX_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaX", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetDeltaX_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaX", true), value);
        }

        public static event Delegates.GetDeltaY_WithArgs GetDeltaY
        {
            add => HookEndpointManager.Add<Delegates.GetDeltaY_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaY", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetDeltaY_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaY", true), value);
        }

        public static event Delegates.GetDeltaScroll_WithArgs GetDeltaScroll
        {
            add => HookEndpointManager.Add<Delegates.GetDeltaScroll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaScroll", true), value);
            remove => HookEndpointManager.Remove<Delegates.GetDeltaScroll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetDeltaScroll", true), value);
        }

        public static event Delegates.GetButtonIsPressed_WithArgs GetButtonIsPressed
        {
            add => HookEndpointManager.Add<Delegates.GetButtonIsPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonIsPressed", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.GetButtonIsPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonIsPressed", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetButtonWasPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonWasPressed", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.GetButtonWasPressed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonWasPressed", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.GetButtonWasReleased_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonWasReleased", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.GetButtonWasReleased_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "GetButtonWasReleased", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.HasMousePresent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "HasMousePresent", true), value);
            remove => HookEndpointManager.Remove<Delegates.HasMousePresent_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityMouseProvider), "HasMousePresent", true), value);
        }
    }
}