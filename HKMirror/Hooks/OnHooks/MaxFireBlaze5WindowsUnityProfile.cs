...
public static class OnMaxFireBlaze5WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MaxFireBlaze5WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MaxFireBlaze5WindowsUnityProfile> orig, MaxFireBlaze5WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MaxFireBlaze5WindowsUnityProfile> orig,
            MaxFireBlaze5WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public MaxFireBlaze5WindowsUnityProfile self;
        }
    }
