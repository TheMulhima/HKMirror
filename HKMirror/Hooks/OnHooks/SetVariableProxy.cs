    ...
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVariableProxy), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static System.Object Invoke(
            Func<Modding.Delegates.SetVariableProxy, System.Type, string, System.Object, System.Object> orig,
            Modding.Delegates.SetVariableProxy self, System.Type type, string name, System.Object value)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVariableProxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static System.Object EndInvoke(
            Func<Modding.Delegates.SetVariableProxy, System.IAsyncResult, System.Object> orig,
            Modding.Delegates.SetVariableProxy self, System.IAsyncResult result)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVariableProxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVariableProxy), "EndInvoke", true), value);
