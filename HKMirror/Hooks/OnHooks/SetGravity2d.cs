...
public static class OnSetGravity2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity2d), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity2d), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity2d), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self)
        {
        ...
        internal static void HookDoSetGravity()
        {
            if (!HookedList.Contains("DoSetGravity"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity2d), "DoSetGravity",
                        true), DoSetGravity);
            }
        }
        ...
        private static void DoSetGravity(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self);
        ...
        public delegate void DoSetGravity_WithArgs(Action<HutongGames.PlayMaker.Actions.SetGravity2d> orig,
            HutongGames.PlayMaker.Actions.SetGravity2d self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity2d), "OnUpdate", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoSetGravity_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity2d), "DoSetGravity",
                    true), value);
            remove => HookEndpointManager.Remove<Delegates.DoSetGravity_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SetGravity2d), "DoSetGravity",
                    true), value);
        }
    }
