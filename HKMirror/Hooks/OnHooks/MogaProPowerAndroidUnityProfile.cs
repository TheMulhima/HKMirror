...
public static class OnMogaProPowerAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MogaProPowerAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MogaProPowerAndroidUnityProfile> orig, MogaProPowerAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MogaProPowerAndroidUnityProfile> orig,
            MogaProPowerAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public MogaProPowerAndroidUnityProfile self;
        }
    }
