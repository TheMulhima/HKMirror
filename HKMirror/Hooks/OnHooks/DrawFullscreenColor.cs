...
public static class OnDrawFullscreenColor
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DrawFullscreenColor), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.DrawFullscreenColor> orig,
            HutongGames.PlayMaker.Actions.DrawFullscreenColor self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.DrawFullscreenColor), "OnGUI",
                        true), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<HutongGames.PlayMaker.Actions.DrawFullscreenColor> orig,
            HutongGames.PlayMaker.Actions.DrawFullscreenColor self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.DrawFullscreenColor> orig,
            HutongGames.PlayMaker.Actions.DrawFullscreenColor self);
        ...
        public delegate void OnGUI_WithArgs(Action<HutongGames.PlayMaker.Actions.DrawFullscreenColor> orig,
            HutongGames.PlayMaker.Actions.DrawFullscreenColor self);
    }
