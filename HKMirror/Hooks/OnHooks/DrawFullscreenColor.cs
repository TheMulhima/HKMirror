...
public static class OnDrawFullscreenColor
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DrawFullscreenColor), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<DrawFullscreenColor> orig, DrawFullscreenColor self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(DrawFullscreenColor), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<DrawFullscreenColor> orig, DrawFullscreenColor self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<DrawFullscreenColor> orig, DrawFullscreenColor self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<DrawFullscreenColor> orig, DrawFullscreenColor self);

        public sealed class Params_Reset
        {
            public DrawFullscreenColor self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DrawFullscreenColor), "Reset"), value);
        ...
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(DrawFullscreenColor), "OnGUI"), value);
