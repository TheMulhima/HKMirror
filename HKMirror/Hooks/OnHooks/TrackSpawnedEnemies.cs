...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TrackSpawnedEnemies), "get_TotalTracked", true), get_TotalTracked);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(TrackSpawnedEnemies), "get_TotalAlive", true), get_TotalAlive);
...
private static void Add(On.TrackSpawnedEnemies.orig_Add orig,TrackSpawnedEnemies self,  HealthManager enemyHealthManager)
{
...
public delegate void Add_WithArgs (Action<TrackSpawnedEnemies,  HealthManager> orig, TrackSpawnedEnemies self,  HealthManager enemyHealthManager);
}
...
{
add => HookEndpointManager.Add<Delegates.get_TotalTracked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TrackSpawnedEnemies), "get_TotalTracked", true), value);
remove => HookEndpointManager.Remove<Delegates.get_TotalTracked_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TrackSpawnedEnemies), "get_TotalTracked", true), value);
}
public static event Delegates.get_TotalAlive_WithArgs get_TotalAlive
{
add => HookEndpointManager.Add<Delegates.get_TotalAlive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TrackSpawnedEnemies), "get_TotalAlive", true), value);
remove => HookEndpointManager.Remove<Delegates.get_TotalAlive_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(TrackSpawnedEnemies), "get_TotalAlive", true), value);
}
