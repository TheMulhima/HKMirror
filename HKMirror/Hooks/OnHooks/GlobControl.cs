...
public static class OnGlobControl
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator Break_AfterArgs(Params_Break args, IEnumerator ret);

        public delegate void Break_BeforeArgs(Params_Break args);

        public delegate IEnumerator Break_WithArgs(Func<GlobControl, IEnumerator> orig, GlobControl self);
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<GlobControl, Collider2D> orig, GlobControl self,
            Collider2D col);
