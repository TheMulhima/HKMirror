...
public static class OnGoogleStadiaMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GoogleStadiaMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GoogleStadiaMacUnityProfile> orig, GoogleStadiaMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GoogleStadiaMacUnityProfile> orig,
            GoogleStadiaMacUnityProfile self);

        public sealed class Params_Define
        {
            public GoogleStadiaMacUnityProfile self;
        }
    }
