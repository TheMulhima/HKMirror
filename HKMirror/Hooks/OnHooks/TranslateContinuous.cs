...
public static class OnTranslateContinuous
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<TranslateContinuous> orig, TranslateContinuous self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<TranslateContinuous> orig, TranslateContinuous self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<TranslateContinuous> orig, TranslateContinuous self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<TranslateContinuous> orig, TranslateContinuous self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<TranslateContinuous> orig, TranslateContinuous self)
        {
        ...
        internal static void HookDoTranslate()
        {
            if (!HookedList.Contains("DoTranslate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "DoTranslate"), DoTranslate);
            }
        }
        ...
        private static void DoTranslate(Action<TranslateContinuous> orig, TranslateContinuous self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<TranslateContinuous> orig, TranslateContinuous self);
        ...
        public delegate void DoTranslate_WithArgs(Action<TranslateContinuous> orig, TranslateContinuous self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<TranslateContinuous> orig, TranslateContinuous self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<TranslateContinuous> orig, TranslateContinuous self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<TranslateContinuous> orig, TranslateContinuous self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<TranslateContinuous> orig, TranslateContinuous self);

        public sealed class Params_Reset
        {
            public TranslateContinuous self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "Awake"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(TranslateContinuous), "OnEnter"), value);
