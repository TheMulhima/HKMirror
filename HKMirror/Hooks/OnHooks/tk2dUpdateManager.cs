...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUpdateManager), "get_Instance", false), get_Instance);
...
private static System.Collections.IEnumerator coSuperLateUpdate(On.tk2dUpdateManager.orig_coSuperLateUpdate orig,tk2dUpdateManager self)
{
...
{
foreach (Delegates.coSuperLateUpdate_BeforeArgs toInvoke in _beforecoSuperLateUpdate.GetInvocationList())
{
try
{
...
private static void QueueCommitInternal(On.tk2dUpdateManager.orig_QueueCommitInternal orig,tk2dUpdateManager self,  tk2dTextMesh textMesh)
{
...
{
foreach (Delegates.QueueCommitInternal_BeforeArgs toInvoke in _beforeQueueCommitInternal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.QueueCommitInternal_AfterArgs toInvoke in _afterQueueCommitInternal.GetInvocationList())
{
try
{
...
private static void FlushQueuesInternal(On.tk2dUpdateManager.orig_FlushQueuesInternal orig,tk2dUpdateManager self)
{
...
{
foreach (Delegates.FlushQueuesInternal_BeforeArgs toInvoke in _beforeFlushQueuesInternal.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FlushQueuesInternal_AfterArgs toInvoke in _afterFlushQueuesInternal.GetInvocationList())
{
try
{
...
public delegate System.Collections.IEnumerator coSuperLateUpdate_AfterArgs(Params_coSuperLateUpdate args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator coSuperLateUpdate_WithArgs (Func<tk2dUpdateManager, System.Collections.IEnumerator> orig, tk2dUpdateManager self);
...
public delegate void QueueCommitInternal_WithArgs (Action<tk2dUpdateManager,  tk2dTextMesh> orig, tk2dUpdateManager self,  tk2dTextMesh textMesh);
...
{
add => HookEndpointManager.Add<Delegates.get_Instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUpdateManager), "get_Instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_Instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUpdateManager), "get_Instance", false), value);
}
