...
public static class Ontk2dUpdateManager
{
    ...
    {
        public delegate IEnumerator coSuperLateUpdate_AfterArgs(Params_coSuperLateUpdate args, IEnumerator ret);

        public delegate void coSuperLateUpdate_BeforeArgs(Params_coSuperLateUpdate args);

        public delegate IEnumerator coSuperLateUpdate_WithArgs(Func<tk2dUpdateManager, IEnumerator> orig,
            tk2dUpdateManager self);
