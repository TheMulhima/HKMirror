...
public static class OnCharmVibrations
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator PlayDelayedVibrationRoutine_AfterArgs(Params_PlayDelayedVibrationRoutine args,
            IEnumerator ret);

        public delegate void PlayDelayedVibrationRoutine_BeforeArgs(Params_PlayDelayedVibrationRoutine args);

        public delegate IEnumerator PlayDelayedVibrationRoutine_WithArgs(
            Func<CharmVibrations, VibrationData, IEnumerator> orig, CharmVibrations self, VibrationData vibrationData);
