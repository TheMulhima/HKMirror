...
public static class OnCharmVibrations
{
    internal static class HookHandler
    {
        ...
        private static void PlayOvercharmPlace(On.CharmVibrations.orig_PlayOvercharmPlace orig, CharmVibrations self)
        {
            ...
            {
                foreach (Delegates.PlayOvercharmPlace_BeforeArgs toInvoke in
                         _beforePlayOvercharmPlace.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.PlayOvercharmPlace_AfterArgs toInvoke in
                         _afterPlayOvercharmPlace.GetInvocationList())
                {
                    try
                    {
            ...
            CharmVibrations self)
        {
            ...
            {
                foreach (Delegates.PlayOvercharmFinalHit_BeforeArgs toInvoke in _beforePlayOvercharmFinalHit
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.PlayOvercharmFinalHit_AfterArgs toInvoke in _afterPlayOvercharmFinalHit
                             .GetInvocationList())
                {
                    try
                    {
            ...
            CharmVibrations self, VibrationData vibrationData)
        {
            ...
            {
                foreach (Delegates.PlayDelayedVibration_BeforeArgs toInvoke in _beforePlayDelayedVibration
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.PlayDelayedVibration_AfterArgs toInvoke in _afterPlayDelayedVibration
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static System.Collections.IEnumerator PlayDelayedVibrationRoutine(
            On.CharmVibrations.orig_PlayDelayedVibrationRoutine orig, CharmVibrations self, VibrationData vibrationData)
        {
            ...
            {
                foreach (Delegates.PlayDelayedVibrationRoutine_BeforeArgs toInvoke in _beforePlayDelayedVibrationRoutine
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void PlayDelayedVibration_WithArgs(Action<CharmVibrations, VibrationData> orig,
            CharmVibrations self, VibrationData vibrationData);
        ...
        public delegate System.Collections.IEnumerator PlayDelayedVibrationRoutine_AfterArgs(
            Params_PlayDelayedVibrationRoutine args, System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator PlayDelayedVibrationRoutine_WithArgs(
            Func<CharmVibrations, VibrationData, System.Collections.IEnumerator> orig, CharmVibrations self,
