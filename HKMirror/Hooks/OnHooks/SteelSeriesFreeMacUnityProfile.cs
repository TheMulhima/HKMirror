...
public static class OnSteelSeriesFreeMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SteelSeriesFreeMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<SteelSeriesFreeMacUnityProfile> orig, SteelSeriesFreeMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<SteelSeriesFreeMacUnityProfile> orig,
            SteelSeriesFreeMacUnityProfile self);

        public sealed class Params_Define
        {
            public SteelSeriesFreeMacUnityProfile self;
        }
    }
