...
public static class OnCollisionEvent
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.CollisionEvent> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.CollisionEvent> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self)
        {
        ...
        internal static void HookStoreCollisionInfo()
        {
            if (!HookedList.Contains("StoreCollisionInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
        ...
        private static void StoreCollisionInfo(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.Collision> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.Collision collisionInfo)
        {
        ...
        internal static void HookDoCollisionEnter()
        {
            if (!HookedList.Contains("DoCollisionEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
                        "DoCollisionEnter", true), DoCollisionEnter);
            }
        }
        ...
        private static void DoCollisionEnter(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.Collision> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.Collision collisionInfo)
        {
        ...
        internal static void HookDoCollisionStay()
        {
            if (!HookedList.Contains("DoCollisionStay"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
                        "DoCollisionStay", true), DoCollisionStay);
            }
        }
        ...
        private static void DoCollisionStay(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.Collision> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.Collision collisionInfo)
        {
        ...
        internal static void HookDoCollisionExit()
        {
            if (!HookedList.Contains("DoCollisionExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
                        "DoCollisionExit", true), DoCollisionExit);
            }
        }
        ...
        private static void DoCollisionExit(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.Collision> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.Collision collisionInfo)
        {
        ...
        internal static void HookDoControllerColliderHit()
        {
            if (!HookedList.Contains("DoControllerColliderHit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
                        "DoControllerColliderHit", true), DoControllerColliderHit);
            }
        }
        ...
        private static void DoControllerColliderHit(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.ControllerColliderHit> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.ControllerColliderHit collisionInfo)
        {
        ...
        internal static void HookDoParticleCollision()
        {
            if (!HookedList.Contains("DoParticleCollision"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
                        "DoParticleCollision", true), DoParticleCollision);
            }
        }
        ...
        private static void DoParticleCollision(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.GameObject other)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.CollisionEvent, string> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.CollisionEvent> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.CollisionEvent> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self);
        ...
        public delegate void DoCollisionEnter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.Collision> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.Collision collisionInfo);
        ...
        public delegate void DoCollisionStay_WithArgs(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.Collision> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.Collision collisionInfo);
        ...
        public delegate void DoCollisionExit_WithArgs(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.Collision> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.Collision collisionInfo);
        ...
        public delegate void DoControllerColliderHit_WithArgs(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.ControllerColliderHit> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.ControllerColliderHit collisionInfo);
        ...
        public delegate void DoParticleCollision_WithArgs(
            Action<HutongGames.PlayMaker.Actions.CollisionEvent, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self, UnityEngine.GameObject other);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.CollisionEvent, string> orig,
            HutongGames.PlayMaker.Actions.CollisionEvent self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoCollisionEnter_WithArgs DoCollisionEnter
        {
            add => HookEndpointManager.Add<Delegates.DoCollisionEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent), "DoCollisionEnter",
                    true), value);
        ...
        public static event Delegates.DoCollisionStay_WithArgs DoCollisionStay
        {
            add => HookEndpointManager.Add<Delegates.DoCollisionStay_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent), "DoCollisionStay",
                    true), value);
        ...
        public static event Delegates.DoCollisionExit_WithArgs DoCollisionExit
        {
            add => HookEndpointManager.Add<Delegates.DoCollisionExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent), "DoCollisionExit",
                    true), value);
        ...
        public static event Delegates.DoControllerColliderHit_WithArgs DoControllerColliderHit
        {
            add => HookEndpointManager.Add<Delegates.DoControllerColliderHit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
                    "DoControllerColliderHit", true), value);
        ...
        public static event Delegates.DoParticleCollision_WithArgs DoParticleCollision
        {
            add => HookEndpointManager.Add<Delegates.DoParticleCollision_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.CollisionEvent),
                    "DoParticleCollision", true), value);
