...
public static class OnCollisionEvent
{
    internal static class HookHandler
    {
            ...
            CollisionEvent self, ControllerColliderHit collisionInfo)
        {
            ...
            if (_beforeDoControllerColliderHit != null)
                foreach (Delegates.DoControllerColliderHit_BeforeArgs toInvoke in _beforeDoControllerColliderHit
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterDoControllerColliderHit != null)
                foreach (Delegates.DoControllerColliderHit_AfterArgs toInvoke in _afterDoControllerColliderHit
                             .GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoCollisionEnter_WithArgs(Action<CollisionEvent, Collision> orig, CollisionEvent self,
            Collision collisionInfo);
        ...
        public delegate void DoCollisionExit_WithArgs(Action<CollisionEvent, Collision> orig, CollisionEvent self,
            Collision collisionInfo);
        ...
        public delegate void DoCollisionStay_WithArgs(Action<CollisionEvent, Collision> orig, CollisionEvent self,
            Collision collisionInfo);
        ...
        public delegate void DoControllerColliderHit_WithArgs(Action<CollisionEvent, ControllerColliderHit> orig,
            CollisionEvent self, ControllerColliderHit collisionInfo);
        ...
        public delegate void DoParticleCollision_WithArgs(Action<CollisionEvent, GameObject> orig, CollisionEvent self,
            GameObject other);
        ...
        public delegate string ErrorCheck_WithArgs(Func<CollisionEvent, string> orig, CollisionEvent self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<CollisionEvent> orig, CollisionEvent self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<CollisionEvent> orig, CollisionEvent self);
        ...
        public delegate void StoreCollisionInfo_WithArgs(Action<CollisionEvent, Collision> orig, CollisionEvent self,
            Collision collisionInfo);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoCollisionEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoCollisionEnter"), value);
            remove => HookEndpointManager.Remove<Delegates.DoCollisionEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoCollisionEnter"), value);
        }

        public static event Delegates.DoCollisionStay_WithArgs DoCollisionStay
        {
            add => HookEndpointManager.Add<Delegates.DoCollisionStay_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoCollisionStay"), value);
            remove => HookEndpointManager.Remove<Delegates.DoCollisionStay_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoCollisionStay"), value);
        }

        public static event Delegates.DoCollisionExit_WithArgs DoCollisionExit
        {
            add => HookEndpointManager.Add<Delegates.DoCollisionExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoCollisionExit"), value);
            remove => HookEndpointManager.Remove<Delegates.DoCollisionExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoCollisionExit"), value);
        }

        public static event Delegates.DoControllerColliderHit_WithArgs DoControllerColliderHit
        {
            add => HookEndpointManager.Add<Delegates.DoControllerColliderHit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoControllerColliderHit"), value);
            remove => HookEndpointManager.Remove<Delegates.DoControllerColliderHit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(CollisionEvent), "DoControllerColliderHit"), value);
        }
