...
public static class OnPlayStation4LinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4LinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4LinuxUnityProfile> orig, PlayStation4LinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4LinuxUnityProfile> orig,
            PlayStation4LinuxUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4LinuxUnityProfile self;
        }
    }
