...
public static class OnGameObjectIsChildOf
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GameObjectIsChildOf), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GameObjectIsChildOf> orig,
            HutongGames.PlayMaker.Actions.GameObjectIsChildOf self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GameObjectIsChildOf), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GameObjectIsChildOf> orig,
            HutongGames.PlayMaker.Actions.GameObjectIsChildOf self)
        {
        ...
        internal static void HookDoIsChildOf()
        {
            if (!HookedList.Contains("DoIsChildOf"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GameObjectIsChildOf),
                        "DoIsChildOf", true), DoIsChildOf);
            }
        }
        ...
        private static void DoIsChildOf(
            Action<HutongGames.PlayMaker.Actions.GameObjectIsChildOf, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.GameObjectIsChildOf self, UnityEngine.GameObject go)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GameObjectIsChildOf> orig,
            HutongGames.PlayMaker.Actions.GameObjectIsChildOf self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GameObjectIsChildOf> orig,
            HutongGames.PlayMaker.Actions.GameObjectIsChildOf self);
        ...
        public delegate void DoIsChildOf_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GameObjectIsChildOf, UnityEngine.GameObject> orig,
            HutongGames.PlayMaker.Actions.GameObjectIsChildOf self, UnityEngine.GameObject go);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoIsChildOf_WithArgs DoIsChildOf
        {
            add => HookEndpointManager.Add<Delegates.DoIsChildOf_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GameObjectIsChildOf), "DoIsChildOf",
                    true), value);
