...
new Hook(ReflectionHelper.GetMethodInfo(typeof(PreInstantiateGameObject), "get_InstantiatedGameObject", true), get_InstantiatedGameObject);
...
private static UnityEngine.GameObject get_InstantiatedGameObject(Func<PreInstantiateGameObject, UnityEngine.GameObject> orig, PreInstantiateGameObject self)
{
...
{
foreach (Delegates.get_InstantiatedGameObject_BeforeArgs toInvoke in _beforeget_InstantiatedGameObject.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_InstantiatedGameObject_AfterArgs toInvoke in _afterget_InstantiatedGameObject.GetInvocationList())
{
try
{
...
public delegate UnityEngine.GameObject get_InstantiatedGameObject_AfterArgs(Params_get_InstantiatedGameObject args, UnityEngine.GameObject ret);
public delegate UnityEngine.GameObject get_InstantiatedGameObject_WithArgs (Func<PreInstantiateGameObject, UnityEngine.GameObject> orig, PreInstantiateGameObject self);
...
{
add => HookEndpointManager.Add<Delegates.get_InstantiatedGameObject_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PreInstantiateGameObject), "get_InstantiatedGameObject", true), value);
remove => HookEndpointManager.Remove<Delegates.get_InstantiatedGameObject_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(PreInstantiateGameObject), "get_InstantiatedGameObject", true), value);
}
