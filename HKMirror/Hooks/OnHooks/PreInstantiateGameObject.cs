...
public static class OnPreInstantiateGameObject
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_InstantiatedGameObject()
        {
            if (!HookedList.Contains("get_InstantiatedGameObject"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(PreInstantiateGameObject), "get_InstantiatedGameObject",
                        true), get_InstantiatedGameObject);
            }
        }
        ...
        private static UnityEngine.GameObject get_InstantiatedGameObject(
            Func<PreInstantiateGameObject, UnityEngine.GameObject> orig, PreInstantiateGameObject self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.GameObject get_InstantiatedGameObject_AfterArgs(
            Params_get_InstantiatedGameObject args, UnityEngine.GameObject ret);

        public delegate UnityEngine.GameObject get_InstantiatedGameObject_WithArgs(
            Func<PreInstantiateGameObject, UnityEngine.GameObject> orig, PreInstantiateGameObject self);
    ...
    public static class WithOrig
    {
        public static event Delegates.get_InstantiatedGameObject_WithArgs get_InstantiatedGameObject
        {
            add => HookEndpointManager.Add<Delegates.get_InstantiatedGameObject_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(PreInstantiateGameObject), "get_InstantiatedGameObject", true),
                value);
