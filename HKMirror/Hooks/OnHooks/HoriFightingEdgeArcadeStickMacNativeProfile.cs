...
public static class OnHoriFightingEdgeArcadeStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriFightingEdgeArcadeStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriFightingEdgeArcadeStickMacNativeProfile> orig,
            HoriFightingEdgeArcadeStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriFightingEdgeArcadeStickMacNativeProfile> orig,
            HoriFightingEdgeArcadeStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriFightingEdgeArcadeStickMacNativeProfile self;
        }
    }
