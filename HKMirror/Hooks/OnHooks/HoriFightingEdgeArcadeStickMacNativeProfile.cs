...
public static class OnHoriFightingEdgeArcadeStickMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.HoriFightingEdgeArcadeStickMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.HoriFightingEdgeArcadeStickMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.HoriFightingEdgeArcadeStickMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.HoriFightingEdgeArcadeStickMacNativeProfile), "Define", true),
                value);
