...
public static class OnLogitechDriveFXRacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechDriveFXRacingWheelMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<LogitechDriveFXRacingWheelMacNativeProfile> orig,
            LogitechDriveFXRacingWheelMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechDriveFXRacingWheelMacNativeProfile> orig,
            LogitechDriveFXRacingWheelMacNativeProfile self);

        public sealed class Params_Define
        {
            public LogitechDriveFXRacingWheelMacNativeProfile self;
        }
    }
