...
public static class OnLogitechDriveFXRacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.LogitechDriveFXRacingWheelMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.LogitechDriveFXRacingWheelMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.LogitechDriveFXRacingWheelMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.LogitechDriveFXRacingWheelMacNativeProfile), "Define", true),
                value);
