...
{
foreach (Delegates.FixedSizeLayoutItem_BeforeArgs toInvoke in _beforeFixedSizeLayoutItem.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FixedSizeLayoutItem_AfterArgs toInvoke in _afterFixedSizeLayoutItem.GetInvocationList())
{
try
{
