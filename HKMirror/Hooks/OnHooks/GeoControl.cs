...
private static void OnCollisionEnter2D(On.GeoControl.orig_OnCollisionEnter2D orig,GeoControl self,  UnityEngine.Collision2D collision)
{
...
private static void OnTriggerEnter2D(On.GeoControl.orig_OnTriggerEnter2D orig,GeoControl self,  UnityEngine.Collider2D collision)
{
...
private static System.Collections.IEnumerator DisableAfterTime(On.GeoControl.orig_DisableAfterTime orig,GeoControl self,  float waitTime)
{
...
private static System.Collections.IEnumerator Getter(On.GeoControl.orig_Getter orig,GeoControl self)
{
...
public delegate void OnCollisionEnter2D_WithArgs (Action<GeoControl,  UnityEngine.Collision2D> orig, GeoControl self,  UnityEngine.Collision2D collision);
...
public delegate void OnTriggerEnter2D_WithArgs (Action<GeoControl,  UnityEngine.Collider2D> orig, GeoControl self,  UnityEngine.Collider2D collision);
...
public delegate System.Collections.IEnumerator DisableAfterTime_WithArgs (Func<GeoControl,  float, System.Collections.IEnumerator> orig, GeoControl self,  float waitTime);
public sealed class Params_Getter
{
public GeoControl self;
}
public delegate void Getter_BeforeArgs(Params_Getter args);
public delegate System.Collections.IEnumerator Getter_AfterArgs(Params_Getter args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Getter_WithArgs (Func<GeoControl, System.Collections.IEnumerator> orig, GeoControl self);
}
