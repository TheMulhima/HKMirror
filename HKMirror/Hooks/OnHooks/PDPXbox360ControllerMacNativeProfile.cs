...
public static class OnPDPXbox360ControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PDPXbox360ControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PDPXbox360ControllerMacNativeProfile> orig,
            PDPXbox360ControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PDPXbox360ControllerMacNativeProfile> orig,
            PDPXbox360ControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PDPXbox360ControllerMacNativeProfile self;
        }
    }
