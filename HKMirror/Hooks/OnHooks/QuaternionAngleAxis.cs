...
public static class OnQuaternionAngleAxis
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "OnLateUpdate"), OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self)
        {
        ...
        internal static void HookDoQuatAngleAxis()
        {
            if (!HookedList.Contains("DoQuatAngleAxis"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "DoQuatAngleAxis"),
                    DoQuatAngleAxis);
            }
        }
        ...
        private static void DoQuatAngleAxis(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoQuatAngleAxis_WithArgs(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<QuaternionAngleAxis> orig, QuaternionAngleAxis self);

        public sealed class Params_Reset
        {
            public QuaternionAngleAxis self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(QuaternionAngleAxis), "OnUpdate"), value);
