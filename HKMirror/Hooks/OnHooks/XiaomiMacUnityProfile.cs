...
public static class OnXiaomiMacUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XiaomiMacUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XiaomiMacUnityProfile> orig, XiaomiMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XiaomiMacUnityProfile> orig, XiaomiMacUnityProfile self);

        public sealed class Params_Define
        {
            public XiaomiMacUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(XiaomiMacUnityProfile), "Define"), value);
