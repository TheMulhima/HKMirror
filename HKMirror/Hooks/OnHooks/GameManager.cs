...
public static class OnGameManager
{
    internal static class HookHandler
    {
        ...
        private static void BeginSceneTransition(On.GameManager.orig_BeginSceneTransition orig, GameManager self,
            GameManager.SceneLoadInfo info)
        {
            ...
            if (_beforeBeginSceneTransition != null)
                foreach (Delegates.BeginSceneTransition_BeforeArgs toInvoke in _beforeBeginSceneTransition
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterBeginSceneTransition != null)
                foreach (Delegates.BeginSceneTransition_AfterArgs toInvoke in _afterBeginSceneTransition
                             .GetInvocationList())
                    try
                    {
        ...
        private static IEnumerator BeginSceneTransitionRoutine(On.GameManager.orig_BeginSceneTransitionRoutine orig,
            GameManager self, GameManager.SceneLoadInfo info)
        {
            ...
            if (_beforeBeginSceneTransitionRoutine != null)
                foreach (Delegates.BeginSceneTransitionRoutine_BeforeArgs toInvoke in _beforeBeginSceneTransitionRoutine
                             .GetInvocationList())
                    try
                    {
        ...
        private static IEnumerator ReturnToMainMenu(On.GameManager.orig_ReturnToMainMenu orig, GameManager self,
            GameManager.ReturnToMainMenuSaveModes saveMode, Action<bool> callback)
        {
            Delegates.Params_ReturnToMainMenu @params = new()
            {
                self = self, saveMode = saveMode, callback = callback
            };
        ...
        internal static void Hookorig_BeginSceneTransition()
        {
            if (!HookedList.Contains("orig_BeginSceneTransition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition"),
                    orig_BeginSceneTransition);
            }
        }
        ...
        private static void orig_BeginSceneTransition(Action<GameManager, GameManager.SceneLoadInfo> orig,
            GameManager self, GameManager.SceneLoadInfo info)
        {
            ...
            if (_beforeorig_BeginSceneTransition != null)
                foreach (Delegates.orig_BeginSceneTransition_BeforeArgs toInvoke in _beforeorig_BeginSceneTransition
                             .GetInvocationList())
                    try
                    {
            ...
            if (_afterorig_BeginSceneTransition != null)
                foreach (Delegates.orig_BeginSceneTransition_AfterArgs toInvoke in _afterorig_BeginSceneTransition
                             .GetInvocationList())
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate void BeginSceneTransition_WithArgs(Action<GameManager, GameManager.SceneLoadInfo> orig,
            GameManager self, GameManager.SceneLoadInfo info);

        public delegate IEnumerator BeginSceneTransitionRoutine_AfterArgs(Params_BeginSceneTransitionRoutine args,
            IEnumerator ret);

        public delegate void BeginSceneTransitionRoutine_BeforeArgs(Params_BeginSceneTransitionRoutine args);

        public delegate IEnumerator BeginSceneTransitionRoutine_WithArgs(
            Func<GameManager, GameManager.SceneLoadInfo, IEnumerator> orig, GameManager self,
            GameManager.SceneLoadInfo info);
        ...
        public delegate void orig_BeginSceneTransition_WithArgs(Action<GameManager, GameManager.SceneLoadInfo> orig,
            GameManager self, GameManager.SceneLoadInfo info);
        ...
        public delegate IEnumerator ReturnToMainMenu_WithArgs(
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.orig_BeginSceneTransition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition"), value);
            remove => HookEndpointManager.Remove<Delegates.orig_BeginSceneTransition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition"), value);
        }
