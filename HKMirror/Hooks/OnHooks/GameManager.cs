...
/// <summary>
/// Contains different types of On Hooks for GameManager class
...
public static class OnGameManager
{
    internal static class HookHandler
    {
        ...
        private static bool get_TimeSlowed(Func<GameManager, bool> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_TimeSlowed.Invoke(@params);
            }
        ...
        internal static void Hookget_inputHandler()
        {
            if (!HookedList.Contains("get_inputHandler"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_inputHandler", true),
                    get_inputHandler);
            }
        }
        ...
        private static InputHandler get_inputHandler(Func<GameManager, InputHandler> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_inputHandler.Invoke(@params);
            }
        ...
        internal static void Hookset_inputHandler()
        {
            if (!HookedList.Contains("set_inputHandler"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_inputHandler", true),
                    set_inputHandler);
            }
        }
        ...
        internal static void Hookget_achievementHandler()
        {
            if (!HookedList.Contains("get_achievementHandler"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_achievementHandler", true),
            ...
            GameManager self)
        {
            ...
            {
                retVal = _afterget_achievementHandler.Invoke(@params);
            }
        ...
        internal static void Hookset_achievementHandler()
        {
            if (!HookedList.Contains("set_achievementHandler"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_achievementHandler", true),
        ...
        internal static void Hookget_AudioManager()
        {
            if (!HookedList.Contains("get_AudioManager"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_AudioManager", true),
                    get_AudioManager);
            }
        }
        ...
        private static AudioManager get_AudioManager(Func<GameManager, AudioManager> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_AudioManager.Invoke(@params);
            }
        ...
        private static CameraController get_cameraCtrl(Func<GameManager, CameraController> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_cameraCtrl.Invoke(@params);
            }
        ...
        private static HeroController get_hero_ctrl(Func<GameManager, HeroController> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_hero_ctrl.Invoke(@params);
            }
        ...
        private static UnityEngine.SpriteRenderer get_heroLight(Func<GameManager, UnityEngine.SpriteRenderer> orig,
            GameManager self)
        {
            ...
            {
                retVal = _afterget_heroLight.Invoke(@params);
            }
        ...
        private static void set_heroLight(Action<GameManager, UnityEngine.SpriteRenderer> orig, GameManager self,
            UnityEngine.SpriteRenderer value)
        {
        ...
        private static SceneManager get_sm(Func<GameManager, SceneManager> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_sm.Invoke(@params);
            }
        ...
        private static UIManager get_ui(Func<GameManager, UIManager> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_ui.Invoke(@params);
            }
        ...
        private static tk2dTileMap get_tilemap(Func<GameManager, tk2dTileMap> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_tilemap.Invoke(@params);
            }
        ...
        private static PlayMakerFSM get_soulOrb_fsm(Func<GameManager, PlayMakerFSM> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_soulOrb_fsm.Invoke(@params);
            }
        ...
        internal static void Hookget_soulVessel_fsm()
        {
            if (!HookedList.Contains("get_soulVessel_fsm"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulVessel_fsm", true),
                    get_soulVessel_fsm);
            }
        }
        ...
        private static PlayMakerFSM get_soulVessel_fsm(Func<GameManager, PlayMakerFSM> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_soulVessel_fsm.Invoke(@params);
            }
        ...
        internal static void Hookset_soulVessel_fsm()
        {
            if (!HookedList.Contains("set_soulVessel_fsm"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulVessel_fsm", true),
                    set_soulVessel_fsm);
            }
        }
        ...
        private static float get_PlayTime(Func<GameManager, float> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_PlayTime.Invoke(@params);
            }
        ...
        internal static void Hookget_RespawningHero()
        {
            if (!HookedList.Contains("get_RespawningHero"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_RespawningHero", true),
                    get_RespawningHero);
            }
        }
        ...
        private static bool get_RespawningHero(Func<GameManager, bool> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_RespawningHero.Invoke(@params);
            }
        ...
        internal static void Hookset_RespawningHero()
        {
            if (!HookedList.Contains("set_RespawningHero"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_RespawningHero", true),
                    set_RespawningHero);
            }
        }
        ...
        internal static void Hookget_IsInSceneTransition()
        {
            if (!HookedList.Contains("get_IsInSceneTransition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsInSceneTransition", true),
        ...
        private static bool get_IsInSceneTransition(Func<GameManager, bool> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_IsInSceneTransition.Invoke(@params);
            }
        ...
        internal static void Hookset_IsInSceneTransition()
        {
            if (!HookedList.Contains("set_IsInSceneTransition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_IsInSceneTransition", true),
        ...
        internal static void Hookget_HasFinishedEnteringScene()
        {
            if (!HookedList.Contains("get_HasFinishedEnteringScene"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_HasFinishedEnteringScene", true),
        ...
        private static bool get_HasFinishedEnteringScene(Func<GameManager, bool> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_HasFinishedEnteringScene.Invoke(@params);
            }
        ...
        private static WorldInfo get_WorldInfo(Func<GameManager, WorldInfo> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_WorldInfo.Invoke(@params);
            }
        ...
        internal static void Hookget_IsLoadingSceneTransition()
        {
            if (!HookedList.Contains("get_IsLoadingSceneTransition"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsLoadingSceneTransition", true),
        ...
        private static bool get_IsLoadingSceneTransition(Func<GameManager, bool> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_IsLoadingSceneTransition.Invoke(@params);
            }
        ...
        internal static void Hookget_CurrentLoadDuration()
        {
            if (!HookedList.Contains("get_CurrentLoadDuration"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_CurrentLoadDuration", true),
        ...
        private static float get_CurrentLoadDuration(Func<GameManager, float> orig, GameManager self)
        {
            ...
            {
                retVal = _afterget_CurrentLoadDuration.Invoke(@params);
            }
        ...
        internal static void Hookget_IsUsingCustomLoadAnimation()
        {
            if (!HookedList.Contains("get_IsUsingCustomLoadAnimation"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsUsingCustomLoadAnimation", true),
        ...
        private static GameManager get_instance(Func<GameManager> orig)
        {
            ...
            {
                retVal = _afterget_instance.Invoke();
            }
        ...
        private static GameManager get_UnsafeInstance(Func<GameManager> orig)
        {
            ...
            {
                retVal = _afterget_UnsafeInstance.Invoke();
            }
        ...
        private static void LevelActivated(On.GameManager.orig_LevelActivated orig, GameManager self,
        ...
        private static System.Collections.IEnumerator TransitionScene(On.GameManager.orig_TransitionScene orig,
        ...
        private static System.Collections.IEnumerator PlayerDead(On.GameManager.orig_PlayerDead orig, GameManager self,
            float waitTime)
        {
        ...
        private static System.Collections.IEnumerator PlayerDeadFromHazard(
            On.GameManager.orig_PlayerDeadFromHazard orig, GameManager self, float waitTime)
        {
        ...
        private static System.Collections.IEnumerator FadeSceneInWithDelay(
            On.GameManager.orig_FadeSceneInWithDelay orig, GameManager self, float delay)
        {
        ...
        private static bool IsGamePaused(On.GameManager.orig_IsGamePaused orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsGamePaused.Invoke(@params);
            }
        ...
        private static void SetGameMap(On.GameManager.orig_SetGameMap orig, GameManager self,
            UnityEngine.GameObject go_gameMap)
        {
        ...
        private static string GetLanguageAsString(On.GameManager.orig_GetLanguageAsString orig, GameManager self)
        {
            ...
            {
                retVal = _afterGetLanguageAsString.Invoke(@params);
            }
        ...
        private static string GetEntryGateName(On.GameManager.orig_GetEntryGateName orig, GameManager self)
        {
            ...
            {
                retVal = _afterGetEntryGateName.Invoke(@params);
            }
            ...
            string boolName)
        {
            ...
            {
                retVal = _afterGetPlayerDataBool.Invoke(@params);
            }
        ...
        private static int GetPlayerDataInt(On.GameManager.orig_GetPlayerDataInt orig, GameManager self, string intName)
        {
            ...
            {
                retVal = _afterGetPlayerDataInt.Invoke(@params);
            }
            ...
            string floatName)
        {
            ...
            {
                retVal = _afterGetPlayerDataFloat.Invoke(@params);
            }
            ...
            string stringName)
        {
            ...
            {
                retVal = _afterGetPlayerDataString.Invoke(@params);
            }
        ...
        private static void SetPlayerDataVector3(On.GameManager.orig_SetPlayerDataVector3 orig, GameManager self,
            string vectorName, UnityEngine.Vector3 value)
        {
        ...
        private static UnityEngine.Vector3 GetPlayerDataVector3(On.GameManager.orig_GetPlayerDataVector3 orig,
            GameManager self, string vectorName)
        {
            ...
            {
                retVal = _afterGetPlayerDataVector3.Invoke(@params);
            }
        ...
        private static bool UpdateGameMap(On.GameManager.orig_UpdateGameMap orig, GameManager self)
        {
            ...
            {
                retVal = _afterUpdateGameMap.Invoke(@params);
            }
            ...
            string scene)
        {
            ...
            {
                retVal = _afterGetIsSceneVisited.Invoke(@params);
            }
            ...
            string key)
        {
            ...
            {
                retVal = _afterIsAchievementAwarded.Invoke(@params);
            }
        ...
        private static int GetStatusRecordInt(On.GameManager.orig_GetStatusRecordInt orig, GameManager self, string key)
        {
            ...
            {
                retVal = _afterGetStatusRecordInt.Invoke(@params);
            }
        ...
        private static void SetState(On.GameManager.orig_SetState orig, GameManager self,
            GlobalEnums.GameState newState)
        {
        ...
        private static System.Collections.IEnumerator LoadSceneAdditive(On.GameManager.orig_LoadSceneAdditive orig,
        ...
        private static System.Collections.IEnumerator LoadFirstScene(On.GameManager.orig_LoadFirstScene orig,
            GameManager self)
        {
        ...
        private static UnityEngine.Vector2? FindEntryPoint(On.GameManager.orig_FindEntryPoint orig, GameManager self,
            string entryPointName, UnityEngine.SceneManagement.Scene filterScene)
        {
            ...
            {
                retVal = _afterFindEntryPoint.Invoke(@params);
            }
        ...
        private static TransitionPoint FindTransitionPoint(On.GameManager.orig_FindTransitionPoint orig,
            GameManager self, string entryPointName, UnityEngine.SceneManagement.Scene filterScene,
            bool fallbackToAnyAvailable)
        {
            ...
            {
                retVal = _afterFindTransitionPoint.Invoke(@params);
            }
        ...
        private static System.Collections.IEnumerator SkipCutsceneNoMash(On.GameManager.orig_SkipCutsceneNoMash orig,
            GameManager self)
        {
        ...
        private static string GetCurrentMapZone(On.GameManager.orig_GetCurrentMapZone orig, GameManager self)
        {
            ...
            {
                retVal = _afterGetCurrentMapZone.Invoke(@params);
            }
        ...
        private static float GetSceneWidth(On.GameManager.orig_GetSceneWidth orig, GameManager self)
        {
            ...
            {
                retVal = _afterGetSceneWidth.Invoke(@params);
            }
        ...
        private static float GetSceneHeight(On.GameManager.orig_GetSceneHeight orig, GameManager self)
        {
            ...
            {
                retVal = _afterGetSceneHeight.Invoke(@params);
            }
        ...
        private static UnityEngine.GameObject GetSceneManager(On.GameManager.orig_GetSceneManager orig,
            GameManager self)
        {
            ...
            {
                retVal = _afterGetSceneManager.Invoke(@params);
            }
        ...
        private static string GetFormattedMapZoneString(On.GameManager.orig_GetFormattedMapZoneString orig,
            GameManager self, GlobalEnums.MapZone mapZone)
        {
            ...
            {
                retVal = _afterGetFormattedMapZoneString.Invoke(@params);
            }
        ...
        private static string GetBaseSceneName(On.GameManager.orig_GetBaseSceneName orig, string fullSceneName)
        {
            ...
            {
                retVal = _afterGetBaseSceneName.Invoke(@params);
            }
        ...
        private static string GetSceneNameString(On.GameManager.orig_GetSceneNameString orig, GameManager self)
        {
            ...
            {
                retVal = _afterGetSceneNameString.Invoke(@params);
            }
        ...
        private static tk2dTileMap GetTileMap(On.GameManager.orig_GetTileMap orig, UnityEngine.GameObject gameObject)
        {
            ...
            {
                retVal = _afterGetTileMap.Invoke(@params);
            }
        ...
        private static bool IsMenuScene(On.GameManager.orig_IsMenuScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsMenuScene.Invoke(@params);
            }
        ...
        private static bool IsTitleScreenScene(On.GameManager.orig_IsTitleScreenScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsTitleScreenScene.Invoke(@params);
            }
        ...
        private static bool IsGameplayScene(On.GameManager.orig_IsGameplayScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsGameplayScene.Invoke(@params);
            }
        ...
        private static bool IsNonGameplayScene(On.GameManager.orig_IsNonGameplayScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsNonGameplayScene.Invoke(@params);
            }
        ...
        private static bool IsCinematicScene(On.GameManager.orig_IsCinematicScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsCinematicScene.Invoke(@params);
            }
        ...
        private static bool IsStagTravelScene(On.GameManager.orig_IsStagTravelScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsStagTravelScene.Invoke(@params);
            }
        ...
        private static bool IsBetaEndScene(On.GameManager.orig_IsBetaEndScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsBetaEndScene.Invoke(@params);
            }
        ...
        private static bool IsTutorialScene(On.GameManager.orig_IsTutorialScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsTutorialScene.Invoke(@params);
            }
        ...
        private static bool IsTestScene(On.GameManager.orig_IsTestScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsTestScene.Invoke(@params);
            }
        ...
        private static bool IsBossDoorScene(On.GameManager.orig_IsBossDoorScene orig, GameManager self)
        {
            ...
            {
                retVal = _afterIsBossDoorScene.Invoke(@params);
            }
            ...
            GameManager self)
        {
            ...
            {
                retVal = _afterShouldKeepHUDCameraActive.Invoke(@params);
            }
        ...
        private static string GetSceneZoneName(On.GameManager.orig_GetSceneZoneName orig, string str)
        {
            ...
            {
                retVal = _afterGetSceneZoneName.Invoke(@params);
            }
        ...
        private static int CountBits(On.GameManager.orig_CountBits orig, int val)
        {
            ...
            {
                retVal = _afterCountBits.Invoke(@params);
            }
            ...
            string sourceSceneName, string destinationSceneName)
        {
            ...
            {
                retVal = _afterIsUnloadAssetsRequired.Invoke(@params);
            }
        ...
        private static void SaveGame_Action(Action<GameManager, System.Action<bool>> orig, GameManager self,
            System.Action<bool> callback)
        {
        ...
        internal static void HookSaveGame_int_Action()
        {
            if (!HookedList.Contains("SaveGame_int_Action"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame_int_Action", true),
                    SaveGame_int_Action);
            }
        }
        ...
        private static void SaveGame_int_Action(Action<GameManager, int, System.Action<bool>> orig, GameManager self,
            int saveSlot, System.Action<bool> callback)
        {
        ...
        private static System.Collections.IEnumerator LoadGameFromUIRoutine(
            On.GameManager.orig_LoadGameFromUIRoutine orig, GameManager self, int saveSlot)
        {
        ...
        private static void GetSaveStatsForSlot(On.GameManager.orig_GetSaveStatsForSlot orig, GameManager self,
            int saveSlot, System.Action<SaveStats> callback)
        {
        ...
        private static System.Collections.IEnumerator PauseGameToggleByMenu(
            On.GameManager.orig_PauseGameToggleByMenu orig, GameManager self)
        {
        ...
        private static System.Collections.IEnumerator PauseGameToggle(On.GameManager.orig_PauseGameToggle orig,
            GameManager self)
        {
        ...
        private static System.Collections.IEnumerator SetTimeScale_float_float(
            On.GameManager.orig_SetTimeScale_float_float orig, GameManager self, float newTimeScale, float duration)
        {
        ...
        private static System.Collections.IEnumerator FreezeMoment_float_float_float_float(
        ...
        private static System.Collections.IEnumerator FreezeMomentGC(On.GameManager.orig_FreezeMomentGC orig,
            GameManager self, float rampDownTime, float waitTime, float rampUpTime, float targetSpeed)
        {
        ...
        private static System.Collections.IEnumerator FreezeMoment_float_float_float_bool(
        ...
        private static System.Collections.IEnumerator RunStartNewGame(On.GameManager.orig_RunStartNewGame orig,
            GameManager self)
        {
        ...
        private static System.Collections.IEnumerator RunContinueGame(On.GameManager.orig_RunContinueGame orig,
            GameManager self)
        {
            ...
            GameManager self)
        {
            ...
            {
                retVal = _afterGetImplicitCinematicVolume.Invoke(@params);
            }
        ...
        private static UIManager orig_get_ui(Func<GameManager, UIManager> orig, GameManager self)
        {
            ...
            {
                retVal = _afterorig_get_ui.Invoke(@params);
            }
        ...
        internal static void Hookorig_OnApplicationQuit()
        {
            if (!HookedList.Contains("orig_OnApplicationQuit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnApplicationQuit", true),
        ...
        internal static void Hookorig_ClearSaveFile()
        {
            if (!HookedList.Contains("orig_ClearSaveFile"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_ClearSaveFile", true),
                    orig_ClearSaveFile);
            }
        }
        ...
        private static void orig_ClearSaveFile(Action<GameManager, int, System.Action<bool>> orig, GameManager self,
            int saveSlot, System.Action<bool> callback)
        {
        ...
        private static System.Collections.IEnumerator orig_PlayerDead(
            Func<GameManager, float, System.Collections.IEnumerator> orig, GameManager self, float waitTime)
        {
        ...
        internal static void Hookorig_SetupSceneRefs()
        {
            if (!HookedList.Contains("orig_SetupSceneRefs"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_SetupSceneRefs", true),
                    orig_SetupSceneRefs);
            }
        }
        ...
        internal static void Hookorig_OnWillActivateFirstLevel()
        {
            if (!HookedList.Contains("orig_OnWillActivateFirstLevel"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnWillActivateFirstLevel", true),
        ...
        internal static void HookPauseToggleDynamicMenu()
        {
            if (!HookedList.Contains("PauseToggleDynamicMenu"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseToggleDynamicMenu", true),
        ...
        private static System.Collections.IEnumerator PauseToggleDynamicMenu(
            Func<GameManager, MenuScreen, bool, System.Collections.IEnumerator> orig, GameManager self,
            MenuScreen screen, bool allowUnpause)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_TimeSlowed_AfterArgs(Params_get_TimeSlowed args);
        ...
        public delegate InputHandler get_inputHandler_AfterArgs(Params_get_inputHandler args);
        ...
        public delegate AudioManager get_AudioManager_AfterArgs(Params_get_AudioManager args);
        ...
        public delegate CameraController get_cameraCtrl_AfterArgs(Params_get_cameraCtrl args);
        ...
        public delegate HeroController get_hero_ctrl_AfterArgs(Params_get_hero_ctrl args);
        ...
        public delegate UnityEngine.SpriteRenderer get_heroLight_AfterArgs(Params_get_heroLight args);

        public delegate UnityEngine.SpriteRenderer get_heroLight_WithArgs(
            Func<GameManager, UnityEngine.SpriteRenderer> orig, GameManager self);
        ...
        public delegate void set_heroLight_WithArgs(Action<GameManager, UnityEngine.SpriteRenderer> orig,
            GameManager self, UnityEngine.SpriteRenderer value);
        ...
        public delegate SceneManager get_sm_AfterArgs(Params_get_sm args);
        ...
        public delegate UIManager get_ui_AfterArgs(Params_get_ui args);
        ...
        public delegate tk2dTileMap get_tilemap_AfterArgs(Params_get_tilemap args);
        ...
        public delegate PlayMakerFSM get_soulOrb_fsm_AfterArgs(Params_get_soulOrb_fsm args);
        ...
        public delegate PlayMakerFSM get_soulVessel_fsm_AfterArgs(Params_get_soulVessel_fsm args);
        ...
        public delegate float get_PlayTime_AfterArgs(Params_get_PlayTime args);
        ...
        public delegate bool get_RespawningHero_AfterArgs(Params_get_RespawningHero args);
        ...
        public delegate bool get_IsInSceneTransition_AfterArgs(Params_get_IsInSceneTransition args);
        ...
        public delegate bool get_HasFinishedEnteringScene_AfterArgs(Params_get_HasFinishedEnteringScene args);
        ...
        public delegate WorldInfo get_WorldInfo_AfterArgs(Params_get_WorldInfo args);
        ...
        public delegate bool get_IsLoadingSceneTransition_AfterArgs(Params_get_IsLoadingSceneTransition args);
        ...
        public delegate float get_CurrentLoadDuration_AfterArgs(Params_get_CurrentLoadDuration args);
        ...
        public delegate GameManager get_instance_AfterArgs();
        ...
        public delegate GameManager get_UnsafeInstance_AfterArgs();
        ...
        public delegate void LevelActivated_WithArgs(
            Action<GameManager, UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.Scene> orig,
            GameManager self, UnityEngine.SceneManagement.Scene sceneFrom, UnityEngine.SceneManagement.Scene sceneTo);
        ...
        public delegate System.Collections.IEnumerator TransitionScene_AfterArgs(Params_TransitionScene args);

        public delegate System.Collections.IEnumerator TransitionScene_WithArgs(
            Func<GameManager, TransitionPoint, System.Collections.IEnumerator> orig, GameManager self,
        ...
        public delegate System.Collections.IEnumerator PlayerDead_AfterArgs(Params_PlayerDead args);

        public delegate System.Collections.IEnumerator PlayerDead_WithArgs(
            Func<GameManager, float, System.Collections.IEnumerator> orig, GameManager self, float waitTime);
        ...
        public delegate System.Collections.IEnumerator PlayerDeadFromHazard_AfterArgs(Params_PlayerDeadFromHazard args);

        public delegate System.Collections.IEnumerator PlayerDeadFromHazard_WithArgs(
            Func<GameManager, float, System.Collections.IEnumerator> orig, GameManager self, float waitTime);
        ...
        public delegate System.Collections.IEnumerator FadeSceneInWithDelay_AfterArgs(Params_FadeSceneInWithDelay args);

        public delegate System.Collections.IEnumerator FadeSceneInWithDelay_WithArgs(
            Func<GameManager, float, System.Collections.IEnumerator> orig, GameManager self, float delay);
        ...
        public delegate bool IsGamePaused_AfterArgs(Params_IsGamePaused args);
        ...
        public delegate void SetGameMap_WithArgs(Action<GameManager, UnityEngine.GameObject> orig, GameManager self,
            UnityEngine.GameObject go_gameMap);
        ...
        public delegate string GetLanguageAsString_AfterArgs(Params_GetLanguageAsString args);
        ...
        public delegate string GetEntryGateName_AfterArgs(Params_GetEntryGateName args);
        ...
        public delegate bool GetPlayerDataBool_AfterArgs(Params_GetPlayerDataBool args);
        ...
        public delegate int GetPlayerDataInt_AfterArgs(Params_GetPlayerDataInt args);
        ...
        public delegate float GetPlayerDataFloat_AfterArgs(Params_GetPlayerDataFloat args);
        ...
        public delegate string GetPlayerDataString_AfterArgs(Params_GetPlayerDataString args);
        ...
        public delegate void SetPlayerDataVector3_WithArgs(Action<GameManager, string, UnityEngine.Vector3> orig,
            GameManager self, string vectorName, UnityEngine.Vector3 value);
        ...
        public delegate UnityEngine.Vector3 GetPlayerDataVector3_AfterArgs(Params_GetPlayerDataVector3 args);

        public delegate UnityEngine.Vector3 GetPlayerDataVector3_WithArgs(
            Func<GameManager, string, UnityEngine.Vector3> orig, GameManager self, string vectorName);
        ...
        public delegate bool UpdateGameMap_AfterArgs(Params_UpdateGameMap args);
        ...
        public delegate bool GetIsSceneVisited_AfterArgs(Params_GetIsSceneVisited args);
        ...
        public delegate bool IsAchievementAwarded_AfterArgs(Params_IsAchievementAwarded args);
        ...
        public delegate int GetStatusRecordInt_AfterArgs(Params_GetStatusRecordInt args);
        ...
        public delegate void SetState_WithArgs(Action<GameManager, GlobalEnums.GameState> orig, GameManager self,
            GlobalEnums.GameState newState);
        ...
        public delegate System.Collections.IEnumerator LoadSceneAdditive_AfterArgs(Params_LoadSceneAdditive args);

        public delegate System.Collections.IEnumerator LoadSceneAdditive_WithArgs(
            Func<GameManager, string, System.Collections.IEnumerator> orig, GameManager self, string destScene);
        ...
        public delegate System.Collections.IEnumerator LoadFirstScene_AfterArgs(Params_LoadFirstScene args);

        public delegate System.Collections.IEnumerator LoadFirstScene_WithArgs(
            Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
        ...
        public delegate UnityEngine.Vector2? FindEntryPoint_AfterArgs(Params_FindEntryPoint args);

        public delegate UnityEngine.Vector2? FindEntryPoint_WithArgs(
            Func<GameManager, string, UnityEngine.SceneManagement.Scene, UnityEngine.Vector2?> orig, GameManager self,
            string entryPointName, UnityEngine.SceneManagement.Scene filterScene);
        ...
        public delegate TransitionPoint FindTransitionPoint_WithArgs(
            Func<GameManager, string, UnityEngine.SceneManagement.Scene, bool, TransitionPoint> orig, GameManager self,
            string entryPointName, UnityEngine.SceneManagement.Scene filterScene, bool fallbackToAnyAvailable);
        ...
        public delegate System.Collections.IEnumerator SkipCutsceneNoMash_AfterArgs(Params_SkipCutsceneNoMash args);

        public delegate System.Collections.IEnumerator SkipCutsceneNoMash_WithArgs(
            Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
        ...
        public delegate string GetCurrentMapZone_AfterArgs(Params_GetCurrentMapZone args);
        ...
        public delegate float GetSceneWidth_AfterArgs(Params_GetSceneWidth args);
        ...
        public delegate float GetSceneHeight_AfterArgs(Params_GetSceneHeight args);
        ...
        public delegate UnityEngine.GameObject GetSceneManager_AfterArgs(Params_GetSceneManager args);

        public delegate UnityEngine.GameObject GetSceneManager_WithArgs(Func<GameManager, UnityEngine.GameObject> orig,
            GameManager self);
        ...
        public delegate string GetFormattedMapZoneString_AfterArgs(Params_GetFormattedMapZoneString args);

        public delegate string GetFormattedMapZoneString_WithArgs(Func<GameManager, GlobalEnums.MapZone, string> orig,
            GameManager self, GlobalEnums.MapZone mapZone);
        ...
        public delegate string GetBaseSceneName_AfterArgs(Params_GetBaseSceneName args);
        ...
        public delegate string GetSceneNameString_AfterArgs(Params_GetSceneNameString args);
        ...
        public delegate tk2dTileMap GetTileMap_AfterArgs(Params_GetTileMap args);

        public delegate tk2dTileMap GetTileMap_WithArgs(Func<UnityEngine.GameObject, tk2dTileMap> orig,
        ...
        public delegate bool IsMenuScene_AfterArgs(Params_IsMenuScene args);
        ...
        public delegate bool IsTitleScreenScene_AfterArgs(Params_IsTitleScreenScene args);
        ...
        public delegate bool IsGameplayScene_AfterArgs(Params_IsGameplayScene args);
        ...
        public delegate bool IsNonGameplayScene_AfterArgs(Params_IsNonGameplayScene args);
        ...
        public delegate bool IsCinematicScene_AfterArgs(Params_IsCinematicScene args);
        ...
        public delegate bool IsStagTravelScene_AfterArgs(Params_IsStagTravelScene args);
        ...
        public delegate bool IsBetaEndScene_AfterArgs(Params_IsBetaEndScene args);
        ...
        public delegate bool IsTutorialScene_AfterArgs(Params_IsTutorialScene args);
        ...
        public delegate bool IsTestScene_AfterArgs(Params_IsTestScene args);
        ...
        public delegate bool IsBossDoorScene_AfterArgs(Params_IsBossDoorScene args);
        ...
        public delegate bool ShouldKeepHUDCameraActive_AfterArgs(Params_ShouldKeepHUDCameraActive args);
        ...
        public delegate string GetSceneZoneName_AfterArgs(Params_GetSceneZoneName args);
        ...
        public delegate int CountBits_AfterArgs(Params_CountBits args);
        ...
        public delegate bool IsUnloadAssetsRequired_AfterArgs(Params_IsUnloadAssetsRequired args);
        ...
        public delegate void HasSaveFile_WithArgs(Action<GameManager, int, System.Action<bool>> orig, GameManager self,
            int saveSlot, System.Action<bool> callback);
        ...
        public delegate void SaveGame_Action_WithArgs(Action<GameManager, System.Action<bool>> orig, GameManager self,
            System.Action<bool> callback);
        ...
        public delegate void SaveGame_int_Action_WithArgs(Action<GameManager, int, System.Action<bool>> orig,
            GameManager self, int saveSlot, System.Action<bool> callback);
        ...
        public delegate System.Collections.IEnumerator LoadGameFromUIRoutine_AfterArgs(
            Params_LoadGameFromUIRoutine args);

        public delegate System.Collections.IEnumerator LoadGameFromUIRoutine_WithArgs(
            Func<GameManager, int, System.Collections.IEnumerator> orig, GameManager self, int saveSlot);
        ...
        public delegate void LoadGame_WithArgs(Action<GameManager, int, System.Action<bool>> orig, GameManager self,
            int saveSlot, System.Action<bool> callback);
        ...
        public delegate void ClearSaveFile_WithArgs(Action<GameManager, int, System.Action<bool>> orig,
            GameManager self, int saveSlot, System.Action<bool> callback);
        ...
        public delegate void GetSaveStatsForSlot_WithArgs(Action<GameManager, int, System.Action<SaveStats>> orig,
            GameManager self, int saveSlot, System.Action<SaveStats> callback);
        ...
        public delegate System.Collections.IEnumerator PauseGameToggleByMenu_AfterArgs(
            Params_PauseGameToggleByMenu args);

        public delegate System.Collections.IEnumerator PauseGameToggleByMenu_WithArgs(
            Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
        ...
        public delegate System.Collections.IEnumerator PauseGameToggle_AfterArgs(Params_PauseGameToggle args);

        public delegate System.Collections.IEnumerator PauseGameToggle_WithArgs(
            Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
        ...
        public delegate System.Collections.IEnumerator SetTimeScale_float_float_AfterArgs(
            Params_SetTimeScale_float_float args);

        public delegate System.Collections.IEnumerator SetTimeScale_float_float_WithArgs(
            Func<GameManager, float, float, System.Collections.IEnumerator> orig, GameManager self, float newTimeScale,
            float duration);
        ...
        public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_float_AfterArgs(
            Params_FreezeMoment_float_float_float_float args);

        public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_float_WithArgs(
            Func<GameManager, float, float, float, float, System.Collections.IEnumerator> orig, GameManager self,
        ...
        public delegate System.Collections.IEnumerator FreezeMomentGC_AfterArgs(Params_FreezeMomentGC args);

        public delegate System.Collections.IEnumerator FreezeMomentGC_WithArgs(
            Func<GameManager, float, float, float, float, System.Collections.IEnumerator> orig, GameManager self,
            float rampDownTime, float waitTime, float rampUpTime, float targetSpeed);
        ...
        public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_bool_AfterArgs(
            Params_FreezeMoment_float_float_float_bool args);

        public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_bool_WithArgs(
            Func<GameManager, float, float, float, bool, System.Collections.IEnumerator> orig, GameManager self,
            float rampDownTime, float waitTime, float rampUpTime, bool runGc);
        ...
        public delegate void EnsureSaveSlotSpace_WithArgs(Action<GameManager, System.Action<bool>> orig,
            GameManager self, System.Action<bool> callback);
        ...
        public delegate System.Collections.IEnumerator RunStartNewGame_AfterArgs(Params_RunStartNewGame args);

        public delegate System.Collections.IEnumerator RunStartNewGame_WithArgs(
            Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
        ...
        public delegate System.Collections.IEnumerator RunContinueGame_AfterArgs(Params_RunContinueGame args);

        public delegate System.Collections.IEnumerator RunContinueGame_WithArgs(
            Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
        ...
        public delegate void OnDisengage_WithArgs(Action<GameManager, System.Action> orig, GameManager self,
            System.Action next);
        ...
        public delegate void EmergencyReturnToMenu_WithArgs(Action<GameManager, System.Action> orig, GameManager self,
            System.Action callback);
        ...
        public delegate System.Collections.IEnumerator QuitGame_AfterArgs(Params_QuitGame args);

        public delegate System.Collections.IEnumerator QuitGame_WithArgs(
            Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
        ...
        public delegate float GetImplicitCinematicVolume_AfterArgs(Params_GetImplicitCinematicVolume args);
        ...
        public delegate UIManager orig_get_ui_AfterArgs(Params_orig_get_ui args);
        ...
        public delegate void orig_ClearSaveFile_WithArgs(Action<GameManager, int, System.Action<bool>> orig,
            GameManager self, int saveSlot, System.Action<bool> callback);
        ...
        public delegate System.Collections.IEnumerator orig_PlayerDead_AfterArgs(Params_orig_PlayerDead args);

        public delegate System.Collections.IEnumerator orig_PlayerDead_WithArgs(
            Func<GameManager, float, System.Collections.IEnumerator> orig, GameManager self, float waitTime);
        ...
        public delegate string ModdedSavePath_AfterArgs(Params_ModdedSavePath args);
        ...
        public delegate System.Collections.IEnumerator PauseToggleDynamicMenu_AfterArgs(
            Params_PauseToggleDynamicMenu args);

        public delegate System.Collections.IEnumerator PauseToggleDynamicMenu_WithArgs(
            Func<GameManager, MenuScreen, bool, System.Collections.IEnumerator> orig, GameManager self,
            MenuScreen screen, bool allowUnpause);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_TimeSlowed_WithArgs get_TimeSlowed
        {
            add => HookEndpointManager.Add<Delegates.get_TimeSlowed_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_TimeSlowed", true), value);
        ...
        public static event Delegates.get_inputHandler_WithArgs get_inputHandler
        {
            add => HookEndpointManager.Add<Delegates.get_inputHandler_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_inputHandler", true), value);
        ...
        public static event Delegates.set_inputHandler_WithArgs set_inputHandler
        {
            add => HookEndpointManager.Add<Delegates.set_inputHandler_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_inputHandler", true), value);
        ...
        public static event Delegates.get_achievementHandler_WithArgs get_achievementHandler
        {
            add => HookEndpointManager.Add<Delegates.get_achievementHandler_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_achievementHandler", true), value);
        ...
        public static event Delegates.set_achievementHandler_WithArgs set_achievementHandler
        {
            add => HookEndpointManager.Add<Delegates.set_achievementHandler_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_achievementHandler", true), value);
        ...
        public static event Delegates.get_AudioManager_WithArgs get_AudioManager
        {
            add => HookEndpointManager.Add<Delegates.get_AudioManager_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_AudioManager", true), value);
        ...
        public static event Delegates.get_cameraCtrl_WithArgs get_cameraCtrl
        {
            add => HookEndpointManager.Add<Delegates.get_cameraCtrl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_cameraCtrl", true), value);
        ...
        public static event Delegates.set_cameraCtrl_WithArgs set_cameraCtrl
        {
            add => HookEndpointManager.Add<Delegates.set_cameraCtrl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_cameraCtrl", true), value);
        ...
        public static event Delegates.get_hero_ctrl_WithArgs get_hero_ctrl
        {
            add => HookEndpointManager.Add<Delegates.get_hero_ctrl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_hero_ctrl", true), value);
        ...
        public static event Delegates.set_hero_ctrl_WithArgs set_hero_ctrl
        {
            add => HookEndpointManager.Add<Delegates.set_hero_ctrl_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_hero_ctrl", true), value);
        ...
        public static event Delegates.get_heroLight_WithArgs get_heroLight
        {
            add => HookEndpointManager.Add<Delegates.get_heroLight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_heroLight", true), value);
        ...
        public static event Delegates.set_heroLight_WithArgs set_heroLight
        {
            add => HookEndpointManager.Add<Delegates.set_heroLight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_heroLight", true), value);
        ...
        public static event Delegates.get_sm_WithArgs get_sm
        {
            add => HookEndpointManager.Add<Delegates.get_sm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_sm", true), value);
        ...
        public static event Delegates.set_sm_WithArgs set_sm
        {
            add => HookEndpointManager.Add<Delegates.set_sm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_sm", true), value);
        ...
        public static event Delegates.get_ui_WithArgs get_ui
        {
            add => HookEndpointManager.Add<Delegates.get_ui_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_ui", true), value);
        ...
        public static event Delegates.set_ui_WithArgs set_ui
        {
            add => HookEndpointManager.Add<Delegates.set_ui_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_ui", true), value);
        ...
        public static event Delegates.get_tilemap_WithArgs get_tilemap
        {
            add => HookEndpointManager.Add<Delegates.get_tilemap_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_tilemap", true), value);
        ...
        public static event Delegates.set_tilemap_WithArgs set_tilemap
        {
            add => HookEndpointManager.Add<Delegates.set_tilemap_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_tilemap", true), value);
        ...
        public static event Delegates.get_soulOrb_fsm_WithArgs get_soulOrb_fsm
        {
            add => HookEndpointManager.Add<Delegates.get_soulOrb_fsm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulOrb_fsm", true), value);
        ...
        public static event Delegates.set_soulOrb_fsm_WithArgs set_soulOrb_fsm
        {
            add => HookEndpointManager.Add<Delegates.set_soulOrb_fsm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulOrb_fsm", true), value);
        ...
        public static event Delegates.get_soulVessel_fsm_WithArgs get_soulVessel_fsm
        {
            add => HookEndpointManager.Add<Delegates.get_soulVessel_fsm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulVessel_fsm", true), value);
        ...
        public static event Delegates.set_soulVessel_fsm_WithArgs set_soulVessel_fsm
        {
            add => HookEndpointManager.Add<Delegates.set_soulVessel_fsm_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulVessel_fsm", true), value);
        ...
        public static event Delegates.get_PlayTime_WithArgs get_PlayTime
        {
            add => HookEndpointManager.Add<Delegates.get_PlayTime_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_PlayTime", true), value);
        ...
        public static event Delegates.get_RespawningHero_WithArgs get_RespawningHero
        {
            add => HookEndpointManager.Add<Delegates.get_RespawningHero_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_RespawningHero", true), value);
        ...
        public static event Delegates.set_RespawningHero_WithArgs set_RespawningHero
        {
            add => HookEndpointManager.Add<Delegates.set_RespawningHero_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_RespawningHero", true), value);
        ...
        public static event Delegates.get_IsInSceneTransition_WithArgs get_IsInSceneTransition
        {
            add => HookEndpointManager.Add<Delegates.get_IsInSceneTransition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsInSceneTransition", true), value);
        ...
        public static event Delegates.set_IsInSceneTransition_WithArgs set_IsInSceneTransition
        {
            add => HookEndpointManager.Add<Delegates.set_IsInSceneTransition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_IsInSceneTransition", true), value);
        ...
        public static event Delegates.get_HasFinishedEnteringScene_WithArgs get_HasFinishedEnteringScene
        {
            add => HookEndpointManager.Add<Delegates.get_HasFinishedEnteringScene_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_HasFinishedEnteringScene", true), value);
        ...
        public static event Delegates.get_WorldInfo_WithArgs get_WorldInfo
        {
            add => HookEndpointManager.Add<Delegates.get_WorldInfo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_WorldInfo", true), value);
        ...
        public static event Delegates.get_IsLoadingSceneTransition_WithArgs get_IsLoadingSceneTransition
        {
            add => HookEndpointManager.Add<Delegates.get_IsLoadingSceneTransition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsLoadingSceneTransition", true), value);
        ...
        public static event Delegates.get_CurrentLoadDuration_WithArgs get_CurrentLoadDuration
        {
            add => HookEndpointManager.Add<Delegates.get_CurrentLoadDuration_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_CurrentLoadDuration", true), value);
        ...
        public static event Delegates.get_IsUsingCustomLoadAnimation_WithArgs get_IsUsingCustomLoadAnimation
        {
            add => HookEndpointManager.Add<Delegates.get_IsUsingCustomLoadAnimation_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsUsingCustomLoadAnimation", true), value);
        ...
        public static event Delegates.SaveGame_Action_WithArgs SaveGame_Action
        {
            add => HookEndpointManager.Add<Delegates.SaveGame_Action_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame", true), value);
        ...
        public static event Delegates.OnDisengage_WithArgs OnDisengage
        {
            add => HookEndpointManager.Add<Delegates.OnDisengage_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "Platform.IDisengageHandler.OnDisengage", true),
                value);
        ...
        public static event Delegates.orig_get_ui_WithArgs orig_get_ui
        {
            add => HookEndpointManager.Add<Delegates.orig_get_ui_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_get_ui", true), value);
        ...
        public static event Delegates.orig_set_ui_WithArgs orig_set_ui
        {
            add => HookEndpointManager.Add<Delegates.orig_set_ui_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_set_ui", true), value);
        ...
        public static event Delegates.orig_OnApplicationQuit_WithArgs orig_OnApplicationQuit
        {
            add => HookEndpointManager.Add<Delegates.orig_OnApplicationQuit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnApplicationQuit", true), value);
        ...
        public static event Delegates.orig_LoadScene_WithArgs orig_LoadScene
        {
            add => HookEndpointManager.Add<Delegates.orig_LoadScene_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_LoadScene", true), value);
        ...
        public static event Delegates.orig_ClearSaveFile_WithArgs orig_ClearSaveFile
        {
            add => HookEndpointManager.Add<Delegates.orig_ClearSaveFile_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_ClearSaveFile", true), value);
        ...
        public static event Delegates.orig_PlayerDead_WithArgs orig_PlayerDead
        {
            add => HookEndpointManager.Add<Delegates.orig_PlayerDead_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_PlayerDead", true), value);
        ...
        public static event Delegates.orig_SetupSceneRefs_WithArgs orig_SetupSceneRefs
        {
            add => HookEndpointManager.Add<Delegates.orig_SetupSceneRefs_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_SetupSceneRefs", true), value);
        ...
        public static event Delegates.orig_OnWillActivateFirstLevel_WithArgs orig_OnWillActivateFirstLevel
        {
            add => HookEndpointManager.Add<Delegates.orig_OnWillActivateFirstLevel_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnWillActivateFirstLevel", true), value);
        ...
        public static event Delegates.PauseToggleDynamicMenu_WithArgs PauseToggleDynamicMenu
        {
            add => HookEndpointManager.Add<Delegates.PauseToggleDynamicMenu_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseToggleDynamicMenu", true), value);
