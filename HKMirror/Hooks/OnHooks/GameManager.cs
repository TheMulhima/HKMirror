...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_TimeSlowed", true), get_TimeSlowed);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_inputHandler", true), get_inputHandler);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_inputHandler", true), set_inputHandler);
...
private static void set_inputHandler(Action<GameManager,  InputHandler> orig, GameManager self,  InputHandler value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_achievementHandler", true), get_achievementHandler);
...
private static AchievementHandler get_achievementHandler(Func<GameManager, AchievementHandler> orig, GameManager self)
{
...
{
foreach (Delegates.get_achievementHandler_BeforeArgs toInvoke in _beforeget_achievementHandler.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_achievementHandler_AfterArgs toInvoke in _afterget_achievementHandler.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_achievementHandler", true), set_achievementHandler);
...
private static void set_achievementHandler(Action<GameManager,  AchievementHandler> orig, GameManager self,  AchievementHandler value)
{
...
{
foreach (Delegates.set_achievementHandler_BeforeArgs toInvoke in _beforeset_achievementHandler.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_achievementHandler_AfterArgs toInvoke in _afterset_achievementHandler.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_AudioManager", true), get_AudioManager);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_cameraCtrl", true), get_cameraCtrl);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_cameraCtrl", true), set_cameraCtrl);
...
private static void set_cameraCtrl(Action<GameManager,  CameraController> orig, GameManager self,  CameraController value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_hero_ctrl", true), get_hero_ctrl);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_hero_ctrl", true), set_hero_ctrl);
...
private static void set_hero_ctrl(Action<GameManager,  HeroController> orig, GameManager self,  HeroController value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_heroLight", true), get_heroLight);
...
private static UnityEngine.SpriteRenderer get_heroLight(Func<GameManager, UnityEngine.SpriteRenderer> orig, GameManager self)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_heroLight", true), set_heroLight);
...
private static void set_heroLight(Action<GameManager,  UnityEngine.SpriteRenderer> orig, GameManager self,  UnityEngine.SpriteRenderer value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_sm", true), get_sm);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_sm", true), set_sm);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_ui", true), get_ui);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_ui", true), set_ui);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_tilemap", true), get_tilemap);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_tilemap", true), set_tilemap);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulOrb_fsm", true), get_soulOrb_fsm);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulOrb_fsm", true), set_soulOrb_fsm);
...
private static void set_soulOrb_fsm(Action<GameManager,  PlayMakerFSM> orig, GameManager self,  PlayMakerFSM value)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulVessel_fsm", true), get_soulVessel_fsm);
...
{
foreach (Delegates.get_soulVessel_fsm_BeforeArgs toInvoke in _beforeget_soulVessel_fsm.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_soulVessel_fsm_AfterArgs toInvoke in _afterget_soulVessel_fsm.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulVessel_fsm", true), set_soulVessel_fsm);
...
private static void set_soulVessel_fsm(Action<GameManager,  PlayMakerFSM> orig, GameManager self,  PlayMakerFSM value)
{
...
{
foreach (Delegates.set_soulVessel_fsm_BeforeArgs toInvoke in _beforeset_soulVessel_fsm.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_soulVessel_fsm_AfterArgs toInvoke in _afterset_soulVessel_fsm.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_PlayTime", true), get_PlayTime);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_RespawningHero", true), get_RespawningHero);
...
{
foreach (Delegates.get_RespawningHero_BeforeArgs toInvoke in _beforeget_RespawningHero.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_RespawningHero_AfterArgs toInvoke in _afterget_RespawningHero.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_RespawningHero", true), set_RespawningHero);
...
{
foreach (Delegates.set_RespawningHero_BeforeArgs toInvoke in _beforeset_RespawningHero.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_RespawningHero_AfterArgs toInvoke in _afterset_RespawningHero.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsInSceneTransition", true), get_IsInSceneTransition);
...
{
foreach (Delegates.get_IsInSceneTransition_BeforeArgs toInvoke in _beforeget_IsInSceneTransition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsInSceneTransition_AfterArgs toInvoke in _afterget_IsInSceneTransition.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_IsInSceneTransition", true), set_IsInSceneTransition);
...
{
foreach (Delegates.set_IsInSceneTransition_BeforeArgs toInvoke in _beforeset_IsInSceneTransition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_IsInSceneTransition_AfterArgs toInvoke in _afterset_IsInSceneTransition.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_HasFinishedEnteringScene", true), get_HasFinishedEnteringScene);
...
{
foreach (Delegates.get_HasFinishedEnteringScene_BeforeArgs toInvoke in _beforeget_HasFinishedEnteringScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_HasFinishedEnteringScene_AfterArgs toInvoke in _afterget_HasFinishedEnteringScene.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_WorldInfo", true), get_WorldInfo);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsLoadingSceneTransition", true), get_IsLoadingSceneTransition);
...
{
foreach (Delegates.get_IsLoadingSceneTransition_BeforeArgs toInvoke in _beforeget_IsLoadingSceneTransition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsLoadingSceneTransition_AfterArgs toInvoke in _afterget_IsLoadingSceneTransition.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_CurrentLoadDuration", true), get_CurrentLoadDuration);
...
{
foreach (Delegates.get_CurrentLoadDuration_BeforeArgs toInvoke in _beforeget_CurrentLoadDuration.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_CurrentLoadDuration_AfterArgs toInvoke in _afterget_CurrentLoadDuration.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsUsingCustomLoadAnimation", true), get_IsUsingCustomLoadAnimation);
...
{
foreach (Delegates.get_IsUsingCustomLoadAnimation_BeforeArgs toInvoke in _beforeget_IsUsingCustomLoadAnimation.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsUsingCustomLoadAnimation_AfterArgs toInvoke in _afterget_IsUsingCustomLoadAnimation.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_UnsafeInstance", false), get_UnsafeInstance);
...
private static void LevelActivated(On.GameManager.orig_LevelActivated orig,GameManager self,  UnityEngine.SceneManagement.Scene sceneFrom,  UnityEngine.SceneManagement.Scene sceneTo)
{
...
{
foreach (Delegates.OnApplicationQuit_BeforeArgs toInvoke in _beforeOnApplicationQuit.GetInvocationList())
{
try
{
...
internal static void HookBeginSceneTransition()
{
if (!HookedList.Contains("BeginSceneTransition"))
{
HookedList.Add("BeginSceneTransition");
On.GameManager.BeginSceneTransition += BeginSceneTransition;

}
}
internal static event Delegates.BeginSceneTransition_BeforeArgs _beforeBeginSceneTransition;
internal static event Delegates.BeginSceneTransition_AfterArgs _afterBeginSceneTransition;
private static void BeginSceneTransition(On.GameManager.orig_BeginSceneTransition orig,GameManager self,  GameManager.SceneLoadInfo info)
{
Delegates.Params_BeginSceneTransition @params = new() 
{
self = self
, info = info
};
if (_beforeBeginSceneTransition != null)
{
foreach (Delegates.BeginSceneTransition_BeforeArgs toInvoke in _beforeBeginSceneTransition.GetInvocationList())
{
try
{
_beforeBeginSceneTransition?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
info = @params.info;
orig(self, info);
if (_afterBeginSceneTransition != null)
{
foreach (Delegates.BeginSceneTransition_AfterArgs toInvoke in _afterBeginSceneTransition.GetInvocationList())
{
try
{
_afterBeginSceneTransition.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
internal static void HookBeginSceneTransitionRoutine()
{
if (!HookedList.Contains("BeginSceneTransitionRoutine"))
{
HookedList.Add("BeginSceneTransitionRoutine");
On.GameManager.BeginSceneTransitionRoutine += BeginSceneTransitionRoutine;

}
}
internal static event Delegates.BeginSceneTransitionRoutine_BeforeArgs _beforeBeginSceneTransitionRoutine;
private static System.Collections.IEnumerator BeginSceneTransitionRoutine(On.GameManager.orig_BeginSceneTransitionRoutine orig,GameManager self,  GameManager.SceneLoadInfo info)
{
Delegates.Params_BeginSceneTransitionRoutine @params = new() 
{
self = self
, info = info
};
if (_beforeBeginSceneTransitionRoutine != null)
{
foreach (Delegates.BeginSceneTransitionRoutine_BeforeArgs toInvoke in _beforeBeginSceneTransitionRoutine.GetInvocationList())
{
try
{
_beforeBeginSceneTransitionRoutine?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
private static System.Collections.IEnumerator TransitionScene(On.GameManager.orig_TransitionScene orig,GameManager self,  TransitionPoint gate)
{
...
private static void ChangeToScene(On.GameManager.orig_ChangeToScene orig,GameManager self,  string targetScene,  string entryGateName,  float pauseBeforeEnter)
{
...
private static System.Collections.IEnumerator PlayerDead(On.GameManager.orig_PlayerDead orig,GameManager self,  float waitTime)
{
...
private static System.Collections.IEnumerator PlayerDeadFromHazard(On.GameManager.orig_PlayerDeadFromHazard orig,GameManager self,  float waitTime)
{
...
{
foreach (Delegates.PlayerDeadFromHazard_BeforeArgs toInvoke in _beforePlayerDeadFromHazard.GetInvocationList())
{
try
{
...
private static void ReadyForRespawn(On.GameManager.orig_ReadyForRespawn orig,GameManager self,  bool isFirstLevelForPlayer)
{
...
private static System.Collections.IEnumerator FadeSceneInWithDelay(On.GameManager.orig_FadeSceneInWithDelay orig,GameManager self,  float delay)
{
...
{
foreach (Delegates.FadeSceneInWithDelay_BeforeArgs toInvoke in _beforeFadeSceneInWithDelay.GetInvocationList())
{
try
{
...
private static void SetGameMap(On.GameManager.orig_SetGameMap orig,GameManager self,  UnityEngine.GameObject go_gameMap)
{
Delegates.Params_SetGameMap @params = new() 
{
self = self
, go_gameMap = go_gameMap
};
...
{
foreach (Delegates.CalculateNotchesUsed_BeforeArgs toInvoke in _beforeCalculateNotchesUsed.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CalculateNotchesUsed_AfterArgs toInvoke in _afterCalculateNotchesUsed.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetLanguageAsString_BeforeArgs toInvoke in _beforeGetLanguageAsString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetLanguageAsString_AfterArgs toInvoke in _afterGetLanguageAsString.GetInvocationList())
{
try
{
...
private static void SetPlayerDataBool(On.GameManager.orig_SetPlayerDataBool orig,GameManager self,  string boolName,  bool value)
{
...
{
foreach (Delegates.SetPlayerDataBool_BeforeArgs toInvoke in _beforeSetPlayerDataBool.GetInvocationList())
{
try
{
...
private static void SetPlayerDataInt(On.GameManager.orig_SetPlayerDataInt orig,GameManager self,  string intName,  int value)
{
...
private static void SetPlayerDataFloat(On.GameManager.orig_SetPlayerDataFloat orig,GameManager self,  string floatName,  float value)
{
...
{
foreach (Delegates.SetPlayerDataFloat_BeforeArgs toInvoke in _beforeSetPlayerDataFloat.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPlayerDataFloat_AfterArgs toInvoke in _afterSetPlayerDataFloat.GetInvocationList())
{
try
{
...
private static void SetPlayerDataString(On.GameManager.orig_SetPlayerDataString orig,GameManager self,  string stringName,  string value)
{
...
{
foreach (Delegates.SetPlayerDataString_BeforeArgs toInvoke in _beforeSetPlayerDataString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPlayerDataString_AfterArgs toInvoke in _afterSetPlayerDataString.GetInvocationList())
{
try
{
...
private static void IncrementPlayerDataInt(On.GameManager.orig_IncrementPlayerDataInt orig,GameManager self,  string intName)
{
...
{
foreach (Delegates.IncrementPlayerDataInt_BeforeArgs toInvoke in _beforeIncrementPlayerDataInt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IncrementPlayerDataInt_AfterArgs toInvoke in _afterIncrementPlayerDataInt.GetInvocationList())
{
try
{
...
private static void DecrementPlayerDataInt(On.GameManager.orig_DecrementPlayerDataInt orig,GameManager self,  string intName)
{
...
{
foreach (Delegates.DecrementPlayerDataInt_BeforeArgs toInvoke in _beforeDecrementPlayerDataInt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DecrementPlayerDataInt_AfterArgs toInvoke in _afterDecrementPlayerDataInt.GetInvocationList())
{
try
{
...
private static bool GetPlayerDataBool(On.GameManager.orig_GetPlayerDataBool orig,GameManager self,  string boolName)
{
...
{
foreach (Delegates.GetPlayerDataBool_BeforeArgs toInvoke in _beforeGetPlayerDataBool.GetInvocationList())
{
try
{
...
private static float GetPlayerDataFloat(On.GameManager.orig_GetPlayerDataFloat orig,GameManager self,  string floatName)
{
...
{
foreach (Delegates.GetPlayerDataFloat_BeforeArgs toInvoke in _beforeGetPlayerDataFloat.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetPlayerDataFloat_AfterArgs toInvoke in _afterGetPlayerDataFloat.GetInvocationList())
{
try
{
...
private static string GetPlayerDataString(On.GameManager.orig_GetPlayerDataString orig,GameManager self,  string stringName)
{
...
{
foreach (Delegates.GetPlayerDataString_BeforeArgs toInvoke in _beforeGetPlayerDataString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetPlayerDataString_AfterArgs toInvoke in _afterGetPlayerDataString.GetInvocationList())
{
try
{
...
private static void SetPlayerDataVector3(On.GameManager.orig_SetPlayerDataVector3 orig,GameManager self,  string vectorName,  UnityEngine.Vector3 value)
{
...
{
foreach (Delegates.SetPlayerDataVector3_BeforeArgs toInvoke in _beforeSetPlayerDataVector3.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetPlayerDataVector3_AfterArgs toInvoke in _afterSetPlayerDataVector3.GetInvocationList())
{
try
{
...
private static UnityEngine.Vector3 GetPlayerDataVector3(On.GameManager.orig_GetPlayerDataVector3 orig,GameManager self,  string vectorName)
{
...
{
foreach (Delegates.GetPlayerDataVector3_BeforeArgs toInvoke in _beforeGetPlayerDataVector3.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetPlayerDataVector3_AfterArgs toInvoke in _afterGetPlayerDataVector3.GetInvocationList())
{
try
{
...
private static void SetCurrentMapZoneAsRespawn(On.GameManager.orig_SetCurrentMapZoneAsRespawn orig,GameManager self)
{
...
{
foreach (Delegates.SetCurrentMapZoneAsRespawn_BeforeArgs toInvoke in _beforeSetCurrentMapZoneAsRespawn.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetCurrentMapZoneAsRespawn_AfterArgs toInvoke in _afterSetCurrentMapZoneAsRespawn.GetInvocationList())
{
try
{
...
private static void SetMapZoneToSpecific(On.GameManager.orig_SetMapZoneToSpecific orig,GameManager self,  string mapZone)
{
...
{
foreach (Delegates.SetMapZoneToSpecific_BeforeArgs toInvoke in _beforeSetMapZoneToSpecific.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetMapZoneToSpecific_AfterArgs toInvoke in _afterSetMapZoneToSpecific.GetInvocationList())
{
try
{
...
private static void AddToScenesVisited(On.GameManager.orig_AddToScenesVisited orig,GameManager self,  string scene)
{
...
{
foreach (Delegates.AddToScenesVisited_BeforeArgs toInvoke in _beforeAddToScenesVisited.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddToScenesVisited_AfterArgs toInvoke in _afterAddToScenesVisited.GetInvocationList())
{
try
{
...
private static bool GetIsSceneVisited(On.GameManager.orig_GetIsSceneVisited orig,GameManager self,  string scene)
{
...
{
foreach (Delegates.GetIsSceneVisited_BeforeArgs toInvoke in _beforeGetIsSceneVisited.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddToDreamPlantList_BeforeArgs toInvoke in _beforeAddToDreamPlantList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddToDreamPlantList_AfterArgs toInvoke in _afterAddToDreamPlantList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddToDreamPlantCList_BeforeArgs toInvoke in _beforeAddToDreamPlantCList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AddToDreamPlantCList_AfterArgs toInvoke in _afterAddToDreamPlantCList.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CountGameCompletion_BeforeArgs toInvoke in _beforeCountGameCompletion.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CountGameCompletion_AfterArgs toInvoke in _afterCountGameCompletion.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CountJournalEntries_BeforeArgs toInvoke in _beforeCountJournalEntries.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CountJournalEntries_AfterArgs toInvoke in _afterCountJournalEntries.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ActivateTestingCheats_BeforeArgs toInvoke in _beforeActivateTestingCheats.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ActivateTestingCheats_AfterArgs toInvoke in _afterActivateTestingCheats.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_death_BeforeArgs toInvoke in _beforeStoryRecord_death.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_rescueGrub_BeforeArgs toInvoke in _beforeStoryRecord_rescueGrub.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_rescueGrub_AfterArgs toInvoke in _afterStoryRecord_rescueGrub.GetInvocationList())
{
try
{
...
private static void StoryRecord_defeatedShade(On.GameManager.orig_StoryRecord_defeatedShade orig,GameManager self)
{
...
{
foreach (Delegates.StoryRecord_defeatedShade_BeforeArgs toInvoke in _beforeStoryRecord_defeatedShade.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_defeatedShade_AfterArgs toInvoke in _afterStoryRecord_defeatedShade.GetInvocationList())
{
try
{
...
private static void StoryRecord_discoveredArea(On.GameManager.orig_StoryRecord_discoveredArea orig,GameManager self,  string areaName)
{
...
{
foreach (Delegates.StoryRecord_discoveredArea_BeforeArgs toInvoke in _beforeStoryRecord_discoveredArea.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_discoveredArea_AfterArgs toInvoke in _afterStoryRecord_discoveredArea.GetInvocationList())
{
try
{
...
private static void StoryRecord_travelledToArea(On.GameManager.orig_StoryRecord_travelledToArea orig,GameManager self,  string areaName)
{
...
{
foreach (Delegates.StoryRecord_travelledToArea_BeforeArgs toInvoke in _beforeStoryRecord_travelledToArea.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_travelledToArea_AfterArgs toInvoke in _afterStoryRecord_travelledToArea.GetInvocationList())
{
try
{
...
private static void StoryRecord_bankDeposit(On.GameManager.orig_StoryRecord_bankDeposit orig,GameManager self,  int amount)
{
...
{
foreach (Delegates.StoryRecord_bankDeposit_BeforeArgs toInvoke in _beforeStoryRecord_bankDeposit.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_bankDeposit_AfterArgs toInvoke in _afterStoryRecord_bankDeposit.GetInvocationList())
{
try
{
...
private static void StoryRecord_bankWithdraw(On.GameManager.orig_StoryRecord_bankWithdraw orig,GameManager self,  int amount)
{
...
{
foreach (Delegates.StoryRecord_bankWithdraw_BeforeArgs toInvoke in _beforeStoryRecord_bankWithdraw.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_bankWithdraw_AfterArgs toInvoke in _afterStoryRecord_bankWithdraw.GetInvocationList())
{
try
{
...
private static void StoryRecord_boughtCorniferMap(On.GameManager.orig_StoryRecord_boughtCorniferMap orig,GameManager self,  string map)
{
...
{
foreach (Delegates.StoryRecord_boughtCorniferMap_BeforeArgs toInvoke in _beforeStoryRecord_boughtCorniferMap.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_boughtCorniferMap_AfterArgs toInvoke in _afterStoryRecord_boughtCorniferMap.GetInvocationList())
{
try
{
...
private static void StoryRecord_visited(On.GameManager.orig_StoryRecord_visited orig,GameManager self,  string visited)
{
...
{
foreach (Delegates.StoryRecord_visited_BeforeArgs toInvoke in _beforeStoryRecord_visited.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_visited_AfterArgs toInvoke in _afterStoryRecord_visited.GetInvocationList())
{
try
{
...
private static void StoryRecord_defeated(On.GameManager.orig_StoryRecord_defeated orig,GameManager self,  string defeated)
{
...
{
foreach (Delegates.StoryRecord_defeated_BeforeArgs toInvoke in _beforeStoryRecord_defeated.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_defeated_AfterArgs toInvoke in _afterStoryRecord_defeated.GetInvocationList())
{
try
{
...
private static void StoryRecord_rodeStag(On.GameManager.orig_StoryRecord_rodeStag orig,GameManager self,  string dest)
{
...
{
foreach (Delegates.StoryRecord_rodeStag_BeforeArgs toInvoke in _beforeStoryRecord_rodeStag.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_rodeStag_AfterArgs toInvoke in _afterStoryRecord_rodeStag.GetInvocationList())
{
try
{
...
private static void StoryRecord_acquired(On.GameManager.orig_StoryRecord_acquired orig,GameManager self,  string item)
{
...
{
foreach (Delegates.StoryRecord_acquired_BeforeArgs toInvoke in _beforeStoryRecord_acquired.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_acquired_AfterArgs toInvoke in _afterStoryRecord_acquired.GetInvocationList())
{
try
{
...
private static void StoryRecord_bought(On.GameManager.orig_StoryRecord_bought orig,GameManager self,  string item)
{
...
{
foreach (Delegates.StoryRecord_bought_BeforeArgs toInvoke in _beforeStoryRecord_bought.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_bought_AfterArgs toInvoke in _afterStoryRecord_bought.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_upgradeNail_BeforeArgs toInvoke in _beforeStoryRecord_upgradeNail.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_upgradeNail_AfterArgs toInvoke in _afterStoryRecord_upgradeNail.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_heartPiece_BeforeArgs toInvoke in _beforeStoryRecord_heartPiece.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_heartPiece_AfterArgs toInvoke in _afterStoryRecord_heartPiece.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_maxHealthUp_BeforeArgs toInvoke in _beforeStoryRecord_maxHealthUp.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_maxHealthUp_AfterArgs toInvoke in _afterStoryRecord_maxHealthUp.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_soulPiece_BeforeArgs toInvoke in _beforeStoryRecord_soulPiece.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_soulPiece_AfterArgs toInvoke in _afterStoryRecord_soulPiece.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_maxSoulUp_BeforeArgs toInvoke in _beforeStoryRecord_maxSoulUp.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_maxSoulUp_AfterArgs toInvoke in _afterStoryRecord_maxSoulUp.GetInvocationList())
{
try
{
...
private static void StoryRecord_charmsChanged(On.GameManager.orig_StoryRecord_charmsChanged orig,GameManager self)
{
...
{
foreach (Delegates.StoryRecord_charmsChanged_BeforeArgs toInvoke in _beforeStoryRecord_charmsChanged.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_charmsChanged_AfterArgs toInvoke in _afterStoryRecord_charmsChanged.GetInvocationList())
{
try
{
...
private static void StoryRecord_charmEquipped(On.GameManager.orig_StoryRecord_charmEquipped orig,GameManager self,  string charmName)
{
...
{
foreach (Delegates.StoryRecord_charmEquipped_BeforeArgs toInvoke in _beforeStoryRecord_charmEquipped.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_charmEquipped_AfterArgs toInvoke in _afterStoryRecord_charmEquipped.GetInvocationList())
{
try
{
...
{
foreach (Delegates.StoryRecord_start_BeforeArgs toInvoke in _beforeStoryRecord_start.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AwardQueuedAchievements_BeforeArgs toInvoke in _beforeAwardQueuedAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AwardQueuedAchievements_AfterArgs toInvoke in _afterAwardQueuedAchievements.GetInvocationList())
{
try
{
...
private static bool IsAchievementAwarded(On.GameManager.orig_IsAchievementAwarded orig,GameManager self,  string key)
{
...
{
foreach (Delegates.IsAchievementAwarded_BeforeArgs toInvoke in _beforeIsAchievementAwarded.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsAchievementAwarded_AfterArgs toInvoke in _afterIsAchievementAwarded.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearAllAchievements_BeforeArgs toInvoke in _beforeClearAllAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ClearAllAchievements_AfterArgs toInvoke in _afterClearAllAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckCharmAchievements_BeforeArgs toInvoke in _beforeCheckCharmAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckCharmAchievements_AfterArgs toInvoke in _afterCheckCharmAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckGrubAchievements_BeforeArgs toInvoke in _beforeCheckGrubAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckGrubAchievements_AfterArgs toInvoke in _afterCheckGrubAchievements.GetInvocationList())
{
try
{
...
private static void CheckStagStationAchievements(On.GameManager.orig_CheckStagStationAchievements orig,GameManager self)
{
...
{
foreach (Delegates.CheckStagStationAchievements_BeforeArgs toInvoke in _beforeCheckStagStationAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckStagStationAchievements_AfterArgs toInvoke in _afterCheckStagStationAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckMapAchievement_BeforeArgs toInvoke in _beforeCheckMapAchievement.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckMapAchievement_AfterArgs toInvoke in _afterCheckMapAchievement.GetInvocationList())
{
try
{
...
private static void CheckJournalAchievements(On.GameManager.orig_CheckJournalAchievements orig,GameManager self)
{
...
{
foreach (Delegates.CheckJournalAchievements_BeforeArgs toInvoke in _beforeCheckJournalAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckJournalAchievements_AfterArgs toInvoke in _afterCheckJournalAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckAllAchievements_BeforeArgs toInvoke in _beforeCheckAllAchievements.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckAllAchievements_AfterArgs toInvoke in _afterCheckAllAchievements.GetInvocationList())
{
try
{
...
private static void CheckBanishmentAchievement(On.GameManager.orig_CheckBanishmentAchievement orig,GameManager self)
{
...
{
foreach (Delegates.CheckBanishmentAchievement_BeforeArgs toInvoke in _beforeCheckBanishmentAchievement.GetInvocationList())
{
try
{
...
{
foreach (Delegates.CheckBanishmentAchievement_AfterArgs toInvoke in _afterCheckBanishmentAchievement.GetInvocationList())
{
try
{
...
private static void SetStatusRecordInt(On.GameManager.orig_SetStatusRecordInt orig,GameManager self,  string key,  int value)
{
...
{
foreach (Delegates.SetStatusRecordInt_BeforeArgs toInvoke in _beforeSetStatusRecordInt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetStatusRecordInt_AfterArgs toInvoke in _afterSetStatusRecordInt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetStatusRecordInt_BeforeArgs toInvoke in _beforeGetStatusRecordInt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetStatusRecordInt_AfterArgs toInvoke in _afterGetStatusRecordInt.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetStatusRecords_BeforeArgs toInvoke in _beforeResetStatusRecords.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetStatusRecords_AfterArgs toInvoke in _afterResetStatusRecords.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveStatusRecords_BeforeArgs toInvoke in _beforeSaveStatusRecords.GetInvocationList())
{
try
{
...
private static void SetState(On.GameManager.orig_SetState orig,GameManager self,  GlobalEnums.GameState newState)
{
...
private static System.Collections.IEnumerator LoadSceneAdditive(On.GameManager.orig_LoadSceneAdditive orig,GameManager self,  string destScene)
{
...
{
foreach (Delegates.LoadSceneAdditive_BeforeArgs toInvoke in _beforeLoadSceneAdditive.GetInvocationList())
{
try
{
...
private static void OnWillActivateFirstLevel(On.GameManager.orig_OnWillActivateFirstLevel orig,GameManager self)
{
...
{
foreach (Delegates.OnWillActivateFirstLevel_BeforeArgs toInvoke in _beforeOnWillActivateFirstLevel.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnWillActivateFirstLevel_AfterArgs toInvoke in _afterOnWillActivateFirstLevel.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator LoadFirstScene(On.GameManager.orig_LoadFirstScene orig,GameManager self)
{
...
private static void LoadPermadeathUnlockScene(On.GameManager.orig_LoadPermadeathUnlockScene orig,GameManager self)
{
...
{
foreach (Delegates.LoadPermadeathUnlockScene_BeforeArgs toInvoke in _beforeLoadPermadeathUnlockScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadPermadeathUnlockScene_AfterArgs toInvoke in _afterLoadPermadeathUnlockScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadMrMushromScene_BeforeArgs toInvoke in _beforeLoadMrMushromScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadMrMushromScene_AfterArgs toInvoke in _afterLoadMrMushromScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadOpeningCinematic_BeforeArgs toInvoke in _beforeLoadOpeningCinematic.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadOpeningCinematic_AfterArgs toInvoke in _afterLoadOpeningCinematic.GetInvocationList())
{
try
{
...
private static void PositionHeroAtSceneEntrance(On.GameManager.orig_PositionHeroAtSceneEntrance orig,GameManager self)
{
...
{
foreach (Delegates.PositionHeroAtSceneEntrance_BeforeArgs toInvoke in _beforePositionHeroAtSceneEntrance.GetInvocationList())
{
try
{
...
{
foreach (Delegates.PositionHeroAtSceneEntrance_AfterArgs toInvoke in _afterPositionHeroAtSceneEntrance.GetInvocationList())
{
try
{
...
private static UnityEngine.Vector2? FindEntryPoint(On.GameManager.orig_FindEntryPoint orig,GameManager self,  string entryPointName,  UnityEngine.SceneManagement.Scene filterScene)
{
...
private static TransitionPoint FindTransitionPoint(On.GameManager.orig_FindTransitionPoint orig,GameManager self,  string entryPointName,  UnityEngine.SceneManagement.Scene filterScene,  bool fallbackToAnyAvailable)
{
...
{
foreach (Delegates.FindTransitionPoint_BeforeArgs toInvoke in _beforeFindTransitionPoint.GetInvocationList())
{
try
{
...
{
foreach (Delegates.FindTransitionPoint_AfterArgs toInvoke in _afterFindTransitionPoint.GetInvocationList())
{
try
{
...
{
self = self
, additiveGateSearch = additiveGateSearch
};
...
private static void SetupSceneRefs(On.GameManager.orig_SetupSceneRefs orig,GameManager self,  bool refreshTilemapInfo)
{
...
private static void UpdateUIStateFromGameState(On.GameManager.orig_UpdateUIStateFromGameState orig,GameManager self)
{
...
{
foreach (Delegates.UpdateUIStateFromGameState_BeforeArgs toInvoke in _beforeUpdateUIStateFromGameState.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateUIStateFromGameState_AfterArgs toInvoke in _afterUpdateUIStateFromGameState.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator SkipCutsceneNoMash(On.GameManager.orig_SkipCutsceneNoMash orig,GameManager self)
{
...
{
foreach (Delegates.SkipCutsceneNoMash_BeforeArgs toInvoke in _beforeSkipCutsceneNoMash.GetInvocationList())
{
try
{
...
{
foreach (Delegates.NoLongerFirstGame_BeforeArgs toInvoke in _beforeNoLongerFirstGame.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupStatusModifiers_BeforeArgs toInvoke in _beforeSetupStatusModifiers.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetupStatusModifiers_AfterArgs toInvoke in _afterSetupStatusModifiers.GetInvocationList())
{
try
{
...
private static void MatchBackerCreditsSetting(On.GameManager.orig_MatchBackerCreditsSetting orig,GameManager self)
{
...
{
foreach (Delegates.MatchBackerCreditsSetting_BeforeArgs toInvoke in _beforeMatchBackerCreditsSetting.GetInvocationList())
{
try
{
...
{
foreach (Delegates.MatchBackerCreditsSetting_AfterArgs toInvoke in _afterMatchBackerCreditsSetting.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshLocalization_BeforeArgs toInvoke in _beforeRefreshLocalization.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshLocalization_AfterArgs toInvoke in _afterRefreshLocalization.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshParticleSystems_BeforeArgs toInvoke in _beforeRefreshParticleSystems.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshParticleSystems_AfterArgs toInvoke in _afterRefreshParticleSystems.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnablePermadeathMode_BeforeArgs toInvoke in _beforeEnablePermadeathMode.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnablePermadeathMode_AfterArgs toInvoke in _afterEnablePermadeathMode.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetCurrentMapZone_BeforeArgs toInvoke in _beforeGetCurrentMapZone.GetInvocationList())
{
try
{
...
private static UnityEngine.GameObject GetSceneManager(On.GameManager.orig_GetSceneManager orig,GameManager self)
{
...
private static string GetFormattedMapZoneString(On.GameManager.orig_GetFormattedMapZoneString orig,GameManager self,  GlobalEnums.MapZone mapZone)
{
...
{
foreach (Delegates.GetFormattedMapZoneString_BeforeArgs toInvoke in _beforeGetFormattedMapZoneString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetFormattedMapZoneString_AfterArgs toInvoke in _afterGetFormattedMapZoneString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetSceneNameString_BeforeArgs toInvoke in _beforeGetSceneNameString.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetSceneNameString_AfterArgs toInvoke in _afterGetSceneNameString.GetInvocationList())
{
try
{
...
private static tk2dTileMap GetTileMap(On.GameManager.orig_GetTileMap orig, UnityEngine.GameObject gameObject)
{
...
private static void RefreshTilemapInfo(On.GameManager.orig_RefreshTilemapInfo orig,GameManager self,  string targetScene)
{
...
{
foreach (Delegates.RefreshTilemapInfo_BeforeArgs toInvoke in _beforeRefreshTilemapInfo.GetInvocationList())
{
try
{
...
{
foreach (Delegates.RefreshTilemapInfo_AfterArgs toInvoke in _afterRefreshTilemapInfo.GetInvocationList())
{
try
{
...
private static void ResetSemiPersistentItems(On.GameManager.orig_ResetSemiPersistentItems orig,GameManager self)
{
...
{
foreach (Delegates.ResetSemiPersistentItems_BeforeArgs toInvoke in _beforeResetSemiPersistentItems.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResetSemiPersistentItems_AfterArgs toInvoke in _afterResetSemiPersistentItems.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsTitleScreenScene_BeforeArgs toInvoke in _beforeIsTitleScreenScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsTitleScreenScene_AfterArgs toInvoke in _afterIsTitleScreenScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsNonGameplayScene_BeforeArgs toInvoke in _beforeIsNonGameplayScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsNonGameplayScene_AfterArgs toInvoke in _afterIsNonGameplayScene.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsStagTravelScene_BeforeArgs toInvoke in _beforeIsStagTravelScene.GetInvocationList())
{
try
{
...
private static bool ShouldKeepHUDCameraActive(On.GameManager.orig_ShouldKeepHUDCameraActive orig,GameManager self)
{
...
{
foreach (Delegates.ShouldKeepHUDCameraActive_BeforeArgs toInvoke in _beforeShouldKeepHUDCameraActive.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ShouldKeepHUDCameraActive_AfterArgs toInvoke in _afterShouldKeepHUDCameraActive.GetInvocationList())
{
try
{
...
private static bool IsUnloadAssetsRequired(On.GameManager.orig_IsUnloadAssetsRequired orig,GameManager self,  string sourceSceneName,  string destinationSceneName)
{
...
{
foreach (Delegates.IsUnloadAssetsRequired_BeforeArgs toInvoke in _beforeIsUnloadAssetsRequired.GetInvocationList())
{
try
{
...
{
foreach (Delegates.IsUnloadAssetsRequired_AfterArgs toInvoke in _afterIsUnloadAssetsRequired.GetInvocationList())
{
try
{
...
private static void HasSaveFile(On.GameManager.orig_HasSaveFile orig,GameManager self,  int saveSlot,  System.Action<bool> callback)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame_Action", true), SaveGame_Action);
...
private static void SaveGame_Action(Action<GameManager,  System.Action<bool>> orig, GameManager self,  System.Action<bool> callback)
{
...
private static void IncreaseGameTimer(On.GameManager.orig_IncreaseGameTimer orig,GameManager self, ref  float timer)
{
...
{
foreach (Delegates.IncreaseGameTimer_BeforeArgs toInvoke in _beforeIncreaseGameTimer.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame_int_Action", true), SaveGame_int_Action);
...
private static void SaveGame_int_Action(Action<GameManager,  int,  System.Action<bool>> orig, GameManager self,  int saveSlot,  System.Action<bool> callback)
{
...
{
foreach (Delegates.SaveGame_int_Action_BeforeArgs toInvoke in _beforeSaveGame_int_Action.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveGame_int_Action_AfterArgs toInvoke in _afterSaveGame_int_Action.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator LoadGameFromUIRoutine(On.GameManager.orig_LoadGameFromUIRoutine orig,GameManager self,  int saveSlot)
{
...
{
foreach (Delegates.LoadGameFromUIRoutine_BeforeArgs toInvoke in _beforeLoadGameFromUIRoutine.GetInvocationList())
{
try
{
...
private static void LoadGame(On.GameManager.orig_LoadGame orig,GameManager self,  int saveSlot,  System.Action<bool> callback)
{
...
private static void ClearSaveFile(On.GameManager.orig_ClearSaveFile orig,GameManager self,  int saveSlot,  System.Action<bool> callback)
{
...
private static void GetSaveStatsForSlot(On.GameManager.orig_GetSaveStatsForSlot orig,GameManager self,  int saveSlot,  System.Action<SaveStats> callback)
{
...
{
foreach (Delegates.GetSaveStatsForSlot_BeforeArgs toInvoke in _beforeGetSaveStatsForSlot.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetSaveStatsForSlot_AfterArgs toInvoke in _afterGetSaveStatsForSlot.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator PauseGameToggleByMenu(On.GameManager.orig_PauseGameToggleByMenu orig,GameManager self)
{
...
{
foreach (Delegates.PauseGameToggleByMenu_BeforeArgs toInvoke in _beforePauseGameToggleByMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator PauseGameToggle(On.GameManager.orig_PauseGameToggle orig,GameManager self)
{
...
private static System.Collections.IEnumerator SetTimeScale_float_float(On.GameManager.orig_SetTimeScale_float_float orig,GameManager self,  float newTimeScale,  float duration)
{
...
{
foreach (Delegates.SetTimeScale_float_float_BeforeArgs toInvoke in _beforeSetTimeScale_float_float.GetInvocationList())
{
try
{
...
private static void SetTimeScale_float(On.GameManager.orig_SetTimeScale_float orig,GameManager self,  float newTimeScale)
{
...
{
foreach (Delegates.SetTimeScale_float_BeforeArgs toInvoke in _beforeSetTimeScale_float.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SetTimeScale_float_AfterArgs toInvoke in _afterSetTimeScale_float.GetInvocationList())
{
try
{
...
internal static event Delegates.FreezeMoment_float_float_float_float_BeforeArgs _beforeFreezeMoment_float_float_float_float;
private static System.Collections.IEnumerator FreezeMoment_float_float_float_float(On.GameManager.orig_FreezeMoment_float_float_float_float orig,GameManager self,  float rampDownTime,  float waitTime,  float rampUpTime,  float targetSpeed)
{
...
{
foreach (Delegates.FreezeMoment_float_float_float_float_BeforeArgs toInvoke in _beforeFreezeMoment_float_float_float_float.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator FreezeMomentGC(On.GameManager.orig_FreezeMomentGC orig,GameManager self,  float rampDownTime,  float waitTime,  float rampUpTime,  float targetSpeed)
{
...
internal static event Delegates.FreezeMoment_float_float_float_bool_BeforeArgs _beforeFreezeMoment_float_float_float_bool;
private static System.Collections.IEnumerator FreezeMoment_float_float_float_bool(On.GameManager.orig_FreezeMoment_float_float_float_bool orig,GameManager self,  float rampDownTime,  float waitTime,  float rampUpTime,  bool runGc)
{
...
{
foreach (Delegates.FreezeMoment_float_float_float_bool_BeforeArgs toInvoke in _beforeFreezeMoment_float_float_float_bool.GetInvocationList())
{
try
{
...
private static void EnsureSaveSlotSpace(On.GameManager.orig_EnsureSaveSlotSpace orig,GameManager self,  System.Action<bool> callback)
{
...
private static System.Collections.IEnumerator RunStartNewGame(On.GameManager.orig_RunStartNewGame orig,GameManager self)
{
...
private static System.Collections.IEnumerator RunContinueGame(On.GameManager.orig_RunContinueGame orig,GameManager self)
{
...
private static System.Collections.IEnumerator ReturnToMainMenu(On.GameManager.orig_ReturnToMainMenu orig,GameManager self,  GameManager.ReturnToMainMenuSaveModes saveMode,  System.Action<bool> callback)
{
...
private static void WillTerminateInBackground(On.GameManager.orig_WillTerminateInBackground orig,GameManager self)
{
...
{
foreach (Delegates.WillTerminateInBackground_BeforeArgs toInvoke in _beforeWillTerminateInBackground.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WillTerminateInBackground_AfterArgs toInvoke in _afterWillTerminateInBackground.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "OnDisengage", true), OnDisengage);
...
private static void OnDisengage(Action<GameManager,  System.Action> orig, GameManager self,  System.Action next)
{
...
private static void EmergencyReturnToMenu(On.GameManager.orig_EmergencyReturnToMenu orig,GameManager self,  System.Action callback)
{
...
{
foreach (Delegates.EmergencyReturnToMenu_BeforeArgs toInvoke in _beforeEmergencyReturnToMenu.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EmergencyReturnToMenu_AfterArgs toInvoke in _afterEmergencyReturnToMenu.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator QuitGame(On.GameManager.orig_QuitGame orig,GameManager self)
{
...
{
foreach (Delegates.DoDestroyPersonalPools_BeforeArgs toInvoke in _beforeDoDestroyPersonalPools.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DoDestroyPersonalPools_AfterArgs toInvoke in _afterDoDestroyPersonalPools.GetInvocationList())
{
try
{
...
private static float GetImplicitCinematicVolume(On.GameManager.orig_GetImplicitCinematicVolume orig,GameManager self)
{
...
{
foreach (Delegates.GetImplicitCinematicVolume_BeforeArgs toInvoke in _beforeGetImplicitCinematicVolume.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetImplicitCinematicVolume_AfterArgs toInvoke in _afterGetImplicitCinematicVolume.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_get_ui", true), orig_get_ui);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_set_ui", true), orig_set_ui);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnApplicationQuit", true), orig_OnApplicationQuit);
...
{
foreach (Delegates.orig_OnApplicationQuit_BeforeArgs toInvoke in _beforeorig_OnApplicationQuit.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_OnApplicationQuit_AfterArgs toInvoke in _afterorig_OnApplicationQuit.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_LoadScene", true), orig_LoadScene);
...
internal static void Hookorig_BeginSceneTransition()
{
if (!HookedList.Contains("orig_BeginSceneTransition"))
{
HookedList.Add("orig_BeginSceneTransition");
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition", true), orig_BeginSceneTransition);

}
}
internal static event Delegates.orig_BeginSceneTransition_BeforeArgs _beforeorig_BeginSceneTransition;
internal static event Delegates.orig_BeginSceneTransition_AfterArgs _afterorig_BeginSceneTransition;
private static void orig_BeginSceneTransition(Action<GameManager,  GameManager.SceneLoadInfo> orig, GameManager self,  GameManager.SceneLoadInfo info)
{
Delegates.Params_orig_BeginSceneTransition @params = new() 
{
self = self
, info = info
};
if (_beforeorig_BeginSceneTransition != null)
{
foreach (Delegates.orig_BeginSceneTransition_BeforeArgs toInvoke in _beforeorig_BeginSceneTransition.GetInvocationList())
{
try
{
_beforeorig_BeginSceneTransition?.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
info = @params.info;
orig(self, info);
if (_afterorig_BeginSceneTransition != null)
{
foreach (Delegates.orig_BeginSceneTransition_AfterArgs toInvoke in _afterorig_BeginSceneTransition.GetInvocationList())
{
try
{
_afterorig_BeginSceneTransition.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_ClearSaveFile", true), orig_ClearSaveFile);
...
private static void orig_ClearSaveFile(Action<GameManager,  int,  System.Action<bool>> orig, GameManager self,  int saveSlot,  System.Action<bool> callback)
{
...
{
foreach (Delegates.orig_ClearSaveFile_BeforeArgs toInvoke in _beforeorig_ClearSaveFile.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_ClearSaveFile_AfterArgs toInvoke in _afterorig_ClearSaveFile.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_PlayerDead", true), orig_PlayerDead);

}
}
internal static event Delegates.orig_PlayerDead_BeforeArgs _beforeorig_PlayerDead;
private static System.Collections.IEnumerator orig_PlayerDead(Func<GameManager,  float, System.Collections.IEnumerator> orig, GameManager self,  float waitTime)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_SetupSceneRefs", true), orig_SetupSceneRefs);
...
private static void orig_SetupSceneRefs(Action<GameManager,  bool> orig, GameManager self,  bool refreshTilemapInfo)
{
...
{
foreach (Delegates.orig_SetupSceneRefs_BeforeArgs toInvoke in _beforeorig_SetupSceneRefs.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_SetupSceneRefs_AfterArgs toInvoke in _afterorig_SetupSceneRefs.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnWillActivateFirstLevel", true), orig_OnWillActivateFirstLevel);
...
{
foreach (Delegates.orig_OnWillActivateFirstLevel_BeforeArgs toInvoke in _beforeorig_OnWillActivateFirstLevel.GetInvocationList())
{
try
{
...
{
foreach (Delegates.orig_OnWillActivateFirstLevel_AfterArgs toInvoke in _afterorig_OnWillActivateFirstLevel.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseToggleDynamicMenu", true), PauseToggleDynamicMenu);

}
}
internal static event Delegates.PauseToggleDynamicMenu_BeforeArgs _beforePauseToggleDynamicMenu;
private static System.Collections.IEnumerator PauseToggleDynamicMenu(Func<GameManager,  MenuScreen,  bool, System.Collections.IEnumerator> orig, GameManager self,  MenuScreen screen,  bool allowUnpause)
{
...
{
foreach (Delegates.PauseToggleDynamicMenu_BeforeArgs toInvoke in _beforePauseToggleDynamicMenu.GetInvocationList())
{
try
{
...
public delegate void set_inputHandler_WithArgs (Action<GameManager,  InputHandler> orig, GameManager self,  InputHandler value);
...
public delegate AchievementHandler get_achievementHandler_AfterArgs(Params_get_achievementHandler args, AchievementHandler ret);
public delegate AchievementHandler get_achievementHandler_WithArgs (Func<GameManager, AchievementHandler> orig, GameManager self);
...
public delegate void set_achievementHandler_WithArgs (Action<GameManager,  AchievementHandler> orig, GameManager self,  AchievementHandler value);
...
public delegate CameraController get_cameraCtrl_WithArgs (Func<GameManager, CameraController> orig, GameManager self);
...
public delegate void set_cameraCtrl_WithArgs (Action<GameManager,  CameraController> orig, GameManager self,  CameraController value);
...
public delegate void set_hero_ctrl_WithArgs (Action<GameManager,  HeroController> orig, GameManager self,  HeroController value);
public sealed class Params_get_heroLight
{
public GameManager self;
}
public delegate void get_heroLight_BeforeArgs(Params_get_heroLight args);
public delegate UnityEngine.SpriteRenderer get_heroLight_AfterArgs(Params_get_heroLight args, UnityEngine.SpriteRenderer ret);
public delegate UnityEngine.SpriteRenderer get_heroLight_WithArgs (Func<GameManager, UnityEngine.SpriteRenderer> orig, GameManager self);
...
public delegate void set_heroLight_WithArgs (Action<GameManager,  UnityEngine.SpriteRenderer> orig, GameManager self,  UnityEngine.SpriteRenderer value);
...
public delegate void set_sm_WithArgs (Action<GameManager,  SceneManager> orig, GameManager self,  SceneManager value);
...
public delegate void set_tilemap_WithArgs (Action<GameManager,  tk2dTileMap> orig, GameManager self,  tk2dTileMap value);
...
public delegate void set_soulOrb_fsm_WithArgs (Action<GameManager,  PlayMakerFSM> orig, GameManager self,  PlayMakerFSM value);
...
public delegate PlayMakerFSM get_soulVessel_fsm_WithArgs (Func<GameManager, PlayMakerFSM> orig, GameManager self);
...
public delegate void set_soulVessel_fsm_WithArgs (Action<GameManager,  PlayMakerFSM> orig, GameManager self,  PlayMakerFSM value);
...
public delegate void set_IsInSceneTransition_WithArgs (Action<GameManager,  bool> orig, GameManager self,  bool value);
...
public delegate bool get_IsUsingCustomLoadAnimation_AfterArgs(Params_get_IsUsingCustomLoadAnimation args, bool ret);
...
public delegate void LevelActivated_WithArgs (Action<GameManager,  UnityEngine.SceneManagement.Scene,  UnityEngine.SceneManagement.Scene> orig, GameManager self,  UnityEngine.SceneManagement.Scene sceneFrom,  UnityEngine.SceneManagement.Scene sceneTo);
...
public sealed class Params_BeginSceneTransition
{
public GameManager self;
public GameManager.SceneLoadInfo info;
}
public delegate void BeginSceneTransition_BeforeArgs(Params_BeginSceneTransition args);
public delegate void BeginSceneTransition_AfterArgs(Params_BeginSceneTransition args);
public delegate void BeginSceneTransition_WithArgs (Action<GameManager,  GameManager.SceneLoadInfo> orig, GameManager self,  GameManager.SceneLoadInfo info);
public sealed class Params_BeginSceneTransitionRoutine
{
public GameManager self;
public GameManager.SceneLoadInfo info;
}
public delegate void BeginSceneTransitionRoutine_BeforeArgs(Params_BeginSceneTransitionRoutine args);
public delegate System.Collections.IEnumerator BeginSceneTransitionRoutine_AfterArgs(Params_BeginSceneTransitionRoutine args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator BeginSceneTransitionRoutine_WithArgs (Func<GameManager,  GameManager.SceneLoadInfo, System.Collections.IEnumerator> orig, GameManager self,  GameManager.SceneLoadInfo info);
...
public delegate System.Collections.IEnumerator TransitionScene_AfterArgs(Params_TransitionScene args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator TransitionScene_WithArgs (Func<GameManager,  TransitionPoint, System.Collections.IEnumerator> orig, GameManager self,  TransitionPoint gate);
...
public delegate void ChangeToScene_WithArgs (Action<GameManager,  string,  string,  float> orig, GameManager self,  string targetScene,  string entryGateName,  float pauseBeforeEnter);
...
public delegate System.Collections.IEnumerator PlayerDead_AfterArgs(Params_PlayerDead args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PlayerDead_WithArgs (Func<GameManager,  float, System.Collections.IEnumerator> orig, GameManager self,  float waitTime);
...
public delegate System.Collections.IEnumerator PlayerDeadFromHazard_AfterArgs(Params_PlayerDeadFromHazard args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PlayerDeadFromHazard_WithArgs (Func<GameManager,  float, System.Collections.IEnumerator> orig, GameManager self,  float waitTime);
...
public delegate void ReadyForRespawn_WithArgs (Action<GameManager,  bool> orig, GameManager self,  bool isFirstLevelForPlayer);
...
public delegate System.Collections.IEnumerator FadeSceneInWithDelay_AfterArgs(Params_FadeSceneInWithDelay args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FadeSceneInWithDelay_WithArgs (Func<GameManager,  float, System.Collections.IEnumerator> orig, GameManager self,  float delay);
...
{
public GameManager self;
public UnityEngine.GameObject go_gameMap;
}
...
public delegate void SetGameMap_WithArgs (Action<GameManager,  UnityEngine.GameObject> orig, GameManager self,  UnityEngine.GameObject go_gameMap);
...
public delegate void SetPlayerDataBool_WithArgs (Action<GameManager,  string,  bool> orig, GameManager self,  string boolName,  bool value);
...
public delegate void SetPlayerDataInt_WithArgs (Action<GameManager,  string,  int> orig, GameManager self,  string intName,  int value);
...
public delegate void SetPlayerDataFloat_WithArgs (Action<GameManager,  string,  float> orig, GameManager self,  string floatName,  float value);
...
public delegate void SetPlayerDataString_WithArgs (Action<GameManager,  string,  string> orig, GameManager self,  string stringName,  string value);
...
public delegate void IncrementPlayerDataInt_WithArgs (Action<GameManager,  string> orig, GameManager self,  string intName);
...
public delegate void DecrementPlayerDataInt_WithArgs (Action<GameManager,  string> orig, GameManager self,  string intName);
...
public delegate void IntAdd_WithArgs (Action<GameManager,  string,  int> orig, GameManager self,  string intName,  int amount);
...
public delegate bool GetPlayerDataBool_WithArgs (Func<GameManager,  string, bool> orig, GameManager self,  string boolName);
...
public delegate int GetPlayerDataInt_WithArgs (Func<GameManager,  string, int> orig, GameManager self,  string intName);
...
public delegate float GetPlayerDataFloat_WithArgs (Func<GameManager,  string, float> orig, GameManager self,  string floatName);
...
public delegate string GetPlayerDataString_WithArgs (Func<GameManager,  string, string> orig, GameManager self,  string stringName);
...
public delegate void SetPlayerDataVector3_WithArgs (Action<GameManager,  string,  UnityEngine.Vector3> orig, GameManager self,  string vectorName,  UnityEngine.Vector3 value);
...
public delegate UnityEngine.Vector3 GetPlayerDataVector3_AfterArgs(Params_GetPlayerDataVector3 args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 GetPlayerDataVector3_WithArgs (Func<GameManager,  string, UnityEngine.Vector3> orig, GameManager self,  string vectorName);
...
public delegate void SetMapZoneToSpecific_WithArgs (Action<GameManager,  string> orig, GameManager self,  string mapZone);
...
public delegate void AddToScenesVisited_WithArgs (Action<GameManager,  string> orig, GameManager self,  string scene);
...
public delegate bool GetIsSceneVisited_WithArgs (Func<GameManager,  string, bool> orig, GameManager self,  string scene);
...
public delegate void StoryRecord_discoveredArea_WithArgs (Action<GameManager,  string> orig, GameManager self,  string areaName);
...
public delegate void StoryRecord_travelledToArea_WithArgs (Action<GameManager,  string> orig, GameManager self,  string areaName);
...
public delegate void StoryRecord_bankDeposit_WithArgs (Action<GameManager,  int> orig, GameManager self,  int amount);
...
public delegate void StoryRecord_bankWithdraw_WithArgs (Action<GameManager,  int> orig, GameManager self,  int amount);
...
public delegate void StoryRecord_boughtCorniferMap_WithArgs (Action<GameManager,  string> orig, GameManager self,  string map);
...
public delegate void StoryRecord_visited_WithArgs (Action<GameManager,  string> orig, GameManager self,  string visited);
...
public delegate void StoryRecord_defeated_WithArgs (Action<GameManager,  string> orig, GameManager self,  string defeated);
...
public delegate void StoryRecord_rodeStag_WithArgs (Action<GameManager,  string> orig, GameManager self,  string dest);
...
public delegate void StoryRecord_acquired_WithArgs (Action<GameManager,  string> orig, GameManager self,  string item);
...
public delegate void StoryRecord_bought_WithArgs (Action<GameManager,  string> orig, GameManager self,  string item);
...
public delegate void StoryRecord_charmEquipped_WithArgs (Action<GameManager,  string> orig, GameManager self,  string charmName);
...
public delegate bool IsAchievementAwarded_WithArgs (Func<GameManager,  string, bool> orig, GameManager self,  string key);
...
public delegate void SetStatusRecordInt_WithArgs (Action<GameManager,  string,  int> orig, GameManager self,  string key,  int value);
...
public delegate int GetStatusRecordInt_WithArgs (Func<GameManager,  string, int> orig, GameManager self,  string key);
...
{
public GameManager self;
public GlobalEnums.GameState newState;
}
...
public delegate void SetState_WithArgs (Action<GameManager,  GlobalEnums.GameState> orig, GameManager self,  GlobalEnums.GameState newState);
...
public delegate System.Collections.IEnumerator LoadSceneAdditive_AfterArgs(Params_LoadSceneAdditive args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator LoadSceneAdditive_WithArgs (Func<GameManager,  string, System.Collections.IEnumerator> orig, GameManager self,  string destScene);
...
public delegate System.Collections.IEnumerator LoadFirstScene_AfterArgs(Params_LoadFirstScene args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator LoadFirstScene_WithArgs (Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
...
public UnityEngine.SceneManagement.Scene filterScene;
}
public delegate void FindEntryPoint_BeforeArgs(Params_FindEntryPoint args);
public delegate UnityEngine.Vector2? FindEntryPoint_AfterArgs(Params_FindEntryPoint args, UnityEngine.Vector2? ret);
public delegate UnityEngine.Vector2? FindEntryPoint_WithArgs (Func<GameManager,  string,  UnityEngine.SceneManagement.Scene, UnityEngine.Vector2?> orig, GameManager self,  string entryPointName,  UnityEngine.SceneManagement.Scene filterScene);
...
public delegate TransitionPoint FindTransitionPoint_AfterArgs(Params_FindTransitionPoint args, TransitionPoint ret);
public delegate TransitionPoint FindTransitionPoint_WithArgs (Func<GameManager,  string,  UnityEngine.SceneManagement.Scene,  bool, TransitionPoint> orig, GameManager self,  string entryPointName,  UnityEngine.SceneManagement.Scene filterScene,  bool fallbackToAnyAvailable);
...
public delegate void EnterHero_WithArgs (Action<GameManager,  bool> orig, GameManager self,  bool additiveGateSearch);
...
public delegate void SetupSceneRefs_WithArgs (Action<GameManager,  bool> orig, GameManager self,  bool refreshTilemapInfo);
...
public delegate System.Collections.IEnumerator SkipCutsceneNoMash_AfterArgs(Params_SkipCutsceneNoMash args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator SkipCutsceneNoMash_WithArgs (Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
...
public delegate UnityEngine.GameObject GetSceneManager_AfterArgs(Params_GetSceneManager args, UnityEngine.GameObject ret);
public delegate UnityEngine.GameObject GetSceneManager_WithArgs (Func<GameManager, UnityEngine.GameObject> orig, GameManager self);
...
public delegate string GetFormattedMapZoneString_WithArgs (Func<GameManager,  GlobalEnums.MapZone, string> orig, GameManager self,  GlobalEnums.MapZone mapZone);
...
public delegate tk2dTileMap GetTileMap_WithArgs (Func< UnityEngine.GameObject, tk2dTileMap> orig,  UnityEngine.GameObject gameObject);
...
public delegate void RefreshTilemapInfo_WithArgs (Action<GameManager,  string> orig, GameManager self,  string targetScene);
...
public delegate bool IsUnloadAssetsRequired_WithArgs (Func<GameManager,  string,  string, bool> orig, GameManager self,  string sourceSceneName,  string destinationSceneName);
...
public delegate void HasSaveFile_WithArgs (Action<GameManager,  int,  System.Action<bool>> orig, GameManager self,  int saveSlot,  System.Action<bool> callback);
...
public delegate void SaveGame_Action_WithArgs (Action<GameManager,  System.Action<bool>> orig, GameManager self,  System.Action<bool> callback);
...
public delegate void IncreaseGameTimer_WithArgs (Action<GameManager,  float> orig, GameManager self, ref  float timer);
...
public delegate void SaveGame_int_Action_WithArgs (Action<GameManager,  int,  System.Action<bool>> orig, GameManager self,  int saveSlot,  System.Action<bool> callback);
...
public delegate System.Collections.IEnumerator LoadGameFromUIRoutine_AfterArgs(Params_LoadGameFromUIRoutine args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator LoadGameFromUIRoutine_WithArgs (Func<GameManager,  int, System.Collections.IEnumerator> orig, GameManager self,  int saveSlot);
...
public delegate void LoadGame_WithArgs (Action<GameManager,  int,  System.Action<bool>> orig, GameManager self,  int saveSlot,  System.Action<bool> callback);
...
public delegate void ClearSaveFile_WithArgs (Action<GameManager,  int,  System.Action<bool>> orig, GameManager self,  int saveSlot,  System.Action<bool> callback);
public sealed class Params_GetSaveStatsForSlot
{
public GameManager self;
public int saveSlot;
public System.Action<SaveStats> callback;
}
...
public delegate void GetSaveStatsForSlot_WithArgs (Action<GameManager,  int,  System.Action<SaveStats>> orig, GameManager self,  int saveSlot,  System.Action<SaveStats> callback);
...
public delegate System.Collections.IEnumerator PauseGameToggleByMenu_AfterArgs(Params_PauseGameToggleByMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PauseGameToggleByMenu_WithArgs (Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
public sealed class Params_PauseGameToggle
{
public GameManager self;
}
public delegate void PauseGameToggle_BeforeArgs(Params_PauseGameToggle args);
public delegate System.Collections.IEnumerator PauseGameToggle_AfterArgs(Params_PauseGameToggle args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PauseGameToggle_WithArgs (Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
...
public delegate System.Collections.IEnumerator SetTimeScale_float_float_AfterArgs(Params_SetTimeScale_float_float args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator SetTimeScale_float_float_WithArgs (Func<GameManager,  float,  float, System.Collections.IEnumerator> orig, GameManager self,  float newTimeScale,  float duration);
...
public delegate void SetTimeScale_float_WithArgs (Action<GameManager,  float> orig, GameManager self,  float newTimeScale);
...
public delegate void FreezeMoment_float_float_float_float_BeforeArgs(Params_FreezeMoment_float_float_float_float args);
public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_float_AfterArgs(Params_FreezeMoment_float_float_float_float args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_float_WithArgs (Func<GameManager,  float,  float,  float,  float, System.Collections.IEnumerator> orig, GameManager self,  float rampDownTime,  float waitTime,  float rampUpTime,  float targetSpeed);
...
public delegate System.Collections.IEnumerator FreezeMomentGC_AfterArgs(Params_FreezeMomentGC args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FreezeMomentGC_WithArgs (Func<GameManager,  float,  float,  float,  float, System.Collections.IEnumerator> orig, GameManager self,  float rampDownTime,  float waitTime,  float rampUpTime,  float targetSpeed);
...
public delegate void FreezeMoment_float_float_float_bool_BeforeArgs(Params_FreezeMoment_float_float_float_bool args);
public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_bool_AfterArgs(Params_FreezeMoment_float_float_float_bool args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator FreezeMoment_float_float_float_bool_WithArgs (Func<GameManager,  float,  float,  float,  bool, System.Collections.IEnumerator> orig, GameManager self,  float rampDownTime,  float waitTime,  float rampUpTime,  bool runGc);
...
public delegate void EnsureSaveSlotSpace_WithArgs (Action<GameManager,  System.Action<bool>> orig, GameManager self,  System.Action<bool> callback);
...
public delegate void StartNewGame_WithArgs (Action<GameManager,  bool,  bool> orig, GameManager self,  bool permadeathMode,  bool bossRushMode);
public sealed class Params_RunStartNewGame
{
public GameManager self;
}
public delegate void RunStartNewGame_BeforeArgs(Params_RunStartNewGame args);
public delegate System.Collections.IEnumerator RunStartNewGame_AfterArgs(Params_RunStartNewGame args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator RunStartNewGame_WithArgs (Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
...
public delegate System.Collections.IEnumerator RunContinueGame_AfterArgs(Params_RunContinueGame args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator RunContinueGame_WithArgs (Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
public sealed class Params_ReturnToMainMenu
{
public GameManager self;
public GameManager.ReturnToMainMenuSaveModes saveMode;
public System.Action<bool> callback;
}
public delegate void ReturnToMainMenu_BeforeArgs(Params_ReturnToMainMenu args);
public delegate System.Collections.IEnumerator ReturnToMainMenu_AfterArgs(Params_ReturnToMainMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator ReturnToMainMenu_WithArgs (Func<GameManager,  GameManager.ReturnToMainMenuSaveModes,  System.Action<bool>, System.Collections.IEnumerator> orig, GameManager self,  GameManager.ReturnToMainMenuSaveModes saveMode,  System.Action<bool> callback);
...
public delegate void OnDisengage_WithArgs (Action<GameManager,  System.Action> orig, GameManager self,  System.Action next);
...
public delegate void EmergencyReturnToMenu_WithArgs (Action<GameManager,  System.Action> orig, GameManager self,  System.Action callback);
public sealed class Params_QuitGame
{
public GameManager self;
}
public delegate void QuitGame_BeforeArgs(Params_QuitGame args);
public delegate System.Collections.IEnumerator QuitGame_AfterArgs(Params_QuitGame args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator QuitGame_WithArgs (Func<GameManager, System.Collections.IEnumerator> orig, GameManager self);
...
public delegate void orig_set_ui_WithArgs (Action<GameManager,  UIManager> orig, GameManager self,  UIManager value);
...
public delegate void orig_LoadScene_WithArgs (Action<GameManager,  string> orig, GameManager self,  string destScene);
public sealed class Params_orig_BeginSceneTransition
{
public GameManager self;
public GameManager.SceneLoadInfo info;
}
public delegate void orig_BeginSceneTransition_BeforeArgs(Params_orig_BeginSceneTransition args);
public delegate void orig_BeginSceneTransition_AfterArgs(Params_orig_BeginSceneTransition args);
public delegate void orig_BeginSceneTransition_WithArgs (Action<GameManager,  GameManager.SceneLoadInfo> orig, GameManager self,  GameManager.SceneLoadInfo info);
...
public delegate void orig_ClearSaveFile_WithArgs (Action<GameManager,  int,  System.Action<bool>> orig, GameManager self,  int saveSlot,  System.Action<bool> callback);
...
public delegate System.Collections.IEnumerator orig_PlayerDead_AfterArgs(Params_orig_PlayerDead args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator orig_PlayerDead_WithArgs (Func<GameManager,  float, System.Collections.IEnumerator> orig, GameManager self,  float waitTime);
...
public delegate void orig_SetupSceneRefs_WithArgs (Action<GameManager,  bool> orig, GameManager self,  bool refreshTilemapInfo);
...
public delegate System.Collections.IEnumerator PauseToggleDynamicMenu_AfterArgs(Params_PauseToggleDynamicMenu args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator PauseToggleDynamicMenu_WithArgs (Func<GameManager,  MenuScreen,  bool, System.Collections.IEnumerator> orig, GameManager self,  MenuScreen screen,  bool allowUnpause);
}
...
public static event Delegates.BeginSceneTransition_BeforeArgs BeginSceneTransition
{
add
{

HookHandler._beforeBeginSceneTransition += value;
HookHandler.HookBeginSceneTransition();
}
remove => HookHandler._beforeBeginSceneTransition -= value;
}
public static event Delegates.BeginSceneTransitionRoutine_BeforeArgs BeginSceneTransitionRoutine
{
add
{

HookHandler._beforeBeginSceneTransitionRoutine += value;
HookHandler.HookBeginSceneTransitionRoutine();
}
remove => HookHandler._beforeBeginSceneTransitionRoutine -= value;
}
...
public static event Delegates.FreezeMoment_float_float_float_float_BeforeArgs FreezeMoment_float_float_float_float
{
add
{
...
public static event Delegates.orig_BeginSceneTransition_BeforeArgs orig_BeginSceneTransition
{
add
{

HookHandler._beforeorig_BeginSceneTransition += value;
HookHandler.Hookorig_BeginSceneTransition();
}
remove => HookHandler._beforeorig_BeginSceneTransition -= value;
}
...
public static event Delegates.BeginSceneTransition_AfterArgs BeginSceneTransition
{
add
{

HookHandler._afterBeginSceneTransition += value;
HookHandler.HookBeginSceneTransition();
}
remove => HookHandler._afterBeginSceneTransition -= value;
}
...
public static event Delegates.orig_BeginSceneTransition_AfterArgs orig_BeginSceneTransition
{
add
{

HookHandler._afterorig_BeginSceneTransition += value;
HookHandler.Hookorig_BeginSceneTransition();
}
remove => HookHandler._afterorig_BeginSceneTransition -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.get_TimeSlowed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_TimeSlowed", true), value);
remove => HookEndpointManager.Remove<Delegates.get_TimeSlowed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_TimeSlowed", true), value);
}
public static event Delegates.get_inputHandler_WithArgs get_inputHandler
{
add => HookEndpointManager.Add<Delegates.get_inputHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_inputHandler", true), value);
remove => HookEndpointManager.Remove<Delegates.get_inputHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_inputHandler", true), value);
}
public static event Delegates.set_inputHandler_WithArgs set_inputHandler
{
add => HookEndpointManager.Add<Delegates.set_inputHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_inputHandler", true), value);
remove => HookEndpointManager.Remove<Delegates.set_inputHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_inputHandler", true), value);
}
public static event Delegates.get_achievementHandler_WithArgs get_achievementHandler
{
add => HookEndpointManager.Add<Delegates.get_achievementHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_achievementHandler", true), value);
remove => HookEndpointManager.Remove<Delegates.get_achievementHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_achievementHandler", true), value);
}
public static event Delegates.set_achievementHandler_WithArgs set_achievementHandler
{
add => HookEndpointManager.Add<Delegates.set_achievementHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_achievementHandler", true), value);
remove => HookEndpointManager.Remove<Delegates.set_achievementHandler_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_achievementHandler", true), value);
}
public static event Delegates.get_AudioManager_WithArgs get_AudioManager
{
add => HookEndpointManager.Add<Delegates.get_AudioManager_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_AudioManager", true), value);
remove => HookEndpointManager.Remove<Delegates.get_AudioManager_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_AudioManager", true), value);
}
public static event Delegates.get_cameraCtrl_WithArgs get_cameraCtrl
{
add => HookEndpointManager.Add<Delegates.get_cameraCtrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_cameraCtrl", true), value);
remove => HookEndpointManager.Remove<Delegates.get_cameraCtrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_cameraCtrl", true), value);
}
public static event Delegates.set_cameraCtrl_WithArgs set_cameraCtrl
{
add => HookEndpointManager.Add<Delegates.set_cameraCtrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_cameraCtrl", true), value);
remove => HookEndpointManager.Remove<Delegates.set_cameraCtrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_cameraCtrl", true), value);
}
public static event Delegates.get_hero_ctrl_WithArgs get_hero_ctrl
{
add => HookEndpointManager.Add<Delegates.get_hero_ctrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_hero_ctrl", true), value);
remove => HookEndpointManager.Remove<Delegates.get_hero_ctrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_hero_ctrl", true), value);
}
public static event Delegates.set_hero_ctrl_WithArgs set_hero_ctrl
{
add => HookEndpointManager.Add<Delegates.set_hero_ctrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_hero_ctrl", true), value);
remove => HookEndpointManager.Remove<Delegates.set_hero_ctrl_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_hero_ctrl", true), value);
}
public static event Delegates.get_heroLight_WithArgs get_heroLight
{
add => HookEndpointManager.Add<Delegates.get_heroLight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_heroLight", true), value);
remove => HookEndpointManager.Remove<Delegates.get_heroLight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_heroLight", true), value);
}
public static event Delegates.set_heroLight_WithArgs set_heroLight
{
add => HookEndpointManager.Add<Delegates.set_heroLight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_heroLight", true), value);
remove => HookEndpointManager.Remove<Delegates.set_heroLight_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_heroLight", true), value);
}
public static event Delegates.get_sm_WithArgs get_sm
{
add => HookEndpointManager.Add<Delegates.get_sm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_sm", true), value);
remove => HookEndpointManager.Remove<Delegates.get_sm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_sm", true), value);
}
public static event Delegates.set_sm_WithArgs set_sm
{
add => HookEndpointManager.Add<Delegates.set_sm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_sm", true), value);
remove => HookEndpointManager.Remove<Delegates.set_sm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_sm", true), value);
}
public static event Delegates.get_ui_WithArgs get_ui
{
add => HookEndpointManager.Add<Delegates.get_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_ui", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_ui", true), value);
}
public static event Delegates.set_ui_WithArgs set_ui
{
add => HookEndpointManager.Add<Delegates.set_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_ui", true), value);
remove => HookEndpointManager.Remove<Delegates.set_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_ui", true), value);
}
public static event Delegates.get_tilemap_WithArgs get_tilemap
{
add => HookEndpointManager.Add<Delegates.get_tilemap_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_tilemap", true), value);
remove => HookEndpointManager.Remove<Delegates.get_tilemap_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_tilemap", true), value);
}
public static event Delegates.set_tilemap_WithArgs set_tilemap
{
add => HookEndpointManager.Add<Delegates.set_tilemap_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_tilemap", true), value);
remove => HookEndpointManager.Remove<Delegates.set_tilemap_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_tilemap", true), value);
}
public static event Delegates.get_soulOrb_fsm_WithArgs get_soulOrb_fsm
{
add => HookEndpointManager.Add<Delegates.get_soulOrb_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulOrb_fsm", true), value);
remove => HookEndpointManager.Remove<Delegates.get_soulOrb_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulOrb_fsm", true), value);
}
public static event Delegates.set_soulOrb_fsm_WithArgs set_soulOrb_fsm
{
add => HookEndpointManager.Add<Delegates.set_soulOrb_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulOrb_fsm", true), value);
remove => HookEndpointManager.Remove<Delegates.set_soulOrb_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulOrb_fsm", true), value);
}
public static event Delegates.get_soulVessel_fsm_WithArgs get_soulVessel_fsm
{
add => HookEndpointManager.Add<Delegates.get_soulVessel_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulVessel_fsm", true), value);
remove => HookEndpointManager.Remove<Delegates.get_soulVessel_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulVessel_fsm", true), value);
}
public static event Delegates.set_soulVessel_fsm_WithArgs set_soulVessel_fsm
{
add => HookEndpointManager.Add<Delegates.set_soulVessel_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulVessel_fsm", true), value);
remove => HookEndpointManager.Remove<Delegates.set_soulVessel_fsm_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulVessel_fsm", true), value);
}
public static event Delegates.get_PlayTime_WithArgs get_PlayTime
{
add => HookEndpointManager.Add<Delegates.get_PlayTime_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_PlayTime", true), value);
remove => HookEndpointManager.Remove<Delegates.get_PlayTime_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_PlayTime", true), value);
}
public static event Delegates.get_RespawningHero_WithArgs get_RespawningHero
{
add => HookEndpointManager.Add<Delegates.get_RespawningHero_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_RespawningHero", true), value);
remove => HookEndpointManager.Remove<Delegates.get_RespawningHero_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_RespawningHero", true), value);
}
public static event Delegates.set_RespawningHero_WithArgs set_RespawningHero
{
add => HookEndpointManager.Add<Delegates.set_RespawningHero_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_RespawningHero", true), value);
remove => HookEndpointManager.Remove<Delegates.set_RespawningHero_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_RespawningHero", true), value);
}
public static event Delegates.get_IsInSceneTransition_WithArgs get_IsInSceneTransition
{
add => HookEndpointManager.Add<Delegates.get_IsInSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsInSceneTransition", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsInSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsInSceneTransition", true), value);
}
public static event Delegates.set_IsInSceneTransition_WithArgs set_IsInSceneTransition
{
add => HookEndpointManager.Add<Delegates.set_IsInSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_IsInSceneTransition", true), value);
remove => HookEndpointManager.Remove<Delegates.set_IsInSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_IsInSceneTransition", true), value);
}
public static event Delegates.get_HasFinishedEnteringScene_WithArgs get_HasFinishedEnteringScene
{
add => HookEndpointManager.Add<Delegates.get_HasFinishedEnteringScene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_HasFinishedEnteringScene", true), value);
remove => HookEndpointManager.Remove<Delegates.get_HasFinishedEnteringScene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_HasFinishedEnteringScene", true), value);
}
public static event Delegates.get_WorldInfo_WithArgs get_WorldInfo
{
add => HookEndpointManager.Add<Delegates.get_WorldInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_WorldInfo", true), value);
remove => HookEndpointManager.Remove<Delegates.get_WorldInfo_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_WorldInfo", true), value);
}
public static event Delegates.get_IsLoadingSceneTransition_WithArgs get_IsLoadingSceneTransition
{
add => HookEndpointManager.Add<Delegates.get_IsLoadingSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsLoadingSceneTransition", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsLoadingSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsLoadingSceneTransition", true), value);
}
public static event Delegates.get_CurrentLoadDuration_WithArgs get_CurrentLoadDuration
{
add => HookEndpointManager.Add<Delegates.get_CurrentLoadDuration_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_CurrentLoadDuration", true), value);
remove => HookEndpointManager.Remove<Delegates.get_CurrentLoadDuration_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_CurrentLoadDuration", true), value);
}
public static event Delegates.get_IsUsingCustomLoadAnimation_WithArgs get_IsUsingCustomLoadAnimation
{
add => HookEndpointManager.Add<Delegates.get_IsUsingCustomLoadAnimation_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsUsingCustomLoadAnimation", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsUsingCustomLoadAnimation_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsUsingCustomLoadAnimation", true), value);
}
public static event Delegates.get_instance_WithArgs get_instance
{
add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_instance", false), value);
}
public static event Delegates.get_UnsafeInstance_WithArgs get_UnsafeInstance
{
add => HookEndpointManager.Add<Delegates.get_UnsafeInstance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_UnsafeInstance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_UnsafeInstance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_UnsafeInstance", false), value);
}
...
public static event On.GameManager.hook_BeginSceneTransition BeginSceneTransition
{
add => On.GameManager.BeginSceneTransition += value;
remove => On.GameManager.BeginSceneTransition -= value;
}
public static event On.GameManager.hook_BeginSceneTransitionRoutine BeginSceneTransitionRoutine
{
add => On.GameManager.BeginSceneTransitionRoutine += value;
remove => On.GameManager.BeginSceneTransitionRoutine -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.SaveGame_Action_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame", true), value);
remove => HookEndpointManager.Remove<Delegates.SaveGame_Action_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.SaveGame_int_Action_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame", true), value);
remove => HookEndpointManager.Remove<Delegates.SaveGame_int_Action_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame", true), value);
}
...
public static event On.GameManager.hook_FreezeMoment_float_float_float_float FreezeMoment_float_float_float_float
{
...
public static event On.GameManager.hook_ReturnToMainMenu ReturnToMainMenu
{
add => On.GameManager.ReturnToMainMenu += value;
remove => On.GameManager.ReturnToMainMenu -= value;
}
...
{
add => HookEndpointManager.Add<Delegates.OnDisengage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "Platform.IDisengageHandler.OnDisengage", true), value);
remove => HookEndpointManager.Remove<Delegates.OnDisengage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "Platform.IDisengageHandler.OnDisengage", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.orig_get_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_get_ui", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_get_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_get_ui", true), value);
}
public static event Delegates.orig_set_ui_WithArgs orig_set_ui
{
add => HookEndpointManager.Add<Delegates.orig_set_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_set_ui", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_set_ui_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_set_ui", true), value);
}
public static event Delegates.orig_OnApplicationQuit_WithArgs orig_OnApplicationQuit
{
add => HookEndpointManager.Add<Delegates.orig_OnApplicationQuit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnApplicationQuit", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_OnApplicationQuit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnApplicationQuit", true), value);
}
public static event Delegates.orig_LoadScene_WithArgs orig_LoadScene
{
add => HookEndpointManager.Add<Delegates.orig_LoadScene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_LoadScene", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_LoadScene_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_LoadScene", true), value);
}
public static event Delegates.orig_BeginSceneTransition_WithArgs orig_BeginSceneTransition
{
add => HookEndpointManager.Add<Delegates.orig_BeginSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_BeginSceneTransition_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition", true), value);
}
public static event Delegates.orig_ClearSaveFile_WithArgs orig_ClearSaveFile
{
add => HookEndpointManager.Add<Delegates.orig_ClearSaveFile_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_ClearSaveFile", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_ClearSaveFile_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_ClearSaveFile", true), value);
}
public static event Delegates.orig_PlayerDead_WithArgs orig_PlayerDead
{
add => HookEndpointManager.Add<Delegates.orig_PlayerDead_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_PlayerDead", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_PlayerDead_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_PlayerDead", true), value);
}
public static event Delegates.ModdedSavePath_WithArgs ModdedSavePath
{
add => HookEndpointManager.Add<Delegates.ModdedSavePath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "ModdedSavePath", false), value);
remove => HookEndpointManager.Remove<Delegates.ModdedSavePath_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "ModdedSavePath", false), value);
}
public static event Delegates.orig_SetupSceneRefs_WithArgs orig_SetupSceneRefs
{
add => HookEndpointManager.Add<Delegates.orig_SetupSceneRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_SetupSceneRefs", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_SetupSceneRefs_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_SetupSceneRefs", true), value);
}
public static event Delegates.orig_OnWillActivateFirstLevel_WithArgs orig_OnWillActivateFirstLevel
{
add => HookEndpointManager.Add<Delegates.orig_OnWillActivateFirstLevel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnWillActivateFirstLevel", true), value);
remove => HookEndpointManager.Remove<Delegates.orig_OnWillActivateFirstLevel_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnWillActivateFirstLevel", true), value);
}
public static event Delegates.PauseToggleDynamicMenu_WithArgs PauseToggleDynamicMenu
{
add => HookEndpointManager.Add<Delegates.PauseToggleDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseToggleDynamicMenu", true), value);
remove => HookEndpointManager.Remove<Delegates.PauseToggleDynamicMenu_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseToggleDynamicMenu", true), value);
}
}
