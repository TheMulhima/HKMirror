...
public static class Ontk2dUICamera
{
    ...
    public static class Delegates
    {
        ...
        public delegate void AssignRaycastLayerMask_WithArgs(Action<tk2dUICamera, LayerMask> orig, tk2dUICamera self,
            LayerMask mask);

        public delegate LayerMask get_FilteredMask_AfterArgs(Params_get_FilteredMask args, LayerMask ret);

        public delegate void get_FilteredMask_BeforeArgs(Params_get_FilteredMask args);

        public delegate LayerMask get_FilteredMask_WithArgs(Func<tk2dUICamera, LayerMask> orig, tk2dUICamera self);

        public delegate Camera get_HostCamera_AfterArgs(Params_get_HostCamera args, Camera ret);

        public delegate void get_HostCamera_BeforeArgs(Params_get_HostCamera args);

        public delegate Camera get_HostCamera_WithArgs(Func<tk2dUICamera, Camera> orig, tk2dUICamera self);
