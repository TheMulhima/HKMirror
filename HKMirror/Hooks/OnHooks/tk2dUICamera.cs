...
private static void AssignRaycastLayerMask(On.tk2dUICamera.orig_AssignRaycastLayerMask orig,tk2dUICamera self,  UnityEngine.LayerMask mask)
{
...
{
foreach (Delegates.AssignRaycastLayerMask_BeforeArgs toInvoke in _beforeAssignRaycastLayerMask.GetInvocationList())
{
try
{
...
{
foreach (Delegates.AssignRaycastLayerMask_AfterArgs toInvoke in _afterAssignRaycastLayerMask.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUICamera), "get_FilteredMask", true), get_FilteredMask);
...
private static UnityEngine.LayerMask get_FilteredMask(Func<tk2dUICamera, UnityEngine.LayerMask> orig, tk2dUICamera self)
{
...
public delegate void AssignRaycastLayerMask_WithArgs (Action<tk2dUICamera,  UnityEngine.LayerMask> orig, tk2dUICamera self,  UnityEngine.LayerMask mask);
public sealed class Params_get_FilteredMask
{
public tk2dUICamera self;
}
public delegate void get_FilteredMask_BeforeArgs(Params_get_FilteredMask args);
public delegate UnityEngine.LayerMask get_FilteredMask_AfterArgs(Params_get_FilteredMask args, UnityEngine.LayerMask ret);
public delegate UnityEngine.LayerMask get_FilteredMask_WithArgs (Func<tk2dUICamera, UnityEngine.LayerMask> orig, tk2dUICamera self);
...
public delegate UnityEngine.Camera get_HostCamera_WithArgs (Func<tk2dUICamera, UnityEngine.Camera> orig, tk2dUICamera self);
...
{
add => HookEndpointManager.Add<Delegates.get_FilteredMask_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUICamera), "get_FilteredMask", true), value);
remove => HookEndpointManager.Remove<Delegates.get_FilteredMask_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUICamera), "get_FilteredMask", true), value);
}
public static event Delegates.get_HostCamera_WithArgs get_HostCamera
{
add => HookEndpointManager.Add<Delegates.get_HostCamera_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUICamera), "get_HostCamera", true), value);
remove => HookEndpointManager.Remove<Delegates.get_HostCamera_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUICamera), "get_HostCamera", true), value);
}
