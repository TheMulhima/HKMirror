...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUILayout), "get_ItemCount", true), get_ItemCount);
...
private static void Reshape(On.tk2dUILayout.orig_Reshape orig,tk2dUILayout self,  UnityEngine.Vector3 dMin,  UnityEngine.Vector3 dMax,  bool updateChildren)
{
...
private static void SetBounds(On.tk2dUILayout.orig_SetBounds orig,tk2dUILayout self,  UnityEngine.Vector3 pMin,  UnityEngine.Vector3 pMax)
{
...
private static UnityEngine.Vector3 GetMinBounds(On.tk2dUILayout.orig_GetMinBounds orig,tk2dUILayout self)
{
...
private static UnityEngine.Vector3 GetMaxBounds(On.tk2dUILayout.orig_GetMaxBounds orig,tk2dUILayout self)
{
...
public delegate void Reshape_WithArgs (Action<tk2dUILayout,  UnityEngine.Vector3,  UnityEngine.Vector3,  bool> orig, tk2dUILayout self,  UnityEngine.Vector3 dMin,  UnityEngine.Vector3 dMax,  bool updateChildren);
public sealed class Params_SetBounds
{
public tk2dUILayout self;
public UnityEngine.Vector3 pMin;
public UnityEngine.Vector3 pMax;
}
...
public delegate void SetBounds_WithArgs (Action<tk2dUILayout,  UnityEngine.Vector3,  UnityEngine.Vector3> orig, tk2dUILayout self,  UnityEngine.Vector3 pMin,  UnityEngine.Vector3 pMax);
public sealed class Params_GetMinBounds
{
public tk2dUILayout self;
}
public delegate void GetMinBounds_BeforeArgs(Params_GetMinBounds args);
public delegate UnityEngine.Vector3 GetMinBounds_AfterArgs(Params_GetMinBounds args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 GetMinBounds_WithArgs (Func<tk2dUILayout, UnityEngine.Vector3> orig, tk2dUILayout self);
public sealed class Params_GetMaxBounds
{
public tk2dUILayout self;
}
public delegate void GetMaxBounds_BeforeArgs(Params_GetMaxBounds args);
public delegate UnityEngine.Vector3 GetMaxBounds_AfterArgs(Params_GetMaxBounds args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 GetMaxBounds_WithArgs (Func<tk2dUILayout, UnityEngine.Vector3> orig, tk2dUILayout self);
...
{
add => HookEndpointManager.Add<Delegates.get_ItemCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUILayout), "get_ItemCount", true), value);
remove => HookEndpointManager.Remove<Delegates.get_ItemCount_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dUILayout), "get_ItemCount", true), value);
}
