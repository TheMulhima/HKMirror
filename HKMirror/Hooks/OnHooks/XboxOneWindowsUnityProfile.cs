...
public static class OnXboxOneWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XboxOneWindowsUnityProfile> orig, XboxOneWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneWindowsUnityProfile> orig, XboxOneWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public XboxOneWindowsUnityProfile self;
        }
    }
