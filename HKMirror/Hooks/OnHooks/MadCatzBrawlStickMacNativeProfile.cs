...
public static class OnMadCatzBrawlStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzBrawlStickMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MadCatzBrawlStickMacNativeProfile> orig,
            MadCatzBrawlStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzBrawlStickMacNativeProfile> orig,
            MadCatzBrawlStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzBrawlStickMacNativeProfile self;
        }
    }
