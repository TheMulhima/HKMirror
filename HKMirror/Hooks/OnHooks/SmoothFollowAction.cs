...
public static class OnSmoothFollowAction
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothFollowAction), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SmoothFollowAction> orig,
            HutongGames.PlayMaker.Actions.SmoothFollowAction self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothFollowAction),
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.SmoothFollowAction> orig,
            HutongGames.PlayMaker.Actions.SmoothFollowAction self)
        {
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.SmoothFollowAction> orig,
            HutongGames.PlayMaker.Actions.SmoothFollowAction self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothFollowAction> orig,
            HutongGames.PlayMaker.Actions.SmoothFollowAction self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothFollowAction> orig,
            HutongGames.PlayMaker.Actions.SmoothFollowAction self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothFollowAction> orig,
            HutongGames.PlayMaker.Actions.SmoothFollowAction self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothFollowAction), "Reset", true),
                value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothFollowAction), "OnPreprocess",
                    true), value);
        ...
        public static event Delegates.OnLateUpdate_WithArgs OnLateUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnLateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothFollowAction), "OnLateUpdate",
                    true), value);
