...
public static class OnMadCatzBeatPadMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzBeatPadMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MadCatzBeatPadMacNativeProfile> orig, MadCatzBeatPadMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzBeatPadMacNativeProfile> orig,
            MadCatzBeatPadMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzBeatPadMacNativeProfile self;
        }
    }
