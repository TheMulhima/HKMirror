...
public static class OnVector3Compare
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self)
        {
        ...
        internal static void HookDoCompare()
        {
            if (!HookedList.Contains("DoCompare"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "DoCompare",
                        true), DoCompare);
            }
        }
        ...
        private static void DoCompare(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self)
        {
        ...
        internal static void HookErrorCheck()
        {
            if (!HookedList.Contains("ErrorCheck"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "ErrorCheck",
                        true), ErrorCheck);
            }
        }
        ...
        private static string ErrorCheck(Func<HutongGames.PlayMaker.Actions.Vector3Compare, string> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self);
        ...
        public delegate void DoCompare_WithArgs(Action<HutongGames.PlayMaker.Actions.Vector3Compare> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<HutongGames.PlayMaker.Actions.Vector3Compare, string> orig,
            HutongGames.PlayMaker.Actions.Vector3Compare self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "OnUpdate", true),
                value);
        ...
        public static event Delegates.DoCompare_WithArgs DoCompare
        {
            add => HookEndpointManager.Add<Delegates.DoCompare_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Vector3Compare), "DoCompare", true),
                value);
