...
public static class OnVector3Compare
{
    ...
    public static class Delegates
    {
        ...
        public delegate void DoCompare_WithArgs(Action<Vector3Compare> orig, Vector3Compare self);
        ...
        public delegate string ErrorCheck_WithArgs(Func<Vector3Compare, string> orig, Vector3Compare self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<Vector3Compare> orig, Vector3Compare self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<Vector3Compare> orig, Vector3Compare self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<Vector3Compare> orig, Vector3Compare self);
