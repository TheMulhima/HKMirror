...
public static class OnNVidiaShieldWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NVidiaShieldWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NVidiaShieldWindowsUnityProfile> orig, NVidiaShieldWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NVidiaShieldWindowsUnityProfile> orig,
            NVidiaShieldWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public NVidiaShieldWindowsUnityProfile self;
        }
    }
