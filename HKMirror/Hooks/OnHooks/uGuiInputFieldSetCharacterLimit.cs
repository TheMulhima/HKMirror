...
public static class OnuGuiInputFieldSetCharacterLimit
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit), "DoSetValue", true),
                    DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit), "OnExit", true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self);
        ...
        public delegate void OnEnter_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit> orig,
            HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiInputFieldSetCharacterLimit),
                    "Reset", true), value);
