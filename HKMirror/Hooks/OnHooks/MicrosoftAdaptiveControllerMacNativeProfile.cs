...
public static class OnMicrosoftAdaptiveControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MicrosoftAdaptiveControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MicrosoftAdaptiveControllerMacNativeProfile> orig,
            MicrosoftAdaptiveControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MicrosoftAdaptiveControllerMacNativeProfile> orig,
            MicrosoftAdaptiveControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MicrosoftAdaptiveControllerMacNativeProfile self;
        }
    }
