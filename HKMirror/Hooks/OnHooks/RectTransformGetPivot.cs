...
public static class OnRectTransformGetPivot
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetPivot), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<RectTransformGetPivot> orig, RectTransformGetPivot self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetPivot), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<RectTransformGetPivot> orig, RectTransformGetPivot self)
        {
        ...
        internal static void HookOnActionUpdate()
        {
            if (!HookedList.Contains("OnActionUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetPivot), "OnActionUpdate"),
                    OnActionUpdate);
            }
        }
        ...
        private static void OnActionUpdate(Action<RectTransformGetPivot> orig, RectTransformGetPivot self)
        {
        ...
        internal static void HookDoGetValues()
        {
            if (!HookedList.Contains("DoGetValues"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RectTransformGetPivot), "DoGetValues"), DoGetValues);
            }
        }
        ...
        private static void DoGetValues(Action<RectTransformGetPivot> orig, RectTransformGetPivot self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoGetValues_WithArgs(Action<RectTransformGetPivot> orig, RectTransformGetPivot self);
        ...
        public delegate void OnActionUpdate_WithArgs(Action<RectTransformGetPivot> orig, RectTransformGetPivot self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<RectTransformGetPivot> orig, RectTransformGetPivot self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<RectTransformGetPivot> orig, RectTransformGetPivot self);

        public sealed class Params_Reset
        {
            public RectTransformGetPivot self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RectTransformGetPivot), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RectTransformGetPivot), "OnEnter"), value);
