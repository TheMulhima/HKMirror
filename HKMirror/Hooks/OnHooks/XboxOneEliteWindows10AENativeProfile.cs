...
public static class OnXboxOneEliteWindows10AENativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XboxOneEliteWindows10AENativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<XboxOneEliteWindows10AENativeProfile> orig,
            XboxOneEliteWindows10AENativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XboxOneEliteWindows10AENativeProfile> orig,
            XboxOneEliteWindows10AENativeProfile self);

        public sealed class Params_Define
        {
            public XboxOneEliteWindows10AENativeProfile self;
        }
    }
