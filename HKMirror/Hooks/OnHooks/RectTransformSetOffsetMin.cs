...
public static class OnRectTransformSetOffsetMin
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin),
                        "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self)
        {
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self)
        {
        ...
        private static void OnActionUpdate(Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self)
        {
        ...
        internal static void HookDoSetOffsetMin()
        {
            if (!HookedList.Contains("DoSetOffsetMin"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin),
                        "DoSetOffsetMin", true), DoSetOffsetMin);
            }
        }
        ...
        private static void DoSetOffsetMin(Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self);
        ...
        public delegate void OnActionUpdate_WithArgs(
            Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self);
        ...
        public delegate void DoSetOffsetMin_WithArgs(
            Action<HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin> orig,
            HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin), "Reset",
                    true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoSetOffsetMin_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin),
                    "DoSetOffsetMin", true), value);
            remove => HookEndpointManager.Remove<Delegates.DoSetOffsetMin_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.RectTransformSetOffsetMin),
                    "DoSetOffsetMin", true), value);
        }
    }
