...
public static class OnRunAway
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RunAway), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<RunAway> orig, RunAway self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RunAway), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<RunAway> orig, RunAway self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RunAway), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<RunAway> orig, RunAway self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RunAway), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<RunAway> orig, RunAway self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RunAway), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<RunAway> orig, RunAway self)
        {
        ...
        internal static void HookDoChase()
        {
            if (!HookedList.Contains("DoChase"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(RunAway), "DoChase"), DoChase);
            }
        }
        ...
        private static void DoChase(Action<RunAway> orig, RunAway self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<RunAway> orig, RunAway self);

        public delegate void DoChase_AfterArgs(Params_DoChase args);

        public delegate void DoChase_BeforeArgs(Params_DoChase args);

        public delegate void DoChase_WithArgs(Action<RunAway> orig, RunAway self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<RunAway> orig, RunAway self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<RunAway> orig, RunAway self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<RunAway> orig, RunAway self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<RunAway> orig, RunAway self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RunAway), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RunAway), "Awake"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RunAway), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RunAway), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RunAway), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoChase_WithArgs DoChase
        {
            add => HookEndpointManager.Add<Delegates.DoChase_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(RunAway), "DoChase"), value);
