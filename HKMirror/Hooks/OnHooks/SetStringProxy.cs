...
public static class OnSetStringProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetStringProxy), "Invoke"), Invoke);
            }
        }
        ...
        private static string Invoke(Func<SetStringProxy, string, string, string> orig, SetStringProxy self,
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetStringProxy), "EndInvoke"), EndInvoke);
            }
        }
        ...
        private static string EndInvoke(Func<SetStringProxy, IAsyncResult, string> orig, SetStringProxy self,
            IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate string EndInvoke_WithArgs(Func<SetStringProxy, IAsyncResult, string> orig, SetStringProxy self,
            IAsyncResult result);
        ...
        public delegate string Invoke_WithArgs(Func<SetStringProxy, string, string, string> orig, SetStringProxy self,
            string name, string res);
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetStringProxy), "Invoke"), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetStringProxy), "EndInvoke"), value);
