...
/// <summary>
/// Contains different types of On Hooks for SetStringProxy class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnSetStringProxy
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "Invoke", true), Invoke);
...
private static string Invoke(Func<Modding.Delegates.SetStringProxy,  string,  string, string> orig, Modding.Delegates.SetStringProxy self,  string name,  string res)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "EndInvoke", true), EndInvoke);
...
private static string EndInvoke(Func<Modding.Delegates.SetStringProxy,  System.IAsyncResult, string> orig, Modding.Delegates.SetStringProxy self,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.SetStringProxy self;
public string name;
public string res;
}
...
public delegate string Invoke_WithArgs (Func<Modding.Delegates.SetStringProxy,  string,  string, string> orig, Modding.Delegates.SetStringProxy self,  string name,  string res);
...
public delegate string EndInvoke_WithArgs (Func<Modding.Delegates.SetStringProxy,  System.IAsyncResult, string> orig, Modding.Delegates.SetStringProxy self,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "EndInvoke", true), value);
}
}
