...
public static class OnSetStringProxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static string Invoke(Func<Modding.Delegates.SetStringProxy, string, string, string> orig,
            Modding.Delegates.SetStringProxy self, string name, string res)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static string EndInvoke(Func<Modding.Delegates.SetStringProxy, System.IAsyncResult, string> orig,
            Modding.Delegates.SetStringProxy self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate string Invoke_WithArgs(Func<Modding.Delegates.SetStringProxy, string, string, string> orig,
            Modding.Delegates.SetStringProxy self, string name, string res);
        ...
        public delegate string EndInvoke_WithArgs(
            Func<Modding.Delegates.SetStringProxy, System.IAsyncResult, string> orig,
            Modding.Delegates.SetStringProxy self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetStringProxy), "EndInvoke", true), value);
