...
public static class OnGUILabel
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILabel), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUILabel> orig, GUILabel self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUILabel> orig, GUILabel self);

        public sealed class Params_OnGUI
        {
            public GUILabel self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUILabel), "OnGUI"), value);
