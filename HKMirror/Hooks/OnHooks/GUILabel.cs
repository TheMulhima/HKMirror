...
/// <summary>
/// Contains different types of On Hooks for GUILabel class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnGUILabel
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILabel), "OnGUI", true), OnGUI);

}
}
internal static event Delegates.OnGUI_BeforeArgs _beforeOnGUI;
internal static event Delegates.OnGUI_AfterArgs _afterOnGUI;
private static void OnGUI(Action<HutongGames.PlayMaker.Actions.GUILabel> orig, HutongGames.PlayMaker.Actions.GUILabel self)
{
...
{
public HutongGames.PlayMaker.Actions.GUILabel self;
}
public delegate void OnGUI_BeforeArgs(Params_OnGUI args);
public delegate void OnGUI_AfterArgs(Params_OnGUI args);
public delegate void OnGUI_WithArgs (Action<HutongGames.PlayMaker.Actions.GUILabel> orig, HutongGames.PlayMaker.Actions.GUILabel self);
}
...
{
add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILabel), "OnGUI", true), value);
remove => HookEndpointManager.Remove<Delegates.OnGUI_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GUILabel), "OnGUI", true), value);
}
}
