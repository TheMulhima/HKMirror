...
public static class OnGenericLinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.GenericLinuxUnityProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.GenericLinuxUnityProfile> orig,
            InControl.UnityDeviceProfiles.GenericLinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<InControl.UnityDeviceProfiles.GenericLinuxUnityProfile> orig,
            InControl.UnityDeviceProfiles.GenericLinuxUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.GenericLinuxUnityProfile), "Define",
                    true), value);
