...
public static class OnGenericLinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GenericLinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GenericLinuxUnityProfile> orig, GenericLinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GenericLinuxUnityProfile> orig, GenericLinuxUnityProfile self);

        public sealed class Params_Define
        {
            public GenericLinuxUnityProfile self;
        }
    }
