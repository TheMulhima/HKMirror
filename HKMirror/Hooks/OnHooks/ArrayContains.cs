...
public static class OnArrayContains
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayContains), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.ArrayContains> orig,
            HutongGames.PlayMaker.Actions.ArrayContains self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayContains), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.ArrayContains> orig,
            HutongGames.PlayMaker.Actions.ArrayContains self)
        {
        ...
        internal static void HookDoCheckContainsValue()
        {
            if (!HookedList.Contains("DoCheckContainsValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayContains),
                        "DoCheckContainsValue", true), DoCheckContainsValue);
            }
        }
        ...
        private static void DoCheckContainsValue(Action<HutongGames.PlayMaker.Actions.ArrayContains> orig,
            HutongGames.PlayMaker.Actions.ArrayContains self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayContains> orig,
            HutongGames.PlayMaker.Actions.ArrayContains self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayContains> orig,
            HutongGames.PlayMaker.Actions.ArrayContains self);
        ...
        public delegate void DoCheckContainsValue_WithArgs(Action<HutongGames.PlayMaker.Actions.ArrayContains> orig,
            HutongGames.PlayMaker.Actions.ArrayContains self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayContains), "OnEnter", true),
                value);
        ...
        public static event Delegates.DoCheckContainsValue_WithArgs DoCheckContainsValue
        {
            add => HookEndpointManager.Add<Delegates.DoCheckContainsValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.ArrayContains),
                    "DoCheckContainsValue", true), value);
