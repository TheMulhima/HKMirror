    ...
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "Invoke",
                        true), Invoke);
            }
        }
        ...
        private static void Invoke(
            Action<Modding.Delegates.OnReceiveDeathEventHandler, EnemyDeathEffects, bool, float?, bool, bool, bool>
                orig, Modding.Delegates.OnReceiveDeathEventHandler self, EnemyDeathEffects enemyDeathEffects,
            bool eventAlreadyReceived, float? attackDirection, bool resetDeathEvent, bool spellBurn, bool isWatery)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "EndInvoke",
                        true), EndInvoke);
            }
        }
        ...
        private static void EndInvoke(
            Action<Modding.Delegates.OnReceiveDeathEventHandler, float?, bool, bool, bool, System.IAsyncResult> orig,
            Modding.Delegates.OnReceiveDeathEventHandler self, float? attackDirection, bool resetDeathEvent,
            bool spellBurn, bool isWatery, System.IAsyncResult result)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "Invoke", true),
                value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "EndInvoke", true),
                value);
