...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "Invoke", true), Invoke);
...
private static void Invoke(Action<Modding.Delegates.OnReceiveDeathEventHandler,  EnemyDeathEffects,  bool,  float?,  bool,  bool,  bool> orig, Modding.Delegates.OnReceiveDeathEventHandler self,  EnemyDeathEffects enemyDeathEffects,  bool eventAlreadyReceived,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery)
{
Delegates.Params_Invoke @params = new() 
{
self = self
, enemyDeathEffects = enemyDeathEffects
, eventAlreadyReceived = eventAlreadyReceived
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "EndInvoke", true), EndInvoke);
...
private static void EndInvoke(Action<Modding.Delegates.OnReceiveDeathEventHandler,  float?,  bool,  bool,  bool,  System.IAsyncResult> orig, Modding.Delegates.OnReceiveDeathEventHandler self,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery,  System.IAsyncResult result)
{
...
{
public Modding.Delegates.OnReceiveDeathEventHandler self;
...
public delegate void Invoke_WithArgs (Action<Modding.Delegates.OnReceiveDeathEventHandler,  EnemyDeathEffects,  bool,  float?,  bool,  bool,  bool> orig, Modding.Delegates.OnReceiveDeathEventHandler self,  EnemyDeathEffects enemyDeathEffects,  bool eventAlreadyReceived,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery);
...
public delegate void EndInvoke_WithArgs (Action<Modding.Delegates.OnReceiveDeathEventHandler,  float?,  bool,  bool,  bool,  System.IAsyncResult> orig, Modding.Delegates.OnReceiveDeathEventHandler self,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery,  System.IAsyncResult result);
}
...
{
add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "Invoke", true), value);
remove => HookEndpointManager.Remove<Delegates.Invoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "Invoke", true), value);
}
public static event Delegates.EndInvoke_WithArgs EndInvoke
{
add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "EndInvoke", true), value);
remove => HookEndpointManager.Remove<Delegates.EndInvoke_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.OnReceiveDeathEventHandler), "EndInvoke", true), value);
}
}
