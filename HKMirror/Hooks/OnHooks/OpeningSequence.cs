...
private static System.Collections.IEnumerator StartAsync(On.OpeningSequence.orig_StartAsync orig,OpeningSequence self)
{
...
private static System.Collections.IEnumerator StartSync(On.OpeningSequence.orig_StartSync orig,OpeningSequence self)
{
...
private static bool IsLevelReady(On.OpeningSequence.orig_IsLevelReady orig, UnityEngine.AsyncOperation operation)
{
...
{
foreach (Delegates.OnChangingSequences_BeforeArgs toInvoke in _beforeOnChangingSequences.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnChangingSequences_AfterArgs toInvoke in _afterOnChangingSequences.GetInvocationList())
{
try
{
...
public delegate System.Collections.IEnumerator Start_WithArgs (Func<OpeningSequence, System.Collections.IEnumerator> orig, OpeningSequence self);
public sealed class Params_StartAsync
{
public OpeningSequence self;
}
public delegate void StartAsync_BeforeArgs(Params_StartAsync args);
public delegate System.Collections.IEnumerator StartAsync_AfterArgs(Params_StartAsync args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator StartAsync_WithArgs (Func<OpeningSequence, System.Collections.IEnumerator> orig, OpeningSequence self);
public sealed class Params_StartSync
{
public OpeningSequence self;
}
public delegate void StartSync_BeforeArgs(Params_StartSync args);
public delegate System.Collections.IEnumerator StartSync_AfterArgs(Params_StartSync args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator StartSync_WithArgs (Func<OpeningSequence, System.Collections.IEnumerator> orig, OpeningSequence self);
...
public delegate bool IsLevelReady_WithArgs (Func< UnityEngine.AsyncOperation, bool> orig,  UnityEngine.AsyncOperation operation);
...
public delegate System.Collections.IEnumerator Skip_WithArgs (Func<OpeningSequence, System.Collections.IEnumerator> orig, OpeningSequence self);
