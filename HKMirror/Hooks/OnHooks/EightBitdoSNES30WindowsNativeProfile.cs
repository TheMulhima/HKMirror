...
public static class OnEightBitdoSNES30WindowsNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.EightBitdoSNES30WindowsNativeProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.NativeDeviceProfiles.EightBitdoSNES30WindowsNativeProfile> orig,
            InControl.NativeDeviceProfiles.EightBitdoSNES30WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.NativeDeviceProfiles.EightBitdoSNES30WindowsNativeProfile> orig,
            InControl.NativeDeviceProfiles.EightBitdoSNES30WindowsNativeProfile self);
    }
