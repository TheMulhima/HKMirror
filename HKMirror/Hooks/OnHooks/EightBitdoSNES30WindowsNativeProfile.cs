...
public static class OnEightBitdoSNES30WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSNES30WindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSNES30WindowsNativeProfile> orig,
            EightBitdoSNES30WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSNES30WindowsNativeProfile> orig,
            EightBitdoSNES30WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSNES30WindowsNativeProfile self;
        }
    }
