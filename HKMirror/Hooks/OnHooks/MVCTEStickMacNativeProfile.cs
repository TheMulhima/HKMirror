...
public static class OnMVCTEStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MVCTEStickMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MVCTEStickMacNativeProfile> orig, MVCTEStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MVCTEStickMacNativeProfile> orig, MVCTEStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public MVCTEStickMacNativeProfile self;
        }
    }
