...
public static class OnMenuPreventDeselect
{
    internal static class HookHandler
    {
        ...
        internal static void HookStart()
        {
            if (!HookedList.Contains("Start"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "Start", true),
                    Start);
            }
        }
        ...
        private static void Start(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self)
        {
        ...
        internal static void HookOnSelect()
        {
            if (!HookedList.Contains("OnSelect"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "OnSelect", true),
                    OnSelect);
            }
        }
        ...
        private static void OnSelect(
            Action<UnityEngine.UI.MenuPreventDeselect, UnityEngine.EventSystems.BaseEventData> orig,
            UnityEngine.UI.MenuPreventDeselect self, UnityEngine.EventSystems.BaseEventData eventData)
        {
        ...
        internal static void HookOnDeselect()
        {
            if (!HookedList.Contains("OnDeselect"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "OnDeselect", true),
                    OnDeselect);
            }
        }
        ...
        internal static void HookOnCancel()
        {
            if (!HookedList.Contains("OnCancel"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "OnCancel", true),
                    OnCancel);
            }
        }
        ...
        internal static void HookValidateDeselect()
        {
            if (!HookedList.Contains("ValidateDeselect"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "ValidateDeselect",
                        true), ValidateDeselect);
            }
        }
        ...
        private static System.Collections.IEnumerator ValidateDeselect(
            Func<UnityEngine.UI.MenuPreventDeselect, System.Collections.IEnumerator> orig,
            UnityEngine.UI.MenuPreventDeselect self)
        {
        ...
        internal static void HookHookUpAudioPlayer()
        {
            if (!HookedList.Contains("HookUpAudioPlayer"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "HookUpAudioPlayer",
                        true), HookUpAudioPlayer);
            }
        }
        ...
        private static void HookUpAudioPlayer(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self)
        {
        ...
        internal static void HookForceDeselect()
        {
            if (!HookedList.Contains("ForceDeselect"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "ForceDeselect", true),
                    ForceDeselect);
            }
        }
        ...
        private static void ForceDeselect(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self)
        {
        ...
        internal static void HookSimulateSubmit()
        {
            if (!HookedList.Contains("SimulateSubmit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "SimulateSubmit", true),
                    SimulateSubmit);
            }
        }
        ...
        private static void SimulateSubmit(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self)
        {
        ...
        internal static void Hookget_customCancelAction()
        {
            if (!HookedList.Contains("get_customCancelAction"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "get_customCancelAction",
        ...
        private static System.Action<UnityEngine.UI.MenuPreventDeselect> get_customCancelAction(
            Func<UnityEngine.UI.MenuPreventDeselect, System.Action<UnityEngine.UI.MenuPreventDeselect>> orig,
            UnityEngine.UI.MenuPreventDeselect self)
        {
        ...
        internal static void Hookset_customCancelAction()
        {
            if (!HookedList.Contains("set_customCancelAction"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "set_customCancelAction",
        ...
        private static void set_customCancelAction(
            Action<UnityEngine.UI.MenuPreventDeselect, System.Action<UnityEngine.UI.MenuPreventDeselect>> orig,
            UnityEngine.UI.MenuPreventDeselect self, System.Action<UnityEngine.UI.MenuPreventDeselect> value)
        {
        ...
        internal static void Hookorig_OnCancel()
        {
            if (!HookedList.Contains("orig_OnCancel"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "orig_OnCancel", true),
                    orig_OnCancel);
            }
        }
    ...
    public static class Delegates
    {
        ...
        public delegate void Start_WithArgs(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self);
        ...
        public delegate void HookUpAudioPlayer_WithArgs(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self);
        ...
        public delegate void ForceDeselect_WithArgs(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self);
        ...
        public delegate void SimulateSubmit_WithArgs(Action<UnityEngine.UI.MenuPreventDeselect> orig,
            UnityEngine.UI.MenuPreventDeselect self);
        ...
        public delegate System.Action<UnityEngine.UI.MenuPreventDeselect> get_customCancelAction_AfterArgs(
            Params_get_customCancelAction args, System.Action<UnityEngine.UI.MenuPreventDeselect> ret);

        public delegate System.Action<UnityEngine.UI.MenuPreventDeselect> get_customCancelAction_WithArgs(
            Func<UnityEngine.UI.MenuPreventDeselect, System.Action<UnityEngine.UI.MenuPreventDeselect>> orig,
            UnityEngine.UI.MenuPreventDeselect self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Start_WithArgs Start
        {
            add => HookEndpointManager.Add<Delegates.Start_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "Start", true), value);
        ...
        public static event Delegates.OnSelect_WithArgs OnSelect
        {
            add => HookEndpointManager.Add<Delegates.OnSelect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "OnSelect", true), value);
        ...
        public static event Delegates.OnDeselect_WithArgs OnDeselect
        {
            add => HookEndpointManager.Add<Delegates.OnDeselect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "OnDeselect", true), value);
        ...
        public static event Delegates.OnCancel_WithArgs OnCancel
        {
            add => HookEndpointManager.Add<Delegates.OnCancel_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "OnCancel", true), value);
        ...
        public static event Delegates.ValidateDeselect_WithArgs ValidateDeselect
        {
            add => HookEndpointManager.Add<Delegates.ValidateDeselect_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "ValidateDeselect", true),
                value);
        ...
        public static event Delegates.HookUpAudioPlayer_WithArgs HookUpAudioPlayer
        {
            add => HookEndpointManager.Add<Delegates.HookUpAudioPlayer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityEngine.UI.MenuPreventDeselect), "HookUpAudioPlayer", true),
                value);
