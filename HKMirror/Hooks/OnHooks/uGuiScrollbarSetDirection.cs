...
public static class OnuGuiScrollbarSetDirection
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetDirection), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<uGuiScrollbarSetDirection> orig, uGuiScrollbarSetDirection self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetDirection), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<uGuiScrollbarSetDirection> orig, uGuiScrollbarSetDirection self)
        {
        ...
        internal static void HookDoSetValue()
        {
            if (!HookedList.Contains("DoSetValue"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetDirection), "DoSetValue"), DoSetValue);
            }
        }
        ...
        private static void DoSetValue(Action<uGuiScrollbarSetDirection> orig, uGuiScrollbarSetDirection self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(uGuiScrollbarSetDirection), "OnExit"), OnExit);
            }
        }
        ...
        private static void OnExit(Action<uGuiScrollbarSetDirection> orig, uGuiScrollbarSetDirection self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetValue_WithArgs(Action<uGuiScrollbarSetDirection> orig,
            uGuiScrollbarSetDirection self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<uGuiScrollbarSetDirection> orig, uGuiScrollbarSetDirection self);

        public delegate void OnExit_AfterArgs(Params_OnExit args);

        public delegate void OnExit_BeforeArgs(Params_OnExit args);

        public delegate void OnExit_WithArgs(Action<uGuiScrollbarSetDirection> orig, uGuiScrollbarSetDirection self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<uGuiScrollbarSetDirection> orig, uGuiScrollbarSetDirection self);

        public sealed class Params_Reset
        {
            public uGuiScrollbarSetDirection self;
        }
