...
public static class OnEightBitdoSN30ProAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoSN30ProAndroidUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoSN30ProAndroidUnityProfile> orig,
            EightBitdoSN30ProAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoSN30ProAndroidUnityProfile> orig,
            EightBitdoSN30ProAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public EightBitdoSN30ProAndroidUnityProfile self;
        }
    }
