...
public static class OnGameStickLinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameStickLinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameStickLinuxUnityProfile> orig, GameStickLinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameStickLinuxUnityProfile> orig, GameStickLinuxUnityProfile self);

        public sealed class Params_Define
        {
            public GameStickLinuxUnityProfile self;
        }
    }
