...
public static class OnWakeAllRigidBodies2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d),
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self)
        {
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self)
        {
        ...
        private static void DoWakeAll(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self);
        ...
        public delegate void DoWakeAll_WithArgs(Action<HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d> orig,
            HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d), "OnEnter",
                    true), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d), "OnUpdate",
                    true), value);
        ...
        public static event Delegates.DoWakeAll_WithArgs DoWakeAll
        {
            add => HookEndpointManager.Add<Delegates.DoWakeAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.WakeAllRigidBodies2d), "DoWakeAll",
                    true), value);
