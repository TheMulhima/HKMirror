...
public static class OnTMP_Glyph
{
    ...
    {
        public delegate TMP_Glyph Clone_AfterArgs(Params_Clone args, TMP_Glyph ret);

        public delegate void Clone_BeforeArgs(Params_Clone args);

        public delegate TMP_Glyph Clone_WithArgs(Func<TMP_Glyph, TMP_Glyph> orig, TMP_Glyph source);
