...
new Hook(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_FadeByController", true), get_FadeByController);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "set_FadeByController", true), set_FadeByController);
...
public delegate void set_FadeByController_WithArgs (Action<FadeSequence,  float> orig, FadeSequence self,  float value);
...
{
add => HookEndpointManager.Add<Delegates.get_IsSkipped_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_IsSkipped", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsSkipped_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_IsSkipped", true), value);
}
public static event Delegates.get_FadeRate_WithArgs get_FadeRate
{
add => HookEndpointManager.Add<Delegates.get_FadeRate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_FadeRate", true), value);
remove => HookEndpointManager.Remove<Delegates.get_FadeRate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_FadeRate", true), value);
}
public static event Delegates.get_FadeByController_WithArgs get_FadeByController
{
add => HookEndpointManager.Add<Delegates.get_FadeByController_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_FadeByController", true), value);
remove => HookEndpointManager.Remove<Delegates.get_FadeByController_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_FadeByController", true), value);
}
public static event Delegates.set_FadeByController_WithArgs set_FadeByController
{
add => HookEndpointManager.Add<Delegates.set_FadeByController_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "set_FadeByController", true), value);
remove => HookEndpointManager.Remove<Delegates.set_FadeByController_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "set_FadeByController", true), value);
}
public static event Delegates.get_IsPlaying_WithArgs get_IsPlaying
{
add => HookEndpointManager.Add<Delegates.get_IsPlaying_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_IsPlaying", true), value);
remove => HookEndpointManager.Remove<Delegates.get_IsPlaying_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(FadeSequence), "get_IsPlaying", true), value);
}
