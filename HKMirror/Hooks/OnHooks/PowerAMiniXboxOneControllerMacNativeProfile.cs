...
public static class OnPowerAMiniXboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.PowerAMiniXboxOneControllerMacNativeProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.PowerAMiniXboxOneControllerMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.PowerAMiniXboxOneControllerMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.PowerAMiniXboxOneControllerMacNativeProfile), "Define", true),
                value);
