...
public static class OnPowerAMiniXboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PowerAMiniXboxOneControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PowerAMiniXboxOneControllerMacNativeProfile> orig,
            PowerAMiniXboxOneControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PowerAMiniXboxOneControllerMacNativeProfile> orig,
            PowerAMiniXboxOneControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PowerAMiniXboxOneControllerMacNativeProfile self;
        }
    }
