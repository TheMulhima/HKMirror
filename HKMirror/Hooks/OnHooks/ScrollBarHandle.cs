...
private static void UpdatePosition(On.ScrollBarHandle.orig_UpdatePosition orig,ScrollBarHandle self,  float value)
{
...
public delegate void UpdatePosition_WithArgs (Action<ScrollBarHandle,  float> orig, ScrollBarHandle self,  float value);
}
