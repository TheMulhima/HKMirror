...
public static class OnXbox360WindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360WindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360WindowsUnityProfile> orig, Xbox360WindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360WindowsUnityProfile> orig, Xbox360WindowsUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360WindowsUnityProfile self;
        }
    }
