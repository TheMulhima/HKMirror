...
public static class OnSecurePlayerPrefs
{
    internal static class HookHandler
    {
        ...
        internal static void HookEncrypt()
        {
            if (!HookedList.Contains("Encrypt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "Encrypt", false),
                    Encrypt);
            }
        }
        ...
        internal static void HookDecrypt()
        {
            if (!HookedList.Contains("Decrypt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "Decrypt", false),
                    Decrypt);
            }
        }
        ...
        internal static void HookStringToUTF8ByteArray()
        {
            if (!HookedList.Contains("StringToUTF8ByteArray"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "StringToUTF8ByteArray",
                        false), StringToUTF8ByteArray);
            }
        }
        ...
        private static byte[] StringToUTF8ByteArray(Func<string, byte[]> orig, string pXmlString)
        {
            ...
            {
                foreach (Delegates.StringToUTF8ByteArray_BeforeArgs toInvoke in _beforeStringToUTF8ByteArray
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.StringToUTF8ByteArray_AfterArgs toInvoke in _afterStringToUTF8ByteArray
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void HookSetInt()
        {
            if (!HookedList.Contains("SetInt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetInt", false),
                    SetInt);
            }
        }
        ...
        internal static void HookSetString()
        {
            if (!HookedList.Contains("SetString"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetString", false),
                    SetString);
            }
        }
        ...
        internal static void HookSetFloat()
        {
            if (!HookedList.Contains("SetFloat"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetFloat", false),
                    SetFloat);
            }
        }
        ...
        internal static void HookSetBool()
        {
            if (!HookedList.Contains("SetBool"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetBool", false),
                    SetBool);
            }
        }
        ...
        internal static void HookGetString()
        {
            if (!HookedList.Contains("GetString"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetString", false),
                    GetString);
            }
        }
        ...
        internal static void HookGetInt()
        {
            if (!HookedList.Contains("GetInt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetInt", false),
                    GetInt);
            }
        }
        ...
        internal static void HookGetFloat()
        {
            if (!HookedList.Contains("GetFloat"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetFloat", false),
                    GetFloat);
            }
        }
        ...
        internal static void HookGetBool()
        {
            if (!HookedList.Contains("GetBool"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetBool", false),
                    GetBool);
            }
        }
        ...
        internal static void HookDeleteKey()
        {
            if (!HookedList.Contains("DeleteKey"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "DeleteKey", false),
                    DeleteKey);
            }
        }
        ...
        internal static void HookDeleteAll()
        {
            if (!HookedList.Contains("DeleteAll"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "DeleteAll", false),
                    DeleteAll);
            }
        }
        ...
        internal static void HookHasKey()
        {
            if (!HookedList.Contains("HasKey"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "HasKey", false),
                    HasKey);
            }
        }
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.Encrypt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "Encrypt", false), value);
            remove => HookEndpointManager.Remove<Delegates.Encrypt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "Encrypt", false), value);
        }

        public static event Delegates.Decrypt_WithArgs Decrypt
        {
            add => HookEndpointManager.Add<Delegates.Decrypt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "Decrypt", false), value);
            remove => HookEndpointManager.Remove<Delegates.Decrypt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "Decrypt", false), value);
        }

        public static event Delegates.StringToUTF8ByteArray_WithArgs StringToUTF8ByteArray
        {
            add => HookEndpointManager.Add<Delegates.StringToUTF8ByteArray_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "StringToUTF8ByteArray",
                    false), value);
            remove => HookEndpointManager.Remove<Delegates.StringToUTF8ByteArray_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "StringToUTF8ByteArray",
                    false), value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.SetInt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetInt", false), value);
            remove => HookEndpointManager.Remove<Delegates.SetInt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetInt", false), value);
        }

        public static event Delegates.SetString_WithArgs SetString
        {
            add => HookEndpointManager.Add<Delegates.SetString_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetString", false), value);
            remove => HookEndpointManager.Remove<Delegates.SetString_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetString", false), value);
        }

        public static event Delegates.SetFloat_WithArgs SetFloat
        {
            add => HookEndpointManager.Add<Delegates.SetFloat_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetFloat", false), value);
            remove => HookEndpointManager.Remove<Delegates.SetFloat_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetFloat", false), value);
        }

        public static event Delegates.SetBool_WithArgs SetBool
        {
            add => HookEndpointManager.Add<Delegates.SetBool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetBool", false), value);
            remove => HookEndpointManager.Remove<Delegates.SetBool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "SetBool", false), value);
        }

        public static event Delegates.GetString_WithArgs GetString
        {
            add => HookEndpointManager.Add<Delegates.GetString_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetString", false), value);
            remove => HookEndpointManager.Remove<Delegates.GetString_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetString", false), value);
        }

        public static event Delegates.GetInt_WithArgs GetInt
        {
            add => HookEndpointManager.Add<Delegates.GetInt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetInt", false), value);
            remove => HookEndpointManager.Remove<Delegates.GetInt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetInt", false), value);
        }

        public static event Delegates.GetFloat_WithArgs GetFloat
        {
            add => HookEndpointManager.Add<Delegates.GetFloat_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetFloat", false), value);
            remove => HookEndpointManager.Remove<Delegates.GetFloat_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetFloat", false), value);
        }

        public static event Delegates.GetBool_WithArgs GetBool
        {
            add => HookEndpointManager.Add<Delegates.GetBool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetBool", false), value);
            remove => HookEndpointManager.Remove<Delegates.GetBool_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "GetBool", false), value);
        }

        public static event Delegates.DeleteKey_WithArgs DeleteKey
        {
            add => HookEndpointManager.Add<Delegates.DeleteKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "DeleteKey", false), value);
            remove => HookEndpointManager.Remove<Delegates.DeleteKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "DeleteKey", false), value);
        }

        public static event Delegates.DeleteAll_WithArgs DeleteAll
        {
            add => HookEndpointManager.Add<Delegates.DeleteAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "DeleteAll", false), value);
            remove => HookEndpointManager.Remove<Delegates.DeleteAll_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "DeleteAll", false), value);
        }
        ...
        public static event Delegates.Save_WithArgs Save
        {
            add => HookEndpointManager.Add<Delegates.Save_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "Save", false), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.HasKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "HasKey", false), value);
            remove => HookEndpointManager.Remove<Delegates.HasKey_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SecPlayerPrefs.SecurePlayerPrefs), "HasKey", false), value);
        }
    }
}