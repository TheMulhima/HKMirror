...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_BuiltModMenuScreens", false), get_BuiltModMenuScreens);
...
private static System.Collections.ObjectModel.ReadOnlyDictionary<Modding.IMod,MenuScreen> get_BuiltModMenuScreens(Func<System.Collections.ObjectModel.ReadOnlyDictionary<Modding.IMod,MenuScreen>> orig)
{
if (_beforeget_BuiltModMenuScreens != null)
{
foreach (Delegates.get_BuiltModMenuScreens_BeforeArgs toInvoke in _beforeget_BuiltModMenuScreens.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_BuiltModMenuScreens_AfterArgs toInvoke in _afterget_BuiltModMenuScreens.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_GlobalSettings", false), get_GlobalSettings);
...
{
foreach (Delegates.get_GlobalSettings_BeforeArgs toInvoke in _beforeget_GlobalSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_GlobalSettings_AfterArgs toInvoke in _afterget_GlobalSettings.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "set_GlobalSettings", false), set_GlobalSettings);
...
private static void set_GlobalSettings(Action< Modding.ModHooksGlobalSettings> orig,  Modding.ModHooksGlobalSettings value)
{
...
{
foreach (Delegates.set_GlobalSettings_BeforeArgs toInvoke in _beforeset_GlobalSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_GlobalSettings_AfterArgs toInvoke in _afterset_GlobalSettings.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "LoadGlobalSettings", false), LoadGlobalSettings);
...
{
foreach (Delegates.LoadGlobalSettings_BeforeArgs toInvoke in _beforeLoadGlobalSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.LoadGlobalSettings_AfterArgs toInvoke in _afterLoadGlobalSettings.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SaveGlobalSettings", false), SaveGlobalSettings);
...
{
foreach (Delegates.SaveGlobalSettings_BeforeArgs toInvoke in _beforeSaveGlobalSettings.GetInvocationList())
{
try
{
...
{
foreach (Delegates.SaveGlobalSettings_AfterArgs toInvoke in _afterSaveGlobalSettings.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnColliderCreate", false), OnColliderCreate);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnObjectPoolSpawn", false), OnObjectPoolSpawn);
...
private static UnityEngine.GameObject OnObjectPoolSpawn(Func< UnityEngine.GameObject, UnityEngine.GameObject> orig,  UnityEngine.GameObject go)
{
...
{
foreach (Delegates.OnObjectPoolSpawn_BeforeArgs toInvoke in _beforeOnObjectPoolSpawn.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnApplicationQuit", false), OnApplicationQuit);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnHitInstanceBeforeHit", false), OnHitInstanceBeforeHit);
...
private static HitInstance OnHitInstanceBeforeHit(Func< HutongGames.PlayMaker.Fsm,  HitInstance, HitInstance> orig,  HutongGames.PlayMaker.Fsm owner,  HitInstance hit)
{
...
{
foreach (Delegates.OnHitInstanceBeforeHit_BeforeArgs toInvoke in _beforeOnHitInstanceBeforeHit.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnHitInstanceBeforeHit_AfterArgs toInvoke in _afterOnHitInstanceBeforeHit.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDrawBlackBorders", false), OnDrawBlackBorders);
...
private static void OnDrawBlackBorders(Action< System.Collections.Generic.List<UnityEngine.GameObject>> orig,  System.Collections.Generic.List<UnityEngine.GameObject> borders)
{
...
{
foreach (Delegates.OnDrawBlackBorders_BeforeArgs toInvoke in _beforeOnDrawBlackBorders.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnDrawBlackBorders_AfterArgs toInvoke in _afterOnDrawBlackBorders.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnEnableEnemy", false), OnEnableEnemy);
...
private static bool OnEnableEnemy(Func< UnityEngine.GameObject,  bool, bool> orig,  UnityEngine.GameObject enemy,  bool isAlreadyDead)
{
Delegates.Params_OnEnableEnemy @params = new() 
{
enemy = enemy
, isAlreadyDead = isAlreadyDead
};
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnRecieveDeathEvent", false), OnRecieveDeathEvent);
...
private static void OnRecieveDeathEvent(Action< EnemyDeathEffects,  bool,  float?,  bool,  bool,  bool> orig,  EnemyDeathEffects enemyDeathEffects,  bool eventAlreadyRecieved,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery)
{
Delegates.Params_OnRecieveDeathEvent @params = new() 
{
enemyDeathEffects = enemyDeathEffects
, eventAlreadyRecieved = eventAlreadyRecieved
, attackDirection = attackDirection
, resetDeathEvent = resetDeathEvent
, spellBurn = spellBurn
, isWatery = isWatery
};
if (_beforeOnRecieveDeathEvent != null)
{
foreach (Delegates.OnRecieveDeathEvent_BeforeArgs toInvoke in _beforeOnRecieveDeathEvent.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnRecieveDeathEvent_AfterArgs toInvoke in _afterOnRecieveDeathEvent.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnRecordKillForJournal", false), OnRecordKillForJournal);
...
private static void OnRecordKillForJournal(Action< EnemyDeathEffects,  string,  string,  string,  string> orig,  EnemyDeathEffects enemyDeathEffects,  string playerDataName,  string killedBoolPlayerDataLookupKey,  string killCountIntPlayerDataLookupKey,  string newDataBoolPlayerDataLookupKey)
{
...
{
foreach (Delegates.OnRecordKillForJournal_BeforeArgs toInvoke in _beforeOnRecordKillForJournal.GetInvocationList())
{
try
{
...
orig(enemyDeathEffects, playerDataName, killedBoolPlayerDataLookupKey, killCountIntPlayerDataLookupKey, newDataBoolPlayerDataLookupKey);
if (_afterOnRecordKillForJournal != null)
{
foreach (Delegates.OnRecordKillForJournal_AfterArgs toInvoke in _afterOnRecordKillForJournal.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerBool", false), SetPlayerBool);
...
private static void SetPlayerBool(Action< string,  bool,  PlayerData> orig,  string target,  bool orig_,  PlayerData pd)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerBool", false), GetPlayerBool);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerFloat", false), SetPlayerFloat);
...
private static void SetPlayerFloat(Action< string,  float,  PlayerData> orig,  string target,  float orig_,  PlayerData pd)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerFloat", false), GetPlayerFloat);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerString", false), SetPlayerString);
...
private static void SetPlayerString(Action< string,  string,  PlayerData> orig,  string target,  string orig_,  PlayerData pd)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerString", false), GetPlayerString);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerVector3", false), SetPlayerVector3);
...
private static void SetPlayerVector3(Action< string,  UnityEngine.Vector3,  PlayerData> orig,  string target,  UnityEngine.Vector3 orig_,  PlayerData pd)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerVector3", false), GetPlayerVector3);
...
private static UnityEngine.Vector3 GetPlayerVector3(Func< string,  PlayerData, UnityEngine.Vector3> orig,  string target,  PlayerData pd)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "AfterTakeDamage", false), AfterTakeDamage);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBeforePlayerDead", false), OnBeforePlayerDead);
...
{
foreach (Delegates.OnBeforePlayerDead_BeforeArgs toInvoke in _beforeOnBeforePlayerDead.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnBeforePlayerDead_AfterArgs toInvoke in _afterOnBeforePlayerDead.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterPlayerDead", false), OnAfterPlayerDead);
...
{
foreach (Delegates.OnAfterPlayerDead_BeforeArgs toInvoke in _beforeOnAfterPlayerDead.GetInvocationList())
{
try
{
...
private static void OnSlashHit(Action< UnityEngine.Collider2D,  UnityEngine.GameObject> orig,  UnityEngine.Collider2D otherCollider,  UnityEngine.GameObject gameObject)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnCharmUpdate", false), OnCharmUpdate);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "BeforeAddHealth", false), BeforeAddHealth);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "DashVelocityChange", false), DashVelocityChange);
...
private static UnityEngine.Vector2 DashVelocityChange(Func< UnityEngine.Vector2, UnityEngine.Vector2> orig,  UnityEngine.Vector2 change)
{
...
{
foreach (Delegates.DashVelocityChange_BeforeArgs toInvoke in _beforeDashVelocityChange.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DashVelocityChange_AfterArgs toInvoke in _afterDashVelocityChange.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDashPressed", false), OnDashPressed);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameLoad", false), OnSavegameLoad);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameSave", false), OnSavegameSave);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameClear", false), OnSavegameClear);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterSaveGameLoad", false), OnAfterSaveGameLoad);
...
{
foreach (Delegates.OnAfterSaveGameLoad_BeforeArgs toInvoke in _beforeOnAfterSaveGameLoad.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnAfterSaveGameLoad_AfterArgs toInvoke in _afterOnAfterSaveGameLoad.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBeforeSaveGameSave", false), OnBeforeSaveGameSave);
...
{
foreach (Delegates.OnBeforeSaveGameSave_BeforeArgs toInvoke in _beforeOnBeforeSaveGameSave.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnBeforeSaveGameSave_AfterArgs toInvoke in _afterOnBeforeSaveGameSave.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetSaveFileName", false), GetSaveFileName);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterSaveGameClear", false), OnAfterSaveGameClear);
...
{
foreach (Delegates.OnAfterSaveGameClear_BeforeArgs toInvoke in _beforeOnAfterSaveGameClear.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnAfterSaveGameClear_AfterArgs toInvoke in _afterOnAfterSaveGameClear.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSceneChanged", false), OnSceneChanged);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "BeforeSceneLoad", false), BeforeSceneLoad);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetMod_string_bool_bool", false), GetMod_string_bool_bool);
...
private static Modding.IMod GetMod_string_bool_bool(Func< string,  bool,  bool, Modding.IMod> orig,  string name,  bool onlyEnabled,  bool allowLoadError)
{
...
{
foreach (Delegates.GetMod_string_bool_bool_BeforeArgs toInvoke in _beforeGetMod_string_bool_bool.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetMod_string_bool_bool_AfterArgs toInvoke in _afterGetMod_string_bool_bool.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetMod_Type_bool_bool", false), GetMod_Type_bool_bool);
...
private static Modding.IMod GetMod_Type_bool_bool(Func< System.Type,  bool,  bool, Modding.IMod> orig,  System.Type type,  bool onlyEnabled,  bool allowLoadError)
{
...
{
foreach (Delegates.GetMod_Type_bool_bool_BeforeArgs toInvoke in _beforeGetMod_Type_bool_bool.GetInvocationList())
{
try
{
...
{
foreach (Delegates.GetMod_Type_bool_bool_AfterArgs toInvoke in _afterGetMod_Type_bool_bool.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled_ITogglableMod", false), ModEnabled_ITogglableMod);
...
{
foreach (Delegates.ModEnabled_ITogglableMod_BeforeArgs toInvoke in _beforeModEnabled_ITogglableMod.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ModEnabled_ITogglableMod_AfterArgs toInvoke in _afterModEnabled_ITogglableMod.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled_string", false), ModEnabled_string);
...
{
foreach (Delegates.ModEnabled_string_BeforeArgs toInvoke in _beforeModEnabled_string.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled_Type", false), ModEnabled_Type);
...
private static System.Collections.Generic.IEnumerable<Modding.IMod> GetAllMods(Func< bool,  bool, System.Collections.Generic.IEnumerable<Modding.IMod>> orig,  bool onlyEnabled,  bool allowLoadError)
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnFinishedLoadingMods", false), OnFinishedLoadingMods);
...
{
foreach (Delegates.OnFinishedLoadingMods_BeforeArgs toInvoke in _beforeOnFinishedLoadingMods.GetInvocationList())
{
try
{
...
{
foreach (Delegates.OnFinishedLoadingMods_AfterArgs toInvoke in _afterOnFinishedLoadingMods.GetInvocationList())
{
try
{
...
public delegate System.Collections.ObjectModel.ReadOnlyDictionary<Modding.IMod,MenuScreen> get_BuiltModMenuScreens_AfterArgs(System.Collections.ObjectModel.ReadOnlyDictionary<Modding.IMod,MenuScreen> ret);
public delegate System.Collections.ObjectModel.ReadOnlyDictionary<Modding.IMod,MenuScreen> get_BuiltModMenuScreens_WithArgs (Func<System.Collections.ObjectModel.ReadOnlyDictionary<Modding.IMod,MenuScreen>> orig);
...
public delegate Modding.ModHooksGlobalSettings get_GlobalSettings_WithArgs (Func<Modding.ModHooksGlobalSettings> orig);
...
public delegate void set_GlobalSettings_WithArgs (Action< Modding.ModHooksGlobalSettings> orig,  Modding.ModHooksGlobalSettings value);
...
public delegate void LogConsole_WithArgs (Action< string,  Modding.LogLevel> orig,  string message,  Modding.LogLevel level);
...
public delegate UnityEngine.GameObject OnObjectPoolSpawn_AfterArgs(Params_OnObjectPoolSpawn args, UnityEngine.GameObject ret);
public delegate UnityEngine.GameObject OnObjectPoolSpawn_WithArgs (Func< UnityEngine.GameObject, UnityEngine.GameObject> orig,  UnityEngine.GameObject go);
...
public delegate HitInstance OnHitInstanceBeforeHit_AfterArgs(Params_OnHitInstanceBeforeHit args, HitInstance ret);
public delegate HitInstance OnHitInstanceBeforeHit_WithArgs (Func< HutongGames.PlayMaker.Fsm,  HitInstance, HitInstance> orig,  HutongGames.PlayMaker.Fsm owner,  HitInstance hit);
...
public delegate void OnDrawBlackBorders_WithArgs (Action< System.Collections.Generic.List<UnityEngine.GameObject>> orig,  System.Collections.Generic.List<UnityEngine.GameObject> borders);
...
public delegate bool OnEnableEnemy_WithArgs (Func< UnityEngine.GameObject,  bool, bool> orig,  UnityEngine.GameObject enemy,  bool isAlreadyDead);
...
public delegate void OnRecieveDeathEvent_WithArgs (Action< EnemyDeathEffects,  bool,  float?,  bool,  bool,  bool> orig,  EnemyDeathEffects enemyDeathEffects,  bool eventAlreadyRecieved,  float? attackDirection,  bool resetDeathEvent,  bool spellBurn,  bool isWatery);
...
public delegate void OnRecordKillForJournal_WithArgs (Action< EnemyDeathEffects,  string,  string,  string,  string> orig,  EnemyDeathEffects enemyDeathEffects,  string playerDataName,  string killedBoolPlayerDataLookupKey,  string killCountIntPlayerDataLookupKey,  string newDataBoolPlayerDataLookupKey);
...
public delegate void SetPlayerBool_WithArgs (Action< string,  bool,  PlayerData> orig,  string target,  bool orig_,  PlayerData pd);
...
public delegate void SetPlayerInt_WithArgs (Action< string,  int,  PlayerData> orig,  string target,  int orig_,  PlayerData pd);
...
public delegate void SetPlayerFloat_WithArgs (Action< string,  float,  PlayerData> orig,  string target,  float orig_,  PlayerData pd);
...
public delegate float GetPlayerFloat_WithArgs (Func< string,  PlayerData, float> orig,  string target,  PlayerData pd);
...
public delegate void SetPlayerString_WithArgs (Action< string,  string,  PlayerData> orig,  string target,  string orig_,  PlayerData pd);
...
public delegate string GetPlayerString_WithArgs (Func< string,  PlayerData, string> orig,  string target,  PlayerData pd);
...
public delegate void SetPlayerVector3_WithArgs (Action< string,  UnityEngine.Vector3,  PlayerData> orig,  string target,  UnityEngine.Vector3 orig_,  PlayerData pd);
...
public delegate UnityEngine.Vector3 GetPlayerVector3_AfterArgs(Params_GetPlayerVector3 args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 GetPlayerVector3_WithArgs (Func< string,  PlayerData, UnityEngine.Vector3> orig,  string target,  PlayerData pd);
...
public delegate void OnAttack_WithArgs (Action< GlobalEnums.AttackDirection> orig,  GlobalEnums.AttackDirection dir);
...
public delegate void AfterAttack_WithArgs (Action< GlobalEnums.AttackDirection> orig,  GlobalEnums.AttackDirection dir);
...
public delegate void OnSlashHit_WithArgs (Action< UnityEngine.Collider2D,  UnityEngine.GameObject> orig,  UnityEngine.Collider2D otherCollider,  UnityEngine.GameObject gameObject);
...
public delegate void OnCharmUpdate_WithArgs (Action< PlayerData,  HeroController> orig,  PlayerData pd,  HeroController hc);
...
public delegate UnityEngine.Vector2 DashVelocityChange_AfterArgs(Params_DashVelocityChange args, UnityEngine.Vector2 ret);
public delegate UnityEngine.Vector2 DashVelocityChange_WithArgs (Func< UnityEngine.Vector2, UnityEngine.Vector2> orig,  UnityEngine.Vector2 change);
...
public delegate Modding.IMod GetMod_string_bool_bool_AfterArgs(Params_GetMod_string_bool_bool args, Modding.IMod ret);
public delegate Modding.IMod GetMod_string_bool_bool_WithArgs (Func< string,  bool,  bool, Modding.IMod> orig,  string name,  bool onlyEnabled,  bool allowLoadError);
...
public delegate Modding.IMod GetMod_Type_bool_bool_AfterArgs(Params_GetMod_Type_bool_bool args, Modding.IMod ret);
public delegate Modding.IMod GetMod_Type_bool_bool_WithArgs (Func< System.Type,  bool,  bool, Modding.IMod> orig,  System.Type type,  bool onlyEnabled,  bool allowLoadError);
...
public delegate bool ModEnabled_ITogglableMod_WithArgs (Func< Modding.ITogglableMod, bool> orig,  Modding.ITogglableMod mod);
...
public delegate System.Collections.Generic.IEnumerable<Modding.IMod> GetAllMods_AfterArgs(Params_GetAllMods args, System.Collections.Generic.IEnumerable<Modding.IMod> ret);
public delegate System.Collections.Generic.IEnumerable<Modding.IMod> GetAllMods_WithArgs (Func< bool,  bool, System.Collections.Generic.IEnumerable<Modding.IMod>> orig,  bool onlyEnabled,  bool allowLoadError);
...
{
add => HookEndpointManager.Add<Delegates.get_BuiltModMenuScreens_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_BuiltModMenuScreens", false), value);
remove => HookEndpointManager.Remove<Delegates.get_BuiltModMenuScreens_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_BuiltModMenuScreens", false), value);
}
public static event Delegates.get_GlobalSettings_WithArgs get_GlobalSettings
{
add => HookEndpointManager.Add<Delegates.get_GlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_GlobalSettings", false), value);
remove => HookEndpointManager.Remove<Delegates.get_GlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_GlobalSettings", false), value);
}
public static event Delegates.set_GlobalSettings_WithArgs set_GlobalSettings
{
add => HookEndpointManager.Add<Delegates.set_GlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "set_GlobalSettings", false), value);
remove => HookEndpointManager.Remove<Delegates.set_GlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "set_GlobalSettings", false), value);
}
public static event Delegates.get_Instance_WithArgs get_Instance
{
add => HookEndpointManager.Add<Delegates.get_Instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_Instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_Instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "get_Instance", false), value);
}
public static event Delegates.LoadGlobalSettings_WithArgs LoadGlobalSettings
{
add => HookEndpointManager.Add<Delegates.LoadGlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "LoadGlobalSettings", false), value);
remove => HookEndpointManager.Remove<Delegates.LoadGlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "LoadGlobalSettings", false), value);
}
public static event Delegates.SaveGlobalSettings_WithArgs SaveGlobalSettings
{
add => HookEndpointManager.Add<Delegates.SaveGlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SaveGlobalSettings", false), value);
remove => HookEndpointManager.Remove<Delegates.SaveGlobalSettings_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SaveGlobalSettings", false), value);
}
public static event Delegates.LogConsole_WithArgs LogConsole
{
add => HookEndpointManager.Add<Delegates.LogConsole_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "LogConsole", false), value);
remove => HookEndpointManager.Remove<Delegates.LogConsole_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "LogConsole", false), value);
}
public static event Delegates.LanguageGet_WithArgs LanguageGet
{
add => HookEndpointManager.Add<Delegates.LanguageGet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "LanguageGet", false), value);
remove => HookEndpointManager.Remove<Delegates.LanguageGet_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "LanguageGet", false), value);
}
public static event Delegates.OnCursor_WithArgs OnCursor
{
add => HookEndpointManager.Add<Delegates.OnCursor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnCursor", false), value);
remove => HookEndpointManager.Remove<Delegates.OnCursor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnCursor", false), value);
}
public static event Delegates.OnColliderCreate_WithArgs OnColliderCreate
{
add => HookEndpointManager.Add<Delegates.OnColliderCreate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnColliderCreate", false), value);
remove => HookEndpointManager.Remove<Delegates.OnColliderCreate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnColliderCreate", false), value);
}
public static event Delegates.OnObjectPoolSpawn_WithArgs OnObjectPoolSpawn
{
add => HookEndpointManager.Add<Delegates.OnObjectPoolSpawn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnObjectPoolSpawn", false), value);
remove => HookEndpointManager.Remove<Delegates.OnObjectPoolSpawn_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnObjectPoolSpawn", false), value);
}
public static event Delegates.OnApplicationQuit_WithArgs OnApplicationQuit
{
add => HookEndpointManager.Add<Delegates.OnApplicationQuit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnApplicationQuit", false), value);
remove => HookEndpointManager.Remove<Delegates.OnApplicationQuit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnApplicationQuit", false), value);
}
public static event Delegates.OnHitInstanceBeforeHit_WithArgs OnHitInstanceBeforeHit
{
add => HookEndpointManager.Add<Delegates.OnHitInstanceBeforeHit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnHitInstanceBeforeHit", false), value);
remove => HookEndpointManager.Remove<Delegates.OnHitInstanceBeforeHit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnHitInstanceBeforeHit", false), value);
}
public static event Delegates.OnDrawBlackBorders_WithArgs OnDrawBlackBorders
{
add => HookEndpointManager.Add<Delegates.OnDrawBlackBorders_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDrawBlackBorders", false), value);
remove => HookEndpointManager.Remove<Delegates.OnDrawBlackBorders_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDrawBlackBorders", false), value);
}
public static event Delegates.OnEnableEnemy_WithArgs OnEnableEnemy
{
add => HookEndpointManager.Add<Delegates.OnEnableEnemy_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnEnableEnemy", false), value);
remove => HookEndpointManager.Remove<Delegates.OnEnableEnemy_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnEnableEnemy", false), value);
}
public static event Delegates.OnRecieveDeathEvent_WithArgs OnRecieveDeathEvent
{
add => HookEndpointManager.Add<Delegates.OnRecieveDeathEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnRecieveDeathEvent", false), value);
remove => HookEndpointManager.Remove<Delegates.OnRecieveDeathEvent_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnRecieveDeathEvent", false), value);
}
public static event Delegates.OnRecordKillForJournal_WithArgs OnRecordKillForJournal
{
add => HookEndpointManager.Add<Delegates.OnRecordKillForJournal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnRecordKillForJournal", false), value);
remove => HookEndpointManager.Remove<Delegates.OnRecordKillForJournal_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnRecordKillForJournal", false), value);
}
public static event Delegates.SetPlayerBool_WithArgs SetPlayerBool
{
add => HookEndpointManager.Add<Delegates.SetPlayerBool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerBool", false), value);
remove => HookEndpointManager.Remove<Delegates.SetPlayerBool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerBool", false), value);
}
public static event Delegates.GetPlayerBool_WithArgs GetPlayerBool
{
add => HookEndpointManager.Add<Delegates.GetPlayerBool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerBool", false), value);
remove => HookEndpointManager.Remove<Delegates.GetPlayerBool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerBool", false), value);
}
public static event Delegates.SetPlayerInt_WithArgs SetPlayerInt
{
add => HookEndpointManager.Add<Delegates.SetPlayerInt_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerInt", false), value);
remove => HookEndpointManager.Remove<Delegates.SetPlayerInt_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerInt", false), value);
}
public static event Delegates.GetPlayerInt_WithArgs GetPlayerInt
{
add => HookEndpointManager.Add<Delegates.GetPlayerInt_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerInt", false), value);
remove => HookEndpointManager.Remove<Delegates.GetPlayerInt_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerInt", false), value);
}
public static event Delegates.SetPlayerFloat_WithArgs SetPlayerFloat
{
add => HookEndpointManager.Add<Delegates.SetPlayerFloat_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerFloat", false), value);
remove => HookEndpointManager.Remove<Delegates.SetPlayerFloat_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerFloat", false), value);
}
public static event Delegates.GetPlayerFloat_WithArgs GetPlayerFloat
{
add => HookEndpointManager.Add<Delegates.GetPlayerFloat_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerFloat", false), value);
remove => HookEndpointManager.Remove<Delegates.GetPlayerFloat_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerFloat", false), value);
}
public static event Delegates.SetPlayerString_WithArgs SetPlayerString
{
add => HookEndpointManager.Add<Delegates.SetPlayerString_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerString", false), value);
remove => HookEndpointManager.Remove<Delegates.SetPlayerString_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerString", false), value);
}
public static event Delegates.GetPlayerString_WithArgs GetPlayerString
{
add => HookEndpointManager.Add<Delegates.GetPlayerString_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerString", false), value);
remove => HookEndpointManager.Remove<Delegates.GetPlayerString_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerString", false), value);
}
public static event Delegates.SetPlayerVector3_WithArgs SetPlayerVector3
{
add => HookEndpointManager.Add<Delegates.SetPlayerVector3_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerVector3", false), value);
remove => HookEndpointManager.Remove<Delegates.SetPlayerVector3_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "SetPlayerVector3", false), value);
}
public static event Delegates.GetPlayerVector3_WithArgs GetPlayerVector3
{
add => HookEndpointManager.Add<Delegates.GetPlayerVector3_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerVector3", false), value);
remove => HookEndpointManager.Remove<Delegates.GetPlayerVector3_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetPlayerVector3", false), value);
}
public static event Delegates.OnBlueHealth_WithArgs OnBlueHealth
{
add => HookEndpointManager.Add<Delegates.OnBlueHealth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBlueHealth", false), value);
remove => HookEndpointManager.Remove<Delegates.OnBlueHealth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBlueHealth", false), value);
}
public static event Delegates.OnTakeHealth_WithArgs OnTakeHealth
{
add => HookEndpointManager.Add<Delegates.OnTakeHealth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnTakeHealth", false), value);
remove => HookEndpointManager.Remove<Delegates.OnTakeHealth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnTakeHealth", false), value);
}
public static event Delegates.OnTakeDamage_WithArgs OnTakeDamage
{
add => HookEndpointManager.Add<Delegates.OnTakeDamage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnTakeDamage", false), value);
remove => HookEndpointManager.Remove<Delegates.OnTakeDamage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnTakeDamage", false), value);
}
public static event Delegates.AfterTakeDamage_WithArgs AfterTakeDamage
{
add => HookEndpointManager.Add<Delegates.AfterTakeDamage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "AfterTakeDamage", false), value);
remove => HookEndpointManager.Remove<Delegates.AfterTakeDamage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "AfterTakeDamage", false), value);
}
public static event Delegates.OnBeforePlayerDead_WithArgs OnBeforePlayerDead
{
add => HookEndpointManager.Add<Delegates.OnBeforePlayerDead_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBeforePlayerDead", false), value);
remove => HookEndpointManager.Remove<Delegates.OnBeforePlayerDead_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBeforePlayerDead", false), value);
}
public static event Delegates.OnAfterPlayerDead_WithArgs OnAfterPlayerDead
{
add => HookEndpointManager.Add<Delegates.OnAfterPlayerDead_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterPlayerDead", false), value);
remove => HookEndpointManager.Remove<Delegates.OnAfterPlayerDead_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterPlayerDead", false), value);
}
public static event Delegates.OnAttack_WithArgs OnAttack
{
add => HookEndpointManager.Add<Delegates.OnAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAttack", false), value);
remove => HookEndpointManager.Remove<Delegates.OnAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAttack", false), value);
}
public static event Delegates.OnDoAttack_WithArgs OnDoAttack
{
add => HookEndpointManager.Add<Delegates.OnDoAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDoAttack", false), value);
remove => HookEndpointManager.Remove<Delegates.OnDoAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDoAttack", false), value);
}
public static event Delegates.AfterAttack_WithArgs AfterAttack
{
add => HookEndpointManager.Add<Delegates.AfterAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "AfterAttack", false), value);
remove => HookEndpointManager.Remove<Delegates.AfterAttack_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "AfterAttack", false), value);
}
public static event Delegates.OnSlashHit_WithArgs OnSlashHit
{
add => HookEndpointManager.Add<Delegates.OnSlashHit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSlashHit", false), value);
remove => HookEndpointManager.Remove<Delegates.OnSlashHit_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSlashHit", false), value);
}
public static event Delegates.OnCharmUpdate_WithArgs OnCharmUpdate
{
add => HookEndpointManager.Add<Delegates.OnCharmUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnCharmUpdate", false), value);
remove => HookEndpointManager.Remove<Delegates.OnCharmUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnCharmUpdate", false), value);
}
public static event Delegates.OnHeroUpdate_WithArgs OnHeroUpdate
{
add => HookEndpointManager.Add<Delegates.OnHeroUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnHeroUpdate", false), value);
remove => HookEndpointManager.Remove<Delegates.OnHeroUpdate_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnHeroUpdate", false), value);
}
public static event Delegates.BeforeAddHealth_WithArgs BeforeAddHealth
{
add => HookEndpointManager.Add<Delegates.BeforeAddHealth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "BeforeAddHealth", false), value);
remove => HookEndpointManager.Remove<Delegates.BeforeAddHealth_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "BeforeAddHealth", false), value);
}
public static event Delegates.OnFocusCost_WithArgs OnFocusCost
{
add => HookEndpointManager.Add<Delegates.OnFocusCost_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnFocusCost", false), value);
remove => HookEndpointManager.Remove<Delegates.OnFocusCost_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnFocusCost", false), value);
}
public static event Delegates.OnSoulGain_WithArgs OnSoulGain
{
add => HookEndpointManager.Add<Delegates.OnSoulGain_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSoulGain", false), value);
remove => HookEndpointManager.Remove<Delegates.OnSoulGain_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSoulGain", false), value);
}
public static event Delegates.DashVelocityChange_WithArgs DashVelocityChange
{
add => HookEndpointManager.Add<Delegates.DashVelocityChange_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "DashVelocityChange", false), value);
remove => HookEndpointManager.Remove<Delegates.DashVelocityChange_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "DashVelocityChange", false), value);
}
public static event Delegates.OnDashPressed_WithArgs OnDashPressed
{
add => HookEndpointManager.Add<Delegates.OnDashPressed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDashPressed", false), value);
remove => HookEndpointManager.Remove<Delegates.OnDashPressed_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnDashPressed", false), value);
}
public static event Delegates.OnSavegameLoad_WithArgs OnSavegameLoad
{
add => HookEndpointManager.Add<Delegates.OnSavegameLoad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameLoad", false), value);
remove => HookEndpointManager.Remove<Delegates.OnSavegameLoad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameLoad", false), value);
}
public static event Delegates.OnSavegameSave_WithArgs OnSavegameSave
{
add => HookEndpointManager.Add<Delegates.OnSavegameSave_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameSave", false), value);
remove => HookEndpointManager.Remove<Delegates.OnSavegameSave_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameSave", false), value);
}
public static event Delegates.OnNewGame_WithArgs OnNewGame
{
add => HookEndpointManager.Add<Delegates.OnNewGame_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnNewGame", false), value);
remove => HookEndpointManager.Remove<Delegates.OnNewGame_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnNewGame", false), value);
}
public static event Delegates.OnSavegameClear_WithArgs OnSavegameClear
{
add => HookEndpointManager.Add<Delegates.OnSavegameClear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameClear", false), value);
remove => HookEndpointManager.Remove<Delegates.OnSavegameClear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSavegameClear", false), value);
}
public static event Delegates.OnAfterSaveGameLoad_WithArgs OnAfterSaveGameLoad
{
add => HookEndpointManager.Add<Delegates.OnAfterSaveGameLoad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterSaveGameLoad", false), value);
remove => HookEndpointManager.Remove<Delegates.OnAfterSaveGameLoad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterSaveGameLoad", false), value);
}
public static event Delegates.OnBeforeSaveGameSave_WithArgs OnBeforeSaveGameSave
{
add => HookEndpointManager.Add<Delegates.OnBeforeSaveGameSave_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBeforeSaveGameSave", false), value);
remove => HookEndpointManager.Remove<Delegates.OnBeforeSaveGameSave_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnBeforeSaveGameSave", false), value);
}
public static event Delegates.GetSaveFileName_WithArgs GetSaveFileName
{
add => HookEndpointManager.Add<Delegates.GetSaveFileName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetSaveFileName", false), value);
remove => HookEndpointManager.Remove<Delegates.GetSaveFileName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetSaveFileName", false), value);
}
public static event Delegates.OnAfterSaveGameClear_WithArgs OnAfterSaveGameClear
{
add => HookEndpointManager.Add<Delegates.OnAfterSaveGameClear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterSaveGameClear", false), value);
remove => HookEndpointManager.Remove<Delegates.OnAfterSaveGameClear_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnAfterSaveGameClear", false), value);
}
public static event Delegates.OnSceneChanged_WithArgs OnSceneChanged
{
add => HookEndpointManager.Add<Delegates.OnSceneChanged_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSceneChanged", false), value);
remove => HookEndpointManager.Remove<Delegates.OnSceneChanged_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnSceneChanged", false), value);
}
public static event Delegates.BeforeSceneLoad_WithArgs BeforeSceneLoad
{
add => HookEndpointManager.Add<Delegates.BeforeSceneLoad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "BeforeSceneLoad", false), value);
remove => HookEndpointManager.Remove<Delegates.BeforeSceneLoad_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "BeforeSceneLoad", false), value);
}
public static event Delegates.GetMod_string_bool_bool_WithArgs GetMod_string_bool_bool
{
add => HookEndpointManager.Add<Delegates.GetMod_string_bool_bool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetMod", false), value);
remove => HookEndpointManager.Remove<Delegates.GetMod_string_bool_bool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetMod", false), value);
}
public static event Delegates.GetMod_Type_bool_bool_WithArgs GetMod_Type_bool_bool
{
add => HookEndpointManager.Add<Delegates.GetMod_Type_bool_bool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetMod", false), value);
remove => HookEndpointManager.Remove<Delegates.GetMod_Type_bool_bool_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetMod", false), value);
}
public static event Delegates.ModEnabled_ITogglableMod_WithArgs ModEnabled_ITogglableMod
{
add => HookEndpointManager.Add<Delegates.ModEnabled_ITogglableMod_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled", false), value);
remove => HookEndpointManager.Remove<Delegates.ModEnabled_ITogglableMod_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled", false), value);
}
public static event Delegates.ModEnabled_string_WithArgs ModEnabled_string
{
add => HookEndpointManager.Add<Delegates.ModEnabled_string_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled", false), value);
remove => HookEndpointManager.Remove<Delegates.ModEnabled_string_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled", false), value);
}
public static event Delegates.ModEnabled_Type_WithArgs ModEnabled_Type
{
add => HookEndpointManager.Add<Delegates.ModEnabled_Type_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled", false), value);
remove => HookEndpointManager.Remove<Delegates.ModEnabled_Type_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "ModEnabled", false), value);
}
public static event Delegates.GetAllMods_WithArgs GetAllMods
{
add => HookEndpointManager.Add<Delegates.GetAllMods_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetAllMods", false), value);
remove => HookEndpointManager.Remove<Delegates.GetAllMods_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "GetAllMods", false), value);
}
public static event Delegates.OnFinishedLoadingMods_WithArgs OnFinishedLoadingMods
{
add => HookEndpointManager.Add<Delegates.OnFinishedLoadingMods_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnFinishedLoadingMods", false), value);
remove => HookEndpointManager.Remove<Delegates.OnFinishedLoadingMods_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(Modding.ModHooks), "OnFinishedLoadingMods", false), value);
}
}
