...
public static class OnHoriPadUltimateMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriPadUltimateMacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HoriPadUltimateMacNativeProfile> orig, HoriPadUltimateMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriPadUltimateMacNativeProfile> orig,
            HoriPadUltimateMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriPadUltimateMacNativeProfile self;
        }
    }
