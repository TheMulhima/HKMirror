...
public static class OnAddForce2dAsAngle
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "Awake",
                        true), Awake);
            }
        }
        ...
        private static void Awake(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle),
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self)
        {
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self)
        {
        ...
        private static void DoAddForce(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self);
        ...
        public delegate void Awake_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self);
        ...
        public delegate void DoAddForce_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dAsAngle> orig,
            HutongGames.PlayMaker.Actions.AddForce2dAsAngle self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "Reset", true),
                value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "Awake", true),
                value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "OnPreprocess",
                    true), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "OnFixedUpdate",
                    true), value);
        ...
        public static event Delegates.DoAddForce_WithArgs DoAddForce
        {
            add => HookEndpointManager.Add<Delegates.DoAddForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dAsAngle), "DoAddForce",
                    true), value);
