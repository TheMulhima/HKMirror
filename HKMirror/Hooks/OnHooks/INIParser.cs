...
private static void Open_TextAsset(On.INIParser.orig_Open_TextAsset orig,INIParser self,  UnityEngine.TextAsset name)
{
...
private static void Initialize(On.INIParser.orig_Initialize orig,INIParser self,  string iniString,  bool AutoFlush)
{
...
private static bool ParseKeyValuePair(On.INIParser.orig_ParseKeyValuePair orig,INIParser self,  string Line, ref  string Key, ref  string Value)
{
...
{
foreach (Delegates.ParseKeyValuePair_BeforeArgs toInvoke in _beforeParseKeyValuePair.GetInvocationList())
{
try
{
...
private static bool IsKeyExists(On.INIParser.orig_IsKeyExists orig,INIParser self,  string SectionName,  string Key)
{
...
private static string ReadValue_string_string_string(On.INIParser.orig_ReadValue_string_string_string orig,INIParser self,  string SectionName,  string Key,  string DefaultValue)
{
...
{
foreach (Delegates.ReadValue_string_string_string_BeforeArgs toInvoke in _beforeReadValue_string_string_string.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ReadValue_string_string_string_AfterArgs toInvoke in _afterReadValue_string_string_string.GetInvocationList())
{
try
{
...
internal static event Delegates.WriteValue_string_string_string_BeforeArgs _beforeWriteValue_string_string_string;
internal static event Delegates.WriteValue_string_string_string_AfterArgs _afterWriteValue_string_string_string;
private static void WriteValue_string_string_string(On.INIParser.orig_WriteValue_string_string_string orig,INIParser self,  string SectionName,  string Key,  string Value)
{
...
{
foreach (Delegates.WriteValue_string_string_string_BeforeArgs toInvoke in _beforeWriteValue_string_string_string.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WriteValue_string_string_string_AfterArgs toInvoke in _afterWriteValue_string_string_string.GetInvocationList())
{
try
{
...
private static bool ReadValue_string_string_bool(On.INIParser.orig_ReadValue_string_string_bool orig,INIParser self,  string SectionName,  string Key,  bool DefaultValue)
{
...
{
foreach (Delegates.ReadValue_string_string_bool_BeforeArgs toInvoke in _beforeReadValue_string_string_bool.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ReadValue_string_string_bool_AfterArgs toInvoke in _afterReadValue_string_string_bool.GetInvocationList())
{
try
{
...
private static int ReadValue_string_string_int(On.INIParser.orig_ReadValue_string_string_int orig,INIParser self,  string SectionName,  string Key,  int DefaultValue)
{
...
{
foreach (Delegates.ReadValue_string_string_int_BeforeArgs toInvoke in _beforeReadValue_string_string_int.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ReadValue_string_string_int_AfterArgs toInvoke in _afterReadValue_string_string_int.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue_string_string_Int64", true), ReadValue_string_string_Int64);
...
private static long ReadValue_string_string_Int64(Func<INIParser,  string,  string,  long, long> orig, INIParser self,  string SectionName,  string Key,  long DefaultValue)
{
...
{
foreach (Delegates.ReadValue_string_string_Int64_BeforeArgs toInvoke in _beforeReadValue_string_string_Int64.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ReadValue_string_string_Int64_AfterArgs toInvoke in _afterReadValue_string_string_Int64.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue_string_string_Double", true), ReadValue_string_string_Double);
...
private static double ReadValue_string_string_Double(Func<INIParser,  string,  string,  double, double> orig, INIParser self,  string SectionName,  string Key,  double DefaultValue)
{
...
{
foreach (Delegates.ReadValue_string_string_Double_BeforeArgs toInvoke in _beforeReadValue_string_string_Double.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ReadValue_string_string_Double_AfterArgs toInvoke in _afterReadValue_string_string_Double.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue_string_string_Array", true), ReadValue_string_string_Array);
...
private static byte[] ReadValue_string_string_Array(Func<INIParser,  string,  string,  byte[], byte[]> orig, INIParser self,  string SectionName,  string Key,  byte[] DefaultValue)
{
...
{
foreach (Delegates.ReadValue_string_string_Array_BeforeArgs toInvoke in _beforeReadValue_string_string_Array.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ReadValue_string_string_Array_AfterArgs toInvoke in _afterReadValue_string_string_Array.GetInvocationList())
{
try
{
...
internal static event Delegates.ReadValue_string_string_DateTime_BeforeArgs _beforeReadValue_string_string_DateTime;
internal static event Delegates.ReadValue_string_string_DateTime_AfterArgs _afterReadValue_string_string_DateTime;
private static System.DateTime ReadValue_string_string_DateTime(On.INIParser.orig_ReadValue_string_string_DateTime orig,INIParser self,  string SectionName,  string Key,  System.DateTime DefaultValue)
{
...
{
foreach (Delegates.ReadValue_string_string_DateTime_BeforeArgs toInvoke in _beforeReadValue_string_string_DateTime.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ReadValue_string_string_DateTime_AfterArgs toInvoke in _afterReadValue_string_string_DateTime.GetInvocationList())
{
try
{
...
private static void WriteValue_string_string_bool(On.INIParser.orig_WriteValue_string_string_bool orig,INIParser self,  string SectionName,  string Key,  bool Value)
{
...
{
foreach (Delegates.WriteValue_string_string_bool_BeforeArgs toInvoke in _beforeWriteValue_string_string_bool.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WriteValue_string_string_bool_AfterArgs toInvoke in _afterWriteValue_string_string_bool.GetInvocationList())
{
try
{
...
private static void WriteValue_string_string_int(On.INIParser.orig_WriteValue_string_string_int orig,INIParser self,  string SectionName,  string Key,  int Value)
{
...
{
foreach (Delegates.WriteValue_string_string_int_BeforeArgs toInvoke in _beforeWriteValue_string_string_int.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WriteValue_string_string_int_AfterArgs toInvoke in _afterWriteValue_string_string_int.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue_string_string_Int64", true), WriteValue_string_string_Int64);
...
private static void WriteValue_string_string_Int64(Action<INIParser,  string,  string,  long> orig, INIParser self,  string SectionName,  string Key,  long Value)
{
...
{
foreach (Delegates.WriteValue_string_string_Int64_BeforeArgs toInvoke in _beforeWriteValue_string_string_Int64.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WriteValue_string_string_Int64_AfterArgs toInvoke in _afterWriteValue_string_string_Int64.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue_string_string_Double", true), WriteValue_string_string_Double);

}
}
internal static event Delegates.WriteValue_string_string_Double_BeforeArgs _beforeWriteValue_string_string_Double;
internal static event Delegates.WriteValue_string_string_Double_AfterArgs _afterWriteValue_string_string_Double;
private static void WriteValue_string_string_Double(Action<INIParser,  string,  string,  double> orig, INIParser self,  string SectionName,  string Key,  double Value)
{
...
{
foreach (Delegates.WriteValue_string_string_Double_BeforeArgs toInvoke in _beforeWriteValue_string_string_Double.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WriteValue_string_string_Double_AfterArgs toInvoke in _afterWriteValue_string_string_Double.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue_string_string_Array", true), WriteValue_string_string_Array);
...
private static void WriteValue_string_string_Array(Action<INIParser,  string,  string,  byte[]> orig, INIParser self,  string SectionName,  string Key,  byte[] Value)
{
...
{
foreach (Delegates.WriteValue_string_string_Array_BeforeArgs toInvoke in _beforeWriteValue_string_string_Array.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WriteValue_string_string_Array_AfterArgs toInvoke in _afterWriteValue_string_string_Array.GetInvocationList())
{
try
{
...
internal static event Delegates.WriteValue_string_string_DateTime_BeforeArgs _beforeWriteValue_string_string_DateTime;
internal static event Delegates.WriteValue_string_string_DateTime_AfterArgs _afterWriteValue_string_string_DateTime;
private static void WriteValue_string_string_DateTime(On.INIParser.orig_WriteValue_string_string_DateTime orig,INIParser self,  string SectionName,  string Key,  System.DateTime Value)
{
...
{
foreach (Delegates.WriteValue_string_string_DateTime_BeforeArgs toInvoke in _beforeWriteValue_string_string_DateTime.GetInvocationList())
{
try
{
...
{
foreach (Delegates.WriteValue_string_string_DateTime_AfterArgs toInvoke in _afterWriteValue_string_string_DateTime.GetInvocationList())
{
try
{
...
public delegate void Open_TextAsset_WithArgs (Action<INIParser,  UnityEngine.TextAsset> orig, INIParser self,  UnityEngine.TextAsset name);
...
public delegate void Initialize_WithArgs (Action<INIParser,  string,  bool> orig, INIParser self,  string iniString,  bool AutoFlush);
...
public delegate string ParseSectionName_WithArgs (Func<INIParser,  string, string> orig, INIParser self,  string Line);
...
public delegate bool ParseKeyValuePair_WithArgs (Func<INIParser,  string,  string,  string, bool> orig, INIParser self,  string Line, ref  string Key, ref  string Value);
...
public delegate bool IsSectionExists_WithArgs (Func<INIParser,  string, bool> orig, INIParser self,  string SectionName);
...
public delegate bool IsKeyExists_WithArgs (Func<INIParser,  string,  string, bool> orig, INIParser self,  string SectionName,  string Key);
...
public delegate void KeyDelete_WithArgs (Action<INIParser,  string,  string> orig, INIParser self,  string SectionName,  string Key);
...
public delegate string ReadValue_string_string_string_AfterArgs(Params_ReadValue_string_string_string args, string ret);
public delegate string ReadValue_string_string_string_WithArgs (Func<INIParser,  string,  string,  string, string> orig, INIParser self,  string SectionName,  string Key,  string DefaultValue);
...
public delegate void WriteValue_string_string_string_WithArgs (Action<INIParser,  string,  string,  string> orig, INIParser self,  string SectionName,  string Key,  string Value);
...
public delegate string EncodeByteArray_WithArgs (Func<INIParser,  byte[], string> orig, INIParser self,  byte[] Value);
...
public delegate byte[] DecodeByteArray_WithArgs (Func<INIParser,  string, byte[]> orig, INIParser self,  string Value);
...
public delegate bool ReadValue_string_string_bool_WithArgs (Func<INIParser,  string,  string,  bool, bool> orig, INIParser self,  string SectionName,  string Key,  bool DefaultValue);
...
public delegate int ReadValue_string_string_int_WithArgs (Func<INIParser,  string,  string,  int, int> orig, INIParser self,  string SectionName,  string Key,  int DefaultValue);
...
public delegate long ReadValue_string_string_Int64_AfterArgs(Params_ReadValue_string_string_Int64 args, long ret);
public delegate long ReadValue_string_string_Int64_WithArgs (Func<INIParser,  string,  string,  long, long> orig, INIParser self,  string SectionName,  string Key,  long DefaultValue);
...
public delegate double ReadValue_string_string_Double_AfterArgs(Params_ReadValue_string_string_Double args, double ret);
public delegate double ReadValue_string_string_Double_WithArgs (Func<INIParser,  string,  string,  double, double> orig, INIParser self,  string SectionName,  string Key,  double DefaultValue);
...
public delegate byte[] ReadValue_string_string_Array_AfterArgs(Params_ReadValue_string_string_Array args, byte[] ret);
public delegate byte[] ReadValue_string_string_Array_WithArgs (Func<INIParser,  string,  string,  byte[], byte[]> orig, INIParser self,  string SectionName,  string Key,  byte[] DefaultValue);
...
public delegate System.DateTime ReadValue_string_string_DateTime_AfterArgs(Params_ReadValue_string_string_DateTime args, System.DateTime ret);
public delegate System.DateTime ReadValue_string_string_DateTime_WithArgs (Func<INIParser,  string,  string,  System.DateTime, System.DateTime> orig, INIParser self,  string SectionName,  string Key,  System.DateTime DefaultValue);
...
public delegate void WriteValue_string_string_bool_WithArgs (Action<INIParser,  string,  string,  bool> orig, INIParser self,  string SectionName,  string Key,  bool Value);
...
public delegate void WriteValue_string_string_int_WithArgs (Action<INIParser,  string,  string,  int> orig, INIParser self,  string SectionName,  string Key,  int Value);
...
public delegate void WriteValue_string_string_Int64_WithArgs (Action<INIParser,  string,  string,  long> orig, INIParser self,  string SectionName,  string Key,  long Value);
...
public delegate void WriteValue_string_string_Double_WithArgs (Action<INIParser,  string,  string,  double> orig, INIParser self,  string SectionName,  string Key,  double Value);
...
public delegate void WriteValue_string_string_Array_WithArgs (Action<INIParser,  string,  string,  byte[]> orig, INIParser self,  string SectionName,  string Key,  byte[] Value);
...
public delegate void WriteValue_string_string_DateTime_BeforeArgs(Params_WriteValue_string_string_DateTime args);
public delegate void WriteValue_string_string_DateTime_AfterArgs(Params_WriteValue_string_string_DateTime args);
public delegate void WriteValue_string_string_DateTime_WithArgs (Action<INIParser,  string,  string,  System.DateTime> orig, INIParser self,  string SectionName,  string Key,  System.DateTime Value);
}
...
{
add => HookEndpointManager.Add<Delegates.get_FileName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_FileName", true), value);
remove => HookEndpointManager.Remove<Delegates.get_FileName_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_FileName", true), value);
}
public static event Delegates.get_iniString_WithArgs get_iniString
{
add => HookEndpointManager.Add<Delegates.get_iniString_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_iniString", true), value);
remove => HookEndpointManager.Remove<Delegates.get_iniString_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_iniString", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.ReadValue_string_string_Int64_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue", true), value);
remove => HookEndpointManager.Remove<Delegates.ReadValue_string_string_Int64_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue", true), value);
}
public static event Delegates.ReadValue_string_string_Double_WithArgs ReadValue_string_string_Double
{
add => HookEndpointManager.Add<Delegates.ReadValue_string_string_Double_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue", true), value);
remove => HookEndpointManager.Remove<Delegates.ReadValue_string_string_Double_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue", true), value);
}
public static event Delegates.ReadValue_string_string_Array_WithArgs ReadValue_string_string_Array
{
add => HookEndpointManager.Add<Delegates.ReadValue_string_string_Array_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue", true), value);
remove => HookEndpointManager.Remove<Delegates.ReadValue_string_string_Array_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue", true), value);
}
...
{
add => HookEndpointManager.Add<Delegates.WriteValue_string_string_Int64_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue", true), value);
remove => HookEndpointManager.Remove<Delegates.WriteValue_string_string_Int64_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue", true), value);
}
public static event Delegates.WriteValue_string_string_Double_WithArgs WriteValue_string_string_Double
{
add => HookEndpointManager.Add<Delegates.WriteValue_string_string_Double_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue", true), value);
remove => HookEndpointManager.Remove<Delegates.WriteValue_string_string_Double_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue", true), value);
}
public static event Delegates.WriteValue_string_string_Array_WithArgs WriteValue_string_string_Array
{
add => HookEndpointManager.Add<Delegates.WriteValue_string_string_Array_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue", true), value);
remove => HookEndpointManager.Remove<Delegates.WriteValue_string_string_Array_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue", true), value);
}
