...
public static class OnINIParser
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_FileName()
        {
            if (!HookedList.Contains("get_FileName"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_FileName"), get_FileName);
            }
        }

        internal static event Delegates.get_FileName_BeforeArgs _beforeget_FileName;
        internal static event Delegates.get_FileName_NormalArgs _afterget_FileName;
        ...
        private static string get_FileName(Func<INIParser, string> orig, INIParser self)
        {
            ...
            if (_afterget_FileName != null) retVal = _afterget_FileName.Invoke(@params);
            return retVal;
        }
        ...
        internal static void Hookget_iniString()
        {
            if (!HookedList.Contains("get_iniString"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_iniString"), get_iniString);
            }
        }

        internal static event Delegates.get_iniString_BeforeArgs _beforeget_iniString;
        internal static event Delegates.get_iniString_NormalArgs _afterget_iniString;
        ...
        private static string get_iniString(Func<INIParser, string> orig, INIParser self)
        {
            ...
            self = @params.self;
            var retVal = orig(self);
            if (_afterget_iniString != null) retVal = _afterget_iniString.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.Open_string_NormalArgs _afterOpen_string;
        ...
        private static void Open_string(On.INIParser.orig_Open_string orig, INIParser self, string path)
        {
            ...
            path = @params.path;
            orig(self, path);
            if (_afterOpen_string != null) _afterOpen_string.Invoke(@params);
        }
        ...
        internal static event Delegates.Open_TextAsset_NormalArgs _afterOpen_TextAsset;

        private static void Open_TextAsset(On.INIParser.orig_Open_TextAsset orig, INIParser self, TextAsset name)
        {
            ...
            name = @params.name;
            orig(self, name);
            if (_afterOpen_TextAsset != null) _afterOpen_TextAsset.Invoke(@params);
        }
        ...
        internal static event Delegates.OpenFromString_NormalArgs _afterOpenFromString;
        ...
        internal static event Delegates.ParseSectionName_NormalArgs _afterParseSectionName;
        ...
        private static string ParseSectionName(On.INIParser.orig_ParseSectionName orig, INIParser self, string Line)
        {
            ...
            if (_afterParseSectionName != null) retVal = _afterParseSectionName.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.ParseKeyValuePair_NormalArgs _afterParseKeyValuePair;
            ...
            ref string Key, ref string Value)
        {
            ...
            if (_afterParseKeyValuePair != null) retVal = _afterParseKeyValuePair.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.isComment_NormalArgs _afterisComment;
        ...
        private static bool isComment(On.INIParser.orig_isComment orig, INIParser self, string Line)
        {
            ...
            Line = @params.Line;
            var retVal = orig(self, Line);
            if (_afterisComment != null) retVal = _afterisComment.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.PerformFlush_NormalArgs _afterPerformFlush;
        ...
        private static void PerformFlush(On.INIParser.orig_PerformFlush orig, INIParser self)
        {
            ...
            self = @params.self;
            orig(self);
            if (_afterPerformFlush != null) _afterPerformFlush.Invoke(@params);
        }
        ...
        internal static event Delegates.IsSectionExists_NormalArgs _afterIsSectionExists;
        ...
        private static bool IsSectionExists(On.INIParser.orig_IsSectionExists orig, INIParser self, string SectionName)
        {
            ...
            if (_afterIsSectionExists != null) retVal = _afterIsSectionExists.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.IsKeyExists_NormalArgs _afterIsKeyExists;
            ...
            string Key)
        {
            ...
            if (_afterIsKeyExists != null) retVal = _afterIsKeyExists.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.SectionDelete_NormalArgs _afterSectionDelete;
        ...
        private static void SectionDelete(On.INIParser.orig_SectionDelete orig, INIParser self, string SectionName)
        {
            ...
            if (_afterSectionDelete != null) _afterSectionDelete.Invoke(@params);
        }
        ...
        internal static event Delegates.KeyDelete_NormalArgs _afterKeyDelete;
        ...
        private static void KeyDelete(On.INIParser.orig_KeyDelete orig, INIParser self, string SectionName, string Key)
        {
            ...
            if (_afterKeyDelete != null) _afterKeyDelete.Invoke(@params);
        }
        ...
        internal static event Delegates.ReadValue_string_string_string_NormalArgs _afterReadValue_string_string_string;
            ...
            INIParser self, string SectionName, string Key, string DefaultValue)
        {
            ...
            if (_afterReadValue_string_string_string != null)
                retVal = _afterReadValue_string_string_string.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.WriteValue_string_string_string_NormalArgs
            _afterWriteValue_string_string_string;
            ...
            INIParser self, string SectionName, string Key, string Value)
        {
            ...
            if (_afterWriteValue_string_string_string != null) _afterWriteValue_string_string_string.Invoke(@params);
        }
        ...
        internal static event Delegates.EncodeByteArray_NormalArgs _afterEncodeByteArray;
        ...
        private static string EncodeByteArray(On.INIParser.orig_EncodeByteArray orig, INIParser self, byte[] Value)
        {
            ...
            if (_afterEncodeByteArray != null) retVal = _afterEncodeByteArray.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.DecodeByteArray_NormalArgs _afterDecodeByteArray;
        ...
        private static byte[] DecodeByteArray(On.INIParser.orig_DecodeByteArray orig, INIParser self, string Value)
        {
            ...
            Value = @params.Value;
            var retVal = orig(self, Value);
            if (_afterDecodeByteArray != null) retVal = _afterDecodeByteArray.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.ReadValue_string_string_bool_NormalArgs _afterReadValue_string_string_bool;
            ...
            INIParser self, string SectionName, string Key, bool DefaultValue)
        {
            ...
            DefaultValue = @params.DefaultValue;
            var retVal = orig(self, SectionName, Key, DefaultValue);
            if (_afterReadValue_string_string_bool != null) retVal = _afterReadValue_string_string_bool.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.ReadValue_string_string_int_NormalArgs _afterReadValue_string_string_int;
            ...
            INIParser self, string SectionName, string Key, int DefaultValue)
        {
            ...
            DefaultValue = @params.DefaultValue;
            var retVal = orig(self, SectionName, Key, DefaultValue);
            if (_afterReadValue_string_string_int != null) retVal = _afterReadValue_string_string_int.Invoke(@params);
            return retVal;
        }
        ...
        internal static void HookReadValue_string_string_Int64()
        {
            if (!HookedList.Contains("ReadValue_string_string_Int64"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue_string_string_Int64"),
        ...
        internal static event Delegates.ReadValue_string_string_Int64_NormalArgs _afterReadValue_string_string_Int64;
            ...
            INIParser self, string SectionName, string Key, long DefaultValue)
        {
            ...
            if (_afterReadValue_string_string_Int64 != null)
                retVal = _afterReadValue_string_string_Int64.Invoke(@params);
            return retVal;
        }
        ...
        internal static void HookReadValue_string_string_Double()
        {
            if (!HookedList.Contains("ReadValue_string_string_Double"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue_string_string_Double"),
        ...
        internal static event Delegates.ReadValue_string_string_Double_NormalArgs _afterReadValue_string_string_Double;
            ...
            INIParser self, string SectionName, string Key, double DefaultValue)
        {
            ...
            if (_afterReadValue_string_string_Double != null)
                retVal = _afterReadValue_string_string_Double.Invoke(@params);
            return retVal;
        }
        ...
        internal static void HookReadValue_string_string_Array()
        {
            if (!HookedList.Contains("ReadValue_string_string_Array"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue_string_string_Array"),
        ...
        internal static event Delegates.ReadValue_string_string_Array_NormalArgs _afterReadValue_string_string_Array;
            ...
            INIParser self, string SectionName, string Key, byte[] DefaultValue)
        {
            ...
            if (_afterReadValue_string_string_Array != null)
                retVal = _afterReadValue_string_string_Array.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.ReadValue_string_string_DateTime_NormalArgs
            _afterReadValue_string_string_DateTime;

        private static DateTime ReadValue_string_string_DateTime(
            ...
            DateTime DefaultValue)
        {
            ...
            if (_afterReadValue_string_string_DateTime != null)
                retVal = _afterReadValue_string_string_DateTime.Invoke(@params);
            return retVal;
        }
        ...
        internal static event Delegates.WriteValue_string_string_bool_NormalArgs _afterWriteValue_string_string_bool;
            ...
            INIParser self, string SectionName, string Key, bool Value)
        {
            ...
            Value = @params.Value;
            orig(self, SectionName, Key, Value);
            if (_afterWriteValue_string_string_bool != null) _afterWriteValue_string_string_bool.Invoke(@params);
        }
        ...
        internal static event Delegates.WriteValue_string_string_int_NormalArgs _afterWriteValue_string_string_int;
            ...
            INIParser self, string SectionName, string Key, int Value)
        {
            ...
            Value = @params.Value;
            orig(self, SectionName, Key, Value);
            if (_afterWriteValue_string_string_int != null) _afterWriteValue_string_string_int.Invoke(@params);
        }
        ...
        internal static void HookWriteValue_string_string_Int64()
        {
            if (!HookedList.Contains("WriteValue_string_string_Int64"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue_string_string_Int64"),
        ...
        internal static event Delegates.WriteValue_string_string_Int64_NormalArgs _afterWriteValue_string_string_Int64;
            ...
            string SectionName, string Key, long Value)
        {
            ...
            Value = @params.Value;
            orig(self, SectionName, Key, Value);
            if (_afterWriteValue_string_string_Int64 != null) _afterWriteValue_string_string_Int64.Invoke(@params);
        }
        ...
        internal static void HookWriteValue_string_string_Double()
        {
            if (!HookedList.Contains("WriteValue_string_string_Double"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue_string_string_Double"),
        ...
        internal static event Delegates.WriteValue_string_string_Double_NormalArgs
            _afterWriteValue_string_string_Double;
            ...
            INIParser self, string SectionName, string Key, double Value)
        {
            ...
            Value = @params.Value;
            orig(self, SectionName, Key, Value);
            if (_afterWriteValue_string_string_Double != null) _afterWriteValue_string_string_Double.Invoke(@params);
        }
        ...
        internal static void HookWriteValue_string_string_Array()
        {
            if (!HookedList.Contains("WriteValue_string_string_Array"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue_string_string_Array"),
        ...
        internal static event Delegates.WriteValue_string_string_Array_NormalArgs _afterWriteValue_string_string_Array;
            ...
            INIParser self, string SectionName, string Key, byte[] Value)
        {
            ...
            Value = @params.Value;
            orig(self, SectionName, Key, Value);
            if (_afterWriteValue_string_string_Array != null) _afterWriteValue_string_string_Array.Invoke(@params);
        }
        ...
        internal static event Delegates.WriteValue_string_string_DateTime_NormalArgs
        ...
        private static void WriteValue_string_string_DateTime(On.INIParser.orig_WriteValue_string_string_DateTime orig,
            INIParser self, string SectionName, string Key, DateTime Value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate byte[] DecodeByteArray_NormalArgs(Params_DecodeByteArray args);

        public delegate void EncodeByteArray_BeforeArgs(Params_EncodeByteArray args);

        public delegate string EncodeByteArray_NormalArgs(Params_EncodeByteArray args);

        public delegate void get_FileName_BeforeArgs(Params_get_FileName args);

        public delegate string get_FileName_NormalArgs(Params_get_FileName args);

        public delegate void get_iniString_BeforeArgs(Params_get_iniString args);

        public delegate string get_iniString_NormalArgs(Params_get_iniString args);
        ...
        public delegate bool isComment_NormalArgs(Params_isComment args);

        public delegate void IsKeyExists_BeforeArgs(Params_IsKeyExists args);

        public delegate bool IsKeyExists_NormalArgs(Params_IsKeyExists args);

        public delegate void IsSectionExists_BeforeArgs(Params_IsSectionExists args);

        public delegate bool IsSectionExists_NormalArgs(Params_IsSectionExists args);

        public delegate void KeyDelete_BeforeArgs(Params_KeyDelete args);

        public delegate void KeyDelete_NormalArgs(Params_KeyDelete args);

        public delegate void Open_string_BeforeArgs(Params_Open_string args);

        public delegate void Open_string_NormalArgs(Params_Open_string args);

        public delegate void Open_TextAsset_BeforeArgs(Params_Open_TextAsset args);

        public delegate void Open_TextAsset_NormalArgs(Params_Open_TextAsset args);

        public delegate void OpenFromString_BeforeArgs(Params_OpenFromString args);

        public delegate void OpenFromString_NormalArgs(Params_OpenFromString args);

        public delegate void ParseKeyValuePair_BeforeArgs(Params_ParseKeyValuePair args);

        public delegate bool ParseKeyValuePair_NormalArgs(Params_ParseKeyValuePair args);

        public delegate void ParseSectionName_BeforeArgs(Params_ParseSectionName args);

        public delegate string ParseSectionName_NormalArgs(Params_ParseSectionName args);

        public delegate void PerformFlush_BeforeArgs(Params_PerformFlush args);

        public delegate void PerformFlush_NormalArgs(Params_PerformFlush args);

        public delegate void ReadValue_string_string_Array_BeforeArgs(Params_ReadValue_string_string_Array args);

        public delegate byte[] ReadValue_string_string_Array_NormalArgs(Params_ReadValue_string_string_Array args);

        public delegate void ReadValue_string_string_bool_BeforeArgs(Params_ReadValue_string_string_bool args);

        public delegate bool ReadValue_string_string_bool_NormalArgs(Params_ReadValue_string_string_bool args);

        public delegate void ReadValue_string_string_DateTime_BeforeArgs(Params_ReadValue_string_string_DateTime args);

        public delegate DateTime ReadValue_string_string_DateTime_NormalArgs(
            Params_ReadValue_string_string_DateTime args);

        public delegate void ReadValue_string_string_Double_BeforeArgs(Params_ReadValue_string_string_Double args);

        public delegate double ReadValue_string_string_Double_NormalArgs(Params_ReadValue_string_string_Double args);

        public delegate void ReadValue_string_string_int_BeforeArgs(Params_ReadValue_string_string_int args);

        public delegate int ReadValue_string_string_int_NormalArgs(Params_ReadValue_string_string_int args);

        public delegate void ReadValue_string_string_Int64_BeforeArgs(Params_ReadValue_string_string_Int64 args);

        public delegate long ReadValue_string_string_Int64_NormalArgs(Params_ReadValue_string_string_Int64 args);

        public delegate void ReadValue_string_string_string_BeforeArgs(Params_ReadValue_string_string_string args);

        public delegate string ReadValue_string_string_string_NormalArgs(Params_ReadValue_string_string_string args);
        ...
        public delegate void WriteValue_string_string_bool_NormalArgs(Params_WriteValue_string_string_bool args);

        public delegate void
            WriteValue_string_string_DateTime_BeforeArgs(Params_WriteValue_string_string_DateTime args);

        public delegate void
            WriteValue_string_string_DateTime_NormalArgs(Params_WriteValue_string_string_DateTime args);

        public delegate void WriteValue_string_string_Double_BeforeArgs(Params_WriteValue_string_string_Double args);

        public delegate void WriteValue_string_string_Double_NormalArgs(Params_WriteValue_string_string_Double args);

        public delegate void WriteValue_string_string_int_BeforeArgs(Params_WriteValue_string_string_int args);

        public delegate void WriteValue_string_string_int_NormalArgs(Params_WriteValue_string_string_int args);

        public delegate void WriteValue_string_string_Int64_BeforeArgs(Params_WriteValue_string_string_Int64 args);

        public delegate void WriteValue_string_string_Int64_NormalArgs(Params_WriteValue_string_string_Int64 args);

        public delegate void WriteValue_string_string_string_BeforeArgs(Params_WriteValue_string_string_string args);

        public delegate void WriteValue_string_string_string_NormalArgs(Params_WriteValue_string_string_string args);
    ...
    {
        public static event Delegates.get_FileName_NormalArgs get_FileName
        {
            add
            {
        ...
        public static event Delegates.get_iniString_NormalArgs get_iniString
        {
            add
            {
        ...
        public static event Delegates.Open_string_NormalArgs Open_string
        {
            add
            {
        ...
        public static event Delegates.Open_TextAsset_NormalArgs Open_TextAsset
        {
            add
            {
        ...
        public static event Delegates.OpenFromString_NormalArgs OpenFromString
        {
            add
            {
        ...
        public static event Delegates.ParseSectionName_NormalArgs ParseSectionName
        {
            add
            {
        ...
        public static event Delegates.ParseKeyValuePair_NormalArgs ParseKeyValuePair
        {
            add
            {
        ...
        public static event Delegates.isComment_NormalArgs isComment
        {
            add
            {
        ...
        public static event Delegates.PerformFlush_NormalArgs PerformFlush
        {
            add
            {
        ...
        public static event Delegates.IsSectionExists_NormalArgs IsSectionExists
        {
            add
            {
        ...
        public static event Delegates.IsKeyExists_NormalArgs IsKeyExists
        {
            add
            {
        ...
        public static event Delegates.SectionDelete_NormalArgs SectionDelete
        {
            add
            {
        ...
        public static event Delegates.KeyDelete_NormalArgs KeyDelete
        {
            add
            {
        ...
        public static event Delegates.ReadValue_string_string_string_NormalArgs ReadValue_string_string_string
        {
            add
            {
        ...
        public static event Delegates.WriteValue_string_string_string_NormalArgs WriteValue_string_string_string
        {
            add
            {
        ...
        public static event Delegates.EncodeByteArray_NormalArgs EncodeByteArray
        {
            add
            {
        ...
        public static event Delegates.DecodeByteArray_NormalArgs DecodeByteArray
        {
            add
            {
        ...
        public static event Delegates.ReadValue_string_string_bool_NormalArgs ReadValue_string_string_bool
        {
            add
            {
        ...
        public static event Delegates.ReadValue_string_string_int_NormalArgs ReadValue_string_string_int
        {
            add
            {
        ...
        public static event Delegates.ReadValue_string_string_Int64_NormalArgs ReadValue_string_string_Int64
        {
            add
            {
        ...
        public static event Delegates.ReadValue_string_string_Double_NormalArgs ReadValue_string_string_Double
        {
            add
            {
        ...
        public static event Delegates.ReadValue_string_string_Array_NormalArgs ReadValue_string_string_Array
        {
            add
            {
        ...
        public static event Delegates.ReadValue_string_string_DateTime_NormalArgs ReadValue_string_string_DateTime
        {
            add
            {
        ...
        public static event Delegates.WriteValue_string_string_bool_NormalArgs WriteValue_string_string_bool
        {
            add
            {
        ...
        public static event Delegates.WriteValue_string_string_int_NormalArgs WriteValue_string_string_int
        {
            add
            {
        ...
        public static event Delegates.WriteValue_string_string_Int64_NormalArgs WriteValue_string_string_Int64
        {
            add
            {
        ...
        public static event Delegates.WriteValue_string_string_Double_NormalArgs WriteValue_string_string_Double
        {
            add
            {
        ...
        public static event Delegates.WriteValue_string_string_Array_NormalArgs WriteValue_string_string_Array
        {
            add
            {
        ...
        public static event Delegates.WriteValue_string_string_DateTime_NormalArgs WriteValue_string_string_DateTime
        {
            add
            {
    ...
    public static class WithOrig
    {
        public static event Delegates.get_FileName_NormalArgs get_FileName
        {
            add => HookEndpointManager.Add<Delegates.get_FileName_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_FileName"), value);
            remove => HookEndpointManager.Remove<Delegates.get_FileName_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_FileName"), value);
        }

        public static event Delegates.get_iniString_NormalArgs get_iniString
        {
            add => HookEndpointManager.Add<Delegates.get_iniString_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_iniString"), value);
            remove => HookEndpointManager.Remove<Delegates.get_iniString_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "get_iniString"), value);
        }
        ...
        public static event Delegates.ReadValue_string_string_Int64_NormalArgs ReadValue_string_string_Int64
        {
            add => HookEndpointManager.Add<Delegates.ReadValue_string_string_Int64_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue"), value);
            remove => HookEndpointManager.Remove<Delegates.ReadValue_string_string_Int64_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue"), value);
        }

        public static event Delegates.ReadValue_string_string_Double_NormalArgs ReadValue_string_string_Double
        {
            add => HookEndpointManager.Add<Delegates.ReadValue_string_string_Double_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue"), value);
            remove => HookEndpointManager.Remove<Delegates.ReadValue_string_string_Double_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue"), value);
        }

        public static event Delegates.ReadValue_string_string_Array_NormalArgs ReadValue_string_string_Array
        {
            add => HookEndpointManager.Add<Delegates.ReadValue_string_string_Array_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue"), value);
            remove => HookEndpointManager.Remove<Delegates.ReadValue_string_string_Array_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "ReadValue"), value);
        }
        ...
        public static event Delegates.WriteValue_string_string_Int64_NormalArgs WriteValue_string_string_Int64
        {
            add => HookEndpointManager.Add<Delegates.WriteValue_string_string_Int64_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue"), value);
            remove => HookEndpointManager.Remove<Delegates.WriteValue_string_string_Int64_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue"), value);
        }

        public static event Delegates.WriteValue_string_string_Double_NormalArgs WriteValue_string_string_Double
        {
            add => HookEndpointManager.Add<Delegates.WriteValue_string_string_Double_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue"), value);
            remove => HookEndpointManager.Remove<Delegates.WriteValue_string_string_Double_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue"), value);
        }

        public static event Delegates.WriteValue_string_string_Array_NormalArgs WriteValue_string_string_Array
        {
            add => HookEndpointManager.Add<Delegates.WriteValue_string_string_Array_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue"), value);
            remove => HookEndpointManager.Remove<Delegates.WriteValue_string_string_Array_NormalArgs>(
                ReflectionHelper.GetMethodInfo(typeof(INIParser), "WriteValue"), value);
        }
