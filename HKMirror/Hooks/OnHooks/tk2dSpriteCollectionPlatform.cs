    ...
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Valid()
        {
            if (!HookedList.Contains("get_Valid"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionPlatform), "get_Valid", true),
                    get_Valid);
            }
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Valid_WithArgs get_Valid
        {
            add => HookEndpointManager.Add<Delegates.get_Valid_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionPlatform), "get_Valid", true), value);
