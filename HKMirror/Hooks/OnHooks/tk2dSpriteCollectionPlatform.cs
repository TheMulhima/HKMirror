...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionPlatform), "get_Valid", true), get_Valid);
...
private static void CopyFrom(On.tk2dSpriteCollectionPlatform.orig_CopyFrom orig,tk2dSpriteCollectionPlatform self,  tk2dSpriteCollectionPlatform source)
{
...
public delegate bool get_Valid_WithArgs (Func<tk2dSpriteCollectionPlatform, bool> orig, tk2dSpriteCollectionPlatform self);
...
public delegate void CopyFrom_WithArgs (Action<tk2dSpriteCollectionPlatform,  tk2dSpriteCollectionPlatform> orig, tk2dSpriteCollectionPlatform self,  tk2dSpriteCollectionPlatform source);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Valid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionPlatform), "get_Valid", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Valid_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionPlatform), "get_Valid", true), value);
}
