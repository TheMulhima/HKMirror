...
public static class OnPowerAMiniControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PowerAMiniControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PowerAMiniControllerMacNativeProfile> orig,
            PowerAMiniControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PowerAMiniControllerMacNativeProfile> orig,
            PowerAMiniControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PowerAMiniControllerMacNativeProfile self;
        }
    }
