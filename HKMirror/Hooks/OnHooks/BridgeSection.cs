...
private static void Open_BridgeLever_bool(On.BridgeSection.orig_Open_BridgeLever_bool orig,BridgeSection self,  BridgeLever lever,  bool playAnim)
{
...
{
foreach (Delegates.Open_BridgeLever_bool_BeforeArgs toInvoke in _beforeOpen_BridgeLever_bool.GetInvocationList())
{
try
{
...
{
foreach (Delegates.Open_BridgeLever_bool_AfterArgs toInvoke in _afterOpen_BridgeLever_bool.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator Open_float(On.BridgeSection.orig_Open_float orig,BridgeSection self,  float waitTime)
{
...
private static System.Collections.IEnumerator OpenFence(On.BridgeSection.orig_OpenFence orig,BridgeSection self)
{
...
public delegate void Open_BridgeLever_bool_WithArgs (Action<BridgeSection,  BridgeLever,  bool> orig, BridgeSection self,  BridgeLever lever,  bool playAnim);
...
public delegate System.Collections.IEnumerator Open_float_AfterArgs(Params_Open_float args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Open_float_WithArgs (Func<BridgeSection,  float, System.Collections.IEnumerator> orig, BridgeSection self,  float waitTime);
public sealed class Params_OpenFence
{
public BridgeSection self;
}
public delegate void OpenFence_BeforeArgs(Params_OpenFence args);
public delegate System.Collections.IEnumerator OpenFence_AfterArgs(Params_OpenFence args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator OpenFence_WithArgs (Func<BridgeSection, System.Collections.IEnumerator> orig, BridgeSection self);
}
