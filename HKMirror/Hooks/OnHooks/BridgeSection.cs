...
public static class OnBridgeSection
{
    ...
    public static class Delegates
    {
        ...
        public delegate IEnumerator Open_float_AfterArgs(Params_Open_float args, IEnumerator ret);

        public delegate void Open_float_BeforeArgs(Params_Open_float args);

        public delegate IEnumerator Open_float_WithArgs(Func<BridgeSection, float, IEnumerator> orig,
            BridgeSection self, float waitTime);

        public delegate IEnumerator OpenFence_AfterArgs(Params_OpenFence args, IEnumerator ret);

        public delegate void OpenFence_BeforeArgs(Params_OpenFence args);

        public delegate IEnumerator OpenFence_WithArgs(Func<BridgeSection, IEnumerator> orig, BridgeSection self);
