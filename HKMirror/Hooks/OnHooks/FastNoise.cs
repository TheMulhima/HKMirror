...
public static class OnFastNoise
{
    internal static class HookHandler
    {
        ...
        internal static void HookOnDisable()
        {
            if (!HookedList.Contains("OnDisable"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityStandardAssets.ImageEffects.FastNoise), "OnDisable",
                        true), OnDisable);
            }
        }
        ...
        private static void OnDisable(Action<UnityStandardAssets.ImageEffects.FastNoise> orig,
            UnityStandardAssets.ImageEffects.FastNoise self)
        {
        ...
        internal static void HookCheckResources()
        {
            if (!HookedList.Contains("CheckResources"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityStandardAssets.ImageEffects.FastNoise), "CheckResources",
                        true), CheckResources);
            }
        }
        ...
        private static bool CheckResources(Func<UnityStandardAssets.ImageEffects.FastNoise, bool> orig,
            UnityStandardAssets.ImageEffects.FastNoise self)
        {
        ...
        internal static void HookOnRenderImage()
        {
            if (!HookedList.Contains("OnRenderImage"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityStandardAssets.ImageEffects.FastNoise), "OnRenderImage",
                        true), OnRenderImage);
            }
        }
        ...
        private static void OnRenderImage(
            Action<UnityStandardAssets.ImageEffects.FastNoise, UnityEngine.RenderTexture, UnityEngine.RenderTexture>
                orig, UnityStandardAssets.ImageEffects.FastNoise self, UnityEngine.RenderTexture source,
        ...
        internal static void HookDrawNoiseQuadGrid()
        {
            if (!HookedList.Contains("DrawNoiseQuadGrid"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(UnityStandardAssets.ImageEffects.FastNoise),
                        "DrawNoiseQuadGrid", false), DrawNoiseQuadGrid);
            }
        }
        ...
        private static void DrawNoiseQuadGrid(
            Action<UnityEngine.RenderTexture, UnityEngine.RenderTexture, UnityEngine.Material, UnityEngine.Texture2D,
                int, int> orig, UnityEngine.RenderTexture source, UnityEngine.RenderTexture dest,
            UnityEngine.Material fxMaterial, UnityEngine.Texture2D noise, int passNr, int frameMultiple)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnDisable_WithArgs(Action<UnityStandardAssets.ImageEffects.FastNoise> orig,
            UnityStandardAssets.ImageEffects.FastNoise self);
        ...
        public delegate bool CheckResources_WithArgs(Func<UnityStandardAssets.ImageEffects.FastNoise, bool> orig,
            UnityStandardAssets.ImageEffects.FastNoise self);
    ...
    public static class WithOrig
    {
        public static event Delegates.OnDisable_WithArgs OnDisable
        {
            add => HookEndpointManager.Add<Delegates.OnDisable_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityStandardAssets.ImageEffects.FastNoise), "OnDisable", true),
                value);
        ...
        public static event Delegates.DrawNoiseQuadGrid_WithArgs DrawNoiseQuadGrid
        {
            add => HookEndpointManager.Add<Delegates.DrawNoiseQuadGrid_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(UnityStandardAssets.ImageEffects.FastNoise), "DrawNoiseQuadGrid",
                    false), value);
