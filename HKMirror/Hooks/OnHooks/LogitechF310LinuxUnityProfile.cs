...
public static class OnLogitechF310LinuxUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LogitechF310LinuxUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<LogitechF310LinuxUnityProfile> orig, LogitechF310LinuxUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<LogitechF310LinuxUnityProfile> orig,
            LogitechF310LinuxUnityProfile self);

        public sealed class Params_Define
        {
            public LogitechF310LinuxUnityProfile self;
        }
    }
