...
public static class OnXInputWindowsChromeUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XInputWindowsChromeUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XInputWindowsChromeUnityProfile> orig, XInputWindowsChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XInputWindowsChromeUnityProfile> orig,
            XInputWindowsChromeUnityProfile self);

        public sealed class Params_Define
        {
            public XInputWindowsChromeUnityProfile self;
        }
    }
