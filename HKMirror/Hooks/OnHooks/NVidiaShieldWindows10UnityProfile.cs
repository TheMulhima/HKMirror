...
public static class OnNVidiaShieldWindows10UnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NVidiaShieldWindows10UnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NVidiaShieldWindows10UnityProfile> orig,
            NVidiaShieldWindows10UnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NVidiaShieldWindows10UnityProfile> orig,
            NVidiaShieldWindows10UnityProfile self);

        public sealed class Params_Define
        {
            public NVidiaShieldWindows10UnityProfile self;
        }
    }
