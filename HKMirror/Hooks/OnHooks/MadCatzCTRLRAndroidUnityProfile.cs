...
public static class OnMadCatzCTRLRAndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzCTRLRAndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<MadCatzCTRLRAndroidUnityProfile> orig, MadCatzCTRLRAndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzCTRLRAndroidUnityProfile> orig,
            MadCatzCTRLRAndroidUnityProfile self);

        public sealed class Params_Define
        {
            public MadCatzCTRLRAndroidUnityProfile self;
        }
    }
