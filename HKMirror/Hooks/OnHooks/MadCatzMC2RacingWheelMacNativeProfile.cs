...
public static class OnMadCatzMC2RacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzMC2RacingWheelMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzMC2RacingWheelMacNativeProfile> orig,
            MadCatzMC2RacingWheelMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzMC2RacingWheelMacNativeProfile> orig,
            MadCatzMC2RacingWheelMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzMC2RacingWheelMacNativeProfile self;
        }
    }
