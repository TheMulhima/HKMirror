...
public static class OnGoogleStadiaWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GoogleStadiaWindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GoogleStadiaWindowsNativeProfile> orig, GoogleStadiaWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GoogleStadiaWindowsNativeProfile> orig,
            GoogleStadiaWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public GoogleStadiaWindowsNativeProfile self;
        }
    }
