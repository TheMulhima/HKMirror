...
public static class OnHashTableAdd
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableAdd), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.HashTableAdd> orig,
            HutongGames.PlayMaker.Actions.HashTableAdd self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableAdd), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.HashTableAdd> orig,
            HutongGames.PlayMaker.Actions.HashTableAdd self)
        {
        ...
        internal static void HookAddToHashTable()
        {
            if (!HookedList.Contains("AddToHashTable"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.HashTableAdd), "AddToHashTable",
                        true), AddToHashTable);
            }
        }
        ...
        private static void AddToHashTable(Action<HutongGames.PlayMaker.Actions.HashTableAdd> orig,
            HutongGames.PlayMaker.Actions.HashTableAdd self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableAdd> orig,
            HutongGames.PlayMaker.Actions.HashTableAdd self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableAdd> orig,
            HutongGames.PlayMaker.Actions.HashTableAdd self);
        ...
        public delegate void AddToHashTable_WithArgs(Action<HutongGames.PlayMaker.Actions.HashTableAdd> orig,
            HutongGames.PlayMaker.Actions.HashTableAdd self);
    }
