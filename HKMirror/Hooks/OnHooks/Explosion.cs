...
public static class OnExplosion
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "Reset", true),
                    Reset);
            }
        }
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        internal static void HookDoExplosion()
        {
            if (!HookedList.Contains("DoExplosion"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "DoExplosion",
                        true), DoExplosion);
            }
        }
        ...
        private static bool ShouldApplyForce(
            Func<HutongGames.PlayMaker.Actions.Explosion, UnityEngine.GameObject, bool> orig,
            HutongGames.PlayMaker.Actions.Explosion self, UnityEngine.GameObject go)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.Explosion> orig,
            HutongGames.PlayMaker.Actions.Explosion self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.Explosion> orig,
            HutongGames.PlayMaker.Actions.Explosion self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.Explosion> orig,
            HutongGames.PlayMaker.Actions.Explosion self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.Explosion> orig,
            HutongGames.PlayMaker.Actions.Explosion self);
        ...
        public delegate void DoExplosion_WithArgs(Action<HutongGames.PlayMaker.Actions.Explosion> orig,
            HutongGames.PlayMaker.Actions.Explosion self);
        ...
        public delegate bool ShouldApplyForce_WithArgs(
            Func<HutongGames.PlayMaker.Actions.Explosion, UnityEngine.GameObject, bool> orig,
            HutongGames.PlayMaker.Actions.Explosion self, UnityEngine.GameObject go);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "Reset", true), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "OnPreprocess", true),
                value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "OnFixedUpdate", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoExplosion_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "DoExplosion", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.DoExplosion_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "DoExplosion", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.ShouldApplyForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "ShouldApplyForce",
                    true), value);
            remove => HookEndpointManager.Remove<Delegates.ShouldApplyForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.Explosion), "ShouldApplyForce",
                    true), value);
        }
    }
