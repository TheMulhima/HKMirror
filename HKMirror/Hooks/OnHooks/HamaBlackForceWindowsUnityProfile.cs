...
public static class OnHamaBlackForceWindowsUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HamaBlackForceWindowsUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HamaBlackForceWindowsUnityProfile> orig,
            HamaBlackForceWindowsUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HamaBlackForceWindowsUnityProfile> orig,
            HamaBlackForceWindowsUnityProfile self);

        public sealed class Params_Define
        {
            public HamaBlackForceWindowsUnityProfile self;
        }
    }
