...
public static class OnChaseObjectGround
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<ChaseObjectGround> orig, ChaseObjectGround self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<ChaseObjectGround> orig, ChaseObjectGround self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<ChaseObjectGround> orig, ChaseObjectGround self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<ChaseObjectGround> orig, ChaseObjectGround self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<ChaseObjectGround> orig, ChaseObjectGround self)
        {
        ...
        internal static void HookDoChase()
        {
            if (!HookedList.Contains("DoChase"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "DoChase"), DoChase);
            }
        }
        ...
        private static void DoChase(Action<ChaseObjectGround> orig, ChaseObjectGround self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<ChaseObjectGround> orig, ChaseObjectGround self);

        public delegate void DoChase_AfterArgs(Params_DoChase args);

        public delegate void DoChase_BeforeArgs(Params_DoChase args);

        public delegate void DoChase_WithArgs(Action<ChaseObjectGround> orig, ChaseObjectGround self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<ChaseObjectGround> orig, ChaseObjectGround self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<ChaseObjectGround> orig, ChaseObjectGround self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<ChaseObjectGround> orig, ChaseObjectGround self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<ChaseObjectGround> orig, ChaseObjectGround self);

        public sealed class Params_Reset
        {
            public ChaseObjectGround self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "Awake"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "OnEnter"), value);
        ...
        public static event Delegates.DoChase_WithArgs DoChase
        {
            add => HookEndpointManager.Add<Delegates.DoChase_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(ChaseObjectGround), "DoChase"), value);
