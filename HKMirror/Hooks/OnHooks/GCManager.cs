...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GCManager), "get_IsAutomaticCollectionEnabled", false), get_IsAutomaticCollectionEnabled);

}
}
internal static event Delegates.get_IsAutomaticCollectionEnabled_BeforeArgs _beforeget_IsAutomaticCollectionEnabled;
internal static event Delegates.get_IsAutomaticCollectionEnabled_AfterArgs _afterget_IsAutomaticCollectionEnabled;
private static bool get_IsAutomaticCollectionEnabled(Func<bool> orig)
{
if (_beforeget_IsAutomaticCollectionEnabled != null)
{
foreach (Delegates.get_IsAutomaticCollectionEnabled_BeforeArgs toInvoke in _beforeget_IsAutomaticCollectionEnabled.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_IsAutomaticCollectionEnabled_AfterArgs toInvoke in _afterget_IsAutomaticCollectionEnabled.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GCManager), "set_IsAutomaticCollectionEnabled", false), set_IsAutomaticCollectionEnabled);

}
}
internal static event Delegates.set_IsAutomaticCollectionEnabled_BeforeArgs _beforeset_IsAutomaticCollectionEnabled;
internal static event Delegates.set_IsAutomaticCollectionEnabled_AfterArgs _afterset_IsAutomaticCollectionEnabled;
...
{
foreach (Delegates.set_IsAutomaticCollectionEnabled_BeforeArgs toInvoke in _beforeset_IsAutomaticCollectionEnabled.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_IsAutomaticCollectionEnabled_AfterArgs toInvoke in _afterset_IsAutomaticCollectionEnabled.GetInvocationList())
{
try
{
...
{
add => HookEndpointManager.Add<Delegates.get_IsSupported_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GCManager), "get_IsSupported", false), value);
remove => HookEndpointManager.Remove<Delegates.get_IsSupported_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GCManager), "get_IsSupported", false), value);
}
public static event Delegates.get_IsAutomaticCollectionEnabled_WithArgs get_IsAutomaticCollectionEnabled
{
add => HookEndpointManager.Add<Delegates.get_IsAutomaticCollectionEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GCManager), "get_IsAutomaticCollectionEnabled", false), value);
remove => HookEndpointManager.Remove<Delegates.get_IsAutomaticCollectionEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GCManager), "get_IsAutomaticCollectionEnabled", false), value);
}
public static event Delegates.set_IsAutomaticCollectionEnabled_WithArgs set_IsAutomaticCollectionEnabled
{
add => HookEndpointManager.Add<Delegates.set_IsAutomaticCollectionEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GCManager), "set_IsAutomaticCollectionEnabled", false), value);
remove => HookEndpointManager.Remove<Delegates.set_IsAutomaticCollectionEnabled_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GCManager), "set_IsAutomaticCollectionEnabled", false), value);
}
