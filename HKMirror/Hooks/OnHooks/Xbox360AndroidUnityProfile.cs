...
public static class OnXbox360AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Xbox360AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<Xbox360AndroidUnityProfile> orig, Xbox360AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<Xbox360AndroidUnityProfile> orig, Xbox360AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public Xbox360AndroidUnityProfile self;
        }
    }
