...
public static class OnBounds
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Bounds), "Reset"),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<Bounds> orig,
            Bounds self)
        {
        ...
        internal static void HookGetEm()
        {
            if (!HookedList.Contains("GetEm"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Bounds), "GetEm"),
                    GetEm);
            }
        }
        ...
        private static void GetEm(Action<Bounds> orig,
            Bounds self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Bounds), "OnEnter"),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<Bounds> orig,
            Bounds self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Bounds), "OnUpdate"),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<Bounds> orig,
            Bounds self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void GetEm_WithArgs(Action<Bounds> orig,
            Bounds self);
        ...
        public delegate void OnEnter_WithArgs(Action<Bounds> orig,
            Bounds self);
        ...
        public delegate void OnUpdate_WithArgs(Action<Bounds> orig,
            Bounds self);
        ...
        public delegate void Reset_WithArgs(Action<Bounds> orig,
            Bounds self);
