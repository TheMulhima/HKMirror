...
public static class OnPDPAfterglowControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PDPAfterglowControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PDPAfterglowControllerMacNativeProfile> orig,
            PDPAfterglowControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PDPAfterglowControllerMacNativeProfile> orig,
            PDPAfterglowControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public PDPAfterglowControllerMacNativeProfile self;
        }
    }
