...
public static class OnNVidiaShieldWindows81UnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NVidiaShieldWindows81UnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<NVidiaShieldWindows81UnityProfile> orig,
            NVidiaShieldWindows81UnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NVidiaShieldWindows81UnityProfile> orig,
            NVidiaShieldWindows81UnityProfile self);

        public sealed class Params_Define
        {
            public NVidiaShieldWindows81UnityProfile self;
        }
    }
