...
public static class OnThrustMasterFerrari430RacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(ThrustMasterFerrari430RacingWheelMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<ThrustMasterFerrari430RacingWheelMacNativeProfile> orig,
            ThrustMasterFerrari430RacingWheelMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ThrustMasterFerrari430RacingWheelMacNativeProfile> orig,
            ThrustMasterFerrari430RacingWheelMacNativeProfile self);

        public sealed class Params_Define
        {
            public ThrustMasterFerrari430RacingWheelMacNativeProfile self;
        }
    }
