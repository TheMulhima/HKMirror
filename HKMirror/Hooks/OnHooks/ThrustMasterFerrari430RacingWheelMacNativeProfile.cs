...
public static class OnThrustMasterFerrari430RacingWheelMacNativeProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.NativeDeviceProfiles.ThrustMasterFerrari430RacingWheelMacNativeProfile),
                        "Define", true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.NativeDeviceProfiles.ThrustMasterFerrari430RacingWheelMacNativeProfile> orig,
            InControl.NativeDeviceProfiles.ThrustMasterFerrari430RacingWheelMacNativeProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.NativeDeviceProfiles.ThrustMasterFerrari430RacingWheelMacNativeProfile), "Define",
                    true), value);
