...
public static class OnuGuiImageSetSprite
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageSetSprite), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageSetSprite), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self)
        {
        ...
        internal static void HookDoSetImageSourceValue()
        {
            if (!HookedList.Contains("DoSetImageSourceValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageSetSprite),
                        "DoSetImageSourceValue", true), DoSetImageSourceValue);
            }
        }
        ...
        private static void DoSetImageSourceValue(Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageSetSprite), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self);
        ...
        public delegate void DoSetImageSourceValue_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.uGuiImageSetSprite> orig,
            HutongGames.PlayMaker.Actions.uGuiImageSetSprite self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageSetSprite), "Reset", true),
                value);
        ...
        public static event Delegates.DoSetImageSourceValue_WithArgs DoSetImageSourceValue
        {
            add => HookEndpointManager.Add<Delegates.DoSetImageSourceValue_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.uGuiImageSetSprite),
                    "DoSetImageSourceValue", true), value);
