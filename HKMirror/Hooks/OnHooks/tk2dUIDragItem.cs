...
{
foreach (Delegates.UpdateBtnPosition_BeforeArgs toInvoke in _beforeUpdateBtnPosition.GetInvocationList())
{
try
{
...
private static UnityEngine.Vector3 CalculateNewPos(On.tk2dUIDragItem.orig_CalculateNewPos orig,tk2dUIDragItem self)
{
...
public delegate UnityEngine.Vector3 CalculateNewPos_AfterArgs(Params_CalculateNewPos args, UnityEngine.Vector3 ret);
public delegate UnityEngine.Vector3 CalculateNewPos_WithArgs (Func<tk2dUIDragItem, UnityEngine.Vector3> orig, tk2dUIDragItem self);
