...
public static class Ontk2dUIDragItem
{
    ...
    public static class Delegates
    {
        ...
        public delegate Vector3 CalculateNewPos_AfterArgs(Params_CalculateNewPos args, Vector3 ret);

        public delegate void CalculateNewPos_BeforeArgs(Params_CalculateNewPos args);

        public delegate Vector3 CalculateNewPos_WithArgs(Func<tk2dUIDragItem, Vector3> orig, tk2dUIDragItem self);
