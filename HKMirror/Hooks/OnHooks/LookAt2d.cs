...
public static class OnLookAt2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2d), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2d), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2d), "OnUpdate", true),
                    OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self)
        {
        ...
        internal static void HookDoLookAt()
        {
            if (!HookedList.Contains("DoLookAt"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2d), "DoLookAt", true),
                    DoLookAt);
            }
        }
        ...
        private static void DoLookAt(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self);
        ...
        public delegate void DoLookAt_WithArgs(Action<HutongGames.PlayMaker.Actions.LookAt2d> orig,
            HutongGames.PlayMaker.Actions.LookAt2d self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2d), "Reset", true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.LookAt2d), "OnEnter", true), value);
