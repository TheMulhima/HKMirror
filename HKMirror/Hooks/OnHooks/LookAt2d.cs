...
public static class OnLookAt2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<LookAt2d> orig, LookAt2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<LookAt2d> orig, LookAt2d self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "OnUpdate"), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<LookAt2d> orig, LookAt2d self)
        {
        ...
        internal static void HookDoLookAt()
        {
            if (!HookedList.Contains("DoLookAt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "DoLookAt"), DoLookAt);
            }
        }
        ...
        private static void DoLookAt(Action<LookAt2d> orig, LookAt2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoLookAt_WithArgs(Action<LookAt2d> orig, LookAt2d self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<LookAt2d> orig, LookAt2d self);

        public delegate void OnUpdate_AfterArgs(Params_OnUpdate args);

        public delegate void OnUpdate_BeforeArgs(Params_OnUpdate args);

        public delegate void OnUpdate_WithArgs(Action<LookAt2d> orig, LookAt2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<LookAt2d> orig, LookAt2d self);

        public sealed class Params_Reset
        {
            public LookAt2d self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "OnEnter"), value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "OnUpdate"), value);
        ...
        public static event Delegates.DoLookAt_WithArgs DoLookAt
        {
            add => HookEndpointManager.Add<Delegates.DoLookAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(LookAt2d), "DoLookAt"), value);
