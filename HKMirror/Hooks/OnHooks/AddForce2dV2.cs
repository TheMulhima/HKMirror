...
public static class OnAddForce2dV2
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dV2), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dV2), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dV2), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dV2), "OnFixedUpdate",
                        true), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self)
        {
        ...
        internal static void HookDoAddForce()
        {
            if (!HookedList.Contains("DoAddForce"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dV2), "DoAddForce",
                        true), DoAddForce);
            }
        }
        ...
        private static void DoAddForce(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self);
        ...
        public delegate void DoAddForce_WithArgs(Action<HutongGames.PlayMaker.Actions.AddForce2dV2> orig,
            HutongGames.PlayMaker.Actions.AddForce2dV2 self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.DoAddForce_WithArgs DoAddForce
        {
            add => HookEndpointManager.Add<Delegates.DoAddForce_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.AddForce2dV2), "DoAddForce", true),
                value);
