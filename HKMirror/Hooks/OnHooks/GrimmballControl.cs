...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_Force", true), get_Force);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_Force", true), set_Force);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_TweenY", true), get_TweenY);
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_TweenY", true), set_TweenY);
...
private static void OnTriggerEnter2D(On.GrimmballControl.orig_OnTriggerEnter2D orig,GrimmballControl self,  UnityEngine.Collider2D collision)
{
...
private static System.Collections.IEnumerator DoFire(On.GrimmballControl.orig_DoFire orig,GrimmballControl self)
{
...
private static System.Collections.IEnumerator Shrink(On.GrimmballControl.orig_Shrink orig,GrimmballControl self)
{
...
public delegate void set_Force_WithArgs (Action<GrimmballControl,  float> orig, GrimmballControl self,  float value);
...
public delegate void set_TweenY_WithArgs (Action<GrimmballControl,  float> orig, GrimmballControl self,  float value);
...
public delegate void OnTriggerEnter2D_WithArgs (Action<GrimmballControl,  UnityEngine.Collider2D> orig, GrimmballControl self,  UnityEngine.Collider2D collision);
...
public delegate System.Collections.IEnumerator DoFire_AfterArgs(Params_DoFire args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator DoFire_WithArgs (Func<GrimmballControl, System.Collections.IEnumerator> orig, GrimmballControl self);
public sealed class Params_Shrink
{
public GrimmballControl self;
}
public delegate void Shrink_BeforeArgs(Params_Shrink args);
public delegate System.Collections.IEnumerator Shrink_AfterArgs(Params_Shrink args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator Shrink_WithArgs (Func<GrimmballControl, System.Collections.IEnumerator> orig, GrimmballControl self);
}
...
{
add => HookEndpointManager.Add<Delegates.get_Force_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_Force", true), value);
remove => HookEndpointManager.Remove<Delegates.get_Force_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_Force", true), value);
}
public static event Delegates.set_Force_WithArgs set_Force
{
add => HookEndpointManager.Add<Delegates.set_Force_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_Force", true), value);
remove => HookEndpointManager.Remove<Delegates.set_Force_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_Force", true), value);
}
public static event Delegates.get_TweenY_WithArgs get_TweenY
{
add => HookEndpointManager.Add<Delegates.get_TweenY_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_TweenY", true), value);
remove => HookEndpointManager.Remove<Delegates.get_TweenY_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_TweenY", true), value);
}
public static event Delegates.set_TweenY_WithArgs set_TweenY
{
add => HookEndpointManager.Add<Delegates.set_TweenY_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_TweenY", true), value);
remove => HookEndpointManager.Remove<Delegates.set_TweenY_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_TweenY", true), value);
}
