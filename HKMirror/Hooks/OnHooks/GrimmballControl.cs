...
public static class OnGrimmballControl
{
    internal static class HookHandler
    {
        ...
        private static System.Collections.IEnumerator DoFire(On.GrimmballControl.orig_DoFire orig,
            GrimmballControl self)
        {
        ...
        private static System.Collections.IEnumerator Shrink(On.GrimmballControl.orig_Shrink orig,
            GrimmballControl self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<GrimmballControl, UnityEngine.Collider2D> orig,
            GrimmballControl self, UnityEngine.Collider2D collision);
        ...
        public delegate System.Collections.IEnumerator DoFire_AfterArgs(Params_DoFire args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator DoFire_WithArgs(
            Func<GrimmballControl, System.Collections.IEnumerator> orig, GrimmballControl self);
        ...
        public delegate System.Collections.IEnumerator Shrink_AfterArgs(Params_Shrink args,
            System.Collections.IEnumerator ret);

        public delegate System.Collections.IEnumerator Shrink_WithArgs(
            Func<GrimmballControl, System.Collections.IEnumerator> orig, GrimmballControl self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.get_Force_WithArgs get_Force
        {
            add => HookEndpointManager.Add<Delegates.get_Force_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_Force", true), value);
        ...
        public static event Delegates.set_Force_WithArgs set_Force
        {
            add => HookEndpointManager.Add<Delegates.set_Force_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_Force", true), value);
        ...
        public static event Delegates.get_TweenY_WithArgs get_TweenY
        {
            add => HookEndpointManager.Add<Delegates.get_TweenY_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "get_TweenY", true), value);
        ...
        public static event Delegates.set_TweenY_WithArgs set_TweenY
        {
            add => HookEndpointManager.Add<Delegates.set_TweenY_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GrimmballControl), "set_TweenY", true), value);
