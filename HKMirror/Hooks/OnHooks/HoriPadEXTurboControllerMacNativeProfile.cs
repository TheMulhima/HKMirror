...
public static class OnHoriPadEXTurboControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HoriPadEXTurboControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<HoriPadEXTurboControllerMacNativeProfile> orig,
            HoriPadEXTurboControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HoriPadEXTurboControllerMacNativeProfile> orig,
            HoriPadEXTurboControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public HoriPadEXTurboControllerMacNativeProfile self;
        }
    }
