...
public static class OnGetTriggerInfo
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTriggerInfo), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetTriggerInfo> orig,
            HutongGames.PlayMaker.Actions.GetTriggerInfo self)
        {
        ...
        internal static void HookStoreTriggerInfo()
        {
            if (!HookedList.Contains("StoreTriggerInfo"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTriggerInfo),
        ...
        private static void StoreTriggerInfo(Action<HutongGames.PlayMaker.Actions.GetTriggerInfo> orig,
            HutongGames.PlayMaker.Actions.GetTriggerInfo self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTriggerInfo), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetTriggerInfo> orig,
            HutongGames.PlayMaker.Actions.GetTriggerInfo self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetTriggerInfo> orig,
            HutongGames.PlayMaker.Actions.GetTriggerInfo self);
        ...
        public delegate void StoreTriggerInfo_WithArgs(Action<HutongGames.PlayMaker.Actions.GetTriggerInfo> orig,
            HutongGames.PlayMaker.Actions.GetTriggerInfo self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetTriggerInfo> orig,
            HutongGames.PlayMaker.Actions.GetTriggerInfo self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.StoreTriggerInfo_WithArgs StoreTriggerInfo
        {
            add => HookEndpointManager.Add<Delegates.StoreTriggerInfo_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTriggerInfo), "StoreTriggerInfo",
                    true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTriggerInfo), "OnEnter", true),
                value);
