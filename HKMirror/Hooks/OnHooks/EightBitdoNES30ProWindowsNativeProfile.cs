...
public static class OnEightBitdoNES30ProWindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(EightBitdoNES30ProWindowsNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<EightBitdoNES30ProWindowsNativeProfile> orig,
            EightBitdoNES30ProWindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<EightBitdoNES30ProWindowsNativeProfile> orig,
            EightBitdoNES30ProWindowsNativeProfile self);

        public sealed class Params_Define
        {
            public EightBitdoNES30ProWindowsNativeProfile self;
        }
    }
