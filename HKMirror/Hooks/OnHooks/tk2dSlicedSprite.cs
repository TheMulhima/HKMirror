...
new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "set_anchor", true), set_anchor);
...
private static void set_anchor(Action<tk2dSlicedSprite,  tk2dBaseSprite.Anchor> orig, tk2dSlicedSprite self,  tk2dBaseSprite.Anchor value)
{
...
public delegate void set_anchor_WithArgs (Action<tk2dSlicedSprite,  tk2dBaseSprite.Anchor> orig, tk2dSlicedSprite self,  tk2dBaseSprite.Anchor value);
...
{
add => HookEndpointManager.Add<Delegates.set_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "set_anchor", true), value);
remove => HookEndpointManager.Remove<Delegates.set_anchor_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "set_anchor", true), value);
}
