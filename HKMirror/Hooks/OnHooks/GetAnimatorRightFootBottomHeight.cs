...
public static class OnGetAnimatorRightFootBottomHeight
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight), "Reset", true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight), "OnLateUpdate", true),
                    OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight self)
        {
        ...
        internal static void Hook_getRightFootBottonHeight()
        {
            if (!HookedList.Contains("_getRightFootBottonHeight"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight),
                        "_getRightFootBottonHeight", true), _getRightFootBottonHeight);
            }
        }
        ...
        private static void _getRightFootBottonHeight(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight self);
        ...
        public delegate void _getRightFootBottonHeight_WithArgs(
            Action<HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight> orig,
            HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight),
                    "Reset", true), value);
        ...
        public static event Delegates._getRightFootBottonHeight_WithArgs _getRightFootBottonHeight
        {
            add => HookEndpointManager.Add<Delegates._getRightFootBottonHeight_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetAnimatorRightFootBottomHeight),
                    "_getRightFootBottonHeight", true), value);
