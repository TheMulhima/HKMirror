...
public static class OnGrassSpriteBehaviour
{
    internal static class HookHandler
    {
            ...
            GrassSpriteBehaviour self)
        {
            ...
            {
                foreach (Delegates.OnBecameInvisible_BeforeArgs toInvoke in
                         _beforeOnBecameInvisible.GetInvocationList())
                {
                    try
                    {
        ...
        private static void OnTriggerEnter2D(On.GrassSpriteBehaviour.orig_OnTriggerEnter2D orig,
            GrassSpriteBehaviour self, UnityEngine.Collider2D collision)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnTriggerEnter2D_WithArgs(Action<GrassSpriteBehaviour, UnityEngine.Collider2D> orig,
            GrassSpriteBehaviour self, UnityEngine.Collider2D collision);
