...
public static class OniTweenRotateFrom
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateFrom), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateFrom), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self)
        {
        ...
        internal static void HookOnExit()
        {
            if (!HookedList.Contains("OnExit"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateFrom), "OnExit",
                        true), OnExit);
            }
        }
        ...
        private static void OnExit(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self)
        {
        ...
        internal static void HookDoiTween()
        {
            if (!HookedList.Contains("DoiTween"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateFrom), "DoiTween",
                        true), DoiTween);
            }
        }
        ...
        private static void DoiTween(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self);
        ...
        public delegate void OnExit_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self);
        ...
        public delegate void DoiTween_WithArgs(Action<HutongGames.PlayMaker.Actions.iTweenRotateFrom> orig,
            HutongGames.PlayMaker.Actions.iTweenRotateFrom self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateFrom), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateFrom), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnExit_WithArgs OnExit
        {
            add => HookEndpointManager.Add<Delegates.OnExit_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.iTweenRotateFrom), "OnExit", true),
                value);
