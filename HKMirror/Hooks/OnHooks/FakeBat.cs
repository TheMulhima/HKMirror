...
{
foreach (Delegates.NotifyAllBossAwake_BeforeArgs toInvoke in _beforeNotifyAllBossAwake.GetInvocationList())
{
try
{
...
{
foreach (Delegates.NotifyAllBossAwake_AfterArgs toInvoke in _afterNotifyAllBossAwake.GetInvocationList())
{
try
{
...
private static System.Collections.IEnumerator SendOutRoutine(On.FakeBat.orig_SendOutRoutine orig,FakeBat self)
{
...
private static System.Collections.IEnumerator BringInRoutine(On.FakeBat.orig_BringInRoutine orig,FakeBat self)
{
...
private static void Accelerate(On.FakeBat.orig_Accelerate orig,FakeBat self,  UnityEngine.Vector2 fixedAcceleration,  UnityEngine.Vector2 speedLimit)
{
Delegates.Params_Accelerate @params = new() 
{
self = self
, fixedAcceleration = fixedAcceleration
...
public delegate System.Collections.IEnumerator SendOutRoutine_AfterArgs(Params_SendOutRoutine args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator SendOutRoutine_WithArgs (Func<FakeBat, System.Collections.IEnumerator> orig, FakeBat self);
...
public delegate System.Collections.IEnumerator BringInRoutine_AfterArgs(Params_BringInRoutine args, System.Collections.IEnumerator ret);
public delegate System.Collections.IEnumerator BringInRoutine_WithArgs (Func<FakeBat, System.Collections.IEnumerator> orig, FakeBat self);
...
{
public FakeBat self;
public UnityEngine.Vector2 fixedAcceleration;
public UnityEngine.Vector2 speedLimit;
}
...
public delegate void Accelerate_WithArgs (Action<FakeBat,  UnityEngine.Vector2,  UnityEngine.Vector2> orig, FakeBat self,  UnityEngine.Vector2 fixedAcceleration,  UnityEngine.Vector2 speedLimit);
}
