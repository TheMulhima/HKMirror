...
public static class OnThrustmasterGPXControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(ThrustmasterGPXControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<ThrustmasterGPXControllerMacNativeProfile> orig,
            ThrustmasterGPXControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<ThrustmasterGPXControllerMacNativeProfile> orig,
            ThrustmasterGPXControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public ThrustmasterGPXControllerMacNativeProfile self;
        }
    }
