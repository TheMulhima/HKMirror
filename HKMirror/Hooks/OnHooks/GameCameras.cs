...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "get_sceneParticles", true), get_sceneParticles);
...
private static SceneParticlesController get_sceneParticles(Func<GameCameras, SceneParticlesController> orig, GameCameras self)
{
...
{
foreach (Delegates.get_sceneParticles_BeforeArgs toInvoke in _beforeget_sceneParticles.GetInvocationList())
{
try
{
...
{
foreach (Delegates.get_sceneParticles_AfterArgs toInvoke in _afterget_sceneParticles.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "set_sceneParticles", true), set_sceneParticles);
...
private static void set_sceneParticles(Action<GameCameras,  SceneParticlesController> orig, GameCameras self,  SceneParticlesController value)
{
...
{
foreach (Delegates.set_sceneParticles_BeforeArgs toInvoke in _beforeset_sceneParticles.GetInvocationList())
{
try
{
...
{
foreach (Delegates.set_sceneParticles_AfterArgs toInvoke in _afterset_sceneParticles.GetInvocationList())
{
try
{
...
{
foreach (Delegates.MoveMenuToHUDCamera_BeforeArgs toInvoke in _beforeMoveMenuToHUDCamera.GetInvocationList())
{
try
{
...
{
foreach (Delegates.MoveMenuToHUDCamera_AfterArgs toInvoke in _afterMoveMenuToHUDCamera.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DisableHUDCamIfAllowed_BeforeArgs toInvoke in _beforeDisableHUDCamIfAllowed.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DisableHUDCamIfAllowed_AfterArgs toInvoke in _afterDisableHUDCamIfAllowed.GetInvocationList())
{
try
{
...
{
foreach (Delegates.ResumeCameraShake_BeforeArgs toInvoke in _beforeResumeCameraShake.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DisableImageEffects_BeforeArgs toInvoke in _beforeDisableImageEffects.GetInvocationList())
{
try
{
...
{
foreach (Delegates.DisableImageEffects_AfterArgs toInvoke in _afterDisableImageEffects.GetInvocationList())
{
try
{
...
private static void EnableImageEffects(On.GameCameras.orig_EnableImageEffects orig,GameCameras self,  bool isGameplayLevel,  bool isBloomForced)
{
...
{
foreach (Delegates.EnableImageEffects_BeforeArgs toInvoke in _beforeEnableImageEffects.GetInvocationList())
{
try
{
...
{
foreach (Delegates.EnableImageEffects_AfterArgs toInvoke in _afterEnableImageEffects.GetInvocationList())
{
try
{
...
{
foreach (Delegates.TestParentForPosition_BeforeArgs toInvoke in _beforeTestParentForPosition.GetInvocationList())
{
try
{
...
{
foreach (Delegates.TestParentForPosition_AfterArgs toInvoke in _afterTestParentForPosition.GetInvocationList())
{
try
{
...
new Hook(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "orig_get_instance", false), orig_get_instance);
...
public delegate SceneParticlesController get_sceneParticles_AfterArgs(Params_get_sceneParticles args, SceneParticlesController ret);
public delegate SceneParticlesController get_sceneParticles_WithArgs (Func<GameCameras, SceneParticlesController> orig, GameCameras self);
...
public delegate void set_sceneParticles_WithArgs (Action<GameCameras,  SceneParticlesController> orig, GameCameras self,  SceneParticlesController value);
...
public delegate void EnableImageEffects_WithArgs (Action<GameCameras,  bool,  bool> orig, GameCameras self,  bool isGameplayLevel,  bool isBloomForced);
...
{
add => HookEndpointManager.Add<Delegates.get_sceneParticles_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "get_sceneParticles", true), value);
remove => HookEndpointManager.Remove<Delegates.get_sceneParticles_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "get_sceneParticles", true), value);
}
public static event Delegates.set_sceneParticles_WithArgs set_sceneParticles
{
add => HookEndpointManager.Add<Delegates.set_sceneParticles_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "set_sceneParticles", true), value);
remove => HookEndpointManager.Remove<Delegates.set_sceneParticles_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "set_sceneParticles", true), value);
}
public static event Delegates.get_instance_WithArgs get_instance
{
add => HookEndpointManager.Add<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "get_instance", false), value);
}
...
{
add => HookEndpointManager.Add<Delegates.orig_get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "orig_get_instance", false), value);
remove => HookEndpointManager.Remove<Delegates.orig_get_instance_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(GameCameras), "orig_get_instance", false), value);
}
}
