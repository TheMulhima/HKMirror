...
public static class OnFloatSquareRoot
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatSquareRoot), "Reset",
                        true), Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatSquareRoot), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatSquareRoot), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self)
        {
        ...
        internal static void HookDoFloatSquareRoot()
        {
            if (!HookedList.Contains("DoFloatSquareRoot"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatSquareRoot),
                        "DoFloatSquareRoot", true), DoFloatSquareRoot);
            }
        }
        ...
        private static void DoFloatSquareRoot(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self);
        ...
        public delegate void DoFloatSquareRoot_WithArgs(Action<HutongGames.PlayMaker.Actions.FloatSquareRoot> orig,
            HutongGames.PlayMaker.Actions.FloatSquareRoot self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatSquareRoot), "Reset", true),
                value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatSquareRoot), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.FloatSquareRoot), "OnUpdate", true),
                value);
