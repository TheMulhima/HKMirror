...
public static class OnMadCatzFightStickTESPlusMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzFightStickTESPlusMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzFightStickTESPlusMacNativeProfile> orig,
            MadCatzFightStickTESPlusMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzFightStickTESPlusMacNativeProfile> orig,
            MadCatzFightStickTESPlusMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzFightStickTESPlusMacNativeProfile self;
        }
    }
