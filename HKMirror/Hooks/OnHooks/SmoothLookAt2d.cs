...
public static class OnSmoothLookAt2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<SmoothLookAt2d> orig, SmoothLookAt2d self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<SmoothLookAt2d> orig, SmoothLookAt2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<SmoothLookAt2d> orig, SmoothLookAt2d self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "OnLateUpdate"), OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<SmoothLookAt2d> orig, SmoothLookAt2d self)
        {
        ...
        internal static void HookDoSmoothLookAt()
        {
            if (!HookedList.Contains("DoSmoothLookAt"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "DoSmoothLookAt"), DoSmoothLookAt);
            }
        }
        ...
        private static void DoSmoothLookAt(Action<SmoothLookAt2d> orig, SmoothLookAt2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSmoothLookAt_WithArgs(Action<SmoothLookAt2d> orig, SmoothLookAt2d self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<SmoothLookAt2d> orig, SmoothLookAt2d self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<SmoothLookAt2d> orig, SmoothLookAt2d self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<SmoothLookAt2d> orig, SmoothLookAt2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<SmoothLookAt2d> orig, SmoothLookAt2d self);

        public sealed class Params_Reset
        {
            public SmoothLookAt2d self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "Reset"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "OnEnter"), value);
        ...
        public static event Delegates.OnLateUpdate_WithArgs OnLateUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnLateUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "OnLateUpdate"), value);
        ...
        public static event Delegates.DoSmoothLookAt_WithArgs DoSmoothLookAt
        {
            add => HookEndpointManager.Add<Delegates.DoSmoothLookAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SmoothLookAt2d), "DoSmoothLookAt"), value);
