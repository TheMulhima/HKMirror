...
public static class OnSmoothLookAt2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d), "OnPreprocess",
                        true), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self)
        {
        ...
        internal static void HookOnLateUpdate()
        {
            if (!HookedList.Contains("OnLateUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d), "OnLateUpdate",
                        true), OnLateUpdate);
            }
        }
        ...
        private static void OnLateUpdate(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self)
        {
        ...
        internal static void HookDoSmoothLookAt()
        {
            if (!HookedList.Contains("DoSmoothLookAt"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d),
                        "DoSmoothLookAt", true), DoSmoothLookAt);
            }
        }
        ...
        private static void DoSmoothLookAt(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self);
        ...
        public delegate void OnLateUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self);
        ...
        public delegate void DoSmoothLookAt_WithArgs(Action<HutongGames.PlayMaker.Actions.SmoothLookAt2d> orig,
            HutongGames.PlayMaker.Actions.SmoothLookAt2d self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d), "OnEnter", true),
                value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.DoSmoothLookAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d), "DoSmoothLookAt",
                    true), value);
            remove => HookEndpointManager.Remove<Delegates.DoSmoothLookAt_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.SmoothLookAt2d), "DoSmoothLookAt",
                    true), value);
        }
    }
