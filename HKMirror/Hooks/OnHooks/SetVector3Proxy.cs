...
public static class OnSetVector3Proxy
{
    ...
    public static class Delegates
    {
        ...
        public delegate Vector3 EndInvoke_WithArgs(Func<SetVector3Proxy, IAsyncResult, Vector3> orig,
            SetVector3Proxy self, IAsyncResult result);
        ...
        public delegate Vector3 Invoke_WithArgs(Func<SetVector3Proxy, string, Vector3, Vector3> orig,
            SetVector3Proxy self, string name, Vector3 orig_);
