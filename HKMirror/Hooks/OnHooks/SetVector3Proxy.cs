...
public static class OnSetVector3Proxy
{
    internal static class HookHandler
    {
        ...
        internal static void HookInvoke()
        {
            if (!HookedList.Contains("Invoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVector3Proxy), "Invoke", true),
                    Invoke);
            }
        }
        ...
        private static UnityEngine.Vector3 Invoke(
            Func<Modding.Delegates.SetVector3Proxy, string, UnityEngine.Vector3, UnityEngine.Vector3> orig,
            Modding.Delegates.SetVector3Proxy self, string name, UnityEngine.Vector3 orig_)
        {
        ...
        internal static void HookEndInvoke()
        {
            if (!HookedList.Contains("EndInvoke"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVector3Proxy), "EndInvoke", true),
                    EndInvoke);
            }
        }
        ...
        private static UnityEngine.Vector3 EndInvoke(
            Func<Modding.Delegates.SetVector3Proxy, System.IAsyncResult, UnityEngine.Vector3> orig,
            Modding.Delegates.SetVector3Proxy self, System.IAsyncResult result)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate UnityEngine.Vector3 Invoke_WithArgs(
            Func<Modding.Delegates.SetVector3Proxy, string, UnityEngine.Vector3, UnityEngine.Vector3> orig,
            Modding.Delegates.SetVector3Proxy self, string name, UnityEngine.Vector3 orig_);
        ...
        public delegate UnityEngine.Vector3 EndInvoke_WithArgs(
            Func<Modding.Delegates.SetVector3Proxy, System.IAsyncResult, UnityEngine.Vector3> orig,
            Modding.Delegates.SetVector3Proxy self, System.IAsyncResult result);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Invoke_WithArgs Invoke
        {
            add => HookEndpointManager.Add<Delegates.Invoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVector3Proxy), "Invoke", true), value);
        ...
        public static event Delegates.EndInvoke_WithArgs EndInvoke
        {
            add => HookEndpointManager.Add<Delegates.EndInvoke_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(Modding.Delegates.SetVector3Proxy), "EndInvoke", true), value);
