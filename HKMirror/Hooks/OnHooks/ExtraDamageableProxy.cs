...
new Hook(ReflectionHelper.GetMethodInfo(typeof(ExtraDamageableProxy), "RecieveExtraDamage", true), RecieveExtraDamage);
...
private static void RecieveExtraDamage(Action<ExtraDamageableProxy,  ExtraDamageTypes> orig, ExtraDamageableProxy self,  ExtraDamageTypes extraDamageTypes)
{
...
public delegate void RecieveExtraDamage_WithArgs (Action<ExtraDamageableProxy,  ExtraDamageTypes> orig, ExtraDamageableProxy self,  ExtraDamageTypes extraDamageTypes);
}
...
{
add => HookEndpointManager.Add<Delegates.RecieveExtraDamage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ExtraDamageableProxy), "IExtraDamageable.RecieveExtraDamage", true), value);
remove => HookEndpointManager.Remove<Delegates.RecieveExtraDamage_WithArgs>(ReflectionHelper.GetMethodInfo(typeof(ExtraDamageableProxy), "IExtraDamageable.RecieveExtraDamage", true), value);
}
}
