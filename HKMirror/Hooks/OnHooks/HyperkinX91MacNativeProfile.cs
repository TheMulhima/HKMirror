...
public static class OnHyperkinX91MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(HyperkinX91MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<HyperkinX91MacNativeProfile> orig, HyperkinX91MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<HyperkinX91MacNativeProfile> orig,
            HyperkinX91MacNativeProfile self);

        public sealed class Params_Define
        {
            public HyperkinX91MacNativeProfile self;
        }
    }
