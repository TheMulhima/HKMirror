...
public static class Ontk2dUIScrollableArea
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_ContentLength()
        {
            if (!HookedList.Contains("get_ContentLength"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentLength", true),
                    get_ContentLength);
            }
        }
        ...
        private static float get_ContentLength(Func<tk2dUIScrollableArea, float> orig, tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.get_ContentLength_BeforeArgs toInvoke in
                         _beforeget_ContentLength.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_ContentLength()
        {
            if (!HookedList.Contains("set_ContentLength"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentLength", true),
                    set_ContentLength);
            }
        }
            ...
            float value)
        {
            ...
            {
                foreach (Delegates.set_ContentLength_BeforeArgs toInvoke in
                         _beforeset_ContentLength.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_VisibleAreaLength()
        {
            if (!HookedList.Contains("get_VisibleAreaLength"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_VisibleAreaLength", true),
        ...
        private static float get_VisibleAreaLength(Func<tk2dUIScrollableArea, float> orig, tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.get_VisibleAreaLength_BeforeArgs toInvoke in _beforeget_VisibleAreaLength
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_VisibleAreaLength_AfterArgs toInvoke in _afterget_VisibleAreaLength
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_VisibleAreaLength()
        {
            if (!HookedList.Contains("set_VisibleAreaLength"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_VisibleAreaLength", true),
            ...
            float value)
        {
            ...
            {
                foreach (Delegates.set_VisibleAreaLength_BeforeArgs toInvoke in _beforeset_VisibleAreaLength
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_VisibleAreaLength_AfterArgs toInvoke in _afterset_VisibleAreaLength
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_BackgroundLayoutItem()
        {
            if (!HookedList.Contains("get_BackgroundLayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_BackgroundLayoutItem", true),
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.get_BackgroundLayoutItem_BeforeArgs toInvoke in _beforeget_BackgroundLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_BackgroundLayoutItem_AfterArgs toInvoke in _afterget_BackgroundLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_BackgroundLayoutItem()
        {
            if (!HookedList.Contains("set_BackgroundLayoutItem"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_BackgroundLayoutItem", true),
            ...
            tk2dUIScrollableArea self, tk2dUILayout value)
        {
            ...
            {
                foreach (Delegates.set_BackgroundLayoutItem_BeforeArgs toInvoke in _beforeset_BackgroundLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_BackgroundLayoutItem_AfterArgs toInvoke in _afterset_BackgroundLayoutItem
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_ContentLayoutContainer()
        {
            if (!HookedList.Contains("get_ContentLayoutContainer"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentLayoutContainer", true),
            ...
            Func<tk2dUIScrollableArea, tk2dUILayoutContainer> orig, tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.get_ContentLayoutContainer_BeforeArgs toInvoke in _beforeget_ContentLayoutContainer
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_ContentLayoutContainer_AfterArgs toInvoke in _afterget_ContentLayoutContainer
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_ContentLayoutContainer()
        {
            if (!HookedList.Contains("set_ContentLayoutContainer"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentLayoutContainer", true),
            ...
            tk2dUIScrollableArea self, tk2dUILayoutContainer value)
        {
            ...
            {
                foreach (Delegates.set_ContentLayoutContainer_BeforeArgs toInvoke in _beforeset_ContentLayoutContainer
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_ContentLayoutContainer_AfterArgs toInvoke in _afterset_ContentLayoutContainer
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_SendMessageTarget()
        {
            if (!HookedList.Contains("get_SendMessageTarget"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_SendMessageTarget", true),
        ...
        private static UnityEngine.GameObject get_SendMessageTarget(
            Func<tk2dUIScrollableArea, UnityEngine.GameObject> orig, tk2dUIScrollableArea self)
        {
        ...
        internal static void Hookset_SendMessageTarget()
        {
            if (!HookedList.Contains("set_SendMessageTarget"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_SendMessageTarget", true),
        ...
        private static void set_SendMessageTarget(Action<tk2dUIScrollableArea, UnityEngine.GameObject> orig,
            tk2dUIScrollableArea self, UnityEngine.GameObject value)
        {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.MeasureContentLength_BeforeArgs toInvoke in _beforeMeasureContentLength
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.MeasureContentLength_AfterArgs toInvoke in _afterMeasureContentLength
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.BackgroundHoverOverScrollWheelChange_AfterArgs
            ...
            float mouseWheelChange)
        {
            ...
            {
                foreach (Delegates.BackgroundHoverOverScrollWheelChange_BeforeArgs toInvoke in
                         _beforeBackgroundHoverOverScrollWheelChange.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.BackgroundHoverOverScrollWheelChange_AfterArgs toInvoke in
                         _afterBackgroundHoverOverScrollWheelChange.GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_ContentContainerOffset()
        {
            if (!HookedList.Contains("get_ContentContainerOffset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentContainerOffset", true),
        ...
        private static UnityEngine.Vector3 get_ContentContainerOffset(
            Func<tk2dUIScrollableArea, UnityEngine.Vector3> orig, tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.get_ContentContainerOffset_BeforeArgs toInvoke in _beforeget_ContentContainerOffset
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_ContentContainerOffset_AfterArgs toInvoke in _afterget_ContentContainerOffset
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookset_ContentContainerOffset()
        {
            if (!HookedList.Contains("set_ContentContainerOffset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentContainerOffset", true),
        ...
        private static void set_ContentContainerOffset(Action<tk2dUIScrollableArea, UnityEngine.Vector3> orig,
            tk2dUIScrollableArea self, UnityEngine.Vector3 value)
        {
            ...
            {
                foreach (Delegates.set_ContentContainerOffset_BeforeArgs toInvoke in _beforeset_ContentContainerOffset
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.set_ContentContainerOffset_AfterArgs toInvoke in _afterset_ContentContainerOffset
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.SetContentPosition_BeforeArgs toInvoke in
                         _beforeSetContentPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.SetContentPosition_AfterArgs toInvoke in
                         _afterSetContentPosition.GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.BackgroundButtonDown_BeforeArgs toInvoke in _beforeBackgroundButtonDown
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.BackgroundButtonDown_AfterArgs toInvoke in _afterBackgroundButtonDown
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.BackgroundOverUpdate_BeforeArgs toInvoke in _beforeBackgroundOverUpdate
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.BackgroundOverUpdate_AfterArgs toInvoke in _afterBackgroundOverUpdate
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.UpdateSwipeScrollDestintationPosition_AfterArgs
            ...
            On.tk2dUIScrollableArea.orig_UpdateSwipeScrollDestintationPosition orig, tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.UpdateSwipeScrollDestintationPosition_BeforeArgs toInvoke in
                         _beforeUpdateSwipeScrollDestintationPosition.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.UpdateSwipeScrollDestintationPosition_AfterArgs toInvoke in
                         _afterUpdateSwipeScrollDestintationPosition.GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.BackgroundButtonRelease_BeforeArgs toInvoke in _beforeBackgroundButtonRelease
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.BackgroundButtonRelease_AfterArgs toInvoke in _afterBackgroundButtonRelease
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.BackgroundButtonHoverOver_BeforeArgs toInvoke in _beforeBackgroundButtonHoverOver
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.BackgroundButtonHoverOver_AfterArgs toInvoke in _afterBackgroundButtonHoverOver
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.BackgroundButtonHoverOut_BeforeArgs toInvoke in _beforeBackgroundButtonHoverOut
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.BackgroundButtonHoverOut_AfterArgs toInvoke in _afterBackgroundButtonHoverOut
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static UnityEngine.Vector3 CalculateClickWorldPos(
            On.tk2dUIScrollableArea.orig_CalculateClickWorldPos orig, tk2dUIScrollableArea self, tk2dUIItem btn)
        {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.UpdateScrollbarActiveState_BeforeArgs toInvoke in _beforeUpdateScrollbarActiveState
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.UpdateScrollbarActiveState_AfterArgs toInvoke in _afterUpdateScrollbarActiveState
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static event Delegates.ContentLengthVisibleAreaLengthChange_AfterArgs
            ...
            float prevContentLength, float newContentLength, float prevVisibleAreaLength, float newVisibleAreaLength)
        {
            ...
            {
                foreach (Delegates.ContentLengthVisibleAreaLengthChange_BeforeArgs toInvoke in
                         _beforeContentLengthVisibleAreaLengthChange.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ContentLengthVisibleAreaLengthChange_AfterArgs toInvoke in
                         _afterContentLengthVisibleAreaLengthChange.GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.UnpressAllUIItemChildren_BeforeArgs toInvoke in _beforeUnpressAllUIItemChildren
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.UnpressAllUIItemChildren_AfterArgs toInvoke in _afterUnpressAllUIItemChildren
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.TargetOnScrollCallback_BeforeArgs toInvoke in _beforeTargetOnScrollCallback
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.TargetOnScrollCallback_AfterArgs toInvoke in _afterTargetOnScrollCallback
                             .GetInvocationList())
                {
                    try
                    {
        ...
        private static void GetRendererBoundsInChildren(On.tk2dUIScrollableArea.orig_GetRendererBoundsInChildren orig,
            UnityEngine.Matrix4x4 rootWorldToLocal, UnityEngine.Vector3[] minMax, UnityEngine.Transform t)
        {
            ...
            {
                foreach (Delegates.GetRendererBoundsInChildren_BeforeArgs toInvoke in _beforeGetRendererBoundsInChildren
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetRendererBoundsInChildren_AfterArgs toInvoke in _afterGetRendererBoundsInChildren
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dUIScrollableArea self)
        {
            ...
            {
                foreach (Delegates.ContentLayoutChangeCallback_BeforeArgs toInvoke in _beforeContentLayoutChangeCallback
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.ContentLayoutChangeCallback_AfterArgs toInvoke in _afterContentLayoutChangeCallback
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate float get_ContentLength_WithArgs(Func<tk2dUIScrollableArea, float> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void set_ContentLength_WithArgs(Action<tk2dUIScrollableArea, float> orig,
            tk2dUIScrollableArea self, float value);
        ...
        public delegate float get_VisibleAreaLength_WithArgs(Func<tk2dUIScrollableArea, float> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void set_VisibleAreaLength_WithArgs(Action<tk2dUIScrollableArea, float> orig,
            tk2dUIScrollableArea self, float value);
        ...
        public delegate tk2dUILayout get_BackgroundLayoutItem_AfterArgs(Params_get_BackgroundLayoutItem args,
            tk2dUILayout ret);

        public delegate tk2dUILayout get_BackgroundLayoutItem_WithArgs(Func<tk2dUIScrollableArea, tk2dUILayout> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void set_BackgroundLayoutItem_WithArgs(Action<tk2dUIScrollableArea, tk2dUILayout> orig,
            tk2dUIScrollableArea self, tk2dUILayout value);
        ...
        public delegate tk2dUILayoutContainer get_ContentLayoutContainer_AfterArgs(
            Params_get_ContentLayoutContainer args, tk2dUILayoutContainer ret);

        public delegate tk2dUILayoutContainer get_ContentLayoutContainer_WithArgs(
            Func<tk2dUIScrollableArea, tk2dUILayoutContainer> orig, tk2dUIScrollableArea self);
        ...
        public delegate void set_ContentLayoutContainer_WithArgs(
            Action<tk2dUIScrollableArea, tk2dUILayoutContainer> orig, tk2dUIScrollableArea self,
            tk2dUILayoutContainer value);
        ...
        public delegate UnityEngine.GameObject get_SendMessageTarget_AfterArgs(Params_get_SendMessageTarget args,
            UnityEngine.GameObject ret);

        public delegate UnityEngine.GameObject get_SendMessageTarget_WithArgs(
            Func<tk2dUIScrollableArea, UnityEngine.GameObject> orig, tk2dUIScrollableArea self);
        ...
        public delegate void set_SendMessageTarget_WithArgs(Action<tk2dUIScrollableArea, UnityEngine.GameObject> orig,
            tk2dUIScrollableArea self, UnityEngine.GameObject value);
        ...
        public delegate void set_Value_WithArgs(Action<tk2dUIScrollableArea, float> orig, tk2dUIScrollableArea self,
            float value);
        ...
        public delegate void SetScrollPercentWithoutEvent_WithArgs(Action<tk2dUIScrollableArea, float> orig,
            tk2dUIScrollableArea self, float newScrollPercent);
        ...
        public delegate float MeasureContentLength_WithArgs(Func<tk2dUIScrollableArea, float> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void BackgroundHoverOverScrollWheelChange_AfterArgs(
            Params_BackgroundHoverOverScrollWheelChange args);

        public delegate void BackgroundHoverOverScrollWheelChange_WithArgs(Action<tk2dUIScrollableArea, float> orig,
            tk2dUIScrollableArea self, float mouseWheelChange);
        ...
        public delegate void ScrollBarMove_WithArgs(Action<tk2dUIScrollableArea, tk2dUIScrollbar> orig,
            tk2dUIScrollableArea self, tk2dUIScrollbar scrollBar);
        ...
        public delegate UnityEngine.Vector3 get_ContentContainerOffset_AfterArgs(Params_get_ContentContainerOffset args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 get_ContentContainerOffset_WithArgs(
            Func<tk2dUIScrollableArea, UnityEngine.Vector3> orig, tk2dUIScrollableArea self);
        ...
        public delegate void set_ContentContainerOffset_WithArgs(Action<tk2dUIScrollableArea, UnityEngine.Vector3> orig,
            tk2dUIScrollableArea self, UnityEngine.Vector3 value);
        ...
        public delegate void
            BackgroundButtonDown_WithArgs(Action<tk2dUIScrollableArea> orig, tk2dUIScrollableArea self);
        ...
        public delegate void
            BackgroundOverUpdate_WithArgs(Action<tk2dUIScrollableArea> orig, tk2dUIScrollableArea self);
        ...
        public delegate void UpdateSwipeScrollDestintationPosition_AfterArgs(
            Params_UpdateSwipeScrollDestintationPosition args);

        public delegate void UpdateSwipeScrollDestintationPosition_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void BackgroundButtonRelease_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void BackgroundButtonHoverOver_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void BackgroundButtonHoverOut_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate UnityEngine.Vector3 CalculateClickWorldPos_AfterArgs(Params_CalculateClickWorldPos args,
            UnityEngine.Vector3 ret);

        public delegate UnityEngine.Vector3 CalculateClickWorldPos_WithArgs(
            Func<tk2dUIScrollableArea, tk2dUIItem, UnityEngine.Vector3> orig, tk2dUIScrollableArea self,
            tk2dUIItem btn);
        ...
        public delegate void UpdateScrollbarActiveState_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void ContentLengthVisibleAreaLengthChange_AfterArgs(
            Params_ContentLengthVisibleAreaLengthChange args);

        public delegate void ContentLengthVisibleAreaLengthChange_WithArgs(
            Action<tk2dUIScrollableArea, float, float, float, float> orig, tk2dUIScrollableArea self,
            float prevContentLength, float newContentLength, float prevVisibleAreaLength, float newVisibleAreaLength);
        ...
        public delegate void UnpressAllUIItemChildren_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void TargetOnScrollCallback_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
        ...
        public delegate void GetRendererBoundsInChildren_WithArgs(
            Action<UnityEngine.Matrix4x4, UnityEngine.Vector3[], UnityEngine.Transform> orig,
            UnityEngine.Matrix4x4 rootWorldToLocal, UnityEngine.Vector3[] minMax, UnityEngine.Transform t);
        ...
        public delegate void LayoutReshaped_WithArgs(
            Action<tk2dUIScrollableArea, UnityEngine.Vector3, UnityEngine.Vector3> orig, tk2dUIScrollableArea self,
            UnityEngine.Vector3 dMin, UnityEngine.Vector3 dMax);
        ...
        public delegate void ContentLayoutChangeCallback_WithArgs(Action<tk2dUIScrollableArea> orig,
            tk2dUIScrollableArea self);
    }
    ...
    public static class AfterOrig
    {
        ...
        public static event Delegates.BackgroundHoverOverScrollWheelChange_AfterArgs
            BackgroundHoverOverScrollWheelChange
            {
                add
                {
        ...
        public static event Delegates.UpdateSwipeScrollDestintationPosition_AfterArgs
            UpdateSwipeScrollDestintationPosition
            {
                add
                {
        ...
        public static event Delegates.ContentLengthVisibleAreaLengthChange_AfterArgs
            ContentLengthVisibleAreaLengthChange
            {
                add
                {
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_ContentLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentLength", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_ContentLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentLength", true), value);
        }

        public static event Delegates.set_ContentLength_WithArgs set_ContentLength
        {
            add => HookEndpointManager.Add<Delegates.set_ContentLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentLength", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_ContentLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentLength", true), value);
        }

        public static event Delegates.get_VisibleAreaLength_WithArgs get_VisibleAreaLength
        {
            add => HookEndpointManager.Add<Delegates.get_VisibleAreaLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_VisibleAreaLength", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_VisibleAreaLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_VisibleAreaLength", true), value);
        }

        public static event Delegates.set_VisibleAreaLength_WithArgs set_VisibleAreaLength
        {
            add => HookEndpointManager.Add<Delegates.set_VisibleAreaLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_VisibleAreaLength", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_VisibleAreaLength_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_VisibleAreaLength", true), value);
        }

        public static event Delegates.get_BackgroundLayoutItem_WithArgs get_BackgroundLayoutItem
        {
            add => HookEndpointManager.Add<Delegates.get_BackgroundLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_BackgroundLayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_BackgroundLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_BackgroundLayoutItem", true), value);
        }

        public static event Delegates.set_BackgroundLayoutItem_WithArgs set_BackgroundLayoutItem
        {
            add => HookEndpointManager.Add<Delegates.set_BackgroundLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_BackgroundLayoutItem", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_BackgroundLayoutItem_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_BackgroundLayoutItem", true), value);
        }

        public static event Delegates.get_ContentLayoutContainer_WithArgs get_ContentLayoutContainer
        {
            add => HookEndpointManager.Add<Delegates.get_ContentLayoutContainer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentLayoutContainer", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_ContentLayoutContainer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentLayoutContainer", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_ContentLayoutContainer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentLayoutContainer", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_ContentLayoutContainer_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentLayoutContainer", true),
                value);
        }
        ...
        public static event Delegates.get_SendMessageTarget_WithArgs get_SendMessageTarget
        {
            add => HookEndpointManager.Add<Delegates.get_SendMessageTarget_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_SendMessageTarget", true), value);
        ...
        public static event Delegates.set_SendMessageTarget_WithArgs set_SendMessageTarget
        {
            add => HookEndpointManager.Add<Delegates.set_SendMessageTarget_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_SendMessageTarget", true), value);
        ...
        public static event Delegates.get_Value_WithArgs get_Value
        {
            add => HookEndpointManager.Add<Delegates.get_Value_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_Value", true), value);
        ...
        public static event Delegates.set_Value_WithArgs set_Value
        {
            add => HookEndpointManager.Add<Delegates.set_Value_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_Value", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_ContentContainerOffset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentContainerOffset", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_ContentContainerOffset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "get_ContentContainerOffset", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.set_ContentContainerOffset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentContainerOffset", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.set_ContentContainerOffset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dUIScrollableArea), "set_ContentContainerOffset", true),
                value);
        }
