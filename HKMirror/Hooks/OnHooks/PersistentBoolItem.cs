...
private static void UpdateActivatedFromFSM(On.PersistentBoolItem.orig_UpdateActivatedFromFSM orig,PersistentBoolItem self)
{
...
{
foreach (Delegates.UpdateActivatedFromFSM_BeforeArgs toInvoke in _beforeUpdateActivatedFromFSM.GetInvocationList())
{
try
{
...
{
foreach (Delegates.UpdateActivatedFromFSM_AfterArgs toInvoke in _afterUpdateActivatedFromFSM.GetInvocationList())
{
try
{
