...
public static class OnMadCatzMicroConControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MadCatzMicroConControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MadCatzMicroConControllerMacNativeProfile> orig,
            MadCatzMicroConControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MadCatzMicroConControllerMacNativeProfile> orig,
            MadCatzMicroConControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MadCatzMicroConControllerMacNativeProfile self;
        }
    }
