...
public static class OnPlayStation3AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation3AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<PlayStation3AndroidUnityProfile> orig, PlayStation3AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation3AndroidUnityProfile> orig,
            PlayStation3AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation3AndroidUnityProfile self;
        }
    }
