...
public static class OnPDPXboxOneArcadeStickMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PDPXboxOneArcadeStickMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PDPXboxOneArcadeStickMacNativeProfile> orig,
            PDPXboxOneArcadeStickMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PDPXboxOneArcadeStickMacNativeProfile> orig,
            PDPXboxOneArcadeStickMacNativeProfile self);

        public sealed class Params_Define
        {
            public PDPXboxOneArcadeStickMacNativeProfile self;
        }
    }
