...
public static class OnMicrosoftXboxOneControllerMacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(MicrosoftXboxOneControllerMacNativeProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<MicrosoftXboxOneControllerMacNativeProfile> orig,
            MicrosoftXboxOneControllerMacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<MicrosoftXboxOneControllerMacNativeProfile> orig,
            MicrosoftXboxOneControllerMacNativeProfile self);

        public sealed class Params_Define
        {
            public MicrosoftXboxOneControllerMacNativeProfile self;
        }
    }
