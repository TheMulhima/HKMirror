...
public static class OnSetAngularVelocity2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self)
        {
        ...
        internal static void HookDoSetVelocity()
        {
            if (!HookedList.Contains("DoSetVelocity"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "DoSetVelocity"), DoSetVelocity);
            }
        }
        ...
        private static void DoSetVelocity(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self);
        ...
        public delegate void DoSetVelocity_WithArgs(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<SetAngularVelocity2d> orig, SetAngularVelocity2d self);

        public sealed class Params_Reset
        {
            public SetAngularVelocity2d self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "Awake"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetAngularVelocity2d), "OnEnter"), value);
