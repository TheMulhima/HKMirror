...
public static class OnIpegaPG9021AndroidUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IpegaPG9021AndroidUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<IpegaPG9021AndroidUnityProfile> orig, IpegaPG9021AndroidUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<IpegaPG9021AndroidUnityProfile> orig,
            IpegaPG9021AndroidUnityProfile self);

        public sealed class Params_Define
        {
            public IpegaPG9021AndroidUnityProfile self;
        }
    }
