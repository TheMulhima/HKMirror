...
public static class OnGameStickUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GameStickUnityProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<GameStickUnityProfile> orig, GameStickUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<GameStickUnityProfile> orig, GameStickUnityProfile self);

        public sealed class Params_Define
        {
            public GameStickUnityProfile self;
        }
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GameStickUnityProfile), "Define"), value);
