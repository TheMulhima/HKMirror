...
public static class OnGetTouchCount
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTouchCount), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTouchCount), "OnEnter",
                        true), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self)
        {
        ...
        internal static void HookOnUpdate()
        {
            if (!HookedList.Contains("OnUpdate"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTouchCount), "OnUpdate",
                        true), OnUpdate);
            }
        }
        ...
        private static void OnUpdate(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self)
        {
        ...
        internal static void HookDoGetTouchCount()
        {
            if (!HookedList.Contains("DoGetTouchCount"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTouchCount),
                        "DoGetTouchCount", true), DoGetTouchCount);
            }
        }
        ...
        private static void DoGetTouchCount(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self);
        ...
        public delegate void OnEnter_WithArgs(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self);
        ...
        public delegate void OnUpdate_WithArgs(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self);
        ...
        public delegate void DoGetTouchCount_WithArgs(Action<HutongGames.PlayMaker.Actions.GetTouchCount> orig,
            HutongGames.PlayMaker.Actions.GetTouchCount self);
    }
    ...
    public static class WithOrig
    {
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTouchCount), "OnEnter", true),
                value);
        ...
        public static event Delegates.OnUpdate_WithArgs OnUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTouchCount), "OnUpdate", true),
                value);
        ...
        public static event Delegates.DoGetTouchCount_WithArgs DoGetTouchCount
        {
            add => HookEndpointManager.Add<Delegates.DoGetTouchCount_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(HutongGames.PlayMaker.Actions.GetTouchCount), "DoGetTouchCount",
                    true), value);
