...
public static class OnLogitechF310ModeXMacUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.LogitechF310ModeXMacUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.LogitechF310ModeXMacUnityProfile> orig,
            InControl.UnityDeviceProfiles.LogitechF310ModeXMacUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.LogitechF310ModeXMacUnityProfile> orig,
            InControl.UnityDeviceProfiles.LogitechF310ModeXMacUnityProfile self);
    }
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(InControl.UnityDeviceProfiles.LogitechF310ModeXMacUnityProfile),
                    "Define", true), value);
