...
/// <summary>
/// Contains different types of On Hooks for MenuButtonSwitchUserListCondition class.<br />
/// Contains hooks that aren't generated by monomod, and before and after orig hooks for easier hooking.
/// </summary>
public static class OnMenuButtonSwitchUserListCondition
{
...
On.MenuButtonSwitchUserListCondition.IsFulfilled += IsFulfilled;
...
private static bool IsFulfilled(On.MenuButtonSwitchUserListCondition.orig_IsFulfilled orig,MenuButtonSwitchUserListCondition self)
{
...
{
public MenuButtonSwitchUserListCondition self;
}
...
public delegate bool IsFulfilled_WithArgs (Func<MenuButtonSwitchUserListCondition, bool> orig, MenuButtonSwitchUserListCondition self);
}
...
{
public static event On.MenuButtonSwitchUserListCondition.hook_IsFulfilled IsFulfilled
{
add => On.MenuButtonSwitchUserListCondition.IsFulfilled += value;
remove => On.MenuButtonSwitchUserListCondition.IsFulfilled -= value;
}
}
