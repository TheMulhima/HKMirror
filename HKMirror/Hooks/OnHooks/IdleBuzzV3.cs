...
public static class OnIdleBuzzV3
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<IdleBuzzV3> orig, IdleBuzzV3 self)
        {
        ...
        internal static void HookAwake()
        {
            if (!HookedList.Contains("Awake"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "Awake"), Awake);
            }
        }
        ...
        private static void Awake(Action<IdleBuzzV3> orig, IdleBuzzV3 self)
        {
        ...
        internal static void HookOnPreprocess()
        {
            if (!HookedList.Contains("OnPreprocess"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "OnPreprocess"), OnPreprocess);
            }
        }
        ...
        private static void OnPreprocess(Action<IdleBuzzV3> orig, IdleBuzzV3 self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<IdleBuzzV3> orig, IdleBuzzV3 self)
        {
        ...
        internal static void HookOnFixedUpdate()
        {
            if (!HookedList.Contains("OnFixedUpdate"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "OnFixedUpdate"), OnFixedUpdate);
            }
        }
        ...
        private static void OnFixedUpdate(Action<IdleBuzzV3> orig, IdleBuzzV3 self)
        {
        ...
        internal static void HookDoBuzz()
        {
            if (!HookedList.Contains("DoBuzz"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "DoBuzz"), DoBuzz);
            }
        }
        ...
        private static void DoBuzz(Action<IdleBuzzV3> orig, IdleBuzzV3 self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Awake_WithArgs(Action<IdleBuzzV3> orig, IdleBuzzV3 self);

        public delegate void DoBuzz_AfterArgs(Params_DoBuzz args);

        public delegate void DoBuzz_BeforeArgs(Params_DoBuzz args);

        public delegate void DoBuzz_WithArgs(Action<IdleBuzzV3> orig, IdleBuzzV3 self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<IdleBuzzV3> orig, IdleBuzzV3 self);
        ...
        public delegate void OnFixedUpdate_WithArgs(Action<IdleBuzzV3> orig, IdleBuzzV3 self);
        ...
        public delegate void OnPreprocess_WithArgs(Action<IdleBuzzV3> orig, IdleBuzzV3 self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<IdleBuzzV3> orig, IdleBuzzV3 self);

        public sealed class Params_Reset
        {
            public IdleBuzzV3 self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "Reset"), value);
        ...
        public static event Delegates.Awake_WithArgs Awake
        {
            add => HookEndpointManager.Add<Delegates.Awake_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "Awake"), value);
        ...
        public static event Delegates.OnPreprocess_WithArgs OnPreprocess
        {
            add => HookEndpointManager.Add<Delegates.OnPreprocess_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "OnPreprocess"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "OnEnter"), value);
        ...
        public static event Delegates.OnFixedUpdate_WithArgs OnFixedUpdate
        {
            add => HookEndpointManager.Add<Delegates.OnFixedUpdate_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "OnFixedUpdate"), value);
        ...
        public static event Delegates.DoBuzz_WithArgs DoBuzz
        {
            add => HookEndpointManager.Add<Delegates.DoBuzz_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(IdleBuzzV3), "DoBuzz"), value);
