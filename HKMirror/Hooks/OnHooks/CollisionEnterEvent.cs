...
private static void OnCollisionEnter2D(On.CollisionEnterEvent.orig_OnCollisionEnter2D orig,CollisionEnterEvent self,  UnityEngine.Collision2D collision)
{
...
private static void OnCollisionStay2D(On.CollisionEnterEvent.orig_OnCollisionStay2D orig,CollisionEnterEvent self,  UnityEngine.Collision2D collision)
{
...
internal static event Delegates.HandleCollision_AfterArgs _afterHandleCollision;
private static void HandleCollision(On.CollisionEnterEvent.orig_HandleCollision orig,CollisionEnterEvent self,  UnityEngine.Collision2D collision)
{
...
if (_beforeHandleCollision != null)
{
foreach (Delegates.HandleCollision_BeforeArgs toInvoke in _beforeHandleCollision.GetInvocationList())
{
try
{
...
collision = @params.collision;
orig(self, collision);
if (_afterHandleCollision != null)
{
foreach (Delegates.HandleCollision_AfterArgs toInvoke in _afterHandleCollision.GetInvocationList())
{
try
{
_afterHandleCollision.Invoke(@params);
}
catch (Exception e) 
{ HKMirrorMod.DoLogError(e);
}
...
private static void CheckTouching(On.CollisionEnterEvent.orig_CheckTouching orig,CollisionEnterEvent self,  UnityEngine.LayerMask layer,  UnityEngine.Collision2D collision)
{
...
public delegate void Awake_WithArgs (Action<CollisionEnterEvent> orig, CollisionEnterEvent self);
...
public delegate void OnCollisionEnter2D_WithArgs (Action<CollisionEnterEvent,  UnityEngine.Collision2D> orig, CollisionEnterEvent self,  UnityEngine.Collision2D collision);
...
public delegate void OnCollisionStay2D_WithArgs (Action<CollisionEnterEvent,  UnityEngine.Collision2D> orig, CollisionEnterEvent self,  UnityEngine.Collision2D collision);
...
public delegate void HandleCollision_AfterArgs(Params_HandleCollision args);
public delegate void HandleCollision_WithArgs (Action<CollisionEnterEvent,  UnityEngine.Collision2D> orig, CollisionEnterEvent self,  UnityEngine.Collision2D collision);
...
public delegate void CheckTouching_WithArgs (Action<CollisionEnterEvent,  UnityEngine.LayerMask,  UnityEngine.Collision2D> orig, CollisionEnterEvent self,  UnityEngine.LayerMask layer,  UnityEngine.Collision2D collision);
}
...
public static event Delegates.HandleCollision_AfterArgs HandleCollision
{
add
{
