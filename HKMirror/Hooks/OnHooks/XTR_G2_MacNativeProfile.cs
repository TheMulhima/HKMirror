...
public static class OnXTR_G2_MacNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XTR_G2_MacNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XTR_G2_MacNativeProfile> orig, XTR_G2_MacNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XTR_G2_MacNativeProfile> orig, XTR_G2_MacNativeProfile self);

        public sealed class Params_Define
        {
            public XTR_G2_MacNativeProfile self;
        }
    }
