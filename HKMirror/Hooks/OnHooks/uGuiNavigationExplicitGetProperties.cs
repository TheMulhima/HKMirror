...
public static class OnuGuiNavigationExplicitGetProperties
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties), "Reset", true),
                    Reset);
            }
        }
        ...
        private static void Reset(Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties), "OnEnter", true),
                    OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties self)
        {
        ...
        internal static void HookDoGetValue()
        {
            if (!HookedList.Contains("DoGetValue"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties), "DoGetValue", true),
                    DoGetValue);
            }
        }
        ...
        private static void DoGetValue(Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Reset_WithArgs(
            Action<HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties> orig,
            HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties self);
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties), "Reset", true), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(HutongGames.PlayMaker.Actions.uGuiNavigationExplicitGetProperties), "OnEnter", true), value);
