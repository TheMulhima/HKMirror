...
public static class OnGUILayoutFlexibleSpace
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutFlexibleSpace), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<GUILayoutFlexibleSpace> orig, GUILayoutFlexibleSpace self)
        {
        ...
        internal static void HookOnGUI()
        {
            if (!HookedList.Contains("OnGUI"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(GUILayoutFlexibleSpace), "OnGUI"), OnGUI);
            }
        }
        ...
        private static void OnGUI(Action<GUILayoutFlexibleSpace> orig, GUILayoutFlexibleSpace self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void OnGUI_WithArgs(Action<GUILayoutFlexibleSpace> orig, GUILayoutFlexibleSpace self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<GUILayoutFlexibleSpace> orig, GUILayoutFlexibleSpace self);

        public sealed class Params_Reset
        {
            public GUILayoutFlexibleSpace self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUILayoutFlexibleSpace), "Reset"), value);
        ...
        public static event Delegates.OnGUI_WithArgs OnGUI
        {
            add => HookEndpointManager.Add<Delegates.OnGUI_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(GUILayoutFlexibleSpace), "OnGUI"), value);
