...
public static class OnNintendoSwitchProWindowsChromeUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.NintendoSwitchProWindowsChromeUnityProfile), "Define",
                        true), Define);
            }
        }
        ...
        private static void Define(
            Action<InControl.UnityDeviceProfiles.NintendoSwitchProWindowsChromeUnityProfile> orig,
            InControl.UnityDeviceProfiles.NintendoSwitchProWindowsChromeUnityProfile self)
        {
    ...
    public static class WithOrig
    {
        public static event Delegates.Define_WithArgs Define
        {
            add => HookEndpointManager.Add<Delegates.Define_WithArgs>(
                ReflectionHelper.GetMethodInfo(
                    typeof(InControl.UnityDeviceProfiles.NintendoSwitchProWindowsChromeUnityProfile), "Define", true),
                value);
