...
public static class OnNintendoSwitchProWindowsChromeUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(NintendoSwitchProWindowsChromeUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<NintendoSwitchProWindowsChromeUnityProfile> orig,
            NintendoSwitchProWindowsChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<NintendoSwitchProWindowsChromeUnityProfile> orig,
            NintendoSwitchProWindowsChromeUnityProfile self);

        public sealed class Params_Define
        {
            public NintendoSwitchProWindowsChromeUnityProfile self;
        }
    }
