...
public static class OnPlayStation4WindowsChromeUnityProfile
{
    internal static class HookHandler
    {
            ...
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(
                        typeof(InControl.UnityDeviceProfiles.PlayStation4WindowsChromeUnityProfile), "Define", true),
                    Define);
            }
        }
        ...
        private static void Define(Action<InControl.UnityDeviceProfiles.PlayStation4WindowsChromeUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation4WindowsChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(
            Action<InControl.UnityDeviceProfiles.PlayStation4WindowsChromeUnityProfile> orig,
            InControl.UnityDeviceProfiles.PlayStation4WindowsChromeUnityProfile self);
    }
