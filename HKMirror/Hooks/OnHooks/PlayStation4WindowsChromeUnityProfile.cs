...
public static class OnPlayStation4WindowsChromeUnityProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(PlayStation4WindowsChromeUnityProfile), "Define"),
                    Define);
            }
        }
        ...
        private static void Define(Action<PlayStation4WindowsChromeUnityProfile> orig,
            PlayStation4WindowsChromeUnityProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<PlayStation4WindowsChromeUnityProfile> orig,
            PlayStation4WindowsChromeUnityProfile self);

        public sealed class Params_Define
        {
            public PlayStation4WindowsChromeUnityProfile self;
        }
    }
