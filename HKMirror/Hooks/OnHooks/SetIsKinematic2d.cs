...
public static class OnSetIsKinematic2d
{
    internal static class HookHandler
    {
        ...
        internal static void HookReset()
        {
            if (!HookedList.Contains("Reset"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetIsKinematic2d), "Reset"), Reset);
            }
        }
        ...
        private static void Reset(Action<SetIsKinematic2d> orig, SetIsKinematic2d self)
        {
        ...
        internal static void HookOnEnter()
        {
            if (!HookedList.Contains("OnEnter"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetIsKinematic2d), "OnEnter"), OnEnter);
            }
        }
        ...
        private static void OnEnter(Action<SetIsKinematic2d> orig, SetIsKinematic2d self)
        {
        ...
        internal static void HookDoSetIsKinematic()
        {
            if (!HookedList.Contains("DoSetIsKinematic"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(SetIsKinematic2d), "DoSetIsKinematic"),
                    DoSetIsKinematic);
            }
        }
        ...
        private static void DoSetIsKinematic(Action<SetIsKinematic2d> orig, SetIsKinematic2d self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void DoSetIsKinematic_WithArgs(Action<SetIsKinematic2d> orig, SetIsKinematic2d self);

        public delegate void OnEnter_AfterArgs(Params_OnEnter args);

        public delegate void OnEnter_BeforeArgs(Params_OnEnter args);

        public delegate void OnEnter_WithArgs(Action<SetIsKinematic2d> orig, SetIsKinematic2d self);

        public delegate void Reset_AfterArgs(Params_Reset args);

        public delegate void Reset_BeforeArgs(Params_Reset args);

        public delegate void Reset_WithArgs(Action<SetIsKinematic2d> orig, SetIsKinematic2d self);

        public sealed class Params_Reset
        {
            public SetIsKinematic2d self;
        }
    ...
    public static class WithOrig
    {
        public static event Delegates.Reset_WithArgs Reset
        {
            add => HookEndpointManager.Add<Delegates.Reset_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetIsKinematic2d), "Reset"), value);
        ...
        public static event Delegates.OnEnter_WithArgs OnEnter
        {
            add => HookEndpointManager.Add<Delegates.OnEnter_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(SetIsKinematic2d), "OnEnter"), value);
