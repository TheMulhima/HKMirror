...
public static class Ontk2dSpriteCollectionData
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_Transient()
        {
            if (!HookedList.Contains("get_Transient"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_Transient", true),
                    get_Transient);
            }
        }
        ...
        internal static void Hookset_Transient()
        {
            if (!HookedList.Contains("set_Transient"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "set_Transient", true),
                    set_Transient);
            }
        }
        ...
        internal static void Hookget_Count()
        {
            if (!HookedList.Contains("get_Count"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_Count", true),
                    get_Count);
            }
        }
            ...
            tk2dSpriteCollectionData self, string name)
        {
            ...
            {
                foreach (Delegates.GetSpriteIdByName_string_BeforeArgs toInvoke in _beforeGetSpriteIdByName_string
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetSpriteIdByName_string_AfterArgs toInvoke in _afterGetSpriteIdByName_string
                             .GetInvocationList())
                {
                    try
                    {
            ...
            string name, int defaultValue)
        {
            ...
            {
                foreach (Delegates.GetSpriteIdByName_string_int_BeforeArgs toInvoke in
                         _beforeGetSpriteIdByName_string_int.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.GetSpriteIdByName_string_int_AfterArgs toInvoke in _afterGetSpriteIdByName_string_int
                             .GetInvocationList())
                {
                    try
                    {
        ...
        internal static void Hookget_FirstValidDefinition()
        {
            if (!HookedList.Contains("get_FirstValidDefinition"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_FirstValidDefinition", true),
            ...
            Func<tk2dSpriteCollectionData, tk2dSpriteDefinition> orig, tk2dSpriteCollectionData self)
        {
            ...
            {
                foreach (Delegates.get_FirstValidDefinition_BeforeArgs toInvoke in _beforeget_FirstValidDefinition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_FirstValidDefinition_AfterArgs toInvoke in _afterget_FirstValidDefinition
                             .GetInvocationList())
                {
                    try
                    {
            ...
            if (!HookedList.Contains("get_FirstValidDefinitionIndex"))
            {
                ...
                new Hook(
                    ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_FirstValidDefinitionIndex",
                        true), get_FirstValidDefinitionIndex);
            }
        }
            ...
            tk2dSpriteCollectionData self)
        {
            ...
            {
                foreach (Delegates.get_FirstValidDefinitionIndex_BeforeArgs toInvoke in
                         _beforeget_FirstValidDefinitionIndex.GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.get_FirstValidDefinitionIndex_AfterArgs toInvoke in
                         _afterget_FirstValidDefinitionIndex.GetInvocationList())
                {
                    try
                    {
        ...
        private static tk2dSpriteCollectionData CreateFromTexture(
            On.tk2dSpriteCollectionData.orig_CreateFromTexture orig, UnityEngine.Texture texture,
            tk2dSpriteCollectionSize size, string[] names, UnityEngine.Rect[] regions, UnityEngine.Vector2[] anchors)
        {
        ...
        private static tk2dSpriteCollectionData CreateFromTexturePacker(
            ...
            string texturePackerData, UnityEngine.Texture texture)
        {
            ...
            {
                foreach (Delegates.CreateFromTexturePacker_BeforeArgs toInvoke in _beforeCreateFromTexturePacker
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.CreateFromTexturePacker_AfterArgs toInvoke in _afterCreateFromTexturePacker
                             .GetInvocationList())
                {
                    try
                    {
            ...
            tk2dSpriteCollectionData self)
        {
            ...
            {
                foreach (Delegates.DestroyTextureInsts_BeforeArgs toInvoke in _beforeDestroyTextureInsts
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.DestroyTextureInsts_AfterArgs toInvoke in
                         _afterDestroyTextureInsts.GetInvocationList())
                {
                    try
                    {
            ...
            tk2dSpriteCollectionData self)
        {
            ...
            {
                foreach (Delegates.DestroyMaterialInsts_BeforeArgs toInvoke in _beforeDestroyMaterialInsts
                             .GetInvocationList())
                {
                    try
                    {
            ...
            {
                foreach (Delegates.DestroyMaterialInsts_AfterArgs toInvoke in _afterDestroyMaterialInsts
                             .GetInvocationList())
                {
                    try
                    {
    ...
    public static class Delegates
    {
        ...
        public delegate bool get_Transient_WithArgs(Func<tk2dSpriteCollectionData, bool> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate void set_Transient_WithArgs(Action<tk2dSpriteCollectionData, bool> orig,
            tk2dSpriteCollectionData self, bool value);
        ...
        public delegate int GetSpriteIdByName_string_WithArgs(Func<tk2dSpriteCollectionData, string, int> orig,
            tk2dSpriteCollectionData self, string name);
        ...
        public delegate int GetSpriteIdByName_string_int_WithArgs(Func<tk2dSpriteCollectionData, string, int, int> orig,
            tk2dSpriteCollectionData self, string name, int defaultValue);
        ...
        public delegate void ClearDictionary_WithArgs(Action<tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate tk2dSpriteDefinition GetSpriteDefinition_WithArgs(
            Func<tk2dSpriteCollectionData, string, tk2dSpriteDefinition> orig, tk2dSpriteCollectionData self,
            string name);
        ...
        public delegate void InitDictionary_WithArgs(Action<tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate tk2dSpriteDefinition get_FirstValidDefinition_AfterArgs(Params_get_FirstValidDefinition args,
            tk2dSpriteDefinition ret);

        public delegate tk2dSpriteDefinition get_FirstValidDefinition_WithArgs(
            Func<tk2dSpriteCollectionData, tk2dSpriteDefinition> orig, tk2dSpriteCollectionData self);
        ...
        public delegate bool IsValidSpriteId_WithArgs(Func<tk2dSpriteCollectionData, int, bool> orig,
            tk2dSpriteCollectionData self, int id);
        ...
        public delegate int get_FirstValidDefinitionIndex_WithArgs(Func<tk2dSpriteCollectionData, int> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate void InitMaterialIds_WithArgs(Action<tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate tk2dSpriteCollectionData get_inst_WithArgs(
            Func<tk2dSpriteCollectionData, tk2dSpriteCollectionData> orig, tk2dSpriteCollectionData self);
        ...
        public delegate tk2dSpriteCollectionData CreateFromTexture_AfterArgs(Params_CreateFromTexture args,
            tk2dSpriteCollectionData ret);

        public delegate tk2dSpriteCollectionData CreateFromTexture_WithArgs(
            Func<UnityEngine.Texture, tk2dSpriteCollectionSize, string[], UnityEngine.Rect[], UnityEngine.Vector2[],
                tk2dSpriteCollectionData> orig, UnityEngine.Texture texture, tk2dSpriteCollectionSize size,
            string[] names, UnityEngine.Rect[] regions, UnityEngine.Vector2[] anchors);
        ...
        public delegate tk2dSpriteCollectionData CreateFromTexturePacker_AfterArgs(Params_CreateFromTexturePacker args,
            tk2dSpriteCollectionData ret);

        public delegate tk2dSpriteCollectionData CreateFromTexturePacker_WithArgs(
            Func<tk2dSpriteCollectionSize, string, UnityEngine.Texture, tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionSize size, string texturePackerData, UnityEngine.Texture texture);
        ...
        public delegate void ResetPlatformData_WithArgs(Action<tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate void DestroyTextureInsts_WithArgs(Action<tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate void UnloadTextures_WithArgs(Action<tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionData self);
        ...
        public delegate void DestroyMaterialInsts_WithArgs(Action<tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionData self);
    ...
    public static class WithOrig
    {
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_Transient_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_Transient", true), value);
            remove => HookEndpointManager.Remove<Delegates.get_Transient_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_Transient", true), value);
        }

        public static event Delegates.set_Transient_WithArgs set_Transient
        {
            add => HookEndpointManager.Add<Delegates.set_Transient_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "set_Transient", true), value);
            remove => HookEndpointManager.Remove<Delegates.set_Transient_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "set_Transient", true), value);
        }
        ...
        public static event Delegates.get_Count_WithArgs get_Count
        {
            add => HookEndpointManager.Add<Delegates.get_Count_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_Count", true), value);
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_FirstValidDefinition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_FirstValidDefinition", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_FirstValidDefinition_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_FirstValidDefinition", true),
                value);
        }
        ...
        {
            add => HookEndpointManager.Add<Delegates.get_FirstValidDefinitionIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_FirstValidDefinitionIndex", true),
                value);
            remove => HookEndpointManager.Remove<Delegates.get_FirstValidDefinitionIndex_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_FirstValidDefinitionIndex", true),
                value);
        }
        ...
        public static event Delegates.get_inst_WithArgs get_inst
        {
            add => HookEndpointManager.Add<Delegates.get_inst_WithArgs>(
                ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionData), "get_inst", true), value);
