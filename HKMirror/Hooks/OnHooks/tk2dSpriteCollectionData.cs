...
public static class Ontk2dSpriteCollectionData
{
    ...
    public static class Delegates
    {
        ...
        public delegate tk2dSpriteCollectionData CreateFromTexture_WithArgs(
            Func<Texture, tk2dSpriteCollectionSize, string[], Rect[], Vector2[], tk2dSpriteCollectionData> orig,
            Texture texture, tk2dSpriteCollectionSize size, string[] names, Rect[] regions, Vector2[] anchors);
        ...
        public delegate tk2dSpriteCollectionData CreateFromTexturePacker_WithArgs(
            Func<tk2dSpriteCollectionSize, string, Texture, tk2dSpriteCollectionData> orig,
            tk2dSpriteCollectionSize size, string texturePackerData, Texture texture);
