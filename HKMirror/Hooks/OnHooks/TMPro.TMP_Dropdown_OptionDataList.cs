...
public static class OnTMPro_TMP_Dropdown_OptionDataList
{
    internal static class HookHandler
    {
        ...
        internal static void Hookget_options()
        {
            if (!HookedList.Contains("get_options"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionDataList), "get_options"),
                    get_options);
            }
        }
        ...
        private static List<TMP_Dropdown.OptionData> get_options(
            Func<TMP_Dropdown.OptionDataList, List<TMP_Dropdown.OptionData>> orig, TMP_Dropdown.OptionDataList self)
        {
        ...
        internal static void Hookset_options()
        {
            if (!HookedList.Contains("set_options"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(TMP_Dropdown.OptionDataList), "set_options"),
                    set_options);
            }
        }
        ...
        private static void set_options(Action<TMP_Dropdown.OptionDataList, List<TMP_Dropdown.OptionData>> orig,
            TMP_Dropdown.OptionDataList self, List<TMP_Dropdown.OptionData> value)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void set_options_WithArgs(
            Action<TMP_Dropdown.OptionDataList, List<TMP_Dropdown.OptionData>> orig, TMP_Dropdown.OptionDataList self,
            List<TMP_Dropdown.OptionData> value);

        public sealed class Params_get_options
        {
            public TMP_Dropdown.OptionDataList self;
        }
