...
public static class OnXTR_G2_WindowsNativeProfile
{
    internal static class HookHandler
    {
        ...
        internal static void HookDefine()
        {
            if (!HookedList.Contains("Define"))
            {
                ...
                new Hook(ReflectionHelper.GetMethodInfo(typeof(XTR_G2_WindowsNativeProfile), "Define"), Define);
            }
        }
        ...
        private static void Define(Action<XTR_G2_WindowsNativeProfile> orig, XTR_G2_WindowsNativeProfile self)
        {
    ...
    public static class Delegates
    {
        ...
        public delegate void Define_WithArgs(Action<XTR_G2_WindowsNativeProfile> orig,
            XTR_G2_WindowsNativeProfile self);

        public sealed class Params_Define
        {
            public XTR_G2_WindowsNativeProfile self;
        }
    }
