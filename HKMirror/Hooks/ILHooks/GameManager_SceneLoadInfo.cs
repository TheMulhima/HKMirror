...
public static class ILGameManager_SceneLoadInfo
{
    public static event ILContext.Manipulator NotifyFetchComplete
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "NotifyFetchComplete"), value);
    ...
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "IsReadyToActivate"), value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "IsReadyToActivate"), value);
    }
    ...
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "NotifyFinished"), value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager.SceneLoadInfo), "NotifyFinished"), value);
    }
}