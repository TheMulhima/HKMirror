...
/// <summary>
/// Contains all correct IL Hooks for CinematicSkipPopup,
...
{
add => IL.CinematicSkipPopup.Show += value;
remove => IL.CinematicSkipPopup.Show -= value;
}
public static event ILContext.Manipulator ShowRoutine
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(CinematicSkipPopup), "ShowRoutine", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(CinematicSkipPopup), "ShowRoutine", true).GetStateMachineTarget(), value);
}
