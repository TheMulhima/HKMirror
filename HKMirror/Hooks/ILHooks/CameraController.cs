...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(CameraController), "DoPositionToHero", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(CameraController), "DoPositionToHero", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(CameraController), "FadeInFailSafe", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(CameraController), "FadeInFailSafe", true).GetStateMachineTarget(), value);
}
