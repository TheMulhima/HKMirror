...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_dimensions", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_dimensions", true), value);
}
public static event ILContext.Manipulator set_dimensions
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_dimensions", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_dimensions", true), value);
}
public static event ILContext.Manipulator set_anchor
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_anchor", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_anchor", true), value);
}
public static event ILContext.Manipulator get_CreateBoxCollider
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_CreateBoxCollider", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "get_CreateBoxCollider", true), value);
}
public static event ILContext.Manipulator set_CreateBoxCollider
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_CreateBoxCollider", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTiledSprite), "set_CreateBoxCollider", true), value);
}
