...
/// <summary>
///     Contains all correct IL Hooks for PlayMakerUnity2d,
...
public static class ILPlayMakerUnity2d
{
    ...
    public static event ILContext.Manipulator ForwardCollisionToCurrentState
    {
        add => IL.PlayMakerUnity2d.ForwardCollisionToCurrentState += value;
        remove => IL.PlayMakerUnity2d.ForwardCollisionToCurrentState -= value;
    }
}