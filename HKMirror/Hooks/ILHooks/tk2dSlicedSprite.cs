...
public static class ILtk2dSlicedSprite
{
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "get_BorderOnly"),
            value);
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "set_BorderOnly"),
            value);
        remove => HookEndpointManager.Unmodify(
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "get_dimensions"),
            value);
        remove => HookEndpointManager.Unmodify(
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "set_dimensions"),
            value);
        remove => HookEndpointManager.Unmodify(
    ...
    {
        add =>
            HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "set_anchor"), value);
        remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dSlicedSprite), "set_anchor"),
            value);
    }
