...
/// <summary>
///     Contains all correct IL Hooks for tk2dStaticSpriteBatcher,
...
public static class ILtk2dStaticSpriteBatcher
{
    ...
    {
        add => IL.tk2dStaticSpriteBatcher.CheckFlag += value;
        remove => IL.tk2dStaticSpriteBatcher.CheckFlag -= value;
    }

    public static event ILContext.Manipulator SetFlag
    {
        add => IL.tk2dStaticSpriteBatcher.SetFlag += value;
        remove => IL.tk2dStaticSpriteBatcher.SetFlag -= value;
    }
