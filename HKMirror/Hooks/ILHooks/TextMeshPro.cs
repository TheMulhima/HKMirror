...
public static class ILTextMeshPro
{
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(TextMeshPro), "set_anchor"), value);
        remove =>
            HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(TextMeshPro), "set_anchor"), value);
    }
