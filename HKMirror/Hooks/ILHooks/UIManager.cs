...
/// <summary>
/// Contains all correct IL Hooks for UIManager,
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsFadingMenu", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsFadingMenu", true), value);
}
public static event ILContext.Manipulator get_IsAnimatingMenus
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsAnimatingMenus", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_IsAnimatingMenus", true), value);
}
public static event ILContext.Manipulator get_instance
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_instance", false), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_instance", false), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "ShowMainMenuHome", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "ShowMainMenuHome", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "StartMenuAnimationCoroutineWorker", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "StartMenuAnimationCoroutineWorker", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToEngageMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToEngageMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToNoSaveMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToNoSaveMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToNoSaveMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToMainMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToMainMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToMainMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToProfileMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToProfileMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToProfileMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator PrepareSaveFilesInOrder
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "PrepareSaveFilesInOrder", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "PrepareSaveFilesInOrder", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToOptionsMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToOptionsMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToOptionsMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToControllerMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToControllerMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToControllerMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToRemapControllerMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToRemapControllerMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToRemapControllerMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToKeyboardMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToKeyboardMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToKeyboardMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToAudioMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToAudioMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToAudioMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToVideoMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToVideoMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToVideoMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToOverscanMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToOverscanMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToOverscanMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToBrightnessMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToBrightnessMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToBrightnessMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToGameOptionsMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToGameOptionsMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToGameOptionsMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToAchievementsMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToAchievementsMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToAchievementsMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToExtrasMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToExtrasMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToExtrasMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToExtrasContentMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToExtrasContentMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToExtrasContentMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToQuitGamePrompt
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToQuitGamePrompt", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToQuitGamePrompt", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToReturnMenuPrompt
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToReturnMenuPrompt", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToReturnMenuPrompt", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToResolutionPrompt
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToResolutionPrompt", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToResolutionPrompt", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator LeaveOptionsMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveOptionsMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveOptionsMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator LeaveExitToMenuPrompt
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveExitToMenuPrompt", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveExitToMenuPrompt", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToPlayModeMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToPlayModeMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToPlayModeMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator ReturnToMainMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "ReturnToMainMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "ReturnToMainMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToPauseMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToPauseMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToPauseMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator GoToMenuCredits
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToMenuCredits", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToMenuCredits", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator ShowCutscenePrompt
{
add => IL.UIManager.ShowCutscenePrompt += value;
remove => IL.UIManager.ShowCutscenePrompt -= value;
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "HideCurrentMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "HideCurrentMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator ShowMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "ShowMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "ShowMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator HideMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "HideMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "HideMenu", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "HideSaveProfileMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "HideSaveProfileMenu", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeInCanvasGroup", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeInCanvasGroup", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator FadeInCanvasGroupAlpha
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeInCanvasGroupAlpha", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeInCanvasGroupAlpha", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator FadeOutCanvasGroup
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeOutCanvasGroup", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeOutCanvasGroup", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator FadeInSprite
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeInSprite", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeInSprite", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator FadeOutSprite
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeOutSprite", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "FadeOutSprite", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_currentDynamicMenu", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "get_currentDynamicMenu", true), value);
}
public static event ILContext.Manipulator set_currentDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "set_currentDynamicMenu", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "set_currentDynamicMenu", true), value);
}
public static event ILContext.Manipulator orig_get_instance
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_get_instance", false), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_get_instance", false), value);
}
public static event ILContext.Manipulator LoadImage
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LoadImage", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LoadImage", true), value);
}
public static event ILContext.Manipulator orig_Awake
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Awake", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Awake", true), value);
}
public static event ILContext.Manipulator orig_Start
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Start", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_Start", true), value);
}
public static event ILContext.Manipulator orig_HideCurrentMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_HideCurrentMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "orig_HideCurrentMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator UIGoToDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIGoToDynamicMenu", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIGoToDynamicMenu", true), value);
}
public static event ILContext.Manipulator GoToDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToDynamicMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "GoToDynamicMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator UILeaveDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UILeaveDynamicMenu", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UILeaveDynamicMenu", true), value);
}
public static event ILContext.Manipulator LeaveDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveDynamicMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "LeaveDynamicMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator UIPauseToDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIPauseToDynamicMenu", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "UIPauseToDynamicMenu", true), value);
}
public static event ILContext.Manipulator PauseToDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "PauseToDynamicMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(UIManager), "PauseToDynamicMenu", true).GetStateMachineTarget(), value);
}
}
