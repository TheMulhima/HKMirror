...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_Shared", false), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_Shared", false), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_FpsFrames", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "get_FpsFrames", true), value);
}
public static event ILContext.Manipulator set_FpsFrames
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "set_FpsFrames", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "set_FpsFrames", true), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "ReportUpload", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(PerformanceHUD), "ReportUpload", true).GetStateMachineTarget(), value);
}
