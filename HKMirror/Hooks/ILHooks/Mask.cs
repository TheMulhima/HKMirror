...
public static class ILMask
{
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(Mask), "set_maskMappingWorldAxis"),
            value);
        remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(Mask), "set_maskMappingWorldAxis"),
            value);
    }
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(Mask), "SetMaskMappingAxisInMaterials"),
            value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(Mask), "SetMaskMappingAxisInMaterials"), value);
    }

    public static event ILContext.Manipulator SetMaskMappingAxisInMaterial
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(Mask), "SetMaskMappingAxisInMaterial"),
            value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(Mask), "SetMaskMappingAxisInMaterial"), value);
    }
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(Mask), "ChangeMappingAxis"), value);
        remove =>
            HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(Mask), "ChangeMappingAxis"), value);
    }
}