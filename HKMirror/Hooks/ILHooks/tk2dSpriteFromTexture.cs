...
/// <summary>
/// Contains all correct IL Hooks for tk2dSpriteFromTexture,
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteFromTexture), "get_Sprite", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteFromTexture), "get_Sprite", true), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteFromTexture), "get_HasSpriteCollection", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteFromTexture), "get_HasSpriteCollection", true), value);
}
...
{
add => IL.tk2dSpriteFromTexture.Create += value;
remove => IL.tk2dSpriteFromTexture.Create -= value;
}
