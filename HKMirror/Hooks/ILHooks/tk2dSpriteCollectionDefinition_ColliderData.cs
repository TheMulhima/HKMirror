...
public static class ILtk2dSpriteCollectionDefinition_ColliderData
{
    public static event ILContext.Manipulator CopyFrom
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CopyFrom"), value);
    ...
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CompareTo"), value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(tk2dSpriteCollectionDefinition.ColliderData), "CompareTo"), value);
    }
}