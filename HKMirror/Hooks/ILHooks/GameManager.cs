...
public static class ILGameManager
{
    ...
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager), "BeginSceneTransitionRoutine").GetStateMachineTarget(),
            value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager), "BeginSceneTransitionRoutine").GetStateMachineTarget(),
            value);
    ...
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager), "ReturnToMainMenu").GetStateMachineTarget(), value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager), "ReturnToMainMenu").GetStateMachineTarget(), value);
    }
    ...
    {
        add => HookEndpointManager.Modify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition"), value);
        remove => HookEndpointManager.Unmodify(
            ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition"), value);
    }
