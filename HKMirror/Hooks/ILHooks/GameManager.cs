...
/// <summary>
/// Contains all correct IL Hooks for GameManager,
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_TimeSlowed", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_TimeSlowed", true), value);
}
public static event ILContext.Manipulator get_inputHandler
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_inputHandler", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_inputHandler", true), value);
}
public static event ILContext.Manipulator set_inputHandler
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_inputHandler", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_inputHandler", true), value);
}
public static event ILContext.Manipulator get_achievementHandler
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_achievementHandler", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_achievementHandler", true), value);
}
public static event ILContext.Manipulator set_achievementHandler
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_achievementHandler", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_achievementHandler", true), value);
}
public static event ILContext.Manipulator get_AudioManager
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_AudioManager", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_AudioManager", true), value);
}
public static event ILContext.Manipulator get_cameraCtrl
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_cameraCtrl", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_cameraCtrl", true), value);
}
public static event ILContext.Manipulator set_cameraCtrl
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_cameraCtrl", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_cameraCtrl", true), value);
}
public static event ILContext.Manipulator get_hero_ctrl
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_hero_ctrl", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_hero_ctrl", true), value);
}
public static event ILContext.Manipulator set_hero_ctrl
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_hero_ctrl", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_hero_ctrl", true), value);
}
public static event ILContext.Manipulator get_heroLight
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_heroLight", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_heroLight", true), value);
}
public static event ILContext.Manipulator set_heroLight
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_heroLight", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_heroLight", true), value);
}
public static event ILContext.Manipulator get_sm
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_sm", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_sm", true), value);
}
public static event ILContext.Manipulator set_sm
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_sm", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_sm", true), value);
}
public static event ILContext.Manipulator get_ui
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_ui", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_ui", true), value);
}
public static event ILContext.Manipulator set_ui
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_ui", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_ui", true), value);
}
public static event ILContext.Manipulator get_tilemap
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_tilemap", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_tilemap", true), value);
}
public static event ILContext.Manipulator set_tilemap
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_tilemap", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_tilemap", true), value);
}
public static event ILContext.Manipulator get_soulOrb_fsm
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulOrb_fsm", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulOrb_fsm", true), value);
}
public static event ILContext.Manipulator set_soulOrb_fsm
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulOrb_fsm", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulOrb_fsm", true), value);
}
public static event ILContext.Manipulator get_soulVessel_fsm
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulVessel_fsm", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_soulVessel_fsm", true), value);
}
public static event ILContext.Manipulator set_soulVessel_fsm
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulVessel_fsm", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_soulVessel_fsm", true), value);
}
public static event ILContext.Manipulator get_PlayTime
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_PlayTime", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_PlayTime", true), value);
}
public static event ILContext.Manipulator get_RespawningHero
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_RespawningHero", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_RespawningHero", true), value);
}
public static event ILContext.Manipulator set_RespawningHero
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_RespawningHero", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_RespawningHero", true), value);
}
public static event ILContext.Manipulator get_IsInSceneTransition
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsInSceneTransition", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsInSceneTransition", true), value);
}
public static event ILContext.Manipulator set_IsInSceneTransition
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_IsInSceneTransition", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "set_IsInSceneTransition", true), value);
}
public static event ILContext.Manipulator get_HasFinishedEnteringScene
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_HasFinishedEnteringScene", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_HasFinishedEnteringScene", true), value);
}
public static event ILContext.Manipulator get_WorldInfo
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_WorldInfo", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_WorldInfo", true), value);
}
public static event ILContext.Manipulator get_IsLoadingSceneTransition
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsLoadingSceneTransition", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsLoadingSceneTransition", true), value);
}
public static event ILContext.Manipulator get_CurrentLoadDuration
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_CurrentLoadDuration", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_CurrentLoadDuration", true), value);
}
public static event ILContext.Manipulator get_IsUsingCustomLoadAnimation
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsUsingCustomLoadAnimation", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_IsUsingCustomLoadAnimation", true), value);
}
public static event ILContext.Manipulator get_instance
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_instance", false), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_instance", false), value);
}
public static event ILContext.Manipulator get_UnsafeInstance
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_UnsafeInstance", false), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "get_UnsafeInstance", false), value);
}
...
public static event ILContext.Manipulator BeginSceneTransition
{
add => IL.GameManager.BeginSceneTransition += value;
remove => IL.GameManager.BeginSceneTransition -= value;
}
public static event ILContext.Manipulator BeginSceneTransitionRoutine
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "BeginSceneTransitionRoutine", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "BeginSceneTransitionRoutine", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator TransitionScene
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "TransitionScene", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "TransitionScene", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PlayerDead", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PlayerDead", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator PlayerDeadFromHazard
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PlayerDeadFromHazard", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PlayerDeadFromHazard", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "FadeSceneInWithDelay", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "FadeSceneInWithDelay", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "LoadSceneAdditive", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "LoadSceneAdditive", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "LoadFirstScene", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "LoadFirstScene", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SkipCutsceneNoMash", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SkipCutsceneNoMash", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SaveGame", true), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "LoadGameFromUIRoutine", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "LoadGameFromUIRoutine", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseGameToggleByMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseGameToggleByMenu", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator PauseGameToggle
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseGameToggle", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseGameToggle", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator SetTimeScale_float_float
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SetTimeScale", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "SetTimeScale", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "FreezeMoment", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "FreezeMoment", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator FreezeMomentGC
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "FreezeMomentGC", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "FreezeMomentGC", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "RunStartNewGame", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "RunStartNewGame", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "RunContinueGame", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "RunContinueGame", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator ReturnToMainMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "ReturnToMainMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "ReturnToMainMenu", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "Platform.IDisengageHandler.OnDisengage", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "Platform.IDisengageHandler.OnDisengage", true), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "QuitGame", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "QuitGame", true).GetStateMachineTarget(), value);
}
...
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_get_ui", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_get_ui", true), value);
}
public static event ILContext.Manipulator orig_set_ui
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_set_ui", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_set_ui", true), value);
}
public static event ILContext.Manipulator orig_OnApplicationQuit
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnApplicationQuit", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnApplicationQuit", true), value);
}
public static event ILContext.Manipulator orig_LoadScene
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_LoadScene", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_LoadScene", true), value);
}
public static event ILContext.Manipulator orig_BeginSceneTransition
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_BeginSceneTransition", true), value);
}
public static event ILContext.Manipulator orig_ClearSaveFile
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_ClearSaveFile", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_ClearSaveFile", true), value);
}
public static event ILContext.Manipulator orig_PlayerDead
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_PlayerDead", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_PlayerDead", true).GetStateMachineTarget(), value);
}
public static event ILContext.Manipulator ModdedSavePath
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "ModdedSavePath", false), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "ModdedSavePath", false), value);
}
public static event ILContext.Manipulator orig_SetupSceneRefs
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_SetupSceneRefs", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_SetupSceneRefs", true), value);
}
public static event ILContext.Manipulator orig_OnWillActivateFirstLevel
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnWillActivateFirstLevel", true), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "orig_OnWillActivateFirstLevel", true), value);
}
public static event ILContext.Manipulator PauseToggleDynamicMenu
{
add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseToggleDynamicMenu", true).GetStateMachineTarget(), value);
remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(GameManager), "PauseToggleDynamicMenu", true).GetStateMachineTarget(), value);
}
}
