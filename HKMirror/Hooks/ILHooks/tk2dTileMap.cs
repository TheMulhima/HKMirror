...
/// <summary>
///     Contains all correct IL Hooks for tk2dTileMap.<br />
...
public static class ILtk2dTileMap
{
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_AllowEdit"), value);
        remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_AllowEdit"),
            value);
    }
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_TilePrefabsList"),
            value);
        remove => HookEndpointManager.Unmodify(
    ...
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Layers"), value);
        remove =>
            HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_Layers"), value);
    }

    public static event ILContext.Manipulator set_Layers
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Layers"), value);
        remove =>
            HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_Layers"), value);
    }

    public static event ILContext.Manipulator get_ColorChannel
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_ColorChannel"),
            value);
        remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_ColorChannel"),
            value);
    }

    public static event ILContext.Manipulator set_ColorChannel
    {
        add => HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_ColorChannel"),
            value);
        remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_ColorChannel"),
            value);
    }
    ...
    {
        add =>
            HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_PrefabsRoot"), value);
        remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "get_PrefabsRoot"),
            value);
    }
    ...
    {
        add =>
            HookEndpointManager.Modify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_PrefabsRoot"), value);
        remove => HookEndpointManager.Unmodify(ReflectionHelper.GetMethodInfo(typeof(tk2dTileMap), "set_PrefabsRoot"),
            value);
    }
