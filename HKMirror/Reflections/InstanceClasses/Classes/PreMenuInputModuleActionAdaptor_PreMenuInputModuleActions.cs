...
///     PreMenuInputModuleActionAdaptor_PreMenuInputModuleActions allowing you to easily get/set fields and call methods without dealing with reflection.
/// </summary>
public class
    PreMenuInputModuleActionAdaptor_PreMenuInputModuleActionsR : InstanceClassWrapper<
        PreMenuInputModuleActionAdaptor.PreMenuInputModuleActions>
{
    public PreMenuInputModuleActionAdaptor_PreMenuInputModuleActionsR(
        PreMenuInputModuleActionAdaptor.PreMenuInputModuleActions _orig) : base(_orig)
    {
    }
