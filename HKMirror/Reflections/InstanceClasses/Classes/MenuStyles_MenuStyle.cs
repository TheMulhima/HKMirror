...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of MenuStyles_MenuStyle allowing you to
...
public UnityEngine.GameObject styleObject
{
...
{
get => orig.IsAvailable;
}

public void SetInitialAudioVolumes (UnityEngine.AudioSource[] sources) =>
