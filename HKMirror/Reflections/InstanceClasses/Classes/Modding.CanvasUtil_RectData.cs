...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of Modding.CanvasUtil_RectData allowing you to
...
public UnityEngine.Vector2 AnchorPivot
{
get => orig.AnchorPivot;
set => orig.AnchorPivot = value;
}

public UnityEngine.Vector2 AnchorPosition
{
get => orig.AnchorPosition;
set => orig.AnchorPosition = value;
}

public UnityEngine.Vector2 RectSizeDelta
{
