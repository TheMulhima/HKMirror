...
{
/// <summary>
///     A class that contains all (public and private) fields and methods of BossChallengeUI_ButtonDisplay allowing you to
...
public UnityEngine.UI.Image incompleteImage
{
get => orig.incompleteImage;
set => orig.incompleteImage = value;
}

public UnityEngine.UI.MenuSelectable button
{
get => orig.button;
