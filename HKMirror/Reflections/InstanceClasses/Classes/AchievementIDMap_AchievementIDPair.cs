...
/// <summary>
///     A class that contains all (public and private) fields and methods of AchievementIDMap_AchievementIDPair allowing
...
public class AchievementIDMap_AchievementIDPairR : InstanceClassWrapper<AchievementIDMap.AchievementIDPair>
{
    ...
    public string InternalId => orig.InternalId;

    public int ServiceId => orig.ServiceId;
}