...
/// <summary>
///     A class that contains all (public and private) fields and methods of GameManager allowing you to easily get/set fields and call methods without dealing with reflection. Similar to
///     <see cref="HKMirror.Reflection.SingletonClasses.GameManagerR">GameManagerR</see> except that you have to provide an
///     instance
/// </summary>
public class GameManagerRR : InstanceClassWrapper<GameManager>
{
    ...
    public int NoSaveSlotID => GameManager.NoSaveSlotID;
    ...
    public void IncreaseGameTimer(float timer)
    {
    ...
    public void OnDisengage(Action next)
    {
        CallMethod(new object[] { next });
    }
